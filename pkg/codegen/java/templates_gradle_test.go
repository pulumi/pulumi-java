...
func TestNewGradleTemplateContext(t *testing.T) {
	...
	assert.Equal(t, "https://pulumi.com", tctx.ProjectURL)
	assert.Equal(t, "https://github.com/pulumi/pulumi-eks", tctx.ProjectGitURL)
