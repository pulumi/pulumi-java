...
public class ToyStore extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable ToyStoreArgs.Builder a);
    }
    private static io.pulumi.example.ToyStoreArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.example.ToyStoreArgs.builder();
     ...
     */
    public ToyStore(String name, BuilderApplicator argsBuilder) {
