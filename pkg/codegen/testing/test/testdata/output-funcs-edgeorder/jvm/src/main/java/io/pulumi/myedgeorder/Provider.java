...
public class Provider extends io.pulumi.resources.ProviderResource {
    ...
    private static io.pulumi.myedgeorder.ProviderArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.myedgeorder.ProviderArgs.builder();
    ...
    public Provider(String name, @Nullable ProviderArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("myedgeorder", name, args == null ? ProviderArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
