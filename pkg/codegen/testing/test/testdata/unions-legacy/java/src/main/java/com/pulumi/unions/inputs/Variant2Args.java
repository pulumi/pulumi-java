...
public final class Variant2Args extends com.pulumi.resources.ResourceArgs {
    ...
    private Variant2Args() {}

    private Variant2Args(Variant2Args $) {
    ...
    public static Builder builder(Variant2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(Variant2Args defaults) {
