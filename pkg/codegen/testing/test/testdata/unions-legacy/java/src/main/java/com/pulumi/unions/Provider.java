...
import com.pulumi.unions.ProviderArgs;
import com.pulumi.unions.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:unions")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("unions", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
