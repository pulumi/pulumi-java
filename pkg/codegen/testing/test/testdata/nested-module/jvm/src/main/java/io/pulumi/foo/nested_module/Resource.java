...
public class Resource extends io.pulumi.resources.CustomResource {
    ...
    public Resource(String name) {
        super("foo:nested/module:Resource", name, ResourceArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public Resource(String name, @Nullable ResourceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("foo:nested/module:Resource", name, args == null ? ResourceArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
