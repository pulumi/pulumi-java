...
public class Provider extends io.pulumi.resources.ProviderResource {
    ...
    private static io.pulumi.foo.ProviderArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.foo.ProviderArgs.builder();
    ...
    public Provider(String name, @Nullable ProviderArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("foo", name, args == null ? ProviderArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
