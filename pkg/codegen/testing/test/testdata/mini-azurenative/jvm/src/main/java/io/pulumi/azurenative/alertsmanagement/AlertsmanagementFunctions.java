...
public final class AlertsmanagementFunctions {
    ...
    public static CompletableFuture<GetActionRuleByNameResult> getActionRuleByName(GetActionRuleByNameArgs args) {
        return Deployment.getInstance().invokeAsync("azure-native:alertsmanagement:getActionRuleByName", TypeShape.of(GetActionRuleByNameResult.class), args == null ? GetActionRuleByNameArgs.Empty : args, Utilities.withVersion(InvokeOptions.Empty));
    }
    /**
     * Action rule object containing target scope, conditions and suppression logic
     * API Version: 2019-05-05-preview.
