...
public final class WebFunctions {
    ...
    public static CompletableFuture<GetWebAppSlotResult> getWebAppSlot(GetWebAppSlotArgs args) {
        return Deployment.getInstance().invokeAsync("azure-native:web:getWebAppSlot", TypeShape.of(GetWebAppSlotResult.class), args == null ? GetWebAppSlotArgs.Empty : args, Utilities.withVersion(InvokeOptions.Empty));
    }
    /**
     * A web app, a mobile app backend, or an API app.
     * API Version: 2020-12-01.
