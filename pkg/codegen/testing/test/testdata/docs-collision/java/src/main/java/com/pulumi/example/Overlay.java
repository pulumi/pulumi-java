...
public class Overlay extends com.pulumi.resources.CustomResource {
    ...
    public Overlay(String name, @Nullable OverlayArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("example::Overlay", name, args == null ? OverlayArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Overlay(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("example::Overlay", name, null, makeResourceOptions(options, id));
    }
