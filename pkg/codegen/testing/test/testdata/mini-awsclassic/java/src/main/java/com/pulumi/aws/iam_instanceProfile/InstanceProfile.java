...
public class InstanceProfile extends CustomResource {
    ...
    private InstanceProfile(String name, Output<String> id, @Nullable InstanceProfileState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static InstanceProfile get(String name, Output<String> id, @Nullable InstanceProfileState state, @Nullable CustomResourceOptions options) {
