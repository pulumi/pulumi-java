...
public final class Ec2_getAmiFunctions {
    public static CompletableFuture<GetAmiResult> getAmi(GetAmiArgs args) {
        return Deployment.getInstance().invokeAsync("aws:ec2/getAmi:getAmi", TypeShape.of(GetAmiResult.class), args == null ? GetAmiArgs.Empty : args, Utilities.withVersion(InvokeOptions.Empty));
    }
