...
import io.pulumi.my8110.ProviderArgs;
import io.pulumi.my8110.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:my8110")
public class Provider extends io.pulumi.resources.ProviderResource {
    public Provider(String name, @Nullable ProviderArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("my8110", name, args == null ? ProviderArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
