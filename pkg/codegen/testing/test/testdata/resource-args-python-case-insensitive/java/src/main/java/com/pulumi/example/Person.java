...
public class Person extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="pets", refs={List.class,Pet.class}, tree="[0,1]")
     ...
     */
    public static Person get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
