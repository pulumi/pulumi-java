...
public class Resource extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.foobar.deeply_nested_module.ResourceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.foobar.deeply_nested_module.ResourceArgs.builder();
