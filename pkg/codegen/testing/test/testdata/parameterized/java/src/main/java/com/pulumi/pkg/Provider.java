...
import com.pulumi.pkg.ProviderArgs;
import com.pulumi.pkg.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:pkg")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("pkg", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false, Utilities.getPackageRef());
    }
