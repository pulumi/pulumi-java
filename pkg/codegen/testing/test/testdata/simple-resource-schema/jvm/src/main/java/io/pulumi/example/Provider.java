...
public class Provider extends io.pulumi.resources.ProviderResource {
    ...
    private static io.pulumi.example.ProviderArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.example.ProviderArgs.builder();
    ...
    public Provider(String name, @Nullable ProviderArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("example", name, args == null ? ProviderArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
