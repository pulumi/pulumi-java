...
import com.pulumi.kubernetes.core.v1.inputs.ConfigMapArgs;
...
public final class ConfigMapListArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConfigMapListArgs Empty = new ConfigMapListArgs();
    ...
    private Output<List<ConfigMapArgs>> items;

    /**
     * @return Items is the list of ConfigMaps.
     * 
     */
    public Output<List<ConfigMapArgs>> items() {
        return this.items;
    }
    ...
    private ConfigMapListArgs() {}

    private ConfigMapListArgs(ConfigMapListArgs $) {
    ...
    public static Builder builder(ConfigMapListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConfigMapListArgs();
        }

        public Builder(ConfigMapListArgs defaults) {
            $ = new ConfigMapListArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder items(Output<List<ConfigMapArgs>> items) {
            $.items = items;
            return this;
        }
         ...
         * 
         */
        public Builder items(List<ConfigMapArgs> items) {
         ...
         * 
         */
        public Builder items(ConfigMapArgs... items) {
