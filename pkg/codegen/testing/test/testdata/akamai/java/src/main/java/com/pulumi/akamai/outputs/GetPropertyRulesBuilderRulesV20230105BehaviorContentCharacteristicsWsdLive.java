...
@CustomType
public final class GetPropertyRulesBuilderRulesV20230105BehaviorContentCharacteristicsWsdLive {
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorContentCharacteristicsWsdLive() {}
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorContentCharacteristicsWsdLive defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uuid;
        public Builder() {}
        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorContentCharacteristicsWsdLive defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorContentCharacteristicsWsdLive build() {
            final var _resultValue = new GetPropertyRulesBuilderRulesV20230105BehaviorContentCharacteristicsWsdLive();
