...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorOriginCustomCertificateArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorOriginCustomCertificateAuthorityArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs;
...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorOriginArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorOriginArgs Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorOriginArgs();
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20230530BehaviorOriginCustomCertificateAuthorityArgs>> customCertificateAuthorities;

    public Optional<Output<List<GetPropertyRulesBuilderRulesV20230530BehaviorOriginCustomCertificateAuthorityArgs>>> customCertificateAuthorities() {
        return Optional.ofNullable(this.customCertificateAuthorities);
    }

    @Import(name="customCertificates")
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20230530BehaviorOriginCustomCertificateArgs>> customCertificates;

    public Optional<Output<List<GetPropertyRulesBuilderRulesV20230530BehaviorOriginCustomCertificateArgs>>> customCertificates() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs> netStorage;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs>> netStorage() {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorOriginArgs() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorOriginArgs(GetPropertyRulesBuilderRulesV20230530BehaviorOriginArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorOriginArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorOriginArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorOriginArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorOriginArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder customCertificateAuthorities(@Nullable Output<List<GetPropertyRulesBuilderRulesV20230530BehaviorOriginCustomCertificateAuthorityArgs>> customCertificateAuthorities) {
            $.customCertificateAuthorities = customCertificateAuthorities;
            return this;
        }

        public Builder customCertificateAuthorities(List<GetPropertyRulesBuilderRulesV20230530BehaviorOriginCustomCertificateAuthorityArgs> customCertificateAuthorities) {
            return customCertificateAuthorities(Output.of(customCertificateAuthorities));
        }

        public Builder customCertificateAuthorities(GetPropertyRulesBuilderRulesV20230530BehaviorOriginCustomCertificateAuthorityArgs... customCertificateAuthorities) {
            return customCertificateAuthorities(List.of(customCertificateAuthorities));
        }

        public Builder customCertificates(@Nullable Output<List<GetPropertyRulesBuilderRulesV20230530BehaviorOriginCustomCertificateArgs>> customCertificates) {
            $.customCertificates = customCertificates;
            return this;
        }

        public Builder customCertificates(List<GetPropertyRulesBuilderRulesV20230530BehaviorOriginCustomCertificateArgs> customCertificates) {
            return customCertificates(Output.of(customCertificates));
        }

        public Builder customCertificates(GetPropertyRulesBuilderRulesV20230530BehaviorOriginCustomCertificateArgs... customCertificates) {
        ...
        public Builder netStorage(@Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs> netStorage) {
            $.netStorage = netStorage;
            return this;
        }

        public Builder netStorage(GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs netStorage) {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorOriginArgs build() {
            return $;
        }
    }
