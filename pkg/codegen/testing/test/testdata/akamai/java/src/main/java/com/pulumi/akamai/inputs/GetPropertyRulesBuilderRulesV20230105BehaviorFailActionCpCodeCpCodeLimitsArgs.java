...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorFailActionCpCodeCpCodeLimitsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorFailActionCpCodeCpCodeLimitsArgs() {}

    private GetPropertyRulesBuilderRulesV20230105BehaviorFailActionCpCodeCpCodeLimitsArgs(GetPropertyRulesBuilderRulesV20230105BehaviorFailActionCpCodeCpCodeLimitsArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorFailActionCpCodeCpCodeLimitsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorFailActionCpCodeCpCodeLimitsArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorFailActionCpCodeCpCodeLimitsArgs defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorFailActionCpCodeCpCodeLimitsArgs build() {
            return $;
        }
    }
