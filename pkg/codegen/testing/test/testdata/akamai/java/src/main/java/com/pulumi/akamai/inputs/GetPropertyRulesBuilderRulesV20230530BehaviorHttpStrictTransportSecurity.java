...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorHttpStrictTransportSecurity extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorHttpStrictTransportSecurity Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorHttpStrictTransportSecurity();
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorHttpStrictTransportSecurity(GetPropertyRulesBuilderRulesV20230530BehaviorHttpStrictTransportSecurity $) {
        this.enable = $.enable;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorHttpStrictTransportSecurity();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorHttpStrictTransportSecurity defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorHttpStrictTransportSecurity(Objects.requireNonNull(defaults));
        }
