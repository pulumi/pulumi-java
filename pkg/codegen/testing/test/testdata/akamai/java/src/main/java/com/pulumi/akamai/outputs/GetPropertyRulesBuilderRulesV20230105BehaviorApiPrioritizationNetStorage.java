...
@CustomType
public final class GetPropertyRulesBuilderRulesV20230105BehaviorApiPrioritizationNetStorage {
    private @Nullable Integer cpCode;
    private @Nullable String downloadDomainName;
    private @Nullable String g2oToken;

    private GetPropertyRulesBuilderRulesV20230105BehaviorApiPrioritizationNetStorage() {}
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorApiPrioritizationNetStorage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String g2oToken;
        public Builder() {}
        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorApiPrioritizationNetStorage defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorApiPrioritizationNetStorage build() {
            final var _resultValue = new GetPropertyRulesBuilderRulesV20230105BehaviorApiPrioritizationNetStorage();
