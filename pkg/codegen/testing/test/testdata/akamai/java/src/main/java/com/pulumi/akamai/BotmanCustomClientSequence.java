...
import com.pulumi.akamai.BotmanCustomClientSequenceArgs;
import com.pulumi.akamai.Utilities;
import com.pulumi.akamai.inputs.BotmanCustomClientSequenceState;
...
@ResourceType(type="akamai:index/botmanCustomClientSequence:BotmanCustomClientSequence")
public class BotmanCustomClientSequence extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="customClientIds", refs={List.class,String.class}, tree="[0,1]")
    ...
    public BotmanCustomClientSequence(java.lang.String name, BotmanCustomClientSequenceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("akamai:index/botmanCustomClientSequence:BotmanCustomClientSequence", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
