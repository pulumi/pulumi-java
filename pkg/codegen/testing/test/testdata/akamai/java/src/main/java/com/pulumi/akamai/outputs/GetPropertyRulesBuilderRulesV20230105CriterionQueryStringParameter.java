...
@CustomType
public final class GetPropertyRulesBuilderRulesV20230105CriterionQueryStringParameter {
    ...
    private GetPropertyRulesBuilderRulesV20230105CriterionQueryStringParameter() {}
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105CriterionQueryStringParameter defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(GetPropertyRulesBuilderRulesV20230105CriterionQueryStringParameter defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230105CriterionQueryStringParameter build() {
            final var _resultValue = new GetPropertyRulesBuilderRulesV20230105CriterionQueryStringParameter();
