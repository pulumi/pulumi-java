...
public class BotmanBotManagementSettings extends com.pulumi.resources.CustomResource {
     ...
     */
    public BotmanBotManagementSettings(String name) {
     ...
     */
    public BotmanBotManagementSettings(String name, BotmanBotManagementSettingsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("akamai:index/botmanBotManagementSettings:BotmanBotManagementSettings", name, args == null ? BotmanBotManagementSettingsArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private BotmanBotManagementSettings(String name, Output<String> id, @Nullable BotmanBotManagementSettingsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static BotmanBotManagementSettings get(String name, Output<String> id, @Nullable BotmanBotManagementSettingsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
