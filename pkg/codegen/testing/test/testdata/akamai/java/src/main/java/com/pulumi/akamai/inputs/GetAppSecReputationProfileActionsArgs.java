...
public final class GetAppSecReputationProfileActionsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetAppSecReputationProfileActionsArgs build() {
            if ($.configId == null) {
                throw new MissingRequiredPropertyException("GetAppSecReputationProfileActionsArgs", "configId");
            }
            if ($.securityPolicyId == null) {
                throw new MissingRequiredPropertyException("GetAppSecReputationProfileActionsArgs", "securityPolicyId");
            }
            return $;
        }
    }
