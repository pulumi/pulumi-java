...
import com.pulumi.akamai.inputs.GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValue;
...
public final class GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatch extends com.pulumi.resources.InvokeArgs {

    public static final GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatch Empty = new GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatch();
    ...
    public Optional<List<GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValue>> objectMatchValues() {
        return Optional.ofNullable(this.objectMatchValues);
    }

    private GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatch() {}

    private GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatch(GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatch $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatch();
        }

        public Builder(GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatch defaults) {
            $ = new GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatch(Objects.requireNonNull(defaults));
        }
