...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorTieredDistributionCustomization extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230105BehaviorTieredDistributionCustomization Empty = new GetPropertyRulesBuilderRulesV20230105BehaviorTieredDistributionCustomization();
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorTieredDistributionCustomization() {}

    private GetPropertyRulesBuilderRulesV20230105BehaviorTieredDistributionCustomization(GetPropertyRulesBuilderRulesV20230105BehaviorTieredDistributionCustomization $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorTieredDistributionCustomization defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorTieredDistributionCustomization();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorTieredDistributionCustomization defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorTieredDistributionCustomization(Objects.requireNonNull(defaults));
        }
