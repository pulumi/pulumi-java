...
@CustomType
public final class GetPropertyRulesBuilderRulesV20230530BehaviorInclude {
    ...
    public static final class Builder {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorInclude build() {
            final var _resultValue = new GetPropertyRulesBuilderRulesV20230530BehaviorInclude();
            _resultValue.id = id;
