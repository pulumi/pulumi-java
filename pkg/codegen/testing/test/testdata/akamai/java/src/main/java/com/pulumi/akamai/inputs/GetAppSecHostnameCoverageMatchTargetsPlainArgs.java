...
public final class GetAppSecHostnameCoverageMatchTargetsPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetAppSecHostnameCoverageMatchTargetsPlainArgs build() {
            if ($.configId == null) {
                throw new MissingRequiredPropertyException("GetAppSecHostnameCoverageMatchTargetsPlainArgs", "configId");
            }
            if ($.hostname == null) {
                throw new MissingRequiredPropertyException("GetAppSecHostnameCoverageMatchTargetsPlainArgs", "hostname");
            }
            return $;
        }
    }
