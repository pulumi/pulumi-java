...
import com.pulumi.akamai.outputs.GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateIssuerRdns;
import com.pulumi.akamai.outputs.GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateSubjectRdns;
...
@CustomType
public final class GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificate {
    private @Nullable Boolean canBeCa;
    private @Nullable Boolean canBeLeaf;
    private @Nullable GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateIssuerRdns issuerRdns;
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateSubjectRdns subjectRdns;
    ...
    public Optional<GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateIssuerRdns> issuerRdns() {
    ...
    public Optional<GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateSubjectRdns> subjectRdns() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder issuerRdns(@Nullable GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateIssuerRdns issuerRdns) {
        ...
        @CustomType.Setter
        public Builder subjectRdns(@Nullable GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateSubjectRdns subjectRdns) {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificate build() {
            final var _resultValue = new GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificate();
