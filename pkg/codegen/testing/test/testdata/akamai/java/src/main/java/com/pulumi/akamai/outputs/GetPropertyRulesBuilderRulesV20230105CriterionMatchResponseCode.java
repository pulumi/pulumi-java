...
@CustomType
public final class GetPropertyRulesBuilderRulesV20230105CriterionMatchResponseCode {
    ...
    private GetPropertyRulesBuilderRulesV20230105CriterionMatchResponseCode() {}
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105CriterionMatchResponseCode defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(GetPropertyRulesBuilderRulesV20230105CriterionMatchResponseCode defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230105CriterionMatchResponseCode build() {
            final var _resultValue = new GetPropertyRulesBuilderRulesV20230105CriterionMatchResponseCode();
