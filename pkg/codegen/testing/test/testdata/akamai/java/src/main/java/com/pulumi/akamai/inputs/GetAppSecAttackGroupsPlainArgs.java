...
public final class GetAppSecAttackGroupsPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetAppSecAttackGroupsPlainArgs build() {
            if ($.configId == null) {
                throw new MissingRequiredPropertyException("GetAppSecAttackGroupsPlainArgs", "configId");
            }
            if ($.securityPolicyId == null) {
                throw new MissingRequiredPropertyException("GetAppSecAttackGroupsPlainArgs", "securityPolicyId");
            }
            return $;
        }
    }
