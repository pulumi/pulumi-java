...
public final class GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMaskArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMaskArgs Empty = new GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMaskArgs();
    ...
    private GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMaskArgs() {}

    private GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMaskArgs(GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMaskArgs $) {
        this.gain = $.gain;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMaskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMaskArgs();
        }

        public Builder(GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMaskArgs defaults) {
            $ = new GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMaskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyPostBreakpointTransformationUnsharpMaskArgs build() {
            return $;
        }
    }
