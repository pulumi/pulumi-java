...
import com.pulumi.akamai.inputs.GetCloudletsPhasedReleaseMatchRuleMatchRuleMatchObjectMatchValue;
...
public final class GetCloudletsPhasedReleaseMatchRuleMatchRuleMatch extends com.pulumi.resources.InvokeArgs {

    public static final GetCloudletsPhasedReleaseMatchRuleMatchRuleMatch Empty = new GetCloudletsPhasedReleaseMatchRuleMatchRuleMatch();
    ...
    public Optional<List<GetCloudletsPhasedReleaseMatchRuleMatchRuleMatchObjectMatchValue>> objectMatchValues() {
        return Optional.ofNullable(this.objectMatchValues);
    }

    private GetCloudletsPhasedReleaseMatchRuleMatchRuleMatch() {}

    private GetCloudletsPhasedReleaseMatchRuleMatchRuleMatch(GetCloudletsPhasedReleaseMatchRuleMatchRuleMatch $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsPhasedReleaseMatchRuleMatchRuleMatch();
        }

        public Builder(GetCloudletsPhasedReleaseMatchRuleMatchRuleMatch defaults) {
            $ = new GetCloudletsPhasedReleaseMatchRuleMatchRuleMatch(Objects.requireNonNull(defaults));
        }
