...
import com.pulumi.akamai.inputs.GetCloudletsRequestControlMatchRuleMatchRuleMatchObjectMatchValue;
...
public final class GetCloudletsRequestControlMatchRuleMatchRuleMatch extends com.pulumi.resources.InvokeArgs {

    public static final GetCloudletsRequestControlMatchRuleMatchRuleMatch Empty = new GetCloudletsRequestControlMatchRuleMatchRuleMatch();
    ...
    public Optional<List<GetCloudletsRequestControlMatchRuleMatchRuleMatchObjectMatchValue>> objectMatchValues() {
        return Optional.ofNullable(this.objectMatchValues);
    }

    private GetCloudletsRequestControlMatchRuleMatchRuleMatch() {}

    private GetCloudletsRequestControlMatchRuleMatchRuleMatch(GetCloudletsRequestControlMatchRuleMatchRuleMatch $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsRequestControlMatchRuleMatchRuleMatch();
        }

        public Builder(GetCloudletsRequestControlMatchRuleMatchRuleMatch defaults) {
            $ = new GetCloudletsRequestControlMatchRuleMatchRuleMatch(Objects.requireNonNull(defaults));
        }
