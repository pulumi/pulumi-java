...
public final class GetImagingPolicyImagePolicyTransformationAppendImageBoxImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageBoxImage Empty = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImage();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageBoxImage() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageBoxImage(GetImagingPolicyImagePolicyTransformationAppendImageBoxImage $) {
        this.color = $.color;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageBoxImage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageBoxImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImage(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageBoxImage build() {
            return $;
        }
    }
