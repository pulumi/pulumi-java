...
public final class GetPropertyRulesBuilderRulesV20230530CriterionContentTypeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230530CriterionContentTypeArgs Empty = new GetPropertyRulesBuilderRulesV20230530CriterionContentTypeArgs();
    ...
    private GetPropertyRulesBuilderRulesV20230530CriterionContentTypeArgs() {}

    private GetPropertyRulesBuilderRulesV20230530CriterionContentTypeArgs(GetPropertyRulesBuilderRulesV20230530CriterionContentTypeArgs $) {
        this.locked = $.locked;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530CriterionContentTypeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530CriterionContentTypeArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530CriterionContentTypeArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530CriterionContentTypeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20230530CriterionContentTypeArgs build() {
            return $;
        }
    }
