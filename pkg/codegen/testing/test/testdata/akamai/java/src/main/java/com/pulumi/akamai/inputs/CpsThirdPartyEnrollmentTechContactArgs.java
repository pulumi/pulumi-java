    ...
    public static final class Builder {
        ...
        public CpsThirdPartyEnrollmentTechContactArgs build() {
            if ($.addressLineOne == null) {
                throw new MissingRequiredPropertyException("CpsThirdPartyEnrollmentTechContactArgs", "addressLineOne");
            }
            if ($.city == null) {
                throw new MissingRequiredPropertyException("CpsThirdPartyEnrollmentTechContactArgs", "city");
            }
            if ($.countryCode == null) {
                throw new MissingRequiredPropertyException("CpsThirdPartyEnrollmentTechContactArgs", "countryCode");
            }
            if ($.email == null) {
                throw new MissingRequiredPropertyException("CpsThirdPartyEnrollmentTechContactArgs", "email");
            }
            if ($.firstName == null) {
                throw new MissingRequiredPropertyException("CpsThirdPartyEnrollmentTechContactArgs", "firstName");
            }
            if ($.lastName == null) {
                throw new MissingRequiredPropertyException("CpsThirdPartyEnrollmentTechContactArgs", "lastName");
            }
            if ($.organization == null) {
                throw new MissingRequiredPropertyException("CpsThirdPartyEnrollmentTechContactArgs", "organization");
            }
            if ($.phone == null) {
                throw new MissingRequiredPropertyException("CpsThirdPartyEnrollmentTechContactArgs", "phone");
            }
            if ($.postalCode == null) {
                throw new MissingRequiredPropertyException("CpsThirdPartyEnrollmentTechContactArgs", "postalCode");
            }
            if ($.region == null) {
                throw new MissingRequiredPropertyException("CpsThirdPartyEnrollmentTechContactArgs", "region");
            }
            return $;
        }
    }
