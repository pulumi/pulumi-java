...
import com.pulumi.akamai.outputs.GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateAuthorityIssuerRdns;
import com.pulumi.akamai.outputs.GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateAuthoritySubjectRdns;
...
@CustomType
public final class GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateAuthority {
    private @Nullable Boolean canBeCa;
    private @Nullable Boolean canBeLeaf;
    private @Nullable GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateAuthorityIssuerRdns issuerRdns;
    ...
    private @Nullable GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateAuthoritySubjectRdns subjectRdns;
    private @Nullable Integer version;

    private GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateAuthority() {}
    ...
    public Optional<GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateAuthorityIssuerRdns> issuerRdns() {
    ...
    public Optional<GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateAuthoritySubjectRdns> subjectRdns() {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateAuthority defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer version;
        public Builder() {}
        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateAuthority defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateAuthority build() {
            final var _resultValue = new GetPropertyRulesBuilderRulesV20230105BehaviorOriginCustomCertificateAuthority();
