...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorVisitorPrioritizationFifoArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230105BehaviorVisitorPrioritizationFifoArgs Empty = new GetPropertyRulesBuilderRulesV20230105BehaviorVisitorPrioritizationFifoArgs();
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorVisitorPrioritizationFifoArgs() {}

    private GetPropertyRulesBuilderRulesV20230105BehaviorVisitorPrioritizationFifoArgs(GetPropertyRulesBuilderRulesV20230105BehaviorVisitorPrioritizationFifoArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorVisitorPrioritizationFifoArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorVisitorPrioritizationFifoArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorVisitorPrioritizationFifoArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorVisitorPrioritizationFifoArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorVisitorPrioritizationFifoArgs build() {
            return $;
        }
    }
