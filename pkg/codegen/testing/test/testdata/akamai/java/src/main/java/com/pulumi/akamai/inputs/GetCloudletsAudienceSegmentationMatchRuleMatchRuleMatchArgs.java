...
import com.pulumi.akamai.inputs.GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchObjectMatchValueArgs;
...
public final class GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchArgs Empty = new GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchArgs();
    ...
    private @Nullable Output<List<GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchObjectMatchValueArgs>> objectMatchValues;

    public Optional<Output<List<GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchObjectMatchValueArgs>>> objectMatchValues() {
        return Optional.ofNullable(this.objectMatchValues);
    }

    private GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchArgs() {}

    private GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchArgs(GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchArgs $) {
    ...
    public static Builder builder(GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchArgs();
        }

        public Builder(GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchArgs defaults) {
            $ = new GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder objectMatchValues(@Nullable Output<List<GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchObjectMatchValueArgs>> objectMatchValues) {
            $.objectMatchValues = objectMatchValues;
            return this;
        }

        public Builder objectMatchValues(List<GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchObjectMatchValueArgs> objectMatchValues) {
            return objectMatchValues(Output.of(objectMatchValues));
        }

        public Builder objectMatchValues(GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchObjectMatchValueArgs... objectMatchValues) {
            return objectMatchValues(List.of(objectMatchValues));
        }

        public GetCloudletsAudienceSegmentationMatchRuleMatchRuleMatchArgs build() {
            return $;
        }
    }
