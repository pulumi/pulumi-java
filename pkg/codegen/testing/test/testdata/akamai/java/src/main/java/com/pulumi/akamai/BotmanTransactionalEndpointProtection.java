...
public class BotmanTransactionalEndpointProtection extends com.pulumi.resources.CustomResource {
     ...
     */
    public BotmanTransactionalEndpointProtection(String name) {
     ...
     */
    public static BotmanTransactionalEndpointProtection get(String name, Output<String> id, @Nullable BotmanTransactionalEndpointProtectionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
