...
@CustomType
public final class GetPropertyRulesBuilderRulesV20230530BehaviorVirtualWaitingRoom {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorVirtualWaitingRoom() {}
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorVirtualWaitingRoom defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String waitingRoomTitle;
        public Builder() {}
        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorVirtualWaitingRoom defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorVirtualWaitingRoom build() {
            final var _resultValue = new GetPropertyRulesBuilderRulesV20230530BehaviorVirtualWaitingRoom();
