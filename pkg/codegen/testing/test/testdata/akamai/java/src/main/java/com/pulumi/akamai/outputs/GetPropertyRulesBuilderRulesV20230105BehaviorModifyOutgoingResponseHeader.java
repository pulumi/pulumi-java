...
@CustomType
public final class GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeader {
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeader() {}
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeader defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uuid;
        public Builder() {}
        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeader defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeader build() {
            final var _resultValue = new GetPropertyRulesBuilderRulesV20230105BehaviorModifyOutgoingResponseHeader();
