...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorGlobalRequestNumber extends com.pulumi.resources.InvokeArgs {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorGlobalRequestNumber() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorGlobalRequestNumber(GetPropertyRulesBuilderRulesV20230530BehaviorGlobalRequestNumber $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorGlobalRequestNumber defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorGlobalRequestNumber();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorGlobalRequestNumber defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorGlobalRequestNumber build() {
            return $;
        }
    }
