...
public final class GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueOptions extends com.pulumi.resources.InvokeArgs {

    public static final GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueOptions Empty = new GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueOptions();
    ...
    private GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueOptions(GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueOptions $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueOptions();
        }

        public Builder(GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueOptions defaults) {
            $ = new GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueOptions(Objects.requireNonNull(defaults));
        }
