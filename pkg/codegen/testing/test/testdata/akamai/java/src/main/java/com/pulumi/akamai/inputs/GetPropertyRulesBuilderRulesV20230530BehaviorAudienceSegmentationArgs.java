...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationCloudletPolicyArgs;
...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationArgs Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationArgs();

    @Import(name="cloudletPolicy")
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationCloudletPolicyArgs> cloudletPolicy;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationArgs() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationArgs(GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationArgs(Objects.requireNonNull(defaults));
        }

        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationCloudletPolicyArgs> cloudletPolicy) {
            $.cloudletPolicy = cloudletPolicy;
            return this;
        }

        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationCloudletPolicyArgs cloudletPolicy) {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorAudienceSegmentationArgs build() {
            return $;
        }
    }
