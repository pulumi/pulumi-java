...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorOriginNetStorageArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230105BehaviorOriginNetStorageArgs Empty = new GetPropertyRulesBuilderRulesV20230105BehaviorOriginNetStorageArgs();
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorOriginNetStorageArgs() {}

    private GetPropertyRulesBuilderRulesV20230105BehaviorOriginNetStorageArgs(GetPropertyRulesBuilderRulesV20230105BehaviorOriginNetStorageArgs $) {
        this.cpCode = $.cpCode;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorOriginNetStorageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorOriginNetStorageArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorOriginNetStorageArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorOriginNetStorageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorOriginNetStorageArgs build() {
            return $;
        }
    }
