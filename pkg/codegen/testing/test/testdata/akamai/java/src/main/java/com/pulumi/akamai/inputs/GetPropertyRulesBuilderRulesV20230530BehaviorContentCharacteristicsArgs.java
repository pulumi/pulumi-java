...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorContentCharacteristicsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorContentCharacteristicsArgs Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorContentCharacteristicsArgs();
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorContentCharacteristicsArgs() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorContentCharacteristicsArgs(GetPropertyRulesBuilderRulesV20230530BehaviorContentCharacteristicsArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorContentCharacteristicsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorContentCharacteristicsArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorContentCharacteristicsArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorContentCharacteristicsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorContentCharacteristicsArgs build() {
            return $;
        }
    }
