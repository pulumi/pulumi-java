...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerAllDownNetStorage;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerCloudletPolicy;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerFailoverOriginMap;
...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancer extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancer Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancer();
    ...
    public Optional<List<GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerFailoverOriginMap>> failoverOriginMaps() {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancer(GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancer $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancer();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancer defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancer(Objects.requireNonNull(defaults));
        }
