...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorManualServerPushArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorManualServerPushArgs() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorManualServerPushArgs(GetPropertyRulesBuilderRulesV20230530BehaviorManualServerPushArgs $) {
        this.locked = $.locked;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorManualServerPushArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorManualServerPushArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorManualServerPushArgs defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorManualServerPushArgs build() {
            return $;
        }
    }
