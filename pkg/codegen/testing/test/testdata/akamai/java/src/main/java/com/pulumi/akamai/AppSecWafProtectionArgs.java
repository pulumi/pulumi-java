...
public final class AppSecWafProtectionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AppSecWafProtectionArgs build() {
            if ($.configId == null) {
                throw new MissingRequiredPropertyException("AppSecWafProtectionArgs", "configId");
            }
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("AppSecWafProtectionArgs", "enabled");
            }
            if ($.securityPolicyId == null) {
                throw new MissingRequiredPropertyException("AppSecWafProtectionArgs", "securityPolicyId");
            }
            return $;
        }
    }
