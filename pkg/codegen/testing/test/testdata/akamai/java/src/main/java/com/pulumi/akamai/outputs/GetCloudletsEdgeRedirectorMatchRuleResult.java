...
public final class GetCloudletsEdgeRedirectorMatchRuleResult {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetCloudletsEdgeRedirectorMatchRuleResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder json(String json) {
            if (json == null) {
              throw new MissingRequiredPropertyException("GetCloudletsEdgeRedirectorMatchRuleResult", "json");
            }
            this.json = json;
            return this;
        }
        ...
        public GetCloudletsEdgeRedirectorMatchRuleResult build() {
            final var _resultValue = new GetCloudletsEdgeRedirectorMatchRuleResult();
            _resultValue.id = id;
