...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerAllDownNetStorageArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerCloudletPolicyArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerFailoverOriginMapArgs;
...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerArgs Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerArgs();

    @Import(name="allDownNetStorage")
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerAllDownNetStorageArgs> allDownNetStorage;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerAllDownNetStorageArgs>> allDownNetStorage() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerCloudletPolicyArgs> cloudletPolicy;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerCloudletPolicyArgs>> cloudletPolicy() {
    ...
    private @Nullable Output<List<GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerFailoverOriginMapArgs>> failoverOriginMaps;

    public Optional<Output<List<GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerFailoverOriginMapArgs>>> failoverOriginMaps() {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerArgs() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerArgs(GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerArgs(Objects.requireNonNull(defaults));
        }

        public Builder allDownNetStorage(@Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerAllDownNetStorageArgs> allDownNetStorage) {
            $.allDownNetStorage = allDownNetStorage;
            return this;
        }

        public Builder allDownNetStorage(GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerAllDownNetStorageArgs allDownNetStorage) {
        ...
        public Builder cloudletPolicy(@Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerCloudletPolicyArgs> cloudletPolicy) {
            $.cloudletPolicy = cloudletPolicy;
            return this;
        }

        public Builder cloudletPolicy(GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerCloudletPolicyArgs cloudletPolicy) {
        ...
        public Builder failoverOriginMaps(@Nullable Output<List<GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerFailoverOriginMapArgs>> failoverOriginMaps) {
            $.failoverOriginMaps = failoverOriginMaps;
            return this;
        }

        public Builder failoverOriginMaps(List<GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerFailoverOriginMapArgs> failoverOriginMaps) {
            return failoverOriginMaps(Output.of(failoverOriginMaps));
        }

        public Builder failoverOriginMaps(GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerFailoverOriginMapArgs... failoverOriginMaps) {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerArgs build() {
            return $;
        }
    }
