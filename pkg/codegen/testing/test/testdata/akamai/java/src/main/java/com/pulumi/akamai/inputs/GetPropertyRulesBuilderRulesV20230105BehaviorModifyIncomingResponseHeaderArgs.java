...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingResponseHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingResponseHeaderArgs Empty = new GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingResponseHeaderArgs();
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingResponseHeaderArgs() {}

    private GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingResponseHeaderArgs(GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingResponseHeaderArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingResponseHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingResponseHeaderArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingResponseHeaderArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingResponseHeaderArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingResponseHeaderArgs build() {
            return $;
        }
    }
