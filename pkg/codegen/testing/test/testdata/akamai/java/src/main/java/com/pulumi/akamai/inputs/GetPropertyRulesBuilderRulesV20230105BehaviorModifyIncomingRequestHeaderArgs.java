...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingRequestHeaderArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingRequestHeaderArgs() {}

    private GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingRequestHeaderArgs(GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingRequestHeaderArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingRequestHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingRequestHeaderArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingRequestHeaderArgs defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorModifyIncomingRequestHeaderArgs build() {
            return $;
        }
    }
