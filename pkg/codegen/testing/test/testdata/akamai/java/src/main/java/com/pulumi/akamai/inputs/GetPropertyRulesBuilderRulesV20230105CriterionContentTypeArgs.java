...
public final class GetPropertyRulesBuilderRulesV20230105CriterionContentTypeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230105CriterionContentTypeArgs Empty = new GetPropertyRulesBuilderRulesV20230105CriterionContentTypeArgs();
    ...
    private GetPropertyRulesBuilderRulesV20230105CriterionContentTypeArgs() {}

    private GetPropertyRulesBuilderRulesV20230105CriterionContentTypeArgs(GetPropertyRulesBuilderRulesV20230105CriterionContentTypeArgs $) {
        this.locked = $.locked;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105CriterionContentTypeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105CriterionContentTypeArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105CriterionContentTypeArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105CriterionContentTypeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20230105CriterionContentTypeArgs build() {
            return $;
        }
    }
