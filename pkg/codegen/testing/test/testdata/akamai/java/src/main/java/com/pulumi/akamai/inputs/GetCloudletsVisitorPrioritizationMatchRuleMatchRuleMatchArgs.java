...
import com.pulumi.akamai.inputs.GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchObjectMatchValueArgs;
...
public final class GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchArgs Empty = new GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchArgs();
    ...
    private @Nullable Output<List<GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchObjectMatchValueArgs>> objectMatchValues;

    public Optional<Output<List<GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchObjectMatchValueArgs>>> objectMatchValues() {
        return Optional.ofNullable(this.objectMatchValues);
    }

    private GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchArgs() {}

    private GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchArgs(GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchArgs $) {
    ...
    public static Builder builder(GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchArgs();
        }

        public Builder(GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchArgs defaults) {
            $ = new GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder objectMatchValues(@Nullable Output<List<GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchObjectMatchValueArgs>> objectMatchValues) {
            $.objectMatchValues = objectMatchValues;
            return this;
        }

        public Builder objectMatchValues(List<GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchObjectMatchValueArgs> objectMatchValues) {
            return objectMatchValues(Output.of(objectMatchValues));
        }

        public Builder objectMatchValues(GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchObjectMatchValueArgs... objectMatchValues) {
            return objectMatchValues(List.of(objectMatchValues));
        }

        public GetCloudletsVisitorPrioritizationMatchRuleMatchRuleMatchArgs build() {
            return $;
        }
    }
