...
@CustomType
public final class GetPropertyRulesBuilderRulesV20230530CriterionFilename {
    ...
    private GetPropertyRulesBuilderRulesV20230530CriterionFilename() {}
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530CriterionFilename defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(GetPropertyRulesBuilderRulesV20230530CriterionFilename defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230530CriterionFilename build() {
            final var _resultValue = new GetPropertyRulesBuilderRulesV20230530CriterionFilename();
