...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorFailActionCpCodeCpCodeLimits;
...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorFailActionCpCode extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorFailActionCpCode Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorFailActionCpCode();
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorFailActionCpCode(GetPropertyRulesBuilderRulesV20230530BehaviorFailActionCpCode $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorFailActionCpCode();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorFailActionCpCode defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorFailActionCpCode(Objects.requireNonNull(defaults));
        }
