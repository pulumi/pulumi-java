...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorDatastreamArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230105BehaviorDatastreamArgs Empty = new GetPropertyRulesBuilderRulesV20230105BehaviorDatastreamArgs();
    ...
    private @Nullable Output<Integer> logStreamName;

    public Optional<Output<Integer>> logStreamName() {
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorDatastreamArgs() {}

    private GetPropertyRulesBuilderRulesV20230105BehaviorDatastreamArgs(GetPropertyRulesBuilderRulesV20230105BehaviorDatastreamArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorDatastreamArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorDatastreamArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorDatastreamArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorDatastreamArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder logStreamName(@Nullable Output<Integer> logStreamName) {
            $.logStreamName = logStreamName;
            return this;
        }

        public Builder logStreamName(Integer logStreamName) {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorDatastreamArgs build() {
            return $;
        }
    }
