...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketingCloudletPolicy;
...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketing extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketing Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketing();
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketing(GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketing $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketing defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketing();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketing defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorFirstPartyMarketing(Objects.requireNonNull(defaults));
        }
