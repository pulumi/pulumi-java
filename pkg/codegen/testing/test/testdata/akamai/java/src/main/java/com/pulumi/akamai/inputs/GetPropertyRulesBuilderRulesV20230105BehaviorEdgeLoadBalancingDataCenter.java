...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230105BehaviorEdgeLoadBalancingDataCenterFailoverRule;
...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorEdgeLoadBalancingDataCenter extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230105BehaviorEdgeLoadBalancingDataCenter Empty = new GetPropertyRulesBuilderRulesV20230105BehaviorEdgeLoadBalancingDataCenter();
    ...
    public Optional<List<GetPropertyRulesBuilderRulesV20230105BehaviorEdgeLoadBalancingDataCenterFailoverRule>> failoverRules() {
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorEdgeLoadBalancingDataCenter(GetPropertyRulesBuilderRulesV20230105BehaviorEdgeLoadBalancingDataCenter $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorEdgeLoadBalancingDataCenter();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorEdgeLoadBalancingDataCenter defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorEdgeLoadBalancingDataCenter(Objects.requireNonNull(defaults));
        }
