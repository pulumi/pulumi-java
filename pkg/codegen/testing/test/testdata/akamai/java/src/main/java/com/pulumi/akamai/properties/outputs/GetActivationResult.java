...
public final class GetActivationResult {
    ...
    public static Builder builder(GetActivationResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder activationId(String activationId) {
            if (activationId == null) {
              throw new MissingRequiredPropertyException("GetActivationResult", "activationId");
            }
        ...
        public Builder contacts(List<String> contacts) {
            if (contacts == null) {
              throw new MissingRequiredPropertyException("GetActivationResult", "contacts");
            }
        ...
        public Builder errors(String errors) {
            if (errors == null) {
              throw new MissingRequiredPropertyException("GetActivationResult", "errors");
            }
            this.errors = errors;
            return this;
        }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetActivationResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder note(String note) {
            if (note == null) {
              throw new MissingRequiredPropertyException("GetActivationResult", "note");
            }
            this.note = note;
            return this;
        }
        ...
        public Builder propertyId(String propertyId) {
            if (propertyId == null) {
              throw new MissingRequiredPropertyException("GetActivationResult", "propertyId");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetActivationResult", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder warnings(String warnings) {
            if (warnings == null) {
              throw new MissingRequiredPropertyException("GetActivationResult", "warnings");
            }
            this.warnings = warnings;
            return this;
        }
        public GetActivationResult build() {
            final var _resultValue = new GetActivationResult();
