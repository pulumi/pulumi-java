...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorStrictHeaderParsing extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorStrictHeaderParsing Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorStrictHeaderParsing();
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorStrictHeaderParsing(GetPropertyRulesBuilderRulesV20230530BehaviorStrictHeaderParsing $) {
        this.locked = $.locked;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorStrictHeaderParsing();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorStrictHeaderParsing defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorStrictHeaderParsing(Objects.requireNonNull(defaults));
        }
