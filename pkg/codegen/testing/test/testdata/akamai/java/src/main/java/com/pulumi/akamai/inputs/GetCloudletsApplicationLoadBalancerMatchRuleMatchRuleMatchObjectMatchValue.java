...
import com.pulumi.akamai.inputs.GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValueOptions;
...
public final class GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValue extends com.pulumi.resources.InvokeArgs {
    ...
    private GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValue(GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValue $) {
        this.name = $.name;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValue();
        }

        public Builder(GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValue defaults) {
            $ = new GetCloudletsApplicationLoadBalancerMatchRuleMatchRuleMatchObjectMatchValue(Objects.requireNonNull(defaults));
        }
