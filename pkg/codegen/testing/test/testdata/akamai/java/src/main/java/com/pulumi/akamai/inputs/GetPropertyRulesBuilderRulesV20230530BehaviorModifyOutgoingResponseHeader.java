...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorModifyOutgoingResponseHeader extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorModifyOutgoingResponseHeader Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorModifyOutgoingResponseHeader();
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorModifyOutgoingResponseHeader() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorModifyOutgoingResponseHeader(GetPropertyRulesBuilderRulesV20230530BehaviorModifyOutgoingResponseHeader $) {
        this.action = $.action;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorModifyOutgoingResponseHeader defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorModifyOutgoingResponseHeader();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorModifyOutgoingResponseHeader defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorModifyOutgoingResponseHeader(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorModifyOutgoingResponseHeader build() {
            return $;
        }
    }
