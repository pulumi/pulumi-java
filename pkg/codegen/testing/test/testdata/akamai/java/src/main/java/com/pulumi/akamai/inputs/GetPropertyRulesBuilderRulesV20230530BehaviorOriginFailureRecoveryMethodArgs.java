...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorOriginFailureRecoveryMethodArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorOriginFailureRecoveryMethodArgs() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorOriginFailureRecoveryMethodArgs(GetPropertyRulesBuilderRulesV20230530BehaviorOriginFailureRecoveryMethodArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorOriginFailureRecoveryMethodArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorOriginFailureRecoveryMethodArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorOriginFailureRecoveryMethodArgs defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorOriginFailureRecoveryMethodArgs build() {
            return $;
        }
    }
