...
import com.pulumi.akamai.inputs.GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatchObjectMatchValueArgs;
...
public final class GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatchArgs() {}

    private GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatchArgs(GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatchArgs $) {
    ...
    public static Builder builder(GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatchArgs();
        }

        public Builder(GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatchArgs defaults) {
        ...
        public GetCloudletsEdgeRedirectorMatchRuleMatchRuleMatchArgs build() {
            return $;
        }
    }
