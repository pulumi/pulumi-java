...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorFailActionNetStorageHostname extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorFailActionNetStorageHostname Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorFailActionNetStorageHostname();
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorFailActionNetStorageHostname(GetPropertyRulesBuilderRulesV20230530BehaviorFailActionNetStorageHostname $) {
        this.cpCode = $.cpCode;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorFailActionNetStorageHostname();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorFailActionNetStorageHostname defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorFailActionNetStorageHostname(Objects.requireNonNull(defaults));
        }
