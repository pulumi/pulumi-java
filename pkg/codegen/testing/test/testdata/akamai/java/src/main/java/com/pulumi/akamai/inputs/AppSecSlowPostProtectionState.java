...
public final class AppSecSlowPostProtectionState extends com.pulumi.resources.ResourceArgs {

    public static final AppSecSlowPostProtectionState Empty = new AppSecSlowPostProtectionState();
    ...
    private AppSecSlowPostProtectionState() {}

    private AppSecSlowPostProtectionState(AppSecSlowPostProtectionState $) {
    ...
    public static Builder builder(AppSecSlowPostProtectionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppSecSlowPostProtectionState();
        }

        public Builder(AppSecSlowPostProtectionState defaults) {
            $ = new AppSecSlowPostProtectionState(Objects.requireNonNull(defaults));
        }
        ...
        public AppSecSlowPostProtectionState build() {
            return $;
        }
    }
