...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorDynamicWebContent extends com.pulumi.resources.InvokeArgs {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorDynamicWebContent(GetPropertyRulesBuilderRulesV20230530BehaviorDynamicWebContent $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorDynamicWebContent();
        }
