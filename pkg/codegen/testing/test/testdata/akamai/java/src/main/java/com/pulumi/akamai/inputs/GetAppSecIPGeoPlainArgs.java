...
public final class GetAppSecIPGeoPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetAppSecIPGeoPlainArgs build() {
            if ($.configId == null) {
                throw new MissingRequiredPropertyException("GetAppSecIPGeoPlainArgs", "configId");
            }
            if ($.securityPolicyId == null) {
                throw new MissingRequiredPropertyException("GetAppSecIPGeoPlainArgs", "securityPolicyId");
            }
            return $;
        }
    }
