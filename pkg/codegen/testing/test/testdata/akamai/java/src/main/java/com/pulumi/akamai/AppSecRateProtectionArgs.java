...
public final class AppSecRateProtectionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AppSecRateProtectionArgs build() {
            if ($.configId == null) {
                throw new MissingRequiredPropertyException("AppSecRateProtectionArgs", "configId");
            }
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("AppSecRateProtectionArgs", "enabled");
            }
            if ($.securityPolicyId == null) {
                throw new MissingRequiredPropertyException("AppSecRateProtectionArgs", "securityPolicyId");
            }
            return $;
        }
    }
