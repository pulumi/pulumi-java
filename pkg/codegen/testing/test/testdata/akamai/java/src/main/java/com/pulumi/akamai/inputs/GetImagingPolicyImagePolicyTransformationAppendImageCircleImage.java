...
public final class GetImagingPolicyImagePolicyTransformationAppendImageCircleImage extends com.pulumi.resources.InvokeArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageCircleImage Empty = new GetImagingPolicyImagePolicyTransformationAppendImageCircleImage();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageCircleImage(GetImagingPolicyImagePolicyTransformationAppendImageCircleImage $) {
        this.color = $.color;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageCircleImage();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageCircleImage defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageCircleImage(Objects.requireNonNull(defaults));
        }
