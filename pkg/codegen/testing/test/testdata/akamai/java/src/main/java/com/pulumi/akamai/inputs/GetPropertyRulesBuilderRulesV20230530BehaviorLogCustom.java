...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorLogCustom extends com.pulumi.resources.InvokeArgs {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorLogCustom() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorLogCustom(GetPropertyRulesBuilderRulesV20230530BehaviorLogCustom $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorLogCustom defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorLogCustom();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorLogCustom defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorLogCustom build() {
            return $;
        }
    }
