...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorSalesForceCommerceCloudClient extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230105BehaviorSalesForceCommerceCloudClient Empty = new GetPropertyRulesBuilderRulesV20230105BehaviorSalesForceCommerceCloudClient();
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorSalesForceCommerceCloudClient(GetPropertyRulesBuilderRulesV20230105BehaviorSalesForceCommerceCloudClient $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorSalesForceCommerceCloudClient();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorSalesForceCommerceCloudClient defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorSalesForceCommerceCloudClient(Objects.requireNonNull(defaults));
        }
