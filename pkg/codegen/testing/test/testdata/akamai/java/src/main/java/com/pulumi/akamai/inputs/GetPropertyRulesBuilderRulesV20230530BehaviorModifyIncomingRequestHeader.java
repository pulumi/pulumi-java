...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingRequestHeader extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingRequestHeader Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingRequestHeader();
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingRequestHeader() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingRequestHeader(GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingRequestHeader $) {
        this.action = $.action;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingRequestHeader defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingRequestHeader();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingRequestHeader defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingRequestHeader(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorModifyIncomingRequestHeader build() {
            return $;
        }
    }
