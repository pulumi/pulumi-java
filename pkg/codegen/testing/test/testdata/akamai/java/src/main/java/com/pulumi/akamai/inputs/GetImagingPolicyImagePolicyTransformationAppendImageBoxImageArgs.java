...
public final class GetImagingPolicyImagePolicyTransformationAppendImageBoxImageArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetImagingPolicyImagePolicyTransformationAppendImageBoxImageArgs Empty = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageArgs();
    ...
    private GetImagingPolicyImagePolicyTransformationAppendImageBoxImageArgs() {}

    private GetImagingPolicyImagePolicyTransformationAppendImageBoxImageArgs(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageArgs $) {
        this.color = $.color;
    ...
    public static Builder builder(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageArgs();
        }

        public Builder(GetImagingPolicyImagePolicyTransformationAppendImageBoxImageArgs defaults) {
            $ = new GetImagingPolicyImagePolicyTransformationAppendImageBoxImageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetImagingPolicyImagePolicyTransformationAppendImageBoxImageArgs build() {
            return $;
        }
    }
