...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerCpCodeOriginalArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerCpCodeTransformedArgs;
...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerArgs Empty = new GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerArgs();
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerCpCodeOriginalArgs> cpCodeOriginal;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerCpCodeOriginalArgs>> cpCodeOriginal() {
        return Optional.ofNullable(this.cpCodeOriginal);
    }

    @Import(name="cpCodeTransformed")
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerCpCodeTransformedArgs> cpCodeTransformed;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerCpCodeTransformedArgs>> cpCodeTransformed() {
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerArgs() {}

    private GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerArgs(GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder cpCodeOriginal(@Nullable Output<GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerCpCodeOriginalArgs> cpCodeOriginal) {
            $.cpCodeOriginal = cpCodeOriginal;
            return this;
        }

        public Builder cpCodeOriginal(GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerCpCodeOriginalArgs cpCodeOriginal) {
            return cpCodeOriginal(Output.of(cpCodeOriginal));
        }

        public Builder cpCodeTransformed(@Nullable Output<GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerCpCodeTransformedArgs> cpCodeTransformed) {
            $.cpCodeTransformed = cpCodeTransformed;
            return this;
        }

        public Builder cpCodeTransformed(GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerCpCodeTransformedArgs cpCodeTransformed) {
        ...
        public GetPropertyRulesBuilderRulesV20230105BehaviorImageManagerArgs build() {
            return $;
        }
    }
