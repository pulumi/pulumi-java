...
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorFailActionCpCodeArgs;
import com.pulumi.akamai.inputs.GetPropertyRulesBuilderRulesV20230530BehaviorFailActionNetStorageHostnameArgs;
...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorFailActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorFailActionArgs Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorFailActionArgs();
    ...
    @Import(name="cpCode")
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorFailActionCpCodeArgs> cpCode;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230530BehaviorFailActionCpCodeArgs>> cpCode() {
    ...
    private @Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorFailActionNetStorageHostnameArgs> netStorageHostname;

    public Optional<Output<GetPropertyRulesBuilderRulesV20230530BehaviorFailActionNetStorageHostnameArgs>> netStorageHostname() {
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorFailActionArgs() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorFailActionArgs(GetPropertyRulesBuilderRulesV20230530BehaviorFailActionArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorFailActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorFailActionArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorFailActionArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorFailActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder cpCode(@Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorFailActionCpCodeArgs> cpCode) {
            $.cpCode = cpCode;
            return this;
        }

        public Builder cpCode(GetPropertyRulesBuilderRulesV20230530BehaviorFailActionCpCodeArgs cpCode) {
        ...
        public Builder netStorageHostname(@Nullable Output<GetPropertyRulesBuilderRulesV20230530BehaviorFailActionNetStorageHostnameArgs> netStorageHostname) {
            $.netStorageHostname = netStorageHostname;
            return this;
        }

        public Builder netStorageHostname(GetPropertyRulesBuilderRulesV20230530BehaviorFailActionNetStorageHostnameArgs netStorageHostname) {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorFailActionArgs build() {
            return $;
        }
    }
