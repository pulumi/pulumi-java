...
import com.pulumi.akamai.inputs.AppSecAttackGroupState;
...
@ResourceType(type="akamai:index/appSecAttackGroup:AppSecAttackGroup")
public class AppSecAttackGroup extends com.pulumi.resources.CustomResource {
    /**
    ...
    public AppSecAttackGroup(java.lang.String name, AppSecAttackGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("akamai:index/appSecAttackGroup:AppSecAttackGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AppSecAttackGroup(java.lang.String name, Output<java.lang.String> id, @Nullable AppSecAttackGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("akamai:index/appSecAttackGroup:AppSecAttackGroup", name, state, makeResourceOptions(options, id), false);
    }

    private static AppSecAttackGroupArgs makeArgs(AppSecAttackGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
