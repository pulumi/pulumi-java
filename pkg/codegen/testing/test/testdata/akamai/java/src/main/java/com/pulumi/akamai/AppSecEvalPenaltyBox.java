...
public class AppSecEvalPenaltyBox extends com.pulumi.resources.CustomResource {
     ...
     */
    public AppSecEvalPenaltyBox(java.lang.String name) {
     ...
     */
    public static AppSecEvalPenaltyBox get(java.lang.String name, Output<java.lang.String> id, @Nullable AppSecEvalPenaltyBoxState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
