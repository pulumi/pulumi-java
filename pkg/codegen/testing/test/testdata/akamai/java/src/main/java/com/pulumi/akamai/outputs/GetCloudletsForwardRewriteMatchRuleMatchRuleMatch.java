...
import com.pulumi.akamai.outputs.GetCloudletsForwardRewriteMatchRuleMatchRuleMatchObjectMatchValue;
...
@CustomType
public final class GetCloudletsForwardRewriteMatchRuleMatchRuleMatch {
    ...
    public List<GetCloudletsForwardRewriteMatchRuleMatchRuleMatchObjectMatchValue> objectMatchValues() {
    ...
    public static final class Builder {
        ...
        public GetCloudletsForwardRewriteMatchRuleMatchRuleMatch build() {
            final var _resultValue = new GetCloudletsForwardRewriteMatchRuleMatchRuleMatch();
