...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorConstructResponse extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230105BehaviorConstructResponse Empty = new GetPropertyRulesBuilderRulesV20230105BehaviorConstructResponse();
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorConstructResponse(GetPropertyRulesBuilderRulesV20230105BehaviorConstructResponse $) {
        this.body = $.body;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorConstructResponse();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorConstructResponse defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorConstructResponse(Objects.requireNonNull(defaults));
        }
