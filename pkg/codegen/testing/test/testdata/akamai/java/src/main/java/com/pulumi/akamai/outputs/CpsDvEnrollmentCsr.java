...
public final class CpsDvEnrollmentCsr {
    ...
    public static final class Builder {
        ...
        public Builder city(String city) {
            if (city == null) {
              throw new MissingRequiredPropertyException("CpsDvEnrollmentCsr", "city");
            }
            this.city = city;
            return this;
        }
        ...
        public Builder countryCode(String countryCode) {
            if (countryCode == null) {
              throw new MissingRequiredPropertyException("CpsDvEnrollmentCsr", "countryCode");
            }
        ...
        public Builder organization(String organization) {
            if (organization == null) {
              throw new MissingRequiredPropertyException("CpsDvEnrollmentCsr", "organization");
            }
        ...
        public Builder organizationalUnit(String organizationalUnit) {
            if (organizationalUnit == null) {
              throw new MissingRequiredPropertyException("CpsDvEnrollmentCsr", "organizationalUnit");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("CpsDvEnrollmentCsr", "state");
            }
            this.state = state;
            return this;
        }
