...
public final class GetPropertyRulesBuilderRulesV20230105CriterionUserAgentArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230105CriterionUserAgentArgs Empty = new GetPropertyRulesBuilderRulesV20230105CriterionUserAgentArgs();
    ...
    private GetPropertyRulesBuilderRulesV20230105CriterionUserAgentArgs() {}

    private GetPropertyRulesBuilderRulesV20230105CriterionUserAgentArgs(GetPropertyRulesBuilderRulesV20230105CriterionUserAgentArgs $) {
        this.locked = $.locked;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230105CriterionUserAgentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105CriterionUserAgentArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105CriterionUserAgentArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105CriterionUserAgentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20230105CriterionUserAgentArgs build() {
            return $;
        }
    }
