...
@CustomType
public final class GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationWaitingRoomNetStorage {
    private @Nullable Integer cpCode;
    private @Nullable String downloadDomainName;
    private @Nullable String g2oToken;

    private GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationWaitingRoomNetStorage() {}
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationWaitingRoomNetStorage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String g2oToken;
        public Builder() {}
        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationWaitingRoomNetStorage defaults) {
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationWaitingRoomNetStorage build() {
            final var _resultValue = new GetPropertyRulesBuilderRulesV20230530BehaviorVisitorPrioritizationWaitingRoomNetStorage();
