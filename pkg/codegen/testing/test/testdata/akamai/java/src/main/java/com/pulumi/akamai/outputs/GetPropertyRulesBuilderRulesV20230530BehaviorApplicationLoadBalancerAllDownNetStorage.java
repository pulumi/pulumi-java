...
@CustomType
public final class GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerAllDownNetStorage {
    private @Nullable Integer cpCode;
    private @Nullable String downloadDomainName;
    private @Nullable String g2oToken;

    private GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerAllDownNetStorage() {}
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerAllDownNetStorage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String g2oToken;
        public Builder() {}
        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorApplicationLoadBalancerAllDownNetStorage defaults) {
