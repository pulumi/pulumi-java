...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorAdaptiveImageCompressionArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorAdaptiveImageCompressionArgs Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorAdaptiveImageCompressionArgs();
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorAdaptiveImageCompressionArgs() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorAdaptiveImageCompressionArgs(GetPropertyRulesBuilderRulesV20230530BehaviorAdaptiveImageCompressionArgs $) {
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorAdaptiveImageCompressionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorAdaptiveImageCompressionArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorAdaptiveImageCompressionArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorAdaptiveImageCompressionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorAdaptiveImageCompressionArgs build() {
            return $;
        }
    }
