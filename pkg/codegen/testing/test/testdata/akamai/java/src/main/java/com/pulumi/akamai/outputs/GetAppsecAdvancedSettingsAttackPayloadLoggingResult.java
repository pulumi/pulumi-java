...
public final class GetAppsecAdvancedSettingsAttackPayloadLoggingResult {
    ...
    public static final class Builder {
        ...
        public Builder configId(Integer configId) {
            if (configId == null) {
              throw new MissingRequiredPropertyException("GetAppsecAdvancedSettingsAttackPayloadLoggingResult", "configId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetAppsecAdvancedSettingsAttackPayloadLoggingResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder json(String json) {
            if (json == null) {
              throw new MissingRequiredPropertyException("GetAppsecAdvancedSettingsAttackPayloadLoggingResult", "json");
            }
            this.json = json;
            return this;
        }
