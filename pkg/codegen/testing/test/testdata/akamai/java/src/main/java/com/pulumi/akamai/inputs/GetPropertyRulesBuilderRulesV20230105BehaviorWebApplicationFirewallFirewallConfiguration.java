...
public final class GetPropertyRulesBuilderRulesV20230105BehaviorWebApplicationFirewallFirewallConfiguration extends com.pulumi.resources.InvokeArgs {

    public static final GetPropertyRulesBuilderRulesV20230105BehaviorWebApplicationFirewallFirewallConfiguration Empty = new GetPropertyRulesBuilderRulesV20230105BehaviorWebApplicationFirewallFirewallConfiguration();
    ...
    private GetPropertyRulesBuilderRulesV20230105BehaviorWebApplicationFirewallFirewallConfiguration(GetPropertyRulesBuilderRulesV20230105BehaviorWebApplicationFirewallFirewallConfiguration $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorWebApplicationFirewallFirewallConfiguration();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230105BehaviorWebApplicationFirewallFirewallConfiguration defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230105BehaviorWebApplicationFirewallFirewallConfiguration(Objects.requireNonNull(defaults));
        }
