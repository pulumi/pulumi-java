...
public final class GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs Empty = new GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs();
    ...
    private GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs() {}

    private GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs(GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs $) {
        this.cpCode = $.cpCode;
    ...
    public static Builder builder(GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs();
        }

        public Builder(GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs defaults) {
            $ = new GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPropertyRulesBuilderRulesV20230530BehaviorOriginNetStorageArgs build() {
            return $;
        }
    }
