...
import com.pulumi.hipackage.ProviderArgs;
import com.pulumi.hipackage.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:hipackage")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("hipackage", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false, Utilities.getPackageRef());
    }
