...
import com.pulumi.anytypefunction.ProviderArgs;
...
@ResourceType(type="pulumi:providers:any-type-function")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("any-type-function", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
