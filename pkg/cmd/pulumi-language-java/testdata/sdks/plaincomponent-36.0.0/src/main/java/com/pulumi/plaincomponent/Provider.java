...
import com.pulumi.plaincomponent.ProviderArgs;
import com.pulumi.plaincomponent.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:plaincomponent")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("plaincomponent", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
