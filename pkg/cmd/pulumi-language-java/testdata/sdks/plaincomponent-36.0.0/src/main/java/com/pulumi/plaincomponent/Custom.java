...
import com.pulumi.plaincomponent.CustomArgs;
import com.pulumi.plaincomponent.Utilities;
import java.lang.String;
import javax.annotation.Nullable;

@ResourceType(type="plaincomponent:index:Custom")
public class Custom extends com.pulumi.resources.CustomResource {
    ...
    public Custom(java.lang.String name, CustomArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("plaincomponent:index:Custom", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Custom(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("plaincomponent:index:Custom", name, null, makeResourceOptions(options, id), false);
    }
