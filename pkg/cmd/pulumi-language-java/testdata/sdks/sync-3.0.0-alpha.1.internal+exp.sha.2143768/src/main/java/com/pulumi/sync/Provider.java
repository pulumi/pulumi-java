...
import com.pulumi.sync.ProviderArgs;
import com.pulumi.sync.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:sync")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sync", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
