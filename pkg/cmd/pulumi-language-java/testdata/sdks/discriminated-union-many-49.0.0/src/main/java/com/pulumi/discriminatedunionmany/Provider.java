...
import com.pulumi.discriminatedunionmany.ProviderArgs;
import com.pulumi.discriminatedunionmany.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:discriminated-union-many")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("discriminated-union-many", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
