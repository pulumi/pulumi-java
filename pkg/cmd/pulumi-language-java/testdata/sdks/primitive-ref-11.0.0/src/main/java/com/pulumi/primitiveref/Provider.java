...
import com.pulumi.primitiveref.ProviderArgs;
import com.pulumi.primitiveref.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:primitive-ref")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("primitive-ref", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
