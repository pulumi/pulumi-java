...
import com.pulumi.componentpropertydeps.ProviderArgs;
...
@ResourceType(type="pulumi:providers:component-property-deps")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("component-property-deps", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
