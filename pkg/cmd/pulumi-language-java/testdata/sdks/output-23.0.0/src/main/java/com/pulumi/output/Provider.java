...
import com.pulumi.output.ProviderArgs;
import com.pulumi.output.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:output")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("output", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
