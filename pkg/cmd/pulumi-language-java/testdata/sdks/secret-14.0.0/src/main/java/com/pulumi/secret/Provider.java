...
import com.pulumi.secret.ProviderArgs;
import com.pulumi.secret.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:secret")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("secret", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
