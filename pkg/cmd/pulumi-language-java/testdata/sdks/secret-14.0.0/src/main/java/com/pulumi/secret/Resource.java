...
import com.pulumi.secret.Utilities;
import com.pulumi.secret.outputs.Data;
import java.lang.String;
import java.util.List;
import javax.annotation.Nullable;

@ResourceType(type="secret:index:Resource")
public class Resource extends com.pulumi.resources.CustomResource {
    @Export(name="private", refs={String.class}, tree="[0]")
    private Output<String> private_;

    public Output<String> private_() {
        return this.private_;
    }
    @Export(name="privateData", refs={Data.class}, tree="[0]")
    private Output<Data> privateData;

    public Output<Data> privateData() {
    ...
    @Export(name="publicData", refs={Data.class}, tree="[0]")
    private Output<Data> publicData;

    public Output<Data> publicData() {
    ...
    public Resource(java.lang.String name, ResourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("secret:index:Resource", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Resource(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("secret:index:Resource", name, null, makeResourceOptions(options, id), false);
    }
