...
import com.pulumi.union.ProviderArgs;
import com.pulumi.union.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:union")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("union", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
