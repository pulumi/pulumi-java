...
import com.pulumi.refref.ProviderArgs;
import com.pulumi.refref.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:ref-ref")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("ref-ref", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
