...
package com.pulumi.refref.outputs;
...
public final class InnerData {
    ...
    public static Builder builder(InnerData defaults) {
    ...
    public static final class Builder {
        ...
        private Map<String,String> stringMap;
        public Builder() {}
        public Builder(InnerData defaults) {
        ...
        public Builder boolArray(List<Boolean> boolArray) {
            if (boolArray == null) {
              throw new MissingRequiredPropertyException("InnerData", "boolArray");
            }
        ...
        public Builder boolean_(Boolean boolean_) {
            if (boolean_ == null) {
              throw new MissingRequiredPropertyException("InnerData", "boolean_");
            }
        ...
        public Builder float_(Double float_) {
            if (float_ == null) {
              throw new MissingRequiredPropertyException("InnerData", "float_");
            }
            this.float_ = float_;
            return this;
        }
        ...
        public Builder integer(Integer integer) {
            if (integer == null) {
              throw new MissingRequiredPropertyException("InnerData", "integer");
            }
        ...
        public Builder string(String string) {
            if (string == null) {
              throw new MissingRequiredPropertyException("InnerData", "string");
            }
            this.string = string;
            return this;
        }
        ...
        public Builder stringMap(Map<String,String> stringMap) {
            if (stringMap == null) {
              throw new MissingRequiredPropertyException("InnerData", "stringMap");
            }
            this.stringMap = stringMap;
            return this;
        }
        public InnerData build() {
            final var _resultValue = new InnerData();
