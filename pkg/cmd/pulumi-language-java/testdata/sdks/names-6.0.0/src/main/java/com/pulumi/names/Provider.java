...
import com.pulumi.names.ProviderArgs;
import com.pulumi.names.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:names")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("names", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
