...
import com.pulumi.kebabnames.Utilities;
import com.pulumi.kebabnames.kebabmodule.SomeResourceArgs;
import com.pulumi.kebabnames.kebabmodule.outputs.OutputItem;
import javax.annotation.Nullable;

@ResourceType(type="kebab-names:kebab-module:someResource")
public class SomeResource extends com.pulumi.resources.CustomResource {
    @Export(name="theOutput", refs={OutputItem.class}, tree="[0]")
    private Output<OutputItem> theOutput;

    public Output<OutputItem> theOutput() {
    ...
    public SomeResource(java.lang.String name, SomeResourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kebab-names:kebab-module:someResource", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private SomeResource(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kebab-names:kebab-module:someResource", name, null, makeResourceOptions(options, id), false);
    }
