...
package com.pulumi.kebabnames;

import com.pulumi.core.Output;
import com.pulumi.core.annotations.ResourceType;
import com.pulumi.core.internal.Codegen;
import com.pulumi.kebabnames.ProviderArgs;
import com.pulumi.kebabnames.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:kebab-names")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kebab-names", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
