...
import com.anamespace.namespaced.Utilities;
...
@ResourceType(type="namespaced:index:Resource")
public class Resource extends com.pulumi.resources.CustomResource {
    @Export(name="resourceRef", refs={Custom.class}, tree="[0]")
    private Output</* @Nullable */ Custom> resourceRef;

    public Output<Optional<Custom>> resourceRef() {
        return Codegen.optional(this.resourceRef);
    }
    ...
    public Resource(java.lang.String name, ResourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("namespaced:index:Resource", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Resource(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("namespaced:index:Resource", name, null, makeResourceOptions(options, id), false);
    }
