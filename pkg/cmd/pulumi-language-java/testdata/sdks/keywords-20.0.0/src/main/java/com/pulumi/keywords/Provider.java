...
import com.pulumi.keywords.ProviderArgs;
import com.pulumi.keywords.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:keywords")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("keywords", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
