...
import com.pulumi.replaceonchanges.ProviderArgs;
import com.pulumi.replaceonchanges.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:replaceonchanges")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("replaceonchanges", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
