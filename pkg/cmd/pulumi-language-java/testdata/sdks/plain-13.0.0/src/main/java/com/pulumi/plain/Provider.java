...
import com.pulumi.plain.ProviderArgs;
import com.pulumi.plain.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:plain")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("plain", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
