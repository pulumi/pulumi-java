...
import com.pulumi.nestedobject.ProviderArgs;
import com.pulumi.nestedobject.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:nestedobject")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nestedobject", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
