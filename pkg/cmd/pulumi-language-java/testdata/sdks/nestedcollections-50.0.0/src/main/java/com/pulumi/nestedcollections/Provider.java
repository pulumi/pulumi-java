...
import com.pulumi.nestedcollections.ProviderArgs;
import com.pulumi.nestedcollections.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:nestedcollections")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nestedcollections", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
