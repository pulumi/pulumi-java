...
import com.pulumi.discriminatedunion.ProviderArgs;
import com.pulumi.discriminatedunion.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:discriminated-union")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("discriminated-union", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
