...
import com.pulumi.simpleinvokewithscalarreturn.ProviderArgs;
import com.pulumi.simpleinvokewithscalarreturn.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:simple-invoke-with-scalar-return")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("simple-invoke-with-scalar-return", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
