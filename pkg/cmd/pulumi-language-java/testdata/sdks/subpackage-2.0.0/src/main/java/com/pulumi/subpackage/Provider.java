...
import com.pulumi.subpackage.ProviderArgs;
import com.pulumi.subpackage.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:subpackage")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("subpackage", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false, Utilities.getPackageRef());
    }
