...
import com.pulumi.simpleinvoke.ProviderArgs;
import com.pulumi.simpleinvoke.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:simple-invoke")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("simple-invoke", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
