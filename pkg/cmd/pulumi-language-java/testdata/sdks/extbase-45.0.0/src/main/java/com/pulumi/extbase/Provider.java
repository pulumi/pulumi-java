...
import com.pulumi.extbase.ProviderArgs;
import com.pulumi.extbase.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:extbase")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("extbase", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
