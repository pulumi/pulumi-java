...
import com.pulumi.multiargumentinvoke.ProviderArgs;
import com.pulumi.multiargumentinvoke.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:multi-argument-invoke")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("multi-argument-invoke", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
