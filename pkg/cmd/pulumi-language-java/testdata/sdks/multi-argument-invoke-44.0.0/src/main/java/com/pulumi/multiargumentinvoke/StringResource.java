...
import com.pulumi.multiargumentinvoke.StringResourceArgs;
import com.pulumi.multiargumentinvoke.Utilities;
import java.lang.String;
import javax.annotation.Nullable;

@ResourceType(type="multi-argument-invoke:index:StringResource")
public class StringResource extends com.pulumi.resources.CustomResource {
    ...
    public StringResource(java.lang.String name, StringResourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("multi-argument-invoke:index:StringResource", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private StringResource(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("multi-argument-invoke:index:StringResource", name, null, makeResourceOptions(options, id), false);
    }
