module github.com/pulumi/pulumi-java/tests/generative

go 1.17

replace github.com/pulumi/pulumi-java/pkg => ../../pkg

require (
	github.com/pulumi/pulumi-java/pkg v0.0.0-00010101000000-000000000000
