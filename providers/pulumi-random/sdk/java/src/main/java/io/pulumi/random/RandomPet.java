...
public class RandomPet extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable RandomPetArgs.Builder a);
    }
    private static io.pulumi.random.RandomPetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.random.RandomPetArgs.builder();
     ...
     */
    public RandomPet(String name, BuilderApplicator argsBuilder) {
