...
public class RandomString extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RandomStringArgs.Builder a);
    }
    private static io.pulumi.random.RandomStringArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.random.RandomStringArgs.builder();
     ...
     */
    public RandomString(String name, BuilderApplicator argsBuilder) {
    ...
    public RandomString(String name, RandomStringArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("random:index/randomString:RandomString", name, args == null ? RandomStringArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
