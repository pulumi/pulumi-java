...
import io.pulumi.kubernetes.rbac.authorization.k8s.io_v1beta1.ClusterRoleListArgs;
import io.pulumi.kubernetes.rbac.authorization.k8s.io_v1beta1.outputs.ClusterRole;
 ...
 * 
 */
@ResourceType(type="kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRoleList")
public class ClusterRoleList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.rbac.authorization.k8s.io_v1beta1.ClusterRoleListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.rbac.authorization.k8s.io_v1beta1.ClusterRoleListArgs.builder();
