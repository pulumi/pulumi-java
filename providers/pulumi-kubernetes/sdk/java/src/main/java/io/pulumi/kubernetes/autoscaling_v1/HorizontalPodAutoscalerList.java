...
public class HorizontalPodAutoscalerList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.autoscaling_v1.HorizontalPodAutoscalerListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.autoscaling_v1.HorizontalPodAutoscalerListArgs.builder();
    ...
    public HorizontalPodAutoscalerList(String name, HorizontalPodAutoscalerListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:autoscaling/v1:HorizontalPodAutoscalerList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
