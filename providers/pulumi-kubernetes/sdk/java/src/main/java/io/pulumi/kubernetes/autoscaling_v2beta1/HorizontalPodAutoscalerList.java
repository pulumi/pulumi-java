...
public class HorizontalPodAutoscalerList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.autoscaling_v2beta1.HorizontalPodAutoscalerListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.autoscaling_v2beta1.HorizontalPodAutoscalerListArgs.builder();
