...
public class IngressClassList extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="items", type=List.class, parameters={IngressClass.class})
    ...
    public interface BuilderApplicator {
        public void apply(IngressClassListArgs.Builder a);
    }
    private static io.pulumi.kubernetes.networking.k8s.io_v1.IngressClassListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.networking.k8s.io_v1.IngressClassListArgs.builder();
     ...
     */
    public IngressClassList(String name, BuilderApplicator argsBuilder) {
