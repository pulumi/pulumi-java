...
import io.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1beta2.outputs.FlowSchemaStatus;
...
public class FlowSchema extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1beta2.FlowSchemaArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1beta2.FlowSchemaArgs.builder();
    ...
    public FlowSchema(String name, @Nullable FlowSchemaArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:FlowSchema", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
