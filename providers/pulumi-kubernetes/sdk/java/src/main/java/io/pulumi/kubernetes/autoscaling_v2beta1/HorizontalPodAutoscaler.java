...
public class HorizontalPodAutoscaler extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.autoscaling_v2beta1.HorizontalPodAutoscalerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.autoscaling_v2beta1.HorizontalPodAutoscalerArgs.builder();
