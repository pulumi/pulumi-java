...
public final class APIServiceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public APIServiceArgs(
        ...
        @Nullable Input<APIServiceSpecArgs> spec,
        @Nullable Input<APIServiceStatusArgs> status) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<APIServiceSpecArgs> spec;
        private @Nullable Input<APIServiceStatusArgs> status;
        ...
        public Builder setSpec(@Nullable Input<APIServiceSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable APIServiceSpecArgs spec) {
            this.spec = Input.ofNullable(spec);
            return this;
        }

        public Builder setStatus(@Nullable Input<APIServiceStatusArgs> status) {
            this.status = status;
            return this;
        }

        public Builder setStatus(@Nullable APIServiceStatusArgs status) {
