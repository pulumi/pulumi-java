...
import io.pulumi.kubernetes.batch_v1.CronJobListArgs;
import io.pulumi.kubernetes.batch_v1.outputs.CronJob;
...
public class CronJobList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.batch_v1.CronJobListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.batch_v1.CronJobListArgs.builder();
    ...
    public CronJobList(String name, CronJobListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:batch/v1:CronJobList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
