...
import io.pulumi.kubernetes.rbac.authorization.k8s.io_v1beta1.inputs.ClusterRoleArgs;
...
public final class ClusterRoleListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="items", required=true)
      private final Output<List<ClusterRoleArgs>> items;

    public Output<List<ClusterRoleArgs>> getItems() {
        return this.items;
    }
    ...
    public ClusterRoleListArgs(
        ...
        Output<List<ClusterRoleArgs>> items,
