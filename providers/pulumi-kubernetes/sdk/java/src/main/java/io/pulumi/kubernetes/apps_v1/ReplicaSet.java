...
public class ReplicaSet extends io.pulumi.resources.CustomResource {
    ...
    public ReplicaSet(String name, @Nullable ReplicaSetArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1:ReplicaSet", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                ...
                Output.of(Alias.builder().setType("kubernetes:extensions/v1beta1:ReplicaSet").build())
            ))
            .build();
