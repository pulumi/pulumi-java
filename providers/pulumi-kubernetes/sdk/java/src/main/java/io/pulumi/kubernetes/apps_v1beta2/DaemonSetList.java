...
import io.pulumi.kubernetes.apps_v1beta2.DaemonSetListArgs;
import io.pulumi.kubernetes.apps_v1beta2.outputs.DaemonSet;
...
public class DaemonSetList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.apps_v1beta2.DaemonSetListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.apps_v1beta2.DaemonSetListArgs.builder();
    ...
    public DaemonSetList(String name, DaemonSetListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta2:DaemonSetList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
