...
public class Role extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.rbac.authorization.k8s.io_v1.RoleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.rbac.authorization.k8s.io_v1.RoleArgs.builder();
    ...
    public Role(String name, @Nullable RoleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1:Role", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
