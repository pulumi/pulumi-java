...
public class PriorityLevelConfigurationList extends io.pulumi.resources.CustomResource {
    ...
    public PriorityLevelConfigurationList(String name) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:PriorityLevelConfigurationList", name, PriorityLevelConfigurationListArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
