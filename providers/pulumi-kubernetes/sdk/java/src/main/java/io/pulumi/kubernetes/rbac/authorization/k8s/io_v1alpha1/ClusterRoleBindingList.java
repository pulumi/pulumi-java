...
public class ClusterRoleBindingList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.ClusterRoleBindingListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.ClusterRoleBindingListArgs.builder();
    ...
    public ClusterRoleBindingList(String name, ClusterRoleBindingListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBindingList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
