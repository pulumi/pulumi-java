...
public class ClusterRoleBinding extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.ClusterRoleBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.ClusterRoleBindingArgs.builder();
