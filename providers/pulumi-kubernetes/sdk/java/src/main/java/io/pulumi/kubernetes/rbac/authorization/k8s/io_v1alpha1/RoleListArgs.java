...
import io.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.inputs.RoleArgs;
...
public final class RoleListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="items", required=true)
        private final Input<List<RoleArgs>> items;

    public Input<List<RoleArgs>> getItems() {
        return this.items;
    }
    ...
    public static final class Builder {
        ...
        private Input<List<RoleArgs>> items;
        ...
        public Builder setItems(Input<List<RoleArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<RoleArgs> items) {
