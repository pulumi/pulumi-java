...
public class AuditSinkList extends io.pulumi.resources.CustomResource {
    ...
    public AuditSinkList(String name, AuditSinkListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:auditregistration.k8s.io/v1alpha1:AuditSinkList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private AuditSinkList(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static AuditSinkList get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
