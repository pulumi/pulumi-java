...
public class FlowSchemaList extends io.pulumi.resources.CustomResource {
    ...
    public FlowSchemaList(String name) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:FlowSchemaList", name, FlowSchemaListArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public FlowSchemaList(String name, FlowSchemaListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:FlowSchemaList", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
