...
public class Event extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.events.k8s.io_v1.EventArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.events.k8s.io_v1.EventArgs.builder();
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:core/v1:Event").build()),
                Output.of(Alias.builder().setType("kubernetes:events.k8s.io/v1beta1:Event").build())
            ))
            .build();
