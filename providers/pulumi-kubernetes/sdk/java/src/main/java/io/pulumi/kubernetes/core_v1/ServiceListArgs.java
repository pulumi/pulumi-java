...
import io.pulumi.kubernetes.core_v1.inputs.ServiceArgs;
 ...
 * 
 */
public final class ServiceListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<ServiceArgs>> items;

    public Input<List<ServiceArgs>> getItems() {
        return this.items;
    }
    ...
    public ServiceListArgs(
        @Nullable Input<String> apiVersion,
        Input<List<ServiceArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<ServiceArgs>> items;
        ...
        public Builder setItems(Input<List<ServiceArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<ServiceArgs> items) {
        ...
        public ServiceListArgs build() {
            return new ServiceListArgs(apiVersion, items, kind, metadata);
        }
    }
}
