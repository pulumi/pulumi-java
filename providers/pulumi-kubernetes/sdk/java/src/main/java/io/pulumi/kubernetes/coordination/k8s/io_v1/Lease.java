...
public class Lease extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.coordination.k8s.io_v1.LeaseArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.coordination.k8s.io_v1.LeaseArgs.builder();
    ...
    public Lease(String name, @Nullable LeaseArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:coordination.k8s.io/v1:Lease", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:coordination.k8s.io/v1beta1:Lease").build())
            ))
            .build();
