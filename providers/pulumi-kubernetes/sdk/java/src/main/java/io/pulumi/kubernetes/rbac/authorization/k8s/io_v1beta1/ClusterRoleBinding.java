...
import io.pulumi.kubernetes.rbac.authorization.k8s.io_v1beta1.ClusterRoleBindingArgs;
...
public class ClusterRoleBinding extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.rbac.authorization.k8s.io_v1beta1.ClusterRoleBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.rbac.authorization.k8s.io_v1beta1.ClusterRoleBindingArgs.builder();
    ...
    public ClusterRoleBinding(String name, ClusterRoleBindingArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRoleBinding", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
