...
import io.pulumi.kubernetes.apps_v1.DaemonSetArgs;
...
public class DaemonSet extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.apps_v1.DaemonSetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.apps_v1.DaemonSetArgs.builder();
    ...
    public DaemonSet(String name, @Nullable DaemonSetArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1:DaemonSet", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
