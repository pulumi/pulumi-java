...
public class HorizontalPodAutoscaler extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.autoscaling_v2.HorizontalPodAutoscalerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.autoscaling_v2.HorizontalPodAutoscalerArgs.builder();
    ...
    public HorizontalPodAutoscaler(String name, @Nullable HorizontalPodAutoscalerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:autoscaling/v2:HorizontalPodAutoscaler", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
