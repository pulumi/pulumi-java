...
import io.pulumi.kubernetes.extensions_v1beta1.DeploymentArgs;
import io.pulumi.kubernetes.extensions_v1beta1.outputs.DeploymentSpec;
import io.pulumi.kubernetes.extensions_v1beta1.outputs.DeploymentStatus;
...
public class Deployment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.extensions_v1beta1.DeploymentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.extensions_v1beta1.DeploymentArgs.builder();
    ...
    public Deployment(String name, @Nullable DeploymentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:Deployment", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private Deployment(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:Deployment", name, null, makeResourceOptions(options, id));
    }
