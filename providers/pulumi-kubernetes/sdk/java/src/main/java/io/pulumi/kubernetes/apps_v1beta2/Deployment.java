...
public class Deployment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.apps_v1beta2.DeploymentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.apps_v1beta2.DeploymentArgs.builder();
    ...
    public Deployment(String name, @Nullable DeploymentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta2:Deployment", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
