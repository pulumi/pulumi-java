...
public class CronJob extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.batch_v1beta1.CronJobArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.batch_v1beta1.CronJobArgs.builder();
    ...
    public CronJob(String name, @Nullable CronJobArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:batch/v1beta1:CronJob", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
