...
public class DaemonSet extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="spec", type=DaemonSetSpec.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="status", type=DaemonSetStatus.class, parameters={})
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable DaemonSetArgs.Builder a);
    }
    private static io.pulumi.kubernetes.extensions_v1beta1.DaemonSetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.extensions_v1beta1.DaemonSetArgs.builder();
     ...
     */
    public DaemonSet(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:apps/v1:DaemonSet").build()),
                Output.of(Alias.builder().setType("kubernetes:apps/v1beta2:DaemonSet").build())
            ))
            .build();
