...
public class CustomResourceDefinitionList extends io.pulumi.resources.CustomResource {
    ...
    public CustomResourceDefinitionList(String name) {
        super("kubernetes:apiextensions.k8s.io/v1beta1:CustomResourceDefinitionList", name, CustomResourceDefinitionListArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
