...
public class PriorityLevelConfiguration extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="spec", type=PriorityLevelConfigurationSpec.class, parameters={})
     ...
     * 
     */
    @Export(name="status", type=PriorityLevelConfigurationStatus.class, parameters={})
    ...
    private static io.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1alpha1.PriorityLevelConfigurationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1alpha1.PriorityLevelConfigurationArgs.builder();
    ...
    public PriorityLevelConfiguration(String name, @Nullable PriorityLevelConfigurationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:PriorityLevelConfiguration", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private PriorityLevelConfiguration(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:flowcontrol.apiserver.k8s.io/v1beta1:PriorityLevelConfiguration").build()),
                Output.of(Alias.builder().setType("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:PriorityLevelConfiguration").build())
            ))
            .build();
     ...
     */
    public static PriorityLevelConfiguration get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
