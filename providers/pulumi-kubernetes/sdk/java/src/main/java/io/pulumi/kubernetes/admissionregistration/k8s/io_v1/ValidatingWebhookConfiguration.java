...
public class ValidatingWebhookConfiguration extends io.pulumi.resources.CustomResource {
    ...
    public ValidatingWebhookConfiguration(String name) {
        super("kubernetes:admissionregistration.k8s.io/v1:ValidatingWebhookConfiguration", name, ValidatingWebhookConfigurationArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
