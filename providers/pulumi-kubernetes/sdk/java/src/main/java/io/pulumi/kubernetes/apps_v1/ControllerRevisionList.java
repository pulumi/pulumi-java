...
import io.pulumi.kubernetes.apps_v1.ControllerRevisionListArgs;
import io.pulumi.kubernetes.apps_v1.outputs.ControllerRevision;
...
public class ControllerRevisionList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.apps_v1.ControllerRevisionListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.apps_v1.ControllerRevisionListArgs.builder();
    ...
    public ControllerRevisionList(String name, ControllerRevisionListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1:ControllerRevisionList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
