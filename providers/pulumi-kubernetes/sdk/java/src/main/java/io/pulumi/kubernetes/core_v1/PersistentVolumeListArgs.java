...
import io.pulumi.kubernetes.core_v1.inputs.PersistentVolumeArgs;
...
public final class PersistentVolumeListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="items", required=true)
        private final Input<List<PersistentVolumeArgs>> items;

    public Input<List<PersistentVolumeArgs>> getItems() {
        return this.items;
    }
    ...
    public PersistentVolumeListArgs(
        ...
        Input<List<PersistentVolumeArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<PersistentVolumeArgs>> items;
        ...
        public Builder setItems(Input<List<PersistentVolumeArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<PersistentVolumeArgs> items) {
