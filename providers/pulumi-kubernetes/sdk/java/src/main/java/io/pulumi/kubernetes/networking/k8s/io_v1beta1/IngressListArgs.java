...
import io.pulumi.kubernetes.networking.k8s.io_v1beta1.inputs.IngressArgs;
...
public final class IngressListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="items", required=true)
        private final Input<List<IngressArgs>> items;

    public Input<List<IngressArgs>> getItems() {
        return this.items;
    }
    ...
    public static final class Builder {
        ...
        private Input<List<IngressArgs>> items;
        ...
        public Builder setItems(Input<List<IngressArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<IngressArgs> items) {
