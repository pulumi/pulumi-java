...
public class ControllerRevisionList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.apps_v1beta1.ControllerRevisionListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.apps_v1beta1.ControllerRevisionListArgs.builder();
     ...
     */
    public static ControllerRevisionList get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
