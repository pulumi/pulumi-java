...
public class Namespace extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable NamespaceArgs.Builder a);
    }
    private static io.pulumi.kubernetes.core_v1.NamespaceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.core_v1.NamespaceArgs.builder();
    ...
    public Namespace(String name, @Nullable NamespaceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:Namespace", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
