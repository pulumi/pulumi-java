...
public class Event extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.core_v1.EventArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.core_v1.EventArgs.builder();
