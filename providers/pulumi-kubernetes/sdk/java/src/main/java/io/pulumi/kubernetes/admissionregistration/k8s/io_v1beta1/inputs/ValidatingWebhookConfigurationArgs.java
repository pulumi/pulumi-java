...
public final class ValidatingWebhookConfigurationArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public ValidatingWebhookConfigurationArgs(
        ...
        @Nullable Input<List<ValidatingWebhookArgs>> webhooks) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<ValidatingWebhookArgs>> webhooks;
        ...
        public Builder setWebhooks(@Nullable Input<List<ValidatingWebhookArgs>> webhooks) {
            this.webhooks = webhooks;
            return this;
        }

        public Builder setWebhooks(@Nullable List<ValidatingWebhookArgs> webhooks) {
