...
import io.pulumi.kubernetes.authentication.k8s.io_v1.inputs.TokenRequestSpecArgs;
...
public final class TokenRequestArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<TokenRequestSpecArgs> spec;

    public Input<TokenRequestSpecArgs> getSpec() {
        return this.spec;
    }
    ...
    public TokenRequestArgs(
        ...
        Input<TokenRequestSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private Input<TokenRequestSpecArgs> spec;
        ...
        public Builder setSpec(Input<TokenRequestSpecArgs> spec) {
            this.spec = Objects.requireNonNull(spec);
            return this;
        }

        public Builder setSpec(TokenRequestSpecArgs spec) {
            this.spec = Input.of(Objects.requireNonNull(spec));
            return this;
        }

        public TokenRequestArgs build() {
            return new TokenRequestArgs(apiVersion, kind, metadata, spec);
        }
    }
}
