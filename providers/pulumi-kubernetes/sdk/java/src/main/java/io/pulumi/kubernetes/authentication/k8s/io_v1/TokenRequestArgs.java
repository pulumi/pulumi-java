...
public final class TokenRequestArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="spec", required=true)
      private final Output<TokenRequestSpecArgs> spec;

    public Output<TokenRequestSpecArgs> getSpec() {
        return this.spec;
    }
    ...
    public TokenRequestArgs(
        ...
        Output<TokenRequestSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private Output<TokenRequestSpecArgs> spec;
        ...
        public Builder spec(Output<TokenRequestSpecArgs> spec) {
            this.spec = Objects.requireNonNull(spec);
            return this;
        }
        public Builder spec(TokenRequestSpecArgs spec) {
