...
public class APIService extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.apiregistration.k8s.io_v1beta1.APIServiceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.apiregistration.k8s.io_v1beta1.APIServiceArgs.builder();
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:apiregistration.k8s.io/v1:APIService").build()),
                Output.of(Alias.builder().setType("kubernetes:apiregistration/v1:APIService").build()),
                Output.of(Alias.builder().setType("kubernetes:apiregistration/v1beta1:APIService").build())
            ))
            .build();
