...
public class RuntimeClass extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.node.k8s.io_v1.RuntimeClassArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.node.k8s.io_v1.RuntimeClassArgs.builder();
    ...
    public RuntimeClass(String name, RuntimeClassArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:node.k8s.io/v1:RuntimeClass", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                ...
                Output.of(Alias.builder().setType("kubernetes:node.k8s.io/v1beta1:RuntimeClass").build())
            ))
            .build();
