...
import io.pulumi.kubernetes.apps_v1beta1.ControllerRevisionArgs;
...
public class ControllerRevision extends io.pulumi.resources.CustomResource {
    ...
    public ControllerRevision(String name) {
        super("kubernetes:apps/v1beta1:ControllerRevision", name, ControllerRevisionArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public ControllerRevision(String name, ControllerRevisionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta1:ControllerRevision", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }

    private ControllerRevision(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1beta1:ControllerRevision", name, null, makeResourceOptions(options, id));
    }
