...
import io.pulumi.kubernetes.admissionregistration.k8s.io_v1.inputs.MutatingWebhookArgs;
...
public final class MutatingWebhookConfigurationArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setWebhooks(@Nullable Input<List<MutatingWebhookArgs>> webhooks) {
            this.webhooks = webhooks;
            return this;
        }

        public Builder setWebhooks(@Nullable List<MutatingWebhookArgs> webhooks) {
