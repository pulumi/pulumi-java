...
import io.pulumi.kubernetes.extensions_v1beta1.DaemonSetListArgs;
import io.pulumi.kubernetes.extensions_v1beta1.outputs.DaemonSet;
...
public class DaemonSetList extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(DaemonSetListArgs.Builder a);
    }
    private static io.pulumi.kubernetes.extensions_v1beta1.DaemonSetListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.extensions_v1beta1.DaemonSetListArgs.builder();
     ...
     */
    public DaemonSetList(String name, BuilderApplicator argsBuilder) {
    ...
    public DaemonSetList(String name, DaemonSetListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:DaemonSetList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private DaemonSetList(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static DaemonSetList get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
