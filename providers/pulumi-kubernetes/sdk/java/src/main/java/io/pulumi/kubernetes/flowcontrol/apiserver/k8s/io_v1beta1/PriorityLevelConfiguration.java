...
public class PriorityLevelConfiguration extends io.pulumi.resources.CustomResource {
    ...
    public PriorityLevelConfiguration(String name, @Nullable PriorityLevelConfigurationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta1:PriorityLevelConfiguration", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:PriorityLevelConfiguration").build()),
