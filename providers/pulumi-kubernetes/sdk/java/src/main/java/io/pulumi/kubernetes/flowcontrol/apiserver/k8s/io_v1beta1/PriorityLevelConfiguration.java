...
public class PriorityLevelConfiguration extends io.pulumi.resources.CustomResource {
    ...
    public PriorityLevelConfiguration(String name) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta1:PriorityLevelConfiguration", name, PriorityLevelConfigurationArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
