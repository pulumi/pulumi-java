...
import io.pulumi.kubernetes.extensions_v1beta1.IngressListArgs;
import io.pulumi.kubernetes.extensions_v1beta1.outputs.Ingress;
...
public class IngressList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.extensions_v1beta1.IngressListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.extensions_v1beta1.IngressListArgs.builder();
    ...
    public IngressList(String name, IngressListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:IngressList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
