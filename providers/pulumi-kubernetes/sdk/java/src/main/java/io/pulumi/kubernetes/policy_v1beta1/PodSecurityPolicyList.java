...
public class PodSecurityPolicyList extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="items", type=List.class, parameters={PodSecurityPolicy.class})
    ...
    public PodSecurityPolicyList(String name, PodSecurityPolicyListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:policy/v1beta1:PodSecurityPolicyList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private PodSecurityPolicyList(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static PodSecurityPolicyList get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
