...
import io.pulumi.kubernetes.authentication.k8s.io_v1beta1.TokenReviewArgs;
import io.pulumi.kubernetes.authentication.k8s.io_v1beta1.outputs.TokenReviewSpec;
import io.pulumi.kubernetes.authentication.k8s.io_v1beta1.outputs.TokenReviewStatus;
...
public class TokenReview extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.authentication.k8s.io_v1beta1.TokenReviewArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.authentication.k8s.io_v1beta1.TokenReviewArgs.builder();
