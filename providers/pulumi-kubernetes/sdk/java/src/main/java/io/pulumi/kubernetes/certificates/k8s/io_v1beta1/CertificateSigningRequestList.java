...
public class CertificateSigningRequestList extends io.pulumi.resources.CustomResource {
    ...
    public CertificateSigningRequestList(String name) {
        super("kubernetes:certificates.k8s.io/v1beta1:CertificateSigningRequestList", name, CertificateSigningRequestListArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
