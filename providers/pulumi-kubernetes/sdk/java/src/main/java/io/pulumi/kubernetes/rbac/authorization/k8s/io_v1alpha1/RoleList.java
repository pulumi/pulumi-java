...
public class RoleList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.RoleListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.RoleListArgs.builder();
    ...
    public RoleList(String name, RoleListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
