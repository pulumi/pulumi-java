...
public class CSIDriver extends io.pulumi.resources.CustomResource {
    ...
    public CSIDriver(String name, CSIDriverArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1beta1:CSIDriver", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private CSIDriver(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:storage.k8s.io/v1:CSIDriver").build())
            ))
            .build();
     ...
     */
    public static CSIDriver get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
