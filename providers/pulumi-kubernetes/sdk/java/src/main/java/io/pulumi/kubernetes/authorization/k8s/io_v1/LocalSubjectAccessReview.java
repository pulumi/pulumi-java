...
public class LocalSubjectAccessReview extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.authorization.k8s.io_v1.LocalSubjectAccessReviewArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.authorization.k8s.io_v1.LocalSubjectAccessReviewArgs.builder();
    ...
    public LocalSubjectAccessReview(String name, LocalSubjectAccessReviewArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:authorization.k8s.io/v1:LocalSubjectAccessReview", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:authorization.k8s.io/v1beta1:LocalSubjectAccessReview").build())
            ))
            .build();
