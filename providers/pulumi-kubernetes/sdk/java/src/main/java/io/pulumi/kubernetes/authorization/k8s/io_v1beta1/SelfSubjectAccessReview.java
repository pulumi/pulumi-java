...
public class SelfSubjectAccessReview extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.authorization.k8s.io_v1beta1.SelfSubjectAccessReviewArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.authorization.k8s.io_v1beta1.SelfSubjectAccessReviewArgs.builder();
    ...
    public SelfSubjectAccessReview(String name, SelfSubjectAccessReviewArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:authorization.k8s.io/v1beta1:SelfSubjectAccessReview", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:authorization.k8s.io/v1:SelfSubjectAccessReview").build())
            ))
            .build();
