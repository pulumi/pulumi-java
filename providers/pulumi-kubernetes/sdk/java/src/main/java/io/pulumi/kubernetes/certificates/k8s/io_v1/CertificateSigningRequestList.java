...
import io.pulumi.kubernetes.certificates.k8s.io_v1.CertificateSigningRequestListArgs;
import io.pulumi.kubernetes.certificates.k8s.io_v1.outputs.CertificateSigningRequest;
...
public class CertificateSigningRequestList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.certificates.k8s.io_v1.CertificateSigningRequestListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.certificates.k8s.io_v1.CertificateSigningRequestListArgs.builder();
    ...
    public CertificateSigningRequestList(String name, CertificateSigningRequestListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:certificates.k8s.io/v1:CertificateSigningRequestList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
