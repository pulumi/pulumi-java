...
import io.pulumi.kubernetes.node.k8s.io_v1.inputs.RuntimeClassArgs;
...
public final class RuntimeClassListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="items", required=true)
      private final Input<List<RuntimeClassArgs>> items;

    public Input<List<RuntimeClassArgs>> getItems() {
        return this.items;
    }
    ...
    public RuntimeClassListArgs(
        ...
        Input<List<RuntimeClassArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<RuntimeClassArgs>> items;
        ...
        public Builder setItems(Input<List<RuntimeClassArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<RuntimeClassArgs> items) {
