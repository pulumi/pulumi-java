...
public class DeploymentList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.apps_v1.DeploymentListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.apps_v1.DeploymentListArgs.builder();
    ...
    public DeploymentList(String name, DeploymentListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1:DeploymentList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
