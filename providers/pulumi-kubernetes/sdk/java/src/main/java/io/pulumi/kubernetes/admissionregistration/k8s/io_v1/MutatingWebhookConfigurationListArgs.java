...
public final class MutatingWebhookConfigurationListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<MutatingWebhookConfigurationArgs>> items;

    public Input<List<MutatingWebhookConfigurationArgs>> getItems() {
        return this.items;
    }
    ...
    public MutatingWebhookConfigurationListArgs(
        ...
        Input<List<MutatingWebhookConfigurationArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<MutatingWebhookConfigurationArgs>> items;
        ...
        public Builder setItems(Input<List<MutatingWebhookConfigurationArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<MutatingWebhookConfigurationArgs> items) {
