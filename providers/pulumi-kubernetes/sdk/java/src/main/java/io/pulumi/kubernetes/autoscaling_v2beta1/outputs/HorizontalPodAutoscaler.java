...
public final class HorizontalPodAutoscaler {
    ...
    private HorizontalPodAutoscaler(
        ...
        @OutputCustomType.Parameter("spec") @Nullable HorizontalPodAutoscalerSpec spec,
        @OutputCustomType.Parameter("status") @Nullable HorizontalPodAutoscalerStatus status) {
