...
public class EndpointSliceList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.discovery.k8s.io_v1.EndpointSliceListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.discovery.k8s.io_v1.EndpointSliceListArgs.builder();
