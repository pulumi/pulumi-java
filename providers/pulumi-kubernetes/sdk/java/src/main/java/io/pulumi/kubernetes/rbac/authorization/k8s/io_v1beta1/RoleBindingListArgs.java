...
import io.pulumi.kubernetes.rbac.authorization.k8s.io_v1beta1.inputs.RoleBindingArgs;
...
public final class RoleBindingListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<RoleBindingArgs>> items;

    public Input<List<RoleBindingArgs>> getItems() {
        return this.items;
    }
    ...
    public RoleBindingListArgs(
        @Nullable Input<String> apiVersion,
        Input<List<RoleBindingArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<RoleBindingArgs>> items;
        ...
        public Builder setItems(Input<List<RoleBindingArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<RoleBindingArgs> items) {
        ...
        public RoleBindingListArgs build() {
            return new RoleBindingListArgs(apiVersion, items, kind, metadata);
        }
    }
}
