...
import io.pulumi.kubernetes.core_v1.inputs.ServiceAccountArgs;
...
public final class ServiceAccountListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<ServiceAccountArgs>> items;

    public Input<List<ServiceAccountArgs>> getItems() {
        return this.items;
    }
    ...
    public ServiceAccountListArgs(
        ...
        Input<List<ServiceAccountArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<ServiceAccountArgs>> items;
        ...
        public Builder setItems(Input<List<ServiceAccountArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<ServiceAccountArgs> items) {
        ...
        public ServiceAccountListArgs build() {
            return new ServiceAccountListArgs(apiVersion, items, kind, metadata);
        }
    }
}
