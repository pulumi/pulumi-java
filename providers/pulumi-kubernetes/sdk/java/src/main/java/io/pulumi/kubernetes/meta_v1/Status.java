...
public class Status extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable StatusArgs.Builder a);
    }
    private static io.pulumi.kubernetes.meta_v1.StatusArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.meta_v1.StatusArgs.builder();
     ...
     */
    public Status(String name, BuilderApplicator argsBuilder) {
