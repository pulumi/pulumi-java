...
public class PriorityLevelConfiguration extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1beta2.PriorityLevelConfigurationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1beta2.PriorityLevelConfigurationArgs.builder();
    ...
    public PriorityLevelConfiguration(String name, @Nullable PriorityLevelConfigurationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:PriorityLevelConfiguration", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
