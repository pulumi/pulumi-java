...
import io.pulumi.kubernetes.extensions_v1beta1.inputs.DaemonSetArgs;
...
public final class DaemonSetListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<DaemonSetArgs>> items;

    public Input<List<DaemonSetArgs>> getItems() {
        return this.items;
    }
    ...
    public DaemonSetListArgs(
        ...
        Input<List<DaemonSetArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<DaemonSetArgs>> items;
        ...
        public Builder setItems(Input<List<DaemonSetArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<DaemonSetArgs> items) {
