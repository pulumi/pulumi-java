...
import io.pulumi.kubernetes.storage.k8s.io_v1.StorageClassListArgs;
import io.pulumi.kubernetes.storage.k8s.io_v1.outputs.StorageClass;
...
public class StorageClassList extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(StorageClassListArgs.Builder a);
    }
    private static io.pulumi.kubernetes.storage.k8s.io_v1.StorageClassListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.storage.k8s.io_v1.StorageClassListArgs.builder();
     ...
     */
    public StorageClassList(String name, BuilderApplicator argsBuilder) {
