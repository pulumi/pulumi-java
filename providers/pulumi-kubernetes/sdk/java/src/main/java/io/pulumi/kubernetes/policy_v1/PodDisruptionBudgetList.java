...
public class PodDisruptionBudgetList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.policy_v1.PodDisruptionBudgetListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.policy_v1.PodDisruptionBudgetListArgs.builder();
    ...
    public PodDisruptionBudgetList(String name, PodDisruptionBudgetListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:policy/v1:PodDisruptionBudgetList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
