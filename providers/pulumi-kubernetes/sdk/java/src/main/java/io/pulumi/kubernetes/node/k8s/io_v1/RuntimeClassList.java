...
public class RuntimeClassList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.node.k8s.io_v1.RuntimeClassListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.node.k8s.io_v1.RuntimeClassListArgs.builder();
