...
public class PodSecurityPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.policy_v1beta1.PodSecurityPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.policy_v1beta1.PodSecurityPolicyArgs.builder();
    ...
    public PodSecurityPolicy(String name, @Nullable PodSecurityPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:policy/v1beta1:PodSecurityPolicy", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:extensions/v1beta1:PodSecurityPolicy").build())
            ))
            .build();
