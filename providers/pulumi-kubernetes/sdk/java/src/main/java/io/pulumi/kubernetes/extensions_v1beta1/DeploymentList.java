...
public class DeploymentList extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(DeploymentListArgs.Builder a);
    }
    private static io.pulumi.kubernetes.extensions_v1beta1.DeploymentListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.extensions_v1beta1.DeploymentListArgs.builder();
     ...
     */
    public DeploymentList(String name, BuilderApplicator argsBuilder) {
    ...
    public DeploymentList(String name, DeploymentListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:DeploymentList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
