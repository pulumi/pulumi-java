...
public final class ResourceQuotaArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<ResourceQuotaSpecArgs> spec;

    public Input<ResourceQuotaSpecArgs> getSpec() {
    ...
    public ResourceQuotaArgs(
        ...
        @Nullable Input<ResourceQuotaSpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<ResourceQuotaSpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<ResourceQuotaSpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable ResourceQuotaSpecArgs spec) {
            this.spec = Input.ofNullable(spec);
            return this;
        }

        public ResourceQuotaArgs build() {
            return new ResourceQuotaArgs(apiVersion, kind, metadata, spec);
        }
    }
}
