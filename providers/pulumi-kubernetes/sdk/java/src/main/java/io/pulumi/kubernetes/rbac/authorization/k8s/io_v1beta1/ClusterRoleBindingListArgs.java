...
import io.pulumi.kubernetes.rbac.authorization.k8s.io_v1beta1.inputs.ClusterRoleBindingArgs;
...
public final class ClusterRoleBindingListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<ClusterRoleBindingArgs>> items;

    public Input<List<ClusterRoleBindingArgs>> getItems() {
        return this.items;
    }
    ...
    public ClusterRoleBindingListArgs(
        ...
        Input<List<ClusterRoleBindingArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<ClusterRoleBindingArgs>> items;
        ...
        public Builder setItems(Input<List<ClusterRoleBindingArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<ClusterRoleBindingArgs> items) {
