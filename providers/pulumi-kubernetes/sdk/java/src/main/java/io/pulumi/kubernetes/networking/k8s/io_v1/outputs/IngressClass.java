...
public final class IngressClass {
    ...
    private IngressClass(
        ...
        @OutputCustomType.Parameter("spec") @Nullable IngressClassSpec spec) {
    ...
    */
     ...
     * 
    */
    public Optional<IngressClassSpec> getSpec() {
    ...
    public static final class Builder {
        ...
        public Builder setSpec(@Nullable IngressClassSpec spec) {
            this.spec = spec;
            return this;
        }
