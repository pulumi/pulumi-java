...
import io.pulumi.kubernetes.certificates.k8s.io_v1.inputs.CertificateSigningRequestArgs;
...
public final class CertificateSigningRequestListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public CertificateSigningRequestListArgs(
        ...
        Input<List<CertificateSigningRequestArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<CertificateSigningRequestArgs>> items;
        ...
        public Builder setItems(Input<List<CertificateSigningRequestArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<CertificateSigningRequestArgs> items) {
