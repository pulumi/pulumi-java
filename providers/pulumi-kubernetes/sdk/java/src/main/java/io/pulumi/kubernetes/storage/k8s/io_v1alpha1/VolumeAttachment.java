...
public class VolumeAttachment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.storage.k8s.io_v1alpha1.VolumeAttachmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.storage.k8s.io_v1alpha1.VolumeAttachmentArgs.builder();
    ...
    public VolumeAttachment(String name, VolumeAttachmentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1alpha1:VolumeAttachment", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
