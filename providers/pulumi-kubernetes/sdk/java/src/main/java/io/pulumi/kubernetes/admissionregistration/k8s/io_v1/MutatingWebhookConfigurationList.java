...
public class MutatingWebhookConfigurationList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.admissionregistration.k8s.io_v1.MutatingWebhookConfigurationListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.admissionregistration.k8s.io_v1.MutatingWebhookConfigurationListArgs.builder();
    ...
    public MutatingWebhookConfigurationList(String name, MutatingWebhookConfigurationListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1:MutatingWebhookConfigurationList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private MutatingWebhookConfigurationList(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static MutatingWebhookConfigurationList get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
