...
import io.pulumi.kubernetes.extensions_v1beta1.inputs.NetworkPolicyArgs;
...
public final class NetworkPolicyListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<NetworkPolicyArgs>> items;

    public Input<List<NetworkPolicyArgs>> getItems() {
        return this.items;
    }
    ...
    public NetworkPolicyListArgs(
        ...
        Input<List<NetworkPolicyArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<NetworkPolicyArgs>> items;
        ...
        public Builder setItems(Input<List<NetworkPolicyArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<NetworkPolicyArgs> items) {
