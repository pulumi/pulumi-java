...
import io.pulumi.kubernetes.apps_v1beta1.inputs.StatefulSetArgs;
...
public final class StatefulSetListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public StatefulSetListArgs(
        ...
        Input<List<StatefulSetArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<StatefulSetArgs>> items;
        ...
        public Builder setItems(Input<List<StatefulSetArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<StatefulSetArgs> items) {
