...
import io.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.RoleArgs;
...
public class Role extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable RoleArgs.Builder a);
    }
    private static io.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.RoleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.RoleArgs.builder();
    ...
    public Role(String name, @Nullable RoleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1alpha1:Role", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                ...
                Output.of(Alias.builder().setType("kubernetes:rbac.authorization.k8s.io/v1beta1:Role").build())
            ))
            .build();
