...
import io.pulumi.kubernetes.node.k8s.io_v1alpha1.RuntimeClassListArgs;
import io.pulumi.kubernetes.node.k8s.io_v1alpha1.outputs.RuntimeClass;
...
public class RuntimeClassList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.node.k8s.io_v1alpha1.RuntimeClassListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.node.k8s.io_v1alpha1.RuntimeClassListArgs.builder();
    ...
    public RuntimeClassList(String name, RuntimeClassListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:node.k8s.io/v1alpha1:RuntimeClassList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
