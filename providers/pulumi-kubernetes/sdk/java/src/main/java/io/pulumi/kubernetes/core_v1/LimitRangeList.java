...
public class LimitRangeList extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(LimitRangeListArgs.Builder a);
    }
    private static io.pulumi.kubernetes.core_v1.LimitRangeListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.core_v1.LimitRangeListArgs.builder();
     ...
     */
    public LimitRangeList(String name, BuilderApplicator argsBuilder) {
    ...
    public LimitRangeList(String name, LimitRangeListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:LimitRangeList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
