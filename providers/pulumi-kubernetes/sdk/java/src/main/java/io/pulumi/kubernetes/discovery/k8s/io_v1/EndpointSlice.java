...
public class EndpointSlice extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.discovery.k8s.io_v1.EndpointSliceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.discovery.k8s.io_v1.EndpointSliceArgs.builder();
    ...
    public EndpointSlice(String name, EndpointSliceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:discovery.k8s.io/v1:EndpointSlice", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:discovery.k8s.io/v1beta1:EndpointSlice").build())
            ))
            .build();
