...
public class EndpointSlice extends io.pulumi.resources.CustomResource {
    ...
    public EndpointSlice(String name, EndpointSliceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:discovery.k8s.io/v1:EndpointSlice", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("kubernetes:discovery.k8s.io/v1beta1:EndpointSlice").build())
            ))
            .build();
