...
public class RoleBinding extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.rbac.authorization.k8s.io_v1.RoleBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.rbac.authorization.k8s.io_v1.RoleBindingArgs.builder();
    ...
    public RoleBinding(String name, RoleBindingArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1:RoleBinding", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleBinding").build()),
                Output.of(Alias.builder().setType("kubernetes:rbac.authorization.k8s.io/v1beta1:RoleBinding").build())
            ))
            .build();
