...
public class RoleBinding extends io.pulumi.resources.CustomResource {
    ...
    public RoleBinding(String name, RoleBindingArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1:RoleBinding", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                ...
                Input.of(Alias.builder().setType("kubernetes:rbac.authorization.k8s.io/v1beta1:RoleBinding").build())
            ))
            .build();
