...
public final class DaemonSetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<DaemonSetSpecArgs> spec;

    public Input<DaemonSetSpecArgs> getSpec() {
    ...
    private final @Nullable Input<DaemonSetStatusArgs> status;

    public Input<DaemonSetStatusArgs> getStatus() {
    ...
    public DaemonSetArgs(
        ...
        @Nullable Input<DaemonSetSpecArgs> spec,
        @Nullable Input<DaemonSetStatusArgs> status) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<DaemonSetSpecArgs> spec;
        private @Nullable Input<DaemonSetStatusArgs> status;
