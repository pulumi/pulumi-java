...
public class Node extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable NodeArgs.Builder a);
    }
    private static io.pulumi.kubernetes.core_v1.NodeArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.core_v1.NodeArgs.builder();
    ...
    public Node(String name, @Nullable NodeArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:Node", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
