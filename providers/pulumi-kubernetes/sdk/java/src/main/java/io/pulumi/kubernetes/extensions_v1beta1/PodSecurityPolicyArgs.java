...
import io.pulumi.kubernetes.extensions_v1beta1.inputs.PodSecurityPolicySpecArgs;
...
public final class PodSecurityPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<PodSecurityPolicySpecArgs> spec;

    public Input<PodSecurityPolicySpecArgs> getSpec() {
    ...
    public PodSecurityPolicyArgs(
        ...
        @Nullable Input<PodSecurityPolicySpecArgs> spec) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<PodSecurityPolicySpecArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<PodSecurityPolicySpecArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable PodSecurityPolicySpecArgs spec) {
