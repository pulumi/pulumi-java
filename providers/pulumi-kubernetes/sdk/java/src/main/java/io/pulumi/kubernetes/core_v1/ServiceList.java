...
public class ServiceList extends io.pulumi.resources.CustomResource {
    ...
    public ServiceList(String name, ServiceListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:ServiceList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private ServiceList(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ServiceList get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
