...
import io.pulumi.kubernetes.apps_v1.StatefulSetListArgs;
import io.pulumi.kubernetes.apps_v1.outputs.StatefulSet;
...
public class StatefulSetList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.apps_v1.StatefulSetListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.apps_v1.StatefulSetListArgs.builder();
    ...
    public StatefulSetList(String name, StatefulSetListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1:StatefulSetList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
