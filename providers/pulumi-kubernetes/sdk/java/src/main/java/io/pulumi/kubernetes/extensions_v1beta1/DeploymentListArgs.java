...
import io.pulumi.kubernetes.extensions_v1beta1.inputs.DeploymentArgs;
...
public final class DeploymentListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="items", required=true)
      private final Output<List<DeploymentArgs>> items;

    public Output<List<DeploymentArgs>> getItems() {
        return this.items;
    }
    ...
    public DeploymentListArgs(
        ...
        Output<List<DeploymentArgs>> items,
