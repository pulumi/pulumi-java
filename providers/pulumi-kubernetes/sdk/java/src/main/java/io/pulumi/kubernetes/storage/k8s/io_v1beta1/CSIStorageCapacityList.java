...
public class CSIStorageCapacityList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.storage.k8s.io_v1beta1.CSIStorageCapacityListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.storage.k8s.io_v1beta1.CSIStorageCapacityListArgs.builder();
    ...
    public CSIStorageCapacityList(String name, CSIStorageCapacityListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1beta1:CSIStorageCapacityList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
