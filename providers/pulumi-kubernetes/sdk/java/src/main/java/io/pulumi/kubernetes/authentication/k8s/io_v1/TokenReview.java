...
public class TokenReview extends io.pulumi.resources.CustomResource {
    ...
    public TokenReview(String name) {
        super("kubernetes:authentication.k8s.io/v1:TokenReview", name, TokenReviewArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("kubernetes:authentication.k8s.io/v1beta1:TokenReview").build())
            ))
            .build();
