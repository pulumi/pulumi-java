...
public class NamespaceList extends io.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @OutputExport(name="items", type=List.class, parameters={Namespace.class})
     ...
     * 
     */
    public Output<List<Namespace>> getItems() {
        return this.items;
    }
    /**
    ...
    public interface BuilderApplicator {
        public void apply(NamespaceListArgs.Builder a);
    }
    private static io.pulumi.kubernetes.core_v1.NamespaceListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.core_v1.NamespaceListArgs.builder();
     ...
     */
    public NamespaceList(String name, BuilderApplicator argsBuilder) {
    ...
    public NamespaceList(String name, NamespaceListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:NamespaceList", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }

    private NamespaceList(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static NamespaceList get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
