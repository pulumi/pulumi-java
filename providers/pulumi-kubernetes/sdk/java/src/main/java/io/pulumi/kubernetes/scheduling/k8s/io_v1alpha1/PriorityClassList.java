...
public class PriorityClassList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.scheduling.k8s.io_v1alpha1.PriorityClassListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.scheduling.k8s.io_v1alpha1.PriorityClassListArgs.builder();
    ...
    public PriorityClassList(String name, PriorityClassListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:scheduling.k8s.io/v1alpha1:PriorityClassList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
