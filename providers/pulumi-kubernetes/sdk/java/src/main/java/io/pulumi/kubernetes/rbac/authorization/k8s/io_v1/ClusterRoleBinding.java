...
public class ClusterRoleBinding extends io.pulumi.resources.CustomResource {
    ...
    public ClusterRoleBinding(String name) {
        super("kubernetes:rbac.authorization.k8s.io/v1:ClusterRoleBinding", name, ClusterRoleBindingArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public ClusterRoleBinding(String name, ClusterRoleBindingArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1:ClusterRoleBinding", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBinding").build()),
