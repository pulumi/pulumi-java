...
public class PersistentVolumeClaim extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable PersistentVolumeClaimArgs.Builder a);
    }
    private static io.pulumi.kubernetes.core_v1.PersistentVolumeClaimArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.core_v1.PersistentVolumeClaimArgs.builder();
     ...
     */
    public PersistentVolumeClaim(String name, BuilderApplicator argsBuilder) {
    ...
    public PersistentVolumeClaim(String name, @Nullable PersistentVolumeClaimArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:PersistentVolumeClaim", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private PersistentVolumeClaim(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static PersistentVolumeClaim get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
