...
public class NetworkPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.networking.k8s.io_v1.NetworkPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.networking.k8s.io_v1.NetworkPolicyArgs.builder();
    ...
    public NetworkPolicy(String name, @Nullable NetworkPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1:NetworkPolicy", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:extensions/v1beta1:NetworkPolicy").build())
            ))
            .build();
