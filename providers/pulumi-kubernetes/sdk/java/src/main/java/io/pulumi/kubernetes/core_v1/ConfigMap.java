...
public class ConfigMap extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable ConfigMapArgs.Builder a);
    }
    private static io.pulumi.kubernetes.core_v1.ConfigMapArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.core_v1.ConfigMapArgs.builder();
     ...
     */
    public ConfigMap(String name, BuilderApplicator argsBuilder) {
