...
public class ServiceAccount extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="imagePullSecrets", type=List.class, parameters={LocalObjectReference.class})
     ...
     * 
     */
    @OutputExport(name="secrets", type=List.class, parameters={ObjectReference.class})
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable ServiceAccountArgs.Builder a);
    }
    private static io.pulumi.kubernetes.core_v1.ServiceAccountArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.core_v1.ServiceAccountArgs.builder();
