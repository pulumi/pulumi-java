...
import io.pulumi.kubernetes.networking.k8s.io_v1beta1.IngressClassArgs;
import io.pulumi.kubernetes.networking.k8s.io_v1beta1.outputs.IngressClassSpec;
...
public class IngressClass extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="spec", type=IngressClassSpec.class, parameters={})
    ...
    private static io.pulumi.kubernetes.networking.k8s.io_v1beta1.IngressClassArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.networking.k8s.io_v1beta1.IngressClassArgs.builder();
    ...
    public IngressClass(String name, @Nullable IngressClassArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1beta1:IngressClass", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private IngressClass(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:networking.k8s.io/v1:IngressClass").build())
            ))
            .build();
     ...
     */
    public static IngressClass get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
