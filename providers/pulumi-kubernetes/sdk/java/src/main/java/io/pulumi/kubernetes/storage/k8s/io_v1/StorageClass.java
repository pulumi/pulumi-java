...
public class StorageClass extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.storage.k8s.io_v1.StorageClassArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.storage.k8s.io_v1.StorageClassArgs.builder();
