...
public class MutatingWebhookConfiguration extends io.pulumi.resources.CustomResource {
    ...
    public MutatingWebhookConfiguration(String name, @Nullable MutatingWebhookConfigurationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:admissionregistration.k8s.io/v1beta1:MutatingWebhookConfiguration", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:admissionregistration.k8s.io/v1:MutatingWebhookConfiguration").build())
            ))
            .build();
