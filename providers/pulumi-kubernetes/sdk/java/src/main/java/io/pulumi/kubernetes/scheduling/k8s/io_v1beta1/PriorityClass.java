...
public class PriorityClass extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.scheduling.k8s.io_v1beta1.PriorityClassArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.scheduling.k8s.io_v1beta1.PriorityClassArgs.builder();
    ...
    public PriorityClass(String name, PriorityClassArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:scheduling.k8s.io/v1beta1:PriorityClass", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private PriorityClass(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:scheduling.k8s.io/v1beta1:PriorityClass", name, null, makeResourceOptions(options, id));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:scheduling.k8s.io/v1:PriorityClass").build()),
                Output.of(Alias.builder().setType("kubernetes:scheduling.k8s.io/v1alpha1:PriorityClass").build())
            ))
            .build();
     ...
     */
    public static PriorityClass get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
