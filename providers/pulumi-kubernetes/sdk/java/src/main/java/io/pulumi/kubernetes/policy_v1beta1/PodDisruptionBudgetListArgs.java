...
import io.pulumi.kubernetes.policy_v1beta1.inputs.PodDisruptionBudgetArgs;
...
public final class PodDisruptionBudgetListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="items", required=true)
        private final Input<List<PodDisruptionBudgetArgs>> items;

    public Input<List<PodDisruptionBudgetArgs>> getItems() {
        return this.items;
    }
    ...
    public PodDisruptionBudgetListArgs(
        @Nullable Input<String> apiVersion,
        Input<List<PodDisruptionBudgetArgs>> items,
    ...
    public static final class Builder {
        ...
        private Input<List<PodDisruptionBudgetArgs>> items;
        ...
        public Builder setItems(Input<List<PodDisruptionBudgetArgs>> items) {
            this.items = Objects.requireNonNull(items);
            return this;
        }

        public Builder setItems(List<PodDisruptionBudgetArgs> items) {
