...
import io.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1beta1.FlowSchemaListArgs;
import io.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1beta1.outputs.FlowSchema;
 ...
 * 
 */
@ResourceType(type="kubernetes:flowcontrol.apiserver.k8s.io/v1beta1:FlowSchemaList")
public class FlowSchemaList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1beta1.FlowSchemaListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1beta1.FlowSchemaListArgs.builder();
    ...
    public FlowSchemaList(String name, FlowSchemaListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta1:FlowSchemaList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private FlowSchemaList(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta1:FlowSchemaList", name, null, makeResourceOptions(options, id));
    }
