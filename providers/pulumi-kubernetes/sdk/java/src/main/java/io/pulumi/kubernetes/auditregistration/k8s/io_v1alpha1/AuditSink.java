...
public class AuditSink extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="spec", type=AuditSinkSpec.class, parameters={})
    ...
    public AuditSink(String name) {
        super("kubernetes:auditregistration.k8s.io/v1alpha1:AuditSink", name, AuditSinkArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
