...
public class PriorityLevelConfigurationList extends io.pulumi.resources.CustomResource {
    ...
    public PriorityLevelConfigurationList(String name) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta1:PriorityLevelConfigurationList", name, PriorityLevelConfigurationListArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public PriorityLevelConfigurationList(String name, PriorityLevelConfigurationListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:flowcontrol.apiserver.k8s.io/v1beta1:PriorityLevelConfigurationList", name, makeArgs(args), makeResourceOptions(options, Input.empty()));
    }
