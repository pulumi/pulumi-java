...
import io.pulumi.kubernetes.storage.k8s.io_v1beta1.VolumeAttachmentArgs;
import io.pulumi.kubernetes.storage.k8s.io_v1beta1.outputs.VolumeAttachmentSpec;
import io.pulumi.kubernetes.storage.k8s.io_v1beta1.outputs.VolumeAttachmentStatus;
...
public class VolumeAttachment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.storage.k8s.io_v1beta1.VolumeAttachmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.storage.k8s.io_v1beta1.VolumeAttachmentArgs.builder();
    ...
    public VolumeAttachment(String name, VolumeAttachmentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1beta1:VolumeAttachment", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:storage.k8s.io/v1:VolumeAttachment").build()),
