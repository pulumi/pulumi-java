...
public class PodSecurityPolicyList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.extensions_v1beta1.PodSecurityPolicyListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.extensions_v1beta1.PodSecurityPolicyListArgs.builder();
    ...
    public PodSecurityPolicyList(String name, PodSecurityPolicyListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:PodSecurityPolicyList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
