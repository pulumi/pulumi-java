...
public class SubjectAccessReview extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(SubjectAccessReviewArgs.Builder a);
    }
    private static io.pulumi.kubernetes.authorization.k8s.io_v1beta1.SubjectAccessReviewArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.authorization.k8s.io_v1beta1.SubjectAccessReviewArgs.builder();
     ...
     */
    public SubjectAccessReview(String name, BuilderApplicator argsBuilder) {
    ...
    public SubjectAccessReview(String name, SubjectAccessReviewArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:authorization.k8s.io/v1beta1:SubjectAccessReview", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:authorization.k8s.io/v1:SubjectAccessReview").build())
            ))
            .build();
