...
public class CustomResourceDefinitionList extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.apiextensions.k8s.io_v1.CustomResourceDefinitionListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.apiextensions.k8s.io_v1.CustomResourceDefinitionListArgs.builder();
    ...
    public CustomResourceDefinitionList(String name, CustomResourceDefinitionListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apiextensions.k8s.io/v1:CustomResourceDefinitionList", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private CustomResourceDefinitionList(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static CustomResourceDefinitionList get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
