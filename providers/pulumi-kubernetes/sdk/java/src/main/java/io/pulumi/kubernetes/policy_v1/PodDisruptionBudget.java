...
import io.pulumi.kubernetes.policy_v1.PodDisruptionBudgetArgs;
...
public class PodDisruptionBudget extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.kubernetes.policy_v1.PodDisruptionBudgetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.kubernetes.policy_v1.PodDisruptionBudgetArgs.builder();
    ...
    public PodDisruptionBudget(String name, @Nullable PodDisruptionBudgetArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:policy/v1:PodDisruptionBudget", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("kubernetes:policy/v1beta1:PodDisruptionBudget").build())
            ))
            .build();
