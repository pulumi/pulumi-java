...
import com.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.RoleBindingListArgs;
import com.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.outputs.RoleBinding;
...
public class RoleBindingList extends CustomResource {
    /**
     ...
     */
    public RoleBindingList(String name, RoleBindingListArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RoleBindingList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RoleBindingList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
