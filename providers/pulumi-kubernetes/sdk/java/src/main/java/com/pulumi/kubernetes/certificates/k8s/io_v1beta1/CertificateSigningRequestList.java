...
package com.pulumi.kubernetes.certificates.k8s.io_v1beta1;
...
import com.pulumi.kubernetes.certificates.k8s.io_v1beta1.CertificateSigningRequestListArgs;
import com.pulumi.kubernetes.certificates.k8s.io_v1beta1.outputs.CertificateSigningRequest;
...
public class CertificateSigningRequestList extends CustomResource {
    /**
     ...
     */
    public CertificateSigningRequestList(String name, CertificateSigningRequestListArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CertificateSigningRequestList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CertificateSigningRequestList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
