...
import com.pulumi.kubernetes.node.k8s.io_v1beta1.inputs.RuntimeClassArgs;
...
public final class RuntimeClassListArgs extends ResourceArgs {
    ...
    private RuntimeClassListArgs(RuntimeClassListArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuntimeClassListArgs();
        }

        public Builder(RuntimeClassListArgs defaults) {
            $ = new RuntimeClassListArgs(Objects.requireNonNull(defaults));
        }
