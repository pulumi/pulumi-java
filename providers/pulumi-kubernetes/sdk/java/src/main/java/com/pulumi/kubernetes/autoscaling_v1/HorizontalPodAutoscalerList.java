...
package com.pulumi.kubernetes.autoscaling_v1;
...
import com.pulumi.kubernetes.autoscaling_v1.HorizontalPodAutoscalerListArgs;
import com.pulumi.kubernetes.autoscaling_v1.outputs.HorizontalPodAutoscaler;
...
public class HorizontalPodAutoscalerList extends CustomResource {
    ...
    public HorizontalPodAutoscalerList(String name, HorizontalPodAutoscalerListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:autoscaling/v1:HorizontalPodAutoscalerList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
