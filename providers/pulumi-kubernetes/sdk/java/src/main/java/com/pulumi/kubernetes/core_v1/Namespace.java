...
import com.pulumi.kubernetes.core_v1.outputs.NamespaceSpec;
import com.pulumi.kubernetes.core_v1.outputs.NamespaceStatus;
...
public class Namespace extends CustomResource {
     ...
     * 
     */
    @Export(name="spec", type=NamespaceSpec.class, parameters={})
     ...
     * 
     */
    public Output<Optional<NamespaceSpec>> spec() {
     ...
     * 
     */
    @Export(name="status", type=NamespaceStatus.class, parameters={})
     ...
     * 
     */
    public Output<Optional<NamespaceStatus>> status() {
     ...
     */
    public Namespace(String name, @Nullable NamespaceArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:core/v1:Namespace", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
