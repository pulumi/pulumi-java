...
import com.pulumi.kubernetes.apps_v1beta2.outputs.DaemonSetSpec;
import com.pulumi.kubernetes.apps_v1beta2.outputs.DaemonSetStatus;
...
public final class DaemonSet {
    ...
    private DaemonSet(
        ...
        @CustomType.Parameter("spec") @Nullable DaemonSetSpec spec,
        @CustomType.Parameter("status") @Nullable DaemonSetStatus status) {
