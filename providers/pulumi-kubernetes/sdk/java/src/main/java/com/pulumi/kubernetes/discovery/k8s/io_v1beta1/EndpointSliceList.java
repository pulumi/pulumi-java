...
package com.pulumi.kubernetes.discovery.k8s.io_v1beta1;
...
import com.pulumi.kubernetes.discovery.k8s.io_v1beta1.EndpointSliceListArgs;
import com.pulumi.kubernetes.discovery.k8s.io_v1beta1.outputs.EndpointSlice;
...
public class EndpointSliceList extends CustomResource {
    /**
     ...
     */
    public EndpointSliceList(String name, EndpointSliceListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:discovery.k8s.io/v1beta1:EndpointSliceList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private EndpointSliceList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EndpointSliceList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
