...
import com.pulumi.kubernetes.core_v1.NodeListArgs;
import com.pulumi.kubernetes.core_v1.outputs.Node;
...
public class NodeList extends CustomResource {
    /**
     ...
     */
    public NodeList(String name, NodeListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:core/v1:NodeList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private NodeList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NodeList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
