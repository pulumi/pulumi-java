...
public class CustomResourceDefinitionList extends CustomResource {
    /**
     ...
     */
    public CustomResourceDefinitionList(String name, CustomResourceDefinitionListArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CustomResourceDefinitionList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomResourceDefinitionList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
