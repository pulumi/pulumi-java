...
import com.pulumi.kubernetes.policy_v1beta1.PodSecurityPolicyArgs;
...
public class PodSecurityPolicy extends CustomResource {
    /**
     ...
     * 
     */
    public Output<Optional<PodSecurityPolicySpec>> spec() {
     ...
     */
    public PodSecurityPolicy(String name, @Nullable PodSecurityPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:policy/v1beta1:PodSecurityPolicy", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private PodSecurityPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PodSecurityPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
