...
import com.pulumi.kubernetes.apps_v1beta1.StatefulSetListArgs;
import com.pulumi.kubernetes.apps_v1beta1.outputs.StatefulSet;
...
public class StatefulSetList extends CustomResource {
    /**
     ...
     */
    public StatefulSetList(String name, StatefulSetListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:apps/v1beta1:StatefulSetList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private StatefulSetList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StatefulSetList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
