...
import com.pulumi.kubernetes.authorization.k8s.io_v1beta1.inputs.SelfSubjectRulesReviewSpecArgs;
...
public final class SelfSubjectRulesReviewArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SelfSubjectRulesReviewArgs(SelfSubjectRulesReviewArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SelfSubjectRulesReviewArgs();
        }

        public Builder(SelfSubjectRulesReviewArgs defaults) {
            $ = new SelfSubjectRulesReviewArgs(Objects.requireNonNull(defaults));
        }
