...
import com.pulumi.kubernetes.authorization.k8s.io_v1.SelfSubjectAccessReviewArgs;
import com.pulumi.kubernetes.authorization.k8s.io_v1.outputs.SelfSubjectAccessReviewSpec;
...
public class SelfSubjectAccessReview extends CustomResource {
    /**
     ...
     */
    public SelfSubjectAccessReview(String name, SelfSubjectAccessReviewArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SelfSubjectAccessReview(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SelfSubjectAccessReview get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
