...
package com.pulumi.kubernetes.apps_v1beta1;
...
import com.pulumi.kubernetes.apps_v1beta1.DeploymentListArgs;
import com.pulumi.kubernetes.apps_v1beta1.outputs.Deployment;
...
public class DeploymentList extends CustomResource {
    /**
     ...
     */
    public DeploymentList(String name, DeploymentListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:apps/v1beta1:DeploymentList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private DeploymentList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DeploymentList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
