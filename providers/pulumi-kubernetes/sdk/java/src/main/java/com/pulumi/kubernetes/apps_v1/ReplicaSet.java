...
import com.pulumi.kubernetes.apps_v1.ReplicaSetArgs;
import com.pulumi.kubernetes.apps_v1.outputs.ReplicaSetSpec;
import com.pulumi.kubernetes.apps_v1.outputs.ReplicaSetStatus;
 ...
 * 
 */
@ResourceType(type="kubernetes:apps/v1:ReplicaSet")
public class ReplicaSet extends com.pulumi.resources.CustomResource {
    ...
    public ReplicaSet(String name, @Nullable ReplicaSetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1:ReplicaSet", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ReplicaSet(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:apps/v1:ReplicaSet", name, null, makeResourceOptions(options, id));
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("kubernetes:extensions/v1beta1:ReplicaSet").build())
            ))
            .build();
