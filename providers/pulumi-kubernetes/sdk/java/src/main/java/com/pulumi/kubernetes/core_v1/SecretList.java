...
import com.pulumi.kubernetes.core_v1.SecretListArgs;
import com.pulumi.kubernetes.core_v1.outputs.Secret;
...
public class SecretList extends CustomResource {
    /**
     ...
     */
    public SecretList(String name, SecretListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:core/v1:SecretList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private SecretList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SecretList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
