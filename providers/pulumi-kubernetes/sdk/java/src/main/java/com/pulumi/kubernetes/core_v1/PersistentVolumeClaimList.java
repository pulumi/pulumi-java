...
public class PersistentVolumeClaimList extends CustomResource {
    /**
     ...
     */
    public PersistentVolumeClaimList(String name, PersistentVolumeClaimListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:core/v1:PersistentVolumeClaimList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private PersistentVolumeClaimList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PersistentVolumeClaimList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
