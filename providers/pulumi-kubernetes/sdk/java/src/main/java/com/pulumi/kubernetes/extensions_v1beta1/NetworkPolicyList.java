...
import com.pulumi.kubernetes.extensions_v1beta1.NetworkPolicyListArgs;
import com.pulumi.kubernetes.extensions_v1beta1.outputs.NetworkPolicy;
...
public class NetworkPolicyList extends CustomResource {
    /**
     ...
     */
    public NetworkPolicyList(String name, NetworkPolicyListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:NetworkPolicyList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private NetworkPolicyList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkPolicyList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
