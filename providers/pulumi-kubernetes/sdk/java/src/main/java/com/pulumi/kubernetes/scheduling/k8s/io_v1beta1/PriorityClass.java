...
import com.pulumi.kubernetes.scheduling.k8s.io_v1beta1.PriorityClassArgs;
...
public class PriorityClass extends CustomResource {
     ...
     */
    public PriorityClass(String name, PriorityClassArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:scheduling.k8s.io/v1beta1:PriorityClass", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private PriorityClass(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PriorityClass get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
