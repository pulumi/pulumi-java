...
import com.pulumi.kubernetes.networking.k8s.io_v1beta1.inputs.IngressArgs;
...
public final class IngressListArgs extends ResourceArgs {
    ...
    private IngressListArgs(IngressListArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(IngressListArgs defaults) {
            $ = new IngressListArgs(Objects.requireNonNull(defaults));
        }
