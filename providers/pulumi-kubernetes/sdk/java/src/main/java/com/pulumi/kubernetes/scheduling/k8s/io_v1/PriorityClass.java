...
package com.pulumi.kubernetes.scheduling.k8s.io_v1;
...
import com.pulumi.kubernetes.scheduling.k8s.io_v1.PriorityClassArgs;
...
public class PriorityClass extends CustomResource {
    ...
    public PriorityClass(String name, PriorityClassArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:scheduling.k8s.io/v1:PriorityClass", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
