...
import com.pulumi.kubernetes.certificates.k8s.io_v1.CertificateSigningRequestArgs;
...
public class CertificateSigningRequest extends CustomResource {
    /**
     ...
     */
    public CertificateSigningRequest(String name, CertificateSigningRequestArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CertificateSigningRequest(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CertificateSigningRequest get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
