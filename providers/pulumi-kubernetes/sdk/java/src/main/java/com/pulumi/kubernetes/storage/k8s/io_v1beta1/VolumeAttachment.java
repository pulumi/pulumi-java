...
import com.pulumi.kubernetes.storage.k8s.io_v1beta1.VolumeAttachmentArgs;
import com.pulumi.kubernetes.storage.k8s.io_v1beta1.outputs.VolumeAttachmentSpec;
import com.pulumi.kubernetes.storage.k8s.io_v1beta1.outputs.VolumeAttachmentStatus;
...
public class VolumeAttachment extends com.pulumi.resources.CustomResource {
    ...
    public VolumeAttachment(String name, VolumeAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1beta1:VolumeAttachment", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
