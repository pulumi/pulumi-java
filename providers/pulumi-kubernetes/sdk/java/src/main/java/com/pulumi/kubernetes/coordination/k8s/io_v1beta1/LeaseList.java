...
public class LeaseList extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public static LeaseList get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
