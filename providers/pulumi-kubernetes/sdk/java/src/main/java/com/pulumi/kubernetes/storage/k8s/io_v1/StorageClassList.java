...
import com.pulumi.kubernetes.storage.k8s.io_v1.StorageClassListArgs;
import com.pulumi.kubernetes.storage.k8s.io_v1.outputs.StorageClass;
 ...
 * 
 */
@ResourceType(type="kubernetes:storage.k8s.io/v1:StorageClassList")
