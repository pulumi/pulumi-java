...
import com.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1beta2.inputs.PriorityLevelConfigurationArgs;
...
public final class PriorityLevelConfigurationListArgs extends ResourceArgs {
    ...
    private PriorityLevelConfigurationListArgs(PriorityLevelConfigurationListArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PriorityLevelConfigurationListArgs();
        }

        public Builder(PriorityLevelConfigurationListArgs defaults) {
            $ = new PriorityLevelConfigurationListArgs(Objects.requireNonNull(defaults));
        }
