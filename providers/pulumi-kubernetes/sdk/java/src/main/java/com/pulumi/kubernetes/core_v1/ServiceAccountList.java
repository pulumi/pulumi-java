...
import com.pulumi.kubernetes.core_v1.ServiceAccountListArgs;
import com.pulumi.kubernetes.core_v1.outputs.ServiceAccount;
...
public class ServiceAccountList extends CustomResource {
    /**
     ...
     * 
     */
    @Export(name="items", type=List.class, parameters={ServiceAccount.class})
     ...
     * 
     */
    public Output<List<ServiceAccount>> items() {
        return this.items;
    }
    /**
     ...
     */
    public ServiceAccountList(String name) {
        this(name, ServiceAccountListArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ServiceAccountList(String name, ServiceAccountListArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ServiceAccountList(String name, ServiceAccountListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:core/v1:ServiceAccountList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ServiceAccountList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceAccountList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
