...
import com.pulumi.kubernetes.core_v1.outputs.ContainerPort;
import com.pulumi.kubernetes.core_v1.outputs.EnvFromSource;
import com.pulumi.kubernetes.core_v1.outputs.EnvVar;
import com.pulumi.kubernetes.core_v1.outputs.Lifecycle;
import com.pulumi.kubernetes.core_v1.outputs.Probe;
import com.pulumi.kubernetes.core_v1.outputs.ResourceRequirements;
import com.pulumi.kubernetes.core_v1.outputs.SecurityContext;
import com.pulumi.kubernetes.core_v1.outputs.VolumeDevice;
import com.pulumi.kubernetes.core_v1.outputs.VolumeMount;
...
public final class Container {
    ...
    private final @Nullable List<EnvFromSource> envFrom;
        /**
         * @return Docker image name. More info: https://kubernetes.io/docs/concepts/containers/images This field is optional to allow higher level config management to default or override container images in workload controllers like Deployments and StatefulSets.
         * 
         */
