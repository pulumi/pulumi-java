...
import com.pulumi.kubernetes.core_v1.ServiceListArgs;
import com.pulumi.kubernetes.core_v1.outputs.Service;
...
public class ServiceList extends CustomResource {
    /**
     ...
     * 
     */
    @Export(name="items", type=List.class, parameters={Service.class})
     ...
     */
    public ServiceList(String name, ServiceListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:core/v1:ServiceList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ServiceList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
