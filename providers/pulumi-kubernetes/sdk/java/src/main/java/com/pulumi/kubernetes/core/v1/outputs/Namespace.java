...
import com.pulumi.kubernetes.core.v1.outputs.NamespaceSpec;
import com.pulumi.kubernetes.core.v1.outputs.NamespaceStatus;
...
public final class Namespace {
    ...
    private Namespace(
        ...
        @CustomType.Parameter("spec") @Nullable NamespaceSpec spec,
        @CustomType.Parameter("status") @Nullable NamespaceStatus status) {
     ...
     * 
     */
    public Optional<NamespaceSpec> spec() {
