...
import com.pulumi.kubernetes.admissionregistration.k8s.io_v1.outputs.RuleWithOperations;
import com.pulumi.kubernetes.admissionregistration.k8s.io_v1.outputs.WebhookClientConfig;
...
public final class ValidatingWebhook {
    ...
    private ValidatingWebhook(
        @CustomType.Parameter("admissionReviewVersions") List<String> admissionReviewVersions,
        ...
        @CustomType.Parameter("sideEffects") String sideEffects,
