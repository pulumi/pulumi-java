...
import com.pulumi.kubernetes.coordination.k8s.io_v1.LeaseArgs;
...
public class Lease extends CustomResource {
    /**
     ...
     * 
     */
    public Output<Optional<LeaseSpec>> spec() {
     ...
     */
    public Lease(String name, @Nullable LeaseArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:coordination.k8s.io/v1:Lease", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private Lease(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Lease get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
