...
import com.pulumi.kubernetes.auditregistration.k8s.io_v1alpha1.AuditSinkArgs;
...
public class AuditSink extends CustomResource {
     ...
     */
    public AuditSink(String name, @Nullable AuditSinkArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AuditSink(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AuditSink get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
