...
public final class TopologySpreadConstraint {
     ...
     * 
     */
    private final @Nullable Integer minDomains;
    /**
    ...
    private TopologySpreadConstraint(
        ...
        @CustomType.Parameter("minDomains") @Nullable Integer minDomains,
    ...
    public static final class Builder {
        ...
        public Builder whenUnsatisfiable(String whenUnsatisfiable) {
            ...
            return new TopologySpreadConstraint(labelSelector, maxSkew, minDomains, topologyKey, whenUnsatisfiable);
        }
    }
}
