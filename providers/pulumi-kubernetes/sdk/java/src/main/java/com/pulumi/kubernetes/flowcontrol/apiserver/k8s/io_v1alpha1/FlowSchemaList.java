...
import com.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1alpha1.FlowSchemaListArgs;
import com.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1alpha1.outputs.FlowSchema;
...
public class FlowSchemaList extends CustomResource {
    /**
     ...
     */
    public FlowSchemaList(String name, FlowSchemaListArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FlowSchemaList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FlowSchemaList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
