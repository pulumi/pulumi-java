...
import com.pulumi.kubernetes.core_v1.ResourceQuotaArgs;
import com.pulumi.kubernetes.core_v1.outputs.ResourceQuotaSpec;
import com.pulumi.kubernetes.core_v1.outputs.ResourceQuotaStatus;
...
public class ResourceQuota extends CustomResource {
    /**
     ...
     * 
     */
    public Output<Optional<ResourceQuotaSpec>> spec() {
     ...
     */
    public ResourceQuota(String name, @Nullable ResourceQuotaArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:core/v1:ResourceQuota", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ResourceQuota(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResourceQuota get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
