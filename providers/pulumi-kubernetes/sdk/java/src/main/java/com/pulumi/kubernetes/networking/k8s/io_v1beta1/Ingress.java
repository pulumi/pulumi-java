...
import com.pulumi.kubernetes.networking.k8s.io_v1beta1.IngressArgs;
import com.pulumi.kubernetes.networking.k8s.io_v1beta1.outputs.IngressSpec;
import com.pulumi.kubernetes.networking.k8s.io_v1beta1.outputs.IngressStatus;
...
public class Ingress extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    public Output</* @Nullable */ IngressSpec> spec() {
        return this.spec;
    }
    /**
     ...
     * 
     */
    public Output</* @Nullable */ IngressStatus> status() {
        return this.status;
    }
    ...
    public Ingress(String name, @Nullable IngressArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1beta1:Ingress", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
