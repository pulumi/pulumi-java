...
import com.pulumi.kubernetes.networking.k8s.io_v1.IngressListArgs;
import com.pulumi.kubernetes.networking.k8s.io_v1.outputs.Ingress;
...
public class IngressList extends CustomResource {
     ...
     */
    public IngressList(String name, IngressListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1:IngressList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private IngressList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IngressList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
