...
import com.pulumi.kubernetes.admissionregistration.k8s.io_v1beta1.ValidatingWebhookConfigurationArgs;
...
public class ValidatingWebhookConfiguration extends CustomResource {
    /**
     ...
     */
    public ValidatingWebhookConfiguration(String name, @Nullable ValidatingWebhookConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ValidatingWebhookConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ValidatingWebhookConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
