...
import com.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.ClusterRoleArgs;
import com.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.outputs.AggregationRule;
...
public class ClusterRole extends CustomResource {
    ...
    public ClusterRole(String name, @Nullable ClusterRoleArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRole", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
