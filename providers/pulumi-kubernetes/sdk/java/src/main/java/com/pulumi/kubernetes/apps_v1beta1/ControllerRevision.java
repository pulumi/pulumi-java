...
import com.pulumi.kubernetes.apps_v1beta1.ControllerRevisionArgs;
...
public class ControllerRevision extends CustomResource {
    ...
    public ControllerRevision(String name, ControllerRevisionArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:apps/v1beta1:ControllerRevision", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
