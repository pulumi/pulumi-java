...
public class LimitRangeList extends CustomResource {
    /**
     ...
     */
    public LimitRangeList(String name, LimitRangeListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:core/v1:LimitRangeList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private LimitRangeList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LimitRangeList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
