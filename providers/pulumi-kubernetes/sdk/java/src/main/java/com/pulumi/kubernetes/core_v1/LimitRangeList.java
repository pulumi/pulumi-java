...
import com.pulumi.kubernetes.core_v1.LimitRangeListArgs;
import com.pulumi.kubernetes.core_v1.outputs.LimitRange;
...
public class LimitRangeList extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LimitRangeList(String name, LimitRangeListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:LimitRangeList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private LimitRangeList(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static LimitRangeList get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
