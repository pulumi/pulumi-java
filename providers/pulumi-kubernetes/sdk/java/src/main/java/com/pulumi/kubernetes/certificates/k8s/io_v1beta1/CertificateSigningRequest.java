...
import com.pulumi.kubernetes.certificates.k8s.io_v1beta1.CertificateSigningRequestArgs;
...
public class CertificateSigningRequest extends CustomResource {
     ...
     */
    public CertificateSigningRequest(String name, @Nullable CertificateSigningRequestArgs args, @Nullable CustomResourceOptions options) {
