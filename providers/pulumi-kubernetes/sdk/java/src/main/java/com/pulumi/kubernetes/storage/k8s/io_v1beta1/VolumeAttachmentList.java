...
import com.pulumi.kubernetes.storage.k8s.io_v1beta1.VolumeAttachmentListArgs;
import com.pulumi.kubernetes.storage.k8s.io_v1beta1.outputs.VolumeAttachment;
 ...
 * 
 */
@ResourceType(type="kubernetes:storage.k8s.io/v1beta1:VolumeAttachmentList")
public class VolumeAttachmentList extends CustomResource {
    /**
     ...
     */
    public VolumeAttachmentList(String name, VolumeAttachmentListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1beta1:VolumeAttachmentList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private VolumeAttachmentList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1beta1:VolumeAttachmentList", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static VolumeAttachmentList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
