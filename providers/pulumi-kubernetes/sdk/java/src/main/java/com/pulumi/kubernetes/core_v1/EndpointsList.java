...
public class EndpointsList extends CustomResource {
    /**
     ...
     */
    public EndpointsList(String name, EndpointsListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:core/v1:EndpointsList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private EndpointsList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EndpointsList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
