...
import com.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.ClusterRoleBindingListArgs;
import com.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.outputs.ClusterRoleBinding;
...
public class ClusterRoleBindingList extends CustomResource {
    /**
     ...
     */
    public ClusterRoleBindingList(String name, ClusterRoleBindingListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBindingList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ClusterRoleBindingList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ClusterRoleBindingList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
