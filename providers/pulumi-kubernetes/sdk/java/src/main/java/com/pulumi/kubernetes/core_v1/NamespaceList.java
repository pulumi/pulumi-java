...
import com.pulumi.kubernetes.core_v1.NamespaceListArgs;
import com.pulumi.kubernetes.core_v1.outputs.Namespace;
...
public class NamespaceList extends CustomResource {
    /**
     ...
     */
    public NamespaceList(String name, NamespaceListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:core/v1:NamespaceList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private NamespaceList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NamespaceList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
