...
import com.pulumi.kubernetes.rbac.authorization.k8s.io_v1beta1.RoleBindingArgs;
...
public class RoleBinding extends CustomResource {
    ...
    public RoleBinding(String name, RoleBindingArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1beta1:RoleBinding", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
