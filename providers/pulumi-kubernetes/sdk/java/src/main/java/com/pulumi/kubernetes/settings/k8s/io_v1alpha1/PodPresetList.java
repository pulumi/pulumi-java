...
package com.pulumi.kubernetes.settings.k8s.io_v1alpha1;
...
import com.pulumi.kubernetes.settings.k8s.io_v1alpha1.PodPresetListArgs;
import com.pulumi.kubernetes.settings.k8s.io_v1alpha1.outputs.PodPreset;
...
public class PodPresetList extends CustomResource {
    /**
     ...
     */
    public PodPresetList(String name, PodPresetListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:settings.k8s.io/v1alpha1:PodPresetList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private PodPresetList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PodPresetList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
