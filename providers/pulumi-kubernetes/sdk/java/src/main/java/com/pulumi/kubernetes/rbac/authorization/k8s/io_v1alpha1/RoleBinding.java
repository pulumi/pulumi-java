...
import com.pulumi.kubernetes.rbac.authorization.k8s.io_v1alpha1.RoleBindingArgs;
 ...
 * 
 */
@ResourceType(type="kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleBinding")
public class RoleBinding extends CustomResource {
    /**
     ...
     */
    public RoleBinding(String name, RoleBindingArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleBinding", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private RoleBinding(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleBinding", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static RoleBinding get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
