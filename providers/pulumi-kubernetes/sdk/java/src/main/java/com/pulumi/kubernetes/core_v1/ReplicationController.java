...
import com.pulumi.kubernetes.core_v1.ReplicationControllerArgs;
...
public class ReplicationController extends CustomResource {
    /**
     ...
     */
    public ReplicationController(String name, @Nullable ReplicationControllerArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:core/v1:ReplicationController", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ReplicationController(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReplicationController get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
