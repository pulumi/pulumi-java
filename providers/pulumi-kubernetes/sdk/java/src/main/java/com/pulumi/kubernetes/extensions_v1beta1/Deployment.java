...
import com.pulumi.kubernetes.extensions_v1beta1.DeploymentArgs;
import com.pulumi.kubernetes.extensions_v1beta1.outputs.DeploymentSpec;
import com.pulumi.kubernetes.extensions_v1beta1.outputs.DeploymentStatus;
...
public class Deployment extends CustomResource {
    ...
    public Deployment(String name, @Nullable DeploymentArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:Deployment", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
