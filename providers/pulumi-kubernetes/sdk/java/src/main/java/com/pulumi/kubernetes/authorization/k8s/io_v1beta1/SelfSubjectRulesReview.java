...
import com.pulumi.kubernetes.authorization.k8s.io_v1beta1.SelfSubjectRulesReviewArgs;
import com.pulumi.kubernetes.authorization.k8s.io_v1beta1.outputs.SelfSubjectRulesReviewSpec;
import com.pulumi.kubernetes.authorization.k8s.io_v1beta1.outputs.SubjectRulesReviewStatus;
...
public class SelfSubjectRulesReview extends CustomResource {
    /**
     ...
     */
    public SelfSubjectRulesReview(String name, SelfSubjectRulesReviewArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SelfSubjectRulesReview(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SelfSubjectRulesReview get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
