...
import com.pulumi.kubernetes.autoscaling_v2beta1.HorizontalPodAutoscalerArgs;
import com.pulumi.kubernetes.autoscaling_v2beta1.outputs.HorizontalPodAutoscalerSpec;
import com.pulumi.kubernetes.autoscaling_v2beta1.outputs.HorizontalPodAutoscalerStatus;
...
public class HorizontalPodAutoscaler extends CustomResource {
    /**
     ...
     * 
     */
    public Output<Optional<HorizontalPodAutoscalerSpec>> spec() {
     ...
     */
    public HorizontalPodAutoscaler(String name, @Nullable HorizontalPodAutoscalerArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:autoscaling/v2beta1:HorizontalPodAutoscaler", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private HorizontalPodAutoscaler(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HorizontalPodAutoscaler get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
