...
import com.pulumi.kubernetes.admissionregistration.k8s.io_v1beta1.outputs.MutatingWebhook;
...
public final class MutatingWebhookConfiguration {
    ...
    private MutatingWebhookConfiguration(
        ...
        @CustomType.Parameter("webhooks") @Nullable List<MutatingWebhook> webhooks) {
