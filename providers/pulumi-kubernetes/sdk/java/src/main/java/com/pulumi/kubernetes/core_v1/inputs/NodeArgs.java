...
public final class NodeArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="spec")
    private @Nullable Output<NodeSpecArgs> spec;
     ...
     * 
     */
    public Optional<Output<NodeSpecArgs>> spec() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder spec(@Nullable Output<NodeSpecArgs> spec) {
            $.spec = spec;
            return this;
        }
         ...
         * 
         */
        public Builder spec(NodeSpecArgs spec) {
            return spec(Output.of(spec));
        }

        /**
         * @param status Most recently observed status of the node. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
         * 
         * @return builder
         * 
         */
