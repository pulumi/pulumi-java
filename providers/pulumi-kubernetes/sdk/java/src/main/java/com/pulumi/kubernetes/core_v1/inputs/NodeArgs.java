...
public final class NodeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Output<NodeSpecArgs> spec() {
    ...
    public Output<NodeStatusArgs> status() {
    ...
    public NodeArgs(
        ...
        @Nullable Output<NodeSpecArgs> spec,
        @Nullable Output<NodeStatusArgs> status) {
    ...
    public static final class Builder {
        ...
        public Builder spec(@Nullable NodeSpecArgs spec) {
        ...
        public Builder status(@Nullable NodeStatusArgs status) {
