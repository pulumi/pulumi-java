...
public class IngressClass extends CustomResource {
    /**
     ...
     */
    public IngressClass(String name, @Nullable IngressClassArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1beta1:IngressClass", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private IngressClass(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IngressClass get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
