...
import com.pulumi.kubernetes.core_v1.PersistentVolumeArgs;
...
public class PersistentVolume extends CustomResource {
    /**
     ...
     */
    public PersistentVolume(String name, @Nullable PersistentVolumeArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:core/v1:PersistentVolume", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private PersistentVolume(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PersistentVolume get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
