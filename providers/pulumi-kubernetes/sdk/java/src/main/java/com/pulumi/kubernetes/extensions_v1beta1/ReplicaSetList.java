...
import com.pulumi.kubernetes.extensions_v1beta1.ReplicaSetListArgs;
import com.pulumi.kubernetes.extensions_v1beta1.outputs.ReplicaSet;
...
public class ReplicaSetList extends CustomResource {
    /**
     ...
     */
    public ReplicaSetList(String name, ReplicaSetListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:ReplicaSetList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ReplicaSetList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReplicaSetList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
