...
public class NetworkPolicy extends CustomResource {
    /**
     ...
     * 
     */
    @Export(name="spec", type=NetworkPolicySpec.class, parameters={})
     ...
     */
    public NetworkPolicy(String name, @Nullable NetworkPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:networking.k8s.io/v1:NetworkPolicy", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private NetworkPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
