...
import com.pulumi.kubernetes.core_v1.EndpointsArgs;
...
public class Endpoints extends CustomResource {
    /**
     ...
     * 
     */
    public Output<Optional<List<EndpointSubset>>> subsets() {
     ...
     */
    public Endpoints(String name, @Nullable EndpointsArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:core/v1:Endpoints", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private Endpoints(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Endpoints get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
