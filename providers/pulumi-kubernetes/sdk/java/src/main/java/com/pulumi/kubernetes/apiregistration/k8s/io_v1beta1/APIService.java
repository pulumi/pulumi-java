...
import com.pulumi.kubernetes.apiregistration.k8s.io_v1beta1.APIServiceArgs;
import com.pulumi.kubernetes.apiregistration.k8s.io_v1beta1.outputs.APIServiceSpec;
import com.pulumi.kubernetes.apiregistration.k8s.io_v1beta1.outputs.APIServiceStatus;
...
public class APIService extends CustomResource {
    /**
     ...
     */
    public APIService(String name, @Nullable APIServiceArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:apiregistration.k8s.io/v1beta1:APIService", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private APIService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static APIService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
