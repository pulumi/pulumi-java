...
public final class ClusterRoleBindingListArgs extends ResourceArgs {
    ...
    private ClusterRoleBindingListArgs(ClusterRoleBindingListArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterRoleBindingListArgs();
        }

        public Builder(ClusterRoleBindingListArgs defaults) {
            $ = new ClusterRoleBindingListArgs(Objects.requireNonNull(defaults));
        }
