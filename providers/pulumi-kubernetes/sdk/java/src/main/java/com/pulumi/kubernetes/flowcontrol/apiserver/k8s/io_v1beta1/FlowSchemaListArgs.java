...
import com.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1beta1.inputs.FlowSchemaArgs;
...
public final class FlowSchemaListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="items", required=true)
      private final Output<List<FlowSchemaArgs>> items;
    ...
    public FlowSchemaListArgs(
        ...
        Output<List<FlowSchemaArgs>> items,
