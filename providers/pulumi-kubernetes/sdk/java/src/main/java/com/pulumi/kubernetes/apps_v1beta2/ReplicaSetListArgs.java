...
import com.pulumi.kubernetes.apps_v1beta2.inputs.ReplicaSetArgs;
...
public final class ReplicaSetListArgs extends ResourceArgs {
    ...
    private ReplicaSetListArgs(ReplicaSetListArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReplicaSetListArgs();
        }

        public Builder(ReplicaSetListArgs defaults) {
            $ = new ReplicaSetListArgs(Objects.requireNonNull(defaults));
        }
