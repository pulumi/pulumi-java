...
package com.pulumi.kubernetes.admissionregistration.k8s.io_v1beta1;
...
import com.pulumi.kubernetes.admissionregistration.k8s.io_v1beta1.ValidatingWebhookConfigurationListArgs;
import com.pulumi.kubernetes.admissionregistration.k8s.io_v1beta1.outputs.ValidatingWebhookConfiguration;
...
public class ValidatingWebhookConfigurationList extends CustomResource {
    /**
     ...
     */
    public ValidatingWebhookConfigurationList(String name, ValidatingWebhookConfigurationListArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ValidatingWebhookConfigurationList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ValidatingWebhookConfigurationList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
