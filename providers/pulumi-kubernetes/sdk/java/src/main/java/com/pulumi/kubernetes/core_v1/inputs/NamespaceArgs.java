...
public final class NamespaceArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<NamespaceStatusArgs>> status() {
    ...
    public static final class Builder {
        ...
        /**
         * @param status Status describes the current status of a Namespace. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder status(NamespaceStatusArgs status) {
