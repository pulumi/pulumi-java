...
import com.pulumi.kubernetes.apps_v1.DaemonSetListArgs;
import com.pulumi.kubernetes.apps_v1.outputs.DaemonSet;
...
public class DaemonSetList extends CustomResource {
    /**
     ...
     */
    public DaemonSetList(String name, DaemonSetListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:apps/v1:DaemonSetList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private DaemonSetList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DaemonSetList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
