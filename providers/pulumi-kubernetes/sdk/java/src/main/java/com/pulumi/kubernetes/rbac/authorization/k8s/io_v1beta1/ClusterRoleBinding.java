...
import com.pulumi.kubernetes.rbac.authorization.k8s.io_v1beta1.ClusterRoleBindingArgs;
import com.pulumi.kubernetes.rbac.authorization.k8s.io_v1beta1.outputs.RoleRef;
import com.pulumi.kubernetes.rbac.authorization.k8s.io_v1beta1.outputs.Subject;
 ...
 * 
 */
@ResourceType(type="kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRoleBinding")
public class ClusterRoleBinding extends CustomResource {
    /**
     ...
     */
    public ClusterRoleBinding(String name, ClusterRoleBindingArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRoleBinding", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ClusterRoleBinding(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRoleBinding", name, null, makeResourceOptions(options, id));
    }
    ...
    private static CustomResourceOptions makeResourceOptions(@Nullable CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBinding").build())
            ))
            .build();
     ...
     */
    public static ClusterRoleBinding get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
