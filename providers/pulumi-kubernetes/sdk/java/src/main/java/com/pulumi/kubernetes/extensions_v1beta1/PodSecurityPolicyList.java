...
import com.pulumi.kubernetes.extensions_v1beta1.PodSecurityPolicyListArgs;
import com.pulumi.kubernetes.extensions_v1beta1.outputs.PodSecurityPolicy;
...
public class PodSecurityPolicyList extends CustomResource {
    /**
     ...
     */
    public PodSecurityPolicyList(String name, PodSecurityPolicyListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:PodSecurityPolicyList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private PodSecurityPolicyList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PodSecurityPolicyList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
