...
import com.pulumi.kubernetes.storage.k8s.io_v1beta1.StorageClassListArgs;
import com.pulumi.kubernetes.storage.k8s.io_v1beta1.outputs.StorageClass;
...
public class StorageClassList extends CustomResource {
    /**
     ...
     */
    public StorageClassList(String name, StorageClassListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:storage.k8s.io/v1beta1:StorageClassList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private StorageClassList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StorageClassList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
