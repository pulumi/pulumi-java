...
public class StorageClassList extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public static StorageClassList get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
