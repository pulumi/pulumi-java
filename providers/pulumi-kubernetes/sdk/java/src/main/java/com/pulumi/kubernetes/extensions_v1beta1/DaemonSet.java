...
public class DaemonSet extends CustomResource {
    /**
     ...
     */
    public DaemonSet(String name, @Nullable DaemonSetArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:DaemonSet", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private DaemonSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DaemonSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
