...
import com.pulumi.kubernetes.extensions_v1beta1.DaemonSetArgs;
import com.pulumi.kubernetes.extensions_v1beta1.outputs.DaemonSetSpec;
import com.pulumi.kubernetes.extensions_v1beta1.outputs.DaemonSetStatus;
...
public class DaemonSet extends com.pulumi.resources.CustomResource {
     ...
     */
    public DaemonSet(String name, @Nullable DaemonSetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:extensions/v1beta1:DaemonSet", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private DaemonSet(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static DaemonSet get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
