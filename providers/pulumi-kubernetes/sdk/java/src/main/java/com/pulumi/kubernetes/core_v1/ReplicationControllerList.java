...
import com.pulumi.kubernetes.core_v1.ReplicationControllerListArgs;
import com.pulumi.kubernetes.core_v1.outputs.ReplicationController;
...
public class ReplicationControllerList extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="items", type=List.class, parameters={ReplicationController.class})
     ...
     */
    public ReplicationControllerList(String name, ReplicationControllerListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes:core/v1:ReplicationControllerList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ReplicationControllerList(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ReplicationControllerList get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
