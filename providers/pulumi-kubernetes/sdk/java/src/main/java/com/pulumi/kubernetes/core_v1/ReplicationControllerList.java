...
public class ReplicationControllerList extends CustomResource {
    /**
     ...
     */
    public ReplicationControllerList(String name, ReplicationControllerListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:core/v1:ReplicationControllerList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ReplicationControllerList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReplicationControllerList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
