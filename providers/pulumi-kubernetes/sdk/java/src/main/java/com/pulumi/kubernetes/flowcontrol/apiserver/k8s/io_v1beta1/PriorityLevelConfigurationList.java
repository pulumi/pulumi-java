...
package com.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1beta1;
...
import com.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1beta1.PriorityLevelConfigurationListArgs;
import com.pulumi.kubernetes.flowcontrol.apiserver.k8s.io_v1beta1.outputs.PriorityLevelConfiguration;
...
public class PriorityLevelConfigurationList extends CustomResource {
    /**
     ...
     */
    public PriorityLevelConfigurationList(String name, PriorityLevelConfigurationListArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PriorityLevelConfigurationList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PriorityLevelConfigurationList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
