...
import com.pulumi.kubernetes.node.k8s.io_v1beta1.RuntimeClassListArgs;
import com.pulumi.kubernetes.node.k8s.io_v1beta1.outputs.RuntimeClass;
...
public class RuntimeClassList extends CustomResource {
     ...
     */
    public RuntimeClassList(String name, RuntimeClassListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:node.k8s.io/v1beta1:RuntimeClassList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private RuntimeClassList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RuntimeClassList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
