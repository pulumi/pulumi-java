...
import com.pulumi.kubernetes.apiregistration.k8s.io_v1.inputs.APIServiceArgs;
...
public final class APIServiceListArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private APIServiceListArgs(APIServiceListArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new APIServiceListArgs();
        }

        public Builder(APIServiceListArgs defaults) {
            $ = new APIServiceListArgs(Objects.requireNonNull(defaults));
        }
