...
package com.pulumi.kubernetes.batch_v1;
...
import com.pulumi.kubernetes.batch_v1.JobListArgs;
import com.pulumi.kubernetes.batch_v1.outputs.Job;
...
public class JobList extends CustomResource {
    /**
     ...
     */
    public JobList(String name, JobListArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:batch/v1:JobList", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private JobList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static JobList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
