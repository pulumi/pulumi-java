...
public class JobList extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public static JobList get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
