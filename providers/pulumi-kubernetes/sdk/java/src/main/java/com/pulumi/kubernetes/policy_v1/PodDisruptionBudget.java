...
import com.pulumi.kubernetes.policy_v1.PodDisruptionBudgetArgs;
import com.pulumi.kubernetes.policy_v1.outputs.PodDisruptionBudgetSpec;
import com.pulumi.kubernetes.policy_v1.outputs.PodDisruptionBudgetStatus;
...
public class PodDisruptionBudget extends CustomResource {
    /**
     ...
     */
    public PodDisruptionBudget(String name, @Nullable PodDisruptionBudgetArgs args, @Nullable CustomResourceOptions options) {
        super("kubernetes:policy/v1:PodDisruptionBudget", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private PodDisruptionBudget(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PodDisruptionBudget get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
