...
import com.pulumi.kubernetes.batch_v2alpha1.inputs.CronJobSpecArgs;
import com.pulumi.kubernetes.batch_v2alpha1.inputs.CronJobStatusArgs;
 ...
 * 
 */
public final class CronJobArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<CronJobSpecArgs>> spec() {
     ...
     * 
     */
    public Optional<Output<CronJobStatusArgs>> status() {
        return Optional.ofNullable(this.status);
    }

    private CronJobArgs() {}

    private CronJobArgs(CronJobArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(CronJobArgs defaults) {
            $ = new CronJobArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder spec(CronJobSpecArgs spec) {
         ...
         * 
         */
        public Builder status(CronJobStatusArgs status) {
