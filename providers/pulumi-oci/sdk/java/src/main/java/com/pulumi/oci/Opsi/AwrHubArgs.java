...
public final class AwrHubArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwrHubArgs Empty = new AwrHubArgs();
    ...
    public static Builder builder(AwrHubArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AwrHubArgs defaults) {
            $ = new AwrHubArgs(Objects.requireNonNull(defaults));
        }
