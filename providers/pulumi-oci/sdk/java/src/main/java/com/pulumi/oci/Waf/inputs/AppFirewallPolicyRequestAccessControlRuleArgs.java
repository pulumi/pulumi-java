...
public final class AppFirewallPolicyRequestAccessControlRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppFirewallPolicyRequestAccessControlRuleArgs Empty = new AppFirewallPolicyRequestAccessControlRuleArgs();
    ...
    private AppFirewallPolicyRequestAccessControlRuleArgs() {}

    private AppFirewallPolicyRequestAccessControlRuleArgs(AppFirewallPolicyRequestAccessControlRuleArgs $) {
    ...
    public static Builder builder(AppFirewallPolicyRequestAccessControlRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFirewallPolicyRequestAccessControlRuleArgs();
        }

        public Builder(AppFirewallPolicyRequestAccessControlRuleArgs defaults) {
            $ = new AppFirewallPolicyRequestAccessControlRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppFirewallPolicyRequestAccessControlRuleArgs build() {
