...
public final class GetRegistryConnectionsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetRegistryConnectionsPlainArgs Empty = new GetRegistryConnectionsPlainArgs();
    ...
    private GetRegistryConnectionsPlainArgs() {}

    private GetRegistryConnectionsPlainArgs(GetRegistryConnectionsPlainArgs $) {
    ...
    public static Builder builder(GetRegistryConnectionsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRegistryConnectionsPlainArgs();
        }

        public Builder(GetRegistryConnectionsPlainArgs defaults) {
            $ = new GetRegistryConnectionsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRegistryConnectionsPlainArgs build() {
