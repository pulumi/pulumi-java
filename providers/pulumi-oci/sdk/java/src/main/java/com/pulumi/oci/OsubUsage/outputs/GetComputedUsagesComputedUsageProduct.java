...
@CustomType
public final class GetComputedUsagesComputedUsageProduct {
    /**
    ...
    private GetComputedUsagesComputedUsageProduct(
    ...
    public static Builder builder(GetComputedUsagesComputedUsageProduct defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetComputedUsagesComputedUsageProduct defaults) {
        ...
        public Builder unitOfMeasure(String unitOfMeasure) {
            ...
            return new GetComputedUsagesComputedUsageProduct(billingCategory, name, partNumber, productCategory, provisioningGroup, ucmRateCardPartType, unitOfMeasure);
        }
    }
}
