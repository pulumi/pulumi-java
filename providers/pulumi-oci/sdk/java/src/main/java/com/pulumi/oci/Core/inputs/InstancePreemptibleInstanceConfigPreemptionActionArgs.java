...
public final class InstancePreemptibleInstanceConfigPreemptionActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstancePreemptibleInstanceConfigPreemptionActionArgs Empty = new InstancePreemptibleInstanceConfigPreemptionActionArgs();
    ...
    private InstancePreemptibleInstanceConfigPreemptionActionArgs() {}

    private InstancePreemptibleInstanceConfigPreemptionActionArgs(InstancePreemptibleInstanceConfigPreemptionActionArgs $) {
    ...
    public static Builder builder(InstancePreemptibleInstanceConfigPreemptionActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstancePreemptibleInstanceConfigPreemptionActionArgs();
        }

        public Builder(InstancePreemptibleInstanceConfigPreemptionActionArgs defaults) {
            $ = new InstancePreemptibleInstanceConfigPreemptionActionArgs(Objects.requireNonNull(defaults));
        }
