...
public final class DatabaseToolsConnectionKeyStoreKeyStoreContentArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DatabaseToolsConnectionKeyStoreKeyStoreContentArgs() {}

    private DatabaseToolsConnectionKeyStoreKeyStoreContentArgs(DatabaseToolsConnectionKeyStoreKeyStoreContentArgs $) {
    ...
    public static Builder builder(DatabaseToolsConnectionKeyStoreKeyStoreContentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatabaseToolsConnectionKeyStoreKeyStoreContentArgs();
        }

        public Builder(DatabaseToolsConnectionKeyStoreKeyStoreContentArgs defaults) {
            $ = new DatabaseToolsConnectionKeyStoreKeyStoreContentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DatabaseToolsConnectionKeyStoreKeyStoreContentArgs build() {
