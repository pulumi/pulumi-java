...
public final class GetModelDeploymentsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetModelDeploymentsPlainArgs Empty = new GetModelDeploymentsPlainArgs();
    ...
    public Optional<List<GetModelDeploymentsFilter>> filters() {
    ...
    private GetModelDeploymentsPlainArgs() {}

    private GetModelDeploymentsPlainArgs(GetModelDeploymentsPlainArgs $) {
    ...
    public static Builder builder(GetModelDeploymentsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetModelDeploymentsPlainArgs();
        }

        public Builder(GetModelDeploymentsPlainArgs defaults) {
            $ = new GetModelDeploymentsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetModelDeploymentsPlainArgs build() {
