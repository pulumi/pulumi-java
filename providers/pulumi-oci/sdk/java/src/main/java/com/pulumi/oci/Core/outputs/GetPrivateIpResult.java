...
public final class GetPrivateIpResult {
    ...
    public static final class Builder {
        ...
        public Builder vnicId(String vnicId) {
            ...
            return new GetPrivateIpResult(availabilityDomain, compartmentId, definedTags, displayName, freeformTags, hostnameLabel, id, ipAddress, isPrimary, isReserved, privateIpId, subnetId, timeCreated, vlanId, vnicId);
        }
    }
}
