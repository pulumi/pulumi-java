...
import com.pulumi.oci.Database.inputs.DbSystemDbHomeDatabaseDbBackupConfigBackupDestinationDetailArgs;
...
public final class DbSystemDbHomeDatabaseDbBackupConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final DbSystemDbHomeDatabaseDbBackupConfigArgs Empty = new DbSystemDbHomeDatabaseDbBackupConfigArgs();
    ...
    private @Nullable Output<List<DbSystemDbHomeDatabaseDbBackupConfigBackupDestinationDetailArgs>> backupDestinationDetails;

    /**
     * @return (Updatable) Backup destination details.
     * 
     */
    public Optional<Output<List<DbSystemDbHomeDatabaseDbBackupConfigBackupDestinationDetailArgs>>> backupDestinationDetails() {
    ...
    private DbSystemDbHomeDatabaseDbBackupConfigArgs() {}

    private DbSystemDbHomeDatabaseDbBackupConfigArgs(DbSystemDbHomeDatabaseDbBackupConfigArgs $) {
    ...
    public static Builder builder(DbSystemDbHomeDatabaseDbBackupConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DbSystemDbHomeDatabaseDbBackupConfigArgs();
        }

        public Builder(DbSystemDbHomeDatabaseDbBackupConfigArgs defaults) {
            $ = new DbSystemDbHomeDatabaseDbBackupConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder backupDestinationDetails(@Nullable Output<List<DbSystemDbHomeDatabaseDbBackupConfigBackupDestinationDetailArgs>> backupDestinationDetails) {
         ...
         * 
         */
        public Builder backupDestinationDetails(List<DbSystemDbHomeDatabaseDbBackupConfigBackupDestinationDetailArgs> backupDestinationDetails) {
         ...
         * 
         */
        public Builder backupDestinationDetails(DbSystemDbHomeDatabaseDbBackupConfigBackupDestinationDetailArgs... backupDestinationDetails) {
        ...
        public DbSystemDbHomeDatabaseDbBackupConfigArgs build() {
            return $;
        }
    }
