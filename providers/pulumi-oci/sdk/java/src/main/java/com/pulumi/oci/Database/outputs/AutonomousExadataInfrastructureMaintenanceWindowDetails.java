...
import com.pulumi.oci.Database.outputs.AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeek;
import com.pulumi.oci.Database.outputs.AutonomousExadataInfrastructureMaintenanceWindowDetailsMonth;
...
@CustomType
public final class AutonomousExadataInfrastructureMaintenanceWindowDetails {
    /**
     ...
     * 
     */
    private final @Nullable List<AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeek> daysOfWeeks;
    /**
     ...
     * 
     */
    private final @Nullable List<AutonomousExadataInfrastructureMaintenanceWindowDetailsMonth> months;
    /**
    ...
    private AutonomousExadataInfrastructureMaintenanceWindowDetails(
        @CustomType.Parameter("customActionTimeoutInMins") @Nullable Integer customActionTimeoutInMins,
        @CustomType.Parameter("daysOfWeeks") @Nullable List<AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeek> daysOfWeeks,
        ...
        @CustomType.Parameter("months") @Nullable List<AutonomousExadataInfrastructureMaintenanceWindowDetailsMonth> months,
     ...
     * 
     */
    public List<AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeek> daysOfWeeks() {
     ...
     * 
     */
    public List<AutonomousExadataInfrastructureMaintenanceWindowDetailsMonth> months() {
    ...
    public static Builder builder(AutonomousExadataInfrastructureMaintenanceWindowDetails defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable Integer customActionTimeoutInMins;
        private @Nullable List<AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeek> daysOfWeeks;
        ...
        private @Nullable List<AutonomousExadataInfrastructureMaintenanceWindowDetailsMonth> months;
        ...
        public Builder(AutonomousExadataInfrastructureMaintenanceWindowDetails defaults) {
        ...
        public Builder daysOfWeeks(@Nullable List<AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeek> daysOfWeeks) {
            this.daysOfWeeks = daysOfWeeks;
            return this;
        }
        public Builder daysOfWeeks(AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeek... daysOfWeeks) {
        ...
        public Builder months(@Nullable List<AutonomousExadataInfrastructureMaintenanceWindowDetailsMonth> months) {
            this.months = months;
            return this;
        }
        public Builder months(AutonomousExadataInfrastructureMaintenanceWindowDetailsMonth... months) {
        ...
        }        public AutonomousExadataInfrastructureMaintenanceWindowDetails build() {
            return new AutonomousExadataInfrastructureMaintenanceWindowDetails(customActionTimeoutInMins, daysOfWeeks, hoursOfDays, isCustomActionTimeoutEnabled, leadTimeInWeeks, months, patchingMode, preference, weeksOfMonths);
        }
    }
}
