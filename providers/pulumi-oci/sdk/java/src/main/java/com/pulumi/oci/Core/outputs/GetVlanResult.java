...
public final class GetVlanResult {
    ...
    public static final class Builder {
        ...
        public Builder vlanTag(Integer vlanTag) {
            ...
            return new GetVlanResult(availabilityDomain, cidrBlock, compartmentId, definedTags, displayName, freeformTags, id, nsgIds, routeTableId, state, timeCreated, vcnId, vlanId, vlanTag);
        }
    }
}
