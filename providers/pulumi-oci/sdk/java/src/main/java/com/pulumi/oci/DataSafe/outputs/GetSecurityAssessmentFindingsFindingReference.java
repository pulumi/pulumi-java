...
@CustomType
public final class GetSecurityAssessmentFindingsFindingReference {
    /**
    ...
    private GetSecurityAssessmentFindingsFindingReference(
    ...
    public static Builder builder(GetSecurityAssessmentFindingsFindingReference defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetSecurityAssessmentFindingsFindingReference defaults) {
        ...
        public Builder stig(String stig) {
            ...
            return new GetSecurityAssessmentFindingsFindingReference(cis, gdpr, stig);
        }
    }
}
