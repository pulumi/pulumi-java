...
public final class PluggableDatabasesRemoteCloneConnectionStringArgs extends com.pulumi.resources.ResourceArgs {

    public static final PluggableDatabasesRemoteCloneConnectionStringArgs Empty = new PluggableDatabasesRemoteCloneConnectionStringArgs();
    ...
    private PluggableDatabasesRemoteCloneConnectionStringArgs() {}

    private PluggableDatabasesRemoteCloneConnectionStringArgs(PluggableDatabasesRemoteCloneConnectionStringArgs $) {
    ...
    public static Builder builder(PluggableDatabasesRemoteCloneConnectionStringArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PluggableDatabasesRemoteCloneConnectionStringArgs();
        }

        public Builder(PluggableDatabasesRemoteCloneConnectionStringArgs defaults) {
            $ = new PluggableDatabasesRemoteCloneConnectionStringArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PluggableDatabasesRemoteCloneConnectionStringArgs build() {
            return $;
        }
    }
