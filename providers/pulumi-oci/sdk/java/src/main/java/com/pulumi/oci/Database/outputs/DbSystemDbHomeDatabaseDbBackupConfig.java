...
public final class DbSystemDbHomeDatabaseDbBackupConfig {
     ...
     * 
     */
    private final @Nullable List<DbSystemDbHomeDatabaseDbBackupConfigBackupDestinationDetail> backupDestinationDetails;
    /**
    ...
    private DbSystemDbHomeDatabaseDbBackupConfig(
        ...
        @CustomType.Parameter("backupDestinationDetails") @Nullable List<DbSystemDbHomeDatabaseDbBackupConfigBackupDestinationDetail> backupDestinationDetails,
    ...
    public static final class Builder {
        ...
        public Builder recoveryWindowInDays(@Nullable Integer recoveryWindowInDays) {
            ...
            return new DbSystemDbHomeDatabaseDbBackupConfig(autoBackupEnabled, autoBackupWindow, backupDestinationDetails, recoveryWindowInDays);
        }
    }
}
