...
public final class GetWorkspacesWorkspace {
    ...
    public static final class Builder {
        ...
        public Builder vcnId(String vcnId) {
            ...
            return new GetWorkspacesWorkspace(compartmentId, definedTags, description, displayName, dnsServerIp, dnsServerZone, freeformTags, id, isForceOperation, isPrivateNetworkEnabled, quiesceTimeout, state, stateMessage, subnetId, timeCreated, timeUpdated, vcnId);
        }
    }
}
