...
@CustomType
public final class GetCertificatesCertificateCollectionItemCertificateConfigValidity {
    /**
    ...
    private GetCertificatesCertificateCollectionItemCertificateConfigValidity(
    ...
    public static Builder builder(GetCertificatesCertificateCollectionItemCertificateConfigValidity defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetCertificatesCertificateCollectionItemCertificateConfigValidity defaults) {
        ...
        public Builder timeOfValidityNotBefore(String timeOfValidityNotBefore) {
            ...
            return this;
        }        public GetCertificatesCertificateCollectionItemCertificateConfigValidity build() {
            return new GetCertificatesCertificateCollectionItemCertificateConfigValidity(timeOfValidityNotAfter, timeOfValidityNotBefore);
        }
    }
}
