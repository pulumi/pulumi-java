...
public final class GetMaskingReportsMaskedColumnPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetMaskingReportsMaskedColumnPlainArgs Empty = new GetMaskingReportsMaskedColumnPlainArgs();
    ...
    private GetMaskingReportsMaskedColumnPlainArgs() {}

    private GetMaskingReportsMaskedColumnPlainArgs(GetMaskingReportsMaskedColumnPlainArgs $) {
    ...
    public static Builder builder(GetMaskingReportsMaskedColumnPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMaskingReportsMaskedColumnPlainArgs();
        }

        public Builder(GetMaskingReportsMaskedColumnPlainArgs defaults) {
            $ = new GetMaskingReportsMaskedColumnPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetMaskingReportsMaskedColumnPlainArgs build() {
