...
public final class GetAuditEventItem {
    ...
    public static final class Builder {
        ...
        public Builder timeCollected(String timeCollected) {
            ...
            return new GetAuditEventItem(actionTaken, auditEventTime, auditLocation, auditPolicies, auditTrailId, auditType, clientHostname, clientId, clientIp, clientProgram, commandParam, commandText, compartmentId, databaseType, dbUserName, definedTags, errorCode, errorMessage, eventName, extendedEventAttributes, freeformTags, id, isAlerted, object, objectOwner, objectType, operation, operationStatus, osTerminal, osUserName, targetClass, targetId, targetName, timeCollected);
        }
    }
}
