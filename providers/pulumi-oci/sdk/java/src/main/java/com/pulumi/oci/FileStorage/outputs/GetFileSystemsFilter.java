...
@CustomType
public final class GetFileSystemsFilter {
    private final String name;
    private final @Nullable Boolean regex;
    private final List<String> values;

    @CustomType.Constructor
    private GetFileSystemsFilter(
    ...
    public static Builder builder(GetFileSystemsFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetFileSystemsFilter defaults) {
        ...
        public Builder values(String... values) {
            ...
            return new GetFileSystemsFilter(name, regex, values);
        }
    }
}
