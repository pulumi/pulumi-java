...
public final class GetMaskingReportMaskedColumnsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetMaskingReportMaskedColumnsArgs Empty = new GetMaskingReportMaskedColumnsArgs();
    ...
    private GetMaskingReportMaskedColumnsArgs(GetMaskingReportMaskedColumnsArgs $) {
    ...
    public static Builder builder(GetMaskingReportMaskedColumnsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMaskingReportMaskedColumnsArgs();
        }

        public Builder(GetMaskingReportMaskedColumnsArgs defaults) {
            $ = new GetMaskingReportMaskedColumnsArgs(Objects.requireNonNull(defaults));
        }
