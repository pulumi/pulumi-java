...
import com.pulumi.oci.DataConnectivity.outputs.GetRegistryFolderDataAssetDefaultConnectionMetadataAggregator;
...
@CustomType
public final class GetRegistryFolderDataAssetDefaultConnectionMetadata {
    /**
     ...
     * 
     */
    private final List<GetRegistryFolderDataAssetDefaultConnectionMetadataAggregator> aggregators;
    /**
    ...
    private GetRegistryFolderDataAssetDefaultConnectionMetadata(
        @CustomType.Parameter("aggregatorKey") String aggregatorKey,
        @CustomType.Parameter("aggregators") List<GetRegistryFolderDataAssetDefaultConnectionMetadataAggregator> aggregators,
     ...
     * 
     */
    public List<GetRegistryFolderDataAssetDefaultConnectionMetadataAggregator> aggregators() {
    ...
    public static Builder builder(GetRegistryFolderDataAssetDefaultConnectionMetadata defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private String aggregatorKey;
        private List<GetRegistryFolderDataAssetDefaultConnectionMetadataAggregator> aggregators;
        ...
        public Builder(GetRegistryFolderDataAssetDefaultConnectionMetadata defaults) {
        ...
        public Builder aggregators(List<GetRegistryFolderDataAssetDefaultConnectionMetadataAggregator> aggregators) {
            this.aggregators = Objects.requireNonNull(aggregators);
            return this;
        }
        public Builder aggregators(GetRegistryFolderDataAssetDefaultConnectionMetadataAggregator... aggregators) {
        ...
        public Builder updatedByName(String updatedByName) {
            ...
            return this;
        }        public GetRegistryFolderDataAssetDefaultConnectionMetadata build() {
            return new GetRegistryFolderDataAssetDefaultConnectionMetadata(aggregatorKey, aggregators, createdBy, createdByName, identifierPath, infoFields, isFavorite, labels, registryVersion, timeCreated, timeUpdated, updatedBy, updatedByName);
        }
    }
}
