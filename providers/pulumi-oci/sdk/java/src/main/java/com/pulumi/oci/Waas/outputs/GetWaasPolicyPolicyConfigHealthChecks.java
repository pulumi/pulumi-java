...
public final class GetWaasPolicyPolicyConfigHealthChecks {
    ...
    public static final class Builder {
        ...
        public Builder unhealthyThreshold(Integer unhealthyThreshold) {
            ...
            return new GetWaasPolicyPolicyConfigHealthChecks(expectedResponseCodeGroups, expectedResponseText, headers, healthyThreshold, intervalInSeconds, isEnabled, isResponseTextCheckEnabled, method, path, timeoutInSeconds, unhealthyThreshold);
        }
    }
}
