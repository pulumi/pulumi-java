...
import com.pulumi.oci.DataConnectivity.outputs.GetRegistryDataAssetsDataAssetSummaryCollectionItemMetadataAggregator;
...
@CustomType
public final class GetRegistryDataAssetsDataAssetSummaryCollectionItemMetadata {
    /**
     * @return A summary type containing information about the object&#39;s aggregator including its type, key, name and description.
     * 
     */
    private final GetRegistryDataAssetsDataAssetSummaryCollectionItemMetadataAggregator aggregator;
    /**
    ...
    private GetRegistryDataAssetsDataAssetSummaryCollectionItemMetadata(
        @CustomType.Parameter("aggregator") GetRegistryDataAssetsDataAssetSummaryCollectionItemMetadataAggregator aggregator,
     ...
     * 
     */
    public GetRegistryDataAssetsDataAssetSummaryCollectionItemMetadataAggregator aggregator() {
    ...
    public static Builder builder(GetRegistryDataAssetsDataAssetSummaryCollectionItemMetadata defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private GetRegistryDataAssetsDataAssetSummaryCollectionItemMetadataAggregator aggregator;
        ...
        public Builder(GetRegistryDataAssetsDataAssetSummaryCollectionItemMetadata defaults) {
        ...
        public Builder aggregator(GetRegistryDataAssetsDataAssetSummaryCollectionItemMetadataAggregator aggregator) {
        ...
        public Builder updatedByName(String updatedByName) {
            ...
            return this;
        }        public GetRegistryDataAssetsDataAssetSummaryCollectionItemMetadata build() {
            return new GetRegistryDataAssetsDataAssetSummaryCollectionItemMetadata(aggregator, aggregatorKey, createdBy, createdByName, identifierPath, infoFields, isFavorite, labels, registryVersion, timeCreated, timeUpdated, updatedBy, updatedByName);
        }
    }
}
