...
public final class MigrationDatapumpSettingsImportDirectoryObject {
    ...
    public static Builder builder(MigrationDatapumpSettingsImportDirectoryObject defaults) {
    ...
    public static final class Builder {
        ...
        public Builder path(String path) {
            ...
            return new MigrationDatapumpSettingsImportDirectoryObject(name, path);
        }
    }
}
