...
import com.pulumi.oci.DataConnectivity.outputs.RegistryDataAssetMetadataAggregator;
...
@CustomType
public final class RegistryDataAssetMetadata {
    /**
     ...
     * 
     */
    private final @Nullable RegistryDataAssetMetadataAggregator aggregator;
    /**
    ...
    private RegistryDataAssetMetadata(
        @CustomType.Parameter("aggregator") @Nullable RegistryDataAssetMetadataAggregator aggregator,
     ...
     * 
     */
    public Optional<RegistryDataAssetMetadataAggregator> aggregator() {
    ...
    public static Builder builder(RegistryDataAssetMetadata defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable RegistryDataAssetMetadataAggregator aggregator;
        ...
        public Builder(RegistryDataAssetMetadata defaults) {
        ...
        public Builder aggregator(@Nullable RegistryDataAssetMetadataAggregator aggregator) {
            this.aggregator = aggregator;
            return this;
        }
        ...
        public Builder updatedByName(@Nullable String updatedByName) {
            this.updatedByName = updatedByName;
            return this;
        }        public RegistryDataAssetMetadata build() {
            return new RegistryDataAssetMetadata(aggregator, aggregatorKey, createdBy, createdByName, identifierPath, infoFields, isFavorite, labels, registryVersion, timeCreated, timeUpdated, updatedBy, updatedByName);
        }
    }
}
