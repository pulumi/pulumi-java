...
@CustomType
public final class CertificateAuthorityCertificateAuthorityConfigSubject {
    /**
    ...
    private CertificateAuthorityCertificateAuthorityConfigSubject(
    ...
    public static Builder builder(CertificateAuthorityCertificateAuthorityConfigSubject defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CertificateAuthorityCertificateAuthorityConfigSubject defaults) {
        ...
        public Builder userId(@Nullable String userId) {
            ...
            return new CertificateAuthorityCertificateAuthorityConfigSubject(commonName, country, distinguishedNameQualifier, domainComponent, generationQualifier, givenName, initials, localityName, organization, organizationalUnit, pseudonym, serialNumber, stateOrProvinceName, street, surname, title, userId);
        }
    }
}
