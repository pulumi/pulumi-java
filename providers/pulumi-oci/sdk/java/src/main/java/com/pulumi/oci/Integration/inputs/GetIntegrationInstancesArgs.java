...
public final class GetIntegrationInstancesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetIntegrationInstancesArgs Empty = new GetIntegrationInstancesArgs();
    ...
    private GetIntegrationInstancesArgs(GetIntegrationInstancesArgs $) {
    ...
    public static Builder builder(GetIntegrationInstancesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetIntegrationInstancesArgs();
        }

        public Builder(GetIntegrationInstancesArgs defaults) {
            $ = new GetIntegrationInstancesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetIntegrationInstancesArgs build() {
