...
public final class DbHomeDatabase {
    ...
    private final @Nullable List<DbHomeDatabaseConnectionString> connectionStrings;
    /**
     ...
     * 
     */
    private final @Nullable DbHomeDatabaseDbBackupConfig dbBackupConfig;
    /**
     ...
     * 
     */
    private final @Nullable List<String> oneOffPatches;
    /**
    ...
    private DbHomeDatabase(
        ...
        @CustomType.Parameter("connectionStrings") @Nullable List<DbHomeDatabaseConnectionString> connectionStrings,
        ...
        @CustomType.Parameter("dbBackupConfig") @Nullable DbHomeDatabaseDbBackupConfig dbBackupConfig,
        ...
        @CustomType.Parameter("oneOffPatches") @Nullable List<String> oneOffPatches,
    ...
    public static final class Builder {
        ...
        public Builder vaultId(@Nullable String vaultId) {
            ...
            return new DbHomeDatabase(adminPassword, backupId, backupTdePassword, characterSet, connectionStrings, databaseId, databaseSoftwareImageId, dbBackupConfig, dbName, dbUniqueName, dbWorkload, definedTags, freeformTags, id, kmsKeyId, kmsKeyVersionId, lifecycleDetails, ncharacterSet, oneOffPatches, pdbName, sidPrefix, state, tdeWalletPassword, timeCreated, timeStampForPointInTimeRecovery, vaultId);
        }
    }
}
