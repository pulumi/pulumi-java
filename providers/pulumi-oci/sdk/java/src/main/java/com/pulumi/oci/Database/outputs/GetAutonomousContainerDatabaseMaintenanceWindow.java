...
@CustomType
public final class GetAutonomousContainerDatabaseMaintenanceWindow {
    /**
     ...
     * 
     */
    private final List<GetAutonomousContainerDatabaseMaintenanceWindowDaysOfWeek> daysOfWeeks;
    /**
     ...
     * 
     */
    private final List<GetAutonomousContainerDatabaseMaintenanceWindowMonth> months;
    /**
    ...
    private GetAutonomousContainerDatabaseMaintenanceWindow(
        @CustomType.Parameter("customActionTimeoutInMins") Integer customActionTimeoutInMins,
        @CustomType.Parameter("daysOfWeeks") List<GetAutonomousContainerDatabaseMaintenanceWindowDaysOfWeek> daysOfWeeks,
        ...
        @CustomType.Parameter("months") List<GetAutonomousContainerDatabaseMaintenanceWindowMonth> months,
     ...
     * 
     */
    public List<GetAutonomousContainerDatabaseMaintenanceWindowDaysOfWeek> daysOfWeeks() {
     ...
     * 
     */
    public List<GetAutonomousContainerDatabaseMaintenanceWindowMonth> months() {
        return this.months;
    }
    /**
     * @return Cloud Exadata infrastructure node patching method, either &#34;ROLLING&#34; or &#34;NONROLLING&#34;. Default value is ROLLING.
    ...
    public static Builder builder(GetAutonomousContainerDatabaseMaintenanceWindow defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private Integer customActionTimeoutInMins;
        private List<GetAutonomousContainerDatabaseMaintenanceWindowDaysOfWeek> daysOfWeeks;
        private List<Integer> hoursOfDays;
        private Boolean isCustomActionTimeoutEnabled;
        private Integer leadTimeInWeeks;
        private List<GetAutonomousContainerDatabaseMaintenanceWindowMonth> months;
        ...
        public Builder(GetAutonomousContainerDatabaseMaintenanceWindow defaults) {
        ...
        }        public GetAutonomousContainerDatabaseMaintenanceWindow build() {
            return new GetAutonomousContainerDatabaseMaintenanceWindow(customActionTimeoutInMins, daysOfWeeks, hoursOfDays, isCustomActionTimeoutEnabled, leadTimeInWeeks, months, patchingMode, preference, weeksOfMonths);
        }
    }
}
