...
public final class VerifyArgs extends com.pulumi.resources.ResourceArgs {

    public static final VerifyArgs Empty = new VerifyArgs();
    ...
    public static Builder builder(VerifyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(VerifyArgs defaults) {
            $ = new VerifyArgs(Objects.requireNonNull(defaults));
        }
