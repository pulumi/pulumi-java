...
public final class GetRulesRule {
     ...
     * 
     */
    private final List<GetRulesRuleAction> actions;
    /**
    ...
    private GetRulesRule(
        @CustomType.Parameter("actions") List<GetRulesRuleAction> actions,
    ...
    public static final class Builder {
        ...
        public Builder timeCreated(String timeCreated) {
            ...
            return new GetRulesRule(actions, compartmentId, condition, definedTags, description, displayName, freeformTags, id, isEnabled, lifecycleMessage, state, timeCreated);
        }
    }
}
