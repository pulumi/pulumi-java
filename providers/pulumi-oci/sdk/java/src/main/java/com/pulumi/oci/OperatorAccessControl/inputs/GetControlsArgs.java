...
public final class GetControlsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private Output</* @Nullable */ List<GetControlsFilter>> filters;

    public Output</* @Nullable */ List<GetControlsFilter>> filters() {
        return this.filters;
    }
    ...
    public static final class Builder {
        ...
        public Builder filters(Output</* @Nullable */ List<GetControlsFilter>> filters) {
            $.filters = filters;
            return this;
        }
