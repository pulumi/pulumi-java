...
public final class TargetDatabaseState extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<List<String>>> associatedResourceIds() {
        return Optional.ofNullable(this.associatedResourceIds);
    }
    ...
    private TargetDatabaseState() {}

    private TargetDatabaseState(TargetDatabaseState $) {
    ...
    public static Builder builder(TargetDatabaseState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(TargetDatabaseState defaults) {
            $ = new TargetDatabaseState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder associatedResourceIds(@Nullable Output<List<String>> associatedResourceIds) {
        ...
        public Builder associatedResourceIds(List<String> associatedResourceIds) {
            return associatedResourceIds(Output.of(associatedResourceIds));
        }
         ...
         * 
         */
        public Builder databaseDetails(@Nullable Output<TargetDatabaseDatabaseDetailsArgs> databaseDetails) {
        ...
        /**
         * @param timeUpdated The date and time of the target database update in Data Safe.
         * 
         * @return builder
         * 
         */
        ...
        public TargetDatabaseState build() {
            return $;
        }
    }
