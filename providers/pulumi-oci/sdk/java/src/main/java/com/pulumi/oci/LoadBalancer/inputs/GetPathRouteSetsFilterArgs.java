...
public final class GetPathRouteSetsFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetPathRouteSetsFilterArgs() {}

    private GetPathRouteSetsFilterArgs(GetPathRouteSetsFilterArgs $) {
        this.name = $.name;
        this.regex = $.regex;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetPathRouteSetsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPathRouteSetsFilterArgs();
        }

        public Builder(GetPathRouteSetsFilterArgs defaults) {
            $ = new GetPathRouteSetsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPathRouteSetsFilterArgs build() {
