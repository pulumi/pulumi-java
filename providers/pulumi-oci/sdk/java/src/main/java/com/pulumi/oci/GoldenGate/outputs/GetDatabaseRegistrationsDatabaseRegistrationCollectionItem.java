...
public final class GetDatabaseRegistrationsDatabaseRegistrationCollectionItem {
    ...
    public static final class Builder {
        ...
        public Builder wallet(String wallet) {
            ...
            return new GetDatabaseRegistrationsDatabaseRegistrationCollectionItem(aliasName, compartmentId, connectionString, databaseId, definedTags, description, displayName, fqdn, freeformTags, id, ipAddress, keyId, lifecycleDetails, password, rcePrivateIp, secretCompartmentId, secretId, sessionMode, state, subnetId, systemTags, timeCreated, timeUpdated, username, vaultId, wallet);
        }
    }
}
