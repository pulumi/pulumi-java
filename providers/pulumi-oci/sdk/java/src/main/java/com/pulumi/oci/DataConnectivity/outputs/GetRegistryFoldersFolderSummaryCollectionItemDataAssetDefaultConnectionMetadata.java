...
import com.pulumi.oci.DataConnectivity.outputs.GetRegistryFoldersFolderSummaryCollectionItemDataAssetDefaultConnectionMetadataAggregator;
...
@CustomType
public final class GetRegistryFoldersFolderSummaryCollectionItemDataAssetDefaultConnectionMetadata {
    /**
     * @return A summary type containing information about the object&#39;s aggregator including its type, key, name and description.
     * 
     */
    private final GetRegistryFoldersFolderSummaryCollectionItemDataAssetDefaultConnectionMetadataAggregator aggregator;
    /**
    ...
    private GetRegistryFoldersFolderSummaryCollectionItemDataAssetDefaultConnectionMetadata(
        @CustomType.Parameter("aggregator") GetRegistryFoldersFolderSummaryCollectionItemDataAssetDefaultConnectionMetadataAggregator aggregator,
     ...
     * 
     */
    public GetRegistryFoldersFolderSummaryCollectionItemDataAssetDefaultConnectionMetadataAggregator aggregator() {
    ...
    public static Builder builder(GetRegistryFoldersFolderSummaryCollectionItemDataAssetDefaultConnectionMetadata defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private GetRegistryFoldersFolderSummaryCollectionItemDataAssetDefaultConnectionMetadataAggregator aggregator;
        ...
        public Builder(GetRegistryFoldersFolderSummaryCollectionItemDataAssetDefaultConnectionMetadata defaults) {
        ...
        public Builder aggregator(GetRegistryFoldersFolderSummaryCollectionItemDataAssetDefaultConnectionMetadataAggregator aggregator) {
        ...
        public Builder updatedByName(String updatedByName) {
            ...
            return this;
        }        public GetRegistryFoldersFolderSummaryCollectionItemDataAssetDefaultConnectionMetadata build() {
            return new GetRegistryFoldersFolderSummaryCollectionItemDataAssetDefaultConnectionMetadata(aggregator, aggregatorKey, createdBy, createdByName, identifierPath, infoFields, isFavorite, labels, registryVersion, timeCreated, timeUpdated, updatedBy, updatedByName);
        }
    }
}
