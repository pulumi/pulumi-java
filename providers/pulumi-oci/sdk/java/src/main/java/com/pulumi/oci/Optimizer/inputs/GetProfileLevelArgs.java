...
public final class GetProfileLevelArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetProfileLevelArgs Empty = new GetProfileLevelArgs();
    ...
    private GetProfileLevelArgs(GetProfileLevelArgs $) {
    ...
    public static Builder builder(GetProfileLevelArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetProfileLevelArgs();
        }

        public Builder(GetProfileLevelArgs defaults) {
            $ = new GetProfileLevelArgs(Objects.requireNonNull(defaults));
        }
