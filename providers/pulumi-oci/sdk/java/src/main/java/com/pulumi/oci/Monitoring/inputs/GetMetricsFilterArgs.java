...
public final class GetMetricsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetMetricsFilterArgs Empty = new GetMetricsFilterArgs();
    ...
    private GetMetricsFilterArgs() {}

    private GetMetricsFilterArgs(GetMetricsFilterArgs $) {
        this.name = $.name;
        this.regex = $.regex;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetMetricsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMetricsFilterArgs();
        }

        public Builder(GetMetricsFilterArgs defaults) {
            $ = new GetMetricsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetMetricsFilterArgs build() {
