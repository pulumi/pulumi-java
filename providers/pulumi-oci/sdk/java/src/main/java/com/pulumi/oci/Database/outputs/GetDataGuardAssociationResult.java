...
public final class GetDataGuardAssociationResult {
    ...
    public static final class Builder {
        ...
        public Builder transportType(String transportType) {
            ...
            return new GetDataGuardAssociationResult(applyLag, applyRate, availabilityDomain, backupNetworkNsgIds, createAsync, creationType, dataGuardAssociationId, databaseAdminPassword, databaseId, databaseSoftwareImageId, deleteStandbyDbHomeOnDelete, displayName, hostname, id, isActiveDataGuardEnabled, lifecycleDetails, nsgIds, peerDataGuardAssociationId, peerDatabaseId, peerDbHomeId, peerDbSystemId, peerDbUniqueName, peerRole, peerSidPrefix, peerVmClusterId, protectionMode, role, shape, state, subnetId, timeCreated, transportType);
        }
    }
}
