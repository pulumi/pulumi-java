...
public final class GetCostTrackingTagsTag {
     ...
     * 
     */
    private final List<GetCostTrackingTagsTagValidator> validators;
    ...
    private GetCostTrackingTagsTag(
        ...
        @CustomType.Parameter("validators") List<GetCostTrackingTagsTagValidator> validators) {
    ...
    public static final class Builder {
        ...
        public Builder validators(GetCostTrackingTagsTagValidator... validators) {
            ...
            return new GetCostTrackingTagsTag(compartmentId, definedTags, description, freeformTags, id, isCostTracking, isRetired, name, state, tagNamespaceId, tagNamespaceName, timeCreated, validators);
        }
    }
}
