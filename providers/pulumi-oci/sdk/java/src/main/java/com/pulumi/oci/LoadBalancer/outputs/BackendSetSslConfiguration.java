...
public final class BackendSetSslConfiguration {
    ...
    public static final class Builder {
        ...
        public Builder verifyPeerCertificate(@Nullable Boolean verifyPeerCertificate) {
            ...
            return new BackendSetSslConfiguration(certificateIds, certificateName, cipherSuiteName, protocols, serverOrderPreference, trustedCertificateAuthorityIds, verifyDepth, verifyPeerCertificate);
        }
    }
}
