...
public final class GetSensitiveTypesSensitiveTypeCollectionItem {
    ...
    public static final class Builder {
        ...
        public Builder timeUpdated(String timeUpdated) {
            ...
            return new GetSensitiveTypesSensitiveTypeCollectionItem(commentPattern, compartmentId, dataPattern, defaultMaskingFormatId, definedTags, description, displayName, entityType, freeformTags, id, namePattern, parentCategoryId, searchType, shortName, source, state, systemTags, timeCreated, timeUpdated);
        }
    }
}
