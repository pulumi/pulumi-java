...
public final class GetDataKeysFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetDataKeysFilter Empty = new GetDataKeysFilter();
    ...
    private GetDataKeysFilter(GetDataKeysFilter $) {
        this.name = $.name;
        this.regex = $.regex;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDataKeysFilter();
        }

        public Builder(GetDataKeysFilter defaults) {
            $ = new GetDataKeysFilter(Objects.requireNonNull(defaults));
        }
