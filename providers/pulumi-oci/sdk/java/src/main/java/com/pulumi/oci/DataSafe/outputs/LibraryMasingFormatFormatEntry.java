...
public final class LibraryMasingFormatFormatEntry {
    ...
    public static final class Builder {
        ...
        public Builder userDefinedFunction(@Nullable String userDefinedFunction) {
            ...
            return new LibraryMasingFormatFormatEntry(columnName, description, endDate, endLength, endValue, fixedNumber, fixedString, groupingColumns, length, libraryMaskingFormatId, postProcessingFunction, randomLists, regularExpression, replaceWith, schemaName, sqlExpression, startDate, startLength, startPosition, startValue, tableName, type, userDefinedFunction);
        }
    }
}
