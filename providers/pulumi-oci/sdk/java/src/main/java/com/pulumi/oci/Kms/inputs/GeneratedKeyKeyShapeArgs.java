...
public final class GeneratedKeyKeyShapeArgs extends com.pulumi.resources.ResourceArgs {

    public static final GeneratedKeyKeyShapeArgs Empty = new GeneratedKeyKeyShapeArgs();
    ...
    private GeneratedKeyKeyShapeArgs() {}

    private GeneratedKeyKeyShapeArgs(GeneratedKeyKeyShapeArgs $) {
    ...
    public static Builder builder(GeneratedKeyKeyShapeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GeneratedKeyKeyShapeArgs();
        }

        public Builder(GeneratedKeyKeyShapeArgs defaults) {
            $ = new GeneratedKeyKeyShapeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GeneratedKeyKeyShapeArgs build() {
