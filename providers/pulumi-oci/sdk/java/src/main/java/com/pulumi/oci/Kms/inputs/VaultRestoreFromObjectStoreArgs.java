...
public final class VaultRestoreFromObjectStoreArgs extends com.pulumi.resources.ResourceArgs {

    public static final VaultRestoreFromObjectStoreArgs Empty = new VaultRestoreFromObjectStoreArgs();
    ...
    private VaultRestoreFromObjectStoreArgs() {}

    private VaultRestoreFromObjectStoreArgs(VaultRestoreFromObjectStoreArgs $) {
        this.bucket = $.bucket;
    ...
    public static Builder builder(VaultRestoreFromObjectStoreArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VaultRestoreFromObjectStoreArgs();
        }

        public Builder(VaultRestoreFromObjectStoreArgs defaults) {
            $ = new VaultRestoreFromObjectStoreArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param bucket (Updatable) Name of the bucket where vault was backed up
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param namespace (Updatable) Namespace of the bucket where vault was backed up
         * 
         * @return builder
         * 
         */
        ...
        public VaultRestoreFromObjectStoreArgs build() {
