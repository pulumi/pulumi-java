...
import com.pulumi.oci.DataSafe.inputs.GetMaskingAnalyticsFilter;
...
public final class GetMaskingAnalyticsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetMaskingAnalyticsPlainArgs Empty = new GetMaskingAnalyticsPlainArgs();
    ...
    public Optional<List<GetMaskingAnalyticsFilter>> filters() {
    ...
    private GetMaskingAnalyticsPlainArgs() {}

    private GetMaskingAnalyticsPlainArgs(GetMaskingAnalyticsPlainArgs $) {
    ...
    public static Builder builder(GetMaskingAnalyticsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMaskingAnalyticsPlainArgs();
        }

        public Builder(GetMaskingAnalyticsPlainArgs defaults) {
            $ = new GetMaskingAnalyticsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetMaskingAnalyticsPlainArgs build() {
