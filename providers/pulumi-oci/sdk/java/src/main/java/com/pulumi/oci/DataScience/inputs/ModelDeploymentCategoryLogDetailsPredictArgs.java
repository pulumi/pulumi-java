...
public final class ModelDeploymentCategoryLogDetailsPredictArgs extends com.pulumi.resources.ResourceArgs {

    public static final ModelDeploymentCategoryLogDetailsPredictArgs Empty = new ModelDeploymentCategoryLogDetailsPredictArgs();
    ...
    private ModelDeploymentCategoryLogDetailsPredictArgs() {}

    private ModelDeploymentCategoryLogDetailsPredictArgs(ModelDeploymentCategoryLogDetailsPredictArgs $) {
    ...
    public static Builder builder(ModelDeploymentCategoryLogDetailsPredictArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ModelDeploymentCategoryLogDetailsPredictArgs();
        }

        public Builder(ModelDeploymentCategoryLogDetailsPredictArgs defaults) {
            $ = new ModelDeploymentCategoryLogDetailsPredictArgs(Objects.requireNonNull(defaults));
        }
