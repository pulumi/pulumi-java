...
public final class GetProtectionRulesProtectionRule {
     ...
     * 
     */
    private final List<GetProtectionRulesProtectionRuleExclusion> exclusions;
    /**
    ...
    private GetProtectionRulesProtectionRule(
        ...
        @CustomType.Parameter("exclusions") List<GetProtectionRulesProtectionRuleExclusion> exclusions,
    ...
    public static final class Builder {
        ...
        public Builder waasPolicyId(String waasPolicyId) {
            ...
            return new GetProtectionRulesProtectionRule(action, description, exclusions, key, labels, modSecurityRuleIds, name, waasPolicyId);
        }
    }
}
