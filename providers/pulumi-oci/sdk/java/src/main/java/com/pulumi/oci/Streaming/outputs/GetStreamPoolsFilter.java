...
@CustomType
public final class GetStreamPoolsFilter {
    /**
    ...
    public static Builder builder(GetStreamPoolsFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetStreamPoolsFilter defaults) {
        ...
        }        public GetStreamPoolsFilter build() {
            return new GetStreamPoolsFilter(name, regex, values);
        }
    }
}
