...
@CustomType
public final class ModelDeploymentCategoryLogDetailsPredict {
    /**
    ...
    public static Builder builder(ModelDeploymentCategoryLogDetailsPredict defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ModelDeploymentCategoryLogDetailsPredict defaults) {
        ...
        public Builder logId(String logId) {
            ...
            return new ModelDeploymentCategoryLogDetailsPredict(logGroupId, logId);
        }
    }
}
