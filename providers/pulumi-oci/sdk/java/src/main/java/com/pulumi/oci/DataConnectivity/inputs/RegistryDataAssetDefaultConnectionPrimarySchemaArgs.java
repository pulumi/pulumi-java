...
public final class RegistryDataAssetDefaultConnectionPrimarySchemaArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegistryDataAssetDefaultConnectionPrimarySchemaArgs Empty = new RegistryDataAssetDefaultConnectionPrimarySchemaArgs();
    ...
    private @Nullable Output<RegistryDataAssetDefaultConnectionPrimarySchemaMetadataArgs> metadata;
     ...
     * 
     */
    public Optional<Output<RegistryDataAssetDefaultConnectionPrimarySchemaMetadataArgs>> metadata() {
    ...
    private @Nullable Output<RegistryDataAssetDefaultConnectionPrimarySchemaParentRefArgs> parentRef;

    /**
     * @return (Updatable) A reference to the object&#39;s parent.
     * 
     */
    public Optional<Output<RegistryDataAssetDefaultConnectionPrimarySchemaParentRefArgs>> parentRef() {
    ...
    private RegistryDataAssetDefaultConnectionPrimarySchemaArgs() {}

    private RegistryDataAssetDefaultConnectionPrimarySchemaArgs(RegistryDataAssetDefaultConnectionPrimarySchemaArgs $) {
    ...
    public static Builder builder(RegistryDataAssetDefaultConnectionPrimarySchemaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegistryDataAssetDefaultConnectionPrimarySchemaArgs();
        }

        public Builder(RegistryDataAssetDefaultConnectionPrimarySchemaArgs defaults) {
            $ = new RegistryDataAssetDefaultConnectionPrimarySchemaArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder metadata(@Nullable Output<RegistryDataAssetDefaultConnectionPrimarySchemaMetadataArgs> metadata) {
            $.metadata = metadata;
            return this;
        }
         ...
         * 
         */
        public Builder metadata(RegistryDataAssetDefaultConnectionPrimarySchemaMetadataArgs metadata) {
         ...
         * 
         */
        public Builder parentRef(@Nullable Output<RegistryDataAssetDefaultConnectionPrimarySchemaParentRefArgs> parentRef) {
            $.parentRef = parentRef;
            return this;
        }
         ...
         * 
         */
        public Builder parentRef(RegistryDataAssetDefaultConnectionPrimarySchemaParentRefArgs parentRef) {
        ...
        public RegistryDataAssetDefaultConnectionPrimarySchemaArgs build() {
