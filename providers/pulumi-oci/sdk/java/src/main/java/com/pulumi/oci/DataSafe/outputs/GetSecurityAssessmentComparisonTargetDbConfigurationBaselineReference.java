...
@CustomType
public final class GetSecurityAssessmentComparisonTargetDbConfigurationBaselineReference {
    /**
    ...
    private GetSecurityAssessmentComparisonTargetDbConfigurationBaselineReference(
    ...
    public static Builder builder(GetSecurityAssessmentComparisonTargetDbConfigurationBaselineReference defaults) {
    ...
    public static final class Builder {
        ...
        public Builder stig(String stig) {
            ...
            return this;
        }        public GetSecurityAssessmentComparisonTargetDbConfigurationBaselineReference build() {
            return new GetSecurityAssessmentComparisonTargetDbConfigurationBaselineReference(cis, gdpr, stig);
        }
    }
}
