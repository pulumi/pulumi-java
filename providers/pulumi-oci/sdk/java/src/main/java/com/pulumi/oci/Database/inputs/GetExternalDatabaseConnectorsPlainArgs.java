...
public final class GetExternalDatabaseConnectorsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetExternalDatabaseConnectorsPlainArgs Empty = new GetExternalDatabaseConnectorsPlainArgs();
    ...
    public Optional<List<GetExternalDatabaseConnectorsFilter>> filters() {
    ...
    private GetExternalDatabaseConnectorsPlainArgs() {}

    private GetExternalDatabaseConnectorsPlainArgs(GetExternalDatabaseConnectorsPlainArgs $) {
    ...
    public static Builder builder(GetExternalDatabaseConnectorsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetExternalDatabaseConnectorsPlainArgs();
        }

        public Builder(GetExternalDatabaseConnectorsPlainArgs defaults) {
            $ = new GetExternalDatabaseConnectorsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param externalDatabaseId The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external database whose connectors will be listed.
         * 
         * @return builder
         * 
         */
