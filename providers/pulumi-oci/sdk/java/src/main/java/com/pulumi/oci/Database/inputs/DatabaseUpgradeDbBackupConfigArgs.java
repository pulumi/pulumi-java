...
import com.pulumi.oci.Database.inputs.DatabaseUpgradeDbBackupConfigBackupDestinationDetailArgs;
...
public final class DatabaseUpgradeDbBackupConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatabaseUpgradeDbBackupConfigArgs Empty = new DatabaseUpgradeDbBackupConfigArgs();
    ...
    private @Nullable Output<List<DatabaseUpgradeDbBackupConfigBackupDestinationDetailArgs>> backupDestinationDetails;

    /**
     * @return Backup destination details.
     * 
     */
    public Optional<Output<List<DatabaseUpgradeDbBackupConfigBackupDestinationDetailArgs>>> backupDestinationDetails() {
    ...
    private DatabaseUpgradeDbBackupConfigArgs() {}

    private DatabaseUpgradeDbBackupConfigArgs(DatabaseUpgradeDbBackupConfigArgs $) {
    ...
    public static Builder builder(DatabaseUpgradeDbBackupConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatabaseUpgradeDbBackupConfigArgs();
        }

        public Builder(DatabaseUpgradeDbBackupConfigArgs defaults) {
            $ = new DatabaseUpgradeDbBackupConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder backupDestinationDetails(@Nullable Output<List<DatabaseUpgradeDbBackupConfigBackupDestinationDetailArgs>> backupDestinationDetails) {
         ...
         * 
         */
        public Builder backupDestinationDetails(List<DatabaseUpgradeDbBackupConfigBackupDestinationDetailArgs> backupDestinationDetails) {
         ...
         * 
         */
        public Builder backupDestinationDetails(DatabaseUpgradeDbBackupConfigBackupDestinationDetailArgs... backupDestinationDetails) {
        ...
        public DatabaseUpgradeDbBackupConfigArgs build() {
            return $;
        }
    }
