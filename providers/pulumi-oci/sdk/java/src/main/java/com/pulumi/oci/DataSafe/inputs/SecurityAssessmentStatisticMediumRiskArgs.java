...
public final class SecurityAssessmentStatisticMediumRiskArgs extends com.pulumi.resources.ResourceArgs {

    public static final SecurityAssessmentStatisticMediumRiskArgs Empty = new SecurityAssessmentStatisticMediumRiskArgs();
    ...
    private SecurityAssessmentStatisticMediumRiskArgs() {}

    private SecurityAssessmentStatisticMediumRiskArgs(SecurityAssessmentStatisticMediumRiskArgs $) {
    ...
    public static Builder builder(SecurityAssessmentStatisticMediumRiskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecurityAssessmentStatisticMediumRiskArgs();
        }

        public Builder(SecurityAssessmentStatisticMediumRiskArgs defaults) {
            $ = new SecurityAssessmentStatisticMediumRiskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SecurityAssessmentStatisticMediumRiskArgs build() {
            return $;
        }
    }
