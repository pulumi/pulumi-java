...
public final class GetManagedDatabaseUserProxiedForUsersArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetManagedDatabaseUserProxiedForUsersArgs Empty = new GetManagedDatabaseUserProxiedForUsersArgs();

    @Import(name="filters")
    private Output</* @Nullable */ List<GetManagedDatabaseUserProxiedForUsersFilter>> filters;

    public Output</* @Nullable */ List<GetManagedDatabaseUserProxiedForUsersFilter>> filters() {
        return this.filters;
    }
    ...
    private GetManagedDatabaseUserProxiedForUsersArgs() {}

    private GetManagedDatabaseUserProxiedForUsersArgs(GetManagedDatabaseUserProxiedForUsersArgs $) {
    ...
    public static Builder builder(GetManagedDatabaseUserProxiedForUsersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetManagedDatabaseUserProxiedForUsersArgs();
        }

        public Builder(GetManagedDatabaseUserProxiedForUsersArgs defaults) {
            $ = new GetManagedDatabaseUserProxiedForUsersArgs(Objects.requireNonNull(defaults));
        }

        public Builder filters(Output</* @Nullable */ List<GetManagedDatabaseUserProxiedForUsersFilter>> filters) {
            $.filters = filters;
            return this;
        }
