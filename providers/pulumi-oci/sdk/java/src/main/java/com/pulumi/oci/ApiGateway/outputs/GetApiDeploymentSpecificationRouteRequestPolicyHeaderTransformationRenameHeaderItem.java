...
public final class GetApiDeploymentSpecificationRouteRequestPolicyHeaderTransformationRenameHeaderItem {
    ...
    public static Builder builder(GetApiDeploymentSpecificationRouteRequestPolicyHeaderTransformationRenameHeaderItem defaults) {
    ...
    public static final class Builder {
        ...
        public Builder to(String to) {
            ...
            return new GetApiDeploymentSpecificationRouteRequestPolicyHeaderTransformationRenameHeaderItem(from, to);
        }
    }
}
