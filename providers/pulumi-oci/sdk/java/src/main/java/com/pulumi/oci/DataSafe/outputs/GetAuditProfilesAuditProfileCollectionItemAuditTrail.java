...
public final class GetAuditProfilesAuditProfileCollectionItemAuditTrail {
    ...
    public static final class Builder {
        ...
        public Builder workRequestId(String workRequestId) {
            ...
            return new GetAuditProfilesAuditProfileCollectionItemAuditTrail(auditCollectionStartTime, auditProfileId, compartmentId, definedTags, description, displayName, freeformTags, id, isAutoPurgeEnabled, lifecycleDetails, state, status, systemTags, targetId, timeCreated, timeUpdated, trailLocation, workRequestId);
        }
    }
}
