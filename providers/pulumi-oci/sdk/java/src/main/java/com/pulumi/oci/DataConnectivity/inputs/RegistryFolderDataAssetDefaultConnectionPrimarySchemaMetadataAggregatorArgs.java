...
public final class RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregatorArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregatorArgs() {}

    private RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregatorArgs(RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregatorArgs $) {
    ...
    public static Builder builder(RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregatorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregatorArgs();
        }

        public Builder(RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregatorArgs defaults) {
            $ = new RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregatorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregatorArgs build() {
            return $;
        }
    }
