...
public final class GetJobExecutionsStatusArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetJobExecutionsStatusArgs Empty = new GetJobExecutionsStatusArgs();
    ...
    private GetJobExecutionsStatusArgs() {}

    private GetJobExecutionsStatusArgs(GetJobExecutionsStatusArgs $) {
    ...
    public static Builder builder(GetJobExecutionsStatusArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobExecutionsStatusArgs();
        }

        public Builder(GetJobExecutionsStatusArgs defaults) {
            $ = new GetJobExecutionsStatusArgs(Objects.requireNonNull(defaults));
        }
