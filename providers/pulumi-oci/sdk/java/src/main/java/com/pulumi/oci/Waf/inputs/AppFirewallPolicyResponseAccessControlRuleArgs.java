...
public final class AppFirewallPolicyResponseAccessControlRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AppFirewallPolicyResponseAccessControlRuleArgs() {}

    private AppFirewallPolicyResponseAccessControlRuleArgs(AppFirewallPolicyResponseAccessControlRuleArgs $) {
    ...
    public static Builder builder(AppFirewallPolicyResponseAccessControlRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFirewallPolicyResponseAccessControlRuleArgs();
        }

        public Builder(AppFirewallPolicyResponseAccessControlRuleArgs defaults) {
            $ = new AppFirewallPolicyResponseAccessControlRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppFirewallPolicyResponseAccessControlRuleArgs build() {
