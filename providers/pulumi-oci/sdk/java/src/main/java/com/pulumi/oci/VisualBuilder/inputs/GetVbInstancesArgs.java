...
public final class GetVbInstancesArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private Output</* @Nullable */ List<GetVbInstancesFilter>> filters;

    public Output</* @Nullable */ List<GetVbInstancesFilter>> filters() {
        return this.filters;
    }
    ...
    public static final class Builder {
        ...
        public Builder filters(Output</* @Nullable */ List<GetVbInstancesFilter>> filters) {
            $.filters = filters;
            return this;
        }
