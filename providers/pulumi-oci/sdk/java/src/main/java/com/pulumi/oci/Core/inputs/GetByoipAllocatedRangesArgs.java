...
public final class GetByoipAllocatedRangesArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private Output</* @Nullable */ List<GetByoipAllocatedRangesFilter>> filters;

    public Output</* @Nullable */ List<GetByoipAllocatedRangesFilter>> filters() {
        return this.filters;
    }
    ...
    public static final class Builder {
        ...
        public Builder filters(Output</* @Nullable */ List<GetByoipAllocatedRangesFilter>> filters) {
            $.filters = filters;
            return this;
        }
