...
public final class GetApisArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private Output</* @Nullable */ List<GetApisFilter>> filters;

    public Output</* @Nullable */ List<GetApisFilter>> filters() {
        return this.filters;
    }
    ...
    public static final class Builder {
        ...
        public Builder filters(Output</* @Nullable */ List<GetApisFilter>> filters) {
            $.filters = filters;
            return this;
        }
