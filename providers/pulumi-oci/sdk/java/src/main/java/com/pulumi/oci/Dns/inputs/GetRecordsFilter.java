...
public final class GetRecordsFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetRecordsFilter Empty = new GetRecordsFilter();
    ...
    private GetRecordsFilter(GetRecordsFilter $) {
        this.name = $.name;
        this.regex = $.regex;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRecordsFilter();
        }

        public Builder(GetRecordsFilter defaults) {
            $ = new GetRecordsFilter(Objects.requireNonNull(defaults));
        }
