...
public final class GetInternetGatewaysArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetInternetGatewaysArgs Empty = new GetInternetGatewaysArgs();
    ...
    private GetInternetGatewaysArgs(GetInternetGatewaysArgs $) {
    ...
    public static Builder builder(GetInternetGatewaysArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetInternetGatewaysArgs();
        }

        public Builder(GetInternetGatewaysArgs defaults) {
            $ = new GetInternetGatewaysArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetInternetGatewaysArgs build() {
