...
public final class SecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs extends com.pulumi.resources.ResourceArgs {

    public static final SecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs Empty = new SecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs();
    ...
    private SecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs() {}

    private SecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs(SecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs $) {
        this.max = $.max;
        this.min = $.min;
    }
    ...
    public static Builder builder(SecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs();
        }

        public Builder(SecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs defaults) {
            $ = new SecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs build() {
