...
import com.pulumi.oci.DataConnectivity.outputs.RegistryFolderDataAssetDefaultConnectionMetadataAggregator;
...
@CustomType
public final class RegistryFolderDataAssetDefaultConnectionMetadata {
    /**
     ...
     * 
     */
    private final @Nullable RegistryFolderDataAssetDefaultConnectionMetadataAggregator aggregator;
    /**
    ...
    private RegistryFolderDataAssetDefaultConnectionMetadata(
        @CustomType.Parameter("aggregator") @Nullable RegistryFolderDataAssetDefaultConnectionMetadataAggregator aggregator,
     ...
     * 
     */
    public Optional<RegistryFolderDataAssetDefaultConnectionMetadataAggregator> aggregator() {
    ...
    public static Builder builder(RegistryFolderDataAssetDefaultConnectionMetadata defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable RegistryFolderDataAssetDefaultConnectionMetadataAggregator aggregator;
        ...
        public Builder(RegistryFolderDataAssetDefaultConnectionMetadata defaults) {
        ...
        public Builder aggregator(@Nullable RegistryFolderDataAssetDefaultConnectionMetadataAggregator aggregator) {
            this.aggregator = aggregator;
            return this;
        }
        ...
        public Builder updatedByName(@Nullable String updatedByName) {
            this.updatedByName = updatedByName;
            return this;
        }        public RegistryFolderDataAssetDefaultConnectionMetadata build() {
            return new RegistryFolderDataAssetDefaultConnectionMetadata(aggregator, aggregatorKey, createdBy, createdByName, identifierPath, infoFields, isFavorite, labels, registryVersion, timeCreated, timeUpdated, updatedBy, updatedByName);
        }
    }
}
