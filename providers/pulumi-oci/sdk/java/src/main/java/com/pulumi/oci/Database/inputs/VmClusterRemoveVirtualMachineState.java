...
public final class VmClusterRemoveVirtualMachineState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<VmClusterRemoveVirtualMachineDbServerArgs>> dbServers;

    /**
     * @return The list of Exacc DB servers for the cluster to be removed.
     * 
     */
    public Optional<Output<List<VmClusterRemoveVirtualMachineDbServerArgs>>> dbServers() {
    ...
    public static Builder builder(VmClusterRemoveVirtualMachineState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VmClusterRemoveVirtualMachineState();
        }
         ...
         * 
         */
        public Builder dbServers(@Nullable Output<List<VmClusterRemoveVirtualMachineDbServerArgs>> dbServers) {
            $.dbServers = dbServers;
            return this;
        }
