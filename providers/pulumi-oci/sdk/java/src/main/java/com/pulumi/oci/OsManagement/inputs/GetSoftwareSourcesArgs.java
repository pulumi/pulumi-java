...
public final class GetSoftwareSourcesArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private Output</* @Nullable */ List<GetSoftwareSourcesFilter>> filters;

    public Output</* @Nullable */ List<GetSoftwareSourcesFilter>> filters() {
        return this.filters;
    }
    ...
    public static final class Builder {
        ...
        public Builder filters(Output</* @Nullable */ List<GetSoftwareSourcesFilter>> filters) {
            $.filters = filters;
            return this;
        }
