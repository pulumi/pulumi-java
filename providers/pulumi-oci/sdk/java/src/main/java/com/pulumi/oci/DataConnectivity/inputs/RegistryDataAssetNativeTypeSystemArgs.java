...
import com.pulumi.oci.DataConnectivity.inputs.RegistryDataAssetNativeTypeSystemTypeArgs;
...
public final class RegistryDataAssetNativeTypeSystemArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="types")
    private @Nullable Output<List<RegistryDataAssetNativeTypeSystemTypeArgs>> types;

    /**
     * @return (Updatable) An array of types.
     * 
     */
    public Optional<Output<List<RegistryDataAssetNativeTypeSystemTypeArgs>>> types() {
        return Optional.ofNullable(this.types);
    }

    private RegistryDataAssetNativeTypeSystemArgs() {}

    private RegistryDataAssetNativeTypeSystemArgs(RegistryDataAssetNativeTypeSystemArgs $) {
    ...
    public static Builder builder(RegistryDataAssetNativeTypeSystemArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegistryDataAssetNativeTypeSystemArgs();
        }

        public Builder(RegistryDataAssetNativeTypeSystemArgs defaults) {
            $ = new RegistryDataAssetNativeTypeSystemArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder parentRef(@Nullable Output<RegistryDataAssetNativeTypeSystemParentRefArgs> parentRef) {
            $.parentRef = parentRef;
            return this;
        }
         ...
         * 
         */
        public Builder parentRef(RegistryDataAssetNativeTypeSystemParentRefArgs parentRef) {
         ...
         * 
         */
        public Builder types(@Nullable Output<List<RegistryDataAssetNativeTypeSystemTypeArgs>> types) {
            $.types = types;
            return this;
        }
         ...
         * 
         */
        public Builder types(List<RegistryDataAssetNativeTypeSystemTypeArgs> types) {
         ...
         * 
         */
        public Builder types(RegistryDataAssetNativeTypeSystemTypeArgs... types) {
            return types(List.of(types));
        }

        public RegistryDataAssetNativeTypeSystemArgs build() {
            return $;
        }
    }
