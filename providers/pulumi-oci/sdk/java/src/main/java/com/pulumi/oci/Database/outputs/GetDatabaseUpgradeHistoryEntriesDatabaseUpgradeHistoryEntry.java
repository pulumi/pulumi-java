...
public final class GetDatabaseUpgradeHistoryEntriesDatabaseUpgradeHistoryEntry {
    ...
    public static final class Builder {
        ...
        public Builder timeStarted(String timeStarted) {
            ...
            return new GetDatabaseUpgradeHistoryEntriesDatabaseUpgradeHistoryEntry(action, id, lifecycleDetails, options, source, sourceDbHomeId, state, targetDatabaseSoftwareImageId, targetDbHomeId, targetDbVersion, timeEnded, timeStarted);
        }
    }
}
