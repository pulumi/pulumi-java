...
public final class MaskingPoliciesMaskingColumnMaskingFormatFormatEntryArgs extends com.pulumi.resources.ResourceArgs {

    public static final MaskingPoliciesMaskingColumnMaskingFormatFormatEntryArgs Empty = new MaskingPoliciesMaskingColumnMaskingFormatFormatEntryArgs();
    ...
    private MaskingPoliciesMaskingColumnMaskingFormatFormatEntryArgs() {}

    private MaskingPoliciesMaskingColumnMaskingFormatFormatEntryArgs(MaskingPoliciesMaskingColumnMaskingFormatFormatEntryArgs $) {
    ...
    public static Builder builder(MaskingPoliciesMaskingColumnMaskingFormatFormatEntryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MaskingPoliciesMaskingColumnMaskingFormatFormatEntryArgs();
        }

        public Builder(MaskingPoliciesMaskingColumnMaskingFormatFormatEntryArgs defaults) {
            $ = new MaskingPoliciesMaskingColumnMaskingFormatFormatEntryArgs(Objects.requireNonNull(defaults));
        }
