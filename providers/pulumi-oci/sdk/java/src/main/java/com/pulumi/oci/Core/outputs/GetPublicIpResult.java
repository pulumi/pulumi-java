...
public final class GetPublicIpResult {
    ...
    public static final class Builder {
        ...
        public Builder timeCreated(String timeCreated) {
            ...
            return new GetPublicIpResult(assignedEntityId, assignedEntityType, availabilityDomain, compartmentId, definedTags, displayName, freeformTags, id, ipAddress, lifetime, privateIpId, publicIpPoolId, scope, state, timeCreated);
        }
    }
}
