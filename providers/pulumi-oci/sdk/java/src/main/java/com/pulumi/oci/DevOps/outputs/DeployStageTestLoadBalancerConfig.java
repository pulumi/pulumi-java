...
@CustomType
public final class DeployStageTestLoadBalancerConfig {
    /**
    ...
    public static Builder builder(DeployStageTestLoadBalancerConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DeployStageTestLoadBalancerConfig defaults) {
        ...
        public Builder state(@Nullable String state) {
            this.state = state;
            return this;
        }        public DeployStageTestLoadBalancerConfig build() {
            return new DeployStageTestLoadBalancerConfig(backendPort, listenerName, loadBalancerId, state);
        }
    }
}
