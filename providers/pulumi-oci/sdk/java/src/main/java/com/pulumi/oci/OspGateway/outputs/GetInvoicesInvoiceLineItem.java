...
public final class GetInvoicesInvoiceLineItem {
     ...
     * 
     */
    private final List<GetInvoicesInvoiceLineItemCurrency> currencies;
    /**
    ...
    private GetInvoicesInvoiceLineItem(
        @CustomType.Parameter("currencies") List<GetInvoicesInvoiceLineItemCurrency> currencies,
    ...
    public static final class Builder {
        ...
        public Builder totalPrice(Double totalPrice) {
            ...
            return new GetInvoicesInvoiceLineItem(currencies, netUnitPrice, orderNo, partNumber, product, quantity, timeEnd, timeStart, totalPrice);
        }
    }
}
