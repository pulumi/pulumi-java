...
@CustomType
public final class GetSecurityAssessmentStatisticMediumRisk {
    /**
    ...
    private GetSecurityAssessmentStatisticMediumRisk(
    ...
    public static Builder builder(GetSecurityAssessmentStatisticMediumRisk defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetSecurityAssessmentStatisticMediumRisk defaults) {
        ...
        public Builder userAccountsFindingsCount(Integer userAccountsFindingsCount) {
            ...
            return this;
        }        public GetSecurityAssessmentStatisticMediumRisk build() {
            return new GetSecurityAssessmentStatisticMediumRisk(auditingFindingsCount, authorizationControlFindingsCount, dataEncryptionFindingsCount, dbConfigurationFindingsCount, fineGrainedAccessControlFindingsCount, privilegesAndRolesFindingsCount, targetsCount, userAccountsFindingsCount);
        }
    }
}
