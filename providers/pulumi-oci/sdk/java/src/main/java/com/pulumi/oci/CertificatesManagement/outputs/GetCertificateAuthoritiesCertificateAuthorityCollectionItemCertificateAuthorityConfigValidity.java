...
@CustomType
public final class GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateAuthorityConfigValidity {
    /**
    ...
    private GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateAuthorityConfigValidity(
    ...
    public static Builder builder(GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateAuthorityConfigValidity defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateAuthorityConfigValidity defaults) {
        ...
        public Builder timeOfValidityNotBefore(String timeOfValidityNotBefore) {
            ...
            return this;
        }        public GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateAuthorityConfigValidity build() {
            return new GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateAuthorityConfigValidity(timeOfValidityNotAfter, timeOfValidityNotBefore);
        }
    }
}
