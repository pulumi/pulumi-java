...
public final class GetInternetGatewaysPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetInternetGatewaysPlainArgs Empty = new GetInternetGatewaysPlainArgs();
    ...
    public Optional<List<GetInternetGatewaysFilter>> filters() {
    ...
    private GetInternetGatewaysPlainArgs() {}

    private GetInternetGatewaysPlainArgs(GetInternetGatewaysPlainArgs $) {
    ...
    public static Builder builder(GetInternetGatewaysPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetInternetGatewaysPlainArgs();
        }

        public Builder(GetInternetGatewaysPlainArgs defaults) {
            $ = new GetInternetGatewaysPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetInternetGatewaysPlainArgs build() {
