...
public final class GetVmClusterArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVmClusterArgs Empty = new GetVmClusterArgs();
    ...
    private GetVmClusterArgs() {}

    private GetVmClusterArgs(GetVmClusterArgs $) {
    ...
    public static Builder builder(GetVmClusterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVmClusterArgs();
        }

        public Builder(GetVmClusterArgs defaults) {
            $ = new GetVmClusterArgs(Objects.requireNonNull(defaults));
        }
