...
@CustomType
public final class GetSecurityAssessmentStatisticLowRisk {
    /**
    ...
    private GetSecurityAssessmentStatisticLowRisk(
    ...
    public static Builder builder(GetSecurityAssessmentStatisticLowRisk defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetSecurityAssessmentStatisticLowRisk defaults) {
        ...
        public Builder userAccountsFindingsCount(Integer userAccountsFindingsCount) {
            ...
            return this;
        }        public GetSecurityAssessmentStatisticLowRisk build() {
            return new GetSecurityAssessmentStatisticLowRisk(auditingFindingsCount, authorizationControlFindingsCount, dataEncryptionFindingsCount, dbConfigurationFindingsCount, fineGrainedAccessControlFindingsCount, privilegesAndRolesFindingsCount, targetsCount, userAccountsFindingsCount);
        }
    }
}
