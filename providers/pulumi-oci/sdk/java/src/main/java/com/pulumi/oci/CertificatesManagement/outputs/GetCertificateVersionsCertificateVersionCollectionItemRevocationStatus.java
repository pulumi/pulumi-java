...
@CustomType
public final class GetCertificateVersionsCertificateVersionCollectionItemRevocationStatus {
    /**
    ...
    private GetCertificateVersionsCertificateVersionCollectionItemRevocationStatus(
    ...
    public static Builder builder(GetCertificateVersionsCertificateVersionCollectionItemRevocationStatus defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetCertificateVersionsCertificateVersionCollectionItemRevocationStatus defaults) {
        ...
        public Builder timeOfRevocation(String timeOfRevocation) {
            ...
            return this;
        }        public GetCertificateVersionsCertificateVersionCollectionItemRevocationStatus build() {
            return new GetCertificateVersionsCertificateVersionCollectionItemRevocationStatus(revocationReason, timeOfRevocation);
        }
    }
}
