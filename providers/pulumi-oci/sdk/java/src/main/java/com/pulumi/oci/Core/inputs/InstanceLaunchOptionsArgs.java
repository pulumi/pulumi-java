...
public final class InstanceLaunchOptionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceLaunchOptionsArgs Empty = new InstanceLaunchOptionsArgs();
    ...
    /**
     * @return (Updatable) Emulation type for the boot volume.
     * 
     */
    ...
    /**
     * @return (Updatable) Emulation type for the physical network interface card (NIC).
     * 
     */
    ...
    private InstanceLaunchOptionsArgs() {}

    private InstanceLaunchOptionsArgs(InstanceLaunchOptionsArgs $) {
    ...
    public static Builder builder(InstanceLaunchOptionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceLaunchOptionsArgs();
        }

        public Builder(InstanceLaunchOptionsArgs defaults) {
            $ = new InstanceLaunchOptionsArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param bootVolumeType (Updatable) Emulation type for the boot volume.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param networkType (Updatable) Emulation type for the physical network interface card (NIC).
         * 
         * @return builder
         * 
         */
        ...
        public InstanceLaunchOptionsArgs build() {
            return $;
        }
    }
