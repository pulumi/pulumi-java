...
import com.pulumi.oci.Database.outputs.AutonomousExadataInfrastructureMaintenanceWindowDaysOfWeek;
import com.pulumi.oci.Database.outputs.AutonomousExadataInfrastructureMaintenanceWindowMonth;
...
@CustomType
public final class AutonomousExadataInfrastructureMaintenanceWindow {
    /**
     ...
     * 
     */
    private final @Nullable List<AutonomousExadataInfrastructureMaintenanceWindowDaysOfWeek> daysOfWeeks;
    /**
     ...
     * 
     */
    private final @Nullable List<AutonomousExadataInfrastructureMaintenanceWindowMonth> months;
    /**
    ...
    private AutonomousExadataInfrastructureMaintenanceWindow(
        ...
        @CustomType.Parameter("daysOfWeeks") @Nullable List<AutonomousExadataInfrastructureMaintenanceWindowDaysOfWeek> daysOfWeeks,
        ...
        @CustomType.Parameter("months") @Nullable List<AutonomousExadataInfrastructureMaintenanceWindowMonth> months,
     ...
     * 
     */
    public List<AutonomousExadataInfrastructureMaintenanceWindowDaysOfWeek> daysOfWeeks() {
     ...
     * 
     */
    public List<AutonomousExadataInfrastructureMaintenanceWindowMonth> months() {
    ...
    public static Builder builder(AutonomousExadataInfrastructureMaintenanceWindow defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable Integer customActionTimeoutInMins;
        private @Nullable List<AutonomousExadataInfrastructureMaintenanceWindowDaysOfWeek> daysOfWeeks;
        ...
        private @Nullable List<AutonomousExadataInfrastructureMaintenanceWindowMonth> months;
        ...
        public Builder(AutonomousExadataInfrastructureMaintenanceWindow defaults) {
        ...
        public Builder daysOfWeeks(@Nullable List<AutonomousExadataInfrastructureMaintenanceWindowDaysOfWeek> daysOfWeeks) {
            this.daysOfWeeks = daysOfWeeks;
            return this;
        }
        public Builder daysOfWeeks(AutonomousExadataInfrastructureMaintenanceWindowDaysOfWeek... daysOfWeeks) {
        ...
        public Builder months(@Nullable List<AutonomousExadataInfrastructureMaintenanceWindowMonth> months) {
            this.months = months;
            return this;
        }
        public Builder months(AutonomousExadataInfrastructureMaintenanceWindowMonth... months) {
        ...
        public Builder weeksOfMonths(Integer... weeksOfMonths) {
            ...
            return new AutonomousExadataInfrastructureMaintenanceWindow(customActionTimeoutInMins, daysOfWeeks, hoursOfDays, isCustomActionTimeoutEnabled, leadTimeInWeeks, months, patchingMode, preference, weeksOfMonths);
        }
    }
}
