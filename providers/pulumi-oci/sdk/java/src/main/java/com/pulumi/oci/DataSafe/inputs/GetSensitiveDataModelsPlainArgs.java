...
public final class GetSensitiveDataModelsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSensitiveDataModelsPlainArgs Empty = new GetSensitiveDataModelsPlainArgs();
    ...
    private GetSensitiveDataModelsPlainArgs() {}

    private GetSensitiveDataModelsPlainArgs(GetSensitiveDataModelsPlainArgs $) {
    ...
    public static Builder builder(GetSensitiveDataModelsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSensitiveDataModelsPlainArgs();
        }

        public Builder(GetSensitiveDataModelsPlainArgs defaults) {
            $ = new GetSensitiveDataModelsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSensitiveDataModelsPlainArgs build() {
