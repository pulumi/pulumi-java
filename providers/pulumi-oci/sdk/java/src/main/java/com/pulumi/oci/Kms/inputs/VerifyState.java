...
public final class VerifyState extends com.pulumi.resources.ResourceArgs {

    public static final VerifyState Empty = new VerifyState();
     ...
     * 
     */
    @Import(name="isSignatureValid")
    private @Nullable Output<Boolean> isSignatureValid;

    /**
     * @return A Boolean value that indicates whether the signature was verified.
     * 
     */
    public Optional<Output<Boolean>> isSignatureValid() {
        return Optional.ofNullable(this.isSignatureValid);
    }
    ...
    public static Builder builder(VerifyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(VerifyState defaults) {
            $ = new VerifyState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param isSignatureValid A Boolean value that indicates whether the signature was verified.
         * 
         * @return builder
         * 
         */
        public Builder isSignatureValid(@Nullable Output<Boolean> isSignatureValid) {
        ...
        public Builder isSignatureValid(Boolean isSignatureValid) {
            return isSignatureValid(Output.of(isSignatureValid));
        }
