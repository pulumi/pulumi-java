...
public final class GetCertificateSubject {
    ...
    public static final class Builder {
        ...
        public Builder userId(String userId) {
            ...
            return new GetCertificateSubject(commonName, country, distinguishedNameQualifier, domainComponent, generationQualifier, givenName, initials, localityName, organization, organizationalUnit, pseudonym, serialNumber, stateOrProvinceName, street, surname, title, userId);
        }
    }
}
