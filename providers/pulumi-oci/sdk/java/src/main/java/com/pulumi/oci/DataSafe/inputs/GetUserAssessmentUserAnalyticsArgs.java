...
public final class GetUserAssessmentUserAnalyticsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private Output</* @Nullable */ List<GetUserAssessmentUserAnalyticsFilter>> filters;

    public Output</* @Nullable */ List<GetUserAssessmentUserAnalyticsFilter>> filters() {
        return this.filters;
    }
    ...
    public static final class Builder {
        ...
        public Builder filters(Output</* @Nullable */ List<GetUserAssessmentUserAnalyticsFilter>> filters) {
            $.filters = filters;
            return this;
        }
