...
public final class GetResponderRecipesPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetResponderRecipesPlainArgs Empty = new GetResponderRecipesPlainArgs();
    ...
    private GetResponderRecipesPlainArgs() {}

    private GetResponderRecipesPlainArgs(GetResponderRecipesPlainArgs $) {
    ...
    public static Builder builder(GetResponderRecipesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetResponderRecipesPlainArgs();
        }

        public Builder(GetResponderRecipesPlainArgs defaults) {
            $ = new GetResponderRecipesPlainArgs(Objects.requireNonNull(defaults));
        }
