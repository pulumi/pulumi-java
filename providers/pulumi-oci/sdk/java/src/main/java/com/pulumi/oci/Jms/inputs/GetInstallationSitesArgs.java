...
public final class GetInstallationSitesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetInstallationSitesArgs Empty = new GetInstallationSitesArgs();
    ...
    public static Builder builder(GetInstallationSitesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetInstallationSitesArgs();
        }

        public Builder(GetInstallationSitesArgs defaults) {
            $ = new GetInstallationSitesArgs(Objects.requireNonNull(defaults));
        }
