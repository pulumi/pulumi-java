...
public final class GetAuditEventAnalyticPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetAuditEventAnalyticPlainArgs Empty = new GetAuditEventAnalyticPlainArgs();
    ...
    private GetAuditEventAnalyticPlainArgs() {}

    private GetAuditEventAnalyticPlainArgs(GetAuditEventAnalyticPlainArgs $) {
    ...
    public static Builder builder(GetAuditEventAnalyticPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAuditEventAnalyticPlainArgs();
        }

        public Builder(GetAuditEventAnalyticPlainArgs defaults) {
            $ = new GetAuditEventAnalyticPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAuditEventAnalyticPlainArgs build() {
