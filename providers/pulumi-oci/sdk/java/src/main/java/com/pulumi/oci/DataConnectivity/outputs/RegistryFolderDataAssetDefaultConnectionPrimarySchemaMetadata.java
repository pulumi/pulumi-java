...
import com.pulumi.oci.DataConnectivity.outputs.RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregator;
...
@CustomType
public final class RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadata {
    /**
     ...
     * 
     */
    private final @Nullable RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregator aggregator;
    /**
    ...
    private RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadata(
        @CustomType.Parameter("aggregator") @Nullable RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregator aggregator,
     ...
     * 
     */
    public Optional<RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregator> aggregator() {
    ...
    public static Builder builder(RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadata defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregator aggregator;
        ...
        public Builder(RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadata defaults) {
        ...
        public Builder aggregator(@Nullable RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregator aggregator) {
            this.aggregator = aggregator;
            return this;
        }
        ...
        public Builder updatedByName(@Nullable String updatedByName) {
            this.updatedByName = updatedByName;
            return this;
        }        public RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadata build() {
            return new RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadata(aggregator, aggregatorKey, createdBy, createdByName, identifierPath, infoFields, isFavorite, labels, registryVersion, timeCreated, timeUpdated, updatedBy, updatedByName);
        }
    }
}
