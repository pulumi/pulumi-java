...
public final class GetManagedDatabaseUserObjectPrivilegeArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetManagedDatabaseUserObjectPrivilegeArgs Empty = new GetManagedDatabaseUserObjectPrivilegeArgs();
    ...
    private GetManagedDatabaseUserObjectPrivilegeArgs() {}

    private GetManagedDatabaseUserObjectPrivilegeArgs(GetManagedDatabaseUserObjectPrivilegeArgs $) {
    ...
    public static Builder builder(GetManagedDatabaseUserObjectPrivilegeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetManagedDatabaseUserObjectPrivilegeArgs();
        }

        public Builder(GetManagedDatabaseUserObjectPrivilegeArgs defaults) {
            $ = new GetManagedDatabaseUserObjectPrivilegeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetManagedDatabaseUserObjectPrivilegeArgs build() {
