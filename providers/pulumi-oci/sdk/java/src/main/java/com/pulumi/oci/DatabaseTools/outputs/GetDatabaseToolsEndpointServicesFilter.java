...
public final class GetDatabaseToolsEndpointServicesFilter {
    ...
    private GetDatabaseToolsEndpointServicesFilter(
    ...
    public static Builder builder(GetDatabaseToolsEndpointServicesFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetDatabaseToolsEndpointServicesFilter defaults) {
        ...
        }        public GetDatabaseToolsEndpointServicesFilter build() {
            return new GetDatabaseToolsEndpointServicesFilter(name, regex, values);
        }
    }
}
