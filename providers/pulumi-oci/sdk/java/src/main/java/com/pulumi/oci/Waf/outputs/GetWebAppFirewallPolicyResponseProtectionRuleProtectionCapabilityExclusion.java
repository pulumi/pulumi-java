...
public final class GetWebAppFirewallPolicyResponseProtectionRuleProtectionCapabilityExclusion {
    ...
    public static Builder builder(GetWebAppFirewallPolicyResponseProtectionRuleProtectionCapabilityExclusion defaults) {
    ...
    public static final class Builder {
        ...
        }        public GetWebAppFirewallPolicyResponseProtectionRuleProtectionCapabilityExclusion build() {
            return new GetWebAppFirewallPolicyResponseProtectionRuleProtectionCapabilityExclusion(args, requestCookies);
        }
    }
}
