...
import com.pulumi.oci.Database.outputs.GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetailDaysOfWeek;
import com.pulumi.oci.Database.outputs.GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetailMonth;
...
@CustomType
public final class GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetail {
    /**
     ...
     * 
     */
    private final List<GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetailDaysOfWeek> daysOfWeeks;
    /**
     ...
     * 
     */
    private final List<GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetailMonth> months;
    /**
    ...
    private GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetail(
        @CustomType.Parameter("customActionTimeoutInMins") Integer customActionTimeoutInMins,
        @CustomType.Parameter("daysOfWeeks") List<GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetailDaysOfWeek> daysOfWeeks,
        ...
        @CustomType.Parameter("months") List<GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetailMonth> months,
     ...
     * 
     */
    public List<GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetailDaysOfWeek> daysOfWeeks() {
     ...
     * 
     */
    public List<GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetailMonth> months() {
        return this.months;
    }
    /**
     * @return Cloud Exadata infrastructure node patching method, either &#34;ROLLING&#34; or &#34;NONROLLING&#34;. Default value is ROLLING.
    ...
    public static Builder builder(GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetail defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private Integer customActionTimeoutInMins;
        private List<GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetailDaysOfWeek> daysOfWeeks;
        private List<Integer> hoursOfDays;
        private Boolean isCustomActionTimeoutEnabled;
        private Integer leadTimeInWeeks;
        private List<GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetailMonth> months;
        ...
        public Builder(GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetail defaults) {
        ...
        public Builder daysOfWeeks(List<GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetailDaysOfWeek> daysOfWeeks) {
            this.daysOfWeeks = Objects.requireNonNull(daysOfWeeks);
            return this;
        }
        public Builder daysOfWeeks(GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetailDaysOfWeek... daysOfWeeks) {
        ...
        public Builder months(List<GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetailMonth> months) {
            this.months = Objects.requireNonNull(months);
            return this;
        }
        public Builder months(GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetailMonth... months) {
        ...
        }        public GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetail build() {
            return new GetAutonomousExadataInfrastructuresAutonomousExadataInfrastructureMaintenanceWindowDetail(customActionTimeoutInMins, daysOfWeeks, hoursOfDays, isCustomActionTimeoutEnabled, leadTimeInWeeks, months, patchingMode, preference, weeksOfMonths);
        }
    }
}
