...
@CustomType
public final class GetWebAppFirewallPolicyRequestProtectionRuleProtectionCapabilityExclusion {
    /**
    ...
    private GetWebAppFirewallPolicyRequestProtectionRuleProtectionCapabilityExclusion(
    ...
    public static Builder builder(GetWebAppFirewallPolicyRequestProtectionRuleProtectionCapabilityExclusion defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetWebAppFirewallPolicyRequestProtectionRuleProtectionCapabilityExclusion defaults) {
        ...
        }        public GetWebAppFirewallPolicyRequestProtectionRuleProtectionCapabilityExclusion build() {
            return new GetWebAppFirewallPolicyRequestProtectionRuleProtectionCapabilityExclusion(args, requestCookies);
        }
    }
}
