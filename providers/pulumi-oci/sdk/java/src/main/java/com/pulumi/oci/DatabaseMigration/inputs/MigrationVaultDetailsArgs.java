...
public final class MigrationVaultDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final MigrationVaultDetailsArgs Empty = new MigrationVaultDetailsArgs();
    ...
    private MigrationVaultDetailsArgs() {}

    private MigrationVaultDetailsArgs(MigrationVaultDetailsArgs $) {
    ...
    public static Builder builder(MigrationVaultDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MigrationVaultDetailsArgs();
        }

        public Builder(MigrationVaultDetailsArgs defaults) {
            $ = new MigrationVaultDetailsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MigrationVaultDetailsArgs build() {
