...
public final class GetManagedDatabasesUserSystemPrivilegesPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetManagedDatabasesUserSystemPrivilegesPlainArgs Empty = new GetManagedDatabasesUserSystemPrivilegesPlainArgs();

    @Import(name="filters")
    private @Nullable List<GetManagedDatabasesUserSystemPrivilegesFilter> filters;

    public Optional<List<GetManagedDatabasesUserSystemPrivilegesFilter>> filters() {
    ...
    private GetManagedDatabasesUserSystemPrivilegesPlainArgs() {}

    private GetManagedDatabasesUserSystemPrivilegesPlainArgs(GetManagedDatabasesUserSystemPrivilegesPlainArgs $) {
    ...
    public static Builder builder(GetManagedDatabasesUserSystemPrivilegesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetManagedDatabasesUserSystemPrivilegesPlainArgs();
        }

        public Builder(GetManagedDatabasesUserSystemPrivilegesPlainArgs defaults) {
            $ = new GetManagedDatabasesUserSystemPrivilegesPlainArgs(Objects.requireNonNull(defaults));
        }
