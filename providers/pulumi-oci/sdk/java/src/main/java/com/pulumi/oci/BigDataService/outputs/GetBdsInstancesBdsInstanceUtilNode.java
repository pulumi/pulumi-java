...
@CustomType
public final class GetBdsInstancesBdsInstanceUtilNode {
    /**
    ...
    private GetBdsInstancesBdsInstanceUtilNode(
    ...
    public static Builder builder(GetBdsInstancesBdsInstanceUtilNode defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetBdsInstancesBdsInstanceUtilNode defaults) {
        ...
        public Builder subnetId(String subnetId) {
            ...
            return this;
        }        public GetBdsInstancesBdsInstanceUtilNode build() {
            return new GetBdsInstancesBdsInstanceUtilNode(blockVolumeSizeInGbs, numberOfNodes, shape, subnetId);
        }
    }
}
