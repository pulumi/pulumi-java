...
public final class SecurityAssessmentStatisticHighRiskArgs extends com.pulumi.resources.ResourceArgs {

    public static final SecurityAssessmentStatisticHighRiskArgs Empty = new SecurityAssessmentStatisticHighRiskArgs();
    ...
    private SecurityAssessmentStatisticHighRiskArgs() {}

    private SecurityAssessmentStatisticHighRiskArgs(SecurityAssessmentStatisticHighRiskArgs $) {
    ...
    public static Builder builder(SecurityAssessmentStatisticHighRiskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecurityAssessmentStatisticHighRiskArgs();
        }

        public Builder(SecurityAssessmentStatisticHighRiskArgs defaults) {
            $ = new SecurityAssessmentStatisticHighRiskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SecurityAssessmentStatisticHighRiskArgs build() {
            return $;
        }
    }
