...
public final class GetManagedDatabaseUserProxiedForUserArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetManagedDatabaseUserProxiedForUserArgs Empty = new GetManagedDatabaseUserProxiedForUserArgs();
    ...
    private GetManagedDatabaseUserProxiedForUserArgs() {}

    private GetManagedDatabaseUserProxiedForUserArgs(GetManagedDatabaseUserProxiedForUserArgs $) {
    ...
    public static Builder builder(GetManagedDatabaseUserProxiedForUserArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetManagedDatabaseUserProxiedForUserArgs();
        }

        public Builder(GetManagedDatabaseUserProxiedForUserArgs defaults) {
            $ = new GetManagedDatabaseUserProxiedForUserArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetManagedDatabaseUserProxiedForUserArgs build() {
