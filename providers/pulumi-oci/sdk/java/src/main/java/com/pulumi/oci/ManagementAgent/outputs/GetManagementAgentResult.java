...
public final class GetManagementAgentResult {
     ...
     * 
     */
    private final List<GetManagementAgentPluginList> pluginLists;
    /**
    ...
    private GetManagementAgentResult(
        ...
        @CustomType.Parameter("pluginLists") List<GetManagementAgentPluginList> pluginLists,
    ...
    public static final class Builder {
        ...
        public Builder version(String version) {
            ...
            return new GetManagementAgentResult(availabilityStatus, compartmentId, definedTags, deployPluginsIds, displayName, freeformTags, host, hostId, id, installKeyId, installPath, installType, isAgentAutoUpgradable, isCustomerDeployed, lifecycleDetails, managedAgentId, managementAgentId, platformName, platformType, platformVersion, pluginLists, resourceArtifactVersion, state, timeCreated, timeLastHeartbeat, timeUpdated, version);
        }
    }
}
