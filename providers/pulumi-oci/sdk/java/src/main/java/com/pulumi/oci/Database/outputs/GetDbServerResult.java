...
public final class GetDbServerResult {
     ...
     * 
     */
    private final List<GetDbServerDbServerPatchingDetail> dbServerPatchingDetails;
    /**
    ...
    private GetDbServerResult(
        ...
        @CustomType.Parameter("dbServerPatchingDetails") List<GetDbServerDbServerPatchingDetail> dbServerPatchingDetails,
    ...
    public static final class Builder {
        ...
        public Builder vmClusterIds(String... vmClusterIds) {
            ...
            return new GetDbServerResult(compartmentId, cpuCoreCount, dbNodeIds, dbNodeStorageSizeInGbs, dbServerId, dbServerPatchingDetails, definedTags, displayName, exadataInfrastructureId, freeformTags, id, lifecycleDetails, maxCpuCount, maxDbNodeStorageInGbs, maxMemoryInGbs, memorySizeInGbs, state, timeCreated, vmClusterIds);
        }
    }
}
