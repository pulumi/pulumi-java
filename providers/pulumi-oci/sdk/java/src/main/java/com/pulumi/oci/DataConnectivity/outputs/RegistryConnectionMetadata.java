...
import com.pulumi.oci.DataConnectivity.outputs.RegistryConnectionMetadataAggregator;
...
@CustomType
public final class RegistryConnectionMetadata {
    /**
     ...
     * 
     */
    private final @Nullable RegistryConnectionMetadataAggregator aggregator;
    /**
    ...
    private RegistryConnectionMetadata(
        @CustomType.Parameter("aggregator") @Nullable RegistryConnectionMetadataAggregator aggregator,
     ...
     * 
     */
    public Optional<RegistryConnectionMetadataAggregator> aggregator() {
    ...
    public static Builder builder(RegistryConnectionMetadata defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable RegistryConnectionMetadataAggregator aggregator;
        ...
        public Builder(RegistryConnectionMetadata defaults) {
        ...
        public Builder aggregator(@Nullable RegistryConnectionMetadataAggregator aggregator) {
            this.aggregator = aggregator;
            return this;
        }
        ...
        public Builder updatedByName(@Nullable String updatedByName) {
            this.updatedByName = updatedByName;
            return this;
        }        public RegistryConnectionMetadata build() {
            return new RegistryConnectionMetadata(aggregator, aggregatorKey, createdBy, createdByName, identifierPath, infoFields, isFavorite, labels, registryVersion, timeCreated, timeUpdated, updatedBy, updatedByName);
        }
    }
}
