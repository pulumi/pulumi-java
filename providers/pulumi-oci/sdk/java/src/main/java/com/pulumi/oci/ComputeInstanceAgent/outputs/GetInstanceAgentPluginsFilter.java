...
public final class GetInstanceAgentPluginsFilter {
    ...
    public static Builder builder(GetInstanceAgentPluginsFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetInstanceAgentPluginsFilter defaults) {
        ...
        }        public GetInstanceAgentPluginsFilter build() {
            return new GetInstanceAgentPluginsFilter(name, regex, values);
        }
    }
}
