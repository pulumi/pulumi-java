...
@CustomType
public final class GetSecurityAssessmentStatisticHighRisk {
    /**
    ...
    private GetSecurityAssessmentStatisticHighRisk(
    ...
    public static Builder builder(GetSecurityAssessmentStatisticHighRisk defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetSecurityAssessmentStatisticHighRisk defaults) {
        ...
        public Builder userAccountsFindingsCount(Integer userAccountsFindingsCount) {
            ...
            return this;
        }        public GetSecurityAssessmentStatisticHighRisk build() {
            return new GetSecurityAssessmentStatisticHighRisk(auditingFindingsCount, authorizationControlFindingsCount, dataEncryptionFindingsCount, dbConfigurationFindingsCount, fineGrainedAccessControlFindingsCount, privilegesAndRolesFindingsCount, targetsCount, userAccountsFindingsCount);
        }
    }
}
