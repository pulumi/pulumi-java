...
public final class DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsSetHeadersItemArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsSetHeadersItemArgs Empty = new DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsSetHeadersItemArgs();
    ...
    private DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsSetHeadersItemArgs() {}

    private DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsSetHeadersItemArgs(DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsSetHeadersItemArgs $) {
    ...
    public static Builder builder(DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsSetHeadersItemArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsSetHeadersItemArgs();
        }

        public Builder(DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsSetHeadersItemArgs defaults) {
            $ = new DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsSetHeadersItemArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsSetHeadersItemArgs build() {
