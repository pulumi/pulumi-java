...
@CustomType
public final class GetVcnsVirtualNetworkByoipv6cidrDetail {
    private final String byoipv6rangeId;
    private final String ipv6cidrBlock;

    @CustomType.Constructor
    private GetVcnsVirtualNetworkByoipv6cidrDetail(
    ...
    public static Builder builder(GetVcnsVirtualNetworkByoipv6cidrDetail defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetVcnsVirtualNetworkByoipv6cidrDetail defaults) {
        ...
        public Builder ipv6cidrBlock(String ipv6cidrBlock) {
            ...
            return new GetVcnsVirtualNetworkByoipv6cidrDetail(byoipv6rangeId, ipv6cidrBlock);
        }
    }
}
