...
@CustomType
public final class RegistryConnectionRegistryMetadata {
    /**
    ...
    private RegistryConnectionRegistryMetadata(
    ...
    public static Builder builder(RegistryConnectionRegistryMetadata defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RegistryConnectionRegistryMetadata defaults) {
        ...
        public Builder updatedByUserName(@Nullable String updatedByUserName) {
            this.updatedByUserName = updatedByUserName;
            return this;
        }        public RegistryConnectionRegistryMetadata build() {
            return new RegistryConnectionRegistryMetadata(aggregatorKey, createdByUserId, createdByUserName, isFavorite, key, labels, registryVersion, timeCreated, timeUpdated, updatedByUserId, updatedByUserName);
        }
    }
}
