...
@CustomType
public final class GetMigrationsMigrationCollectionItemDatapumpSettingDataPumpParameter {
    /**
    ...
    private GetMigrationsMigrationCollectionItemDatapumpSettingDataPumpParameter(
    ...
    public static Builder builder(GetMigrationsMigrationCollectionItemDatapumpSettingDataPumpParameter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetMigrationsMigrationCollectionItemDatapumpSettingDataPumpParameter defaults) {
        ...
        public Builder tableExistsAction(String tableExistsAction) {
            ...
            return new GetMigrationsMigrationCollectionItemDatapumpSettingDataPumpParameter(estimate, excludeParameters, exportParallelismDegree, importParallelismDegree, isCluster, tableExistsAction);
        }
    }
}
