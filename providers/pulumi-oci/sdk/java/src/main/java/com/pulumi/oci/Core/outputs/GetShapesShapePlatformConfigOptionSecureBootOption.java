...
@CustomType
public final class GetShapesShapePlatformConfigOptionSecureBootOption {
    /**
    ...
    private GetShapesShapePlatformConfigOptionSecureBootOption(
    ...
    public static Builder builder(GetShapesShapePlatformConfigOptionSecureBootOption defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetShapesShapePlatformConfigOptionSecureBootOption defaults) {
        ...
        public Builder isDefaultEnabled(Boolean isDefaultEnabled) {
            ...
            return this;
        }        public GetShapesShapePlatformConfigOptionSecureBootOption build() {
            return new GetShapesShapePlatformConfigOptionSecureBootOption(allowedValues, isDefaultEnabled);
        }
    }
}
