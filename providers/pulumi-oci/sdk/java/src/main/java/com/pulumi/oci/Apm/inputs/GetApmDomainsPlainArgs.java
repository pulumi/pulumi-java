...
public final class GetApmDomainsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetApmDomainsPlainArgs Empty = new GetApmDomainsPlainArgs();
    ...
    private GetApmDomainsPlainArgs() {}

    private GetApmDomainsPlainArgs(GetApmDomainsPlainArgs $) {
    ...
    public static Builder builder(GetApmDomainsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetApmDomainsPlainArgs();
        }

        public Builder(GetApmDomainsPlainArgs defaults) {
            $ = new GetApmDomainsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetApmDomainsPlainArgs build() {
