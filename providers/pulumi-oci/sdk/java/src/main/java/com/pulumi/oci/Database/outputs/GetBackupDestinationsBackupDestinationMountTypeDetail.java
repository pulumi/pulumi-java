...
@CustomType
public final class GetBackupDestinationsBackupDestinationMountTypeDetail {
    /**
    ...
    private GetBackupDestinationsBackupDestinationMountTypeDetail(
    ...
    public static Builder builder(GetBackupDestinationsBackupDestinationMountTypeDetail defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetBackupDestinationsBackupDestinationMountTypeDetail defaults) {
        ...
        }        public GetBackupDestinationsBackupDestinationMountTypeDetail build() {
            return new GetBackupDestinationsBackupDestinationMountTypeDetail(localMountPointPath, mountType, nfsServerExport, nfsServers);
        }
    }
}
