...
import com.pulumi.oci.Database.outputs.DbSystemMaintenanceWindowDetailsDaysOfWeek;
import com.pulumi.oci.Database.outputs.DbSystemMaintenanceWindowDetailsMonth;
...
@CustomType
public final class DbSystemMaintenanceWindowDetails {
    /**
     ...
     * 
     */
    private final @Nullable List<DbSystemMaintenanceWindowDetailsDaysOfWeek> daysOfWeeks;
    /**
     ...
     * 
     */
    private final @Nullable List<DbSystemMaintenanceWindowDetailsMonth> months;
    /**
    ...
    private DbSystemMaintenanceWindowDetails(
        @CustomType.Parameter("customActionTimeoutInMins") @Nullable Integer customActionTimeoutInMins,
        @CustomType.Parameter("daysOfWeeks") @Nullable List<DbSystemMaintenanceWindowDetailsDaysOfWeek> daysOfWeeks,
        ...
        @CustomType.Parameter("months") @Nullable List<DbSystemMaintenanceWindowDetailsMonth> months,
     ...
     * 
     */
    public List<DbSystemMaintenanceWindowDetailsDaysOfWeek> daysOfWeeks() {
     ...
     * 
     */
    public List<DbSystemMaintenanceWindowDetailsMonth> months() {
    ...
    public static Builder builder(DbSystemMaintenanceWindowDetails defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable Integer customActionTimeoutInMins;
        private @Nullable List<DbSystemMaintenanceWindowDetailsDaysOfWeek> daysOfWeeks;
        ...
        private @Nullable List<DbSystemMaintenanceWindowDetailsMonth> months;
        ...
        public Builder(DbSystemMaintenanceWindowDetails defaults) {
        ...
        public Builder daysOfWeeks(@Nullable List<DbSystemMaintenanceWindowDetailsDaysOfWeek> daysOfWeeks) {
            this.daysOfWeeks = daysOfWeeks;
            return this;
        }
        public Builder daysOfWeeks(DbSystemMaintenanceWindowDetailsDaysOfWeek... daysOfWeeks) {
        ...
        public Builder months(@Nullable List<DbSystemMaintenanceWindowDetailsMonth> months) {
            this.months = months;
            return this;
        }
        public Builder months(DbSystemMaintenanceWindowDetailsMonth... months) {
        ...
        }        public DbSystemMaintenanceWindowDetails build() {
            return new DbSystemMaintenanceWindowDetails(customActionTimeoutInMins, daysOfWeeks, hoursOfDays, isCustomActionTimeoutEnabled, leadTimeInWeeks, months, patchingMode, preference, weeksOfMonths);
        }
    }
}
