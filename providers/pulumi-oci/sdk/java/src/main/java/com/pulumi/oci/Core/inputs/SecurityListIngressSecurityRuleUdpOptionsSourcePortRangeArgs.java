...
public final class SecurityListIngressSecurityRuleUdpOptionsSourcePortRangeArgs extends com.pulumi.resources.ResourceArgs {

    public static final SecurityListIngressSecurityRuleUdpOptionsSourcePortRangeArgs Empty = new SecurityListIngressSecurityRuleUdpOptionsSourcePortRangeArgs();
    ...
    private SecurityListIngressSecurityRuleUdpOptionsSourcePortRangeArgs() {}

    private SecurityListIngressSecurityRuleUdpOptionsSourcePortRangeArgs(SecurityListIngressSecurityRuleUdpOptionsSourcePortRangeArgs $) {
        this.max = $.max;
        this.min = $.min;
    }
    ...
    public static Builder builder(SecurityListIngressSecurityRuleUdpOptionsSourcePortRangeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecurityListIngressSecurityRuleUdpOptionsSourcePortRangeArgs();
        }

        public Builder(SecurityListIngressSecurityRuleUdpOptionsSourcePortRangeArgs defaults) {
            $ = new SecurityListIngressSecurityRuleUdpOptionsSourcePortRangeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SecurityListIngressSecurityRuleUdpOptionsSourcePortRangeArgs build() {
