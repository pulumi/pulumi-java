...
import com.pulumi.oci.Database.inputs.DatabaseDbBackupConfigBackupDestinationDetailArgs;
...
public final class DatabaseDbBackupConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatabaseDbBackupConfigArgs Empty = new DatabaseDbBackupConfigArgs();
    ...
    private @Nullable Output<List<DatabaseDbBackupConfigBackupDestinationDetailArgs>> backupDestinationDetails;

    /**
     * @return Backup destination details.
     * 
     */
    public Optional<Output<List<DatabaseDbBackupConfigBackupDestinationDetailArgs>>> backupDestinationDetails() {
    ...
    private DatabaseDbBackupConfigArgs() {}
    ...
    public static Builder builder(DatabaseDbBackupConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatabaseDbBackupConfigArgs();
        }

        public Builder(DatabaseDbBackupConfigArgs defaults) {
            $ = new DatabaseDbBackupConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder backupDestinationDetails(@Nullable Output<List<DatabaseDbBackupConfigBackupDestinationDetailArgs>> backupDestinationDetails) {
         ...
         * 
         */
        public Builder backupDestinationDetails(List<DatabaseDbBackupConfigBackupDestinationDetailArgs> backupDestinationDetails) {
         ...
         * 
         */
        public Builder backupDestinationDetails(DatabaseDbBackupConfigBackupDestinationDetailArgs... backupDestinationDetails) {
        ...
        public DatabaseDbBackupConfigArgs build() {
            return $;
        }
    }
