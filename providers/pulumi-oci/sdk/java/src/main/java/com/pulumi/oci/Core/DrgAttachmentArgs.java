...
public final class DrgAttachmentArgs extends com.pulumi.resources.ResourceArgs {

    public static final DrgAttachmentArgs Empty = new DrgAttachmentArgs();
    ...
    private DrgAttachmentArgs() {}

    private DrgAttachmentArgs(DrgAttachmentArgs $) {
    ...
    public static Builder builder(DrgAttachmentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DrgAttachmentArgs();
        }

        public Builder(DrgAttachmentArgs defaults) {
            $ = new DrgAttachmentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DrgAttachmentArgs build() {
