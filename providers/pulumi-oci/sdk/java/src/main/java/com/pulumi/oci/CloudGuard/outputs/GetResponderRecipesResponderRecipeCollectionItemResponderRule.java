...
import com.pulumi.oci.CloudGuard.outputs.GetResponderRecipesResponderRecipeCollectionItemResponderRuleDetail;
...
public final class GetResponderRecipesResponderRecipeCollectionItemResponderRule {
     ...
     * 
     */
    private final List<GetResponderRecipesResponderRecipeCollectionItemResponderRuleDetail> details;
    /**
    ...
    private GetResponderRecipesResponderRecipeCollectionItemResponderRule(
        ...
        @CustomType.Parameter("details") List<GetResponderRecipesResponderRecipeCollectionItemResponderRuleDetail> details,
    ...
    public static Builder builder(GetResponderRecipesResponderRecipeCollectionItemResponderRule defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetResponderRecipesResponderRecipeCollectionItemResponderRule defaults) {
        ...
        public Builder details(List<GetResponderRecipesResponderRecipeCollectionItemResponderRuleDetail> details) {
            this.details = Objects.requireNonNull(details);
            return this;
        }
        public Builder details(GetResponderRecipesResponderRecipeCollectionItemResponderRuleDetail... details) {
        ...
        public Builder type(String type) {
            ...
            return this;
        }        public GetResponderRecipesResponderRecipeCollectionItemResponderRule build() {
            return new GetResponderRecipesResponderRecipeCollectionItemResponderRule(compartmentId, description, details, displayName, lifecycleDetails, policies, responderRuleId, state, supportedModes, timeCreated, timeUpdated, type);
        }
    }
}
