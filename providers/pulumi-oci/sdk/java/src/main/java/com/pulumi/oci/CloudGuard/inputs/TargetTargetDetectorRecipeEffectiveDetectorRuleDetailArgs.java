...
import com.pulumi.oci.CloudGuard.inputs.TargetTargetDetectorRecipeEffectiveDetectorRuleDetailConditionGroupArgs;
import com.pulumi.oci.CloudGuard.inputs.TargetTargetDetectorRecipeEffectiveDetectorRuleDetailConfigurationArgs;
...
public final class TargetTargetDetectorRecipeEffectiveDetectorRuleDetailArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TargetTargetDetectorRecipeEffectiveDetectorRuleDetailArgs() {}

    private TargetTargetDetectorRecipeEffectiveDetectorRuleDetailArgs(TargetTargetDetectorRecipeEffectiveDetectorRuleDetailArgs $) {
    ...
    public static Builder builder(TargetTargetDetectorRecipeEffectiveDetectorRuleDetailArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TargetTargetDetectorRecipeEffectiveDetectorRuleDetailArgs();
        }

        public Builder(TargetTargetDetectorRecipeEffectiveDetectorRuleDetailArgs defaults) {
            $ = new TargetTargetDetectorRecipeEffectiveDetectorRuleDetailArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder conditionGroups(@Nullable Output<List<TargetTargetDetectorRecipeEffectiveDetectorRuleDetailConditionGroupArgs>> conditionGroups) {
         ...
         * 
         */
        public Builder conditionGroups(List<TargetTargetDetectorRecipeEffectiveDetectorRuleDetailConditionGroupArgs> conditionGroups) {
         ...
         * 
         */
        public Builder conditionGroups(TargetTargetDetectorRecipeEffectiveDetectorRuleDetailConditionGroupArgs... conditionGroups) {
         ...
         * 
         */
        public Builder configurations(@Nullable Output<List<TargetTargetDetectorRecipeEffectiveDetectorRuleDetailConfigurationArgs>> configurations) {
         ...
         * 
         */
        public Builder configurations(List<TargetTargetDetectorRecipeEffectiveDetectorRuleDetailConfigurationArgs> configurations) {
         ...
         * 
         */
        public Builder configurations(TargetTargetDetectorRecipeEffectiveDetectorRuleDetailConfigurationArgs... configurations) {
        ...
        public TargetTargetDetectorRecipeEffectiveDetectorRuleDetailArgs build() {
            return $;
        }
    }
