...
@CustomType
public final class GetCertificateAuthoritiesCertificateAuthorityCollectionItemCurrentVersionValidity {
    /**
    ...
    private GetCertificateAuthoritiesCertificateAuthorityCollectionItemCurrentVersionValidity(
    ...
    public static Builder builder(GetCertificateAuthoritiesCertificateAuthorityCollectionItemCurrentVersionValidity defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetCertificateAuthoritiesCertificateAuthorityCollectionItemCurrentVersionValidity defaults) {
        ...
        public Builder timeOfValidityNotBefore(String timeOfValidityNotBefore) {
            ...
            return this;
        }        public GetCertificateAuthoritiesCertificateAuthorityCollectionItemCurrentVersionValidity build() {
            return new GetCertificateAuthoritiesCertificateAuthorityCollectionItemCurrentVersionValidity(timeOfValidityNotAfter, timeOfValidityNotBefore);
        }
    }
}
