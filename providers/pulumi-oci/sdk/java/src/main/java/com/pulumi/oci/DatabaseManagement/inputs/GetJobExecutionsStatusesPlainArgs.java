...
public final class GetJobExecutionsStatusesPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetJobExecutionsStatusesPlainArgs Empty = new GetJobExecutionsStatusesPlainArgs();
    ...
    public Optional<List<GetJobExecutionsStatusesFilter>> filters() {
    ...
    private GetJobExecutionsStatusesPlainArgs() {}

    private GetJobExecutionsStatusesPlainArgs(GetJobExecutionsStatusesPlainArgs $) {
    ...
    public static Builder builder(GetJobExecutionsStatusesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetJobExecutionsStatusesPlainArgs();
        }

        public Builder(GetJobExecutionsStatusesPlainArgs defaults) {
            $ = new GetJobExecutionsStatusesPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetJobExecutionsStatusesPlainArgs build() {
