...
@CustomType
public final class GetApiDeploymentSpecificationRouteRequestPolicyHeaderTransformationSetHeaderItem {
    /**
    ...
    private GetApiDeploymentSpecificationRouteRequestPolicyHeaderTransformationSetHeaderItem(
    ...
    public static Builder builder(GetApiDeploymentSpecificationRouteRequestPolicyHeaderTransformationSetHeaderItem defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetApiDeploymentSpecificationRouteRequestPolicyHeaderTransformationSetHeaderItem defaults) {
        ...
        }        public GetApiDeploymentSpecificationRouteRequestPolicyHeaderTransformationSetHeaderItem build() {
            return new GetApiDeploymentSpecificationRouteRequestPolicyHeaderTransformationSetHeaderItem(ifExists, name, values);
        }
    }
}
