...
public final class GetContainerImagesPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetContainerImagesPlainArgs Empty = new GetContainerImagesPlainArgs();
    ...
    private GetContainerImagesPlainArgs() {}

    private GetContainerImagesPlainArgs(GetContainerImagesPlainArgs $) {
    ...
    public static Builder builder(GetContainerImagesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetContainerImagesPlainArgs();
        }

        public Builder(GetContainerImagesPlainArgs defaults) {
            $ = new GetContainerImagesPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetContainerImagesPlainArgs build() {
