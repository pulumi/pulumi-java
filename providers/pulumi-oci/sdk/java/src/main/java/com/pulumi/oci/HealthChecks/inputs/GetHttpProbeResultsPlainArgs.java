...
public final class GetHttpProbeResultsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetHttpProbeResultsPlainArgs Empty = new GetHttpProbeResultsPlainArgs();
    ...
    private GetHttpProbeResultsPlainArgs() {}

    private GetHttpProbeResultsPlainArgs(GetHttpProbeResultsPlainArgs $) {
    ...
    public static Builder builder(GetHttpProbeResultsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetHttpProbeResultsPlainArgs();
        }

        public Builder(GetHttpProbeResultsPlainArgs defaults) {
            $ = new GetHttpProbeResultsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetHttpProbeResultsPlainArgs build() {
