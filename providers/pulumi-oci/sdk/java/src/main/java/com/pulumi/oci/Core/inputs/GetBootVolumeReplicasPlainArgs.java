...
public final class GetBootVolumeReplicasPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetBootVolumeReplicasPlainArgs Empty = new GetBootVolumeReplicasPlainArgs();
    ...
    public Optional<List<GetBootVolumeReplicasFilter>> filters() {
    ...
    public static Builder builder(GetBootVolumeReplicasPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBootVolumeReplicasPlainArgs();
        }

        public Builder(GetBootVolumeReplicasPlainArgs defaults) {
            $ = new GetBootVolumeReplicasPlainArgs(Objects.requireNonNull(defaults));
        }
