...
import com.pulumi.oci.Database.outputs.GetAutonomousDatabaseConnectionStringProfile;
...
@CustomType
public final class GetAutonomousDatabaseConnectionString {
    /**
     ...
     * 
     */
    private final List<GetAutonomousDatabaseConnectionStringProfile> profiles;

    @CustomType.Constructor
    private GetAutonomousDatabaseConnectionString(
        ...
        @CustomType.Parameter("profiles") List<GetAutonomousDatabaseConnectionStringProfile> profiles) {
     ...
     * 
     */
    public List<GetAutonomousDatabaseConnectionStringProfile> profiles() {
    ...
    public static Builder builder(GetAutonomousDatabaseConnectionString defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetAutonomousDatabaseConnectionStringProfile> profiles;

        public Builder() {
    	      // Empty
        }

        public Builder(GetAutonomousDatabaseConnectionString defaults) {
        ...
        public Builder profiles(List<GetAutonomousDatabaseConnectionStringProfile> profiles) {
            this.profiles = Objects.requireNonNull(profiles);
            return this;
        }
        public Builder profiles(GetAutonomousDatabaseConnectionStringProfile... profiles) {
            return profiles(List.of(profiles));
        }        public GetAutonomousDatabaseConnectionString build() {
            return new GetAutonomousDatabaseConnectionString(allConnectionStrings, dedicated, high, low, medium, profiles);
        }
    }
}
