...
public final class DrgArgs extends com.pulumi.resources.ResourceArgs {

    public static final DrgArgs Empty = new DrgArgs();
    ...
    public static Builder builder(DrgArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DrgArgs defaults) {
            $ = new DrgArgs(Objects.requireNonNull(defaults));
        }
