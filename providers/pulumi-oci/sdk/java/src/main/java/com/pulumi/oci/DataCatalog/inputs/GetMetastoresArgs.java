...
public final class GetMetastoresArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private Output</* @Nullable */ List<GetMetastoresFilter>> filters;

    public Output</* @Nullable */ List<GetMetastoresFilter>> filters() {
        return this.filters;
    }
    ...
    public static final class Builder {
        ...
        public Builder filters(Output</* @Nullable */ List<GetMetastoresFilter>> filters) {
            $.filters = filters;
            return this;
        }
