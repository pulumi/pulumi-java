...
public final class GetMaskingPoliciesMaskingColumnMaskingFormatFormatEntry {
    ...
    public static final class Builder {
        ...
        public Builder userDefinedFunction(String userDefinedFunction) {
            ...
            return new GetMaskingPoliciesMaskingColumnMaskingFormatFormatEntry(columnName, description, endDate, endLength, endValue, fixedNumber, fixedString, groupingColumns, length, libraryMaskingFormatId, postProcessingFunction, randomLists, regularExpression, replaceWith, schemaName, sqlExpression, startDate, startLength, startPosition, startValue, tableName, type, userDefinedFunction);
        }
    }
}
