...
public final class GetVantagePointItemGeo {
    ...
    public static Builder builder(GetVantagePointItemGeo defaults) {
    ...
    public static final class Builder {
        ...
        public Builder longitude(Double longitude) {
            ...
            return new GetVantagePointItemGeo(adminDivCode, cityName, countryCode, countryName, latitude, longitude);
        }
    }
}
