...
public final class GetMysqlConfigurationsFilter {
    ...
    public static Builder builder(GetMysqlConfigurationsFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetMysqlConfigurationsFilter defaults) {
        ...
        }        public GetMysqlConfigurationsFilter build() {
            return new GetMysqlConfigurationsFilter(name, regex, values);
        }
    }
}
