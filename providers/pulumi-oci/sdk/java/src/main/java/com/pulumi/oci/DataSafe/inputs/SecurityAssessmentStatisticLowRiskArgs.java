...
public final class SecurityAssessmentStatisticLowRiskArgs extends com.pulumi.resources.ResourceArgs {

    public static final SecurityAssessmentStatisticLowRiskArgs Empty = new SecurityAssessmentStatisticLowRiskArgs();
    ...
    private SecurityAssessmentStatisticLowRiskArgs() {}

    private SecurityAssessmentStatisticLowRiskArgs(SecurityAssessmentStatisticLowRiskArgs $) {
    ...
    public static Builder builder(SecurityAssessmentStatisticLowRiskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecurityAssessmentStatisticLowRiskArgs();
        }

        public Builder(SecurityAssessmentStatisticLowRiskArgs defaults) {
            $ = new SecurityAssessmentStatisticLowRiskArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SecurityAssessmentStatisticLowRiskArgs build() {
            return $;
        }
    }
