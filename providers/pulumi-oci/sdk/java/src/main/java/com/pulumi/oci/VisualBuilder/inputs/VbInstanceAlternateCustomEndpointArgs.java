...
public final class VbInstanceAlternateCustomEndpointArgs extends com.pulumi.resources.ResourceArgs {

    public static final VbInstanceAlternateCustomEndpointArgs Empty = new VbInstanceAlternateCustomEndpointArgs();
    ...
    private VbInstanceAlternateCustomEndpointArgs() {}

    private VbInstanceAlternateCustomEndpointArgs(VbInstanceAlternateCustomEndpointArgs $) {
    ...
    public static Builder builder(VbInstanceAlternateCustomEndpointArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VbInstanceAlternateCustomEndpointArgs();
        }

        public Builder(VbInstanceAlternateCustomEndpointArgs defaults) {
            $ = new VbInstanceAlternateCustomEndpointArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VbInstanceAlternateCustomEndpointArgs build() {
