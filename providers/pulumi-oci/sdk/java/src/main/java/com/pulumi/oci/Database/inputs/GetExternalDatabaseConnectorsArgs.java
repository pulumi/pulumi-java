...
public final class GetExternalDatabaseConnectorsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetExternalDatabaseConnectorsArgs Empty = new GetExternalDatabaseConnectorsArgs();
    ...
    private GetExternalDatabaseConnectorsArgs(GetExternalDatabaseConnectorsArgs $) {
    ...
    public static Builder builder(GetExternalDatabaseConnectorsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetExternalDatabaseConnectorsArgs();
        }

        public Builder(GetExternalDatabaseConnectorsArgs defaults) {
            $ = new GetExternalDatabaseConnectorsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetExternalDatabaseConnectorsArgs build() {
