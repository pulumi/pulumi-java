...
public final class AutonomousExadataInfrastructureMaintenanceWindowDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutonomousExadataInfrastructureMaintenanceWindowDetailsArgs Empty = new AutonomousExadataInfrastructureMaintenanceWindowDetailsArgs();
    ...
    private @Nullable Output<List<AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeekArgs>> daysOfWeeks;

    /**
     * @return (Updatable) Days during the week when maintenance should be performed.
     * 
     */
    public Optional<Output<List<AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeekArgs>>> daysOfWeeks() {
     ...
     */
    @Import(name="months")
    private @Nullable Output<List<AutonomousExadataInfrastructureMaintenanceWindowDetailsMonthArgs>> months;

    /**
     * @return (Updatable) Months during the year when maintenance should be performed.
     * 
     */
    public Optional<Output<List<AutonomousExadataInfrastructureMaintenanceWindowDetailsMonthArgs>>> months() {
    ...
    private AutonomousExadataInfrastructureMaintenanceWindowDetailsArgs() {}

    private AutonomousExadataInfrastructureMaintenanceWindowDetailsArgs(AutonomousExadataInfrastructureMaintenanceWindowDetailsArgs $) {
    ...
    public static Builder builder(AutonomousExadataInfrastructureMaintenanceWindowDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutonomousExadataInfrastructureMaintenanceWindowDetailsArgs();
        }

        public Builder(AutonomousExadataInfrastructureMaintenanceWindowDetailsArgs defaults) {
            $ = new AutonomousExadataInfrastructureMaintenanceWindowDetailsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder daysOfWeeks(@Nullable Output<List<AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeekArgs>> daysOfWeeks) {
         ...
         * 
         */
        public Builder daysOfWeeks(List<AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeekArgs> daysOfWeeks) {
         ...
         * 
         */
        public Builder daysOfWeeks(AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeekArgs... daysOfWeeks) {
         ...
         * 
         */
        public Builder months(@Nullable Output<List<AutonomousExadataInfrastructureMaintenanceWindowDetailsMonthArgs>> months) {
            $.months = months;
            return this;
        }
         ...
         * 
         */
        public Builder months(List<AutonomousExadataInfrastructureMaintenanceWindowDetailsMonthArgs> months) {
         ...
         * 
         */
        public Builder months(AutonomousExadataInfrastructureMaintenanceWindowDetailsMonthArgs... months) {
        ...
        public AutonomousExadataInfrastructureMaintenanceWindowDetailsArgs build() {
