...
import com.pulumi.oci.DataConnectivity.outputs.GetRegistryFoldersFolderSummaryCollectionItemDataAssetMetadataAggregator;
...
@CustomType
public final class GetRegistryFoldersFolderSummaryCollectionItemDataAssetMetadata {
    /**
     * @return A summary type containing information about the object&#39;s aggregator including its type, key, name and description.
     * 
     */
    private final GetRegistryFoldersFolderSummaryCollectionItemDataAssetMetadataAggregator aggregator;
    /**
    ...
    private GetRegistryFoldersFolderSummaryCollectionItemDataAssetMetadata(
        @CustomType.Parameter("aggregator") GetRegistryFoldersFolderSummaryCollectionItemDataAssetMetadataAggregator aggregator,
     ...
     * 
     */
    public GetRegistryFoldersFolderSummaryCollectionItemDataAssetMetadataAggregator aggregator() {
    ...
    public static Builder builder(GetRegistryFoldersFolderSummaryCollectionItemDataAssetMetadata defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private GetRegistryFoldersFolderSummaryCollectionItemDataAssetMetadataAggregator aggregator;
        ...
        public Builder(GetRegistryFoldersFolderSummaryCollectionItemDataAssetMetadata defaults) {
        ...
        public Builder aggregator(GetRegistryFoldersFolderSummaryCollectionItemDataAssetMetadataAggregator aggregator) {
        ...
        public Builder updatedByName(String updatedByName) {
            ...
            return this;
        }        public GetRegistryFoldersFolderSummaryCollectionItemDataAssetMetadata build() {
            return new GetRegistryFoldersFolderSummaryCollectionItemDataAssetMetadata(aggregator, aggregatorKey, createdBy, createdByName, identifierPath, infoFields, isFavorite, labels, registryVersion, timeCreated, timeUpdated, updatedBy, updatedByName);
        }
    }
}
