...
public final class GetExportSetsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetExportSetsArgs Empty = new GetExportSetsArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetExportSetsFilterArgs>> filters;

    public Optional<Output<List<GetExportSetsFilterArgs>>> filters() {
    ...
    private GetExportSetsArgs() {}

    private GetExportSetsArgs(GetExportSetsArgs $) {
    ...
    public static Builder builder(GetExportSetsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetExportSetsArgs();
        }

        public Builder(GetExportSetsArgs defaults) {
            $ = new GetExportSetsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetExportSetsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetExportSetsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetExportSetsFilterArgs... filters) {
