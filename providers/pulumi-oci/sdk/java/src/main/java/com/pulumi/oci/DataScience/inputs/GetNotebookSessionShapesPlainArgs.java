...
public final class GetNotebookSessionShapesPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetNotebookSessionShapesPlainArgs Empty = new GetNotebookSessionShapesPlainArgs();
    ...
    private GetNotebookSessionShapesPlainArgs() {}

    private GetNotebookSessionShapesPlainArgs(GetNotebookSessionShapesPlainArgs $) {
    ...
    public static Builder builder(GetNotebookSessionShapesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNotebookSessionShapesPlainArgs();
        }

        public Builder(GetNotebookSessionShapesPlainArgs defaults) {
            $ = new GetNotebookSessionShapesPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetNotebookSessionShapesPlainArgs build() {
