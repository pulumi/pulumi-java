...
import com.pulumi.oci.Database.outputs.DatabaseDatabaseDbBackupConfigBackupDestinationDetail;
...
@CustomType
public final class DatabaseDatabaseDbBackupConfig {
    /**
     ...
     * 
     */
    private final @Nullable List<DatabaseDatabaseDbBackupConfigBackupDestinationDetail> backupDestinationDetails;
    /**
    ...
    private DatabaseDatabaseDbBackupConfig(
        ...
        @CustomType.Parameter("backupDestinationDetails") @Nullable List<DatabaseDatabaseDbBackupConfigBackupDestinationDetail> backupDestinationDetails,
     ...
     * 
     */
    public List<DatabaseDatabaseDbBackupConfigBackupDestinationDetail> backupDestinationDetails() {
    ...
    public static Builder builder(DatabaseDatabaseDbBackupConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<DatabaseDatabaseDbBackupConfigBackupDestinationDetail> backupDestinationDetails;
        ...
        public Builder(DatabaseDatabaseDbBackupConfig defaults) {
        ...
        public Builder backupDestinationDetails(@Nullable List<DatabaseDatabaseDbBackupConfigBackupDestinationDetail> backupDestinationDetails) {
            this.backupDestinationDetails = backupDestinationDetails;
            return this;
        }
        public Builder backupDestinationDetails(DatabaseDatabaseDbBackupConfigBackupDestinationDetail... backupDestinationDetails) {
        ...
        public Builder recoveryWindowInDays(@Nullable Integer recoveryWindowInDays) {
            this.recoveryWindowInDays = recoveryWindowInDays;
            return this;
        }        public DatabaseDatabaseDbBackupConfig build() {
            return new DatabaseDatabaseDbBackupConfig(autoBackupEnabled, autoBackupWindow, backupDestinationDetails, recoveryWindowInDays);
        }
    }
}
