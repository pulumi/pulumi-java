...
public final class ManagedDatabasesChangeDatabaseParameterCredentialsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ManagedDatabasesChangeDatabaseParameterCredentialsArgs Empty = new ManagedDatabasesChangeDatabaseParameterCredentialsArgs();
    ...
    private ManagedDatabasesChangeDatabaseParameterCredentialsArgs() {}

    private ManagedDatabasesChangeDatabaseParameterCredentialsArgs(ManagedDatabasesChangeDatabaseParameterCredentialsArgs $) {
    ...
    public static Builder builder(ManagedDatabasesChangeDatabaseParameterCredentialsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagedDatabasesChangeDatabaseParameterCredentialsArgs();
        }

        public Builder(ManagedDatabasesChangeDatabaseParameterCredentialsArgs defaults) {
            $ = new ManagedDatabasesChangeDatabaseParameterCredentialsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ManagedDatabasesChangeDatabaseParameterCredentialsArgs build() {
            return $;
        }
    }
