...
@CustomType
public final class GetAutonomousDatabasesAutonomousDatabaseStandbyDb {
    /**
    ...
    private GetAutonomousDatabasesAutonomousDatabaseStandbyDb(
    ...
    public static Builder builder(GetAutonomousDatabasesAutonomousDatabaseStandbyDb defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAutonomousDatabasesAutonomousDatabaseStandbyDb defaults) {
        ...
        public Builder timeDataGuardRoleChanged(String timeDataGuardRoleChanged) {
            ...
            return this;
        }        public GetAutonomousDatabasesAutonomousDatabaseStandbyDb build() {
            return new GetAutonomousDatabasesAutonomousDatabaseStandbyDb(lagTimeInSeconds, lifecycleDetails, state, timeDataGuardRoleChanged);
        }
    }
}
