...
public final class GetHostnamesFilter extends com.pulumi.resources.InvokeArgs {
    ...
    private GetHostnamesFilter(GetHostnamesFilter $) {
        this.name = $.name;
        this.regex = $.regex;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetHostnamesFilter();
        }

        public Builder(GetHostnamesFilter defaults) {
            $ = new GetHostnamesFilter(Objects.requireNonNull(defaults));
        }
