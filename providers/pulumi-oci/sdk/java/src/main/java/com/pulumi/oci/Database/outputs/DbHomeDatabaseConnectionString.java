...
@CustomType
public final class DbHomeDatabaseConnectionString {
    ...
    private DbHomeDatabaseConnectionString(
    ...
    public static Builder builder(DbHomeDatabaseConnectionString defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DbHomeDatabaseConnectionString defaults) {
        ...
        public Builder cdbIpDefault(@Nullable String cdbIpDefault) {
            this.cdbIpDefault = cdbIpDefault;
            return this;
        }        public DbHomeDatabaseConnectionString build() {
            return new DbHomeDatabaseConnectionString(allConnectionStrings, cdbDefault, cdbIpDefault);
        }
    }
}
