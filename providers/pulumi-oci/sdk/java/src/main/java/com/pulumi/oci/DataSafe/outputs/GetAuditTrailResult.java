...
public final class GetAuditTrailResult {
    ...
    public static final class Builder {
        ...
        public Builder workRequestId(String workRequestId) {
            ...
            return new GetAuditTrailResult(auditCollectionStartTime, auditProfileId, auditTrailId, compartmentId, definedTags, description, displayName, freeformTags, id, isAutoPurgeEnabled, lifecycleDetails, resumeTrigger, state, status, systemTags, targetId, timeCreated, timeUpdated, trailLocation, workRequestId);
        }
    }
}
