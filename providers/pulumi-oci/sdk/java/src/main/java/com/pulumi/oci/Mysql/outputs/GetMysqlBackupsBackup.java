...
public final class GetMysqlBackupsBackup {
     ...
     * 
     */
    private final List<GetMysqlBackupsBackupDbSystemSnapshot> dbSystemSnapshots;
    /**
    ...
    private GetMysqlBackupsBackup(
        ...
        @CustomType.Parameter("dbSystemSnapshots") List<GetMysqlBackupsBackupDbSystemSnapshot> dbSystemSnapshots,
    ...
    public static final class Builder {
        ...
        public Builder timeUpdated(String timeUpdated) {
            ...
            return new GetMysqlBackupsBackup(backupSizeInGbs, backupType, compartmentId, creationType, dataStorageSizeInGb, dbSystemId, dbSystemSnapshots, definedTags, description, displayName, freeformTags, id, lifecycleDetails, mysqlVersion, retentionInDays, shapeName, state, timeCreated, timeUpdated);
        }
    }
}
