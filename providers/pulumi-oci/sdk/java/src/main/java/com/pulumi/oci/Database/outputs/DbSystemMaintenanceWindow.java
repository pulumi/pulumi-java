...
import com.pulumi.oci.Database.outputs.DbSystemMaintenanceWindowDaysOfWeek;
import com.pulumi.oci.Database.outputs.DbSystemMaintenanceWindowMonth;
...
@CustomType
public final class DbSystemMaintenanceWindow {
    /**
     ...
     * 
     */
    private final @Nullable List<DbSystemMaintenanceWindowDaysOfWeek> daysOfWeeks;
    /**
     ...
     * 
     */
    private final @Nullable List<DbSystemMaintenanceWindowMonth> months;
    /**
    ...
    private DbSystemMaintenanceWindow(
        @CustomType.Parameter("customActionTimeoutInMins") @Nullable Integer customActionTimeoutInMins,
        @CustomType.Parameter("daysOfWeeks") @Nullable List<DbSystemMaintenanceWindowDaysOfWeek> daysOfWeeks,
        ...
        @CustomType.Parameter("months") @Nullable List<DbSystemMaintenanceWindowMonth> months,
     ...
     * 
     */
    public List<DbSystemMaintenanceWindowDaysOfWeek> daysOfWeeks() {
     ...
     * 
     */
    public List<DbSystemMaintenanceWindowMonth> months() {
    ...
    public static Builder builder(DbSystemMaintenanceWindow defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable Integer customActionTimeoutInMins;
        private @Nullable List<DbSystemMaintenanceWindowDaysOfWeek> daysOfWeeks;
        ...
        private @Nullable List<DbSystemMaintenanceWindowMonth> months;
        ...
        public Builder(DbSystemMaintenanceWindow defaults) {
        ...
        public Builder daysOfWeeks(@Nullable List<DbSystemMaintenanceWindowDaysOfWeek> daysOfWeeks) {
            this.daysOfWeeks = daysOfWeeks;
            return this;
        }
        public Builder daysOfWeeks(DbSystemMaintenanceWindowDaysOfWeek... daysOfWeeks) {
        ...
        public Builder months(@Nullable List<DbSystemMaintenanceWindowMonth> months) {
            this.months = months;
            return this;
        }
        public Builder months(DbSystemMaintenanceWindowMonth... months) {
        ...
        }        public DbSystemMaintenanceWindow build() {
            return new DbSystemMaintenanceWindow(customActionTimeoutInMins, daysOfWeeks, hoursOfDays, isCustomActionTimeoutEnabled, leadTimeInWeeks, months, patchingMode, preference, weeksOfMonths);
        }
    }
}
