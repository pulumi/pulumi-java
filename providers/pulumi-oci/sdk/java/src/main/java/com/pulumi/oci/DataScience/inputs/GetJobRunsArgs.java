...
public final class GetJobRunsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetJobRunsFilterArgs>> filters;

    public Optional<Output<List<GetJobRunsFilterArgs>>> filters() {
    ...
    public static final class Builder {
        ...
        public Builder filters(@Nullable Output<List<GetJobRunsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetJobRunsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetJobRunsFilterArgs... filters) {
