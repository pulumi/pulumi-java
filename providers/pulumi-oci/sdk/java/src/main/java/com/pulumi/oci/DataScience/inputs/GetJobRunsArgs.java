...
public final class GetJobRunsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetJobRunsArgs Empty = new GetJobRunsArgs();
    ...
    @Import(name="filters")
    private Output</* @Nullable */ List<GetJobRunsFilter>> filters;

    public Output</* @Nullable */ List<GetJobRunsFilter>> filters() {
        return this.filters;
    }
     ...
     * 
     */
    public Output</* @Nullable */ String> jobId() {
        return this.jobId;
    }
    ...
    private GetJobRunsArgs() {}

    private GetJobRunsArgs(GetJobRunsArgs $) {
    ...
    public static Builder builder(GetJobRunsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetJobRunsArgs defaults) {
            $ = new GetJobRunsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(Output</* @Nullable */ List<GetJobRunsFilter>> filters) {
            $.filters = filters;
            return this;
        }
         ...
         * 
         */
        public Builder jobId(Output</* @Nullable */ String> jobId) {
            $.jobId = jobId;
            return this;
        }
