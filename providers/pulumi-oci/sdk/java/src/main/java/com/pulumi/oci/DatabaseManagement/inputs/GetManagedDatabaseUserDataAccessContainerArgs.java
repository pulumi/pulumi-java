...
public final class GetManagedDatabaseUserDataAccessContainerArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetManagedDatabaseUserDataAccessContainerArgs Empty = new GetManagedDatabaseUserDataAccessContainerArgs();
    ...
    private GetManagedDatabaseUserDataAccessContainerArgs() {}

    private GetManagedDatabaseUserDataAccessContainerArgs(GetManagedDatabaseUserDataAccessContainerArgs $) {
    ...
    public static Builder builder(GetManagedDatabaseUserDataAccessContainerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetManagedDatabaseUserDataAccessContainerArgs();
        }

        public Builder(GetManagedDatabaseUserDataAccessContainerArgs defaults) {
            $ = new GetManagedDatabaseUserDataAccessContainerArgs(Objects.requireNonNull(defaults));
        }
