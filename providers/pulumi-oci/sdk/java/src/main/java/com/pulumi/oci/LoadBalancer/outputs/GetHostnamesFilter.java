...
public final class GetHostnamesFilter {
    ...
    public static Builder builder(GetHostnamesFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetHostnamesFilter defaults) {
        ...
        }        public GetHostnamesFilter build() {
            return new GetHostnamesFilter(name, regex, values);
        }
    }
}
