...
@CustomType
public final class GetBuildPipelineStagesFilter {
    /**
    ...
    private GetBuildPipelineStagesFilter(
    ...
    public static Builder builder(GetBuildPipelineStagesFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetBuildPipelineStagesFilter defaults) {
        ...
        }        public GetBuildPipelineStagesFilter build() {
            return new GetBuildPipelineStagesFilter(name, regex, values);
        }
    }
}
