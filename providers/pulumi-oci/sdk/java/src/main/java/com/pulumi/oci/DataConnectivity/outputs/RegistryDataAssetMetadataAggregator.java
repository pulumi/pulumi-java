...
@CustomType
public final class RegistryDataAssetMetadataAggregator {
    /**
    ...
    private RegistryDataAssetMetadataAggregator(
    ...
    public static Builder builder(RegistryDataAssetMetadataAggregator defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RegistryDataAssetMetadataAggregator defaults) {
        ...
        public Builder type(@Nullable String type) {
            this.type = type;
            return this;
        }        public RegistryDataAssetMetadataAggregator build() {
            return new RegistryDataAssetMetadataAggregator(description, identifier, key, name, type);
        }
    }
}
