...
public final class GetAuditProfileCollectedAuditVolumePlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetAuditProfileCollectedAuditVolumePlainArgs Empty = new GetAuditProfileCollectedAuditVolumePlainArgs();
    ...
    private GetAuditProfileCollectedAuditVolumePlainArgs() {}

    private GetAuditProfileCollectedAuditVolumePlainArgs(GetAuditProfileCollectedAuditVolumePlainArgs $) {
    ...
    public static Builder builder(GetAuditProfileCollectedAuditVolumePlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAuditProfileCollectedAuditVolumePlainArgs();
        }

        public Builder(GetAuditProfileCollectedAuditVolumePlainArgs defaults) {
            $ = new GetAuditProfileCollectedAuditVolumePlainArgs(Objects.requireNonNull(defaults));
        }
