...
public final class GetRepositoryPathPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetRepositoryPathPlainArgs Empty = new GetRepositoryPathPlainArgs();
    ...
    private GetRepositoryPathPlainArgs() {}

    private GetRepositoryPathPlainArgs(GetRepositoryPathPlainArgs $) {
    ...
    public static Builder builder(GetRepositoryPathPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRepositoryPathPlainArgs();
        }

        public Builder(GetRepositoryPathPlainArgs defaults) {
            $ = new GetRepositoryPathPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRepositoryPathPlainArgs build() {
