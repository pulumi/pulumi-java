...
public final class SecurityAssessmentStatisticPassArgs extends com.pulumi.resources.ResourceArgs {

    public static final SecurityAssessmentStatisticPassArgs Empty = new SecurityAssessmentStatisticPassArgs();
    ...
    private SecurityAssessmentStatisticPassArgs() {}

    private SecurityAssessmentStatisticPassArgs(SecurityAssessmentStatisticPassArgs $) {
    ...
    public static Builder builder(SecurityAssessmentStatisticPassArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecurityAssessmentStatisticPassArgs();
        }

        public Builder(SecurityAssessmentStatisticPassArgs defaults) {
            $ = new SecurityAssessmentStatisticPassArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SecurityAssessmentStatisticPassArgs build() {
            return $;
        }
    }
