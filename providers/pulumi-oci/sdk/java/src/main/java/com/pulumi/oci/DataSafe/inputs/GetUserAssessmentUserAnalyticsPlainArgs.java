...
public final class GetUserAssessmentUserAnalyticsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetUserAssessmentUserAnalyticsPlainArgs Empty = new GetUserAssessmentUserAnalyticsPlainArgs();
    ...
    private GetUserAssessmentUserAnalyticsPlainArgs() {}

    private GetUserAssessmentUserAnalyticsPlainArgs(GetUserAssessmentUserAnalyticsPlainArgs $) {
    ...
    public static Builder builder(GetUserAssessmentUserAnalyticsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetUserAssessmentUserAnalyticsPlainArgs();
        }

        public Builder(GetUserAssessmentUserAnalyticsPlainArgs defaults) {
            $ = new GetUserAssessmentUserAnalyticsPlainArgs(Objects.requireNonNull(defaults));
        }
