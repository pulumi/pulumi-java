...
public final class GetGroupsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private Output</* @Nullable */ List<GetGroupsFilter>> filters;

    public Output</* @Nullable */ List<GetGroupsFilter>> filters() {
        return this.filters;
    }
    ...
    public static final class Builder {
        ...
        public Builder filters(Output</* @Nullable */ List<GetGroupsFilter>> filters) {
            $.filters = filters;
            return this;
        }
