...
public final class GetVaultRestoreFromObjectStore {
    ...
    public static Builder builder(GetVaultRestoreFromObjectStore defaults) {
    ...
    public static final class Builder {
        ...
        public Builder uri(String uri) {
            ...
            return new GetVaultRestoreFromObjectStore(bucket, destination, namespace, object, uri);
        }
    }
}
