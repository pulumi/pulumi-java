...
public final class GetAuditEventArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetAuditEventArgs Empty = new GetAuditEventArgs();
    ...
    private GetAuditEventArgs() {}

    private GetAuditEventArgs(GetAuditEventArgs $) {
    ...
    public static Builder builder(GetAuditEventArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAuditEventArgs();
        }

        public Builder(GetAuditEventArgs defaults) {
            $ = new GetAuditEventArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAuditEventArgs build() {
