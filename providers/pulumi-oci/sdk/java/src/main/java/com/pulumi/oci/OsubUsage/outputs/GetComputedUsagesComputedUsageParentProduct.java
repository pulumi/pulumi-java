...
@CustomType
public final class GetComputedUsagesComputedUsageParentProduct {
    /**
    ...
    private GetComputedUsagesComputedUsageParentProduct(
    ...
    public static Builder builder(GetComputedUsagesComputedUsageParentProduct defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetComputedUsagesComputedUsageParentProduct defaults) {
        ...
        public Builder unitOfMeasure(String unitOfMeasure) {
            ...
            return this;
        }        public GetComputedUsagesComputedUsageParentProduct build() {
            return new GetComputedUsagesComputedUsageParentProduct(billingCategory, name, partNumber, productCategory, provisioningGroup, ucmRateCardPartType, unitOfMeasure);
        }
    }
}
