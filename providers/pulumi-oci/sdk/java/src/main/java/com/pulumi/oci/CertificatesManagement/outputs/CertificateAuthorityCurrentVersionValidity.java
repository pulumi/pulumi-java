...
@CustomType
public final class CertificateAuthorityCurrentVersionValidity {
    /**
    ...
    private CertificateAuthorityCurrentVersionValidity(
    ...
    public static Builder builder(CertificateAuthorityCurrentVersionValidity defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CertificateAuthorityCurrentVersionValidity defaults) {
        ...
        public Builder timeOfValidityNotBefore(@Nullable String timeOfValidityNotBefore) {
            this.timeOfValidityNotBefore = timeOfValidityNotBefore;
            return this;
        }        public CertificateAuthorityCurrentVersionValidity build() {
            return new CertificateAuthorityCurrentVersionValidity(timeOfValidityNotAfter, timeOfValidityNotBefore);
        }
    }
}
