...
public final class GetManagedDatabasesUserProxyUserArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetManagedDatabasesUserProxyUserArgs Empty = new GetManagedDatabasesUserProxyUserArgs();
    ...
    private GetManagedDatabasesUserProxyUserArgs() {}

    private GetManagedDatabasesUserProxyUserArgs(GetManagedDatabasesUserProxyUserArgs $) {
    ...
    public static Builder builder(GetManagedDatabasesUserProxyUserArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetManagedDatabasesUserProxyUserArgs();
        }

        public Builder(GetManagedDatabasesUserProxyUserArgs defaults) {
            $ = new GetManagedDatabasesUserProxyUserArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetManagedDatabasesUserProxyUserArgs build() {
