...
import com.pulumi.oci.DataConnectivity.outputs.RegistryFolderDataAssetMetadataAggregator;
...
@CustomType
public final class RegistryFolderDataAssetMetadata {
    /**
     ...
     * 
     */
    private final @Nullable RegistryFolderDataAssetMetadataAggregator aggregator;
    /**
    ...
    private RegistryFolderDataAssetMetadata(
        @CustomType.Parameter("aggregator") @Nullable RegistryFolderDataAssetMetadataAggregator aggregator,
     ...
     * 
     */
    public Optional<RegistryFolderDataAssetMetadataAggregator> aggregator() {
    ...
    public static Builder builder(RegistryFolderDataAssetMetadata defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable RegistryFolderDataAssetMetadataAggregator aggregator;
        ...
        public Builder(RegistryFolderDataAssetMetadata defaults) {
        ...
        public Builder aggregator(@Nullable RegistryFolderDataAssetMetadataAggregator aggregator) {
            this.aggregator = aggregator;
            return this;
        }
        ...
        public Builder updatedByName(@Nullable String updatedByName) {
            this.updatedByName = updatedByName;
            return this;
        }        public RegistryFolderDataAssetMetadata build() {
            return new RegistryFolderDataAssetMetadata(aggregator, aggregatorKey, createdBy, createdByName, identifierPath, infoFields, isFavorite, labels, registryVersion, timeCreated, timeUpdated, updatedBy, updatedByName);
        }
    }
}
