...
public final class GetJobsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private Output</* @Nullable */ List<GetJobsFilter>> filters;

    public Output</* @Nullable */ List<GetJobsFilter>> filters() {
        return this.filters;
    }
    ...
    public static final class Builder {
        ...
        public Builder filters(Output</* @Nullable */ List<GetJobsFilter>> filters) {
            $.filters = filters;
            return this;
        }
