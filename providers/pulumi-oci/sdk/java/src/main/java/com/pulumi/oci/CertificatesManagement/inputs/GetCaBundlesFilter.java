...
public final class GetCaBundlesFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetCaBundlesFilter Empty = new GetCaBundlesFilter();
    ...
    private GetCaBundlesFilter(GetCaBundlesFilter $) {
        this.name = $.name;
        this.regex = $.regex;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCaBundlesFilter();
        }

        public Builder(GetCaBundlesFilter defaults) {
            $ = new GetCaBundlesFilter(Objects.requireNonNull(defaults));
        }
