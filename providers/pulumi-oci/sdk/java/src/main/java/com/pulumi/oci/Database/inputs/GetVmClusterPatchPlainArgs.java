...
public final class GetVmClusterPatchPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVmClusterPatchPlainArgs Empty = new GetVmClusterPatchPlainArgs();
    ...
    private GetVmClusterPatchPlainArgs() {}

    private GetVmClusterPatchPlainArgs(GetVmClusterPatchPlainArgs $) {
    ...
    public static Builder builder(GetVmClusterPatchPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVmClusterPatchPlainArgs();
        }

        public Builder(GetVmClusterPatchPlainArgs defaults) {
            $ = new GetVmClusterPatchPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVmClusterPatchPlainArgs build() {
