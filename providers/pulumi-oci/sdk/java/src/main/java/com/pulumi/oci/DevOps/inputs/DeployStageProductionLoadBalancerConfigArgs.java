...
public final class DeployStageProductionLoadBalancerConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DeployStageProductionLoadBalancerConfigArgs() {}

    private DeployStageProductionLoadBalancerConfigArgs(DeployStageProductionLoadBalancerConfigArgs $) {
    ...
    public static Builder builder(DeployStageProductionLoadBalancerConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeployStageProductionLoadBalancerConfigArgs();
        }

        public Builder(DeployStageProductionLoadBalancerConfigArgs defaults) {
            $ = new DeployStageProductionLoadBalancerConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeployStageProductionLoadBalancerConfigArgs build() {
            return $;
        }
    }
