...
public final class VolumeBackupPolicyState extends com.pulumi.resources.ResourceArgs {

    public static final VolumeBackupPolicyState Empty = new VolumeBackupPolicyState();
    ...
    private VolumeBackupPolicyState() {}

    private VolumeBackupPolicyState(VolumeBackupPolicyState $) {
    ...
    public static Builder builder(VolumeBackupPolicyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VolumeBackupPolicyState();
        }

        public Builder(VolumeBackupPolicyState defaults) {
            $ = new VolumeBackupPolicyState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param timeCreated The date and time the volume backup policy was created. Format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
         * 
         * @return builder
         * 
         */
        ...
        public VolumeBackupPolicyState build() {
            return $;
        }
    }
