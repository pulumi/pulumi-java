...
public final class GetCertificateCertificateConfigSubject {
    ...
    public static final class Builder {
        ...
        public Builder userId(String userId) {
            ...
            return new GetCertificateCertificateConfigSubject(commonName, country, distinguishedNameQualifier, domainComponent, generationQualifier, givenName, initials, localityName, organization, organizationalUnit, pseudonym, serialNumber, stateOrProvinceName, street, surname, title, userId);
        }
    }
}
