...
public final class GetBootVolumeBackupsBootVolumeBackup {
    ...
    private final List<GetBootVolumeBackupsBootVolumeBackupSourceDetail> sourceDetails;
    /**
    ...
    private GetBootVolumeBackupsBootVolumeBackup(
        ...
        @CustomType.Parameter("sourceDetails") List<GetBootVolumeBackupsBootVolumeBackupSourceDetail> sourceDetails,
    ...
    public static final class Builder {
        ...
        public Builder uniqueSizeInGbs(String uniqueSizeInGbs) {
            ...
            return new GetBootVolumeBackupsBootVolumeBackup(bootVolumeId, compartmentId, definedTags, displayName, expirationTime, freeformTags, id, imageId, kmsKeyId, sizeInGbs, sourceBootVolumeBackupId, sourceDetails, sourceType, state, systemTags, timeCreated, timeRequestReceived, type, uniqueSizeInGbs);
        }
    }
}
