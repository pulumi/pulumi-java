...
public final class GetVcnsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private Output</* @Nullable */ List<GetVcnsFilter>> filters;

    public Output</* @Nullable */ List<GetVcnsFilter>> filters() {
        return this.filters;
    }
    ...
    public static final class Builder {
        ...
        public Builder filters(Output</* @Nullable */ List<GetVcnsFilter>> filters) {
            $.filters = filters;
            return this;
        }
