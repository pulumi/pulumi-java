...
public final class GetBuildPipelinesFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetBuildPipelinesFilterArgs Empty = new GetBuildPipelinesFilterArgs();
    ...
    private GetBuildPipelinesFilterArgs() {}

    private GetBuildPipelinesFilterArgs(GetBuildPipelinesFilterArgs $) {
        this.name = $.name;
        this.regex = $.regex;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetBuildPipelinesFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBuildPipelinesFilterArgs();
        }

        public Builder(GetBuildPipelinesFilterArgs defaults) {
            $ = new GetBuildPipelinesFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetBuildPipelinesFilterArgs build() {
