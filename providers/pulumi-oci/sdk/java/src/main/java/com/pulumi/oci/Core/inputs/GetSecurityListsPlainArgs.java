...
import com.pulumi.oci.Core.inputs.GetSecurityListsFilter;
...
public final class GetSecurityListsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSecurityListsPlainArgs Empty = new GetSecurityListsPlainArgs();
    ...
    public Optional<List<GetSecurityListsFilter>> filters() {
    ...
    private GetSecurityListsPlainArgs() {}

    private GetSecurityListsPlainArgs(GetSecurityListsPlainArgs $) {
    ...
    public static Builder builder(GetSecurityListsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSecurityListsPlainArgs();
        }

        public Builder(GetSecurityListsPlainArgs defaults) {
            $ = new GetSecurityListsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSecurityListsPlainArgs build() {
