...
@CustomType
public final class GetRegistryFolderDataAssetDefaultConnectionMetadataAggregator {
    /**
    ...
    private GetRegistryFolderDataAssetDefaultConnectionMetadataAggregator(
    ...
    public static Builder builder(GetRegistryFolderDataAssetDefaultConnectionMetadataAggregator defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetRegistryFolderDataAssetDefaultConnectionMetadataAggregator defaults) {
        ...
        public Builder type(String type) {
            ...
            return this;
        }        public GetRegistryFolderDataAssetDefaultConnectionMetadataAggregator build() {
            return new GetRegistryFolderDataAssetDefaultConnectionMetadataAggregator(description, identifier, key, name, type);
        }
    }
}
