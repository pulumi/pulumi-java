...
public final class GetAuthTokensArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private Output</* @Nullable */ List<GetAuthTokensFilter>> filters;

    public Output</* @Nullable */ List<GetAuthTokensFilter>> filters() {
        return this.filters;
    }
    ...
    public static final class Builder {
        ...
        public Builder filters(Output</* @Nullable */ List<GetAuthTokensFilter>> filters) {
            $.filters = filters;
            return this;
        }
