...
public final class GetKeyVersionsKeyVersion {
     ...
     * 
     */
    private final List<GetKeyVersionsKeyVersionReplicaDetail> replicaDetails;
    ...
    private GetKeyVersionsKeyVersion(
        ...
        @CustomType.Parameter("replicaDetails") List<GetKeyVersionsKeyVersionReplicaDetail> replicaDetails,
    ...
    public static final class Builder {
        ...
        public Builder vaultId(String vaultId) {
            ...
            return new GetKeyVersionsKeyVersion(compartmentId, id, isPrimary, keyId, keyVersionId, managementEndpoint, publicKey, replicaDetails, restoredFromKeyId, restoredFromKeyVersionId, state, timeCreated, timeOfDeletion, vaultId);
        }
    }
}
