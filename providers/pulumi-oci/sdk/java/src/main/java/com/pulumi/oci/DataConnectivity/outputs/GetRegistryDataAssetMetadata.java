...
import com.pulumi.oci.DataConnectivity.outputs.GetRegistryDataAssetMetadataAggregator;
...
@CustomType
public final class GetRegistryDataAssetMetadata {
    /**
     ...
     * 
     */
    private final List<GetRegistryDataAssetMetadataAggregator> aggregators;
    /**
    ...
    private GetRegistryDataAssetMetadata(
        @CustomType.Parameter("aggregatorKey") String aggregatorKey,
        @CustomType.Parameter("aggregators") List<GetRegistryDataAssetMetadataAggregator> aggregators,
     ...
     * 
     */
    public List<GetRegistryDataAssetMetadataAggregator> aggregators() {
    ...
    public static Builder builder(GetRegistryDataAssetMetadata defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private String aggregatorKey;
        private List<GetRegistryDataAssetMetadataAggregator> aggregators;
        ...
        public Builder(GetRegistryDataAssetMetadata defaults) {
        ...
        public Builder aggregators(List<GetRegistryDataAssetMetadataAggregator> aggregators) {
            this.aggregators = Objects.requireNonNull(aggregators);
            return this;
        }
        public Builder aggregators(GetRegistryDataAssetMetadataAggregator... aggregators) {
        ...
        public Builder updatedByName(String updatedByName) {
            ...
            return this;
        }        public GetRegistryDataAssetMetadata build() {
            return new GetRegistryDataAssetMetadata(aggregatorKey, aggregators, createdBy, createdByName, identifierPath, infoFields, isFavorite, labels, registryVersion, timeCreated, timeUpdated, updatedBy, updatedByName);
        }
    }
}
