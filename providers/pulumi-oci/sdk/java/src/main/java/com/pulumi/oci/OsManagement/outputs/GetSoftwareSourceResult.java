...
public final class GetSoftwareSourceResult {
     ...
     * 
     */
    private final List<GetSoftwareSourceAssociatedManagedInstance> associatedManagedInstances;
    /**
    ...
    private GetSoftwareSourceResult(
        ...
        @CustomType.Parameter("associatedManagedInstances") List<GetSoftwareSourceAssociatedManagedInstance> associatedManagedInstances,
    ...
    public static final class Builder {
        ...
        public Builder url(String url) {
            ...
            return new GetSoftwareSourceResult(archType, associatedManagedInstances, checksumType, compartmentId, definedTags, description, displayName, freeformTags, gpgKeyFingerprint, gpgKeyId, gpgKeyUrl, id, maintainerEmail, maintainerName, maintainerPhone, packages, parentId, parentName, repoType, softwareSourceId, state, status, url);
        }
    }
}
