...
public final class GetSteeringPoliciesFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetSteeringPoliciesFilter Empty = new GetSteeringPoliciesFilter();
    ...
    private GetSteeringPoliciesFilter(GetSteeringPoliciesFilter $) {
        this.name = $.name;
        this.regex = $.regex;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSteeringPoliciesFilter();
        }

        public Builder(GetSteeringPoliciesFilter defaults) {
            $ = new GetSteeringPoliciesFilter(Objects.requireNonNull(defaults));
        }
