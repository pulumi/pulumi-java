...
@CustomType
public final class GetUserCapability {
    /**
    ...
    public static Builder builder(GetUserCapability defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetUserCapability defaults) {
        ...
        public Builder canUseSmtpCredentials(Boolean canUseSmtpCredentials) {
            ...
            return new GetUserCapability(canUseApiKeys, canUseAuthTokens, canUseConsolePassword, canUseCustomerSecretKeys, canUseDbCredentials, canUseOauth2clientCredentials, canUseSmtpCredentials);
        }
    }
}
