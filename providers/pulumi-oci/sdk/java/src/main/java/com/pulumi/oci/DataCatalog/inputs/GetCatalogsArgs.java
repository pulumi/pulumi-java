...
import com.pulumi.oci.DataCatalog.inputs.GetCatalogsFilterArgs;
...
public final class GetCatalogsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetCatalogsFilterArgs>> filters;

    public Optional<Output<List<GetCatalogsFilterArgs>>> filters() {
    ...
    public static final class Builder {
        ...
        public Builder filters(@Nullable Output<List<GetCatalogsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetCatalogsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetCatalogsFilterArgs... filters) {
