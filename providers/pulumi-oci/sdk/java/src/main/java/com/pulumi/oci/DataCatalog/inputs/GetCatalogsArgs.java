...
public final class GetCatalogsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private Output</* @Nullable */ List<GetCatalogsFilter>> filters;

    public Output</* @Nullable */ List<GetCatalogsFilter>> filters() {
        return this.filters;
    }
    ...
    public static final class Builder {
        ...
        public Builder filters(Output</* @Nullable */ List<GetCatalogsFilter>> filters) {
            $.filters = filters;
            return this;
        }
