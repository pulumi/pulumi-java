...
public final class RegistryConnectionMetadataAggregatorArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegistryConnectionMetadataAggregatorArgs Empty = new RegistryConnectionMetadataAggregatorArgs();
    ...
    private RegistryConnectionMetadataAggregatorArgs() {}

    private RegistryConnectionMetadataAggregatorArgs(RegistryConnectionMetadataAggregatorArgs $) {
    ...
    public static Builder builder(RegistryConnectionMetadataAggregatorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegistryConnectionMetadataAggregatorArgs();
        }

        public Builder(RegistryConnectionMetadataAggregatorArgs defaults) {
            $ = new RegistryConnectionMetadataAggregatorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegistryConnectionMetadataAggregatorArgs build() {
            return $;
        }
    }
