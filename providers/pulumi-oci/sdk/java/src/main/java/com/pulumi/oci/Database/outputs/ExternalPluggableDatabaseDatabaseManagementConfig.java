...
@CustomType
public final class ExternalPluggableDatabaseDatabaseManagementConfig {
    /**
    ...
    private ExternalPluggableDatabaseDatabaseManagementConfig(
    ...
    public static Builder builder(ExternalPluggableDatabaseDatabaseManagementConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ExternalPluggableDatabaseDatabaseManagementConfig defaults) {
        ...
        public Builder licenseModel(@Nullable String licenseModel) {
            ...
            return new ExternalPluggableDatabaseDatabaseManagementConfig(databaseManagementConnectionId, databaseManagementStatus, licenseModel);
        }
    }
}
