...
public final class ModelProvenanceArgs extends com.pulumi.resources.ResourceArgs {

    public static final ModelProvenanceArgs Empty = new ModelProvenanceArgs();
    ...
    private ModelProvenanceArgs() {}

    private ModelProvenanceArgs(ModelProvenanceArgs $) {
    ...
    public static Builder builder(ModelProvenanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ModelProvenanceArgs();
        }

        public Builder(ModelProvenanceArgs defaults) {
            $ = new ModelProvenanceArgs(Objects.requireNonNull(defaults));
        }
