...
public final class GetServiceConnectorsServiceConnectorCollectionItemTarget {
    ...
    public static final class Builder {
        ...
        public Builder topicId(String topicId) {
            ...
            return new GetServiceConnectorsServiceConnectorCollectionItemTarget(batchRolloverSizeInMbs, batchRolloverTimeInMs, bucket, compartmentId, dimensions, enableFormattedMessaging, functionId, kind, logGroupId, metric, metricNamespace, namespace, objectNamePrefix, streamId, topicId);
        }
    }
}
