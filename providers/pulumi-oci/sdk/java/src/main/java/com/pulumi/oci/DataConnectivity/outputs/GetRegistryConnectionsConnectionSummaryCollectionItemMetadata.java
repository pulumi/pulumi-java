...
import com.pulumi.oci.DataConnectivity.outputs.GetRegistryConnectionsConnectionSummaryCollectionItemMetadataAggregator;
...
@CustomType
public final class GetRegistryConnectionsConnectionSummaryCollectionItemMetadata {
    /**
     * @return A summary type containing information about the object&#39;s aggregator including its type, key, name and description.
     * 
     */
    private final GetRegistryConnectionsConnectionSummaryCollectionItemMetadataAggregator aggregator;
    /**
    ...
    private GetRegistryConnectionsConnectionSummaryCollectionItemMetadata(
        @CustomType.Parameter("aggregator") GetRegistryConnectionsConnectionSummaryCollectionItemMetadataAggregator aggregator,
     ...
     * 
     */
    public GetRegistryConnectionsConnectionSummaryCollectionItemMetadataAggregator aggregator() {
    ...
    public static Builder builder(GetRegistryConnectionsConnectionSummaryCollectionItemMetadata defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private GetRegistryConnectionsConnectionSummaryCollectionItemMetadataAggregator aggregator;
        ...
        public Builder(GetRegistryConnectionsConnectionSummaryCollectionItemMetadata defaults) {
        ...
        public Builder aggregator(GetRegistryConnectionsConnectionSummaryCollectionItemMetadataAggregator aggregator) {
        ...
        public Builder updatedByName(String updatedByName) {
            ...
            return this;
        }        public GetRegistryConnectionsConnectionSummaryCollectionItemMetadata build() {
            return new GetRegistryConnectionsConnectionSummaryCollectionItemMetadata(aggregator, aggregatorKey, createdBy, createdByName, identifierPath, infoFields, isFavorite, labels, registryVersion, timeCreated, timeUpdated, updatedBy, updatedByName);
        }
    }
}
