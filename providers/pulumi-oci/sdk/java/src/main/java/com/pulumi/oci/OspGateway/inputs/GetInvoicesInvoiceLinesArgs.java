...
public final class GetInvoicesInvoiceLinesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetInvoicesInvoiceLinesArgs Empty = new GetInvoicesInvoiceLinesArgs();
    ...
    private GetInvoicesInvoiceLinesArgs() {}

    private GetInvoicesInvoiceLinesArgs(GetInvoicesInvoiceLinesArgs $) {
    ...
    public static Builder builder(GetInvoicesInvoiceLinesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetInvoicesInvoiceLinesArgs();
        }

        public Builder(GetInvoicesInvoiceLinesArgs defaults) {
            $ = new GetInvoicesInvoiceLinesArgs(Objects.requireNonNull(defaults));
        }
