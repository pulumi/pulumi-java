...
@CustomType
public final class GetClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnet {
    /**
    ...
    private GetClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnet(
    ...
    public static Builder builder(GetClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnet defaults) {
    ...
    public static final class Builder {
        ...
        public Builder subnetId(String subnetId) {
            ...
            return new GetClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnet(displayName, subnetId);
        }
    }
}
