...
public final class MysqlDbSystemArgs extends com.pulumi.resources.ResourceArgs {

    public static final MysqlDbSystemArgs Empty = new MysqlDbSystemArgs();
    ...
    public static Builder builder(MysqlDbSystemArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MysqlDbSystemArgs();
        }

        public Builder(MysqlDbSystemArgs defaults) {
            $ = new MysqlDbSystemArgs(Objects.requireNonNull(defaults));
        }
