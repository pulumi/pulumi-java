...
@CustomType
public final class GetSecurityAssessmentComparisonTargetPrivilegesAndRoleBaselineReference {
    /**
    ...
    private GetSecurityAssessmentComparisonTargetPrivilegesAndRoleBaselineReference(
    ...
    public static Builder builder(GetSecurityAssessmentComparisonTargetPrivilegesAndRoleBaselineReference defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetSecurityAssessmentComparisonTargetPrivilegesAndRoleBaselineReference defaults) {
        ...
        public Builder stig(String stig) {
            ...
            return new GetSecurityAssessmentComparisonTargetPrivilegesAndRoleBaselineReference(cis, gdpr, stig);
        }
    }
}
