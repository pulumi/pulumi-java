...
public final class GetManagedDatabaseUserResult {
    ...
    public static final class Builder {
        ...
        public Builder userName(String userName) {
            ...
            return new GetManagedDatabaseUserResult(allShared, authentication, common, consumerGroup, defaultCollation, defaultTablespace, editionsEnabled, externalName, externalShared, id, implicit, inherited, localTempTablespace, managedDatabaseId, name, oracleMaintained, passwordVersions, profile, proxyConnect, status, tempTablespace, timeCreated, timeExpiring, timeLastLogin, timeLocked, timePasswordChanged, userName);
        }
    }
}
