...
import com.pulumi.awsx.vpc.inputs.GetDefaultVpcArgs;
import com.pulumi.awsx.vpc.outputs.GetDefaultVpcResult;
...
public final class VpcFunctions {
    ...
    public static CompletableFuture<GetDefaultVpcResult> getDefaultVpc(GetDefaultVpcArgs args, InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("awsx:vpc:getDefaultVpc", TypeShape.of(GetDefaultVpcResult.class), args, Utilities.withVersion(options));
    }
}
