...
import com.pulumi.awsx.vpc.inputs.NatGatewayConfigurationArgs;
import com.pulumi.awsx.vpc.inputs.SubnetConfigurationArgs;
...
public final class VpcArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="availabilityZoneNames")
    private @Nullable List<String> availabilityZoneNames;

    /**
     * @return A list of availability zones to which the subnets defined in subnetsPerAz will be deployed. Optional, defaults to the first 3 AZs in the current region.
     * 
     */
    public Optional<List<String>> availabilityZoneNames() {
        return Optional.ofNullable(this.availabilityZoneNames);
    }
    ...
    /**
     * @return The CIDR block for the VPC. Optional. Defaults to 10.0.0.0/16.
     * 
     */
    ...
    private @Nullable NatGatewayConfigurationArgs natGateways;

    /**
     * @return Configuration for NAT Gateways. Optional. If private and public subnets are both specified, defaults to one gateway per availability zone. Otherwise, no gateways will be created.
     * 
     */
    public Optional<NatGatewayConfigurationArgs> natGateways() {
     ...
     * 
     */
    @Import(name="subnetsPerAz")
    private @Nullable List<SubnetConfigurationArgs> subnetsPerAz;

    /**
     * @return A list of subnets that should be deployed to each AZ specified in availabilityZoneNames. Optional. Defaults to a (smaller) public subnet and a (larger) private subnet based on the size of the CIDR block for the VPC.
     * 
     */
    public Optional<List<SubnetConfigurationArgs>> subnetsPerAz() {
        return Optional.ofNullable(this.subnetsPerAz);
    }
    ...
    private VpcArgs(VpcArgs $) {
        ...
        this.subnetsPerAz = $.subnetsPerAz;
        this.tags = $.tags;
    }
    ...
    public static final class Builder {
        ...
        /**
         * @param availabilityZoneNames A list of availability zones to which the subnets defined in subnetsPerAz will be deployed. Optional, defaults to the first 3 AZs in the current region.
         * 
         * @return builder
         * 
         */
        public Builder availabilityZoneNames(@Nullable List<String> availabilityZoneNames) {
         ...
         * 
         */
        public Builder availabilityZoneNames(String... availabilityZoneNames) {
            return availabilityZoneNames(List.of(availabilityZoneNames));
        }

        /**
         * @param cidrBlock The CIDR block for the VPC. Optional. Defaults to 10.0.0.0/16.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param natGateways Configuration for NAT Gateways. Optional. If private and public subnets are both specified, defaults to one gateway per availability zone. Otherwise, no gateways will be created.
         * 
         * @return builder
         * 
         */
        public Builder natGateways(@Nullable NatGatewayConfigurationArgs natGateways) {
            $.natGateways = natGateways;
            return this;
        }

        /**
         * @param subnetsPerAz A list of subnets that should be deployed to each AZ specified in availabilityZoneNames. Optional. Defaults to a (smaller) public subnet and a (larger) private subnet based on the size of the CIDR block for the VPC.
         * 
         * @return builder
         * 
         */
        public Builder subnetsPerAz(@Nullable List<SubnetConfigurationArgs> subnetsPerAz) {
         ...
         * 
         */
        public Builder subnetsPerAz(SubnetConfigurationArgs... subnetsPerAz) {
            return subnetsPerAz(List.of(subnetsPerAz));
        }
