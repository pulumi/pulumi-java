...
public class AppProfile extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.bigtableadmin_v2.AppProfileArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.bigtableadmin_v2.AppProfileArgs.builder();
