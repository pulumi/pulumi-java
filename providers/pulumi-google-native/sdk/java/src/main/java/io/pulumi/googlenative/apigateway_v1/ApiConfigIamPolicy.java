...
public class ApiConfigIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.apigateway_v1.ApiConfigIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.apigateway_v1.ApiConfigIamPolicyArgs.builder();
    ...
    public ApiConfigIamPolicy(String name, ApiConfigIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:apigateway/v1:ApiConfigIamPolicy", name, args == null ? ApiConfigIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ApiConfigIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ApiConfigIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
