...
public class TransferConfig extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable TransferConfigArgs.Builder a);
    }
    private static io.pulumi.googlenative.bigquerydatatransfer_v1.TransferConfigArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.bigquerydatatransfer_v1.TransferConfigArgs.builder();
     ...
     */
    public TransferConfig(String name, BuilderApplicator argsBuilder) {
