...
public class Notification extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.storage_v1.NotificationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.storage_v1.NotificationArgs.builder();
