...
public class Router extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.RouterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.RouterArgs.builder();
    ...
    public Router(String name, RouterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:Router", name, args == null ? RouterArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
