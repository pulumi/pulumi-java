...
public class CapacityCommitment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.bigqueryreservation_v1beta1.CapacityCommitmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.bigqueryreservation_v1beta1.CapacityCommitmentArgs.builder();
    ...
    public CapacityCommitment(String name, @Nullable CapacityCommitmentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:bigqueryreservation/v1beta1:CapacityCommitment", name, args == null ? CapacityCommitmentArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
