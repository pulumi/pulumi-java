...
public final class GoogleCloudDialogflowCxV3beta1ExperimentResultVersionMetricsArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public GoogleCloudDialogflowCxV3beta1ExperimentResultVersionMetricsArgs(
        @Nullable Input<List<GoogleCloudDialogflowCxV3beta1ExperimentResultMetricArgs>> metrics,
    ...
    public static final class Builder {
        private @Nullable Input<List<GoogleCloudDialogflowCxV3beta1ExperimentResultMetricArgs>> metrics;
        ...
        public Builder setMetrics(@Nullable Input<List<GoogleCloudDialogflowCxV3beta1ExperimentResultMetricArgs>> metrics) {
            this.metrics = metrics;
            return this;
        }

        public Builder setMetrics(@Nullable List<GoogleCloudDialogflowCxV3beta1ExperimentResultMetricArgs> metrics) {
