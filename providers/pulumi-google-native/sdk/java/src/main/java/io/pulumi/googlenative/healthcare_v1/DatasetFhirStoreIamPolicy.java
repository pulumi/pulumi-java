...
public class DatasetFhirStoreIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public DatasetFhirStoreIamPolicy(String name, DatasetFhirStoreIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1:DatasetFhirStoreIamPolicy", name, args == null ? DatasetFhirStoreIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
