...
import io.pulumi.googlenative.compute_beta.PacketMirroringArgs;
import io.pulumi.googlenative.compute_beta.outputs.PacketMirroringFilterResponse;
import io.pulumi.googlenative.compute_beta.outputs.PacketMirroringForwardingRuleInfoResponse;
import io.pulumi.googlenative.compute_beta.outputs.PacketMirroringMirroredResourceInfoResponse;
import io.pulumi.googlenative.compute_beta.outputs.PacketMirroringNetworkInfoResponse;
...
public class PacketMirroring extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.PacketMirroringArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.PacketMirroringArgs.builder();
    ...
    public PacketMirroring(String name, PacketMirroringArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:PacketMirroring", name, args == null ? PacketMirroringArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
     ...
     */
    public static PacketMirroring get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
