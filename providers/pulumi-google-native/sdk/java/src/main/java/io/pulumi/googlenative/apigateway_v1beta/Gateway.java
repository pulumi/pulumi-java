...
public class Gateway extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.apigateway_v1beta.GatewayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.apigateway_v1beta.GatewayArgs.builder();
    ...
    public Gateway(String name, GatewayArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:apigateway/v1beta:Gateway", name, args == null ? GatewayArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
