...
public class PacketMirroring extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.PacketMirroringArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.PacketMirroringArgs.builder();
