...
import io.pulumi.googlenative.bigqueryconnection_v1beta1.outputs.BindingResponse;
...
public class ConnectionIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(ConnectionIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.bigqueryconnection_v1beta1.ConnectionIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.bigqueryconnection_v1beta1.ConnectionIamPolicyArgs.builder();
     ...
     */
    public ConnectionIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public ConnectionIamPolicy(String name, ConnectionIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:bigqueryconnection/v1beta1:ConnectionIamPolicy", name, args == null ? ConnectionIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ConnectionIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ConnectionIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
