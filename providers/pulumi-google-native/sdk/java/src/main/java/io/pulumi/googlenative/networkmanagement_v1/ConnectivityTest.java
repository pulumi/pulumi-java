...
public class ConnectivityTest extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.networkmanagement_v1.ConnectivityTestArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.networkmanagement_v1.ConnectivityTestArgs.builder();
    ...
    public ConnectivityTest(String name, ConnectivityTestArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkmanagement/v1:ConnectivityTest", name, args == null ? ConnectivityTestArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
