...
import io.pulumi.googlenative.compute_v1.MachineImageIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:MachineImageIamPolicy")
public class MachineImageIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.MachineImageIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.MachineImageIamPolicyArgs.builder();
    ...
    public MachineImageIamPolicy(String name, MachineImageIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:MachineImageIamPolicy", name, args == null ? MachineImageIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private MachineImageIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:MachineImageIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static MachineImageIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
