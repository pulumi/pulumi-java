...
public final class SessionEntityTypeArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setEntities(Input<List<GoogleCloudDialogflowV2EntityTypeEntityArgs>> entities) {
            this.entities = Objects.requireNonNull(entities);
            return this;
        }

        public Builder setEntities(List<GoogleCloudDialogflowV2EntityTypeEntityArgs> entities) {
