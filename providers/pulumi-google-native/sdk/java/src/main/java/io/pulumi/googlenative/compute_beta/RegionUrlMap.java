...
public class RegionUrlMap extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.RegionUrlMapArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.RegionUrlMapArgs.builder();
    ...
    public RegionUrlMap(String name, RegionUrlMapArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionUrlMap", name, args == null ? RegionUrlMapArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
