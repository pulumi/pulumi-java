...
public class FirewallPolicy extends io.pulumi.resources.CustomResource {
    ...
    public FirewallPolicy(String name) {
        super("google-native:compute/alpha:FirewallPolicy", name, FirewallPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public FirewallPolicy(String name, @Nullable FirewallPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:FirewallPolicy", name, args == null ? FirewallPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
