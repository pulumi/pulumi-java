...
public class ChannelConnectionIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public ChannelConnectionIamPolicy(String name) {
        super("google-native:eventarc/v1:ChannelConnectionIamPolicy", name, ChannelConnectionIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public ChannelConnectionIamPolicy(String name, ChannelConnectionIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:eventarc/v1:ChannelConnectionIamPolicy", name, args == null ? ChannelConnectionIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ChannelConnectionIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ChannelConnectionIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
