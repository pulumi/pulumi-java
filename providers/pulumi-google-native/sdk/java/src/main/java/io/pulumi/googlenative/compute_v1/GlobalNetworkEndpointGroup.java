...
import io.pulumi.googlenative.compute_v1.GlobalNetworkEndpointGroupArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:GlobalNetworkEndpointGroup")
public class GlobalNetworkEndpointGroup extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable GlobalNetworkEndpointGroupArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_v1.GlobalNetworkEndpointGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.GlobalNetworkEndpointGroupArgs.builder();
    ...
    public GlobalNetworkEndpointGroup(String name, @Nullable GlobalNetworkEndpointGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:GlobalNetworkEndpointGroup", name, args == null ? GlobalNetworkEndpointGroupArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private GlobalNetworkEndpointGroup(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:GlobalNetworkEndpointGroup", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static GlobalNetworkEndpointGroup get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
