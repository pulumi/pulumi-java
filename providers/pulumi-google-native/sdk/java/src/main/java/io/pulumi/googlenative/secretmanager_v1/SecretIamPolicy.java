...
public class SecretIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public SecretIamPolicy(String name, SecretIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:secretmanager/v1:SecretIamPolicy", name, args == null ? SecretIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private SecretIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SecretIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
