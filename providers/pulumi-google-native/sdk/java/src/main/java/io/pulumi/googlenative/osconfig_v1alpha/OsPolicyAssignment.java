...
public class OsPolicyAssignment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.osconfig_v1alpha.OsPolicyAssignmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.osconfig_v1alpha.OsPolicyAssignmentArgs.builder();
