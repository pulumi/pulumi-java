...
public class Domain extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.managedidentities_v1alpha1.DomainArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.managedidentities_v1alpha1.DomainArgs.builder();
