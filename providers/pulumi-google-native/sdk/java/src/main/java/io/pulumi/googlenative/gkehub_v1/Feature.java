...
public class Feature extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable FeatureArgs.Builder a);
    }
    private static io.pulumi.googlenative.gkehub_v1.FeatureArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.gkehub_v1.FeatureArgs.builder();
    ...
    public Feature(String name, @Nullable FeatureArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkehub/v1:Feature", name, args == null ? FeatureArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
