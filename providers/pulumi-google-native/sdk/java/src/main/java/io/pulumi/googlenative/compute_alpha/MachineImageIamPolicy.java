...
import io.pulumi.googlenative.compute_alpha.MachineImageIamPolicyArgs;
...
public class MachineImageIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.MachineImageIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.MachineImageIamPolicyArgs.builder();
    ...
    public MachineImageIamPolicy(String name, MachineImageIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:MachineImageIamPolicy", name, args == null ? MachineImageIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
