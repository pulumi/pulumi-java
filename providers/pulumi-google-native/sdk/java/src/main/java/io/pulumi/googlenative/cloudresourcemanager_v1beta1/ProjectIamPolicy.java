...
import io.pulumi.googlenative.cloudresourcemanager_v1beta1.ProjectIamPolicyArgs;
...
public class ProjectIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.cloudresourcemanager_v1beta1.ProjectIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudresourcemanager_v1beta1.ProjectIamPolicyArgs.builder();
    ...
    public ProjectIamPolicy(String name, ProjectIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v1beta1:ProjectIamPolicy", name, args == null ? ProjectIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
