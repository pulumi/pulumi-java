...
public class Fleet extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.gkehub_v1alpha.FleetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.gkehub_v1alpha.FleetArgs.builder();
    ...
    public Fleet(String name, @Nullable FleetArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkehub/v1alpha:Fleet", name, args == null ? FleetArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
