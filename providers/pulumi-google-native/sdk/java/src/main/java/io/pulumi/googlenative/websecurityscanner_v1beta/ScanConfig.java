...
public class ScanConfig extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="ignoreHttpStatusErrors", type=Boolean.class, parameters={})
     ...
     * 
     */
    @Export(name="managedScan", type=Boolean.class, parameters={})
     ...
     * 
     */
    @Export(name="riskLevel", type=String.class, parameters={})
     ...
     * 
     */
    @Export(name="staticIpScan", type=Boolean.class, parameters={})
    ...
    private static io.pulumi.googlenative.websecurityscanner_v1beta.ScanConfigArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.websecurityscanner_v1beta.ScanConfigArgs.builder();
