...
import io.pulumi.googlenative.binaryauthorization_v1beta1.AttestorIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:binaryauthorization/v1beta1:AttestorIamPolicy")
public class AttestorIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.binaryauthorization_v1beta1.AttestorIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.binaryauthorization_v1beta1.AttestorIamPolicyArgs.builder();
    ...
    public AttestorIamPolicy(String name, AttestorIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:binaryauthorization/v1beta1:AttestorIamPolicy", name, args == null ? AttestorIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private AttestorIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:binaryauthorization/v1beta1:AttestorIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static AttestorIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new AttestorIamPolicy(name, id, options);
    }
}
