...
public final class GetMachineImageResult {
    ...
    @OutputCustomType.Constructor({"creationTimestamp","description","guestFlush","instanceProperties","kind","machineImageEncryptionKey","name","satisfiesPzs","savedDisks","selfLink","selfLinkWithId","sourceDiskEncryptionKeys","sourceInstance","sourceInstanceProperties","status","storageLocations","totalStorageBytes"})
