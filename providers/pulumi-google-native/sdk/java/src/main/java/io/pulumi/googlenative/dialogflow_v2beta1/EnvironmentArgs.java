...
public final class EnvironmentArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<GoogleCloudDialogflowV2beta1FulfillmentArgs> fulfillment;

    public Input<GoogleCloudDialogflowV2beta1FulfillmentArgs> getFulfillment() {
    ...
    private final @Nullable Input<GoogleCloudDialogflowV2beta1TextToSpeechSettingsArgs> textToSpeechSettings;

    public Input<GoogleCloudDialogflowV2beta1TextToSpeechSettingsArgs> getTextToSpeechSettings() {
    ...
    public EnvironmentArgs(
        ...
        @Nullable Input<GoogleCloudDialogflowV2beta1FulfillmentArgs> fulfillment,
        @Nullable Input<String> location,
        @Nullable Input<String> project,
        @Nullable Input<GoogleCloudDialogflowV2beta1TextToSpeechSettingsArgs> textToSpeechSettings) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<GoogleCloudDialogflowV2beta1FulfillmentArgs> fulfillment;
        private @Nullable Input<String> location;
        private @Nullable Input<String> project;
        private @Nullable Input<GoogleCloudDialogflowV2beta1TextToSpeechSettingsArgs> textToSpeechSettings;
