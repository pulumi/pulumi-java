...
public class RegionNotificationEndpoint extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.RegionNotificationEndpointArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.RegionNotificationEndpointArgs.builder();
    ...
    public RegionNotificationEndpoint(String name, RegionNotificationEndpointArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:RegionNotificationEndpoint", name, args == null ? RegionNotificationEndpointArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
