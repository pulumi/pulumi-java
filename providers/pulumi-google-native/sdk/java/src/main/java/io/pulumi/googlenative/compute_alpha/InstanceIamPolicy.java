...
import io.pulumi.googlenative.compute_alpha.InstanceIamPolicyArgs;
...
public class InstanceIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.InstanceIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.InstanceIamPolicyArgs.builder();
    ...
    public InstanceIamPolicy(String name, InstanceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:InstanceIamPolicy", name, args == null ? InstanceIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
