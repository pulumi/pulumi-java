...
public class Job extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.cloudscheduler_v1.JobArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudscheduler_v1.JobArgs.builder();
