...
public class Queue extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.cloudtasks_v2beta3.QueueArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudtasks_v2beta3.QueueArgs.builder();
