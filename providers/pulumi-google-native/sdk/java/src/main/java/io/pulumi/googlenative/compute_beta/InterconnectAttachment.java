...
public class InterconnectAttachment extends io.pulumi.resources.CustomResource {
    ...
    public InterconnectAttachment(String name) {
        super("google-native:compute/beta:InterconnectAttachment", name, InterconnectAttachmentArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public InterconnectAttachment(String name, InterconnectAttachmentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:InterconnectAttachment", name, args == null ? InterconnectAttachmentArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
