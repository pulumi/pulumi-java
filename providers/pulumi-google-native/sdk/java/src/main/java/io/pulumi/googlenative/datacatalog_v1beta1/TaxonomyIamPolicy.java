...
import io.pulumi.googlenative.datacatalog_v1beta1.TaxonomyIamPolicyArgs;
...
public class TaxonomyIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.datacatalog_v1beta1.TaxonomyIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.datacatalog_v1beta1.TaxonomyIamPolicyArgs.builder();
    ...
    public TaxonomyIamPolicy(String name, TaxonomyIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datacatalog/v1beta1:TaxonomyIamPolicy", name, args == null ? TaxonomyIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private TaxonomyIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TaxonomyIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
