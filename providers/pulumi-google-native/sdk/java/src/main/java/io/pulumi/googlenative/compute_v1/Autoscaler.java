...
import io.pulumi.googlenative.compute_v1.AutoscalerArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:Autoscaler")
public class Autoscaler extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.AutoscalerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.AutoscalerArgs.builder();
    ...
    public Autoscaler(String name, @Nullable AutoscalerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:Autoscaler", name, args == null ? AutoscalerArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private Autoscaler(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:Autoscaler", name, null, makeResourceOptions(options, id));
    }
