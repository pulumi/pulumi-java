...
public class NodePool extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(NodePoolArgs.Builder a);
    }
    private static io.pulumi.googlenative.container_v1beta1.NodePoolArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.container_v1beta1.NodePoolArgs.builder();
     ...
     */
    public NodePool(String name, BuilderApplicator argsBuilder) {
