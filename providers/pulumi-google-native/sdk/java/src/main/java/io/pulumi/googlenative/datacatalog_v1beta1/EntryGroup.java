...
public class EntryGroup extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="dataCatalogTimestamps", type=GoogleCloudDatacatalogV1beta1SystemTimestampsResponse.class, parameters={})
    ...
    public EntryGroup(String name) {
        super("google-native:datacatalog/v1beta1:EntryGroup", name, EntryGroupArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public EntryGroup(String name, EntryGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datacatalog/v1beta1:EntryGroup", name, args == null ? EntryGroupArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private EntryGroup(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static EntryGroup get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
