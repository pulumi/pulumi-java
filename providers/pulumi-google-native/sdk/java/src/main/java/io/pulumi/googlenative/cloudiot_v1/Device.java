...
public class Device extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.cloudiot_v1.DeviceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudiot_v1.DeviceArgs.builder();
    ...
    public Device(String name, DeviceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudiot/v1:Device", name, args == null ? DeviceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
