...
import io.pulumi.googlenative.datacatalog_v1.TagTemplateIamPolicyArgs;
...
public class TagTemplateIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.datacatalog_v1.TagTemplateIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.datacatalog_v1.TagTemplateIamPolicyArgs.builder();
    ...
    public TagTemplateIamPolicy(String name, TagTemplateIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datacatalog/v1:TagTemplateIamPolicy", name, args == null ? TagTemplateIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
