...
public class Topic extends io.pulumi.resources.CustomResource {
    ...
    public Topic(String name) {
        super("google-native:pubsub/v1beta1a:Topic", name, TopicArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public Topic(String name, @Nullable TopicArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:pubsub/v1beta1a:Topic", name, args == null ? TopicArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
