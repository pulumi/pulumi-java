...
public class OrganizationIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(OrganizationIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.cloudresourcemanager_v3.OrganizationIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudresourcemanager_v3.OrganizationIamPolicyArgs.builder();
     ...
     */
    public OrganizationIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     * @param name The _unique_ name of the resulting resource.
     */
    public OrganizationIamPolicy(String name) {
        this(name, OrganizationIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public OrganizationIamPolicy(String name, OrganizationIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
    ...
    public OrganizationIamPolicy(String name, OrganizationIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v3:OrganizationIamPolicy", name, args == null ? OrganizationIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private OrganizationIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static OrganizationIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
