...
public final class RegionInstantSnapshotIamPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public RegionInstantSnapshotIamPolicyArgs build() {
            return new RegionInstantSnapshotIamPolicyArgs(auditConfigs, bindings, etag, project, region, resource, rules, version);
        }
    }
}
