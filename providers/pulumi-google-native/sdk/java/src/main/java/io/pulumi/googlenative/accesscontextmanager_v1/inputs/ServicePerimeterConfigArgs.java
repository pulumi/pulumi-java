...
public final class ServicePerimeterConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setEgressPolicies(@Nullable Input<List<EgressPolicyArgs>> egressPolicies) {
            this.egressPolicies = egressPolicies;
            return this;
        }

        public Builder setEgressPolicies(@Nullable List<EgressPolicyArgs> egressPolicies) {
            this.egressPolicies = Input.ofNullable(egressPolicies);
            return this;
        }

        public Builder setIngressPolicies(@Nullable Input<List<IngressPolicyArgs>> ingressPolicies) {
            this.ingressPolicies = ingressPolicies;
            return this;
        }

        public Builder setIngressPolicies(@Nullable List<IngressPolicyArgs> ingressPolicies) {
