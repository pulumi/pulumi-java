...
import io.pulumi.googlenative.compute_beta.ImageIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:ImageIamPolicy")
public class ImageIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.ImageIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.ImageIamPolicyArgs.builder();
    ...
    public ImageIamPolicy(String name, ImageIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:ImageIamPolicy", name, args == null ? ImageIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ImageIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:ImageIamPolicy", name, null, makeResourceOptions(options, id));
    }
