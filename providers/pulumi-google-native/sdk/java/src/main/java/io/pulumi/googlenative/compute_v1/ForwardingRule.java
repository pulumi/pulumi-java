...
public class ForwardingRule extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ForwardingRuleArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_v1.ForwardingRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.ForwardingRuleArgs.builder();
     ...
     */
    public static ForwardingRule get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
