...
public class App extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.appengine_v1beta.AppArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.appengine_v1beta.AppArgs.builder();
    ...
    public App(String name, @Nullable AppArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:appengine/v1beta:App", name, args == null ? AppArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
