...
public class PatchDeployment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.osconfig_v1.PatchDeploymentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.osconfig_v1.PatchDeploymentArgs.builder();
