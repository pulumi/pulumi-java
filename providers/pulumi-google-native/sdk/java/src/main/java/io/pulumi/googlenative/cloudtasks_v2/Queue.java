...
public class Queue extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.cloudtasks_v2.QueueArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudtasks_v2.QueueArgs.builder();
    ...
    public Queue(String name, @Nullable QueueArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudtasks/v2:Queue", name, args == null ? QueueArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
