...
public class OrganizationReplay extends io.pulumi.resources.CustomResource {
    ...
    public OrganizationReplay(String name) {
        super("google-native:policysimulator/v1beta1:OrganizationReplay", name, OrganizationReplayArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public OrganizationReplay(String name, OrganizationReplayArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:policysimulator/v1beta1:OrganizationReplay", name, args == null ? OrganizationReplayArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private OrganizationReplay(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static OrganizationReplay get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
