...
public class Occurrence extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(OccurrenceArgs.Builder a);
    }
    private static io.pulumi.googlenative.containeranalysis_v1beta1.OccurrenceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.containeranalysis_v1beta1.OccurrenceArgs.builder();
    ...
    public Occurrence(String name, OccurrenceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:containeranalysis/v1beta1:Occurrence", name, args == null ? OccurrenceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
