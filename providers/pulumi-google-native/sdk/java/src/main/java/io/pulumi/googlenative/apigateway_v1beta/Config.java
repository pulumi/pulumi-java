...
public class Config extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.apigateway_v1beta.ConfigArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.apigateway_v1beta.ConfigArgs.builder();
    ...
    public Config(String name, ConfigArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:apigateway/v1beta:Config", name, args == null ? ConfigArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
