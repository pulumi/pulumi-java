...
public class Registry extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.cloudiot_v1.RegistryArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudiot_v1.RegistryArgs.builder();
    ...
    public Registry(String name, @Nullable RegistryArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudiot/v1:Registry", name, args == null ? RegistryArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
