...
public class ServiceAttachment extends io.pulumi.resources.CustomResource {
    ...
    public ServiceAttachment(String name) {
        super("google-native:compute/beta:ServiceAttachment", name, ServiceAttachmentArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public ServiceAttachment(String name, ServiceAttachmentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:ServiceAttachment", name, args == null ? ServiceAttachmentArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
