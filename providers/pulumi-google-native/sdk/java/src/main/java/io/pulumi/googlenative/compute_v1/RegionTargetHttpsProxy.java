...
public class RegionTargetHttpsProxy extends io.pulumi.resources.CustomResource {
    ...
    public RegionTargetHttpsProxy(String name) {
        super("google-native:compute/v1:RegionTargetHttpsProxy", name, RegionTargetHttpsProxyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public RegionTargetHttpsProxy(String name, RegionTargetHttpsProxyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:RegionTargetHttpsProxy", name, args == null ? RegionTargetHttpsProxyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
