 ...
 * 
 */
@ResourceType(type="google-native:cloudbilling/v1:BillingAccountIamPolicy")
public class BillingAccountIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(BillingAccountIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.cloudbilling_v1.BillingAccountIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudbilling_v1.BillingAccountIamPolicyArgs.builder();
     ...
     */
    public BillingAccountIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     * @param name The _unique_ name of the resulting resource.
     */
    public BillingAccountIamPolicy(String name) {
        this(name, BillingAccountIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public BillingAccountIamPolicy(String name, BillingAccountIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
    ...
    public BillingAccountIamPolicy(String name, BillingAccountIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudbilling/v1:BillingAccountIamPolicy", name, args == null ? BillingAccountIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private BillingAccountIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudbilling/v1:BillingAccountIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static BillingAccountIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new BillingAccountIamPolicy(name, id, options);
    }
}
