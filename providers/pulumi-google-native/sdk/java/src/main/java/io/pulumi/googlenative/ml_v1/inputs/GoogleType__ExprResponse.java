 ...
 * 
 */
public final class GoogleType__ExprResponse extends io.pulumi.resources.InvokeArgs {

    public static final GoogleType__ExprResponse Empty = new GoogleType__ExprResponse();
    ...
    public GoogleType__ExprResponse(
        String description,
        String expression,
        String location,
        String title) {
