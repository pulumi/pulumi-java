...
public class Model extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.firebaseml_v1beta2.ModelArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.firebaseml_v1beta2.ModelArgs.builder();
