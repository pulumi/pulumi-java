...
public class Instance extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.redis_v1beta1.InstanceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.redis_v1beta1.InstanceArgs.builder();
    ...
    public Instance(String name, InstanceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:redis/v1beta1:Instance", name, args == null ? InstanceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
