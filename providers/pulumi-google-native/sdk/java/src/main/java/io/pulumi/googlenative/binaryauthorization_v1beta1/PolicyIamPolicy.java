 ...
 * 
 */
@ResourceType(type="google-native:binaryauthorization/v1beta1:PolicyIamPolicy")
public class PolicyIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.binaryauthorization_v1beta1.PolicyIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.binaryauthorization_v1beta1.PolicyIamPolicyArgs.builder();
    ...
    public PolicyIamPolicy(String name, @Nullable PolicyIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:binaryauthorization/v1beta1:PolicyIamPolicy", name, args == null ? PolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private PolicyIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:binaryauthorization/v1beta1:PolicyIamPolicy", name, null, makeResourceOptions(options, id));
    }
