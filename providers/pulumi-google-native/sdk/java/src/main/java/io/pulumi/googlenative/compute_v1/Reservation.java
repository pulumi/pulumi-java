...
public class Reservation extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.ReservationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.ReservationArgs.builder();
    ...
    public Reservation(String name, @Nullable ReservationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:Reservation", name, args == null ? ReservationArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
