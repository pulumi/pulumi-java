...
public final class AgentArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder advancedSettings(@Nullable Input<GoogleCloudDialogflowCxV3AdvancedSettingsArgs> advancedSettings) {
            this.advancedSettings = advancedSettings;
            return this;
        }
        ...
        public Builder speechToTextSettings(@Nullable Input<GoogleCloudDialogflowCxV3SpeechToTextSettingsArgs> speechToTextSettings) {
            this.speechToTextSettings = speechToTextSettings;
            return this;
        }
