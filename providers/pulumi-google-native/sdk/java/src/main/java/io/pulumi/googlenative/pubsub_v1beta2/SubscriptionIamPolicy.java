...
import io.pulumi.googlenative.pubsub_v1beta2.SubscriptionIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:pubsub/v1beta2:SubscriptionIamPolicy")
public class SubscriptionIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.pubsub_v1beta2.SubscriptionIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.pubsub_v1beta2.SubscriptionIamPolicyArgs.builder();
    ...
    public SubscriptionIamPolicy(String name, SubscriptionIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:pubsub/v1beta2:SubscriptionIamPolicy", name, args == null ? SubscriptionIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private SubscriptionIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:pubsub/v1beta2:SubscriptionIamPolicy", name, null, makeResourceOptions(options, id));
    }
