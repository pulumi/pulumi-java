...
public class GetFhir {
    ...
    public interface BuilderApplicator {
        public void apply(GetFhirArgs.Builder a);
    }
    private static GetFhirArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = GetFhirArgs.builder();
 ...
 * 
     */
    public static CompletableFuture<GetFhirResult> invokeAsync(BuilderApplicator argsBuilder, @Nullable InvokeOptions options) {
    ...
    public static CompletableFuture<GetFhirResult> invokeAsync(GetFhirArgs args, @Nullable InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("google-native:healthcare/v1beta1:getFhir", TypeShape.of(GetFhirResult.class), args == null ? GetFhirArgs.Empty : args, Utilities.withVersion(options));
    }
}
