...
public class Agent extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.dialogflow_v3beta1.AgentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dialogflow_v3beta1.AgentArgs.builder();
    ...
    public Agent(String name, AgentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v3beta1:Agent", name, args == null ? AgentArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
