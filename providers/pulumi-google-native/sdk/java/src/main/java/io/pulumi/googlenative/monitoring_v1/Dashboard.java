...
public class Dashboard extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.monitoring_v1.DashboardArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.monitoring_v1.DashboardArgs.builder();
