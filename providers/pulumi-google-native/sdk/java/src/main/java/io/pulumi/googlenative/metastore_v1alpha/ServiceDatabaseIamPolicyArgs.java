...
import io.pulumi.googlenative.metastore_v1alpha.inputs.AuditConfigArgs;
import io.pulumi.googlenative.metastore_v1alpha.inputs.BindingArgs;
...
public final class ServiceDatabaseIamPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public ServiceDatabaseIamPolicyArgs(
    ...
    public static final class Builder {
        ...
        public ServiceDatabaseIamPolicyArgs build() {
            return new ServiceDatabaseIamPolicyArgs(auditConfigs, bindings, databaseId, etag, location, project, serviceId, updateMask, version);
        }
    }
}
