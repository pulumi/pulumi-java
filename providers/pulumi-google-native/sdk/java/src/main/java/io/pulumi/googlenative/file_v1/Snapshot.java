...
public class Snapshot extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.file_v1.SnapshotArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.file_v1.SnapshotArgs.builder();
    ...
    public Snapshot(String name, SnapshotArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:file/v1:Snapshot", name, args == null ? SnapshotArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
