...
public class BackendBucket extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.BackendBucketArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.BackendBucketArgs.builder();
