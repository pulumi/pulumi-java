...
import io.pulumi.googlenative.compute_v1.NodeTemplateIamPolicyArgs;
...
public class NodeTemplateIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.NodeTemplateIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.NodeTemplateIamPolicyArgs.builder();
    ...
    public NodeTemplateIamPolicy(String name, NodeTemplateIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:NodeTemplateIamPolicy", name, args == null ? NodeTemplateIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
