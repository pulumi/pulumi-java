...
import io.pulumi.googlenative.compute_v1.TargetGrpcProxyArgs;
...
public class TargetGrpcProxy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.TargetGrpcProxyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.TargetGrpcProxyArgs.builder();
    ...
    public TargetGrpcProxy(String name, @Nullable TargetGrpcProxyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:TargetGrpcProxy", name, args == null ? TargetGrpcProxyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
