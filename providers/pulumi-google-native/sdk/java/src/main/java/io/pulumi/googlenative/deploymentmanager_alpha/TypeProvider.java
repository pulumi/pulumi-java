...
public class TypeProvider extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.deploymentmanager_alpha.TypeProviderArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.deploymentmanager_alpha.TypeProviderArgs.builder();
    ...
    public TypeProvider(String name, @Nullable TypeProviderArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:deploymentmanager/alpha:TypeProvider", name, args == null ? TypeProviderArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
     ...
     */
    public static TypeProvider get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
