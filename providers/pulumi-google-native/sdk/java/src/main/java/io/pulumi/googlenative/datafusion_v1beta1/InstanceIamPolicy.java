...
import io.pulumi.googlenative.datafusion_v1beta1.InstanceIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:datafusion/v1beta1:InstanceIamPolicy")
public class InstanceIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.datafusion_v1beta1.InstanceIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.datafusion_v1beta1.InstanceIamPolicyArgs.builder();
    ...
    public InstanceIamPolicy(String name, InstanceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datafusion/v1beta1:InstanceIamPolicy", name, args == null ? InstanceIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private InstanceIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datafusion/v1beta1:InstanceIamPolicy", name, null, makeResourceOptions(options, id));
    }
