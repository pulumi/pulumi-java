...
import io.pulumi.googlenative.artifactregistry_v1beta2.RepositoryIamPolicyArgs;
...
public class RepositoryIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.artifactregistry_v1beta2.RepositoryIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.artifactregistry_v1beta2.RepositoryIamPolicyArgs.builder();
    ...
    public RepositoryIamPolicy(String name, RepositoryIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:artifactregistry/v1beta2:RepositoryIamPolicy", name, args == null ? RepositoryIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
