...
public final class AttachedDiskArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public AttachedDiskArgs(
        ...
        @Nullable Input<Boolean> forceAttach,
        ...
        @Nullable Input<AttachedDiskSavedState> savedState,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<Boolean> forceAttach;
        ...
        private @Nullable Input<AttachedDiskSavedState> savedState;
        ...
        public Builder setForceAttach(@Nullable Input<Boolean> forceAttach) {
            this.forceAttach = forceAttach;
            return this;
        }

        public Builder setForceAttach(@Nullable Boolean forceAttach) {
            this.forceAttach = Input.ofNullable(forceAttach);
            return this;
        }
        ...
        public Builder setSavedState(@Nullable Input<AttachedDiskSavedState> savedState) {
            this.savedState = savedState;
            return this;
        }

        public Builder setSavedState(@Nullable AttachedDiskSavedState savedState) {
            this.savedState = Input.ofNullable(savedState);
            return this;
        }
