...
public class Company extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.jobs_v4.CompanyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.jobs_v4.CompanyArgs.builder();
    ...
    public Company(String name, CompanyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:jobs/v4:Company", name, args == null ? CompanyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private Company(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Company get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
