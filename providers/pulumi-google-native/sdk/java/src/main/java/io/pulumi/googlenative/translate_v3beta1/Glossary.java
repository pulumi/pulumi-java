...
public class Glossary extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.translate_v3beta1.GlossaryArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.translate_v3beta1.GlossaryArgs.builder();
    ...
    public Glossary(String name, GlossaryArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:translate/v3beta1:Glossary", name, args == null ? GlossaryArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
