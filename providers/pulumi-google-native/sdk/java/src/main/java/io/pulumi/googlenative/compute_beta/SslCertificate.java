...
import io.pulumi.googlenative.compute_beta.SslCertificateArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:SslCertificate")
public class SslCertificate extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.SslCertificateArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.SslCertificateArgs.builder();
    ...
    public SslCertificate(String name, @Nullable SslCertificateArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:SslCertificate", name, args == null ? SslCertificateArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private SslCertificate(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:SslCertificate", name, null, makeResourceOptions(options, id));
    }
