...
public class ConnectionProfile extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.datamigration_v1beta1.ConnectionProfileArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.datamigration_v1beta1.ConnectionProfileArgs.builder();
