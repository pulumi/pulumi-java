...
public class MuteConfig extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(MuteConfigArgs.Builder a);
    }
    private static io.pulumi.googlenative.securitycenter_v1.MuteConfigArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.securitycenter_v1.MuteConfigArgs.builder();
     ...
     */
    public MuteConfig(String name, BuilderApplicator argsBuilder) {
