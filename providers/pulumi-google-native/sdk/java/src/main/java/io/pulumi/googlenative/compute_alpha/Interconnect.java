...
import io.pulumi.googlenative.compute_alpha.InterconnectArgs;
...
public class Interconnect extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="macsec", type=InterconnectMacsecResponse.class, parameters={})
     ...
     * 
     */
    public Output<InterconnectMacsecResponse> getMacsec() {
        return this.macsec;
    }
    /**
     ...
     * 
     */
    @OutputExport(name="macsecEnabled", type=Boolean.class, parameters={})
    ...
    private static io.pulumi.googlenative.compute_alpha.InterconnectArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.InterconnectArgs.builder();
    ...
    public Interconnect(String name, @Nullable InterconnectArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:Interconnect", name, args == null ? InterconnectArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
