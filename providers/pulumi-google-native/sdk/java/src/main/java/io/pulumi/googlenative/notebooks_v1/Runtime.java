...
public class Runtime extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.notebooks_v1.RuntimeArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.notebooks_v1.RuntimeArgs.builder();
     ...
     */
    public static Runtime get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
