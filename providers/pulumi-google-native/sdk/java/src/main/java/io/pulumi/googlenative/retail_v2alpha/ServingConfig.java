...
public class ServingConfig extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="dynamicFacetSpec", type=GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecResponse.class, parameters={})
     ...
     * 
     */
    public Output<GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpecResponse> getDynamicFacetSpec() {
    ...
    private static io.pulumi.googlenative.retail_v2alpha.ServingConfigArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.retail_v2alpha.ServingConfigArgs.builder();
    ...
    public ServingConfig(String name, ServingConfigArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:retail/v2alpha:ServingConfig", name, args == null ? ServingConfigArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
