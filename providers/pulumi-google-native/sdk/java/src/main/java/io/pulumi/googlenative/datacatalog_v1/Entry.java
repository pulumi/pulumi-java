...
public class Entry extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.datacatalog_v1.EntryArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.datacatalog_v1.EntryArgs.builder();
