...
public class ResourceRecordSet extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.dns_v1.ResourceRecordSetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dns_v1.ResourceRecordSetArgs.builder();
    ...
    public ResourceRecordSet(String name, ResourceRecordSetArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dns/v1:ResourceRecordSet", name, args == null ? ResourceRecordSetArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
