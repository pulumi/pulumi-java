...
public final class EntityTypeArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder entities(@Nullable Input<List<GoogleCloudDialogflowCxV3EntityTypeEntityArgs>> entities) {
            this.entities = entities;
            return this;
        }
        ...
        public Builder excludedPhrases(@Nullable Input<List<GoogleCloudDialogflowCxV3EntityTypeExcludedPhraseArgs>> excludedPhrases) {
            this.excludedPhrases = excludedPhrases;
            return this;
        }
