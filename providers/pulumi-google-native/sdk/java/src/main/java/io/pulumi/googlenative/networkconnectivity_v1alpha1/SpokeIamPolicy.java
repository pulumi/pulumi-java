...
public class SpokeIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(SpokeIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.networkconnectivity_v1alpha1.SpokeIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.networkconnectivity_v1alpha1.SpokeIamPolicyArgs.builder();
     ...
     */
    public SpokeIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public SpokeIamPolicy(String name, SpokeIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkconnectivity/v1alpha1:SpokeIamPolicy", name, args == null ? SpokeIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private SpokeIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SpokeIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
