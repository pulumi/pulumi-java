...
import io.pulumi.googlenative.compute_beta.ExternalVpnGatewayArgs;
...
public class ExternalVpnGateway extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.ExternalVpnGatewayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.ExternalVpnGatewayArgs.builder();
    ...
    public ExternalVpnGateway(String name, @Nullable ExternalVpnGatewayArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:ExternalVpnGateway", name, args == null ? ExternalVpnGatewayArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
