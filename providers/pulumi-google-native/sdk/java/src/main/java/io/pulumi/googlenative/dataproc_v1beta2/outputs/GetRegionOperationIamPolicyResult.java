...
@CustomType
public final class GetRegionOperationIamPolicyResult {
    /**
    ...
    */
    ...
    public static Builder builder(GetRegionOperationIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetRegionOperationIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetRegionOperationIamPolicyResult build() {
            return new GetRegionOperationIamPolicyResult(bindings, etag, version);
        }
    }
}
