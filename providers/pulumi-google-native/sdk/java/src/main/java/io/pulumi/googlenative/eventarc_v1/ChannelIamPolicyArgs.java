...
public final class ChannelIamPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ChannelIamPolicyArgs build() {
            return new ChannelIamPolicyArgs(auditConfigs, bindings, channelId, etag, location, project, updateMask, version);
        }
    }
}
