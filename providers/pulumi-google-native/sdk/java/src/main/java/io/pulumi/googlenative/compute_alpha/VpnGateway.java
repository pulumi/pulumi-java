...
import io.pulumi.googlenative.compute_alpha.VpnGatewayArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:VpnGateway")
public class VpnGateway extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.VpnGatewayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.VpnGatewayArgs.builder();
    ...
    public VpnGateway(String name, VpnGatewayArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:VpnGateway", name, args == null ? VpnGatewayArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private VpnGateway(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:VpnGateway", name, null, makeResourceOptions(options, id));
    }
