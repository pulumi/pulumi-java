...
public class Feature extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.gkehub_v1beta.FeatureArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.gkehub_v1beta.FeatureArgs.builder();
    ...
    public Feature(String name, @Nullable FeatureArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkehub/v1beta:Feature", name, args == null ? FeatureArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
