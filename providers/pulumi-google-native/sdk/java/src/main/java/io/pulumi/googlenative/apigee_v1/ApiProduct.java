...
public class ApiProduct extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ApiProductArgs.Builder a);
    }
    private static io.pulumi.googlenative.apigee_v1.ApiProductArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.apigee_v1.ApiProductArgs.builder();
     ...
     */
    public ApiProduct(String name, BuilderApplicator argsBuilder) {
    ...
    public ApiProduct(String name, ApiProductArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:apigee/v1:ApiProduct", name, args == null ? ApiProductArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ApiProduct(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ApiProduct get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
