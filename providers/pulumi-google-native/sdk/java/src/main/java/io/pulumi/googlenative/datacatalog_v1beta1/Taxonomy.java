...
public class Taxonomy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.datacatalog_v1beta1.TaxonomyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.datacatalog_v1beta1.TaxonomyArgs.builder();
    ...
    public Taxonomy(String name, TaxonomyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datacatalog/v1beta1:Taxonomy", name, args == null ? TaxonomyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
