...
import io.pulumi.googlenative.deploymentmanager_v2.DeploymentIamPolicyArgs;
import io.pulumi.googlenative.deploymentmanager_v2.outputs.AuditConfigResponse;
import io.pulumi.googlenative.deploymentmanager_v2.outputs.BindingResponse;
...
public class DeploymentIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.deploymentmanager_v2.DeploymentIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.deploymentmanager_v2.DeploymentIamPolicyArgs.builder();
    ...
    public DeploymentIamPolicy(String name, DeploymentIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:deploymentmanager/v2:DeploymentIamPolicy", name, args == null ? DeploymentIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
