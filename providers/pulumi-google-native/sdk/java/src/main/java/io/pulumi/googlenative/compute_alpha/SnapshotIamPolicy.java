...
import io.pulumi.googlenative.compute_alpha.SnapshotIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:SnapshotIamPolicy")
public class SnapshotIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(SnapshotIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.SnapshotIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.SnapshotIamPolicyArgs.builder();
     ...
     */
    public SnapshotIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public SnapshotIamPolicy(String name, SnapshotIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:SnapshotIamPolicy", name, args == null ? SnapshotIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private SnapshotIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:SnapshotIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static SnapshotIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
