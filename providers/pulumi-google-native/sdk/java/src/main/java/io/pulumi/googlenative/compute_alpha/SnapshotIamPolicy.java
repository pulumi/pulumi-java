...
public class SnapshotIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public SnapshotIamPolicy(String name, SnapshotIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:SnapshotIamPolicy", name, args == null ? SnapshotIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private SnapshotIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SnapshotIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
