...
public class Change extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.dns_v1beta2.ChangeArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dns_v1beta2.ChangeArgs.builder();
