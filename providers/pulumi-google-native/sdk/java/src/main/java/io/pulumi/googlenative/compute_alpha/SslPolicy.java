...
import io.pulumi.googlenative.compute_alpha.SslPolicyArgs;
...
public class SslPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.SslPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.SslPolicyArgs.builder();
    ...
    public SslPolicy(String name, @Nullable SslPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:SslPolicy", name, args == null ? SslPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
