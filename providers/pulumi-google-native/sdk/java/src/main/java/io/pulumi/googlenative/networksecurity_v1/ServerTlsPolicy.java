...
public class ServerTlsPolicy extends io.pulumi.resources.CustomResource {
    ...
    public ServerTlsPolicy(String name) {
        super("google-native:networksecurity/v1:ServerTlsPolicy", name, ServerTlsPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public ServerTlsPolicy(String name, ServerTlsPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networksecurity/v1:ServerTlsPolicy", name, args == null ? ServerTlsPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
