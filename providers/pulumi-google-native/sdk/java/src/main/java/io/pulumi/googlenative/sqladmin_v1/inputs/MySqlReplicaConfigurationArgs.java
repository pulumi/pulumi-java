...
public final class MySqlReplicaConfigurationArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setMasterHeartbeatPeriod(@Nullable Input<String> masterHeartbeatPeriod) {
            this.masterHeartbeatPeriod = masterHeartbeatPeriod;
            return this;
        }

        public Builder setMasterHeartbeatPeriod(@Nullable String masterHeartbeatPeriod) {
