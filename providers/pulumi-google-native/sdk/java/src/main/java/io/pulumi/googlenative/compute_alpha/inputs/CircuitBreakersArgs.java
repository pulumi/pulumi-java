...
public final class CircuitBreakersArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public CircuitBreakersArgs(
        @Nullable Input<DurationArgs> connectTimeout,
    ...
    public static final class Builder {
        private @Nullable Input<DurationArgs> connectTimeout;
        ...
        public Builder setConnectTimeout(@Nullable Input<DurationArgs> connectTimeout) {
            this.connectTimeout = connectTimeout;
            return this;
        }

        public Builder setConnectTimeout(@Nullable DurationArgs connectTimeout) {
