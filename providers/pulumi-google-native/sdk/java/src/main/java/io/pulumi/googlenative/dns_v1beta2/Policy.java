...
public class Policy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.dns_v1beta2.PolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dns_v1beta2.PolicyArgs.builder();
    ...
    public Policy(String name, @Nullable PolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dns/v1beta2:Policy", name, args == null ? PolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
