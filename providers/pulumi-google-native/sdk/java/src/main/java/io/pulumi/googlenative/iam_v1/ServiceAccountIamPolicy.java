...
public class ServiceAccountIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ServiceAccountIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.iam_v1.ServiceAccountIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.iam_v1.ServiceAccountIamPolicyArgs.builder();
     ...
     */
    public ServiceAccountIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public ServiceAccountIamPolicy(String name, ServiceAccountIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:iam/v1:ServiceAccountIamPolicy", name, args == null ? ServiceAccountIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ServiceAccountIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ServiceAccountIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
