 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:GlobalNetworkEndpointGroup")
public class GlobalNetworkEndpointGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.GlobalNetworkEndpointGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.GlobalNetworkEndpointGroupArgs.builder();
    ...
    public GlobalNetworkEndpointGroup(String name, @Nullable GlobalNetworkEndpointGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:GlobalNetworkEndpointGroup", name, args == null ? GlobalNetworkEndpointGroupArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
    ...
    private GlobalNetworkEndpointGroup(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:GlobalNetworkEndpointGroup", name, null, makeResourceOptions(options, id));
    }
