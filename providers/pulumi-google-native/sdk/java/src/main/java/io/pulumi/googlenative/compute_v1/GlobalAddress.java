...
public class GlobalAddress extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.GlobalAddressArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.GlobalAddressArgs.builder();
    ...
    public GlobalAddress(String name, @Nullable GlobalAddressArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:GlobalAddress", name, args == null ? GlobalAddressArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
