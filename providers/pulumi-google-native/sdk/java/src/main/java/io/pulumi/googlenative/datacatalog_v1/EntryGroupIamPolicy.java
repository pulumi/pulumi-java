...
import io.pulumi.googlenative.datacatalog_v1.EntryGroupIamPolicyArgs;
...
public class EntryGroupIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.datacatalog_v1.EntryGroupIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.datacatalog_v1.EntryGroupIamPolicyArgs.builder();
    ...
    public EntryGroupIamPolicy(String name, EntryGroupIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datacatalog/v1:EntryGroupIamPolicy", name, args == null ? EntryGroupIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
