...
public class CertificateAuthority extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.privateca_v1.CertificateAuthorityArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.privateca_v1.CertificateAuthorityArgs.builder();
