...
public class AccessLevel extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.accesscontextmanager_v1.AccessLevelArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.accesscontextmanager_v1.AccessLevelArgs.builder();
