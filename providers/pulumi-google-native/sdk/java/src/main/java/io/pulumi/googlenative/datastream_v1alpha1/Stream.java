...
public class Stream extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.datastream_v1alpha1.StreamArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.datastream_v1alpha1.StreamArgs.builder();
    ...
    public Stream(String name, StreamArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datastream/v1alpha1:Stream", name, args == null ? StreamArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
