...
public class Workflow extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.workflows_v1.WorkflowArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.workflows_v1.WorkflowArgs.builder();
    ...
    public Workflow(String name, WorkflowArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:workflows/v1:Workflow", name, args == null ? WorkflowArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
