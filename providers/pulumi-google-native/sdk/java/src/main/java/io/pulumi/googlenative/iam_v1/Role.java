...
public class Role extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.iam_v1.RoleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.iam_v1.RoleArgs.builder();
