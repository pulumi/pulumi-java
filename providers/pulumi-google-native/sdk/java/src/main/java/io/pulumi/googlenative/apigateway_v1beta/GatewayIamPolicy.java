...
public class GatewayIamPolicy extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="auditConfigs", type=List.class, parameters={ApigatewayAuditConfigResponse.class})
     ...
     * 
     */
    @Export(name="bindings", type=List.class, parameters={ApigatewayBindingResponse.class})
    ...
    public interface BuilderApplicator {
        public void apply(GatewayIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.apigateway_v1beta.GatewayIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.apigateway_v1beta.GatewayIamPolicyArgs.builder();
     ...
     */
    public GatewayIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public GatewayIamPolicy(String name, GatewayIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:apigateway/v1beta:GatewayIamPolicy", name, args == null ? GatewayIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private GatewayIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static GatewayIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
