...
public final class InternalRangeIamPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="internalRangeId", required=true)
      private final Output<String> internalRangeId;

    public Output<String> getInternalRangeId() {
    ...
    public static final class Builder {
        ...
        public Builder internalRangeId(String internalRangeId) {
            this.internalRangeId = Output.of(Objects.requireNonNull(internalRangeId));
            return this;
        }
