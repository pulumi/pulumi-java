...
import io.pulumi.googlenative.healthcare_v1beta1.DatasetIamPolicyArgs;
...
public class DatasetIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.healthcare_v1beta1.DatasetIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.healthcare_v1beta1.DatasetIamPolicyArgs.builder();
    ...
    public DatasetIamPolicy(String name, DatasetIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1beta1:DatasetIamPolicy", name, args == null ? DatasetIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
