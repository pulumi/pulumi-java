...
public class GameServerDeployment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.gameservices_v1beta.GameServerDeploymentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.gameservices_v1beta.GameServerDeploymentArgs.builder();
    ...
    public GameServerDeployment(String name, GameServerDeploymentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gameservices/v1beta:GameServerDeployment", name, args == null ? GameServerDeploymentArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
