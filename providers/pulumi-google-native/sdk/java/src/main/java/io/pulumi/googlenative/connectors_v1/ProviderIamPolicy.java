...
import io.pulumi.googlenative.connectors_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:connectors/v1:ProviderIamPolicy")
public class ProviderIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(ProviderIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.connectors_v1.ProviderIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.connectors_v1.ProviderIamPolicyArgs.builder();
     ...
     */
    public ProviderIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public ProviderIamPolicy(String name) {
        this(name, ProviderIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ProviderIamPolicy(String name, ProviderIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ProviderIamPolicy(String name, ProviderIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:connectors/v1:ProviderIamPolicy", name, args == null ? ProviderIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ProviderIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:connectors/v1:ProviderIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ProviderIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new ProviderIamPolicy(name, id, options);
    }
}
