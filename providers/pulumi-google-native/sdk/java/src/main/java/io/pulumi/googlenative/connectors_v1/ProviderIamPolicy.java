...
public class ProviderIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public ProviderIamPolicy(String name, ProviderIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:connectors/v1:ProviderIamPolicy", name, args == null ? ProviderIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ProviderIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ProviderIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
