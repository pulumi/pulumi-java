...
public class Address extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.AddressArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.AddressArgs.builder();
    ...
    public Address(String name, AddressArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:Address", name, args == null ? AddressArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
