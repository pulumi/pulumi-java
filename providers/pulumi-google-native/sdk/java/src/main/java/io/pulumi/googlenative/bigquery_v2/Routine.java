...
public class Routine extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.bigquery_v2.RoutineArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.bigquery_v2.RoutineArgs.builder();
    ...
    public Routine(String name, RoutineArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:bigquery/v2:Routine", name, args == null ? RoutineArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
