...
import io.pulumi.googlenative.compute_beta.BackendServiceArgs;
...
public class BackendService extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.BackendServiceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.BackendServiceArgs.builder();
    ...
    public BackendService(String name, @Nullable BackendServiceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:BackendService", name, args == null ? BackendServiceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
