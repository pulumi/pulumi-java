...
import io.pulumi.googlenative.managedidentities_v1alpha1.DomainIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:managedidentities/v1alpha1:DomainIamPolicy")
public class DomainIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(DomainIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.managedidentities_v1alpha1.DomainIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.managedidentities_v1alpha1.DomainIamPolicyArgs.builder();
     ...
     */
    public DomainIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public DomainIamPolicy(String name, DomainIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:managedidentities/v1alpha1:DomainIamPolicy", name, args == null ? DomainIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private DomainIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:managedidentities/v1alpha1:DomainIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static DomainIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
