...
public class GcpUserAccessBinding extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.accesscontextmanager_v1.GcpUserAccessBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.accesscontextmanager_v1.GcpUserAccessBindingArgs.builder();
    ...
    public GcpUserAccessBinding(String name, GcpUserAccessBindingArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:accesscontextmanager/v1:GcpUserAccessBinding", name, args == null ? GcpUserAccessBindingArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private GcpUserAccessBinding(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static GcpUserAccessBinding get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
