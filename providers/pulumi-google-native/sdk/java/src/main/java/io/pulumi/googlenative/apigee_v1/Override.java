...
public class Override extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(OverrideArgs.Builder a);
    }
    private static io.pulumi.googlenative.apigee_v1.OverrideArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.apigee_v1.OverrideArgs.builder();
     ...
     */
    public Override(String name, BuilderApplicator argsBuilder) {
