...
import io.pulumi.googlenative.compute_v1.SubnetworkIamPolicyArgs;
...
public class SubnetworkIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.SubnetworkIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.SubnetworkIamPolicyArgs.builder();
    ...
    public SubnetworkIamPolicy(String name, SubnetworkIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:SubnetworkIamPolicy", name, args == null ? SubnetworkIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
