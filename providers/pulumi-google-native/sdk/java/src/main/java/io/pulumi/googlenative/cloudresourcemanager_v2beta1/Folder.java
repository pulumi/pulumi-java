...
public class Folder extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.cloudresourcemanager_v2beta1.FolderArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudresourcemanager_v2beta1.FolderArgs.builder();
