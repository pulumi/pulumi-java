...
import io.pulumi.googlenative.compute_alpha.SslCertificateArgs;
...
public class SslCertificate extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.SslCertificateArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.SslCertificateArgs.builder();
    ...
    public SslCertificate(String name, @Nullable SslCertificateArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:SslCertificate", name, args == null ? SslCertificateArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
