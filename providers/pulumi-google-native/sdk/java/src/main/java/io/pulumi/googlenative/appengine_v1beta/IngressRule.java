...
public class IngressRule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.appengine_v1beta.IngressRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.appengine_v1beta.IngressRuleArgs.builder();
    ...
    public IngressRule(String name, IngressRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:appengine/v1beta:IngressRule", name, args == null ? IngressRuleArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
