...
public class Instance extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.file_v1beta1.InstanceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.file_v1beta1.InstanceArgs.builder();
