 ...
 * 
 */
@ResourceType(type="google-native:datacatalog/v1beta1:EntryGroupIamPolicy")
public class EntryGroupIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.datacatalog_v1beta1.EntryGroupIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.datacatalog_v1beta1.EntryGroupIamPolicyArgs.builder();
    ...
    public EntryGroupIamPolicy(String name, EntryGroupIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datacatalog/v1beta1:EntryGroupIamPolicy", name, args == null ? EntryGroupIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private EntryGroupIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datacatalog/v1beta1:EntryGroupIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static EntryGroupIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
