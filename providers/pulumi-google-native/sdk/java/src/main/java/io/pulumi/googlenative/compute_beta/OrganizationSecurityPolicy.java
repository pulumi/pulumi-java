...
import io.pulumi.googlenative.compute_beta.OrganizationSecurityPolicyArgs;
...
public class OrganizationSecurityPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.OrganizationSecurityPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.OrganizationSecurityPolicyArgs.builder();
    ...
    public OrganizationSecurityPolicy(String name, @Nullable OrganizationSecurityPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:OrganizationSecurityPolicy", name, args == null ? OrganizationSecurityPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
