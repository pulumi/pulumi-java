...
public class Instance extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.sqladmin_v1.InstanceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.sqladmin_v1.InstanceArgs.builder();
    ...
    public Instance(String name, @Nullable InstanceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:sqladmin/v1:Instance", name, args == null ? InstanceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
