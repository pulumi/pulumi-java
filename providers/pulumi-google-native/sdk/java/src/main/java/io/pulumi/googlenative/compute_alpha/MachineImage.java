...
import io.pulumi.googlenative.compute_alpha.MachineImageArgs;
...
public class MachineImage extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(MachineImageArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.MachineImageArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.MachineImageArgs.builder();
     ...
     */
    public MachineImage(String name, BuilderApplicator argsBuilder) {
    ...
    public MachineImage(String name, MachineImageArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:MachineImage", name, args == null ? MachineImageArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
