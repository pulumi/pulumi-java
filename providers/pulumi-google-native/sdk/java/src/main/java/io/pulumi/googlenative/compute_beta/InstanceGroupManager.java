...
import io.pulumi.googlenative.compute_beta.InstanceGroupManagerArgs;
...
public class InstanceGroupManager extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable InstanceGroupManagerArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_beta.InstanceGroupManagerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.InstanceGroupManagerArgs.builder();
     ...
     */
    public InstanceGroupManager(String name, BuilderApplicator argsBuilder) {
    ...
    public InstanceGroupManager(String name, @Nullable InstanceGroupManagerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:InstanceGroupManager", name, args == null ? InstanceGroupManagerArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private InstanceGroupManager(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static InstanceGroupManager get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
