...
public class FhirStore extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(FhirStoreArgs.Builder a);
    }
    private static io.pulumi.googlenative.healthcare_v1beta1.FhirStoreArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.healthcare_v1beta1.FhirStoreArgs.builder();
     ...
     */
    public FhirStore(String name, BuilderApplicator argsBuilder) {
    ...
    public FhirStore(String name, FhirStoreArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1beta1:FhirStore", name, args == null ? FhirStoreArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private FhirStore(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static FhirStore get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
