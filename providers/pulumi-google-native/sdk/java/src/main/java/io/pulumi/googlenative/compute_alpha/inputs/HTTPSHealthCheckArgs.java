...
public final class HTTPSHealthCheckArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Input<HTTPSHealthCheckPortSpecification> getPortSpecification() {
    ...
    public Input<HTTPSHealthCheckProxyHeader> getProxyHeader() {
    ...
    public Input<HTTPSHealthCheckWeightReportMode> getWeightReportMode() {
    ...
    public HTTPSHealthCheckArgs(
        ...
        @Nullable Input<HTTPSHealthCheckPortSpecification> portSpecification,
        @Nullable Input<HTTPSHealthCheckProxyHeader> proxyHeader,
        @Nullable Input<String> requestPath,
        @Nullable Input<String> response,
        @Nullable Input<HTTPSHealthCheckWeightReportMode> weightReportMode) {
        this.host = host;
        this.port = port;
    ...
    public static final class Builder {
        ...
        private @Nullable Input<HTTPSHealthCheckPortSpecification> portSpecification;
        private @Nullable Input<HTTPSHealthCheckProxyHeader> proxyHeader;
        private @Nullable Input<String> requestPath;
        private @Nullable Input<String> response;
        private @Nullable Input<HTTPSHealthCheckWeightReportMode> weightReportMode;
        ...
        public Builder setPortSpecification(@Nullable Input<HTTPSHealthCheckPortSpecification> portSpecification) {
            this.portSpecification = portSpecification;
            return this;
        }

        public Builder setPortSpecification(@Nullable HTTPSHealthCheckPortSpecification portSpecification) {
            this.portSpecification = Input.ofNullable(portSpecification);
            return this;
        }

        public Builder setProxyHeader(@Nullable Input<HTTPSHealthCheckProxyHeader> proxyHeader) {
            this.proxyHeader = proxyHeader;
            return this;
        }

        public Builder setProxyHeader(@Nullable HTTPSHealthCheckProxyHeader proxyHeader) {
        ...
        public Builder setWeightReportMode(@Nullable Input<HTTPSHealthCheckWeightReportMode> weightReportMode) {
            this.weightReportMode = weightReportMode;
            return this;
        }

        public Builder setWeightReportMode(@Nullable HTTPSHealthCheckWeightReportMode weightReportMode) {
