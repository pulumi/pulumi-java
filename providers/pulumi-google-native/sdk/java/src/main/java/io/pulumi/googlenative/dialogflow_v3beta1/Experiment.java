...
public class Experiment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.dialogflow_v3beta1.ExperimentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dialogflow_v3beta1.ExperimentArgs.builder();
    ...
    public Experiment(String name, ExperimentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v3beta1:Experiment", name, args == null ? ExperimentArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
