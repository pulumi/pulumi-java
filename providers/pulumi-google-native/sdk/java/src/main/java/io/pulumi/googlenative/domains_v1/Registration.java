...
public class Registration extends io.pulumi.resources.CustomResource {
    ...
    public Registration(String name) {
        super("google-native:domains/v1:Registration", name, RegistrationArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public Registration(String name, RegistrationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:domains/v1:Registration", name, args == null ? RegistrationArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
