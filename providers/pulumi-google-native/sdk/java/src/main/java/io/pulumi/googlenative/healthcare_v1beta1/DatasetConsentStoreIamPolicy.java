...
import io.pulumi.googlenative.healthcare_v1beta1.DatasetConsentStoreIamPolicyArgs;
...
public class DatasetConsentStoreIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public DatasetConsentStoreIamPolicy(String name) {
        super("google-native:healthcare/v1beta1:DatasetConsentStoreIamPolicy", name, DatasetConsentStoreIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public DatasetConsentStoreIamPolicy(String name, DatasetConsentStoreIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1beta1:DatasetConsentStoreIamPolicy", name, args == null ? DatasetConsentStoreIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
