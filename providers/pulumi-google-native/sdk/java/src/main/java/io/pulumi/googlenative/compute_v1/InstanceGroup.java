...
public class InstanceGroup extends io.pulumi.resources.CustomResource {
    ...
    public InstanceGroup(String name) {
        super("google-native:compute/v1:InstanceGroup", name, InstanceGroupArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public InstanceGroup(String name, @Nullable InstanceGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:InstanceGroup", name, args == null ? InstanceGroupArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
