...
public class Attestor extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.binaryauthorization_v1beta1.AttestorArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.binaryauthorization_v1beta1.AttestorArgs.builder();
