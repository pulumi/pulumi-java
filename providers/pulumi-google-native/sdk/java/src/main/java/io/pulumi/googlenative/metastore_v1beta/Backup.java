...
public class Backup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.metastore_v1beta.BackupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.metastore_v1beta.BackupArgs.builder();
    ...
    public Backup(String name, BackupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1beta:Backup", name, args == null ? BackupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
