...
import io.pulumi.googlenative.compute_v1.HttpsHealthCheckArgs;
...
public class HttpsHealthCheck extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.HttpsHealthCheckArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.HttpsHealthCheckArgs.builder();
    ...
    public HttpsHealthCheck(String name, @Nullable HttpsHealthCheckArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:HttpsHealthCheck", name, args == null ? HttpsHealthCheckArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
