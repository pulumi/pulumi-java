...
public class Topic extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.pubsublite_v1.TopicArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.pubsublite_v1.TopicArgs.builder();
