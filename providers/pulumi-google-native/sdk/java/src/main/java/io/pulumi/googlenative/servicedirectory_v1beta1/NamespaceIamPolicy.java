...
public class NamespaceIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public NamespaceIamPolicy(String name, NamespaceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:servicedirectory/v1beta1:NamespaceIamPolicy", name, args == null ? NamespaceIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private NamespaceIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static NamespaceIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
