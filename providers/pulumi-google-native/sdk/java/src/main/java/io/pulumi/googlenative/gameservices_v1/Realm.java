...
public class Realm extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.gameservices_v1.RealmArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.gameservices_v1.RealmArgs.builder();
