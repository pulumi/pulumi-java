...
import io.pulumi.googlenative.artifactregistry_v1.RepositoryIamPolicyArgs;
import io.pulumi.googlenative.artifactregistry_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:artifactregistry/v1:RepositoryIamPolicy")
public class RepositoryIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.artifactregistry_v1.RepositoryIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.artifactregistry_v1.RepositoryIamPolicyArgs.builder();
    ...
    public RepositoryIamPolicy(String name, RepositoryIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:artifactregistry/v1:RepositoryIamPolicy", name, args == null ? RepositoryIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private RepositoryIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:artifactregistry/v1:RepositoryIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static RepositoryIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
