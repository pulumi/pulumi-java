...
import io.pulumi.googlenative.compute_beta.BackendServiceIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:BackendServiceIamPolicy")
public class BackendServiceIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.BackendServiceIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.BackendServiceIamPolicyArgs.builder();
    ...
    public BackendServiceIamPolicy(String name, BackendServiceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:BackendServiceIamPolicy", name, args == null ? BackendServiceIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private BackendServiceIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:BackendServiceIamPolicy", name, null, makeResourceOptions(options, id));
    }
