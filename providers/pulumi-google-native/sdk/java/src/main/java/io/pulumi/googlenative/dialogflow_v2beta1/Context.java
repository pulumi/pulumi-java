...
public class Context extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ContextArgs.Builder a);
    }
    private static io.pulumi.googlenative.dialogflow_v2beta1.ContextArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dialogflow_v2beta1.ContextArgs.builder();
     ...
     */
    public Context(String name, BuilderApplicator argsBuilder) {
