...
public class InstanceClusterBackupIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public InstanceClusterBackupIamPolicy(String name) {
        super("google-native:bigtableadmin/v2:InstanceClusterBackupIamPolicy", name, InstanceClusterBackupIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public InstanceClusterBackupIamPolicy(String name, InstanceClusterBackupIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:bigtableadmin/v2:InstanceClusterBackupIamPolicy", name, args == null ? InstanceClusterBackupIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private InstanceClusterBackupIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static InstanceClusterBackupIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
