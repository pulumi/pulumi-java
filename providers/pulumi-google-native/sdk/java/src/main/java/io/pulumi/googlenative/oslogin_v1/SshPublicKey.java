...
public class SshPublicKey extends io.pulumi.resources.CustomResource {
    ...
    public SshPublicKey(String name) {
        super("google-native:oslogin/v1:SshPublicKey", name, SshPublicKeyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public SshPublicKey(String name, SshPublicKeyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:oslogin/v1:SshPublicKey", name, args == null ? SshPublicKeyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
