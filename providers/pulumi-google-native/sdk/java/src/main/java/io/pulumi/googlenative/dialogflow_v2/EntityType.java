...
public class EntityType extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.dialogflow_v2.EntityTypeArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dialogflow_v2.EntityTypeArgs.builder();
