...
public final class JobArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public JobArgs(
        ...
        @Nullable Input<Boolean> legacyAppEngineCron,
    ...
    private JobArgs() {
        ...
        this.legacyAppEngineCron = Input.empty();
    ...
    public static final class Builder {
        ...
        private @Nullable Input<Boolean> legacyAppEngineCron;
        ...
        public Builder setLegacyAppEngineCron(@Nullable Input<Boolean> legacyAppEngineCron) {
            this.legacyAppEngineCron = legacyAppEngineCron;
            return this;
        }

        public Builder setLegacyAppEngineCron(@Nullable Boolean legacyAppEngineCron) {
            this.legacyAppEngineCron = Input.ofNullable(legacyAppEngineCron);
            return this;
        }
