...
public class Budget extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.billingbudgets_v1.BudgetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.billingbudgets_v1.BudgetArgs.builder();
