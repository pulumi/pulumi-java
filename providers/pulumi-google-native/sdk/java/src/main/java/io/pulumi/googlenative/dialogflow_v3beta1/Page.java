...
public class Page extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PageArgs.Builder a);
    }
    private static io.pulumi.googlenative.dialogflow_v3beta1.PageArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dialogflow_v3beta1.PageArgs.builder();
     ...
     */
    public Page(String name, BuilderApplicator argsBuilder) {
    ...
    public Page(String name, PageArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v3beta1:Page", name, args == null ? PageArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
