...
import io.pulumi.googlenative.compute_alpha.FirewallPolicyIamPolicyArgs;
...
public class FirewallPolicyIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(FirewallPolicyIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.FirewallPolicyIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.FirewallPolicyIamPolicyArgs.builder();
     ...
     */
    public FirewallPolicyIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public FirewallPolicyIamPolicy(String name, FirewallPolicyIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:FirewallPolicyIamPolicy", name, args == null ? FirewallPolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private FirewallPolicyIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static FirewallPolicyIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
