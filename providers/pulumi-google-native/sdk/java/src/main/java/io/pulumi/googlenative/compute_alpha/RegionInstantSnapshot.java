...
public class RegionInstantSnapshot extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RegionInstantSnapshotArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.RegionInstantSnapshotArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.RegionInstantSnapshotArgs.builder();
     ...
     */
    public RegionInstantSnapshot(String name, BuilderApplicator argsBuilder) {
    ...
    public RegionInstantSnapshot(String name, RegionInstantSnapshotArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionInstantSnapshot", name, args == null ? RegionInstantSnapshotArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private RegionInstantSnapshot(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static RegionInstantSnapshot get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
