...
public class MetadataImport extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.metastore_v1beta.MetadataImportArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.metastore_v1beta.MetadataImportArgs.builder();
