...
public class License extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.LicenseArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.LicenseArgs.builder();
    ...
    public License(String name, @Nullable LicenseArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:License", name, args == null ? LicenseArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
