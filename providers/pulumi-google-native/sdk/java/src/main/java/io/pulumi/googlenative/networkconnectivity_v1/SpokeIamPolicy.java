...
import io.pulumi.googlenative.networkconnectivity_v1.SpokeIamPolicyArgs;
...
public class SpokeIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.networkconnectivity_v1.SpokeIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.networkconnectivity_v1.SpokeIamPolicyArgs.builder();
    ...
    public SpokeIamPolicy(String name, SpokeIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkconnectivity/v1:SpokeIamPolicy", name, args == null ? SpokeIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
