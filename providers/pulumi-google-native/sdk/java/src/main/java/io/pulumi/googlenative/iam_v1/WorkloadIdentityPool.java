...
public class WorkloadIdentityPool extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.iam_v1.WorkloadIdentityPoolArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.iam_v1.WorkloadIdentityPoolArgs.builder();
     ...
     */
    public static WorkloadIdentityPool get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
