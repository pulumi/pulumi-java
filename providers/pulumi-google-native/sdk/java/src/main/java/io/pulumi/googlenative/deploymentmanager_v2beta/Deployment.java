...
public class Deployment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.deploymentmanager_v2beta.DeploymentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.deploymentmanager_v2beta.DeploymentArgs.builder();
