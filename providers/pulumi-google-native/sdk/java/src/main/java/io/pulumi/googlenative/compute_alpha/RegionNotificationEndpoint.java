...
public class RegionNotificationEndpoint extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.RegionNotificationEndpointArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.RegionNotificationEndpointArgs.builder();
    ...
    public RegionNotificationEndpoint(String name, RegionNotificationEndpointArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionNotificationEndpoint", name, args == null ? RegionNotificationEndpointArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
