...
import io.pulumi.googlenative.compute_v1.GlobalPublicDelegatedPrefixArgs;
...
public class GlobalPublicDelegatedPrefix extends io.pulumi.resources.CustomResource {
    ...
    public GlobalPublicDelegatedPrefix(String name) {
        super("google-native:compute/v1:GlobalPublicDelegatedPrefix", name, GlobalPublicDelegatedPrefixArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public GlobalPublicDelegatedPrefix(String name, @Nullable GlobalPublicDelegatedPrefixArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:GlobalPublicDelegatedPrefix", name, args == null ? GlobalPublicDelegatedPrefixArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
