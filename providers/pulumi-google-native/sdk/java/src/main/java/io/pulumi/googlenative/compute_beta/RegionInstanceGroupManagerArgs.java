...
public final class RegionInstanceGroupManagerArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<RegionInstanceGroupManagerFailoverAction> failoverAction;

    public Input<RegionInstanceGroupManagerFailoverAction> getFailoverAction() {
    ...
    public RegionInstanceGroupManagerArgs(
        ...
        @Nullable Input<RegionInstanceGroupManagerFailoverAction> failoverAction,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<RegionInstanceGroupManagerFailoverAction> failoverAction;
        ...
        public Builder setFailoverAction(@Nullable Input<RegionInstanceGroupManagerFailoverAction> failoverAction) {
            this.failoverAction = failoverAction;
            return this;
        }

        public Builder setFailoverAction(@Nullable RegionInstanceGroupManagerFailoverAction failoverAction) {
