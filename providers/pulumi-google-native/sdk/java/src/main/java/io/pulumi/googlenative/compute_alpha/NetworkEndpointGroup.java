...
public class NetworkEndpointGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.NetworkEndpointGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.NetworkEndpointGroupArgs.builder();
    ...
    public NetworkEndpointGroup(String name, @Nullable NetworkEndpointGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:NetworkEndpointGroup", name, args == null ? NetworkEndpointGroupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
