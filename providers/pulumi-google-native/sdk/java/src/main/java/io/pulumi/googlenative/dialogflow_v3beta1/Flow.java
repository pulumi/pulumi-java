...
public class Flow extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.dialogflow_v3beta1.FlowArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dialogflow_v3beta1.FlowArgs.builder();
    ...
    public Flow(String name, FlowArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v3beta1:Flow", name, args == null ? FlowArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
