...
public class ConfigIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.runtimeconfig_v1beta1.ConfigIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.runtimeconfig_v1beta1.ConfigIamPolicyArgs.builder();
    ...
    public ConfigIamPolicy(String name, ConfigIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:runtimeconfig/v1beta1:ConfigIamPolicy", name, args == null ? ConfigIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ConfigIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ConfigIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
