...
import io.pulumi.googlenative.healthcare_v1beta1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:healthcare/v1beta1:DatasetHl7V2StoreIamPolicy")
public class DatasetHl7V2StoreIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(DatasetHl7V2StoreIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.healthcare_v1beta1.DatasetHl7V2StoreIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.healthcare_v1beta1.DatasetHl7V2StoreIamPolicyArgs.builder();
     ...
     */
    public DatasetHl7V2StoreIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public DatasetHl7V2StoreIamPolicy(String name) {
        this(name, DatasetHl7V2StoreIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DatasetHl7V2StoreIamPolicy(String name, DatasetHl7V2StoreIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
    ...
    public DatasetHl7V2StoreIamPolicy(String name, DatasetHl7V2StoreIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1beta1:DatasetHl7V2StoreIamPolicy", name, args == null ? DatasetHl7V2StoreIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private DatasetHl7V2StoreIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1beta1:DatasetHl7V2StoreIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static DatasetHl7V2StoreIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new DatasetHl7V2StoreIamPolicy(name, id, options);
    }
}
