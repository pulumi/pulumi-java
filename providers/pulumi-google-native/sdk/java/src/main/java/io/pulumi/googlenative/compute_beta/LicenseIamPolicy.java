...
import io.pulumi.googlenative.compute_beta.LicenseIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:LicenseIamPolicy")
public class LicenseIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(LicenseIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_beta.LicenseIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.LicenseIamPolicyArgs.builder();
     ...
     */
    public LicenseIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     * @param name The _unique_ name of the resulting resource.
     */
    public LicenseIamPolicy(String name) {
        this(name, LicenseIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public LicenseIamPolicy(String name, LicenseIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:LicenseIamPolicy", name, args == null ? LicenseIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private LicenseIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:LicenseIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static LicenseIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
