...
public class LicenseIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public LicenseIamPolicy(String name, LicenseIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:LicenseIamPolicy", name, args == null ? LicenseIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
     ...
     */
    public static LicenseIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
