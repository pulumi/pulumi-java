 ...
 */
    public static CompletableFuture<GetNodePoolResult> invokeAsync(GetNodePoolArgs args, @Nullable InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("google-native:container/v1beta1:getNodePool", TypeShape.of(GetNodePoolResult.class), args == null ? GetNodePoolArgs.Empty : args, Utilities.withVersion(options));
    }
}
