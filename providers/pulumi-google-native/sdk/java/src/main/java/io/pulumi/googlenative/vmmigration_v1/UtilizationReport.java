...
public class UtilizationReport extends io.pulumi.resources.CustomResource {
    ...
    public UtilizationReport(String name) {
        super("google-native:vmmigration/v1:UtilizationReport", name, UtilizationReportArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public UtilizationReport(String name, UtilizationReportArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:vmmigration/v1:UtilizationReport", name, args == null ? UtilizationReportArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
