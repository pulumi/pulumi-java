...
public class Consent extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.healthcare_v1beta1.ConsentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.healthcare_v1beta1.ConsentArgs.builder();
    ...
    public Consent(String name, ConsentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1beta1:Consent", name, args == null ? ConsentArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
     ...
     */
    public static Consent get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
