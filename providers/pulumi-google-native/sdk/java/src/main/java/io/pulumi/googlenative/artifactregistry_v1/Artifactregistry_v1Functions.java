...
public final class Artifactregistry_v1Functions {
     ...
     * 
     */
    public static CompletableFuture<GetRepositoryResult> getRepository(io.pulumi.googlenative.artifactregistry_v1.inputs.GetRepositoryArgs args) {
        return getRepository(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetRepositoryResult> getRepository(io.pulumi.googlenative.artifactregistry_v1.inputs.GetRepositoryArgs args, InvokeOptions options) {
     ...
     * 
     */
    public static CompletableFuture<GetRepositoryIamPolicyResult> getRepositoryIamPolicy(io.pulumi.googlenative.artifactregistry_v1.inputs.GetRepositoryIamPolicyArgs args) {
        return getRepositoryIamPolicy(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetRepositoryIamPolicyResult> getRepositoryIamPolicy(io.pulumi.googlenative.artifactregistry_v1.inputs.GetRepositoryIamPolicyArgs args, InvokeOptions options) {
     ...
     * 
     */
    public static CompletableFuture<GetTagResult> getTag(io.pulumi.googlenative.artifactregistry_v1.inputs.GetTagArgs args) {
        return getTag(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetTagResult> getTag(io.pulumi.googlenative.artifactregistry_v1.inputs.GetTagArgs args, InvokeOptions options) {
