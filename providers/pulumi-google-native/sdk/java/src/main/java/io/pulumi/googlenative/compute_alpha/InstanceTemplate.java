...
import io.pulumi.googlenative.compute_alpha.InstanceTemplateArgs;
...
public class InstanceTemplate extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable InstanceTemplateArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.InstanceTemplateArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.InstanceTemplateArgs.builder();
     ...
     */
    public InstanceTemplate(String name, BuilderApplicator argsBuilder) {
    ...
    public InstanceTemplate(String name, @Nullable InstanceTemplateArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:InstanceTemplate", name, args == null ? InstanceTemplateArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private InstanceTemplate(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:InstanceTemplate", name, null, makeResourceOptions(options, id));
    }
