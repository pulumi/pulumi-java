...
public class ClientTlsPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ClientTlsPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.networksecurity_v1.ClientTlsPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.networksecurity_v1.ClientTlsPolicyArgs.builder();
     ...
     */
    public ClientTlsPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public ClientTlsPolicy(String name, ClientTlsPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networksecurity/v1:ClientTlsPolicy", name, args == null ? ClientTlsPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
