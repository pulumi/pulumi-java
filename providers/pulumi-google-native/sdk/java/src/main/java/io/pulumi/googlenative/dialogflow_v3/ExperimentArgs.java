...
import io.pulumi.googlenative.dialogflow_v3.inputs.GoogleCloudDialogflowCxV3RolloutConfigArgs;
import io.pulumi.googlenative.dialogflow_v3.inputs.GoogleCloudDialogflowCxV3RolloutStateArgs;
import io.pulumi.googlenative.dialogflow_v3.inputs.GoogleCloudDialogflowCxV3VariantsHistoryArgs;
...
public final class ExperimentArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Input<GoogleCloudDialogflowCxV3ExperimentDefinitionArgs> getDefinition() {
    ...
    public Input<GoogleCloudDialogflowCxV3ExperimentResultArgs> getResult() {
    ...
    public Input<GoogleCloudDialogflowCxV3RolloutConfigArgs> getRolloutConfig() {
    ...
    public Input<GoogleCloudDialogflowCxV3RolloutStateArgs> getRolloutState() {
    ...
    public Input<List<GoogleCloudDialogflowCxV3VariantsHistoryArgs>> getVariantsHistory() {
    ...
    public ExperimentArgs(
        ...
        @Nullable Input<GoogleCloudDialogflowCxV3ExperimentDefinitionArgs> definition,
        ...
        @Nullable Input<GoogleCloudDialogflowCxV3ExperimentResultArgs> result,
        @Nullable Input<GoogleCloudDialogflowCxV3RolloutConfigArgs> rolloutConfig,
        @Nullable Input<String> rolloutFailureReason,
        @Nullable Input<GoogleCloudDialogflowCxV3RolloutStateArgs> rolloutState,
        @Nullable Input<String> startTime,
        @Nullable Input<ExperimentState> state,
        @Nullable Input<List<GoogleCloudDialogflowCxV3VariantsHistoryArgs>> variantsHistory) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<GoogleCloudDialogflowCxV3ExperimentDefinitionArgs> definition;
        ...
        private @Nullable Input<GoogleCloudDialogflowCxV3ExperimentResultArgs> result;
        private @Nullable Input<GoogleCloudDialogflowCxV3RolloutConfigArgs> rolloutConfig;
        private @Nullable Input<String> rolloutFailureReason;
        private @Nullable Input<GoogleCloudDialogflowCxV3RolloutStateArgs> rolloutState;
        private @Nullable Input<String> startTime;
        private @Nullable Input<ExperimentState> state;
        private @Nullable Input<List<GoogleCloudDialogflowCxV3VariantsHistoryArgs>> variantsHistory;
        ...
        public Builder setDefinition(@Nullable Input<GoogleCloudDialogflowCxV3ExperimentDefinitionArgs> definition) {
            this.definition = definition;
            return this;
        }

        public Builder setDefinition(@Nullable GoogleCloudDialogflowCxV3ExperimentDefinitionArgs definition) {
        ...
        public Builder setResult(@Nullable Input<GoogleCloudDialogflowCxV3ExperimentResultArgs> result) {
            this.result = result;
            return this;
        }

        public Builder setResult(@Nullable GoogleCloudDialogflowCxV3ExperimentResultArgs result) {
            this.result = Input.ofNullable(result);
            return this;
        }

        public Builder setRolloutConfig(@Nullable Input<GoogleCloudDialogflowCxV3RolloutConfigArgs> rolloutConfig) {
            this.rolloutConfig = rolloutConfig;
            return this;
        }

        public Builder setRolloutConfig(@Nullable GoogleCloudDialogflowCxV3RolloutConfigArgs rolloutConfig) {
        ...
        public Builder setRolloutState(@Nullable Input<GoogleCloudDialogflowCxV3RolloutStateArgs> rolloutState) {
            this.rolloutState = rolloutState;
            return this;
        }

        public Builder setRolloutState(@Nullable GoogleCloudDialogflowCxV3RolloutStateArgs rolloutState) {
        ...
        public Builder setVariantsHistory(@Nullable Input<List<GoogleCloudDialogflowCxV3VariantsHistoryArgs>> variantsHistory) {
            this.variantsHistory = variantsHistory;
            return this;
        }

        public Builder setVariantsHistory(@Nullable List<GoogleCloudDialogflowCxV3VariantsHistoryArgs> variantsHistory) {
