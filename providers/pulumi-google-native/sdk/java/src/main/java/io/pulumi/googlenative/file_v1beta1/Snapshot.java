...
public class Snapshot extends io.pulumi.resources.CustomResource {
    ...
    public Snapshot(String name) {
        super("google-native:file/v1beta1:Snapshot", name, SnapshotArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public Snapshot(String name, SnapshotArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:file/v1beta1:Snapshot", name, args == null ? SnapshotArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
