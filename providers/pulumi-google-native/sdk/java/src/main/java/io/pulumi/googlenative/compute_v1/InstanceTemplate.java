...
import io.pulumi.googlenative.compute_v1.InstanceTemplateArgs;
...
public class InstanceTemplate extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.InstanceTemplateArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.InstanceTemplateArgs.builder();
    ...
    public InstanceTemplate(String name, @Nullable InstanceTemplateArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:InstanceTemplate", name, args == null ? InstanceTemplateArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
