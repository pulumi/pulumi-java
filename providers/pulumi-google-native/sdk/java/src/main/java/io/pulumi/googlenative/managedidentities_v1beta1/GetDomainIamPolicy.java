 ...
 */
    public static CompletableFuture<GetDomainIamPolicyResult> invokeAsync(GetDomainIamPolicyArgs args, @Nullable InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("google-native:managedidentities/v1beta1:getDomainIamPolicy", TypeShape.of(GetDomainIamPolicyResult.class), args == null ? GetDomainIamPolicyArgs.Empty : args, Utilities.withVersion(options));
    }
}
