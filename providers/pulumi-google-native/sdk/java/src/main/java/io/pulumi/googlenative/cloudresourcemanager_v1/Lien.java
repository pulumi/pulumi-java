...
public class Lien extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.cloudresourcemanager_v1.LienArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudresourcemanager_v1.LienArgs.builder();
    ...
    public Lien(String name, @Nullable LienArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v1:Lien", name, args == null ? LienArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
