...
public final class Gkehub_v1beta1Functions {
     ...
     * 
     */
    public static CompletableFuture<GetMembershipResult> getMembership(io.pulumi.googlenative.gkehub_v1beta1.inputs.GetMembershipArgs args) {
        return getMembership(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetMembershipResult> getMembership(io.pulumi.googlenative.gkehub_v1beta1.inputs.GetMembershipArgs args, InvokeOptions options) {
     ...
     * 
     */
    public static CompletableFuture<GetMembershipIamPolicyResult> getMembershipIamPolicy(io.pulumi.googlenative.gkehub_v1beta1.inputs.GetMembershipIamPolicyArgs args) {
        return getMembershipIamPolicy(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetMembershipIamPolicyResult> getMembershipIamPolicy(io.pulumi.googlenative.gkehub_v1beta1.inputs.GetMembershipIamPolicyArgs args, InvokeOptions options) {
