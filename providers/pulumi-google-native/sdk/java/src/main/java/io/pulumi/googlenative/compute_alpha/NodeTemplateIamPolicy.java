...
public class NodeTemplateIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public NodeTemplateIamPolicy(String name) {
        super("google-native:compute/alpha:NodeTemplateIamPolicy", name, NodeTemplateIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public NodeTemplateIamPolicy(String name, NodeTemplateIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:NodeTemplateIamPolicy", name, args == null ? NodeTemplateIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private NodeTemplateIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static NodeTemplateIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
