...
public final class Memcache_v1Functions {
     ...
     * 
     */
    public static CompletableFuture<GetInstanceResult> getInstance(io.pulumi.googlenative.memcache_v1.inputs.GetInstanceArgs args) {
        return getInstance(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetInstanceResult> getInstance(io.pulumi.googlenative.memcache_v1.inputs.GetInstanceArgs args, InvokeOptions options) {
