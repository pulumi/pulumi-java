...
public class PublicDelegatedPrefix extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PublicDelegatedPrefixArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_v1.PublicDelegatedPrefixArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.PublicDelegatedPrefixArgs.builder();
     ...
     */
    public PublicDelegatedPrefix(String name, BuilderApplicator argsBuilder) {
    ...
    public PublicDelegatedPrefix(String name, PublicDelegatedPrefixArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:PublicDelegatedPrefix", name, args == null ? PublicDelegatedPrefixArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
     ...
     */
    public static PublicDelegatedPrefix get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
