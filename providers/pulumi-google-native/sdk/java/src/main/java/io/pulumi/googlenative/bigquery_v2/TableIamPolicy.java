...
public class TableIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public TableIamPolicy(String name, TableIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:bigquery/v2:TableIamPolicy", name, args == null ? TableIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private TableIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TableIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
