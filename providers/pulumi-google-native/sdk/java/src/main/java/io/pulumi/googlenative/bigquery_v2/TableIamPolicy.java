...
import io.pulumi.googlenative.bigquery_v2.TableIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:bigquery/v2:TableIamPolicy")
public class TableIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.bigquery_v2.TableIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.bigquery_v2.TableIamPolicyArgs.builder();
    ...
    public TableIamPolicy(String name, TableIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:bigquery/v2:TableIamPolicy", name, args == null ? TableIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private TableIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:bigquery/v2:TableIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static TableIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
