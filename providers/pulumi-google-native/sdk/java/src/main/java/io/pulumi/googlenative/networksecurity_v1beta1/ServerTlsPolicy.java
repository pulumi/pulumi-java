...
public class ServerTlsPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.networksecurity_v1beta1.ServerTlsPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.networksecurity_v1beta1.ServerTlsPolicyArgs.builder();
