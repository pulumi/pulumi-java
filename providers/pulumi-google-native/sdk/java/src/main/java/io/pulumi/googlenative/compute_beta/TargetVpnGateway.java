...
public class TargetVpnGateway extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.TargetVpnGatewayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.TargetVpnGatewayArgs.builder();
    ...
    public TargetVpnGateway(String name, TargetVpnGatewayArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:TargetVpnGateway", name, args == null ? TargetVpnGatewayArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
