...
public class TargetProject extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.vmmigration_v1.TargetProjectArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.vmmigration_v1.TargetProjectArgs.builder();
    ...
    public TargetProject(String name, TargetProjectArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:vmmigration/v1:TargetProject", name, args == null ? TargetProjectArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
