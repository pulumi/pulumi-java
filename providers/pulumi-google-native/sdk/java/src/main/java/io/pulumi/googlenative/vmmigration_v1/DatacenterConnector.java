...
public class DatacenterConnector extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.vmmigration_v1.DatacenterConnectorArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.vmmigration_v1.DatacenterConnectorArgs.builder();
