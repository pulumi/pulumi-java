...
public class CutoverJob extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.vmmigration_v1alpha1.CutoverJobArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.vmmigration_v1alpha1.CutoverJobArgs.builder();
    ...
    public CutoverJob(String name, CutoverJobArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:vmmigration/v1alpha1:CutoverJob", name, args == null ? CutoverJobArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
