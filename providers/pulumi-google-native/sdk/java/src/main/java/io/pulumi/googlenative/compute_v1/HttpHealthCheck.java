...
import io.pulumi.googlenative.compute_v1.HttpHealthCheckArgs;
...
public class HttpHealthCheck extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.HttpHealthCheckArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.HttpHealthCheckArgs.builder();
    ...
    public HttpHealthCheck(String name, @Nullable HttpHealthCheckArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:HttpHealthCheck", name, args == null ? HttpHealthCheckArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
