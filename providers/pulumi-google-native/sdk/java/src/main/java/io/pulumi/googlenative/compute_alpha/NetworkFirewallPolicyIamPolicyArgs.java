 ...
 * 
 */
public final class NetworkFirewallPolicyIamPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public NetworkFirewallPolicyIamPolicyArgs build() {
            return new NetworkFirewallPolicyIamPolicyArgs(auditConfigs, bindings, etag, project, resource, rules, version);
        }
    }
}
