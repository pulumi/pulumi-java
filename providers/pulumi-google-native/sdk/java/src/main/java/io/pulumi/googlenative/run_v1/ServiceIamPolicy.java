...
import io.pulumi.googlenative.run_v1.ServiceIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:run/v1:ServiceIamPolicy")
public class ServiceIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ServiceIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.run_v1.ServiceIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.run_v1.ServiceIamPolicyArgs.builder();
     ...
     */
    public ServiceIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public ServiceIamPolicy(String name, ServiceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:run/v1:ServiceIamPolicy", name, args == null ? ServiceIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ServiceIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:run/v1:ServiceIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ServiceIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
