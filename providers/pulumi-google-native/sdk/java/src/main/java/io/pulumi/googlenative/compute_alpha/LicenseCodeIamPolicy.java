...
public class LicenseCodeIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public LicenseCodeIamPolicy(String name, LicenseCodeIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:LicenseCodeIamPolicy", name, args == null ? LicenseCodeIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private LicenseCodeIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static LicenseCodeIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
