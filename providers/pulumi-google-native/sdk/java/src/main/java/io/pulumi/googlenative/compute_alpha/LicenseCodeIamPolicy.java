...
import io.pulumi.googlenative.compute_alpha.LicenseCodeIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:LicenseCodeIamPolicy")
public class LicenseCodeIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(LicenseCodeIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.LicenseCodeIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.LicenseCodeIamPolicyArgs.builder();
     ...
     */
    public LicenseCodeIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     * @param name The _unique_ name of the resulting resource.
     */
    public LicenseCodeIamPolicy(String name) {
        this(name, LicenseCodeIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LicenseCodeIamPolicy(String name, LicenseCodeIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LicenseCodeIamPolicy(String name, LicenseCodeIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:LicenseCodeIamPolicy", name, args == null ? LicenseCodeIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private LicenseCodeIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:LicenseCodeIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static LicenseCodeIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new LicenseCodeIamPolicy(name, id, options);
    }
}
