...
public class RegionSslPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RegionSslPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.RegionSslPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.RegionSslPolicyArgs.builder();
     ...
     */
    public RegionSslPolicy(String name, BuilderApplicator argsBuilder) {
