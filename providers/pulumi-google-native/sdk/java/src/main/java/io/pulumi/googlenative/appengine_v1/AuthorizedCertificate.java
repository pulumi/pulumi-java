...
public class AuthorizedCertificate extends io.pulumi.resources.CustomResource {
    ...
    public AuthorizedCertificate(String name) {
        super("google-native:appengine/v1:AuthorizedCertificate", name, AuthorizedCertificateArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public AuthorizedCertificate(String name, AuthorizedCertificateArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:appengine/v1:AuthorizedCertificate", name, args == null ? AuthorizedCertificateArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
