...
public final class TagKeyIamPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<String> tagKeyId;

    public Input<String> getTagKeyId() {
    ...
    public static final class Builder {
        ...
        public Builder setTagKeyId(Input<String> tagKeyId) {
            this.tagKeyId = Objects.requireNonNull(tagKeyId);
            return this;
        }

        public Builder setTagKeyId(String tagKeyId) {
            this.tagKeyId = Input.of(Objects.requireNonNull(tagKeyId));
            return this;
        }
