...
import io.pulumi.googlenative.networkservices_v1.EdgeCacheKeysetIamPolicyArgs;
...
public class EdgeCacheKeysetIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(EdgeCacheKeysetIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.networkservices_v1.EdgeCacheKeysetIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.networkservices_v1.EdgeCacheKeysetIamPolicyArgs.builder();
     ...
     */
    public EdgeCacheKeysetIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public EdgeCacheKeysetIamPolicy(String name, EdgeCacheKeysetIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:EdgeCacheKeysetIamPolicy", name, args == null ? EdgeCacheKeysetIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private EdgeCacheKeysetIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static EdgeCacheKeysetIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
