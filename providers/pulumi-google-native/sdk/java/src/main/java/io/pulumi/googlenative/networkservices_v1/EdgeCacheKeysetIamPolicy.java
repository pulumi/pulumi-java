...
public class EdgeCacheKeysetIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public EdgeCacheKeysetIamPolicy(String name, EdgeCacheKeysetIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:EdgeCacheKeysetIamPolicy", name, args == null ? EdgeCacheKeysetIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private EdgeCacheKeysetIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static EdgeCacheKeysetIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
