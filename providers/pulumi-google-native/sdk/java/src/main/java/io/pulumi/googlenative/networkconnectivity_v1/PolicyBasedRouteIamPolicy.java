...
public class PolicyBasedRouteIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public PolicyBasedRouteIamPolicy(String name) {
        super("google-native:networkconnectivity/v1:PolicyBasedRouteIamPolicy", name, PolicyBasedRouteIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public PolicyBasedRouteIamPolicy(String name, PolicyBasedRouteIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkconnectivity/v1:PolicyBasedRouteIamPolicy", name, args == null ? PolicyBasedRouteIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private PolicyBasedRouteIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static PolicyBasedRouteIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
