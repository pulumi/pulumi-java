...
public class WorkerPool extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.cloudbuild_v1.WorkerPoolArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudbuild_v1.WorkerPoolArgs.builder();
