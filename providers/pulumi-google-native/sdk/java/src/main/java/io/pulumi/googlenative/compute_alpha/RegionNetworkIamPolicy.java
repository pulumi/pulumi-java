...
import io.pulumi.googlenative.compute_alpha.RegionNetworkIamPolicyArgs;
...
public class RegionNetworkIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(RegionNetworkIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.RegionNetworkIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.RegionNetworkIamPolicyArgs.builder();
     ...
     */
    public RegionNetworkIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public RegionNetworkIamPolicy(String name, RegionNetworkIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionNetworkIamPolicy", name, args == null ? RegionNetworkIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private RegionNetworkIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static RegionNetworkIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
