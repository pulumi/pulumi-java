...
public class RegionNetworkIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public RegionNetworkIamPolicy(String name, RegionNetworkIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionNetworkIamPolicy", name, args == null ? RegionNetworkIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private RegionNetworkIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static RegionNetworkIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
