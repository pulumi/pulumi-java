...
public class Environment extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    public Output<GoogleCloudDialogflowV2FulfillmentResponse> getFulfillment() {
     ...
     * 
     */
    public Output<GoogleCloudDialogflowV2TextToSpeechSettingsResponse> getTextToSpeechSettings() {
    ...
    private static io.pulumi.googlenative.dialogflow_v2.EnvironmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dialogflow_v2.EnvironmentArgs.builder();
    ...
    public Environment(String name, EnvironmentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v2:Environment", name, args == null ? EnvironmentArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
