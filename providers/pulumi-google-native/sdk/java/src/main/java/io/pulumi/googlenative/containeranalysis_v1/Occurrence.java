...
public class Occurrence extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.containeranalysis_v1.OccurrenceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.containeranalysis_v1.OccurrenceArgs.builder();
