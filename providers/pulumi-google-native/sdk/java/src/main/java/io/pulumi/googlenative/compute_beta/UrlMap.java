...
import io.pulumi.googlenative.compute_beta.UrlMapArgs;
...
public class UrlMap extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.UrlMapArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.UrlMapArgs.builder();
    ...
    public UrlMap(String name, @Nullable UrlMapArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:UrlMap", name, args == null ? UrlMapArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
