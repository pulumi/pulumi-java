...
public class DomainIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.managedidentities_v1.DomainIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.managedidentities_v1.DomainIamPolicyArgs.builder();
    ...
    public DomainIamPolicy(String name, DomainIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:managedidentities/v1:DomainIamPolicy", name, args == null ? DomainIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
