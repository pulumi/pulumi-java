...
import io.pulumi.googlenative.compute_v1.FirewallPolicyIamPolicyArgs;
...
public class FirewallPolicyIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.FirewallPolicyIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.FirewallPolicyIamPolicyArgs.builder();
    ...
    public FirewallPolicyIamPolicy(String name, FirewallPolicyIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:FirewallPolicyIamPolicy", name, args == null ? FirewallPolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
