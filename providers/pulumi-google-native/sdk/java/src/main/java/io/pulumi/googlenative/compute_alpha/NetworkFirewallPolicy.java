...
import io.pulumi.googlenative.compute_alpha.NetworkFirewallPolicyArgs;
...
public class NetworkFirewallPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable NetworkFirewallPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.NetworkFirewallPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.NetworkFirewallPolicyArgs.builder();
     ...
     */
    public NetworkFirewallPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public NetworkFirewallPolicy(String name, @Nullable NetworkFirewallPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:NetworkFirewallPolicy", name, args == null ? NetworkFirewallPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private NetworkFirewallPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static NetworkFirewallPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
