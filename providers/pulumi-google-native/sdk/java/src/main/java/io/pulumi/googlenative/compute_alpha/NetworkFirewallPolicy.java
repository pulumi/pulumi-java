...
public class NetworkFirewallPolicy extends io.pulumi.resources.CustomResource {
    ...
    public NetworkFirewallPolicy(String name, @Nullable NetworkFirewallPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:NetworkFirewallPolicy", name, args == null ? NetworkFirewallPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private NetworkFirewallPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static NetworkFirewallPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
