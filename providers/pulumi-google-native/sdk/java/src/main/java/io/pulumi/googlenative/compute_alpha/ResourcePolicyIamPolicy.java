...
import io.pulumi.googlenative.compute_alpha.ResourcePolicyIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:ResourcePolicyIamPolicy")
public class ResourcePolicyIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(ResourcePolicyIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.ResourcePolicyIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.ResourcePolicyIamPolicyArgs.builder();
     ...
     */
    public ResourcePolicyIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     * @param name The _unique_ name of the resulting resource.
     */
    public ResourcePolicyIamPolicy(String name) {
        this(name, ResourcePolicyIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ResourcePolicyIamPolicy(String name, ResourcePolicyIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ResourcePolicyIamPolicy(String name, ResourcePolicyIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:ResourcePolicyIamPolicy", name, args == null ? ResourcePolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ResourcePolicyIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:ResourcePolicyIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ResourcePolicyIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new ResourcePolicyIamPolicy(name, id, options);
    }
}
