...
import io.pulumi.googlenative.compute_alpha.TargetHttpProxyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:TargetHttpProxy")
public class TargetHttpProxy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.TargetHttpProxyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.TargetHttpProxyArgs.builder();
    ...
    public TargetHttpProxy(String name, @Nullable TargetHttpProxyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:TargetHttpProxy", name, args == null ? TargetHttpProxyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private TargetHttpProxy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:TargetHttpProxy", name, null, makeResourceOptions(options, id));
    }
