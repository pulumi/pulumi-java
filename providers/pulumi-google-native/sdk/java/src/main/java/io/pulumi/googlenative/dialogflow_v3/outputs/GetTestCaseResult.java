...
public final class GetTestCaseResult {
    ...
    private GetTestCaseResult(
        ...
        @CustomType.Parameter("lastTestResult") GoogleCloudDialogflowCxV3TestCaseResultResponse lastTestResult,
        @CustomType.Parameter("name") String name,
        @CustomType.Parameter("notes") String notes,
        @CustomType.Parameter("tags") List<String> tags,
        @CustomType.Parameter("testCaseConversationTurns") List<GoogleCloudDialogflowCxV3ConversationTurnResponse> testCaseConversationTurns,
        @CustomType.Parameter("testConfig") GoogleCloudDialogflowCxV3TestConfigResponse testConfig) {
