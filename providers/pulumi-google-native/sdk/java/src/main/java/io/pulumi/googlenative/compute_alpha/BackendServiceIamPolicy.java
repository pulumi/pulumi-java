...
import io.pulumi.googlenative.compute_alpha.BackendServiceIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:BackendServiceIamPolicy")
public class BackendServiceIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.BackendServiceIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.BackendServiceIamPolicyArgs.builder();
    ...
    public BackendServiceIamPolicy(String name, BackendServiceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:BackendServiceIamPolicy", name, args == null ? BackendServiceIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private BackendServiceIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:BackendServiceIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static BackendServiceIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new BackendServiceIamPolicy(name, id, options);
    }
}
