...
import io.pulumi.googlenative.apigateway_v1.ApiIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:apigateway/v1:ApiIamPolicy")
public class ApiIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.apigateway_v1.ApiIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.apigateway_v1.ApiIamPolicyArgs.builder();
    ...
    public ApiIamPolicy(String name, ApiIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:apigateway/v1:ApiIamPolicy", name, args == null ? ApiIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ApiIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:apigateway/v1:ApiIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ApiIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new ApiIamPolicy(name, id, options);
    }
}
