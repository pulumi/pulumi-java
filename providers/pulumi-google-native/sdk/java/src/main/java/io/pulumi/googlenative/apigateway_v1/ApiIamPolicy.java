...
public class ApiIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public ApiIamPolicy(String name, ApiIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:apigateway/v1:ApiIamPolicy", name, args == null ? ApiIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ApiIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ApiIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
