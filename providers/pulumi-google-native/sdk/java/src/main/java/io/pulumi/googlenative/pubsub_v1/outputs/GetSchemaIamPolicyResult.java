...
@OutputCustomType
public final class GetSchemaIamPolicyResult {
    /**
    ...
    public static Builder builder(GetSchemaIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetSchemaIamPolicyResult defaults) {
        ...
        public GetSchemaIamPolicyResult build() {
            return new GetSchemaIamPolicyResult(bindings, etag, version);
        }
    }
}
