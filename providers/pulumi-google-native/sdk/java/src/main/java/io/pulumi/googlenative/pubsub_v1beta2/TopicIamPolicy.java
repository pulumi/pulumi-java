...
public class TopicIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.pubsub_v1beta2.TopicIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.pubsub_v1beta2.TopicIamPolicyArgs.builder();
    ...
    public TopicIamPolicy(String name, TopicIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:pubsub/v1beta2:TopicIamPolicy", name, args == null ? TopicIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private TopicIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TopicIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
