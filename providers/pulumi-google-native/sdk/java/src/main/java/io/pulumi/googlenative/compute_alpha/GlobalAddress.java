...
import io.pulumi.googlenative.compute_alpha.GlobalAddressArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:GlobalAddress")
public class GlobalAddress extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.GlobalAddressArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.GlobalAddressArgs.builder();
    ...
    public GlobalAddress(String name, @Nullable GlobalAddressArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:GlobalAddress", name, args == null ? GlobalAddressArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private GlobalAddress(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:GlobalAddress", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static GlobalAddress get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
