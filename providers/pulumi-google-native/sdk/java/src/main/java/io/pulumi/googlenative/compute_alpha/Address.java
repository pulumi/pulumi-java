...
import io.pulumi.googlenative.compute_alpha.AddressArgs;
...
public class Address extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(AddressArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.AddressArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.AddressArgs.builder();
     ...
     */
    public Address(String name, BuilderApplicator argsBuilder) {
    ...
    public Address(String name, AddressArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:Address", name, args == null ? AddressArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
