...
import io.pulumi.googlenative.dataproc_v1beta2.WorkflowTemplateIamPolicyArgs;
...
public class WorkflowTemplateIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(WorkflowTemplateIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.dataproc_v1beta2.WorkflowTemplateIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dataproc_v1beta2.WorkflowTemplateIamPolicyArgs.builder();
     ...
     */
    public WorkflowTemplateIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public WorkflowTemplateIamPolicy(String name, WorkflowTemplateIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataproc/v1beta2:WorkflowTemplateIamPolicy", name, args == null ? WorkflowTemplateIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private WorkflowTemplateIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static WorkflowTemplateIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
