...
public class WorkflowTemplateIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public WorkflowTemplateIamPolicy(String name, WorkflowTemplateIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataproc/v1beta2:WorkflowTemplateIamPolicy", name, args == null ? WorkflowTemplateIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
     ...
     */
    public static WorkflowTemplateIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
