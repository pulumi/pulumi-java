...
import io.pulumi.googlenative.gameservices_v1beta.GameServerDeploymentIamPolicyArgs;
import io.pulumi.googlenative.gameservices_v1beta.outputs.AuditConfigResponse;
import io.pulumi.googlenative.gameservices_v1beta.outputs.BindingResponse;
import io.pulumi.googlenative.gameservices_v1beta.outputs.RuleResponse;
 ...
 * 
 */
@ResourceType(type="google-native:gameservices/v1beta:GameServerDeploymentIamPolicy")
public class GameServerDeploymentIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.gameservices_v1beta.GameServerDeploymentIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.gameservices_v1beta.GameServerDeploymentIamPolicyArgs.builder();
    ...
    public GameServerDeploymentIamPolicy(String name, GameServerDeploymentIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gameservices/v1beta:GameServerDeploymentIamPolicy", name, args == null ? GameServerDeploymentIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private GameServerDeploymentIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gameservices/v1beta:GameServerDeploymentIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static GameServerDeploymentIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
