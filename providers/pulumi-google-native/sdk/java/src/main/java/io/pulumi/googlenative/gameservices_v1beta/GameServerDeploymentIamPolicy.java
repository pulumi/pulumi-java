...
public class GameServerDeploymentIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public GameServerDeploymentIamPolicy(String name) {
        super("google-native:gameservices/v1beta:GameServerDeploymentIamPolicy", name, GameServerDeploymentIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
