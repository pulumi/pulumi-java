...
public class Disk extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.DiskArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.DiskArgs.builder();
    ...
    public Disk(String name, @Nullable DiskArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:Disk", name, args == null ? DiskArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
