...
public class Hub extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable HubArgs.Builder a);
    }
    private static io.pulumi.googlenative.networkconnectivity_v1alpha1.HubArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.networkconnectivity_v1alpha1.HubArgs.builder();
