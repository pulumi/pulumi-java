 ...
 * 
 */
@ResourceType(type="google-native:cloudresourcemanager/v3:TagKeyIamPolicy")
public class TagKeyIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(TagKeyIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.cloudresourcemanager_v3.TagKeyIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudresourcemanager_v3.TagKeyIamPolicyArgs.builder();
     ...
     */
    public TagKeyIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public TagKeyIamPolicy(String name, TagKeyIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v3:TagKeyIamPolicy", name, args == null ? TagKeyIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private TagKeyIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v3:TagKeyIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static TagKeyIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new TagKeyIamPolicy(name, id, options);
    }
}
