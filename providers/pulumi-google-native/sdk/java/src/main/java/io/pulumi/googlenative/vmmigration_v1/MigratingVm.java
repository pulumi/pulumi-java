...
public class MigratingVm extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.vmmigration_v1.MigratingVmArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.vmmigration_v1.MigratingVmArgs.builder();
    ...
    public MigratingVm(String name, MigratingVmArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:vmmigration/v1:MigratingVm", name, args == null ? MigratingVmArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
