...
import io.pulumi.googlenative.retail_v2beta.inputs.GoogleCloudRetailV2betaColorInfoArgs;
import io.pulumi.googlenative.retail_v2beta.inputs.GoogleCloudRetailV2betaFulfillmentInfoArgs;
import io.pulumi.googlenative.retail_v2beta.inputs.GoogleCloudRetailV2betaImageArgs;
import io.pulumi.googlenative.retail_v2beta.inputs.GoogleCloudRetailV2betaPriceInfoArgs;
import io.pulumi.googlenative.retail_v2beta.inputs.GoogleCloudRetailV2betaPromotionArgs;
import io.pulumi.googlenative.retail_v2beta.inputs.GoogleCloudRetailV2betaRatingArgs;
...
public final class ProductArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setAudience(@Nullable Input<GoogleCloudRetailV2betaAudienceArgs> audience) {
            this.audience = audience;
            return this;
        }

        public Builder setAudience(@Nullable GoogleCloudRetailV2betaAudienceArgs audience) {
        ...
        public Builder setColorInfo(@Nullable Input<GoogleCloudRetailV2betaColorInfoArgs> colorInfo) {
            this.colorInfo = colorInfo;
            return this;
        }

        public Builder setColorInfo(@Nullable GoogleCloudRetailV2betaColorInfoArgs colorInfo) {
        ...
        public Builder setFulfillmentInfo(@Nullable Input<List<GoogleCloudRetailV2betaFulfillmentInfoArgs>> fulfillmentInfo) {
            this.fulfillmentInfo = fulfillmentInfo;
            return this;
        }

        public Builder setFulfillmentInfo(@Nullable List<GoogleCloudRetailV2betaFulfillmentInfoArgs> fulfillmentInfo) {
        ...
        public Builder setImages(@Nullable Input<List<GoogleCloudRetailV2betaImageArgs>> images) {
            this.images = images;
            return this;
        }

        public Builder setImages(@Nullable List<GoogleCloudRetailV2betaImageArgs> images) {
        ...
        public Builder setPriceInfo(@Nullable Input<GoogleCloudRetailV2betaPriceInfoArgs> priceInfo) {
            this.priceInfo = priceInfo;
            return this;
        }

        public Builder setPriceInfo(@Nullable GoogleCloudRetailV2betaPriceInfoArgs priceInfo) {
        ...
        public Builder setPromotions(@Nullable Input<List<GoogleCloudRetailV2betaPromotionArgs>> promotions) {
            this.promotions = promotions;
            return this;
        }

        public Builder setPromotions(@Nullable List<GoogleCloudRetailV2betaPromotionArgs> promotions) {
        ...
        public Builder setRating(@Nullable Input<GoogleCloudRetailV2betaRatingArgs> rating) {
            this.rating = rating;
            return this;
        }

        public Builder setRating(@Nullable GoogleCloudRetailV2betaRatingArgs rating) {
