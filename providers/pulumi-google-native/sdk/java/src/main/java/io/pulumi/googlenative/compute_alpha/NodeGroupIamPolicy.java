...
import io.pulumi.googlenative.compute_alpha.NodeGroupIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:NodeGroupIamPolicy")
public class NodeGroupIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(NodeGroupIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.NodeGroupIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.NodeGroupIamPolicyArgs.builder();
     ...
     */
    public NodeGroupIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public NodeGroupIamPolicy(String name, NodeGroupIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:NodeGroupIamPolicy", name, args == null ? NodeGroupIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private NodeGroupIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:NodeGroupIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static NodeGroupIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
