...
public class NodeGroupIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public NodeGroupIamPolicy(String name, NodeGroupIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:NodeGroupIamPolicy", name, args == null ? NodeGroupIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private NodeGroupIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static NodeGroupIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
