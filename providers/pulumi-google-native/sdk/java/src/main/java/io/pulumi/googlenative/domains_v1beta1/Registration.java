 ...
 * 
 */
@ResourceType(type="google-native:domains/v1beta1:Registration")
public class Registration extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.domains_v1beta1.RegistrationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.domains_v1beta1.RegistrationArgs.builder();
    ...
    public Registration(String name, RegistrationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:domains/v1beta1:Registration", name, args == null ? RegistrationArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private Registration(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:domains/v1beta1:Registration", name, null, makeResourceOptions(options, id));
    }
