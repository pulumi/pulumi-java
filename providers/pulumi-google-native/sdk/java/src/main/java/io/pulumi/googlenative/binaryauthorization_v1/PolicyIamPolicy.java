...
public class PolicyIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public PolicyIamPolicy(String name, @Nullable PolicyIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:binaryauthorization/v1:PolicyIamPolicy", name, args == null ? PolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
     ...
     */
    public static PolicyIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
