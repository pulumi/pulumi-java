...
public class MachineImage extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.MachineImageArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.MachineImageArgs.builder();
    ...
    public MachineImage(String name, MachineImageArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:MachineImage", name, args == null ? MachineImageArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
