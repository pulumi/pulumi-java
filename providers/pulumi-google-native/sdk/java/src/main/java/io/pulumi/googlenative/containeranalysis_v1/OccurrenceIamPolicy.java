...
import io.pulumi.googlenative.containeranalysis_v1.OccurrenceIamPolicyArgs;
...
public class OccurrenceIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    private static io.pulumi.googlenative.containeranalysis_v1.OccurrenceIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.containeranalysis_v1.OccurrenceIamPolicyArgs.builder();
     ...
     */
    public OccurrenceIamPolicy(String name, OccurrenceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:containeranalysis/v1:OccurrenceIamPolicy", name, args == null ? OccurrenceIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private OccurrenceIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static OccurrenceIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
