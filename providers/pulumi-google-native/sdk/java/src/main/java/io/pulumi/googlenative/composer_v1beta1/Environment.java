...
public class Environment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.composer_v1beta1.EnvironmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.composer_v1beta1.EnvironmentArgs.builder();
    ...
    public Environment(String name, @Nullable EnvironmentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:composer/v1beta1:Environment", name, args == null ? EnvironmentArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
