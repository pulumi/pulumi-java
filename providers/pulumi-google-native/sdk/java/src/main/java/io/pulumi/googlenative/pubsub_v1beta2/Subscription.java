...
public class Subscription extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.pubsub_v1beta2.SubscriptionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.pubsub_v1beta2.SubscriptionArgs.builder();
