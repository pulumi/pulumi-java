...
public class InstanceDatabaseIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public InstanceDatabaseIamPolicy(String name, InstanceDatabaseIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:spanner/v1:InstanceDatabaseIamPolicy", name, args == null ? InstanceDatabaseIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private InstanceDatabaseIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static InstanceDatabaseIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
