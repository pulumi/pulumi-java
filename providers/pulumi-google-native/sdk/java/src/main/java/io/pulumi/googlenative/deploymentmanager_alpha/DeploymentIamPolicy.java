...
import io.pulumi.googlenative.deploymentmanager_alpha.DeploymentIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:deploymentmanager/alpha:DeploymentIamPolicy")
public class DeploymentIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.deploymentmanager_alpha.DeploymentIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.deploymentmanager_alpha.DeploymentIamPolicyArgs.builder();
    ...
    public DeploymentIamPolicy(String name, DeploymentIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:deploymentmanager/alpha:DeploymentIamPolicy", name, args == null ? DeploymentIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private DeploymentIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:deploymentmanager/alpha:DeploymentIamPolicy", name, null, makeResourceOptions(options, id));
    }
