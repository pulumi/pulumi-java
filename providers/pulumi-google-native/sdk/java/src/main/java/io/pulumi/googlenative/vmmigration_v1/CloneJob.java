...
public class CloneJob extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.vmmigration_v1.CloneJobArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.vmmigration_v1.CloneJobArgs.builder();
    ...
    public CloneJob(String name, CloneJobArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:vmmigration/v1:CloneJob", name, args == null ? CloneJobArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
