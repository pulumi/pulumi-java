...
import io.pulumi.googlenative.compute_beta.InstanceTemplateIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:InstanceTemplateIamPolicy")
public class InstanceTemplateIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public InstanceTemplateIamPolicy(String name) {
        super("google-native:compute/beta:InstanceTemplateIamPolicy", name, InstanceTemplateIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public InstanceTemplateIamPolicy(String name, InstanceTemplateIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:InstanceTemplateIamPolicy", name, args == null ? InstanceTemplateIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private InstanceTemplateIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:InstanceTemplateIamPolicy", name, null, makeResourceOptions(options, id));
    }
