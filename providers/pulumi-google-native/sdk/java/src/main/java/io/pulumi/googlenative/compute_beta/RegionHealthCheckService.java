...
public class RegionHealthCheckService extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.RegionHealthCheckServiceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.RegionHealthCheckServiceArgs.builder();
