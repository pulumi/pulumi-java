...
public class Device extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.cloudidentity_v1.DeviceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudidentity_v1.DeviceArgs.builder();
