...
public class NodePool extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.container_v1.NodePoolArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.container_v1.NodePoolArgs.builder();
    ...
    public NodePool(String name, NodePoolArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:container/v1:NodePool", name, args == null ? NodePoolArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
