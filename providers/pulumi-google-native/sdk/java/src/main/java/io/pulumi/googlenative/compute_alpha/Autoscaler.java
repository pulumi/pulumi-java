...
public class Autoscaler extends io.pulumi.resources.CustomResource {
    ...
    public Autoscaler(String name) {
        super("google-native:compute/alpha:Autoscaler", name, AutoscalerArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public Autoscaler(String name, @Nullable AutoscalerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:Autoscaler", name, args == null ? AutoscalerArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
