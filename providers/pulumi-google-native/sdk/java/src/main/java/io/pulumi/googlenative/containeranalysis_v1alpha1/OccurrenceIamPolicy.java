...
public class OccurrenceIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public OccurrenceIamPolicy(String name) {
        super("google-native:containeranalysis/v1alpha1:OccurrenceIamPolicy", name, OccurrenceIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public OccurrenceIamPolicy(String name, OccurrenceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:containeranalysis/v1alpha1:OccurrenceIamPolicy", name, args == null ? OccurrenceIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
