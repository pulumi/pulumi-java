...
public class Namespace extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.servicedirectory_v1.NamespaceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.servicedirectory_v1.NamespaceArgs.builder();
