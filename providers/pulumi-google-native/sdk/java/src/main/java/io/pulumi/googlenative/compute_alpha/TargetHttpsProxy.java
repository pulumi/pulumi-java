...
import io.pulumi.googlenative.compute_alpha.TargetHttpsProxyArgs;
...
public class TargetHttpsProxy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.TargetHttpsProxyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.TargetHttpsProxyArgs.builder();
    ...
    public TargetHttpsProxy(String name, @Nullable TargetHttpsProxyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:TargetHttpsProxy", name, args == null ? TargetHttpsProxyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
