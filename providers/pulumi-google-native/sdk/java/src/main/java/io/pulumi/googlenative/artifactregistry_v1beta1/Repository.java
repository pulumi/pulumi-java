...
public class Repository extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.artifactregistry_v1beta1.RepositoryArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.artifactregistry_v1beta1.RepositoryArgs.builder();
    ...
    public Repository(String name, @Nullable RepositoryArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:artifactregistry/v1beta1:Repository", name, args == null ? RepositoryArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
