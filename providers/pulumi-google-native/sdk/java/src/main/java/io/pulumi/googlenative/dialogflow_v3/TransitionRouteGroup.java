...
public class TransitionRouteGroup extends io.pulumi.resources.CustomResource {
    ...
    public TransitionRouteGroup(String name) {
        super("google-native:dialogflow/v3:TransitionRouteGroup", name, TransitionRouteGroupArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public TransitionRouteGroup(String name, TransitionRouteGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v3:TransitionRouteGroup", name, args == null ? TransitionRouteGroupArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
