...
public final class RuntimeEnvironmentArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder ipConfiguration(@Nullable Input<RuntimeEnvironmentIpConfiguration> ipConfiguration) {
            this.ipConfiguration = ipConfiguration;
            return this;
        }

        public Builder ipConfiguration(@Nullable RuntimeEnvironmentIpConfiguration ipConfiguration) {
