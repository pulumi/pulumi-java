...
import io.pulumi.googlenative.dataflow_v1b3.enums.RuntimeEnvironmentIpConfiguration;
...
public final class RuntimeEnvironmentArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Input<RuntimeEnvironmentIpConfiguration> getIpConfiguration() {
    ...
    public RuntimeEnvironmentArgs(
        ...
        @Nullable Input<RuntimeEnvironmentIpConfiguration> ipConfiguration,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<RuntimeEnvironmentIpConfiguration> ipConfiguration;
        ...
        public Builder setIpConfiguration(@Nullable Input<RuntimeEnvironmentIpConfiguration> ipConfiguration) {
            this.ipConfiguration = ipConfiguration;
            return this;
        }

        public Builder setIpConfiguration(@Nullable RuntimeEnvironmentIpConfiguration ipConfiguration) {
        ...
        public RuntimeEnvironmentArgs build() {
            return new RuntimeEnvironmentArgs(additionalExperiments, additionalUserLabels, bypassTempDirValidation, enableStreamingEngine, ipConfiguration, kmsKeyName, machineType, maxWorkers, network, numWorkers, serviceAccountEmail, subnetwork, tempLocation, workerRegion, workerZone, zone);
        }
    }
}
