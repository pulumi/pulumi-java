...
public class NodeGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.NodeGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.NodeGroupArgs.builder();
    ...
    public NodeGroup(String name, NodeGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:NodeGroup", name, args == null ? NodeGroupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
