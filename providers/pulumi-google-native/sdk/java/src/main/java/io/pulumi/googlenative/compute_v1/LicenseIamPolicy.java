...
import io.pulumi.googlenative.compute_v1.LicenseIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:LicenseIamPolicy")
public class LicenseIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.LicenseIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.LicenseIamPolicyArgs.builder();
    ...
    public LicenseIamPolicy(String name, LicenseIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:LicenseIamPolicy", name, args == null ? LicenseIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private LicenseIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:LicenseIamPolicy", name, null, makeResourceOptions(options, id));
    }
