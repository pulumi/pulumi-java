...
public class Hl7V2Store extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.healthcare_v1.Hl7V2StoreArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.healthcare_v1.Hl7V2StoreArgs.builder();
    ...
    public Hl7V2Store(String name, Hl7V2StoreArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1:Hl7V2Store", name, args == null ? Hl7V2StoreArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
     ...
     */
    public static Hl7V2Store get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
