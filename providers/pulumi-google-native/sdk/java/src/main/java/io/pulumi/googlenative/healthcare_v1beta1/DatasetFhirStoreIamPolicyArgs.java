 ...
 * 
 */
public final class DatasetFhirStoreIamPolicyArgs extends io.pulumi.resources.ResourceArgs {

    public static final DatasetFhirStoreIamPolicyArgs Empty = new DatasetFhirStoreIamPolicyArgs();
