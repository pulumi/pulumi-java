...
public class Network extends io.pulumi.resources.CustomResource {
    ...
    public Network(String name) {
        super("google-native:compute/beta:Network", name, NetworkArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public Network(String name, @Nullable NetworkArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:Network", name, args == null ? NetworkArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
