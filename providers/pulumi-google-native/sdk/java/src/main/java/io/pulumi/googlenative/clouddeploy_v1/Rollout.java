...
public class Rollout extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.clouddeploy_v1.RolloutArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.clouddeploy_v1.RolloutArgs.builder();
