...
public class FhirStore extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.healthcare_v1.FhirStoreArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.healthcare_v1.FhirStoreArgs.builder();
    ...
    public FhirStore(String name, FhirStoreArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1:FhirStore", name, args == null ? FhirStoreArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
