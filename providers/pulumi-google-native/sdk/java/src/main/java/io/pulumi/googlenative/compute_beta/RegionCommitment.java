...
public class RegionCommitment extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RegionCommitmentArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_beta.RegionCommitmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.RegionCommitmentArgs.builder();
     ...
     */
    public RegionCommitment(String name, BuilderApplicator argsBuilder) {
    ...
    public RegionCommitment(String name, RegionCommitmentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionCommitment", name, args == null ? RegionCommitmentArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
