...
public class BackendBucketIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public BackendBucketIamPolicy(String name, BackendBucketIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:BackendBucketIamPolicy", name, args == null ? BackendBucketIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private BackendBucketIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static BackendBucketIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
