...
import io.pulumi.googlenative.compute_alpha.BackendBucketIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:BackendBucketIamPolicy")
public class BackendBucketIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(BackendBucketIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.BackendBucketIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.BackendBucketIamPolicyArgs.builder();
     ...
     */
    public BackendBucketIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public BackendBucketIamPolicy(String name, BackendBucketIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:BackendBucketIamPolicy", name, args == null ? BackendBucketIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private BackendBucketIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:BackendBucketIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static BackendBucketIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
