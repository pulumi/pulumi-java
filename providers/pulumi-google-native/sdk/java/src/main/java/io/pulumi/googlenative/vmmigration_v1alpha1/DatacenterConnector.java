...
public class DatacenterConnector extends io.pulumi.resources.CustomResource {
    ...
    public DatacenterConnector(String name) {
        super("google-native:vmmigration/v1alpha1:DatacenterConnector", name, DatacenterConnectorArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public DatacenterConnector(String name, DatacenterConnectorArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:vmmigration/v1alpha1:DatacenterConnector", name, args == null ? DatacenterConnectorArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
