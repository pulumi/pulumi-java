...
public class TargetProject extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(TargetProjectArgs.Builder a);
    }
    private static io.pulumi.googlenative.vmmigration_v1alpha1.TargetProjectArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.vmmigration_v1alpha1.TargetProjectArgs.builder();
     ...
     */
    public TargetProject(String name, BuilderApplicator argsBuilder) {
    ...
    public TargetProject(String name, TargetProjectArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:vmmigration/v1alpha1:TargetProject", name, args == null ? TargetProjectArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private TargetProject(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TargetProject get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
