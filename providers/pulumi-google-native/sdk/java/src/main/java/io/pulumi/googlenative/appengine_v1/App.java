...
public class App extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.appengine_v1.AppArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.appengine_v1.AppArgs.builder();
    ...
    public App(String name, @Nullable AppArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:appengine/v1:App", name, args == null ? AppArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
