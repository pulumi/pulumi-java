...
import io.pulumi.googlenative.dialogflow_v3beta1.IntentArgs;
...
public class Intent extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.dialogflow_v3beta1.IntentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dialogflow_v3beta1.IntentArgs.builder();
    ...
    public Intent(String name, IntentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v3beta1:Intent", name, args == null ? IntentArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
