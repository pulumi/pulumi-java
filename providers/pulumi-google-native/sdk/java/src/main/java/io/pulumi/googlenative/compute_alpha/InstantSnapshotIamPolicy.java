...
public class InstantSnapshotIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public InstantSnapshotIamPolicy(String name) {
        super("google-native:compute/alpha:InstantSnapshotIamPolicy", name, InstantSnapshotIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public InstantSnapshotIamPolicy(String name, InstantSnapshotIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:InstantSnapshotIamPolicy", name, args == null ? InstantSnapshotIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private InstantSnapshotIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static InstantSnapshotIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
