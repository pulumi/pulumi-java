...
import io.pulumi.googlenative.networksecurity_v1beta1.inputs.GoogleIamV1AuditLogConfigArgs;
...
public final class GoogleIamV1AuditConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<GoogleIamV1AuditLogConfigArgs>> auditLogConfigs;

    public Input<List<GoogleIamV1AuditLogConfigArgs>> getAuditLogConfigs() {
    ...
    public GoogleIamV1AuditConfigArgs(
        @Nullable Input<List<GoogleIamV1AuditLogConfigArgs>> auditLogConfigs,
    ...
    public static final class Builder {
        private @Nullable Input<List<GoogleIamV1AuditLogConfigArgs>> auditLogConfigs;
        ...
        public Builder setAuditLogConfigs(@Nullable Input<List<GoogleIamV1AuditLogConfigArgs>> auditLogConfigs) {
            this.auditLogConfigs = auditLogConfigs;
            return this;
        }

        public Builder setAuditLogConfigs(@Nullable List<GoogleIamV1AuditLogConfigArgs> auditLogConfigs) {
