...
public class BucketIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.storage_v1.BucketIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.storage_v1.BucketIamPolicyArgs.builder();
    ...
    public BucketIamPolicy(String name, BucketIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:storage/v1:BucketIamPolicy", name, args == null ? BucketIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private BucketIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static BucketIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
