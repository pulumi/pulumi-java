...
public class OrganizationSourceIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public OrganizationSourceIamPolicy(String name, OrganizationSourceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:securitycenter/v1beta1:OrganizationSourceIamPolicy", name, args == null ? OrganizationSourceIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
     ...
     */
    public static OrganizationSourceIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
