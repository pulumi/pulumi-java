...
import io.pulumi.googlenative.securitycenter_v1beta1.OrganizationSourceIamPolicyArgs;
...
public class OrganizationSourceIamPolicy extends io.pulumi.resources.CustomResource {
    /**
     ...
     */
    public OrganizationSourceIamPolicy(String name) {
        super("google-native:securitycenter/v1beta1:OrganizationSourceIamPolicy", name, OrganizationSourceIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public OrganizationSourceIamPolicy(String name, OrganizationSourceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:securitycenter/v1beta1:OrganizationSourceIamPolicy", name, args == null ? OrganizationSourceIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private OrganizationSourceIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static OrganizationSourceIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
