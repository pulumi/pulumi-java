...
public class Stream extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.datastream_v1.StreamArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.datastream_v1.StreamArgs.builder();
    ...
    public Stream(String name, StreamArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datastream/v1:Stream", name, args == null ? StreamArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
