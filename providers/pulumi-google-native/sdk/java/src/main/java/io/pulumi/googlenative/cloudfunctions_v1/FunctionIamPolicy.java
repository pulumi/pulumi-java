...
import io.pulumi.googlenative.cloudfunctions_v1.FunctionIamPolicyArgs;
import io.pulumi.googlenative.cloudfunctions_v1.outputs.AuditConfigResponse;
import io.pulumi.googlenative.cloudfunctions_v1.outputs.BindingResponse;
...
public class FunctionIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(FunctionIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.cloudfunctions_v1.FunctionIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudfunctions_v1.FunctionIamPolicyArgs.builder();
     ...
     */
    public FunctionIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public FunctionIamPolicy(String name, FunctionIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudfunctions/v1:FunctionIamPolicy", name, args == null ? FunctionIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private FunctionIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static FunctionIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
