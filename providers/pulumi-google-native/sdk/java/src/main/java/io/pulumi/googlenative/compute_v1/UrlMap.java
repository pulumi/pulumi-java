...
public class UrlMap extends io.pulumi.resources.CustomResource {
    ...
    public UrlMap(String name, @Nullable UrlMapArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:UrlMap", name, args == null ? UrlMapArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private UrlMap(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static UrlMap get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
