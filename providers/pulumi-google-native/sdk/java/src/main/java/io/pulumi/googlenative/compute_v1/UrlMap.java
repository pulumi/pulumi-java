...
import io.pulumi.googlenative.compute_v1.UrlMapArgs;
...
public class UrlMap extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.UrlMapArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.UrlMapArgs.builder();
    ...
    public UrlMap(String name, @Nullable UrlMapArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:UrlMap", name, args == null ? UrlMapArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private UrlMap(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static UrlMap get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
