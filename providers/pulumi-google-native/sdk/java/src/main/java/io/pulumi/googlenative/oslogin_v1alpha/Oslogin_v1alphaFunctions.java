...
public final class Oslogin_v1alphaFunctions {
     ...
     * 
     */
    public static CompletableFuture<GetSshPublicKeyResult> getSshPublicKey(io.pulumi.googlenative.oslogin_v1alpha.inputs.GetSshPublicKeyArgs args) {
        return getSshPublicKey(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetSshPublicKeyResult> getSshPublicKey(io.pulumi.googlenative.oslogin_v1alpha.inputs.GetSshPublicKeyArgs args, InvokeOptions options) {
