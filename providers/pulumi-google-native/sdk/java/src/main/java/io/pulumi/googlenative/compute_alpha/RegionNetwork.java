...
public class RegionNetwork extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(RegionNetworkArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.RegionNetworkArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.RegionNetworkArgs.builder();
     ...
     */
    public RegionNetwork(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public RegionNetwork(String name, RegionNetworkArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionNetwork", name, args == null ? RegionNetworkArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private RegionNetwork(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static RegionNetwork get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
