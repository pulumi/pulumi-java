...
public class RegionNetwork extends io.pulumi.resources.CustomResource {
    ...
    public RegionNetwork(String name, RegionNetworkArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionNetwork", name, args == null ? RegionNetworkArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private RegionNetwork(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static RegionNetwork get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
