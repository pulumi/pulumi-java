...
public class PatchDeployment extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PatchDeploymentArgs.Builder a);
    }
    private static io.pulumi.googlenative.osconfig_v1beta.PatchDeploymentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.osconfig_v1beta.PatchDeploymentArgs.builder();
     ...
     */
    public PatchDeployment(String name, BuilderApplicator argsBuilder) {
