...
import io.pulumi.googlenative.run_v1.JobIamPolicyArgs;
...
public class JobIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.run_v1.JobIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.run_v1.JobIamPolicyArgs.builder();
    ...
    public JobIamPolicy(String name, JobIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:run/v1:JobIamPolicy", name, args == null ? JobIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
