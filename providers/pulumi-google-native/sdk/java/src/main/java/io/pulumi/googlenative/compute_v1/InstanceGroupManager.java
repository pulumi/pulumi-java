...
import io.pulumi.googlenative.compute_v1.InstanceGroupManagerArgs;
...
public class InstanceGroupManager extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.InstanceGroupManagerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.InstanceGroupManagerArgs.builder();
    ...
    public InstanceGroupManager(String name, @Nullable InstanceGroupManagerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:InstanceGroupManager", name, args == null ? InstanceGroupManagerArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
