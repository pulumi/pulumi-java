...
public final class HTTP2HealthCheckArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<HTTP2HealthCheckWeightReportMode> weightReportMode;

    public Input<HTTP2HealthCheckWeightReportMode> getWeightReportMode() {
    ...
    public HTTP2HealthCheckArgs(
        ...
        @Nullable Input<HTTP2HealthCheckWeightReportMode> weightReportMode) {
        this.host = host;
        this.port = port;
    ...
    public static final class Builder {
        ...
        private @Nullable Input<HTTP2HealthCheckWeightReportMode> weightReportMode;
