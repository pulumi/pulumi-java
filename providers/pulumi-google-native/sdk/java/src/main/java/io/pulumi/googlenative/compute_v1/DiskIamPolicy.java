...
import io.pulumi.googlenative.compute_v1.DiskIamPolicyArgs;
...
public class DiskIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.DiskIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.DiskIamPolicyArgs.builder();
    ...
    public DiskIamPolicy(String name, DiskIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:DiskIamPolicy", name, args == null ? DiskIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
