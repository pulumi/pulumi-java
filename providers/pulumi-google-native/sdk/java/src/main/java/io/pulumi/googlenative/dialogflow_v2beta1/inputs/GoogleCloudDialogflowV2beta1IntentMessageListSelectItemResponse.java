 ...
 * 
 */
public final class GoogleCloudDialogflowV2beta1IntentMessageListSelectItemResponse extends io.pulumi.resources.InvokeArgs {
    ...
    public GoogleCloudDialogflowV2beta1IntentMessageListSelectItemResponse(
        String description,
