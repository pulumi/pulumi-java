...
public class Feed extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(FeedArgs.Builder a);
    }
    private static io.pulumi.googlenative.cloudasset_v1.FeedArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudasset_v1.FeedArgs.builder();
     ...
     */
    public Feed(String name, BuilderApplicator argsBuilder) {
    ...
    public Feed(String name, FeedArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudasset/v1:Feed", name, args == null ? FeedArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private Feed(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Feed get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
