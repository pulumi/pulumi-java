...
import io.pulumi.googlenative.compute_beta.BackendBucketIamPolicyArgs;
...
public class BackendBucketIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.BackendBucketIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.BackendBucketIamPolicyArgs.builder();
    ...
    public BackendBucketIamPolicy(String name, BackendBucketIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:BackendBucketIamPolicy", name, args == null ? BackendBucketIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
