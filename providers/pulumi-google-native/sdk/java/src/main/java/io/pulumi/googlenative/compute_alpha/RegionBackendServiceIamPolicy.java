...
import io.pulumi.googlenative.compute_alpha.RegionBackendServiceIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:RegionBackendServiceIamPolicy")
public class RegionBackendServiceIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RegionBackendServiceIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.RegionBackendServiceIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.RegionBackendServiceIamPolicyArgs.builder();
     ...
     */
    public RegionBackendServiceIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public RegionBackendServiceIamPolicy(String name, RegionBackendServiceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionBackendServiceIamPolicy", name, args == null ? RegionBackendServiceIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private RegionBackendServiceIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionBackendServiceIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static RegionBackendServiceIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
