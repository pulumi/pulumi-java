 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:Snapshot")
public class Snapshot extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="sourceInstantSnapshot", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="sourceInstantSnapshotId", type=String.class, parameters={})
     ...
     * 
     */
    public Output<String> getSourceInstantSnapshotId() {
    ...
    private static io.pulumi.googlenative.compute_alpha.SnapshotArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.SnapshotArgs.builder();
    ...
    public Snapshot(String name, @Nullable SnapshotArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:Snapshot", name, args == null ? SnapshotArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private Snapshot(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:Snapshot", name, null, makeResourceOptions(options, id));
    }
