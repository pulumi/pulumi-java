...
public class Webhook extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.dialogflow_v3.WebhookArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dialogflow_v3.WebhookArgs.builder();
    ...
    public Webhook(String name, WebhookArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v3:Webhook", name, args == null ? WebhookArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
