...
public class ProjectIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable ProjectIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.cloudresourcemanager_v3.ProjectIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudresourcemanager_v3.ProjectIamPolicyArgs.builder();
     ...
     */
    public ProjectIamPolicy(String name, @Nullable ProjectIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v3:ProjectIamPolicy", name, args == null ? ProjectIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
