...
public class DatasetAnnotationStoreIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public DatasetAnnotationStoreIamPolicy(String name) {
        super("google-native:healthcare/v1beta1:DatasetAnnotationStoreIamPolicy", name, DatasetAnnotationStoreIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
