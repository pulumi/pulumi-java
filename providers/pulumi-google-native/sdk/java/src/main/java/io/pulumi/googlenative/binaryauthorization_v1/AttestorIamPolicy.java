...
public class AttestorIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.binaryauthorization_v1.AttestorIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.binaryauthorization_v1.AttestorIamPolicyArgs.builder();
    ...
    public AttestorIamPolicy(String name, AttestorIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:binaryauthorization/v1:AttestorIamPolicy", name, args == null ? AttestorIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
