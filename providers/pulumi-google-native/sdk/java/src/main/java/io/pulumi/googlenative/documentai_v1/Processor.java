...
public class Processor extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.documentai_v1.ProcessorArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.documentai_v1.ProcessorArgs.builder();
    ...
    public Processor(String name, @Nullable ProcessorArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:documentai/v1:Processor", name, args == null ? ProcessorArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
