...
public class Backup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.managedidentities_v1beta1.BackupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.managedidentities_v1beta1.BackupArgs.builder();
    ...
    public Backup(String name, BackupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:managedidentities/v1beta1:Backup", name, args == null ? BackupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
