...
public final class Storagetransfer_v1Functions {
     ...
     * 
     */
    public static CompletableFuture<GetAgentPoolResult> getAgentPool(io.pulumi.googlenative.storagetransfer_v1.inputs.GetAgentPoolArgs args) {
        return getAgentPool(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetAgentPoolResult> getAgentPool(io.pulumi.googlenative.storagetransfer_v1.inputs.GetAgentPoolArgs args, InvokeOptions options) {
     ...
     * 
     */
    public static CompletableFuture<GetTransferJobResult> getTransferJob(io.pulumi.googlenative.storagetransfer_v1.inputs.GetTransferJobArgs args) {
        return getTransferJob(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetTransferJobResult> getTransferJob(io.pulumi.googlenative.storagetransfer_v1.inputs.GetTransferJobArgs args, InvokeOptions options) {
