...
public class ConnectionProfile extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.datastream_v1.ConnectionProfileArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.datastream_v1.ConnectionProfileArgs.builder();
    ...
    public ConnectionProfile(String name, ConnectionProfileArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datastream/v1:ConnectionProfile", name, args == null ? ConnectionProfileArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
