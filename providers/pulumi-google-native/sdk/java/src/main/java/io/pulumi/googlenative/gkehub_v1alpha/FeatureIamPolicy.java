...
public class FeatureIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.gkehub_v1alpha.FeatureIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.gkehub_v1alpha.FeatureIamPolicyArgs.builder();
    ...
    public FeatureIamPolicy(String name, FeatureIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkehub/v1alpha:FeatureIamPolicy", name, args == null ? FeatureIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
