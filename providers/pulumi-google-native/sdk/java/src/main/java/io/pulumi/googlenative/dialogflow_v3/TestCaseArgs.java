...
public final class TestCaseArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Input<GoogleCloudDialogflowCxV3TestCaseResultArgs> getLastTestResult() {
    ...
    public Input<List<GoogleCloudDialogflowCxV3ConversationTurnArgs>> getTestCaseConversationTurns() {
    ...
    public Input<GoogleCloudDialogflowCxV3TestConfigArgs> getTestConfig() {
    ...
    public TestCaseArgs(
        ...
        @Nullable Input<GoogleCloudDialogflowCxV3TestCaseResultArgs> lastTestResult,
        @Nullable Input<String> location,
        @Nullable Input<String> name,
        @Nullable Input<String> notes,
        @Nullable Input<String> project,
        @Nullable Input<List<String>> tags,
        @Nullable Input<List<GoogleCloudDialogflowCxV3ConversationTurnArgs>> testCaseConversationTurns,
        @Nullable Input<GoogleCloudDialogflowCxV3TestConfigArgs> testConfig) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<GoogleCloudDialogflowCxV3TestCaseResultArgs> lastTestResult;
        private @Nullable Input<String> location;
        private @Nullable Input<String> name;
        private @Nullable Input<String> notes;
        private @Nullable Input<String> project;
        private @Nullable Input<List<String>> tags;
        private @Nullable Input<List<GoogleCloudDialogflowCxV3ConversationTurnArgs>> testCaseConversationTurns;
        private @Nullable Input<GoogleCloudDialogflowCxV3TestConfigArgs> testConfig;
