...
public final class RouterArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setMd5AuthenticationKeys(@Nullable Input<List<RouterMd5AuthenticationKeyArgs>> md5AuthenticationKeys) {
            this.md5AuthenticationKeys = md5AuthenticationKeys;
            return this;
        }

        public Builder setMd5AuthenticationKeys(@Nullable List<RouterMd5AuthenticationKeyArgs> md5AuthenticationKeys) {
