...
public class ConversationProfile extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ConversationProfileArgs.Builder a);
    }
    private static io.pulumi.googlenative.dialogflow_v2beta1.ConversationProfileArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dialogflow_v2beta1.ConversationProfileArgs.builder();
     ...
     */
    public ConversationProfile(String name, BuilderApplicator argsBuilder) {
