...
public final class GoogleCloudDatacatalogV1beta1ColumnSchemaArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public GoogleCloudDatacatalogV1beta1ColumnSchemaArgs(
        ...
        @Nullable Input<List<GoogleCloudDatacatalogV1beta1ColumnSchemaArgs>> subcolumns,
        Input<String> type) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<GoogleCloudDatacatalogV1beta1ColumnSchemaArgs>> subcolumns;
        ...
        public Builder setSubcolumns(@Nullable Input<List<GoogleCloudDatacatalogV1beta1ColumnSchemaArgs>> subcolumns) {
            this.subcolumns = subcolumns;
            return this;
        }

        public Builder setSubcolumns(@Nullable List<GoogleCloudDatacatalogV1beta1ColumnSchemaArgs> subcolumns) {
