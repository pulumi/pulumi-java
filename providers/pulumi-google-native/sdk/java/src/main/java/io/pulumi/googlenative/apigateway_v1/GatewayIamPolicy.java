...
import io.pulumi.googlenative.apigateway_v1.GatewayIamPolicyArgs;
...
public class GatewayIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.apigateway_v1.GatewayIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.apigateway_v1.GatewayIamPolicyArgs.builder();
    ...
    public GatewayIamPolicy(String name, GatewayIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:apigateway/v1:GatewayIamPolicy", name, args == null ? GatewayIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
