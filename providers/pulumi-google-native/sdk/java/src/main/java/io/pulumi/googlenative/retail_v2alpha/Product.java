...
public class Product extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="audience", type=GoogleCloudRetailV2alphaAudienceResponse.class, parameters={})
     ...
     * 
     */
    @Export(name="colorInfo", type=GoogleCloudRetailV2alphaColorInfoResponse.class, parameters={})
     ...
     * 
     */
    @Export(name="fulfillmentInfo", type=List.class, parameters={GoogleCloudRetailV2alphaFulfillmentInfoResponse.class})
     ...
     * 
     */
    @Export(name="images", type=List.class, parameters={GoogleCloudRetailV2alphaImageResponse.class})
     ...
     * 
     */
    @Export(name="priceInfo", type=GoogleCloudRetailV2alphaPriceInfoResponse.class, parameters={})
     ...
     * 
     */
    @Export(name="promotions", type=List.class, parameters={GoogleCloudRetailV2alphaPromotionResponse.class})
     ...
     * 
     */
    @Export(name="rating", type=GoogleCloudRetailV2alphaRatingResponse.class, parameters={})
     ...
     * 
     */
    @Export(name="variants", type=List.class, parameters={GoogleCloudRetailV2alphaProductResponse.class})
