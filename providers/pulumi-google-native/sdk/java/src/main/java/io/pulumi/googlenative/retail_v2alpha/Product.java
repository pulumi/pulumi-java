...
public class Product extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.retail_v2alpha.ProductArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.retail_v2alpha.ProductArgs.builder();
    ...
    public Product(String name, ProductArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:retail/v2alpha:Product", name, args == null ? ProductArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
