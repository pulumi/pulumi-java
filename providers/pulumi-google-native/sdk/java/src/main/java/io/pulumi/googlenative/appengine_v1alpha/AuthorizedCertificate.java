...
public class AuthorizedCertificate extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.appengine_v1alpha.AuthorizedCertificateArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.appengine_v1alpha.AuthorizedCertificateArgs.builder();
    ...
    public AuthorizedCertificate(String name, AuthorizedCertificateArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:appengine/v1alpha:AuthorizedCertificate", name, args == null ? AuthorizedCertificateArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
