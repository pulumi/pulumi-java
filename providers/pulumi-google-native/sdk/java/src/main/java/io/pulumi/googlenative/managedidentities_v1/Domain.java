...
public class Domain extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.managedidentities_v1.DomainArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.managedidentities_v1.DomainArgs.builder();
    ...
    public Domain(String name, DomainArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:managedidentities/v1:Domain", name, args == null ? DomainArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
