...
public class SecuritySetting extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(SecuritySettingArgs.Builder a);
    }
    private static io.pulumi.googlenative.dialogflow_v3beta1.SecuritySettingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dialogflow_v3beta1.SecuritySettingArgs.builder();
     ...
     */
    public SecuritySetting(String name, BuilderApplicator argsBuilder) {
    ...
    public SecuritySetting(String name, SecuritySettingArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v3beta1:SecuritySetting", name, args == null ? SecuritySettingArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
     ...
     */
    public static SecuritySetting get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
