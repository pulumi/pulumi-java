...
public class Interconnect extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.InterconnectArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.InterconnectArgs.builder();
