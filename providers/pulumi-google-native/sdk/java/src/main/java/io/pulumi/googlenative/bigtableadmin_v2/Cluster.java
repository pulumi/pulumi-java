...
public class Cluster extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.bigtableadmin_v2.ClusterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.bigtableadmin_v2.ClusterArgs.builder();
