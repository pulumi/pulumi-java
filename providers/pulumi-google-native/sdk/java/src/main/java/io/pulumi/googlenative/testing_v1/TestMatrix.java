...
public class TestMatrix extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(TestMatrixArgs.Builder a);
    }
    private static io.pulumi.googlenative.testing_v1.TestMatrixArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.testing_v1.TestMatrixArgs.builder();
     ...
     */
    public TestMatrix(String name, BuilderApplicator argsBuilder) {
    ...
    public TestMatrix(String name, TestMatrixArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:testing/v1:TestMatrix", name, args == null ? TestMatrixArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private TestMatrix(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TestMatrix get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
