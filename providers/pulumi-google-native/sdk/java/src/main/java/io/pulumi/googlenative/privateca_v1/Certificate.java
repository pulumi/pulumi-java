...
public class Certificate extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.privateca_v1.CertificateArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.privateca_v1.CertificateArgs.builder();
    ...
    public Certificate(String name, CertificateArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:privateca/v1:Certificate", name, args == null ? CertificateArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
