...
public class ConnectivityTestIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.networkmanagement_v1beta1.ConnectivityTestIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.networkmanagement_v1beta1.ConnectivityTestIamPolicyArgs.builder();
    ...
    public ConnectivityTestIamPolicy(String name, ConnectivityTestIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkmanagement/v1beta1:ConnectivityTestIamPolicy", name, args == null ? ConnectivityTestIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
