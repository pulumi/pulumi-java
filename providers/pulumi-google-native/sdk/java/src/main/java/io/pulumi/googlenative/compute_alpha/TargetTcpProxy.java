...
import io.pulumi.googlenative.compute_alpha.TargetTcpProxyArgs;
...
public class TargetTcpProxy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.TargetTcpProxyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.TargetTcpProxyArgs.builder();
    ...
    public TargetTcpProxy(String name, @Nullable TargetTcpProxyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:TargetTcpProxy", name, args == null ? TargetTcpProxyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
