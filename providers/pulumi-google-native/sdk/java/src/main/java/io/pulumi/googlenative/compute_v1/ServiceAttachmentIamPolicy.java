...
public class ServiceAttachmentIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public ServiceAttachmentIamPolicy(String name) {
        super("google-native:compute/v1:ServiceAttachmentIamPolicy", name, ServiceAttachmentIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public ServiceAttachmentIamPolicy(String name, ServiceAttachmentIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:ServiceAttachmentIamPolicy", name, args == null ? ServiceAttachmentIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
