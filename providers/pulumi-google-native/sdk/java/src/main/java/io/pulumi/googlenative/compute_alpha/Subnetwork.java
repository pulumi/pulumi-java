...
public class Subnetwork extends io.pulumi.resources.CustomResource {
    ...
    public Subnetwork(String name) {
        super("google-native:compute/alpha:Subnetwork", name, SubnetworkArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public Subnetwork(String name, SubnetworkArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:Subnetwork", name, args == null ? SubnetworkArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
