...
import io.pulumi.googlenative.compute_beta.NetworkEndpointGroupArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:NetworkEndpointGroup")
public class NetworkEndpointGroup extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable NetworkEndpointGroupArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_beta.NetworkEndpointGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.NetworkEndpointGroupArgs.builder();
    ...
    public NetworkEndpointGroup(String name, @Nullable NetworkEndpointGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:NetworkEndpointGroup", name, args == null ? NetworkEndpointGroupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private NetworkEndpointGroup(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:NetworkEndpointGroup", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static NetworkEndpointGroup get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
