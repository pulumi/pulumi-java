...
public class Query extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.apigee_v1.QueryArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.apigee_v1.QueryArgs.builder();
    ...
    public Query(String name, QueryArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:apigee/v1:Query", name, args == null ? QueryArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
