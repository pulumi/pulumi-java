...
import io.pulumi.googlenative.cloudresourcemanager_v3.FolderIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:cloudresourcemanager/v3:FolderIamPolicy")
public class FolderIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.cloudresourcemanager_v3.FolderIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudresourcemanager_v3.FolderIamPolicyArgs.builder();
    ...
    public FolderIamPolicy(String name, FolderIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v3:FolderIamPolicy", name, args == null ? FolderIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private FolderIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v3:FolderIamPolicy", name, null, makeResourceOptions(options, id));
    }
