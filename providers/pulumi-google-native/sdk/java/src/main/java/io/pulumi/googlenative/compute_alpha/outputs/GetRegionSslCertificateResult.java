...
public final class GetRegionSslCertificateResult {
    ...
    @OutputCustomType.Constructor({"certificate","creationTimestamp","description","expireTime","kind","managed","name","privateKey","region","selfLink","selfLinkWithId","selfManaged","subjectAlternativeNames","type"})
