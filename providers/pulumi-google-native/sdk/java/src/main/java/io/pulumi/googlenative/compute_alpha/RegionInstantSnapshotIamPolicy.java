...
public class RegionInstantSnapshotIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public RegionInstantSnapshotIamPolicy(String name, RegionInstantSnapshotIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionInstantSnapshotIamPolicy", name, args == null ? RegionInstantSnapshotIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private RegionInstantSnapshotIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static RegionInstantSnapshotIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
