...
public class InstantSnapshot extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable InstantSnapshotArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.InstantSnapshotArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.InstantSnapshotArgs.builder();
     ...
     */
    public InstantSnapshot(String name, BuilderApplicator argsBuilder) {
    ...
    public InstantSnapshot(String name, @Nullable InstantSnapshotArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:InstantSnapshot", name, args == null ? InstantSnapshotArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private InstantSnapshot(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static InstantSnapshot get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
