...
import io.pulumi.googlenative.artifactregistry_v1beta2.TagArgs;
...
public class Tag extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.artifactregistry_v1beta2.TagArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.artifactregistry_v1beta2.TagArgs.builder();
    ...
    public Tag(String name, TagArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:artifactregistry/v1beta2:Tag", name, args == null ? TagArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
