...
public class InterconnectAttachmentIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public InterconnectAttachmentIamPolicy(String name, InterconnectAttachmentIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:InterconnectAttachmentIamPolicy", name, args == null ? InterconnectAttachmentIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
