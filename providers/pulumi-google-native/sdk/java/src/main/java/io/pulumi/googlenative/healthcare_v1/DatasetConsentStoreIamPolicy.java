...
import io.pulumi.googlenative.healthcare_v1.DatasetConsentStoreIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:healthcare/v1:DatasetConsentStoreIamPolicy")
public class DatasetConsentStoreIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    private static io.pulumi.googlenative.healthcare_v1.DatasetConsentStoreIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.healthcare_v1.DatasetConsentStoreIamPolicyArgs.builder();
    ...
    public DatasetConsentStoreIamPolicy(String name) {
        this(name, DatasetConsentStoreIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DatasetConsentStoreIamPolicy(String name, DatasetConsentStoreIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DatasetConsentStoreIamPolicy(String name, DatasetConsentStoreIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1:DatasetConsentStoreIamPolicy", name, args == null ? DatasetConsentStoreIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private DatasetConsentStoreIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1:DatasetConsentStoreIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static DatasetConsentStoreIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new DatasetConsentStoreIamPolicy(name, id, options);
    }
}
