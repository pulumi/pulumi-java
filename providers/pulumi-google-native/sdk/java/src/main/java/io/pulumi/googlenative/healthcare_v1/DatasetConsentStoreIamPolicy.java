...
public class DatasetConsentStoreIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public DatasetConsentStoreIamPolicy(String name, DatasetConsentStoreIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1:DatasetConsentStoreIamPolicy", name, args == null ? DatasetConsentStoreIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private DatasetConsentStoreIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static DatasetConsentStoreIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
