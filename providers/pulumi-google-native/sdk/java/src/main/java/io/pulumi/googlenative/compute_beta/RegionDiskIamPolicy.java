...
import io.pulumi.googlenative.compute_beta.RegionDiskIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:RegionDiskIamPolicy")
public class RegionDiskIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.RegionDiskIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.RegionDiskIamPolicyArgs.builder();
    ...
    public RegionDiskIamPolicy(String name, RegionDiskIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionDiskIamPolicy", name, args == null ? RegionDiskIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private RegionDiskIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionDiskIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static RegionDiskIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new RegionDiskIamPolicy(name, id, options);
    }
}
