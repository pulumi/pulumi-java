...
public class GameServerCluster extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.gameservices_v1.GameServerClusterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.gameservices_v1.GameServerClusterArgs.builder();
    ...
    public GameServerCluster(String name, GameServerClusterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gameservices/v1:GameServerCluster", name, args == null ? GameServerClusterArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
