...
public final class EnvironmentArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setTestCasesConfig(@Nullable Input<GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfigArgs> testCasesConfig) {
            this.testCasesConfig = testCasesConfig;
            return this;
        }

        public Builder setTestCasesConfig(@Nullable GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfigArgs testCasesConfig) {
            this.testCasesConfig = Input.ofNullable(testCasesConfig);
            return this;
        }

        public Builder setVersionConfigs(Input<List<GoogleCloudDialogflowCxV3beta1EnvironmentVersionConfigArgs>> versionConfigs) {
            this.versionConfigs = Objects.requireNonNull(versionConfigs);
            return this;
        }

        public Builder setVersionConfigs(List<GoogleCloudDialogflowCxV3beta1EnvironmentVersionConfigArgs> versionConfigs) {
