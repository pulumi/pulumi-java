...
public class AttributeDefinition extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.healthcare_v1beta1.AttributeDefinitionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.healthcare_v1beta1.AttributeDefinitionArgs.builder();
    ...
    public AttributeDefinition(String name, AttributeDefinitionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1beta1:AttributeDefinition", name, args == null ? AttributeDefinitionArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
