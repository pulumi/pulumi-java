...
import io.pulumi.googlenative.deploymentmanager_v2beta.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:deploymentmanager/v2beta:DeploymentIamPolicy")
public class DeploymentIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public DeploymentIamPolicy(String name) {
        super("google-native:deploymentmanager/v2beta:DeploymentIamPolicy", name, DeploymentIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DeploymentIamPolicy(String name, DeploymentIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:deploymentmanager/v2beta:DeploymentIamPolicy", name, args == null ? DeploymentIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private DeploymentIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:deploymentmanager/v2beta:DeploymentIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static DeploymentIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new DeploymentIamPolicy(name, id, options);
    }
}
