...
import io.pulumi.googlenative.gkehub_v1alpha2.outputs.MembershipEndpointResponse;
import io.pulumi.googlenative.gkehub_v1alpha2.outputs.MembershipStateResponse;
 ...
 * 
 */
@ResourceType(type="google-native:gkehub/v1alpha2:Membership")
public class Membership extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.gkehub_v1alpha2.MembershipArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.gkehub_v1alpha2.MembershipArgs.builder();
    ...
    public Membership(String name, MembershipArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkehub/v1alpha2:Membership", name, args == null ? MembershipArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private Membership(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkehub/v1alpha2:Membership", name, null, makeResourceOptions(options, id));
    }
