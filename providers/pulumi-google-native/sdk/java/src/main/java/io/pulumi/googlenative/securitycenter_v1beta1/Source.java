...
public class Source extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.securitycenter_v1beta1.SourceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.securitycenter_v1beta1.SourceArgs.builder();
    ...
    public Source(String name, SourceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:securitycenter/v1beta1:Source", name, args == null ? SourceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
