...
import io.pulumi.googlenative.privateca_v1.CaPoolIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:privateca/v1:CaPoolIamPolicy")
public class CaPoolIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(CaPoolIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.privateca_v1.CaPoolIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.privateca_v1.CaPoolIamPolicyArgs.builder();
     ...
     */
    public CaPoolIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public CaPoolIamPolicy(String name, CaPoolIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:privateca/v1:CaPoolIamPolicy", name, args == null ? CaPoolIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private CaPoolIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:privateca/v1:CaPoolIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static CaPoolIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new CaPoolIamPolicy(name, id, options);
    }
}
