...
public class CaPoolIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public CaPoolIamPolicy(String name, CaPoolIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:privateca/v1:CaPoolIamPolicy", name, args == null ? CaPoolIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private CaPoolIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static CaPoolIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
