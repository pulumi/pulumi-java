...
@OutputCustomType
public final class GetProviderIamPolicyResult {
    /**
    ...
    private GetProviderIamPolicyResult(
    ...
    public static Builder builder(GetProviderIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetProviderIamPolicyResult defaults) {
        ...
        public GetProviderIamPolicyResult build() {
            return new GetProviderIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
