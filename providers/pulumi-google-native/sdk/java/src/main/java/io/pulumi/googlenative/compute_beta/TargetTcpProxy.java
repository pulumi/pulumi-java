...
public class TargetTcpProxy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable TargetTcpProxyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_beta.TargetTcpProxyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.TargetTcpProxyArgs.builder();
    ...
    public TargetTcpProxy(String name, @Nullable TargetTcpProxyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:TargetTcpProxy", name, args == null ? TargetTcpProxyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
