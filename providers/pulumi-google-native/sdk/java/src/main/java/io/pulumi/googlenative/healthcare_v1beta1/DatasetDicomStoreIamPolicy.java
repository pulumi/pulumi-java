...
import io.pulumi.googlenative.healthcare_v1beta1.DatasetDicomStoreIamPolicyArgs;
...
public class DatasetDicomStoreIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.healthcare_v1beta1.DatasetDicomStoreIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.healthcare_v1beta1.DatasetDicomStoreIamPolicyArgs.builder();
    ...
    public DatasetDicomStoreIamPolicy(String name, DatasetDicomStoreIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1beta1:DatasetDicomStoreIamPolicy", name, args == null ? DatasetDicomStoreIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
