 ...
 * 
 */
@ResourceType(type="google-native:privateca/v1:CertificateTemplateIamPolicy")
public class CertificateTemplateIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(CertificateTemplateIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.privateca_v1.CertificateTemplateIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.privateca_v1.CertificateTemplateIamPolicyArgs.builder();
     ...
     */
    public CertificateTemplateIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public CertificateTemplateIamPolicy(String name, CertificateTemplateIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:privateca/v1:CertificateTemplateIamPolicy", name, args == null ? CertificateTemplateIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private CertificateTemplateIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:privateca/v1:CertificateTemplateIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static CertificateTemplateIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new CertificateTemplateIamPolicy(name, id, options);
    }
}
