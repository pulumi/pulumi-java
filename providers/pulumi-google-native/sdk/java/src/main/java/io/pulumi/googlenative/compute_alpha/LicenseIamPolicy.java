...
public class LicenseIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.LicenseIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.LicenseIamPolicyArgs.builder();
    ...
    public LicenseIamPolicy(String name, LicenseIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:LicenseIamPolicy", name, args == null ? LicenseIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
