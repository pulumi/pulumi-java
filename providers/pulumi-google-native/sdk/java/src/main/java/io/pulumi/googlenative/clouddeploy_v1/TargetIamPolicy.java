...
import io.pulumi.googlenative.clouddeploy_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:clouddeploy/v1:TargetIamPolicy")
public class TargetIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(TargetIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.clouddeploy_v1.TargetIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.clouddeploy_v1.TargetIamPolicyArgs.builder();
     ...
     */
    public TargetIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     * @param name The _unique_ name of the resulting resource.
     */
    public TargetIamPolicy(String name) {
    ...
    public TargetIamPolicy(String name, TargetIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:clouddeploy/v1:TargetIamPolicy", name, args == null ? TargetIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private TargetIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:clouddeploy/v1:TargetIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static TargetIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new TargetIamPolicy(name, id, options);
    }
}
