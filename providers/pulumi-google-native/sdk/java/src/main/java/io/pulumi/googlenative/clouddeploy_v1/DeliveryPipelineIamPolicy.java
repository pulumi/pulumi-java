...
import io.pulumi.googlenative.clouddeploy_v1.DeliveryPipelineIamPolicyArgs;
...
public class DeliveryPipelineIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public DeliveryPipelineIamPolicy(String name) {
        super("google-native:clouddeploy/v1:DeliveryPipelineIamPolicy", name, DeliveryPipelineIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DeliveryPipelineIamPolicy(String name, DeliveryPipelineIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:clouddeploy/v1:DeliveryPipelineIamPolicy", name, args == null ? DeliveryPipelineIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private DeliveryPipelineIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static DeliveryPipelineIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
