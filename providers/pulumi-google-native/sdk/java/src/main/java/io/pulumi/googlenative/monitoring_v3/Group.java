...
public class Group extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.monitoring_v3.GroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.monitoring_v3.GroupArgs.builder();
