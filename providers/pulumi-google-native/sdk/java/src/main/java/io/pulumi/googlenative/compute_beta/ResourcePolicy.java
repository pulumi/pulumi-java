...
public class ResourcePolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.ResourcePolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.ResourcePolicyArgs.builder();
    ...
    public ResourcePolicy(String name, ResourcePolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:ResourcePolicy", name, args == null ? ResourcePolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
