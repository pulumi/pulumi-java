...
public class RegionNetworkFirewallPolicyIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public RegionNetworkFirewallPolicyIamPolicy(String name) {
        super("google-native:compute/alpha:RegionNetworkFirewallPolicyIamPolicy", name, RegionNetworkFirewallPolicyIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
