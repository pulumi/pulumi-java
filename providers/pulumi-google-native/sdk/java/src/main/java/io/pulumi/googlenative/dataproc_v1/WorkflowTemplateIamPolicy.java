...
public class WorkflowTemplateIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.dataproc_v1.WorkflowTemplateIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dataproc_v1.WorkflowTemplateIamPolicyArgs.builder();
    ...
    public WorkflowTemplateIamPolicy(String name, WorkflowTemplateIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataproc/v1:WorkflowTemplateIamPolicy", name, args == null ? WorkflowTemplateIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
