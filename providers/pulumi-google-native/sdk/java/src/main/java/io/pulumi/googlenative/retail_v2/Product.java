...
public class Product extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="audience", type=GoogleCloudRetailV2AudienceResponse.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="colorInfo", type=GoogleCloudRetailV2ColorInfoResponse.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="fulfillmentInfo", type=List.class, parameters={GoogleCloudRetailV2FulfillmentInfoResponse.class})
     ...
     * 
     */
    @OutputExport(name="images", type=List.class, parameters={GoogleCloudRetailV2ImageResponse.class})
     ...
     * 
     */
    @OutputExport(name="priceInfo", type=GoogleCloudRetailV2PriceInfoResponse.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="promotions", type=List.class, parameters={GoogleCloudRetailV2PromotionResponse.class})
     ...
     * 
     */
    @OutputExport(name="rating", type=GoogleCloudRetailV2RatingResponse.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="variants", type=List.class, parameters={GoogleCloudRetailV2ProductResponse.class})
    ...
    private static io.pulumi.googlenative.retail_v2.ProductArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.retail_v2.ProductArgs.builder();
    ...
    public Product(String name, ProductArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:retail/v2:Product", name, args == null ? ProductArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
