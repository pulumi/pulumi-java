...
public class NodeGroup extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(NodeGroupArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_v1.NodeGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.NodeGroupArgs.builder();
     ...
     */
    public NodeGroup(String name, BuilderApplicator argsBuilder) {
    ...
    public NodeGroup(String name, NodeGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:NodeGroup", name, args == null ? NodeGroupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private NodeGroup(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static NodeGroup get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
