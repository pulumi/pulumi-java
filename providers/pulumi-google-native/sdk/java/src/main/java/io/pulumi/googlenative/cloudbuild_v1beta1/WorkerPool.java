...
public class WorkerPool extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.cloudbuild_v1beta1.WorkerPoolArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudbuild_v1beta1.WorkerPoolArgs.builder();
    ...
    public WorkerPool(String name, WorkerPoolArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudbuild/v1beta1:WorkerPool", name, args == null ? WorkerPoolArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
