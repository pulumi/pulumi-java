...
public class ExternalVpnGateway extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.ExternalVpnGatewayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.ExternalVpnGatewayArgs.builder();
