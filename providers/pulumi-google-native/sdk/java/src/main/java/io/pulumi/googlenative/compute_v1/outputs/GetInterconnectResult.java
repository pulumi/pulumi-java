 ...
 */
    ...
    @OutputCustomType.Constructor({"adminEnabled","circuitInfos","creationTimestamp","customerName","description","expectedOutages","googleIpAddress","googleReferenceId","interconnectAttachments","interconnectType","kind","linkType","location","name","nocContactEmail","operationalStatus","peerIpAddress","provisionedLinkCount","requestedLinkCount","satisfiesPzs","selfLink","state"})
