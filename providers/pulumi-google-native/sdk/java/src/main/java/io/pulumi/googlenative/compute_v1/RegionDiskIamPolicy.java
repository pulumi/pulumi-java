...
import io.pulumi.googlenative.compute_v1.RegionDiskIamPolicyArgs;
...
public class RegionDiskIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.RegionDiskIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.RegionDiskIamPolicyArgs.builder();
    ...
    public RegionDiskIamPolicy(String name, RegionDiskIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:RegionDiskIamPolicy", name, args == null ? RegionDiskIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
