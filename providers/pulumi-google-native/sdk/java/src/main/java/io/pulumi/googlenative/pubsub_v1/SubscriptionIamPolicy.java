...
public class SubscriptionIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public SubscriptionIamPolicy(String name, SubscriptionIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:pubsub/v1:SubscriptionIamPolicy", name, args == null ? SubscriptionIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private SubscriptionIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SubscriptionIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
