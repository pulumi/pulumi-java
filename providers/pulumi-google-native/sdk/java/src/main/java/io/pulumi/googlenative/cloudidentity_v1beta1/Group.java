...
public class Group extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.cloudidentity_v1beta1.GroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudidentity_v1beta1.GroupArgs.builder();
    ...
    public Group(String name, GroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudidentity/v1beta1:Group", name, args == null ? GroupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
