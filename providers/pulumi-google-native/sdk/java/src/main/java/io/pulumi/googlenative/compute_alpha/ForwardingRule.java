...
import io.pulumi.googlenative.compute_alpha.ForwardingRuleArgs;
...
public class ForwardingRule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.ForwardingRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.ForwardingRuleArgs.builder();
    ...
    public ForwardingRule(String name, ForwardingRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:ForwardingRule", name, args == null ? ForwardingRuleArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
