...
import io.pulumi.googlenative.gkehub_v1.FeatureIamPolicyArgs;
import io.pulumi.googlenative.gkehub_v1.outputs.AuditConfigResponse;
import io.pulumi.googlenative.gkehub_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:gkehub/v1:FeatureIamPolicy")
public class FeatureIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(FeatureIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.gkehub_v1.FeatureIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.gkehub_v1.FeatureIamPolicyArgs.builder();
     ...
     */
    public FeatureIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public FeatureIamPolicy(String name, FeatureIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkehub/v1:FeatureIamPolicy", name, args == null ? FeatureIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private FeatureIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkehub/v1:FeatureIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static FeatureIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new FeatureIamPolicy(name, id, options);
    }
}
