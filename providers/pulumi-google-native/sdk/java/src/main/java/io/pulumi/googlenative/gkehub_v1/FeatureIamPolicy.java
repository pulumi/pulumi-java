...
public class FeatureIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public FeatureIamPolicy(String name, FeatureIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkehub/v1:FeatureIamPolicy", name, args == null ? FeatureIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private FeatureIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static FeatureIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
