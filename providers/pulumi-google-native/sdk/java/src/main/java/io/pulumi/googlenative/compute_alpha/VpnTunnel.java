...
import io.pulumi.googlenative.compute_alpha.VpnTunnelArgs;
...
public class VpnTunnel extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.VpnTunnelArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.VpnTunnelArgs.builder();
    ...
    public VpnTunnel(String name, VpnTunnelArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:VpnTunnel", name, args == null ? VpnTunnelArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
