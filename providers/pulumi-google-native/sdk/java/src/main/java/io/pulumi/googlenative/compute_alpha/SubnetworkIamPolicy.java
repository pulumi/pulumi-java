...
public class SubnetworkIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public SubnetworkIamPolicy(String name, SubnetworkIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:SubnetworkIamPolicy", name, args == null ? SubnetworkIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private SubnetworkIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SubnetworkIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
