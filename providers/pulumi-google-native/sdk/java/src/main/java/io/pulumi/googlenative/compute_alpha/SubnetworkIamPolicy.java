...
import io.pulumi.googlenative.compute_alpha.SubnetworkIamPolicyArgs;
...
public class SubnetworkIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.SubnetworkIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.SubnetworkIamPolicyArgs.builder();
    ...
    public SubnetworkIamPolicy(String name, SubnetworkIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:SubnetworkIamPolicy", name, args == null ? SubnetworkIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private SubnetworkIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SubnetworkIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
