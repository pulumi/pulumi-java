...
public class InstanceTableIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public InstanceTableIamPolicy(String name, InstanceTableIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:bigtableadmin/v2:InstanceTableIamPolicy", name, args == null ? InstanceTableIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
