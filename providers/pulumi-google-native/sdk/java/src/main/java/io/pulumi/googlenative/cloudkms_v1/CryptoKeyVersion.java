...
public class CryptoKeyVersion extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(CryptoKeyVersionArgs.Builder a);
    }
    private static io.pulumi.googlenative.cloudkms_v1.CryptoKeyVersionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudkms_v1.CryptoKeyVersionArgs.builder();
     ...
     */
    public CryptoKeyVersion(String name, BuilderApplicator argsBuilder) {
