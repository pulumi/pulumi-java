...
public class ServiceDatabaseIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public ServiceDatabaseIamPolicy(String name, ServiceDatabaseIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1alpha:ServiceDatabaseIamPolicy", name, args == null ? ServiceDatabaseIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ServiceDatabaseIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ServiceDatabaseIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
