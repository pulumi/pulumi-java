...
public final class GetAgentResult {
    ...
    private GetAgentResult(
        @OutputCustomType.Parameter("advancedSettings") GoogleCloudDialogflowCxV3AdvancedSettingsResponse advancedSettings,
        ...
        @OutputCustomType.Parameter("speechToTextSettings") GoogleCloudDialogflowCxV3SpeechToTextSettingsResponse speechToTextSettings,
