...
public class ServiceBackupIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.metastore_v1beta.ServiceBackupIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.metastore_v1beta.ServiceBackupIamPolicyArgs.builder();
    ...
    public ServiceBackupIamPolicy(String name, ServiceBackupIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1beta:ServiceBackupIamPolicy", name, args == null ? ServiceBackupIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
