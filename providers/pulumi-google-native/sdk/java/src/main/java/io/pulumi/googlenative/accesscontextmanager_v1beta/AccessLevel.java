...
public class AccessLevel extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.accesscontextmanager_v1beta.AccessLevelArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.accesscontextmanager_v1beta.AccessLevelArgs.builder();
    ...
    public AccessLevel(String name, AccessLevelArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:accesscontextmanager/v1beta:AccessLevel", name, args == null ? AccessLevelArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
