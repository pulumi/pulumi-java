...
import io.pulumi.googlenative.compute_alpha.HealthCheckArgs;
...
public class HealthCheck extends io.pulumi.resources.CustomResource {
    ...
    @OutputExport(name="udpHealthCheck", type=UDPHealthCheckResponse.class, parameters={})
    ...
    private static io.pulumi.googlenative.compute_alpha.HealthCheckArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.HealthCheckArgs.builder();
    ...
    public HealthCheck(String name, @Nullable HealthCheckArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:HealthCheck", name, args == null ? HealthCheckArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
