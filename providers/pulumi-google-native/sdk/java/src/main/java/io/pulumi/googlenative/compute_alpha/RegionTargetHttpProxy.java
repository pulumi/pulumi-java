 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:RegionTargetHttpProxy")
public class RegionTargetHttpProxy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.RegionTargetHttpProxyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.RegionTargetHttpProxyArgs.builder();
    ...
    public RegionTargetHttpProxy(String name, RegionTargetHttpProxyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionTargetHttpProxy", name, args == null ? RegionTargetHttpProxyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private RegionTargetHttpProxy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionTargetHttpProxy", name, null, makeResourceOptions(options, id));
    }
