...
public final class ScanRunArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setErrorTrace(@Nullable Input<ScanRunErrorTraceArgs> errorTrace) {
            this.errorTrace = errorTrace;
            return this;
        }

        public Builder setErrorTrace(@Nullable ScanRunErrorTraceArgs errorTrace) {
        ...
        public Builder setWarningTraces(@Nullable Input<List<ScanRunWarningTraceArgs>> warningTraces) {
            this.warningTraces = warningTraces;
            return this;
        }

        public Builder setWarningTraces(@Nullable List<ScanRunWarningTraceArgs> warningTraces) {
