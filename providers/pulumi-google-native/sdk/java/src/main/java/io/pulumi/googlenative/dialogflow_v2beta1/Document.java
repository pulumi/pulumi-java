...
public class Document extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    public Output<GoogleCloudDialogflowV2beta1DocumentReloadStatusResponse> latestReloadStatus() {
    ...
    public Document(String name, DocumentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v2beta1:Document", name, args == null ? DocumentArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
