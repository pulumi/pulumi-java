...
public class Document extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="latestReloadStatus", type=GoogleCloudDialogflowV2beta1DocumentReloadStatusResponse.class, parameters={})
    ...
    private static io.pulumi.googlenative.dialogflow_v2beta1.DocumentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dialogflow_v2beta1.DocumentArgs.builder();
    ...
    public Document(String name, DocumentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v2beta1:Document", name, args == null ? DocumentArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
