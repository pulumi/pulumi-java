...
import io.pulumi.googlenative.compute_beta.TargetHttpsProxyArgs;
...
public class TargetHttpsProxy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable TargetHttpsProxyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_beta.TargetHttpsProxyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.TargetHttpsProxyArgs.builder();
     ...
     */
    public TargetHttpsProxy(String name, @Nullable TargetHttpsProxyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:TargetHttpsProxy", name, args == null ? TargetHttpsProxyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private TargetHttpsProxy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:TargetHttpsProxy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static TargetHttpsProxy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
