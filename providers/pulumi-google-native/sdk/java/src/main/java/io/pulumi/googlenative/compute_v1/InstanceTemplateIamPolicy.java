...
import io.pulumi.googlenative.compute_v1.InstanceTemplateIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:InstanceTemplateIamPolicy")
public class InstanceTemplateIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    private static io.pulumi.googlenative.compute_v1.InstanceTemplateIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.InstanceTemplateIamPolicyArgs.builder();
     ...
     */
    public InstanceTemplateIamPolicy(String name, InstanceTemplateIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public InstanceTemplateIamPolicy(String name, InstanceTemplateIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:InstanceTemplateIamPolicy", name, args == null ? InstanceTemplateIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private InstanceTemplateIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:InstanceTemplateIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static InstanceTemplateIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
