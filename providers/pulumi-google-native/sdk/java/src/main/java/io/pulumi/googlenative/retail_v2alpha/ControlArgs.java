...
public final class ControlArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder facetSpec(@Nullable Input<GoogleCloudRetailV2alphaSearchRequestFacetSpecArgs> facetSpec) {
            this.facetSpec = facetSpec;
            return this;
        }
        ...
        public Builder rule(@Nullable Input<GoogleCloudRetailV2alphaRuleArgs> rule) {
            this.rule = rule;
            return this;
        }
