...
public class MembershipIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(MembershipIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.gkehub_v1beta.MembershipIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.gkehub_v1beta.MembershipIamPolicyArgs.builder();
     ...
     */
    public MembershipIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     * @param name The _unique_ name of the resulting resource.
     */
    public MembershipIamPolicy(String name) {
     ...
     */
    public MembershipIamPolicy(String name, MembershipIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
    ...
    public MembershipIamPolicy(String name, MembershipIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkehub/v1beta:MembershipIamPolicy", name, args == null ? MembershipIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private MembershipIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static MembershipIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
