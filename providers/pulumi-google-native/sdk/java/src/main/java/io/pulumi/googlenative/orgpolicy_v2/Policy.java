...
public class Policy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.orgpolicy_v2.PolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.orgpolicy_v2.PolicyArgs.builder();
    ...
    public Policy(String name, @Nullable PolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:orgpolicy/v2:Policy", name, args == null ? PolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
