...
public class Registration extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.domains_v1alpha2.RegistrationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.domains_v1alpha2.RegistrationArgs.builder();
