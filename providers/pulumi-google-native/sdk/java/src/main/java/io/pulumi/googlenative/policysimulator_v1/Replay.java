...
public class Replay extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.policysimulator_v1.ReplayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.policysimulator_v1.ReplayArgs.builder();
    ...
    public Replay(String name, ReplayArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:policysimulator/v1:Replay", name, args == null ? ReplayArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
