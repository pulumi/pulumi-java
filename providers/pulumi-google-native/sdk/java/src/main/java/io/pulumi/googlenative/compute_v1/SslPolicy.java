...
public class SslPolicy extends io.pulumi.resources.CustomResource {
    ...
    public SslPolicy(String name, @Nullable SslPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:SslPolicy", name, args == null ? SslPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
     ...
     */
    public static SslPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
