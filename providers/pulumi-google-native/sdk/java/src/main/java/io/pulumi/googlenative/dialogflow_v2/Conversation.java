...
public class Conversation extends io.pulumi.resources.CustomResource {
    ...
    public Conversation(String name) {
        super("google-native:dialogflow/v2:Conversation", name, ConversationArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public Conversation(String name, ConversationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v2:Conversation", name, args == null ? ConversationArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
