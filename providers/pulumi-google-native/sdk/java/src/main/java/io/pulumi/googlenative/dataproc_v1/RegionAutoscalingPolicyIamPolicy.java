...
public class RegionAutoscalingPolicyIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.dataproc_v1.RegionAutoscalingPolicyIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dataproc_v1.RegionAutoscalingPolicyIamPolicyArgs.builder();
    ...
    public RegionAutoscalingPolicyIamPolicy(String name, RegionAutoscalingPolicyIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataproc/v1:RegionAutoscalingPolicyIamPolicy", name, args == null ? RegionAutoscalingPolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
