...
public class FeedbackMessage extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(FeedbackMessageArgs.Builder a);
    }
    private static io.pulumi.googlenative.datalabeling_v1beta1.FeedbackMessageArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.datalabeling_v1beta1.FeedbackMessageArgs.builder();
     ...
     */
    public FeedbackMessage(String name, BuilderApplicator argsBuilder) {
