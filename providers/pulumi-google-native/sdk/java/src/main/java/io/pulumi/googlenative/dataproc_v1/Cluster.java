...
public class Cluster extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.dataproc_v1.ClusterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dataproc_v1.ClusterArgs.builder();
    ...
    public Cluster(String name, ClusterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataproc/v1:Cluster", name, args == null ? ClusterArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
