 ...
 * 
 */
@ResourceType(type="google-native:networkservices/v1beta1:ServiceBindingIamPolicy")
public class ServiceBindingIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(ServiceBindingIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.networkservices_v1beta1.ServiceBindingIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.networkservices_v1beta1.ServiceBindingIamPolicyArgs.builder();
     ...
     */
    public ServiceBindingIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     * @param name The _unique_ name of the resulting resource.
     */
    public ServiceBindingIamPolicy(String name) {
        this(name, ServiceBindingIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ServiceBindingIamPolicy(String name, ServiceBindingIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
    ...
    public ServiceBindingIamPolicy(String name, ServiceBindingIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1beta1:ServiceBindingIamPolicy", name, args == null ? ServiceBindingIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ServiceBindingIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1beta1:ServiceBindingIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ServiceBindingIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
