...
public final class Iap_v1beta1Functions {
     ...
     * 
     */
    public static CompletableFuture<GetV1beta1IamPolicyResult> getV1beta1IamPolicy(io.pulumi.googlenative.iap_v1beta1.inputs.GetV1beta1IamPolicyArgs args) {
        return getV1beta1IamPolicy(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetV1beta1IamPolicyResult> getV1beta1IamPolicy(io.pulumi.googlenative.iap_v1beta1.inputs.GetV1beta1IamPolicyArgs args, InvokeOptions options) {
