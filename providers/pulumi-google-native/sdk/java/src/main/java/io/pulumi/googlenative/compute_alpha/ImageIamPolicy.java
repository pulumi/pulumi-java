...
import io.pulumi.googlenative.compute_alpha.ImageIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:ImageIamPolicy")
public class ImageIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ImageIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.ImageIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.ImageIamPolicyArgs.builder();
     ...
     */
    public ImageIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public ImageIamPolicy(String name) {
        this(name, ImageIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ImageIamPolicy(String name, ImageIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
    ...
    public ImageIamPolicy(String name, ImageIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:ImageIamPolicy", name, args == null ? ImageIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ImageIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:ImageIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ImageIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
