...
public final class BucketAccessControlArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setProjectTeam(@Nullable Input<BucketAccessControlProjectTeamArgs> projectTeam) {
            this.projectTeam = projectTeam;
            return this;
        }

        public Builder setProjectTeam(@Nullable BucketAccessControlProjectTeamArgs projectTeam) {
