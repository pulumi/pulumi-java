...
public class Version extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.dialogflow_v3.VersionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dialogflow_v3.VersionArgs.builder();
    ...
    public Version(String name, VersionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v3:Version", name, args == null ? VersionArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
