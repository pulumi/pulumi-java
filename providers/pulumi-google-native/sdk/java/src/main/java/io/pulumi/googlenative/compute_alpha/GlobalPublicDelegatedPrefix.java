...
import io.pulumi.googlenative.compute_alpha.GlobalPublicDelegatedPrefixArgs;
...
public class GlobalPublicDelegatedPrefix extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.GlobalPublicDelegatedPrefixArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.GlobalPublicDelegatedPrefixArgs.builder();
    ...
    public GlobalPublicDelegatedPrefix(String name, @Nullable GlobalPublicDelegatedPrefixArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:GlobalPublicDelegatedPrefix", name, args == null ? GlobalPublicDelegatedPrefixArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
