...
public class PublicDelegatedPrefix extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.PublicDelegatedPrefixArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.PublicDelegatedPrefixArgs.builder();
    ...
    public PublicDelegatedPrefix(String name, PublicDelegatedPrefixArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:PublicDelegatedPrefix", name, args == null ? PublicDelegatedPrefixArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
