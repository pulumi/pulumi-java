...
public final class Securitycenter_v1beta1Functions {
     ...
     * 
     */
    public static CompletableFuture<GetOrganizationSourceIamPolicyResult> getOrganizationSourceIamPolicy(io.pulumi.googlenative.securitycenter_v1beta1.inputs.GetOrganizationSourceIamPolicyArgs args) {
        return getOrganizationSourceIamPolicy(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetOrganizationSourceIamPolicyResult> getOrganizationSourceIamPolicy(io.pulumi.googlenative.securitycenter_v1beta1.inputs.GetOrganizationSourceIamPolicyArgs args, InvokeOptions options) {
     ...
     * 
     */
    public static CompletableFuture<GetSourceResult> getSource(io.pulumi.googlenative.securitycenter_v1beta1.inputs.GetSourceArgs args) {
        return getSource(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetSourceResult> getSource(io.pulumi.googlenative.securitycenter_v1beta1.inputs.GetSourceArgs args, InvokeOptions options) {
