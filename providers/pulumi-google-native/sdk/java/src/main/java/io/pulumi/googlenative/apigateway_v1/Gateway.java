...
public class Gateway extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.apigateway_v1.GatewayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.apigateway_v1.GatewayArgs.builder();
