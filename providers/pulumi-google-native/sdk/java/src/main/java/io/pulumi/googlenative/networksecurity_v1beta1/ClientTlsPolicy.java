...
public class ClientTlsPolicy extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="clientCertificate", type=GoogleCloudNetworksecurityV1beta1CertificateProviderResponse.class, parameters={})
    ...
    private static io.pulumi.googlenative.networksecurity_v1beta1.ClientTlsPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.networksecurity_v1beta1.ClientTlsPolicyArgs.builder();
    ...
    public ClientTlsPolicy(String name, ClientTlsPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networksecurity/v1beta1:ClientTlsPolicy", name, args == null ? ClientTlsPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
