...
public class Network extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.NetworkArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.NetworkArgs.builder();
