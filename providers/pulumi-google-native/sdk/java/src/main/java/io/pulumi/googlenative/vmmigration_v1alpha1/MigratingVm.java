...
public class MigratingVm extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(MigratingVmArgs.Builder a);
    }
    private static io.pulumi.googlenative.vmmigration_v1alpha1.MigratingVmArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.vmmigration_v1alpha1.MigratingVmArgs.builder();
     ...
     */
    public MigratingVm(String name, BuilderApplicator argsBuilder) {
    ...
    public MigratingVm(String name, MigratingVmArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:vmmigration/v1alpha1:MigratingVm", name, args == null ? MigratingVmArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
