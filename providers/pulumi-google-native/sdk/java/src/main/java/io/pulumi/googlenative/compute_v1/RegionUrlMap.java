 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:RegionUrlMap")
public class RegionUrlMap extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.RegionUrlMapArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.RegionUrlMapArgs.builder();
    ...
    public RegionUrlMap(String name, RegionUrlMapArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:RegionUrlMap", name, args == null ? RegionUrlMapArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private RegionUrlMap(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:RegionUrlMap", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static RegionUrlMap get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
