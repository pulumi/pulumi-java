...
public final class TagValueIamPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="tagValueId", required=true)
      private final Output<String> tagValueId;

    public Output<String> getTagValueId() {
    ...
    public static final class Builder {
        ...
        public Builder tagValueId(String tagValueId) {
            this.tagValueId = Output.of(Objects.requireNonNull(tagValueId));
            return this;
        }
