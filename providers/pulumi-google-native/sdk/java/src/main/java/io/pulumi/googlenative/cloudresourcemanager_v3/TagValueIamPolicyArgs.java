...
public final class TagValueIamPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<String> tagValueId;

    public Input<String> getTagValueId() {
    ...
    public static final class Builder {
        ...
        private Input<String> tagValueId;
        ...
        public Builder setTagValueId(Input<String> tagValueId) {
            this.tagValueId = Objects.requireNonNull(tagValueId);
            return this;
        }

        public Builder setTagValueId(String tagValueId) {
            this.tagValueId = Input.of(Objects.requireNonNull(tagValueId));
            return this;
        }
        ...
        public TagValueIamPolicyArgs build() {
            return new TagValueIamPolicyArgs(auditConfigs, bindings, etag, tagValueId, updateMask, version);
        }
    }
}
