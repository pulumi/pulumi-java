...
public class ReservationIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public ReservationIamPolicy(String name, ReservationIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:ReservationIamPolicy", name, args == null ? ReservationIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ReservationIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ReservationIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
