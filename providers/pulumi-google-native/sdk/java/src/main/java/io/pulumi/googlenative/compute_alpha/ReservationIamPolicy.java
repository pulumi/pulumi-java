...
import io.pulumi.googlenative.compute_alpha.ReservationIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:ReservationIamPolicy")
public class ReservationIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(ReservationIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.ReservationIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.ReservationIamPolicyArgs.builder();
     ...
     */
    public ReservationIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     * @param name The _unique_ name of the resulting resource.
     */
    public ReservationIamPolicy(String name) {
        this(name, ReservationIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ReservationIamPolicy(String name, ReservationIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ReservationIamPolicy(String name, ReservationIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:ReservationIamPolicy", name, args == null ? ReservationIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ReservationIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:ReservationIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ReservationIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
