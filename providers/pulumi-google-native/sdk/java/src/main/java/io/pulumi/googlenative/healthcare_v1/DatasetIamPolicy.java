...
import io.pulumi.googlenative.healthcare_v1.DatasetIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:healthcare/v1:DatasetIamPolicy")
public class DatasetIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.healthcare_v1.DatasetIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.healthcare_v1.DatasetIamPolicyArgs.builder();
    ...
    public DatasetIamPolicy(String name, DatasetIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1:DatasetIamPolicy", name, args == null ? DatasetIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private DatasetIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1:DatasetIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static DatasetIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new DatasetIamPolicy(name, id, options);
    }
}
