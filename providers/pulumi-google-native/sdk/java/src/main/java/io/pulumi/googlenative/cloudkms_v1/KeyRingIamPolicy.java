...
public class KeyRingIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public KeyRingIamPolicy(String name, KeyRingIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudkms/v1:KeyRingIamPolicy", name, args == null ? KeyRingIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private KeyRingIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static KeyRingIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
