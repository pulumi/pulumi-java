...
import io.pulumi.googlenative.cloudkms_v1.KeyRingIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:cloudkms/v1:KeyRingIamPolicy")
public class KeyRingIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.cloudkms_v1.KeyRingIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudkms_v1.KeyRingIamPolicyArgs.builder();
    ...
    public KeyRingIamPolicy(String name, KeyRingIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudkms/v1:KeyRingIamPolicy", name, args == null ? KeyRingIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private KeyRingIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudkms/v1:KeyRingIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static KeyRingIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new KeyRingIamPolicy(name, id, options);
    }
}
