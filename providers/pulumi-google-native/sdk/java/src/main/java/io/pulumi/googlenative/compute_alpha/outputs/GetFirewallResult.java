...
public final class GetFirewallResult {
    ...
    @OutputCustomType.Constructor({"allowed","creationTimestamp","denied","description","destinationRanges","direction","disabled","kind","logConfig","name","network","priority","selfLink","selfLinkWithId","sourceRanges","sourceServiceAccounts","sourceTags","targetServiceAccounts","targetTags"})
