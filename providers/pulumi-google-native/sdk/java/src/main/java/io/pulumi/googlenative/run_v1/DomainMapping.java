...
public class DomainMapping extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable DomainMappingArgs.Builder a);
    }
    private static io.pulumi.googlenative.run_v1.DomainMappingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.run_v1.DomainMappingArgs.builder();
