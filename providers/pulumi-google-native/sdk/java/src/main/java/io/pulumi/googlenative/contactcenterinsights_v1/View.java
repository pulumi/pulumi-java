...
public class View extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable ViewArgs.Builder a);
    }
    private static io.pulumi.googlenative.contactcenterinsights_v1.ViewArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.contactcenterinsights_v1.ViewArgs.builder();
    ...
    public View(String name, @Nullable ViewArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:contactcenterinsights/v1:View", name, args == null ? ViewArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
