...
public class UserDataMapping extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.healthcare_v1beta1.UserDataMappingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.healthcare_v1beta1.UserDataMappingArgs.builder();
    ...
    public UserDataMapping(String name, UserDataMappingArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1beta1:UserDataMapping", name, args == null ? UserDataMappingArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private UserDataMapping(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static UserDataMapping get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
