 ...
 */
public final class GoogleType__ExprArgs extends io.pulumi.resources.ResourceArgs {

    public static final GoogleType__ExprArgs Empty = new GoogleType__ExprArgs();
