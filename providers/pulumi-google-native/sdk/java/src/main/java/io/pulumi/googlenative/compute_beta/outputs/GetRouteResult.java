...
public final class GetRouteResult {
    ...
    @OutputCustomType.Constructor({"asPaths","creationTimestamp","description","destRange","kind","name","network","nextHopGateway","nextHopIlb","nextHopInstance","nextHopInterconnectAttachment","nextHopIp","nextHopNetwork","nextHopPeering","nextHopVpnTunnel","priority","routeType","selfLink","tags","warnings"})
