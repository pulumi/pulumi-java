...
public class Peering extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.managedidentities_v1beta1.PeeringArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.managedidentities_v1beta1.PeeringArgs.builder();
    ...
    public Peering(String name, PeeringArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:managedidentities/v1beta1:Peering", name, args == null ? PeeringArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
