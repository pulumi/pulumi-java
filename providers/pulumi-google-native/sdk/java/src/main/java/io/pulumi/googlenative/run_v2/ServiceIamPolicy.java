...
import io.pulumi.googlenative.run_v2.ServiceIamPolicyArgs;
...
public class ServiceIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.run_v2.ServiceIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.run_v2.ServiceIamPolicyArgs.builder();
    ...
    public ServiceIamPolicy(String name, ServiceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:run/v2:ServiceIamPolicy", name, args == null ? ServiceIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
