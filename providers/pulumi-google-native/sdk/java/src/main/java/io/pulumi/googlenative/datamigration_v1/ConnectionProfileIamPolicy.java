...
import io.pulumi.googlenative.datamigration_v1.ConnectionProfileIamPolicyArgs;
import io.pulumi.googlenative.datamigration_v1.outputs.AuditConfigResponse;
import io.pulumi.googlenative.datamigration_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:datamigration/v1:ConnectionProfileIamPolicy")
public class ConnectionProfileIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(ConnectionProfileIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.datamigration_v1.ConnectionProfileIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.datamigration_v1.ConnectionProfileIamPolicyArgs.builder();
     ...
     */
    public ConnectionProfileIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public ConnectionProfileIamPolicy(String name, ConnectionProfileIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datamigration/v1:ConnectionProfileIamPolicy", name, args == null ? ConnectionProfileIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ConnectionProfileIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datamigration/v1:ConnectionProfileIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ConnectionProfileIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
