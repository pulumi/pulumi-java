...
import io.pulumi.googlenative.servicedirectory_v1.NamespaceIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:servicedirectory/v1:NamespaceIamPolicy")
public class NamespaceIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.servicedirectory_v1.NamespaceIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.servicedirectory_v1.NamespaceIamPolicyArgs.builder();
    ...
    public NamespaceIamPolicy(String name, NamespaceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:servicedirectory/v1:NamespaceIamPolicy", name, args == null ? NamespaceIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private NamespaceIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:servicedirectory/v1:NamespaceIamPolicy", name, null, makeResourceOptions(options, id));
    }
