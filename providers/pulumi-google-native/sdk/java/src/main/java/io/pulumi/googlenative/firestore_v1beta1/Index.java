...
public class Index extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.firestore_v1beta1.IndexArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.firestore_v1beta1.IndexArgs.builder();
