...
public class VpnGateway extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.VpnGatewayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.VpnGatewayArgs.builder();
    ...
    public VpnGateway(String name, VpnGatewayArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:VpnGateway", name, args == null ? VpnGatewayArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
