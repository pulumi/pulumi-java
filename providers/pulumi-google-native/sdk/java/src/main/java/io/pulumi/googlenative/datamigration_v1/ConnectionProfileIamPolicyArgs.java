...
public final class ConnectionProfileIamPolicyArgs extends io.pulumi.resources.ResourceArgs {

    public static final ConnectionProfileIamPolicyArgs Empty = new ConnectionProfileIamPolicyArgs();
    ...
    private ConnectionProfileIamPolicyArgs() {
    ...
    public static Builder builder(ConnectionProfileIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ConnectionProfileIamPolicyArgs defaults) {
        ...
        public ConnectionProfileIamPolicyArgs build() {
            return new ConnectionProfileIamPolicyArgs(auditConfigs, bindings, connectionProfileId, etag, location, project, updateMask, version);
        }
    }
}
