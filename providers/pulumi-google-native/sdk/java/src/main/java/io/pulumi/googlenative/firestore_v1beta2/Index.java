...
public class Index extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.firestore_v1beta2.IndexArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.firestore_v1beta2.IndexArgs.builder();
    ...
    public Index(String name, IndexArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:firestore/v1beta2:Index", name, args == null ? IndexArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
