...
public class EdgeCacheServiceIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(EdgeCacheServiceIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.networkservices_v1.EdgeCacheServiceIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.networkservices_v1.EdgeCacheServiceIamPolicyArgs.builder();
     ...
     */
    public EdgeCacheServiceIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public EdgeCacheServiceIamPolicy(String name, EdgeCacheServiceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:EdgeCacheServiceIamPolicy", name, args == null ? EdgeCacheServiceIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private EdgeCacheServiceIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static EdgeCacheServiceIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
