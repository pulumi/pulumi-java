...
public class InterconnectIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public InterconnectIamPolicy(String name, InterconnectIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:InterconnectIamPolicy", name, args == null ? InterconnectIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private InterconnectIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static InterconnectIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
