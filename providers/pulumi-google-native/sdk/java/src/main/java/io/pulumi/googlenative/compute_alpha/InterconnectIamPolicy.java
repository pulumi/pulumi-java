...
import io.pulumi.googlenative.compute_alpha.InterconnectIamPolicyArgs;
...
public class InterconnectIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(InterconnectIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.InterconnectIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.InterconnectIamPolicyArgs.builder();
     ...
     */
    public InterconnectIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public InterconnectIamPolicy(String name, InterconnectIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:InterconnectIamPolicy", name, args == null ? InterconnectIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private InterconnectIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static InterconnectIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
