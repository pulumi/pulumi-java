...
public class GlobalPublicDelegatedPrefix extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.GlobalPublicDelegatedPrefixArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.GlobalPublicDelegatedPrefixArgs.builder();
