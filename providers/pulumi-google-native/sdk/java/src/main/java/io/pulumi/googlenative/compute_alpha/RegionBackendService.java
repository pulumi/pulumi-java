...
public class RegionBackendService extends io.pulumi.resources.CustomResource {
    ...
    public RegionBackendService(String name) {
        super("google-native:compute/alpha:RegionBackendService", name, RegionBackendServiceArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public RegionBackendService(String name, RegionBackendServiceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionBackendService", name, args == null ? RegionBackendServiceArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
