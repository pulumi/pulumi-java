...
import io.pulumi.googlenative.metastore_v1alpha.ServiceIamPolicyArgs;
...
public class ServiceIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.metastore_v1alpha.ServiceIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.metastore_v1alpha.ServiceIamPolicyArgs.builder();
    ...
    public ServiceIamPolicy(String name, ServiceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1alpha:ServiceIamPolicy", name, args == null ? ServiceIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
