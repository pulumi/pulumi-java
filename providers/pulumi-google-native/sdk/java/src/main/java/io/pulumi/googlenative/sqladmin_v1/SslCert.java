...
public class SslCert extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.sqladmin_v1.SslCertArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.sqladmin_v1.SslCertArgs.builder();
    ...
    public SslCert(String name, SslCertArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:sqladmin/v1:SslCert", name, args == null ? SslCertArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
