...
public class RegionAutoscalingPolicyIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public RegionAutoscalingPolicyIamPolicy(String name) {
        super("google-native:dataproc/v1beta2:RegionAutoscalingPolicyIamPolicy", name, RegionAutoscalingPolicyIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
