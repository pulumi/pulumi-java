...
import io.pulumi.googlenative.dataproc_v1beta2.RegionAutoscalingPolicyIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:dataproc/v1beta2:RegionAutoscalingPolicyIamPolicy")
public class RegionAutoscalingPolicyIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RegionAutoscalingPolicyIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.dataproc_v1beta2.RegionAutoscalingPolicyIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dataproc_v1beta2.RegionAutoscalingPolicyIamPolicyArgs.builder();
     ...
     */
    public RegionAutoscalingPolicyIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public RegionAutoscalingPolicyIamPolicy(String name) {
        this(name, RegionAutoscalingPolicyIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RegionAutoscalingPolicyIamPolicy(String name, RegionAutoscalingPolicyIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
    ...
    public RegionAutoscalingPolicyIamPolicy(String name, RegionAutoscalingPolicyIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataproc/v1beta2:RegionAutoscalingPolicyIamPolicy", name, args == null ? RegionAutoscalingPolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private RegionAutoscalingPolicyIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataproc/v1beta2:RegionAutoscalingPolicyIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static RegionAutoscalingPolicyIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
