...
public class AuthorizationPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.networksecurity_v1.AuthorizationPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.networksecurity_v1.AuthorizationPolicyArgs.builder();
    ...
    public AuthorizationPolicy(String name, AuthorizationPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networksecurity/v1:AuthorizationPolicy", name, args == null ? AuthorizationPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
