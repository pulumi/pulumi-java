...
public final class EntityTypeArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public EntityTypeArgs(
        ...
        @Nullable Input<List<GoogleCloudDialogflowV2beta1EntityTypeEntityArgs>> entities,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<GoogleCloudDialogflowV2beta1EntityTypeEntityArgs>> entities;
        ...
        public Builder setEntities(@Nullable Input<List<GoogleCloudDialogflowV2beta1EntityTypeEntityArgs>> entities) {
            this.entities = entities;
            return this;
        }

        public Builder setEntities(@Nullable List<GoogleCloudDialogflowV2beta1EntityTypeEntityArgs> entities) {
