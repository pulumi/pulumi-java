...
public class Execution extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.workflowexecutions_v1.ExecutionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.workflowexecutions_v1.ExecutionArgs.builder();
