...
public class Contact extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.essentialcontacts_v1.ContactArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.essentialcontacts_v1.ContactArgs.builder();
    ...
    public Contact(String name, ContactArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:essentialcontacts/v1:Contact", name, args == null ? ContactArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
