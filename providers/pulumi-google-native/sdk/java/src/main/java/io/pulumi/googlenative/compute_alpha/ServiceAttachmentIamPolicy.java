...
import io.pulumi.googlenative.compute_alpha.ServiceAttachmentIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:ServiceAttachmentIamPolicy")
public class ServiceAttachmentIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    private static io.pulumi.googlenative.compute_alpha.ServiceAttachmentIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.ServiceAttachmentIamPolicyArgs.builder();
    ...
    public ServiceAttachmentIamPolicy(String name, ServiceAttachmentIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:ServiceAttachmentIamPolicy", name, args == null ? ServiceAttachmentIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ServiceAttachmentIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:ServiceAttachmentIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ServiceAttachmentIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new ServiceAttachmentIamPolicy(name, id, options);
    }
}
