...
public class ServiceAttachmentIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public ServiceAttachmentIamPolicy(String name, ServiceAttachmentIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:ServiceAttachmentIamPolicy", name, args == null ? ServiceAttachmentIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
     ...
     */
    public static ServiceAttachmentIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
