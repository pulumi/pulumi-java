...
import io.pulumi.googlenative.compute_alpha.enums.GlobalNetworkEndpointGroupNetworkEndpointType;
import io.pulumi.googlenative.compute_alpha.enums.GlobalNetworkEndpointGroupType;
...
public final class GlobalNetworkEndpointGroupArgs extends io.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="type")
      private final @Nullable Output<GlobalNetworkEndpointGroupType> type;

    public Output<GlobalNetworkEndpointGroupType> type() {
    ...
    public GlobalNetworkEndpointGroupArgs(
        ...
        @Nullable Output<GlobalNetworkEndpointGroupType> type) {
    ...
    public static final class Builder {
        ...
        public Builder type(@Nullable GlobalNetworkEndpointGroupType type) {
            this.type = Codegen.ofNullable(type);
            return this;
        }        public GlobalNetworkEndpointGroupArgs build() {
            return new GlobalNetworkEndpointGroupArgs(annotations, appEngine, cloudFunction, cloudRun, defaultPort, description, name, network, networkEndpointType, project, pscTargetService, requestId, serverlessDeployment, subnetwork, type);
        }
    }
}
