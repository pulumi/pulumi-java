...
public class NodeTemplateIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.NodeTemplateIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.NodeTemplateIamPolicyArgs.builder();
    ...
    public NodeTemplateIamPolicy(String name, NodeTemplateIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:NodeTemplateIamPolicy", name, args == null ? NodeTemplateIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
