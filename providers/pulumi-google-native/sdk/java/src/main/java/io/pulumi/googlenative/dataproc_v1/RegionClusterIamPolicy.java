...
import io.pulumi.googlenative.dataproc_v1.RegionClusterIamPolicyArgs;
...
public class RegionClusterIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.dataproc_v1.RegionClusterIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.dataproc_v1.RegionClusterIamPolicyArgs.builder();
    ...
    public RegionClusterIamPolicy(String name, RegionClusterIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataproc/v1:RegionClusterIamPolicy", name, args == null ? RegionClusterIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
