...
public class Service extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.run_v2.ServiceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.run_v2.ServiceArgs.builder();
    ...
    public Service(String name, ServiceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:run/v2:Service", name, args == null ? ServiceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
