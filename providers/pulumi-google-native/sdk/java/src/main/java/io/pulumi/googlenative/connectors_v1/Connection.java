...
public class Connection extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.connectors_v1.ConnectionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.connectors_v1.ConnectionArgs.builder();
