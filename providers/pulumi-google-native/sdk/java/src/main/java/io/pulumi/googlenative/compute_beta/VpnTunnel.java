...
public class VpnTunnel extends io.pulumi.resources.CustomResource {
    ...
    public VpnTunnel(String name) {
        super("google-native:compute/beta:VpnTunnel", name, VpnTunnelArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public VpnTunnel(String name, VpnTunnelArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:VpnTunnel", name, args == null ? VpnTunnelArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
