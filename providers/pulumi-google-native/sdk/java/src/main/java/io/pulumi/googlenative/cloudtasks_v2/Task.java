...
public class Task extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.cloudtasks_v2.TaskArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudtasks_v2.TaskArgs.builder();
    ...
    public Task(String name, TaskArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudtasks/v2:Task", name, args == null ? TaskArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
