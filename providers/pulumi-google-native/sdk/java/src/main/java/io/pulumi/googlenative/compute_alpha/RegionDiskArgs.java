...
public final class RegionDiskArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<RegionDiskArchitecture> architecture;

    public Input<RegionDiskArchitecture> getArchitecture() {
    ...
    public RegionDiskArgs(
        @Nullable Input<RegionDiskArchitecture> architecture,
    ...
    public static final class Builder {
        private @Nullable Input<RegionDiskArchitecture> architecture;
