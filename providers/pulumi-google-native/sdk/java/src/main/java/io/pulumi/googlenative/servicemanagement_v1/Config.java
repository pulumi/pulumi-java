...
public class Config extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.servicemanagement_v1.ConfigArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.servicemanagement_v1.ConfigArgs.builder();
