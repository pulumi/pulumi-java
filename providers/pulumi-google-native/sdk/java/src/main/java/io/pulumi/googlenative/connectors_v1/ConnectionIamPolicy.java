...
import io.pulumi.googlenative.connectors_v1.ConnectionIamPolicyArgs;
...
public class ConnectionIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.connectors_v1.ConnectionIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.connectors_v1.ConnectionIamPolicyArgs.builder();
    ...
    public ConnectionIamPolicy(String name, ConnectionIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:connectors/v1:ConnectionIamPolicy", name, args == null ? ConnectionIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
