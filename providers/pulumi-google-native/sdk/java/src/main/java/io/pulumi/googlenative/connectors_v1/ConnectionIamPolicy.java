...
public class ConnectionIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public ConnectionIamPolicy(String name, ConnectionIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:connectors/v1:ConnectionIamPolicy", name, args == null ? ConnectionIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
     ...
     */
    public static ConnectionIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
