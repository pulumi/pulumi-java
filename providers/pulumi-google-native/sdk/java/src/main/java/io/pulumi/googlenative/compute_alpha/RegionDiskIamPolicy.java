 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:RegionDiskIamPolicy")
public class RegionDiskIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.RegionDiskIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.RegionDiskIamPolicyArgs.builder();
    ...
    public RegionDiskIamPolicy(String name, RegionDiskIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionDiskIamPolicy", name, args == null ? RegionDiskIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private RegionDiskIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionDiskIamPolicy", name, null, makeResourceOptions(options, id));
    }
