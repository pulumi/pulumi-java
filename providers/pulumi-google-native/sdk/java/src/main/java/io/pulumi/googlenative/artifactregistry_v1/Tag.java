...
public class Tag extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.artifactregistry_v1.TagArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.artifactregistry_v1.TagArgs.builder();
    ...
    public Tag(String name, TagArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:artifactregistry/v1:Tag", name, args == null ? TagArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
