...
public class EndpointPolicyIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public EndpointPolicyIamPolicy(String name, EndpointPolicyIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1beta1:EndpointPolicyIamPolicy", name, args == null ? EndpointPolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private EndpointPolicyIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static EndpointPolicyIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
