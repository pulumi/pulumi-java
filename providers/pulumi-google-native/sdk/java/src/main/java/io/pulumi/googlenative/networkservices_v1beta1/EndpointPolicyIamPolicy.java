...
import io.pulumi.googlenative.networkservices_v1beta1.EndpointPolicyIamPolicyArgs;
import io.pulumi.googlenative.networkservices_v1beta1.outputs.AuditConfigResponse;
import io.pulumi.googlenative.networkservices_v1beta1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:networkservices/v1beta1:EndpointPolicyIamPolicy")
public class EndpointPolicyIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    private static io.pulumi.googlenative.networkservices_v1beta1.EndpointPolicyIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.networkservices_v1beta1.EndpointPolicyIamPolicyArgs.builder();
     ...
     */
    public EndpointPolicyIamPolicy(String name, EndpointPolicyIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1beta1:EndpointPolicyIamPolicy", name, args == null ? EndpointPolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private EndpointPolicyIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1beta1:EndpointPolicyIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static EndpointPolicyIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        return new EndpointPolicyIamPolicy(name, id, options);
    }
}
