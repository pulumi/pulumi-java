...
public class License extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable LicenseArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.LicenseArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.LicenseArgs.builder();
