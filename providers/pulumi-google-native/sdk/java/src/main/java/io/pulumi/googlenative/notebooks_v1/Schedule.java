...
public class Schedule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.notebooks_v1.ScheduleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.notebooks_v1.ScheduleArgs.builder();
