...
import io.pulumi.googlenative.compute_beta.RegionDiskArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:RegionDisk")
public class RegionDisk extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.RegionDiskArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.RegionDiskArgs.builder();
    ...
    public RegionDisk(String name, RegionDiskArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionDisk", name, args == null ? RegionDiskArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private RegionDisk(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionDisk", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static RegionDisk get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
