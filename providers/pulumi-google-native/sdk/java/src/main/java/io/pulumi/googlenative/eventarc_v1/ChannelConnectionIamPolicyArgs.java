...
import io.pulumi.googlenative.eventarc_v1.inputs.AuditConfigArgs;
import io.pulumi.googlenative.eventarc_v1.inputs.BindingArgs;
...
public final class ChannelConnectionIamPolicyArgs extends io.pulumi.resources.ResourceArgs {

    public static final ChannelConnectionIamPolicyArgs Empty = new ChannelConnectionIamPolicyArgs();
    ...
    private final Input<String> channelConnectionId;

    public Input<String> getChannelConnectionId() {
    ...
    private ChannelConnectionIamPolicyArgs() {
        this.auditConfigs = Input.empty();
        this.bindings = Input.empty();
        this.channelConnectionId = Input.empty();
    ...
    public static Builder builder(ChannelConnectionIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        private Input<String> channelConnectionId;
        ...
        public Builder(ChannelConnectionIamPolicyArgs defaults) {
        ...
        public Builder setChannelConnectionId(Input<String> channelConnectionId) {
            this.channelConnectionId = Objects.requireNonNull(channelConnectionId);
            return this;
        }

        public Builder setChannelConnectionId(String channelConnectionId) {
            this.channelConnectionId = Input.of(Objects.requireNonNull(channelConnectionId));
            return this;
        }
        ...
        public ChannelConnectionIamPolicyArgs build() {
            return new ChannelConnectionIamPolicyArgs(auditConfigs, bindings, channelConnectionId, etag, location, project, updateMask, version);
        }
    }
}
