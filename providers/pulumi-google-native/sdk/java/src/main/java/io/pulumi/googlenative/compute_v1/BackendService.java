...
public class BackendService extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.BackendServiceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.BackendServiceArgs.builder();
