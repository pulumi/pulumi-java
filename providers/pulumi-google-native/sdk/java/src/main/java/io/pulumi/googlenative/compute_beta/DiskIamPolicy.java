...
public class DiskIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public DiskIamPolicy(String name, DiskIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:DiskIamPolicy", name, args == null ? DiskIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private DiskIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static DiskIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
