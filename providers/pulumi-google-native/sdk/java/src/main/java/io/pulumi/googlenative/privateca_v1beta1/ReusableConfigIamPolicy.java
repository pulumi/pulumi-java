...
public class ReusableConfigIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public ReusableConfigIamPolicy(String name) {
        super("google-native:privateca/v1beta1:ReusableConfigIamPolicy", name, ReusableConfigIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public ReusableConfigIamPolicy(String name, ReusableConfigIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:privateca/v1beta1:ReusableConfigIamPolicy", name, args == null ? ReusableConfigIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ReusableConfigIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ReusableConfigIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
