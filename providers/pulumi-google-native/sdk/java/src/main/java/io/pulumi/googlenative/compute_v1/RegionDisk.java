...
public class RegionDisk extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_v1.RegionDiskArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.RegionDiskArgs.builder();
    ...
    public RegionDisk(String name, RegionDiskArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:RegionDisk", name, args == null ? RegionDiskArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
