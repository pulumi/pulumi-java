...
import io.pulumi.googlenative.compute_beta.ServiceAttachmentIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:ServiceAttachmentIamPolicy")
public class ServiceAttachmentIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_beta.ServiceAttachmentIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.ServiceAttachmentIamPolicyArgs.builder();
    ...
    public ServiceAttachmentIamPolicy(String name, ServiceAttachmentIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:ServiceAttachmentIamPolicy", name, args == null ? ServiceAttachmentIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private ServiceAttachmentIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:ServiceAttachmentIamPolicy", name, null, makeResourceOptions(options, id));
    }
