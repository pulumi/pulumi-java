...
public class Provider extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.iam_v1.ProviderArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.iam_v1.ProviderArgs.builder();
