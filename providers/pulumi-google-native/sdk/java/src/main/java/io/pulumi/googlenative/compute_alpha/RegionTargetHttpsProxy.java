...
import io.pulumi.googlenative.compute_alpha.RegionTargetHttpsProxyArgs;
...
public class RegionTargetHttpsProxy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.compute_alpha.RegionTargetHttpsProxyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.RegionTargetHttpsProxyArgs.builder();
    ...
    public RegionTargetHttpsProxy(String name, RegionTargetHttpsProxyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionTargetHttpsProxy", name, args == null ? RegionTargetHttpsProxyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
