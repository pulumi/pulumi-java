...
public class HealthCheck extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable HealthCheckArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_beta.HealthCheckArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_beta.HealthCheckArgs.builder();
