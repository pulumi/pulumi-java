...
import io.pulumi.googlenative.gkehub_v1beta.FeatureIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:gkehub/v1beta:FeatureIamPolicy")
public class FeatureIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.gkehub_v1beta.FeatureIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.gkehub_v1beta.FeatureIamPolicyArgs.builder();
    ...
    public FeatureIamPolicy(String name, FeatureIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkehub/v1beta:FeatureIamPolicy", name, args == null ? FeatureIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private FeatureIamPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:gkehub/v1beta:FeatureIamPolicy", name, null, makeResourceOptions(options, id));
    }
