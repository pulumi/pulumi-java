...
public class DicomStore extends io.pulumi.resources.CustomResource {
    ...
    public DicomStore(String name) {
        super("google-native:healthcare/v1beta1:DicomStore", name, DicomStoreArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public DicomStore(String name, DicomStoreArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:healthcare/v1beta1:DicomStore", name, args == null ? DicomStoreArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
