...
public class RegionHealthCheck extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RegionHealthCheckArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_v1.RegionHealthCheckArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_v1.RegionHealthCheckArgs.builder();
     ...
     */
    public RegionHealthCheck(String name, BuilderApplicator argsBuilder) {
