...
public class ObjectAccessControl extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="projectTeam", type=ObjectAccessControlProjectTeamResponse.class, parameters={})
    ...
    private static io.pulumi.googlenative.storage_v1.ObjectAccessControlArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.storage_v1.ObjectAccessControlArgs.builder();
    ...
    public ObjectAccessControl(String name, ObjectAccessControlArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:storage/v1:ObjectAccessControl", name, args == null ? ObjectAccessControlArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ObjectAccessControl(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ObjectAccessControl get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
