...
public class Task extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    public Output<Integer> getDispatchCount() {
     ...
     * 
     */
    public Output<AttemptResponse> getFirstAttempt() {
     ...
     * 
     */
    public Output<HttpRequestResponse> getHttpRequest() {
     ...
     * 
     */
    public Output<AttemptResponse> getLastAttempt() {
     ...
     * 
     */
    public Output<Integer> getResponseCount() {
    ...
    private static io.pulumi.googlenative.cloudtasks_v2beta3.TaskArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.cloudtasks_v2beta3.TaskArgs.builder();
    ...
    public Task(String name, TaskArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudtasks/v2beta3:Task", name, args == null ? TaskArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
