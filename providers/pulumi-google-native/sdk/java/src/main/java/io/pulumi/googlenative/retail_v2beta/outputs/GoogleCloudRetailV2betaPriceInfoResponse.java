...
import io.pulumi.googlenative.retail_v2beta.outputs.GoogleCloudRetailV2betaPriceInfoPriceRangeResponse;
...
public final class GoogleCloudRetailV2betaPriceInfoResponse {
    ...
    private GoogleCloudRetailV2betaPriceInfoResponse(
        ...
        @OutputCustomType.Parameter("priceRange") GoogleCloudRetailV2betaPriceInfoPriceRangeResponse priceRange) {
        this.cost = cost;
