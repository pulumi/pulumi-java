...
import io.pulumi.googlenative.metastore_v1alpha.ServiceBackupIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:metastore/v1alpha:ServiceBackupIamPolicy")
public class ServiceBackupIamPolicy extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(ServiceBackupIamPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.metastore_v1alpha.ServiceBackupIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.metastore_v1alpha.ServiceBackupIamPolicyArgs.builder();
     ...
     */
    public ServiceBackupIamPolicy(String name, BuilderApplicator argsBuilder) {
     ...
     * @param name The _unique_ name of the resulting resource.
     */
    public ServiceBackupIamPolicy(String name) {
        this(name, ServiceBackupIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ServiceBackupIamPolicy(String name, ServiceBackupIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
    ...
    public ServiceBackupIamPolicy(String name, ServiceBackupIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1alpha:ServiceBackupIamPolicy", name, args == null ? ServiceBackupIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ServiceBackupIamPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1alpha:ServiceBackupIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ServiceBackupIamPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
