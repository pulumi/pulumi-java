...
public class ServiceBackupIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public ServiceBackupIamPolicy(String name, ServiceBackupIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1alpha:ServiceBackupIamPolicy", name, args == null ? ServiceBackupIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
     ...
     */
    public static ServiceBackupIamPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
