...
public class EndpointPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.networkservices_v1beta1.EndpointPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.networkservices_v1beta1.EndpointPolicyArgs.builder();
    ...
    public EndpointPolicy(String name, EndpointPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1beta1:EndpointPolicy", name, args == null ? EndpointPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
