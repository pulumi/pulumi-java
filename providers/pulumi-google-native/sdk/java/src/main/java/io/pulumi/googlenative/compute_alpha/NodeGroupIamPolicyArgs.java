...
public final class NodeGroupIamPolicyArgs extends io.pulumi.resources.ResourceArgs {

    public static final NodeGroupIamPolicyArgs Empty = new NodeGroupIamPolicyArgs();
