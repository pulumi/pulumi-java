...
public class OrganizationSecurityPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable OrganizationSecurityPolicyArgs.Builder a);
    }
    private static io.pulumi.googlenative.compute_alpha.OrganizationSecurityPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.compute_alpha.OrganizationSecurityPolicyArgs.builder();
    ...
    public OrganizationSecurityPolicy(String name, @Nullable OrganizationSecurityPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:OrganizationSecurityPolicy", name, args == null ? OrganizationSecurityPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private OrganizationSecurityPolicy(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static OrganizationSecurityPolicy get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
