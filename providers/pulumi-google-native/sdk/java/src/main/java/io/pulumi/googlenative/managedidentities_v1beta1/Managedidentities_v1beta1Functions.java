...
public final class Managedidentities_v1beta1Functions {
     ...
     * 
     */
    public static CompletableFuture<GetBackupResult> getBackup(io.pulumi.googlenative.managedidentities_v1beta1.inputs.GetBackupArgs args) {
        return getBackup(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetBackupResult> getBackup(io.pulumi.googlenative.managedidentities_v1beta1.inputs.GetBackupArgs args, InvokeOptions options) {
     ...
     * 
     */
    public static CompletableFuture<GetDomainResult> getDomain(io.pulumi.googlenative.managedidentities_v1beta1.inputs.GetDomainArgs args) {
        return getDomain(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetDomainResult> getDomain(io.pulumi.googlenative.managedidentities_v1beta1.inputs.GetDomainArgs args, InvokeOptions options) {
     ...
     * 
     */
    public static CompletableFuture<GetDomainBackupIamPolicyResult> getDomainBackupIamPolicy(io.pulumi.googlenative.managedidentities_v1beta1.inputs.GetDomainBackupIamPolicyArgs args) {
        return getDomainBackupIamPolicy(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetDomainBackupIamPolicyResult> getDomainBackupIamPolicy(io.pulumi.googlenative.managedidentities_v1beta1.inputs.GetDomainBackupIamPolicyArgs args, InvokeOptions options) {
     ...
     * 
     */
    public static CompletableFuture<GetDomainIamPolicyResult> getDomainIamPolicy(io.pulumi.googlenative.managedidentities_v1beta1.inputs.GetDomainIamPolicyArgs args) {
        return getDomainIamPolicy(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetDomainIamPolicyResult> getDomainIamPolicy(io.pulumi.googlenative.managedidentities_v1beta1.inputs.GetDomainIamPolicyArgs args, InvokeOptions options) {
     ...
     * 
     */
    public static CompletableFuture<GetPeeringResult> getPeering(io.pulumi.googlenative.managedidentities_v1beta1.inputs.GetPeeringArgs args) {
        return getPeering(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetPeeringResult> getPeering(io.pulumi.googlenative.managedidentities_v1beta1.inputs.GetPeeringArgs args, InvokeOptions options) {
     ...
     * 
     */
    public static CompletableFuture<GetPeeringIamPolicyResult> getPeeringIamPolicy(io.pulumi.googlenative.managedidentities_v1beta1.inputs.GetPeeringIamPolicyArgs args) {
        return getPeeringIamPolicy(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetPeeringIamPolicyResult> getPeeringIamPolicy(io.pulumi.googlenative.managedidentities_v1beta1.inputs.GetPeeringIamPolicyArgs args, InvokeOptions options) {
