...
public class Processor extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable ProcessorArgs.Builder a);
    }
    private static io.pulumi.googlenative.documentai_v1beta3.ProcessorArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.documentai_v1beta3.ProcessorArgs.builder();
     ...
     */
    public Processor(String name, BuilderApplicator argsBuilder) {
