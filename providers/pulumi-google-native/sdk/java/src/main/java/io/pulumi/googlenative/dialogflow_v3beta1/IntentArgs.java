...
public final class IntentArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Output<List<GoogleCloudDialogflowCxV3beta1IntentParameterArgs>> parameters() {
    ...
    public Output<List<GoogleCloudDialogflowCxV3beta1IntentTrainingPhraseArgs>> trainingPhrases() {
    ...
    public IntentArgs(
        ...
        @Nullable Output<List<GoogleCloudDialogflowCxV3beta1IntentParameterArgs>> parameters,
        @Nullable Output<Integer> priority,
        @Nullable Output<String> project,
        @Nullable Output<List<GoogleCloudDialogflowCxV3beta1IntentTrainingPhraseArgs>> trainingPhrases) {
