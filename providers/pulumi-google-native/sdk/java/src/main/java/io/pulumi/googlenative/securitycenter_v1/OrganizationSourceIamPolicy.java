...
import io.pulumi.googlenative.securitycenter_v1.outputs.BindingResponse;
...
public class OrganizationSourceIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.googlenative.securitycenter_v1.OrganizationSourceIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.googlenative.securitycenter_v1.OrganizationSourceIamPolicyArgs.builder();
    ...
    public OrganizationSourceIamPolicy(String name, OrganizationSourceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("google-native:securitycenter/v1:OrganizationSourceIamPolicy", name, args == null ? OrganizationSourceIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
