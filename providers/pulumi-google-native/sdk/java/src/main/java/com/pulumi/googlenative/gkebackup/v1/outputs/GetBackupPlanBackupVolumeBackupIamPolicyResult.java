...
import com.pulumi.googlenative.gkebackup.v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.gkebackup.v1.outputs.BindingResponse;
...
@CustomType
public final class GetBackupPlanBackupVolumeBackupIamPolicyResult {
    /**
    ...
    private GetBackupPlanBackupVolumeBackupIamPolicyResult(
    ...
    public static Builder builder(GetBackupPlanBackupVolumeBackupIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetBackupPlanBackupVolumeBackupIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetBackupPlanBackupVolumeBackupIamPolicyResult build() {
            return new GetBackupPlanBackupVolumeBackupIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
