...
public final class ServiceConsumerIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="consumerId", required=true)
      private final Output<String> consumerId;
    ...
    public static final class Builder {
        ...
        public Builder consumerId(String consumerId) {
            this.consumerId = Output.of(Objects.requireNonNull(consumerId));
            return this;
        }
