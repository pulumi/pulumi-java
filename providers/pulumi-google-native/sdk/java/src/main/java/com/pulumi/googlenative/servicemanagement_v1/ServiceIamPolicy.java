...
import com.pulumi.googlenative.servicemanagement_v1.ServiceIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:servicemanagement/v1:ServiceIamPolicy")
public class ServiceIamPolicy extends CustomResource {
    /**
     ...
     */
    public ServiceIamPolicy(String name, ServiceIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:servicemanagement/v1:ServiceIamPolicy", name, args == null ? ServiceIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ServiceIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:servicemanagement/v1:ServiceIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ServiceIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        return new ServiceIamPolicy(name, id, options);
    }
}
