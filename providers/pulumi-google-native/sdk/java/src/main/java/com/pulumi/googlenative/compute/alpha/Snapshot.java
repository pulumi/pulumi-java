...
import com.pulumi.googlenative.compute.alpha.SnapshotArgs;
...
public class Snapshot extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="creationSizeBytes", type=String.class, parameters={})
    private Output<String> creationSizeBytes;

    /**
     * @return Size in bytes of the snapshot at creation time.
     * 
     */
    public Output<String> creationSizeBytes() {
