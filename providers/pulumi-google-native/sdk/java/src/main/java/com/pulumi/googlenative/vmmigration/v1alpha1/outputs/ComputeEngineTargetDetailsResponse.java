...
public final class ComputeEngineTargetDetailsResponse {
    ...
    public static final class Builder {
        ...
        public Builder zone(String zone) {
            ...
            return new ComputeEngineTargetDetailsResponse(additionalLicenses, appliedLicense, bootOption, computeScheduling, diskType, hostname, labels, licenseType, machineType, machineTypeSeries, metadata, networkInterfaces, networkTags, project, secureBoot, serviceAccount, vmName, zone);
        }
    }
}
