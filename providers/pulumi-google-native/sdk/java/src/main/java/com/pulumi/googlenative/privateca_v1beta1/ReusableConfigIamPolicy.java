...
import com.pulumi.googlenative.privateca_v1beta1.ReusableConfigIamPolicyArgs;
...
public class ReusableConfigIamPolicy extends CustomResource {
    /**
     ...
     */
    public ReusableConfigIamPolicy(String name, ReusableConfigIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReusableConfigIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReusableConfigIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
