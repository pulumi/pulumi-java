...
import com.pulumi.googlenative.retail_v2alpha.inputs.GetControlPlainArgs;
import com.pulumi.googlenative.retail_v2alpha.inputs.GetProductArgs;
import com.pulumi.googlenative.retail_v2alpha.inputs.GetProductPlainArgs;
import com.pulumi.googlenative.retail_v2alpha.inputs.GetServingConfigArgs;
import com.pulumi.googlenative.retail_v2alpha.inputs.GetServingConfigPlainArgs;
...
public final class Retail_v2alphaFunctions {
    ...
    public static Output<GetControlResult> getControl(GetControlArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:retail/v2alpha:getControl", TypeShape.of(GetControlResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets a Control.
     * 
    ...
    public static Output<GetProductResult> getProduct(GetProductArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:retail/v2alpha:getProduct", TypeShape.of(GetProductResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets a Product.
     * 
    ...
    public static Output<GetServingConfigResult> getServingConfig(GetServingConfigArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:retail/v2alpha:getServingConfig", TypeShape.of(GetServingConfigResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets a ServingConfig. Returns a NotFound error if the ServingConfig does not exist.
     * 
