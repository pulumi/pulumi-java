...
import com.pulumi.googlenative.datacatalog_v1.TaxonomyArgs;
...
public class Taxonomy extends CustomResource {
    /**
     ...
     */
    public Taxonomy(String name, TaxonomyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Taxonomy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Taxonomy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
