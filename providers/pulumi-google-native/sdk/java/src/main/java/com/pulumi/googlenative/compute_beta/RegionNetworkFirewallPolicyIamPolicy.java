...
import com.pulumi.googlenative.compute_beta.RegionNetworkFirewallPolicyIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:RegionNetworkFirewallPolicyIamPolicy")
public class RegionNetworkFirewallPolicyIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public RegionNetworkFirewallPolicyIamPolicy(String name, RegionNetworkFirewallPolicyIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionNetworkFirewallPolicyIamPolicy", name, args == null ? RegionNetworkFirewallPolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private RegionNetworkFirewallPolicyIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionNetworkFirewallPolicyIamPolicy", name, null, makeResourceOptions(options, id));
    }
