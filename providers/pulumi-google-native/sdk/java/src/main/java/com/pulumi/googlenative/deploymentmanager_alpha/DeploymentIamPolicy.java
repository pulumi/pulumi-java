...
import com.pulumi.googlenative.deploymentmanager_alpha.DeploymentIamPolicyArgs;
import com.pulumi.googlenative.deploymentmanager_alpha.outputs.AuditConfigResponse;
import com.pulumi.googlenative.deploymentmanager_alpha.outputs.BindingResponse;
...
public class DeploymentIamPolicy extends CustomResource {
    ...
    public DeploymentIamPolicy(String name, DeploymentIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:deploymentmanager/alpha:DeploymentIamPolicy", name, args == null ? DeploymentIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
