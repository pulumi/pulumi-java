 ...
 * 
 */
public final class GoogleCloudRetailV2alphaImageArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GoogleCloudRetailV2alphaImageArgs(GoogleCloudRetailV2alphaImageArgs $) {
        this.height = $.height;
        this.uri = $.uri;
        this.width = $.width;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleCloudRetailV2alphaImageArgs();
        }

        public Builder(GoogleCloudRetailV2alphaImageArgs defaults) {
            $ = new GoogleCloudRetailV2alphaImageArgs(Objects.requireNonNull(defaults));
        }
