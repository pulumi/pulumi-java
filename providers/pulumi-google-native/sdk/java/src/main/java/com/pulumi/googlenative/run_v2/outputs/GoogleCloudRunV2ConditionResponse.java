...
public final class GoogleCloudRunV2ConditionResponse {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            ...
            return new GoogleCloudRunV2ConditionResponse(domainMappingReason, executionReason, internalReason, lastTransitionTime, message, reason, revisionReason, severity, state, type);
        }
    }
}
