...
import com.pulumi.googlenative.dialogflow_v2.ContextArgs;
...
public class Context extends CustomResource {
    /**
     ...
     */
    public Context(String name, ContextArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Context(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Context get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
