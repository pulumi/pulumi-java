...
import com.pulumi.googlenative.compute_alpha.enums.DiskInterface;
import com.pulumi.googlenative.compute_alpha.enums.DiskStorageType;
...
public final class DiskArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<DiskArchitecture>> architecture() {
    ...
    private @Nullable Output<DiskInterface> interface_;
     ...
     */
    @Deprecated /* [Deprecated] Specifies the disk interface to use for attaching this disk, which is either SCSI or NVME. The default is SCSI. */
    public Optional<Output<DiskInterface>> interface_() {
    ...
    private @Nullable Output<DiskStorageType> storageType;
     ...
     */
    @Deprecated /* [Deprecated] Storage type of the persistent disk. */
    public Optional<Output<DiskStorageType>> storageType() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder architecture(DiskArchitecture architecture) {
         ...
         */
        @Deprecated /* [Deprecated] Specifies the disk interface to use for attaching this disk, which is either SCSI or NVME. The default is SCSI. */
        public Builder interface_(@Nullable Output<DiskInterface> interface_) {
         ...
         */
        @Deprecated /* [Deprecated] Specifies the disk interface to use for attaching this disk, which is either SCSI or NVME. The default is SCSI. */
        public Builder interface_(DiskInterface interface_) {
        ...
        /**
         * @param sourceInstantSnapshot The source instant snapshot used to create this disk. You can provide this as a partial or full URL to the resource. For example, the following are valid values: - https://www.googleapis.com/compute/v1/projects/project/zones/zone /instantSnapshots/instantSnapshot - projects/project/zones/zone/instantSnapshots/instantSnapshot - zones/zone/instantSnapshots/instantSnapshot
         * 
         * @return builder
         * 
         */
         ...
         */
        @Deprecated /* [Deprecated] Storage type of the persistent disk. */
        public Builder storageType(@Nullable Output<DiskStorageType> storageType) {
