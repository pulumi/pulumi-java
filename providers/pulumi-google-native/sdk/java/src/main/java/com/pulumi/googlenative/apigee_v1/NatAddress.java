...
import com.pulumi.googlenative.apigee_v1.NatAddressArgs;
...
public class NatAddress extends CustomResource {
    /**
     ...
     */
    public NatAddress(String name, NatAddressArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NatAddress(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NatAddress get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
