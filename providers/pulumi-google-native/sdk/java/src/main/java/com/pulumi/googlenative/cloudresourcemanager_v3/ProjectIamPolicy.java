...
import com.pulumi.googlenative.cloudresourcemanager_v3.ProjectIamPolicyArgs;
...
public class ProjectIamPolicy extends CustomResource {
    /**
     ...
     */
    public ProjectIamPolicy(String name, @Nullable ProjectIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProjectIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProjectIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
