...
public class AndroidApp extends CustomResource {
    /**
     ...
     */
    public AndroidApp(String name, @Nullable AndroidAppArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AndroidApp(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AndroidApp get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
