...
public class AlertPolicy extends CustomResource {
     ...
     */
    public AlertPolicy(String name, @Nullable AlertPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AlertPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AlertPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
