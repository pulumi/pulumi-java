...
public class IssueModel extends CustomResource {
    /**
     ...
     */
    public IssueModel(String name, @Nullable IssueModelArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IssueModel(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IssueModel get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
