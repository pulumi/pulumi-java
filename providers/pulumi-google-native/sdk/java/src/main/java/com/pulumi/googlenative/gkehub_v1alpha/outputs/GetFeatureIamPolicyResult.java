...
import com.pulumi.googlenative.gkehub_v1alpha.outputs.AuditConfigResponse;
import com.pulumi.googlenative.gkehub_v1alpha.outputs.BindingResponse;
...
@CustomType
public final class GetFeatureIamPolicyResult {
        /**
    ...
    public static Builder builder(GetFeatureIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetFeatureIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetFeatureIamPolicyResult build() {
            return new GetFeatureIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
