...
public class BillingAccountSink extends CustomResource {
    /**
     ...
     */
    public BillingAccountSink(String name, BillingAccountSinkArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BillingAccountSink(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BillingAccountSink get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
