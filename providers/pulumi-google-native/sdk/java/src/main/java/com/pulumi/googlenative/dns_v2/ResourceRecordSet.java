...
package com.pulumi.googlenative.dns_v2;
...
import com.pulumi.googlenative.dns_v2.ResourceRecordSetArgs;
import com.pulumi.googlenative.dns_v2.outputs.RRSetRoutingPolicyResponse;
 ...
 * 
 */
@ResourceType(type="google-native:dns/v2:ResourceRecordSet")
public class ResourceRecordSet extends com.pulumi.resources.CustomResource {
    ...
    public ResourceRecordSet(String name, ResourceRecordSetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dns/v2:ResourceRecordSet", name, args == null ? ResourceRecordSetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ResourceRecordSet(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dns/v2:ResourceRecordSet", name, null, makeResourceOptions(options, id));
    }
