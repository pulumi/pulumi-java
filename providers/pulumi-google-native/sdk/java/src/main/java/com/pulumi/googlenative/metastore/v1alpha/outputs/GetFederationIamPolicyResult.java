...
import com.pulumi.googlenative.metastore.v1alpha.outputs.AuditConfigResponse;
import com.pulumi.googlenative.metastore.v1alpha.outputs.BindingResponse;
...
@CustomType
public final class GetFederationIamPolicyResult {
    /**
    ...
    private GetFederationIamPolicyResult(
    ...
    public static Builder builder(GetFederationIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetFederationIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetFederationIamPolicyResult build() {
            return new GetFederationIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
