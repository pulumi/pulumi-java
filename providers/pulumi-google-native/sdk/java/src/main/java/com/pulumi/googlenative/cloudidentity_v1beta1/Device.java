...
import com.pulumi.googlenative.cloudidentity_v1beta1.DeviceArgs;
import com.pulumi.googlenative.cloudidentity_v1beta1.outputs.AndroidAttributesResponse;
import com.pulumi.googlenative.cloudidentity_v1beta1.outputs.EndpointVerificationSpecificAttributesResponse;
...
public class Device extends CustomResource {
     ...
     * 
     */
    public Output<AndroidAttributesResponse> androidSpecificAttributes() {
     ...
     * 
     */
    public Output<EndpointVerificationSpecificAttributesResponse> endpointVerificationSpecificAttributes() {
     ...
     */
    public Device(String name, @Nullable DeviceArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:cloudidentity/v1beta1:Device", name, args == null ? DeviceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
