 ...
 * 
 */
public final class GoogleCloudRetailV2betaColorInfoArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GoogleCloudRetailV2betaColorInfoArgs(GoogleCloudRetailV2betaColorInfoArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleCloudRetailV2betaColorInfoArgs();
        }

        public Builder(GoogleCloudRetailV2betaColorInfoArgs defaults) {
            $ = new GoogleCloudRetailV2betaColorInfoArgs(Objects.requireNonNull(defaults));
        }
