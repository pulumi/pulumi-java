...
import com.pulumi.googlenative.containeranalysis_v1.OccurrenceIamPolicyArgs;
import com.pulumi.googlenative.containeranalysis_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:containeranalysis/v1:OccurrenceIamPolicy")
public class OccurrenceIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public OccurrenceIamPolicy(String name, OccurrenceIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:containeranalysis/v1:OccurrenceIamPolicy", name, args == null ? OccurrenceIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private OccurrenceIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:containeranalysis/v1:OccurrenceIamPolicy", name, null, makeResourceOptions(options, id));
    }
