...
public final class BackupArgs extends ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param sourceInstance The resource name of the source Cloud Filestore instance, in the format `projects/{project_number}/locations/{location_id}/instances/{instance_id}`, used to create this backup.
         * 
         * @return builder
         * 
         */
