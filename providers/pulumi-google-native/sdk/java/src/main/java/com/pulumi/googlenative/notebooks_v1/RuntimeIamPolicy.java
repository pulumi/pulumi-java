...
public class RuntimeIamPolicy extends CustomResource {
    ...
    private RuntimeIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RuntimeIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
