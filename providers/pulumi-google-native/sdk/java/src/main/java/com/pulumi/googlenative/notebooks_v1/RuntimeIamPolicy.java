...
import com.pulumi.googlenative.notebooks_v1.RuntimeIamPolicyArgs;
import com.pulumi.googlenative.notebooks_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:notebooks/v1:RuntimeIamPolicy")
public class RuntimeIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public RuntimeIamPolicy(String name, RuntimeIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:notebooks/v1:RuntimeIamPolicy", name, args == null ? RuntimeIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RuntimeIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:notebooks/v1:RuntimeIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static RuntimeIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RuntimeIamPolicy(name, id, options);
    }
}
