...
import com.pulumi.googlenative.gkehub_v1alpha.FeatureIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:gkehub/v1alpha:FeatureIamPolicy")
public class FeatureIamPolicy extends CustomResource {
    /**
     ...
     */
    public FeatureIamPolicy(String name, FeatureIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:gkehub/v1alpha:FeatureIamPolicy", name, args == null ? FeatureIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FeatureIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:gkehub/v1alpha:FeatureIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static FeatureIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
