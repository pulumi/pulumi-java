...
import com.pulumi.googlenative.dialogflow_v2.ConversationArgs;
...
public class Conversation extends CustomResource {
     ...
     * 
     */
    public Output<GoogleCloudDialogflowV2ConversationPhoneNumberResponse> phoneNumber() {
     ...
     */
    public Conversation(String name, ConversationArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:dialogflow/v2:Conversation", name, args == null ? ConversationArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
