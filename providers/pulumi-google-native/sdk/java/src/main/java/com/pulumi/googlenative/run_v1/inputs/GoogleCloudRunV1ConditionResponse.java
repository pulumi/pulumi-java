 ...
 * 
 */
public final class GoogleCloudRunV1ConditionResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private GoogleCloudRunV1ConditionResponse(GoogleCloudRunV1ConditionResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleCloudRunV1ConditionResponse();
        }

        public Builder(GoogleCloudRunV1ConditionResponse defaults) {
            $ = new GoogleCloudRunV1ConditionResponse(Objects.requireNonNull(defaults));
        }
