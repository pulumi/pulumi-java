...
import com.pulumi.googlenative.notebooks_v1.InstanceIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:notebooks/v1:InstanceIamPolicy")
public class InstanceIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public InstanceIamPolicy(String name, InstanceIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:notebooks/v1:InstanceIamPolicy", name, args == null ? InstanceIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private InstanceIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:notebooks/v1:InstanceIamPolicy", name, null, makeResourceOptions(options, id));
    }
