...
public final class GetCutoverJobResult {
     ...
     * 
     */
    private final List<CutoverStepResponse> steps;
    /**
    ...
    private GetCutoverJobResult(
        ...
        @CustomType.Parameter("steps") List<CutoverStepResponse> steps,
    ...
    public static final class Builder {
        ...
        public Builder targetDetails(TargetVMDetailsResponse targetDetails) {
            ...
            return new GetCutoverJobResult(computeEngineTargetDetails, computeEngineVmDetails, createTime, endTime, error, name, progress, progressPercent, state, stateMessage, stateTime, steps, targetDetails);
        }
    }
}
