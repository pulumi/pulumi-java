...
@CustomType
public final class GetClientConnectorServiceIamPolicyResult {
    /**
    ...
    public static Builder builder(GetClientConnectorServiceIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetClientConnectorServiceIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetClientConnectorServiceIamPolicyResult build() {
            return new GetClientConnectorServiceIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
