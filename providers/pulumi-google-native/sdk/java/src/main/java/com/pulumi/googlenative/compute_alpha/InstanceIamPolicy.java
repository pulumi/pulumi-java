...
import com.pulumi.googlenative.compute_alpha.InstanceIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:InstanceIamPolicy")
public class InstanceIamPolicy extends CustomResource {
    ...
    public InstanceIamPolicy(String name, InstanceIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/alpha:InstanceIamPolicy", name, args == null ? InstanceIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private InstanceIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:compute/alpha:InstanceIamPolicy", name, null, makeResourceOptions(options, id));
    }
