...
import com.pulumi.googlenative.cloudasset_v1.SavedQueryArgs;
...
public class SavedQuery extends CustomResource {
    /**
     * The query content.
     * 
     */
     ...
     */
    public SavedQuery(String name, SavedQueryArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SavedQuery(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SavedQuery get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
