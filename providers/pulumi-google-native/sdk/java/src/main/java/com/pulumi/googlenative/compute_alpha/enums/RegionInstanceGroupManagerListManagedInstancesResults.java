...
import java.util.StringJoiner;
     ...
     */
    @EnumType
    public enum RegionInstanceGroupManagerListManagedInstancesResults {
        /**
        ...
        RegionInstanceGroupManagerListManagedInstancesResults(String value) {
        ...
        public String toString() {
            return new StringJoiner(", ", "RegionInstanceGroupManagerListManagedInstancesResults[", "]")
