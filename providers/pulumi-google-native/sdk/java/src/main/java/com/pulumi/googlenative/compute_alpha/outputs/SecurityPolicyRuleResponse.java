...
public final class SecurityPolicyRuleResponse {
     ...
     * 
     */
    private final String ruleManagedProtectionTier;
    /**
    ...
    private SecurityPolicyRuleResponse(
        ...
        @CustomType.Parameter("ruleManagedProtectionTier") String ruleManagedProtectionTier,
    ...
    public static final class Builder {
        ...
        public Builder targetServiceAccounts(String... targetServiceAccounts) {
            ...
            return new SecurityPolicyRuleResponse(action, description, direction, enableLogging, headerAction, kind, match, preview, priority, rateLimitOptions, redirectOptions, redirectTarget, ruleManagedProtectionTier, ruleNumber, ruleTupleCount, targetResources, targetServiceAccounts);
        }
    }
}
