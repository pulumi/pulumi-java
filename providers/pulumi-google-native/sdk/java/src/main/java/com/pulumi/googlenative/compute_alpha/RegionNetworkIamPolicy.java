...
public class RegionNetworkIamPolicy extends CustomResource {
    /**
     ...
     */
    public RegionNetworkIamPolicy(String name, RegionNetworkIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegionNetworkIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegionNetworkIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
