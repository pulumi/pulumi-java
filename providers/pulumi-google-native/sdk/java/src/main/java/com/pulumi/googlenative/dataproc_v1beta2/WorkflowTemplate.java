...
import com.pulumi.googlenative.dataproc_v1beta2.WorkflowTemplateArgs;
...
public class WorkflowTemplate extends CustomResource {
    ...
    private WorkflowTemplate(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkflowTemplate get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
