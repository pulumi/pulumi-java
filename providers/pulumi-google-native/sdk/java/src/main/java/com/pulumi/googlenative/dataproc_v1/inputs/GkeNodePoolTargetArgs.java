...
import com.pulumi.googlenative.dataproc_v1.enums.GkeNodePoolTargetRolesItem;
import com.pulumi.googlenative.dataproc_v1.inputs.GkeNodePoolConfigArgs;
...
public final class GkeNodePoolTargetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param nodePool The target GKE NodePool. Format: &#39;projects/{project}/locations/{location}/clusters/{cluster}/nodePools/{node_pool}&#39;
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param nodePoolConfig Input only. The configuration for the GKE NodePool.If specified, Dataproc attempts to create a NodePool with the specified shape. If one with the same name already exists, it is verified against all specified fields. If a field differs, the virtual cluster creation will fail.If omitted, any NodePool with the specified name is used. If a NodePool with the specified name does not exist, Dataproc create a NodePool with default values.This is an input only field. It will not be returned by the API.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param roles The types of role for a GKE NodePool
         * 
         * @return builder
         * 
         */
