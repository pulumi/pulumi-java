...
import com.pulumi.googlenative.compute_alpha.ReservationIamPolicyArgs;
...
public class ReservationIamPolicy extends CustomResource {
    /**
     ...
     */
    public ReservationIamPolicy(String name, ReservationIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReservationIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReservationIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
