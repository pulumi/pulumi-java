...
import com.pulumi.googlenative.datafusion_v1beta1.InstanceIamPolicyArgs;
...
public class InstanceIamPolicy extends CustomResource {
    ...
    public InstanceIamPolicy(String name, InstanceIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:datafusion/v1beta1:InstanceIamPolicy", name, args == null ? InstanceIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
