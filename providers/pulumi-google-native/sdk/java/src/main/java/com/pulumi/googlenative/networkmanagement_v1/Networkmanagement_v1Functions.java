...
import com.pulumi.googlenative.networkmanagement_v1.inputs.GetConnectivityTestArgs;
import com.pulumi.googlenative.networkmanagement_v1.inputs.GetConnectivityTestIamPolicyArgs;
import com.pulumi.googlenative.networkmanagement_v1.inputs.GetConnectivityTestIamPolicyPlainArgs;
import com.pulumi.googlenative.networkmanagement_v1.inputs.GetConnectivityTestPlainArgs;
import com.pulumi.googlenative.networkmanagement_v1.outputs.GetConnectivityTestIamPolicyResult;
import com.pulumi.googlenative.networkmanagement_v1.outputs.GetConnectivityTestResult;
import java.util.concurrent.CompletableFuture;

public final class Networkmanagement_v1Functions {
    /**
    ...
    public static Output<GetConnectivityTestResult> getConnectivityTest(GetConnectivityTestArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:networkmanagement/v1:getConnectivityTest", TypeShape.of(GetConnectivityTestResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the details of a specific Connectivity Test.
     * 
    ...
    public static Output<GetConnectivityTestIamPolicyResult> getConnectivityTestIamPolicy(GetConnectivityTestIamPolicyArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:networkmanagement/v1:getConnectivityTestIamPolicy", TypeShape.of(GetConnectivityTestIamPolicyResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
     * 
