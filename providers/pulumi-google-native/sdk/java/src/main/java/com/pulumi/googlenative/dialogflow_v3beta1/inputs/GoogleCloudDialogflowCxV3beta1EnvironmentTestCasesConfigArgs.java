 ...
 * 
 */
public final class GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfigArgs(GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfigArgs();
        }

        public Builder(GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfigArgs defaults) {
            $ = new GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfigArgs(Objects.requireNonNull(defaults));
        }
