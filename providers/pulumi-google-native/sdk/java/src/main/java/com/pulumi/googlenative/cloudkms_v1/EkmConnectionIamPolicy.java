...
import com.pulumi.googlenative.cloudkms_v1.EkmConnectionIamPolicyArgs;
...
public class EkmConnectionIamPolicy extends CustomResource {
    /**
     ...
     */
    public EkmConnectionIamPolicy(String name, EkmConnectionIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EkmConnectionIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EkmConnectionIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
