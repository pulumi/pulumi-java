...
import com.pulumi.googlenative.networkmanagement_v1beta1.inputs.AuditConfigArgs;
import com.pulumi.googlenative.networkmanagement_v1beta1.inputs.BindingArgs;
...
public final class ConnectivityTestIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ConnectivityTestIamPolicyArgs(ConnectivityTestIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectivityTestIamPolicyArgs();
        }

        public Builder(ConnectivityTestIamPolicyArgs defaults) {
            $ = new ConnectivityTestIamPolicyArgs(Objects.requireNonNull(defaults));
        }
