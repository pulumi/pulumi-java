...
import com.pulumi.googlenative.managedidentities_v1beta1.PeeringArgs;
...
public class Peering extends CustomResource {
    /**
     ...
     */
    public Peering(String name, PeeringArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Peering(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Peering get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
