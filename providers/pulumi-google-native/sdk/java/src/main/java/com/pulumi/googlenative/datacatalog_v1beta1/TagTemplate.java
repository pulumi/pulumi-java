...
import com.pulumi.googlenative.datacatalog_v1beta1.TagTemplateArgs;
...
public class TagTemplate extends CustomResource {
    ...
    private TagTemplate(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TagTemplate get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
