...
import com.pulumi.googlenative.compute_beta.RegionSecurityPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:RegionSecurityPolicy")
public class RegionSecurityPolicy extends com.pulumi.resources.CustomResource {
    ...
    public RegionSecurityPolicy(String name, RegionSecurityPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionSecurityPolicy", name, args == null ? RegionSecurityPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegionSecurityPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionSecurityPolicy", name, null, makeResourceOptions(options, id));
    }
