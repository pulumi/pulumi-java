...
import com.pulumi.googlenative.spanner_v1.inputs.BindingArgs;
...
public final class InstanceDatabaseIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceDatabaseIamPolicyArgs(InstanceDatabaseIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceDatabaseIamPolicyArgs();
        }

        public Builder(InstanceDatabaseIamPolicyArgs defaults) {
            $ = new InstanceDatabaseIamPolicyArgs(Objects.requireNonNull(defaults));
        }
