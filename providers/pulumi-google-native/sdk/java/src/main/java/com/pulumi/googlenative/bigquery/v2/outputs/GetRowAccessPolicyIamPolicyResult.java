...
import com.pulumi.googlenative.bigquery.v2.outputs.AuditConfigResponse;
import com.pulumi.googlenative.bigquery.v2.outputs.BindingResponse;
...
@CustomType
public final class GetRowAccessPolicyIamPolicyResult {
    /**
    ...
    private GetRowAccessPolicyIamPolicyResult(
    ...
    public static Builder builder(GetRowAccessPolicyIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetRowAccessPolicyIamPolicyResult defaults) {
