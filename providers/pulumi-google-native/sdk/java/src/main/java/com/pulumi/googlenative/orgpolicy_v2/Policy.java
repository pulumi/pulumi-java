...
import com.pulumi.googlenative.orgpolicy_v2.PolicyArgs;
...
public class Policy extends CustomResource {
     ...
     */
    public Policy(String name, @Nullable PolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:orgpolicy/v2:Policy", name, args == null ? PolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
