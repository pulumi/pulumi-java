...
import com.pulumi.googlenative.healthcare_v1.DatasetArgs;
...
public class Dataset extends CustomResource {
     ...
     */
    public Dataset(String name, @Nullable DatasetArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:healthcare/v1:Dataset", name, args == null ? DatasetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
