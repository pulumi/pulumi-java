...
import com.pulumi.googlenative.toolresults_v1beta3.PerfSampleSeriesArgs;
import com.pulumi.googlenative.toolresults_v1beta3.outputs.BasicPerfSampleSeriesResponse;
...
public class PerfSampleSeries extends CustomResource {
    /**
     ...
     */
    public PerfSampleSeries(String name, PerfSampleSeriesArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PerfSampleSeries(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PerfSampleSeries get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
