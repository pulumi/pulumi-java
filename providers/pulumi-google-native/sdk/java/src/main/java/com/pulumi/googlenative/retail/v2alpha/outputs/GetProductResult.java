...
import com.pulumi.googlenative.retail.v2alpha.outputs.GoogleCloudRetailV2alphaAudienceResponse;
import com.pulumi.googlenative.retail.v2alpha.outputs.GoogleCloudRetailV2alphaColorInfoResponse;
import com.pulumi.googlenative.retail.v2alpha.outputs.GoogleCloudRetailV2alphaFulfillmentInfoResponse;
import com.pulumi.googlenative.retail.v2alpha.outputs.GoogleCloudRetailV2alphaImageResponse;
import com.pulumi.googlenative.retail.v2alpha.outputs.GoogleCloudRetailV2alphaPriceInfoResponse;
import com.pulumi.googlenative.retail.v2alpha.outputs.GoogleCloudRetailV2alphaProductResponse;
import com.pulumi.googlenative.retail.v2alpha.outputs.GoogleCloudRetailV2alphaPromotionResponse;
import com.pulumi.googlenative.retail.v2alpha.outputs.GoogleCloudRetailV2alphaRatingResponse;
...
public final class GetProductResult {
    ...
    private GetProductResult(
        ...
        @CustomType.Parameter("audience") GoogleCloudRetailV2alphaAudienceResponse audience,
        ...
        @CustomType.Parameter("colorInfo") GoogleCloudRetailV2alphaColorInfoResponse colorInfo,
        @CustomType.Parameter("conditions") List<String> conditions,
        @CustomType.Parameter("description") String description,
        @CustomType.Parameter("expireTime") String expireTime,
        @CustomType.Parameter("fulfillmentInfo") List<GoogleCloudRetailV2alphaFulfillmentInfoResponse> fulfillmentInfo,
        @CustomType.Parameter("gtin") String gtin,
        @CustomType.Parameter("images") List<GoogleCloudRetailV2alphaImageResponse> images,
        ...
        @CustomType.Parameter("priceInfo") GoogleCloudRetailV2alphaPriceInfoResponse priceInfo,
        @CustomType.Parameter("primaryProductId") String primaryProductId,
        @CustomType.Parameter("promotions") List<GoogleCloudRetailV2alphaPromotionResponse> promotions,
        @CustomType.Parameter("publishTime") String publishTime,
        @CustomType.Parameter("rating") GoogleCloudRetailV2alphaRatingResponse rating,
        ...
        @CustomType.Parameter("variants") List<GoogleCloudRetailV2alphaProductResponse> variants) {
     ...
     * 
     */
    public GoogleCloudRetailV2alphaAudienceResponse audience() {
     ...
     * 
     */
    public GoogleCloudRetailV2alphaColorInfoResponse colorInfo() {
     ...
     * 
     */
    public List<GoogleCloudRetailV2alphaFulfillmentInfoResponse> fulfillmentInfo() {
     ...
     * 
     */
    public List<GoogleCloudRetailV2alphaImageResponse> images() {
        return this.images;
    }
    /**
     * @return Language of the title/description and other string attributes. Use language tags defined by [BCP 47](https://www.rfc-editor.org/rfc/bcp/bcp47.txt). For product prediction, this field is ignored and the model automatically detects the text language. The Product can include text in different languages, but duplicating Products to provide text in multiple languages can result in degraded model performance. For product search this field is in use. It defaults to &#34;en-US&#34; if unset.
     ...
     * 
     */
    public GoogleCloudRetailV2alphaPriceInfoResponse priceInfo() {
     ...
     * 
     */
    public List<GoogleCloudRetailV2alphaPromotionResponse> promotions() {
     ...
     * 
     */
    public GoogleCloudRetailV2alphaRatingResponse rating() {
        return this.rating;
    }
    /**
     * @return Indicates which fields in the Products are returned in SearchResponse. Supported fields for all types: * audience * availability * brands * color_info * conditions * gtin * materials * name * patterns * price_info * rating * sizes * title * uri Supported fields only for Type.PRIMARY and Type.COLLECTION: * categories * description * images Supported fields only for Type.VARIANT: * Only the first image in images To mark attributes as retrievable, include paths of the form &#34;attributes.key&#34; where &#34;key&#34; is the key of a custom attribute, as specified in attributes. For Type.PRIMARY and Type.COLLECTION, the following fields are always returned in SearchResponse by default: * name For Type.VARIANT, the following fields are always returned in by default: * name * color_info The maximum number of paths is 30. Otherwise, an INVALID_ARGUMENT error is returned. Note: Returning more fields in SearchResponse can increase response payload size and serving latency.
     ...
     * 
     */
    public List<GoogleCloudRetailV2alphaProductResponse> variants() {
    ...
    public static final class Builder {
        ...
        public Builder fulfillmentInfo(GoogleCloudRetailV2alphaFulfillmentInfoResponse... fulfillmentInfo) {
        ...
        public Builder images(GoogleCloudRetailV2alphaImageResponse... images) {
        ...
        public Builder promotions(GoogleCloudRetailV2alphaPromotionResponse... promotions) {
        ...
        public Builder variants(GoogleCloudRetailV2alphaProductResponse... variants) {
