...
@CustomType
public final class GetEndpointIamPolicyResult {
        /**
    ...
    public static Builder builder(GetEndpointIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetEndpointIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetEndpointIamPolicyResult build() {
            return new GetEndpointIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
