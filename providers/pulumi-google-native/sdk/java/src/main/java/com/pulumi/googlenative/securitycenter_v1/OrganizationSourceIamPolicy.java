...
import com.pulumi.googlenative.securitycenter_v1.OrganizationSourceIamPolicyArgs;
import com.pulumi.googlenative.securitycenter_v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.securitycenter_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:securitycenter/v1:OrganizationSourceIamPolicy")
public class OrganizationSourceIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private OrganizationSourceIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:securitycenter/v1:OrganizationSourceIamPolicy", name, null, makeResourceOptions(options, id));
    }
