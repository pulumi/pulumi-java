...
public final class GkeNodePoolAutoscalingConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The maximum number of nodes in the NodePool. Must be &gt;= min_node_count. Note: Quota must be sufficient to scale up the cluster.
     * 
     */
    ...
    /**
     * @return The minimum number of nodes in the NodePool. Must be &gt;= 0 and &lt;= max_node_count.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param maxNodeCount The maximum number of nodes in the NodePool. Must be &gt;= min_node_count. Note: Quota must be sufficient to scale up the cluster.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param minNodeCount The minimum number of nodes in the NodePool. Must be &gt;= 0 and &lt;= max_node_count.
         * 
         * @return builder
         * 
         */
