...
import com.pulumi.googlenative.dataproc_v1.inputs.GkeNodePoolTargetArgs;
...
public final class GkeClusterConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param nodePoolTarget Optional. GKE NodePools where workloads will be scheduled. At least one node pool must be assigned the &#39;default&#39; role. Each role can be given to only a single NodePoolTarget. All NodePools must have the same location settings. If a nodePoolTarget is not specified, Dataproc constructs a default nodePoolTarget.
         * 
         * @return builder
         * 
         */
