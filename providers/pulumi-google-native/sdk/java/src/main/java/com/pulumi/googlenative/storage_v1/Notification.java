...
import com.pulumi.googlenative.storage_v1.NotificationArgs;
...
public class Notification extends CustomResource {
    ...
    private Notification(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Notification get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
