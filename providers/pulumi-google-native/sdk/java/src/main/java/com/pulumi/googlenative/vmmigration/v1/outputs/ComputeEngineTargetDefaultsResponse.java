...
import com.pulumi.googlenative.vmmigration.v1.outputs.AppliedLicenseResponse;
import com.pulumi.googlenative.vmmigration.v1.outputs.ComputeSchedulingResponse;
import com.pulumi.googlenative.vmmigration.v1.outputs.NetworkInterfaceResponse;
...
public final class ComputeEngineTargetDefaultsResponse {
    ...
    public static final class Builder {
        ...
        public Builder zone(String zone) {
            ...
            return new ComputeEngineTargetDefaultsResponse(additionalLicenses, appliedLicense, bootOption, computeScheduling, diskType, hostname, labels, licenseType, machineType, machineTypeSeries, metadata, networkInterfaces, networkTags, secureBoot, serviceAccount, targetProject, vmName, zone);
        }
    }
}
