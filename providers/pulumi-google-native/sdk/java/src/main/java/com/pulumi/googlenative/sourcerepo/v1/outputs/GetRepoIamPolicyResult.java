...
import com.pulumi.googlenative.sourcerepo.v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.sourcerepo.v1.outputs.BindingResponse;
...
@CustomType
public final class GetRepoIamPolicyResult {
    /**
    ...
    private GetRepoIamPolicyResult(
    ...
    public static Builder builder(GetRepoIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetRepoIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetRepoIamPolicyResult build() {
            return new GetRepoIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
