...
import com.pulumi.googlenative.compute_alpha.BackendBucketIamPolicyArgs;
...
public class BackendBucketIamPolicy extends CustomResource {
    /**
     ...
     */
    public BackendBucketIamPolicy(String name, BackendBucketIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BackendBucketIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BackendBucketIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
