...
import com.pulumi.googlenative.cloudbuild_v1.BitbucketServerConfigArgs;
...
public class BitbucketServerConfig extends CustomResource {
    /**
     ...
     */
    public BitbucketServerConfig(String name, BitbucketServerConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BitbucketServerConfig(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BitbucketServerConfig get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
