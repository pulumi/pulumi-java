...
public final class GetRegionSecurityPolicyResult {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            ...
            return new GetRegionSecurityPolicyResult(adaptiveProtectionConfig, advancedOptionsConfig, creationTimestamp, ddosProtectionConfig, description, fingerprint, kind, name, recaptchaOptionsConfig, region, rules, selfLink, type);
        }
    }
}
