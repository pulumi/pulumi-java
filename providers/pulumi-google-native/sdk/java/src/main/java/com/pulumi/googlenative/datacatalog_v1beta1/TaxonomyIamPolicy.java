...
import com.pulumi.googlenative.datacatalog_v1beta1.TaxonomyIamPolicyArgs;
import com.pulumi.googlenative.datacatalog_v1beta1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:datacatalog/v1beta1:TaxonomyIamPolicy")
public class TaxonomyIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public TaxonomyIamPolicy(String name, TaxonomyIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datacatalog/v1beta1:TaxonomyIamPolicy", name, args == null ? TaxonomyIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TaxonomyIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datacatalog/v1beta1:TaxonomyIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static TaxonomyIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new TaxonomyIamPolicy(name, id, options);
    }
}
