...
import com.pulumi.googlenative.bigtableadmin_v2.InstanceIamPolicyArgs;
import com.pulumi.googlenative.bigtableadmin_v2.outputs.AuditConfigResponse;
import com.pulumi.googlenative.bigtableadmin_v2.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:bigtableadmin/v2:InstanceIamPolicy")
public class InstanceIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public InstanceIamPolicy(String name, InstanceIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:bigtableadmin/v2:InstanceIamPolicy", name, args == null ? InstanceIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private InstanceIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:bigtableadmin/v2:InstanceIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static InstanceIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
