...
import com.pulumi.googlenative.compute_beta.GlobalAddressArgs;
...
public class GlobalAddress extends CustomResource {
    ...
    public GlobalAddress(String name, @Nullable GlobalAddressArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/beta:GlobalAddress", name, args == null ? GlobalAddressArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
