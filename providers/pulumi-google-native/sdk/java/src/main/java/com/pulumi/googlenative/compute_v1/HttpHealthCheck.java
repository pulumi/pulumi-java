...
import com.pulumi.googlenative.compute_v1.HttpHealthCheckArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:HttpHealthCheck")
public class HttpHealthCheck extends CustomResource {
    /**
     ...
     */
    public HttpHealthCheck(String name, @Nullable HttpHealthCheckArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/v1:HttpHealthCheck", name, args == null ? HttpHealthCheckArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private HttpHealthCheck(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:compute/v1:HttpHealthCheck", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static HttpHealthCheck get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
