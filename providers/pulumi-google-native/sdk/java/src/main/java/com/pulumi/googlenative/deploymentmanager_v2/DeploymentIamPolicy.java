...
import com.pulumi.googlenative.deploymentmanager_v2.DeploymentIamPolicyArgs;
...
public class DeploymentIamPolicy extends CustomResource {
    /**
     ...
     */
    public DeploymentIamPolicy(String name, DeploymentIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DeploymentIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DeploymentIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
