...
import com.pulumi.googlenative.compute_alpha.NodeTemplateArgs;
...
public class NodeTemplate extends com.pulumi.resources.CustomResource {
    ...
    public NodeTemplate(String name, NodeTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:NodeTemplate", name, args == null ? NodeTemplateArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
