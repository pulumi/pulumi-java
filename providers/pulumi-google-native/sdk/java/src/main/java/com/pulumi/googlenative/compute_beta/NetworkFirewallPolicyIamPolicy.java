...
import com.pulumi.googlenative.compute_beta.NetworkFirewallPolicyIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:NetworkFirewallPolicyIamPolicy")
public class NetworkFirewallPolicyIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public NetworkFirewallPolicyIamPolicy(String name, NetworkFirewallPolicyIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:NetworkFirewallPolicyIamPolicy", name, args == null ? NetworkFirewallPolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private NetworkFirewallPolicyIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:NetworkFirewallPolicyIamPolicy", name, null, makeResourceOptions(options, id));
    }
