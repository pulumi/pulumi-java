...
import com.pulumi.googlenative.dlp_v2.DeidentifyTemplateArgs;
...
public class DeidentifyTemplate extends CustomResource {
    /**
     ...
     */
    public DeidentifyTemplate(String name, @Nullable DeidentifyTemplateArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DeidentifyTemplate(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DeidentifyTemplate get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
