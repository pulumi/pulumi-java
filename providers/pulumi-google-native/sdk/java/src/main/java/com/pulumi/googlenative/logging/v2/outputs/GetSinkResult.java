...
public final class GetSinkResult {
    ...
    public static final class Builder {
        ...
        public Builder writerIdentity(String writerIdentity) {
            ...
            return new GetSinkResult(bigqueryOptions, createTime, description, destination, disabled, exclusions, filter, includeChildren, name, outputVersionFormat, updateTime, writerIdentity);
        }
    }
}
