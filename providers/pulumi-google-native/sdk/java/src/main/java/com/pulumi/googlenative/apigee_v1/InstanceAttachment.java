...
import com.pulumi.googlenative.apigee_v1.InstanceAttachmentArgs;
...
public class InstanceAttachment extends CustomResource {
    ...
    private InstanceAttachment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static InstanceAttachment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
