...
public final class RetryConfigResponse extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return The maximum number of attempts for a task. Cloud Tasks will attempt the task `max_attempts` times (that is, if the first attempt fails, then there will be `max_attempts - 1` retries). Must be &gt; 0.
     * 
     */
    ...
    /**
     * @return If true, then the number of attempts is unlimited.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param maxAttempts The maximum number of attempts for a task. Cloud Tasks will attempt the task `max_attempts` times (that is, if the first attempt fails, then there will be `max_attempts - 1` retries). Must be &gt; 0.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param unlimitedAttempts If true, then the number of attempts is unlimited.
         * 
         * @return builder
         * 
         */
