...
import com.pulumi.googlenative.dns_v1beta2.ManagedZoneArgs;
...
public class ManagedZone extends CustomResource {
     ...
     */
    public ManagedZone(String name, @Nullable ManagedZoneArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagedZone(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagedZone get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
