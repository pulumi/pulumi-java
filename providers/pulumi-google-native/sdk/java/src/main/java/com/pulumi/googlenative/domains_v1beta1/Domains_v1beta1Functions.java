...
import com.pulumi.googlenative.domains_v1beta1.inputs.GetRegistrationIamPolicyPlainArgs;
import com.pulumi.googlenative.domains_v1beta1.inputs.GetRegistrationPlainArgs;
...
public final class Domains_v1beta1Functions {
    ...
    public static Output<GetRegistrationResult> getRegistration(GetRegistrationArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:domains/v1beta1:getRegistration", TypeShape.of(GetRegistrationResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the details of a `Registration` resource.
     * 
    ...
    public static Output<GetRegistrationIamPolicyResult> getRegistrationIamPolicy(GetRegistrationIamPolicyArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:domains/v1beta1:getRegistrationIamPolicy", TypeShape.of(GetRegistrationIamPolicyResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
     * 
