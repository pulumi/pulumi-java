...
import com.pulumi.googlenative.compute_v1.TargetInstanceArgs;
...
public class TargetInstance extends CustomResource {
    ...
    public TargetInstance(String name, @Nullable TargetInstanceArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/v1:TargetInstance", name, args == null ? TargetInstanceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
