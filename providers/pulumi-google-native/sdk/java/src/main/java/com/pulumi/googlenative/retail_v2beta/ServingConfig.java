...
import com.pulumi.googlenative.retail_v2beta.ServingConfigArgs;
...
public class ServingConfig extends CustomResource {
    /**
     ...
     * 
     */
    public Output<GoogleCloudRetailV2betaSearchRequestDynamicFacetSpecResponse> dynamicFacetSpec() {
     ...
     */
    public ServingConfig(String name, ServingConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServingConfig(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServingConfig get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
