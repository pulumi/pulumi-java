...
import com.pulumi.googlenative.compute_alpha.NetworkFirewallPolicyArgs;
...
public class NetworkFirewallPolicy extends CustomResource {
    /**
     ...
     */
    public NetworkFirewallPolicy(String name, @Nullable NetworkFirewallPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NetworkFirewallPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkFirewallPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
