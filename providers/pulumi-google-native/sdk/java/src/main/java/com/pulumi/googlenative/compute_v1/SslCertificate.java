...
import com.pulumi.googlenative.compute_v1.SslCertificateArgs;
import com.pulumi.googlenative.compute_v1.outputs.SslCertificateManagedSslCertificateResponse;
import com.pulumi.googlenative.compute_v1.outputs.SslCertificateSelfManagedSslCertificateResponse;
...
public class SslCertificate extends com.pulumi.resources.CustomResource {
    ...
    public SslCertificate(String name, @Nullable SslCertificateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:SslCertificate", name, args == null ? SslCertificateArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
