...
public final class GetResourcePolicyResult {
     ...
     * 
     */
    private final ResourcePolicyDiskConsistencyGroupPolicyResponse diskConsistencyGroupPolicy;
    /**
    ...
    private GetResourcePolicyResult(
        ...
        @CustomType.Parameter("diskConsistencyGroupPolicy") ResourcePolicyDiskConsistencyGroupPolicyResponse diskConsistencyGroupPolicy,
    ...
    public static final class Builder {
        ...
        public Builder vmMaintenancePolicy(ResourcePolicyVmMaintenancePolicyResponse vmMaintenancePolicy) {
            ...
            return new GetResourcePolicyResult(creationTimestamp, description, diskConsistencyGroupPolicy, groupPlacementPolicy, instanceSchedulePolicy, kind, name, region, resourceStatus, selfLink, selfLinkWithId, snapshotSchedulePolicy, status, vmMaintenancePolicy);
        }
    }
}
