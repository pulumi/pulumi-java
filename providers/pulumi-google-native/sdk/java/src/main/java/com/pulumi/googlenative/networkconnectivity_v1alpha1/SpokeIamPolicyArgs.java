...
import com.pulumi.googlenative.networkconnectivity_v1alpha1.inputs.AuditConfigArgs;
import com.pulumi.googlenative.networkconnectivity_v1alpha1.inputs.BindingArgs;
...
public final class SpokeIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SpokeIamPolicyArgs(SpokeIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SpokeIamPolicyArgs();
        }

        public Builder(SpokeIamPolicyArgs defaults) {
            $ = new SpokeIamPolicyArgs(Objects.requireNonNull(defaults));
        }
