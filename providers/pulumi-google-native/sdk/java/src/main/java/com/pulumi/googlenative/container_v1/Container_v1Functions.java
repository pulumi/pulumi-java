...
import com.pulumi.googlenative.container_v1.inputs.GetClusterPlainArgs;
import com.pulumi.googlenative.container_v1.inputs.GetNodePoolArgs;
import com.pulumi.googlenative.container_v1.inputs.GetNodePoolPlainArgs;
...
public final class Container_v1Functions {
    ...
    public static Output<GetClusterResult> getCluster(GetClusterArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:container/v1:getCluster", TypeShape.of(GetClusterResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the details of a specific cluster.
     * 
    ...
    public static Output<GetNodePoolResult> getNodePool(GetNodePoolArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:container/v1:getNodePool", TypeShape.of(GetNodePoolResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Retrieves the requested node pool.
     * 
