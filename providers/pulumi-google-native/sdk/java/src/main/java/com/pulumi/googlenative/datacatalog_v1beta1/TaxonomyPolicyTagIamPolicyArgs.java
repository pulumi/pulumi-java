...
public final class TaxonomyPolicyTagIamPolicyArgs extends ResourceArgs {
    ...
    private TaxonomyPolicyTagIamPolicyArgs(TaxonomyPolicyTagIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TaxonomyPolicyTagIamPolicyArgs();
        }

        public Builder(TaxonomyPolicyTagIamPolicyArgs defaults) {
            $ = new TaxonomyPolicyTagIamPolicyArgs(Objects.requireNonNull(defaults));
        }
