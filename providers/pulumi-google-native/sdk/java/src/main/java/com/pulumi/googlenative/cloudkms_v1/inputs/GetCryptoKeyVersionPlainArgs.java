...
public final class GetCryptoKeyVersionPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetCryptoKeyVersionPlainArgs Empty = new GetCryptoKeyVersionPlainArgs();
    ...
    private GetCryptoKeyVersionPlainArgs() {}

    private GetCryptoKeyVersionPlainArgs(GetCryptoKeyVersionPlainArgs $) {
    ...
    public static Builder builder(GetCryptoKeyVersionPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetCryptoKeyVersionPlainArgs();
        }

        public Builder(GetCryptoKeyVersionPlainArgs defaults) {
            $ = new GetCryptoKeyVersionPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetCryptoKeyVersionPlainArgs build() {
