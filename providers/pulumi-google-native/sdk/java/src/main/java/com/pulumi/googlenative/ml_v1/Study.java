...
import com.pulumi.googlenative.ml_v1.StudyArgs;
...
public class Study extends CustomResource {
    /**
     ...
     */
    public Study(String name, StudyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:ml/v1:Study", name, args == null ? StudyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Study(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Study get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
