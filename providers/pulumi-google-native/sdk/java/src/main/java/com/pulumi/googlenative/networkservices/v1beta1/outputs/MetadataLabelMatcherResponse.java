...
import com.pulumi.googlenative.networkservices.v1beta1.outputs.MetadataLabelsResponse;
...
public final class MetadataLabelMatcherResponse {
    ...
    private MetadataLabelMatcherResponse(
        @CustomType.Parameter("metadataLabelMatchCriteria") String metadataLabelMatchCriteria,
        @CustomType.Parameter("metadataLabels") List<MetadataLabelsResponse> metadataLabels) {
