...
import com.pulumi.googlenative.compute_beta.inputs.MetadataFilterLabelMatchResponse;
...
public final class MetadataFilterResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private MetadataFilterResponse(MetadataFilterResponse $) {
