 ...
 * 
 */
public final class GoogleCloudDatacatalogV1ColumnSchemaResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private GoogleCloudDatacatalogV1ColumnSchemaResponse(GoogleCloudDatacatalogV1ColumnSchemaResponse $) {
        this.column = $.column;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleCloudDatacatalogV1ColumnSchemaResponse();
        }

        public Builder(GoogleCloudDatacatalogV1ColumnSchemaResponse defaults) {
            $ = new GoogleCloudDatacatalogV1ColumnSchemaResponse(Objects.requireNonNull(defaults));
        }
