...
import com.pulumi.googlenative.cloudtasks_v2beta3.QueueIamPolicyArgs;
import com.pulumi.googlenative.cloudtasks_v2beta3.outputs.BindingResponse;
...
public class QueueIamPolicy extends CustomResource {
    /**
     ...
     */
    public QueueIamPolicy(String name, QueueIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private QueueIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static QueueIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
