...
public class FolderIamPolicy extends CustomResource {
    /**
     ...
     */
    public FolderIamPolicy(String name, FolderIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FolderIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FolderIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
