...
import com.pulumi.googlenative.cloudresourcemanager_v2beta1.FolderIamPolicyArgs;
import com.pulumi.googlenative.cloudresourcemanager_v2beta1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.cloudresourcemanager_v2beta1.outputs.BindingResponse;
...
public class FolderIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public FolderIamPolicy(String name, FolderIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v2beta1:FolderIamPolicy", name, args == null ? FolderIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FolderIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static FolderIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
