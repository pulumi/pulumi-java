...
import com.pulumi.googlenative.retail_v2beta.ControlArgs;
...
public class Control extends CustomResource {
     ...
     */
    public Control(String name, ControlArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Control(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Control get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
