...
import com.pulumi.googlenative.gkehub_v1.FeatureArgs;
import com.pulumi.googlenative.gkehub_v1.outputs.CommonFeatureSpecResponse;
import com.pulumi.googlenative.gkehub_v1.outputs.CommonFeatureStateResponse;
import com.pulumi.googlenative.gkehub_v1.outputs.FeatureResourceStateResponse;
...
public class Feature extends CustomResource {
     ...
     */
    public Feature(String name, @Nullable FeatureArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:gkehub/v1:Feature", name, args == null ? FeatureArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Feature(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Feature get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
