...
public final class GetSslPolicyResult {
    ...
    public static final class Builder {
        ...
        public Builder warnings(SslPolicyWarningsItemResponse... warnings) {
            ...
            return new GetSslPolicyResult(creationTimestamp, customFeatures, description, enabledFeatures, fingerprint, kind, minTlsVersion, name, profile, region, selfLink, warnings);
        }
    }
}
