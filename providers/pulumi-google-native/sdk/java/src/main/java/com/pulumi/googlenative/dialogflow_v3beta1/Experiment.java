...
import com.pulumi.googlenative.dialogflow_v3beta1.ExperimentArgs;
...
public class Experiment extends CustomResource {
     ...
     * 
     */
    @Export(name="definition", type=GoogleCloudDialogflowCxV3beta1ExperimentDefinitionResponse.class, parameters={})
     ...
     * 
     */
    @Export(name="result", type=GoogleCloudDialogflowCxV3beta1ExperimentResultResponse.class, parameters={})
     ...
     * 
     */
    @Export(name="rolloutConfig", type=GoogleCloudDialogflowCxV3beta1RolloutConfigResponse.class, parameters={})
     ...
     * 
     */
    @Export(name="rolloutState", type=GoogleCloudDialogflowCxV3beta1RolloutStateResponse.class, parameters={})
     ...
     * 
     */
    @Export(name="variantsHistory", type=List.class, parameters={GoogleCloudDialogflowCxV3beta1VariantsHistoryResponse.class})
    ...
    public Experiment(String name, ExperimentArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:dialogflow/v3beta1:Experiment", name, args == null ? ExperimentArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
