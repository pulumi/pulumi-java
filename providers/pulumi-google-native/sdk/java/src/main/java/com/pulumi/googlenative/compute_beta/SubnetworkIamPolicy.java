...
import com.pulumi.googlenative.compute_beta.SubnetworkIamPolicyArgs;
...
public class SubnetworkIamPolicy extends CustomResource {
    ...
    private SubnetworkIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SubnetworkIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
