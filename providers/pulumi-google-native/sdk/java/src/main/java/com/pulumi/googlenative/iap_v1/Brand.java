...
import com.pulumi.googlenative.iap_v1.BrandArgs;
...
public class Brand extends CustomResource {
     ...
     */
    public Brand(String name, @Nullable BrandArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:iap/v1:Brand", name, args == null ? BrandArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Brand(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Brand get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
