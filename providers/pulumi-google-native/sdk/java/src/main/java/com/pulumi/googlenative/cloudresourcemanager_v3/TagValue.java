...
import com.pulumi.googlenative.cloudresourcemanager_v3.TagValueArgs;
...
public class TagValue extends CustomResource {
    ...
    private TagValue(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TagValue get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
