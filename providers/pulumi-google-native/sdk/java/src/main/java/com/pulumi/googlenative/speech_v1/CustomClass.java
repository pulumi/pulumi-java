...
import com.pulumi.googlenative.speech_v1.CustomClassArgs;
import com.pulumi.googlenative.speech_v1.outputs.ClassItemResponse;
...
public class CustomClass extends CustomResource {
    /**
     ...
     */
    public CustomClass(String name, CustomClassArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CustomClass(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomClass get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
