...
public final class BucketLifecycleRuleItemConditionResponse {
    ...
    private BucketLifecycleRuleItemConditionResponse(
        ...
        @CustomType.Parameter("matchesPrefix") List<String> matchesPrefix,
        @CustomType.Parameter("matchesStorageClass") List<String> matchesStorageClass,
        @CustomType.Parameter("matchesSuffix") List<String> matchesSuffix,
    ...
    public static final class Builder {
        ...
        public Builder numNewerVersions(Integer numNewerVersions) {
            ...
            return new BucketLifecycleRuleItemConditionResponse(age, createdBefore, customTimeBefore, daysSinceCustomTime, daysSinceNoncurrentTime, isLive, matchesPattern, matchesPrefix, matchesStorageClass, matchesSuffix, noncurrentTimeBefore, numNewerVersions);
        }
    }
}
