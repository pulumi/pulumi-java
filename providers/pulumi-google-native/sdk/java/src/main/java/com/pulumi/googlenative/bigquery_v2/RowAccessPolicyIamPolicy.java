...
public class RowAccessPolicyIamPolicy extends CustomResource {
    /**
     ...
     */
    public RowAccessPolicyIamPolicy(String name, RowAccessPolicyIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RowAccessPolicyIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RowAccessPolicyIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
