...
public final class ReservationResponse {
    ...
    public static final class Builder {
        ...
        public Builder zone(String zone) {
            ...
            return new ReservationResponse(commitment, creationTimestamp, description, kind, name, resourcePolicies, satisfiesPzs, selfLink, selfLinkWithId, shareSettings, specificReservation, specificReservationRequired, status, zone);
        }
    }
}
