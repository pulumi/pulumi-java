...
import com.pulumi.googlenative.contactcenterinsights_v1.PhraseMatcherArgs;
...
public class PhraseMatcher extends CustomResource {
    /**
     ...
     */
    public PhraseMatcher(String name, PhraseMatcherArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PhraseMatcher(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PhraseMatcher get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
