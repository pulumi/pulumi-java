...
@CustomType
public final class GetExclusionResult {
    /**
    ...
    public static Builder builder(GetExclusionResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetExclusionResult defaults) {
        ...
        public Builder updateTime(String updateTime) {
            ...
            return this;
        }        public GetExclusionResult build() {
            return new GetExclusionResult(createTime, description, disabled, filter, name, updateTime);
        }
    }
}
