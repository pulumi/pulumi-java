...
public final class GetRegionNetworkFirewallPolicyResult {
    ...
    public static final class Builder {
        ...
        public Builder vpcNetworkScope(String vpcNetworkScope) {
            ...
            return new GetRegionNetworkFirewallPolicyResult(associations, creationTimestamp, description, displayName, fingerprint, kind, name, parent, region, ruleTupleCount, rules, selfLink, selfLinkWithId, shortName, vpcNetworkScope);
        }
    }
}
