...
import com.pulumi.googlenative.jobs_v3.CompanyArgs;
import com.pulumi.googlenative.jobs_v3.outputs.CompanyDerivedInfoResponse;
...
public class Company extends CustomResource {
    /**
     ...
     */
    public Company(String name, CompanyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:jobs/v3:Company", name, args == null ? CompanyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Company(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Company get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
