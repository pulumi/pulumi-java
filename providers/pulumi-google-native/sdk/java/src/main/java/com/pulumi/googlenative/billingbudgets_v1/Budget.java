...
import com.pulumi.googlenative.billingbudgets_v1.BudgetArgs;
...
public class Budget extends CustomResource {
     ...
     */
    public Budget(String name, BudgetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Budget(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Budget get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
