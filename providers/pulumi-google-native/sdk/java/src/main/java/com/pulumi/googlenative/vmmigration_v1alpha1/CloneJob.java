...
public class CloneJob extends CustomResource {
    /**
     ...
     */
    public CloneJob(String name, CloneJobArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CloneJob(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CloneJob get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
