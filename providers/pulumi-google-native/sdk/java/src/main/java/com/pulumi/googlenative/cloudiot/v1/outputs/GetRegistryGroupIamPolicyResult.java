...
import com.pulumi.googlenative.cloudiot.v1.outputs.BindingResponse;
...
@CustomType
public final class GetRegistryGroupIamPolicyResult {
    /**
    ...
    private GetRegistryGroupIamPolicyResult(
    ...
    public static Builder builder(GetRegistryGroupIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetRegistryGroupIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetRegistryGroupIamPolicyResult build() {
            return new GetRegistryGroupIamPolicyResult(bindings, etag, version);
        }
    }
}
