...
import com.pulumi.googlenative.healthcare_v1beta1.AnnotationStoreArgs;
...
public class AnnotationStore extends CustomResource {
    /**
     ...
     */
    public AnnotationStore(String name, AnnotationStoreArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AnnotationStore(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AnnotationStore get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
