...
import com.pulumi.googlenative.gameservices_v1beta.inputs.AuditConfigArgs;
import com.pulumi.googlenative.gameservices_v1beta.inputs.BindingArgs;
import com.pulumi.googlenative.gameservices_v1beta.inputs.RuleArgs;
...
public final class GameServerDeploymentIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GameServerDeploymentIamPolicyArgs() {}

    private GameServerDeploymentIamPolicyArgs(GameServerDeploymentIamPolicyArgs $) {
    ...
    public static Builder builder(GameServerDeploymentIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GameServerDeploymentIamPolicyArgs defaults) {
            $ = new GameServerDeploymentIamPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GameServerDeploymentIamPolicyArgs build() {
