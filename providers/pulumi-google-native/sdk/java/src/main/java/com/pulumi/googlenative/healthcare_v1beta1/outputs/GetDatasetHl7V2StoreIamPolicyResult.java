...
@CustomType
public final class GetDatasetHl7V2StoreIamPolicyResult {
    /**
    ...
    private GetDatasetHl7V2StoreIamPolicyResult(
    ...
    public static Builder builder(GetDatasetHl7V2StoreIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetDatasetHl7V2StoreIamPolicyResult defaults) {
