...
import com.pulumi.googlenative.metastore_v1alpha.ServiceIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:metastore/v1alpha:ServiceIamPolicy")
public class ServiceIamPolicy extends CustomResource {
    ...
    public ServiceIamPolicy(String name, ServiceIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:metastore/v1alpha:ServiceIamPolicy", name, args == null ? ServiceIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ServiceIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:metastore/v1alpha:ServiceIamPolicy", name, null, makeResourceOptions(options, id));
    }
