...
import com.pulumi.googlenative.networkservices_v1beta1.inputs.AuditConfigArgs;
import com.pulumi.googlenative.networkservices_v1beta1.inputs.BindingArgs;
...
public final class MeshIamPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final MeshIamPolicyArgs Empty = new MeshIamPolicyArgs();
    ...
    private MeshIamPolicyArgs() {}

    private MeshIamPolicyArgs(MeshIamPolicyArgs $) {
    ...
    public static Builder builder(MeshIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MeshIamPolicyArgs();
        }

        public Builder(MeshIamPolicyArgs defaults) {
            $ = new MeshIamPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MeshIamPolicyArgs build() {
