...
import com.pulumi.googlenative.managedidentities_v1beta1.DomainArgs;
import com.pulumi.googlenative.managedidentities_v1beta1.outputs.TrustResponse;
...
public class Domain extends CustomResource {
    ...
    public Domain(String name, DomainArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:managedidentities/v1beta1:Domain", name, args == null ? DomainArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
