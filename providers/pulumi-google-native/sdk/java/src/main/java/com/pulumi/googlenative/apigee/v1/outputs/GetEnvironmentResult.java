...
public final class GetEnvironmentResult {
     ...
     * 
     */
    private final String forwardProxyUri;
    /**
    ...
    private GetEnvironmentResult(
        ...
        @CustomType.Parameter("forwardProxyUri") String forwardProxyUri,
    ...
    public static final class Builder {
        ...
        public Builder state(String state) {
            ...
            return new GetEnvironmentResult(apiProxyType, createdAt, deploymentType, description, displayName, forwardProxyUri, lastModifiedAt, name, properties, state);
        }
    }
}
