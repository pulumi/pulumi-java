...
import com.pulumi.googlenative.clouddeploy_v1.DeliveryPipelineArgs;
...
public class DeliveryPipeline extends CustomResource {
    /**
     ...
     */
    public DeliveryPipeline(String name, DeliveryPipelineArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DeliveryPipeline(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DeliveryPipeline get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
