...
public final class GetRegionTargetHttpsProxyResult {
    ...
    public static final class Builder {
        ...
        public Builder urlMap(String urlMap) {
            ...
            return new GetRegionTargetHttpsProxyResult(authentication, authorization, authorizationPolicy, certificateMap, creationTimestamp, description, fingerprint, httpFilters, kind, name, proxyBind, quicOverride, region, selfLink, serverTlsPolicy, sslCertificates, sslPolicy, urlMap);
        }
    }
}
