...
public final class InstanceBackupIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceBackupIamPolicyArgs(InstanceBackupIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceBackupIamPolicyArgs();
        }

        public Builder(InstanceBackupIamPolicyArgs defaults) {
            $ = new InstanceBackupIamPolicyArgs(Objects.requireNonNull(defaults));
        }
