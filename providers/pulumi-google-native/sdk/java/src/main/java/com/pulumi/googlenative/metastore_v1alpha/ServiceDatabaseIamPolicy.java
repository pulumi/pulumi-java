...
import com.pulumi.googlenative.metastore_v1alpha.ServiceDatabaseIamPolicyArgs;
...
public class ServiceDatabaseIamPolicy extends CustomResource {
    /**
     ...
     */
    public ServiceDatabaseIamPolicy(String name, ServiceDatabaseIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceDatabaseIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceDatabaseIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
