...
public final class NetworkPeeringResponse {
    ...
    public static final class Builder {
        ...
        public Builder stateDetails(String stateDetails) {
            ...
            return new NetworkPeeringResponse(autoCreateRoutes, exchangeSubnetRoutes, exportCustomRoutes, exportSubnetRoutesWithPublicIp, importCustomRoutes, importSubnetRoutesWithPublicIp, name, network, peerMtu, stackType, state, stateDetails);
        }
    }
}
