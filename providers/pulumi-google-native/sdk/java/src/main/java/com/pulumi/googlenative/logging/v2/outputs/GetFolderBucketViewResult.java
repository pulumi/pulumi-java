...
@CustomType
public final class GetFolderBucketViewResult {
    /**
    ...
    public static Builder builder(GetFolderBucketViewResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetFolderBucketViewResult defaults) {
        ...
        public Builder updateTime(String updateTime) {
            ...
            return this;
        }        public GetFolderBucketViewResult build() {
            return new GetFolderBucketViewResult(createTime, description, filter, name, updateTime);
        }
    }
}
