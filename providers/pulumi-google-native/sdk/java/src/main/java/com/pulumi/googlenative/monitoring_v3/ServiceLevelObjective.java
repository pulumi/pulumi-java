...
import com.pulumi.googlenative.monitoring_v3.ServiceLevelObjectiveArgs;
...
public class ServiceLevelObjective extends CustomResource {
    /**
     ...
     */
    public ServiceLevelObjective(String name, ServiceLevelObjectiveArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceLevelObjective(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceLevelObjective get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
