...
import com.pulumi.googlenative.eventarc.v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.eventarc.v1.outputs.BindingResponse;
...
@CustomType
public final class GetChannelIamPolicyResult {
    /**
    ...
    private GetChannelIamPolicyResult(
    ...
    public static Builder builder(GetChannelIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetChannelIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetChannelIamPolicyResult build() {
            return new GetChannelIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
