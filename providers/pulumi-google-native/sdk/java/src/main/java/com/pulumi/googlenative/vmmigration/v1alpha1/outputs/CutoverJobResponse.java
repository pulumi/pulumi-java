...
public final class CutoverJobResponse {
    ...
    public static final class Builder {
        ...
        public Builder targetDetails(TargetVMDetailsResponse targetDetails) {
            ...
            return new CutoverJobResponse(computeEngineTargetDetails, computeEngineVmDetails, createTime, endTime, error, name, progress, progressPercent, state, stateMessage, stateTime, steps, targetDetails);
        }
    }
}
