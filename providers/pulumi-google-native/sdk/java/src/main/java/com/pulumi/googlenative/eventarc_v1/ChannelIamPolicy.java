...
import com.pulumi.googlenative.eventarc_v1.ChannelIamPolicyArgs;
...
public class ChannelIamPolicy extends CustomResource {
    /**
     ...
     */
    public ChannelIamPolicy(String name, ChannelIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ChannelIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ChannelIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
