...
import com.pulumi.googlenative.oslogin_v1.SshPublicKeyArgs;
...
public class SshPublicKey extends CustomResource {
    /**
     ...
     */
    public SshPublicKey(String name, SshPublicKeyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:oslogin/v1:SshPublicKey", name, args == null ? SshPublicKeyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SshPublicKey(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SshPublicKey get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
