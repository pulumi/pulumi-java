...
import com.pulumi.googlenative.orgpolicy_v2.OrganizationPolicyArgs;
...
public class OrganizationPolicy extends CustomResource {
    ...
    private OrganizationPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OrganizationPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
