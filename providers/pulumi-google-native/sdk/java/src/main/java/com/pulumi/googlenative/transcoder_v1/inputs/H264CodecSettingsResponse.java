 ...
 * 
 */
public final class H264CodecSettingsResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private H264CodecSettingsResponse(H264CodecSettingsResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new H264CodecSettingsResponse();
        }

        public Builder(H264CodecSettingsResponse defaults) {
            $ = new H264CodecSettingsResponse(Objects.requireNonNull(defaults));
        }
        ...
        public H264CodecSettingsResponse build() {
            ...
            $.entropyCoder = Objects.requireNonNull($.entropyCoder, "expected parameter 'entropyCoder' to be non-null");
