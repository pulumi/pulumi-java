...
import com.pulumi.googlenative.compute_v1.RouterArgs;
...
public class Router extends CustomResource {
    ...
    private Router(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Router get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
