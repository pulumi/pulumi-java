...
import com.pulumi.googlenative.beyondcorp.v1.outputs.GoogleIamV1AuditConfigResponse;
import com.pulumi.googlenative.beyondcorp.v1.outputs.GoogleIamV1BindingResponse;
...
@CustomType
public final class GetAppConnectorIamPolicyResult {
    /**
    ...
    private GetAppConnectorIamPolicyResult(
    ...
    public static Builder builder(GetAppConnectorIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAppConnectorIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetAppConnectorIamPolicyResult build() {
            return new GetAppConnectorIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
