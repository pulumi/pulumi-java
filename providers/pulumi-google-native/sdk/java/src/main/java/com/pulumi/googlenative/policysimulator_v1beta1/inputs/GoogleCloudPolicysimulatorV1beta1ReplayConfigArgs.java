...
import com.pulumi.googlenative.policysimulator_v1beta1.enums.GoogleCloudPolicysimulatorV1beta1ReplayConfigLogSource;
 ...
 * 
 */
public final class GoogleCloudPolicysimulatorV1beta1ReplayConfigArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<GoogleCloudPolicysimulatorV1beta1ReplayConfigLogSource>> logSource() {
    ...
    private GoogleCloudPolicysimulatorV1beta1ReplayConfigArgs(GoogleCloudPolicysimulatorV1beta1ReplayConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleCloudPolicysimulatorV1beta1ReplayConfigArgs();
        }

        public Builder(GoogleCloudPolicysimulatorV1beta1ReplayConfigArgs defaults) {
            $ = new GoogleCloudPolicysimulatorV1beta1ReplayConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder logSource(GoogleCloudPolicysimulatorV1beta1ReplayConfigLogSource logSource) {
