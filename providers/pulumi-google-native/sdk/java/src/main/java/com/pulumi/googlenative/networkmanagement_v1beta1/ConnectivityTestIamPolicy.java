...
public class ConnectivityTestIamPolicy extends CustomResource {
    /**
     ...
     */
    public ConnectivityTestIamPolicy(String name, ConnectivityTestIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConnectivityTestIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConnectivityTestIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
