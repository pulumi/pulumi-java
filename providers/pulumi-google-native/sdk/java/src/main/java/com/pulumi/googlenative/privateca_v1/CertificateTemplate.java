...
public class CertificateTemplate extends CustomResource {
    ...
    private CertificateTemplate(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CertificateTemplate get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
