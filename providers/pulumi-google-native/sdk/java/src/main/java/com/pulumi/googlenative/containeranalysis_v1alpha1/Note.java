...
import com.pulumi.googlenative.containeranalysis_v1alpha1.NoteArgs;
...
public class Note extends CustomResource {
     ...
     */
    public Note(String name, @Nullable NoteArgs args, @Nullable CustomResourceOptions options) {
