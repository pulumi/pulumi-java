...
import com.pulumi.googlenative.compute_beta.NodeTemplateIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:NodeTemplateIamPolicy")
public class NodeTemplateIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private NodeTemplateIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:NodeTemplateIamPolicy", name, null, makeResourceOptions(options, id));
    }
