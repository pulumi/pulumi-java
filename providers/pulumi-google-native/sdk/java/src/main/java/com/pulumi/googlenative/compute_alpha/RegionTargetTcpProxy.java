...
import com.pulumi.googlenative.compute_alpha.RegionTargetTcpProxyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:RegionTargetTcpProxy")
public class RegionTargetTcpProxy extends com.pulumi.resources.CustomResource {
     ...
     */
    public RegionTargetTcpProxy(String name) {
    ...
    public RegionTargetTcpProxy(String name, RegionTargetTcpProxyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionTargetTcpProxy", name, args == null ? RegionTargetTcpProxyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegionTargetTcpProxy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionTargetTcpProxy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static RegionTargetTcpProxy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RegionTargetTcpProxy(name, id, options);
    }
}
