...
import com.pulumi.googlenative.cloudbuild_v1alpha1.WorkerPoolArgs;
...
public class WorkerPool extends CustomResource {
     ...
     */
    public WorkerPool(String name, @Nullable WorkerPoolArgs args, @Nullable CustomResourceOptions options) {
