...
import com.pulumi.googlenative.compute_v1.VpnGatewayArgs;
...
public class VpnGateway extends CustomResource {
    ...
    public VpnGateway(String name, VpnGatewayArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/v1:VpnGateway", name, args == null ? VpnGatewayArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private VpnGateway(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpnGateway get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
