...
import com.pulumi.googlenative.eventarc_v1beta1.inputs.DestinationArgs;
import com.pulumi.googlenative.eventarc_v1beta1.inputs.MatchingCriteriaArgs;
...
public final class TriggerArgs extends ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param matchingCriteria null The criteria by which events are filtered. Only events that match with this criteria will be sent to the destination.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param name The resource name of the trigger. Must be unique within the location on the project and must in `projects/{project}/locations/{location}/triggers/{trigger}` format.
         * 
         * @return builder
         * 
         */
        ...
        public TriggerArgs build() {
            ...
            $.matchingCriteria = Objects.requireNonNull($.matchingCriteria, "expected parameter 'matchingCriteria' to be non-null");
