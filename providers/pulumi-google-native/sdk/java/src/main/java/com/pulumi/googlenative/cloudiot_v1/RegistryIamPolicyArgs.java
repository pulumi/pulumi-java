...
import com.pulumi.googlenative.cloudiot_v1.inputs.BindingArgs;
...
public final class RegistryIamPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegistryIamPolicyArgs Empty = new RegistryIamPolicyArgs();
    ...
    private RegistryIamPolicyArgs() {}

    private RegistryIamPolicyArgs(RegistryIamPolicyArgs $) {
    ...
    public static Builder builder(RegistryIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RegistryIamPolicyArgs defaults) {
            $ = new RegistryIamPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegistryIamPolicyArgs build() {
