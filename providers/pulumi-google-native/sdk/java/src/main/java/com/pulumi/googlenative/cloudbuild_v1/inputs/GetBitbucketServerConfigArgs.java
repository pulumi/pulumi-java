...
public final class GetBitbucketServerConfigArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public GetBitbucketServerConfigArgs(
        ...
        this.bitbucketServerConfigId = Objects.requireNonNull(bitbucketServerConfigId, "expected parameter 'bitbucketServerConfigId' to be non-null");
        this.location = Objects.requireNonNull(location, "expected parameter 'location' to be non-null");
        this.project = project;
    }

    private GetBitbucketServerConfigArgs() {
        this.bitbucketServerConfigId = null;
        this.location = null;
        this.project = null;
    }
