...
import com.pulumi.googlenative.storage_v1.DefaultObjectAccessControlArgs;
...
public class DefaultObjectAccessControl extends CustomResource {
    ...
    private DefaultObjectAccessControl(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DefaultObjectAccessControl get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
