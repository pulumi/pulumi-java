...
import com.pulumi.googlenative.firebaseappcheck_v1beta.DebugTokenArgs;
...
public class DebugToken extends CustomResource {
    /**
     ...
     */
    public DebugToken(String name, DebugTokenArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DebugToken(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DebugToken get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
