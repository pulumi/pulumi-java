...
import com.pulumi.googlenative.dialogflow_v2.inputs.GoogleCloudDialogflowV2FulfillmentArgs;
import com.pulumi.googlenative.dialogflow_v2.inputs.GoogleCloudDialogflowV2TextToSpeechSettingsArgs;
...
public final class EnvironmentArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Output<GoogleCloudDialogflowV2FulfillmentArgs> fulfillment() {
    ...
    public Output<GoogleCloudDialogflowV2TextToSpeechSettingsArgs> textToSpeechSettings() {
    ...
    public EnvironmentArgs(
        ...
        @Nullable Output<GoogleCloudDialogflowV2FulfillmentArgs> fulfillment,
        @Nullable Output<String> location,
        @Nullable Output<String> project,
        @Nullable Output<GoogleCloudDialogflowV2TextToSpeechSettingsArgs> textToSpeechSettings) {
