 ...
 * 
 */
public final class HttpRouteQueryParameterMatchArgs extends com.pulumi.resources.ResourceArgs {

    public static final HttpRouteQueryParameterMatchArgs Empty = new HttpRouteQueryParameterMatchArgs();
    ...
    private HttpRouteQueryParameterMatchArgs() {}

    private HttpRouteQueryParameterMatchArgs(HttpRouteQueryParameterMatchArgs $) {
    ...
    public static Builder builder(HttpRouteQueryParameterMatchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HttpRouteQueryParameterMatchArgs();
        }

        public Builder(HttpRouteQueryParameterMatchArgs defaults) {
            $ = new HttpRouteQueryParameterMatchArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param exactMatch The value of the query parameter must exactly match the contents of exact_match. Only one of exact_match, regex_match, or present_match must be set.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param presentMatch Specifies that the QueryParameterMatcher matches if request contains query parameter, irrespective of whether the parameter has a value or not. Only one of exact_match, regex_match, or present_match must be set.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param regexMatch The value of the query parameter must match the regular expression specified by regex_match. For regular expression grammar, please see https://github.com/google/re2/wiki/Syntax Only one of exact_match, regex_match, or present_match must be set.
         * 
         * @return builder
         * 
         */
        ...
        public HttpRouteQueryParameterMatchArgs build() {
            return $;
        }
    }
