...
import com.pulumi.googlenative.managedidentities_v1beta1.inputs.GetBackupPlainArgs;
...
import com.pulumi.googlenative.managedidentities_v1beta1.inputs.GetDomainBackupIamPolicyPlainArgs;
import com.pulumi.googlenative.managedidentities_v1beta1.inputs.GetDomainIamPolicyArgs;
import com.pulumi.googlenative.managedidentities_v1beta1.inputs.GetDomainIamPolicyPlainArgs;
import com.pulumi.googlenative.managedidentities_v1beta1.inputs.GetDomainPlainArgs;
...
import com.pulumi.googlenative.managedidentities_v1beta1.inputs.GetPeeringIamPolicyPlainArgs;
import com.pulumi.googlenative.managedidentities_v1beta1.inputs.GetPeeringPlainArgs;
...
public final class Managedidentities_v1beta1Functions {
    ...
    public static Output<GetBackupResult> getBackup(GetBackupArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:managedidentities/v1beta1:getBackup", TypeShape.of(GetBackupResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets details of a single Backup.
     * 
    ...
    public static Output<GetDomainResult> getDomain(GetDomainArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:managedidentities/v1beta1:getDomain", TypeShape.of(GetDomainResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets information about a domain.
     * 
    ...
    public static Output<GetDomainBackupIamPolicyResult> getDomainBackupIamPolicy(GetDomainBackupIamPolicyArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:managedidentities/v1beta1:getDomainBackupIamPolicy", TypeShape.of(GetDomainBackupIamPolicyResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
     * 
    ...
    public static Output<GetDomainIamPolicyResult> getDomainIamPolicy(GetDomainIamPolicyArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:managedidentities/v1beta1:getDomainIamPolicy", TypeShape.of(GetDomainIamPolicyResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
     * 
    ...
    public static Output<GetPeeringResult> getPeering(GetPeeringArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:managedidentities/v1beta1:getPeering", TypeShape.of(GetPeeringResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets details of a single Peering.
     * 
    ...
    public static Output<GetPeeringIamPolicyResult> getPeeringIamPolicy(GetPeeringIamPolicyArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:managedidentities/v1beta1:getPeeringIamPolicy", TypeShape.of(GetPeeringIamPolicyResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
     * 
