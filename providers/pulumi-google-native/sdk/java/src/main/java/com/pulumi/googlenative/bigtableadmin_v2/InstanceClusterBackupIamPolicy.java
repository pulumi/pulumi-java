...
import com.pulumi.googlenative.bigtableadmin_v2.InstanceClusterBackupIamPolicyArgs;
...
public class InstanceClusterBackupIamPolicy extends CustomResource {
    /**
     ...
     */
    public InstanceClusterBackupIamPolicy(String name, InstanceClusterBackupIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private InstanceClusterBackupIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static InstanceClusterBackupIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
