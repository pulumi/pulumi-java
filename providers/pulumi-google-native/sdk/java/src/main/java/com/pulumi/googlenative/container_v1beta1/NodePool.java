...
import com.pulumi.googlenative.container_v1beta1.NodePoolArgs;
...
public class NodePool extends CustomResource {
    /**
     ...
     */
    public NodePool(String name, NodePoolArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NodePool(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NodePool get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
