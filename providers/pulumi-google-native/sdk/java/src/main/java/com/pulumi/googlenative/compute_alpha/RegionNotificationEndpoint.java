...
import com.pulumi.googlenative.compute_alpha.RegionNotificationEndpointArgs;
...
public class RegionNotificationEndpoint extends CustomResource {
    /**
     ...
     */
    public RegionNotificationEndpoint(String name, RegionNotificationEndpointArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionNotificationEndpoint", name, args == null ? RegionNotificationEndpointArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegionNotificationEndpoint(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegionNotificationEndpoint get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
