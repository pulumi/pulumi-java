...
import com.pulumi.googlenative.compute_alpha.GlobalPublicDelegatedPrefixArgs;
import com.pulumi.googlenative.compute_alpha.outputs.PublicDelegatedPrefixPublicDelegatedSubPrefixResponse;
...
public class GlobalPublicDelegatedPrefix extends CustomResource {
    /**
     ...
     */
    public GlobalPublicDelegatedPrefix(String name, @Nullable GlobalPublicDelegatedPrefixArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GlobalPublicDelegatedPrefix(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GlobalPublicDelegatedPrefix get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
