...
import com.pulumi.googlenative.dns_v1.PolicyArgs;
...
public class Policy extends CustomResource {
    ...
    public Policy(String name, @Nullable PolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:dns/v1:Policy", name, args == null ? PolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
