...
public final class FeatureIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FeatureIamPolicyArgs(FeatureIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureIamPolicyArgs();
        }

        public Builder(FeatureIamPolicyArgs defaults) {
            $ = new FeatureIamPolicyArgs(Objects.requireNonNull(defaults));
        }
