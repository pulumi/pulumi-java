...
public class NetworkFirewallPolicyIamPolicy extends CustomResource {
    /**
     ...
     */
    public NetworkFirewallPolicyIamPolicy(String name, NetworkFirewallPolicyIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NetworkFirewallPolicyIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkFirewallPolicyIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
