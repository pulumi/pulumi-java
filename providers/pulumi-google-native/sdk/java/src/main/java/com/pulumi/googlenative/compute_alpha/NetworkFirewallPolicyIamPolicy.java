...
import com.pulumi.googlenative.compute_alpha.NetworkFirewallPolicyIamPolicyArgs;
...
public class NetworkFirewallPolicyIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public NetworkFirewallPolicyIamPolicy(String name, NetworkFirewallPolicyIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:NetworkFirewallPolicyIamPolicy", name, args == null ? NetworkFirewallPolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
