...
public final class CertificateAuthorityArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<CertificateAuthorityPolicyArgs>> certificatePolicy() {
     ...
     * 
     */
    public Optional<Output<IssuingOptionsArgs>> issuingOptions() {
        return Optional.ofNullable(this.issuingOptions);
    }
    ...
    public static final class Builder {
        ...
        /**
         * @param certificatePolicy Optional. The CertificateAuthorityPolicy to enforce when issuing Certificates from this CertificateAuthority.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder certificatePolicy(CertificateAuthorityPolicyArgs certificatePolicy) {
        ...
        /**
         * @param issuingOptions Optional. The IssuingOptions to follow when issuing Certificates from this CertificateAuthority.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder issuingOptions(IssuingOptionsArgs issuingOptions) {
            return issuingOptions(Output.of(issuingOptions));
        }
        ...
        /**
         * @param lifetime The desired lifetime of the CA certificate. Used to create the &#34;not_before_time&#34; and &#34;not_after_time&#34; fields inside an X.509 certificate.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param tier Immutable. The Tier of this CertificateAuthority.
         * 
         * @return builder
         * 
         */
