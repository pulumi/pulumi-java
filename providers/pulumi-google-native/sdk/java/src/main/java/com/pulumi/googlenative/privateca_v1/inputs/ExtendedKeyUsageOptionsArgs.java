...
public final class ExtendedKeyUsageOptionsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ExtendedKeyUsageOptionsArgs(ExtendedKeyUsageOptionsArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ExtendedKeyUsageOptionsArgs();
        }

        public Builder(ExtendedKeyUsageOptionsArgs defaults) {
            $ = new ExtendedKeyUsageOptionsArgs(Objects.requireNonNull(defaults));
        }
