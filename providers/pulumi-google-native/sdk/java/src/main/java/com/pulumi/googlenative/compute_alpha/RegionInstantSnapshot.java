...
import com.pulumi.googlenative.compute_alpha.RegionInstantSnapshotArgs;
...
public class RegionInstantSnapshot extends CustomResource {
    /**
     ...
     */
    public RegionInstantSnapshot(String name, RegionInstantSnapshotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegionInstantSnapshot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegionInstantSnapshot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
