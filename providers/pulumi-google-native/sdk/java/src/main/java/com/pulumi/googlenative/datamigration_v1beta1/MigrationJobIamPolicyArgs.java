...
import com.pulumi.googlenative.datamigration_v1beta1.inputs.AuditConfigArgs;
import com.pulumi.googlenative.datamigration_v1beta1.inputs.BindingArgs;
...
public final class MigrationJobIamPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final MigrationJobIamPolicyArgs Empty = new MigrationJobIamPolicyArgs();
    ...
    private MigrationJobIamPolicyArgs(MigrationJobIamPolicyArgs $) {
    ...
    public static Builder builder(MigrationJobIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MigrationJobIamPolicyArgs();
        }

        public Builder(MigrationJobIamPolicyArgs defaults) {
            $ = new MigrationJobIamPolicyArgs(Objects.requireNonNull(defaults));
        }
