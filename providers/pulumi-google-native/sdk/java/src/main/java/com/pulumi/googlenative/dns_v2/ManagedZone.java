...
import com.pulumi.googlenative.dns_v2.ManagedZoneArgs;
 ...
 * 
 */
@ResourceType(type="google-native:dns/v2:ManagedZone")
public class ManagedZone extends com.pulumi.resources.CustomResource {
    ...
    public ManagedZone(String name, @Nullable ManagedZoneArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dns/v2:ManagedZone", name, args == null ? ManagedZoneArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ManagedZone(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dns/v2:ManagedZone", name, null, makeResourceOptions(options, id));
    }
