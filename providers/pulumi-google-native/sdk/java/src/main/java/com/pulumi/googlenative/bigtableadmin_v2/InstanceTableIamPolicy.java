...
public class InstanceTableIamPolicy extends CustomResource {
    /**
     ...
     */
    public InstanceTableIamPolicy(String name, InstanceTableIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private InstanceTableIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static InstanceTableIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
