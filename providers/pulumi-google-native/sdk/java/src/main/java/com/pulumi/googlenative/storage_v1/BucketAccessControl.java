...
import com.pulumi.googlenative.storage_v1.BucketAccessControlArgs;
...
public class BucketAccessControl extends CustomResource {
    ...
    private BucketAccessControl(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BucketAccessControl get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
