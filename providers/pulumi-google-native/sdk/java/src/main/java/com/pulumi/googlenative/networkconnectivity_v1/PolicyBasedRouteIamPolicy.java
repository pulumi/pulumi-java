...
import com.pulumi.googlenative.networkconnectivity_v1.PolicyBasedRouteIamPolicyArgs;
import com.pulumi.googlenative.networkconnectivity_v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.networkconnectivity_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:networkconnectivity/v1:PolicyBasedRouteIamPolicy")
public class PolicyBasedRouteIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public PolicyBasedRouteIamPolicy(String name) {
        this(name, PolicyBasedRouteIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public PolicyBasedRouteIamPolicy(String name, PolicyBasedRouteIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PolicyBasedRouteIamPolicy(String name, PolicyBasedRouteIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private PolicyBasedRouteIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkconnectivity/v1:PolicyBasedRouteIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static PolicyBasedRouteIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new PolicyBasedRouteIamPolicy(name, id, options);
    }
}
