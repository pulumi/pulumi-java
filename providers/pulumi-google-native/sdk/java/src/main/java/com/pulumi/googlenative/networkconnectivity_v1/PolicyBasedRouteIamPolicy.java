...
public class PolicyBasedRouteIamPolicy extends CustomResource {
    /**
     ...
     */
    public PolicyBasedRouteIamPolicy(String name, PolicyBasedRouteIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PolicyBasedRouteIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PolicyBasedRouteIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
