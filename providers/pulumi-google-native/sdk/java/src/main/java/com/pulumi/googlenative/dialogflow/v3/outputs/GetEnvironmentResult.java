...
public final class GetEnvironmentResult {
     ...
     * 
     */
    private final GoogleCloudDialogflowCxV3EnvironmentWebhookConfigResponse webhookConfig;
    ...
    private GetEnvironmentResult(
        ...
        @CustomType.Parameter("testCasesConfig") GoogleCloudDialogflowCxV3EnvironmentTestCasesConfigResponse testCasesConfig,
        @CustomType.Parameter("updateTime") String updateTime,
        @CustomType.Parameter("versionConfigs") List<GoogleCloudDialogflowCxV3EnvironmentVersionConfigResponse> versionConfigs,
        @CustomType.Parameter("webhookConfig") GoogleCloudDialogflowCxV3EnvironmentWebhookConfigResponse webhookConfig) {
     ...
     * 
     */
    public GoogleCloudDialogflowCxV3EnvironmentTestCasesConfigResponse testCasesConfig() {
     ...
     * 
     */
    public List<GoogleCloudDialogflowCxV3EnvironmentVersionConfigResponse> versionConfigs() {
     ...
     * 
     */
    public GoogleCloudDialogflowCxV3EnvironmentWebhookConfigResponse webhookConfig() {
    ...
    public static final class Builder {
        ...
        private String name;
        private GoogleCloudDialogflowCxV3EnvironmentTestCasesConfigResponse testCasesConfig;
        private String updateTime;
        private List<GoogleCloudDialogflowCxV3EnvironmentVersionConfigResponse> versionConfigs;
        private GoogleCloudDialogflowCxV3EnvironmentWebhookConfigResponse webhookConfig;
        ...
        public Builder versionConfigs(GoogleCloudDialogflowCxV3EnvironmentVersionConfigResponse... versionConfigs) {
            return versionConfigs(List.of(versionConfigs));
        }
        public Builder webhookConfig(GoogleCloudDialogflowCxV3EnvironmentWebhookConfigResponse webhookConfig) {
