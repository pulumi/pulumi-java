...
import com.pulumi.googlenative.containeranalysis.v1beta1.outputs.DigestResponse;
import com.pulumi.googlenative.containeranalysis.v1beta1.outputs.DistributionResponse;
...
public final class PackageResponse {
    ...
    public static final class Builder {
        ...
        public Builder version(VersionResponse version) {
            ...
            return new PackageResponse(architecture, cpeUri, description, digest, distribution, license, maintainer, name, packageType, url, version);
        }
    }
}
