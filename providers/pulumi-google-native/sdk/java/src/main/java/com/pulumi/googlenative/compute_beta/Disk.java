...
import com.pulumi.googlenative.compute_beta.DiskArgs;
import com.pulumi.googlenative.compute_beta.outputs.CustomerEncryptionKeyResponse;
import com.pulumi.googlenative.compute_beta.outputs.GuestOsFeatureResponse;
...
public class Disk extends CustomResource {
    ...
    public Disk(String name, @Nullable DiskArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/beta:Disk", name, args == null ? DiskArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
