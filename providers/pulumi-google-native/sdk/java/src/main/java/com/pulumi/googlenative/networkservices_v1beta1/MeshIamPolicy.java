...
import com.pulumi.googlenative.networkservices_v1beta1.MeshIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:networkservices/v1beta1:MeshIamPolicy")
public class MeshIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public MeshIamPolicy(String name) {
        this(name, MeshIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public MeshIamPolicy(String name, MeshIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MeshIamPolicy(String name, MeshIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1beta1:MeshIamPolicy", name, args == null ? MeshIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private MeshIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1beta1:MeshIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static MeshIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new MeshIamPolicy(name, id, options);
    }
}
