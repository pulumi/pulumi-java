...
import com.pulumi.googlenative.datamigration_v1.ConnectionProfileArgs;
...
public class ConnectionProfile extends CustomResource {
     ...
     * 
     */
    public Output<PostgreSqlConnectionProfileResponse> postgresql() {
    ...
    public ConnectionProfile(String name, ConnectionProfileArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:datamigration/v1:ConnectionProfile", name, args == null ? ConnectionProfileArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
