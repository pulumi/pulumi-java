...
import com.pulumi.googlenative.compute.v1.outputs.FirewallPolicyAssociationResponse;
import com.pulumi.googlenative.compute.v1.outputs.FirewallPolicyRuleResponse;
...
@CustomType
public final class GetRegionNetworkFirewallPolicyResult {
    /**
    ...
    private GetRegionNetworkFirewallPolicyResult(
    ...
    public static Builder builder(GetRegionNetworkFirewallPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetRegionNetworkFirewallPolicyResult defaults) {
        ...
        public Builder shortName(String shortName) {
            ...
            return new GetRegionNetworkFirewallPolicyResult(associations, creationTimestamp, description, displayName, fingerprint, kind, name, parent, region, ruleTupleCount, rules, selfLink, selfLinkWithId, shortName);
        }
    }
}
