...
import com.pulumi.googlenative.cloudbilling_v1.BillingAccountArgs;
...
public class BillingAccount extends CustomResource {
    /**
     ...
     */
    public BillingAccount(String name, @Nullable BillingAccountArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BillingAccount(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BillingAccount get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
