...
import com.pulumi.googlenative.compute_alpha.TargetSslProxyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:TargetSslProxy")
public class TargetSslProxy extends CustomResource {
    /**
     ...
     */
    public TargetSslProxy(String name, @Nullable TargetSslProxyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TargetSslProxy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:compute/alpha:TargetSslProxy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static TargetSslProxy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
