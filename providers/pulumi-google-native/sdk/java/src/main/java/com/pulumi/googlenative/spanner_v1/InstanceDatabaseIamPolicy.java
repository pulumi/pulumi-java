...
import com.pulumi.googlenative.spanner_v1.InstanceDatabaseIamPolicyArgs;
import com.pulumi.googlenative.spanner_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:spanner/v1:InstanceDatabaseIamPolicy")
public class InstanceDatabaseIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public InstanceDatabaseIamPolicy(String name, InstanceDatabaseIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:spanner/v1:InstanceDatabaseIamPolicy", name, args == null ? InstanceDatabaseIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private InstanceDatabaseIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:spanner/v1:InstanceDatabaseIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static InstanceDatabaseIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new InstanceDatabaseIamPolicy(name, id, options);
    }
}
