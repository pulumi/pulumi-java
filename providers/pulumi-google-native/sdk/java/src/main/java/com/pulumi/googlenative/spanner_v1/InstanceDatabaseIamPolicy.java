...
public class InstanceDatabaseIamPolicy extends CustomResource {
    /**
     ...
     */
    public InstanceDatabaseIamPolicy(String name, InstanceDatabaseIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private InstanceDatabaseIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static InstanceDatabaseIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
