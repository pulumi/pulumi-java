...
public class AccessPolicyIamPolicy extends CustomResource {
    /**
     ...
     */
    public AccessPolicyIamPolicy(String name, AccessPolicyIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AccessPolicyIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AccessPolicyIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
