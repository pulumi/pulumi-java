...
import com.pulumi.googlenative.accesscontextmanager_v1.AccessPolicyIamPolicyArgs;
import com.pulumi.googlenative.accesscontextmanager_v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.accesscontextmanager_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:accesscontextmanager/v1:AccessPolicyIamPolicy")
public class AccessPolicyIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public AccessPolicyIamPolicy(String name) {
     ...
     */
    public AccessPolicyIamPolicy(String name, AccessPolicyIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:accesscontextmanager/v1:AccessPolicyIamPolicy", name, args == null ? AccessPolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AccessPolicyIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:accesscontextmanager/v1:AccessPolicyIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static AccessPolicyIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
