...
import com.pulumi.googlenative.compute_v1.ImageIamPolicyArgs;
...
public class ImageIamPolicy extends CustomResource {
    ...
    public ImageIamPolicy(String name, ImageIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/v1:ImageIamPolicy", name, args == null ? ImageIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
