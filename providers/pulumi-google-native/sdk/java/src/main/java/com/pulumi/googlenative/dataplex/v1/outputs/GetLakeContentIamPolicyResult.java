...
@CustomType
public final class GetLakeContentIamPolicyResult {
    /**
    ...
    public static Builder builder(GetLakeContentIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetLakeContentIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetLakeContentIamPolicyResult build() {
            return new GetLakeContentIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
