...
import com.pulumi.googlenative.iam_v1.OrganizationRoleArgs;
...
public class OrganizationRole extends com.pulumi.resources.CustomResource {
     ...
     */
    public OrganizationRole(String name, OrganizationRoleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private OrganizationRole(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static OrganizationRole get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
