...
public class OrganizationRole extends CustomResource {
    /**
     ...
     */
    public OrganizationRole(String name, OrganizationRoleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OrganizationRole(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OrganizationRole get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
