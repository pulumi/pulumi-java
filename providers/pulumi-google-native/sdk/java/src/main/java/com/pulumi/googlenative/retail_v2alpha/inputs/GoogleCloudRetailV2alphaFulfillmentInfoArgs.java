...
public final class GoogleCloudRetailV2alphaFulfillmentInfoArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GoogleCloudRetailV2alphaFulfillmentInfoArgs(GoogleCloudRetailV2alphaFulfillmentInfoArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleCloudRetailV2alphaFulfillmentInfoArgs();
        }

        public Builder(GoogleCloudRetailV2alphaFulfillmentInfoArgs defaults) {
            $ = new GoogleCloudRetailV2alphaFulfillmentInfoArgs(Objects.requireNonNull(defaults));
        }
