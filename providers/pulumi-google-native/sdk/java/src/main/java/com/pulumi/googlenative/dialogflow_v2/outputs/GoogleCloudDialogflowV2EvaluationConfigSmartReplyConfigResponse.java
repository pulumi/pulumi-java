...
@CustomType
public final class GoogleCloudDialogflowV2EvaluationConfigSmartReplyConfigResponse {
    /**
    ...
    public static Builder builder(GoogleCloudDialogflowV2EvaluationConfigSmartReplyConfigResponse defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GoogleCloudDialogflowV2EvaluationConfigSmartReplyConfigResponse defaults) {
        ...
        public Builder maxResultCount(Integer maxResultCount) {
            ...
            return this;
        }        public GoogleCloudDialogflowV2EvaluationConfigSmartReplyConfigResponse build() {
            return new GoogleCloudDialogflowV2EvaluationConfigSmartReplyConfigResponse(allowlistDocument, maxResultCount);
        }
    }
}
