...
import com.pulumi.googlenative.managedidentities_v1alpha1.DomainBackupIamPolicyArgs;
...
public class DomainBackupIamPolicy extends CustomResource {
    /**
     ...
     */
    public DomainBackupIamPolicy(String name, DomainBackupIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DomainBackupIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DomainBackupIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
