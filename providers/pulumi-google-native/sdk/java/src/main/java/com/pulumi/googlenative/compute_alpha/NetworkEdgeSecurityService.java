...
import com.pulumi.googlenative.compute_alpha.NetworkEdgeSecurityServiceArgs;
...
public class NetworkEdgeSecurityService extends CustomResource {
    /**
     ...
     */
    public NetworkEdgeSecurityService(String name, NetworkEdgeSecurityServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NetworkEdgeSecurityService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkEdgeSecurityService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
