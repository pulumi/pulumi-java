...
import com.pulumi.googlenative.dialogflow_v2.KnowledgeBaseArgs;
 ...
 * 
 */
@ResourceType(type="google-native:dialogflow/v2:KnowledgeBase")
public class KnowledgeBase extends com.pulumi.resources.CustomResource {
    ...
    private KnowledgeBase(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v2:KnowledgeBase", name, null, makeResourceOptions(options, id));
    }
