...
import com.pulumi.googlenative.compute_alpha.RegionSslPolicyArgs;
...
public class RegionSslPolicy extends CustomResource {
    /**
     ...
     */
    public RegionSslPolicy(String name, RegionSslPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegionSslPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegionSslPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
