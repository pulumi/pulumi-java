...
import com.pulumi.googlenative.cloudresourcemanager_v2.FolderArgs;
...
public class Folder extends CustomResource {
    ...
    private Folder(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Folder get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
