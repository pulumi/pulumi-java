...
public final class LicenseIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private LicenseIamPolicyArgs(LicenseIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LicenseIamPolicyArgs();
        }

        public Builder(LicenseIamPolicyArgs defaults) {
            $ = new LicenseIamPolicyArgs(Objects.requireNonNull(defaults));
        }
