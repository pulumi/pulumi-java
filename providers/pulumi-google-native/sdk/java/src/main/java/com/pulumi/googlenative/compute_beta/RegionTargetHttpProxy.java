...
import com.pulumi.googlenative.compute_beta.RegionTargetHttpProxyArgs;
...
public class RegionTargetHttpProxy extends com.pulumi.resources.CustomResource {
    ...
    public RegionTargetHttpProxy(String name, RegionTargetHttpProxyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:RegionTargetHttpProxy", name, args == null ? RegionTargetHttpProxyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
