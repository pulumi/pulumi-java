...
public final class GoogleCloudBillingBudgetsV1FilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Output<GoogleCloudBillingBudgetsV1FilterCalendarPeriod> calendarPeriod() {
    ...
    public Output<GoogleCloudBillingBudgetsV1FilterCreditTypesTreatment> creditTypesTreatment() {
    ...
    public Output<GoogleCloudBillingBudgetsV1CustomPeriodArgs> customPeriod() {
