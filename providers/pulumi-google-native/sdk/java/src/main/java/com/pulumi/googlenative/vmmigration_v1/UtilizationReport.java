...
import com.pulumi.googlenative.vmmigration_v1.UtilizationReportArgs;
import com.pulumi.googlenative.vmmigration_v1.outputs.StatusResponse;
import com.pulumi.googlenative.vmmigration_v1.outputs.VmUtilizationInfoResponse;
...
public class UtilizationReport extends CustomResource {
    /**
     ...
     */
    public UtilizationReport(String name, UtilizationReportArgs args, @Nullable CustomResourceOptions options) {
    ...
    private UtilizationReport(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UtilizationReport get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
