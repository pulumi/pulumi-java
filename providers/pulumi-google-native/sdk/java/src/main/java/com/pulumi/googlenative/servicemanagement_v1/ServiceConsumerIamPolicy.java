...
public class ServiceConsumerIamPolicy extends CustomResource {
    /**
     ...
     */
    public ServiceConsumerIamPolicy(String name, ServiceConsumerIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceConsumerIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceConsumerIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
