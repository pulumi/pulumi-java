...
import com.pulumi.googlenative.servicemanagement_v1.ServiceConsumerIamPolicyArgs;
import com.pulumi.googlenative.servicemanagement_v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.servicemanagement_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:servicemanagement/v1:ServiceConsumerIamPolicy")
public class ServiceConsumerIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ServiceConsumerIamPolicy(String name) {
        this(name, ServiceConsumerIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ServiceConsumerIamPolicy(String name, ServiceConsumerIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ServiceConsumerIamPolicy(String name, ServiceConsumerIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:servicemanagement/v1:ServiceConsumerIamPolicy", name, args == null ? ServiceConsumerIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ServiceConsumerIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ServiceConsumerIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
