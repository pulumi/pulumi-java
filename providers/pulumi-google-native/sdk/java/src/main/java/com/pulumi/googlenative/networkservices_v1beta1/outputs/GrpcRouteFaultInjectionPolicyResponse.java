...
import com.pulumi.googlenative.networkservices_v1beta1.outputs.GrpcRouteFaultInjectionPolicyAbortResponse;
import com.pulumi.googlenative.networkservices_v1beta1.outputs.GrpcRouteFaultInjectionPolicyDelayResponse;
...
public final class GrpcRouteFaultInjectionPolicyResponse {
     ...
     * 
     */
    private final GrpcRouteFaultInjectionPolicyAbortResponse abort;
    /**
     * @return The specification for injecting delay to client requests.
     * 
     */
    private final GrpcRouteFaultInjectionPolicyDelayResponse delay;

    @CustomType.Constructor
    private GrpcRouteFaultInjectionPolicyResponse(
        @CustomType.Parameter("abort") GrpcRouteFaultInjectionPolicyAbortResponse abort,
        @CustomType.Parameter("delay") GrpcRouteFaultInjectionPolicyDelayResponse delay) {
        this.abort = abort;
        this.delay = delay;
    }
    ...
    public static final class Builder {
        ...
        public Builder delay(GrpcRouteFaultInjectionPolicyDelayResponse delay) {
            ...
            return new GrpcRouteFaultInjectionPolicyResponse(abort, delay);
        }
    }
}
