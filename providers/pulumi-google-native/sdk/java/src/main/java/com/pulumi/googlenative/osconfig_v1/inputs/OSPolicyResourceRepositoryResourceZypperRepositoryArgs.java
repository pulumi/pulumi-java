...
public final class OSPolicyResourceRepositoryResourceZypperRepositoryArgs extends ResourceArgs {
    ...
    /**
     * @return A one word, unique name for this repository. This is the `repo id` in the zypper config file and also the `display_name` if `display_name` is omitted. This id is also used as the unique identifier when checking for GuestPolicy conflicts.
     * 
     */
    ...
    private OSPolicyResourceRepositoryResourceZypperRepositoryArgs(OSPolicyResourceRepositoryResourceZypperRepositoryArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OSPolicyResourceRepositoryResourceZypperRepositoryArgs();
        }

        public Builder(OSPolicyResourceRepositoryResourceZypperRepositoryArgs defaults) {
            $ = new OSPolicyResourceRepositoryResourceZypperRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param id A one word, unique name for this repository. This is the `repo id` in the zypper config file and also the `display_name` if `display_name` is omitted. This id is also used as the unique identifier when checking for GuestPolicy conflicts.
         * 
         * @return builder
         * 
         */
