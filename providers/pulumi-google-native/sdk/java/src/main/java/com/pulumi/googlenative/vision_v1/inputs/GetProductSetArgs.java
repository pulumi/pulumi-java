...
public final class GetProductSetArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private Output<String> productSetId;
    ...
    public static final class Builder {
        ...
        public Builder productSetId(Output<String> productSetId) {
