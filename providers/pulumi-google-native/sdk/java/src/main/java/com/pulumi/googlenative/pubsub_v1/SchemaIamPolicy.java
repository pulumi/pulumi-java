...
public class SchemaIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private SchemaIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SchemaIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
