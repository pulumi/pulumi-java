...
import com.pulumi.googlenative.beyondcorp.v1alpha.outputs.GoogleIamV1AuditConfigResponse;
import com.pulumi.googlenative.beyondcorp.v1alpha.outputs.GoogleIamV1BindingResponse;
...
@CustomType
public final class GetConnectorIamPolicyResult {
    /**
    ...
    private GetConnectorIamPolicyResult(
    ...
    public static Builder builder(GetConnectorIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetConnectorIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetConnectorIamPolicyResult build() {
            return new GetConnectorIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
