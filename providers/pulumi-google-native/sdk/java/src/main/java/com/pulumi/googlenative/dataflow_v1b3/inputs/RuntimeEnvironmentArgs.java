...
public final class RuntimeEnvironmentArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Additional experiment flags for the job, specified with the `--experiments` option.
     * 
     */
    ...
    /**
     * @return The maximum number of Google Compute Engine instances to be made available to your pipeline during execution, from 1 to 1000.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param additionalExperiments Additional experiment flags for the job, specified with the `--experiments` option.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param maxWorkers The maximum number of Google Compute Engine instances to be made available to your pipeline during execution, from 1 to 1000.
         * 
         * @return builder
         * 
         */
