...
public class CaPoolIamPolicy extends CustomResource {
    ...
    private CaPoolIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CaPoolIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
