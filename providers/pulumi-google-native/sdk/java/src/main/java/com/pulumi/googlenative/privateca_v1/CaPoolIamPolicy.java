...
import com.pulumi.googlenative.privateca_v1.CaPoolIamPolicyArgs;
...
public class CaPoolIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private CaPoolIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static CaPoolIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
