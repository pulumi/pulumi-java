...
public final class ResourcePolicySnapshotSchedulePolicyRetentionPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<ResourcePolicySnapshotSchedulePolicyRetentionPolicyOnPolicySwitch>> onPolicySwitch() {
        return Optional.ofNullable(this.onPolicySwitch);
    }
    ...
    public static final class Builder {
        ...
        public Builder onPolicySwitch(ResourcePolicySnapshotSchedulePolicyRetentionPolicyOnPolicySwitch onPolicySwitch) {
            return onPolicySwitch(Output.of(onPolicySwitch));
        }
