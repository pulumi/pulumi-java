...
public final class ResponsePolicyNetworkArgs extends com.pulumi.resources.ResourceArgs {

    public static final ResponsePolicyNetworkArgs Empty = new ResponsePolicyNetworkArgs();
    ...
    private ResponsePolicyNetworkArgs() {}

    private ResponsePolicyNetworkArgs(ResponsePolicyNetworkArgs $) {
        this.kind = $.kind;
    ...
    public static Builder builder(ResponsePolicyNetworkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ResponsePolicyNetworkArgs();
        }

        public Builder(ResponsePolicyNetworkArgs defaults) {
            $ = new ResponsePolicyNetworkArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ResponsePolicyNetworkArgs build() {
            return $;
        }
    }
