...
import com.pulumi.googlenative.apigee_v1.TargetServerArgs;
import com.pulumi.googlenative.apigee_v1.outputs.GoogleCloudApigeeV1TlsInfoResponse;
...
public class TargetServer extends CustomResource {
    /**
     ...
     */
    public TargetServer(String name, TargetServerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TargetServer(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TargetServer get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
