...
import com.pulumi.googlenative.cloudkms_v1.KeyRingIamPolicyArgs;
...
public class KeyRingIamPolicy extends CustomResource {
    ...
    private KeyRingIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static KeyRingIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
