...
import com.pulumi.googlenative.cloudresourcemanager_v3.TagKeyIamPolicyArgs;
...
public class TagKeyIamPolicy extends CustomResource {
    ...
    private TagKeyIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TagKeyIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
