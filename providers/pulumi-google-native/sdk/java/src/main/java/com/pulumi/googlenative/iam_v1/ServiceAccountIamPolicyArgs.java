...
import com.pulumi.googlenative.iam_v1.inputs.AuditConfigArgs;
import com.pulumi.googlenative.iam_v1.inputs.BindingArgs;
...
public final class ServiceAccountIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServiceAccountIamPolicyArgs(ServiceAccountIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceAccountIamPolicyArgs();
        }

        public Builder(ServiceAccountIamPolicyArgs defaults) {
            $ = new ServiceAccountIamPolicyArgs(Objects.requireNonNull(defaults));
        }
