...
import com.pulumi.googlenative.dataplex_v1.inputs.GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptionsArgs;
import com.pulumi.googlenative.dataplex_v1.inputs.GoogleCloudDataplexV1ZoneDiscoverySpecJsonOptionsArgs;
 ...
 * 
 */
public final class GoogleCloudDataplexV1ZoneDiscoverySpecArgs extends com.pulumi.resources.ResourceArgs {

    public static final GoogleCloudDataplexV1ZoneDiscoverySpecArgs Empty = new GoogleCloudDataplexV1ZoneDiscoverySpecArgs();
    ...
    private @Nullable Output<GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptionsArgs> csvOptions;

    /**
     * @return Optional. Configuration for CSV data.
     * 
     */
    public Optional<Output<GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptionsArgs>> csvOptions() {
    ...
    private @Nullable Output<GoogleCloudDataplexV1ZoneDiscoverySpecJsonOptionsArgs> jsonOptions;

    /**
     * @return Optional. Configuration for Json data.
     * 
     */
    public Optional<Output<GoogleCloudDataplexV1ZoneDiscoverySpecJsonOptionsArgs>> jsonOptions() {
    ...
    private GoogleCloudDataplexV1ZoneDiscoverySpecArgs() {}

    private GoogleCloudDataplexV1ZoneDiscoverySpecArgs(GoogleCloudDataplexV1ZoneDiscoverySpecArgs $) {
    ...
    public static Builder builder(GoogleCloudDataplexV1ZoneDiscoverySpecArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleCloudDataplexV1ZoneDiscoverySpecArgs();
        }

        public Builder(GoogleCloudDataplexV1ZoneDiscoverySpecArgs defaults) {
            $ = new GoogleCloudDataplexV1ZoneDiscoverySpecArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder csvOptions(@Nullable Output<GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptionsArgs> csvOptions) {
         ...
         * 
         */
        public Builder csvOptions(GoogleCloudDataplexV1ZoneDiscoverySpecCsvOptionsArgs csvOptions) {
         ...
         * 
         */
        public Builder jsonOptions(@Nullable Output<GoogleCloudDataplexV1ZoneDiscoverySpecJsonOptionsArgs> jsonOptions) {
         ...
         * 
         */
        public Builder jsonOptions(GoogleCloudDataplexV1ZoneDiscoverySpecJsonOptionsArgs jsonOptions) {
        ...
        public GoogleCloudDataplexV1ZoneDiscoverySpecArgs build() {
