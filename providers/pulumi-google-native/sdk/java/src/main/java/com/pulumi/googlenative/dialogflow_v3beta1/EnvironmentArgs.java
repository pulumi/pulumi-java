...
public final class EnvironmentArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Output<GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfigArgs> testCasesConfig() {
    ...
    public EnvironmentArgs(
        ...
        @Nullable Output<GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfigArgs> testCasesConfig,
        Output<List<GoogleCloudDialogflowCxV3beta1EnvironmentVersionConfigArgs>> versionConfigs) {
