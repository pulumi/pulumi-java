 ...
 * 
 */
public final class GoogleTypePostalAddressResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private GoogleTypePostalAddressResponse(GoogleTypePostalAddressResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleTypePostalAddressResponse();
        }

        public Builder(GoogleTypePostalAddressResponse defaults) {
            $ = new GoogleTypePostalAddressResponse(Objects.requireNonNull(defaults));
        }
