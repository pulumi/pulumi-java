...
import com.pulumi.googlenative.appengine_v1beta.IngressRuleArgs;
...
public class IngressRule extends CustomResource {
    /**
     ...
     */
    public IngressRule(String name, IngressRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IngressRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IngressRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
