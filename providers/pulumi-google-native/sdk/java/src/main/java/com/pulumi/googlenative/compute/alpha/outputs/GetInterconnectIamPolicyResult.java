...
import com.pulumi.googlenative.compute.alpha.outputs.AuditConfigResponse;
import com.pulumi.googlenative.compute.alpha.outputs.BindingResponse;
import com.pulumi.googlenative.compute.alpha.outputs.RuleResponse;
...
public final class GetInterconnectIamPolicyResult {
    ...
    public static Builder builder(GetInterconnectIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetInterconnectIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetInterconnectIamPolicyResult build() {
            return new GetInterconnectIamPolicyResult(auditConfigs, bindings, etag, rules, version);
        }
    }
}
