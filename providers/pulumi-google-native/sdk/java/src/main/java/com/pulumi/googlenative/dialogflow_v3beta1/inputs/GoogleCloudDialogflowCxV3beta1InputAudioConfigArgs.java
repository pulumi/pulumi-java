...
import com.pulumi.googlenative.dialogflow_v3beta1.enums.GoogleCloudDialogflowCxV3beta1InputAudioConfigAudioEncoding;
import com.pulumi.googlenative.dialogflow_v3beta1.enums.GoogleCloudDialogflowCxV3beta1InputAudioConfigModelVariant;
 ...
 * 
 */
public final class GoogleCloudDialogflowCxV3beta1InputAudioConfigArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<GoogleCloudDialogflowCxV3beta1InputAudioConfigModelVariant>> modelVariant() {
    ...
    private GoogleCloudDialogflowCxV3beta1InputAudioConfigArgs(GoogleCloudDialogflowCxV3beta1InputAudioConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleCloudDialogflowCxV3beta1InputAudioConfigArgs();
        }

        public Builder(GoogleCloudDialogflowCxV3beta1InputAudioConfigArgs defaults) {
            $ = new GoogleCloudDialogflowCxV3beta1InputAudioConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder modelVariant(GoogleCloudDialogflowCxV3beta1InputAudioConfigModelVariant modelVariant) {
