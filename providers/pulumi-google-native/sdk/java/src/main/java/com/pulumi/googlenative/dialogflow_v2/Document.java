...
public class Document extends CustomResource {
    ...
    private Document(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Document get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
