...
import com.pulumi.googlenative.pubsub_v1.TopicIamPolicyArgs;
...
public class TopicIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public TopicIamPolicy(String name, TopicIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:pubsub/v1:TopicIamPolicy", name, args == null ? TopicIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
