...
import com.pulumi.googlenative.networkservices_v1beta1.ServiceBindingIamPolicyArgs;
...
public class ServiceBindingIamPolicy extends CustomResource {
    /**
     ...
     */
    public ServiceBindingIamPolicy(String name, ServiceBindingIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceBindingIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceBindingIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
