...
import com.pulumi.googlenative.healthcare_v1.ConsentStoreArgs;
...
public class ConsentStore extends CustomResource {
    ...
    private ConsentStore(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConsentStore get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
