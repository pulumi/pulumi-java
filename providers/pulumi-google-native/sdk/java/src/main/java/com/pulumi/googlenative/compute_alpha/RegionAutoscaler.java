...
import com.pulumi.googlenative.compute_alpha.RegionAutoscalerArgs;
...
public class RegionAutoscaler extends CustomResource {
    ...
    private RegionAutoscaler(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegionAutoscaler get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
