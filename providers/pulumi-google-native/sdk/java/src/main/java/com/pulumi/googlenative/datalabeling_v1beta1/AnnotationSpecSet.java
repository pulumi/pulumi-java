...
import com.pulumi.googlenative.datalabeling_v1beta1.AnnotationSpecSetArgs;
...
public class AnnotationSpecSet extends CustomResource {
    /**
     ...
     */
    public AnnotationSpecSet(String name, AnnotationSpecSetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AnnotationSpecSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AnnotationSpecSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
