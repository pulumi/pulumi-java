...
import com.pulumi.googlenative.datalabeling_v1beta1.EvaluationJobArgs;
...
public class EvaluationJob extends CustomResource {
    /**
     ...
     */
    public EvaluationJob(String name, EvaluationJobArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EvaluationJob(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EvaluationJob get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
