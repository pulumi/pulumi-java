...
public final class GetTargetHttpsProxyResult {
    ...
    public static final class Builder {
        ...
        public Builder urlMap(String urlMap) {
            ...
            return new GetTargetHttpsProxyResult(authorizationPolicy, certificateMap, creationTimestamp, description, fingerprint, kind, name, proxyBind, quicOverride, region, selfLink, serverTlsPolicy, sslCertificates, sslPolicy, urlMap);
        }
    }
}
