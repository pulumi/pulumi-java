...
public class ImageIamPolicy extends CustomResource {
    /**
     ...
     */
    public ImageIamPolicy(String name, ImageIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ImageIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ImageIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
