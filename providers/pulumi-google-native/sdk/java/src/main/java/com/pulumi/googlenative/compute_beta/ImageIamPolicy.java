...
import com.pulumi.googlenative.compute_beta.ImageIamPolicyArgs;
...
public class ImageIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ImageIamPolicy(String name, ImageIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:ImageIamPolicy", name, args == null ? ImageIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ImageIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ImageIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
