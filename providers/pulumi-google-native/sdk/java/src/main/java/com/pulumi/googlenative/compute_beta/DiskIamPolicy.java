...
import com.pulumi.googlenative.compute_beta.DiskIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:DiskIamPolicy")
public class DiskIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public DiskIamPolicy(String name, DiskIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:DiskIamPolicy", name, args == null ? DiskIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DiskIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:DiskIamPolicy", name, null, makeResourceOptions(options, id));
    }
