...
import com.pulumi.googlenative.datacatalog_v1.TaxonomyIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:datacatalog/v1:TaxonomyIamPolicy")
public class TaxonomyIamPolicy extends CustomResource {
    ...
    public TaxonomyIamPolicy(String name, TaxonomyIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:datacatalog/v1:TaxonomyIamPolicy", name, args == null ? TaxonomyIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TaxonomyIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:datacatalog/v1:TaxonomyIamPolicy", name, null, makeResourceOptions(options, id));
    }
