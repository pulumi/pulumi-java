...
public final class GetOccurrenceResult {
    ...
    public static final class Builder {
        ...
        public Builder vulnerability(GrafeasV1beta1VulnerabilityDetailsResponse vulnerability) {
            ...
            return new GetOccurrenceResult(attestation, build, createTime, deployment, derivedImage, discovered, envelope, installation, intoto, kind, name, noteName, remediation, resource, sbom, spdxFile, spdxPackage, spdxRelationship, updateTime, vulnerability);
        }
    }
}
