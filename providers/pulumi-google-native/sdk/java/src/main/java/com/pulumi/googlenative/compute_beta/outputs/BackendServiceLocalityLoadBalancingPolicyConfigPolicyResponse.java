...
public final class BackendServiceLocalityLoadBalancingPolicyConfigPolicyResponse {
    ...
    private BackendServiceLocalityLoadBalancingPolicyConfigPolicyResponse(@CustomType.Parameter("name") String name) {
        this.name = name;
    }
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            ...
            return new BackendServiceLocalityLoadBalancingPolicyConfigPolicyResponse(name);
        }
    }
}
