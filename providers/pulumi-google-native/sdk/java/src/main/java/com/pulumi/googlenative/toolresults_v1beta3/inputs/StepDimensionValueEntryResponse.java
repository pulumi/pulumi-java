...
public final class StepDimensionValueEntryResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private StepDimensionValueEntryResponse(StepDimensionValueEntryResponse $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StepDimensionValueEntryResponse();
        }

        public Builder(StepDimensionValueEntryResponse defaults) {
            $ = new StepDimensionValueEntryResponse(Objects.requireNonNull(defaults));
        }
