...
import com.pulumi.googlenative.compute_alpha.InstantSnapshotArgs;
...
public class InstantSnapshot extends com.pulumi.resources.CustomResource {
     ...
     */
    public InstantSnapshot(String name, @Nullable InstantSnapshotArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private InstantSnapshot(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static InstantSnapshot get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
