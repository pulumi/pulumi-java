...
public class InstantSnapshot extends CustomResource {
    /**
     ...
     */
    public InstantSnapshot(String name, @Nullable InstantSnapshotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private InstantSnapshot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static InstantSnapshot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
