...
public final class SourceInstancePropertiesResponse {
    ...
    public static final class Builder {
        ...
        public Builder tags(TagsResponse tags) {
            ...
            return new SourceInstancePropertiesResponse(canIpForward, deletionProtection, description, disks, guestAccelerators, keyRevocationActionType, labels, machineType, metadata, minCpuPlatform, networkInterfaces, scheduling, serviceAccounts, tags);
        }
    }
}
