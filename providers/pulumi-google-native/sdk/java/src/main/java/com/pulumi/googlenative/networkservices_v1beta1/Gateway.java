...
import com.pulumi.googlenative.networkservices_v1beta1.GatewayArgs;
 ...
 * 
 */
@ResourceType(type="google-native:networkservices/v1beta1:Gateway")
public class Gateway extends com.pulumi.resources.CustomResource {
    ...
    public Gateway(String name, GatewayArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1beta1:Gateway", name, args == null ? GatewayArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Gateway(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1beta1:Gateway", name, null, makeResourceOptions(options, id));
    }
