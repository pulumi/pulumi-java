...
import com.pulumi.googlenative.containeranalysis_v1alpha1.NoteIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:containeranalysis/v1alpha1:NoteIamPolicy")
public class NoteIamPolicy extends CustomResource {
    /**
     ...
     */
    public NoteIamPolicy(String name, NoteIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:containeranalysis/v1alpha1:NoteIamPolicy", name, args == null ? NoteIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private NoteIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:containeranalysis/v1alpha1:NoteIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static NoteIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
