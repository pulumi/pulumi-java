...
import com.pulumi.googlenative.eventarc_v1.TriggerIamPolicyArgs;
import com.pulumi.googlenative.eventarc_v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.eventarc_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:eventarc/v1:TriggerIamPolicy")
public class TriggerIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public TriggerIamPolicy(String name) {
        this(name, TriggerIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public TriggerIamPolicy(String name, TriggerIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TriggerIamPolicy(String name, TriggerIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:eventarc/v1:TriggerIamPolicy", name, args == null ? TriggerIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TriggerIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:eventarc/v1:TriggerIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static TriggerIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new TriggerIamPolicy(name, id, options);
    }
}
