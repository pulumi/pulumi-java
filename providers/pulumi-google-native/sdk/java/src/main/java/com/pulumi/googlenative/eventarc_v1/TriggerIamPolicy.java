...
public class TriggerIamPolicy extends CustomResource {
    /**
     ...
     */
    public TriggerIamPolicy(String name, TriggerIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TriggerIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TriggerIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
