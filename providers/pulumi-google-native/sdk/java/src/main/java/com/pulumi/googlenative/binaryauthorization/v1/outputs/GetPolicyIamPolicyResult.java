...
import com.pulumi.googlenative.binaryauthorization.v1.outputs.BindingResponse;
...
@CustomType
public final class GetPolicyIamPolicyResult {
    /**
    ...
    private GetPolicyIamPolicyResult(
    ...
    public static Builder builder(GetPolicyIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetPolicyIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetPolicyIamPolicyResult build() {
            return new GetPolicyIamPolicyResult(bindings, etag, version);
        }
    }
}
