...
import com.pulumi.googlenative.compute_beta.enums.BackendServiceCdnPolicyCacheMode;
import com.pulumi.googlenative.compute_beta.inputs.BackendServiceCdnPolicyBypassCacheOnRequestHeaderArgs;
import com.pulumi.googlenative.compute_beta.inputs.BackendServiceCdnPolicyNegativeCachingPolicyArgs;
import com.pulumi.googlenative.compute_beta.inputs.CacheKeyPolicyArgs;
...
public final class BackendServiceCdnPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Output<List<BackendServiceCdnPolicyBypassCacheOnRequestHeaderArgs>> bypassCacheOnRequestHeaders() {
    ...
    public Output<CacheKeyPolicyArgs> cacheKeyPolicy() {
    ...
    public Output<BackendServiceCdnPolicyCacheMode> cacheMode() {
    ...
    public Output<List<BackendServiceCdnPolicyNegativeCachingPolicyArgs>> negativeCachingPolicy() {
    ...
    public static final class Builder {
        ...
        public Builder negativeCachingPolicy(BackendServiceCdnPolicyNegativeCachingPolicyArgs... negativeCachingPolicy) {
