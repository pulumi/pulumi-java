...
import com.pulumi.googlenative.cloudfunctions_v2alpha.FunctionArgs;
import com.pulumi.googlenative.cloudfunctions_v2alpha.outputs.BuildConfigResponse;
import com.pulumi.googlenative.cloudfunctions_v2alpha.outputs.EventTriggerResponse;
import com.pulumi.googlenative.cloudfunctions_v2alpha.outputs.GoogleCloudFunctionsV2alphaStateMessageResponse;
import com.pulumi.googlenative.cloudfunctions_v2alpha.outputs.ServiceConfigResponse;
 ...
 * 
 */
@ResourceType(type="google-native:cloudfunctions/v2alpha:Function")
public class Function extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="stateMessages", type=List.class, parameters={GoogleCloudFunctionsV2alphaStateMessageResponse.class})
    private Output<List<GoogleCloudFunctionsV2alphaStateMessageResponse>> stateMessages;

    /**
     * @return State Messages for this Cloud Function.
     * 
     */
    public Output<List<GoogleCloudFunctionsV2alphaStateMessageResponse>> stateMessages() {
    ...
    public Function(String name, @Nullable FunctionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudfunctions/v2alpha:Function", name, args == null ? FunctionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Function(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudfunctions/v2alpha:Function", name, null, makeResourceOptions(options, id));
    }
