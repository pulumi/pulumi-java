...
import com.pulumi.googlenative.tpu_v1alpha1.NodeArgs;
...
public class Node extends CustomResource {
    ...
    private Node(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Node get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
