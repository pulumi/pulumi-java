...
import com.pulumi.googlenative.gkehub_v1beta1.MembershipIamPolicyArgs;
import com.pulumi.googlenative.gkehub_v1beta1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.gkehub_v1beta1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:gkehub/v1beta1:MembershipIamPolicy")
public class MembershipIamPolicy extends CustomResource {
    /**
     ...
     */
    public MembershipIamPolicy(String name, MembershipIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:gkehub/v1beta1:MembershipIamPolicy", name, args == null ? MembershipIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private MembershipIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:gkehub/v1beta1:MembershipIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static MembershipIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
