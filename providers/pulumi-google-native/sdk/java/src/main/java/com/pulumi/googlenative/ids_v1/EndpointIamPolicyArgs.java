...
import com.pulumi.googlenative.ids_v1.inputs.AuditConfigArgs;
import com.pulumi.googlenative.ids_v1.inputs.BindingArgs;
...
public final class EndpointIamPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final EndpointIamPolicyArgs Empty = new EndpointIamPolicyArgs();
    ...
    public static Builder builder(EndpointIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(EndpointIamPolicyArgs defaults) {
        ...
        public Builder version(@Nullable Integer version) {
            ...
            return this;
        }        public EndpointIamPolicyArgs build() {
            return new EndpointIamPolicyArgs(auditConfigs, bindings, endpointId, etag, location, project, updateMask, version);
        }
    }
}
