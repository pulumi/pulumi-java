...
public final class GetFirewallPolicyResult {
    ...
    public static final class Builder {
        ...
        public Builder vpcNetworkScope(String vpcNetworkScope) {
            ...
            return new GetFirewallPolicyResult(associations, creationTimestamp, description, displayName, fingerprint, kind, name, parent, region, ruleTupleCount, rules, selfLink, selfLinkWithId, shortName, vpcNetworkScope);
        }
    }
}
