...
import com.pulumi.googlenative.datacatalog_v1.EntryGroupIamPolicyArgs;
...
public class EntryGroupIamPolicy extends CustomResource {
    ...
    private EntryGroupIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EntryGroupIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
