...
import com.pulumi.googlenative.networkservices_v1beta1.EndpointPolicyIamPolicyArgs;
import com.pulumi.googlenative.networkservices_v1beta1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.networkservices_v1beta1.outputs.BindingResponse;
...
public class EndpointPolicyIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public EndpointPolicyIamPolicy(String name, EndpointPolicyIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1beta1:EndpointPolicyIamPolicy", name, args == null ? EndpointPolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private EndpointPolicyIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static EndpointPolicyIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
