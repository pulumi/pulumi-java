...
public class EndpointPolicyIamPolicy extends CustomResource {
    /**
     ...
     */
    public EndpointPolicyIamPolicy(String name, EndpointPolicyIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EndpointPolicyIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EndpointPolicyIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
