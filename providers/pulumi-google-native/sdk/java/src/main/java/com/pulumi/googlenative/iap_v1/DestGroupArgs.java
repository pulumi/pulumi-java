...
public final class DestGroupArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Required. The ID to use for the TunnelDestGroup, which will become the final component of the resource name. This value should be 4-63 characters, and valid characters are /a-z-/.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param name Immutable. Identifier for the TunnelDestGroup. Must be unique within the project.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param tunnelDestGroupId Required. The ID to use for the TunnelDestGroup, which will become the final component of the resource name. This value should be 4-63 characters, and valid characters are /a-z-/.
         * 
         * @return builder
         * 
         */
