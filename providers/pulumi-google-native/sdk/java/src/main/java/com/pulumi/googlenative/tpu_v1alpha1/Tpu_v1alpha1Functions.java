...
import com.pulumi.googlenative.tpu_v1alpha1.inputs.GetNodePlainArgs;
...
public final class Tpu_v1alpha1Functions {
    ...
    public static Output<GetNodeResult> getNode(GetNodeArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:tpu/v1alpha1:getNode", TypeShape.of(GetNodeResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the details of a node.
     * 
