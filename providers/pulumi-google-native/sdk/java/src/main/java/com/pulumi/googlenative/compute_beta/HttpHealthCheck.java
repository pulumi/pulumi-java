...
import com.pulumi.googlenative.compute_beta.HttpHealthCheckArgs;
...
public class HttpHealthCheck extends CustomResource {
    ...
    public HttpHealthCheck(String name, @Nullable HttpHealthCheckArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/beta:HttpHealthCheck", name, args == null ? HttpHealthCheckArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
