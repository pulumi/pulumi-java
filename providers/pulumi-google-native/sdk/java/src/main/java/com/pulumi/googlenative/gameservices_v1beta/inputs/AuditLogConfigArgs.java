...
import com.pulumi.googlenative.gameservices_v1beta.enums.AuditLogConfigLogType;
...
public final class AuditLogConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<Boolean>> ignoreChildExemptions() {
        return Optional.ofNullable(this.ignoreChildExemptions);
    }
