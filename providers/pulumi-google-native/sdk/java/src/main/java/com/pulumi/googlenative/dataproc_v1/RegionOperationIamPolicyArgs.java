...
public final class RegionOperationIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegionOperationIamPolicyArgs(RegionOperationIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionOperationIamPolicyArgs();
        }

        public Builder(RegionOperationIamPolicyArgs defaults) {
            $ = new RegionOperationIamPolicyArgs(Objects.requireNonNull(defaults));
        }
