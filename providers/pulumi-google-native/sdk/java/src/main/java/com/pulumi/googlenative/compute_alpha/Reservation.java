...
import com.pulumi.googlenative.compute_alpha.ReservationArgs;
...
public class Reservation extends CustomResource {
    ...
    public Reservation(String name, @Nullable ReservationArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/alpha:Reservation", name, args == null ? ReservationArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
