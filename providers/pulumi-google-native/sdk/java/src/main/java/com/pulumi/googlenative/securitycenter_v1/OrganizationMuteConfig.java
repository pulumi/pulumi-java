...
public class OrganizationMuteConfig extends CustomResource {
    /**
     ...
     */
    public OrganizationMuteConfig(String name, OrganizationMuteConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OrganizationMuteConfig(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OrganizationMuteConfig get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
