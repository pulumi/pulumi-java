...
import com.pulumi.googlenative.securitycenter_v1.OrganizationMuteConfigArgs;
...
public class OrganizationMuteConfig extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public OrganizationMuteConfig(String name) {
        this(name, OrganizationMuteConfigArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public OrganizationMuteConfig(String name, OrganizationMuteConfigArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private OrganizationMuteConfig(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static OrganizationMuteConfig get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
