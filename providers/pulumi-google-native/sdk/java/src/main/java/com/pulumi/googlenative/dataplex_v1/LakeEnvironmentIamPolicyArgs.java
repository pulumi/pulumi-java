...
import com.pulumi.googlenative.dataplex_v1.inputs.GoogleIamV1AuditConfigArgs;
import com.pulumi.googlenative.dataplex_v1.inputs.GoogleIamV1BindingArgs;
...
public final class LakeEnvironmentIamPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final LakeEnvironmentIamPolicyArgs Empty = new LakeEnvironmentIamPolicyArgs();
    ...
    private LakeEnvironmentIamPolicyArgs() {}

    private LakeEnvironmentIamPolicyArgs(LakeEnvironmentIamPolicyArgs $) {
    ...
    public static Builder builder(LakeEnvironmentIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LakeEnvironmentIamPolicyArgs();
        }

        public Builder(LakeEnvironmentIamPolicyArgs defaults) {
            $ = new LakeEnvironmentIamPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LakeEnvironmentIamPolicyArgs build() {
