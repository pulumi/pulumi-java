...
import com.pulumi.googlenative.compute.v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.compute.v1.outputs.BindingResponse;
import com.pulumi.googlenative.compute.v1.outputs.RuleResponse;
...
@CustomType
public final class GetRegionNetworkFirewallPolicyIamPolicyResult {
    /**
    ...
    public static Builder builder(GetRegionNetworkFirewallPolicyIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetRegionNetworkFirewallPolicyIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetRegionNetworkFirewallPolicyIamPolicyResult build() {
            return new GetRegionNetworkFirewallPolicyIamPolicyResult(auditConfigs, bindings, etag, rules, version);
        }
    }
}
