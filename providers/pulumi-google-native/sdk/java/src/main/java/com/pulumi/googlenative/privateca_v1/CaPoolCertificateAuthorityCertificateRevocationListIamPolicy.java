...
public class CaPoolCertificateAuthorityCertificateRevocationListIamPolicy extends CustomResource {
    /**
     ...
     */
    public CaPoolCertificateAuthorityCertificateRevocationListIamPolicy(String name, CaPoolCertificateAuthorityCertificateRevocationListIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CaPoolCertificateAuthorityCertificateRevocationListIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CaPoolCertificateAuthorityCertificateRevocationListIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
