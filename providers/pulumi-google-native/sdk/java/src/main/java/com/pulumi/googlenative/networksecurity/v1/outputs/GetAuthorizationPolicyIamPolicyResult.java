...
import com.pulumi.googlenative.networksecurity.v1.outputs.GoogleIamV1AuditConfigResponse;
import com.pulumi.googlenative.networksecurity.v1.outputs.GoogleIamV1BindingResponse;
...
@CustomType
public final class GetAuthorizationPolicyIamPolicyResult {
    /**
    ...
    private GetAuthorizationPolicyIamPolicyResult(
        @CustomType.Parameter("auditConfigs") List<GoogleIamV1AuditConfigResponse> auditConfigs,
        @CustomType.Parameter("bindings") List<GoogleIamV1BindingResponse> bindings,
     ...
     * 
     */
    public List<GoogleIamV1AuditConfigResponse> auditConfigs() {
     ...
     * 
     */
    public List<GoogleIamV1BindingResponse> bindings() {
    ...
    public static Builder builder(GetAuthorizationPolicyIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAuthorizationPolicyIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetAuthorizationPolicyIamPolicyResult build() {
            return new GetAuthorizationPolicyIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
