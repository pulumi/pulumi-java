...
import com.pulumi.googlenative.gkebackup_v1.inputs.RestoreConfigArgs;
...
public final class RestorePlanArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Required. The client-provided short name for the RestorePlan resource. This name must: a. be between 1 and 63 characters long (inclusive) b. consist of only lower-case ASCII letters, numbers, and dashes c. start with a lower-case letter d. end with a lower-case letter or number e. be unique within the set of RestorePlans in this location
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param backupPlan Immutable. The BackupPlan from which Backups may be used as the source for Restores created via this RestorePlan. Format: projects/*{@literal /}locations/*{@literal /}backupPlans/*.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param cluster Immutable. The target cluster into which Restores created via this RestorePlan will restore data. NOTE: the cluster&#39;s region must be the same as the RestorePlan. Possible formats: 1. projects/*{@literal /}locations/*{@literal /}clusters/* 2. projects/*{@literal /}zones/*{@literal /}clusters/*
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param restorePlanId Required. The client-provided short name for the RestorePlan resource. This name must: a. be between 1 and 63 characters long (inclusive) b. consist of only lower-case ASCII letters, numbers, and dashes c. start with a lower-case letter d. end with a lower-case letter or number e. be unique within the set of RestorePlans in this location
         * 
         * @return builder
         * 
         */
