...
import com.pulumi.googlenative.networkservices_v1beta1.ServiceBindingArgs;
...
public class ServiceBinding extends CustomResource {
    /**
     ...
     */
    public ServiceBinding(String name, ServiceBindingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceBinding(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceBinding get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
