...
import com.pulumi.googlenative.dataplex_v1.LakeIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:dataplex/v1:LakeIamPolicy")
public class LakeIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public LakeIamPolicy(String name, LakeIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataplex/v1:LakeIamPolicy", name, args == null ? LakeIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private LakeIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dataplex/v1:LakeIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static LakeIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
