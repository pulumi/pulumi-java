...
import com.pulumi.googlenative.compute_v1.RegionHealthCheckServiceArgs;
...
public class RegionHealthCheckService extends CustomResource {
    /**
     ...
     */
    public RegionHealthCheckService(String name, RegionHealthCheckServiceArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/v1:RegionHealthCheckService", name, args == null ? RegionHealthCheckServiceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegionHealthCheckService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegionHealthCheckService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
