...
import com.pulumi.googlenative.apigee_v1.HostQueryArgs;
...
public class HostQuery extends CustomResource {
    /**
     ...
     */
    public HostQuery(String name, HostQueryArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HostQuery(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HostQuery get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
