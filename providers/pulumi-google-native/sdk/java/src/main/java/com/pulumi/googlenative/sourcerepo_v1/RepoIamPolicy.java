...
import com.pulumi.googlenative.sourcerepo_v1.RepoIamPolicyArgs;
import com.pulumi.googlenative.sourcerepo_v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.sourcerepo_v1.outputs.BindingResponse;
...
public class RepoIamPolicy extends CustomResource {
    /**
     ...
     */
    public RepoIamPolicy(String name, RepoIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RepoIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RepoIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
