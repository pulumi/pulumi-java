...
import com.pulumi.googlenative.compute_alpha.inputs.InstanceGroupManagerStatusAllInstancesConfigResponse;
import com.pulumi.googlenative.compute_alpha.inputs.InstanceGroupManagerStatusStatefulResponse;
import com.pulumi.googlenative.compute_alpha.inputs.InstanceGroupManagerStatusVersionTargetResponse;
...
public final class InstanceGroupManagerStatusResponse extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param allInstancesConfig A status of consistency of Instances&#39; config applied to instances with Instances&#39; config defined in managed instance group.
         * 
         * @return builder
         * 
         */
        ...
        public InstanceGroupManagerStatusResponse build() {
            $.allInstancesConfig = Objects.requireNonNull($.allInstancesConfig, "expected parameter 'allInstancesConfig' to be non-null");
