...
public final class GetNodePoolResult {
    ...
    public static final class Builder {
        ...
        public Builder version(String version) {
            ...
            return new GetNodePoolResult(autoscaling, conditions, config, initialNodeCount, instanceGroupUrls, locations, management, maxPodsConstraint, name, networkConfig, podIpv4CidrSize, selfLink, status, statusMessage, upgradeSettings, version);
        }
    }
}
