...
import com.pulumi.googlenative.networkmanagement_v1beta1.ConnectivityTestArgs;
 ...
 * 
 */
@ResourceType(type="google-native:networkmanagement/v1beta1:ConnectivityTest")
public class ConnectivityTest extends CustomResource {
    /**
     ...
     * 
     */
    @Export(name="probingDetails", type=ProbingDetailsResponse.class, parameters={})
    private Output<ProbingDetailsResponse> probingDetails;
     ...
     */
    public ConnectivityTest(String name, ConnectivityTestArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConnectivityTest(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:networkmanagement/v1beta1:ConnectivityTest", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ConnectivityTest get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
