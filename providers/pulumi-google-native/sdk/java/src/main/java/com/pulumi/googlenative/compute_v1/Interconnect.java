...
import com.pulumi.googlenative.compute_v1.InterconnectArgs;
...
public class Interconnect extends CustomResource {
    /**
     ...
     */
    public Interconnect(String name, @Nullable InterconnectArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/v1:Interconnect", name, args == null ? InterconnectArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Interconnect(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Interconnect get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
