...
import com.pulumi.googlenative.artifactregistry_v1.inputs.GetRepositoryArgs;
import com.pulumi.googlenative.artifactregistry_v1.inputs.GetRepositoryIamPolicyArgs;
import com.pulumi.googlenative.artifactregistry_v1.inputs.GetRepositoryIamPolicyPlainArgs;
import com.pulumi.googlenative.artifactregistry_v1.inputs.GetRepositoryPlainArgs;
import com.pulumi.googlenative.artifactregistry_v1.inputs.GetTagArgs;
import com.pulumi.googlenative.artifactregistry_v1.inputs.GetTagPlainArgs;
import com.pulumi.googlenative.artifactregistry_v1.outputs.GetRepositoryIamPolicyResult;
import com.pulumi.googlenative.artifactregistry_v1.outputs.GetRepositoryResult;
import com.pulumi.googlenative.artifactregistry_v1.outputs.GetTagResult;
...
public final class Artifactregistry_v1Functions {
    ...
    public static Output<GetRepositoryResult> getRepository(GetRepositoryArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:artifactregistry/v1:getRepository", TypeShape.of(GetRepositoryResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets a repository.
     * 
    ...
    public static Output<GetRepositoryIamPolicyResult> getRepositoryIamPolicy(GetRepositoryIamPolicyArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:artifactregistry/v1:getRepositoryIamPolicy", TypeShape.of(GetRepositoryIamPolicyResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the IAM policy for a given resource.
     * 
    ...
    public static Output<GetTagResult> getTag(GetTagArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:artifactregistry/v1:getTag", TypeShape.of(GetTagResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets a tag.
     * 
