...
import com.pulumi.googlenative.dataproc.v1beta2.outputs.BindingResponse;
...
@CustomType
public final class GetRegionJobIamPolicyResult {
    /**
    ...
    private GetRegionJobIamPolicyResult(
    ...
    public static Builder builder(GetRegionJobIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetRegionJobIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetRegionJobIamPolicyResult build() {
            return new GetRegionJobIamPolicyResult(bindings, etag, version);
        }
    }
}
