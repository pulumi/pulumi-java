...
public final class GetTargetHttpsProxyResult {
    ...
    public static final class Builder {
        ...
        public Builder urlMap(String urlMap) {
            ...
            return new GetTargetHttpsProxyResult(authentication, authorization, authorizationPolicy, certificateMap, creationTimestamp, description, fingerprint, httpFilters, kind, name, proxyBind, quicOverride, region, selfLink, selfLinkWithId, serverTlsPolicy, sslCertificates, sslPolicy, urlMap);
        }
    }
}
