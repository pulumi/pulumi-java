...
public final class GetInstantSnapshotIamPolicyArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetInstantSnapshotIamPolicyArgs(GetInstantSnapshotIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetInstantSnapshotIamPolicyArgs();
        }

        public Builder(GetInstantSnapshotIamPolicyArgs defaults) {
            $ = new GetInstantSnapshotIamPolicyArgs(Objects.requireNonNull(defaults));
        }
