...
import com.pulumi.googlenative.compute_beta.GlobalForwardingRuleArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:GlobalForwardingRule")
public class GlobalForwardingRule extends com.pulumi.resources.CustomResource {
     ...
     */
    public GlobalForwardingRule(String name, @Nullable GlobalForwardingRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
    ...
    public GlobalForwardingRule(String name, @Nullable GlobalForwardingRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:GlobalForwardingRule", name, args == null ? GlobalForwardingRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
