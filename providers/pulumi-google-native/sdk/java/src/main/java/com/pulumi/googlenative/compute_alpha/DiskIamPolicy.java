...
import com.pulumi.googlenative.compute_alpha.DiskIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:DiskIamPolicy")
public class DiskIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public DiskIamPolicy(String name, DiskIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:DiskIamPolicy", name, args == null ? DiskIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DiskIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:DiskIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static DiskIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new DiskIamPolicy(name, id, options);
    }
}
