...
public class DiskIamPolicy extends CustomResource {
    ...
    private DiskIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DiskIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
