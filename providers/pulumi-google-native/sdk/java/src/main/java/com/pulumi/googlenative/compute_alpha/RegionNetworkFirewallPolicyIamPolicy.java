...
import com.pulumi.googlenative.compute_alpha.RegionNetworkFirewallPolicyIamPolicyArgs;
...
public class RegionNetworkFirewallPolicyIamPolicy extends CustomResource {
    /**
     ...
     */
    public RegionNetworkFirewallPolicyIamPolicy(String name, RegionNetworkFirewallPolicyIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegionNetworkFirewallPolicyIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegionNetworkFirewallPolicyIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
