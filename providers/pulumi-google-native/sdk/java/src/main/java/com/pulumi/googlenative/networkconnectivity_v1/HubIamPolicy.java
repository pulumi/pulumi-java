...
public class HubIamPolicy extends CustomResource {
    /**
     ...
     */
    public HubIamPolicy(String name, HubIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HubIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HubIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
