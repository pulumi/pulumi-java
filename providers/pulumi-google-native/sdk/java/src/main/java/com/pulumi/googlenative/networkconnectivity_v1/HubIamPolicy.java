...
import com.pulumi.googlenative.networkconnectivity_v1.HubIamPolicyArgs;
...
public class HubIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public HubIamPolicy(String name, HubIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkconnectivity/v1:HubIamPolicy", name, args == null ? HubIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private HubIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static HubIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
