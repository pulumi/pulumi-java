...
import com.pulumi.googlenative.firebase_v1beta1.IosAppArgs;
...
public class IosApp extends CustomResource {
    /**
     ...
     */
    public IosApp(String name, @Nullable IosAppArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IosApp(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IosApp get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
