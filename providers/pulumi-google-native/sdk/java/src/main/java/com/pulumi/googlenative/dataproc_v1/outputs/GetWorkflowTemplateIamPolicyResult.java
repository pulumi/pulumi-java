...
@CustomType
public final class GetWorkflowTemplateIamPolicyResult {
    /**
    ...
    */
    ...
    public static Builder builder(GetWorkflowTemplateIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetWorkflowTemplateIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetWorkflowTemplateIamPolicyResult build() {
            return new GetWorkflowTemplateIamPolicyResult(bindings, etag, version);
        }
    }
}
