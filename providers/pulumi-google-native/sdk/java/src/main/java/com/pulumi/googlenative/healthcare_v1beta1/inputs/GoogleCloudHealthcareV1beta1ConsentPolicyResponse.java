...
import com.pulumi.googlenative.healthcare_v1beta1.inputs.AttributeResponse;
import com.pulumi.googlenative.healthcare_v1beta1.inputs.ExprResponse;
 ...
 * 
 */
public final class GoogleCloudHealthcareV1beta1ConsentPolicyResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private GoogleCloudHealthcareV1beta1ConsentPolicyResponse(GoogleCloudHealthcareV1beta1ConsentPolicyResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleCloudHealthcareV1beta1ConsentPolicyResponse();
        }

        public Builder(GoogleCloudHealthcareV1beta1ConsentPolicyResponse defaults) {
            $ = new GoogleCloudHealthcareV1beta1ConsentPolicyResponse(Objects.requireNonNull(defaults));
        }
