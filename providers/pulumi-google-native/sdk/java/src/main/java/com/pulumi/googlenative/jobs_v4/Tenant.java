...
import com.pulumi.googlenative.jobs_v4.TenantArgs;
...
public class Tenant extends CustomResource {
    ...
    private Tenant(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Tenant get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
