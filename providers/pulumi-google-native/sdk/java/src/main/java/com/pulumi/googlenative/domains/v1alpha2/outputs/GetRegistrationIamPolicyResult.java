...
import com.pulumi.googlenative.domains.v1alpha2.outputs.AuditConfigResponse;
import com.pulumi.googlenative.domains.v1alpha2.outputs.BindingResponse;
...
@CustomType
public final class GetRegistrationIamPolicyResult {
    /**
    ...
    private GetRegistrationIamPolicyResult(
    ...
    public static Builder builder(GetRegistrationIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetRegistrationIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetRegistrationIamPolicyResult build() {
            return new GetRegistrationIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
