...
import com.pulumi.googlenative.essentialcontacts_v1.OrganizationContactArgs;
...
public class OrganizationContact extends CustomResource {
    /**
     ...
     */
    public OrganizationContact(String name, OrganizationContactArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OrganizationContact(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OrganizationContact get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
