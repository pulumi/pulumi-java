...
public final class GetRegionNetworkEndpointGroupResult {
    ...
    public static final class Builder {
        ...
        public Builder zone(String zone) {
            ...
            return new GetRegionNetworkEndpointGroupResult(annotations, appEngine, cloudFunction, cloudRun, creationTimestamp, defaultPort, description, kind, loadBalancer, name, network, networkEndpointType, pscTargetService, region, selfLink, serverlessDeployment, size, subnetwork, zone);
        }
    }
}
