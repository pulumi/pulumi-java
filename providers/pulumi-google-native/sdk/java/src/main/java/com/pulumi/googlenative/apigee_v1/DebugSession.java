...
public class DebugSession extends CustomResource {
    /**
     ...
     */
    public DebugSession(String name, DebugSessionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DebugSession(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DebugSession get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
