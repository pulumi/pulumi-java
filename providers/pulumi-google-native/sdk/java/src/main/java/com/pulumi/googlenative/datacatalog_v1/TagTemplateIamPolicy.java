...
import com.pulumi.googlenative.datacatalog_v1.TagTemplateIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:datacatalog/v1:TagTemplateIamPolicy")
public class TagTemplateIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public TagTemplateIamPolicy(String name, TagTemplateIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datacatalog/v1:TagTemplateIamPolicy", name, args == null ? TagTemplateIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TagTemplateIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:datacatalog/v1:TagTemplateIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static TagTemplateIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
