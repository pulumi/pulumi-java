...
public class TagTemplateIamPolicy extends CustomResource {
    ...
    private TagTemplateIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TagTemplateIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
