...
import com.pulumi.googlenative.bigqueryconnection_v1beta1.ConnectionIamPolicyArgs;
import com.pulumi.googlenative.bigqueryconnection_v1beta1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.bigqueryconnection_v1beta1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:bigqueryconnection/v1beta1:ConnectionIamPolicy")
public class ConnectionIamPolicy extends CustomResource {
    /**
     ...
     */
    public ConnectionIamPolicy(String name, ConnectionIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConnectionIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:bigqueryconnection/v1beta1:ConnectionIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ConnectionIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        return new ConnectionIamPolicy(name, id, options);
    }
}
