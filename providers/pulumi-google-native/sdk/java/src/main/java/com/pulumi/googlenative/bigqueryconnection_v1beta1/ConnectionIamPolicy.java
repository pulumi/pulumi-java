...
public class ConnectionIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private ConnectionIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ConnectionIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
