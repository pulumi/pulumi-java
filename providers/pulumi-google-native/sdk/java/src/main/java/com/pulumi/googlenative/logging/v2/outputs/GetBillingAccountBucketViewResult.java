...
@CustomType
public final class GetBillingAccountBucketViewResult {
    /**
    ...
    public static Builder builder(GetBillingAccountBucketViewResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetBillingAccountBucketViewResult defaults) {
        ...
        public Builder updateTime(String updateTime) {
            ...
            return this;
        }        public GetBillingAccountBucketViewResult build() {
            return new GetBillingAccountBucketViewResult(createTime, description, filter, name, updateTime);
        }
    }
}
