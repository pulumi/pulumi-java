 ...
 * 
 */
public final class GoogleTypeTimeOfDayArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GoogleTypeTimeOfDayArgs(GoogleTypeTimeOfDayArgs $) {
        this.hours = $.hours;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleTypeTimeOfDayArgs();
        }

        public Builder(GoogleTypeTimeOfDayArgs defaults) {
            $ = new GoogleTypeTimeOfDayArgs(Objects.requireNonNull(defaults));
        }
