...
import com.pulumi.googlenative.servicedirectory_v1.NamespaceIamPolicyArgs;
...
public class NamespaceIamPolicy extends CustomResource {
    /**
     ...
     */
    public NamespaceIamPolicy(String name, NamespaceIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NamespaceIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NamespaceIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
