...
public class DatasetConsentStoreIamPolicy extends CustomResource {
    /**
     ...
     */
    public DatasetConsentStoreIamPolicy(String name, DatasetConsentStoreIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DatasetConsentStoreIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DatasetConsentStoreIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
