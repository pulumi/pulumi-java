...
public final class GetOrganizationSinkResult {
    ...
    public static final class Builder {
        ...
        public Builder writerIdentity(String writerIdentity) {
            ...
            return new GetOrganizationSinkResult(bigqueryOptions, createTime, description, destination, disabled, exclusions, filter, includeChildren, name, outputVersionFormat, updateTime, writerIdentity);
        }
    }
}
