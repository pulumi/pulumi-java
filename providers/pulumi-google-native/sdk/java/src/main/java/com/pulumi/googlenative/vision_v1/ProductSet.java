...
public class ProductSet extends CustomResource {
    /**
     ...
     */
    public ProductSet(String name, @Nullable ProductSetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProductSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProductSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
