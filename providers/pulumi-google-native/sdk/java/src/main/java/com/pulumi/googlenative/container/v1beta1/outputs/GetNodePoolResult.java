...
public final class GetNodePoolResult {
     ...
     * 
     */
    private final UpdateInfoResponse updateInfo;
    /**
    ...
    private GetNodePoolResult(
        ...
        @CustomType.Parameter("updateInfo") UpdateInfoResponse updateInfo,
    ...
    public static final class Builder {
        ...
        public Builder version(String version) {
            ...
            return new GetNodePoolResult(autoscaling, conditions, config, initialNodeCount, instanceGroupUrls, locations, management, maxPodsConstraint, name, networkConfig, placementPolicy, podIpv4CidrSize, selfLink, status, statusMessage, updateInfo, upgradeSettings, version);
        }
    }
}
