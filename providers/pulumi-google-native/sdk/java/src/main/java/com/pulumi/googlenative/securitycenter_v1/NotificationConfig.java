...
import com.pulumi.googlenative.securitycenter_v1.NotificationConfigArgs;
...
public class NotificationConfig extends CustomResource {
    ...
    private NotificationConfig(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NotificationConfig get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
