...
import com.pulumi.googlenative.compute_beta.ServiceAttachmentIamPolicyArgs;
...
public class ServiceAttachmentIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public ServiceAttachmentIamPolicy(String name, ServiceAttachmentIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:ServiceAttachmentIamPolicy", name, args == null ? ServiceAttachmentIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
