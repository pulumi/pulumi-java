...
import com.pulumi.googlenative.networkservices_v1.EdgeCacheOriginIamPolicyArgs;
...
public class EdgeCacheOriginIamPolicy extends CustomResource {
    /**
     ...
     */
    public EdgeCacheOriginIamPolicy(String name, EdgeCacheOriginIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EdgeCacheOriginIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EdgeCacheOriginIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
