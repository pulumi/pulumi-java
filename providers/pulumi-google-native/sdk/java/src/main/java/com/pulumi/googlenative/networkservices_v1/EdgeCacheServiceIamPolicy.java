...
import com.pulumi.googlenative.networkservices_v1.EdgeCacheServiceIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:networkservices/v1:EdgeCacheServiceIamPolicy")
public class EdgeCacheServiceIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public EdgeCacheServiceIamPolicy(String name) {
        this(name, EdgeCacheServiceIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public EdgeCacheServiceIamPolicy(String name, EdgeCacheServiceIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public EdgeCacheServiceIamPolicy(String name, EdgeCacheServiceIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private EdgeCacheServiceIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1:EdgeCacheServiceIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static EdgeCacheServiceIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new EdgeCacheServiceIamPolicy(name, id, options);
    }
}
