...
public class EdgeCacheServiceIamPolicy extends CustomResource {
    /**
     ...
     */
    public EdgeCacheServiceIamPolicy(String name, EdgeCacheServiceIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EdgeCacheServiceIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EdgeCacheServiceIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
