...
@CustomType
public final class GetProjectBigQueryExportResult {
    /**
    ...
    public static Builder builder(GetProjectBigQueryExportResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetProjectBigQueryExportResult defaults) {
        ...
        public Builder updateTime(String updateTime) {
            ...
            return this;
        }        public GetProjectBigQueryExportResult build() {
            return new GetProjectBigQueryExportResult(createTime, dataset, description, filter, mostRecentEditor, name, principal, updateTime);
        }
    }
}
