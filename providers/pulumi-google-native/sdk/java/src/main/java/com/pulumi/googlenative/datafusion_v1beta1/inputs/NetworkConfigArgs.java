...
public final class NetworkConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The IP range in CIDR notation to use for the managed Data Fusion instance nodes. This range must not overlap with any other ranges used in the Data Fusion instance network.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param ipAllocation The IP range in CIDR notation to use for the managed Data Fusion instance nodes. This range must not overlap with any other ranges used in the Data Fusion instance network.
         * 
         * @return builder
         * 
         */
