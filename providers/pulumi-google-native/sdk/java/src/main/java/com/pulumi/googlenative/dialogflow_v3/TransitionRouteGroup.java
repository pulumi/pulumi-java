...
public class TransitionRouteGroup extends CustomResource {
    /**
     ...
     */
    public TransitionRouteGroup(String name, TransitionRouteGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TransitionRouteGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TransitionRouteGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
