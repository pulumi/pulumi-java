...
import com.pulumi.googlenative.securitycenter_v1.MuteConfigArgs;
...
public class MuteConfig extends CustomResource {
    /**
     ...
     */
    public MuteConfig(String name, MuteConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MuteConfig(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MuteConfig get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
