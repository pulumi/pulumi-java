...
public class Page extends CustomResource {
    /**
     ...
     */
    public Page(String name, PageArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:dialogflow/v3beta1:Page", name, args == null ? PageArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Page(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Page get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
