...
import com.pulumi.googlenative.dialogflow_v2.EnvironmentArgs;
import com.pulumi.googlenative.dialogflow_v2.outputs.GoogleCloudDialogflowV2FulfillmentResponse;
import com.pulumi.googlenative.dialogflow_v2.outputs.GoogleCloudDialogflowV2TextToSpeechSettingsResponse;
 ...
 * 
 */
@ResourceType(type="google-native:dialogflow/v2:Environment")
public class Environment extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    public Output<GoogleCloudDialogflowV2FulfillmentResponse> fulfillment() {
     ...
     * 
     */
    public Output<GoogleCloudDialogflowV2TextToSpeechSettingsResponse> textToSpeechSettings() {
    ...
    public Environment(String name, EnvironmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v2:Environment", name, args == null ? EnvironmentArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Environment(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:dialogflow/v2:Environment", name, null, makeResourceOptions(options, id));
    }
