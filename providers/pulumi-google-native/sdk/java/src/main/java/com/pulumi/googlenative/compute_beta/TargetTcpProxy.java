...
import com.pulumi.googlenative.compute_beta.TargetTcpProxyArgs;
...
public class TargetTcpProxy extends CustomResource {
    /**
     ...
     */
    public TargetTcpProxy(String name, @Nullable TargetTcpProxyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/beta:TargetTcpProxy", name, args == null ? TargetTcpProxyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TargetTcpProxy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TargetTcpProxy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
