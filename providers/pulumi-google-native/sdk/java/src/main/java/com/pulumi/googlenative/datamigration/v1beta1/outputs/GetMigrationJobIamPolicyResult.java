...
import com.pulumi.googlenative.datamigration.v1beta1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.datamigration.v1beta1.outputs.BindingResponse;
...
@CustomType
public final class GetMigrationJobIamPolicyResult {
    /**
    ...
    public static Builder builder(GetMigrationJobIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetMigrationJobIamPolicyResult defaults) {
