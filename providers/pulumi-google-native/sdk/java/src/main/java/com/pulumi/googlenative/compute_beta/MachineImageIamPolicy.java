...
import com.pulumi.googlenative.compute_beta.MachineImageIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:MachineImageIamPolicy")
public class MachineImageIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public MachineImageIamPolicy(String name, MachineImageIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:MachineImageIamPolicy", name, args == null ? MachineImageIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private MachineImageIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:MachineImageIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static MachineImageIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
