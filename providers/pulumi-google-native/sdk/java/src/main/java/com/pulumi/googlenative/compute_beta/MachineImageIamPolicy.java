...
public class MachineImageIamPolicy extends CustomResource {
    ...
    private MachineImageIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MachineImageIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
