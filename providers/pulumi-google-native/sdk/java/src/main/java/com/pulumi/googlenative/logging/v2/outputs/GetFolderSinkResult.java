...
@CustomType
public final class GetFolderSinkResult {
    /**
    ...
    public static Builder builder(GetFolderSinkResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetFolderSinkResult defaults) {
        ...
        public Builder writerIdentity(String writerIdentity) {
            ...
            return this;
        }        public GetFolderSinkResult build() {
            return new GetFolderSinkResult(bigqueryOptions, createTime, description, destination, disabled, exclusions, filter, includeChildren, name, outputVersionFormat, updateTime, writerIdentity);
        }
    }
}
