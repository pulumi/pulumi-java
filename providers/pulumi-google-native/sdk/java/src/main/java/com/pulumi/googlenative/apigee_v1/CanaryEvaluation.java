...
import com.pulumi.googlenative.apigee_v1.CanaryEvaluationArgs;
import com.pulumi.googlenative.apigee_v1.outputs.GoogleCloudApigeeV1CanaryEvaluationMetricLabelsResponse;
...
public class CanaryEvaluation extends CustomResource {
    /**
     ...
     */
    public CanaryEvaluation(String name, CanaryEvaluationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CanaryEvaluation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CanaryEvaluation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
