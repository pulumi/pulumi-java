...
import com.pulumi.googlenative.pubsub_v1beta2.TopicIamPolicyArgs;
import com.pulumi.googlenative.pubsub_v1beta2.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:pubsub/v1beta2:TopicIamPolicy")
public class TopicIamPolicy extends CustomResource {
    /**
     ...
     */
    public TopicIamPolicy(String name, TopicIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:pubsub/v1beta2:TopicIamPolicy", name, args == null ? TopicIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TopicIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:pubsub/v1beta2:TopicIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static TopicIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
