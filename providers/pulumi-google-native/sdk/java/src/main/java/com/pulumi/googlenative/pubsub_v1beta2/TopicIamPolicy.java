...
public class TopicIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private TopicIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TopicIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
