...
@CustomType
public final class GetArtifactIamPolicyResult {
    /**
    ...
    private GetArtifactIamPolicyResult(
    ...
    public static Builder builder(GetArtifactIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetArtifactIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetArtifactIamPolicyResult build() {
            return new GetArtifactIamPolicyResult(bindings, etag, version);
        }
    }
}
