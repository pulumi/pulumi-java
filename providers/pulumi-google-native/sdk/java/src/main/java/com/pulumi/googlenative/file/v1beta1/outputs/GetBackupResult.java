...
public final class GetBackupResult {
    ...
    public static final class Builder {
        ...
        public Builder storageBytes(String storageBytes) {
            ...
            return new GetBackupResult(capacityGb, createTime, description, downloadBytes, kmsKeyName, labels, name, satisfiesPzs, sourceFileShare, sourceInstance, sourceInstanceTier, state, storageBytes);
        }
    }
}
