...
import com.pulumi.googlenative.artifactregistry_v1beta2.RepositoryIamPolicyArgs;
import com.pulumi.googlenative.artifactregistry_v1beta2.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:artifactregistry/v1beta2:RepositoryIamPolicy")
public class RepositoryIamPolicy extends CustomResource {
    /**
     ...
     */
    public RepositoryIamPolicy(String name, RepositoryIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:artifactregistry/v1beta2:RepositoryIamPolicy", name, args == null ? RepositoryIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RepositoryIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:artifactregistry/v1beta2:RepositoryIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static RepositoryIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
