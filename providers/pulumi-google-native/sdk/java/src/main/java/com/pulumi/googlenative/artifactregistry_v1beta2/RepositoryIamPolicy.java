...
public class RepositoryIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private RepositoryIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static RepositoryIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
