...
public class RegionDiskIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private RegionDiskIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static RegionDiskIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
