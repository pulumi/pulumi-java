...
import com.pulumi.googlenative.compute_alpha.RegionDiskIamPolicyArgs;
...
public class RegionDiskIamPolicy extends CustomResource {
    /**
     ...
     */
    public RegionDiskIamPolicy(String name, RegionDiskIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegionDiskIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegionDiskIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
