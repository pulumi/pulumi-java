...
import com.pulumi.googlenative.gkehub_v1alpha.inputs.AuditConfigArgs;
import com.pulumi.googlenative.gkehub_v1alpha.inputs.BindingArgs;
...
public final class MembershipIamPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final MembershipIamPolicyArgs Empty = new MembershipIamPolicyArgs();
    ...
    private MembershipIamPolicyArgs() {}

    private MembershipIamPolicyArgs(MembershipIamPolicyArgs $) {
    ...
    public static Builder builder(MembershipIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MembershipIamPolicyArgs();
        }

        public Builder(MembershipIamPolicyArgs defaults) {
            $ = new MembershipIamPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MembershipIamPolicyArgs build() {
