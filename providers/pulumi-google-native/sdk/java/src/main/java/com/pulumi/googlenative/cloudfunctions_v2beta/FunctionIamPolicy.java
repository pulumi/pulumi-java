...
import com.pulumi.googlenative.cloudfunctions_v2beta.FunctionIamPolicyArgs;
import com.pulumi.googlenative.cloudfunctions_v2beta.outputs.AuditConfigResponse;
import com.pulumi.googlenative.cloudfunctions_v2beta.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:cloudfunctions/v2beta:FunctionIamPolicy")
public class FunctionIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public FunctionIamPolicy(String name, FunctionIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudfunctions/v2beta:FunctionIamPolicy", name, args == null ? FunctionIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FunctionIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudfunctions/v2beta:FunctionIamPolicy", name, null, makeResourceOptions(options, id));
    }
