...
import com.pulumi.googlenative.managedidentities_v1.inputs.BindingArgs;
...
public final class DomainIamPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainIamPolicyArgs Empty = new DomainIamPolicyArgs();
    ...
    private DomainIamPolicyArgs() {}

    private DomainIamPolicyArgs(DomainIamPolicyArgs $) {
    ...
    public static Builder builder(DomainIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainIamPolicyArgs();
        }

        public Builder(DomainIamPolicyArgs defaults) {
            $ = new DomainIamPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainIamPolicyArgs build() {
