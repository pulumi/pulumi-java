...
import com.pulumi.googlenative.networkconnectivity_v1alpha1.SpokeIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:networkconnectivity/v1alpha1:SpokeIamPolicy")
public class SpokeIamPolicy extends com.pulumi.resources.CustomResource {
    /**
    ...
    public SpokeIamPolicy(String name) {
        this(name, SpokeIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SpokeIamPolicy(String name, SpokeIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SpokeIamPolicy(String name, SpokeIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private SpokeIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkconnectivity/v1alpha1:SpokeIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static SpokeIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new SpokeIamPolicy(name, id, options);
    }
}
