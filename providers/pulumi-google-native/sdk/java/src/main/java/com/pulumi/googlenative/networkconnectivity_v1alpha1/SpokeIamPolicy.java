...
public class SpokeIamPolicy extends CustomResource {
    /**
     ...
     */
    public SpokeIamPolicy(String name, SpokeIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SpokeIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SpokeIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
