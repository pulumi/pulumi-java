...
public final class FirewallPolicyRuleResponse {
    ...
    private FirewallPolicyRuleResponse(
        ...
        @CustomType.Parameter("securityProfileGroup") String securityProfileGroup,
    ...
    public static final class Builder {
        ...
        public Builder targetServiceAccounts(String... targetServiceAccounts) {
            ...
            return new FirewallPolicyRuleResponse(action, description, direction, disabled, enableLogging, kind, match, priority, ruleName, ruleTupleCount, securityProfileGroup, targetResources, targetSecureTags, targetServiceAccounts);
        }
    }
}
