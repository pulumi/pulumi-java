...
public final class AttachedDiskResponse {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            ...
            return new AttachedDiskResponse(architecture, autoDelete, boot, deviceName, diskEncryptionKey, diskSizeGb, guestOsFeatures, index, initializeParams, interface_, kind, licenses, mode, shieldedInstanceInitialState, source, type);
        }
    }
}
