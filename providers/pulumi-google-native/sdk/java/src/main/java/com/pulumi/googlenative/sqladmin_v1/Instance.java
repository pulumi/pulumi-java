...
import com.pulumi.googlenative.sqladmin_v1.InstanceArgs;
...
import com.pulumi.googlenative.sqladmin_v1.outputs.InstanceFailoverReplicaResponse;
import com.pulumi.googlenative.sqladmin_v1.outputs.IpMappingResponse;
import com.pulumi.googlenative.sqladmin_v1.outputs.OnPremisesConfigurationResponse;
import com.pulumi.googlenative.sqladmin_v1.outputs.ReplicaConfigurationResponse;
import com.pulumi.googlenative.sqladmin_v1.outputs.SettingsResponse;
import com.pulumi.googlenative.sqladmin_v1.outputs.SqlOutOfDiskReportResponse;
import com.pulumi.googlenative.sqladmin_v1.outputs.SqlScheduledMaintenanceResponse;
import com.pulumi.googlenative.sqladmin_v1.outputs.SslCertResponse;
...
public class Instance extends CustomResource {
     ...
     */
    public Instance(String name, @Nullable InstanceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Instance(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Instance get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
