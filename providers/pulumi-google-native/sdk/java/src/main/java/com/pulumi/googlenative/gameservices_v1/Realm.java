...
import com.pulumi.googlenative.gameservices_v1.RealmArgs;
...
public class Realm extends CustomResource {
    ...
    public Realm(String name, RealmArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:gameservices/v1:Realm", name, args == null ? RealmArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Realm(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Realm get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
