...
import com.pulumi.googlenative.iap_v1.V1IamPolicyArgs;
import com.pulumi.googlenative.iap_v1.outputs.BindingResponse;
...
public class V1IamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public V1IamPolicy(String name, V1IamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private V1IamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static V1IamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
