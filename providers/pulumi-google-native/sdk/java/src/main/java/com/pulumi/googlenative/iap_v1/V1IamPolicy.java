...
public class V1IamPolicy extends CustomResource {
    /**
     ...
     */
    public V1IamPolicy(String name, V1IamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private V1IamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static V1IamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
