...
import com.pulumi.googlenative.compute_v1.TargetTcpProxyArgs;
...
public class TargetTcpProxy extends CustomResource {
    ...
    public TargetTcpProxy(String name, @Nullable TargetTcpProxyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/v1:TargetTcpProxy", name, args == null ? TargetTcpProxyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
