...
public class ServiceAccountIamPolicy extends CustomResource {
    /**
     ...
     */
    public ServiceAccountIamPolicy(String name, ServiceAccountIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceAccountIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceAccountIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
