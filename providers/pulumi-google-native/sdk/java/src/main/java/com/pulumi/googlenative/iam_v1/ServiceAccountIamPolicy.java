...
import com.pulumi.googlenative.iam_v1.ServiceAccountIamPolicyArgs;
import com.pulumi.googlenative.iam_v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.iam_v1.outputs.BindingResponse;
...
public class ServiceAccountIamPolicy extends com.pulumi.resources.CustomResource {
    /**
    ...
    public ServiceAccountIamPolicy(String name) {
        this(name, ServiceAccountIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ServiceAccountIamPolicy(String name, ServiceAccountIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ServiceAccountIamPolicy(String name, ServiceAccountIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:iam/v1:ServiceAccountIamPolicy", name, args == null ? ServiceAccountIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ServiceAccountIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ServiceAccountIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
