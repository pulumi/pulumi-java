...
import com.pulumi.googlenative.dlp_v2.StoredInfoTypeArgs;
...
public class StoredInfoType extends CustomResource {
    /**
     ...
     */
    public StoredInfoType(String name, StoredInfoTypeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StoredInfoType(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StoredInfoType get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
