...
import com.pulumi.googlenative.containeranalysis_v1beta1.OccurrenceIamPolicyArgs;
import com.pulumi.googlenative.containeranalysis_v1beta1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:containeranalysis/v1beta1:OccurrenceIamPolicy")
public class OccurrenceIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public OccurrenceIamPolicy(String name, OccurrenceIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:containeranalysis/v1beta1:OccurrenceIamPolicy", name, args == null ? OccurrenceIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private OccurrenceIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:containeranalysis/v1beta1:OccurrenceIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static OccurrenceIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
