...
public class OccurrenceIamPolicy extends CustomResource {
    /**
     ...
     */
    public OccurrenceIamPolicy(String name, OccurrenceIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OccurrenceIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OccurrenceIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
