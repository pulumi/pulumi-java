...
public class TypeProvider extends CustomResource {
    /**
     ...
     */
    public TypeProvider(String name, @Nullable TypeProviderArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TypeProvider(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TypeProvider get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
