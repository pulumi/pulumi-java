...
import com.pulumi.googlenative.cloudresourcemanager_v2beta1.FolderArgs;
...
public class Folder extends CustomResource {
    ...
    public Folder(String name, FolderArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v2beta1:Folder", name, args == null ? FolderArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
