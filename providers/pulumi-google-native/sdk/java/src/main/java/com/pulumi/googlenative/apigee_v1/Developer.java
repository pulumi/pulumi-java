...
import com.pulumi.googlenative.apigee_v1.DeveloperArgs;
...
public class Developer extends CustomResource {
    /**
     * Access type.
     * 
     */
     ...
     */
    public Developer(String name, DeveloperArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Developer(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Developer get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
