...
import com.pulumi.googlenative.cloudtasks_v2beta3.inputs.GetQueueIamPolicyPlainArgs;
import com.pulumi.googlenative.cloudtasks_v2beta3.inputs.GetQueuePlainArgs;
import com.pulumi.googlenative.cloudtasks_v2beta3.inputs.GetTaskArgs;
import com.pulumi.googlenative.cloudtasks_v2beta3.inputs.GetTaskPlainArgs;
...
public final class Cloudtasks_v2beta3Functions {
    ...
    public static Output<GetQueueResult> getQueue(GetQueueArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:cloudtasks/v2beta3:getQueue", TypeShape.of(GetQueueResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets a queue.
     * 
    ...
    public static Output<GetQueueIamPolicyResult> getQueueIamPolicy(GetQueueIamPolicyArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:cloudtasks/v2beta3:getQueueIamPolicy", TypeShape.of(GetQueueIamPolicyResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the access control policy for a Queue. Returns an empty policy if the resource exists and does not have a policy set. Authorization requires the following [Google IAM](https://cloud.google.com/iam) permission on the specified resource parent: * `cloudtasks.queues.getIamPolicy`
     * 
    ...
    public static Output<GetTaskResult> getTask(GetTaskArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:cloudtasks/v2beta3:getTask", TypeShape.of(GetTaskResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets a task.
     * 
