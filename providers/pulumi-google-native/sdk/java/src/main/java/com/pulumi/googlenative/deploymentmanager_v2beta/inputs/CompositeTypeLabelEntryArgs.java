 ...
 * 
 */
public final class CompositeTypeLabelEntryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CompositeTypeLabelEntryArgs(CompositeTypeLabelEntryArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CompositeTypeLabelEntryArgs();
        }

        public Builder(CompositeTypeLabelEntryArgs defaults) {
            $ = new CompositeTypeLabelEntryArgs(Objects.requireNonNull(defaults));
        }
