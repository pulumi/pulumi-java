...
import com.pulumi.googlenative.sqladmin_v1.SslCertArgs;
...
public class SslCert extends CustomResource {
    /**
     * PEM representation.
     * 
     */
     ...
     */
    public SslCert(String name, SslCertArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:sqladmin/v1:SslCert", name, args == null ? SslCertArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SslCert(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SslCert get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
