...
import com.pulumi.googlenative.compute_v1.VpnTunnelArgs;
...
public class VpnTunnel extends CustomResource {
    ...
    private VpnTunnel(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpnTunnel get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
