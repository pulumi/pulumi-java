...
import com.pulumi.googlenative.analyticshub.v1beta1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.analyticshub.v1beta1.outputs.BindingResponse;
...
@CustomType
public final class GetDataExchangeListingIamPolicyResult {
    /**
    ...
    private GetDataExchangeListingIamPolicyResult(
    ...
    public static Builder builder(GetDataExchangeListingIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetDataExchangeListingIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetDataExchangeListingIamPolicyResult build() {
            return new GetDataExchangeListingIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
