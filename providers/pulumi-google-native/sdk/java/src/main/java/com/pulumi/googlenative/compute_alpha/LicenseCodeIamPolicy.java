...
public class LicenseCodeIamPolicy extends CustomResource {
    /**
     ...
     */
    public LicenseCodeIamPolicy(String name, LicenseCodeIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LicenseCodeIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LicenseCodeIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
