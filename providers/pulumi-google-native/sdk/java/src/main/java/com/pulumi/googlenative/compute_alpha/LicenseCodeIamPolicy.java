...
import com.pulumi.googlenative.compute_alpha.LicenseCodeIamPolicyArgs;
...
public class LicenseCodeIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LicenseCodeIamPolicy(String name, LicenseCodeIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:LicenseCodeIamPolicy", name, args == null ? LicenseCodeIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private LicenseCodeIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static LicenseCodeIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
