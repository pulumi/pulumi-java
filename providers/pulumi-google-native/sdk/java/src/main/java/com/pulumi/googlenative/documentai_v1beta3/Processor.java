...
import com.pulumi.googlenative.documentai_v1beta3.ProcessorArgs;
...
public class Processor extends CustomResource {
     ...
     */
    public Processor(String name, @Nullable ProcessorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Processor(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Processor get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
