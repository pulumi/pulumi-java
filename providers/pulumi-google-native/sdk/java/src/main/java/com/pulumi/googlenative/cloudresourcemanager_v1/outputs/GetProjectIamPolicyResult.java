...
package com.pulumi.googlenative.cloudresourcemanager_v1.outputs;
...
@CustomType
public final class GetProjectIamPolicyResult {
    /**
    ...
    private GetProjectIamPolicyResult(
    ...
    */
    ...
    public static Builder builder(GetProjectIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetProjectIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetProjectIamPolicyResult build() {
            return new GetProjectIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
