...
public final class PackageIssueResponse {
     ...
     * 
     */
    private final List<GrafeasV1FileLocationResponse> fileLocation;
    /**
    ...
    private PackageIssueResponse(
        ...
        @CustomType.Parameter("fileLocation") List<GrafeasV1FileLocationResponse> fileLocation,
    ...
    public static final class Builder {
        ...
        public Builder packageType(String packageType) {
            ...
            return new PackageIssueResponse(affectedCpeUri, affectedPackage, affectedVersion, effectiveSeverity, fileLocation, fixAvailable, fixedCpeUri, fixedPackage, fixedVersion, packageType);
        }
    }
}
