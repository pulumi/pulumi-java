...
import com.pulumi.googlenative.apigee_v1.ArchiveDeploymentArgs;
...
public class ArchiveDeployment extends CustomResource {
    /**
     ...
     */
    public ArchiveDeployment(String name, ArchiveDeploymentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ArchiveDeployment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ArchiveDeployment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
