...
import com.pulumi.googlenative.compute.beta.outputs.AdvancedMachineFeaturesResponse;
import com.pulumi.googlenative.compute.beta.outputs.AttachedDiskResponse;
import com.pulumi.googlenative.compute.beta.outputs.ConfidentialInstanceConfigResponse;
import com.pulumi.googlenative.compute.beta.outputs.CustomerEncryptionKeyResponse;
import com.pulumi.googlenative.compute.beta.outputs.DisplayDeviceResponse;
import com.pulumi.googlenative.compute.beta.outputs.InstanceParamsResponse;
...
import com.pulumi.googlenative.compute.beta.outputs.NetworkPerformanceConfigResponse;
import com.pulumi.googlenative.compute.beta.outputs.ReservationAffinityResponse;
...
import com.pulumi.googlenative.compute.beta.outputs.ShieldedInstanceConfigResponse;
import com.pulumi.googlenative.compute.beta.outputs.ShieldedInstanceIntegrityPolicyResponse;
import com.pulumi.googlenative.compute.beta.outputs.ShieldedVmConfigResponse;
import com.pulumi.googlenative.compute.beta.outputs.ShieldedVmIntegrityPolicyResponse;
...
public final class GetInstanceResult {
    ...
    public static final class Builder {
        ...
        public Builder zone(String zone) {
            ...
            return new GetInstanceResult(advancedMachineFeatures, canIpForward, confidentialInstanceConfig, cpuPlatform, creationTimestamp, deletionProtection, description, disks, displayDevice, eraseWindowsVssSignature, fingerprint, guestAccelerators, hostname, keyRevocationActionType, kind, labelFingerprint, labels, lastStartTimestamp, lastStopTimestamp, lastSuspendedTimestamp, machineType, metadata, minCpuPlatform, name, networkInterfaces, networkPerformanceConfig, params, postKeyRevocationActionType, privateIpv6GoogleAccess, reservationAffinity, resourcePolicies, satisfiesPzs, scheduling, selfLink, serviceAccounts, shieldedInstanceConfig, shieldedInstanceIntegrityPolicy, shieldedVmConfig, shieldedVmIntegrityPolicy, sourceMachineImage, sourceMachineImageEncryptionKey, startRestricted, status, statusMessage, tags, zone);
        }
    }
}
