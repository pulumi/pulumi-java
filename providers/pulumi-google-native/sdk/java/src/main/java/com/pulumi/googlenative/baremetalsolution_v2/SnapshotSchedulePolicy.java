...
public class SnapshotSchedulePolicy extends CustomResource {
    /**
     ...
     */
    public SnapshotSchedulePolicy(String name, SnapshotSchedulePolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SnapshotSchedulePolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SnapshotSchedulePolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
