...
import com.pulumi.googlenative.compute_alpha.inputs.UrlMapTestHeaderArgs;
...
public final class UrlMapTestArgs extends ResourceArgs {
     ...
     * 
     */
    public Optional<Output<Integer>> backendServiceWeight() {
        return Optional.ofNullable(this.backendServiceWeight);
    }
    ...
    public static final class Builder {
        ...
        public Builder backendServiceWeight(Integer backendServiceWeight) {
            return backendServiceWeight(Output.of(backendServiceWeight));
        }
