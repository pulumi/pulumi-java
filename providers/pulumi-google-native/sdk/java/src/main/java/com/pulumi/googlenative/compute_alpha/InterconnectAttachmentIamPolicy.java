...
public class InterconnectAttachmentIamPolicy extends CustomResource {
    /**
     ...
     */
    public InterconnectAttachmentIamPolicy(String name, InterconnectAttachmentIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private InterconnectAttachmentIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static InterconnectAttachmentIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
