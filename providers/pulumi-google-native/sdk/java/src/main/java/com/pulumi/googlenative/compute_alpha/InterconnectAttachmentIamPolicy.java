...
import com.pulumi.googlenative.compute_alpha.InterconnectAttachmentIamPolicyArgs;
...
public class InterconnectAttachmentIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public InterconnectAttachmentIamPolicy(String name, InterconnectAttachmentIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private InterconnectAttachmentIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static InterconnectAttachmentIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
