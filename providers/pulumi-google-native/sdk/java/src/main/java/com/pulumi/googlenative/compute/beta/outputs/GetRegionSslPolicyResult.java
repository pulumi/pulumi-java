...
import com.pulumi.googlenative.compute.beta.outputs.RegionSslPolicyWarningsItemResponse;
...
public final class GetRegionSslPolicyResult {
    ...
    public static final class Builder {
        ...
        public Builder warnings(RegionSslPolicyWarningsItemResponse... warnings) {
            ...
            return new GetRegionSslPolicyResult(creationTimestamp, customFeatures, description, enabledFeatures, fingerprint, kind, minTlsVersion, name, profile, region, selfLink, warnings);
        }
    }
}
