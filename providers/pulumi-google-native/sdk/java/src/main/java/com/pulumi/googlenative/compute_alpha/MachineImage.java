...
import com.pulumi.googlenative.compute_alpha.MachineImageArgs;
import com.pulumi.googlenative.compute_alpha.outputs.CustomerEncryptionKeyResponse;
import com.pulumi.googlenative.compute_alpha.outputs.InstancePropertiesResponse;
import com.pulumi.googlenative.compute_alpha.outputs.SavedDiskResponse;
import com.pulumi.googlenative.compute_alpha.outputs.SourceDiskEncryptionKeyResponse;
import com.pulumi.googlenative.compute_alpha.outputs.SourceInstancePropertiesResponse;
...
public class MachineImage extends CustomResource {
    /**
     ...
     */
    public MachineImage(String name, MachineImageArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MachineImage(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MachineImage get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
