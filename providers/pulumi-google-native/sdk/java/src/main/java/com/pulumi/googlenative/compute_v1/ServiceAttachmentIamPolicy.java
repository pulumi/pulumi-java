...
import com.pulumi.googlenative.compute_v1.ServiceAttachmentIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:ServiceAttachmentIamPolicy")
public class ServiceAttachmentIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ServiceAttachmentIamPolicy(String name, ServiceAttachmentIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private ServiceAttachmentIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:ServiceAttachmentIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ServiceAttachmentIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
