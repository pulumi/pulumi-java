...
public class ServiceAttachmentIamPolicy extends CustomResource {
    /**
     ...
     */
    public ServiceAttachmentIamPolicy(String name, ServiceAttachmentIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceAttachmentIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceAttachmentIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
