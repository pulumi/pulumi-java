...
import com.pulumi.googlenative.storage_v1.ObjectIamPolicyArgs;
...
public class ObjectIamPolicy extends CustomResource {
    /**
     ...
     */
    public ObjectIamPolicy(String name, ObjectIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ObjectIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ObjectIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
