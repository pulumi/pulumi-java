...
import com.pulumi.googlenative.apigee_v1.KeystoreArgs;
...
public class Keystore extends CustomResource {
    /**
     ...
     */
    public Keystore(String name, KeystoreArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:apigee/v1:Keystore", name, args == null ? KeystoreArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Keystore(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Keystore get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
