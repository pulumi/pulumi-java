...
public class InstanceBackupIamPolicy extends CustomResource {
    /**
     ...
     */
    public InstanceBackupIamPolicy(String name, InstanceBackupIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private InstanceBackupIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static InstanceBackupIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
