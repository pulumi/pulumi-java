...
import com.pulumi.googlenative.spanner_v1.InstanceBackupIamPolicyArgs;
...
public class InstanceBackupIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public InstanceBackupIamPolicy(String name, InstanceBackupIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private InstanceBackupIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static InstanceBackupIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
