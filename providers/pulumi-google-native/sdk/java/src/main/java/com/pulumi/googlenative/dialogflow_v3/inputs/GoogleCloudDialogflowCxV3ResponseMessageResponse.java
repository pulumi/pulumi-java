...
public final class GoogleCloudDialogflowCxV3ResponseMessageResponse extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param endInteraction A signal that indicates the interaction with the Dialogflow agent has ended. This message is generated by Dialogflow only when the conversation reaches `END_SESSION` page. It is not supposed to be defined by the user. It&#39;s guaranteed that there is at most one such message in each response.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param mixedAudio An audio response message composed of both the synthesized Dialogflow agent responses and responses defined via play_audio. This message is generated by Dialogflow only and not supposed to be defined by the user.
         * 
         * @return builder
         * 
         */
