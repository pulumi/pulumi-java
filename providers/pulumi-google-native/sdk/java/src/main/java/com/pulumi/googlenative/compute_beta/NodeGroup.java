...
public class NodeGroup extends CustomResource {
    ...
    public NodeGroup(String name, NodeGroupArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/beta:NodeGroup", name, args == null ? NodeGroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private NodeGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NodeGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
