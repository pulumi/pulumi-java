...
public class AttestorIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private AttestorIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static AttestorIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
