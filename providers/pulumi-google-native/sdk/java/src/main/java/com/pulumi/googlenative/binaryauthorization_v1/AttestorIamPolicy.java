...
import com.pulumi.googlenative.binaryauthorization_v1.AttestorIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:binaryauthorization/v1:AttestorIamPolicy")
public class AttestorIamPolicy extends CustomResource {
    /**
     ...
     */
    public AttestorIamPolicy(String name, AttestorIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:binaryauthorization/v1:AttestorIamPolicy", name, args == null ? AttestorIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AttestorIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:binaryauthorization/v1:AttestorIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static AttestorIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
