...
import com.pulumi.googlenative.metastore_v1beta.ServiceDatabaseTableIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:metastore/v1beta:ServiceDatabaseTableIamPolicy")
public class ServiceDatabaseTableIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ServiceDatabaseTableIamPolicy(String name) {
        this(name, ServiceDatabaseTableIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ServiceDatabaseTableIamPolicy(String name, ServiceDatabaseTableIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ServiceDatabaseTableIamPolicy(String name, ServiceDatabaseTableIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1beta:ServiceDatabaseTableIamPolicy", name, args == null ? ServiceDatabaseTableIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ServiceDatabaseTableIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1beta:ServiceDatabaseTableIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static ServiceDatabaseTableIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
