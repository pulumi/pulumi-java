...
import com.pulumi.googlenative.cloudfunctions_v2alpha.FunctionIamPolicyArgs;
import com.pulumi.googlenative.cloudfunctions_v2alpha.outputs.AuditConfigResponse;
import com.pulumi.googlenative.cloudfunctions_v2alpha.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:cloudfunctions/v2alpha:FunctionIamPolicy")
public class FunctionIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public FunctionIamPolicy(String name, FunctionIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudfunctions/v2alpha:FunctionIamPolicy", name, args == null ? FunctionIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FunctionIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudfunctions/v2alpha:FunctionIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static FunctionIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new FunctionIamPolicy(name, id, options);
    }
}
