...
import com.pulumi.googlenative.compute_beta.HealthCheckArgs;
...
public class HealthCheck extends CustomResource {
    ...
    public HealthCheck(String name, @Nullable HealthCheckArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/beta:HealthCheck", name, args == null ? HealthCheckArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
