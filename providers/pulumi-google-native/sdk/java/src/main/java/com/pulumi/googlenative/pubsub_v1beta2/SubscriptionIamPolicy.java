...
import com.pulumi.googlenative.pubsub_v1beta2.SubscriptionIamPolicyArgs;
...
public class SubscriptionIamPolicy extends CustomResource {
    ...
    private SubscriptionIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SubscriptionIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
