...
import com.pulumi.googlenative.compute_beta.PublicDelegatedPrefixArgs;
import com.pulumi.googlenative.compute_beta.outputs.PublicDelegatedPrefixPublicDelegatedSubPrefixResponse;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:PublicDelegatedPrefix")
public class PublicDelegatedPrefix extends CustomResource {
    /**
     ...
     */
    public PublicDelegatedPrefix(String name, PublicDelegatedPrefixArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PublicDelegatedPrefix(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:compute/beta:PublicDelegatedPrefix", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static PublicDelegatedPrefix get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
