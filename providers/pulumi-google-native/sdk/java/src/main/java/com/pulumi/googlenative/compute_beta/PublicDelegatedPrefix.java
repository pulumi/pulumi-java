...
public class PublicDelegatedPrefix extends com.pulumi.resources.CustomResource {
    ...
    private PublicDelegatedPrefix(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static PublicDelegatedPrefix get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
