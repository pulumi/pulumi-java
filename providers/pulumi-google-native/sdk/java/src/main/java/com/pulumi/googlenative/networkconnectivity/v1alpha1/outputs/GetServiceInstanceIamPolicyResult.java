...
import com.pulumi.googlenative.networkconnectivity.v1alpha1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.networkconnectivity.v1alpha1.outputs.BindingResponse;
...
@CustomType
public final class GetServiceInstanceIamPolicyResult {
    /**
    ...
    private GetServiceInstanceIamPolicyResult(
    ...
    public static Builder builder(GetServiceInstanceIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetServiceInstanceIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetServiceInstanceIamPolicyResult build() {
            return new GetServiceInstanceIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
