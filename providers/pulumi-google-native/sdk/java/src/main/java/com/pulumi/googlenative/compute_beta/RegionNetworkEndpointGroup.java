...
import com.pulumi.googlenative.compute_beta.RegionNetworkEndpointGroupArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:RegionNetworkEndpointGroup")
public class RegionNetworkEndpointGroup extends CustomResource {
    ...
    public RegionNetworkEndpointGroup(String name, RegionNetworkEndpointGroupArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/beta:RegionNetworkEndpointGroup", name, args == null ? RegionNetworkEndpointGroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegionNetworkEndpointGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:compute/beta:RegionNetworkEndpointGroup", name, null, makeResourceOptions(options, id));
    }
