...
public class DatasetHl7V2StoreIamPolicy extends CustomResource {
    /**
     ...
     */
    public DatasetHl7V2StoreIamPolicy(String name, DatasetHl7V2StoreIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DatasetHl7V2StoreIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DatasetHl7V2StoreIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
