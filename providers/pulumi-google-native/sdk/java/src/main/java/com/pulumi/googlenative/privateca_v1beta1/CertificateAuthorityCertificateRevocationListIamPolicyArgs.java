...
import com.pulumi.googlenative.privateca_v1beta1.inputs.AuditConfigArgs;
import com.pulumi.googlenative.privateca_v1beta1.inputs.BindingArgs;
...
public final class CertificateAuthorityCertificateRevocationListIamPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final CertificateAuthorityCertificateRevocationListIamPolicyArgs Empty = new CertificateAuthorityCertificateRevocationListIamPolicyArgs();
    ...
    public CertificateAuthorityCertificateRevocationListIamPolicyArgs(
    ...
    private CertificateAuthorityCertificateRevocationListIamPolicyArgs() {
    ...
    public static Builder builder(CertificateAuthorityCertificateRevocationListIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CertificateAuthorityCertificateRevocationListIamPolicyArgs defaults) {
        ...
        public Builder version(@Nullable Integer version) {
            ...
            return this;
        }        public CertificateAuthorityCertificateRevocationListIamPolicyArgs build() {
            return new CertificateAuthorityCertificateRevocationListIamPolicyArgs(auditConfigs, bindings, certificateAuthorityId, certificateRevocationListId, etag, location, project, updateMask, version);
        }
    }
}
