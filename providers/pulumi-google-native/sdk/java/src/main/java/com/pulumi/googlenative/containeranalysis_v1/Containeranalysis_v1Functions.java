...
import com.pulumi.googlenative.containeranalysis_v1.inputs.GetNoteIamPolicyPlainArgs;
import com.pulumi.googlenative.containeranalysis_v1.inputs.GetNotePlainArgs;
...
import com.pulumi.googlenative.containeranalysis_v1.inputs.GetOccurrenceIamPolicyPlainArgs;
import com.pulumi.googlenative.containeranalysis_v1.inputs.GetOccurrencePlainArgs;
...
public final class Containeranalysis_v1Functions {
    ...
    public static Output<GetNoteResult> getNote(GetNoteArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:containeranalysis/v1:getNote", TypeShape.of(GetNoteResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the specified note.
     * 
    ...
    public static Output<GetNoteIamPolicyResult> getNoteIamPolicy(GetNoteIamPolicyArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:containeranalysis/v1:getNoteIamPolicy", TypeShape.of(GetNoteIamPolicyResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the access control policy for a note or an occurrence resource. Requires `containeranalysis.notes.setIamPolicy` or `containeranalysis.occurrences.setIamPolicy` permission if the resource is a note or occurrence, respectively. The resource takes the format `projects/[PROJECT_ID]/notes/[NOTE_ID]` for notes and `projects/[PROJECT_ID]/occurrences/[OCCURRENCE_ID]` for occurrences.
     * 
    ...
    public static Output<GetOccurrenceResult> getOccurrence(GetOccurrenceArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:containeranalysis/v1:getOccurrence", TypeShape.of(GetOccurrenceResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the specified occurrence.
     * 
    ...
    public static Output<GetOccurrenceIamPolicyResult> getOccurrenceIamPolicy(GetOccurrenceIamPolicyArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("google-native:containeranalysis/v1:getOccurrenceIamPolicy", TypeShape.of(GetOccurrenceIamPolicyResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Gets the access control policy for a note or an occurrence resource. Requires `containeranalysis.notes.setIamPolicy` or `containeranalysis.occurrences.setIamPolicy` permission if the resource is a note or occurrence, respectively. The resource takes the format `projects/[PROJECT_ID]/notes/[NOTE_ID]` for notes and `projects/[PROJECT_ID]/occurrences/[OCCURRENCE_ID]` for occurrences.
     * 
