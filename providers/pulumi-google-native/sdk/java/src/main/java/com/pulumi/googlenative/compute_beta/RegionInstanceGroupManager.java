...
import com.pulumi.googlenative.compute_beta.RegionInstanceGroupManagerArgs;
...
public class RegionInstanceGroupManager extends CustomResource {
    ...
    private RegionInstanceGroupManager(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegionInstanceGroupManager get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
