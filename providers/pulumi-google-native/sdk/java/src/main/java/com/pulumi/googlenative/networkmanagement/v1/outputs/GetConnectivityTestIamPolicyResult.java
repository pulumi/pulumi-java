...
import com.pulumi.googlenative.networkmanagement.v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.networkmanagement.v1.outputs.BindingResponse;
...
@CustomType
public final class GetConnectivityTestIamPolicyResult {
    /**
    ...
    private GetConnectivityTestIamPolicyResult(
    ...
    public static Builder builder(GetConnectivityTestIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetConnectivityTestIamPolicyResult defaults) {
