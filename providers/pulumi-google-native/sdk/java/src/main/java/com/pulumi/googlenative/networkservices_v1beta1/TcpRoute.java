...
import com.pulumi.googlenative.networkservices_v1beta1.TcpRouteArgs;
import com.pulumi.googlenative.networkservices_v1beta1.outputs.TcpRouteRouteRuleResponse;
 ...
 * 
 */
@ResourceType(type="google-native:networkservices/v1beta1:TcpRoute")
public class TcpRoute extends com.pulumi.resources.CustomResource {
    ...
    public TcpRoute(String name, TcpRouteArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1beta1:TcpRoute", name, args == null ? TcpRouteArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TcpRoute(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:networkservices/v1beta1:TcpRoute", name, null, makeResourceOptions(options, id));
    }
