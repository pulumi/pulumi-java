...
import com.pulumi.googlenative.compute_alpha.RegionDiskArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:RegionDisk")
public class RegionDisk extends CustomResource {
    /**
     ...
     * 
     */
    @Export(name="sourceInstantSnapshot", type=String.class, parameters={})
    private Output<String> sourceInstantSnapshot;
     ...
     * 
     */
    @Export(name="sourceInstantSnapshotId", type=String.class, parameters={})
     ...
     */
    public RegionDisk(String name, RegionDiskArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionDisk", name, args == null ? RegionDiskArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegionDisk(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionDisk", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static RegionDisk get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
