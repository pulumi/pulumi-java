...
import com.pulumi.googlenative.compute_beta.HttpsHealthCheckArgs;
...
public class HttpsHealthCheck extends CustomResource {
    /**
     ...
     */
    public HttpsHealthCheck(String name, @Nullable HttpsHealthCheckArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HttpsHealthCheck(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HttpsHealthCheck get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
