...
import com.pulumi.googlenative.clouddeploy.v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.clouddeploy.v1.outputs.BindingResponse;
...
@CustomType
public final class GetDeliveryPipelineIamPolicyResult {
    /**
    ...
    public static Builder builder(GetDeliveryPipelineIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetDeliveryPipelineIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetDeliveryPipelineIamPolicyResult build() {
            return new GetDeliveryPipelineIamPolicyResult(auditConfigs, bindings, etag, version);
        }
    }
}
