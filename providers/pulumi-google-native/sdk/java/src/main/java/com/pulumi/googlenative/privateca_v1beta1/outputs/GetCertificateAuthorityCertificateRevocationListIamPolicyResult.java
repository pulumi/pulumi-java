...
import com.pulumi.googlenative.privateca_v1beta1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.privateca_v1beta1.outputs.BindingResponse;
...
@CustomType
public final class GetCertificateAuthorityCertificateRevocationListIamPolicyResult {
    /**
    ...
    private GetCertificateAuthorityCertificateRevocationListIamPolicyResult(
    ...
    public static Builder builder(GetCertificateAuthorityCertificateRevocationListIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetCertificateAuthorityCertificateRevocationListIamPolicyResult defaults) {
