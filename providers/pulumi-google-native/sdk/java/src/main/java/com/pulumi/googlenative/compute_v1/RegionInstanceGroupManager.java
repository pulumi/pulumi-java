...
import com.pulumi.googlenative.compute_v1.RegionInstanceGroupManagerArgs;
...
public class RegionInstanceGroupManager extends CustomResource {
    ...
    public RegionInstanceGroupManager(String name, RegionInstanceGroupManagerArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/v1:RegionInstanceGroupManager", name, args == null ? RegionInstanceGroupManagerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
