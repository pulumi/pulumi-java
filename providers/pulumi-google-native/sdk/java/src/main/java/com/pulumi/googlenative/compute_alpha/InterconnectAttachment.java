...
import com.pulumi.googlenative.compute_alpha.InterconnectAttachmentArgs;
import com.pulumi.googlenative.compute_alpha.outputs.InterconnectAttachmentPartnerMetadataResponse;
import com.pulumi.googlenative.compute_alpha.outputs.InterconnectAttachmentPrivateInfoResponse;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:InterconnectAttachment")
public class InterconnectAttachment extends com.pulumi.resources.CustomResource {
    ...
    public InterconnectAttachment(String name, InterconnectAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:InterconnectAttachment", name, args == null ? InterconnectAttachmentArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private InterconnectAttachment(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:InterconnectAttachment", name, null, makeResourceOptions(options, id));
    }
