...
import com.pulumi.googlenative.compute_v1.AddressArgs;
...
public class Address extends CustomResource {
     ...
     */
    public Address(String name, AddressArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/v1:Address", name, args == null ? AddressArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Address(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Address get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
