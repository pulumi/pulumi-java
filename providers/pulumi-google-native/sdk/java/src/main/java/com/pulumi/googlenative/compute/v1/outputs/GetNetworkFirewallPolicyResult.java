...
public final class GetNetworkFirewallPolicyResult {
    ...
    public static final class Builder {
        ...
        public Builder shortName(String shortName) {
            ...
            return new GetNetworkFirewallPolicyResult(associations, creationTimestamp, description, displayName, fingerprint, kind, name, parent, region, ruleTupleCount, rules, selfLink, selfLinkWithId, shortName);
        }
    }
}
