...
import com.pulumi.googlenative.healthcare_v1beta1.enums.FhirStoreVersion;
import com.pulumi.googlenative.healthcare_v1beta1.inputs.NotificationConfigArgs;
import com.pulumi.googlenative.healthcare_v1beta1.inputs.SearchConfigArgs;
import com.pulumi.googlenative.healthcare_v1beta1.inputs.StreamConfigArgs;
import com.pulumi.googlenative.healthcare_v1beta1.inputs.ValidationConfigArgs;
...
public final class FhirStoreArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Output<SearchConfigArgs> searchConfig() {
        return this.searchConfig == null ? Codegen.empty() : this.searchConfig;
    }
    ...
    public FhirStoreArgs(
        ...
        @Nullable Output<SearchConfigArgs> searchConfig,
    ...
    private FhirStoreArgs() {
        ...
        this.searchConfig = Codegen.empty();
    ...
    public static final class Builder {
        ...
        public Builder searchConfig(@Nullable SearchConfigArgs searchConfig) {
            this.searchConfig = Codegen.ofNullable(searchConfig);
            return this;
        }
        ...
        public Builder version(@Nullable FhirStoreVersion version) {
            ...
            return new FhirStoreArgs(datasetId, defaultSearchHandlingStrict, disableReferentialIntegrity, disableResourceVersioning, enableUpdateCreate, fhirStoreId, labels, location, notificationConfig, project, searchConfig, streamConfigs, validationConfig, version);
        }
    }
}
