...
public final class EndpointPolicyIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EndpointPolicyIamPolicyArgs(EndpointPolicyIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EndpointPolicyIamPolicyArgs();
        }

        public Builder(EndpointPolicyIamPolicyArgs defaults) {
            $ = new EndpointPolicyIamPolicyArgs(Objects.requireNonNull(defaults));
        }
