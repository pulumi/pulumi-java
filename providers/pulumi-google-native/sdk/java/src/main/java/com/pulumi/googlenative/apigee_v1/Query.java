...
import com.pulumi.googlenative.apigee_v1.QueryArgs;
...
public class Query extends CustomResource {
     ...
     */
    public Query(String name, QueryArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:apigee/v1:Query", name, args == null ? QueryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Query(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Query get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
