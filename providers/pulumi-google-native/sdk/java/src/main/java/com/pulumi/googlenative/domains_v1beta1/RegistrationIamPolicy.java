...
public class RegistrationIamPolicy extends CustomResource {
    /**
     ...
     */
    public RegistrationIamPolicy(String name, RegistrationIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegistrationIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegistrationIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
