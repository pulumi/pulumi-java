...
import com.pulumi.googlenative.cloudresourcemanager_v3.TagValueIamPolicyArgs;
import com.pulumi.googlenative.cloudresourcemanager_v3.outputs.AuditConfigResponse;
import com.pulumi.googlenative.cloudresourcemanager_v3.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:cloudresourcemanager/v3:TagValueIamPolicy")
public class TagValueIamPolicy extends CustomResource {
    /**
     ...
     */
    public TagValueIamPolicy(String name, TagValueIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v3:TagValueIamPolicy", name, args == null ? TagValueIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TagValueIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TagValueIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
