...
public class TagValueIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private TagValueIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TagValueIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
