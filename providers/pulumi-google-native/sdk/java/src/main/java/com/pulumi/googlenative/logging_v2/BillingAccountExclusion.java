...
import com.pulumi.googlenative.logging_v2.BillingAccountExclusionArgs;
...
public class BillingAccountExclusion extends CustomResource {
    /**
     ...
     */
    public BillingAccountExclusion(String name, BillingAccountExclusionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BillingAccountExclusion(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BillingAccountExclusion get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
