...
public class BillingAccountExclusion extends com.pulumi.resources.CustomResource {
    ...
    private BillingAccountExclusion(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static BillingAccountExclusion get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
