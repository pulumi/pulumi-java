...
import com.pulumi.googlenative.compute_alpha.RegionInstantSnapshotIamPolicyArgs;
...
public class RegionInstantSnapshotIamPolicy extends CustomResource {
    /**
     ...
     */
    public RegionInstantSnapshotIamPolicy(String name, RegionInstantSnapshotIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegionInstantSnapshotIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegionInstantSnapshotIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
