...
import com.pulumi.googlenative.cloudbilling_v1.BillingAccountIamPolicyArgs;
...
public class BillingAccountIamPolicy extends CustomResource {
    /**
     ...
     */
    public BillingAccountIamPolicy(String name, BillingAccountIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BillingAccountIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BillingAccountIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
