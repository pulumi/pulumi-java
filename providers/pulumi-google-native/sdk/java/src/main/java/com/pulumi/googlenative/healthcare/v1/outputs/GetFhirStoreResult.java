...
public final class GetFhirStoreResult {
    ...
    public static final class Builder {
        ...
        public Builder version(String version) {
            ...
            return new GetFhirStoreResult(complexDataTypeReferenceParsing, defaultSearchHandlingStrict, disableReferentialIntegrity, disableResourceVersioning, enableUpdateCreate, labels, name, notificationConfig, streamConfigs, validationConfig, version);
        }
    }
}
