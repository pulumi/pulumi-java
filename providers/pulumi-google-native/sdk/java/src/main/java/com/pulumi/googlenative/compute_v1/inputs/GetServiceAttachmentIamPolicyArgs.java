...
public final class GetServiceAttachmentIamPolicyArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetServiceAttachmentIamPolicyArgs(GetServiceAttachmentIamPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceAttachmentIamPolicyArgs();
        }

        public Builder(GetServiceAttachmentIamPolicyArgs defaults) {
            $ = new GetServiceAttachmentIamPolicyArgs(Objects.requireNonNull(defaults));
        }
