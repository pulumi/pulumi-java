...
public final class OperationWarningsItemDataItemResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private OperationWarningsItemDataItemResponse(OperationWarningsItemDataItemResponse $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OperationWarningsItemDataItemResponse();
        }

        public Builder(OperationWarningsItemDataItemResponse defaults) {
            $ = new OperationWarningsItemDataItemResponse(Objects.requireNonNull(defaults));
        }
