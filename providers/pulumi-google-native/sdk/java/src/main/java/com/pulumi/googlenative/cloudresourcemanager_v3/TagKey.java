...
public class TagKey extends CustomResource {
    ...
    private TagKey(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TagKey get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
