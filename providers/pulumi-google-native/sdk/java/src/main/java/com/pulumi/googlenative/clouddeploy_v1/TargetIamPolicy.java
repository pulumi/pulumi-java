...
public class TargetIamPolicy extends CustomResource {
    /**
     ...
     */
    public TargetIamPolicy(String name, TargetIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TargetIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TargetIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
