...
import com.pulumi.googlenative.clouddeploy_v1.TargetIamPolicyArgs;
import com.pulumi.googlenative.clouddeploy_v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.clouddeploy_v1.outputs.BindingResponse;
...
public class TargetIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public TargetIamPolicy(String name, TargetIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private TargetIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TargetIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
