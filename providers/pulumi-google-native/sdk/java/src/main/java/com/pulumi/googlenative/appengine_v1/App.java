...
import com.pulumi.googlenative.appengine_v1.AppArgs;
import com.pulumi.googlenative.appengine_v1.outputs.FeatureSettingsResponse;
import com.pulumi.googlenative.appengine_v1.outputs.IdentityAwareProxyResponse;
import com.pulumi.googlenative.appengine_v1.outputs.UrlDispatchRuleResponse;
...
public class App extends CustomResource {
     ...
     */
    public App(String name, @Nullable AppArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:appengine/v1:App", name, args == null ? AppArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private App(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static App get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
