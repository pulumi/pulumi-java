...
public class AutoscalingPolicy extends CustomResource {
    ...
    private AutoscalingPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AutoscalingPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
