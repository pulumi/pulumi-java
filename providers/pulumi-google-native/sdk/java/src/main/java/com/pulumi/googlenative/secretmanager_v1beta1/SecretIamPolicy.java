...
import com.pulumi.googlenative.secretmanager_v1beta1.SecretIamPolicyArgs;
import com.pulumi.googlenative.secretmanager_v1beta1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.secretmanager_v1beta1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:secretmanager/v1beta1:SecretIamPolicy")
public class SecretIamPolicy extends CustomResource {
    /**
     ...
     */
    public SecretIamPolicy(String name, SecretIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:secretmanager/v1beta1:SecretIamPolicy", name, args == null ? SecretIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SecretIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:secretmanager/v1beta1:SecretIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static SecretIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
