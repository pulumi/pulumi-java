...
public class SecretIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private SecretIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SecretIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
