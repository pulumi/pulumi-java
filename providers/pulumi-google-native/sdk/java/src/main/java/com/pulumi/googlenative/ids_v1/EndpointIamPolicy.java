...
public class EndpointIamPolicy extends CustomResource {
    /**
     ...
     */
    public EndpointIamPolicy(String name, EndpointIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EndpointIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EndpointIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
