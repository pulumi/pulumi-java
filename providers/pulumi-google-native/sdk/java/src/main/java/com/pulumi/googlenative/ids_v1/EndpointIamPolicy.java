...
import com.pulumi.googlenative.ids_v1.EndpointIamPolicyArgs;
import com.pulumi.googlenative.ids_v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.ids_v1.outputs.BindingResponse;
...
public class EndpointIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public EndpointIamPolicy(String name, EndpointIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private EndpointIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static EndpointIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
