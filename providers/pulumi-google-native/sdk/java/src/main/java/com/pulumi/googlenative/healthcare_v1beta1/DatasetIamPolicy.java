...
import com.pulumi.googlenative.healthcare_v1beta1.DatasetIamPolicyArgs;
...
public class DatasetIamPolicy extends CustomResource {
    ...
    private DatasetIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DatasetIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
