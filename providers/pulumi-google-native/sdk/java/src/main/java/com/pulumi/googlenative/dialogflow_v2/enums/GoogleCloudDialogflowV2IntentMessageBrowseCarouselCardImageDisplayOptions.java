...
import java.util.StringJoiner;
    ...
    public enum GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardImageDisplayOptions {
        ...
        GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardImageDisplayOptions(String value) {
        ...
        public String toString() {
            return new StringJoiner(", ", "GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardImageDisplayOptions[", "]")
