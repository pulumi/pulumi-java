...
import com.pulumi.googlenative.essentialcontacts_v1.FolderContactArgs;
...
public class FolderContact extends CustomResource {
    /**
     ...
     */
    public FolderContact(String name, FolderContactArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FolderContact(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FolderContact get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
