...
public final class ScanRunArgs extends ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param errorTrace If result_state is an ERROR, this field provides the primary reason for scan&#39;s termination and more details, if such are available.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param warningTraces A list of warnings, if such are encountered during this scan run.
         * 
         * @return builder
         * 
         */
