...
import com.pulumi.googlenative.apigeeregistry.v1.outputs.BindingResponse;
...
@CustomType
public final class GetApiDeploymentIamPolicyResult {
    /**
    ...
    private GetApiDeploymentIamPolicyResult(
    ...
    public static Builder builder(GetApiDeploymentIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetApiDeploymentIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetApiDeploymentIamPolicyResult build() {
            return new GetApiDeploymentIamPolicyResult(bindings, etag, version);
        }
    }
}
