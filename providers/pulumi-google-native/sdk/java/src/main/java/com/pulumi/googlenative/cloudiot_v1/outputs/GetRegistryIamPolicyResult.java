...
@CustomType
public final class GetRegistryIamPolicyResult {
        /**
    ...
    public static Builder builder(GetRegistryIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetRegistryIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetRegistryIamPolicyResult build() {
            return new GetRegistryIamPolicyResult(bindings, etag, version);
        }
    }
}
