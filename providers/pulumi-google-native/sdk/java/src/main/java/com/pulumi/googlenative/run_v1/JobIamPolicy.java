...
import com.pulumi.googlenative.run_v1.JobIamPolicyArgs;
import com.pulumi.googlenative.run_v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.run_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:run/v1:JobIamPolicy")
public class JobIamPolicy extends CustomResource {
    ...
    public JobIamPolicy(String name, JobIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:run/v1:JobIamPolicy", name, args == null ? JobIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private JobIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:run/v1:JobIamPolicy", name, null, makeResourceOptions(options, id));
    }
