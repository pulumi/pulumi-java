...
import com.pulumi.googlenative.managedidentities_v1beta1.BackupArgs;
...
public class Backup extends com.pulumi.resources.CustomResource {
    ...
    public Backup(String name, BackupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:managedidentities/v1beta1:Backup", name, args == null ? BackupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
