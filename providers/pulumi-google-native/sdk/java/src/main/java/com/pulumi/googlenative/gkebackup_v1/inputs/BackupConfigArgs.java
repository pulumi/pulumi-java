...
import com.pulumi.googlenative.gkebackup_v1.inputs.EncryptionKeyArgs;
...
public final class BackupConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return This defines a customer managed encryption key that will be used to encrypt the Backup artifacts for Backups created via this BackupPlan.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param encryptionKey This defines a customer managed encryption key that will be used to encrypt the Backup artifacts for Backups created via this BackupPlan.
         * 
         * @return builder
         * 
         */
