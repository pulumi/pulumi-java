...
import com.pulumi.googlenative.clouddeploy_v1.TargetArgs;
...
public class Target extends CustomResource {
     ...
     */
    public Target(String name, TargetArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:clouddeploy/v1:Target", name, args == null ? TargetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Target(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Target get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
