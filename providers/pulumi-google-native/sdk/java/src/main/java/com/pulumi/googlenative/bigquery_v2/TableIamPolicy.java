...
import com.pulumi.googlenative.bigquery_v2.TableIamPolicyArgs;
...
public class TableIamPolicy extends CustomResource {
    /**
     ...
     */
    public TableIamPolicy(String name, TableIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TableIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TableIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
