...
public final class SecurityPolicyRuleMatcherConfigDestinationPortArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SecurityPolicyRuleMatcherConfigDestinationPortArgs(SecurityPolicyRuleMatcherConfigDestinationPortArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecurityPolicyRuleMatcherConfigDestinationPortArgs();
        }

        public Builder(SecurityPolicyRuleMatcherConfigDestinationPortArgs defaults) {
            $ = new SecurityPolicyRuleMatcherConfigDestinationPortArgs(Objects.requireNonNull(defaults));
        }
