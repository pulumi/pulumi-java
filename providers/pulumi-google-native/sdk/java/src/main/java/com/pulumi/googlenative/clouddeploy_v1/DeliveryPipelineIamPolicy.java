...
public class DeliveryPipelineIamPolicy extends CustomResource {
    /**
     ...
     */
    public DeliveryPipelineIamPolicy(String name, DeliveryPipelineIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DeliveryPipelineIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DeliveryPipelineIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
