...
import com.pulumi.googlenative.clouddeploy_v1.DeliveryPipelineIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:clouddeploy/v1:DeliveryPipelineIamPolicy")
public class DeliveryPipelineIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public DeliveryPipelineIamPolicy(String name, DeliveryPipelineIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:clouddeploy/v1:DeliveryPipelineIamPolicy", name, args == null ? DeliveryPipelineIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DeliveryPipelineIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:clouddeploy/v1:DeliveryPipelineIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static DeliveryPipelineIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
