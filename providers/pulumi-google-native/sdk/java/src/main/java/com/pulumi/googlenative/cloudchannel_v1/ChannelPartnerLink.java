...
import com.pulumi.googlenative.cloudchannel_v1.ChannelPartnerLinkArgs;
...
public class ChannelPartnerLink extends CustomResource {
    /**
     ...
     */
    public ChannelPartnerLink(String name, ChannelPartnerLinkArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ChannelPartnerLink(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ChannelPartnerLink get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
