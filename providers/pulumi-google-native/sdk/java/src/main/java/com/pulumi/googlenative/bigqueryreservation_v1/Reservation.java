...
import com.pulumi.googlenative.bigqueryreservation_v1.ReservationArgs;
...
public class Reservation extends CustomResource {
     ...
     */
    public Reservation(String name, @Nullable ReservationArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:bigqueryreservation/v1:Reservation", name, args == null ? ReservationArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Reservation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Reservation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
