...
public class TargetGrpcProxy extends com.pulumi.resources.CustomResource {
    ...
    private TargetGrpcProxy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TargetGrpcProxy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
