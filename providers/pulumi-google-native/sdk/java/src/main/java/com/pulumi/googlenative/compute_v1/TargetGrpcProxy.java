...
import com.pulumi.googlenative.compute_v1.TargetGrpcProxyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:TargetGrpcProxy")
public class TargetGrpcProxy extends CustomResource {
    ...
    public TargetGrpcProxy(String name, @Nullable TargetGrpcProxyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/v1:TargetGrpcProxy", name, args == null ? TargetGrpcProxyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TargetGrpcProxy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:compute/v1:TargetGrpcProxy", name, null, makeResourceOptions(options, id));
    }
