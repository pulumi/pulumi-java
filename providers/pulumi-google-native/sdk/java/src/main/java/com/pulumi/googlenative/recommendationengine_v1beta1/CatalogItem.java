...
import com.pulumi.googlenative.recommendationengine_v1beta1.CatalogItemArgs;
...
public class CatalogItem extends CustomResource {
    /**
     ...
     */
    public CatalogItem(String name, CatalogItemArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CatalogItem(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CatalogItem get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
