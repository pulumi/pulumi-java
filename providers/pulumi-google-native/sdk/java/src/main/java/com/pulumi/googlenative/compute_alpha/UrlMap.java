...
public class UrlMap extends CustomResource {
    ...
    private UrlMap(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UrlMap get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
