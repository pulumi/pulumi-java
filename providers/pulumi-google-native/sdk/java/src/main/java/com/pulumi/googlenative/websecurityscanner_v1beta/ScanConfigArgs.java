...
public final class ScanConfigArgs extends ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param exportToSecurityCommandCenter Controls export of scan configurations and results to Security Command Center.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param managedScan Whether the scan config is managed by Web Security Scanner, output only.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param riskLevel The risk level selected for the scan
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param staticIpScan Whether the scan configuration has enabled static IP address scan feature. If enabled, the scanner will access applications from static IP addresses.
         * 
         * @return builder
         * 
         */
