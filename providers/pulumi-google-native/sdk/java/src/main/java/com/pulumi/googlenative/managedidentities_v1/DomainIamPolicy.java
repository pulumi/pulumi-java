...
import com.pulumi.googlenative.managedidentities_v1.DomainIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:managedidentities/v1:DomainIamPolicy")
public class DomainIamPolicy extends CustomResource {
    /**
     ...
     */
    public DomainIamPolicy(String name, DomainIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DomainIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:managedidentities/v1:DomainIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static DomainIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
