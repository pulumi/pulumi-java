...
public class DomainIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private DomainIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static DomainIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
