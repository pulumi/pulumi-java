...
public class ConfigIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private ConfigIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ConfigIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
