...
import com.pulumi.googlenative.runtimeconfig_v1beta1.ConfigIamPolicyArgs;
import com.pulumi.googlenative.runtimeconfig_v1beta1.outputs.BindingResponse;
...
public class ConfigIamPolicy extends CustomResource {
    /**
     ...
     */
    public ConfigIamPolicy(String name, ConfigIamPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:runtimeconfig/v1beta1:ConfigIamPolicy", name, args == null ? ConfigIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ConfigIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConfigIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
