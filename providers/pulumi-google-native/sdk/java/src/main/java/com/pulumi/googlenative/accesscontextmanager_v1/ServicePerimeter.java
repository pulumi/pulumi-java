...
import com.pulumi.googlenative.accesscontextmanager_v1.ServicePerimeterArgs;
...
public class ServicePerimeter extends CustomResource {
    ...
    private ServicePerimeter(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServicePerimeter get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
