...
import com.pulumi.googlenative.cloudresourcemanager_v3.LienArgs;
...
public class Lien extends CustomResource {
     ...
     */
    public Lien(String name, @Nullable LienArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v3:Lien", name, args == null ? LienArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Lien(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Lien get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
