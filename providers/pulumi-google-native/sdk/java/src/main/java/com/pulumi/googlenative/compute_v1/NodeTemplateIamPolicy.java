...
public class NodeTemplateIamPolicy extends CustomResource {
    /**
     ...
     */
    public NodeTemplateIamPolicy(String name, NodeTemplateIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NodeTemplateIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NodeTemplateIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
