...
import com.pulumi.googlenative.compute_v1.NodeTemplateIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:NodeTemplateIamPolicy")
public class NodeTemplateIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public NodeTemplateIamPolicy(String name, NodeTemplateIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:NodeTemplateIamPolicy", name, args == null ? NodeTemplateIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private NodeTemplateIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:NodeTemplateIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static NodeTemplateIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
