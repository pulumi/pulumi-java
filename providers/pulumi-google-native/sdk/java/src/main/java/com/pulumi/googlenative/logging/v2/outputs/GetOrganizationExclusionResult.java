...
@CustomType
public final class GetOrganizationExclusionResult {
    /**
    ...
    public static Builder builder(GetOrganizationExclusionResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetOrganizationExclusionResult defaults) {
        ...
        public Builder updateTime(String updateTime) {
            ...
            return this;
        }        public GetOrganizationExclusionResult build() {
            return new GetOrganizationExclusionResult(createTime, description, disabled, filter, name, updateTime);
        }
    }
}
