...
import com.pulumi.googlenative.cloudfunctions_v1.FunctionIamPolicyArgs;
import com.pulumi.googlenative.cloudfunctions_v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.cloudfunctions_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:cloudfunctions/v1:FunctionIamPolicy")
public class FunctionIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public FunctionIamPolicy(String name, FunctionIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudfunctions/v1:FunctionIamPolicy", name, args == null ? FunctionIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FunctionIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudfunctions/v1:FunctionIamPolicy", name, null, makeResourceOptions(options, id));
    }
