...
public class FunctionIamPolicy extends CustomResource {
    ...
    private FunctionIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FunctionIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
