...
import com.pulumi.googlenative.metastore_v1beta.ServiceIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:metastore/v1beta:ServiceIamPolicy")
public class ServiceIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private ServiceIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:metastore/v1beta:ServiceIamPolicy", name, null, makeResourceOptions(options, id));
    }
