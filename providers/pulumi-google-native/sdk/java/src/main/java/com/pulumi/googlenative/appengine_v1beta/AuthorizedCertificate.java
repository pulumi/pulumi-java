...
import com.pulumi.googlenative.appengine_v1beta.AuthorizedCertificateArgs;
...
public class AuthorizedCertificate extends CustomResource {
    ...
    public AuthorizedCertificate(String name, AuthorizedCertificateArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:appengine/v1beta:AuthorizedCertificate", name, args == null ? AuthorizedCertificateArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
