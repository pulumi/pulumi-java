...
import com.pulumi.googlenative.compute_beta.SnapshotIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:SnapshotIamPolicy")
public class SnapshotIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public SnapshotIamPolicy(String name, SnapshotIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:SnapshotIamPolicy", name, args == null ? SnapshotIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SnapshotIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/beta:SnapshotIamPolicy", name, null, makeResourceOptions(options, id));
    }
