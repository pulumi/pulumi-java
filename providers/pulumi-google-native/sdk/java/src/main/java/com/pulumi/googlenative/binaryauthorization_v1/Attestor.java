...
import com.pulumi.googlenative.binaryauthorization_v1.AttestorArgs;
...
public class Attestor extends CustomResource {
     ...
     * 
     */
    public Output<UserOwnedGrafeasNoteResponse> userOwnedGrafeasNote() {
    ...
    public Attestor(String name, AttestorArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:binaryauthorization/v1:Attestor", name, args == null ? AttestorArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Attestor(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Attestor get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
