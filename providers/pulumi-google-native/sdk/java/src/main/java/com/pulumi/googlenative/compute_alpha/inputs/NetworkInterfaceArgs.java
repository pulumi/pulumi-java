...
public final class NetworkInterfaceArgs extends ResourceArgs {
     ...
     * 
     */
    public Optional<Output<List<NetworkInterfaceSubInterfaceArgs>>> subinterfaces() {
        return Optional.ofNullable(this.subinterfaces);
    }
    ...
    public static final class Builder {
        ...
        /**
         * @param subinterfaces SubInterfaces help enable L2 communication for the instance over subnetworks that support L2. Every network interface will get a default untagged (vlan not specified) subinterface. Users can specify additional tagged subinterfaces which are sub-fields to the Network Interface.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder subinterfaces(List<NetworkInterfaceSubInterfaceArgs> subinterfaces) {
            return subinterfaces(Output.of(subinterfaces));
        }
