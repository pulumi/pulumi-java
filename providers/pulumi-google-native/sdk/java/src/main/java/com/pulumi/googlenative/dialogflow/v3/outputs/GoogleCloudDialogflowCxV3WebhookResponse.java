...
@CustomType
public final class GoogleCloudDialogflowCxV3WebhookResponse {
    /**
    ...
    public static Builder builder(GoogleCloudDialogflowCxV3WebhookResponse defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GoogleCloudDialogflowCxV3WebhookResponse defaults) {
        ...
        public Builder timeout(String timeout) {
            ...
            return this;
        }        public GoogleCloudDialogflowCxV3WebhookResponse build() {
            return new GoogleCloudDialogflowCxV3WebhookResponse(disabled, displayName, genericWebService, name, serviceDirectory, timeout);
        }
    }
}
