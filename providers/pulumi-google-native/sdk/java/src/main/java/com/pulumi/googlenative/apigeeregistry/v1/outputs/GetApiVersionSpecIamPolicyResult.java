...
@CustomType
public final class GetApiVersionSpecIamPolicyResult {
    /**
    ...
    public static Builder builder(GetApiVersionSpecIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetApiVersionSpecIamPolicyResult defaults) {
        ...
        public Builder version(Integer version) {
            ...
            return this;
        }        public GetApiVersionSpecIamPolicyResult build() {
            return new GetApiVersionSpecIamPolicyResult(bindings, etag, version);
        }
    }
}
