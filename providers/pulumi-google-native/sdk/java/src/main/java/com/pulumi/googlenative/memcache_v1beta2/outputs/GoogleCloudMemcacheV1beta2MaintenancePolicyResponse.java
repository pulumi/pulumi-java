...
import com.pulumi.googlenative.memcache_v1beta2.outputs.WeeklyMaintenanceWindowResponse;
import java.lang.String;
import java.util.List;
import java.util.Objects;

@CustomType
public final class GoogleCloudMemcacheV1beta2MaintenancePolicyResponse {
    /**
    ...
    public static Builder builder(GoogleCloudMemcacheV1beta2MaintenancePolicyResponse defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GoogleCloudMemcacheV1beta2MaintenancePolicyResponse defaults) {
        ...
        }        public GoogleCloudMemcacheV1beta2MaintenancePolicyResponse build() {
            return new GoogleCloudMemcacheV1beta2MaintenancePolicyResponse(createTime, description, updateTime, weeklyMaintenanceWindow);
        }
    }
}
