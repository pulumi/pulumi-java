...
public final class AttachedDiskInitializeParamsResponse {
    ...
    public static final class Builder {
        ...
        public Builder sourceSnapshotEncryptionKey(CustomerEncryptionKeyResponse sourceSnapshotEncryptionKey) {
            ...
            return new AttachedDiskInitializeParamsResponse(architecture, description, diskName, diskSizeGb, diskType, labels, licenses, onUpdateAction, provisionedIops, resourcePolicies, sourceImage, sourceImageEncryptionKey, sourceSnapshot, sourceSnapshotEncryptionKey);
        }
    }
}
