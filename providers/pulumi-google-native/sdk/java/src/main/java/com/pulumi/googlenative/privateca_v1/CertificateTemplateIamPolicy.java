...
public class CertificateTemplateIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    private CertificateTemplateIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static CertificateTemplateIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
