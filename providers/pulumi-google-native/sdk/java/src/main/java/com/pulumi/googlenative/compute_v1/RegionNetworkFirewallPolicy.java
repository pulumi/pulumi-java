...
import com.pulumi.googlenative.compute_v1.RegionNetworkFirewallPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/v1:RegionNetworkFirewallPolicy")
public class RegionNetworkFirewallPolicy extends com.pulumi.resources.CustomResource {
    ...
    public RegionNetworkFirewallPolicy(String name, RegionNetworkFirewallPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:RegionNetworkFirewallPolicy", name, args == null ? RegionNetworkFirewallPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private RegionNetworkFirewallPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/v1:RegionNetworkFirewallPolicy", name, null, makeResourceOptions(options, id));
    }
