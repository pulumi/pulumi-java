...
import com.pulumi.googlenative.storage_v1.BucketObjectArgs;
...
public class BucketObject extends CustomResource {
    ...
    private BucketObject(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BucketObject get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
