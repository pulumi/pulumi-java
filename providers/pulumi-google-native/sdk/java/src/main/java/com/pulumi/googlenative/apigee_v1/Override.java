...
import com.pulumi.googlenative.apigee_v1.OverrideArgs;
...
public class Override extends CustomResource {
    /**
     ...
     */
    public Override(String name, OverrideArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:apigee/v1:Override", name, args == null ? OverrideArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Override(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Override get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
