...
public class LicenseIamPolicy extends CustomResource {
    /**
     ...
     */
    public LicenseIamPolicy(String name, LicenseIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LicenseIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LicenseIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
