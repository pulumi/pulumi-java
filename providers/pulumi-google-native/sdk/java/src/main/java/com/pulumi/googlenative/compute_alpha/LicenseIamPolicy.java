...
import com.pulumi.googlenative.compute_alpha.LicenseIamPolicyArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:LicenseIamPolicy")
public class LicenseIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LicenseIamPolicy(String name, LicenseIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private LicenseIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:LicenseIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static LicenseIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
