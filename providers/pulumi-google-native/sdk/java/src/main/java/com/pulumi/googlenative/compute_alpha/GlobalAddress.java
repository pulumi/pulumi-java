...
public class GlobalAddress extends CustomResource {
    ...
    private GlobalAddress(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GlobalAddress get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
