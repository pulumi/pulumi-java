...
import com.pulumi.googlenative.compute_alpha.GlobalAddressArgs;
...
public class GlobalAddress extends com.pulumi.resources.CustomResource {
    ...
    public GlobalAddress(String name, @Nullable GlobalAddressArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:compute/alpha:GlobalAddress", name, args == null ? GlobalAddressArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private GlobalAddress(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static GlobalAddress get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
