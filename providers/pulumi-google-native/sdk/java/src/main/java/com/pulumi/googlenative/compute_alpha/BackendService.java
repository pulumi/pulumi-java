...
import com.pulumi.googlenative.compute_alpha.BackendServiceArgs;
...
public class BackendService extends CustomResource {
    ...
    private BackendService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BackendService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
