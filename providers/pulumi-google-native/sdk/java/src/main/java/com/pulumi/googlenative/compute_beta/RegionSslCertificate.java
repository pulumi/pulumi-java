...
import com.pulumi.googlenative.compute_beta.RegionSslCertificateArgs;
import com.pulumi.googlenative.compute_beta.outputs.SslCertificateManagedSslCertificateResponse;
import com.pulumi.googlenative.compute_beta.outputs.SslCertificateSelfManagedSslCertificateResponse;
 ...
 * 
 */
@ResourceType(type="google-native:compute/beta:RegionSslCertificate")
public class RegionSslCertificate extends CustomResource {
    ...
    public RegionSslCertificate(String name, RegionSslCertificateArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/beta:RegionSslCertificate", name, args == null ? RegionSslCertificateArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegionSslCertificate(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:compute/beta:RegionSslCertificate", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static RegionSslCertificate get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
