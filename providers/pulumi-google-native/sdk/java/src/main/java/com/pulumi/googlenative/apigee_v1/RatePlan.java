...
import com.pulumi.googlenative.apigee_v1.RatePlanArgs;
...
public class RatePlan extends CustomResource {
    /**
     ...
     */
    public RatePlan(String name, RatePlanArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:apigee/v1:RatePlan", name, args == null ? RatePlanArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RatePlan(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RatePlan get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
