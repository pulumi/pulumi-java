...
public class OrganizationIamPolicy extends CustomResource {
    /**
     ...
     */
    public OrganizationIamPolicy(String name, OrganizationIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OrganizationIamPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OrganizationIamPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
