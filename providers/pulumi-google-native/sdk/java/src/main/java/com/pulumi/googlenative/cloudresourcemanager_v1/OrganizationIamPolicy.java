...
import com.pulumi.googlenative.cloudresourcemanager_v1.OrganizationIamPolicyArgs;
import com.pulumi.googlenative.cloudresourcemanager_v1.outputs.AuditConfigResponse;
import com.pulumi.googlenative.cloudresourcemanager_v1.outputs.BindingResponse;
 ...
 * 
 */
@ResourceType(type="google-native:cloudresourcemanager/v1:OrganizationIamPolicy")
public class OrganizationIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public OrganizationIamPolicy(String name, OrganizationIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v1:OrganizationIamPolicy", name, args == null ? OrganizationIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private OrganizationIamPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("google-native:cloudresourcemanager/v1:OrganizationIamPolicy", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static OrganizationIamPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
