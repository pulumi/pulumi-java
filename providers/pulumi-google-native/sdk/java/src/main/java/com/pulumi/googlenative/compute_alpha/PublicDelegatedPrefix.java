...
import com.pulumi.googlenative.compute_alpha.PublicDelegatedPrefixArgs;
 ...
 * 
 */
@ResourceType(type="google-native:compute/alpha:PublicDelegatedPrefix")
public class PublicDelegatedPrefix extends CustomResource {
    ...
    public PublicDelegatedPrefix(String name, PublicDelegatedPrefixArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/alpha:PublicDelegatedPrefix", name, args == null ? PublicDelegatedPrefixArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private PublicDelegatedPrefix(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("google-native:compute/alpha:PublicDelegatedPrefix", name, null, makeResourceOptions(options, id));
    }
