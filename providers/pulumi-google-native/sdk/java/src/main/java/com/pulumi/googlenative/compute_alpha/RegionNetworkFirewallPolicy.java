...
import com.pulumi.googlenative.compute_alpha.RegionNetworkFirewallPolicyArgs;
...
public class RegionNetworkFirewallPolicy extends CustomResource {
    /**
     ...
     */
    public RegionNetworkFirewallPolicy(String name, RegionNetworkFirewallPolicyArgs args, @Nullable CustomResourceOptions options) {
        super("google-native:compute/alpha:RegionNetworkFirewallPolicy", name, args == null ? RegionNetworkFirewallPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegionNetworkFirewallPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegionNetworkFirewallPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
