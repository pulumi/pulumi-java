...
public final class RouteSpecHttp2RouteRetryPolicyPerRetryTimeoutGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RouteSpecHttp2RouteRetryPolicyPerRetryTimeoutGetArgs(RouteSpecHttp2RouteRetryPolicyPerRetryTimeoutGetArgs $) {
        this.unit = $.unit;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RouteSpecHttp2RouteRetryPolicyPerRetryTimeoutGetArgs();
        }

        public Builder(RouteSpecHttp2RouteRetryPolicyPerRetryTimeoutGetArgs defaults) {
            $ = new RouteSpecHttp2RouteRetryPolicyPerRetryTimeoutGetArgs(Objects.requireNonNull(defaults));
        }
