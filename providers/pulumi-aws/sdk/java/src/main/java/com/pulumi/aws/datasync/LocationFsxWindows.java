...
public class LocationFsxWindows extends CustomResource {
    ...
    private LocationFsxWindows(String name, Output<String> id, @Nullable LocationFsxWindowsState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LocationFsxWindows get(String name, Output<String> id, @Nullable LocationFsxWindowsState state, @Nullable CustomResourceOptions options) {
