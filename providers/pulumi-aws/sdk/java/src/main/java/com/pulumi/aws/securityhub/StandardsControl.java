...
public class StandardsControl extends CustomResource {
     ...
     */
    public StandardsControl(String name, StandardsControlArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StandardsControl(String name, Output<String> id, @Nullable StandardsControlState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StandardsControl get(String name, Output<String> id, @Nullable StandardsControlState state, @Nullable CustomResourceOptions options) {
