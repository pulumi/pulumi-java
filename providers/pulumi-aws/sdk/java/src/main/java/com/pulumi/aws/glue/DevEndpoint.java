...
public class DevEndpoint extends CustomResource {
     ...
     */
    public DevEndpoint(String name, DevEndpointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DevEndpoint(String name, Output<String> id, @Nullable DevEndpointState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DevEndpoint get(String name, Output<String> id, @Nullable DevEndpointState state, @Nullable CustomResourceOptions options) {
