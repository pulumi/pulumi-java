...
public final class GatewayRouteArgs extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="spec", required=true)
      private final Output<GatewayRouteSpecArgs> spec;

    public Output<GatewayRouteSpecArgs> getSpec() {
        return this.spec;
    }
    ...
    @Import(name="virtualGatewayName", required=true)
      private final Output<String> virtualGatewayName;
    ...
    public GatewayRouteArgs(
        ...
        Output<GatewayRouteSpecArgs> spec,
        @Nullable Output<Map<String,String>> tags,
        Output<String> virtualGatewayName) {
