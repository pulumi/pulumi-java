...
public final class ModelVpcConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ModelVpcConfigGetArgs(ModelVpcConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ModelVpcConfigGetArgs();
        }

        public Builder(ModelVpcConfigGetArgs defaults) {
            $ = new ModelVpcConfigGetArgs(Objects.requireNonNull(defaults));
        }
