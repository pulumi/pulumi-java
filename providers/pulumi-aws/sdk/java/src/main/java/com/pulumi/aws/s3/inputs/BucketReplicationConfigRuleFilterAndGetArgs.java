...
public final class BucketReplicationConfigRuleFilterAndGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private BucketReplicationConfigRuleFilterAndGetArgs(BucketReplicationConfigRuleFilterAndGetArgs $) {
        this.prefix = $.prefix;
        this.tags = $.tags;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BucketReplicationConfigRuleFilterAndGetArgs();
        }

        public Builder(BucketReplicationConfigRuleFilterAndGetArgs defaults) {
            $ = new BucketReplicationConfigRuleFilterAndGetArgs(Objects.requireNonNull(defaults));
        }
