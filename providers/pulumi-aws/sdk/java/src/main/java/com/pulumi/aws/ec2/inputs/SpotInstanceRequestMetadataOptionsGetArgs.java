...
public final class SpotInstanceRequestMetadataOptionsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SpotInstanceRequestMetadataOptionsGetArgs(SpotInstanceRequestMetadataOptionsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SpotInstanceRequestMetadataOptionsGetArgs();
        }

        public Builder(SpotInstanceRequestMetadataOptionsGetArgs defaults) {
            $ = new SpotInstanceRequestMetadataOptionsGetArgs(Objects.requireNonNull(defaults));
        }
