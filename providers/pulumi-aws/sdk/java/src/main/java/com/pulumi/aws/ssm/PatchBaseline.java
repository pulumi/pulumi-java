...
public class PatchBaseline extends CustomResource {
     ...
     */
    public PatchBaseline(String name, @Nullable PatchBaselineArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PatchBaseline(String name, Output<String> id, @Nullable PatchBaselineState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PatchBaseline get(String name, Output<String> id, @Nullable PatchBaselineState state, @Nullable CustomResourceOptions options) {
