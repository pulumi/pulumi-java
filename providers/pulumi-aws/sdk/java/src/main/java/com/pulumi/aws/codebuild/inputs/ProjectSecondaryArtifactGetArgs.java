...
public final class ProjectSecondaryArtifactGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ProjectSecondaryArtifactGetArgs(ProjectSecondaryArtifactGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectSecondaryArtifactGetArgs();
        }

        public Builder(ProjectSecondaryArtifactGetArgs defaults) {
            $ = new ProjectSecondaryArtifactGetArgs(Objects.requireNonNull(defaults));
        }
