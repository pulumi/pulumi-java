...
public class VoiceConnectorTermination extends CustomResource {
     ...
     */
    public VoiceConnectorTermination(String name, VoiceConnectorTerminationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VoiceConnectorTermination(String name, Output<String> id, @Nullable VoiceConnectorTerminationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VoiceConnectorTermination get(String name, Output<String> id, @Nullable VoiceConnectorTerminationState state, @Nullable CustomResourceOptions options) {
