...
public class EfsLocation extends CustomResource {
     ...
     */
    public EfsLocation(String name, EfsLocationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EfsLocation(String name, Output<String> id, @Nullable EfsLocationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EfsLocation get(String name, Output<String> id, @Nullable EfsLocationState state, @Nullable CustomResourceOptions options) {
