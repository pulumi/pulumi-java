...
public class HaproxyLayer extends CustomResource {
    /**
     ...
     */
    public HaproxyLayer(String name, HaproxyLayerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HaproxyLayer(String name, Output<String> id, @Nullable HaproxyLayerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HaproxyLayer get(String name, Output<String> id, @Nullable HaproxyLayerState state, @Nullable CustomResourceOptions options) {
