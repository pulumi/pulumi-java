...
public final class VirtualGatewaySpecListenerTlsValidationSubjectAlternativeNamesMatchArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private VirtualGatewaySpecListenerTlsValidationSubjectAlternativeNamesMatchArgs(VirtualGatewaySpecListenerTlsValidationSubjectAlternativeNamesMatchArgs $) {
        this.exacts = $.exacts;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualGatewaySpecListenerTlsValidationSubjectAlternativeNamesMatchArgs();
        }
