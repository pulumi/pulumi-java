...
public class DomainName extends CustomResource {
     ...
     */
    public DomainName(String name, DomainNameArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DomainName(String name, Output<String> id, @Nullable DomainNameState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DomainName get(String name, Output<String> id, @Nullable DomainNameState state, @Nullable CustomResourceOptions options) {
