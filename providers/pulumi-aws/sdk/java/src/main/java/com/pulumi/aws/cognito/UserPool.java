...
public class UserPool extends CustomResource {
    ...
    private UserPool(String name, Output<String> id, @Nullable UserPoolState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UserPool get(String name, Output<String> id, @Nullable UserPoolState state, @Nullable CustomResourceOptions options) {
