...
public final class ApplicationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Output<List<ApplicationAppSourceArgs>> appSources() {
    ...
    public Output<List<ApplicationEnvironmentArgs>> environments() {
    ...
    public Output<List<ApplicationSslConfigurationArgs>> sslConfigurations() {
