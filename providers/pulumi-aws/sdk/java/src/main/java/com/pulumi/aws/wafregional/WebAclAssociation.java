...
public class WebAclAssociation extends CustomResource {
    ...
    private WebAclAssociation(String name, Output<String> id, @Nullable WebAclAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAclAssociation get(String name, Output<String> id, @Nullable WebAclAssociationState state, @Nullable CustomResourceOptions options) {
