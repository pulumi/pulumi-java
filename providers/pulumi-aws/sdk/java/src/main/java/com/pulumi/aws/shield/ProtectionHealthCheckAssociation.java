...
public class ProtectionHealthCheckAssociation extends CustomResource {
     ...
     */
    public ProtectionHealthCheckAssociation(String name, ProtectionHealthCheckAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProtectionHealthCheckAssociation(String name, Output<String> id, @Nullable ProtectionHealthCheckAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProtectionHealthCheckAssociation get(String name, Output<String> id, @Nullable ProtectionHealthCheckAssociationState state, @Nullable CustomResourceOptions options) {
