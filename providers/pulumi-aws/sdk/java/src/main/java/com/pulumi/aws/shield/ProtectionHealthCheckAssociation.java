 ...
 *             .resourceArn(exampleEip.getId().apply(id -&gt; String.format(&#34;arn:%s:ec2:%s:%s:eip-allocation/%s&#34;, currentPartition.apply(getPartitionResult -&gt; getPartitionResult.getPartition()),currentRegion.apply(getRegionResult -&gt; getRegionResult.getName()),currentCallerIdentity.apply(getCallerIdentityResult -&gt; getCallerIdentityResult.getAccountId()),id)))
 *             .build());
 * 
 *         var exampleHealthCheck = new HealthCheck(&#34;exampleHealthCheck&#34;, HealthCheckArgs.builder()        
 *             .ipAddress(exampleEip.getPublicIp())
 *             .port(80)
 *             .type(&#34;HTTP&#34;)
 *             .resourcePath(&#34;/ready&#34;)
 *             .failureThreshold(&#34;3&#34;)
 ...
 *             .healthCheckArn(exampleHealthCheck.getArn())
 *             .shieldProtectionId(exampleProtection.getId())
 *             .build());
 * 
 *         }
 * }
