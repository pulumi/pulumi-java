...
public final class EbsFunctions {
     ...
     *             .encrypted(true)
     *             .kmsKeyId(current.apply(getDefaultKmsKeyResult -&gt; getDefaultKmsKeyResult.getKeyArn()))
     *             .build());
     * 
     *         }
     * }
