...
public class CachePolicy extends CustomResource {
    ...
    private CachePolicy(String name, Output<String> id, @Nullable CachePolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CachePolicy get(String name, Output<String> id, @Nullable CachePolicyState state, @Nullable CustomResourceOptions options) {
