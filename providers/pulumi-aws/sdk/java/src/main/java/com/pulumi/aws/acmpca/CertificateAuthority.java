...
public class CertificateAuthority extends CustomResource {
    ...
    private CertificateAuthority(String name, Output<String> id, @Nullable CertificateAuthorityState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CertificateAuthority get(String name, Output<String> id, @Nullable CertificateAuthorityState state, @Nullable CustomResourceOptions options) {
