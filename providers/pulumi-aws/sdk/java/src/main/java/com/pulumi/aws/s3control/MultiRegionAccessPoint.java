...
public class MultiRegionAccessPoint extends CustomResource {
    /**
     ...
     */
    public MultiRegionAccessPoint(String name, MultiRegionAccessPointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MultiRegionAccessPoint(String name, Output<String> id, @Nullable MultiRegionAccessPointState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MultiRegionAccessPoint get(String name, Output<String> id, @Nullable MultiRegionAccessPointState state, @Nullable CustomResourceOptions options) {
