...
public class LocationHdfs extends CustomResource {
     ...
     */
    public LocationHdfs(String name, LocationHdfsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LocationHdfs(String name, Output<String> id, @Nullable LocationHdfsState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LocationHdfs get(String name, Output<String> id, @Nullable LocationHdfsState state, @Nullable CustomResourceOptions options) {
