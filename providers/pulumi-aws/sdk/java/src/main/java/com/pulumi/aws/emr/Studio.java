...
public class Studio extends CustomResource {
    ...
    private Studio(String name, Output<String> id, @Nullable StudioState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Studio get(String name, Output<String> id, @Nullable StudioState state, @Nullable CustomResourceOptions options) {
