...
public final class InsightFiltersNetworkProtocolGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersNetworkProtocolGetArgs(InsightFiltersNetworkProtocolGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersNetworkProtocolGetArgs();
        }

        public Builder(InsightFiltersNetworkProtocolGetArgs defaults) {
            $ = new InsightFiltersNetworkProtocolGetArgs(Objects.requireNonNull(defaults));
        }
