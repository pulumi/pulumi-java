...
public class OrganizationManagedRule extends CustomResource {
     ...
     */
    public OrganizationManagedRule(String name, OrganizationManagedRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OrganizationManagedRule(String name, Output<String> id, @Nullable OrganizationManagedRuleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OrganizationManagedRule get(String name, Output<String> id, @Nullable OrganizationManagedRuleState state, @Nullable CustomResourceOptions options) {
