...
public class EventBus extends CustomResource {
    /**
     ...
     */
    public EventBus(String name, @Nullable EventBusArgs args, @Nullable CustomResourceOptions options) {
        super("aws:cloudwatch/eventBus:EventBus", name, args == null ? EventBusArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private EventBus(String name, Output<String> id, @Nullable EventBusState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EventBus get(String name, Output<String> id, @Nullable EventBusState state, @Nullable CustomResourceOptions options) {
