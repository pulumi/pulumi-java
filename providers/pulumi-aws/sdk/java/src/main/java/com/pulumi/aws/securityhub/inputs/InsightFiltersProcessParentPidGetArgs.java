...
public final class InsightFiltersProcessParentPidGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersProcessParentPidGetArgs(InsightFiltersProcessParentPidGetArgs $) {
        this.eq = $.eq;
        this.gte = $.gte;
        this.lte = $.lte;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersProcessParentPidGetArgs();
        }

        public Builder(InsightFiltersProcessParentPidGetArgs defaults) {
            $ = new InsightFiltersProcessParentPidGetArgs(Objects.requireNonNull(defaults));
        }
