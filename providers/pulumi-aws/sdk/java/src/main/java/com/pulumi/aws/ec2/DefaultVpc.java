...
public class DefaultVpc extends CustomResource {
    /**
     ...
     */
    public DefaultVpc(String name, @Nullable DefaultVpcArgs args, @Nullable CustomResourceOptions options) {
        super("aws:ec2/defaultVpc:DefaultVpc", name, args == null ? DefaultVpcArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DefaultVpc(String name, Output<String> id, @Nullable DefaultVpcState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DefaultVpc get(String name, Output<String> id, @Nullable DefaultVpcState state, @Nullable CustomResourceOptions options) {
