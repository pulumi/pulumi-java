...
public final class PatchBaselineSourceGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PatchBaselineSourceGetArgs(PatchBaselineSourceGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PatchBaselineSourceGetArgs();
        }

        public Builder(PatchBaselineSourceGetArgs defaults) {
            $ = new PatchBaselineSourceGetArgs(Objects.requireNonNull(defaults));
        }
