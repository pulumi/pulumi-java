...
public class RecoveryGroup extends CustomResource {
    /**
     ...
     */
    public RecoveryGroup(String name, RecoveryGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RecoveryGroup(String name, Output<String> id, @Nullable RecoveryGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RecoveryGroup get(String name, Output<String> id, @Nullable RecoveryGroupState state, @Nullable CustomResourceOptions options) {
