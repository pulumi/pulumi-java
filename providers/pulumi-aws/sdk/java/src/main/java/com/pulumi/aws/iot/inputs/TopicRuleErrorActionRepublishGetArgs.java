...
public final class TopicRuleErrorActionRepublishGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TopicRuleErrorActionRepublishGetArgs(TopicRuleErrorActionRepublishGetArgs $) {
        this.qos = $.qos;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TopicRuleErrorActionRepublishGetArgs();
        }

        public Builder(TopicRuleErrorActionRepublishGetArgs defaults) {
            $ = new TopicRuleErrorActionRepublishGetArgs(Objects.requireNonNull(defaults));
        }
