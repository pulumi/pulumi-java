...
public final class WebAclRuleStatementLabelMatchStatementGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WebAclRuleStatementLabelMatchStatementGetArgs(WebAclRuleStatementLabelMatchStatementGetArgs $) {
        this.key = $.key;
        this.scope = $.scope;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementLabelMatchStatementGetArgs();
        }

        public Builder(WebAclRuleStatementLabelMatchStatementGetArgs defaults) {
            $ = new WebAclRuleStatementLabelMatchStatementGetArgs(Objects.requireNonNull(defaults));
        }
