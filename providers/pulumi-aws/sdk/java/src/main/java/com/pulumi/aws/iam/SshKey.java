...
public class SshKey extends CustomResource {
     ...
     */
    public SshKey(String name, SshKeyArgs args, @Nullable CustomResourceOptions options) {
        super("aws:iam/sshKey:SshKey", name, args == null ? SshKeyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SshKey(String name, Output<String> id, @Nullable SshKeyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SshKey get(String name, Output<String> id, @Nullable SshKeyState state, @Nullable CustomResourceOptions options) {
