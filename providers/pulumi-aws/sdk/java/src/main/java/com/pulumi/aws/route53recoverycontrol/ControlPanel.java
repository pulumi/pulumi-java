...
public class ControlPanel extends CustomResource {
     ...
     */
    public ControlPanel(String name, ControlPanelArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ControlPanel(String name, Output<String> id, @Nullable ControlPanelState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ControlPanel get(String name, Output<String> id, @Nullable ControlPanelState state, @Nullable CustomResourceOptions options) {
