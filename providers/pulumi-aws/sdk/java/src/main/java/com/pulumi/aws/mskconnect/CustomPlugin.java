...
public class CustomPlugin extends CustomResource {
    /**
     ...
     */
    public CustomPlugin(String name, CustomPluginArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CustomPlugin(String name, Output<String> id, @Nullable CustomPluginState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomPlugin get(String name, Output<String> id, @Nullable CustomPluginState state, @Nullable CustomResourceOptions options) {
