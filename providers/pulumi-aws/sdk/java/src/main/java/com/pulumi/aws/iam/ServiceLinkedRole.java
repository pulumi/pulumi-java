...
public class ServiceLinkedRole extends CustomResource {
    /**
     ...
     */
    public ServiceLinkedRole(String name, ServiceLinkedRoleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceLinkedRole(String name, Output<String> id, @Nullable ServiceLinkedRoleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceLinkedRole get(String name, Output<String> id, @Nullable ServiceLinkedRoleState state, @Nullable CustomResourceOptions options) {
