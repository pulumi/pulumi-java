...
public final class RestApiEndpointConfigurationGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return A list of endpoint types. This resource currently only supports managing a single value. Valid values: `EDGE`, `REGIONAL` or `PRIVATE`. If unspecified, defaults to `EDGE`. Must be declared as `REGIONAL` in non-Commercial partitions. Refer to the [documentation](https://docs.aws.amazon.com/apigateway/latest/developerguide/create-regional-api.html) for more information on the difference between edge-optimized and regional APIs.
     * 
     */
    ...
    private RestApiEndpointConfigurationGetArgs(RestApiEndpointConfigurationGetArgs $) {
        this.types = $.types;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RestApiEndpointConfigurationGetArgs();
        }

        public Builder(RestApiEndpointConfigurationGetArgs defaults) {
            $ = new RestApiEndpointConfigurationGetArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param types A list of endpoint types. This resource currently only supports managing a single value. Valid values: `EDGE`, `REGIONAL` or `PRIVATE`. If unspecified, defaults to `EDGE`. Must be declared as `REGIONAL` in non-Commercial partitions. Refer to the [documentation](https://docs.aws.amazon.com/apigateway/latest/developerguide/create-regional-api.html) for more information on the difference between edge-optimized and regional APIs.
         * 
         * @return builder
         * 
         */
