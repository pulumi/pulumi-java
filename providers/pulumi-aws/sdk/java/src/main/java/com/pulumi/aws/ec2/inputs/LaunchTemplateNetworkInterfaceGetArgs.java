...
public final class LaunchTemplateNetworkInterfaceGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private LaunchTemplateNetworkInterfaceGetArgs(LaunchTemplateNetworkInterfaceGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LaunchTemplateNetworkInterfaceGetArgs();
        }

        public Builder(LaunchTemplateNetworkInterfaceGetArgs defaults) {
            $ = new LaunchTemplateNetworkInterfaceGetArgs(Objects.requireNonNull(defaults));
        }
