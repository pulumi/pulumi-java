...
public final class PipelineThumbnailConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PipelineThumbnailConfigGetArgs(PipelineThumbnailConfigGetArgs $) {
        this.bucket = $.bucket;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PipelineThumbnailConfigGetArgs();
        }

        public Builder(PipelineThumbnailConfigGetArgs defaults) {
            $ = new PipelineThumbnailConfigGetArgs(Objects.requireNonNull(defaults));
        }
