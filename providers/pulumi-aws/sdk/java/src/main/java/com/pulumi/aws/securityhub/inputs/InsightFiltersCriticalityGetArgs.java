...
public final class InsightFiltersCriticalityGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final InsightFiltersCriticalityGetArgs Empty = new InsightFiltersCriticalityGetArgs();
    ...
    private InsightFiltersCriticalityGetArgs(InsightFiltersCriticalityGetArgs $) {
        this.eq = $.eq;
        this.gte = $.gte;
        this.lte = $.lte;
    }
    ...
    public static Builder builder(InsightFiltersCriticalityGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersCriticalityGetArgs();
        }

        public Builder(InsightFiltersCriticalityGetArgs defaults) {
            $ = new InsightFiltersCriticalityGetArgs(Objects.requireNonNull(defaults));
        }
