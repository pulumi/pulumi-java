...
public final class PatchBaselineApprovalRulePatchFilterGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PatchBaselineApprovalRulePatchFilterGetArgs(PatchBaselineApprovalRulePatchFilterGetArgs $) {
        this.key = $.key;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PatchBaselineApprovalRulePatchFilterGetArgs();
        }

        public Builder(PatchBaselineApprovalRulePatchFilterGetArgs defaults) {
            $ = new PatchBaselineApprovalRulePatchFilterGetArgs(Objects.requireNonNull(defaults));
        }
