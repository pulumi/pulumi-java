...
public final class InstanceFleetInstanceTypeConfigConfigurationGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceFleetInstanceTypeConfigConfigurationGetArgs(InstanceFleetInstanceTypeConfigConfigurationGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceFleetInstanceTypeConfigConfigurationGetArgs();
        }

        public Builder(InstanceFleetInstanceTypeConfigConfigurationGetArgs defaults) {
            $ = new InstanceFleetInstanceTypeConfigConfigurationGetArgs(Objects.requireNonNull(defaults));
        }
