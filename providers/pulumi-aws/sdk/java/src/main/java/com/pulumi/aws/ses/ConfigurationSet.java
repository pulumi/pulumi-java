...
public class ConfigurationSet extends CustomResource {
    ...
    private ConfigurationSet(String name, Output<String> id, @Nullable ConfigurationSetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConfigurationSet get(String name, Output<String> id, @Nullable ConfigurationSetState state, @Nullable CustomResourceOptions options) {
