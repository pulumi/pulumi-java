...
public class AlternativeContact extends CustomResource {
     ...
     */
    public AlternativeContact(String name, AlternativeContactArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AlternativeContact(String name, Output<String> id, @Nullable AlternativeContactState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AlternativeContact get(String name, Output<String> id, @Nullable AlternativeContactState state, @Nullable CustomResourceOptions options) {
