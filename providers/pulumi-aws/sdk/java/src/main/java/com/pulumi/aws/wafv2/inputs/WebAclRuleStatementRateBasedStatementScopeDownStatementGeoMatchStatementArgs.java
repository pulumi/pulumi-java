...
public final class WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementArgs extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="forwardedIpConfig")
      private final @Nullable Output<WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementForwardedIpConfigArgs> forwardedIpConfig;

    public Output<WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementForwardedIpConfigArgs> getForwardedIpConfig() {
    ...
    public WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementArgs(
        ...
        @Nullable Output<WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementForwardedIpConfigArgs> forwardedIpConfig) {
    ...
    public static final class Builder {
        ...
        public Builder forwardedIpConfig(@Nullable WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementForwardedIpConfigArgs forwardedIpConfig) {
            ...
            return new WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementArgs(countryCodes, forwardedIpConfig);
        }
    }
}
