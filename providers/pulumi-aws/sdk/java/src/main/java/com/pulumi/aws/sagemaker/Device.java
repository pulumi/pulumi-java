...
public class Device extends CustomResource {
    ...
    private Device(String name, Output<String> id, @Nullable DeviceState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Device get(String name, Output<String> id, @Nullable DeviceState state, @Nullable CustomResourceOptions options) {
