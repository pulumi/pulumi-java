...
public final class InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs(InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs $) {
        this.unit = $.unit;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs();
        }

        public Builder(InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs defaults) {
            $ = new InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs(Objects.requireNonNull(defaults));
        }
