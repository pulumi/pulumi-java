...
public final class StaticWebLayerEbsVolumeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private StaticWebLayerEbsVolumeArgs(StaticWebLayerEbsVolumeArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StaticWebLayerEbsVolumeArgs();
        }

        public Builder(StaticWebLayerEbsVolumeArgs defaults) {
            $ = new StaticWebLayerEbsVolumeArgs(Objects.requireNonNull(defaults));
        }
