...
public class ApiMapping extends CustomResource {
    /**
     * The API identifier.
     * 
     */
     ...
     */
    public ApiMapping(String name, ApiMappingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApiMapping(String name, Output<String> id, @Nullable ApiMappingState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApiMapping get(String name, Output<String> id, @Nullable ApiMappingState state, @Nullable CustomResourceOptions options) {
