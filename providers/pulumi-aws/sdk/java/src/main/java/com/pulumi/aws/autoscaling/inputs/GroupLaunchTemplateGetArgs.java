...
public final class GroupLaunchTemplateGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GroupLaunchTemplateGetArgs(GroupLaunchTemplateGetArgs $) {
        this.id = $.id;
        this.name = $.name;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupLaunchTemplateGetArgs();
        }

        public Builder(GroupLaunchTemplateGetArgs defaults) {
            $ = new GroupLaunchTemplateGetArgs(Objects.requireNonNull(defaults));
        }
