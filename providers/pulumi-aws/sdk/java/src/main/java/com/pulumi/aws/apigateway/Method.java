...
public class Method extends CustomResource {
     ...
     */
    public Method(String name, MethodArgs args, @Nullable CustomResourceOptions options) {
        super("aws:apigateway/method:Method", name, args == null ? MethodArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Method(String name, Output<String> id, @Nullable MethodState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Method get(String name, Output<String> id, @Nullable MethodState state, @Nullable CustomResourceOptions options) {
