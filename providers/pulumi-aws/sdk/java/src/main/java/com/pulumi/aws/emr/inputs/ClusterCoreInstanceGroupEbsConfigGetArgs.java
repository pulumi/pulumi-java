...
public final class ClusterCoreInstanceGroupEbsConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterCoreInstanceGroupEbsConfigGetArgs(ClusterCoreInstanceGroupEbsConfigGetArgs $) {
        this.iops = $.iops;
        this.size = $.size;
        this.type = $.type;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterCoreInstanceGroupEbsConfigGetArgs();
        }

        public Builder(ClusterCoreInstanceGroupEbsConfigGetArgs defaults) {
            $ = new ClusterCoreInstanceGroupEbsConfigGetArgs(Objects.requireNonNull(defaults));
        }
