...
public class LifecycleHook extends CustomResource {
    ...
    private LifecycleHook(String name, Output<String> id, @Nullable LifecycleHookState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LifecycleHook get(String name, Output<String> id, @Nullable LifecycleHookState state, @Nullable CustomResourceOptions options) {
