...
public final class TableAttributeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TableAttributeGetArgs(TableAttributeGetArgs $) {
        this.name = $.name;
        this.type = $.type;
    }
