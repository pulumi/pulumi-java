...
public final class ServiceSourceConfigurationCodeRepositoryCodeConfigurationCodeConfigurationValuesGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServiceSourceConfigurationCodeRepositoryCodeConfigurationCodeConfigurationValuesGetArgs(ServiceSourceConfigurationCodeRepositoryCodeConfigurationCodeConfigurationValuesGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceSourceConfigurationCodeRepositoryCodeConfigurationCodeConfigurationValuesGetArgs();
        }

        public Builder(ServiceSourceConfigurationCodeRepositoryCodeConfigurationCodeConfigurationValuesGetArgs defaults) {
            $ = new ServiceSourceConfigurationCodeRepositoryCodeConfigurationCodeConfigurationValuesGetArgs(Objects.requireNonNull(defaults));
        }
