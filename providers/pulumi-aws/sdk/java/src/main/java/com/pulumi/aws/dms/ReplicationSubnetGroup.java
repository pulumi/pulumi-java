...
public class ReplicationSubnetGroup extends CustomResource {
     ...
     */
    public ReplicationSubnetGroup(String name, ReplicationSubnetGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReplicationSubnetGroup(String name, Output<String> id, @Nullable ReplicationSubnetGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReplicationSubnetGroup get(String name, Output<String> id, @Nullable ReplicationSubnetGroupState state, @Nullable CustomResourceOptions options) {
