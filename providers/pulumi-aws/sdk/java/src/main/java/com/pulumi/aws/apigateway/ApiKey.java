...
public class ApiKey extends CustomResource {
     ...
     */
    public ApiKey(String name, @Nullable ApiKeyArgs args, @Nullable CustomResourceOptions options) {
        super("aws:apigateway/apiKey:ApiKey", name, args == null ? ApiKeyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ApiKey(String name, Output<String> id, @Nullable ApiKeyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApiKey get(String name, Output<String> id, @Nullable ApiKeyState state, @Nullable CustomResourceOptions options) {
