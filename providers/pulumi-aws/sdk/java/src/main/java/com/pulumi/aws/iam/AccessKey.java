...
public class AccessKey extends CustomResource {
    ...
    private AccessKey(String name, Output<String> id, @Nullable AccessKeyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AccessKey get(String name, Output<String> id, @Nullable AccessKeyState state, @Nullable CustomResourceOptions options) {
