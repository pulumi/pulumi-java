...
public final class DeploymentGroupDeploymentStyleGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DeploymentGroupDeploymentStyleGetArgs(DeploymentGroupDeploymentStyleGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeploymentGroupDeploymentStyleGetArgs();
        }

        public Builder(DeploymentGroupDeploymentStyleGetArgs defaults) {
            $ = new DeploymentGroupDeploymentStyleGetArgs(Objects.requireNonNull(defaults));
        }
