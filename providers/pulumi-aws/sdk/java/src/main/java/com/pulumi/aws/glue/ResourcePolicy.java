 ...
 *                 .resources(String.format(&#34;arn:%s:glue:%s:%s:*&#34;, currentPartition.apply(getPartitionResult -&gt; getPartitionResult.getPartition()),currentRegion.apply(getRegionResult -&gt; getRegionResult.getName()),currentCallerIdentity.apply(getCallerIdentityResult -&gt; getCallerIdentityResult.getAccountId())))
 ...
 *             .policy(glue_example_policy.getJson())
 *             .build());
 * 
 *         }
 * }
