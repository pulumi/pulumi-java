...
public class ClassificationJob extends CustomResource {
    /**
     ...
     */
    public ClassificationJob(String name, ClassificationJobArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ClassificationJob(String name, Output<String> id, @Nullable ClassificationJobState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ClassificationJob get(String name, Output<String> id, @Nullable ClassificationJobState state, @Nullable CustomResourceOptions options) {
