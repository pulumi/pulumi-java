...
public final class GetBrokerArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private Output</* @Nullable */ String> brokerId;

    /**
     * @return The unique id of the mq broker.
     * 
     */
    public Output</* @Nullable */ String> brokerId() {
    ...
    private Output</* @Nullable */ String> brokerName;

    /**
     * @return The unique name of the mq broker.
     * 
     */
    public Output</* @Nullable */ String> brokerName() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder brokerId(Output</* @Nullable */ String> brokerId) {
            $.brokerId = brokerId;
            return this;
        }
         ...
         * 
         */
        public Builder brokerName(Output</* @Nullable */ String> brokerName) {
