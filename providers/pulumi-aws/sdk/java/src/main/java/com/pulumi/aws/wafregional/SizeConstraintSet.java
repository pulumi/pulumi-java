...
public class SizeConstraintSet extends CustomResource {
     ...
     */
    public SizeConstraintSet(String name, @Nullable SizeConstraintSetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SizeConstraintSet(String name, Output<String> id, @Nullable SizeConstraintSetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SizeConstraintSet get(String name, Output<String> id, @Nullable SizeConstraintSetState state, @Nullable CustomResourceOptions options) {
