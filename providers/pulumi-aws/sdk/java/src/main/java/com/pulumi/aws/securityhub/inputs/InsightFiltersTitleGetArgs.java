...
public final class InsightFiltersTitleGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final InsightFiltersTitleGetArgs Empty = new InsightFiltersTitleGetArgs();
    ...
    private InsightFiltersTitleGetArgs() {}

    private InsightFiltersTitleGetArgs(InsightFiltersTitleGetArgs $) {
    ...
    public static Builder builder(InsightFiltersTitleGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersTitleGetArgs();
        }

        public Builder(InsightFiltersTitleGetArgs defaults) {
            $ = new InsightFiltersTitleGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InsightFiltersTitleGetArgs build() {
