...
public class VoiceConnector extends CustomResource {
    /**
     ...
     */
    public VoiceConnector(String name, VoiceConnectorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VoiceConnector(String name, Output<String> id, @Nullable VoiceConnectorState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VoiceConnector get(String name, Output<String> id, @Nullable VoiceConnectorState state, @Nullable CustomResourceOptions options) {
