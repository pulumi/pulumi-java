...
public class ReceiptRuleSet extends CustomResource {
     ...
     */
    public ReceiptRuleSet(String name, ReceiptRuleSetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReceiptRuleSet(String name, Output<String> id, @Nullable ReceiptRuleSetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReceiptRuleSet get(String name, Output<String> id, @Nullable ReceiptRuleSetState state, @Nullable CustomResourceOptions options) {
