...
public class SnapshotCopy extends CustomResource {
     ...
     */
    public SnapshotCopy(String name, SnapshotCopyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SnapshotCopy(String name, Output<String> id, @Nullable SnapshotCopyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SnapshotCopy get(String name, Output<String> id, @Nullable SnapshotCopyState state, @Nullable CustomResourceOptions options) {
