...
public class TrafficMirrorSession extends CustomResource {
    /**
     ...
     */
    public TrafficMirrorSession(String name, TrafficMirrorSessionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TrafficMirrorSession(String name, Output<String> id, @Nullable TrafficMirrorSessionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TrafficMirrorSession get(String name, Output<String> id, @Nullable TrafficMirrorSessionState state, @Nullable CustomResourceOptions options) {
