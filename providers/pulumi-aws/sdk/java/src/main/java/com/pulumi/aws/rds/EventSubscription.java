...
public class EventSubscription extends CustomResource {
     ...
     */
    public EventSubscription(String name, EventSubscriptionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EventSubscription(String name, Output<String> id, @Nullable EventSubscriptionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EventSubscription get(String name, Output<String> id, @Nullable EventSubscriptionState state, @Nullable CustomResourceOptions options) {
