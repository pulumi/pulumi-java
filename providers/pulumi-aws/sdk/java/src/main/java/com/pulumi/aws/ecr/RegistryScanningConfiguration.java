...
public class RegistryScanningConfiguration extends CustomResource {
     ...
     */
    public RegistryScanningConfiguration(String name, RegistryScanningConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegistryScanningConfiguration(String name, Output<String> id, @Nullable RegistryScanningConfigurationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegistryScanningConfiguration get(String name, Output<String> id, @Nullable RegistryScanningConfigurationState state, @Nullable CustomResourceOptions options) {
