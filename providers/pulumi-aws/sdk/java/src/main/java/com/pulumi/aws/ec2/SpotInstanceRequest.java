...
public class SpotInstanceRequest extends CustomResource {
    /**
     ...
     */
    public SpotInstanceRequest(String name, @Nullable SpotInstanceRequestArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SpotInstanceRequest(String name, Output<String> id, @Nullable SpotInstanceRequestState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SpotInstanceRequest get(String name, Output<String> id, @Nullable SpotInstanceRequestState state, @Nullable CustomResourceOptions options) {
