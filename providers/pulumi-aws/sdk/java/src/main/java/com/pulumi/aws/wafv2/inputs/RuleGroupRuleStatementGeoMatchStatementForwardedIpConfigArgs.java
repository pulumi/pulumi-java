...
public final class RuleGroupRuleStatementGeoMatchStatementForwardedIpConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RuleGroupRuleStatementGeoMatchStatementForwardedIpConfigArgs(RuleGroupRuleStatementGeoMatchStatementForwardedIpConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupRuleStatementGeoMatchStatementForwardedIpConfigArgs();
        }

        public Builder(RuleGroupRuleStatementGeoMatchStatementForwardedIpConfigArgs defaults) {
            $ = new RuleGroupRuleStatementGeoMatchStatementForwardedIpConfigArgs(Objects.requireNonNull(defaults));
        }
