...
public class LayerVersion extends CustomResource {
     ...
     */
    public LayerVersion(String name, LayerVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LayerVersion(String name, Output<String> id, @Nullable LayerVersionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LayerVersion get(String name, Output<String> id, @Nullable LayerVersionState state, @Nullable CustomResourceOptions options) {
