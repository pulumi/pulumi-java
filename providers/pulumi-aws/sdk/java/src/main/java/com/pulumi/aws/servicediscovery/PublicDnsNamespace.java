...
public class PublicDnsNamespace extends CustomResource {
    /**
     ...
     */
    public PublicDnsNamespace(String name, @Nullable PublicDnsNamespaceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PublicDnsNamespace(String name, Output<String> id, @Nullable PublicDnsNamespaceState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PublicDnsNamespace get(String name, Output<String> id, @Nullable PublicDnsNamespaceState state, @Nullable CustomResourceOptions options) {
