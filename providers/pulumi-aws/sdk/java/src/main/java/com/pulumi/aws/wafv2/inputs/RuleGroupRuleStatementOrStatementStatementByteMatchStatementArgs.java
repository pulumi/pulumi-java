...
public final class RuleGroupRuleStatementOrStatementStatementByteMatchStatementArgs extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="fieldToMatch")
      private final @Nullable Output<RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchArgs> fieldToMatch;

    public Output<RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchArgs> getFieldToMatch() {
    ...
    @Import(name="textTransformations", required=true)
      private final Output<List<RuleGroupRuleStatementOrStatementStatementByteMatchStatementTextTransformationArgs>> textTransformations;

    public Output<List<RuleGroupRuleStatementOrStatementStatementByteMatchStatementTextTransformationArgs>> getTextTransformations() {
        return this.textTransformations;
    }

    public RuleGroupRuleStatementOrStatementStatementByteMatchStatementArgs(
        @Nullable Output<RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchArgs> fieldToMatch,
        Output<String> positionalConstraint,
        Output<String> searchString,
        Output<List<RuleGroupRuleStatementOrStatementStatementByteMatchStatementTextTransformationArgs>> textTransformations) {
    ...
    public static final class Builder {
        ...
        public Builder fieldToMatch(@Nullable RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchArgs fieldToMatch) {
        ...
        public Builder textTransformations(RuleGroupRuleStatementOrStatementStatementByteMatchStatementTextTransformationArgs... textTransformations) {
            ...
            return new RuleGroupRuleStatementOrStatementStatementByteMatchStatementArgs(fieldToMatch, positionalConstraint, searchString, textTransformations);
        }
    }
}
