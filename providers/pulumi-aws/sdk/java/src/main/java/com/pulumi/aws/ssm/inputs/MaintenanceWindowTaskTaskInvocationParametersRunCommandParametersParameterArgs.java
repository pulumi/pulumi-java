...
public final class MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersParameterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersParameterArgs(MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersParameterArgs $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersParameterArgs();
        }

        public Builder(MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersParameterArgs defaults) {
            $ = new MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersParameterArgs(Objects.requireNonNull(defaults));
        }
