...
public class DistributionConfiguration extends CustomResource {
    /**
     ...
     */
    public DistributionConfiguration(String name, DistributionConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DistributionConfiguration(String name, Output<String> id, @Nullable DistributionConfigurationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DistributionConfiguration get(String name, Output<String> id, @Nullable DistributionConfigurationState state, @Nullable CustomResourceOptions options) {
