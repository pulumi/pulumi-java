...
public class StudioLifecycleConfig extends CustomResource {
    /**
     ...
     */
    public StudioLifecycleConfig(String name, StudioLifecycleConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StudioLifecycleConfig(String name, Output<String> id, @Nullable StudioLifecycleConfigState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StudioLifecycleConfig get(String name, Output<String> id, @Nullable StudioLifecycleConfigState state, @Nullable CustomResourceOptions options) {
