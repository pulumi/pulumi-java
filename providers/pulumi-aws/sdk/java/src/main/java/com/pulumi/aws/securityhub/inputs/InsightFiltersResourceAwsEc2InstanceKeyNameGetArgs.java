...
public final class InsightFiltersResourceAwsEc2InstanceKeyNameGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersResourceAwsEc2InstanceKeyNameGetArgs(InsightFiltersResourceAwsEc2InstanceKeyNameGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersResourceAwsEc2InstanceKeyNameGetArgs();
        }

        public Builder(InsightFiltersResourceAwsEc2InstanceKeyNameGetArgs defaults) {
            $ = new InsightFiltersResourceAwsEc2InstanceKeyNameGetArgs(Objects.requireNonNull(defaults));
        }
