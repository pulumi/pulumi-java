...
public class PartitionIndex extends CustomResource {
     ...
     */
    public PartitionIndex(String name, PartitionIndexArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PartitionIndex(String name, Output<String> id, @Nullable PartitionIndexState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PartitionIndex get(String name, Output<String> id, @Nullable PartitionIndexState state, @Nullable CustomResourceOptions options) {
