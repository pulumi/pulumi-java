...
public class Constraint extends CustomResource {
     ...
     */
    public Constraint(String name, ConstraintArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Constraint(String name, Output<String> id, @Nullable ConstraintState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Constraint get(String name, Output<String> id, @Nullable ConstraintState state, @Nullable CustomResourceOptions options) {
