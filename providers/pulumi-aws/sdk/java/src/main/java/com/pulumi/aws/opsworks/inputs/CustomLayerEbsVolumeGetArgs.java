...
public final class CustomLayerEbsVolumeGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final CustomLayerEbsVolumeGetArgs Empty = new CustomLayerEbsVolumeGetArgs();
    ...
    private CustomLayerEbsVolumeGetArgs(CustomLayerEbsVolumeGetArgs $) {
    ...
    public static Builder builder(CustomLayerEbsVolumeGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CustomLayerEbsVolumeGetArgs();
        }

        public Builder(CustomLayerEbsVolumeGetArgs defaults) {
            $ = new CustomLayerEbsVolumeGetArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param encrypted Encrypt the volume.
         * 
         * @return builder
         * 
         */
