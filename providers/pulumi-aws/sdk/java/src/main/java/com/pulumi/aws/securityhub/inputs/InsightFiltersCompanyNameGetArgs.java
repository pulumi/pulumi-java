...
public final class InsightFiltersCompanyNameGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersCompanyNameGetArgs(InsightFiltersCompanyNameGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersCompanyNameGetArgs();
        }

        public Builder(InsightFiltersCompanyNameGetArgs defaults) {
            $ = new InsightFiltersCompanyNameGetArgs(Objects.requireNonNull(defaults));
        }
