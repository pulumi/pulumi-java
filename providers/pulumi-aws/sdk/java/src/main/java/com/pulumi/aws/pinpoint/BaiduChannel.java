...
public class BaiduChannel extends CustomResource {
     ...
     */
    public BaiduChannel(String name, BaiduChannelArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BaiduChannel(String name, Output<String> id, @Nullable BaiduChannelState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BaiduChannel get(String name, Output<String> id, @Nullable BaiduChannelState state, @Nullable CustomResourceOptions options) {
