...
public class BucketPolicy extends CustomResource {
    ...
    private BucketPolicy(String name, Output<String> id, @Nullable BucketPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BucketPolicy get(String name, Output<String> id, @Nullable BucketPolicyState state, @Nullable CustomResourceOptions options) {
