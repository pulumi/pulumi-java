...
public final class ConfgurationSetState extends com.pulumi.resources.ResourceArgs {
    ...
    private ConfgurationSetState(ConfgurationSetState $) {
        this.arn = $.arn;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConfgurationSetState();
        }

        public Builder(ConfgurationSetState defaults) {
            $ = new ConfgurationSetState(Objects.requireNonNull(defaults));
        }
