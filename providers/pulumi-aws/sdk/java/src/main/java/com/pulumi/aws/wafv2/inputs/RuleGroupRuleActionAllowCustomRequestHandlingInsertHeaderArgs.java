...
public final class RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderArgs(
        Output<String> name,
        Output<String> value) {
    ...
    public static final class Builder {
        ...
        public Builder value(String value) {
            ...
            return new RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderArgs(name, value);
        }
    }
}
