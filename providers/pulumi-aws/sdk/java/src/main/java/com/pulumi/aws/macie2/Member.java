...
public class Member extends CustomResource {
     ...
     */
    public Member(String name, MemberArgs args, @Nullable CustomResourceOptions options) {
        super("aws:macie2/member:Member", name, args == null ? MemberArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Member(String name, Output<String> id, @Nullable MemberState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Member get(String name, Output<String> id, @Nullable MemberState state, @Nullable CustomResourceOptions options) {
