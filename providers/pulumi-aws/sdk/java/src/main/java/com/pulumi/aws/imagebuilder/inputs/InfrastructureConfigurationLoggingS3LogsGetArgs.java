...
public final class InfrastructureConfigurationLoggingS3LogsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InfrastructureConfigurationLoggingS3LogsGetArgs(InfrastructureConfigurationLoggingS3LogsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InfrastructureConfigurationLoggingS3LogsGetArgs();
        }

        public Builder(InfrastructureConfigurationLoggingS3LogsGetArgs defaults) {
            $ = new InfrastructureConfigurationLoggingS3LogsGetArgs(Objects.requireNonNull(defaults));
        }
