...
public class VpcEndpointService extends CustomResource {
     ...
     */
    public VpcEndpointService(String name, VpcEndpointServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VpcEndpointService(String name, Output<String> id, @Nullable VpcEndpointServiceState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpcEndpointService get(String name, Output<String> id, @Nullable VpcEndpointServiceState state, @Nullable CustomResourceOptions options) {
