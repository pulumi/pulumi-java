...
public final class FirehoseDeliveryStreamHttpEndpointConfigurationCloudwatchLoggingOptionsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FirehoseDeliveryStreamHttpEndpointConfigurationCloudwatchLoggingOptionsGetArgs(FirehoseDeliveryStreamHttpEndpointConfigurationCloudwatchLoggingOptionsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirehoseDeliveryStreamHttpEndpointConfigurationCloudwatchLoggingOptionsGetArgs();
        }

        public Builder(FirehoseDeliveryStreamHttpEndpointConfigurationCloudwatchLoggingOptionsGetArgs defaults) {
            $ = new FirehoseDeliveryStreamHttpEndpointConfigurationCloudwatchLoggingOptionsGetArgs(Objects.requireNonNull(defaults));
        }
