...
public class S3Location extends CustomResource {
     ...
     */
    public S3Location(String name, S3LocationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private S3Location(String name, Output<String> id, @Nullable S3LocationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static S3Location get(String name, Output<String> id, @Nullable S3LocationState state, @Nullable CustomResourceOptions options) {
