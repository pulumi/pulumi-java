...
public final class VirtualRouterArgs extends ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param meshName The name of the service mesh in which to create the virtual router. Must be between 1 and 255 characters in length.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param name The name to use for the virtual router. Must be between 1 and 255 characters in length.
         * 
         * @return builder
         * 
         */
