...
public class Task extends CustomResource {
    ...
    private Task(String name, Output<String> id, @Nullable TaskState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Task get(String name, Output<String> id, @Nullable TaskState state, @Nullable CustomResourceOptions options) {
