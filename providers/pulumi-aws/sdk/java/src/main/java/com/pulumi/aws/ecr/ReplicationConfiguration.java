...
public class ReplicationConfiguration extends CustomResource {
     ...
     */
    public ReplicationConfiguration(String name, @Nullable ReplicationConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReplicationConfiguration(String name, Output<String> id, @Nullable ReplicationConfigurationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReplicationConfiguration get(String name, Output<String> id, @Nullable ReplicationConfigurationState state, @Nullable CustomResourceOptions options) {
