...
public final class MysqlLayerCloudwatchConfigurationLogStreamArgs extends ResourceArgs {
    ...
    private MysqlLayerCloudwatchConfigurationLogStreamArgs(MysqlLayerCloudwatchConfigurationLogStreamArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MysqlLayerCloudwatchConfigurationLogStreamArgs();
        }

        public Builder(MysqlLayerCloudwatchConfigurationLogStreamArgs defaults) {
            $ = new MysqlLayerCloudwatchConfigurationLogStreamArgs(Objects.requireNonNull(defaults));
        }
