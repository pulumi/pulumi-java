...
public final class RateBasedRulePredicateGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RateBasedRulePredicateGetArgs(RateBasedRulePredicateGetArgs $) {
        this.dataId = $.dataId;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RateBasedRulePredicateGetArgs();
        }

        public Builder(RateBasedRulePredicateGetArgs defaults) {
            $ = new RateBasedRulePredicateGetArgs(Objects.requireNonNull(defaults));
        }
