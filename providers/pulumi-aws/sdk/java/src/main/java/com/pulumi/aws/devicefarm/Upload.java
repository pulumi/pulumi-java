...
public class Upload extends CustomResource {
     ...
     */
    public Upload(String name, UploadArgs args, @Nullable CustomResourceOptions options) {
        super("aws:devicefarm/upload:Upload", name, args == null ? UploadArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Upload(String name, Output<String> id, @Nullable UploadState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Upload get(String name, Output<String> id, @Nullable UploadState state, @Nullable CustomResourceOptions options) {
