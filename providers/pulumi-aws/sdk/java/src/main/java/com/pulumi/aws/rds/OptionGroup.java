...
public class OptionGroup extends CustomResource {
    /**
     ...
     */
    public OptionGroup(String name, OptionGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OptionGroup(String name, Output<String> id, @Nullable OptionGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OptionGroup get(String name, Output<String> id, @Nullable OptionGroupState state, @Nullable CustomResourceOptions options) {
