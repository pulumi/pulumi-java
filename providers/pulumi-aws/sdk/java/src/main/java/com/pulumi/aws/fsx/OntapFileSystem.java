...
public class OntapFileSystem extends CustomResource {
     ...
     */
    public OntapFileSystem(String name, OntapFileSystemArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OntapFileSystem(String name, Output<String> id, @Nullable OntapFileSystemState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OntapFileSystem get(String name, Output<String> id, @Nullable OntapFileSystemState state, @Nullable CustomResourceOptions options) {
