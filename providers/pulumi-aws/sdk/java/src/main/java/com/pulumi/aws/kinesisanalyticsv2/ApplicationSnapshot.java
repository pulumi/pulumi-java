...
public class ApplicationSnapshot extends CustomResource {
     ...
     */
    public ApplicationSnapshot(String name, ApplicationSnapshotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApplicationSnapshot(String name, Output<String> id, @Nullable ApplicationSnapshotState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApplicationSnapshot get(String name, Output<String> id, @Nullable ApplicationSnapshotState state, @Nullable CustomResourceOptions options) {
