...
public class AssessmentTemplate extends CustomResource {
     ...
     */
    public AssessmentTemplate(String name, AssessmentTemplateArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AssessmentTemplate(String name, Output<String> id, @Nullable AssessmentTemplateState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AssessmentTemplate get(String name, Output<String> id, @Nullable AssessmentTemplateState state, @Nullable CustomResourceOptions options) {
