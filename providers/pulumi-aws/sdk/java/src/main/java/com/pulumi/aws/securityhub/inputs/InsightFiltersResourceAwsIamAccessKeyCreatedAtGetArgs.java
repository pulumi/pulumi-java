...
import com.pulumi.aws.securityhub.inputs.InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeGetArgs;
...
public final class InsightFiltersResourceAwsIamAccessKeyCreatedAtGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeGetArgs>> dateRange() {
    ...
    private InsightFiltersResourceAwsIamAccessKeyCreatedAtGetArgs(InsightFiltersResourceAwsIamAccessKeyCreatedAtGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersResourceAwsIamAccessKeyCreatedAtGetArgs();
        }

        public Builder(InsightFiltersResourceAwsIamAccessKeyCreatedAtGetArgs defaults) {
            $ = new InsightFiltersResourceAwsIamAccessKeyCreatedAtGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder dateRange(InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeGetArgs dateRange) {
