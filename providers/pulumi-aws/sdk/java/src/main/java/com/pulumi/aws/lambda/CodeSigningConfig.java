...
public class CodeSigningConfig extends CustomResource {
    ...
    private CodeSigningConfig(String name, Output<String> id, @Nullable CodeSigningConfigState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CodeSigningConfig get(String name, Output<String> id, @Nullable CodeSigningConfigState state, @Nullable CustomResourceOptions options) {
