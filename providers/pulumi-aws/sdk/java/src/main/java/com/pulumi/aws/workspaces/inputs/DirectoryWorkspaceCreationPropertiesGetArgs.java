...
public final class DirectoryWorkspaceCreationPropertiesGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DirectoryWorkspaceCreationPropertiesGetArgs(DirectoryWorkspaceCreationPropertiesGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DirectoryWorkspaceCreationPropertiesGetArgs();
        }

        public Builder(DirectoryWorkspaceCreationPropertiesGetArgs defaults) {
            $ = new DirectoryWorkspaceCreationPropertiesGetArgs(Objects.requireNonNull(defaults));
        }
