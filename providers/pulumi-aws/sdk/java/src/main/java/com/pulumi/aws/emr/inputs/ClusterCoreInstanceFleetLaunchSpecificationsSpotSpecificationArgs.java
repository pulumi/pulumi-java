...
public final class ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationArgs(ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationArgs();
        }

        public Builder(ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationArgs defaults) {
            $ = new ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationArgs(Objects.requireNonNull(defaults));
        }
