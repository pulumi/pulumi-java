...
public class Configuration extends CustomResource {
    ...
    private Configuration(String name, Output<String> id, @Nullable ConfigurationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Configuration get(String name, Output<String> id, @Nullable ConfigurationState state, @Nullable CustomResourceOptions options) {
