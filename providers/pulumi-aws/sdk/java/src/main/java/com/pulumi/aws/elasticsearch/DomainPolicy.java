...
public class DomainPolicy extends CustomResource {
    /**
     ...
     */
    public DomainPolicy(String name, DomainPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DomainPolicy(String name, Output<String> id, @Nullable DomainPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DomainPolicy get(String name, Output<String> id, @Nullable DomainPolicyState state, @Nullable CustomResourceOptions options) {
