...
public class BucketNotification extends CustomResource {
     ...
     */
    public BucketNotification(String name, BucketNotificationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BucketNotification(String name, Output<String> id, @Nullable BucketNotificationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BucketNotification get(String name, Output<String> id, @Nullable BucketNotificationState state, @Nullable CustomResourceOptions options) {
