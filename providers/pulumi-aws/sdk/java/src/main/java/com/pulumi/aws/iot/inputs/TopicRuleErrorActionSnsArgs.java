...
public final class TopicRuleErrorActionSnsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TopicRuleErrorActionSnsArgs(TopicRuleErrorActionSnsArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TopicRuleErrorActionSnsArgs();
        }

        public Builder(TopicRuleErrorActionSnsArgs defaults) {
            $ = new TopicRuleErrorActionSnsArgs(Objects.requireNonNull(defaults));
        }
