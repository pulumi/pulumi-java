...
public class ResolverDnsSecConfig extends CustomResource {
     ...
     */
    public ResolverDnsSecConfig(String name, ResolverDnsSecConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResolverDnsSecConfig(String name, Output<String> id, @Nullable ResolverDnsSecConfigState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResolverDnsSecConfig get(String name, Output<String> id, @Nullable ResolverDnsSecConfigState state, @Nullable CustomResourceOptions options) {
