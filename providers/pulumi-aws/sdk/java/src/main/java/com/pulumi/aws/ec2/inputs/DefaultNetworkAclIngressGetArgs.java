...
public final class DefaultNetworkAclIngressGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DefaultNetworkAclIngressGetArgs(DefaultNetworkAclIngressGetArgs $) {
        this.action = $.action;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DefaultNetworkAclIngressGetArgs();
        }

        public Builder(DefaultNetworkAclIngressGetArgs defaults) {
            $ = new DefaultNetworkAclIngressGetArgs(Objects.requireNonNull(defaults));
        }
