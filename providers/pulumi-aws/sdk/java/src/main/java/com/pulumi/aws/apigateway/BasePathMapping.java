...
public class BasePathMapping extends CustomResource {
    /**
     ...
     */
    public BasePathMapping(String name, BasePathMappingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BasePathMapping(String name, Output<String> id, @Nullable BasePathMappingState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BasePathMapping get(String name, Output<String> id, @Nullable BasePathMappingState state, @Nullable CustomResourceOptions options) {
