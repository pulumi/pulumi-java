...
public class RouteTable extends CustomResource {
    ...
    private RouteTable(String name, Output<String> id, @Nullable RouteTableState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RouteTable get(String name, Output<String> id, @Nullable RouteTableState state, @Nullable CustomResourceOptions options) {
