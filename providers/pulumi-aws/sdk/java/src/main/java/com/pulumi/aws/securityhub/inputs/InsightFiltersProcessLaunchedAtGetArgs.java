...
import com.pulumi.aws.securityhub.inputs.InsightFiltersProcessLaunchedAtDateRangeGetArgs;
...
public final class InsightFiltersProcessLaunchedAtGetArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<InsightFiltersProcessLaunchedAtDateRangeGetArgs>> dateRange() {
    ...
    private InsightFiltersProcessLaunchedAtGetArgs(InsightFiltersProcessLaunchedAtGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersProcessLaunchedAtGetArgs();
        }

        public Builder(InsightFiltersProcessLaunchedAtGetArgs defaults) {
            $ = new InsightFiltersProcessLaunchedAtGetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder dateRange(InsightFiltersProcessLaunchedAtDateRangeGetArgs dateRange) {
