...
public final class IntentRejectionStatementMessageGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private IntentRejectionStatementMessageGetArgs(IntentRejectionStatementMessageGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IntentRejectionStatementMessageGetArgs();
        }

        public Builder(IntentRejectionStatementMessageGetArgs defaults) {
            $ = new IntentRejectionStatementMessageGetArgs(Objects.requireNonNull(defaults));
        }
