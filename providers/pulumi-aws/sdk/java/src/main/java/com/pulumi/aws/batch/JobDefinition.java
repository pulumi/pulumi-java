...
public class JobDefinition extends CustomResource {
    ...
    private JobDefinition(String name, Output<String> id, @Nullable JobDefinitionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static JobDefinition get(String name, Output<String> id, @Nullable JobDefinitionState state, @Nullable CustomResourceOptions options) {
