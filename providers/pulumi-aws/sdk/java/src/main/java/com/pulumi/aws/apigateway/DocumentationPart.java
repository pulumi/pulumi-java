...
public class DocumentationPart extends CustomResource {
     ...
     */
    public DocumentationPart(String name, DocumentationPartArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DocumentationPart(String name, Output<String> id, @Nullable DocumentationPartState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DocumentationPart get(String name, Output<String> id, @Nullable DocumentationPartState state, @Nullable CustomResourceOptions options) {
