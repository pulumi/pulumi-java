...
public class VaultNotifications extends CustomResource {
     ...
     */
    public VaultNotifications(String name, VaultNotificationsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VaultNotifications(String name, Output<String> id, @Nullable VaultNotificationsState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VaultNotifications get(String name, Output<String> id, @Nullable VaultNotificationsState state, @Nullable CustomResourceOptions options) {
