...
public class StaticWebLayer extends CustomResource {
    /**
     ...
     */
    public StaticWebLayer(String name, StaticWebLayerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StaticWebLayer(String name, Output<String> id, @Nullable StaticWebLayerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StaticWebLayer get(String name, Output<String> id, @Nullable StaticWebLayerState state, @Nullable CustomResourceOptions options) {
