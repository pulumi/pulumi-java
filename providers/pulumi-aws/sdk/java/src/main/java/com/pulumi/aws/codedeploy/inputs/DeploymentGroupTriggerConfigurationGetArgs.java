...
public final class DeploymentGroupTriggerConfigurationGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DeploymentGroupTriggerConfigurationGetArgs(DeploymentGroupTriggerConfigurationGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeploymentGroupTriggerConfigurationGetArgs();
        }

        public Builder(DeploymentGroupTriggerConfigurationGetArgs defaults) {
            $ = new DeploymentGroupTriggerConfigurationGetArgs(Objects.requireNonNull(defaults));
        }
