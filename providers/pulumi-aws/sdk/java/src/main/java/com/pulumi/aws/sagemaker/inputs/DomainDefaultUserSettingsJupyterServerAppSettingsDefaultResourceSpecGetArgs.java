...
public final class DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs(DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs();
        }

        public Builder(DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs defaults) {
            $ = new DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs(Objects.requireNonNull(defaults));
        }
