...
public class ClusterInstance extends CustomResource {
     ...
     */
    public ClusterInstance(String name, ClusterInstanceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ClusterInstance(String name, Output<String> id, @Nullable ClusterInstanceState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ClusterInstance get(String name, Output<String> id, @Nullable ClusterInstanceState state, @Nullable CustomResourceOptions options) {
