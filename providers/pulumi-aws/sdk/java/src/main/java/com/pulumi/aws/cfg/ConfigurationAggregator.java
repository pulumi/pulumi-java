...
public class ConfigurationAggregator extends CustomResource {
    /**
     ...
     */
    public ConfigurationAggregator(String name, @Nullable ConfigurationAggregatorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConfigurationAggregator(String name, Output<String> id, @Nullable ConfigurationAggregatorState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConfigurationAggregator get(String name, Output<String> id, @Nullable ConfigurationAggregatorState state, @Nullable CustomResourceOptions options) {
