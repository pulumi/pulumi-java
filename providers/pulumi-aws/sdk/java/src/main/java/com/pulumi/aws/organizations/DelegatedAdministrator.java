...
public class DelegatedAdministrator extends CustomResource {
    /**
     ...
     */
    public DelegatedAdministrator(String name, DelegatedAdministratorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DelegatedAdministrator(String name, Output<String> id, @Nullable DelegatedAdministratorState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DelegatedAdministrator get(String name, Output<String> id, @Nullable DelegatedAdministratorState state, @Nullable CustomResourceOptions options) {
