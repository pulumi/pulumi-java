...
public class VpcEndpointServiceAllowedPrinciple extends CustomResource {
     ...
     */
    public VpcEndpointServiceAllowedPrinciple(String name, VpcEndpointServiceAllowedPrincipleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VpcEndpointServiceAllowedPrinciple(String name, Output<String> id, @Nullable VpcEndpointServiceAllowedPrincipleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpcEndpointServiceAllowedPrinciple get(String name, Output<String> id, @Nullable VpcEndpointServiceAllowedPrincipleState state, @Nullable CustomResourceOptions options) {
