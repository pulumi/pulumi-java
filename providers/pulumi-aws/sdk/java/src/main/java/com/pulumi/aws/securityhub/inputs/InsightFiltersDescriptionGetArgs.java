...
public final class InsightFiltersDescriptionGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final InsightFiltersDescriptionGetArgs Empty = new InsightFiltersDescriptionGetArgs();
    ...
    private InsightFiltersDescriptionGetArgs() {}

    private InsightFiltersDescriptionGetArgs(InsightFiltersDescriptionGetArgs $) {
    ...
    public static Builder builder(InsightFiltersDescriptionGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersDescriptionGetArgs();
        }

        public Builder(InsightFiltersDescriptionGetArgs defaults) {
            $ = new InsightFiltersDescriptionGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InsightFiltersDescriptionGetArgs build() {
