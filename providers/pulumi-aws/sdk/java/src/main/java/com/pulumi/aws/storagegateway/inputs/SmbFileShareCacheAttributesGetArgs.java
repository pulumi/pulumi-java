...
public final class SmbFileShareCacheAttributesGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SmbFileShareCacheAttributesGetArgs(SmbFileShareCacheAttributesGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SmbFileShareCacheAttributesGetArgs();
        }

        public Builder(SmbFileShareCacheAttributesGetArgs defaults) {
            $ = new SmbFileShareCacheAttributesGetArgs(Objects.requireNonNull(defaults));
        }
