...
public final class ImageBuilderDomainJoinInfoGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ImageBuilderDomainJoinInfoGetArgs(ImageBuilderDomainJoinInfoGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ImageBuilderDomainJoinInfoGetArgs();
        }

        public Builder(ImageBuilderDomainJoinInfoGetArgs defaults) {
            $ = new ImageBuilderDomainJoinInfoGetArgs(Objects.requireNonNull(defaults));
        }
