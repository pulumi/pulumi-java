...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs;
...
public final class WebAclRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatementGetArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<WebAclRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs>> ipSetForwardedIpConfig() {
        return Optional.ofNullable(this.ipSetForwardedIpConfig);
    }

    private WebAclRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatementGetArgs() {}

    private WebAclRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatementGetArgs(WebAclRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatementGetArgs $) {
        this.arn = $.arn;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatementGetArgs();
        }

        public Builder(WebAclRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatementGetArgs defaults) {
            $ = new WebAclRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatementGetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder ipSetForwardedIpConfig(WebAclRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs ipSetForwardedIpConfig) {
