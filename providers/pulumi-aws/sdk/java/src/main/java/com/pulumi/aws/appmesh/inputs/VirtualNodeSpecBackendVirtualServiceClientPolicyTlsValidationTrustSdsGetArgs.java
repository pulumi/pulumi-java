...
public final class VirtualNodeSpecBackendVirtualServiceClientPolicyTlsValidationTrustSdsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private VirtualNodeSpecBackendVirtualServiceClientPolicyTlsValidationTrustSdsGetArgs(VirtualNodeSpecBackendVirtualServiceClientPolicyTlsValidationTrustSdsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualNodeSpecBackendVirtualServiceClientPolicyTlsValidationTrustSdsGetArgs();
        }

        public Builder(VirtualNodeSpecBackendVirtualServiceClientPolicyTlsValidationTrustSdsGetArgs defaults) {
            $ = new VirtualNodeSpecBackendVirtualServiceClientPolicyTlsValidationTrustSdsGetArgs(Objects.requireNonNull(defaults));
        }
