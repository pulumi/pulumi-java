...
public class ProductSubscription extends CustomResource {
     ...
     */
    public ProductSubscription(String name, ProductSubscriptionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProductSubscription(String name, Output<String> id, @Nullable ProductSubscriptionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProductSubscription get(String name, Output<String> id, @Nullable ProductSubscriptionState state, @Nullable CustomResourceOptions options) {
