...
public final class GetVpcsArgs extends com.pulumi.resources.InvokeArgs {
     ...
     */
    @Import(name="filters")
    private Output</* @Nullable */ List<GetVpcsFilter>> filters;

    /**
     * @return Custom filter block as described below.
     * 
     */
    public Output</* @Nullable */ List<GetVpcsFilter>> filters() {
        return this.filters;
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder filters(Output</* @Nullable */ List<GetVpcsFilter>> filters) {
            $.filters = filters;
            return this;
        }
