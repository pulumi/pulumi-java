...
public class SmbFileShare extends CustomResource {
    /**
     ...
     */
    public SmbFileShare(String name, SmbFileShareArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SmbFileShare(String name, Output<String> id, @Nullable SmbFileShareState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SmbFileShare get(String name, Output<String> id, @Nullable SmbFileShareState state, @Nullable CustomResourceOptions options) {
