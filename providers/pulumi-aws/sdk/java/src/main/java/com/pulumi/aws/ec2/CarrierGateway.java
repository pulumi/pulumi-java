...
public class CarrierGateway extends CustomResource {
    /**
     ...
     */
    public CarrierGateway(String name, CarrierGatewayArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CarrierGateway(String name, Output<String> id, @Nullable CarrierGatewayState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CarrierGateway get(String name, Output<String> id, @Nullable CarrierGatewayState state, @Nullable CustomResourceOptions options) {
