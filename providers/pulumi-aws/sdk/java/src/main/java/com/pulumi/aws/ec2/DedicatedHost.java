...
public class DedicatedHost extends CustomResource {
     ...
     */
    public DedicatedHost(String name, DedicatedHostArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DedicatedHost(String name, Output<String> id, @Nullable DedicatedHostState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DedicatedHost get(String name, Output<String> id, @Nullable DedicatedHostState state, @Nullable CustomResourceOptions options) {
