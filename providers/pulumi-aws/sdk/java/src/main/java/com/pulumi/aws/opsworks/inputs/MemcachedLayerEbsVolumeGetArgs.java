...
public final class MemcachedLayerEbsVolumeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MemcachedLayerEbsVolumeGetArgs(MemcachedLayerEbsVolumeGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MemcachedLayerEbsVolumeGetArgs();
        }

        public Builder(MemcachedLayerEbsVolumeGetArgs defaults) {
            $ = new MemcachedLayerEbsVolumeGetArgs(Objects.requireNonNull(defaults));
        }
