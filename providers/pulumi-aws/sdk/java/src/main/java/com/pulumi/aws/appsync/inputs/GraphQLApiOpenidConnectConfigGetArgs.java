...
public final class GraphQLApiOpenidConnectConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GraphQLApiOpenidConnectConfigGetArgs(GraphQLApiOpenidConnectConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GraphQLApiOpenidConnectConfigGetArgs();
        }

        public Builder(GraphQLApiOpenidConnectConfigGetArgs defaults) {
            $ = new GraphQLApiOpenidConnectConfigGetArgs(Objects.requireNonNull(defaults));
        }
