...
public final class RegistryScanningConfigurationRuleGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegistryScanningConfigurationRuleGetArgs(RegistryScanningConfigurationRuleGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegistryScanningConfigurationRuleGetArgs();
        }

        public Builder(RegistryScanningConfigurationRuleGetArgs defaults) {
            $ = new RegistryScanningConfigurationRuleGetArgs(Objects.requireNonNull(defaults));
        }
