...
public class Certificate extends CustomResource {
     ...
     */
    public Certificate(String name, CertificateArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Certificate(String name, Output<String> id, @Nullable CertificateState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Certificate get(String name, Output<String> id, @Nullable CertificateState state, @Nullable CustomResourceOptions options) {
