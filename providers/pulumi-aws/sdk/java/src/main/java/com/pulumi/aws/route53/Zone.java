...
public class Zone extends CustomResource {
    ...
    private Zone(String name, Output<String> id, @Nullable ZoneState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Zone get(String name, Output<String> id, @Nullable ZoneState state, @Nullable CustomResourceOptions options) {
