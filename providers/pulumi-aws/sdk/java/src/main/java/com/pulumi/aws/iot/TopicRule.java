...
public class TopicRule extends CustomResource {
    ...
    private TopicRule(String name, Output<String> id, @Nullable TopicRuleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TopicRule get(String name, Output<String> id, @Nullable TopicRuleState state, @Nullable CustomResourceOptions options) {
