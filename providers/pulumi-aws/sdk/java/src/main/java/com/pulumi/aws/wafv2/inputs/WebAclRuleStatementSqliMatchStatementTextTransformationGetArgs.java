...
public final class WebAclRuleStatementSqliMatchStatementTextTransformationGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementSqliMatchStatementTextTransformationGetArgs Empty = new WebAclRuleStatementSqliMatchStatementTextTransformationGetArgs();
    ...
    private WebAclRuleStatementSqliMatchStatementTextTransformationGetArgs() {}

    private WebAclRuleStatementSqliMatchStatementTextTransformationGetArgs(WebAclRuleStatementSqliMatchStatementTextTransformationGetArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementSqliMatchStatementTextTransformationGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementSqliMatchStatementTextTransformationGetArgs();
        }

        public Builder(WebAclRuleStatementSqliMatchStatementTextTransformationGetArgs defaults) {
            $ = new WebAclRuleStatementSqliMatchStatementTextTransformationGetArgs(Objects.requireNonNull(defaults));
        }
