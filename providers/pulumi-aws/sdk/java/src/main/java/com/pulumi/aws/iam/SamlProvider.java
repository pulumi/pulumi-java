...
public class SamlProvider extends CustomResource {
    /**
     ...
     */
    public SamlProvider(String name, SamlProviderArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SamlProvider(String name, Output<String> id, @Nullable SamlProviderState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SamlProvider get(String name, Output<String> id, @Nullable SamlProviderState state, @Nullable CustomResourceOptions options) {
