...
public final class TopicRuleErrorActionStepFunctionsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TopicRuleErrorActionStepFunctionsGetArgs(TopicRuleErrorActionStepFunctionsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TopicRuleErrorActionStepFunctionsGetArgs();
        }

        public Builder(TopicRuleErrorActionStepFunctionsGetArgs defaults) {
            $ = new TopicRuleErrorActionStepFunctionsGetArgs(Objects.requireNonNull(defaults));
        }
