...
public class ResolverQueryLogConfig extends CustomResource {
    /**
     ...
     */
    public ResolverQueryLogConfig(String name, ResolverQueryLogConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResolverQueryLogConfig(String name, Output<String> id, @Nullable ResolverQueryLogConfigState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResolverQueryLogConfig get(String name, Output<String> id, @Nullable ResolverQueryLogConfigState state, @Nullable CustomResourceOptions options) {
