...
public final class RuleGroupRuleStatementAndStatementStatementAndStatementStatementIpSetReferenceStatementArgs extends ResourceArgs {
     ...
     * 
     */
    public Optional<Output<RuleGroupRuleStatementAndStatementStatementAndStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigArgs>> ipSetForwardedIpConfig() {
        return Optional.ofNullable(this.ipSetForwardedIpConfig);
    }

    private RuleGroupRuleStatementAndStatementStatementAndStatementStatementIpSetReferenceStatementArgs() {}

    private RuleGroupRuleStatementAndStatementStatementAndStatementStatementIpSetReferenceStatementArgs(RuleGroupRuleStatementAndStatementStatementAndStatementStatementIpSetReferenceStatementArgs $) {
        this.arn = $.arn;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupRuleStatementAndStatementStatementAndStatementStatementIpSetReferenceStatementArgs();
        }

        public Builder(RuleGroupRuleStatementAndStatementStatementAndStatementStatementIpSetReferenceStatementArgs defaults) {
            $ = new RuleGroupRuleStatementAndStatementStatementAndStatementStatementIpSetReferenceStatementArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder ipSetForwardedIpConfig(RuleGroupRuleStatementAndStatementStatementAndStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigArgs ipSetForwardedIpConfig) {
