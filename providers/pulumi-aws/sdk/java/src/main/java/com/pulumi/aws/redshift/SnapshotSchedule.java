...
public class SnapshotSchedule extends CustomResource {
    /**
     ...
     */
    public SnapshotSchedule(String name, SnapshotScheduleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SnapshotSchedule(String name, Output<String> id, @Nullable SnapshotScheduleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SnapshotSchedule get(String name, Output<String> id, @Nullable SnapshotScheduleState state, @Nullable CustomResourceOptions options) {
