...
public class RegistryPolicy extends CustomResource {
    ...
    private RegistryPolicy(String name, Output<String> id, @Nullable RegistryPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegistryPolicy get(String name, Output<String> id, @Nullable RegistryPolicyState state, @Nullable CustomResourceOptions options) {
