...
public final class TopicRuleSqsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TopicRuleSqsGetArgs(TopicRuleSqsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TopicRuleSqsGetArgs();
        }

        public Builder(TopicRuleSqsGetArgs defaults) {
            $ = new TopicRuleSqsGetArgs(Objects.requireNonNull(defaults));
        }
