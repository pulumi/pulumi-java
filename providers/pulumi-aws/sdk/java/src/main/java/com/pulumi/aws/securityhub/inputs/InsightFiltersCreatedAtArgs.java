...
public final class InsightFiltersCreatedAtArgs extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="dateRange")
      private final @Nullable Output<InsightFiltersCreatedAtDateRangeArgs> dateRange;

    public Output<InsightFiltersCreatedAtDateRangeArgs> getDateRange() {
    ...
    public InsightFiltersCreatedAtArgs(
        @Nullable Output<InsightFiltersCreatedAtDateRangeArgs> dateRange,
