...
public class FileSystemPolicy extends CustomResource {
    /**
     ...
     */
    public FileSystemPolicy(String name, FileSystemPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FileSystemPolicy(String name, Output<String> id, @Nullable FileSystemPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FileSystemPolicy get(String name, Output<String> id, @Nullable FileSystemPolicyState state, @Nullable CustomResourceOptions options) {
