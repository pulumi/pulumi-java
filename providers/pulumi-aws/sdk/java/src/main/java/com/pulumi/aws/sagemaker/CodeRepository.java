...
public class CodeRepository extends CustomResource {
    /**
     ...
     */
    public CodeRepository(String name, CodeRepositoryArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CodeRepository(String name, Output<String> id, @Nullable CodeRepositoryState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CodeRepository get(String name, Output<String> id, @Nullable CodeRepositoryState state, @Nullable CustomResourceOptions options) {
