...
public class Access extends CustomResource {
     ...
     */
    public Access(String name, AccessArgs args, @Nullable CustomResourceOptions options) {
        super("aws:transfer/access:Access", name, args == null ? AccessArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Access(String name, Output<String> id, @Nullable AccessState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Access get(String name, Output<String> id, @Nullable AccessState state, @Nullable CustomResourceOptions options) {
