...
public final class RulePredicateGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RulePredicateGetArgs(RulePredicateGetArgs $) {
        this.dataId = $.dataId;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RulePredicateGetArgs();
        }

        public Builder(RulePredicateGetArgs defaults) {
            $ = new RulePredicateGetArgs(Objects.requireNonNull(defaults));
        }
