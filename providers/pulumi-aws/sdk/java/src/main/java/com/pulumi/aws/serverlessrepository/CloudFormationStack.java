...
public class CloudFormationStack extends CustomResource {
    /**
     ...
     */
    public CloudFormationStack(String name, CloudFormationStackArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CloudFormationStack(String name, Output<String> id, @Nullable CloudFormationStackState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CloudFormationStack get(String name, Output<String> id, @Nullable CloudFormationStackState state, @Nullable CustomResourceOptions options) {
