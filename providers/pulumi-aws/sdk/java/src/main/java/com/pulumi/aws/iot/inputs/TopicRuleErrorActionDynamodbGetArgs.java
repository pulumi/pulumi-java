...
public final class TopicRuleErrorActionDynamodbGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TopicRuleErrorActionDynamodbGetArgs(TopicRuleErrorActionDynamodbGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TopicRuleErrorActionDynamodbGetArgs();
        }

        public Builder(TopicRuleErrorActionDynamodbGetArgs defaults) {
            $ = new TopicRuleErrorActionDynamodbGetArgs(Objects.requireNonNull(defaults));
        }
