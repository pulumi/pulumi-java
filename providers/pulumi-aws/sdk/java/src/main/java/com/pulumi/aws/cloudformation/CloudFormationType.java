...
public class CloudFormationType extends CustomResource {
     ...
     */
    public CloudFormationType(String name, CloudFormationTypeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CloudFormationType(String name, Output<String> id, @Nullable CloudFormationTypeState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CloudFormationType get(String name, Output<String> id, @Nullable CloudFormationTypeState state, @Nullable CustomResourceOptions options) {
