...
public class LustreFileSystem extends CustomResource {
     ...
     */
    public LustreFileSystem(String name, LustreFileSystemArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LustreFileSystem(String name, Output<String> id, @Nullable LustreFileSystemState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LustreFileSystem get(String name, Output<String> id, @Nullable LustreFileSystemState state, @Nullable CustomResourceOptions options) {
