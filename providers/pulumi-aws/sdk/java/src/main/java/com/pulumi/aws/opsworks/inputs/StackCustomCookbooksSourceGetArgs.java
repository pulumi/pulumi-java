...
public final class StackCustomCookbooksSourceGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private StackCustomCookbooksSourceGetArgs(StackCustomCookbooksSourceGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StackCustomCookbooksSourceGetArgs();
        }

        public Builder(StackCustomCookbooksSourceGetArgs defaults) {
            $ = new StackCustomCookbooksSourceGetArgs(Objects.requireNonNull(defaults));
        }
