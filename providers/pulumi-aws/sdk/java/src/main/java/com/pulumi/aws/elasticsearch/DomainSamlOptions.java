...
public class DomainSamlOptions extends CustomResource {
     ...
     */
    public DomainSamlOptions(String name, DomainSamlOptionsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DomainSamlOptions(String name, Output<String> id, @Nullable DomainSamlOptionsState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DomainSamlOptions get(String name, Output<String> id, @Nullable DomainSamlOptionsState state, @Nullable CustomResourceOptions options) {
