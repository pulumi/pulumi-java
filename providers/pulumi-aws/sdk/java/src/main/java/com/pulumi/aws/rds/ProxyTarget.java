...
public class ProxyTarget extends CustomResource {
     ...
     */
    public ProxyTarget(String name, ProxyTargetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProxyTarget(String name, Output<String> id, @Nullable ProxyTargetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProxyTarget get(String name, Output<String> id, @Nullable ProxyTargetState state, @Nullable CustomResourceOptions options) {
