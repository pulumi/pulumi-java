...
public class ProtectionGroup extends CustomResource {
     ...
     */
    public ProtectionGroup(String name, ProtectionGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProtectionGroup(String name, Output<String> id, @Nullable ProtectionGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProtectionGroup get(String name, Output<String> id, @Nullable ProtectionGroupState state, @Nullable CustomResourceOptions options) {
