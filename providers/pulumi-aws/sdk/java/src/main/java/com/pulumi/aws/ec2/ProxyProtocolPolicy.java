...
public class ProxyProtocolPolicy extends CustomResource {
    /**
     ...
     */
    public ProxyProtocolPolicy(String name, ProxyProtocolPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProxyProtocolPolicy(String name, Output<String> id, @Nullable ProxyProtocolPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProxyProtocolPolicy get(String name, Output<String> id, @Nullable ProxyProtocolPolicyState state, @Nullable CustomResourceOptions options) {
