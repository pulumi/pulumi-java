...
public final class AnalyticsApplicationInputsSchemaRecordFormatMappingParametersCsvGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AnalyticsApplicationInputsSchemaRecordFormatMappingParametersCsvGetArgs(AnalyticsApplicationInputsSchemaRecordFormatMappingParametersCsvGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AnalyticsApplicationInputsSchemaRecordFormatMappingParametersCsvGetArgs();
        }

        public Builder(AnalyticsApplicationInputsSchemaRecordFormatMappingParametersCsvGetArgs defaults) {
            $ = new AnalyticsApplicationInputsSchemaRecordFormatMappingParametersCsvGetArgs(Objects.requireNonNull(defaults));
        }
