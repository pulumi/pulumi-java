...
public class Portfolio extends CustomResource {
     ...
     */
    public Portfolio(String name, PortfolioArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Portfolio(String name, Output<String> id, @Nullable PortfolioState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Portfolio get(String name, Output<String> id, @Nullable PortfolioState state, @Nullable CustomResourceOptions options) {
