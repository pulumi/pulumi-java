...
public class OntapVolume extends CustomResource {
     ...
     */
    public OntapVolume(String name, OntapVolumeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OntapVolume(String name, Output<String> id, @Nullable OntapVolumeState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OntapVolume get(String name, Output<String> id, @Nullable OntapVolumeState state, @Nullable CustomResourceOptions options) {
