...
public class EmailChannel extends CustomResource {
    /**
     * The application ID.
     * 
     */
     ...
     */
    public EmailChannel(String name, EmailChannelArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EmailChannel(String name, Output<String> id, @Nullable EmailChannelState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EmailChannel get(String name, Output<String> id, @Nullable EmailChannelState state, @Nullable CustomResourceOptions options) {
