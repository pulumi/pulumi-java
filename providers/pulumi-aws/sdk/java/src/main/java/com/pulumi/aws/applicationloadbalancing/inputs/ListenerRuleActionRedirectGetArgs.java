...
public final class ListenerRuleActionRedirectGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ListenerRuleActionRedirectGetArgs(ListenerRuleActionRedirectGetArgs $) {
        this.host = $.host;
        this.path = $.path;
        this.port = $.port;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListenerRuleActionRedirectGetArgs();
        }

        public Builder(ListenerRuleActionRedirectGetArgs defaults) {
            $ = new ListenerRuleActionRedirectGetArgs(Objects.requireNonNull(defaults));
        }
