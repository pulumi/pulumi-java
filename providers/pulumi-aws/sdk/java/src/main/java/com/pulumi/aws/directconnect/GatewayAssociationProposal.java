...
public class GatewayAssociationProposal extends CustomResource {
     ...
     */
    public GatewayAssociationProposal(String name, GatewayAssociationProposalArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GatewayAssociationProposal(String name, Output<String> id, @Nullable GatewayAssociationProposalState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GatewayAssociationProposal get(String name, Output<String> id, @Nullable GatewayAssociationProposalState state, @Nullable CustomResourceOptions options) {
