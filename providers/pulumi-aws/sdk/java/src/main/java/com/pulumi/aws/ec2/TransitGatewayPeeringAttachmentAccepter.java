...
public class TransitGatewayPeeringAttachmentAccepter extends CustomResource {
     ...
     */
    public TransitGatewayPeeringAttachmentAccepter(String name, TransitGatewayPeeringAttachmentAccepterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TransitGatewayPeeringAttachmentAccepter(String name, Output<String> id, @Nullable TransitGatewayPeeringAttachmentAccepterState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TransitGatewayPeeringAttachmentAccepter get(String name, Output<String> id, @Nullable TransitGatewayPeeringAttachmentAccepterState state, @Nullable CustomResourceOptions options) {
