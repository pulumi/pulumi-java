...
public class HostedPrivateVirtualInterfaceAccepter extends CustomResource {
    /**
     ...
     */
    public HostedPrivateVirtualInterfaceAccepter(String name, HostedPrivateVirtualInterfaceAccepterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HostedPrivateVirtualInterfaceAccepter(String name, Output<String> id, @Nullable HostedPrivateVirtualInterfaceAccepterState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HostedPrivateVirtualInterfaceAccepter get(String name, Output<String> id, @Nullable HostedPrivateVirtualInterfaceAccepterState state, @Nullable CustomResourceOptions options) {
