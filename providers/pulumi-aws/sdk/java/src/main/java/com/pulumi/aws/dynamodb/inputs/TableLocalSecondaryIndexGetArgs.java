...
public final class TableLocalSecondaryIndexGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TableLocalSecondaryIndexGetArgs(TableLocalSecondaryIndexGetArgs $) {
        this.name = $.name;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TableLocalSecondaryIndexGetArgs();
        }

        public Builder(TableLocalSecondaryIndexGetArgs defaults) {
            $ = new TableLocalSecondaryIndexGetArgs(Objects.requireNonNull(defaults));
        }
