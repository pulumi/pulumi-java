...
public final class DeploymentGroupEc2TagSetEc2TagFilterGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DeploymentGroupEc2TagSetEc2TagFilterGetArgs(DeploymentGroupEc2TagSetEc2TagFilterGetArgs $) {
        this.key = $.key;
        this.type = $.type;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeploymentGroupEc2TagSetEc2TagFilterGetArgs();
        }

        public Builder(DeploymentGroupEc2TagSetEc2TagFilterGetArgs defaults) {
            $ = new DeploymentGroupEc2TagSetEc2TagFilterGetArgs(Objects.requireNonNull(defaults));
        }
