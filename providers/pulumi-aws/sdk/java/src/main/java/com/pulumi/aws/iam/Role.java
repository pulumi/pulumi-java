...
public class Role extends CustomResource {
    ...
    private Role(String name, Output<String> id, @Nullable RoleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Role get(String name, Output<String> id, @Nullable RoleState state, @Nullable CustomResourceOptions options) {
