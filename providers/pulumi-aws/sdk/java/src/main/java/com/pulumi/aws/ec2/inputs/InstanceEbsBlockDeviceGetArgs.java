...
public final class InstanceEbsBlockDeviceGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceEbsBlockDeviceGetArgs(InstanceEbsBlockDeviceGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceEbsBlockDeviceGetArgs();
        }

        public Builder(InstanceEbsBlockDeviceGetArgs defaults) {
            $ = new InstanceEbsBlockDeviceGetArgs(Objects.requireNonNull(defaults));
        }
