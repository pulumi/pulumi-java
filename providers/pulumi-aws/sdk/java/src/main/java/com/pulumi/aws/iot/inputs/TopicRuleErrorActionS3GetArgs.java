...
public final class TopicRuleErrorActionS3GetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TopicRuleErrorActionS3GetArgs(TopicRuleErrorActionS3GetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TopicRuleErrorActionS3GetArgs();
        }

        public Builder(TopicRuleErrorActionS3GetArgs defaults) {
            $ = new TopicRuleErrorActionS3GetArgs(Objects.requireNonNull(defaults));
        }
