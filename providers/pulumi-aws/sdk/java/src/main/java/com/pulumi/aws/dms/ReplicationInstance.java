...
public class ReplicationInstance extends CustomResource {
     ...
     */
    public ReplicationInstance(String name, ReplicationInstanceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReplicationInstance(String name, Output<String> id, @Nullable ReplicationInstanceState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReplicationInstance get(String name, Output<String> id, @Nullable ReplicationInstanceState state, @Nullable CustomResourceOptions options) {
