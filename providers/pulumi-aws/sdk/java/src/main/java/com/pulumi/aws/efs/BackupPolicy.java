...
public class BackupPolicy extends CustomResource {
    ...
    private BackupPolicy(String name, Output<String> id, @Nullable BackupPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BackupPolicy get(String name, Output<String> id, @Nullable BackupPolicyState state, @Nullable CustomResourceOptions options) {
