...
public class PortfolioShare extends CustomResource {
     ...
     */
    public PortfolioShare(String name, PortfolioShareArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PortfolioShare(String name, Output<String> id, @Nullable PortfolioShareState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PortfolioShare get(String name, Output<String> id, @Nullable PortfolioShareState state, @Nullable CustomResourceOptions options) {
