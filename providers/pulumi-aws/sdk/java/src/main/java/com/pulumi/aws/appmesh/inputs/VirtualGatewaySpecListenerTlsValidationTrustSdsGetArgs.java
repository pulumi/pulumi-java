...
public final class VirtualGatewaySpecListenerTlsValidationTrustSdsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private VirtualGatewaySpecListenerTlsValidationTrustSdsGetArgs(VirtualGatewaySpecListenerTlsValidationTrustSdsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualGatewaySpecListenerTlsValidationTrustSdsGetArgs();
        }

        public Builder(VirtualGatewaySpecListenerTlsValidationTrustSdsGetArgs defaults) {
            $ = new VirtualGatewaySpecListenerTlsValidationTrustSdsGetArgs(Objects.requireNonNull(defaults));
        }
