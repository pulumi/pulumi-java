...
public final class InsightFiltersRelatedFindingsIdGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final InsightFiltersRelatedFindingsIdGetArgs Empty = new InsightFiltersRelatedFindingsIdGetArgs();
    ...
    private InsightFiltersRelatedFindingsIdGetArgs() {}

    private InsightFiltersRelatedFindingsIdGetArgs(InsightFiltersRelatedFindingsIdGetArgs $) {
    ...
    public static Builder builder(InsightFiltersRelatedFindingsIdGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersRelatedFindingsIdGetArgs();
        }

        public Builder(InsightFiltersRelatedFindingsIdGetArgs defaults) {
            $ = new InsightFiltersRelatedFindingsIdGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InsightFiltersRelatedFindingsIdGetArgs build() {
