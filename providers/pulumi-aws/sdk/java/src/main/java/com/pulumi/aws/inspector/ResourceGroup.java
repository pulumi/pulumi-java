...
public class ResourceGroup extends CustomResource {
     ...
     */
    public ResourceGroup(String name, ResourceGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResourceGroup(String name, Output<String> id, @Nullable ResourceGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResourceGroup get(String name, Output<String> id, @Nullable ResourceGroupState state, @Nullable CustomResourceOptions options) {
