...
public class MemcachedLayer extends CustomResource {
    /**
     ...
     */
    public MemcachedLayer(String name, MemcachedLayerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MemcachedLayer(String name, Output<String> id, @Nullable MemcachedLayerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MemcachedLayer get(String name, Output<String> id, @Nullable MemcachedLayerState state, @Nullable CustomResourceOptions options) {
