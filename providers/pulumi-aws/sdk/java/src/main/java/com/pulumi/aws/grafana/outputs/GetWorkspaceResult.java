...
public final class GetWorkspaceResult {
    ...
    public static final class Builder {
        ...
        public Builder workspaceId(String workspaceId) {
            ...
            return new GetWorkspaceResult(accountAccessType, arn, authenticationProviders, createdDate, dataSources, description, endpoint, grafanaVersion, id, lastUpdatedDate, name, notificationDestinations, organizationRoleName, organizationalUnits, permissionType, roleArn, samlConfigurationStatus, stackSetName, status, workspaceId);
        }
    }
}
