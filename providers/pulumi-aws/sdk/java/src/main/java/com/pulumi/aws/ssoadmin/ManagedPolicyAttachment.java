...
public class ManagedPolicyAttachment extends CustomResource {
     ...
     */
    public ManagedPolicyAttachment(String name, ManagedPolicyAttachmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagedPolicyAttachment(String name, Output<String> id, @Nullable ManagedPolicyAttachmentState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagedPolicyAttachment get(String name, Output<String> id, @Nullable ManagedPolicyAttachmentState state, @Nullable CustomResourceOptions options) {
