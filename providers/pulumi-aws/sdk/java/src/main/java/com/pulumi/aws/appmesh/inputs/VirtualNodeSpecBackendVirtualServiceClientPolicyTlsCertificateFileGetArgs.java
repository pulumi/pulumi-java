...
public final class VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFileGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFileGetArgs Empty = new VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFileGetArgs();
    ...
    private VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFileGetArgs() {}

    private VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFileGetArgs(VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFileGetArgs $) {
    ...
    public static Builder builder(VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFileGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFileGetArgs();
        }

        public Builder(VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFileGetArgs defaults) {
            $ = new VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFileGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFileGetArgs build() {
