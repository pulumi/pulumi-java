...
public class OpenZfsVolume extends CustomResource {
     ...
     */
    public OpenZfsVolume(String name, OpenZfsVolumeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OpenZfsVolume(String name, Output<String> id, @Nullable OpenZfsVolumeState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OpenZfsVolume get(String name, Output<String> id, @Nullable OpenZfsVolumeState state, @Nullable CustomResourceOptions options) {
