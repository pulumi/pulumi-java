...
public class Trail extends CustomResource {
    ...
    private Trail(String name, Output<String> id, @Nullable TrailState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Trail get(String name, Output<String> id, @Nullable TrailState state, @Nullable CustomResourceOptions options) {
