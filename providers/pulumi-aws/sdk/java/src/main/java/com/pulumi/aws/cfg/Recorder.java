...
public class Recorder extends CustomResource {
     ...
     */
    public Recorder(String name, RecorderArgs args, @Nullable CustomResourceOptions options) {
        super("aws:cfg/recorder:Recorder", name, args == null ? RecorderArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Recorder(String name, Output<String> id, @Nullable RecorderState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Recorder get(String name, Output<String> id, @Nullable RecorderState state, @Nullable CustomResourceOptions options) {
