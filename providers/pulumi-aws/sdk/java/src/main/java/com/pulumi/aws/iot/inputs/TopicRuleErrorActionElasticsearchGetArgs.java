...
public final class TopicRuleErrorActionElasticsearchGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TopicRuleErrorActionElasticsearchGetArgs(TopicRuleErrorActionElasticsearchGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TopicRuleErrorActionElasticsearchGetArgs();
        }

        public Builder(TopicRuleErrorActionElasticsearchGetArgs defaults) {
            $ = new TopicRuleErrorActionElasticsearchGetArgs(Objects.requireNonNull(defaults));
        }
