...
public class ApprovalRuleTemplateAssociation extends CustomResource {
     ...
     */
    public ApprovalRuleTemplateAssociation(String name, ApprovalRuleTemplateAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApprovalRuleTemplateAssociation(String name, Output<String> id, @Nullable ApprovalRuleTemplateAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApprovalRuleTemplateAssociation get(String name, Output<String> id, @Nullable ApprovalRuleTemplateAssociationState state, @Nullable CustomResourceOptions options) {
