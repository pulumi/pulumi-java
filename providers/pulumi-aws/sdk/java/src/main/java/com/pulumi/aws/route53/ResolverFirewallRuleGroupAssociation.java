...
public class ResolverFirewallRuleGroupAssociation extends CustomResource {
     ...
     */
    public ResolverFirewallRuleGroupAssociation(String name, ResolverFirewallRuleGroupAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResolverFirewallRuleGroupAssociation(String name, Output<String> id, @Nullable ResolverFirewallRuleGroupAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResolverFirewallRuleGroupAssociation get(String name, Output<String> id, @Nullable ResolverFirewallRuleGroupAssociationState state, @Nullable CustomResourceOptions options) {
