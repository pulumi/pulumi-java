...
public final class PipelineContentConfigPermissionGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PipelineContentConfigPermissionGetArgs(PipelineContentConfigPermissionGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PipelineContentConfigPermissionGetArgs();
        }

        public Builder(PipelineContentConfigPermissionGetArgs defaults) {
            $ = new PipelineContentConfigPermissionGetArgs(Objects.requireNonNull(defaults));
        }
