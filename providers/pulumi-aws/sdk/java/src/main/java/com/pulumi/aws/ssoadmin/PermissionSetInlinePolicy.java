...
public class PermissionSetInlinePolicy extends CustomResource {
     ...
     */
    public PermissionSetInlinePolicy(String name, PermissionSetInlinePolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PermissionSetInlinePolicy(String name, Output<String> id, @Nullable PermissionSetInlinePolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PermissionSetInlinePolicy get(String name, Output<String> id, @Nullable PermissionSetInlinePolicyState state, @Nullable CustomResourceOptions options) {
