...
public class ApnsSandboxChannel extends CustomResource {
    /**
     * The application ID.
     * 
     */
     ...
     */
    public ApnsSandboxChannel(String name, ApnsSandboxChannelArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApnsSandboxChannel(String name, Output<String> id, @Nullable ApnsSandboxChannelState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApnsSandboxChannel get(String name, Output<String> id, @Nullable ApnsSandboxChannelState state, @Nullable CustomResourceOptions options) {
