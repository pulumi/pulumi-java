...
public class LogService extends CustomResource {
    /**
     * The id of directory.
     * 
     */
     ...
     */
    public LogService(String name, LogServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LogService(String name, Output<String> id, @Nullable LogServiceState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LogService get(String name, Output<String> id, @Nullable LogServiceState state, @Nullable CustomResourceOptions options) {
