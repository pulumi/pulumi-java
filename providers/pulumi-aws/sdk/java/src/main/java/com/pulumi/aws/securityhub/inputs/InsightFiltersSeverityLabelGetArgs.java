...
public final class InsightFiltersSeverityLabelGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersSeverityLabelGetArgs(InsightFiltersSeverityLabelGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersSeverityLabelGetArgs();
        }

        public Builder(InsightFiltersSeverityLabelGetArgs defaults) {
            $ = new InsightFiltersSeverityLabelGetArgs(Objects.requireNonNull(defaults));
        }
