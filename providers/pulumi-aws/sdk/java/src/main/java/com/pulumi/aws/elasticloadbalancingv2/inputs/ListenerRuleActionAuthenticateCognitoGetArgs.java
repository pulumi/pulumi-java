...
public final class ListenerRuleActionAuthenticateCognitoGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ListenerRuleActionAuthenticateCognitoGetArgs(ListenerRuleActionAuthenticateCognitoGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListenerRuleActionAuthenticateCognitoGetArgs();
        }

        public Builder(ListenerRuleActionAuthenticateCognitoGetArgs defaults) {
            $ = new ListenerRuleActionAuthenticateCognitoGetArgs(Objects.requireNonNull(defaults));
        }
