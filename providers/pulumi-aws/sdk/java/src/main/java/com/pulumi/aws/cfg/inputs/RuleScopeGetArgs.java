...
public final class RuleScopeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RuleScopeGetArgs(RuleScopeGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleScopeGetArgs();
        }

        public Builder(RuleScopeGetArgs defaults) {
            $ = new RuleScopeGetArgs(Objects.requireNonNull(defaults));
        }
