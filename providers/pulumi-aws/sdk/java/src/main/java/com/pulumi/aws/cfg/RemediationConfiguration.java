...
public class RemediationConfiguration extends CustomResource {
     ...
     */
    public RemediationConfiguration(String name, RemediationConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RemediationConfiguration(String name, Output<String> id, @Nullable RemediationConfigurationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RemediationConfiguration get(String name, Output<String> id, @Nullable RemediationConfigurationState state, @Nullable CustomResourceOptions options) {
