...
public class ReportGroup extends CustomResource {
    /**
     ...
     */
    public ReportGroup(String name, ReportGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReportGroup(String name, Output<String> id, @Nullable ReportGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReportGroup get(String name, Output<String> id, @Nullable ReportGroupState state, @Nullable CustomResourceOptions options) {
