...
public class EventStream extends CustomResource {
    /**
     * The application ID.
     * 
     */
     ...
     */
    public EventStream(String name, EventStreamArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EventStream(String name, Output<String> id, @Nullable EventStreamState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EventStream get(String name, Output<String> id, @Nullable EventStreamState state, @Nullable CustomResourceOptions options) {
