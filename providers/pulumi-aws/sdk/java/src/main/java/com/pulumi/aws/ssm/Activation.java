...
public class Activation extends CustomResource {
    /**
     ...
     */
    public Activation(String name, ActivationArgs args, @Nullable CustomResourceOptions options) {
        super("aws:ssm/activation:Activation", name, args == null ? ActivationArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Activation(String name, Output<String> id, @Nullable ActivationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Activation get(String name, Output<String> id, @Nullable ActivationState state, @Nullable CustomResourceOptions options) {
