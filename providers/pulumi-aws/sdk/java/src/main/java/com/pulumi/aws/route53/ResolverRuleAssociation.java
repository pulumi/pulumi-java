...
public class ResolverRuleAssociation extends CustomResource {
     ...
     */
    public ResolverRuleAssociation(String name, ResolverRuleAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResolverRuleAssociation(String name, Output<String> id, @Nullable ResolverRuleAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResolverRuleAssociation get(String name, Output<String> id, @Nullable ResolverRuleAssociationState state, @Nullable CustomResourceOptions options) {
