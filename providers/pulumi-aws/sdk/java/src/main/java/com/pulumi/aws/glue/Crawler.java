...
public class Crawler extends CustomResource {
     ...
     */
    public Crawler(String name, CrawlerArgs args, @Nullable CustomResourceOptions options) {
        super("aws:glue/crawler:Crawler", name, args == null ? CrawlerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Crawler(String name, Output<String> id, @Nullable CrawlerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Crawler get(String name, Output<String> id, @Nullable CrawlerState state, @Nullable CustomResourceOptions options) {
