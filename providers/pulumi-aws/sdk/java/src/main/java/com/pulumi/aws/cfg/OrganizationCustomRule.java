...
public class OrganizationCustomRule extends CustomResource {
     ...
     */
    public OrganizationCustomRule(String name, OrganizationCustomRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OrganizationCustomRule(String name, Output<String> id, @Nullable OrganizationCustomRuleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OrganizationCustomRule get(String name, Output<String> id, @Nullable OrganizationCustomRuleState state, @Nullable CustomResourceOptions options) {
