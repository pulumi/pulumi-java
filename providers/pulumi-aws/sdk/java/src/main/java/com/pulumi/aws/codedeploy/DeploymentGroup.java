...
public class DeploymentGroup extends CustomResource {
     ...
     */
    public DeploymentGroup(String name, DeploymentGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DeploymentGroup(String name, Output<String> id, @Nullable DeploymentGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DeploymentGroup get(String name, Output<String> id, @Nullable DeploymentGroupState state, @Nullable CustomResourceOptions options) {
