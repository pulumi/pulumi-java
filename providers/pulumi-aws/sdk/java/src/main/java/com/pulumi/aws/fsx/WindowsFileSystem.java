...
public class WindowsFileSystem extends CustomResource {
    /**
     ...
     */
    public WindowsFileSystem(String name, WindowsFileSystemArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WindowsFileSystem(String name, Output<String> id, @Nullable WindowsFileSystemState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WindowsFileSystem get(String name, Output<String> id, @Nullable WindowsFileSystemState state, @Nullable CustomResourceOptions options) {
