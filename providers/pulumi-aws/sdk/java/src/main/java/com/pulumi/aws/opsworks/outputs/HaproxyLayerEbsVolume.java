...
@CustomType
public final class HaproxyLayerEbsVolume {
    ...
    */
    ...
    public static Builder builder(HaproxyLayerEbsVolume defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(HaproxyLayerEbsVolume defaults) {
        ...
        public Builder type(@Nullable String type) {
            this.type = type;
            return this;
        }        public HaproxyLayerEbsVolume build() {
            return new HaproxyLayerEbsVolume(encrypted, iops, mountPoint, numberOfDisks, raidLevel, size, type);
        }
    }
}
