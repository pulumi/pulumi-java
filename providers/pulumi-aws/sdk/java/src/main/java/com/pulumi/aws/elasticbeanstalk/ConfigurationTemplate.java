...
public class ConfigurationTemplate extends CustomResource {
     ...
     */
    public ConfigurationTemplate(String name, ConfigurationTemplateArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConfigurationTemplate(String name, Output<String> id, @Nullable ConfigurationTemplateState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConfigurationTemplate get(String name, Output<String> id, @Nullable ConfigurationTemplateState state, @Nullable CustomResourceOptions options) {
