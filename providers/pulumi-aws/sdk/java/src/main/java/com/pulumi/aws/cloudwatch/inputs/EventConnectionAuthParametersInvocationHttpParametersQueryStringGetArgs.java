...
public final class EventConnectionAuthParametersInvocationHttpParametersQueryStringGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EventConnectionAuthParametersInvocationHttpParametersQueryStringGetArgs(EventConnectionAuthParametersInvocationHttpParametersQueryStringGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EventConnectionAuthParametersInvocationHttpParametersQueryStringGetArgs();
        }

        public Builder(EventConnectionAuthParametersInvocationHttpParametersQueryStringGetArgs defaults) {
            $ = new EventConnectionAuthParametersInvocationHttpParametersQueryStringGetArgs(Objects.requireNonNull(defaults));
        }
