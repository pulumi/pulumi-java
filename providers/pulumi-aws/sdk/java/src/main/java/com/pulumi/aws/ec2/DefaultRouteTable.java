...
public class DefaultRouteTable extends CustomResource {
    /**
     ...
     */
    public DefaultRouteTable(String name, DefaultRouteTableArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DefaultRouteTable(String name, Output<String> id, @Nullable DefaultRouteTableState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DefaultRouteTable get(String name, Output<String> id, @Nullable DefaultRouteTableState state, @Nullable CustomResourceOptions options) {
