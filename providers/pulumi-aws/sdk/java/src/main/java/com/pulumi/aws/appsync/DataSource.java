...
public class DataSource extends CustomResource {
    ...
    private DataSource(String name, Output<String> id, @Nullable DataSourceState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DataSource get(String name, Output<String> id, @Nullable DataSourceState state, @Nullable CustomResourceOptions options) {
