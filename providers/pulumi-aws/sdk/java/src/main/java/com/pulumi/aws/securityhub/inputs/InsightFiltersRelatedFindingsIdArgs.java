...
public final class InsightFiltersRelatedFindingsIdArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersRelatedFindingsIdArgs(InsightFiltersRelatedFindingsIdArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersRelatedFindingsIdArgs();
        }

        public Builder(InsightFiltersRelatedFindingsIdArgs defaults) {
            $ = new InsightFiltersRelatedFindingsIdArgs(Objects.requireNonNull(defaults));
        }
