...
public final class GetLocalGatewaysArgs extends com.pulumi.resources.InvokeArgs {
     ...
     */
    @Import(name="filters")
    private Output</* @Nullable */ List<GetLocalGatewaysFilter>> filters;

    /**
     * @return Custom filter block as described below.
     * 
     */
    public Output</* @Nullable */ List<GetLocalGatewaysFilter>> filters() {
        return this.filters;
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder filters(Output</* @Nullable */ List<GetLocalGatewaysFilter>> filters) {
            $.filters = filters;
            return this;
        }
