...
public class Alias extends CustomResource {
    ...
    private Alias(String name, Output<String> id, @Nullable AliasState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Alias get(String name, Output<String> id, @Nullable AliasState state, @Nullable CustomResourceOptions options) {
