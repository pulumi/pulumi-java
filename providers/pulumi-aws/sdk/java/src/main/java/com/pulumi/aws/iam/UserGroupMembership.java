...
public class UserGroupMembership extends CustomResource {
     ...
     */
    public UserGroupMembership(String name, UserGroupMembershipArgs args, @Nullable CustomResourceOptions options) {
    ...
    private UserGroupMembership(String name, Output<String> id, @Nullable UserGroupMembershipState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UserGroupMembership get(String name, Output<String> id, @Nullable UserGroupMembershipState state, @Nullable CustomResourceOptions options) {
