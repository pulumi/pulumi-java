...
public final class RouteSpecTcpRouteTimeoutIdleGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RouteSpecTcpRouteTimeoutIdleGetArgs(RouteSpecTcpRouteTimeoutIdleGetArgs $) {
        this.unit = $.unit;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RouteSpecTcpRouteTimeoutIdleGetArgs();
        }

        public Builder(RouteSpecTcpRouteTimeoutIdleGetArgs defaults) {
            $ = new RouteSpecTcpRouteTimeoutIdleGetArgs(Objects.requireNonNull(defaults));
        }
