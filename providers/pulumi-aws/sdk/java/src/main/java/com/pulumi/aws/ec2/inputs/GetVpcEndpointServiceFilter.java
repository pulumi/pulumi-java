...
public final class GetVpcEndpointServiceFilter extends InvokeArgs {

    public static final GetVpcEndpointServiceFilter Empty = new GetVpcEndpointServiceFilter();
    ...
    private GetVpcEndpointServiceFilter(GetVpcEndpointServiceFilter $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVpcEndpointServiceFilter();
        }

        public Builder(GetVpcEndpointServiceFilter defaults) {
            $ = new GetVpcEndpointServiceFilter(Objects.requireNonNull(defaults));
        }

        /**
         * @param name The name of the filter field. Valid values can be found in the [EC2 DescribeVpcEndpointServices API Reference](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVpcEndpointServices.html).
         * 
         * @return builder
         * 
         */
