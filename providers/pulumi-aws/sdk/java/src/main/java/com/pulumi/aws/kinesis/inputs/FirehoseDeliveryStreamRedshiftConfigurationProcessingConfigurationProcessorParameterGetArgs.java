...
public final class FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorParameterGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorParameterGetArgs(FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorParameterGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorParameterGetArgs();
        }

        public Builder(FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorParameterGetArgs defaults) {
            $ = new FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorParameterGetArgs(Objects.requireNonNull(defaults));
        }
