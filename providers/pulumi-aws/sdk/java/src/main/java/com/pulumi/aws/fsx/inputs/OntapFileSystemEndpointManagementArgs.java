...
public final class OntapFileSystemEndpointManagementArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OntapFileSystemEndpointManagementArgs(OntapFileSystemEndpointManagementArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OntapFileSystemEndpointManagementArgs();
        }

        public Builder(OntapFileSystemEndpointManagementArgs defaults) {
            $ = new OntapFileSystemEndpointManagementArgs(Objects.requireNonNull(defaults));
        }
