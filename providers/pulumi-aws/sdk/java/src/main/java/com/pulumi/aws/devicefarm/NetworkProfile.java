...
public class NetworkProfile extends CustomResource {
    ...
    private NetworkProfile(String name, Output<String> id, @Nullable NetworkProfileState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkProfile get(String name, Output<String> id, @Nullable NetworkProfileState state, @Nullable CustomResourceOptions options) {
