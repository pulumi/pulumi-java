...
public class VpcIpamOrganizationAdminAccount extends CustomResource {
     ...
     */
    public VpcIpamOrganizationAdminAccount(String name, VpcIpamOrganizationAdminAccountArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VpcIpamOrganizationAdminAccount(String name, Output<String> id, @Nullable VpcIpamOrganizationAdminAccountState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpcIpamOrganizationAdminAccount get(String name, Output<String> id, @Nullable VpcIpamOrganizationAdminAccountState state, @Nullable CustomResourceOptions options) {
