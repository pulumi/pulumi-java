...
public class AnalyticsConfiguration extends CustomResource {
     ...
     */
    public AnalyticsConfiguration(String name, AnalyticsConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AnalyticsConfiguration(String name, Output<String> id, @Nullable AnalyticsConfigurationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AnalyticsConfiguration get(String name, Output<String> id, @Nullable AnalyticsConfigurationState state, @Nullable CustomResourceOptions options) {
