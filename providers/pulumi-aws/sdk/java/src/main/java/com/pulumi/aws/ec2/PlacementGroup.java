...
public class PlacementGroup extends CustomResource {
     ...
     */
    public PlacementGroup(String name, PlacementGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PlacementGroup(String name, Output<String> id, @Nullable PlacementGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PlacementGroup get(String name, Output<String> id, @Nullable PlacementGroupState state, @Nullable CustomResourceOptions options) {
