...
public final class PartitionStorageDescriptorColumnGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PartitionStorageDescriptorColumnGetArgs(PartitionStorageDescriptorColumnGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PartitionStorageDescriptorColumnGetArgs();
        }

        public Builder(PartitionStorageDescriptorColumnGetArgs defaults) {
            $ = new PartitionStorageDescriptorColumnGetArgs(Objects.requireNonNull(defaults));
        }
