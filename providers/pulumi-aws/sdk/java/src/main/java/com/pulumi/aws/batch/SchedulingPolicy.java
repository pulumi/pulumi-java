...
public class SchedulingPolicy extends CustomResource {
    ...
    private SchedulingPolicy(String name, Output<String> id, @Nullable SchedulingPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SchedulingPolicy get(String name, Output<String> id, @Nullable SchedulingPolicyState state, @Nullable CustomResourceOptions options) {
