...
public class QuickConnect extends CustomResource {
    ...
    private QuickConnect(String name, Output<String> id, @Nullable QuickConnectState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static QuickConnect get(String name, Output<String> id, @Nullable QuickConnectState state, @Nullable CustomResourceOptions options) {
