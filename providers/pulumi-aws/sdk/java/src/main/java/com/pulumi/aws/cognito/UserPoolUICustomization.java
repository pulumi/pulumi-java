...
public class UserPoolUICustomization extends CustomResource {
     ...
     */
    public UserPoolUICustomization(String name, UserPoolUICustomizationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private UserPoolUICustomization(String name, Output<String> id, @Nullable UserPoolUICustomizationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UserPoolUICustomization get(String name, Output<String> id, @Nullable UserPoolUICustomizationState state, @Nullable CustomResourceOptions options) {
