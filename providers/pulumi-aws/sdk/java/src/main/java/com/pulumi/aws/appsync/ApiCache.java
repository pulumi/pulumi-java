...
public class ApiCache extends CustomResource {
    /**
     ...
     */
    public ApiCache(String name, ApiCacheArgs args, @Nullable CustomResourceOptions options) {
        super("aws:appsync/apiCache:ApiCache", name, args == null ? ApiCacheArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ApiCache(String name, Output<String> id, @Nullable ApiCacheState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApiCache get(String name, Output<String> id, @Nullable ApiCacheState state, @Nullable CustomResourceOptions options) {
