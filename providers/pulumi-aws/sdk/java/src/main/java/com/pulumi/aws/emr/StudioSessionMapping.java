...
public class StudioSessionMapping extends CustomResource {
    ...
    private StudioSessionMapping(String name, Output<String> id, @Nullable StudioSessionMappingState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StudioSessionMapping get(String name, Output<String> id, @Nullable StudioSessionMappingState state, @Nullable CustomResourceOptions options) {
