...
public final class GetEipsArgs extends com.pulumi.resources.InvokeArgs {
     ...
     */
    @Import(name="filters")
    private Output</* @Nullable */ List<GetEipsFilter>> filters;

    /**
     * @return Custom filter block as described below.
     * 
     */
    public Output</* @Nullable */ List<GetEipsFilter>> filters() {
        return this.filters;
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder filters(Output</* @Nullable */ List<GetEipsFilter>> filters) {
            $.filters = filters;
            return this;
        }
