...
public class CustomDomainAssociation extends CustomResource {
     ...
     */
    public CustomDomainAssociation(String name, CustomDomainAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CustomDomainAssociation(String name, Output<String> id, @Nullable CustomDomainAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomDomainAssociation get(String name, Output<String> id, @Nullable CustomDomainAssociationState state, @Nullable CustomResourceOptions options) {
