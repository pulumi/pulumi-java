...
public class SlotType extends CustomResource {
     ...
     */
    public SlotType(String name, SlotTypeArgs args, @Nullable CustomResourceOptions options) {
        super("aws:lex/slotType:SlotType", name, args == null ? SlotTypeArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SlotType(String name, Output<String> id, @Nullable SlotTypeState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SlotType get(String name, Output<String> id, @Nullable SlotTypeState state, @Nullable CustomResourceOptions options) {
