...
public final class WebAclRuleActionBlockCustomResponseResponseHeaderGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WebAclRuleActionBlockCustomResponseResponseHeaderGetArgs(WebAclRuleActionBlockCustomResponseResponseHeaderGetArgs $) {
        this.name = $.name;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleActionBlockCustomResponseResponseHeaderGetArgs();
        }

        public Builder(WebAclRuleActionBlockCustomResponseResponseHeaderGetArgs defaults) {
            $ = new WebAclRuleActionBlockCustomResponseResponseHeaderGetArgs(Objects.requireNonNull(defaults));
        }
