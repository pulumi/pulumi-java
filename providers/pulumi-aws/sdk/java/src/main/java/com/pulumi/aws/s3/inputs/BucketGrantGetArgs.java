...
public final class BucketGrantGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private BucketGrantGetArgs(BucketGrantGetArgs $) {
        this.id = $.id;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BucketGrantGetArgs();
        }

        public Builder(BucketGrantGetArgs defaults) {
            $ = new BucketGrantGetArgs(Objects.requireNonNull(defaults));
        }
