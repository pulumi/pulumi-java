...
public final class VirtualNodeSpecListenerConnectionPoolGrpcGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private VirtualNodeSpecListenerConnectionPoolGrpcGetArgs(VirtualNodeSpecListenerConnectionPoolGrpcGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualNodeSpecListenerConnectionPoolGrpcGetArgs();
        }

        public Builder(VirtualNodeSpecListenerConnectionPoolGrpcGetArgs defaults) {
            $ = new VirtualNodeSpecListenerConnectionPoolGrpcGetArgs(Objects.requireNonNull(defaults));
        }
