...
public final class CrawlerMongodbTargetGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CrawlerMongodbTargetGetArgs(CrawlerMongodbTargetGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CrawlerMongodbTargetGetArgs();
        }

        public Builder(CrawlerMongodbTargetGetArgs defaults) {
            $ = new CrawlerMongodbTargetGetArgs(Objects.requireNonNull(defaults));
        }
