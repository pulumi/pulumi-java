...
public class DataLakeSettings extends CustomResource {
     ...
     */
    public DataLakeSettings(String name, @Nullable DataLakeSettingsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DataLakeSettings(String name, Output<String> id, @Nullable DataLakeSettingsState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DataLakeSettings get(String name, Output<String> id, @Nullable DataLakeSettingsState state, @Nullable CustomResourceOptions options) {
