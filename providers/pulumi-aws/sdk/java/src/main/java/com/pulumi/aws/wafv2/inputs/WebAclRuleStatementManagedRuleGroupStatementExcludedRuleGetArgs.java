...
public final class WebAclRuleStatementManagedRuleGroupStatementExcludedRuleGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WebAclRuleStatementManagedRuleGroupStatementExcludedRuleGetArgs(WebAclRuleStatementManagedRuleGroupStatementExcludedRuleGetArgs $) {
        this.name = $.name;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementManagedRuleGroupStatementExcludedRuleGetArgs();
        }

        public Builder(WebAclRuleStatementManagedRuleGroupStatementExcludedRuleGetArgs defaults) {
            $ = new WebAclRuleStatementManagedRuleGroupStatementExcludedRuleGetArgs(Objects.requireNonNull(defaults));
        }
