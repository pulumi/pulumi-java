...
public class MaintenanceWindowTarget extends CustomResource {
    /**
     ...
     */
    public MaintenanceWindowTarget(String name, MaintenanceWindowTargetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MaintenanceWindowTarget(String name, Output<String> id, @Nullable MaintenanceWindowTargetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MaintenanceWindowTarget get(String name, Output<String> id, @Nullable MaintenanceWindowTargetState state, @Nullable CustomResourceOptions options) {
