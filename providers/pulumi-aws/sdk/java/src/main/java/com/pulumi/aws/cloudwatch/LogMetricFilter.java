...
public class LogMetricFilter extends CustomResource {
     ...
     */
    public LogMetricFilter(String name, LogMetricFilterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LogMetricFilter(String name, Output<String> id, @Nullable LogMetricFilterState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LogMetricFilter get(String name, Output<String> id, @Nullable LogMetricFilterState state, @Nullable CustomResourceOptions options) {
