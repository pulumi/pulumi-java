...
import com.pulumi.aws.docdb.inputs.ClusterParameterGroupState;
import com.pulumi.aws.docdb.outputs.ClusterParameterGroupParameter;
...
public class ClusterParameterGroup extends com.pulumi.resources.CustomResource {
    ...
    public ClusterParameterGroup(String name, ClusterParameterGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:docdb/clusterParameterGroup:ClusterParameterGroup", name, args == null ? ClusterParameterGroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
