...
public final class DataLakeSettingsCreateDatabaseDefaultPermissionGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DataLakeSettingsCreateDatabaseDefaultPermissionGetArgs(DataLakeSettingsCreateDatabaseDefaultPermissionGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataLakeSettingsCreateDatabaseDefaultPermissionGetArgs();
        }

        public Builder(DataLakeSettingsCreateDatabaseDefaultPermissionGetArgs defaults) {
            $ = new DataLakeSettingsCreateDatabaseDefaultPermissionGetArgs(Objects.requireNonNull(defaults));
        }
