...
public class BgpPeer extends CustomResource {
     ...
     */
    public BgpPeer(String name, BgpPeerArgs args, @Nullable CustomResourceOptions options) {
        super("aws:directconnect/bgpPeer:BgpPeer", name, args == null ? BgpPeerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private BgpPeer(String name, Output<String> id, @Nullable BgpPeerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BgpPeer get(String name, Output<String> id, @Nullable BgpPeerState state, @Nullable CustomResourceOptions options) {
