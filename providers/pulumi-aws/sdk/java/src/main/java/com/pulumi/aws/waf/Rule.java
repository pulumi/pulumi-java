...
public class Rule extends CustomResource {
    ...
    private Rule(String name, Output<String> id, @Nullable RuleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Rule get(String name, Output<String> id, @Nullable RuleState state, @Nullable CustomResourceOptions options) {
