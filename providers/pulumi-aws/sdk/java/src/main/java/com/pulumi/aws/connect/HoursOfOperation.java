...
public class HoursOfOperation extends CustomResource {
    ...
    private HoursOfOperation(String name, Output<String> id, @Nullable HoursOfOperationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HoursOfOperation get(String name, Output<String> id, @Nullable HoursOfOperationState state, @Nullable CustomResourceOptions options) {
