...
public class EventArchive extends CustomResource {
    /**
     ...
     */
    public EventArchive(String name, EventArchiveArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EventArchive(String name, Output<String> id, @Nullable EventArchiveState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EventArchive get(String name, Output<String> id, @Nullable EventArchiveState state, @Nullable CustomResourceOptions options) {
