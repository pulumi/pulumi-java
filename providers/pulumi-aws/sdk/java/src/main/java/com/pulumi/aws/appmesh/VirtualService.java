...
public class VirtualService extends CustomResource {
    /**
     ...
     */
    public VirtualService(String name, VirtualServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualService(String name, Output<String> id, @Nullable VirtualServiceState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualService get(String name, Output<String> id, @Nullable VirtualServiceState state, @Nullable CustomResourceOptions options) {
