...
public class OrganizationsAccess extends CustomResource {
     ...
     */
    public OrganizationsAccess(String name, OrganizationsAccessArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OrganizationsAccess(String name, Output<String> id, @Nullable OrganizationsAccessState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OrganizationsAccess get(String name, Output<String> id, @Nullable OrganizationsAccessState state, @Nullable CustomResourceOptions options) {
