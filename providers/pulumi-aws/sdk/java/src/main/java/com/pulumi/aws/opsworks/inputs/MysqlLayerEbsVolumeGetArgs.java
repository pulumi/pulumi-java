...
public final class MysqlLayerEbsVolumeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MysqlLayerEbsVolumeGetArgs(MysqlLayerEbsVolumeGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MysqlLayerEbsVolumeGetArgs();
        }

        public Builder(MysqlLayerEbsVolumeGetArgs defaults) {
            $ = new MysqlLayerEbsVolumeGetArgs(Objects.requireNonNull(defaults));
        }
