...
public final class InsightFiltersResourceAwsS3BucketOwnerNameGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersResourceAwsS3BucketOwnerNameGetArgs(InsightFiltersResourceAwsS3BucketOwnerNameGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersResourceAwsS3BucketOwnerNameGetArgs();
        }

        public Builder(InsightFiltersResourceAwsS3BucketOwnerNameGetArgs defaults) {
            $ = new InsightFiltersResourceAwsS3BucketOwnerNameGetArgs(Objects.requireNonNull(defaults));
        }
