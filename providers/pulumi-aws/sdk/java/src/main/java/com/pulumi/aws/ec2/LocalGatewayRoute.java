...
public class LocalGatewayRoute extends CustomResource {
     ...
     */
    public LocalGatewayRoute(String name, LocalGatewayRouteArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LocalGatewayRoute(String name, Output<String> id, @Nullable LocalGatewayRouteState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LocalGatewayRoute get(String name, Output<String> id, @Nullable LocalGatewayRouteState state, @Nullable CustomResourceOptions options) {
