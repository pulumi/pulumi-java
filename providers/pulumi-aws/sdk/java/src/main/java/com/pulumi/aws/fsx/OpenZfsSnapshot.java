...
public class OpenZfsSnapshot extends CustomResource {
    /**
     ...
     */
    public OpenZfsSnapshot(String name, OpenZfsSnapshotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OpenZfsSnapshot(String name, Output<String> id, @Nullable OpenZfsSnapshotState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OpenZfsSnapshot get(String name, Output<String> id, @Nullable OpenZfsSnapshotState state, @Nullable CustomResourceOptions options) {
