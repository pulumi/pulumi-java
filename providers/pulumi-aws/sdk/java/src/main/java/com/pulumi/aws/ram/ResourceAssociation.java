...
public class ResourceAssociation extends CustomResource {
    ...
    private ResourceAssociation(String name, Output<String> id, @Nullable ResourceAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResourceAssociation get(String name, Output<String> id, @Nullable ResourceAssociationState state, @Nullable CustomResourceOptions options) {
