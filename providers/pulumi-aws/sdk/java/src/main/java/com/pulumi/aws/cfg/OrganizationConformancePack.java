...
public class OrganizationConformancePack extends CustomResource {
    /**
     ...
     */
    public OrganizationConformancePack(String name, @Nullable OrganizationConformancePackArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OrganizationConformancePack(String name, Output<String> id, @Nullable OrganizationConformancePackState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OrganizationConformancePack get(String name, Output<String> id, @Nullable OrganizationConformancePackState state, @Nullable CustomResourceOptions options) {
