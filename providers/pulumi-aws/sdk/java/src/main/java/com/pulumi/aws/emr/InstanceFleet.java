...
public class InstanceFleet extends CustomResource {
     ...
     */
    public InstanceFleet(String name, InstanceFleetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private InstanceFleet(String name, Output<String> id, @Nullable InstanceFleetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static InstanceFleet get(String name, Output<String> id, @Nullable InstanceFleetState state, @Nullable CustomResourceOptions options) {
