...
public final class EnvironmentLoggingConfigurationDagProcessingLogsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EnvironmentLoggingConfigurationDagProcessingLogsGetArgs(EnvironmentLoggingConfigurationDagProcessingLogsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EnvironmentLoggingConfigurationDagProcessingLogsGetArgs();
        }

        public Builder(EnvironmentLoggingConfigurationDagProcessingLogsGetArgs defaults) {
            $ = new EnvironmentLoggingConfigurationDagProcessingLogsGetArgs(Objects.requireNonNull(defaults));
        }
