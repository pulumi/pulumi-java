...
public class CustomLayer extends CustomResource {
    /**
     ...
     */
    public CustomLayer(String name, CustomLayerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CustomLayer(String name, Output<String> id, @Nullable CustomLayerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomLayer get(String name, Output<String> id, @Nullable CustomLayerState state, @Nullable CustomResourceOptions options) {
