...
public class Response extends CustomResource {
     ...
     */
    public Response(String name, ResponseArgs args, @Nullable CustomResourceOptions options) {
        super("aws:apigateway/response:Response", name, args == null ? ResponseArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Response(String name, Output<String> id, @Nullable ResponseState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Response get(String name, Output<String> id, @Nullable ResponseState state, @Nullable CustomResourceOptions options) {
