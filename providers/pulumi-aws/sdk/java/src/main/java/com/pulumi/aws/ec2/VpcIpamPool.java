...
public class VpcIpamPool extends CustomResource {
     ...
     */
    public VpcIpamPool(String name, VpcIpamPoolArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VpcIpamPool(String name, Output<String> id, @Nullable VpcIpamPoolState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpcIpamPool get(String name, Output<String> id, @Nullable VpcIpamPoolState state, @Nullable CustomResourceOptions options) {
