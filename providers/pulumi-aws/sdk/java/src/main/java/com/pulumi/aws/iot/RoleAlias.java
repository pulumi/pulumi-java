...
public class RoleAlias extends CustomResource {
    /**
     ...
     */
    public RoleAlias(String name, RoleAliasArgs args, @Nullable CustomResourceOptions options) {
        super("aws:iot/roleAlias:RoleAlias", name, args == null ? RoleAliasArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RoleAlias(String name, Output<String> id, @Nullable RoleAliasState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RoleAlias get(String name, Output<String> id, @Nullable RoleAliasState state, @Nullable CustomResourceOptions options) {
