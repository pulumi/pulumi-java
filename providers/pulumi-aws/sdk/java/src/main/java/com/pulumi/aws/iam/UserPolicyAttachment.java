...
public class UserPolicyAttachment extends CustomResource {
     ...
     */
    public UserPolicyAttachment(String name, UserPolicyAttachmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private UserPolicyAttachment(String name, Output<String> id, @Nullable UserPolicyAttachmentState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UserPolicyAttachment get(String name, Output<String> id, @Nullable UserPolicyAttachmentState state, @Nullable CustomResourceOptions options) {
