...
public class FindingsFilter extends CustomResource {
    /**
     ...
     */
    public FindingsFilter(String name, FindingsFilterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FindingsFilter(String name, Output<String> id, @Nullable FindingsFilterState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FindingsFilter get(String name, Output<String> id, @Nullable FindingsFilterState state, @Nullable CustomResourceOptions options) {
