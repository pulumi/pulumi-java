...
public class RateBasedRule extends CustomResource {
     ...
     */
    public RateBasedRule(String name, RateBasedRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RateBasedRule(String name, Output<String> id, @Nullable RateBasedRuleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RateBasedRule get(String name, Output<String> id, @Nullable RateBasedRuleState state, @Nullable CustomResourceOptions options) {
