...
public class Bot extends CustomResource {
    ...
    private Bot(String name, Output<String> id, @Nullable BotState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Bot get(String name, Output<String> id, @Nullable BotState state, @Nullable CustomResourceOptions options) {
