...
public class StaticIpAttachment extends CustomResource {
     ...
     */
    public StaticIpAttachment(String name, StaticIpAttachmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StaticIpAttachment(String name, Output<String> id, @Nullable StaticIpAttachmentState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StaticIpAttachment get(String name, Output<String> id, @Nullable StaticIpAttachmentState state, @Nullable CustomResourceOptions options) {
