...
public class VoiceConnectorTerminationCredentials extends CustomResource {
     ...
     */
    public VoiceConnectorTerminationCredentials(String name, VoiceConnectorTerminationCredentialsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VoiceConnectorTerminationCredentials(String name, Output<String> id, @Nullable VoiceConnectorTerminationCredentialsState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VoiceConnectorTerminationCredentials get(String name, Output<String> id, @Nullable VoiceConnectorTerminationCredentialsState state, @Nullable CustomResourceOptions options) {
