...
public class TransitGateway extends CustomResource {
    ...
    private TransitGateway(String name, Output<String> id, @Nullable TransitGatewayState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TransitGateway get(String name, Output<String> id, @Nullable TransitGatewayState state, @Nullable CustomResourceOptions options) {
