 ...
 *                                     jsonProperty(&#34;aws:SourceAccount&#34;, current.apply(getCallerIdentityResult -&gt; getCallerIdentityResult.getAccountId()))
 *                                 )),
 ...
 *                             jsonProperty(&#34;Effect&#34;, &#34;Allow&#34;),
 *                             jsonProperty(&#34;Principal&#34;, jsonObject(
 *                                 jsonProperty(&#34;AWS&#34;, String.format(&#34;arn:aws:iam::%s:root&#34;, current.apply(getCallerIdentityResult -&gt; getCallerIdentityResult.getAccountId())))
 *                             )),
 *                             jsonProperty(&#34;Resource&#34;, &#34;*&#34;),
 ...
 *             .hostedZoneId(aws_route53_zone.getTest().getId())
 *             .keyManagementServiceArn(aws_kms_key.getTest().getArn())
 *             .build());
 * 
