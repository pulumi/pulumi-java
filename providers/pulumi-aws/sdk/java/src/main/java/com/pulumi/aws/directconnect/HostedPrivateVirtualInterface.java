...
public class HostedPrivateVirtualInterface extends CustomResource {
     ...
     */
    public HostedPrivateVirtualInterface(String name, HostedPrivateVirtualInterfaceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HostedPrivateVirtualInterface(String name, Output<String> id, @Nullable HostedPrivateVirtualInterfaceState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HostedPrivateVirtualInterface get(String name, Output<String> id, @Nullable HostedPrivateVirtualInterfaceState state, @Nullable CustomResourceOptions options) {
