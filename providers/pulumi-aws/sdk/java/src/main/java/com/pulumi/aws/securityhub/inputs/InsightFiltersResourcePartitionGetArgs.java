...
public final class InsightFiltersResourcePartitionGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final InsightFiltersResourcePartitionGetArgs Empty = new InsightFiltersResourcePartitionGetArgs();
    ...
    private InsightFiltersResourcePartitionGetArgs() {}

    private InsightFiltersResourcePartitionGetArgs(InsightFiltersResourcePartitionGetArgs $) {
    ...
    public static Builder builder(InsightFiltersResourcePartitionGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersResourcePartitionGetArgs();
        }

        public Builder(InsightFiltersResourcePartitionGetArgs defaults) {
            $ = new InsightFiltersResourcePartitionGetArgs(Objects.requireNonNull(defaults));
        }
