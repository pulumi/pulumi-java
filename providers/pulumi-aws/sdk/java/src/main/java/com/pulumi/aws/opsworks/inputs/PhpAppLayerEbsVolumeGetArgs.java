...
public final class PhpAppLayerEbsVolumeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PhpAppLayerEbsVolumeGetArgs(PhpAppLayerEbsVolumeGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PhpAppLayerEbsVolumeGetArgs();
        }

        public Builder(PhpAppLayerEbsVolumeGetArgs defaults) {
            $ = new PhpAppLayerEbsVolumeGetArgs(Objects.requireNonNull(defaults));
        }
