...
public final class JavaAppLayerCloudwatchConfigurationLogStreamArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public JavaAppLayerCloudwatchConfigurationLogStreamArgs(
    ...
    public static final class Builder {
        ...
        public Builder timeZone(@Nullable String timeZone) {
            ...
            return new JavaAppLayerCloudwatchConfigurationLogStreamArgs(batchCount, batchSize, bufferDuration, datetimeFormat, encoding, file, fileFingerprintLines, initialPosition, logGroupName, multilineStartPattern, timeZone);
        }
    }
}
