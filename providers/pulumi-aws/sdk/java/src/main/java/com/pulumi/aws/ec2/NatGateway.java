...
public class NatGateway extends CustomResource {
    ...
    private NatGateway(String name, Output<String> id, @Nullable NatGatewayState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NatGateway get(String name, Output<String> id, @Nullable NatGatewayState state, @Nullable CustomResourceOptions options) {
