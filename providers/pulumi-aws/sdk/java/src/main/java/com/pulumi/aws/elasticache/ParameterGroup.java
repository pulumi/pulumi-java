...
public class ParameterGroup extends CustomResource {
    /**
     ...
     */
    public ParameterGroup(String name, ParameterGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ParameterGroup(String name, Output<String> id, @Nullable ParameterGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ParameterGroup get(String name, Output<String> id, @Nullable ParameterGroupState state, @Nullable CustomResourceOptions options) {
