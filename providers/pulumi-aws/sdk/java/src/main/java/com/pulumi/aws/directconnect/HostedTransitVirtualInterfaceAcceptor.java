...
public class HostedTransitVirtualInterfaceAcceptor extends CustomResource {
    /**
     ...
     */
    public HostedTransitVirtualInterfaceAcceptor(String name, HostedTransitVirtualInterfaceAcceptorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HostedTransitVirtualInterfaceAcceptor(String name, Output<String> id, @Nullable HostedTransitVirtualInterfaceAcceptorState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HostedTransitVirtualInterfaceAcceptor get(String name, Output<String> id, @Nullable HostedTransitVirtualInterfaceAcceptorState state, @Nullable CustomResourceOptions options) {
