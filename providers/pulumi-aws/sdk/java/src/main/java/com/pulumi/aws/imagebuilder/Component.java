...
public class Component extends CustomResource {
    ...
    private Component(String name, Output<String> id, @Nullable ComponentState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Component get(String name, Output<String> id, @Nullable ComponentState state, @Nullable CustomResourceOptions options) {
