...
public class ReplicationGroup extends CustomResource {
     ...
     */
    public ReplicationGroup(String name, ReplicationGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReplicationGroup(String name, Output<String> id, @Nullable ReplicationGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReplicationGroup get(String name, Output<String> id, @Nullable ReplicationGroupState state, @Nullable CustomResourceOptions options) {
