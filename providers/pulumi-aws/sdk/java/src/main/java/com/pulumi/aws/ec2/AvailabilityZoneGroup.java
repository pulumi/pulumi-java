...
public class AvailabilityZoneGroup extends CustomResource {
    /**
     ...
     */
    public AvailabilityZoneGroup(String name, AvailabilityZoneGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AvailabilityZoneGroup(String name, Output<String> id, @Nullable AvailabilityZoneGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AvailabilityZoneGroup get(String name, Output<String> id, @Nullable AvailabilityZoneGroupState state, @Nullable CustomResourceOptions options) {
