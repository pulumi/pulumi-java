...
public class StandardsSubscription extends CustomResource {
    /**
     ...
     */
    public StandardsSubscription(String name, StandardsSubscriptionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StandardsSubscription(String name, Output<String> id, @Nullable StandardsSubscriptionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StandardsSubscription get(String name, Output<String> id, @Nullable StandardsSubscriptionState state, @Nullable CustomResourceOptions options) {
