...
public final class DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecArgs(DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecArgs $) {
    ...
    public static Builder builder(DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecArgs();
        }

        public Builder(DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecArgs defaults) {
            $ = new DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecArgs(Objects.requireNonNull(defaults));
        }
