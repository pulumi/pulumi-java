...
public class Schedule extends CustomResource {
    ...
    private Schedule(String name, Output<String> id, @Nullable ScheduleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Schedule get(String name, Output<String> id, @Nullable ScheduleState state, @Nullable CustomResourceOptions options) {
