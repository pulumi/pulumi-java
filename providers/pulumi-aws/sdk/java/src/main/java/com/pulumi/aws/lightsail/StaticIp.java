...
public class StaticIp extends CustomResource {
    ...
    private StaticIp(String name, Output<String> id, @Nullable StaticIpState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StaticIp get(String name, Output<String> id, @Nullable StaticIpState state, @Nullable CustomResourceOptions options) {
