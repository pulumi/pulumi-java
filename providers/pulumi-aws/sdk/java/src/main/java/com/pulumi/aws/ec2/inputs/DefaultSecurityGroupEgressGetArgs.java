...
public final class DefaultSecurityGroupEgressGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DefaultSecurityGroupEgressGetArgs(DefaultSecurityGroupEgressGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DefaultSecurityGroupEgressGetArgs();
        }

        public Builder(DefaultSecurityGroupEgressGetArgs defaults) {
            $ = new DefaultSecurityGroupEgressGetArgs(Objects.requireNonNull(defaults));
        }
