...
public final class ApiCorsConfigurationGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ApiCorsConfigurationGetArgs(ApiCorsConfigurationGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApiCorsConfigurationGetArgs();
        }

        public Builder(ApiCorsConfigurationGetArgs defaults) {
            $ = new ApiCorsConfigurationGetArgs(Objects.requireNonNull(defaults));
        }
