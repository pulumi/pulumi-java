...
public class SpotDatafeedSubscription extends CustomResource {
     ...
     */
    public SpotDatafeedSubscription(String name, SpotDatafeedSubscriptionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SpotDatafeedSubscription(String name, Output<String> id, @Nullable SpotDatafeedSubscriptionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SpotDatafeedSubscription get(String name, Output<String> id, @Nullable SpotDatafeedSubscriptionState state, @Nullable CustomResourceOptions options) {
