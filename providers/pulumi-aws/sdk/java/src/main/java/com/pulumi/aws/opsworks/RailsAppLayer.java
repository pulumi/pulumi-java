...
public class RailsAppLayer extends CustomResource {
    /**
     ...
     */
    public RailsAppLayer(String name, RailsAppLayerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RailsAppLayer(String name, Output<String> id, @Nullable RailsAppLayerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RailsAppLayer get(String name, Output<String> id, @Nullable RailsAppLayerState state, @Nullable CustomResourceOptions options) {
