...
public class TrafficMirrorFilter extends CustomResource {
    /**
     ...
     */
    public TrafficMirrorFilter(String name, @Nullable TrafficMirrorFilterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TrafficMirrorFilter(String name, Output<String> id, @Nullable TrafficMirrorFilterState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TrafficMirrorFilter get(String name, Output<String> id, @Nullable TrafficMirrorFilterState state, @Nullable CustomResourceOptions options) {
