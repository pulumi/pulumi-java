...
public final class VirtualGatewaySpecListenerPortMappingGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private VirtualGatewaySpecListenerPortMappingGetArgs(VirtualGatewaySpecListenerPortMappingGetArgs $) {
        this.port = $.port;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualGatewaySpecListenerPortMappingGetArgs();
        }

        public Builder(VirtualGatewaySpecListenerPortMappingGetArgs defaults) {
            $ = new VirtualGatewaySpecListenerPortMappingGetArgs(Objects.requireNonNull(defaults));
        }
