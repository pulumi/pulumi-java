...
public class Resolver extends CustomResource {
     ...
     */
    public Resolver(String name, ResolverArgs args, @Nullable CustomResourceOptions options) {
        super("aws:appsync/resolver:Resolver", name, args == null ? ResolverArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Resolver(String name, Output<String> id, @Nullable ResolverState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Resolver get(String name, Output<String> id, @Nullable ResolverState state, @Nullable CustomResourceOptions options) {
