...
public class ApplicationVersion extends CustomResource {
    /**
     ...
     */
    public ApplicationVersion(String name, ApplicationVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApplicationVersion(String name, Output<String> id, @Nullable ApplicationVersionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApplicationVersion get(String name, Output<String> id, @Nullable ApplicationVersionState state, @Nullable CustomResourceOptions options) {
