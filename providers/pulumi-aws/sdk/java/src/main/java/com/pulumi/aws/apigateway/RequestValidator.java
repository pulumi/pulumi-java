...
public class RequestValidator extends CustomResource {
    ...
    private RequestValidator(String name, Output<String> id, @Nullable RequestValidatorState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RequestValidator get(String name, Output<String> id, @Nullable RequestValidatorState state, @Nullable CustomResourceOptions options) {
