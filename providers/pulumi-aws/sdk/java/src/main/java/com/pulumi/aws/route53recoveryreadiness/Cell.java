...
public class Cell extends CustomResource {
    /**
     * ARN of the cell
     * 
     */
     ...
     */
    public Cell(String name, CellArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Cell(String name, Output<String> id, @Nullable CellState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Cell get(String name, Output<String> id, @Nullable CellState state, @Nullable CustomResourceOptions options) {
