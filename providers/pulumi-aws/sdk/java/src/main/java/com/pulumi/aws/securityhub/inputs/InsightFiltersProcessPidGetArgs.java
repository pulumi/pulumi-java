...
public final class InsightFiltersProcessPidGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final InsightFiltersProcessPidGetArgs Empty = new InsightFiltersProcessPidGetArgs();
    ...
    private InsightFiltersProcessPidGetArgs(InsightFiltersProcessPidGetArgs $) {
        this.eq = $.eq;
        this.gte = $.gte;
        this.lte = $.lte;
    }
    ...
    public static Builder builder(InsightFiltersProcessPidGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersProcessPidGetArgs();
        }

        public Builder(InsightFiltersProcessPidGetArgs defaults) {
            $ = new InsightFiltersProcessPidGetArgs(Objects.requireNonNull(defaults));
        }
