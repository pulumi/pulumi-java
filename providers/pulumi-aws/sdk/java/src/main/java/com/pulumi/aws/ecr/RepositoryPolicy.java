...
public class RepositoryPolicy extends CustomResource {
     ...
     */
    public RepositoryPolicy(String name, RepositoryPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RepositoryPolicy(String name, Output<String> id, @Nullable RepositoryPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RepositoryPolicy get(String name, Output<String> id, @Nullable RepositoryPolicyState state, @Nullable CustomResourceOptions options) {
