...
public class ScramSecretAssociation extends CustomResource {
     ...
     */
    public ScramSecretAssociation(String name, ScramSecretAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ScramSecretAssociation(String name, Output<String> id, @Nullable ScramSecretAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ScramSecretAssociation get(String name, Output<String> id, @Nullable ScramSecretAssociationState state, @Nullable CustomResourceOptions options) {
