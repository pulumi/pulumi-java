...
public class ApprovalRuleTemplate extends CustomResource {
     ...
     */
    public ApprovalRuleTemplate(String name, ApprovalRuleTemplateArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApprovalRuleTemplate(String name, Output<String> id, @Nullable ApprovalRuleTemplateState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApprovalRuleTemplate get(String name, Output<String> id, @Nullable ApprovalRuleTemplateState state, @Nullable CustomResourceOptions options) {
