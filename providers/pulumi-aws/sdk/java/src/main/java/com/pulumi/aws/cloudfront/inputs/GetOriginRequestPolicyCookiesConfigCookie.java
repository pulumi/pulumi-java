...
public final class GetOriginRequestPolicyCookiesConfigCookie extends com.pulumi.resources.InvokeArgs {
    ...
    private GetOriginRequestPolicyCookiesConfigCookie(GetOriginRequestPolicyCookiesConfigCookie $) {
        this.items = $.items;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOriginRequestPolicyCookiesConfigCookie();
        }

        public Builder(GetOriginRequestPolicyCookiesConfigCookie defaults) {
            $ = new GetOriginRequestPolicyCookiesConfigCookie(Objects.requireNonNull(defaults));
        }
