...
public class BucketOwnershipControls extends CustomResource {
     ...
     */
    public BucketOwnershipControls(String name, BucketOwnershipControlsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BucketOwnershipControls(String name, Output<String> id, @Nullable BucketOwnershipControlsState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BucketOwnershipControls get(String name, Output<String> id, @Nullable BucketOwnershipControlsState state, @Nullable CustomResourceOptions options) {
