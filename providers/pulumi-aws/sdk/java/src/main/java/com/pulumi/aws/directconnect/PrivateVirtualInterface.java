...
public class PrivateVirtualInterface extends CustomResource {
    /**
     ...
     */
    public PrivateVirtualInterface(String name, PrivateVirtualInterfaceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateVirtualInterface(String name, Output<String> id, @Nullable PrivateVirtualInterfaceState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateVirtualInterface get(String name, Output<String> id, @Nullable PrivateVirtualInterfaceState state, @Nullable CustomResourceOptions options) {
