...
public class PublicKey extends CustomResource {
    /**
     ...
     */
    public PublicKey(String name, PublicKeyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PublicKey(String name, Output<String> id, @Nullable PublicKeyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PublicKey get(String name, Output<String> id, @Nullable PublicKeyState state, @Nullable CustomResourceOptions options) {
