...
public class MetricAlarm extends CustomResource {
     ...
     */
    public MetricAlarm(String name, MetricAlarmArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MetricAlarm(String name, Output<String> id, @Nullable MetricAlarmState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MetricAlarm get(String name, Output<String> id, @Nullable MetricAlarmState state, @Nullable CustomResourceOptions options) {
