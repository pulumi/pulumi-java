...
public final class UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs(UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs();
        }

        public Builder(UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs defaults) {
            $ = new UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs(Objects.requireNonNull(defaults));
        }
