...
public final class InstanceMetadataOptionsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceMetadataOptionsGetArgs(InstanceMetadataOptionsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceMetadataOptionsGetArgs();
        }

        public Builder(InstanceMetadataOptionsGetArgs defaults) {
            $ = new InstanceMetadataOptionsGetArgs(Objects.requireNonNull(defaults));
        }
