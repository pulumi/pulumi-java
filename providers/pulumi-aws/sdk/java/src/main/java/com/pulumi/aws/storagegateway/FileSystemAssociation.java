...
public class FileSystemAssociation extends CustomResource {
     ...
     */
    public FileSystemAssociation(String name, FileSystemAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FileSystemAssociation(String name, Output<String> id, @Nullable FileSystemAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FileSystemAssociation get(String name, Output<String> id, @Nullable FileSystemAssociationState state, @Nullable CustomResourceOptions options) {
