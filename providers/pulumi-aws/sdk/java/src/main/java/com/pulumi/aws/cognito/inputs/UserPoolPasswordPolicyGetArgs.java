...
public final class UserPoolPasswordPolicyGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private UserPoolPasswordPolicyGetArgs(UserPoolPasswordPolicyGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserPoolPasswordPolicyGetArgs();
        }

        public Builder(UserPoolPasswordPolicyGetArgs defaults) {
            $ = new UserPoolPasswordPolicyGetArgs(Objects.requireNonNull(defaults));
        }
