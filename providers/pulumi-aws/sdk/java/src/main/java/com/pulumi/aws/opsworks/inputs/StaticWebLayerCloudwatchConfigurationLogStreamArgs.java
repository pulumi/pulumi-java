...
public final class StaticWebLayerCloudwatchConfigurationLogStreamArgs extends ResourceArgs {
    ...
    private StaticWebLayerCloudwatchConfigurationLogStreamArgs(StaticWebLayerCloudwatchConfigurationLogStreamArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StaticWebLayerCloudwatchConfigurationLogStreamArgs();
        }

        public Builder(StaticWebLayerCloudwatchConfigurationLogStreamArgs defaults) {
            $ = new StaticWebLayerCloudwatchConfigurationLogStreamArgs(Objects.requireNonNull(defaults));
        }
