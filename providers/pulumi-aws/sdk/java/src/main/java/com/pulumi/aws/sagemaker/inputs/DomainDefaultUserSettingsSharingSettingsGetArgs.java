...
public final class DomainDefaultUserSettingsSharingSettingsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DomainDefaultUserSettingsSharingSettingsGetArgs(DomainDefaultUserSettingsSharingSettingsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainDefaultUserSettingsSharingSettingsGetArgs();
        }

        public Builder(DomainDefaultUserSettingsSharingSettingsGetArgs defaults) {
            $ = new DomainDefaultUserSettingsSharingSettingsGetArgs(Objects.requireNonNull(defaults));
        }
