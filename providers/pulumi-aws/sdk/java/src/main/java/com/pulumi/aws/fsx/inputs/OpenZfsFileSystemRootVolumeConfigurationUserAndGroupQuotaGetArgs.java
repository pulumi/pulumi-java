...
public final class OpenZfsFileSystemRootVolumeConfigurationUserAndGroupQuotaGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OpenZfsFileSystemRootVolumeConfigurationUserAndGroupQuotaGetArgs(OpenZfsFileSystemRootVolumeConfigurationUserAndGroupQuotaGetArgs $) {
        this.id = $.id;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OpenZfsFileSystemRootVolumeConfigurationUserAndGroupQuotaGetArgs();
        }

        public Builder(OpenZfsFileSystemRootVolumeConfigurationUserAndGroupQuotaGetArgs defaults) {
            $ = new OpenZfsFileSystemRootVolumeConfigurationUserAndGroupQuotaGetArgs(Objects.requireNonNull(defaults));
        }
