...
public class Insight extends CustomResource {
    /**
     * ARN of the insight.
     * 
     */
     ...
     */
    public Insight(String name, InsightArgs args, @Nullable CustomResourceOptions options) {
        super("aws:securityhub/insight:Insight", name, args == null ? InsightArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Insight(String name, Output<String> id, @Nullable InsightState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Insight get(String name, Output<String> id, @Nullable InsightState state, @Nullable CustomResourceOptions options) {
