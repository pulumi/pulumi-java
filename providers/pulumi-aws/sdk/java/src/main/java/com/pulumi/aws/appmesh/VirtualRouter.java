...
public class VirtualRouter extends CustomResource {
    ...
    private VirtualRouter(String name, Output<String> id, @Nullable VirtualRouterState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualRouter get(String name, Output<String> id, @Nullable VirtualRouterState state, @Nullable CustomResourceOptions options) {
