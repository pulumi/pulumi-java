...
@CustomType
public final class RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig {
        /**
    ...
    private RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig(
    ...
    public static Builder builder(RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig defaults) {
        ...
        public Builder position(String position) {
            ...
            return this;
        }        public RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig build() {
            return new RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig(fallbackBehavior, headerName, position);
        }
    }
}
