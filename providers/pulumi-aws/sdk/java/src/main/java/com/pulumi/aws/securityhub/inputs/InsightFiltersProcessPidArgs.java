...
public final class InsightFiltersProcessPidArgs extends com.pulumi.resources.ResourceArgs {

    public static final InsightFiltersProcessPidArgs Empty = new InsightFiltersProcessPidArgs();
    ...
    private InsightFiltersProcessPidArgs() {}

    private InsightFiltersProcessPidArgs(InsightFiltersProcessPidArgs $) {
        this.eq = $.eq;
        this.gte = $.gte;
        this.lte = $.lte;
    }
    ...
    public static Builder builder(InsightFiltersProcessPidArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersProcessPidArgs();
        }

        public Builder(InsightFiltersProcessPidArgs defaults) {
            $ = new InsightFiltersProcessPidArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InsightFiltersProcessPidArgs build() {
            return $;
        }
    }
