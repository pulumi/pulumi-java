...
public class TrafficMirrorFilterRule extends CustomResource {
     ...
     */
    public TrafficMirrorFilterRule(String name, TrafficMirrorFilterRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TrafficMirrorFilterRule(String name, Output<String> id, @Nullable TrafficMirrorFilterRuleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TrafficMirrorFilterRule get(String name, Output<String> id, @Nullable TrafficMirrorFilterRuleState state, @Nullable CustomResourceOptions options) {
