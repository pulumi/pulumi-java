...
import com.pulumi.aws.wafv2.inputs.WebAclDefaultActionBlockCustomResponseResponseHeaderGetArgs;
...
public final class WebAclDefaultActionBlockCustomResponseGetArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<List<WebAclDefaultActionBlockCustomResponseResponseHeaderGetArgs>>> responseHeaders() {
        return Optional.ofNullable(this.responseHeaders);
    }

    private WebAclDefaultActionBlockCustomResponseGetArgs() {}

    private WebAclDefaultActionBlockCustomResponseGetArgs(WebAclDefaultActionBlockCustomResponseGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclDefaultActionBlockCustomResponseGetArgs();
        }

        public Builder(WebAclDefaultActionBlockCustomResponseGetArgs defaults) {
            $ = new WebAclDefaultActionBlockCustomResponseGetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder responseHeaders(List<WebAclDefaultActionBlockCustomResponseResponseHeaderGetArgs> responseHeaders) {
