...
public class BotAssociation extends CustomResource {
    /**
     ...
     */
    public BotAssociation(String name, BotAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BotAssociation(String name, Output<String> id, @Nullable BotAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BotAssociation get(String name, Output<String> id, @Nullable BotAssociationState state, @Nullable CustomResourceOptions options) {
