...
public class AccountAssignment extends CustomResource {
     ...
     */
    public AccountAssignment(String name, AccountAssignmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AccountAssignment(String name, Output<String> id, @Nullable AccountAssignmentState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AccountAssignment get(String name, Output<String> id, @Nullable AccountAssignmentState state, @Nullable CustomResourceOptions options) {
