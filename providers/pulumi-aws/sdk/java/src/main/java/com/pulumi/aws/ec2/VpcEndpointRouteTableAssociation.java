...
public class VpcEndpointRouteTableAssociation extends CustomResource {
    /**
     ...
     */
    public VpcEndpointRouteTableAssociation(String name, VpcEndpointRouteTableAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VpcEndpointRouteTableAssociation(String name, Output<String> id, @Nullable VpcEndpointRouteTableAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpcEndpointRouteTableAssociation get(String name, Output<String> id, @Nullable VpcEndpointRouteTableAssociationState state, @Nullable CustomResourceOptions options) {
