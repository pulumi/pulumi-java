...
public class LinkAggregationGroup extends CustomResource {
    /**
     * The ARN of the LAG.
     * 
     */
     ...
     */
    public LinkAggregationGroup(String name, LinkAggregationGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LinkAggregationGroup(String name, Output<String> id, @Nullable LinkAggregationGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LinkAggregationGroup get(String name, Output<String> id, @Nullable LinkAggregationGroupState state, @Nullable CustomResourceOptions options) {
