...
public class Workteam extends CustomResource {
    /**
     ...
     */
    public Workteam(String name, WorkteamArgs args, @Nullable CustomResourceOptions options) {
        super("aws:sagemaker/workteam:Workteam", name, args == null ? WorkteamArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Workteam(String name, Output<String> id, @Nullable WorkteamState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Workteam get(String name, Output<String> id, @Nullable WorkteamState state, @Nullable CustomResourceOptions options) {
