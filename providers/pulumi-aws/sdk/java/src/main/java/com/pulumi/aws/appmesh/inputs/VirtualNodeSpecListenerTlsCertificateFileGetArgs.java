...
public final class VirtualNodeSpecListenerTlsCertificateFileGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final VirtualNodeSpecListenerTlsCertificateFileGetArgs Empty = new VirtualNodeSpecListenerTlsCertificateFileGetArgs();
    ...
    private VirtualNodeSpecListenerTlsCertificateFileGetArgs() {}

    private VirtualNodeSpecListenerTlsCertificateFileGetArgs(VirtualNodeSpecListenerTlsCertificateFileGetArgs $) {
    ...
    public static Builder builder(VirtualNodeSpecListenerTlsCertificateFileGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualNodeSpecListenerTlsCertificateFileGetArgs();
        }

        public Builder(VirtualNodeSpecListenerTlsCertificateFileGetArgs defaults) {
