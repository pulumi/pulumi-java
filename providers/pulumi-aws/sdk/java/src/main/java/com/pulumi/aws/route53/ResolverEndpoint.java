...
public class ResolverEndpoint extends CustomResource {
    /**
     ...
     */
    public ResolverEndpoint(String name, ResolverEndpointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResolverEndpoint(String name, Output<String> id, @Nullable ResolverEndpointState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResolverEndpoint get(String name, Output<String> id, @Nullable ResolverEndpointState state, @Nullable CustomResourceOptions options) {
