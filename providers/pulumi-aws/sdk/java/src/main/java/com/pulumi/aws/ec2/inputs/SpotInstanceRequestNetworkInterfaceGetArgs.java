...
public final class SpotInstanceRequestNetworkInterfaceGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final SpotInstanceRequestNetworkInterfaceGetArgs Empty = new SpotInstanceRequestNetworkInterfaceGetArgs();
    ...
    private SpotInstanceRequestNetworkInterfaceGetArgs(SpotInstanceRequestNetworkInterfaceGetArgs $) {
    ...
    public static Builder builder(SpotInstanceRequestNetworkInterfaceGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SpotInstanceRequestNetworkInterfaceGetArgs();
        }

        public Builder(SpotInstanceRequestNetworkInterfaceGetArgs defaults) {
            $ = new SpotInstanceRequestNetworkInterfaceGetArgs(Objects.requireNonNull(defaults));
        }
