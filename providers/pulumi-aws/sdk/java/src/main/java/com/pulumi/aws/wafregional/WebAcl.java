...
public class WebAcl extends CustomResource {
    ...
    private WebAcl(String name, Output<String> id, @Nullable WebAclState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAcl get(String name, Output<String> id, @Nullable WebAclState state, @Nullable CustomResourceOptions options) {
