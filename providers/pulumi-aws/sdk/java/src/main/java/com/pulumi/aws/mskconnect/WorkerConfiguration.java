...
public class WorkerConfiguration extends CustomResource {
     ...
     */
    public WorkerConfiguration(String name, WorkerConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WorkerConfiguration(String name, Output<String> id, @Nullable WorkerConfigurationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkerConfiguration get(String name, Output<String> id, @Nullable WorkerConfigurationState state, @Nullable CustomResourceOptions options) {
