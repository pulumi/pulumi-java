...
public class Activity extends CustomResource {
    ...
    private Activity(String name, Output<String> id, @Nullable ActivityState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Activity get(String name, Output<String> id, @Nullable ActivityState state, @Nullable CustomResourceOptions options) {
