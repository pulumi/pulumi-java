...
public class SnapshotScheduleAssociation extends CustomResource {
     ...
     */
    public SnapshotScheduleAssociation(String name, SnapshotScheduleAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SnapshotScheduleAssociation(String name, Output<String> id, @Nullable SnapshotScheduleAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SnapshotScheduleAssociation get(String name, Output<String> id, @Nullable SnapshotScheduleAssociationState state, @Nullable CustomResourceOptions options) {
