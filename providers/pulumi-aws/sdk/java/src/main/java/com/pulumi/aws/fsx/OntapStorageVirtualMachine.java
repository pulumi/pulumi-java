...
public class OntapStorageVirtualMachine extends CustomResource {
    /**
     ...
     */
    public OntapStorageVirtualMachine(String name, OntapStorageVirtualMachineArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OntapStorageVirtualMachine(String name, Output<String> id, @Nullable OntapStorageVirtualMachineState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OntapStorageVirtualMachine get(String name, Output<String> id, @Nullable OntapStorageVirtualMachineState state, @Nullable CustomResourceOptions options) {
