...
public class GroupPolicy extends CustomResource {
     ...
     */
    public GroupPolicy(String name, GroupPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GroupPolicy(String name, Output<String> id, @Nullable GroupPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GroupPolicy get(String name, Output<String> id, @Nullable GroupPolicyState state, @Nullable CustomResourceOptions options) {
