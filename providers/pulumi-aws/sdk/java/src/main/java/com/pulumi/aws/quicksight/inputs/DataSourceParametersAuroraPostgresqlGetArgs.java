...
public final class DataSourceParametersAuroraPostgresqlGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DataSourceParametersAuroraPostgresqlGetArgs(DataSourceParametersAuroraPostgresqlGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataSourceParametersAuroraPostgresqlGetArgs();
        }

        public Builder(DataSourceParametersAuroraPostgresqlGetArgs defaults) {
            $ = new DataSourceParametersAuroraPostgresqlGetArgs(Objects.requireNonNull(defaults));
        }
