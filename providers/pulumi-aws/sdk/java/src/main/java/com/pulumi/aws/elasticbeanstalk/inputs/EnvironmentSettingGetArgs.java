...
public final class EnvironmentSettingGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EnvironmentSettingGetArgs(EnvironmentSettingGetArgs $) {
        this.name = $.name;
