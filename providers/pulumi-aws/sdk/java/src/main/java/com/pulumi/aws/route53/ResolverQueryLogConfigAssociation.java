...
public class ResolverQueryLogConfigAssociation extends CustomResource {
    /**
     ...
     */
    public ResolverQueryLogConfigAssociation(String name, ResolverQueryLogConfigAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResolverQueryLogConfigAssociation(String name, Output<String> id, @Nullable ResolverQueryLogConfigAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResolverQueryLogConfigAssociation get(String name, Output<String> id, @Nullable ResolverQueryLogConfigAssociationState state, @Nullable CustomResourceOptions options) {
