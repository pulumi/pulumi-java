...
public class ThingGroup extends CustomResource {
     ...
     */
    public ThingGroup(String name, @Nullable ThingGroupArgs args, @Nullable CustomResourceOptions options) {
        super("aws:iot/thingGroup:ThingGroup", name, args == null ? ThingGroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ThingGroup(String name, Output<String> id, @Nullable ThingGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ThingGroup get(String name, Output<String> id, @Nullable ThingGroupState state, @Nullable CustomResourceOptions options) {
