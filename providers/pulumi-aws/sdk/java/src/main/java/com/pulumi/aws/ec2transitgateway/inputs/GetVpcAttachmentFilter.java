...
public final class GetVpcAttachmentFilter extends com.pulumi.resources.InvokeArgs {
    ...
    private GetVpcAttachmentFilter(GetVpcAttachmentFilter $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVpcAttachmentFilter();
        }

        public Builder(GetVpcAttachmentFilter defaults) {
            $ = new GetVpcAttachmentFilter(Objects.requireNonNull(defaults));
        }
