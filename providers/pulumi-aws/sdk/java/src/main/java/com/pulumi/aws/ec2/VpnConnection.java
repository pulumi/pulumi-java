...
public class VpnConnection extends CustomResource {
    ...
    private VpnConnection(String name, Output<String> id, @Nullable VpnConnectionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpnConnection get(String name, Output<String> id, @Nullable VpnConnectionState state, @Nullable CustomResourceOptions options) {
