...
public class ThingType extends CustomResource {
     ...
     */
    public ThingType(String name, @Nullable ThingTypeArgs args, @Nullable CustomResourceOptions options) {
        super("aws:iot/thingType:ThingType", name, args == null ? ThingTypeArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ThingType(String name, Output<String> id, @Nullable ThingTypeState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ThingType get(String name, Output<String> id, @Nullable ThingTypeState state, @Nullable CustomResourceOptions options) {
