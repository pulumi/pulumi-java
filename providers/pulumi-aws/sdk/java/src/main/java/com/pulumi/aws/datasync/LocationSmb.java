...
public class LocationSmb extends CustomResource {
    /**
     ...
     */
    public LocationSmb(String name, LocationSmbArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LocationSmb(String name, Output<String> id, @Nullable LocationSmbState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LocationSmb get(String name, Output<String> id, @Nullable LocationSmbState state, @Nullable CustomResourceOptions options) {
