...
public final class InsightFiltersNetworkSourcePortGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final InsightFiltersNetworkSourcePortGetArgs Empty = new InsightFiltersNetworkSourcePortGetArgs();
    ...
    private InsightFiltersNetworkSourcePortGetArgs() {}

    private InsightFiltersNetworkSourcePortGetArgs(InsightFiltersNetworkSourcePortGetArgs $) {
        this.eq = $.eq;
        this.gte = $.gte;
        this.lte = $.lte;
    }
    ...
    public static Builder builder(InsightFiltersNetworkSourcePortGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersNetworkSourcePortGetArgs();
        }

        public Builder(InsightFiltersNetworkSourcePortGetArgs defaults) {
            $ = new InsightFiltersNetworkSourcePortGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InsightFiltersNetworkSourcePortGetArgs build() {
            return $;
        }
    }
