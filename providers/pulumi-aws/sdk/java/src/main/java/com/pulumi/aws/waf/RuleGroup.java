...
public class RuleGroup extends CustomResource {
    /**
     ...
     */
    public RuleGroup(String name, RuleGroupArgs args, @Nullable CustomResourceOptions options) {
        super("aws:waf/ruleGroup:RuleGroup", name, args == null ? RuleGroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RuleGroup(String name, Output<String> id, @Nullable RuleGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RuleGroup get(String name, Output<String> id, @Nullable RuleGroupState state, @Nullable CustomResourceOptions options) {
