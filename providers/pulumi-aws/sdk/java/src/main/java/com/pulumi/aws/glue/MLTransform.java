...
public class MLTransform extends CustomResource {
     ...
     */
    public MLTransform(String name, MLTransformArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MLTransform(String name, Output<String> id, @Nullable MLTransformState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MLTransform get(String name, Output<String> id, @Nullable MLTransformState state, @Nullable CustomResourceOptions options) {
