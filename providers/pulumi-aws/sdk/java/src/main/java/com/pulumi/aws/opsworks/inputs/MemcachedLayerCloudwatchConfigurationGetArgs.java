...
import com.pulumi.aws.opsworks.inputs.MemcachedLayerCloudwatchConfigurationLogStreamGetArgs;
...
public final class MemcachedLayerCloudwatchConfigurationGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<MemcachedLayerCloudwatchConfigurationLogStreamGetArgs>> logStreams;

    public Optional<Output<List<MemcachedLayerCloudwatchConfigurationLogStreamGetArgs>>> logStreams() {
        return Optional.ofNullable(this.logStreams);
    }

    private MemcachedLayerCloudwatchConfigurationGetArgs() {}

    private MemcachedLayerCloudwatchConfigurationGetArgs(MemcachedLayerCloudwatchConfigurationGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MemcachedLayerCloudwatchConfigurationGetArgs();
        }

        public Builder(MemcachedLayerCloudwatchConfigurationGetArgs defaults) {
            $ = new MemcachedLayerCloudwatchConfigurationGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder logStreams(List<MemcachedLayerCloudwatchConfigurationLogStreamGetArgs> logStreams) {
