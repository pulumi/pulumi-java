...
public final class TrafficMirrorFilterRuleDestinationPortRangeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TrafficMirrorFilterRuleDestinationPortRangeGetArgs(TrafficMirrorFilterRuleDestinationPortRangeGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TrafficMirrorFilterRuleDestinationPortRangeGetArgs();
        }

        public Builder(TrafficMirrorFilterRuleDestinationPortRangeGetArgs defaults) {
            $ = new TrafficMirrorFilterRuleDestinationPortRangeGetArgs(Objects.requireNonNull(defaults));
        }
