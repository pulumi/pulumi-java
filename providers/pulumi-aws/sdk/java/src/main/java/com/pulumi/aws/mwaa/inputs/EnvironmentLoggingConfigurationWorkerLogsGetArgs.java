...
public final class EnvironmentLoggingConfigurationWorkerLogsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EnvironmentLoggingConfigurationWorkerLogsGetArgs(EnvironmentLoggingConfigurationWorkerLogsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EnvironmentLoggingConfigurationWorkerLogsGetArgs();
        }

        public Builder(EnvironmentLoggingConfigurationWorkerLogsGetArgs defaults) {
            $ = new EnvironmentLoggingConfigurationWorkerLogsGetArgs(Objects.requireNonNull(defaults));
        }
