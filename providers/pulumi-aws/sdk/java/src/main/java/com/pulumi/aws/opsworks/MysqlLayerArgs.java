...
public final class MysqlLayerArgs extends ResourceArgs {
     ...
     * 
     */
    public Optional<Output<Boolean>> rootPasswordOnAllInstances() {
        return Optional.ofNullable(this.rootPasswordOnAllInstances);
    }
    ...
    private MysqlLayerArgs(MysqlLayerArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(MysqlLayerArgs defaults) {
            $ = new MysqlLayerArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param rootPassword Root password to use for MySQL.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param rootPasswordOnAllInstances Whether to set the root user password to all instances in the stack so they can access the instances in this layer.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder rootPasswordOnAllInstances(Boolean rootPasswordOnAllInstances) {
            return rootPasswordOnAllInstances(Output.of(rootPasswordOnAllInstances));
        }
