...
public final class FunctionVpcConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FunctionVpcConfigGetArgs(FunctionVpcConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionVpcConfigGetArgs();
        }

        public Builder(FunctionVpcConfigGetArgs defaults) {
            $ = new FunctionVpcConfigGetArgs(Objects.requireNonNull(defaults));
        }
