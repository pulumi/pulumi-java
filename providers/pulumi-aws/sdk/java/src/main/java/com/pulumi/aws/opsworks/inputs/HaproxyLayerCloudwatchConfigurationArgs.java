...
public final class HaproxyLayerCloudwatchConfigurationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Output<List<HaproxyLayerCloudwatchConfigurationLogStreamArgs>> logStreams() {
