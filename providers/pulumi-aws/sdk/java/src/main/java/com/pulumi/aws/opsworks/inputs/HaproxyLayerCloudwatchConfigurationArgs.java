...
import com.pulumi.aws.opsworks.inputs.HaproxyLayerCloudwatchConfigurationLogStreamArgs;
...
public final class HaproxyLayerCloudwatchConfigurationArgs extends ResourceArgs {
    ...
    public Optional<Output<List<HaproxyLayerCloudwatchConfigurationLogStreamArgs>>> logStreams() {
        return Optional.ofNullable(this.logStreams);
    }

    private HaproxyLayerCloudwatchConfigurationArgs() {}

    private HaproxyLayerCloudwatchConfigurationArgs(HaproxyLayerCloudwatchConfigurationArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HaproxyLayerCloudwatchConfigurationArgs();
        }

        public Builder(HaproxyLayerCloudwatchConfigurationArgs defaults) {
            $ = new HaproxyLayerCloudwatchConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder logStreams(List<HaproxyLayerCloudwatchConfigurationLogStreamArgs> logStreams) {
