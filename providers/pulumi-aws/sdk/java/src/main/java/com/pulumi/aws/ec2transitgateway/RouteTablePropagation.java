...
public class RouteTablePropagation extends com.pulumi.resources.CustomResource {
     ...
     */
    public RouteTablePropagation(String name, RouteTablePropagationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private RouteTablePropagation(String name, Output<String> id, @Nullable RouteTablePropagationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static RouteTablePropagation get(String name, Output<String> id, @Nullable RouteTablePropagationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
