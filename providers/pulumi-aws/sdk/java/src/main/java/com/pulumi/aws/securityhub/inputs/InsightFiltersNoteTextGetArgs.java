...
public final class InsightFiltersNoteTextGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersNoteTextGetArgs(InsightFiltersNoteTextGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersNoteTextGetArgs();
        }

        public Builder(InsightFiltersNoteTextGetArgs defaults) {
            $ = new InsightFiltersNoteTextGetArgs(Objects.requireNonNull(defaults));
        }
