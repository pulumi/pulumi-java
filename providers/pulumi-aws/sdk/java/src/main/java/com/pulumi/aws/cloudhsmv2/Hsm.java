...
public class Hsm extends CustomResource {
     ...
     */
    public Hsm(String name, HsmArgs args, @Nullable CustomResourceOptions options) {
        super("aws:cloudhsmv2/hsm:Hsm", name, args == null ? HsmArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Hsm(String name, Output<String> id, @Nullable HsmState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Hsm get(String name, Output<String> id, @Nullable HsmState state, @Nullable CustomResourceOptions options) {
