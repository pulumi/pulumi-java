...
public class AdmChannel extends CustomResource {
     ...
     */
    public AdmChannel(String name, AdmChannelArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AdmChannel(String name, Output<String> id, @Nullable AdmChannelState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AdmChannel get(String name, Output<String> id, @Nullable AdmChannelState state, @Nullable CustomResourceOptions options) {
