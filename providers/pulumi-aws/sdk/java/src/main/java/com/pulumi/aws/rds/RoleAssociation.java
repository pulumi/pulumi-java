...
public class RoleAssociation extends CustomResource {
     ...
     */
    public RoleAssociation(String name, RoleAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RoleAssociation(String name, Output<String> id, @Nullable RoleAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RoleAssociation get(String name, Output<String> id, @Nullable RoleAssociationState state, @Nullable CustomResourceOptions options) {
