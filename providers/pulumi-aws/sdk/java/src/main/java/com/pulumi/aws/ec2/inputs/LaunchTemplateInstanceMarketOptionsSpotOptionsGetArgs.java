...
public final class LaunchTemplateInstanceMarketOptionsSpotOptionsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private LaunchTemplateInstanceMarketOptionsSpotOptionsGetArgs(LaunchTemplateInstanceMarketOptionsSpotOptionsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LaunchTemplateInstanceMarketOptionsSpotOptionsGetArgs();
        }

        public Builder(LaunchTemplateInstanceMarketOptionsSpotOptionsGetArgs defaults) {
            $ = new LaunchTemplateInstanceMarketOptionsSpotOptionsGetArgs(Objects.requireNonNull(defaults));
        }
