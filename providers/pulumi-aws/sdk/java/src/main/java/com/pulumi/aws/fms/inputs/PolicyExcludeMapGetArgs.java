...
public final class PolicyExcludeMapGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyExcludeMapGetArgs Empty = new PolicyExcludeMapGetArgs();
    ...
    private PolicyExcludeMapGetArgs() {}

    private PolicyExcludeMapGetArgs(PolicyExcludeMapGetArgs $) {
    ...
    public static Builder builder(PolicyExcludeMapGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyExcludeMapGetArgs();
        }

        public Builder(PolicyExcludeMapGetArgs defaults) {
            $ = new PolicyExcludeMapGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyExcludeMapGetArgs build() {
            return $;
        }
    }
