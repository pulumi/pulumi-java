 ...
 *             .assumeRolePolicy(mainIdentityPool.getId().apply(id -&gt; &#34;&#34;&#34;
 * {
 *   &#34;Version&#34;: &#34;2012-10-17&#34;,
 *   &#34;Statement&#34;: [
 *     {
 ...
 *             .identityPoolId(mainIdentityPool.getId())
 *             .roleMappings(IdentityPoolRoleAttachmentRoleMapping.builder()
 *                 .identityProvider(&#34;graph.facebook.com&#34;)
 *                 .ambiguousRoleResolution(&#34;AuthenticatedRole&#34;)
 *                 .type(&#34;Rules&#34;)
 *                 .mappingRules(IdentityPoolRoleAttachmentRoleMappingMappingRule.builder()
 *                     .claim(&#34;isAdmin&#34;)
 *                     .matchType(&#34;Equals&#34;)
 *                     .roleArn(authenticatedRole.getArn())
 *                     .value(&#34;paid&#34;)
 *                     .build())
 *                 .build())
 *             .roles(Map.of(&#34;authenticated&#34;, authenticatedRole.getArn()))
 *             .build());
 * 
 *         }
 * }
