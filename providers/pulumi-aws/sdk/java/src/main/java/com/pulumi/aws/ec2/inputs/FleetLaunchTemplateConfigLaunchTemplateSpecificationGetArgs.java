...
public final class FleetLaunchTemplateConfigLaunchTemplateSpecificationGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FleetLaunchTemplateConfigLaunchTemplateSpecificationGetArgs(FleetLaunchTemplateConfigLaunchTemplateSpecificationGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FleetLaunchTemplateConfigLaunchTemplateSpecificationGetArgs();
        }

        public Builder(FleetLaunchTemplateConfigLaunchTemplateSpecificationGetArgs defaults) {
            $ = new FleetLaunchTemplateConfigLaunchTemplateSpecificationGetArgs(Objects.requireNonNull(defaults));
        }
