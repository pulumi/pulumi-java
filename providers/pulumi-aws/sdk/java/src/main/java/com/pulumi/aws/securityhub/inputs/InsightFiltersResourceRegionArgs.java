...
public final class InsightFiltersResourceRegionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersResourceRegionArgs(InsightFiltersResourceRegionArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersResourceRegionArgs();
        }

        public Builder(InsightFiltersResourceRegionArgs defaults) {
            $ = new InsightFiltersResourceRegionArgs(Objects.requireNonNull(defaults));
        }
