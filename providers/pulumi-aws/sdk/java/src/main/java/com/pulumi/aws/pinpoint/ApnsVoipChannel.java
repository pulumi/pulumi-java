...
public class ApnsVoipChannel extends CustomResource {
    /**
     * The application ID.
     * 
     */
     ...
     */
    public ApnsVoipChannel(String name, ApnsVoipChannelArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApnsVoipChannel(String name, Output<String> id, @Nullable ApnsVoipChannelState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApnsVoipChannel get(String name, Output<String> id, @Nullable ApnsVoipChannelState state, @Nullable CustomResourceOptions options) {
