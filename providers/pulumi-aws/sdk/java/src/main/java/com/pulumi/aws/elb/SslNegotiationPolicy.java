...
public class SslNegotiationPolicy extends CustomResource {
     ...
     */
    public SslNegotiationPolicy(String name, SslNegotiationPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SslNegotiationPolicy(String name, Output<String> id, @Nullable SslNegotiationPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SslNegotiationPolicy get(String name, Output<String> id, @Nullable SslNegotiationPolicyState state, @Nullable CustomResourceOptions options) {
