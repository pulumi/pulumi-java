...
public class BucketReplicationConfig extends CustomResource {
    /**
     ...
     */
    public BucketReplicationConfig(String name, BucketReplicationConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BucketReplicationConfig(String name, Output<String> id, @Nullable BucketReplicationConfigState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BucketReplicationConfig get(String name, Output<String> id, @Nullable BucketReplicationConfigState state, @Nullable CustomResourceOptions options) {
