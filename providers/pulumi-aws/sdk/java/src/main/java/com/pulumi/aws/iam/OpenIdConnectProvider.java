...
public class OpenIdConnectProvider extends CustomResource {
     ...
     */
    public OpenIdConnectProvider(String name, OpenIdConnectProviderArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OpenIdConnectProvider(String name, Output<String> id, @Nullable OpenIdConnectProviderState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OpenIdConnectProvider get(String name, Output<String> id, @Nullable OpenIdConnectProviderState state, @Nullable CustomResourceOptions options) {
