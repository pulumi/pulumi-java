...
public final class FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptionsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptionsGetArgs(FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptionsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptionsGetArgs();
        }

        public Builder(FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptionsGetArgs defaults) {
            $ = new FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptionsGetArgs(Objects.requireNonNull(defaults));
        }
