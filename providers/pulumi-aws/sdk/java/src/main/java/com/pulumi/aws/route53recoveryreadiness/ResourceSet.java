...
public class ResourceSet extends CustomResource {
     ...
     */
    public ResourceSet(String name, ResourceSetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResourceSet(String name, Output<String> id, @Nullable ResourceSetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResourceSet get(String name, Output<String> id, @Nullable ResourceSetState state, @Nullable CustomResourceOptions options) {
