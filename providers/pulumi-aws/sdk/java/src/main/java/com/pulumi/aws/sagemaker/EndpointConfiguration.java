...
public class EndpointConfiguration extends CustomResource {
    /**
    ...
    private EndpointConfiguration(String name, Output<String> id, @Nullable EndpointConfigurationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EndpointConfiguration get(String name, Output<String> id, @Nullable EndpointConfigurationState state, @Nullable CustomResourceOptions options) {
