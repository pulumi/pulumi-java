...
public class ObjectCopy extends CustomResource {
     ...
     */
    public ObjectCopy(String name, ObjectCopyArgs args, @Nullable CustomResourceOptions options) {
        super("aws:s3/objectCopy:ObjectCopy", name, args == null ? ObjectCopyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ObjectCopy(String name, Output<String> id, @Nullable ObjectCopyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ObjectCopy get(String name, Output<String> id, @Nullable ObjectCopyState state, @Nullable CustomResourceOptions options) {
