...
public class EipAssociation extends CustomResource {
     ...
     */
    public EipAssociation(String name, @Nullable EipAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EipAssociation(String name, Output<String> id, @Nullable EipAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EipAssociation get(String name, Output<String> id, @Nullable EipAssociationState state, @Nullable CustomResourceOptions options) {
