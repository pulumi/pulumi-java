...
public class VpcDhcpOptionsAssociation extends CustomResource {
     ...
     */
    public VpcDhcpOptionsAssociation(String name, VpcDhcpOptionsAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VpcDhcpOptionsAssociation(String name, Output<String> id, @Nullable VpcDhcpOptionsAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpcDhcpOptionsAssociation get(String name, Output<String> id, @Nullable VpcDhcpOptionsAssociationState state, @Nullable CustomResourceOptions options) {
