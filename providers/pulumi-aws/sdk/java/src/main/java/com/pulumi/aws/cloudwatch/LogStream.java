...
public class LogStream extends CustomResource {
     ...
     */
    public LogStream(String name, LogStreamArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LogStream(String name, Output<String> id, @Nullable LogStreamState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LogStream get(String name, Output<String> id, @Nullable LogStreamState state, @Nullable CustomResourceOptions options) {
