...
public final class BucketLifecycleRuleTransitionGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private BucketLifecycleRuleTransitionGetArgs(BucketLifecycleRuleTransitionGetArgs $) {
        this.date = $.date;
        this.days = $.days;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BucketLifecycleRuleTransitionGetArgs();
        }

        public Builder(BucketLifecycleRuleTransitionGetArgs defaults) {
            $ = new BucketLifecycleRuleTransitionGetArgs(Objects.requireNonNull(defaults));
        }
