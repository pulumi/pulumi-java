...
public final class IntentConclusionStatementMessageGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private IntentConclusionStatementMessageGetArgs(IntentConclusionStatementMessageGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IntentConclusionStatementMessageGetArgs();
        }

        public Builder(IntentConclusionStatementMessageGetArgs defaults) {
            $ = new IntentConclusionStatementMessageGetArgs(Objects.requireNonNull(defaults));
        }
