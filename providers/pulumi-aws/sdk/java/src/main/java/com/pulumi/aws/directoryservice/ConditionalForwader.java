...
public class ConditionalForwader extends CustomResource {
    /**
     * The id of directory.
     * 
     */
     ...
     */
    public ConditionalForwader(String name, ConditionalForwaderArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConditionalForwader(String name, Output<String> id, @Nullable ConditionalForwaderState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConditionalForwader get(String name, Output<String> id, @Nullable ConditionalForwaderState state, @Nullable CustomResourceOptions options) {
