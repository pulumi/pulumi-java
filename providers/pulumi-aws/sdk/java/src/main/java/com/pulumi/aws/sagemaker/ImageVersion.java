...
public class ImageVersion extends CustomResource {
     ...
     */
    public ImageVersion(String name, ImageVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ImageVersion(String name, Output<String> id, @Nullable ImageVersionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ImageVersion get(String name, Output<String> id, @Nullable ImageVersionState state, @Nullable CustomResourceOptions options) {
