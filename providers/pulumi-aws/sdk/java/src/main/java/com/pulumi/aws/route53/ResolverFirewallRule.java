...
public class ResolverFirewallRule extends CustomResource {
     ...
     */
    public ResolverFirewallRule(String name, ResolverFirewallRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResolverFirewallRule(String name, Output<String> id, @Nullable ResolverFirewallRuleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResolverFirewallRule get(String name, Output<String> id, @Nullable ResolverFirewallRuleState state, @Nullable CustomResourceOptions options) {
