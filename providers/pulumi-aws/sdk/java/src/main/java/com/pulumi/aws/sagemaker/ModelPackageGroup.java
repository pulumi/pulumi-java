...
public class ModelPackageGroup extends CustomResource {
     ...
     */
    public ModelPackageGroup(String name, ModelPackageGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ModelPackageGroup(String name, Output<String> id, @Nullable ModelPackageGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ModelPackageGroup get(String name, Output<String> id, @Nullable ModelPackageGroupState state, @Nullable CustomResourceOptions options) {
