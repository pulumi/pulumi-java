...
public class ClusterParameterGroup extends CustomResource {
    /**
     ...
     */
    public ClusterParameterGroup(String name, ClusterParameterGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ClusterParameterGroup(String name, Output<String> id, @Nullable ClusterParameterGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ClusterParameterGroup get(String name, Output<String> id, @Nullable ClusterParameterGroupState state, @Nullable CustomResourceOptions options) {
