...
public final class VirtualNodeSpecListenerTimeoutGrpcPerRequestGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private VirtualNodeSpecListenerTimeoutGrpcPerRequestGetArgs(VirtualNodeSpecListenerTimeoutGrpcPerRequestGetArgs $) {
        this.unit = $.unit;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualNodeSpecListenerTimeoutGrpcPerRequestGetArgs();
        }

        public Builder(VirtualNodeSpecListenerTimeoutGrpcPerRequestGetArgs defaults) {
            $ = new VirtualNodeSpecListenerTimeoutGrpcPerRequestGetArgs(Objects.requireNonNull(defaults));
        }
