...
public class Parameter extends CustomResource {
     ...
     */
    public Parameter(String name, ParameterArgs args, @Nullable CustomResourceOptions options) {
        super("aws:ssm/parameter:Parameter", name, args == null ? ParameterArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Parameter(String name, Output<String> id, @Nullable ParameterState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Parameter get(String name, Output<String> id, @Nullable ParameterState state, @Nullable CustomResourceOptions options) {
