...
public class VpcIpamPoolCidr extends CustomResource {
     ...
     */
    public VpcIpamPoolCidr(String name, VpcIpamPoolCidrArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VpcIpamPoolCidr(String name, Output<String> id, @Nullable VpcIpamPoolCidrState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpcIpamPoolCidr get(String name, Output<String> id, @Nullable VpcIpamPoolCidrState state, @Nullable CustomResourceOptions options) {
