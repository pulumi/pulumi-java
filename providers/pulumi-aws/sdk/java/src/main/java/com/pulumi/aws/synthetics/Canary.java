...
public class Canary extends CustomResource {
    ...
    private Canary(String name, Output<String> id, @Nullable CanaryState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Canary get(String name, Output<String> id, @Nullable CanaryState state, @Nullable CustomResourceOptions options) {
