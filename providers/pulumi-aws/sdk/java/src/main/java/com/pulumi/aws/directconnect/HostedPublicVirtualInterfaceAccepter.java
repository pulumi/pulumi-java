...
public class HostedPublicVirtualInterfaceAccepter extends CustomResource {
    /**
     ...
     */
    public HostedPublicVirtualInterfaceAccepter(String name, HostedPublicVirtualInterfaceAccepterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HostedPublicVirtualInterfaceAccepter(String name, Output<String> id, @Nullable HostedPublicVirtualInterfaceAccepterState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HostedPublicVirtualInterfaceAccepter get(String name, Output<String> id, @Nullable HostedPublicVirtualInterfaceAccepterState state, @Nullable CustomResourceOptions options) {
