...
public class CatalogTable extends CustomResource {
     ...
     */
    public CatalogTable(String name, CatalogTableArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CatalogTable(String name, Output<String> id, @Nullable CatalogTableState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CatalogTable get(String name, Output<String> id, @Nullable CatalogTableState state, @Nullable CustomResourceOptions options) {
