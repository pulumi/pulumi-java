...
public class LogDestination extends CustomResource {
    /**
     ...
     */
    public LogDestination(String name, LogDestinationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LogDestination(String name, Output<String> id, @Nullable LogDestinationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LogDestination get(String name, Output<String> id, @Nullable LogDestinationState state, @Nullable CustomResourceOptions options) {
