...
public final class DeploymentGroupBlueGreenDeploymentConfigGreenFleetProvisioningOptionGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DeploymentGroupBlueGreenDeploymentConfigGreenFleetProvisioningOptionGetArgs(DeploymentGroupBlueGreenDeploymentConfigGreenFleetProvisioningOptionGetArgs $) {
        this.action = $.action;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeploymentGroupBlueGreenDeploymentConfigGreenFleetProvisioningOptionGetArgs();
        }

        public Builder(DeploymentGroupBlueGreenDeploymentConfigGreenFleetProvisioningOptionGetArgs defaults) {
            $ = new DeploymentGroupBlueGreenDeploymentConfigGreenFleetProvisioningOptionGetArgs(Objects.requireNonNull(defaults));
        }
