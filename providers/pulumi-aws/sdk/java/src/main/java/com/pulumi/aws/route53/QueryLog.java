...
public class QueryLog extends CustomResource {
     ...
     */
    public QueryLog(String name, QueryLogArgs args, @Nullable CustomResourceOptions options) {
        super("aws:route53/queryLog:QueryLog", name, args == null ? QueryLogArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private QueryLog(String name, Output<String> id, @Nullable QueryLogState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static QueryLog get(String name, Output<String> id, @Nullable QueryLogState state, @Nullable CustomResourceOptions options) {
