...
public class EgressOnlyInternetGateway extends CustomResource {
     ...
     */
    public EgressOnlyInternetGateway(String name, EgressOnlyInternetGatewayArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EgressOnlyInternetGateway(String name, Output<String> id, @Nullable EgressOnlyInternetGatewayState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EgressOnlyInternetGateway get(String name, Output<String> id, @Nullable EgressOnlyInternetGatewayState state, @Nullable CustomResourceOptions options) {
