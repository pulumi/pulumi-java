...
public final class InsightFiltersLastObservedAtDateRangeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersLastObservedAtDateRangeGetArgs(InsightFiltersLastObservedAtDateRangeGetArgs $) {
        this.unit = $.unit;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersLastObservedAtDateRangeGetArgs();
        }

        public Builder(InsightFiltersLastObservedAtDateRangeGetArgs defaults) {
            $ = new InsightFiltersLastObservedAtDateRangeGetArgs(Objects.requireNonNull(defaults));
        }
