...
public final class DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs Empty = new DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs();
    ...
    private DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs() {}

    private DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs(DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs $) {
    ...
    public static Builder builder(DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs();
        }

        public Builder(DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs defaults) {
            $ = new DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpecGetArgs build() {
            return $;
        }
    }
