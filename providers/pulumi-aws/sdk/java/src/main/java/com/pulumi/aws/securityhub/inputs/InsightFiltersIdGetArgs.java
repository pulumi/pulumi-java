...
public final class InsightFiltersIdGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersIdGetArgs(InsightFiltersIdGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersIdGetArgs();
        }

        public Builder(InsightFiltersIdGetArgs defaults) {
            $ = new InsightFiltersIdGetArgs(Objects.requireNonNull(defaults));
        }
