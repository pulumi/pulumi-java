...
public final class RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchSingleHeaderArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchSingleHeaderArgs(Output<String> name) {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            ...
            return new RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchSingleHeaderArgs(name);
        }
    }
}
