...
public final class InsightFiltersResourceAwsEc2InstanceTypeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersResourceAwsEc2InstanceTypeGetArgs(InsightFiltersResourceAwsEc2InstanceTypeGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersResourceAwsEc2InstanceTypeGetArgs();
        }

        public Builder(InsightFiltersResourceAwsEc2InstanceTypeGetArgs defaults) {
            $ = new InsightFiltersResourceAwsEc2InstanceTypeGetArgs(Objects.requireNonNull(defaults));
        }
