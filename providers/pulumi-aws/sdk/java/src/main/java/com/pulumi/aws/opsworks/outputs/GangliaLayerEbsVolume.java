...
public final class GangliaLayerEbsVolume {
    ...
    */
    ...
    public static Builder builder(GangliaLayerEbsVolume defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GangliaLayerEbsVolume defaults) {
        ...
        public Builder type(@Nullable String type) {
            this.type = type;
            return this;
        }        public GangliaLayerEbsVolume build() {
            return new GangliaLayerEbsVolume(encrypted, iops, mountPoint, numberOfDisks, raidLevel, size, type);
        }
    }
}
