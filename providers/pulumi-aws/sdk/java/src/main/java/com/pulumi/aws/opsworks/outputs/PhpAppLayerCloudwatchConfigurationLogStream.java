...
public final class PhpAppLayerCloudwatchConfigurationLogStream {
    ...
    public static Builder builder(PhpAppLayerCloudwatchConfigurationLogStream defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PhpAppLayerCloudwatchConfigurationLogStream defaults) {
        ...
        public Builder timeZone(@Nullable String timeZone) {
            this.timeZone = timeZone;
            return this;
        }        public PhpAppLayerCloudwatchConfigurationLogStream build() {
            return new PhpAppLayerCloudwatchConfigurationLogStream(batchCount, batchSize, bufferDuration, datetimeFormat, encoding, file, fileFingerprintLines, initialPosition, logGroupName, multilineStartPattern, timeZone);
        }
    }
}
