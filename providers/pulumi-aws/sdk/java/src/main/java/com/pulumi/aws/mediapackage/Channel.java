...
public class Channel extends CustomResource {
    ...
    private Channel(String name, Output<String> id, @Nullable ChannelState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Channel get(String name, Output<String> id, @Nullable ChannelState state, @Nullable CustomResourceOptions options) {
