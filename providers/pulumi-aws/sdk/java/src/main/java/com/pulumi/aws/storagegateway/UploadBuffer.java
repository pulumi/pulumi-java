...
public class UploadBuffer extends CustomResource {
     ...
     */
    public UploadBuffer(String name, UploadBufferArgs args, @Nullable CustomResourceOptions options) {
    ...
    private UploadBuffer(String name, Output<String> id, @Nullable UploadBufferState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UploadBuffer get(String name, Output<String> id, @Nullable UploadBufferState state, @Nullable CustomResourceOptions options) {
