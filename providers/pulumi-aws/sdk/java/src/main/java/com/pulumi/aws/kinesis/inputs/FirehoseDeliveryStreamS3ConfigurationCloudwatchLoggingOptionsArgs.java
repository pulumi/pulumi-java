...
public final class FirehoseDeliveryStreamS3ConfigurationCloudwatchLoggingOptionsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FirehoseDeliveryStreamS3ConfigurationCloudwatchLoggingOptionsArgs(FirehoseDeliveryStreamS3ConfigurationCloudwatchLoggingOptionsArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirehoseDeliveryStreamS3ConfigurationCloudwatchLoggingOptionsArgs();
        }

        public Builder(FirehoseDeliveryStreamS3ConfigurationCloudwatchLoggingOptionsArgs defaults) {
            $ = new FirehoseDeliveryStreamS3ConfigurationCloudwatchLoggingOptionsArgs(Objects.requireNonNull(defaults));
        }
