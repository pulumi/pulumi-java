...
public final class GetSubnetGroupArgs extends InvokeArgs {
    ...
    /**
     * @return The name of the RDS database subnet group.
     * 
     */
    public String name() {
        return this.name;
    ...
    public static final class Builder {
        ...
        /**
         * @param name The name of the RDS database subnet group.
         * 
         * @return builder
         * 
         */
