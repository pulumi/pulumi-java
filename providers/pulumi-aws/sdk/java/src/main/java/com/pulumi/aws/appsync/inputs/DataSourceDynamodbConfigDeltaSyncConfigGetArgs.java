...
public final class DataSourceDynamodbConfigDeltaSyncConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DataSourceDynamodbConfigDeltaSyncConfigGetArgs(DataSourceDynamodbConfigDeltaSyncConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataSourceDynamodbConfigDeltaSyncConfigGetArgs();
        }

        public Builder(DataSourceDynamodbConfigDeltaSyncConfigGetArgs defaults) {
            $ = new DataSourceDynamodbConfigDeltaSyncConfigGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DataSourceDynamodbConfigDeltaSyncConfigGetArgs build() {
            $.deltaSyncTableName = Objects.requireNonNull($.deltaSyncTableName, "expected parameter 'deltaSyncTableName' to be non-null");
            return $;
        }
    }
