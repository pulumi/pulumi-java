...
public class GangliaLayer extends CustomResource {
    /**
    ...
    @Export(name="cloudwatchConfiguration", type=GangliaLayerCloudwatchConfiguration.class, parameters={})
     ...
     */
    public GangliaLayer(String name, GangliaLayerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GangliaLayer(String name, Output<String> id, @Nullable GangliaLayerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GangliaLayer get(String name, Output<String> id, @Nullable GangliaLayerState state, @Nullable CustomResourceOptions options) {
