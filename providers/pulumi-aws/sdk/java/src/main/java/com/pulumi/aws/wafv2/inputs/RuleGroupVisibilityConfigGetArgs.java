...
public final class RuleGroupVisibilityConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RuleGroupVisibilityConfigGetArgs(RuleGroupVisibilityConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupVisibilityConfigGetArgs();
        }

        public Builder(RuleGroupVisibilityConfigGetArgs defaults) {
            $ = new RuleGroupVisibilityConfigGetArgs(Objects.requireNonNull(defaults));
        }
