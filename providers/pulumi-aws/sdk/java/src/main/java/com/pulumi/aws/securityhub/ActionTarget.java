...
public class ActionTarget extends CustomResource {
    /**
     ...
     */
    public ActionTarget(String name, ActionTargetArgs args, @Nullable CustomResourceOptions options) {
        super("aws:securityhub/actionTarget:ActionTarget", name, args == null ? ActionTargetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ActionTarget(String name, Output<String> id, @Nullable ActionTargetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ActionTarget get(String name, Output<String> id, @Nullable ActionTargetState state, @Nullable CustomResourceOptions options) {
