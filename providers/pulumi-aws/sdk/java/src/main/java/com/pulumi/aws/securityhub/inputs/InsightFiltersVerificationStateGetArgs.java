...
public final class InsightFiltersVerificationStateGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final InsightFiltersVerificationStateGetArgs Empty = new InsightFiltersVerificationStateGetArgs();
    ...
    private InsightFiltersVerificationStateGetArgs() {}

    private InsightFiltersVerificationStateGetArgs(InsightFiltersVerificationStateGetArgs $) {
    ...
    public static Builder builder(InsightFiltersVerificationStateGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersVerificationStateGetArgs();
        }

        public Builder(InsightFiltersVerificationStateGetArgs defaults) {
            $ = new InsightFiltersVerificationStateGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InsightFiltersVerificationStateGetArgs build() {
