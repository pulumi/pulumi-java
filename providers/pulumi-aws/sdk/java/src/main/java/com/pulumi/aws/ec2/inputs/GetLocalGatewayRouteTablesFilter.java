...
public final class GetLocalGatewayRouteTablesFilter extends com.pulumi.resources.InvokeArgs {
    ...
    private GetLocalGatewayRouteTablesFilter(GetLocalGatewayRouteTablesFilter $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLocalGatewayRouteTablesFilter();
        }

        public Builder(GetLocalGatewayRouteTablesFilter defaults) {
            $ = new GetLocalGatewayRouteTablesFilter(Objects.requireNonNull(defaults));
        }
