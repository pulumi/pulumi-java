...
public final class AmiFromInstanceEbsBlockDeviceGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AmiFromInstanceEbsBlockDeviceGetArgs(AmiFromInstanceEbsBlockDeviceGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AmiFromInstanceEbsBlockDeviceGetArgs();
        }

        public Builder(AmiFromInstanceEbsBlockDeviceGetArgs defaults) {
            $ = new AmiFromInstanceEbsBlockDeviceGetArgs(Objects.requireNonNull(defaults));
        }
