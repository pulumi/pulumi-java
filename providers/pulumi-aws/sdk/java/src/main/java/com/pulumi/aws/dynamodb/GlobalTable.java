...
public class GlobalTable extends CustomResource {
    /**
     ...
     */
    public GlobalTable(String name, GlobalTableArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GlobalTable(String name, Output<String> id, @Nullable GlobalTableState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GlobalTable get(String name, Output<String> id, @Nullable GlobalTableState state, @Nullable CustomResourceOptions options) {
