...
public final class ClassificationJobScheduleFrequencyGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClassificationJobScheduleFrequencyGetArgs(ClassificationJobScheduleFrequencyGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClassificationJobScheduleFrequencyGetArgs();
        }

        public Builder(ClassificationJobScheduleFrequencyGetArgs defaults) {
            $ = new ClassificationJobScheduleFrequencyGetArgs(Objects.requireNonNull(defaults));
        }
