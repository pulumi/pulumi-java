...
public class DomainIdentityVerification extends CustomResource {
     ...
     */
    public DomainIdentityVerification(String name, DomainIdentityVerificationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DomainIdentityVerification(String name, Output<String> id, @Nullable DomainIdentityVerificationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DomainIdentityVerification get(String name, Output<String> id, @Nullable DomainIdentityVerificationState state, @Nullable CustomResourceOptions options) {
