...
public final class UserProfileUserSettingsJupyterServerAppSettingsDefaultResourceSpecArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private UserProfileUserSettingsJupyterServerAppSettingsDefaultResourceSpecArgs(UserProfileUserSettingsJupyterServerAppSettingsDefaultResourceSpecArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserProfileUserSettingsJupyterServerAppSettingsDefaultResourceSpecArgs();
        }

        public Builder(UserProfileUserSettingsJupyterServerAppSettingsDefaultResourceSpecArgs defaults) {
            $ = new UserProfileUserSettingsJupyterServerAppSettingsDefaultResourceSpecArgs(Objects.requireNonNull(defaults));
        }
