...
public class VpcIpamScope extends CustomResource {
     ...
     */
    public VpcIpamScope(String name, VpcIpamScopeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VpcIpamScope(String name, Output<String> id, @Nullable VpcIpamScopeState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpcIpamScope get(String name, Output<String> id, @Nullable VpcIpamScopeState state, @Nullable CustomResourceOptions options) {
