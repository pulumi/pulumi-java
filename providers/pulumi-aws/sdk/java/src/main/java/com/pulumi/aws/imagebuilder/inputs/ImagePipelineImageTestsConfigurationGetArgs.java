...
public final class ImagePipelineImageTestsConfigurationGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ImagePipelineImageTestsConfigurationGetArgs(ImagePipelineImageTestsConfigurationGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ImagePipelineImageTestsConfigurationGetArgs();
        }

        public Builder(ImagePipelineImageTestsConfigurationGetArgs defaults) {
            $ = new ImagePipelineImageTestsConfigurationGetArgs(Objects.requireNonNull(defaults));
        }
