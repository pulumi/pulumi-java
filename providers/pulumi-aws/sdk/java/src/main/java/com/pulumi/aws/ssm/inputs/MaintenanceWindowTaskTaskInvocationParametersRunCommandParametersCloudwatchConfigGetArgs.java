...
public final class MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersCloudwatchConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersCloudwatchConfigGetArgs(MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersCloudwatchConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersCloudwatchConfigGetArgs();
        }

        public Builder(MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersCloudwatchConfigGetArgs defaults) {
            $ = new MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersCloudwatchConfigGetArgs(Objects.requireNonNull(defaults));
        }
