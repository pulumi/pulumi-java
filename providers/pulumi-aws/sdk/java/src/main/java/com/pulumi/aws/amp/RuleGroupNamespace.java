...
public class RuleGroupNamespace extends CustomResource {
     ...
     */
    public RuleGroupNamespace(String name, RuleGroupNamespaceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RuleGroupNamespace(String name, Output<String> id, @Nullable RuleGroupNamespaceState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RuleGroupNamespace get(String name, Output<String> id, @Nullable RuleGroupNamespaceState state, @Nullable CustomResourceOptions options) {
