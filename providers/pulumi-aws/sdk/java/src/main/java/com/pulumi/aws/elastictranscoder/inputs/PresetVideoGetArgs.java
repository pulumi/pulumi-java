...
public final class PresetVideoGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PresetVideoGetArgs(PresetVideoGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PresetVideoGetArgs();
        }

        public Builder(PresetVideoGetArgs defaults) {
            $ = new PresetVideoGetArgs(Objects.requireNonNull(defaults));
        }
