...
public class MaintenanceWindowTask extends CustomResource {
     ...
     */
    public MaintenanceWindowTask(String name, MaintenanceWindowTaskArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MaintenanceWindowTask(String name, Output<String> id, @Nullable MaintenanceWindowTaskState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MaintenanceWindowTask get(String name, Output<String> id, @Nullable MaintenanceWindowTaskState state, @Nullable CustomResourceOptions options) {
