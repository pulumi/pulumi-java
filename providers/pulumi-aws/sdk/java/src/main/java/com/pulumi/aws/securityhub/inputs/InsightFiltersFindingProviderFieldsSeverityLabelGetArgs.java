...
public final class InsightFiltersFindingProviderFieldsSeverityLabelGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersFindingProviderFieldsSeverityLabelGetArgs(InsightFiltersFindingProviderFieldsSeverityLabelGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersFindingProviderFieldsSeverityLabelGetArgs();
        }

        public Builder(InsightFiltersFindingProviderFieldsSeverityLabelGetArgs defaults) {
            $ = new InsightFiltersFindingProviderFieldsSeverityLabelGetArgs(Objects.requireNonNull(defaults));
        }
