...
public class LogDestinationPolicy extends CustomResource {
     ...
     */
    public LogDestinationPolicy(String name, LogDestinationPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LogDestinationPolicy(String name, Output<String> id, @Nullable LogDestinationPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LogDestinationPolicy get(String name, Output<String> id, @Nullable LogDestinationPolicyState state, @Nullable CustomResourceOptions options) {
