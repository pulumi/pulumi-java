...
public class VpcEndpoint extends CustomResource {
     ...
     */
    public VpcEndpoint(String name, VpcEndpointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VpcEndpoint(String name, Output<String> id, @Nullable VpcEndpointState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpcEndpoint get(String name, Output<String> id, @Nullable VpcEndpointState state, @Nullable CustomResourceOptions options) {
