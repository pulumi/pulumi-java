...
public class IpSet extends CustomResource {
    /**
     ...
     */
    public IpSet(String name, IpSetArgs args, @Nullable CustomResourceOptions options) {
        super("aws:wafv2/ipSet:IpSet", name, args == null ? IpSetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private IpSet(String name, Output<String> id, @Nullable IpSetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IpSet get(String name, Output<String> id, @Nullable IpSetState state, @Nullable CustomResourceOptions options) {
