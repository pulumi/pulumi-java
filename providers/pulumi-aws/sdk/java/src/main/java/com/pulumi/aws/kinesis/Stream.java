...
public class Stream extends CustomResource {
    /**
     ...
     */
    public Stream(String name, @Nullable StreamArgs args, @Nullable CustomResourceOptions options) {
        super("aws:kinesis/stream:Stream", name, args == null ? StreamArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Stream(String name, Output<String> id, @Nullable StreamState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Stream get(String name, Output<String> id, @Nullable StreamState state, @Nullable CustomResourceOptions options) {
