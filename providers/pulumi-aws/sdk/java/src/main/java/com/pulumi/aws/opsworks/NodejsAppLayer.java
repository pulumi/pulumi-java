...
public class NodejsAppLayer extends CustomResource {
    /**
     ...
     * 
     */
    public Output<Optional<List<NodejsAppLayerEbsVolume>>> ebsVolumes() {
     ...
     */
    public NodejsAppLayer(String name, NodejsAppLayerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NodejsAppLayer(String name, Output<String> id, @Nullable NodejsAppLayerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NodejsAppLayer get(String name, Output<String> id, @Nullable NodejsAppLayerState state, @Nullable CustomResourceOptions options) {
