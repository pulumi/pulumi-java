...
public class ContactFlow extends CustomResource {
    /**
     ...
     */
    public ContactFlow(String name, ContactFlowArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ContactFlow(String name, Output<String> id, @Nullable ContactFlowState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ContactFlow get(String name, Output<String> id, @Nullable ContactFlowState state, @Nullable CustomResourceOptions options) {
