...
public class Accelerator extends CustomResource {
    /**
     ...
     */
    public Accelerator(String name, @Nullable AcceleratorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Accelerator(String name, Output<String> id, @Nullable AcceleratorState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Accelerator get(String name, Output<String> id, @Nullable AcceleratorState state, @Nullable CustomResourceOptions options) {
