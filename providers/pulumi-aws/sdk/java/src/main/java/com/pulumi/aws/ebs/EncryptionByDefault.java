...
public class EncryptionByDefault extends CustomResource {
    /**
     ...
     */
    public EncryptionByDefault(String name, @Nullable EncryptionByDefaultArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EncryptionByDefault(String name, Output<String> id, @Nullable EncryptionByDefaultState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EncryptionByDefault get(String name, Output<String> id, @Nullable EncryptionByDefaultState state, @Nullable CustomResourceOptions options) {
