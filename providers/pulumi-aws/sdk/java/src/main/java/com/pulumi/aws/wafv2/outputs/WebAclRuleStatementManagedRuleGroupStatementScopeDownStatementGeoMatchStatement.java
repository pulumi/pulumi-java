...
public final class WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatement {
     ...
     * 
     */
    private final @Nullable WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatementForwardedIpConfig forwardedIpConfig;
    ...
    private WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatement(
        ...
        @CustomType.Parameter("forwardedIpConfig") @Nullable WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatementForwardedIpConfig forwardedIpConfig) {
    ...
    */
     ...
     * 
    */
    public Optional<WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatementForwardedIpConfig> getForwardedIpConfig() {
    ...
    public static final class Builder {
        ...
        public Builder forwardedIpConfig(@Nullable WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatementForwardedIpConfig forwardedIpConfig) {
            ...
            return new WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatement(countryCodes, forwardedIpConfig);
        }
    }
}
