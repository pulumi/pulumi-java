...
public final class VirtualGatewaySpecListenerTlsCertificateFileGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final VirtualGatewaySpecListenerTlsCertificateFileGetArgs Empty = new VirtualGatewaySpecListenerTlsCertificateFileGetArgs();
    ...
    private VirtualGatewaySpecListenerTlsCertificateFileGetArgs() {}

    private VirtualGatewaySpecListenerTlsCertificateFileGetArgs(VirtualGatewaySpecListenerTlsCertificateFileGetArgs $) {
    ...
    public static Builder builder(VirtualGatewaySpecListenerTlsCertificateFileGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualGatewaySpecListenerTlsCertificateFileGetArgs();
        }

        public Builder(VirtualGatewaySpecListenerTlsCertificateFileGetArgs defaults) {
            $ = new VirtualGatewaySpecListenerTlsCertificateFileGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VirtualGatewaySpecListenerTlsCertificateFileGetArgs build() {
