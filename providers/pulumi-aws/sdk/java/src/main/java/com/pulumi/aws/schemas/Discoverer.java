...
public class Discoverer extends CustomResource {
    /**
     ...
     */
    public Discoverer(String name, DiscovererArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Discoverer(String name, Output<String> id, @Nullable DiscovererState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Discoverer get(String name, Output<String> id, @Nullable DiscovererState state, @Nullable CustomResourceOptions options) {
