...
public class DefaultSecurityGroup extends CustomResource {
     ...
     */
    public DefaultSecurityGroup(String name, @Nullable DefaultSecurityGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DefaultSecurityGroup(String name, Output<String> id, @Nullable DefaultSecurityGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DefaultSecurityGroup get(String name, Output<String> id, @Nullable DefaultSecurityGroupState state, @Nullable CustomResourceOptions options) {
