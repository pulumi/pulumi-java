...
public class DomainDkim extends CustomResource {
    /**
     ...
     */
    public DomainDkim(String name, DomainDkimArgs args, @Nullable CustomResourceOptions options) {
        super("aws:ses/domainDkim:DomainDkim", name, args == null ? DomainDkimArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DomainDkim(String name, Output<String> id, @Nullable DomainDkimState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DomainDkim get(String name, Output<String> id, @Nullable DomainDkimState state, @Nullable CustomResourceOptions options) {
