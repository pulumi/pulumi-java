...
public final class HaproxyLayerCloudwatchConfigurationGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Output<List<HaproxyLayerCloudwatchConfigurationLogStreamGetArgs>> logStreams() {
        return this.logStreams == null ? Codegen.empty() : this.logStreams;
    }

    public HaproxyLayerCloudwatchConfigurationGetArgs(
        @Nullable Output<Boolean> enabled,
        @Nullable Output<List<HaproxyLayerCloudwatchConfigurationLogStreamGetArgs>> logStreams) {
