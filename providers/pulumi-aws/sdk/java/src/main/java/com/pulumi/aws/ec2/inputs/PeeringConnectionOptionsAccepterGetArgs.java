...
public final class PeeringConnectionOptionsAccepterGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final PeeringConnectionOptionsAccepterGetArgs Empty = new PeeringConnectionOptionsAccepterGetArgs();
    ...
    private PeeringConnectionOptionsAccepterGetArgs() {
    ...
    public static Builder builder(PeeringConnectionOptionsAccepterGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PeeringConnectionOptionsAccepterGetArgs defaults) {
        ...
        public Builder allowVpcToRemoteClassicLink(@Nullable Boolean allowVpcToRemoteClassicLink) {
            ...
            return this;
        }        public PeeringConnectionOptionsAccepterGetArgs build() {
            return new PeeringConnectionOptionsAccepterGetArgs(allowClassicLinkToRemoteVpc, allowRemoteVpcDnsResolution, allowVpcToRemoteClassicLink);
        }
    }
}
