...
public class ContactFlowModule extends CustomResource {
    ...
    private ContactFlowModule(String name, Output<String> id, @Nullable ContactFlowModuleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ContactFlowModule get(String name, Output<String> id, @Nullable ContactFlowModuleState state, @Nullable CustomResourceOptions options) {
