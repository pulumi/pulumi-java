...
public final class RuleGroupRuleStatementByteMatchStatementFieldToMatchSingleHeaderGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public RuleGroupRuleStatementByteMatchStatementFieldToMatchSingleHeaderGetArgs(Output<String> name) {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            ...
            return new RuleGroupRuleStatementByteMatchStatementFieldToMatchSingleHeaderGetArgs(name);
        }
    }
}
