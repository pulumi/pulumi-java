...
public final class DistributionLoggingConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DistributionLoggingConfigGetArgs(DistributionLoggingConfigGetArgs $) {
        this.bucket = $.bucket;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DistributionLoggingConfigGetArgs();
        }

        public Builder(DistributionLoggingConfigGetArgs defaults) {
            $ = new DistributionLoggingConfigGetArgs(Objects.requireNonNull(defaults));
        }
