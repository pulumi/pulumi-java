...
public class CatalogDatabase extends CustomResource {
    /**
     ...
     */
    public CatalogDatabase(String name, @Nullable CatalogDatabaseArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CatalogDatabase(String name, Output<String> id, @Nullable CatalogDatabaseState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CatalogDatabase get(String name, Output<String> id, @Nullable CatalogDatabaseState state, @Nullable CustomResourceOptions options) {
