...
public class CompositeAlarm extends CustomResource {
    /**
     ...
     */
    public CompositeAlarm(String name, CompositeAlarmArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CompositeAlarm(String name, Output<String> id, @Nullable CompositeAlarmState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CompositeAlarm get(String name, Output<String> id, @Nullable CompositeAlarmState state, @Nullable CustomResourceOptions options) {
