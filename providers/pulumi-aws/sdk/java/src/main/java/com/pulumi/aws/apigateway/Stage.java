...
public class Stage extends CustomResource {
     ...
     */
    public Stage(String name, StageArgs args, @Nullable CustomResourceOptions options) {
        super("aws:apigateway/stage:Stage", name, args == null ? StageArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Stage(String name, Output<String> id, @Nullable StageState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Stage get(String name, Output<String> id, @Nullable StageState state, @Nullable CustomResourceOptions options) {
