...
public class WorkingStorage extends CustomResource {
     ...
     */
    public WorkingStorage(String name, WorkingStorageArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WorkingStorage(String name, Output<String> id, @Nullable WorkingStorageState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkingStorage get(String name, Output<String> id, @Nullable WorkingStorageState state, @Nullable CustomResourceOptions options) {
