...
public class SmsChannel extends CustomResource {
    /**
     * The application ID.
     * 
     */
     ...
     */
    public SmsChannel(String name, SmsChannelArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SmsChannel(String name, Output<String> id, @Nullable SmsChannelState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SmsChannel get(String name, Output<String> id, @Nullable SmsChannelState state, @Nullable CustomResourceOptions options) {
