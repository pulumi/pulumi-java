...
import com.pulumi.aws.cloudfront.inputs.DistributionDefaultCacheBehaviorForwardedValuesGetArgs;
import com.pulumi.aws.cloudfront.inputs.DistributionDefaultCacheBehaviorFunctionAssociationGetArgs;
import com.pulumi.aws.cloudfront.inputs.DistributionDefaultCacheBehaviorLambdaFunctionAssociationGetArgs;
...
public final class DistributionDefaultCacheBehaviorGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="forwardedValues")
      private final @Nullable Output<DistributionDefaultCacheBehaviorForwardedValuesGetArgs> forwardedValues;

    public Output<DistributionDefaultCacheBehaviorForwardedValuesGetArgs> getForwardedValues() {
    ...
    @Import(name="functionAssociations")
      private final @Nullable Output<List<DistributionDefaultCacheBehaviorFunctionAssociationGetArgs>> functionAssociations;

    public Output<List<DistributionDefaultCacheBehaviorFunctionAssociationGetArgs>> getFunctionAssociations() {
    ...
    @Import(name="lambdaFunctionAssociations")
      private final @Nullable Output<List<DistributionDefaultCacheBehaviorLambdaFunctionAssociationGetArgs>> lambdaFunctionAssociations;

    public Output<List<DistributionDefaultCacheBehaviorLambdaFunctionAssociationGetArgs>> getLambdaFunctionAssociations() {
    ...
    public DistributionDefaultCacheBehaviorGetArgs(
        ...
        @Nullable Output<DistributionDefaultCacheBehaviorForwardedValuesGetArgs> forwardedValues,
        @Nullable Output<List<DistributionDefaultCacheBehaviorFunctionAssociationGetArgs>> functionAssociations,
        @Nullable Output<List<DistributionDefaultCacheBehaviorLambdaFunctionAssociationGetArgs>> lambdaFunctionAssociations,
    ...
    public static final class Builder {
        ...
        private @Nullable Output<DistributionDefaultCacheBehaviorForwardedValuesGetArgs> forwardedValues;
        private @Nullable Output<List<DistributionDefaultCacheBehaviorFunctionAssociationGetArgs>> functionAssociations;
        private @Nullable Output<List<DistributionDefaultCacheBehaviorLambdaFunctionAssociationGetArgs>> lambdaFunctionAssociations;
        ...
        public Builder forwardedValues(@Nullable Output<DistributionDefaultCacheBehaviorForwardedValuesGetArgs> forwardedValues) {
            this.forwardedValues = forwardedValues;
            return this;
        }
        public Builder forwardedValues(@Nullable DistributionDefaultCacheBehaviorForwardedValuesGetArgs forwardedValues) {
            this.forwardedValues = Codegen.ofNullable(forwardedValues);
            return this;
        }
        public Builder functionAssociations(@Nullable Output<List<DistributionDefaultCacheBehaviorFunctionAssociationGetArgs>> functionAssociations) {
            this.functionAssociations = functionAssociations;
            return this;
        }
        public Builder functionAssociations(@Nullable List<DistributionDefaultCacheBehaviorFunctionAssociationGetArgs> functionAssociations) {
            this.functionAssociations = Codegen.ofNullable(functionAssociations);
            return this;
        }
        public Builder functionAssociations(DistributionDefaultCacheBehaviorFunctionAssociationGetArgs... functionAssociations) {
            return functionAssociations(List.of(functionAssociations));
        }
        public Builder lambdaFunctionAssociations(@Nullable Output<List<DistributionDefaultCacheBehaviorLambdaFunctionAssociationGetArgs>> lambdaFunctionAssociations) {
            this.lambdaFunctionAssociations = lambdaFunctionAssociations;
            return this;
        }
        public Builder lambdaFunctionAssociations(@Nullable List<DistributionDefaultCacheBehaviorLambdaFunctionAssociationGetArgs> lambdaFunctionAssociations) {
            this.lambdaFunctionAssociations = Codegen.ofNullable(lambdaFunctionAssociations);
            return this;
        }
        public Builder lambdaFunctionAssociations(DistributionDefaultCacheBehaviorLambdaFunctionAssociationGetArgs... lambdaFunctionAssociations) {
