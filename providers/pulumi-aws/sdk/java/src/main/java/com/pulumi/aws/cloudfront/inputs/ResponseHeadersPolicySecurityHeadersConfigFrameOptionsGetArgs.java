...
public final class ResponseHeadersPolicySecurityHeadersConfigFrameOptionsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ResponseHeadersPolicySecurityHeadersConfigFrameOptionsGetArgs(ResponseHeadersPolicySecurityHeadersConfigFrameOptionsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ResponseHeadersPolicySecurityHeadersConfigFrameOptionsGetArgs();
        }

        public Builder(ResponseHeadersPolicySecurityHeadersConfigFrameOptionsGetArgs defaults) {
            $ = new ResponseHeadersPolicySecurityHeadersConfigFrameOptionsGetArgs(Objects.requireNonNull(defaults));
        }
