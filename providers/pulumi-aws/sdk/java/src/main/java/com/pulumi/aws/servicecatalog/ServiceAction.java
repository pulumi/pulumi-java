...
public class ServiceAction extends CustomResource {
    ...
    private ServiceAction(String name, Output<String> id, @Nullable ServiceActionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceAction get(String name, Output<String> id, @Nullable ServiceActionState state, @Nullable CustomResourceOptions options) {
