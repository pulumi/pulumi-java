...
public class OrganizationConfiguration extends CustomResource {
     ...
     */
    public OrganizationConfiguration(String name, OrganizationConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OrganizationConfiguration(String name, Output<String> id, @Nullable OrganizationConfigurationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OrganizationConfiguration get(String name, Output<String> id, @Nullable OrganizationConfigurationState state, @Nullable CustomResourceOptions options) {
