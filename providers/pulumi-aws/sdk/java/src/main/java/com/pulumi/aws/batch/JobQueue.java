...
public class JobQueue extends CustomResource {
    /**
     ...
     */
    public JobQueue(String name, JobQueueArgs args, @Nullable CustomResourceOptions options) {
        super("aws:batch/jobQueue:JobQueue", name, args == null ? JobQueueArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private JobQueue(String name, Output<String> id, @Nullable JobQueueState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static JobQueue get(String name, Output<String> id, @Nullable JobQueueState state, @Nullable CustomResourceOptions options) {
