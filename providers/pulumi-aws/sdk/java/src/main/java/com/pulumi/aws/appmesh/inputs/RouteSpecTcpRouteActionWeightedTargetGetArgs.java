...
public final class RouteSpecTcpRouteActionWeightedTargetGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final RouteSpecTcpRouteActionWeightedTargetGetArgs Empty = new RouteSpecTcpRouteActionWeightedTargetGetArgs();
    ...
    private RouteSpecTcpRouteActionWeightedTargetGetArgs() {}

    private RouteSpecTcpRouteActionWeightedTargetGetArgs(RouteSpecTcpRouteActionWeightedTargetGetArgs $) {
    ...
    public static Builder builder(RouteSpecTcpRouteActionWeightedTargetGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RouteSpecTcpRouteActionWeightedTargetGetArgs();
        }

        public Builder(RouteSpecTcpRouteActionWeightedTargetGetArgs defaults) {
            $ = new RouteSpecTcpRouteActionWeightedTargetGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RouteSpecTcpRouteActionWeightedTargetGetArgs build() {
