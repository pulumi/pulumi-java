...
public class VpcIpamPreviewNextCidr extends CustomResource {
    /**
     ...
     */
    public VpcIpamPreviewNextCidr(String name, VpcIpamPreviewNextCidrArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VpcIpamPreviewNextCidr(String name, Output<String> id, @Nullable VpcIpamPreviewNextCidrState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpcIpamPreviewNextCidr get(String name, Output<String> id, @Nullable VpcIpamPreviewNextCidrState state, @Nullable CustomResourceOptions options) {
