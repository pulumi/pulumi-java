...
public final class InsightFiltersProductArnGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final InsightFiltersProductArnGetArgs Empty = new InsightFiltersProductArnGetArgs();
    ...
    private InsightFiltersProductArnGetArgs() {}

    private InsightFiltersProductArnGetArgs(InsightFiltersProductArnGetArgs $) {
    ...
    public static Builder builder(InsightFiltersProductArnGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersProductArnGetArgs();
        }

        public Builder(InsightFiltersProductArnGetArgs defaults) {
            $ = new InsightFiltersProductArnGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InsightFiltersProductArnGetArgs build() {
