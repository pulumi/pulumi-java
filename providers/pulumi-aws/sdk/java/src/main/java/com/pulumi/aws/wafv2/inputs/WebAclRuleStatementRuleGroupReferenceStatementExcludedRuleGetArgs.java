...
public final class WebAclRuleStatementRuleGroupReferenceStatementExcludedRuleGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WebAclRuleStatementRuleGroupReferenceStatementExcludedRuleGetArgs(WebAclRuleStatementRuleGroupReferenceStatementExcludedRuleGetArgs $) {
        this.name = $.name;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementRuleGroupReferenceStatementExcludedRuleGetArgs();
        }

        public Builder(WebAclRuleStatementRuleGroupReferenceStatementExcludedRuleGetArgs defaults) {
            $ = new WebAclRuleStatementRuleGroupReferenceStatementExcludedRuleGetArgs(Objects.requireNonNull(defaults));
        }
