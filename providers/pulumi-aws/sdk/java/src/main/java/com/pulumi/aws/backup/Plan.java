...
public class Plan extends CustomResource {
     ...
     */
    public Plan(String name, PlanArgs args, @Nullable CustomResourceOptions options) {
        super("aws:backup/plan:Plan", name, args == null ? PlanArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Plan(String name, Output<String> id, @Nullable PlanState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Plan get(String name, Output<String> id, @Nullable PlanState state, @Nullable CustomResourceOptions options) {
