...
public class PeeringAttachment extends CustomResource {
    /**
     ...
     */
    public PeeringAttachment(String name, PeeringAttachmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PeeringAttachment(String name, Output<String> id, @Nullable PeeringAttachmentState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PeeringAttachment get(String name, Output<String> id, @Nullable PeeringAttachmentState state, @Nullable CustomResourceOptions options) {
