...
public class ProxyDefaultTargetGroup extends CustomResource {
    /**
     ...
     */
    public ProxyDefaultTargetGroup(String name, ProxyDefaultTargetGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProxyDefaultTargetGroup(String name, Output<String> id, @Nullable ProxyDefaultTargetGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProxyDefaultTargetGroup get(String name, Output<String> id, @Nullable ProxyDefaultTargetGroupState state, @Nullable CustomResourceOptions options) {
