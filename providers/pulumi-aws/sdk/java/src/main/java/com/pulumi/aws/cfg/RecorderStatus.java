...
public class RecorderStatus extends CustomResource {
     ...
     */
    public RecorderStatus(String name, RecorderStatusArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RecorderStatus(String name, Output<String> id, @Nullable RecorderStatusState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RecorderStatus get(String name, Output<String> id, @Nullable RecorderStatusState state, @Nullable CustomResourceOptions options) {
