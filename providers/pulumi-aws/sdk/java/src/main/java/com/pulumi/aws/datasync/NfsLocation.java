...
public class NfsLocation extends CustomResource {
    /**
     ...
     */
    public NfsLocation(String name, NfsLocationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NfsLocation(String name, Output<String> id, @Nullable NfsLocationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NfsLocation get(String name, Output<String> id, @Nullable NfsLocationState state, @Nullable CustomResourceOptions options) {
