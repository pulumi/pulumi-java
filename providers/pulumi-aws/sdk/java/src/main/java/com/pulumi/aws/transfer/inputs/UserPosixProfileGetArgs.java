...
public final class UserPosixProfileGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private UserPosixProfileGetArgs(UserPosixProfileGetArgs $) {
        this.gid = $.gid;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserPosixProfileGetArgs();
        }

        public Builder(UserPosixProfileGetArgs defaults) {
            $ = new UserPosixProfileGetArgs(Objects.requireNonNull(defaults));
        }
