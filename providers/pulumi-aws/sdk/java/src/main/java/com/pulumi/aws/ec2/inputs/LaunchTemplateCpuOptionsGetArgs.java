...
public final class LaunchTemplateCpuOptionsGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final LaunchTemplateCpuOptionsGetArgs Empty = new LaunchTemplateCpuOptionsGetArgs();
    ...
    private LaunchTemplateCpuOptionsGetArgs() {}

    private LaunchTemplateCpuOptionsGetArgs(LaunchTemplateCpuOptionsGetArgs $) {
    ...
    public static Builder builder(LaunchTemplateCpuOptionsGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LaunchTemplateCpuOptionsGetArgs();
        }

        public Builder(LaunchTemplateCpuOptionsGetArgs defaults) {
            $ = new LaunchTemplateCpuOptionsGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LaunchTemplateCpuOptionsGetArgs build() {
            return $;
        }
    }
