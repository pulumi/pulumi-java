...
import com.pulumi.aws.wafv2.inputs.RuleGroupRuleStatementAndStatementStatementOrStatementStatementGeoMatchStatementForwardedIpConfigGetArgs;
...
public final class RuleGroupRuleStatementAndStatementStatementOrStatementStatementGeoMatchStatementGetArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<RuleGroupRuleStatementAndStatementStatementOrStatementStatementGeoMatchStatementForwardedIpConfigGetArgs>> forwardedIpConfig() {
        return Optional.ofNullable(this.forwardedIpConfig);
    }

    private RuleGroupRuleStatementAndStatementStatementOrStatementStatementGeoMatchStatementGetArgs() {}

    private RuleGroupRuleStatementAndStatementStatementOrStatementStatementGeoMatchStatementGetArgs(RuleGroupRuleStatementAndStatementStatementOrStatementStatementGeoMatchStatementGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupRuleStatementAndStatementStatementOrStatementStatementGeoMatchStatementGetArgs();
        }

        public Builder(RuleGroupRuleStatementAndStatementStatementOrStatementStatementGeoMatchStatementGetArgs defaults) {
            $ = new RuleGroupRuleStatementAndStatementStatementOrStatementStatementGeoMatchStatementGetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder forwardedIpConfig(RuleGroupRuleStatementAndStatementStatementOrStatementStatementGeoMatchStatementForwardedIpConfigGetArgs forwardedIpConfig) {
