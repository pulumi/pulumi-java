...
public final class ClusterCacheNodeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterCacheNodeGetArgs(ClusterCacheNodeGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterCacheNodeGetArgs();
        }

        public Builder(ClusterCacheNodeGetArgs defaults) {
            $ = new ClusterCacheNodeGetArgs(Objects.requireNonNull(defaults));
        }
