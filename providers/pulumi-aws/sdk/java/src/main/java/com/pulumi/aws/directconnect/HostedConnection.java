...
public class HostedConnection extends CustomResource {
     ...
     */
    public HostedConnection(String name, HostedConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HostedConnection(String name, Output<String> id, @Nullable HostedConnectionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HostedConnection get(String name, Output<String> id, @Nullable HostedConnectionState state, @Nullable CustomResourceOptions options) {
