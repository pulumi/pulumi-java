...
import com.pulumi.aws.emr.inputs.ClusterMasterInstanceFleetInstanceTypeConfigGetArgs;
import com.pulumi.aws.emr.inputs.ClusterMasterInstanceFleetLaunchSpecificationsGetArgs;
...
public final class ClusterMasterInstanceFleetGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterMasterInstanceFleetGetArgs Empty = new ClusterMasterInstanceFleetGetArgs();
    ...
    @Import(name="instanceTypeConfigs")
      private final @Nullable Output<List<ClusterMasterInstanceFleetInstanceTypeConfigGetArgs>> instanceTypeConfigs;

    public Output<List<ClusterMasterInstanceFleetInstanceTypeConfigGetArgs>> getInstanceTypeConfigs() {
    ...
    @Import(name="launchSpecifications")
      private final @Nullable Output<ClusterMasterInstanceFleetLaunchSpecificationsGetArgs> launchSpecifications;

    public Output<ClusterMasterInstanceFleetLaunchSpecificationsGetArgs> getLaunchSpecifications() {
    ...
    public ClusterMasterInstanceFleetGetArgs(
        ...
        @Nullable Output<List<ClusterMasterInstanceFleetInstanceTypeConfigGetArgs>> instanceTypeConfigs,
        @Nullable Output<ClusterMasterInstanceFleetLaunchSpecificationsGetArgs> launchSpecifications,
    ...
    private ClusterMasterInstanceFleetGetArgs() {
    ...
    public static Builder builder(ClusterMasterInstanceFleetGetArgs defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable Output<String> id;
        private @Nullable Output<List<ClusterMasterInstanceFleetInstanceTypeConfigGetArgs>> instanceTypeConfigs;
        private @Nullable Output<ClusterMasterInstanceFleetLaunchSpecificationsGetArgs> launchSpecifications;
        ...
        public Builder(ClusterMasterInstanceFleetGetArgs defaults) {
        ...
        public Builder instanceTypeConfigs(@Nullable Output<List<ClusterMasterInstanceFleetInstanceTypeConfigGetArgs>> instanceTypeConfigs) {
            this.instanceTypeConfigs = instanceTypeConfigs;
            return this;
        }
        public Builder instanceTypeConfigs(@Nullable List<ClusterMasterInstanceFleetInstanceTypeConfigGetArgs> instanceTypeConfigs) {
            this.instanceTypeConfigs = Codegen.ofNullable(instanceTypeConfigs);
            return this;
        }
        public Builder instanceTypeConfigs(ClusterMasterInstanceFleetInstanceTypeConfigGetArgs... instanceTypeConfigs) {
            return instanceTypeConfigs(List.of(instanceTypeConfigs));
        }
        public Builder launchSpecifications(@Nullable Output<ClusterMasterInstanceFleetLaunchSpecificationsGetArgs> launchSpecifications) {
            this.launchSpecifications = launchSpecifications;
            return this;
        }
        public Builder launchSpecifications(@Nullable ClusterMasterInstanceFleetLaunchSpecificationsGetArgs launchSpecifications) {
        ...
        public Builder targetSpotCapacity(@Nullable Integer targetSpotCapacity) {
            ...
            return this;
        }        public ClusterMasterInstanceFleetGetArgs build() {
            return new ClusterMasterInstanceFleetGetArgs(id, instanceTypeConfigs, launchSpecifications, name, provisionedOnDemandCapacity, provisionedSpotCapacity, targetOnDemandCapacity, targetSpotCapacity);
        }
    }
}
