...
public final class ClusterMasterInstanceFleetGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<List<ClusterMasterInstanceFleetInstanceTypeConfigGetArgs>>> instanceTypeConfigs() {
    ...
    public Optional<Output<ClusterMasterInstanceFleetLaunchSpecificationsGetArgs>> launchSpecifications() {
    ...
    private ClusterMasterInstanceFleetGetArgs(ClusterMasterInstanceFleetGetArgs $) {
        this.id = $.id;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterMasterInstanceFleetGetArgs();
        }

        public Builder(ClusterMasterInstanceFleetGetArgs defaults) {
            $ = new ClusterMasterInstanceFleetGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder instanceTypeConfigs(List<ClusterMasterInstanceFleetInstanceTypeConfigGetArgs> instanceTypeConfigs) {
        ...
        public Builder launchSpecifications(ClusterMasterInstanceFleetLaunchSpecificationsGetArgs launchSpecifications) {
