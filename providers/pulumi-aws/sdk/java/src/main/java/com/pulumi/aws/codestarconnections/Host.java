...
public class Host extends CustomResource {
    ...
    private Host(String name, Output<String> id, @Nullable HostState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Host get(String name, Output<String> id, @Nullable HostState state, @Nullable CustomResourceOptions options) {
