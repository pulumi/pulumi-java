...
public final class ClusterClusterCertificateGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterClusterCertificateGetArgs(ClusterClusterCertificateGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterClusterCertificateGetArgs();
        }

        public Builder(ClusterClusterCertificateGetArgs defaults) {
            $ = new ClusterClusterCertificateGetArgs(Objects.requireNonNull(defaults));
        }
