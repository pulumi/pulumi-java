...
public final class TargetGroupStickinessGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TargetGroupStickinessGetArgs(TargetGroupStickinessGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TargetGroupStickinessGetArgs();
        }

        public Builder(TargetGroupStickinessGetArgs defaults) {
            $ = new TargetGroupStickinessGetArgs(Objects.requireNonNull(defaults));
        }
