...
public final class InsightFiltersFindingProviderFieldsConfidenceGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersFindingProviderFieldsConfidenceGetArgs(InsightFiltersFindingProviderFieldsConfidenceGetArgs $) {
        this.eq = $.eq;
        this.gte = $.gte;
        this.lte = $.lte;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersFindingProviderFieldsConfidenceGetArgs();
        }

        public Builder(InsightFiltersFindingProviderFieldsConfidenceGetArgs defaults) {
            $ = new InsightFiltersFindingProviderFieldsConfidenceGetArgs(Objects.requireNonNull(defaults));
        }
