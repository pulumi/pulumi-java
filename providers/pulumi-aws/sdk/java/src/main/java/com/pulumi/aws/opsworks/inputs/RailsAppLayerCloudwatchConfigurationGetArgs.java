...
import com.pulumi.aws.opsworks.inputs.RailsAppLayerCloudwatchConfigurationLogStreamGetArgs;
...
public final class RailsAppLayerCloudwatchConfigurationGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<List<RailsAppLayerCloudwatchConfigurationLogStreamGetArgs>>> logStreams() {
        return Optional.ofNullable(this.logStreams);
    }

    private RailsAppLayerCloudwatchConfigurationGetArgs() {}

    private RailsAppLayerCloudwatchConfigurationGetArgs(RailsAppLayerCloudwatchConfigurationGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RailsAppLayerCloudwatchConfigurationGetArgs();
        }

        public Builder(RailsAppLayerCloudwatchConfigurationGetArgs defaults) {
            $ = new RailsAppLayerCloudwatchConfigurationGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder logStreams(List<RailsAppLayerCloudwatchConfigurationLogStreamGetArgs> logStreams) {
