...
public final class DirectoryWorkspaceAccessPropertiesGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DirectoryWorkspaceAccessPropertiesGetArgs(DirectoryWorkspaceAccessPropertiesGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DirectoryWorkspaceAccessPropertiesGetArgs();
        }

        public Builder(DirectoryWorkspaceAccessPropertiesGetArgs defaults) {
            $ = new DirectoryWorkspaceAccessPropertiesGetArgs(Objects.requireNonNull(defaults));
        }
