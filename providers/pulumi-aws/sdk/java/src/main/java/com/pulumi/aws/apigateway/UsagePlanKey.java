...
public class UsagePlanKey extends CustomResource {
    ...
    private UsagePlanKey(String name, Output<String> id, @Nullable UsagePlanKeyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UsagePlanKey get(String name, Output<String> id, @Nullable UsagePlanKeyState state, @Nullable CustomResourceOptions options) {
