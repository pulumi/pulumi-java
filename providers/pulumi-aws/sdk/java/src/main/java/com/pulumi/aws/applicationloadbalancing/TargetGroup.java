...
import com.pulumi.aws.applicationloadbalancing.TargetGroupArgs;
import com.pulumi.aws.applicationloadbalancing.inputs.TargetGroupState;
import com.pulumi.aws.applicationloadbalancing.outputs.TargetGroupHealthCheck;
import com.pulumi.aws.applicationloadbalancing.outputs.TargetGroupStickiness;
...
public class TargetGroup extends CustomResource {
    ...
    public TargetGroup(String name, @Nullable TargetGroupArgs args, @Nullable CustomResourceOptions options) {
        super("aws:applicationloadbalancing/targetGroup:TargetGroup", name, args == null ? TargetGroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
