...
public class VpnGatewayAttachment extends CustomResource {
    /**
     * The ID of the VPC.
     * 
     */
     ...
     */
    public VpnGatewayAttachment(String name, VpnGatewayAttachmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VpnGatewayAttachment(String name, Output<String> id, @Nullable VpnGatewayAttachmentState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpnGatewayAttachment get(String name, Output<String> id, @Nullable VpnGatewayAttachmentState state, @Nullable CustomResourceOptions options) {
