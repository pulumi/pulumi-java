...
public final class InsightFiltersRecommendationTextGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final InsightFiltersRecommendationTextGetArgs Empty = new InsightFiltersRecommendationTextGetArgs();
    ...
    private InsightFiltersRecommendationTextGetArgs() {}

    private InsightFiltersRecommendationTextGetArgs(InsightFiltersRecommendationTextGetArgs $) {
    ...
    public static Builder builder(InsightFiltersRecommendationTextGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersRecommendationTextGetArgs();
        }

        public Builder(InsightFiltersRecommendationTextGetArgs defaults) {
            $ = new InsightFiltersRecommendationTextGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InsightFiltersRecommendationTextGetArgs build() {
