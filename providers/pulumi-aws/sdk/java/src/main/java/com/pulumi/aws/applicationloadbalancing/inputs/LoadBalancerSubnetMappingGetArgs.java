...
public final class LoadBalancerSubnetMappingGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private LoadBalancerSubnetMappingGetArgs(LoadBalancerSubnetMappingGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoadBalancerSubnetMappingGetArgs();
        }

        public Builder(LoadBalancerSubnetMappingGetArgs defaults) {
            $ = new LoadBalancerSubnetMappingGetArgs(Objects.requireNonNull(defaults));
        }
