...
public class RegexPatternSet extends CustomResource {
     ...
     */
    public RegexPatternSet(String name, @Nullable RegexPatternSetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegexPatternSet(String name, Output<String> id, @Nullable RegexPatternSetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegexPatternSet get(String name, Output<String> id, @Nullable RegexPatternSetState state, @Nullable CustomResourceOptions options) {
