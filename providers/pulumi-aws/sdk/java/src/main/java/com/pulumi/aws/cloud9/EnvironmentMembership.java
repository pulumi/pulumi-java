...
public class EnvironmentMembership extends CustomResource {
    /**
     ...
     */
    public EnvironmentMembership(String name, EnvironmentMembershipArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EnvironmentMembership(String name, Output<String> id, @Nullable EnvironmentMembershipState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EnvironmentMembership get(String name, Output<String> id, @Nullable EnvironmentMembershipState state, @Nullable CustomResourceOptions options) {
