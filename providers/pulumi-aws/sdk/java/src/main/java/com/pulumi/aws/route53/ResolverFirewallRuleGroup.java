...
public class ResolverFirewallRuleGroup extends CustomResource {
    /**
     ...
     */
    public ResolverFirewallRuleGroup(String name, @Nullable ResolverFirewallRuleGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResolverFirewallRuleGroup(String name, Output<String> id, @Nullable ResolverFirewallRuleGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResolverFirewallRuleGroup get(String name, Output<String> id, @Nullable ResolverFirewallRuleGroupState state, @Nullable CustomResourceOptions options) {
