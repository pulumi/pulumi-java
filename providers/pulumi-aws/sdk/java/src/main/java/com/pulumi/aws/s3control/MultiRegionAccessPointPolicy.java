 ...
 *                 .name(&#34;example&#34;)
 *                 .regions(MultiRegionAccessPointDetailsRegion.builder()
 ...
 *             .details(MultiRegionAccessPointPolicyDetails.builder()
 *                 .name(exampleMultiRegionAccessPoint.getId().apply(id -&gt; id.split(&#34;:&#34;))[1])
 *                 .policy(exampleMultiRegionAccessPoint.getAlias().apply(alias -&gt; serializeJson(
 *                     jsonObject(
 ...
 *                                 jsonProperty(&#34;AWS&#34;, currentCallerIdentity.apply(getCallerIdentityResult -&gt; getCallerIdentityResult.getAccountId()))
 *                             )),
 *                             jsonProperty(&#34;Action&#34;, jsonArray(
 *                                 &#34;s3:GetObject&#34;, 
 *                                 &#34;s3:PutObject&#34;
 *                             )),
 *                             jsonProperty(&#34;Resource&#34;, String.format(&#34;arn:%s:s3::%s:accesspoint/%s/object/*&#34;, currentPartition.apply(getPartitionResult -&gt; getPartitionResult.getPartition()),currentCallerIdentity.apply(getCallerIdentityResult -&gt; getCallerIdentityResult.getAccountId()),alias))
 *                         )))
 *                     ))))
 *                 .build())
 *             .build());
