...
public class LogSubscriptionFilter extends CustomResource {
    /**
     ...
     */
    public LogSubscriptionFilter(String name, LogSubscriptionFilterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LogSubscriptionFilter(String name, Output<String> id, @Nullable LogSubscriptionFilterState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LogSubscriptionFilter get(String name, Output<String> id, @Nullable LogSubscriptionFilterState state, @Nullable CustomResourceOptions options) {
