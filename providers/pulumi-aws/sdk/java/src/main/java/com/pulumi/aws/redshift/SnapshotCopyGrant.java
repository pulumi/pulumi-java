...
public class SnapshotCopyGrant extends CustomResource {
    /**
     ...
     */
    public SnapshotCopyGrant(String name, SnapshotCopyGrantArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SnapshotCopyGrant(String name, Output<String> id, @Nullable SnapshotCopyGrantState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SnapshotCopyGrant get(String name, Output<String> id, @Nullable SnapshotCopyGrantState state, @Nullable CustomResourceOptions options) {
