...
public final class RouteState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param instanceOwnerId The AWS account ID of the owner of the EC2 instance.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param origin How the route was created - `CreateRouteTable`, `CreateRoute` or `EnableVgwRoutePropagation`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param state The state of the route - `active` or `blackhole`.
         * 
         * @return builder
         * 
         */
