...
public class VpnGatewayRoutePropagation extends CustomResource {
     ...
     */
    public VpnGatewayRoutePropagation(String name, VpnGatewayRoutePropagationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VpnGatewayRoutePropagation(String name, Output<String> id, @Nullable VpnGatewayRoutePropagationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpnGatewayRoutePropagation get(String name, Output<String> id, @Nullable VpnGatewayRoutePropagationState state, @Nullable CustomResourceOptions options) {
