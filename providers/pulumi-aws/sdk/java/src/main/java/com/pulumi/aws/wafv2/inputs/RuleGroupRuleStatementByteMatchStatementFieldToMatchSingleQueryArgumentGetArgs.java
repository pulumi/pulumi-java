...
public final class RuleGroupRuleStatementByteMatchStatementFieldToMatchSingleQueryArgumentGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RuleGroupRuleStatementByteMatchStatementFieldToMatchSingleQueryArgumentGetArgs(RuleGroupRuleStatementByteMatchStatementFieldToMatchSingleQueryArgumentGetArgs $) {
        this.name = $.name;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupRuleStatementByteMatchStatementFieldToMatchSingleQueryArgumentGetArgs();
        }

        public Builder(RuleGroupRuleStatementByteMatchStatementFieldToMatchSingleQueryArgumentGetArgs defaults) {
            $ = new RuleGroupRuleStatementByteMatchStatementFieldToMatchSingleQueryArgumentGetArgs(Objects.requireNonNull(defaults));
        }
