...
public class Route extends CustomResource {
    ...
    private Route(String name, Output<String> id, @Nullable RouteState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Route get(String name, Output<String> id, @Nullable RouteState state, @Nullable CustomResourceOptions options) {
