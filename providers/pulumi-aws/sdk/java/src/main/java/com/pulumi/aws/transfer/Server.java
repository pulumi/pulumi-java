...
public class Server extends CustomResource {
     ...
     */
    public Server(String name, @Nullable ServerArgs args, @Nullable CustomResourceOptions options) {
        super("aws:transfer/server:Server", name, args == null ? ServerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Server(String name, Output<String> id, @Nullable ServerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Server get(String name, Output<String> id, @Nullable ServerState state, @Nullable CustomResourceOptions options) {
