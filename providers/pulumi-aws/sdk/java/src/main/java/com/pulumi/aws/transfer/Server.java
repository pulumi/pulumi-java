...
public class Server extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    public Output</* @Nullable */ ServerEndpointDetails> endpointDetails() {
     ...
     * 
     */
    public Output</* @Nullable */ String> function() {
     ...
     * 
     */
    public Output</* @Nullable */ String> hostKey() {
        return this.hostKey;
    }
    /**
     ...
     * 
     */
    public Output</* @Nullable */ String> identityProviderType() {
     ...
     * 
     */
    public Output</* @Nullable */ String> invocationRole() {
     ...
     * 
     */
    public Output</* @Nullable */ String> loggingRole() {
     ...
     * 
     */
    public Output</* @Nullable */ String> securityPolicyName() {
