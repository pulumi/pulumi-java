...
public final class StaticWebLayerEbsVolumeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private StaticWebLayerEbsVolumeGetArgs(StaticWebLayerEbsVolumeGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StaticWebLayerEbsVolumeGetArgs();
        }

        public Builder(StaticWebLayerEbsVolumeGetArgs defaults) {
            $ = new StaticWebLayerEbsVolumeGetArgs(Objects.requireNonNull(defaults));
        }
