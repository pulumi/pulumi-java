...
public class VaultPolicy extends CustomResource {
     ...
     */
    public VaultPolicy(String name, VaultPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VaultPolicy(String name, Output<String> id, @Nullable VaultPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VaultPolicy get(String name, Output<String> id, @Nullable VaultPolicyState state, @Nullable CustomResourceOptions options) {
