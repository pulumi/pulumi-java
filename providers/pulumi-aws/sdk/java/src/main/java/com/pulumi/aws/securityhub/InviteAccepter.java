...
public class InviteAccepter extends CustomResource {
     ...
     */
    public InviteAccepter(String name, InviteAccepterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private InviteAccepter(String name, Output<String> id, @Nullable InviteAccepterState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static InviteAccepter get(String name, Output<String> id, @Nullable InviteAccepterState state, @Nullable CustomResourceOptions options) {
