...
public class FieldLevelEncryptionProfile extends CustomResource {
     ...
     */
    public FieldLevelEncryptionProfile(String name, FieldLevelEncryptionProfileArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FieldLevelEncryptionProfile(String name, Output<String> id, @Nullable FieldLevelEncryptionProfileState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FieldLevelEncryptionProfile get(String name, Output<String> id, @Nullable FieldLevelEncryptionProfileState state, @Nullable CustomResourceOptions options) {
