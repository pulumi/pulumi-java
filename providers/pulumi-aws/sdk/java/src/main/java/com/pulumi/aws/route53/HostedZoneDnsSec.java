...
public class HostedZoneDnsSec extends CustomResource {
     ...
     */
    public HostedZoneDnsSec(String name, HostedZoneDnsSecArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HostedZoneDnsSec(String name, Output<String> id, @Nullable HostedZoneDnsSecState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HostedZoneDnsSec get(String name, Output<String> id, @Nullable HostedZoneDnsSecState state, @Nullable CustomResourceOptions options) {
