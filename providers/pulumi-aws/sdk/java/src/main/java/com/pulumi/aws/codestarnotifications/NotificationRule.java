...
public class NotificationRule extends CustomResource {
    ...
    private NotificationRule(String name, Output<String> id, @Nullable NotificationRuleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NotificationRule get(String name, Output<String> id, @Nullable NotificationRuleState state, @Nullable CustomResourceOptions options) {
