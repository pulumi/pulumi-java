...
public class SecurityProfile extends CustomResource {
     ...
     */
    public SecurityProfile(String name, SecurityProfileArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SecurityProfile(String name, Output<String> id, @Nullable SecurityProfileState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SecurityProfile get(String name, Output<String> id, @Nullable SecurityProfileState state, @Nullable CustomResourceOptions options) {
