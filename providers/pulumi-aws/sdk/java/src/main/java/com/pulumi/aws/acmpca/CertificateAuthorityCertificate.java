...
public class CertificateAuthorityCertificate extends CustomResource {
     ...
     */
    public CertificateAuthorityCertificate(String name, CertificateAuthorityCertificateArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CertificateAuthorityCertificate(String name, Output<String> id, @Nullable CertificateAuthorityCertificateState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CertificateAuthorityCertificate get(String name, Output<String> id, @Nullable CertificateAuthorityCertificateState state, @Nullable CustomResourceOptions options) {
