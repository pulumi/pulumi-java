 ...
 *             .certificateSigningRequest(exampleCertificateAuthority.getCertificateSigningRequest())
 *             .signingAlgorithm(&#34;SHA512WITHRSA&#34;)
 *             .templateArn(String.format(&#34;arn:%s:acm-pca:::template/RootCACertificate/V1&#34;, current.apply(getPartitionResult -&gt; getPartitionResult.getPartition())))
 ...
 *             .certificateAuthorityArn(exampleCertificateAuthority.getArn())
 *             .certificate(exampleCertificate.getCertificate())
 *             .certificateChain(exampleCertificate.getCertificateChain())
 *             .build());
 * 
 *         }
 * }
 ...
 *             .certificateAuthorityArn(rootCertificateAuthority.getArn())
 *             .certificateSigningRequest(subordinateCertificateAuthority.getCertificateSigningRequest())
 *             .signingAlgorithm(&#34;SHA512WITHRSA&#34;)
 *             .templateArn(String.format(&#34;arn:%s:acm-pca:::template/SubordinateCACertificate_PathLen0/V1&#34;, current.apply(getPartitionResult -&gt; getPartitionResult.getPartition())))
 *             .validity(CertificateValidity.builder()
 *                 .type(&#34;YEARS&#34;)
 *                 .value(1)
 *                 .build())
 ...
 *             .certificateAuthorityArn(subordinateCertificateAuthority.getArn())
 *             .certificate(subordinateCertificate.getCertificate())
 *             .certificateChain(subordinateCertificate.getCertificateChain())
 *             .build());
 * 
