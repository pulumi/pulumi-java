...
public class RouteTableAssociation extends CustomResource {
     ...
     */
    public RouteTableAssociation(String name, RouteTableAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RouteTableAssociation(String name, Output<String> id, @Nullable RouteTableAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RouteTableAssociation get(String name, Output<String> id, @Nullable RouteTableAssociationState state, @Nullable CustomResourceOptions options) {
