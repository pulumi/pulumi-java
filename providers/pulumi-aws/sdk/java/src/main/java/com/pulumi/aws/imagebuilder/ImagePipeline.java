...
public class ImagePipeline extends CustomResource {
     ...
     */
    public ImagePipeline(String name, ImagePipelineArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ImagePipeline(String name, Output<String> id, @Nullable ImagePipelineState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ImagePipeline get(String name, Output<String> id, @Nullable ImagePipelineState state, @Nullable CustomResourceOptions options) {
