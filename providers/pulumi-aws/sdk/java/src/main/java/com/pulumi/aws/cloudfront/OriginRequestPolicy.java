...
public class OriginRequestPolicy extends CustomResource {
    ...
    private OriginRequestPolicy(String name, Output<String> id, @Nullable OriginRequestPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OriginRequestPolicy get(String name, Output<String> id, @Nullable OriginRequestPolicyState state, @Nullable CustomResourceOptions options) {
