...
public final class InsightFiltersResourceDetailsOtherGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersResourceDetailsOtherGetArgs(InsightFiltersResourceDetailsOtherGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersResourceDetailsOtherGetArgs();
        }

        public Builder(InsightFiltersResourceDetailsOtherGetArgs defaults) {
            $ = new InsightFiltersResourceDetailsOtherGetArgs(Objects.requireNonNull(defaults));
        }
