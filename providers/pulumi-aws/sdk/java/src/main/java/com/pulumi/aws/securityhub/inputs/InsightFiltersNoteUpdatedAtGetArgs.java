...
public final class InsightFiltersNoteUpdatedAtGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="dateRange")
      private final @Nullable Output<InsightFiltersNoteUpdatedAtDateRangeGetArgs> dateRange;

    public Output<InsightFiltersNoteUpdatedAtDateRangeGetArgs> getDateRange() {
    ...
    public InsightFiltersNoteUpdatedAtGetArgs(
        @Nullable Output<InsightFiltersNoteUpdatedAtDateRangeGetArgs> dateRange,
    ...
    public static final class Builder {
        ...
        public Builder dateRange(@Nullable InsightFiltersNoteUpdatedAtDateRangeGetArgs dateRange) {
