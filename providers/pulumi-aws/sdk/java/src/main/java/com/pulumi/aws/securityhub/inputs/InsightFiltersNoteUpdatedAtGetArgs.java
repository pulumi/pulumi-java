...
import com.pulumi.aws.securityhub.inputs.InsightFiltersNoteUpdatedAtDateRangeGetArgs;
...
public final class InsightFiltersNoteUpdatedAtGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<InsightFiltersNoteUpdatedAtDateRangeGetArgs> dateRange;

    /**
     * @return A configuration block of the date range for the date filter. See date_range below for more details.
     * 
     */
    public Optional<Output<InsightFiltersNoteUpdatedAtDateRangeGetArgs>> dateRange() {
    ...
    private InsightFiltersNoteUpdatedAtGetArgs(InsightFiltersNoteUpdatedAtGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersNoteUpdatedAtGetArgs();
        }

        public Builder(InsightFiltersNoteUpdatedAtGetArgs defaults) {
            $ = new InsightFiltersNoteUpdatedAtGetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder dateRange(@Nullable Output<InsightFiltersNoteUpdatedAtDateRangeGetArgs> dateRange) {
            $.dateRange = dateRange;
            return this;
        }
         ...
         * 
         */
        public Builder dateRange(InsightFiltersNoteUpdatedAtDateRangeGetArgs dateRange) {
