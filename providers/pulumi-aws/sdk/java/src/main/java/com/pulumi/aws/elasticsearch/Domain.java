 ...
 *             .vpcId(selectedVpc.apply(getVpcResult -&gt; getVpcResult.getId()))
 ...
 *                 .toPort(443)
 *                 .protocol(&#34;tcp&#34;)
 *                 .cidrBlocks(selectedVpc.apply(getVpcResult -&gt; getVpcResult.getCidrBlock()))
 *                 .build())
 *             .build());
 * 
 ...
 *                 .subnetIds(                
 *                     selectedSubnetIds.apply(getSubnetIdsResult -&gt; getSubnetIdsResult.getIds()[0]),
 *                     selectedSubnetIds.apply(getSubnetIdsResult -&gt; getSubnetIdsResult.getIds()[1]))
 *                 .securityGroupIds(esSecurityGroup.getId())
 *                 .build())
