...
public final class DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpecGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpecGetArgs Empty = new DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpecGetArgs();
    ...
    private DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpecGetArgs(DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpecGetArgs $) {
    ...
    public static Builder builder(DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpecGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpecGetArgs();
        }

        public Builder(DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpecGetArgs defaults) {
            $ = new DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpecGetArgs(Objects.requireNonNull(defaults));
        }
