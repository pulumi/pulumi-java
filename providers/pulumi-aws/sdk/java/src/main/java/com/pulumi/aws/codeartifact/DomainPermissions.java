...
public class DomainPermissions extends CustomResource {
    /**
     ...
     */
    public DomainPermissions(String name, DomainPermissionsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DomainPermissions(String name, Output<String> id, @Nullable DomainPermissionsState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DomainPermissions get(String name, Output<String> id, @Nullable DomainPermissionsState state, @Nullable CustomResourceOptions options) {
