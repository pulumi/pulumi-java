...
public final class OpenZfsFileSystemRootVolumeConfigurationNfsExportsClientConfigurationGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OpenZfsFileSystemRootVolumeConfigurationNfsExportsClientConfigurationGetArgs(OpenZfsFileSystemRootVolumeConfigurationNfsExportsClientConfigurationGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OpenZfsFileSystemRootVolumeConfigurationNfsExportsClientConfigurationGetArgs();
        }

        public Builder(OpenZfsFileSystemRootVolumeConfigurationNfsExportsClientConfigurationGetArgs defaults) {
            $ = new OpenZfsFileSystemRootVolumeConfigurationNfsExportsClientConfigurationGetArgs(Objects.requireNonNull(defaults));
        }
