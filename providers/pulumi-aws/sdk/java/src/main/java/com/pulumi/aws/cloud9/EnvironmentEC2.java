...
public class EnvironmentEC2 extends CustomResource {
     ...
     */
    public EnvironmentEC2(String name, EnvironmentEC2Args args, @Nullable CustomResourceOptions options) {
    ...
    private EnvironmentEC2(String name, Output<String> id, @Nullable EnvironmentEC2State state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EnvironmentEC2 get(String name, Output<String> id, @Nullable EnvironmentEC2State state, @Nullable CustomResourceOptions options) {
