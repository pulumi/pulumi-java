...
public class ResourceServer extends CustomResource {
    /**
     ...
     */
    public ResourceServer(String name, ResourceServerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResourceServer(String name, Output<String> id, @Nullable ResourceServerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResourceServer get(String name, Output<String> id, @Nullable ResourceServerState state, @Nullable CustomResourceOptions options) {
