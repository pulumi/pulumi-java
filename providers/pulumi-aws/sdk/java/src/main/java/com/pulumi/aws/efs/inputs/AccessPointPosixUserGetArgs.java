...
public final class AccessPointPosixUserGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AccessPointPosixUserGetArgs(AccessPointPosixUserGetArgs $) {
        this.gid = $.gid;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessPointPosixUserGetArgs();
        }

        public Builder(AccessPointPosixUserGetArgs defaults) {
            $ = new AccessPointPosixUserGetArgs(Objects.requireNonNull(defaults));
        }
