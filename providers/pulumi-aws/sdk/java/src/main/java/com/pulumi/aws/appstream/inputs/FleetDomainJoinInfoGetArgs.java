...
public final class FleetDomainJoinInfoGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FleetDomainJoinInfoGetArgs(FleetDomainJoinInfoGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FleetDomainJoinInfoGetArgs();
        }

        public Builder(FleetDomainJoinInfoGetArgs defaults) {
            $ = new FleetDomainJoinInfoGetArgs(Objects.requireNonNull(defaults));
        }
