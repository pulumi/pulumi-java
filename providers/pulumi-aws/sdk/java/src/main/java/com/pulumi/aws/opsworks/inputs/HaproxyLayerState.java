...
public final class HaproxyLayerState extends com.pulumi.resources.ResourceArgs {
    ...
    public HaproxyLayerState(
        ...
        @Nullable Output<HaproxyLayerCloudwatchConfigurationGetArgs> cloudwatchConfiguration,
        ...
        @Nullable Output<List<HaproxyLayerEbsVolumeGetArgs>> ebsVolumes,
        ...
        @Nullable Output<String> statsPassword,
