...
public final class InsightFiltersResourceAwsIamAccessKeyStatusGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersResourceAwsIamAccessKeyStatusGetArgs(InsightFiltersResourceAwsIamAccessKeyStatusGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersResourceAwsIamAccessKeyStatusGetArgs();
        }

        public Builder(InsightFiltersResourceAwsIamAccessKeyStatusGetArgs defaults) {
            $ = new InsightFiltersResourceAwsIamAccessKeyStatusGetArgs(Objects.requireNonNull(defaults));
        }
