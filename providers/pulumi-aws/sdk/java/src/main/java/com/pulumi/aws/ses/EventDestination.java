...
public class EventDestination extends CustomResource {
     ...
     */
    public EventDestination(String name, EventDestinationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EventDestination(String name, Output<String> id, @Nullable EventDestinationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EventDestination get(String name, Output<String> id, @Nullable EventDestinationState state, @Nullable CustomResourceOptions options) {
