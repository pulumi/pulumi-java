...
public class StoredIscsiVolume extends CustomResource {
    /**
     ...
     */
    public StoredIscsiVolume(String name, StoredIscsiVolumeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StoredIscsiVolume(String name, Output<String> id, @Nullable StoredIscsiVolumeState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StoredIscsiVolume get(String name, Output<String> id, @Nullable StoredIscsiVolumeState state, @Nullable CustomResourceOptions options) {
