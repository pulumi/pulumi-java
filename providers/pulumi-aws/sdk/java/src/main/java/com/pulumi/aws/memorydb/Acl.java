...
public class Acl extends CustomResource {
     ...
     */
    public Acl(String name, @Nullable AclArgs args, @Nullable CustomResourceOptions options) {
        super("aws:memorydb/acl:Acl", name, args == null ? AclArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Acl(String name, Output<String> id, @Nullable AclState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Acl get(String name, Output<String> id, @Nullable AclState state, @Nullable CustomResourceOptions options) {
