...
public final class WebAclRuleStatementNotStatementStatementSizeConstraintStatementTextTransformationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WebAclRuleStatementNotStatementStatementSizeConstraintStatementTextTransformationArgs(WebAclRuleStatementNotStatementStatementSizeConstraintStatementTextTransformationArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementNotStatementStatementSizeConstraintStatementTextTransformationArgs();
        }

        public Builder(WebAclRuleStatementNotStatementStatementSizeConstraintStatementTextTransformationArgs defaults) {
            $ = new WebAclRuleStatementNotStatementStatementSizeConstraintStatementTextTransformationArgs(Objects.requireNonNull(defaults));
        }
