...
public class Target extends CustomResource {
    ...
    private Target(String name, Output<String> id, @Nullable TargetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Target get(String name, Output<String> id, @Nullable TargetState state, @Nullable CustomResourceOptions options) {
