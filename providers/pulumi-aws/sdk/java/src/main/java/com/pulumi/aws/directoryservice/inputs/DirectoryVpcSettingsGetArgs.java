...
public final class DirectoryVpcSettingsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DirectoryVpcSettingsGetArgs(DirectoryVpcSettingsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DirectoryVpcSettingsGetArgs();
        }

        public Builder(DirectoryVpcSettingsGetArgs defaults) {
            $ = new DirectoryVpcSettingsGetArgs(Objects.requireNonNull(defaults));
        }
