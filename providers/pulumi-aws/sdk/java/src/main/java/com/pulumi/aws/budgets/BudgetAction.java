...
public class BudgetAction extends CustomResource {
     ...
     */
    public BudgetAction(String name, BudgetActionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BudgetAction(String name, Output<String> id, @Nullable BudgetActionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BudgetAction get(String name, Output<String> id, @Nullable BudgetActionState state, @Nullable CustomResourceOptions options) {
