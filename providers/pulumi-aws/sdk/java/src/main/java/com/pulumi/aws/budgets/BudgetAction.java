 ...
 *             .budgetName(exampleBudget.getName())
 *             .actionType(&#34;APPLY_IAM_POLICY&#34;)
 *             .approvalModel(&#34;AUTOMATIC&#34;)
 *             .notificationType(&#34;ACTUAL&#34;)
 *             .executionRoleArn(exampleRole.getArn())
 *             .actionThreshold(BudgetActionActionThreshold.builder()
 *                 .actionThresholdType(&#34;ABSOLUTE_VALUE&#34;)
 *                 .actionThresholdValue(100)
 *                 .build())
 *             .definition(BudgetActionDefinition.builder()
 *                 .iamActionDefinition(BudgetActionDefinitionIamActionDefinition.builder()
 *                     .policyArn(examplePolicy.getArn())
 *                     .roles(exampleRole.getName())
 *                     .build())
 *                 .build())
 *             .subscribers(BudgetActionSubscriber.builder()
