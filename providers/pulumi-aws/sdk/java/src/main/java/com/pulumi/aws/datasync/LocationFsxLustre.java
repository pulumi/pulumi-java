...
public class LocationFsxLustre extends CustomResource {
    /**
     ...
     */
    public LocationFsxLustre(String name, LocationFsxLustreArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LocationFsxLustre(String name, Output<String> id, @Nullable LocationFsxLustreState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LocationFsxLustre get(String name, Output<String> id, @Nullable LocationFsxLustreState state, @Nullable CustomResourceOptions options) {
