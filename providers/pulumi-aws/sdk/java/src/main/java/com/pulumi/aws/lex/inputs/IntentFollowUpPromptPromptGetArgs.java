...
import com.pulumi.aws.lex.inputs.IntentFollowUpPromptPromptMessageGetArgs;
...
public final class IntentFollowUpPromptPromptGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<List<IntentFollowUpPromptPromptMessageGetArgs>> messages;

    public Output<List<IntentFollowUpPromptPromptMessageGetArgs>> messages() {
    ...
    private IntentFollowUpPromptPromptGetArgs(IntentFollowUpPromptPromptGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IntentFollowUpPromptPromptGetArgs();
        }

        public Builder(IntentFollowUpPromptPromptGetArgs defaults) {
            $ = new IntentFollowUpPromptPromptGetArgs(Objects.requireNonNull(defaults));
        }
