...
public final class InsightFiltersNetworkSourceMacGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final InsightFiltersNetworkSourceMacGetArgs Empty = new InsightFiltersNetworkSourceMacGetArgs();
    ...
    private InsightFiltersNetworkSourceMacGetArgs() {}

    private InsightFiltersNetworkSourceMacGetArgs(InsightFiltersNetworkSourceMacGetArgs $) {
    ...
    public static Builder builder(InsightFiltersNetworkSourceMacGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersNetworkSourceMacGetArgs();
        }

        public Builder(InsightFiltersNetworkSourceMacGetArgs defaults) {
            $ = new InsightFiltersNetworkSourceMacGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InsightFiltersNetworkSourceMacGetArgs build() {
