...
public class TrafficMirrorTarget extends CustomResource {
     ...
     */
    public TrafficMirrorTarget(String name, @Nullable TrafficMirrorTargetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TrafficMirrorTarget(String name, Output<String> id, @Nullable TrafficMirrorTargetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TrafficMirrorTarget get(String name, Output<String> id, @Nullable TrafficMirrorTargetState state, @Nullable CustomResourceOptions options) {
