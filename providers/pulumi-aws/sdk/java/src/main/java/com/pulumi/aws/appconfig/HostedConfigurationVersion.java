...
public class HostedConfigurationVersion extends CustomResource {
     ...
     */
    public HostedConfigurationVersion(String name, HostedConfigurationVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HostedConfigurationVersion(String name, Output<String> id, @Nullable HostedConfigurationVersionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HostedConfigurationVersion get(String name, Output<String> id, @Nullable HostedConfigurationVersionState state, @Nullable CustomResourceOptions options) {
