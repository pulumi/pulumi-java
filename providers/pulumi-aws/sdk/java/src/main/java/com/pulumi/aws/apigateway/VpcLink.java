...
public class VpcLink extends CustomResource {
     ...
     */
    public VpcLink(String name, VpcLinkArgs args, @Nullable CustomResourceOptions options) {
        super("aws:apigateway/vpcLink:VpcLink", name, args == null ? VpcLinkArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private VpcLink(String name, Output<String> id, @Nullable VpcLinkState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpcLink get(String name, Output<String> id, @Nullable VpcLinkState state, @Nullable CustomResourceOptions options) {
