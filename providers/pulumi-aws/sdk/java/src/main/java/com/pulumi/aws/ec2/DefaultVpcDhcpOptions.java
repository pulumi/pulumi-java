...
public class DefaultVpcDhcpOptions extends CustomResource {
    /**
     ...
     */
    public DefaultVpcDhcpOptions(String name, @Nullable DefaultVpcDhcpOptionsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DefaultVpcDhcpOptions(String name, Output<String> id, @Nullable DefaultVpcDhcpOptionsState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DefaultVpcDhcpOptions get(String name, Output<String> id, @Nullable DefaultVpcDhcpOptionsState state, @Nullable CustomResourceOptions options) {
