...
public class ClientCertificate extends CustomResource {
     ...
     */
    public ClientCertificate(String name, @Nullable ClientCertificateArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ClientCertificate(String name, Output<String> id, @Nullable ClientCertificateState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ClientCertificate get(String name, Output<String> id, @Nullable ClientCertificateState state, @Nullable CustomResourceOptions options) {
