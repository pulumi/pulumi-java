...
public class AmiCopy extends CustomResource {
     ...
     */
    public AmiCopy(String name, AmiCopyArgs args, @Nullable CustomResourceOptions options) {
        super("aws:ec2/amiCopy:AmiCopy", name, args == null ? AmiCopyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AmiCopy(String name, Output<String> id, @Nullable AmiCopyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AmiCopy get(String name, Output<String> id, @Nullable AmiCopyState state, @Nullable CustomResourceOptions options) {
