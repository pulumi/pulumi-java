...
public class VpcEndpointSubnetAssociation extends CustomResource {
     ...
     */
    public VpcEndpointSubnetAssociation(String name, VpcEndpointSubnetAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VpcEndpointSubnetAssociation(String name, Output<String> id, @Nullable VpcEndpointSubnetAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpcEndpointSubnetAssociation get(String name, Output<String> id, @Nullable VpcEndpointSubnetAssociationState state, @Nullable CustomResourceOptions options) {
