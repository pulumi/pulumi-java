...
public class Backup extends CustomResource {
     ...
     */
    public Backup(String name, @Nullable BackupArgs args, @Nullable CustomResourceOptions options) {
        super("aws:fsx/backup:Backup", name, args == null ? BackupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Backup(String name, Output<String> id, @Nullable BackupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Backup get(String name, Output<String> id, @Nullable BackupState state, @Nullable CustomResourceOptions options) {
