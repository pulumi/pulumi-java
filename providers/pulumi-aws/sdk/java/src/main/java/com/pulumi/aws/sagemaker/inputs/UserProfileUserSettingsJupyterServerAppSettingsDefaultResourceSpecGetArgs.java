...
public final class UserProfileUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private UserProfileUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs(UserProfileUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserProfileUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs();
        }

        public Builder(UserProfileUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs defaults) {
            $ = new UserProfileUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs(Objects.requireNonNull(defaults));
        }
