...
public class ObjectLambdaAccessPoint extends CustomResource {
     ...
     */
    public ObjectLambdaAccessPoint(String name, ObjectLambdaAccessPointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ObjectLambdaAccessPoint(String name, Output<String> id, @Nullable ObjectLambdaAccessPointState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ObjectLambdaAccessPoint get(String name, Output<String> id, @Nullable ObjectLambdaAccessPointState state, @Nullable CustomResourceOptions options) {
