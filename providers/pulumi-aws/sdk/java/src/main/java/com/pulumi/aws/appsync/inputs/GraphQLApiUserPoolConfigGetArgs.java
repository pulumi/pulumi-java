...
public final class GraphQLApiUserPoolConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GraphQLApiUserPoolConfigGetArgs(GraphQLApiUserPoolConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GraphQLApiUserPoolConfigGetArgs();
        }

        public Builder(GraphQLApiUserPoolConfigGetArgs defaults) {
            $ = new GraphQLApiUserPoolConfigGetArgs(Objects.requireNonNull(defaults));
        }
