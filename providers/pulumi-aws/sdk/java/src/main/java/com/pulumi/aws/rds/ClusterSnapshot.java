...
public class ClusterSnapshot extends CustomResource {
     ...
     */
    public ClusterSnapshot(String name, ClusterSnapshotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ClusterSnapshot(String name, Output<String> id, @Nullable ClusterSnapshotState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ClusterSnapshot get(String name, Output<String> id, @Nullable ClusterSnapshotState state, @Nullable CustomResourceOptions options) {
