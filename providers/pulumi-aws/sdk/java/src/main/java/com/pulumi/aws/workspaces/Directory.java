...
public class Directory extends CustomResource {
     ...
     */
    public Directory(String name, DirectoryArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Directory(String name, Output<String> id, @Nullable DirectoryState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Directory get(String name, Output<String> id, @Nullable DirectoryState state, @Nullable CustomResourceOptions options) {
