...
public class LambdaFunctionAssociation extends CustomResource {
    /**
     ...
     */
    public LambdaFunctionAssociation(String name, LambdaFunctionAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LambdaFunctionAssociation(String name, Output<String> id, @Nullable LambdaFunctionAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LambdaFunctionAssociation get(String name, Output<String> id, @Nullable LambdaFunctionAssociationState state, @Nullable CustomResourceOptions options) {
