...
public final class WebAclRuleVisibilityConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WebAclRuleVisibilityConfigGetArgs(WebAclRuleVisibilityConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleVisibilityConfigGetArgs();
        }

        public Builder(WebAclRuleVisibilityConfigGetArgs defaults) {
            $ = new WebAclRuleVisibilityConfigGetArgs(Objects.requireNonNull(defaults));
        }
