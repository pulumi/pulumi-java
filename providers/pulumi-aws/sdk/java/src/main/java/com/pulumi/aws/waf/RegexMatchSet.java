...
public class RegexMatchSet extends CustomResource {
    /**
     ...
     */
    public RegexMatchSet(String name, @Nullable RegexMatchSetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegexMatchSet(String name, Output<String> id, @Nullable RegexMatchSetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegexMatchSet get(String name, Output<String> id, @Nullable RegexMatchSetState state, @Nullable CustomResourceOptions options) {
