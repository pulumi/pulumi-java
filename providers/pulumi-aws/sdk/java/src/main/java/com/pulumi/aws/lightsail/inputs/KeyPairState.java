...
public final class KeyPairState extends ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param encryptedFingerprint The MD5 public key fingerprint for the encrypted
         * private key
         * 
         * @return builder
         * 
        ...
        /**
         * @param encryptedPrivateKey the private key material, base 64 encoded and
         * encrypted with the given `pgp_key`. This is only populated when creating a new
         * key and `pgp_key` is supplied
         * 
         * @return builder
        ...
        /**
         * @param privateKey the private key, base64 encoded. This is only populated
         * when creating a new key, and when no `pgp_key` is provided
         * 
         * @return builder
         * 
