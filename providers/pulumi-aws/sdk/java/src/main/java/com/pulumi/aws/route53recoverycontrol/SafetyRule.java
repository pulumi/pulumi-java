...
public class SafetyRule extends CustomResource {
    /**
     ...
     */
    public SafetyRule(String name, SafetyRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SafetyRule(String name, Output<String> id, @Nullable SafetyRuleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SafetyRule get(String name, Output<String> id, @Nullable SafetyRuleState state, @Nullable CustomResourceOptions options) {
