...
public final class SigningJobRevocationRecordGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SigningJobRevocationRecordGetArgs(SigningJobRevocationRecordGetArgs $) {
        this.reason = $.reason;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SigningJobRevocationRecordGetArgs();
        }

        public Builder(SigningJobRevocationRecordGetArgs defaults) {
            $ = new SigningJobRevocationRecordGetArgs(Objects.requireNonNull(defaults));
        }
