...
public class Vpc extends CustomResource {
    ...
    private Vpc(String name, Output<String> id, @Nullable VpcState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Vpc get(String name, Output<String> id, @Nullable VpcState state, @Nullable CustomResourceOptions options) {
