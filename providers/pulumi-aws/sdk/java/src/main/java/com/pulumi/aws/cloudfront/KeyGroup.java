...
public class KeyGroup extends CustomResource {
    ...
    private KeyGroup(String name, Output<String> id, @Nullable KeyGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static KeyGroup get(String name, Output<String> id, @Nullable KeyGroupState state, @Nullable CustomResourceOptions options) {
