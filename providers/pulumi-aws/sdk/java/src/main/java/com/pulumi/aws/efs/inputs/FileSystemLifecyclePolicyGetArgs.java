...
public final class FileSystemLifecyclePolicyGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FileSystemLifecyclePolicyGetArgs(FileSystemLifecyclePolicyGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FileSystemLifecyclePolicyGetArgs();
        }

        public Builder(FileSystemLifecyclePolicyGetArgs defaults) {
            $ = new FileSystemLifecyclePolicyGetArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param transitionToIa Indicates how long it takes to transition files to the IA storage class. Valid values: `AFTER_7_DAYS`, `AFTER_14_DAYS`, `AFTER_30_DAYS`, `AFTER_60_DAYS`, or `AFTER_90_DAYS`.
         * 
         * @return builder
         * 
         */
