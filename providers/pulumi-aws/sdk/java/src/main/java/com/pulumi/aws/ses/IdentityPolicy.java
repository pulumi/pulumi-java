...
public class IdentityPolicy extends CustomResource {
    /**
     ...
     */
    public IdentityPolicy(String name, IdentityPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IdentityPolicy(String name, Output<String> id, @Nullable IdentityPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IdentityPolicy get(String name, Output<String> id, @Nullable IdentityPolicyState state, @Nullable CustomResourceOptions options) {
