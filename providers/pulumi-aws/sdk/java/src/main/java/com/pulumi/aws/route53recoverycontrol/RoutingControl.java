...
public class RoutingControl extends CustomResource {
     ...
     */
    public RoutingControl(String name, RoutingControlArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RoutingControl(String name, Output<String> id, @Nullable RoutingControlState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RoutingControl get(String name, Output<String> id, @Nullable RoutingControlState state, @Nullable CustomResourceOptions options) {
