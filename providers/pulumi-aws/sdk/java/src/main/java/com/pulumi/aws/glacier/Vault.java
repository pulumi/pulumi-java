...
public class Vault extends CustomResource {
     ...
     */
    public Vault(String name, @Nullable VaultArgs args, @Nullable CustomResourceOptions options) {
        super("aws:glacier/vault:Vault", name, args == null ? VaultArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Vault(String name, Output<String> id, @Nullable VaultState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Vault get(String name, Output<String> id, @Nullable VaultState state, @Nullable CustomResourceOptions options) {
