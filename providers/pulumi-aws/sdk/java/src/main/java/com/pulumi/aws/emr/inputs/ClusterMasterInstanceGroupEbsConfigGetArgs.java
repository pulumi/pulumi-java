...
public final class ClusterMasterInstanceGroupEbsConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterMasterInstanceGroupEbsConfigGetArgs(ClusterMasterInstanceGroupEbsConfigGetArgs $) {
        this.iops = $.iops;
        this.size = $.size;
        this.type = $.type;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterMasterInstanceGroupEbsConfigGetArgs();
        }

        public Builder(ClusterMasterInstanceGroupEbsConfigGetArgs defaults) {
            $ = new ClusterMasterInstanceGroupEbsConfigGetArgs(Objects.requireNonNull(defaults));
        }
