...
public final class InsightFiltersConfidenceGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final InsightFiltersConfidenceGetArgs Empty = new InsightFiltersConfidenceGetArgs();
    ...
    private InsightFiltersConfidenceGetArgs() {}

    private InsightFiltersConfidenceGetArgs(InsightFiltersConfidenceGetArgs $) {
        this.eq = $.eq;
        this.gte = $.gte;
        this.lte = $.lte;
    }
    ...
    public static Builder builder(InsightFiltersConfidenceGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersConfidenceGetArgs();
        }

        public Builder(InsightFiltersConfidenceGetArgs defaults) {
            $ = new InsightFiltersConfidenceGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InsightFiltersConfidenceGetArgs build() {
            return $;
        }
    }
