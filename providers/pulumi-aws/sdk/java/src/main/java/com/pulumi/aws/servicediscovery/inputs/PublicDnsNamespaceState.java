...
public final class PublicDnsNamespaceState extends com.pulumi.resources.ResourceArgs {
    ...
    private PublicDnsNamespaceState(PublicDnsNamespaceState $) {
        this.arn = $.arn;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PublicDnsNamespaceState();
        }

        public Builder(PublicDnsNamespaceState defaults) {
            $ = new PublicDnsNamespaceState(Objects.requireNonNull(defaults));
        }
