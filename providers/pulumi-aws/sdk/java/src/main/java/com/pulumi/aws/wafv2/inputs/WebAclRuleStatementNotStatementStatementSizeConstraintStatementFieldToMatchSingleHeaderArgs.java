...
public final class WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchSingleHeaderArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchSingleHeaderArgs(Output<String> name) {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            ...
            return new WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchSingleHeaderArgs(name);
        }
    }
}
