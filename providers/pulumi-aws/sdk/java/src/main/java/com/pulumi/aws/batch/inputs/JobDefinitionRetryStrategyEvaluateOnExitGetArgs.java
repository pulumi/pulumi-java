...
public final class JobDefinitionRetryStrategyEvaluateOnExitGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private JobDefinitionRetryStrategyEvaluateOnExitGetArgs(JobDefinitionRetryStrategyEvaluateOnExitGetArgs $) {
        this.action = $.action;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobDefinitionRetryStrategyEvaluateOnExitGetArgs();
        }

        public Builder(JobDefinitionRetryStrategyEvaluateOnExitGetArgs defaults) {
            $ = new JobDefinitionRetryStrategyEvaluateOnExitGetArgs(Objects.requireNonNull(defaults));
        }
