...
public final class AssociationOutputLocationGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AssociationOutputLocationGetArgs(AssociationOutputLocationGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AssociationOutputLocationGetArgs();
        }

        public Builder(AssociationOutputLocationGetArgs defaults) {
            $ = new AssociationOutputLocationGetArgs(Objects.requireNonNull(defaults));
        }
