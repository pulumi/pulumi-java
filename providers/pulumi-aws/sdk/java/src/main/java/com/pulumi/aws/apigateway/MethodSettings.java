...
public class MethodSettings extends CustomResource {
     ...
     */
    public MethodSettings(String name, MethodSettingsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MethodSettings(String name, Output<String> id, @Nullable MethodSettingsState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MethodSettings get(String name, Output<String> id, @Nullable MethodSettingsState state, @Nullable CustomResourceOptions options) {
