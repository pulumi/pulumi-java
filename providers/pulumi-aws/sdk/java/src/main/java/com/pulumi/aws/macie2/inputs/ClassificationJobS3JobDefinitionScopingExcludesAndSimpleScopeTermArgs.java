...
public final class ClassificationJobS3JobDefinitionScopingExcludesAndSimpleScopeTermArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClassificationJobS3JobDefinitionScopingExcludesAndSimpleScopeTermArgs(ClassificationJobS3JobDefinitionScopingExcludesAndSimpleScopeTermArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClassificationJobS3JobDefinitionScopingExcludesAndSimpleScopeTermArgs();
        }
