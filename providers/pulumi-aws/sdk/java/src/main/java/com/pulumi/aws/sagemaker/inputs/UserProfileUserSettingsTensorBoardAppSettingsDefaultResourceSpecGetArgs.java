...
public final class UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpecGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpecGetArgs(UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpecGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpecGetArgs();
        }

        public Builder(UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpecGetArgs defaults) {
            $ = new UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpecGetArgs(Objects.requireNonNull(defaults));
        }
