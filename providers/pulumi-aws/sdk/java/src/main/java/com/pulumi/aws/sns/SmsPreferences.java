...
public class SmsPreferences extends CustomResource {
     ...
     */
    public SmsPreferences(String name, @Nullable SmsPreferencesArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SmsPreferences(String name, Output<String> id, @Nullable SmsPreferencesState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SmsPreferences get(String name, Output<String> id, @Nullable SmsPreferencesState state, @Nullable CustomResourceOptions options) {
