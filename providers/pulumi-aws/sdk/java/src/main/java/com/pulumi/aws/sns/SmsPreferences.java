...
public class SmsPreferences extends com.pulumi.resources.CustomResource {
     ...
     */
    public static SmsPreferences get(String name, Output<String> id, @Nullable SmsPreferencesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
