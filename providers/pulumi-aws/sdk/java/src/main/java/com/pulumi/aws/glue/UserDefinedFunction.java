...
public class UserDefinedFunction extends CustomResource {
     ...
     */
    public UserDefinedFunction(String name, UserDefinedFunctionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private UserDefinedFunction(String name, Output<String> id, @Nullable UserDefinedFunctionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UserDefinedFunction get(String name, Output<String> id, @Nullable UserDefinedFunctionState state, @Nullable CustomResourceOptions options) {
