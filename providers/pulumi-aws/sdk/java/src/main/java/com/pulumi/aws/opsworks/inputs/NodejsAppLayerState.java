...
public final class NodejsAppLayerState extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="cloudwatchConfiguration")
      private final @Nullable Output<NodejsAppLayerCloudwatchConfigurationGetArgs> cloudwatchConfiguration;

    public Output<NodejsAppLayerCloudwatchConfigurationGetArgs> getCloudwatchConfiguration() {
    ...
    @Import(name="ebsVolumes")
      private final @Nullable Output<List<NodejsAppLayerEbsVolumeGetArgs>> ebsVolumes;

    public Output<List<NodejsAppLayerEbsVolumeGetArgs>> getEbsVolumes() {
    ...
    public NodejsAppLayerState(
        ...
        @Nullable Output<NodejsAppLayerCloudwatchConfigurationGetArgs> cloudwatchConfiguration,
        ...
        @Nullable Output<List<NodejsAppLayerEbsVolumeGetArgs>> ebsVolumes,
    ...
    public static Builder builder(NodejsAppLayerState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(NodejsAppLayerState defaults) {
        ...
        public Builder cloudwatchConfiguration(@Nullable NodejsAppLayerCloudwatchConfigurationGetArgs cloudwatchConfiguration) {
        ...
        public Builder ebsVolumes(@Nullable List<NodejsAppLayerEbsVolumeGetArgs> ebsVolumes) {
