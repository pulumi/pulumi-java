...
public final class NodejsAppLayerState extends ResourceArgs {
    ...
    private NodejsAppLayerState(NodejsAppLayerState $) {
        this.arn = $.arn;
    ...
    public static final class Builder {
        ...
        public Builder(NodejsAppLayerState defaults) {
            $ = new NodejsAppLayerState(Objects.requireNonNull(defaults));
        }
