...
public class RouteResponse extends CustomResource {
     ...
     */
    public RouteResponse(String name, RouteResponseArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RouteResponse(String name, Output<String> id, @Nullable RouteResponseState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RouteResponse get(String name, Output<String> id, @Nullable RouteResponseState state, @Nullable CustomResourceOptions options) {
