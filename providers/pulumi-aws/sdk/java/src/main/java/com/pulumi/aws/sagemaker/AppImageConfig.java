...
public class AppImageConfig extends CustomResource {
     ...
     */
    public AppImageConfig(String name, AppImageConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AppImageConfig(String name, Output<String> id, @Nullable AppImageConfigState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AppImageConfig get(String name, Output<String> id, @Nullable AppImageConfigState state, @Nullable CustomResourceOptions options) {
