...
public class ClusterEndpoint extends CustomResource {
    /**
     ...
     */
    public ClusterEndpoint(String name, ClusterEndpointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ClusterEndpoint(String name, Output<String> id, @Nullable ClusterEndpointState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ClusterEndpoint get(String name, Output<String> id, @Nullable ClusterEndpointState state, @Nullable CustomResourceOptions options) {
