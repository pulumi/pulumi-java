...
public final class WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs Empty = new WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs();
    ...
    private WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs() {}

    private WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs(WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs();
        }

        public Builder(WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs defaults) {
            $ = new WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs build() {
