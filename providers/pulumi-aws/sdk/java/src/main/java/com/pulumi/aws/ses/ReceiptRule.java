...
public class ReceiptRule extends CustomResource {
     ...
     */
    public ReceiptRule(String name, ReceiptRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReceiptRule(String name, Output<String> id, @Nullable ReceiptRuleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReceiptRule get(String name, Output<String> id, @Nullable ReceiptRuleState state, @Nullable CustomResourceOptions options) {
