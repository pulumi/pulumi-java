...
public final class GraphQLApiLambdaAuthorizerConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GraphQLApiLambdaAuthorizerConfigGetArgs(GraphQLApiLambdaAuthorizerConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GraphQLApiLambdaAuthorizerConfigGetArgs();
        }

        public Builder(GraphQLApiLambdaAuthorizerConfigGetArgs defaults) {
            $ = new GraphQLApiLambdaAuthorizerConfigGetArgs(Objects.requireNonNull(defaults));
        }
