...
public class SecretPolicy extends CustomResource {
    /**
     ...
     */
    public SecretPolicy(String name, SecretPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SecretPolicy(String name, Output<String> id, @Nullable SecretPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SecretPolicy get(String name, Output<String> id, @Nullable SecretPolicyState state, @Nullable CustomResourceOptions options) {
