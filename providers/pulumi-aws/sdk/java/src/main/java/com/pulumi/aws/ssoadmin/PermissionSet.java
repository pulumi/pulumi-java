...
public class PermissionSet extends CustomResource {
    ...
    private PermissionSet(String name, Output<String> id, @Nullable PermissionSetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PermissionSet get(String name, Output<String> id, @Nullable PermissionSetState state, @Nullable CustomResourceOptions options) {
