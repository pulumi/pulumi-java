...
public class ConfigurationProfile extends CustomResource {
     ...
     */
    public ConfigurationProfile(String name, ConfigurationProfileArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConfigurationProfile(String name, Output<String> id, @Nullable ConfigurationProfileState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConfigurationProfile get(String name, Output<String> id, @Nullable ConfigurationProfileState state, @Nullable CustomResourceOptions options) {
