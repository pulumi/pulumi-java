...
public class AssessmentTarget extends CustomResource {
     ...
     */
    public AssessmentTarget(String name, @Nullable AssessmentTargetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AssessmentTarget(String name, Output<String> id, @Nullable AssessmentTargetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AssessmentTarget get(String name, Output<String> id, @Nullable AssessmentTargetState state, @Nullable CustomResourceOptions options) {
