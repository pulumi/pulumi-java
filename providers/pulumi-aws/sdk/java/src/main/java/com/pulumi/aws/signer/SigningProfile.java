...
public class SigningProfile extends CustomResource {
    ...
    private SigningProfile(String name, Output<String> id, @Nullable SigningProfileState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SigningProfile get(String name, Output<String> id, @Nullable SigningProfileState state, @Nullable CustomResourceOptions options) {
