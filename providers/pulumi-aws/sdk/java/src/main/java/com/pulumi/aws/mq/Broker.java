...
public class Broker extends CustomResource {
     ...
     */
    public Broker(String name, BrokerArgs args, @Nullable CustomResourceOptions options) {
        super("aws:mq/broker:Broker", name, args == null ? BrokerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Broker(String name, Output<String> id, @Nullable BrokerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Broker get(String name, Output<String> id, @Nullable BrokerState state, @Nullable CustomResourceOptions options) {
