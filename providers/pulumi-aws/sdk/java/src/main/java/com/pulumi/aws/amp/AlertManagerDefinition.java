...
public class AlertManagerDefinition extends CustomResource {
     ...
     */
    public AlertManagerDefinition(String name, AlertManagerDefinitionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AlertManagerDefinition(String name, Output<String> id, @Nullable AlertManagerDefinitionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AlertManagerDefinition get(String name, Output<String> id, @Nullable AlertManagerDefinitionState state, @Nullable CustomResourceOptions options) {
