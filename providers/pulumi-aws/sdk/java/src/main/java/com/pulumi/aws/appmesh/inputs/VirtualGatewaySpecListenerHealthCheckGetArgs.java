...
public final class VirtualGatewaySpecListenerHealthCheckGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private VirtualGatewaySpecListenerHealthCheckGetArgs(VirtualGatewaySpecListenerHealthCheckGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualGatewaySpecListenerHealthCheckGetArgs();
        }

        public Builder(VirtualGatewaySpecListenerHealthCheckGetArgs defaults) {
            $ = new VirtualGatewaySpecListenerHealthCheckGetArgs(Objects.requireNonNull(defaults));
        }
