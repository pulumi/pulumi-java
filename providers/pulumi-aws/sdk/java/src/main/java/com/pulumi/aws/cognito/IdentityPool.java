...
public class IdentityPool extends CustomResource {
    /**
    ...
    private IdentityPool(String name, Output<String> id, @Nullable IdentityPoolState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IdentityPool get(String name, Output<String> id, @Nullable IdentityPoolState state, @Nullable CustomResourceOptions options) {
