...
public class MountTarget extends CustomResource {
    ...
    private MountTarget(String name, Output<String> id, @Nullable MountTargetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MountTarget get(String name, Output<String> id, @Nullable MountTargetState state, @Nullable CustomResourceOptions options) {
