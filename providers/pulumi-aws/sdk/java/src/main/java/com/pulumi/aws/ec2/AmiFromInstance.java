...
public class AmiFromInstance extends CustomResource {
    /**
     ...
     */
    public AmiFromInstance(String name, AmiFromInstanceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AmiFromInstance(String name, Output<String> id, @Nullable AmiFromInstanceState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AmiFromInstance get(String name, Output<String> id, @Nullable AmiFromInstanceState state, @Nullable CustomResourceOptions options) {
