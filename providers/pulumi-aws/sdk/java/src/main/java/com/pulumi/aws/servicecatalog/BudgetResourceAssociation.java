...
public class BudgetResourceAssociation extends CustomResource {
     ...
     */
    public BudgetResourceAssociation(String name, BudgetResourceAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BudgetResourceAssociation(String name, Output<String> id, @Nullable BudgetResourceAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BudgetResourceAssociation get(String name, Output<String> id, @Nullable BudgetResourceAssociationState state, @Nullable CustomResourceOptions options) {
