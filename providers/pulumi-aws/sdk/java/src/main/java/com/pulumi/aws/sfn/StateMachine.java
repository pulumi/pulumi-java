...
public class StateMachine extends CustomResource {
     ...
     */
    public StateMachine(String name, StateMachineArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StateMachine(String name, Output<String> id, @Nullable StateMachineState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StateMachine get(String name, Output<String> id, @Nullable StateMachineState state, @Nullable CustomResourceOptions options) {
