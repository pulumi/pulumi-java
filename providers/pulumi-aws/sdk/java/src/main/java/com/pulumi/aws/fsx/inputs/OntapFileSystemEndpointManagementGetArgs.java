...
public final class OntapFileSystemEndpointManagementGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OntapFileSystemEndpointManagementGetArgs(OntapFileSystemEndpointManagementGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OntapFileSystemEndpointManagementGetArgs();
        }

        public Builder(OntapFileSystemEndpointManagementGetArgs defaults) {
            $ = new OntapFileSystemEndpointManagementGetArgs(Objects.requireNonNull(defaults));
        }
