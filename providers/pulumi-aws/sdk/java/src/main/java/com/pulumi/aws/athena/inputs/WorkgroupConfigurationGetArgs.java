...
import com.pulumi.aws.athena.inputs.WorkgroupConfigurationEngineVersionGetArgs;
import com.pulumi.aws.athena.inputs.WorkgroupConfigurationResultConfigurationGetArgs;
...
public final class WorkgroupConfigurationGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkgroupConfigurationGetArgs Empty = new WorkgroupConfigurationGetArgs();
    ...
    private @Nullable Output<WorkgroupConfigurationEngineVersionGetArgs> engineVersion;
     ...
     * 
     */
    public Optional<Output<WorkgroupConfigurationEngineVersionGetArgs>> engineVersion() {
    ...
    private @Nullable Output<WorkgroupConfigurationResultConfigurationGetArgs> resultConfiguration;

    /**
     * @return Configuration block with result settings. Documented below.
     * 
     */
    public Optional<Output<WorkgroupConfigurationResultConfigurationGetArgs>> resultConfiguration() {
        return Optional.ofNullable(this.resultConfiguration);
    }

    private WorkgroupConfigurationGetArgs() {}

    private WorkgroupConfigurationGetArgs(WorkgroupConfigurationGetArgs $) {
    ...
    public static Builder builder(WorkgroupConfigurationGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkgroupConfigurationGetArgs();
        }

        public Builder(WorkgroupConfigurationGetArgs defaults) {
            $ = new WorkgroupConfigurationGetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder engineVersion(@Nullable Output<WorkgroupConfigurationEngineVersionGetArgs> engineVersion) {
         ...
         * 
         */
        public Builder engineVersion(WorkgroupConfigurationEngineVersionGetArgs engineVersion) {
         ...
         * 
         */
        public Builder resultConfiguration(@Nullable Output<WorkgroupConfigurationResultConfigurationGetArgs> resultConfiguration) {
         ...
         * 
         */
        public Builder resultConfiguration(WorkgroupConfigurationResultConfigurationGetArgs resultConfiguration) {
            return resultConfiguration(Output.of(resultConfiguration));
        }

        public WorkgroupConfigurationGetArgs build() {
            return $;
        }
    }
