...
public class PrivateDnsNamespace extends CustomResource {
    /**
     ...
     */
    public PrivateDnsNamespace(String name, PrivateDnsNamespaceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateDnsNamespace(String name, Output<String> id, @Nullable PrivateDnsNamespaceState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateDnsNamespace get(String name, Output<String> id, @Nullable PrivateDnsNamespaceState state, @Nullable CustomResourceOptions options) {
