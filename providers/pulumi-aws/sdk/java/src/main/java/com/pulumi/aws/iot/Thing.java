...
public class Thing extends CustomResource {
     ...
     */
    public Thing(String name, @Nullable ThingArgs args, @Nullable CustomResourceOptions options) {
        super("aws:iot/thing:Thing", name, args == null ? ThingArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Thing(String name, Output<String> id, @Nullable ThingState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Thing get(String name, Output<String> id, @Nullable ThingState state, @Nullable CustomResourceOptions options) {
