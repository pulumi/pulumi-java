...
public class Pipeline extends CustomResource {
    ...
    private Pipeline(String name, Output<String> id, @Nullable PipelineState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Pipeline get(String name, Output<String> id, @Nullable PipelineState state, @Nullable CustomResourceOptions options) {
