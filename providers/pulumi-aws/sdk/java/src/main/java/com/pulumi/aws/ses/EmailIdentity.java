...
public class EmailIdentity extends CustomResource {
    /**
     ...
     */
    public EmailIdentity(String name, EmailIdentityArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EmailIdentity(String name, Output<String> id, @Nullable EmailIdentityState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EmailIdentity get(String name, Output<String> id, @Nullable EmailIdentityState state, @Nullable CustomResourceOptions options) {
