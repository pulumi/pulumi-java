...
public class Invocation extends CustomResource {
    /**
     ...
     */
    public Invocation(String name, InvocationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Invocation(String name, Output<String> id, @Nullable InvocationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Invocation get(String name, Output<String> id, @Nullable InvocationState state, @Nullable CustomResourceOptions options) {
