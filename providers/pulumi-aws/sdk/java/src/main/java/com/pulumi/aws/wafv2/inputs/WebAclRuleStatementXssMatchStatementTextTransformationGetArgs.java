...
public final class WebAclRuleStatementXssMatchStatementTextTransformationGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementXssMatchStatementTextTransformationGetArgs Empty = new WebAclRuleStatementXssMatchStatementTextTransformationGetArgs();
    ...
    private WebAclRuleStatementXssMatchStatementTextTransformationGetArgs() {}

    private WebAclRuleStatementXssMatchStatementTextTransformationGetArgs(WebAclRuleStatementXssMatchStatementTextTransformationGetArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementXssMatchStatementTextTransformationGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementXssMatchStatementTextTransformationGetArgs();
        }

        public Builder(WebAclRuleStatementXssMatchStatementTextTransformationGetArgs defaults) {
            $ = new WebAclRuleStatementXssMatchStatementTextTransformationGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WebAclRuleStatementXssMatchStatementTextTransformationGetArgs build() {
