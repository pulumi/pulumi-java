...
public class SnapshotImport extends CustomResource {
    /**
     ...
     */
    public SnapshotImport(String name, SnapshotImportArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SnapshotImport(String name, Output<String> id, @Nullable SnapshotImportState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SnapshotImport get(String name, Output<String> id, @Nullable SnapshotImportState state, @Nullable CustomResourceOptions options) {
