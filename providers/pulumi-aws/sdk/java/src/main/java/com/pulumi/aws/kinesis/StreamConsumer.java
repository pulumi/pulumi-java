...
public class StreamConsumer extends CustomResource {
    /**
     ...
     */
    public StreamConsumer(String name, StreamConsumerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StreamConsumer(String name, Output<String> id, @Nullable StreamConsumerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StreamConsumer get(String name, Output<String> id, @Nullable StreamConsumerState state, @Nullable CustomResourceOptions options) {
