...
public class DefaultSubnet extends CustomResource {
    /**
     * ARN for the subnet.
     * 
     */
     ...
     */
    public DefaultSubnet(String name, DefaultSubnetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DefaultSubnet(String name, Output<String> id, @Nullable DefaultSubnetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DefaultSubnet get(String name, Output<String> id, @Nullable DefaultSubnetState state, @Nullable CustomResourceOptions options) {
