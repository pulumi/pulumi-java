...
public class Protection extends CustomResource {
    /**
     ...
     */
    public Protection(String name, ProtectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Protection(String name, Output<String> id, @Nullable ProtectionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Protection get(String name, Output<String> id, @Nullable ProtectionState state, @Nullable CustomResourceOptions options) {
