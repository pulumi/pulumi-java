...
public final class VirtualGatewaySpecBackendDefaultsClientPolicyTlsCertificateFileGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final VirtualGatewaySpecBackendDefaultsClientPolicyTlsCertificateFileGetArgs Empty = new VirtualGatewaySpecBackendDefaultsClientPolicyTlsCertificateFileGetArgs();
    ...
    private VirtualGatewaySpecBackendDefaultsClientPolicyTlsCertificateFileGetArgs(VirtualGatewaySpecBackendDefaultsClientPolicyTlsCertificateFileGetArgs $) {
    ...
    public static Builder builder(VirtualGatewaySpecBackendDefaultsClientPolicyTlsCertificateFileGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualGatewaySpecBackendDefaultsClientPolicyTlsCertificateFileGetArgs();
        }

        public Builder(VirtualGatewaySpecBackendDefaultsClientPolicyTlsCertificateFileGetArgs defaults) {
            $ = new VirtualGatewaySpecBackendDefaultsClientPolicyTlsCertificateFileGetArgs(Objects.requireNonNull(defaults));
        }
