...
public class EndpointGroup extends CustomResource {
    ...
    private EndpointGroup(String name, Output<String> id, @Nullable EndpointGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EndpointGroup get(String name, Output<String> id, @Nullable EndpointGroupState state, @Nullable CustomResourceOptions options) {
