...
public final class InsightFiltersResourceTypeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersResourceTypeGetArgs(InsightFiltersResourceTypeGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersResourceTypeGetArgs();
        }

        public Builder(InsightFiltersResourceTypeGetArgs defaults) {
            $ = new InsightFiltersResourceTypeGetArgs(Objects.requireNonNull(defaults));
        }
