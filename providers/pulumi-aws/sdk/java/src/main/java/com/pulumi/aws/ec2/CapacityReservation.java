...
public class CapacityReservation extends CustomResource {
     ...
     */
    public CapacityReservation(String name, CapacityReservationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CapacityReservation(String name, Output<String> id, @Nullable CapacityReservationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CapacityReservation get(String name, Output<String> id, @Nullable CapacityReservationState state, @Nullable CustomResourceOptions options) {
