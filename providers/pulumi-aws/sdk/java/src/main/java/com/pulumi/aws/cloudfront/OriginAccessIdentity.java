...
public class OriginAccessIdentity extends CustomResource {
     ...
     */
    public OriginAccessIdentity(String name, @Nullable OriginAccessIdentityArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OriginAccessIdentity(String name, Output<String> id, @Nullable OriginAccessIdentityState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OriginAccessIdentity get(String name, Output<String> id, @Nullable OriginAccessIdentityState state, @Nullable CustomResourceOptions options) {
