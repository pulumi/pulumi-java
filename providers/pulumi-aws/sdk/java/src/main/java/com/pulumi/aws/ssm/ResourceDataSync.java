...
public class ResourceDataSync extends CustomResource {
     ...
     */
    public ResourceDataSync(String name, ResourceDataSyncArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResourceDataSync(String name, Output<String> id, @Nullable ResourceDataSyncState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResourceDataSync get(String name, Output<String> id, @Nullable ResourceDataSyncState state, @Nullable CustomResourceOptions options) {
