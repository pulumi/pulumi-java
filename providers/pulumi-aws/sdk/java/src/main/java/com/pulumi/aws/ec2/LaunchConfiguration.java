...
public class LaunchConfiguration extends CustomResource {
     ...
     */
    public LaunchConfiguration(String name, LaunchConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LaunchConfiguration(String name, Output<String> id, @Nullable LaunchConfigurationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LaunchConfiguration get(String name, Output<String> id, @Nullable LaunchConfigurationState state, @Nullable CustomResourceOptions options) {
