...
public class TransitVirtualInterface extends CustomResource {
    /**
     ...
     */
    public TransitVirtualInterface(String name, TransitVirtualInterfaceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TransitVirtualInterface(String name, Output<String> id, @Nullable TransitVirtualInterfaceState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TransitVirtualInterface get(String name, Output<String> id, @Nullable TransitVirtualInterfaceState state, @Nullable CustomResourceOptions options) {
