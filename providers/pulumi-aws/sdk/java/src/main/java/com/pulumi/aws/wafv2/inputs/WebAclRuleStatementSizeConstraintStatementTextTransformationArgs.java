...
public final class WebAclRuleStatementSizeConstraintStatementTextTransformationArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementSizeConstraintStatementTextTransformationArgs Empty = new WebAclRuleStatementSizeConstraintStatementTextTransformationArgs();
    ...
    private WebAclRuleStatementSizeConstraintStatementTextTransformationArgs() {}

    private WebAclRuleStatementSizeConstraintStatementTextTransformationArgs(WebAclRuleStatementSizeConstraintStatementTextTransformationArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementSizeConstraintStatementTextTransformationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementSizeConstraintStatementTextTransformationArgs();
        }

        public Builder(WebAclRuleStatementSizeConstraintStatementTextTransformationArgs defaults) {
            $ = new WebAclRuleStatementSizeConstraintStatementTextTransformationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WebAclRuleStatementSizeConstraintStatementTextTransformationArgs build() {
