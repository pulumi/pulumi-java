...
public final class InsightFiltersThreatIntelIndicatorValueGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersThreatIntelIndicatorValueGetArgs(InsightFiltersThreatIntelIndicatorValueGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersThreatIntelIndicatorValueGetArgs();
        }

        public Builder(InsightFiltersThreatIntelIndicatorValueGetArgs defaults) {
            $ = new InsightFiltersThreatIntelIndicatorValueGetArgs(Objects.requireNonNull(defaults));
        }
