...
public class TaskSet extends CustomResource {
     ...
     */
    public TaskSet(String name, TaskSetArgs args, @Nullable CustomResourceOptions options) {
        super("aws:ecs/taskSet:TaskSet", name, args == null ? TaskSetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TaskSet(String name, Output<String> id, @Nullable TaskSetState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TaskSet get(String name, Output<String> id, @Nullable TaskSetState state, @Nullable CustomResourceOptions options) {
