...
public class LicenseConfiguration extends CustomResource {
     ...
     */
    public LicenseConfiguration(String name, LicenseConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LicenseConfiguration(String name, Output<String> id, @Nullable LicenseConfigurationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LicenseConfiguration get(String name, Output<String> id, @Nullable LicenseConfigurationState state, @Nullable CustomResourceOptions options) {
