...
public final class SecretRotationRulesGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SecretRotationRulesGetArgs(SecretRotationRulesGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecretRotationRulesGetArgs();
        }

        public Builder(SecretRotationRulesGetArgs defaults) {
            $ = new SecretRotationRulesGetArgs(Objects.requireNonNull(defaults));
        }
