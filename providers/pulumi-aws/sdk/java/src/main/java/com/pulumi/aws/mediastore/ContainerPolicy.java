...
public class ContainerPolicy extends CustomResource {
    /**
     ...
     */
    public ContainerPolicy(String name, ContainerPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ContainerPolicy(String name, Output<String> id, @Nullable ContainerPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ContainerPolicy get(String name, Output<String> id, @Nullable ContainerPolicyState state, @Nullable CustomResourceOptions options) {
