...
public class MysqlLayer extends CustomResource {
    /**
     ...
     */
    public MysqlLayer(String name, MysqlLayerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MysqlLayer(String name, Output<String> id, @Nullable MysqlLayerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MysqlLayer get(String name, Output<String> id, @Nullable MysqlLayerState state, @Nullable CustomResourceOptions options) {
