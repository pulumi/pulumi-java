...
public class OrganizationAdminAccount extends CustomResource {
     ...
     */
    public OrganizationAdminAccount(String name, OrganizationAdminAccountArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OrganizationAdminAccount(String name, Output<String> id, @Nullable OrganizationAdminAccountState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OrganizationAdminAccount get(String name, Output<String> id, @Nullable OrganizationAdminAccountState state, @Nullable CustomResourceOptions options) {
