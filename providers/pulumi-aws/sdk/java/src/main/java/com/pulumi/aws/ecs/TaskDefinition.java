...
public class TaskDefinition extends CustomResource {
     ...
     */
    public TaskDefinition(String name, TaskDefinitionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TaskDefinition(String name, Output<String> id, @Nullable TaskDefinitionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TaskDefinition get(String name, Output<String> id, @Nullable TaskDefinitionState state, @Nullable CustomResourceOptions options) {
