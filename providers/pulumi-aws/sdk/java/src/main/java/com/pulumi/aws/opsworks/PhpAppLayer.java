...
public class PhpAppLayer extends CustomResource {
    /**
     ...
     */
    public PhpAppLayer(String name, PhpAppLayerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PhpAppLayer(String name, Output<String> id, @Nullable PhpAppLayerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PhpAppLayer get(String name, Output<String> id, @Nullable PhpAppLayerState state, @Nullable CustomResourceOptions options) {
