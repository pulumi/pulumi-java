...
public final class VirtualNodeSpecListenerTimeoutHttpIdleGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private VirtualNodeSpecListenerTimeoutHttpIdleGetArgs(VirtualNodeSpecListenerTimeoutHttpIdleGetArgs $) {
        this.unit = $.unit;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualNodeSpecListenerTimeoutHttpIdleGetArgs();
        }

        public Builder(VirtualNodeSpecListenerTimeoutHttpIdleGetArgs defaults) {
            $ = new VirtualNodeSpecListenerTimeoutHttpIdleGetArgs(Objects.requireNonNull(defaults));
        }
