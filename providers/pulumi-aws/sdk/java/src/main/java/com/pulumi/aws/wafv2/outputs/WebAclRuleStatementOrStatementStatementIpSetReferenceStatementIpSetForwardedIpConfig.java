...
@CustomType
public final class WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig {
        /**
    ...
    public static Builder builder(WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig defaults) {
        ...
        public Builder position(String position) {
            ...
            return this;
        }        public WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig build() {
            return new WebAclRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig(fallbackBehavior, headerName, position);
        }
    }
}
