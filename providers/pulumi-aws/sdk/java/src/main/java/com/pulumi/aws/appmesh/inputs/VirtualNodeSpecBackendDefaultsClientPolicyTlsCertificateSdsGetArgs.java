...
public final class VirtualNodeSpecBackendDefaultsClientPolicyTlsCertificateSdsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private VirtualNodeSpecBackendDefaultsClientPolicyTlsCertificateSdsGetArgs(VirtualNodeSpecBackendDefaultsClientPolicyTlsCertificateSdsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualNodeSpecBackendDefaultsClientPolicyTlsCertificateSdsGetArgs();
        }

        public Builder(VirtualNodeSpecBackendDefaultsClientPolicyTlsCertificateSdsGetArgs defaults) {
            $ = new VirtualNodeSpecBackendDefaultsClientPolicyTlsCertificateSdsGetArgs(Objects.requireNonNull(defaults));
        }
