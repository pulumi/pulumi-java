...
public class BucketLifecycleConfiguration extends CustomResource {
     ...
     */
    public BucketLifecycleConfiguration(String name, BucketLifecycleConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BucketLifecycleConfiguration(String name, Output<String> id, @Nullable BucketLifecycleConfigurationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BucketLifecycleConfiguration get(String name, Output<String> id, @Nullable BucketLifecycleConfigurationState state, @Nullable CustomResourceOptions options) {
