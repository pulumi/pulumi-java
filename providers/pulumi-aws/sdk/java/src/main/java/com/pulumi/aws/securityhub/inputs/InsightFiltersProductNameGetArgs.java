...
public final class InsightFiltersProductNameGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersProductNameGetArgs(InsightFiltersProductNameGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersProductNameGetArgs();
        }

        public Builder(InsightFiltersProductNameGetArgs defaults) {
            $ = new InsightFiltersProductNameGetArgs(Objects.requireNonNull(defaults));
        }
