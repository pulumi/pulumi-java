...
public class UserStackAssociation extends CustomResource {
     ...
     */
    public UserStackAssociation(String name, UserStackAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private UserStackAssociation(String name, Output<String> id, @Nullable UserStackAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UserStackAssociation get(String name, Output<String> id, @Nullable UserStackAssociationState state, @Nullable CustomResourceOptions options) {
