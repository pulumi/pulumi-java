...
import com.pulumi.aws.wafv2.inputs.RuleGroupRuleStatementAndStatementStatementGeoMatchStatementForwardedIpConfigGetArgs;
...
public final class RuleGroupRuleStatementAndStatementStatementGeoMatchStatementGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<RuleGroupRuleStatementAndStatementStatementGeoMatchStatementForwardedIpConfigGetArgs>> forwardedIpConfig() {
        return Optional.ofNullable(this.forwardedIpConfig);
    }

    private RuleGroupRuleStatementAndStatementStatementGeoMatchStatementGetArgs() {}

    private RuleGroupRuleStatementAndStatementStatementGeoMatchStatementGetArgs(RuleGroupRuleStatementAndStatementStatementGeoMatchStatementGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupRuleStatementAndStatementStatementGeoMatchStatementGetArgs();
        }

        public Builder(RuleGroupRuleStatementAndStatementStatementGeoMatchStatementGetArgs defaults) {
            $ = new RuleGroupRuleStatementAndStatementStatementGeoMatchStatementGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder forwardedIpConfig(RuleGroupRuleStatementAndStatementStatementGeoMatchStatementForwardedIpConfigGetArgs forwardedIpConfig) {
