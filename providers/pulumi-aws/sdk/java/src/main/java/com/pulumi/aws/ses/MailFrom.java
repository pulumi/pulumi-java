...
public class MailFrom extends CustomResource {
     ...
     */
    public MailFrom(String name, MailFromArgs args, @Nullable CustomResourceOptions options) {
        super("aws:ses/mailFrom:MailFrom", name, args == null ? MailFromArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private MailFrom(String name, Output<String> id, @Nullable MailFromState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MailFrom get(String name, Output<String> id, @Nullable MailFromState state, @Nullable CustomResourceOptions options) {
