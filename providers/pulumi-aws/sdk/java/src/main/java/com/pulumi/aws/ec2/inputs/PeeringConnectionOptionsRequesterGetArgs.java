...
public final class PeeringConnectionOptionsRequesterGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PeeringConnectionOptionsRequesterGetArgs(PeeringConnectionOptionsRequesterGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PeeringConnectionOptionsRequesterGetArgs();
        }

        public Builder(PeeringConnectionOptionsRequesterGetArgs defaults) {
            $ = new PeeringConnectionOptionsRequesterGetArgs(Objects.requireNonNull(defaults));
        }
