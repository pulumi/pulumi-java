...
import com.pulumi.aws.kinesis.inputs.FirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptionsGetArgs;
import com.pulumi.aws.kinesis.inputs.FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationGetArgs;
import com.pulumi.aws.kinesis.inputs.FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfigurationGetArgs;
...
public final class FirehoseDeliveryStreamRedshiftConfigurationGetArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<FirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptionsGetArgs>> cloudwatchLoggingOptions() {
     ...
     * 
     */
    public Optional<Output<FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationGetArgs>> processingConfiguration() {
     ...
     * 
     */
    public Optional<Output<FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfigurationGetArgs>> s3BackupConfiguration() {
    ...
    private FirehoseDeliveryStreamRedshiftConfigurationGetArgs(FirehoseDeliveryStreamRedshiftConfigurationGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirehoseDeliveryStreamRedshiftConfigurationGetArgs();
        }

        public Builder(FirehoseDeliveryStreamRedshiftConfigurationGetArgs defaults) {
            $ = new FirehoseDeliveryStreamRedshiftConfigurationGetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudwatchLoggingOptions(FirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptionsGetArgs cloudwatchLoggingOptions) {
         ...
         * 
         */
        public Builder processingConfiguration(FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationGetArgs processingConfiguration) {
         ...
         * 
         */
        public Builder s3BackupConfiguration(FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfigurationGetArgs s3BackupConfiguration) {
