...
public class ProvisionedProduct extends CustomResource {
     ...
     */
    public ProvisionedProduct(String name, @Nullable ProvisionedProductArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProvisionedProduct(String name, Output<String> id, @Nullable ProvisionedProductState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProvisionedProduct get(String name, Output<String> id, @Nullable ProvisionedProductState state, @Nullable CustomResourceOptions options) {
