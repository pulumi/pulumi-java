...
public class Selection extends CustomResource {
     ...
     */
    public Selection(String name, SelectionArgs args, @Nullable CustomResourceOptions options) {
        super("aws:backup/selection:Selection", name, args == null ? SelectionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Selection(String name, Output<String> id, @Nullable SelectionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Selection get(String name, Output<String> id, @Nullable SelectionState state, @Nullable CustomResourceOptions options) {
