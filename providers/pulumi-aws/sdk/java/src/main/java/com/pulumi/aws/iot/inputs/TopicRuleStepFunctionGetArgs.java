...
public final class TopicRuleStepFunctionGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TopicRuleStepFunctionGetArgs(TopicRuleStepFunctionGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TopicRuleStepFunctionGetArgs();
        }

        public Builder(TopicRuleStepFunctionGetArgs defaults) {
            $ = new TopicRuleStepFunctionGetArgs(Objects.requireNonNull(defaults));
        }
