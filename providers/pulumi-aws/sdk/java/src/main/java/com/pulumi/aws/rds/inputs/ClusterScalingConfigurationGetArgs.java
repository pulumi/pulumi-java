...
public final class ClusterScalingConfigurationGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterScalingConfigurationGetArgs() {}

    private ClusterScalingConfigurationGetArgs(ClusterScalingConfigurationGetArgs $) {
    ...
    public static Builder builder(ClusterScalingConfigurationGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterScalingConfigurationGetArgs();
        }

        public Builder(ClusterScalingConfigurationGetArgs defaults) {
            $ = new ClusterScalingConfigurationGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param secondsUntilAutoPause The time, in seconds, before an Aurora DB cluster in serverless mode is paused. Valid values are `300` through `86400`. Defaults to `300`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param timeoutAction The action to take when the timeout is reached. Valid values: `ForceApplyCapacityChange`, `RollbackCapacityChange`. Defaults to `RollbackCapacityChange`. See [documentation](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-serverless.how-it-works.html#aurora-serverless.how-it-works.timeout-action).
         * 
         * @return builder
         * 
         */
