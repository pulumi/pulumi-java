...
public final class BucketLifecycleRuleNoncurrentVersionTransitionGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private BucketLifecycleRuleNoncurrentVersionTransitionGetArgs(BucketLifecycleRuleNoncurrentVersionTransitionGetArgs $) {
        this.days = $.days;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BucketLifecycleRuleNoncurrentVersionTransitionGetArgs();
        }

        public Builder(BucketLifecycleRuleNoncurrentVersionTransitionGetArgs defaults) {
            $ = new BucketLifecycleRuleNoncurrentVersionTransitionGetArgs(Objects.requireNonNull(defaults));
        }
