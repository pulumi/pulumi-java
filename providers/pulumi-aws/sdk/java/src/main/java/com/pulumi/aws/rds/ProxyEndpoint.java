...
public class ProxyEndpoint extends CustomResource {
     ...
     */
    public ProxyEndpoint(String name, ProxyEndpointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProxyEndpoint(String name, Output<String> id, @Nullable ProxyEndpointState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProxyEndpoint get(String name, Output<String> id, @Nullable ProxyEndpointState state, @Nullable CustomResourceOptions options) {
