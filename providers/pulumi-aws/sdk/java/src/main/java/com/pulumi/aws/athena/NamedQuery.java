...
public class NamedQuery extends CustomResource {
     ...
     */
    public NamedQuery(String name, NamedQueryArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NamedQuery(String name, Output<String> id, @Nullable NamedQueryState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NamedQuery get(String name, Output<String> id, @Nullable NamedQueryState state, @Nullable CustomResourceOptions options) {
