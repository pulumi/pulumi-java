...
public class ImageBuilder extends CustomResource {
    /**
     ...
     */
    public ImageBuilder(String name, ImageBuilderArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ImageBuilder(String name, Output<String> id, @Nullable ImageBuilderState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ImageBuilder get(String name, Output<String> id, @Nullable ImageBuilderState state, @Nullable CustomResourceOptions options) {
