...
public class Proxy extends CustomResource {
     ...
     */
    public Proxy(String name, ProxyArgs args, @Nullable CustomResourceOptions options) {
        super("aws:rds/proxy:Proxy", name, args == null ? ProxyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Proxy(String name, Output<String> id, @Nullable ProxyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Proxy get(String name, Output<String> id, @Nullable ProxyState state, @Nullable CustomResourceOptions options) {
