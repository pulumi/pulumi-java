...
public class NotebookInstanceLifecycleConfiguration extends CustomResource {
    /**
     ...
     */
    public NotebookInstanceLifecycleConfiguration(String name, @Nullable NotebookInstanceLifecycleConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NotebookInstanceLifecycleConfiguration(String name, Output<String> id, @Nullable NotebookInstanceLifecycleConfigurationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NotebookInstanceLifecycleConfiguration get(String name, Output<String> id, @Nullable NotebookInstanceLifecycleConfigurationState state, @Nullable CustomResourceOptions options) {
