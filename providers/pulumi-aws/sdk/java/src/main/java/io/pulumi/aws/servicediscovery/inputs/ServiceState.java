...
public final class ServiceState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setDnsConfig(@Nullable Input<ServiceDnsConfigGetArgs> dnsConfig) {
            this.dnsConfig = dnsConfig;
            return this;
        }

        public Builder setDnsConfig(@Nullable ServiceDnsConfigGetArgs dnsConfig) {
        ...
        public Builder setHealthCheckConfig(@Nullable Input<ServiceHealthCheckConfigGetArgs> healthCheckConfig) {
            this.healthCheckConfig = healthCheckConfig;
            return this;
        }

        public Builder setHealthCheckConfig(@Nullable ServiceHealthCheckConfigGetArgs healthCheckConfig) {
            this.healthCheckConfig = Input.ofNullable(healthCheckConfig);
            return this;
        }

        public Builder setHealthCheckCustomConfig(@Nullable Input<ServiceHealthCheckCustomConfigGetArgs> healthCheckCustomConfig) {
            this.healthCheckCustomConfig = healthCheckCustomConfig;
            return this;
        }

        public Builder setHealthCheckCustomConfig(@Nullable ServiceHealthCheckCustomConfigGetArgs healthCheckCustomConfig) {
