...
public class OntapFileSystem extends io.pulumi.resources.CustomResource {
    ...
    public OntapFileSystem(String name, OntapFileSystemArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:fsx/ontapFileSystem:OntapFileSystem", name, args == null ? OntapFileSystemArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private OntapFileSystem(String name, Input<String> id, @Nullable OntapFileSystemState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static OntapFileSystem get(String name, Input<String> id, @Nullable OntapFileSystemState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
