...
public final class MemcachedLayerCloudwatchConfigurationLogStreamGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final MemcachedLayerCloudwatchConfigurationLogStreamGetArgs Empty = new MemcachedLayerCloudwatchConfigurationLogStreamGetArgs();
    ...
    public MemcachedLayerCloudwatchConfigurationLogStreamGetArgs(
    ...
    private MemcachedLayerCloudwatchConfigurationLogStreamGetArgs() {
    ...
    public static Builder builder(MemcachedLayerCloudwatchConfigurationLogStreamGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(MemcachedLayerCloudwatchConfigurationLogStreamGetArgs defaults) {
        ...
        public MemcachedLayerCloudwatchConfigurationLogStreamGetArgs build() {
            return new MemcachedLayerCloudwatchConfigurationLogStreamGetArgs(batchCount, batchSize, bufferDuration, datetimeFormat, encoding, file, fileFingerprintLines, initialPosition, logGroupName, multilineStartPattern, timeZone);
        }
    }
}
