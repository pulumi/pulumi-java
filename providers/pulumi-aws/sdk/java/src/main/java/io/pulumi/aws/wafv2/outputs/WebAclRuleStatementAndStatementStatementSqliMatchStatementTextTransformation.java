...
@OutputCustomType
public final class WebAclRuleStatementAndStatementStatementSqliMatchStatementTextTransformation {
    /**
    ...
    private WebAclRuleStatementAndStatementStatementSqliMatchStatementTextTransformation(
        Integer priority,
        String type) {
    ...
    public static Builder builder(WebAclRuleStatementAndStatementStatementSqliMatchStatementTextTransformation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WebAclRuleStatementAndStatementStatementSqliMatchStatementTextTransformation defaults) {
