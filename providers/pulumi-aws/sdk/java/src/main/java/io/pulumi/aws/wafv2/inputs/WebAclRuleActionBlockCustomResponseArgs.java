...
public final class WebAclRuleActionBlockCustomResponseArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setResponseHeaders(@Nullable Input<List<WebAclRuleActionBlockCustomResponseResponseHeaderArgs>> responseHeaders) {
            this.responseHeaders = responseHeaders;
            return this;
        }

        public Builder setResponseHeaders(@Nullable List<WebAclRuleActionBlockCustomResponseResponseHeaderArgs> responseHeaders) {
