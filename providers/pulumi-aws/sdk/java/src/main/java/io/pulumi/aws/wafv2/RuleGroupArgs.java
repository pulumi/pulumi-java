...
public final class RuleGroupArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCustomResponseBodies(@Nullable Input<List<RuleGroupCustomResponseBodyArgs>> customResponseBodies) {
            this.customResponseBodies = customResponseBodies;
            return this;
        }

        public Builder setCustomResponseBodies(@Nullable List<RuleGroupCustomResponseBodyArgs> customResponseBodies) {
