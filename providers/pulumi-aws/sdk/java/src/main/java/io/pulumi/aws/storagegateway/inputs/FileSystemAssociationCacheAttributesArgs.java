...
public final class FileSystemAssociationCacheAttributesArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public FileSystemAssociationCacheAttributesArgs(@Nullable Input<Integer> cacheStaleTimeoutInSeconds) {
