...
public class VideoStream extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable VideoStreamArgs.Builder a);
    }
    private static io.pulumi.aws.kinesis.VideoStreamArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.kinesis.VideoStreamArgs.builder();
     ...
     */
    public VideoStream(String name, BuilderApplicator argsBuilder) {
    ...
    public VideoStream(String name, @Nullable VideoStreamArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:kinesis/videoStream:VideoStream", name, args == null ? VideoStreamArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private VideoStream(String name, Input<String> id, @Nullable VideoStreamState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static VideoStream get(String name, Input<String> id, @Nullable VideoStreamState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
