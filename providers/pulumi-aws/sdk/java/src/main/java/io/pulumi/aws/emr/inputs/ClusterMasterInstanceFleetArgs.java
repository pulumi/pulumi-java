...
public final class ClusterMasterInstanceFleetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigArgs>> instanceTypeConfigs;

    public Input<List<ClusterMasterInstanceFleetInstanceTypeConfigArgs>> getInstanceTypeConfigs() {
    ...
    private final @Nullable Input<ClusterMasterInstanceFleetLaunchSpecificationsArgs> launchSpecifications;

    public Input<ClusterMasterInstanceFleetLaunchSpecificationsArgs> getLaunchSpecifications() {
    ...
    public ClusterMasterInstanceFleetArgs(
        ...
        @Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigArgs>> instanceTypeConfigs,
        @Nullable Input<ClusterMasterInstanceFleetLaunchSpecificationsArgs> launchSpecifications,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigArgs>> instanceTypeConfigs;
        private @Nullable Input<ClusterMasterInstanceFleetLaunchSpecificationsArgs> launchSpecifications;
        ...
        public Builder setInstanceTypeConfigs(@Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigArgs>> instanceTypeConfigs) {
            this.instanceTypeConfigs = instanceTypeConfigs;
            return this;
        }

        public Builder setInstanceTypeConfigs(@Nullable List<ClusterMasterInstanceFleetInstanceTypeConfigArgs> instanceTypeConfigs) {
            this.instanceTypeConfigs = Input.ofNullable(instanceTypeConfigs);
            return this;
        }

        public Builder setLaunchSpecifications(@Nullable Input<ClusterMasterInstanceFleetLaunchSpecificationsArgs> launchSpecifications) {
            this.launchSpecifications = launchSpecifications;
            return this;
        }

        public Builder setLaunchSpecifications(@Nullable ClusterMasterInstanceFleetLaunchSpecificationsArgs launchSpecifications) {
