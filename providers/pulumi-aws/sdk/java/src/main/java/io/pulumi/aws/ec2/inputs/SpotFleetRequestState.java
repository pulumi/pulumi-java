...
public final class SpotFleetRequestState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setIamFleetRole(@Nullable Input<String> iamFleetRole) {
            this.iamFleetRole = iamFleetRole;
            return this;
        }

        public Builder setIamFleetRole(@Nullable String iamFleetRole) {
        ...
        public Builder setLaunchSpecifications(@Nullable Input<List<SpotFleetRequestLaunchSpecificationGetArgs>> launchSpecifications) {
            this.launchSpecifications = launchSpecifications;
            return this;
        }

        public Builder setLaunchSpecifications(@Nullable List<SpotFleetRequestLaunchSpecificationGetArgs> launchSpecifications) {
            this.launchSpecifications = Input.ofNullable(launchSpecifications);
            return this;
        }

        public Builder setLaunchTemplateConfigs(@Nullable Input<List<SpotFleetRequestLaunchTemplateConfigGetArgs>> launchTemplateConfigs) {
            this.launchTemplateConfigs = launchTemplateConfigs;
            return this;
        }

        public Builder setLaunchTemplateConfigs(@Nullable List<SpotFleetRequestLaunchTemplateConfigGetArgs> launchTemplateConfigs) {
        ...
        public Builder setSpotMaintenanceStrategies(@Nullable Input<SpotFleetRequestSpotMaintenanceStrategiesGetArgs> spotMaintenanceStrategies) {
            this.spotMaintenanceStrategies = spotMaintenanceStrategies;
            return this;
        }

        public Builder setSpotMaintenanceStrategies(@Nullable SpotFleetRequestSpotMaintenanceStrategiesGetArgs spotMaintenanceStrategies) {
