...
public final class InsightFiltersResourceAwsEc2InstanceLaunchedAtGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public InsightFiltersResourceAwsEc2InstanceLaunchedAtGetArgs(
        @Nullable Input<InsightFiltersResourceAwsEc2InstanceLaunchedAtDateRangeGetArgs> dateRange,
    ...
    public static final class Builder {
        private @Nullable Input<InsightFiltersResourceAwsEc2InstanceLaunchedAtDateRangeGetArgs> dateRange;
        ...
        public Builder setDateRange(@Nullable Input<InsightFiltersResourceAwsEc2InstanceLaunchedAtDateRangeGetArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder setDateRange(@Nullable InsightFiltersResourceAwsEc2InstanceLaunchedAtDateRangeGetArgs dateRange) {
