...
public class SizeConstraintSet extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.wafregional.SizeConstraintSetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.wafregional.SizeConstraintSetArgs.builder();
