...
public class Database extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="tableCount", type=Integer.class, parameters={})
    ...
    public Database(String name, DatabaseArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:timestreamwrite/database:Database", name, args == null ? DatabaseArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
