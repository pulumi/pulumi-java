...
public class GameSessionQueue extends io.pulumi.resources.CustomResource {
     ...
     */
    public static GameSessionQueue get(String name, Output<String> id, @Nullable GameSessionQueueState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
