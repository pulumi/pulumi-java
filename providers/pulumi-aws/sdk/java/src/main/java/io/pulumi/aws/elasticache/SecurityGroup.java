...
public class SecurityGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.elasticache.SecurityGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.elasticache.SecurityGroupArgs.builder();
