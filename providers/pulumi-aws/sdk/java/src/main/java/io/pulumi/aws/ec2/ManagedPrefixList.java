...
public class ManagedPrefixList extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ManagedPrefixListArgs.Builder a);
    }
    private static io.pulumi.aws.ec2.ManagedPrefixListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2.ManagedPrefixListArgs.builder();
     ...
     */
    public ManagedPrefixList(String name, BuilderApplicator argsBuilder) {
