...
public final class ClassificationJobS3JobDefinitionScopingIncludesAndTagScopeTermGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setTagValues(@Nullable Input<List<ClassificationJobS3JobDefinitionScopingIncludesAndTagScopeTermTagValueGetArgs>> tagValues) {
            this.tagValues = tagValues;
            return this;
        }

        public Builder setTagValues(@Nullable List<ClassificationJobS3JobDefinitionScopingIncludesAndTagScopeTermTagValueGetArgs> tagValues) {
