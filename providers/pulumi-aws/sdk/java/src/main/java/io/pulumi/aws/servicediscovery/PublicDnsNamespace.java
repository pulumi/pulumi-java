...
public class PublicDnsNamespace extends io.pulumi.resources.CustomResource {
    ...
    public PublicDnsNamespace(String name, @Nullable PublicDnsNamespaceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:servicediscovery/publicDnsNamespace:PublicDnsNamespace", name, args == null ? PublicDnsNamespaceArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private PublicDnsNamespace(String name, Input<String> id, @Nullable PublicDnsNamespaceState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static PublicDnsNamespace get(String name, Input<String> id, @Nullable PublicDnsNamespaceState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
