...
public final class ListenerDefaultActionAuthenticateOidcArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ListenerDefaultActionAuthenticateOidcArgs build() {
            return new ListenerDefaultActionAuthenticateOidcArgs(authenticationRequestExtraParams, authorizationEndpoint, clientId, clientSecret, issuer, onUnauthenticatedRequest, scope, sessionCookieName, sessionTimeout, tokenEndpoint, userInfoEndpoint);
        }
    }
}
