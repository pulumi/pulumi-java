...
public final class InsightFiltersProcessLaunchedAtArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="dateRange")
      private final @Nullable Input<InsightFiltersProcessLaunchedAtDateRangeArgs> dateRange;

    public Input<InsightFiltersProcessLaunchedAtDateRangeArgs> getDateRange() {
    ...
    public InsightFiltersProcessLaunchedAtArgs(
        @Nullable Input<InsightFiltersProcessLaunchedAtDateRangeArgs> dateRange,
    ...
    public static final class Builder {
        private @Nullable Input<InsightFiltersProcessLaunchedAtDateRangeArgs> dateRange;
        ...
        public Builder setDateRange(@Nullable Input<InsightFiltersProcessLaunchedAtDateRangeArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder setDateRange(@Nullable InsightFiltersProcessLaunchedAtDateRangeArgs dateRange) {
