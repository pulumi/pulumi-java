...
public class ParameterGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.redshift.ParameterGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.redshift.ParameterGroupArgs.builder();
