...
public class VirtualGateway extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="spec", type=VirtualGatewaySpec.class, parameters={})
    ...
    public interface BuilderApplicator {
        public void apply(VirtualGatewayArgs.Builder a);
    }
    private static io.pulumi.aws.appmesh.VirtualGatewayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.appmesh.VirtualGatewayArgs.builder();
     ...
     */
    public VirtualGateway(String name, BuilderApplicator argsBuilder) {
    ...
    public VirtualGateway(String name, VirtualGatewayArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:appmesh/virtualGateway:VirtualGateway", name, args == null ? VirtualGatewayArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private VirtualGateway(String name, Input<String> id, @Nullable VirtualGatewayState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static VirtualGateway get(String name, Input<String> id, @Nullable VirtualGatewayState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
