...
public class ParameterGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.elasticache.ParameterGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.elasticache.ParameterGroupArgs.builder();
    ...
    public ParameterGroup(String name, ParameterGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:elasticache/parameterGroup:ParameterGroup", name, args == null ? ParameterGroupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
