...
public class JobQueue extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="computeEnvironments", type=List.class, parameters={String.class})
     ...
     * 
     */
    @OutputExport(name="schedulingPolicyArn", type=String.class, parameters={})
    ...
    public JobQueue(String name, JobQueueArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:batch/jobQueue:JobQueue", name, args == null ? JobQueueArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private JobQueue(String name, Input<String> id, @Nullable JobQueueState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static JobQueue get(String name, Input<String> id, @Nullable JobQueueState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
