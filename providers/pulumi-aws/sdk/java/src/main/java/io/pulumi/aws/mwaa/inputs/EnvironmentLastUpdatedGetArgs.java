...
public final class EnvironmentLastUpdatedGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setErrors(@Nullable Input<List<EnvironmentLastUpdatedErrorGetArgs>> errors) {
            this.errors = errors;
            return this;
        }

        public Builder setErrors(@Nullable List<EnvironmentLastUpdatedErrorGetArgs> errors) {
