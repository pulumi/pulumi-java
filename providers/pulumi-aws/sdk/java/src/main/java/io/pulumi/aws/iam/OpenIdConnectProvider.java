...
public class OpenIdConnectProvider extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.iam.OpenIdConnectProviderArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.iam.OpenIdConnectProviderArgs.builder();
    ...
    public OpenIdConnectProvider(String name, OpenIdConnectProviderArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:iam/openIdConnectProvider:OpenIdConnectProvider", name, args == null ? OpenIdConnectProviderArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private OpenIdConnectProvider(String name, Input<String> id, @Nullable OpenIdConnectProviderState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static OpenIdConnectProvider get(String name, Input<String> id, @Nullable OpenIdConnectProviderState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
