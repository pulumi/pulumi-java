...
public final class SmbFileShareArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public SmbFileShareArgs(
        ...
        @Nullable Input<SmbFileShareCacheAttributesArgs> cacheAttributes,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<SmbFileShareCacheAttributesArgs> cacheAttributes;
        ...
        public Builder setCacheAttributes(@Nullable Input<SmbFileShareCacheAttributesArgs> cacheAttributes) {
            this.cacheAttributes = cacheAttributes;
            return this;
        }

        public Builder setCacheAttributes(@Nullable SmbFileShareCacheAttributesArgs cacheAttributes) {
