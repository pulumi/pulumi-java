...
public class StoredIscsiVolume extends io.pulumi.resources.CustomResource {
    ...
    public StoredIscsiVolume(String name, StoredIscsiVolumeArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:storagegateway/storedIscsiVolume:StoredIscsiVolume", name, args == null ? StoredIscsiVolumeArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private StoredIscsiVolume(String name, Input<String> id, @Nullable StoredIscsiVolumeState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static StoredIscsiVolume get(String name, Input<String> id, @Nullable StoredIscsiVolumeState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
