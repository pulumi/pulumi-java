...
public class UserGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.cognito.UserGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.cognito.UserGroupArgs.builder();
