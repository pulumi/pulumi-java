...
public class EventSubscription extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.redshift.EventSubscriptionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.redshift.EventSubscriptionArgs.builder();
