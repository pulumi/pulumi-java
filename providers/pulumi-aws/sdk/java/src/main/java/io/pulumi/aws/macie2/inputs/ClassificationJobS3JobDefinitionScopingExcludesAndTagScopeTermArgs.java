...
public final class ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setTagValues(@Nullable Input<List<ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValueArgs>> tagValues) {
            this.tagValues = tagValues;
            return this;
        }

        public Builder setTagValues(@Nullable List<ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValueArgs> tagValues) {
