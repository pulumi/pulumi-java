...
public class Backup extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable BackupArgs.Builder a);
    }
    private static io.pulumi.aws.fsx.BackupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.fsx.BackupArgs.builder();
    ...
    public Backup(String name, @Nullable BackupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:fsx/backup:Backup", name, args == null ? BackupArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private Backup(String name, Input<String> id, @Nullable BackupState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Backup get(String name, Input<String> id, @Nullable BackupState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
