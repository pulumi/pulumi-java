...
public class Gateway extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.directconnect.GatewayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.directconnect.GatewayArgs.builder();
    ...
    public Gateway(String name, GatewayArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:directconnect/gateway:Gateway", name, args == null ? GatewayArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
