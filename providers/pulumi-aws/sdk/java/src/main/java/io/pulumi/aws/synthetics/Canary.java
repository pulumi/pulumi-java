...
public class Canary extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="engineArn", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="s3Version", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="startCanary", type=Boolean.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="timelines", type=List.class, parameters={CanaryTimeline.class})
     ...
     * 
     */
    @OutputExport(name="zipFile", type=String.class, parameters={})
    ...
    public Canary(String name, CanaryArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:synthetics/canary:Canary", name, args == null ? CanaryArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private Canary(String name, Input<String> id, @Nullable CanaryState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Canary get(String name, Input<String> id, @Nullable CanaryState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
