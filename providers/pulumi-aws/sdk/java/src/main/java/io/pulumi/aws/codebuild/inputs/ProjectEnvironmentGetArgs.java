...
public final class ProjectEnvironmentGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setEnvironmentVariables(@Nullable Input<List<ProjectEnvironmentEnvironmentVariableGetArgs>> environmentVariables) {
            this.environmentVariables = environmentVariables;
            return this;
        }

        public Builder setEnvironmentVariables(@Nullable List<ProjectEnvironmentEnvironmentVariableGetArgs> environmentVariables) {
        ...
        public Builder setRegistryCredential(@Nullable Input<ProjectEnvironmentRegistryCredentialGetArgs> registryCredential) {
            this.registryCredential = registryCredential;
            return this;
        }

        public Builder setRegistryCredential(@Nullable ProjectEnvironmentRegistryCredentialGetArgs registryCredential) {
