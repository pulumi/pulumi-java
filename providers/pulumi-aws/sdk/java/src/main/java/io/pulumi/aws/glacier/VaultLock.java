...
public class VaultLock extends io.pulumi.resources.CustomResource {
    ...
    public VaultLock(String name, VaultLockArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:glacier/vaultLock:VaultLock", name, args == null ? VaultLockArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private VaultLock(String name, Input<String> id, @Nullable VaultLockState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static VaultLock get(String name, Input<String> id, @Nullable VaultLockState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
