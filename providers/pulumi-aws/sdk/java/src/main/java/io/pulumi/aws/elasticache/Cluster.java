...
import io.pulumi.aws.elasticache.ClusterArgs;
...
public class Cluster extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.elasticache.ClusterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.elasticache.ClusterArgs.builder();
    ...
    public Cluster(String name, @Nullable ClusterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:elasticache/cluster:Cluster", name, args == null ? ClusterArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
