...
public class Policy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.organizations.PolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.organizations.PolicyArgs.builder();
    ...
    public Policy(String name, PolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:organizations/policy:Policy", name, args == null ? PolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
