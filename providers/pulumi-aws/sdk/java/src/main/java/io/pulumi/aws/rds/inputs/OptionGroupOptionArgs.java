...
public final class OptionGroupOptionArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setOptionSettings(@Nullable Input<List<OptionGroupOptionOptionSettingArgs>> optionSettings) {
            this.optionSettings = optionSettings;
            return this;
        }

        public Builder setOptionSettings(@Nullable List<OptionGroupOptionOptionSettingArgs> optionSettings) {
