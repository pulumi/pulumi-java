...
public final class DistributionOrderedCacheBehaviorForwardedValuesCookiesGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DistributionOrderedCacheBehaviorForwardedValuesCookiesGetArgs build() {
            return new DistributionOrderedCacheBehaviorForwardedValuesCookiesGetArgs(forward, whitelistedNames);
        }
    }
}
