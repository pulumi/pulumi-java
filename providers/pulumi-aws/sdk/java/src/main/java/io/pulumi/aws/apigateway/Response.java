...
public class Response extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ResponseArgs.Builder a);
    }
    private static io.pulumi.aws.apigateway.ResponseArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.apigateway.ResponseArgs.builder();
     ...
     */
    public Response(String name, BuilderApplicator argsBuilder) {
