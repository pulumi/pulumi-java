...
public final class InsightFiltersResourceAwsEc2InstanceLaunchedAtArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setDateRange(@Nullable Input<InsightFiltersResourceAwsEc2InstanceLaunchedAtDateRangeArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder setDateRange(@Nullable InsightFiltersResourceAwsEc2InstanceLaunchedAtDateRangeArgs dateRange) {
