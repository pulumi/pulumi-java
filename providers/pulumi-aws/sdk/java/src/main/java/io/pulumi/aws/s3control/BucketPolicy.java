...
public class BucketPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.s3control.BucketPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.s3control.BucketPolicyArgs.builder();
