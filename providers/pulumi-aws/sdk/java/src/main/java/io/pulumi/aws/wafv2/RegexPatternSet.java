...
public class RegexPatternSet extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.wafv2.RegexPatternSetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.wafv2.RegexPatternSetArgs.builder();
