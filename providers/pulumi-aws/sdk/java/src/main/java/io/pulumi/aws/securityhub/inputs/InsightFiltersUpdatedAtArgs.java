...
import io.pulumi.aws.securityhub.inputs.InsightFiltersUpdatedAtDateRangeArgs;
...
public final class InsightFiltersUpdatedAtArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<InsightFiltersUpdatedAtDateRangeArgs> dateRange;

    public Input<InsightFiltersUpdatedAtDateRangeArgs> getDateRange() {
    ...
    public InsightFiltersUpdatedAtArgs(
        @Nullable Input<InsightFiltersUpdatedAtDateRangeArgs> dateRange,
    ...
    public static final class Builder {
        private @Nullable Input<InsightFiltersUpdatedAtDateRangeArgs> dateRange;
        ...
        public Builder setDateRange(@Nullable Input<InsightFiltersUpdatedAtDateRangeArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder setDateRange(@Nullable InsightFiltersUpdatedAtDateRangeArgs dateRange) {
