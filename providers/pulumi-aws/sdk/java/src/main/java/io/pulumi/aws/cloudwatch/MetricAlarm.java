...
public class MetricAlarm extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(MetricAlarmArgs.Builder a);
    }
    private static io.pulumi.aws.cloudwatch.MetricAlarmArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.cloudwatch.MetricAlarmArgs.builder();
     ...
     */
    public MetricAlarm(String name, BuilderApplicator argsBuilder) {
