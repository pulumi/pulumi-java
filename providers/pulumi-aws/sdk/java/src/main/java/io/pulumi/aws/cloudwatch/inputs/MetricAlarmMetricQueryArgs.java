...
public final class MetricAlarmMetricQueryArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setMetric(@Nullable Input<MetricAlarmMetricQueryMetricArgs> metric) {
            this.metric = metric;
            return this;
        }

        public Builder setMetric(@Nullable MetricAlarmMetricQueryMetricArgs metric) {
