...
public final class NodejsAppLayerEbsVolumeArgs extends io.pulumi.resources.ResourceArgs {

    public static final NodejsAppLayerEbsVolumeArgs Empty = new NodejsAppLayerEbsVolumeArgs();
    ...
    public NodejsAppLayerEbsVolumeArgs(
    ...
    private NodejsAppLayerEbsVolumeArgs() {
    ...
    public static Builder builder(NodejsAppLayerEbsVolumeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public NodejsAppLayerEbsVolumeArgs build() {
            return new NodejsAppLayerEbsVolumeArgs(encrypted, iops, mountPoint, numberOfDisks, raidLevel, size, type);
        }
    }
}
