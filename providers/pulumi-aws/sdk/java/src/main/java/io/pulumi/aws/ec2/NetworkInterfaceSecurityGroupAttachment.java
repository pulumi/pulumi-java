...
public class NetworkInterfaceSecurityGroupAttachment extends io.pulumi.resources.CustomResource {
    ...
    public NetworkInterfaceSecurityGroupAttachment(String name, NetworkInterfaceSecurityGroupAttachmentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/networkInterfaceSecurityGroupAttachment:NetworkInterfaceSecurityGroupAttachment", name, args == null ? NetworkInterfaceSecurityGroupAttachmentArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private NetworkInterfaceSecurityGroupAttachment(String name, Input<String> id, @Nullable NetworkInterfaceSecurityGroupAttachmentState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static NetworkInterfaceSecurityGroupAttachment get(String name, Input<String> id, @Nullable NetworkInterfaceSecurityGroupAttachmentState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
