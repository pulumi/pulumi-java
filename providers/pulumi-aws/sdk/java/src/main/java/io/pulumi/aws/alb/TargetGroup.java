...
import io.pulumi.aws.alb.TargetGroupArgs;
import io.pulumi.aws.alb.inputs.TargetGroupState;
import io.pulumi.aws.alb.outputs.TargetGroupHealthCheck;
import io.pulumi.aws.alb.outputs.TargetGroupStickiness;
...
public class TargetGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.alb.TargetGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.alb.TargetGroupArgs.builder();
    ...
    public TargetGroup(String name, @Nullable TargetGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:alb/targetGroup:TargetGroup", name, args == null ? TargetGroupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("aws:applicationloadbalancing/targetGroup:TargetGroup").build())
            ))
            .build();
