...
public class ManagedScalingPolicy extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="computeLimits", type=List.class, parameters={ManagedScalingPolicyComputeLimit.class})
    ...
    public interface BuilderApplicator {
        public void apply(ManagedScalingPolicyArgs.Builder a);
    }
    private static io.pulumi.aws.emr.ManagedScalingPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.emr.ManagedScalingPolicyArgs.builder();
     ...
     */
    public ManagedScalingPolicy(String name, BuilderApplicator argsBuilder) {
