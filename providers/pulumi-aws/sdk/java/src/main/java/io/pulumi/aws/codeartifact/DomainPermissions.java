...
public class DomainPermissions extends io.pulumi.resources.CustomResource {
    ...
    public DomainPermissions(String name, DomainPermissionsArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:codeartifact/domainPermissions:DomainPermissions", name, args == null ? DomainPermissionsArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private DomainPermissions(String name, Input<String> id, @Nullable DomainPermissionsState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static DomainPermissions get(String name, Input<String> id, @Nullable DomainPermissionsState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
