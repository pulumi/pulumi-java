...
public final class ClusterCoreInstanceGroupGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final ClusterCoreInstanceGroupGetArgs Empty = new ClusterCoreInstanceGroupGetArgs();
    ...
    public static final class Builder {
        ...
        public Builder setEbsConfigs(@Nullable Input<List<ClusterCoreInstanceGroupEbsConfigGetArgs>> ebsConfigs) {
            this.ebsConfigs = ebsConfigs;
            return this;
        }

        public Builder setEbsConfigs(@Nullable List<ClusterCoreInstanceGroupEbsConfigGetArgs> ebsConfigs) {
