...
public final class InsightFiltersCompanyNameArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public InsightFiltersCompanyNameArgs(
    ...
    private InsightFiltersCompanyNameArgs() {
    ...
    public static Builder builder(InsightFiltersCompanyNameArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(InsightFiltersCompanyNameArgs defaults) {
        ...
        public Builder value(String value) {
            ...
            return this;
        }        public InsightFiltersCompanyNameArgs build() {
            return new InsightFiltersCompanyNameArgs(comparison, value);
        }
    }
}
