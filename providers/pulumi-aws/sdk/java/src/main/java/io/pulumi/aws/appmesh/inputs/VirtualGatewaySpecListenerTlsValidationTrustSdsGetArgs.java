...
public final class VirtualGatewaySpecListenerTlsValidationTrustSdsGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public VirtualGatewaySpecListenerTlsValidationTrustSdsGetArgs(Input<String> secretName) {
