...
public class User extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.memorydb.UserArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.memorydb.UserArgs.builder();
    ...
    public User(String name, UserArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:memorydb/user:User", name, args == null ? UserArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
