...
public final class DistributionOrderedCacheBehaviorForwardedValuesGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCookies(Input<DistributionOrderedCacheBehaviorForwardedValuesCookiesGetArgs> cookies) {
            this.cookies = Objects.requireNonNull(cookies);
            return this;
        }

        public Builder setCookies(DistributionOrderedCacheBehaviorForwardedValuesCookiesGetArgs cookies) {
