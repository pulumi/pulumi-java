...
public class MonitoringSubscription extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(MonitoringSubscriptionArgs.Builder a);
    }
    private static io.pulumi.aws.cloudfront.MonitoringSubscriptionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.cloudfront.MonitoringSubscriptionArgs.builder();
     ...
     */
    public MonitoringSubscription(String name, BuilderApplicator argsBuilder) {
