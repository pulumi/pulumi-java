...
public final class EnvironmentLoggingConfigurationSchedulerLogs {
    ...
    */
    ...
    public static Builder builder(EnvironmentLoggingConfigurationSchedulerLogs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(EnvironmentLoggingConfigurationSchedulerLogs defaults) {
        ...
        public EnvironmentLoggingConfigurationSchedulerLogs build() {
            return new EnvironmentLoggingConfigurationSchedulerLogs(cloudWatchLogGroupArn, enabled, logLevel);
        }
    }
}
