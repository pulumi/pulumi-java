...
public final class MysqlLayerCloudwatchConfigurationLogStream {
    ...
    public static Builder builder(MysqlLayerCloudwatchConfigurationLogStream defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(MysqlLayerCloudwatchConfigurationLogStream defaults) {
        ...
        public Builder timeZone(@Nullable String timeZone) {
            ...
            return new MysqlLayerCloudwatchConfigurationLogStream(batchCount, batchSize, bufferDuration, datetimeFormat, encoding, file, fileFingerprintLines, initialPosition, logGroupName, multilineStartPattern, timeZone);
        }
    }
}
