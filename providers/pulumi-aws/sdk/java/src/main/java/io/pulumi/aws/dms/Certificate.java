...
public class Certificate extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.dms.CertificateArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.dms.CertificateArgs.builder();
    ...
    public Certificate(String name, CertificateArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:dms/certificate:Certificate", name, args == null ? CertificateArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
