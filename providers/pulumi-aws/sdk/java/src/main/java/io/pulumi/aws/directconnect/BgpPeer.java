...
public class BgpPeer extends io.pulumi.resources.CustomResource {
    ...
    public BgpPeer(String name, BgpPeerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:directconnect/bgpPeer:BgpPeer", name, args == null ? BgpPeerArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private BgpPeer(String name, Input<String> id, @Nullable BgpPeerState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static BgpPeer get(String name, Input<String> id, @Nullable BgpPeerState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
