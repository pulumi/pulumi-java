...
public final class GetNetworkInterfaceFilter extends io.pulumi.resources.InvokeArgs {

    public static final GetNetworkInterfaceFilter Empty = new GetNetworkInterfaceFilter();
    ...
    public GetNetworkInterfaceFilter(
        String name,
        List<String> values) {
