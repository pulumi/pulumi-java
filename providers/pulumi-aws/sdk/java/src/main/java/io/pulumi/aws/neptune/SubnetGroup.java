...
public class SubnetGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.neptune.SubnetGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.neptune.SubnetGroupArgs.builder();
    ...
    public SubnetGroup(String name, SubnetGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:neptune/subnetGroup:SubnetGroup", name, args == null ? SubnetGroupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
