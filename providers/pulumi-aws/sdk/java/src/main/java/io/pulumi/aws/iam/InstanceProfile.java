...
public class InstanceProfile extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.iam.InstanceProfileArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.iam.InstanceProfileArgs.builder();
