...
public class IpSet extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.wafregional.IpSetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.wafregional.IpSetArgs.builder();
