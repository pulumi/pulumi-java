...
public class Crawler extends io.pulumi.resources.CustomResource {
    ...
    public Crawler(String name, CrawlerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:glue/crawler:Crawler", name, args == null ? CrawlerArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private Crawler(String name, Input<String> id, @Nullable CrawlerState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Crawler get(String name, Input<String> id, @Nullable CrawlerState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
