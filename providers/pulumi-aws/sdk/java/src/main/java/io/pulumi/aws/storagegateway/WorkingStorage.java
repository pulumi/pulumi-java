...
public class WorkingStorage extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(WorkingStorageArgs.Builder a);
    }
    private static io.pulumi.aws.storagegateway.WorkingStorageArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.storagegateway.WorkingStorageArgs.builder();
     ...
     */
    public WorkingStorage(String name, BuilderApplicator argsBuilder) {
