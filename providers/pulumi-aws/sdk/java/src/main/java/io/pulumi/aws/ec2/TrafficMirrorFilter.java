...
public class TrafficMirrorFilter extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="networkServices", type=List.class, parameters={String.class})
    ...
    public TrafficMirrorFilter(String name, @Nullable TrafficMirrorFilterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/trafficMirrorFilter:TrafficMirrorFilter", name, args == null ? TrafficMirrorFilterArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private TrafficMirrorFilter(String name, Input<String> id, @Nullable TrafficMirrorFilterState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TrafficMirrorFilter get(String name, Input<String> id, @Nullable TrafficMirrorFilterState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
