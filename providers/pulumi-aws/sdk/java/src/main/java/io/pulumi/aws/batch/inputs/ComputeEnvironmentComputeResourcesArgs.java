...
public final class ComputeEnvironmentComputeResourcesArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setEc2Configuration(@Nullable Input<ComputeEnvironmentComputeResourcesEc2ConfigurationArgs> ec2Configuration) {
            this.ec2Configuration = ec2Configuration;
            return this;
        }

        public Builder setEc2Configuration(@Nullable ComputeEnvironmentComputeResourcesEc2ConfigurationArgs ec2Configuration) {
        ...
        public Builder setLaunchTemplate(@Nullable Input<ComputeEnvironmentComputeResourcesLaunchTemplateArgs> launchTemplate) {
            this.launchTemplate = launchTemplate;
            return this;
        }

        public Builder setLaunchTemplate(@Nullable ComputeEnvironmentComputeResourcesLaunchTemplateArgs launchTemplate) {
