...
public class InvitationAccepter extends io.pulumi.resources.CustomResource {
    ...
    public InvitationAccepter(String name, InvitationAccepterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:detective/invitationAccepter:InvitationAccepter", name, args == null ? InvitationAccepterArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private InvitationAccepter(String name, Input<String> id, @Nullable InvitationAccepterState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static InvitationAccepter get(String name, Input<String> id, @Nullable InvitationAccepterState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
