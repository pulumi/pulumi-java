...
public class Thing extends io.pulumi.resources.CustomResource {
    ...
    public Thing(String name, @Nullable ThingArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:iot/thing:Thing", name, args == null ? ThingArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private Thing(String name, Input<String> id, @Nullable ThingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Thing get(String name, Input<String> id, @Nullable ThingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
