...
public class Endpoint extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.ec2clientvpn.EndpointArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2clientvpn.EndpointArgs.builder();
