...
public final class ClusterMasterInstanceFleetInstanceTypeConfigGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder configurations(@Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigConfigurationGetArgs>> configurations) {
            this.configurations = configurations;
            return this;
        }
        ...
        public Builder ebsConfigs(@Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigEbsConfigGetArgs>> ebsConfigs) {
            this.ebsConfigs = ebsConfigs;
            return this;
        }
