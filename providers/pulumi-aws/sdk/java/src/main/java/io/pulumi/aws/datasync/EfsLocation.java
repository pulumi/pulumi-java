...
public class EfsLocation extends io.pulumi.resources.CustomResource {
    ...
    public EfsLocation(String name, EfsLocationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:datasync/efsLocation:EfsLocation", name, args == null ? EfsLocationArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private EfsLocation(String name, Input<String> id, @Nullable EfsLocationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static EfsLocation get(String name, Input<String> id, @Nullable EfsLocationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
