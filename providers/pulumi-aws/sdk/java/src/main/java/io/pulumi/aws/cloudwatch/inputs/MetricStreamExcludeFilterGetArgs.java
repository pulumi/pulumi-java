...
public final class MetricStreamExcludeFilterGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public MetricStreamExcludeFilterGetArgs(Input<String> namespace) {
