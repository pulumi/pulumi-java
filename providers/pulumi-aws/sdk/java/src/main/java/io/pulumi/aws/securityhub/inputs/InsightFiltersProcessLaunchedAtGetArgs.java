...
public final class InsightFiltersProcessLaunchedAtGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setDateRange(@Nullable Input<InsightFiltersProcessLaunchedAtDateRangeGetArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder setDateRange(@Nullable InsightFiltersProcessLaunchedAtDateRangeGetArgs dateRange) {
