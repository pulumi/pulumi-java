...
public class IdentityPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(IdentityPolicyArgs.Builder a);
    }
    private static io.pulumi.aws.ses.IdentityPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ses.IdentityPolicyArgs.builder();
     ...
     */
    public IdentityPolicy(String name, BuilderApplicator argsBuilder) {
