...
public class ResourcePolicy extends io.pulumi.resources.CustomResource {
    @OutputExport(name="enableHybrid", type=String.class, parameters={})
    ...
    private static io.pulumi.aws.glue.ResourcePolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.glue.ResourcePolicyArgs.builder();
