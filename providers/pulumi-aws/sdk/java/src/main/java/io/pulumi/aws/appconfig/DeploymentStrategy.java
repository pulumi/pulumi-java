...
public class DeploymentStrategy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(DeploymentStrategyArgs.Builder a);
    }
    private static io.pulumi.aws.appconfig.DeploymentStrategyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.appconfig.DeploymentStrategyArgs.builder();
     ...
     */
    public DeploymentStrategy(String name, BuilderApplicator argsBuilder) {
