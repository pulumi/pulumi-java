...
public class ClientCertificate extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.apigateway.ClientCertificateArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.apigateway.ClientCertificateArgs.builder();
