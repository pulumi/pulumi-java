...
public final class CustomLayerEbsVolumeArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public CustomLayerEbsVolumeArgs build() {
            return new CustomLayerEbsVolumeArgs(encrypted, iops, mountPoint, numberOfDisks, raidLevel, size, type);
        }
    }
}
