...
public class InstanceGroup extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(InstanceGroupArgs.Builder a);
    }
    private static io.pulumi.aws.emr.InstanceGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.emr.InstanceGroupArgs.builder();
