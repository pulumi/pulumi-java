...
public final class VirtualNodeState extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="spec")
      private final @Nullable Input<VirtualNodeSpecGetArgs> spec;

    public Input<VirtualNodeSpecGetArgs> getSpec() {
    ...
    public VirtualNodeState(
        ...
        @Nullable Input<VirtualNodeSpecGetArgs> spec,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<VirtualNodeSpecGetArgs> spec;
        ...
        public Builder setSpec(@Nullable Input<VirtualNodeSpecGetArgs> spec) {
            this.spec = spec;
            return this;
        }

        public Builder setSpec(@Nullable VirtualNodeSpecGetArgs spec) {
