...
public final class RuleGroupRuleStatementAndStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final RuleGroupRuleStatementAndStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs Empty = new RuleGroupRuleStatementAndStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs();
    ...
    public RuleGroupRuleStatementAndStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs(
    ...
    private RuleGroupRuleStatementAndStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs() {
    ...
    public static Builder builder(RuleGroupRuleStatementAndStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RuleGroupRuleStatementAndStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs defaults) {
        ...
        public Builder position(String position) {
            ...
            return this;
        }        public RuleGroupRuleStatementAndStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs build() {
            return new RuleGroupRuleStatementAndStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs(fallbackBehavior, headerName, position);
        }
    }
}
