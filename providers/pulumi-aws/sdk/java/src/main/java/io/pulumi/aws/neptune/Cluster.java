...
public class Cluster extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="enableCloudwatchLogsExports", type=List.class, parameters={String.class})
     ...
     * 
     */
    @OutputExport(name="neptuneClusterParameterGroupName", type=String.class, parameters={})
    ...
    public Cluster(String name, @Nullable ClusterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:neptune/cluster:Cluster", name, args == null ? ClusterArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
