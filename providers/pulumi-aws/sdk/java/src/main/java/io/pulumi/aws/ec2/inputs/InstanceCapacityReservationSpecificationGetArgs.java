...
public final class InstanceCapacityReservationSpecificationGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCapacityReservationTarget(@Nullable Input<InstanceCapacityReservationSpecificationCapacityReservationTargetGetArgs> capacityReservationTarget) {
            this.capacityReservationTarget = capacityReservationTarget;
            return this;
        }

        public Builder setCapacityReservationTarget(@Nullable InstanceCapacityReservationSpecificationCapacityReservationTargetGetArgs capacityReservationTarget) {
