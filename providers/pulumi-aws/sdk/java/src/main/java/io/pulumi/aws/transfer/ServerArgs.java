...
public final class ServerArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setEndpointDetails(@Nullable Input<ServerEndpointDetailsArgs> endpointDetails) {
            this.endpointDetails = endpointDetails;
            return this;
        }

        public Builder setEndpointDetails(@Nullable ServerEndpointDetailsArgs endpointDetails) {
