...
public class DelegatedAdministrator extends io.pulumi.resources.CustomResource {
    ...
    public DelegatedAdministrator(String name, DelegatedAdministratorArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:organizations/delegatedAdministrator:DelegatedAdministrator", name, args == null ? DelegatedAdministratorArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private DelegatedAdministrator(String name, Input<String> id, @Nullable DelegatedAdministratorState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static DelegatedAdministrator get(String name, Input<String> id, @Nullable DelegatedAdministratorState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
