...
public class OriginAccessIdentity extends io.pulumi.resources.CustomResource {
     ...
     */
    public static OriginAccessIdentity get(String name, Output<String> id, @Nullable OriginAccessIdentityState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
