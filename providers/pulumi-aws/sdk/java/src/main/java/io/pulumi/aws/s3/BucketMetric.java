...
public class BucketMetric extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(BucketMetricArgs.Builder a);
    }
    private static io.pulumi.aws.s3.BucketMetricArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.s3.BucketMetricArgs.builder();
     ...
     */
    public BucketMetric(String name, BuilderApplicator argsBuilder) {
