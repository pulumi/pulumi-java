...
public class IdentityPool extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(IdentityPoolArgs.Builder a);
    }
    private static io.pulumi.aws.cognito.IdentityPoolArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.cognito.IdentityPoolArgs.builder();
     ...
     */
    public IdentityPool(String name, BuilderApplicator argsBuilder) {
