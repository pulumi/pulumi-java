...
public final class WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs Empty = new WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs();
    ...
    public WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs(
    ...
    private WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs() {
    ...
    public static Builder builder(WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs defaults) {
        ...
        public WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs build() {
            return new WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs(fallbackBehavior, headerName, position);
        }
    }
}
