...
public class ManagedPolicyAttachment extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ManagedPolicyAttachmentArgs.Builder a);
    }
    private static io.pulumi.aws.ssoadmin.ManagedPolicyAttachmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ssoadmin.ManagedPolicyAttachmentArgs.builder();
     ...
     */
    public ManagedPolicyAttachment(String name, BuilderApplicator argsBuilder) {
