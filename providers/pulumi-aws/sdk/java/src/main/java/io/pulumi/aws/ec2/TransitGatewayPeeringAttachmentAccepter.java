...
public class TransitGatewayPeeringAttachmentAccepter extends io.pulumi.resources.CustomResource {
    ...
    public TransitGatewayPeeringAttachmentAccepter(String name, TransitGatewayPeeringAttachmentAccepterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/transitGatewayPeeringAttachmentAccepter:TransitGatewayPeeringAttachmentAccepter", name, args == null ? TransitGatewayPeeringAttachmentAccepterArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private TransitGatewayPeeringAttachmentAccepter(String name, Input<String> id, @Nullable TransitGatewayPeeringAttachmentAccepterState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TransitGatewayPeeringAttachmentAccepter get(String name, Input<String> id, @Nullable TransitGatewayPeeringAttachmentAccepterState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
