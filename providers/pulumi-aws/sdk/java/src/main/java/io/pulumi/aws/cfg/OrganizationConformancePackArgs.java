...
public final class OrganizationConformancePackArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setInputParameters(@Nullable Input<List<OrganizationConformancePackInputParameterArgs>> inputParameters) {
            this.inputParameters = inputParameters;
            return this;
        }

        public Builder setInputParameters(@Nullable List<OrganizationConformancePackInputParameterArgs> inputParameters) {
