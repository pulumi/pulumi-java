...
public final class PipelineArtifactStoreGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public PipelineArtifactStoreGetArgs(
        @Nullable Input<PipelineArtifactStoreEncryptionKeyGetArgs> encryptionKey,
    ...
    public static final class Builder {
        private @Nullable Input<PipelineArtifactStoreEncryptionKeyGetArgs> encryptionKey;
        ...
        public Builder setEncryptionKey(@Nullable Input<PipelineArtifactStoreEncryptionKeyGetArgs> encryptionKey) {
            this.encryptionKey = encryptionKey;
            return this;
        }

        public Builder setEncryptionKey(@Nullable PipelineArtifactStoreEncryptionKeyGetArgs encryptionKey) {
