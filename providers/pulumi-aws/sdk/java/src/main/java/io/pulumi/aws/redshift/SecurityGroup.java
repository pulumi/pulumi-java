...
public class SecurityGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.redshift.SecurityGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.redshift.SecurityGroupArgs.builder();
    ...
    public SecurityGroup(String name, SecurityGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:redshift/securityGroup:SecurityGroup", name, args == null ? SecurityGroupArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
