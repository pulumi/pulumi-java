...
public class LustreFileSystem extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(LustreFileSystemArgs.Builder a);
    }
    private static io.pulumi.aws.fsx.LustreFileSystemArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.fsx.LustreFileSystemArgs.builder();
     ...
     */
    public LustreFileSystem(String name, BuilderApplicator argsBuilder) {
