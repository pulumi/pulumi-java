...
public class ManagedPrefixListEntry extends io.pulumi.resources.CustomResource {
    ...
    public ManagedPrefixListEntry(String name, ManagedPrefixListEntryArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/managedPrefixListEntry:ManagedPrefixListEntry", name, args == null ? ManagedPrefixListEntryArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ManagedPrefixListEntry(String name, Input<String> id, @Nullable ManagedPrefixListEntryState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ManagedPrefixListEntry get(String name, Input<String> id, @Nullable ManagedPrefixListEntryState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
