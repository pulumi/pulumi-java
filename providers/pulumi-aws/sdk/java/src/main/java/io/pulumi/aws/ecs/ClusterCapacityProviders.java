...
public class ClusterCapacityProviders extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="defaultCapacityProviderStrategies", type=List.class, parameters={ClusterCapacityProvidersDefaultCapacityProviderStrategy.class})
    ...
    public interface BuilderApplicator {
        public void apply(ClusterCapacityProvidersArgs.Builder a);
    }
    private static io.pulumi.aws.ecs.ClusterCapacityProvidersArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ecs.ClusterCapacityProvidersArgs.builder();
     ...
     */
    public ClusterCapacityProviders(String name, BuilderApplicator argsBuilder) {
