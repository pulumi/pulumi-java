...
public final class RailsAppLayerEbsVolumeArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public RailsAppLayerEbsVolumeArgs build() {
            return new RailsAppLayerEbsVolumeArgs(encrypted, iops, mountPoint, numberOfDisks, raidLevel, size, type);
        }
    }
}
