...
public final class DeploymentGroupEc2TagSetGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public DeploymentGroupEc2TagSetGetArgs(@Nullable Input<List<DeploymentGroupEc2TagSetEc2TagFilterGetArgs>> ec2TagFilters) {
    ...
    public static final class Builder {
        private @Nullable Input<List<DeploymentGroupEc2TagSetEc2TagFilterGetArgs>> ec2TagFilters;
        ...
        public Builder setEc2TagFilters(@Nullable Input<List<DeploymentGroupEc2TagSetEc2TagFilterGetArgs>> ec2TagFilters) {
            this.ec2TagFilters = ec2TagFilters;
            return this;
        }

        public Builder setEc2TagFilters(@Nullable List<DeploymentGroupEc2TagSetEc2TagFilterGetArgs> ec2TagFilters) {
