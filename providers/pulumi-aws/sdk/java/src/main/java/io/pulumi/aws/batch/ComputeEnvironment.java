...
public class ComputeEnvironment extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="computeEnvironmentName", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="computeEnvironmentNamePrefix", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="computeResources", type=ComputeEnvironmentComputeResources.class, parameters={})
    ...
    public interface BuilderApplicator {
        public void apply(ComputeEnvironmentArgs.Builder a);
    }
    private static io.pulumi.aws.batch.ComputeEnvironmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.batch.ComputeEnvironmentArgs.builder();
     ...
     */
    public ComputeEnvironment(String name, BuilderApplicator argsBuilder) {
    ...
    public ComputeEnvironment(String name, ComputeEnvironmentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:batch/computeEnvironment:ComputeEnvironment", name, args == null ? ComputeEnvironmentArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ComputeEnvironment(String name, Input<String> id, @Nullable ComputeEnvironmentState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ComputeEnvironment get(String name, Input<String> id, @Nullable ComputeEnvironmentState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
