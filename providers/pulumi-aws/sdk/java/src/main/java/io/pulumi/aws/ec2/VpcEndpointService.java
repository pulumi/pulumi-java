...
public class VpcEndpointService extends io.pulumi.resources.CustomResource {
    ...
    public VpcEndpointService(String name, VpcEndpointServiceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/vpcEndpointService:VpcEndpointService", name, args == null ? VpcEndpointServiceArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private VpcEndpointService(String name, Input<String> id, @Nullable VpcEndpointServiceState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static VpcEndpointService get(String name, Input<String> id, @Nullable VpcEndpointServiceState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
