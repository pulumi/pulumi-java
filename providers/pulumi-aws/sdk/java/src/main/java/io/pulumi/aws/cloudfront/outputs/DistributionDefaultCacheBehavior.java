...
public final class DistributionDefaultCacheBehavior {
    ...
    private DistributionDefaultCacheBehavior(
        ...
        @Nullable DistributionDefaultCacheBehaviorForwardedValues forwardedValues,
        @Nullable List<DistributionDefaultCacheBehaviorFunctionAssociation> functionAssociations,
        @Nullable List<DistributionDefaultCacheBehaviorLambdaFunctionAssociation> lambdaFunctionAssociations,
    ...
    public static final class Builder {
        ...
        public Builder setForwardedValues(@Nullable DistributionDefaultCacheBehaviorForwardedValues forwardedValues) {
            this.forwardedValues = forwardedValues;
            return this;
        }

        public Builder setFunctionAssociations(@Nullable List<DistributionDefaultCacheBehaviorFunctionAssociation> functionAssociations) {
            this.functionAssociations = functionAssociations;
            return this;
        }

        public Builder setLambdaFunctionAssociations(@Nullable List<DistributionDefaultCacheBehaviorLambdaFunctionAssociation> lambdaFunctionAssociations) {
            this.lambdaFunctionAssociations = lambdaFunctionAssociations;
            return this;
        }
