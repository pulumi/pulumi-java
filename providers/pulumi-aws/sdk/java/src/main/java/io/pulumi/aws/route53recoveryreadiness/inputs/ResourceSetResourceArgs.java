...
public final class ResourceSetResourceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<ResourceSetResourceDnsTargetResourceArgs> dnsTargetResource;

    public Input<ResourceSetResourceDnsTargetResourceArgs> getDnsTargetResource() {
    ...
    public ResourceSetResourceArgs(
        ...
        @Nullable Input<ResourceSetResourceDnsTargetResourceArgs> dnsTargetResource,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<ResourceSetResourceDnsTargetResourceArgs> dnsTargetResource;
        ...
        public Builder setDnsTargetResource(@Nullable Input<ResourceSetResourceDnsTargetResourceArgs> dnsTargetResource) {
            this.dnsTargetResource = dnsTargetResource;
            return this;
        }

        public Builder setDnsTargetResource(@Nullable ResourceSetResourceDnsTargetResourceArgs dnsTargetResource) {
