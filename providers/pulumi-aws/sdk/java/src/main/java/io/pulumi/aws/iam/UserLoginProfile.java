...
public class UserLoginProfile extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="encryptedPassword", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="passwordLength", type=Integer.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="passwordResetRequired", type=Boolean.class, parameters={})
    ...
    public interface BuilderApplicator {
        public void apply(UserLoginProfileArgs.Builder a);
    }
    private static io.pulumi.aws.iam.UserLoginProfileArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.iam.UserLoginProfileArgs.builder();
     ...
     */
    public UserLoginProfile(String name, BuilderApplicator argsBuilder) {
