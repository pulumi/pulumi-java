...
public final class GangliaLayerEbsVolumeGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final GangliaLayerEbsVolumeGetArgs Empty = new GangliaLayerEbsVolumeGetArgs();
    ...
    private GangliaLayerEbsVolumeGetArgs() {
    ...
    public static Builder builder(GangliaLayerEbsVolumeGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GangliaLayerEbsVolumeGetArgs defaults) {
        ...
        public Builder type(@Nullable String type) {
            ...
            return this;
        }        public GangliaLayerEbsVolumeGetArgs build() {
            return new GangliaLayerEbsVolumeGetArgs(encrypted, iops, mountPoint, numberOfDisks, raidLevel, size, type);
        }
    }
}
