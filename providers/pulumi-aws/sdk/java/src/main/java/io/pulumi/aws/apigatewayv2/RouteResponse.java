...
public class RouteResponse extends io.pulumi.resources.CustomResource {
     ...
     */
    public static RouteResponse get(String name, Output<String> id, @Nullable RouteResponseState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
