...
public final class DomainClusterConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<DomainClusterConfigZoneAwarenessConfigArgs> zoneAwarenessConfig;

    public Input<DomainClusterConfigZoneAwarenessConfigArgs> getZoneAwarenessConfig() {
    ...
    public DomainClusterConfigArgs(
        ...
        @Nullable Input<DomainClusterConfigZoneAwarenessConfigArgs> zoneAwarenessConfig,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<DomainClusterConfigZoneAwarenessConfigArgs> zoneAwarenessConfig;
        ...
        public Builder setZoneAwarenessConfig(@Nullable Input<DomainClusterConfigZoneAwarenessConfigArgs> zoneAwarenessConfig) {
            this.zoneAwarenessConfig = zoneAwarenessConfig;
            return this;
        }

        public Builder setZoneAwarenessConfig(@Nullable DomainClusterConfigZoneAwarenessConfigArgs zoneAwarenessConfig) {
