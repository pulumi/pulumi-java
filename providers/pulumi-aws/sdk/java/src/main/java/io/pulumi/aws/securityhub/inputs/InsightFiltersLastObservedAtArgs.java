...
public final class InsightFiltersLastObservedAtArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<InsightFiltersLastObservedAtDateRangeArgs> dateRange;

    public Input<InsightFiltersLastObservedAtDateRangeArgs> getDateRange() {
    ...
    public InsightFiltersLastObservedAtArgs(
        @Nullable Input<InsightFiltersLastObservedAtDateRangeArgs> dateRange,
    ...
    public static final class Builder {
        private @Nullable Input<InsightFiltersLastObservedAtDateRangeArgs> dateRange;
        ...
        public Builder setDateRange(@Nullable Input<InsightFiltersLastObservedAtDateRangeArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder setDateRange(@Nullable InsightFiltersLastObservedAtDateRangeArgs dateRange) {
