...
public final class DistributionDefaultCacheBehaviorForwardedValuesArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCookies(Input<DistributionDefaultCacheBehaviorForwardedValuesCookiesArgs> cookies) {
            this.cookies = Objects.requireNonNull(cookies);
            return this;
        }

        public Builder setCookies(DistributionDefaultCacheBehaviorForwardedValuesCookiesArgs cookies) {
