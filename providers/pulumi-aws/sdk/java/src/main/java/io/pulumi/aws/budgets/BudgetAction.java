...
public class BudgetAction extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(BudgetActionArgs.Builder a);
    }
    private static io.pulumi.aws.budgets.BudgetActionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.budgets.BudgetActionArgs.builder();
     ...
     */
    public BudgetAction(String name, BuilderApplicator argsBuilder) {
