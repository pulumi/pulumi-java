...
public final class ScalingPlanScalingInstructionTargetTrackingConfigurationArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public ScalingPlanScalingInstructionTargetTrackingConfigurationArgs(
        @Nullable Input<ScalingPlanScalingInstructionTargetTrackingConfigurationCustomizedScalingMetricSpecificationArgs> customizedScalingMetricSpecification,
        @Nullable Input<Boolean> disableScaleIn,
        @Nullable Input<Integer> estimatedInstanceWarmup,
        @Nullable Input<ScalingPlanScalingInstructionTargetTrackingConfigurationPredefinedScalingMetricSpecificationArgs> predefinedScalingMetricSpecification,
    ...
    public static final class Builder {
        private @Nullable Input<ScalingPlanScalingInstructionTargetTrackingConfigurationCustomizedScalingMetricSpecificationArgs> customizedScalingMetricSpecification;
        private @Nullable Input<Boolean> disableScaleIn;
        private @Nullable Input<Integer> estimatedInstanceWarmup;
        private @Nullable Input<ScalingPlanScalingInstructionTargetTrackingConfigurationPredefinedScalingMetricSpecificationArgs> predefinedScalingMetricSpecification;
        ...
        public Builder setCustomizedScalingMetricSpecification(@Nullable Input<ScalingPlanScalingInstructionTargetTrackingConfigurationCustomizedScalingMetricSpecificationArgs> customizedScalingMetricSpecification) {
            this.customizedScalingMetricSpecification = customizedScalingMetricSpecification;
            return this;
        }

        public Builder setCustomizedScalingMetricSpecification(@Nullable ScalingPlanScalingInstructionTargetTrackingConfigurationCustomizedScalingMetricSpecificationArgs customizedScalingMetricSpecification) {
        ...
        public Builder setPredefinedScalingMetricSpecification(@Nullable Input<ScalingPlanScalingInstructionTargetTrackingConfigurationPredefinedScalingMetricSpecificationArgs> predefinedScalingMetricSpecification) {
            this.predefinedScalingMetricSpecification = predefinedScalingMetricSpecification;
            return this;
        }

        public Builder setPredefinedScalingMetricSpecification(@Nullable ScalingPlanScalingInstructionTargetTrackingConfigurationPredefinedScalingMetricSpecificationArgs predefinedScalingMetricSpecification) {
