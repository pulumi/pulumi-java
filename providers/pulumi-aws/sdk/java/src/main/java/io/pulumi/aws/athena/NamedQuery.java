...
public class NamedQuery extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.athena.NamedQueryArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.athena.NamedQueryArgs.builder();
