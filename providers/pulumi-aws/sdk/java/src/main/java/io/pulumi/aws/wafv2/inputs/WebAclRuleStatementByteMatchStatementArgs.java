...
public final class WebAclRuleStatementByteMatchStatementArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="textTransformations", required=true)
      private final Output<List<WebAclRuleStatementByteMatchStatementTextTransformationArgs>> textTransformations;

    public Output<List<WebAclRuleStatementByteMatchStatementTextTransformationArgs>> getTextTransformations() {
        return this.textTransformations;
    }

    public WebAclRuleStatementByteMatchStatementArgs(
        @Nullable Output<WebAclRuleStatementByteMatchStatementFieldToMatchArgs> fieldToMatch,
        Output<String> positionalConstraint,
        Output<String> searchString,
        Output<List<WebAclRuleStatementByteMatchStatementTextTransformationArgs>> textTransformations) {
