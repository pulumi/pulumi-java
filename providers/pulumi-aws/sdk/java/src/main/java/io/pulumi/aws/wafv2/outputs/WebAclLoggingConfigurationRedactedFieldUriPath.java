...
public final class WebAclLoggingConfigurationRedactedFieldUriPath {
    ...
    public static Builder builder(WebAclLoggingConfigurationRedactedFieldUriPath defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WebAclLoggingConfigurationRedactedFieldUriPath defaults) {
