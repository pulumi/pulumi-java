...
public final class GangliaLayerEbsVolumeArgs extends io.pulumi.resources.ResourceArgs {

    public static final GangliaLayerEbsVolumeArgs Empty = new GangliaLayerEbsVolumeArgs();
    ...
    private GangliaLayerEbsVolumeArgs() {
    ...
    public static Builder builder(GangliaLayerEbsVolumeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GangliaLayerEbsVolumeArgs defaults) {
        ...
        public Builder type(@Nullable String type) {
            ...
            return this;
        }        public GangliaLayerEbsVolumeArgs build() {
            return new GangliaLayerEbsVolumeArgs(encrypted, iops, mountPoint, numberOfDisks, raidLevel, size, type);
        }
    }
}
