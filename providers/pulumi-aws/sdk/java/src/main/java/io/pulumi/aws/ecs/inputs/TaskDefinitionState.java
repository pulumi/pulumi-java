...
public final class TaskDefinitionState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setContainerDefinitions(@Nullable Input<String> containerDefinitions) {
            this.containerDefinitions = containerDefinitions;
            return this;
        }

        public Builder setContainerDefinitions(@Nullable String containerDefinitions) {
        ...
        public Builder setEphemeralStorage(@Nullable Input<TaskDefinitionEphemeralStorageGetArgs> ephemeralStorage) {
            this.ephemeralStorage = ephemeralStorage;
            return this;
        }

        public Builder setEphemeralStorage(@Nullable TaskDefinitionEphemeralStorageGetArgs ephemeralStorage) {
        ...
        public Builder setInferenceAccelerators(@Nullable Input<List<TaskDefinitionInferenceAcceleratorGetArgs>> inferenceAccelerators) {
            this.inferenceAccelerators = inferenceAccelerators;
            return this;
        }

        public Builder setInferenceAccelerators(@Nullable List<TaskDefinitionInferenceAcceleratorGetArgs> inferenceAccelerators) {
        ...
        public Builder setPlacementConstraints(@Nullable Input<List<TaskDefinitionPlacementConstraintGetArgs>> placementConstraints) {
            this.placementConstraints = placementConstraints;
            return this;
        }

        public Builder setPlacementConstraints(@Nullable List<TaskDefinitionPlacementConstraintGetArgs> placementConstraints) {
            this.placementConstraints = Input.ofNullable(placementConstraints);
            return this;
        }

        public Builder setProxyConfiguration(@Nullable Input<TaskDefinitionProxyConfigurationGetArgs> proxyConfiguration) {
            this.proxyConfiguration = proxyConfiguration;
            return this;
        }

        public Builder setProxyConfiguration(@Nullable TaskDefinitionProxyConfigurationGetArgs proxyConfiguration) {
        ...
        public Builder setRuntimePlatform(@Nullable Input<TaskDefinitionRuntimePlatformGetArgs> runtimePlatform) {
            this.runtimePlatform = runtimePlatform;
            return this;
        }

        public Builder setRuntimePlatform(@Nullable TaskDefinitionRuntimePlatformGetArgs runtimePlatform) {
        ...
        public Builder setVolumes(@Nullable Input<List<TaskDefinitionVolumeGetArgs>> volumes) {
            this.volumes = volumes;
            return this;
        }

        public Builder setVolumes(@Nullable List<TaskDefinitionVolumeGetArgs> volumes) {
