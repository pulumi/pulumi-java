...
public class ApiCache extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ApiCacheArgs.Builder a);
    }
    private static io.pulumi.aws.appsync.ApiCacheArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.appsync.ApiCacheArgs.builder();
     ...
     */
    public ApiCache(String name, BuilderApplicator argsBuilder) {
