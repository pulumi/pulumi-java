...
public final class NetworkAclIngressGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final NetworkAclIngressGetArgs Empty = new NetworkAclIngressGetArgs();
    ...
    private NetworkAclIngressGetArgs() {
    ...
    public static Builder builder(NetworkAclIngressGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(NetworkAclIngressGetArgs defaults) {
        ...
        public NetworkAclIngressGetArgs build() {
            return new NetworkAclIngressGetArgs(action, cidrBlock, fromPort, icmpCode, icmpType, ipv6CidrBlock, protocol, ruleNo, toPort);
        }
    }
}
