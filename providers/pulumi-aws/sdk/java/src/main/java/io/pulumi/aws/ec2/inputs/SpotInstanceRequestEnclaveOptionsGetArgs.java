...
public final class SpotInstanceRequestEnclaveOptionsGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public SpotInstanceRequestEnclaveOptionsGetArgs(@Nullable Input<Boolean> enabled) {
