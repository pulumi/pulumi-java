...
public class Authorizer extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="tokenSigningPublicKeys", type=Map.class, parameters={String.class, String.class})
    ...
    public Authorizer(String name, AuthorizerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:iot/authorizer:Authorizer", name, args == null ? AuthorizerArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
