...
public class NetworkProfile extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(NetworkProfileArgs.Builder a);
    }
    private static io.pulumi.aws.devicefarm.NetworkProfileArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.devicefarm.NetworkProfileArgs.builder();
     ...
     */
    public NetworkProfile(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public static NetworkProfile get(String name, Output<String> id, @Nullable NetworkProfileState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
