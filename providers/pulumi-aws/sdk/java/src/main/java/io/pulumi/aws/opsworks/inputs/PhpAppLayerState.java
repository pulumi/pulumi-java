...
public final class PhpAppLayerState extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="cloudwatchConfiguration")
      private final @Nullable Output<PhpAppLayerCloudwatchConfigurationGetArgs> cloudwatchConfiguration;

    public Output<PhpAppLayerCloudwatchConfigurationGetArgs> getCloudwatchConfiguration() {
    ...
    @InputImport(name="ebsVolumes")
      private final @Nullable Output<List<PhpAppLayerEbsVolumeGetArgs>> ebsVolumes;

    public Output<List<PhpAppLayerEbsVolumeGetArgs>> getEbsVolumes() {
    ...
    public PhpAppLayerState(
        ...
        @Nullable Output<PhpAppLayerCloudwatchConfigurationGetArgs> cloudwatchConfiguration,
        ...
        @Nullable Output<List<PhpAppLayerEbsVolumeGetArgs>> ebsVolumes,
