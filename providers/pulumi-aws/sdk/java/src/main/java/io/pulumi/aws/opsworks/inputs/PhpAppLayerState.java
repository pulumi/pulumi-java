...
public final class PhpAppLayerState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCloudwatchConfiguration(@Nullable Input<PhpAppLayerCloudwatchConfigurationGetArgs> cloudwatchConfiguration) {
            this.cloudwatchConfiguration = cloudwatchConfiguration;
            return this;
        }

        public Builder setCloudwatchConfiguration(@Nullable PhpAppLayerCloudwatchConfigurationGetArgs cloudwatchConfiguration) {
        ...
        public Builder setEbsVolumes(@Nullable Input<List<PhpAppLayerEbsVolumeGetArgs>> ebsVolumes) {
            this.ebsVolumes = ebsVolumes;
            return this;
        }

        public Builder setEbsVolumes(@Nullable List<PhpAppLayerEbsVolumeGetArgs> ebsVolumes) {
