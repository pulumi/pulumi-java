...
public class EmailIdentity extends io.pulumi.resources.CustomResource {
    ...
    public EmailIdentity(String name, EmailIdentityArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ses/emailIdentity:EmailIdentity", name, args == null ? EmailIdentityArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private EmailIdentity(String name, Input<String> id, @Nullable EmailIdentityState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static EmailIdentity get(String name, Input<String> id, @Nullable EmailIdentityState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
