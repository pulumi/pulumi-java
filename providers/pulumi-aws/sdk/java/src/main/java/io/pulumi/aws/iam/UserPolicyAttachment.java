...
public class UserPolicyAttachment extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(UserPolicyAttachmentArgs.Builder a);
    }
    private static io.pulumi.aws.iam.UserPolicyAttachmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.iam.UserPolicyAttachmentArgs.builder();
     ...
     */
    public UserPolicyAttachment(String name, BuilderApplicator argsBuilder) {
