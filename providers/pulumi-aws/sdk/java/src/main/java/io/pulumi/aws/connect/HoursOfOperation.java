...
public class HoursOfOperation extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.connect.HoursOfOperationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.connect.HoursOfOperationArgs.builder();
    ...
    public HoursOfOperation(String name, HoursOfOperationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:connect/hoursOfOperation:HoursOfOperation", name, args == null ? HoursOfOperationArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private HoursOfOperation(String name, Input<String> id, @Nullable HoursOfOperationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static HoursOfOperation get(String name, Input<String> id, @Nullable HoursOfOperationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
