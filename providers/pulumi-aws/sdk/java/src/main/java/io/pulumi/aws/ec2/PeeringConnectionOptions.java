...
public class PeeringConnectionOptions extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PeeringConnectionOptionsArgs.Builder a);
    }
    private static io.pulumi.aws.ec2.PeeringConnectionOptionsArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2.PeeringConnectionOptionsArgs.builder();
     ...
     */
    public PeeringConnectionOptions(String name, BuilderApplicator argsBuilder) {
