...
public class QuickConnect extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.connect.QuickConnectArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.connect.QuickConnectArgs.builder();
    ...
    public QuickConnect(String name, QuickConnectArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:connect/quickConnect:QuickConnect", name, args == null ? QuickConnectArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private QuickConnect(String name, Input<String> id, @Nullable QuickConnectState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static QuickConnect get(String name, Input<String> id, @Nullable QuickConnectState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
