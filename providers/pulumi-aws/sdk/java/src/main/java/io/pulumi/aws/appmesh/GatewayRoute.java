...
public class GatewayRoute extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="spec", type=GatewayRouteSpec.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="virtualGatewayName", type=String.class, parameters={})
    ...
    public interface BuilderApplicator {
        public void apply(GatewayRouteArgs.Builder a);
    }
    private static io.pulumi.aws.appmesh.GatewayRouteArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.appmesh.GatewayRouteArgs.builder();
     ...
     */
    public GatewayRoute(String name, BuilderApplicator argsBuilder) {
    ...
    public GatewayRoute(String name, GatewayRouteArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:appmesh/gatewayRoute:GatewayRoute", name, args == null ? GatewayRouteArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private GatewayRoute(String name, Input<String> id, @Nullable GatewayRouteState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static GatewayRoute get(String name, Input<String> id, @Nullable GatewayRouteState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
