...
public class Studio extends io.pulumi.resources.CustomResource {
    ...
    public Studio(String name, StudioArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:emr/studio:Studio", name, args == null ? StudioArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private Studio(String name, Output<String> id, @Nullable StudioState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Studio get(String name, Output<String> id, @Nullable StudioState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
