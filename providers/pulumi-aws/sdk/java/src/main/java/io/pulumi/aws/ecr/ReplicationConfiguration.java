...
public class ReplicationConfiguration extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable ReplicationConfigurationArgs.Builder a);
    }
    private static io.pulumi.aws.ecr.ReplicationConfigurationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ecr.ReplicationConfigurationArgs.builder();
     ...
     */
    public ReplicationConfiguration(String name, BuilderApplicator argsBuilder) {
