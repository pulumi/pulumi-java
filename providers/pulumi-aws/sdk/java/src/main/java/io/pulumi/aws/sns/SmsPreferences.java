...
public class SmsPreferences extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="defaultSenderId", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="defaultSmsType", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="deliveryStatusIamRoleArn", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="deliveryStatusSuccessSamplingRate", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="monthlySpendLimit", type=Integer.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="usageReportS3Bucket", type=String.class, parameters={})
    ...
    public SmsPreferences(String name, @Nullable SmsPreferencesArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:sns/smsPreferences:SmsPreferences", name, args == null ? SmsPreferencesArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private SmsPreferences(String name, Input<String> id, @Nullable SmsPreferencesState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SmsPreferences get(String name, Input<String> id, @Nullable SmsPreferencesState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
