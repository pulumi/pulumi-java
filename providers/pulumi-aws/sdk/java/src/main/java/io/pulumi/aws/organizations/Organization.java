...
public class Organization extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable OrganizationArgs.Builder a);
    }
    private static io.pulumi.aws.organizations.OrganizationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.organizations.OrganizationArgs.builder();
