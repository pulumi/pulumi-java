...
public final class LifecyclePolicyPolicyDetailsScheduleArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCreateRule(Input<LifecyclePolicyPolicyDetailsScheduleCreateRuleArgs> createRule) {
            this.createRule = Objects.requireNonNull(createRule);
            return this;
        }

        public Builder setCreateRule(LifecyclePolicyPolicyDetailsScheduleCreateRuleArgs createRule) {
            this.createRule = Input.of(Objects.requireNonNull(createRule));
            return this;
        }

        public Builder setCrossRegionCopyRules(@Nullable Input<List<LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleArgs>> crossRegionCopyRules) {
            this.crossRegionCopyRules = crossRegionCopyRules;
            return this;
        }

        public Builder setCrossRegionCopyRules(@Nullable List<LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleArgs> crossRegionCopyRules) {
        ...
        public Builder setRetainRule(Input<LifecyclePolicyPolicyDetailsScheduleRetainRuleArgs> retainRule) {
            this.retainRule = Objects.requireNonNull(retainRule);
            return this;
        }

        public Builder setRetainRule(LifecyclePolicyPolicyDetailsScheduleRetainRuleArgs retainRule) {
