...
public final class RouteSpecHttpRouteMatchHeaderArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setMatch(@Nullable Input<RouteSpecHttpRouteMatchHeaderMatchArgs> match) {
            this.match = match;
            return this;
        }

        public Builder setMatch(@Nullable RouteSpecHttpRouteMatchHeaderMatchArgs match) {
