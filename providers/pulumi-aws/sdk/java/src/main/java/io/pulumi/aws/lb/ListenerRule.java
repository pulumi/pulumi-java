...
import io.pulumi.aws.lb.ListenerRuleArgs;
import io.pulumi.aws.lb.inputs.ListenerRuleState;
...
public class ListenerRule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.lb.ListenerRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.lb.ListenerRuleArgs.builder();
