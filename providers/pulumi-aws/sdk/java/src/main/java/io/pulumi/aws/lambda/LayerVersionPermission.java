...
public class LayerVersionPermission extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(LayerVersionPermissionArgs.Builder a);
    }
    private static io.pulumi.aws.lambda.LayerVersionPermissionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.lambda.LayerVersionPermissionArgs.builder();
     ...
     */
    public LayerVersionPermission(String name, BuilderApplicator argsBuilder) {
