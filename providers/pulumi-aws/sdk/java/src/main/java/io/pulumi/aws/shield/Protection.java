...
public class Protection extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ProtectionArgs.Builder a);
    }
    private static io.pulumi.aws.shield.ProtectionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.shield.ProtectionArgs.builder();
     ...
     */
    public Protection(String name, BuilderApplicator argsBuilder) {
