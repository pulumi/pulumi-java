...
public class VpnGatewayAttachment extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(VpnGatewayAttachmentArgs.Builder a);
    }
    private static io.pulumi.aws.ec2.VpnGatewayAttachmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2.VpnGatewayAttachmentArgs.builder();
     ...
     */
    public VpnGatewayAttachment(String name, BuilderApplicator argsBuilder) {
