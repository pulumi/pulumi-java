...
public class ApnsSandboxChannel extends io.pulumi.resources.CustomResource {
    ...
    public ApnsSandboxChannel(String name, ApnsSandboxChannelArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:pinpoint/apnsSandboxChannel:ApnsSandboxChannel", name, args == null ? ApnsSandboxChannelArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ApnsSandboxChannel(String name, Input<String> id, @Nullable ApnsSandboxChannelState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ApnsSandboxChannel get(String name, Input<String> id, @Nullable ApnsSandboxChannelState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
