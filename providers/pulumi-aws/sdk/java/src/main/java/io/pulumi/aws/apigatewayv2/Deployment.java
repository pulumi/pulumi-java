...
public class Deployment extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="autoDeployed", type=Boolean.class, parameters={})
    ...
    public Deployment(String name, DeploymentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:apigatewayv2/deployment:Deployment", name, args == null ? DeploymentArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
