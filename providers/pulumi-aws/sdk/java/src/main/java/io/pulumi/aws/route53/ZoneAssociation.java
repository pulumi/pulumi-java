...
public class ZoneAssociation extends io.pulumi.resources.CustomResource {
    ...
    public ZoneAssociation(String name, ZoneAssociationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:route53/zoneAssociation:ZoneAssociation", name, args == null ? ZoneAssociationArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ZoneAssociation(String name, Input<String> id, @Nullable ZoneAssociationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ZoneAssociation get(String name, Input<String> id, @Nullable ZoneAssociationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
