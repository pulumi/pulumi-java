...
public class EventBus extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="eventSourceName", type=String.class, parameters={})
     ...
     * 
     */
    public Output</* @Nullable */ String> getEventSourceName() {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable EventBusArgs.Builder a);
    }
    private static io.pulumi.aws.cloudwatch.EventBusArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.cloudwatch.EventBusArgs.builder();
     ...
     */
    public EventBus(String name, BuilderApplicator argsBuilder) {
