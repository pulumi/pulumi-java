...
public final class NetworkAclIngressArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public NetworkAclIngressArgs build() {
            return new NetworkAclIngressArgs(action, cidrBlock, fromPort, icmpCode, icmpType, ipv6CidrBlock, protocol, ruleNo, toPort);
        }
    }
}
