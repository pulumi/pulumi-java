...
public class VolumeAttachment extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="forceDetach", type=Boolean.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="stopInstanceBeforeDetaching", type=Boolean.class, parameters={})
    ...
    public VolumeAttachment(String name, VolumeAttachmentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/volumeAttachment:VolumeAttachment", name, args == null ? VolumeAttachmentArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private VolumeAttachment(String name, Input<String> id, @Nullable VolumeAttachmentState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static VolumeAttachment get(String name, Input<String> id, @Nullable VolumeAttachmentState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
