...
public class WebAclLoggingConfiguration extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(WebAclLoggingConfigurationArgs.Builder a);
    }
    private static io.pulumi.aws.wafv2.WebAclLoggingConfigurationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.wafv2.WebAclLoggingConfigurationArgs.builder();
     ...
     */
    public WebAclLoggingConfiguration(String name, BuilderApplicator argsBuilder) {
