...
public final class InsightFiltersCreatedAtGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setDateRange(@Nullable Input<InsightFiltersCreatedAtDateRangeGetArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder setDateRange(@Nullable InsightFiltersCreatedAtDateRangeGetArgs dateRange) {
