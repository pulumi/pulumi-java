...
public final class RuleGroupRuleStatementSizeConstraintStatementGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<RuleGroupRuleStatementSizeConstraintStatementFieldToMatchGetArgs> fieldToMatch;

    public Input<RuleGroupRuleStatementSizeConstraintStatementFieldToMatchGetArgs> getFieldToMatch() {
    ...
    private final Input<List<RuleGroupRuleStatementSizeConstraintStatementTextTransformationGetArgs>> textTransformations;

    public Input<List<RuleGroupRuleStatementSizeConstraintStatementTextTransformationGetArgs>> getTextTransformations() {
        return this.textTransformations;
    }

    public RuleGroupRuleStatementSizeConstraintStatementGetArgs(
        Input<String> comparisonOperator,
        @Nullable Input<RuleGroupRuleStatementSizeConstraintStatementFieldToMatchGetArgs> fieldToMatch,
        Input<Integer> size,
        Input<List<RuleGroupRuleStatementSizeConstraintStatementTextTransformationGetArgs>> textTransformations) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<RuleGroupRuleStatementSizeConstraintStatementFieldToMatchGetArgs> fieldToMatch;
        private Input<Integer> size;
        private Input<List<RuleGroupRuleStatementSizeConstraintStatementTextTransformationGetArgs>> textTransformations;
        ...
        public Builder setFieldToMatch(@Nullable Input<RuleGroupRuleStatementSizeConstraintStatementFieldToMatchGetArgs> fieldToMatch) {
            this.fieldToMatch = fieldToMatch;
            return this;
        }

        public Builder setFieldToMatch(@Nullable RuleGroupRuleStatementSizeConstraintStatementFieldToMatchGetArgs fieldToMatch) {
        ...
        public Builder setTextTransformations(Input<List<RuleGroupRuleStatementSizeConstraintStatementTextTransformationGetArgs>> textTransformations) {
            this.textTransformations = Objects.requireNonNull(textTransformations);
            return this;
        }

        public Builder setTextTransformations(List<RuleGroupRuleStatementSizeConstraintStatementTextTransformationGetArgs> textTransformations) {
