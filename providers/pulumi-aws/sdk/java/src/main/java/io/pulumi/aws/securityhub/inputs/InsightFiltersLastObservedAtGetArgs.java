...
public final class InsightFiltersLastObservedAtGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder dateRange(@Nullable Input<InsightFiltersLastObservedAtDateRangeGetArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder dateRange(@Nullable InsightFiltersLastObservedAtDateRangeGetArgs dateRange) {
