...
import io.pulumi.aws.securityhub.inputs.InsightFiltersLastObservedAtDateRangeGetArgs;
...
public final class InsightFiltersLastObservedAtGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<InsightFiltersLastObservedAtDateRangeGetArgs> dateRange;

    public Input<InsightFiltersLastObservedAtDateRangeGetArgs> getDateRange() {
    ...
    public InsightFiltersLastObservedAtGetArgs(
        @Nullable Input<InsightFiltersLastObservedAtDateRangeGetArgs> dateRange,
    ...
    public static final class Builder {
        private @Nullable Input<InsightFiltersLastObservedAtDateRangeGetArgs> dateRange;
        ...
        public Builder setDateRange(@Nullable Input<InsightFiltersLastObservedAtDateRangeGetArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder setDateRange(@Nullable InsightFiltersLastObservedAtDateRangeGetArgs dateRange) {
        ...
        public InsightFiltersLastObservedAtGetArgs build() {
            return new InsightFiltersLastObservedAtGetArgs(dateRange, end, start);
        }
    }
}
