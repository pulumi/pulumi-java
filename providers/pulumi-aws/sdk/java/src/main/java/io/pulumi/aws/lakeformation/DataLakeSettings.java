...
public class DataLakeSettings extends io.pulumi.resources.CustomResource {
    ...
    public DataLakeSettings(String name, @Nullable DataLakeSettingsArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:lakeformation/dataLakeSettings:DataLakeSettings", name, args == null ? DataLakeSettingsArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private DataLakeSettings(String name, Input<String> id, @Nullable DataLakeSettingsState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static DataLakeSettings get(String name, Input<String> id, @Nullable DataLakeSettingsState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
