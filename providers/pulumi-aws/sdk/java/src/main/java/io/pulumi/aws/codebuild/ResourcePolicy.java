...
public class ResourcePolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.codebuild.ResourcePolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.codebuild.ResourcePolicyArgs.builder();
