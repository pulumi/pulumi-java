...
public class Eip extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable EipArgs.Builder a);
    }
    private static io.pulumi.aws.ec2.EipArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2.EipArgs.builder();
     ...
     */
    public Eip(String name, BuilderApplicator argsBuilder) {
