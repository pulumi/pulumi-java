...
import io.pulumi.aws.cloudhsmv2.ClusterArgs;
...
public class Cluster extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.cloudhsmv2.ClusterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.cloudhsmv2.ClusterArgs.builder();
    ...
    public Cluster(String name, ClusterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:cloudhsmv2/cluster:Cluster", name, args == null ? ClusterArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
