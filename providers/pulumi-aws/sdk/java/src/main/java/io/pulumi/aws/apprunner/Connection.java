...
public class Connection extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.apprunner.ConnectionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.apprunner.ConnectionArgs.builder();
    ...
    public Connection(String name, ConnectionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:apprunner/connection:Connection", name, args == null ? ConnectionArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
