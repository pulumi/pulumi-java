...
import io.pulumi.aws.emr.inputs.ClusterMasterInstanceFleetInstanceTypeConfigGetArgs;
import io.pulumi.aws.emr.inputs.ClusterMasterInstanceFleetLaunchSpecificationsGetArgs;
...
public final class ClusterMasterInstanceFleetGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="instanceTypeConfigs")
      private final @Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigGetArgs>> instanceTypeConfigs;

    public Input<List<ClusterMasterInstanceFleetInstanceTypeConfigGetArgs>> getInstanceTypeConfigs() {
    ...
    @InputImport(name="launchSpecifications")
      private final @Nullable Input<ClusterMasterInstanceFleetLaunchSpecificationsGetArgs> launchSpecifications;

    public Input<ClusterMasterInstanceFleetLaunchSpecificationsGetArgs> getLaunchSpecifications() {
    ...
    public ClusterMasterInstanceFleetGetArgs(
        ...
        @Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigGetArgs>> instanceTypeConfigs,
        @Nullable Input<ClusterMasterInstanceFleetLaunchSpecificationsGetArgs> launchSpecifications,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigGetArgs>> instanceTypeConfigs;
        private @Nullable Input<ClusterMasterInstanceFleetLaunchSpecificationsGetArgs> launchSpecifications;
        ...
        public Builder setInstanceTypeConfigs(@Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigGetArgs>> instanceTypeConfigs) {
            this.instanceTypeConfigs = instanceTypeConfigs;
            return this;
        }

        public Builder setInstanceTypeConfigs(@Nullable List<ClusterMasterInstanceFleetInstanceTypeConfigGetArgs> instanceTypeConfigs) {
            this.instanceTypeConfigs = Input.ofNullable(instanceTypeConfigs);
            return this;
        }

        public Builder setLaunchSpecifications(@Nullable Input<ClusterMasterInstanceFleetLaunchSpecificationsGetArgs> launchSpecifications) {
            this.launchSpecifications = launchSpecifications;
            return this;
        }

        public Builder setLaunchSpecifications(@Nullable ClusterMasterInstanceFleetLaunchSpecificationsGetArgs launchSpecifications) {
