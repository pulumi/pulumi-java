...
public final class FirehoseDeliveryStreamExtendedS3ConfigurationArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public FirehoseDeliveryStreamExtendedS3ConfigurationArgs(
        ...
        @Nullable Output<FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptionsArgs> cloudwatchLoggingOptions,
        @Nullable Output<String> compressionFormat,
        @Nullable Output<FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationArgs> dataFormatConversionConfiguration,
        @Nullable Output<FirehoseDeliveryStreamExtendedS3ConfigurationDynamicPartitioningConfigurationArgs> dynamicPartitioningConfiguration,
        @Nullable Output<String> errorOutputPrefix,
        @Nullable Output<String> kmsKeyArn,
        @Nullable Output<String> prefix,
        @Nullable Output<FirehoseDeliveryStreamExtendedS3ConfigurationProcessingConfigurationArgs> processingConfiguration,
        Output<String> roleArn,
        @Nullable Output<FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfigurationArgs> s3BackupConfiguration,
