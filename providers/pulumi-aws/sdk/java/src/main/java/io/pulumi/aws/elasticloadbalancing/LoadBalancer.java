...
import io.pulumi.aws.elasticloadbalancing.LoadBalancerArgs;
import io.pulumi.aws.elasticloadbalancing.inputs.LoadBalancerState;
import io.pulumi.aws.elasticloadbalancing.outputs.LoadBalancerAccessLogs;
import io.pulumi.aws.elasticloadbalancing.outputs.LoadBalancerHealthCheck;
import io.pulumi.aws.elasticloadbalancing.outputs.LoadBalancerListener;
...
public class LoadBalancer extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.elasticloadbalancing.LoadBalancerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.elasticloadbalancing.LoadBalancerArgs.builder();
    ...
    public LoadBalancer(String name, LoadBalancerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:elasticloadbalancing/loadBalancer:LoadBalancer", name, args == null ? LoadBalancerArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
