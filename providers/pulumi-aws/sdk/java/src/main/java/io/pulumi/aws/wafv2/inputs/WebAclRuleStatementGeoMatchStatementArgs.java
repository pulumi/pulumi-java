...
public final class WebAclRuleStatementGeoMatchStatementArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="forwardedIpConfig")
      private final @Nullable Input<WebAclRuleStatementGeoMatchStatementForwardedIpConfigArgs> forwardedIpConfig;

    public Input<WebAclRuleStatementGeoMatchStatementForwardedIpConfigArgs> getForwardedIpConfig() {
    ...
    public WebAclRuleStatementGeoMatchStatementArgs(
        ...
        @Nullable Input<WebAclRuleStatementGeoMatchStatementForwardedIpConfigArgs> forwardedIpConfig) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<WebAclRuleStatementGeoMatchStatementForwardedIpConfigArgs> forwardedIpConfig;
        ...
        public Builder setForwardedIpConfig(@Nullable Input<WebAclRuleStatementGeoMatchStatementForwardedIpConfigArgs> forwardedIpConfig) {
            this.forwardedIpConfig = forwardedIpConfig;
            return this;
        }

        public Builder setForwardedIpConfig(@Nullable WebAclRuleStatementGeoMatchStatementForwardedIpConfigArgs forwardedIpConfig) {
