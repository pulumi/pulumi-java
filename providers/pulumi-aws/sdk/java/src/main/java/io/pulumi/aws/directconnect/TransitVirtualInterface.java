...
public class TransitVirtualInterface extends io.pulumi.resources.CustomResource {
    ...
    public TransitVirtualInterface(String name, TransitVirtualInterfaceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:directconnect/transitVirtualInterface:TransitVirtualInterface", name, args == null ? TransitVirtualInterfaceArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private TransitVirtualInterface(String name, Input<String> id, @Nullable TransitVirtualInterfaceState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TransitVirtualInterface get(String name, Input<String> id, @Nullable TransitVirtualInterfaceState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
