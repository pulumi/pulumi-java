...
public final class ClusterCoreInstanceFleetInstanceTypeConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<List<ClusterCoreInstanceFleetInstanceTypeConfigConfigurationArgs>> configurations;

    public Input<List<ClusterCoreInstanceFleetInstanceTypeConfigConfigurationArgs>> getConfigurations() {
    ...
    private final @Nullable Input<List<ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs>> ebsConfigs;

    public Input<List<ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs>> getEbsConfigs() {
    ...
    public ClusterCoreInstanceFleetInstanceTypeConfigArgs(
        ...
        @Nullable Input<List<ClusterCoreInstanceFleetInstanceTypeConfigConfigurationArgs>> configurations,
        @Nullable Input<List<ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs>> ebsConfigs,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<ClusterCoreInstanceFleetInstanceTypeConfigConfigurationArgs>> configurations;
        private @Nullable Input<List<ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs>> ebsConfigs;
        ...
        public Builder setConfigurations(@Nullable Input<List<ClusterCoreInstanceFleetInstanceTypeConfigConfigurationArgs>> configurations) {
            this.configurations = configurations;
            return this;
        }

        public Builder setConfigurations(@Nullable List<ClusterCoreInstanceFleetInstanceTypeConfigConfigurationArgs> configurations) {
            this.configurations = Input.ofNullable(configurations);
            return this;
        }

        public Builder setEbsConfigs(@Nullable Input<List<ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs>> ebsConfigs) {
            this.ebsConfigs = ebsConfigs;
            return this;
        }

        public Builder setEbsConfigs(@Nullable List<ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs> ebsConfigs) {
