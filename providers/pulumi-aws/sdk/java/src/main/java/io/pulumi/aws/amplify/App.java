...
public class App extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="autoBranchCreationPatterns", type=List.class, parameters={String.class})
     ...
     * 
     */
    @OutputExport(name="enableAutoBranchCreation", type=Boolean.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="enableBranchAutoBuild", type=Boolean.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="iamServiceRoleArn", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="productionBranches", type=List.class, parameters={AppProductionBranch.class})
    ...
    private static io.pulumi.aws.amplify.AppArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.amplify.AppArgs.builder();
    ...
    public App(String name, @Nullable AppArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:amplify/app:App", name, args == null ? AppArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
