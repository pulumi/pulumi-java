...
public class UserPoolUICustomization extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(UserPoolUICustomizationArgs.Builder a);
    }
    private static io.pulumi.aws.cognito.UserPoolUICustomizationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.cognito.UserPoolUICustomizationArgs.builder();
     ...
     */
    public UserPoolUICustomization(String name, BuilderApplicator argsBuilder) {
