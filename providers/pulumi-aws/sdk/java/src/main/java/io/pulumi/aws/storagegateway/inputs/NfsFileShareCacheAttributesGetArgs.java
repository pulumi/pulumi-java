...
public final class NfsFileShareCacheAttributesGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public NfsFileShareCacheAttributesGetArgs(@Nullable Input<Integer> cacheStaleTimeoutInSeconds) {
