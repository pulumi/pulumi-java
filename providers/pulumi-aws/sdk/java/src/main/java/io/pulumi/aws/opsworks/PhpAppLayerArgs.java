...
public final class PhpAppLayerArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Output<PhpAppLayerCloudwatchConfigurationArgs> cloudwatchConfiguration() {
    ...
    public Output<List<PhpAppLayerEbsVolumeArgs>> ebsVolumes() {
    ...
    public PhpAppLayerArgs(
        ...
        @Nullable Output<PhpAppLayerCloudwatchConfigurationArgs> cloudwatchConfiguration,
        ...
        @Nullable Output<List<PhpAppLayerEbsVolumeArgs>> ebsVolumes,
