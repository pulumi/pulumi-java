...
@OutputCustomType
public final class MemcachedLayerCloudwatchConfigurationLogStream {
    ...
    private MemcachedLayerCloudwatchConfigurationLogStream(
    ...
    public static Builder builder(MemcachedLayerCloudwatchConfigurationLogStream defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(MemcachedLayerCloudwatchConfigurationLogStream defaults) {
