...
public final class InsightFiltersRelatedFindingsProductArn {
    ...
    private InsightFiltersRelatedFindingsProductArn(
        String comparison,
        String value) {
    ...
    public static Builder builder(InsightFiltersRelatedFindingsProductArn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(InsightFiltersRelatedFindingsProductArn defaults) {
