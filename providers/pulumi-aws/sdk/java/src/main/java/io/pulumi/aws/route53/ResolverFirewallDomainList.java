...
public class ResolverFirewallDomainList extends io.pulumi.resources.CustomResource {
    ...
    public ResolverFirewallDomainList(String name, @Nullable ResolverFirewallDomainListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:route53/resolverFirewallDomainList:ResolverFirewallDomainList", name, args == null ? ResolverFirewallDomainListArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ResolverFirewallDomainList(String name, Input<String> id, @Nullable ResolverFirewallDomainListState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ResolverFirewallDomainList get(String name, Input<String> id, @Nullable ResolverFirewallDomainListState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
