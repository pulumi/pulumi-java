...
public class TargetGroupAttachment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.lb.TargetGroupAttachmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.lb.TargetGroupAttachmentArgs.builder();
