...
public final class ClusterMasterInstanceFleetInstanceTypeConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="configurations")
      private final @Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigConfigurationArgs>> configurations;

    public Input<List<ClusterMasterInstanceFleetInstanceTypeConfigConfigurationArgs>> getConfigurations() {
    ...
    @InputImport(name="ebsConfigs")
      private final @Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigEbsConfigArgs>> ebsConfigs;

    public Input<List<ClusterMasterInstanceFleetInstanceTypeConfigEbsConfigArgs>> getEbsConfigs() {
    ...
    public ClusterMasterInstanceFleetInstanceTypeConfigArgs(
        ...
        @Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigConfigurationArgs>> configurations,
        @Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigEbsConfigArgs>> ebsConfigs,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigConfigurationArgs>> configurations;
        private @Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigEbsConfigArgs>> ebsConfigs;
        ...
        public Builder setConfigurations(@Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigConfigurationArgs>> configurations) {
            this.configurations = configurations;
            return this;
        }

        public Builder setConfigurations(@Nullable List<ClusterMasterInstanceFleetInstanceTypeConfigConfigurationArgs> configurations) {
            this.configurations = Input.ofNullable(configurations);
            return this;
        }

        public Builder setEbsConfigs(@Nullable Input<List<ClusterMasterInstanceFleetInstanceTypeConfigEbsConfigArgs>> ebsConfigs) {
            this.ebsConfigs = ebsConfigs;
            return this;
        }

        public Builder setEbsConfigs(@Nullable List<ClusterMasterInstanceFleetInstanceTypeConfigEbsConfigArgs> ebsConfigs) {
