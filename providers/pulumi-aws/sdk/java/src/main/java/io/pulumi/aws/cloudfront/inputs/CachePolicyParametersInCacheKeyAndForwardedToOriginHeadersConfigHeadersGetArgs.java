...
public final class CachePolicyParametersInCacheKeyAndForwardedToOriginHeadersConfigHeadersGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public CachePolicyParametersInCacheKeyAndForwardedToOriginHeadersConfigHeadersGetArgs(@Nullable Input<List<String>> items) {
        this.items = items;
    }
