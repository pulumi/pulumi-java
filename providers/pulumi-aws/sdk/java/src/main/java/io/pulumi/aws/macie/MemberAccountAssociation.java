...
public class MemberAccountAssociation extends io.pulumi.resources.CustomResource {
    ...
    public MemberAccountAssociation(String name, MemberAccountAssociationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:macie/memberAccountAssociation:MemberAccountAssociation", name, args == null ? MemberAccountAssociationArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private MemberAccountAssociation(String name, Input<String> id, @Nullable MemberAccountAssociationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static MemberAccountAssociation get(String name, Input<String> id, @Nullable MemberAccountAssociationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
