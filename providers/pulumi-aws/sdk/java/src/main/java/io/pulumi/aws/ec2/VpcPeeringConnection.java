...
public class VpcPeeringConnection extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="acceptStatus", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="accepter", type=VpcPeeringConnectionAccepter.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="peerOwnerId", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="requester", type=VpcPeeringConnectionRequester.class, parameters={})
    ...
    public VpcPeeringConnection(String name, VpcPeeringConnectionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/vpcPeeringConnection:VpcPeeringConnection", name, args == null ? VpcPeeringConnectionArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private VpcPeeringConnection(String name, Input<String> id, @Nullable VpcPeeringConnectionState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static VpcPeeringConnection get(String name, Input<String> id, @Nullable VpcPeeringConnectionState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
