...
public class IntegrationResponse extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="integrationId", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="integrationResponseKey", type=String.class, parameters={})
    ...
    private static io.pulumi.aws.apigatewayv2.IntegrationResponseArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.apigatewayv2.IntegrationResponseArgs.builder();
    ...
    public IntegrationResponse(String name, IntegrationResponseArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:apigatewayv2/integrationResponse:IntegrationResponse", name, args == null ? IntegrationResponseArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
