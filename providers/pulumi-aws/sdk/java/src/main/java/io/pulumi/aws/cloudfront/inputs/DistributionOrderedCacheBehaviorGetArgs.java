...
import io.pulumi.aws.cloudfront.inputs.DistributionOrderedCacheBehaviorForwardedValuesGetArgs;
...
public final class DistributionOrderedCacheBehaviorGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="forwardedValues")
      private final @Nullable Input<DistributionOrderedCacheBehaviorForwardedValuesGetArgs> forwardedValues;

    public Input<DistributionOrderedCacheBehaviorForwardedValuesGetArgs> getForwardedValues() {
    ...
    @InputImport(name="functionAssociations")
      private final @Nullable Input<List<DistributionOrderedCacheBehaviorFunctionAssociationGetArgs>> functionAssociations;

    public Input<List<DistributionOrderedCacheBehaviorFunctionAssociationGetArgs>> getFunctionAssociations() {
    ...
    @InputImport(name="lambdaFunctionAssociations")
      private final @Nullable Input<List<DistributionOrderedCacheBehaviorLambdaFunctionAssociationGetArgs>> lambdaFunctionAssociations;

    public Input<List<DistributionOrderedCacheBehaviorLambdaFunctionAssociationGetArgs>> getLambdaFunctionAssociations() {
    ...
    public DistributionOrderedCacheBehaviorGetArgs(
        ...
        @Nullable Input<DistributionOrderedCacheBehaviorForwardedValuesGetArgs> forwardedValues,
        @Nullable Input<List<DistributionOrderedCacheBehaviorFunctionAssociationGetArgs>> functionAssociations,
        @Nullable Input<List<DistributionOrderedCacheBehaviorLambdaFunctionAssociationGetArgs>> lambdaFunctionAssociations,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<DistributionOrderedCacheBehaviorForwardedValuesGetArgs> forwardedValues;
        private @Nullable Input<List<DistributionOrderedCacheBehaviorFunctionAssociationGetArgs>> functionAssociations;
        private @Nullable Input<List<DistributionOrderedCacheBehaviorLambdaFunctionAssociationGetArgs>> lambdaFunctionAssociations;
        ...
        public Builder setForwardedValues(@Nullable Input<DistributionOrderedCacheBehaviorForwardedValuesGetArgs> forwardedValues) {
            this.forwardedValues = forwardedValues;
            return this;
        }

        public Builder setForwardedValues(@Nullable DistributionOrderedCacheBehaviorForwardedValuesGetArgs forwardedValues) {
            this.forwardedValues = Input.ofNullable(forwardedValues);
            return this;
        }

        public Builder setFunctionAssociations(@Nullable Input<List<DistributionOrderedCacheBehaviorFunctionAssociationGetArgs>> functionAssociations) {
            this.functionAssociations = functionAssociations;
            return this;
        }

        public Builder setFunctionAssociations(@Nullable List<DistributionOrderedCacheBehaviorFunctionAssociationGetArgs> functionAssociations) {
            this.functionAssociations = Input.ofNullable(functionAssociations);
            return this;
        }

        public Builder setLambdaFunctionAssociations(@Nullable Input<List<DistributionOrderedCacheBehaviorLambdaFunctionAssociationGetArgs>> lambdaFunctionAssociations) {
            this.lambdaFunctionAssociations = lambdaFunctionAssociations;
            return this;
        }

        public Builder setLambdaFunctionAssociations(@Nullable List<DistributionOrderedCacheBehaviorLambdaFunctionAssociationGetArgs> lambdaFunctionAssociations) {
