...
import io.pulumi.aws.lb.inputs.TargetGroupHealthCheckGetArgs;
import io.pulumi.aws.lb.inputs.TargetGroupStickinessGetArgs;
...
public final class TargetGroupState extends io.pulumi.resources.ResourceArgs {
    ...
    public TargetGroupState(
        ...
        @Nullable Input<TargetGroupHealthCheckGetArgs> healthCheck,
        ...
        @Nullable Input<TargetGroupStickinessGetArgs> stickiness,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<TargetGroupHealthCheckGetArgs> healthCheck;
        ...
        private @Nullable Input<TargetGroupStickinessGetArgs> stickiness;
        ...
        public Builder setHealthCheck(@Nullable Input<TargetGroupHealthCheckGetArgs> healthCheck) {
            this.healthCheck = healthCheck;
            return this;
        }

        public Builder setHealthCheck(@Nullable TargetGroupHealthCheckGetArgs healthCheck) {
        ...
        public Builder setStickiness(@Nullable Input<TargetGroupStickinessGetArgs> stickiness) {
            this.stickiness = stickiness;
            return this;
        }

        public Builder setStickiness(@Nullable TargetGroupStickinessGetArgs stickiness) {
