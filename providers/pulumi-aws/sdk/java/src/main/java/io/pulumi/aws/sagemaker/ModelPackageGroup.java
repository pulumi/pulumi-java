...
public class ModelPackageGroup extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ModelPackageGroupArgs.Builder a);
    }
    private static io.pulumi.aws.sagemaker.ModelPackageGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.sagemaker.ModelPackageGroupArgs.builder();
