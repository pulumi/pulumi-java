...
public class AssessmentTarget extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable AssessmentTargetArgs.Builder a);
    }
    private static io.pulumi.aws.inspector.AssessmentTargetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.inspector.AssessmentTargetArgs.builder();
     ...
     */
    public AssessmentTarget(String name, BuilderApplicator argsBuilder) {
