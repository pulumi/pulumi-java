...
public final class DistributionConfigurationDistributionAmiDistributionConfigurationArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setLaunchPermission(@Nullable Input<DistributionConfigurationDistributionAmiDistributionConfigurationLaunchPermissionArgs> launchPermission) {
            this.launchPermission = launchPermission;
            return this;
        }

        public Builder setLaunchPermission(@Nullable DistributionConfigurationDistributionAmiDistributionConfigurationLaunchPermissionArgs launchPermission) {
