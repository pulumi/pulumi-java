...
public class UserDefinedFunction extends io.pulumi.resources.CustomResource {
    ...
    public UserDefinedFunction(String name, UserDefinedFunctionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:glue/userDefinedFunction:UserDefinedFunction", name, args == null ? UserDefinedFunctionArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private UserDefinedFunction(String name, Input<String> id, @Nullable UserDefinedFunctionState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static UserDefinedFunction get(String name, Input<String> id, @Nullable UserDefinedFunctionState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
