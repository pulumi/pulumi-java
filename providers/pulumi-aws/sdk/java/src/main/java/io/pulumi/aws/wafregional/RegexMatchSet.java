...
public class RegexMatchSet extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.wafregional.RegexMatchSetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.wafregional.RegexMatchSetArgs.builder();
