...
public class SamplingRule extends io.pulumi.resources.CustomResource {
    ...
    public SamplingRule(String name, SamplingRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:xray/samplingRule:SamplingRule", name, args == null ? SamplingRuleArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private SamplingRule(String name, Input<String> id, @Nullable SamplingRuleState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SamplingRule get(String name, Input<String> id, @Nullable SamplingRuleState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
