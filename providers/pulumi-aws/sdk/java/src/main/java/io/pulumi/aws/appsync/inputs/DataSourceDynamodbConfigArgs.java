...
public final class DataSourceDynamodbConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setDeltaSyncConfig(@Nullable Input<DataSourceDynamodbConfigDeltaSyncConfigArgs> deltaSyncConfig) {
            this.deltaSyncConfig = deltaSyncConfig;
            return this;
        }

        public Builder setDeltaSyncConfig(@Nullable DataSourceDynamodbConfigDeltaSyncConfigArgs deltaSyncConfig) {
