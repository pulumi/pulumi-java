...
public final class HaproxyLayerCloudwatchConfigurationLogStreamArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public HaproxyLayerCloudwatchConfigurationLogStreamArgs build() {
            return new HaproxyLayerCloudwatchConfigurationLogStreamArgs(batchCount, batchSize, bufferDuration, datetimeFormat, encoding, file, fileFingerprintLines, initialPosition, logGroupName, multilineStartPattern, timeZone);
        }
    }
}
