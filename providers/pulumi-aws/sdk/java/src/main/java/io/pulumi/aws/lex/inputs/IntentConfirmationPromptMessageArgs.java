...
public final class IntentConfirmationPromptMessageArgs extends io.pulumi.resources.ResourceArgs {

    public static final IntentConfirmationPromptMessageArgs Empty = new IntentConfirmationPromptMessageArgs();
    ...
    public IntentConfirmationPromptMessageArgs(
    ...
    private IntentConfirmationPromptMessageArgs() {
    ...
    public static Builder builder(IntentConfirmationPromptMessageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(IntentConfirmationPromptMessageArgs defaults) {
        ...
        public Builder groupNumber(@Nullable Integer groupNumber) {
            ...
            return this;
        }        public IntentConfirmationPromptMessageArgs build() {
            return new IntentConfirmationPromptMessageArgs(content, contentType, groupNumber);
        }
    }
}
