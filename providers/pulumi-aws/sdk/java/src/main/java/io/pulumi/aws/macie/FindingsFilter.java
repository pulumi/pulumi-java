...
public class FindingsFilter extends io.pulumi.resources.CustomResource {
    ...
    public FindingsFilter(String name, FindingsFilterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:macie/findingsFilter:FindingsFilter", name, args == null ? FindingsFilterArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private FindingsFilter(String name, Input<String> id, @Nullable FindingsFilterState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static FindingsFilter get(String name, Input<String> id, @Nullable FindingsFilterState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
