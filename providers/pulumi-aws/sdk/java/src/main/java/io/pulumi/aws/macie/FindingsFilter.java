...
public class FindingsFilter extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.macie.FindingsFilterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.macie.FindingsFilterArgs.builder();
