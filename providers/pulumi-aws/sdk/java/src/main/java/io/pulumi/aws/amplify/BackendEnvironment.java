...
public class BackendEnvironment extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(BackendEnvironmentArgs.Builder a);
    }
    private static io.pulumi.aws.amplify.BackendEnvironmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.amplify.BackendEnvironmentArgs.builder();
     ...
     */
    public BackendEnvironment(String name, BuilderApplicator argsBuilder) {
