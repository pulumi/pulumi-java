...
public class MLTransform extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="inputRecordTables", type=List.class, parameters={MLTransformInputRecordTable.class})
     ...
     * 
     */
    @OutputExport(name="labelCount", type=Integer.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="parameters", type=MLTransformParameters.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="schemas", type=List.class, parameters={MLTransformSchema.class})
    ...
    public MLTransform(String name, MLTransformArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:glue/mLTransform:MLTransform", name, args == null ? MLTransformArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private MLTransform(String name, Input<String> id, @Nullable MLTransformState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static MLTransform get(String name, Input<String> id, @Nullable MLTransformState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
