...
public final class TrailEventSelectorArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="dataResources")
      private final @Nullable Output<List<TrailEventSelectorDataResourceArgs>> dataResources;

    public Output<List<TrailEventSelectorDataResourceArgs>> getDataResources() {
    ...
    public TrailEventSelectorArgs(
        @Nullable Output<List<TrailEventSelectorDataResourceArgs>> dataResources,
