...
public class Acl extends io.pulumi.resources.CustomResource {
    ...
    public Acl(String name, @Nullable AclArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:memorydb/acl:Acl", name, args == null ? AclArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private Acl(String name, Input<String> id, @Nullable AclState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Acl get(String name, Input<String> id, @Nullable AclState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
