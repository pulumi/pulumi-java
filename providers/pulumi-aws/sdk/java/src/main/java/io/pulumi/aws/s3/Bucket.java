...
public class Bucket extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="accelerationStatus", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="bucketDomainName", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="bucketRegionalDomainName", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="corsRules", type=List.class, parameters={BucketCorsRule.class})
     ...
     * 
     */
    @OutputExport(name="grants", type=List.class, parameters={BucketGrant.class})
     ...
     * 
     */
    @OutputExport(name="loggings", type=List.class, parameters={BucketLogging.class})
     ...
     * 
     */
    @OutputExport(name="serverSideEncryptionConfiguration", type=BucketServerSideEncryptionConfiguration.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="websiteDomain", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="websiteEndpoint", type=String.class, parameters={})
    ...
    private static io.pulumi.aws.s3.BucketArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.s3.BucketArgs.builder();
