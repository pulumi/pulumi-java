...
public class HostedConnection extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="loaIssueTime", type=String.class, parameters={})
    ...
    public interface BuilderApplicator {
        public void apply(HostedConnectionArgs.Builder a);
    }
    private static io.pulumi.aws.directconnect.HostedConnectionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.directconnect.HostedConnectionArgs.builder();
     ...
     */
    public HostedConnection(String name, BuilderApplicator argsBuilder) {
    ...
    public HostedConnection(String name, HostedConnectionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:directconnect/hostedConnection:HostedConnection", name, args == null ? HostedConnectionArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private HostedConnection(String name, Input<String> id, @Nullable HostedConnectionState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static HostedConnection get(String name, Input<String> id, @Nullable HostedConnectionState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
