...
public class TaskDefinition extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="containerDefinitions", type=String.class, parameters={})
    ...
    private static io.pulumi.aws.ecs.TaskDefinitionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ecs.TaskDefinitionArgs.builder();
