...
public class DomainName extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    public Output</* @Nullable */ String> getCertificateName() {
     ...
     * 
     */
    public Output</* @Nullable */ String> getCertificatePrivateKey() {
     ...
     * 
     */
    public Output<DomainNameEndpointConfiguration> getEndpointConfiguration() {
     ...
     * 
     */
    public Output</* @Nullable */ String> getRegionalCertificateName() {
    ...
    private static io.pulumi.aws.apigateway.DomainNameArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.apigateway.DomainNameArgs.builder();
    ...
    public DomainName(String name, DomainNameArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:apigateway/domainName:DomainName", name, args == null ? DomainNameArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
