...
public class DefaultKmsKey extends io.pulumi.resources.CustomResource {
    ...
    public DefaultKmsKey(String name, DefaultKmsKeyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ebs/defaultKmsKey:DefaultKmsKey", name, args == null ? DefaultKmsKeyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private DefaultKmsKey(String name, Input<String> id, @Nullable DefaultKmsKeyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static DefaultKmsKey get(String name, Input<String> id, @Nullable DefaultKmsKeyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
