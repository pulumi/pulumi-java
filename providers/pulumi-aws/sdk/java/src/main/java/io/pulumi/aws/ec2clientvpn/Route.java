...
public class Route extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.ec2clientvpn.RouteArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2clientvpn.RouteArgs.builder();
    ...
    public Route(String name, RouteArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2clientvpn/route:Route", name, args == null ? RouteArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
