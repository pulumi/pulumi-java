...
public final class InsightFiltersCreatedAtArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setDateRange(@Nullable Input<InsightFiltersCreatedAtDateRangeArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder setDateRange(@Nullable InsightFiltersCreatedAtDateRangeArgs dateRange) {
