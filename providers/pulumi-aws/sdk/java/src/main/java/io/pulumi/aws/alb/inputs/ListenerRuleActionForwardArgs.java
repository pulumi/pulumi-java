...
import io.pulumi.aws.alb.inputs.ListenerRuleActionForwardStickinessArgs;
import io.pulumi.aws.alb.inputs.ListenerRuleActionForwardTargetGroupArgs;
...
public final class ListenerRuleActionForwardArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder stickiness(@Nullable Input<ListenerRuleActionForwardStickinessArgs> stickiness) {
            this.stickiness = stickiness;
            return this;
        }
        ...
        public Builder targetGroups(Input<List<ListenerRuleActionForwardTargetGroupArgs>> targetGroups) {
