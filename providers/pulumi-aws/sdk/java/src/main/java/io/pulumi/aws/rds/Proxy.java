...
public class Proxy extends io.pulumi.resources.CustomResource {
    ...
    public Proxy(String name, ProxyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:rds/proxy:Proxy", name, args == null ? ProxyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private Proxy(String name, Input<String> id, @Nullable ProxyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Proxy get(String name, Input<String> id, @Nullable ProxyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
