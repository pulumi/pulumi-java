...
public final class GangliaLayerState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder cloudwatchConfiguration(@Nullable Input<GangliaLayerCloudwatchConfigurationGetArgs> cloudwatchConfiguration) {
            this.cloudwatchConfiguration = cloudwatchConfiguration;
            return this;
        }

        public Builder cloudwatchConfiguration(@Nullable GangliaLayerCloudwatchConfigurationGetArgs cloudwatchConfiguration) {
        ...
        public Builder ebsVolumes(@Nullable Input<List<GangliaLayerEbsVolumeGetArgs>> ebsVolumes) {
            this.ebsVolumes = ebsVolumes;
            return this;
        }

        public Builder ebsVolumes(@Nullable List<GangliaLayerEbsVolumeGetArgs> ebsVolumes) {
