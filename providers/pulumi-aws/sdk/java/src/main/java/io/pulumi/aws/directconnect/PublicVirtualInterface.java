...
public class PublicVirtualInterface extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PublicVirtualInterfaceArgs.Builder a);
    }
    private static io.pulumi.aws.directconnect.PublicVirtualInterfaceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.directconnect.PublicVirtualInterfaceArgs.builder();
     ...
     */
    public PublicVirtualInterface(String name, BuilderApplicator argsBuilder) {
