...
public class EventSubscription extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.neptune.EventSubscriptionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.neptune.EventSubscriptionArgs.builder();
    ...
    public EventSubscription(String name, EventSubscriptionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:neptune/eventSubscription:EventSubscription", name, args == null ? EventSubscriptionArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
