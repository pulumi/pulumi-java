...
public class SslNegotiationPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(SslNegotiationPolicyArgs.Builder a);
    }
    private static io.pulumi.aws.elasticloadbalancing.SslNegotiationPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.elasticloadbalancing.SslNegotiationPolicyArgs.builder();
     ...
     */
    public SslNegotiationPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public SslNegotiationPolicy(String name, SslNegotiationPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:elasticloadbalancing/sslNegotiationPolicy:SslNegotiationPolicy", name, args == null ? SslNegotiationPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private SslNegotiationPolicy(String name, Input<String> id, @Nullable SslNegotiationPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SslNegotiationPolicy get(String name, Input<String> id, @Nullable SslNegotiationPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
