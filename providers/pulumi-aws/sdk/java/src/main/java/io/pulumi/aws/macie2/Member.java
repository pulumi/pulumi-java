...
public class Member extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.macie2.MemberArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.macie2.MemberArgs.builder();
    ...
    public Member(String name, MemberArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:macie2/member:Member", name, args == null ? MemberArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
