...
public class CachePolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(CachePolicyArgs.Builder a);
    }
    private static io.pulumi.aws.cloudfront.CachePolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.cloudfront.CachePolicyArgs.builder();
     ...
     */
    public CachePolicy(String name, BuilderApplicator argsBuilder) {
