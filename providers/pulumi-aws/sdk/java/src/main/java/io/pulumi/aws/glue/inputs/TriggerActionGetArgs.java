...
public final class TriggerActionGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setNotificationProperty(@Nullable Input<TriggerActionNotificationPropertyGetArgs> notificationProperty) {
            this.notificationProperty = notificationProperty;
            return this;
        }

        public Builder setNotificationProperty(@Nullable TriggerActionNotificationPropertyGetArgs notificationProperty) {
