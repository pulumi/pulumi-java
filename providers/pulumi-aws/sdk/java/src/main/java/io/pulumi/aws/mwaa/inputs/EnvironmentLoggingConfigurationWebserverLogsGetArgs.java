...
public final class EnvironmentLoggingConfigurationWebserverLogsGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public EnvironmentLoggingConfigurationWebserverLogsGetArgs(
    ...
    private EnvironmentLoggingConfigurationWebserverLogsGetArgs() {
    ...
    public static Builder builder(EnvironmentLoggingConfigurationWebserverLogsGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(EnvironmentLoggingConfigurationWebserverLogsGetArgs defaults) {
        ...
        public Builder logLevel(@Nullable String logLevel) {
            ...
            return this;
        }        public EnvironmentLoggingConfigurationWebserverLogsGetArgs build() {
            return new EnvironmentLoggingConfigurationWebserverLogsGetArgs(cloudWatchLogGroupArn, enabled, logLevel);
        }
    }
}
