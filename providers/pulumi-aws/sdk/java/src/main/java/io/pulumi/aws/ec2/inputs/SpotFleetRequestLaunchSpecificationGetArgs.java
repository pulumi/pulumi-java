...
public final class SpotFleetRequestLaunchSpecificationGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="ebsBlockDevices")
      private final @Nullable Input<List<SpotFleetRequestLaunchSpecificationEbsBlockDeviceGetArgs>> ebsBlockDevices;

    public Input<List<SpotFleetRequestLaunchSpecificationEbsBlockDeviceGetArgs>> getEbsBlockDevices() {
    ...
    @InputImport(name="ephemeralBlockDevices")
      private final @Nullable Input<List<SpotFleetRequestLaunchSpecificationEphemeralBlockDeviceGetArgs>> ephemeralBlockDevices;

    public Input<List<SpotFleetRequestLaunchSpecificationEphemeralBlockDeviceGetArgs>> getEphemeralBlockDevices() {
    ...
    @InputImport(name="rootBlockDevices")
      private final @Nullable Input<List<SpotFleetRequestLaunchSpecificationRootBlockDeviceGetArgs>> rootBlockDevices;

    public Input<List<SpotFleetRequestLaunchSpecificationRootBlockDeviceGetArgs>> getRootBlockDevices() {
    ...
    public SpotFleetRequestLaunchSpecificationGetArgs(
        ...
        @Nullable Input<List<SpotFleetRequestLaunchSpecificationEbsBlockDeviceGetArgs>> ebsBlockDevices,
        @Nullable Input<Boolean> ebsOptimized,
        @Nullable Input<List<SpotFleetRequestLaunchSpecificationEphemeralBlockDeviceGetArgs>> ephemeralBlockDevices,
        ...
        @Nullable Input<List<SpotFleetRequestLaunchSpecificationRootBlockDeviceGetArgs>> rootBlockDevices,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<SpotFleetRequestLaunchSpecificationEbsBlockDeviceGetArgs>> ebsBlockDevices;
        private @Nullable Input<Boolean> ebsOptimized;
        private @Nullable Input<List<SpotFleetRequestLaunchSpecificationEphemeralBlockDeviceGetArgs>> ephemeralBlockDevices;
        ...
        private @Nullable Input<List<SpotFleetRequestLaunchSpecificationRootBlockDeviceGetArgs>> rootBlockDevices;
        ...
        public Builder setEbsBlockDevices(@Nullable Input<List<SpotFleetRequestLaunchSpecificationEbsBlockDeviceGetArgs>> ebsBlockDevices) {
            this.ebsBlockDevices = ebsBlockDevices;
            return this;
        }

        public Builder setEbsBlockDevices(@Nullable List<SpotFleetRequestLaunchSpecificationEbsBlockDeviceGetArgs> ebsBlockDevices) {
        ...
        public Builder setEphemeralBlockDevices(@Nullable Input<List<SpotFleetRequestLaunchSpecificationEphemeralBlockDeviceGetArgs>> ephemeralBlockDevices) {
            this.ephemeralBlockDevices = ephemeralBlockDevices;
            return this;
        }

        public Builder setEphemeralBlockDevices(@Nullable List<SpotFleetRequestLaunchSpecificationEphemeralBlockDeviceGetArgs> ephemeralBlockDevices) {
        ...
        public Builder setRootBlockDevices(@Nullable Input<List<SpotFleetRequestLaunchSpecificationRootBlockDeviceGetArgs>> rootBlockDevices) {
            this.rootBlockDevices = rootBlockDevices;
            return this;
        }

        public Builder setRootBlockDevices(@Nullable List<SpotFleetRequestLaunchSpecificationRootBlockDeviceGetArgs> rootBlockDevices) {
