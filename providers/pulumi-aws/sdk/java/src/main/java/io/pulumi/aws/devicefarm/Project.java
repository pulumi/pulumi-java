...
public class Project extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.devicefarm.ProjectArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.devicefarm.ProjectArgs.builder();
