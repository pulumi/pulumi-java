...
public class CatalogDatabase extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable CatalogDatabaseArgs.Builder a);
    }
    private static io.pulumi.aws.glue.CatalogDatabaseArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.glue.CatalogDatabaseArgs.builder();
     ...
     */
    public CatalogDatabase(String name, BuilderApplicator argsBuilder) {
