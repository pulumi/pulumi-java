...
public final class InsightFiltersFirstObservedAtGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<InsightFiltersFirstObservedAtDateRangeGetArgs> dateRange;

    public Input<InsightFiltersFirstObservedAtDateRangeGetArgs> getDateRange() {
    ...
    public InsightFiltersFirstObservedAtGetArgs(
        @Nullable Input<InsightFiltersFirstObservedAtDateRangeGetArgs> dateRange,
    ...
    public static final class Builder {
        private @Nullable Input<InsightFiltersFirstObservedAtDateRangeGetArgs> dateRange;
        ...
        public Builder setDateRange(@Nullable Input<InsightFiltersFirstObservedAtDateRangeGetArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder setDateRange(@Nullable InsightFiltersFirstObservedAtDateRangeGetArgs dateRange) {
