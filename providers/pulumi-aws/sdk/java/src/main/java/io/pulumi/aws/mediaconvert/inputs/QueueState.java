...
public final class QueueState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setReservationPlanSettings(@Nullable Input<QueueReservationPlanSettingsGetArgs> reservationPlanSettings) {
            this.reservationPlanSettings = reservationPlanSettings;
            return this;
        }

        public Builder setReservationPlanSettings(@Nullable QueueReservationPlanSettingsGetArgs reservationPlanSettings) {
