...
public class QueuePolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(QueuePolicyArgs.Builder a);
    }
    private static io.pulumi.aws.sqs.QueuePolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.sqs.QueuePolicyArgs.builder();
     ...
     */
    public QueuePolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public QueuePolicy(String name, QueuePolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:sqs/queuePolicy:QueuePolicy", name, args == null ? QueuePolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private QueuePolicy(String name, Input<String> id, @Nullable QueuePolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static QueuePolicy get(String name, Input<String> id, @Nullable QueuePolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
