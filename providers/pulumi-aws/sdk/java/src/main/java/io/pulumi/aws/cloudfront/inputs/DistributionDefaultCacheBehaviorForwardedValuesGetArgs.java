...
public final class DistributionDefaultCacheBehaviorForwardedValuesGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="cookies", required=true)
      private final Output<DistributionDefaultCacheBehaviorForwardedValuesCookiesGetArgs> cookies;

    public Output<DistributionDefaultCacheBehaviorForwardedValuesCookiesGetArgs> getCookies() {
        return this.cookies;
    }
    ...
    public DistributionDefaultCacheBehaviorForwardedValuesGetArgs(
        Output<DistributionDefaultCacheBehaviorForwardedValuesCookiesGetArgs> cookies,
