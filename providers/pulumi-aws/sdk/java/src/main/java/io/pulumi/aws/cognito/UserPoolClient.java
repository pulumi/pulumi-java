...
public class UserPoolClient extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(UserPoolClientArgs.Builder a);
    }
    private static io.pulumi.aws.cognito.UserPoolClientArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.cognito.UserPoolClientArgs.builder();
     ...
     */
    public UserPoolClient(String name, BuilderApplicator argsBuilder) {
    ...
    public UserPoolClient(String name, UserPoolClientArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:cognito/userPoolClient:UserPoolClient", name, args == null ? UserPoolClientArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private UserPoolClient(String name, Input<String> id, @Nullable UserPoolClientState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static UserPoolClient get(String name, Input<String> id, @Nullable UserPoolClientState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
