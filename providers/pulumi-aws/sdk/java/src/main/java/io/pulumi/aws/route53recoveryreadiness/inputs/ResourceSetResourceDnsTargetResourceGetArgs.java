...
public final class ResourceSetResourceDnsTargetResourceGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setTargetResource(@Nullable Input<ResourceSetResourceDnsTargetResourceTargetResourceGetArgs> targetResource) {
            this.targetResource = targetResource;
            return this;
        }

        public Builder setTargetResource(@Nullable ResourceSetResourceDnsTargetResourceTargetResourceGetArgs targetResource) {
