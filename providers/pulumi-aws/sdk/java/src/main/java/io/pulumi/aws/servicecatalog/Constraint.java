...
public class Constraint extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ConstraintArgs.Builder a);
    }
    private static io.pulumi.aws.servicecatalog.ConstraintArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.servicecatalog.ConstraintArgs.builder();
     ...
     */
    public Constraint(String name, BuilderApplicator argsBuilder) {
