...
public final class DistributionOrderedCacheBehaviorArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public DistributionOrderedCacheBehaviorArgs(
        ...
        @Nullable Input<DistributionOrderedCacheBehaviorForwardedValuesArgs> forwardedValues,
        @Nullable Input<List<DistributionOrderedCacheBehaviorFunctionAssociationArgs>> functionAssociations,
        @Nullable Input<List<DistributionOrderedCacheBehaviorLambdaFunctionAssociationArgs>> lambdaFunctionAssociations,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<DistributionOrderedCacheBehaviorForwardedValuesArgs> forwardedValues;
        private @Nullable Input<List<DistributionOrderedCacheBehaviorFunctionAssociationArgs>> functionAssociations;
        private @Nullable Input<List<DistributionOrderedCacheBehaviorLambdaFunctionAssociationArgs>> lambdaFunctionAssociations;
        ...
        public Builder setForwardedValues(@Nullable Input<DistributionOrderedCacheBehaviorForwardedValuesArgs> forwardedValues) {
            this.forwardedValues = forwardedValues;
            return this;
        }

        public Builder setForwardedValues(@Nullable DistributionOrderedCacheBehaviorForwardedValuesArgs forwardedValues) {
            this.forwardedValues = Input.ofNullable(forwardedValues);
            return this;
        }

        public Builder setFunctionAssociations(@Nullable Input<List<DistributionOrderedCacheBehaviorFunctionAssociationArgs>> functionAssociations) {
            this.functionAssociations = functionAssociations;
            return this;
        }

        public Builder setFunctionAssociations(@Nullable List<DistributionOrderedCacheBehaviorFunctionAssociationArgs> functionAssociations) {
            this.functionAssociations = Input.ofNullable(functionAssociations);
            return this;
        }

        public Builder setLambdaFunctionAssociations(@Nullable Input<List<DistributionOrderedCacheBehaviorLambdaFunctionAssociationArgs>> lambdaFunctionAssociations) {
            this.lambdaFunctionAssociations = lambdaFunctionAssociations;
            return this;
        }

        public Builder setLambdaFunctionAssociations(@Nullable List<DistributionOrderedCacheBehaviorLambdaFunctionAssociationArgs> lambdaFunctionAssociations) {
