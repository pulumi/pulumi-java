...
public class ClusterParameterGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.rds.ClusterParameterGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.rds.ClusterParameterGroupArgs.builder();
