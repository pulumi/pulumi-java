...
public class HostedZoneDnsSec extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="signingStatus", type=String.class, parameters={})
    ...
    public HostedZoneDnsSec(String name, HostedZoneDnsSecArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:route53/hostedZoneDnsSec:HostedZoneDnsSec", name, args == null ? HostedZoneDnsSecArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private HostedZoneDnsSec(String name, Input<String> id, @Nullable HostedZoneDnsSecState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static HostedZoneDnsSec get(String name, Input<String> id, @Nullable HostedZoneDnsSecState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
