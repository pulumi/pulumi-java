...
public final class ClusterMasterInstanceFleetLaunchSpecificationsSpotSpecificationGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final ClusterMasterInstanceFleetLaunchSpecificationsSpotSpecificationGetArgs Empty = new ClusterMasterInstanceFleetLaunchSpecificationsSpotSpecificationGetArgs();
    ...
    public ClusterMasterInstanceFleetLaunchSpecificationsSpotSpecificationGetArgs(
    ...
    private ClusterMasterInstanceFleetLaunchSpecificationsSpotSpecificationGetArgs() {
    ...
    public static Builder builder(ClusterMasterInstanceFleetLaunchSpecificationsSpotSpecificationGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ClusterMasterInstanceFleetLaunchSpecificationsSpotSpecificationGetArgs defaults) {
        ...
        public Builder timeoutAction(Input<String> timeoutAction) {
        ...
        public Builder timeoutDurationMinutes(Input<Integer> timeoutDurationMinutes) {
        ...
        public ClusterMasterInstanceFleetLaunchSpecificationsSpotSpecificationGetArgs build() {
            return new ClusterMasterInstanceFleetLaunchSpecificationsSpotSpecificationGetArgs(allocationStrategy, blockDurationMinutes, timeoutAction, timeoutDurationMinutes);
        }
    }
}
