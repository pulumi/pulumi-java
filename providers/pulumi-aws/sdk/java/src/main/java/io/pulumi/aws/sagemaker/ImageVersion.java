...
public class ImageVersion extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.sagemaker.ImageVersionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.sagemaker.ImageVersionArgs.builder();
