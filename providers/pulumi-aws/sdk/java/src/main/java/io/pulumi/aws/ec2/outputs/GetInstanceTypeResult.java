...
public final class GetInstanceTypeResult {
    ...
    private GetInstanceTypeResult(
        ...
        Integer ebsPerformanceBaselineIops,
        Double ebsPerformanceBaselineThroughput,
        Integer ebsPerformanceMaximumBandwidth,
        ...
        List<GetInstanceTypeFpga> fpgas,
        Boolean freeTierEligible,
        List<GetInstanceTypeGpus> gpuses,
        Boolean hibernationSupported,
        String hypervisor,
        String id,
        List<GetInstanceTypeInferenceAccelerator> inferenceAccelerators,
        List<GetInstanceTypeInstanceDisk> instanceDisks,
        Boolean instanceStorageSupported,
        String instanceType,
        Boolean ipv6Supported,
        Integer maximumIpv4AddressesPerInterface,
        ...
        List<String> supportedPlacementStrategies,
        List<String> supportedRootDeviceTypes,
        List<String> supportedUsagesClasses,
        List<String> supportedVirtualizationTypes,
        Double sustainedClockSpeed,
        Integer totalFpgaMemory,
        Integer totalGpuMemory,
        Integer totalInstanceStorage,
        List<Integer> validCores,
        List<Integer> validThreadsPerCores) {
