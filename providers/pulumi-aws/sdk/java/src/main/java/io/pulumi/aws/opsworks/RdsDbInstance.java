...
public class RdsDbInstance extends io.pulumi.resources.CustomResource {
    ...
    public RdsDbInstance(String name, RdsDbInstanceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:opsworks/rdsDbInstance:RdsDbInstance", name, args == null ? RdsDbInstanceArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private RdsDbInstance(String name, Input<String> id, @Nullable RdsDbInstanceState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static RdsDbInstance get(String name, Input<String> id, @Nullable RdsDbInstanceState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
