...
public class DocumentationVersion extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.apigateway.DocumentationVersionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.apigateway.DocumentationVersionArgs.builder();
