...
public class ReadinessCheck extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ReadinessCheckArgs.Builder a);
    }
    private static io.pulumi.aws.route53recoveryreadiness.ReadinessCheckArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.route53recoveryreadiness.ReadinessCheckArgs.builder();
     ...
     */
    public ReadinessCheck(String name, BuilderApplicator argsBuilder) {
