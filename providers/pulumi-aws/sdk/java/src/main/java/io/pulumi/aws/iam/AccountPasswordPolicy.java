...
public class AccountPasswordPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable AccountPasswordPolicyArgs.Builder a);
    }
    private static io.pulumi.aws.iam.AccountPasswordPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.iam.AccountPasswordPolicyArgs.builder();
     ...
     */
    public AccountPasswordPolicy(String name, BuilderApplicator argsBuilder) {
