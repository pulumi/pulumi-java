...
public final class RouteSpecHttp2RouteMatchGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setHeaders(@Nullable Input<List<RouteSpecHttp2RouteMatchHeaderGetArgs>> headers) {
            this.headers = headers;
            return this;
        }

        public Builder setHeaders(@Nullable List<RouteSpecHttp2RouteMatchHeaderGetArgs> headers) {
