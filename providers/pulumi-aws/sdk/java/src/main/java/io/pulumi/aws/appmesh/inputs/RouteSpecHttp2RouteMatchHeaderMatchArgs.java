...
public final class RouteSpecHttp2RouteMatchHeaderMatchArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<RouteSpecHttp2RouteMatchHeaderMatchRangeArgs> range;

    public Input<RouteSpecHttp2RouteMatchHeaderMatchRangeArgs> getRange() {
    ...
    public RouteSpecHttp2RouteMatchHeaderMatchArgs(
        ...
        @Nullable Input<RouteSpecHttp2RouteMatchHeaderMatchRangeArgs> range,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<RouteSpecHttp2RouteMatchHeaderMatchRangeArgs> range;
        ...
        public Builder setRange(@Nullable Input<RouteSpecHttp2RouteMatchHeaderMatchRangeArgs> range) {
            this.range = range;
            return this;
        }

        public Builder setRange(@Nullable RouteSpecHttp2RouteMatchHeaderMatchRangeArgs range) {
