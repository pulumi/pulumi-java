...
public class WebsiteCertificateAuthorityAssociation extends io.pulumi.resources.CustomResource {
    ...
    public WebsiteCertificateAuthorityAssociation(String name, WebsiteCertificateAuthorityAssociationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:worklink/websiteCertificateAuthorityAssociation:WebsiteCertificateAuthorityAssociation", name, args == null ? WebsiteCertificateAuthorityAssociationArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private WebsiteCertificateAuthorityAssociation(String name, Input<String> id, @Nullable WebsiteCertificateAuthorityAssociationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static WebsiteCertificateAuthorityAssociation get(String name, Input<String> id, @Nullable WebsiteCertificateAuthorityAssociationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
