...
public class S3Location extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(S3LocationArgs.Builder a);
    }
    private static io.pulumi.aws.datasync.S3LocationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.datasync.S3LocationArgs.builder();
     ...
     */
    public S3Location(String name, BuilderApplicator argsBuilder) {
