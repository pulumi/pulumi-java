...
public class Function extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="architectures", type=List.class, parameters={String.class})
     ...
     * 
     */
    @OutputExport(name="fileSystemConfig", type=FunctionFileSystemConfig.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="packageType", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="qualifiedArn", type=String.class, parameters={})
    ...
    private static io.pulumi.aws.lambda.FunctionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.lambda.FunctionArgs.builder();
    ...
    public Function(String name, FunctionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:lambda/function:Function", name, args == null ? FunctionArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
