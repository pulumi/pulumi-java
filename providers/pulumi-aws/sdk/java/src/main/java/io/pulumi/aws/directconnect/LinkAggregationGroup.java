...
public class LinkAggregationGroup extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(LinkAggregationGroupArgs.Builder a);
    }
    private static io.pulumi.aws.directconnect.LinkAggregationGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.directconnect.LinkAggregationGroupArgs.builder();
     ...
     */
    public LinkAggregationGroup(String name, BuilderApplicator argsBuilder) {
    ...
    public LinkAggregationGroup(String name, LinkAggregationGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:directconnect/linkAggregationGroup:LinkAggregationGroup", name, args == null ? LinkAggregationGroupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private LinkAggregationGroup(String name, Output<String> id, @Nullable LinkAggregationGroupState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static LinkAggregationGroup get(String name, Output<String> id, @Nullable LinkAggregationGroupState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
