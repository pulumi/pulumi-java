...
public final class MysqlLayerState extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="cloudwatchConfiguration")
      private final @Nullable Output<MysqlLayerCloudwatchConfigurationGetArgs> cloudwatchConfiguration;

    public Output<MysqlLayerCloudwatchConfigurationGetArgs> getCloudwatchConfiguration() {
    ...
    @Import(name="ebsVolumes")
      private final @Nullable Output<List<MysqlLayerEbsVolumeGetArgs>> ebsVolumes;

    public Output<List<MysqlLayerEbsVolumeGetArgs>> getEbsVolumes() {
    ...
    public MysqlLayerState(
        ...
        @Nullable Output<MysqlLayerCloudwatchConfigurationGetArgs> cloudwatchConfiguration,
        ...
        @Nullable Output<List<MysqlLayerEbsVolumeGetArgs>> ebsVolumes,
