...
public final class MysqlLayerState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder cloudwatchConfiguration(@Nullable Input<MysqlLayerCloudwatchConfigurationGetArgs> cloudwatchConfiguration) {
            this.cloudwatchConfiguration = cloudwatchConfiguration;
            return this;
        }

        public Builder cloudwatchConfiguration(@Nullable MysqlLayerCloudwatchConfigurationGetArgs cloudwatchConfiguration) {
        ...
        public Builder ebsVolumes(@Nullable Input<List<MysqlLayerEbsVolumeGetArgs>> ebsVolumes) {
            this.ebsVolumes = ebsVolumes;
            return this;
        }

        public Builder ebsVolumes(@Nullable List<MysqlLayerEbsVolumeGetArgs> ebsVolumes) {
