...
public final class InsightFiltersResourceAwsIamAccessKeyCreatedAtArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="dateRange")
      private final @Nullable Input<InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs> dateRange;

    public Input<InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs> getDateRange() {
    ...
    public InsightFiltersResourceAwsIamAccessKeyCreatedAtArgs(
        @Nullable Input<InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs> dateRange,
    ...
    public static final class Builder {
        private @Nullable Input<InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs> dateRange;
        ...
        public Builder setDateRange(@Nullable Input<InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder setDateRange(@Nullable InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs dateRange) {
