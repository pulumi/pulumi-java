...
public final class RuleGroupState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCustomResponseBodies(@Nullable Input<List<RuleGroupCustomResponseBodyGetArgs>> customResponseBodies) {
            this.customResponseBodies = customResponseBodies;
            return this;
        }

        public Builder setCustomResponseBodies(@Nullable List<RuleGroupCustomResponseBodyGetArgs> customResponseBodies) {
        ...
        public Builder setRules(@Nullable Input<List<RuleGroupRuleGetArgs>> rules) {
            this.rules = rules;
            return this;
        }

        public Builder setRules(@Nullable List<RuleGroupRuleGetArgs> rules) {
        ...
        public Builder setVisibilityConfig(@Nullable Input<RuleGroupVisibilityConfigGetArgs> visibilityConfig) {
            this.visibilityConfig = visibilityConfig;
            return this;
        }

        public Builder setVisibilityConfig(@Nullable RuleGroupVisibilityConfigGetArgs visibilityConfig) {
