...
public final class HaproxyLayerCloudwatchConfigurationLogStreamGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(HaproxyLayerCloudwatchConfigurationLogStreamGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(HaproxyLayerCloudwatchConfigurationLogStreamGetArgs defaults) {
        ...
        public HaproxyLayerCloudwatchConfigurationLogStreamGetArgs build() {
            return new HaproxyLayerCloudwatchConfigurationLogStreamGetArgs(batchCount, batchSize, bufferDuration, datetimeFormat, encoding, file, fileFingerprintLines, initialPosition, logGroupName, multilineStartPattern, timeZone);
        }
    }
}
