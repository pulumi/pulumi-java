...
public final class TaskDefinitionVolumeEfsVolumeConfigurationGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public TaskDefinitionVolumeEfsVolumeConfigurationGetArgs(
        @Nullable Output<TaskDefinitionVolumeEfsVolumeConfigurationAuthorizationConfigGetArgs> authorizationConfig,
    ...
    public static final class Builder {
        private @Nullable Output<TaskDefinitionVolumeEfsVolumeConfigurationAuthorizationConfigGetArgs> authorizationConfig;
        ...
        public Builder authorizationConfig(@Nullable Output<TaskDefinitionVolumeEfsVolumeConfigurationAuthorizationConfigGetArgs> authorizationConfig) {
            this.authorizationConfig = authorizationConfig;
            return this;
        }
