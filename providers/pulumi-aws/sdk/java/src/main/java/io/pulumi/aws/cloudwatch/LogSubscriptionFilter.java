...
public class LogSubscriptionFilter extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(LogSubscriptionFilterArgs.Builder a);
    }
    private static io.pulumi.aws.cloudwatch.LogSubscriptionFilterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.cloudwatch.LogSubscriptionFilterArgs.builder();
     ...
     */
    public LogSubscriptionFilter(String name, BuilderApplicator argsBuilder) {
