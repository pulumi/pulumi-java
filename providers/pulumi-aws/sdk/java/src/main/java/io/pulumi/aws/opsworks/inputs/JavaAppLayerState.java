...
public final class JavaAppLayerState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCloudwatchConfiguration(@Nullable Input<JavaAppLayerCloudwatchConfigurationGetArgs> cloudwatchConfiguration) {
            this.cloudwatchConfiguration = cloudwatchConfiguration;
            return this;
        }

        public Builder setCloudwatchConfiguration(@Nullable JavaAppLayerCloudwatchConfigurationGetArgs cloudwatchConfiguration) {
        ...
        public Builder setEbsVolumes(@Nullable Input<List<JavaAppLayerEbsVolumeGetArgs>> ebsVolumes) {
            this.ebsVolumes = ebsVolumes;
            return this;
        }

        public Builder setEbsVolumes(@Nullable List<JavaAppLayerEbsVolumeGetArgs> ebsVolumes) {
