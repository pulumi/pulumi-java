...
public class SigningProfile extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.signer.SigningProfileArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.signer.SigningProfileArgs.builder();
