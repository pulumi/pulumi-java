...
public class SigningJob extends io.pulumi.resources.CustomResource {
    ...
    public SigningJob(String name, SigningJobArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:signer/signingJob:SigningJob", name, args == null ? SigningJobArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private SigningJob(String name, Input<String> id, @Nullable SigningJobState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SigningJob get(String name, Input<String> id, @Nullable SigningJobState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
