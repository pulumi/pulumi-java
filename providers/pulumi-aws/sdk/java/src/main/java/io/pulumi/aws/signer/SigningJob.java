...
import io.pulumi.aws.signer.SigningJobArgs;
import io.pulumi.aws.signer.inputs.SigningJobState;
import io.pulumi.aws.signer.outputs.SigningJobDestination;
import io.pulumi.aws.signer.outputs.SigningJobRevocationRecord;
...
public class SigningJob extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    public Output<SigningJobDestination> getDestination() {
     ...
     * 
     */
    public Output</* @Nullable */ Boolean> getIgnoreSigningJobFailure() {
     ...
     * 
     */
    public Output<List<SigningJobRevocationRecord>> getRevocationRecords() {
     ...
     * 
     */
    public Output<List<SigningJobSignedObject>> getSignedObjects() {
     ...
     * 
     */
    public Output<SigningJobSource> getSource() {
        return this.source;
    }
    /**
    ...
    public interface BuilderApplicator {
        public void apply(SigningJobArgs.Builder a);
    }
    private static io.pulumi.aws.signer.SigningJobArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.signer.SigningJobArgs.builder();
     ...
     */
    public SigningJob(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public SigningJob(String name, SigningJobArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:signer/signingJob:SigningJob", name, args == null ? SigningJobArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private SigningJob(String name, Output<String> id, @Nullable SigningJobState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SigningJob get(String name, Output<String> id, @Nullable SigningJobState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
