...
public class PlacementGroup extends io.pulumi.resources.CustomResource {
     ...
     */
    public static PlacementGroup get(String name, Output<String> id, @Nullable PlacementGroupState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
