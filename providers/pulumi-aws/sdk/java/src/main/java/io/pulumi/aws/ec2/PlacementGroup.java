...
public class PlacementGroup extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PlacementGroupArgs.Builder a);
    }
    private static io.pulumi.aws.ec2.PlacementGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2.PlacementGroupArgs.builder();
     ...
     */
    public PlacementGroup(String name, BuilderApplicator argsBuilder) {
