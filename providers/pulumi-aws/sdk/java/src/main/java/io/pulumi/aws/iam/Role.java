...
public class Role extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="assumeRolePolicy", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="forceDetachPolicies", type=Boolean.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="inlinePolicies", type=List.class, parameters={RoleInlinePolicy.class})
    ...
    private static io.pulumi.aws.iam.RoleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.iam.RoleArgs.builder();
    ...
    public Role(String name, RoleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:iam/role:Role", name, args == null ? RoleArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private Role(String name, Input<String> id, @Nullable RoleState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Role get(String name, Input<String> id, @Nullable RoleState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
