...
public class CustomDataIdentifier extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable CustomDataIdentifierArgs.Builder a);
    }
    private static io.pulumi.aws.macie.CustomDataIdentifierArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.macie.CustomDataIdentifierArgs.builder();
     ...
     */
    public CustomDataIdentifier(String name, BuilderApplicator argsBuilder) {
    ...
    public CustomDataIdentifier(String name, @Nullable CustomDataIdentifierArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:macie/customDataIdentifier:CustomDataIdentifier", name, args == null ? CustomDataIdentifierArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private CustomDataIdentifier(String name, Input<String> id, @Nullable CustomDataIdentifierState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static CustomDataIdentifier get(String name, Input<String> id, @Nullable CustomDataIdentifierState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
