...
public final class RouteSpecHttpRouteMatchHeaderMatchArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setRange(@Nullable Input<RouteSpecHttpRouteMatchHeaderMatchRangeArgs> range) {
            this.range = range;
            return this;
        }

        public Builder setRange(@Nullable RouteSpecHttpRouteMatchHeaderMatchRangeArgs range) {
