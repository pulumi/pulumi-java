...
public class Account extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable AccountArgs.Builder a);
    }
    private static io.pulumi.aws.macie2.AccountArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.macie2.AccountArgs.builder();
    ...
    public Account(String name, @Nullable AccountArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:macie2/account:Account", name, args == null ? AccountArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
