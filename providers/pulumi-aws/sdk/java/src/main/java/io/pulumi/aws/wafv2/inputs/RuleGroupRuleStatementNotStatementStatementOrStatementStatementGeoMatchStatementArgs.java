...
public final class RuleGroupRuleStatementNotStatementStatementOrStatementStatementGeoMatchStatementArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="forwardedIpConfig")
      private final @Nullable Output<RuleGroupRuleStatementNotStatementStatementOrStatementStatementGeoMatchStatementForwardedIpConfigArgs> forwardedIpConfig;

    public Output<RuleGroupRuleStatementNotStatementStatementOrStatementStatementGeoMatchStatementForwardedIpConfigArgs> getForwardedIpConfig() {
    ...
    public RuleGroupRuleStatementNotStatementStatementOrStatementStatementGeoMatchStatementArgs(
        ...
        @Nullable Output<RuleGroupRuleStatementNotStatementStatementOrStatementStatementGeoMatchStatementForwardedIpConfigArgs> forwardedIpConfig) {
