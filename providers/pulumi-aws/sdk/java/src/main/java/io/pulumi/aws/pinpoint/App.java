...
public class App extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="campaignHook", type=AppCampaignHook.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="limits", type=AppLimits.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="quietTime", type=AppQuietTime.class, parameters={})
    ...
    public App(String name, @Nullable AppArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:pinpoint/app:App", name, args == null ? AppArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
