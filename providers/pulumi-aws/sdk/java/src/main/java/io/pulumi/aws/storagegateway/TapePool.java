...
public class TapePool extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="poolName", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="retentionLockTimeInDays", type=Integer.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="retentionLockType", type=String.class, parameters={})
    ...
    public TapePool(String name, TapePoolArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:storagegateway/tapePool:TapePool", name, args == null ? TapePoolArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private TapePool(String name, Input<String> id, @Nullable TapePoolState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TapePool get(String name, Input<String> id, @Nullable TapePoolState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
