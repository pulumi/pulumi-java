...
import io.pulumi.aws.lex.inputs.IntentSlotValueElicitationPromptMessageGetArgs;
...
public final class IntentSlotValueElicitationPromptGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="messages", required=true)
      private final Input<List<IntentSlotValueElicitationPromptMessageGetArgs>> messages;

    public Input<List<IntentSlotValueElicitationPromptMessageGetArgs>> getMessages() {
    ...
    public IntentSlotValueElicitationPromptGetArgs(
        ...
        Input<List<IntentSlotValueElicitationPromptMessageGetArgs>> messages,
    ...
    public static final class Builder {
        ...
        private Input<List<IntentSlotValueElicitationPromptMessageGetArgs>> messages;
        ...
        public Builder setMessages(Input<List<IntentSlotValueElicitationPromptMessageGetArgs>> messages) {
            this.messages = Objects.requireNonNull(messages);
            return this;
        }

        public Builder setMessages(List<IntentSlotValueElicitationPromptMessageGetArgs> messages) {
        ...
        public IntentSlotValueElicitationPromptGetArgs build() {
            return new IntentSlotValueElicitationPromptGetArgs(maxAttempts, messages, responseCard);
        }
    }
}
