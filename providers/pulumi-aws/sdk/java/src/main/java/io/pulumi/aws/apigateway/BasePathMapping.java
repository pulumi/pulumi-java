...
public class BasePathMapping extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(BasePathMappingArgs.Builder a);
    }
    private static io.pulumi.aws.apigateway.BasePathMappingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.apigateway.BasePathMappingArgs.builder();
     ...
     */
    public BasePathMapping(String name, BuilderApplicator argsBuilder) {
