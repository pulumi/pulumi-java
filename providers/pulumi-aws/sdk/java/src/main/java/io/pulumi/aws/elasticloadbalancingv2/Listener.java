...
public class Listener extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.elasticloadbalancingv2.ListenerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.elasticloadbalancingv2.ListenerArgs.builder();
    ...
    public Listener(String name, ListenerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:elasticloadbalancingv2/listener:Listener", name, args == null ? ListenerArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
