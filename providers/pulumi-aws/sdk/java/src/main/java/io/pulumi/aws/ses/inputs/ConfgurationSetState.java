...
public final class ConfgurationSetState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setDeliveryOptions(@Nullable Input<ConfgurationSetDeliveryOptionsGetArgs> deliveryOptions) {
            this.deliveryOptions = deliveryOptions;
            return this;
        }

        public Builder setDeliveryOptions(@Nullable ConfgurationSetDeliveryOptionsGetArgs deliveryOptions) {
