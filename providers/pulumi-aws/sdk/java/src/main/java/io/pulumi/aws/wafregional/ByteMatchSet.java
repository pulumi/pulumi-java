...
public class ByteMatchSet extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.wafregional.ByteMatchSetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.wafregional.ByteMatchSetArgs.builder();
