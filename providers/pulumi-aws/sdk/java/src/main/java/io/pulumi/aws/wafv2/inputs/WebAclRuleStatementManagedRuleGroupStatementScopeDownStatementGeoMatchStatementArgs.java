...
public final class WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatementArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="forwardedIpConfig")
      private final @Nullable Output<WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatementForwardedIpConfigArgs> forwardedIpConfig;

    public Output<WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatementForwardedIpConfigArgs> getForwardedIpConfig() {
    ...
    public WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatementArgs(
        ...
        @Nullable Output<WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatementForwardedIpConfigArgs> forwardedIpConfig) {
