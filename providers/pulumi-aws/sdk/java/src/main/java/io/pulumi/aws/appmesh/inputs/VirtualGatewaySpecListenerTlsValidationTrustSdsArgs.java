...
public final class VirtualGatewaySpecListenerTlsValidationTrustSdsArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public VirtualGatewaySpecListenerTlsValidationTrustSdsArgs(Input<String> secretName) {
