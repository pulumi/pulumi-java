...
public class HostedTransitVirtualInterfaceAcceptor extends io.pulumi.resources.CustomResource {
    ...
    public HostedTransitVirtualInterfaceAcceptor(String name, HostedTransitVirtualInterfaceAcceptorArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:directconnect/hostedTransitVirtualInterfaceAcceptor:HostedTransitVirtualInterfaceAcceptor", name, args == null ? HostedTransitVirtualInterfaceAcceptorArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private HostedTransitVirtualInterfaceAcceptor(String name, Input<String> id, @Nullable HostedTransitVirtualInterfaceAcceptorState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static HostedTransitVirtualInterfaceAcceptor get(String name, Input<String> id, @Nullable HostedTransitVirtualInterfaceAcceptorState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
