...
public class Connection extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.glue.ConnectionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.glue.ConnectionArgs.builder();
    ...
    public Connection(String name, @Nullable ConnectionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:glue/connection:Connection", name, args == null ? ConnectionArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
