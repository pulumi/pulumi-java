...
public class Application extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.codedeploy.ApplicationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.codedeploy.ApplicationArgs.builder();
