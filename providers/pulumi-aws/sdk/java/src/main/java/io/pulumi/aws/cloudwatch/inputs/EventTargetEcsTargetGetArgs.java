...
public final class EventTargetEcsTargetGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setNetworkConfiguration(@Nullable Input<EventTargetEcsTargetNetworkConfigurationGetArgs> networkConfiguration) {
            this.networkConfiguration = networkConfiguration;
            return this;
        }

        public Builder setNetworkConfiguration(@Nullable EventTargetEcsTargetNetworkConfigurationGetArgs networkConfiguration) {
            this.networkConfiguration = Input.ofNullable(networkConfiguration);
            return this;
        }

        public Builder setPlacementConstraints(@Nullable Input<List<EventTargetEcsTargetPlacementConstraintGetArgs>> placementConstraints) {
            this.placementConstraints = placementConstraints;
            return this;
        }

        public Builder setPlacementConstraints(@Nullable List<EventTargetEcsTargetPlacementConstraintGetArgs> placementConstraints) {
