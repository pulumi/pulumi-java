...
public class ApiMapping extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ApiMappingArgs.Builder a);
    }
    private static io.pulumi.aws.apigatewayv2.ApiMappingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.apigatewayv2.ApiMappingArgs.builder();
     ...
     */
    public ApiMapping(String name, BuilderApplicator argsBuilder) {
    ...
    public ApiMapping(String name, ApiMappingArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:apigatewayv2/apiMapping:ApiMapping", name, args == null ? ApiMappingArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ApiMapping(String name, Input<String> id, @Nullable ApiMappingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ApiMapping get(String name, Input<String> id, @Nullable ApiMappingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
