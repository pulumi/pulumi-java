...
public class SecurityGroup extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="egress", type=List.class, parameters={SecurityGroupEgress.class})
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable SecurityGroupArgs.Builder a);
    }
    private static io.pulumi.aws.ec2.SecurityGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2.SecurityGroupArgs.builder();
    ...
    public SecurityGroup(String name, @Nullable SecurityGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/securityGroup:SecurityGroup", name, args == null ? SecurityGroupArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
