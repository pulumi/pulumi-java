...
public final class MemcachedLayerArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCloudwatchConfiguration(@Nullable Input<MemcachedLayerCloudwatchConfigurationArgs> cloudwatchConfiguration) {
            this.cloudwatchConfiguration = cloudwatchConfiguration;
            return this;
        }

        public Builder setCloudwatchConfiguration(@Nullable MemcachedLayerCloudwatchConfigurationArgs cloudwatchConfiguration) {
        ...
        public Builder setEbsVolumes(@Nullable Input<List<MemcachedLayerEbsVolumeArgs>> ebsVolumes) {
            this.ebsVolumes = ebsVolumes;
            return this;
        }

        public Builder setEbsVolumes(@Nullable List<MemcachedLayerEbsVolumeArgs> ebsVolumes) {
