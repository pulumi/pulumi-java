...
public final class NodejsAppLayerArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Output<NodejsAppLayerCloudwatchConfigurationArgs> cloudwatchConfiguration() {
    ...
    public Output<List<NodejsAppLayerEbsVolumeArgs>> ebsVolumes() {
    ...
    public Output<String> nodejsVersion() {
