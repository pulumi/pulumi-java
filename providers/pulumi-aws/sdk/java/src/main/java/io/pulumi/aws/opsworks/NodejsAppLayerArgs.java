...
public final class NodejsAppLayerArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCloudwatchConfiguration(@Nullable Input<NodejsAppLayerCloudwatchConfigurationArgs> cloudwatchConfiguration) {
            this.cloudwatchConfiguration = cloudwatchConfiguration;
            return this;
        }

        public Builder setCloudwatchConfiguration(@Nullable NodejsAppLayerCloudwatchConfigurationArgs cloudwatchConfiguration) {
        ...
        public Builder setEbsVolumes(@Nullable Input<List<NodejsAppLayerEbsVolumeArgs>> ebsVolumes) {
            this.ebsVolumes = ebsVolumes;
            return this;
        }

        public Builder setEbsVolumes(@Nullable List<NodejsAppLayerEbsVolumeArgs> ebsVolumes) {
        ...
        public Builder setNodejsVersion(@Nullable Input<String> nodejsVersion) {
            this.nodejsVersion = nodejsVersion;
            return this;
        }

        public Builder setNodejsVersion(@Nullable String nodejsVersion) {
