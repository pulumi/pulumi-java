...
public class Record extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RecordArgs.Builder a);
    }
    private static io.pulumi.aws.route53.RecordArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.route53.RecordArgs.builder();
     ...
     */
    public Record(String name, BuilderApplicator argsBuilder) {
