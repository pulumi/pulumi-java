...
public class RuleGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.waf.RuleGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.waf.RuleGroupArgs.builder();
    ...
    public RuleGroup(String name, RuleGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:waf/ruleGroup:RuleGroup", name, args == null ? RuleGroupArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
