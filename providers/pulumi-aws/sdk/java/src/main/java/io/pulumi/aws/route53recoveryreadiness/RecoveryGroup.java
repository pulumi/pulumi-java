...
public class RecoveryGroup extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RecoveryGroupArgs.Builder a);
    }
    private static io.pulumi.aws.route53recoveryreadiness.RecoveryGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.route53recoveryreadiness.RecoveryGroupArgs.builder();
     ...
     */
    public static RecoveryGroup get(String name, Output<String> id, @Nullable RecoveryGroupState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
