...
public class AmiLaunchPermission extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(AmiLaunchPermissionArgs.Builder a);
    }
    private static io.pulumi.aws.ec2.AmiLaunchPermissionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2.AmiLaunchPermissionArgs.builder();
     ...
     */
    public AmiLaunchPermission(String name, BuilderApplicator argsBuilder) {
