...
public final class WebAclRuleStatementNotStatementStatementGeoMatchStatementArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="forwardedIpConfig")
      private final @Nullable Output<WebAclRuleStatementNotStatementStatementGeoMatchStatementForwardedIpConfigArgs> forwardedIpConfig;

    public Output<WebAclRuleStatementNotStatementStatementGeoMatchStatementForwardedIpConfigArgs> getForwardedIpConfig() {
    ...
    public WebAclRuleStatementNotStatementStatementGeoMatchStatementArgs(
        ...
        @Nullable Output<WebAclRuleStatementNotStatementStatementGeoMatchStatementForwardedIpConfigArgs> forwardedIpConfig) {
    ...
    public static final class Builder {
        ...
        private @Nullable Output<WebAclRuleStatementNotStatementStatementGeoMatchStatementForwardedIpConfigArgs> forwardedIpConfig;
        ...
        public Builder forwardedIpConfig(@Nullable Output<WebAclRuleStatementNotStatementStatementGeoMatchStatementForwardedIpConfigArgs> forwardedIpConfig) {
            this.forwardedIpConfig = forwardedIpConfig;
            return this;
        }
