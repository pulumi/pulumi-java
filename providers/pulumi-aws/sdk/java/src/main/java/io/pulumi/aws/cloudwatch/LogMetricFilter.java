...
public class LogMetricFilter extends io.pulumi.resources.CustomResource {
    ...
    public LogMetricFilter(String name, LogMetricFilterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:cloudwatch/logMetricFilter:LogMetricFilter", name, args == null ? LogMetricFilterArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private LogMetricFilter(String name, Input<String> id, @Nullable LogMetricFilterState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static LogMetricFilter get(String name, Input<String> id, @Nullable LogMetricFilterState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
