...
public final class WebAclRuleStatementGeoMatchStatementGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setForwardedIpConfig(@Nullable Input<WebAclRuleStatementGeoMatchStatementForwardedIpConfigGetArgs> forwardedIpConfig) {
            this.forwardedIpConfig = forwardedIpConfig;
            return this;
        }

        public Builder setForwardedIpConfig(@Nullable WebAclRuleStatementGeoMatchStatementForwardedIpConfigGetArgs forwardedIpConfig) {
