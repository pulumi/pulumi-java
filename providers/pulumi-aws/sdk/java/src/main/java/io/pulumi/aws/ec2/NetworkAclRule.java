...
public class NetworkAclRule extends io.pulumi.resources.CustomResource {
    ...
    public NetworkAclRule(String name, NetworkAclRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/networkAclRule:NetworkAclRule", name, args == null ? NetworkAclRuleArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private NetworkAclRule(String name, Input<String> id, @Nullable NetworkAclRuleState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static NetworkAclRule get(String name, Input<String> id, @Nullable NetworkAclRuleState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
