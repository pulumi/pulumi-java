...
public class EventStream extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="destinationStreamArn", type=String.class, parameters={})
    ...
    public interface BuilderApplicator {
        public void apply(EventStreamArgs.Builder a);
    }
    private static io.pulumi.aws.pinpoint.EventStreamArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.pinpoint.EventStreamArgs.builder();
     ...
     */
    public EventStream(String name, BuilderApplicator argsBuilder) {
