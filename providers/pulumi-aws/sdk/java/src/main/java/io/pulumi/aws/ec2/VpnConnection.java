...
public class VpnConnection extends io.pulumi.resources.CustomResource {
    ...
    public VpnConnection(String name, VpnConnectionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/vpnConnection:VpnConnection", name, args == null ? VpnConnectionArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private VpnConnection(String name, Input<String> id, @Nullable VpnConnectionState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static VpnConnection get(String name, Input<String> id, @Nullable VpnConnectionState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
