...
public class AmiCopy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(AmiCopyArgs.Builder a);
    }
    private static io.pulumi.aws.ec2.AmiCopyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2.AmiCopyArgs.builder();
     ...
     */
    public AmiCopy(String name, BuilderApplicator argsBuilder) {
