...
public class VaultPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(VaultPolicyArgs.Builder a);
    }
    private static io.pulumi.aws.backup.VaultPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.backup.VaultPolicyArgs.builder();
     ...
     */
    public VaultPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public VaultPolicy(String name, VaultPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:backup/vaultPolicy:VaultPolicy", name, args == null ? VaultPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private VaultPolicy(String name, Input<String> id, @Nullable VaultPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static VaultPolicy get(String name, Input<String> id, @Nullable VaultPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
