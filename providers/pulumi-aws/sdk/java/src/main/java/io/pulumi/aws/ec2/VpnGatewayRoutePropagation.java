...
public class VpnGatewayRoutePropagation extends io.pulumi.resources.CustomResource {
    ...
    public VpnGatewayRoutePropagation(String name, VpnGatewayRoutePropagationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/vpnGatewayRoutePropagation:VpnGatewayRoutePropagation", name, args == null ? VpnGatewayRoutePropagationArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private VpnGatewayRoutePropagation(String name, Input<String> id, @Nullable VpnGatewayRoutePropagationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static VpnGatewayRoutePropagation get(String name, Input<String> id, @Nullable VpnGatewayRoutePropagationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
