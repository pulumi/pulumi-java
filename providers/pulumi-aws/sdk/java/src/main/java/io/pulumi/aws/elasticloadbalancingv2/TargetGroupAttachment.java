...
public class TargetGroupAttachment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.elasticloadbalancingv2.TargetGroupAttachmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.elasticloadbalancingv2.TargetGroupAttachmentArgs.builder();
