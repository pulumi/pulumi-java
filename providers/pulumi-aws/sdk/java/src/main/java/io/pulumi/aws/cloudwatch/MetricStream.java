...
public class MetricStream extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.cloudwatch.MetricStreamArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.cloudwatch.MetricStreamArgs.builder();
    ...
    public MetricStream(String name, MetricStreamArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:cloudwatch/metricStream:MetricStream", name, args == null ? MetricStreamArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private MetricStream(String name, Input<String> id, @Nullable MetricStreamState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static MetricStream get(String name, Input<String> id, @Nullable MetricStreamState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
