...
public class SecretVersion extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="secretBinary", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="secretString", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="versionStages", type=List.class, parameters={String.class})
    ...
    public SecretVersion(String name, SecretVersionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:secretsmanager/secretVersion:SecretVersion", name, args == null ? SecretVersionArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
