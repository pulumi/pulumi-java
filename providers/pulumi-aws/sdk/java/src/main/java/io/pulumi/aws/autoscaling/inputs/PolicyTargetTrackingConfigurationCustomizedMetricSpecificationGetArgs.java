...
public final class PolicyTargetTrackingConfigurationCustomizedMetricSpecificationGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder metricDimensions(@Nullable Input<List<PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricDimensionGetArgs>> metricDimensions) {
            this.metricDimensions = metricDimensions;
            return this;
        }
