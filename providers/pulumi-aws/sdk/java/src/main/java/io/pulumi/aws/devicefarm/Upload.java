...
public class Upload extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(UploadArgs.Builder a);
    }
    private static io.pulumi.aws.devicefarm.UploadArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.devicefarm.UploadArgs.builder();
     ...
     */
    public Upload(String name, BuilderApplicator argsBuilder) {
