...
public final class NodejsAppLayerCloudwatchConfigurationLogStreamArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public NodejsAppLayerCloudwatchConfigurationLogStreamArgs(
    ...
    public static final class Builder {
        ...
        public Builder timeZone(@Nullable String timeZone) {
            ...
            return new NodejsAppLayerCloudwatchConfigurationLogStreamArgs(batchCount, batchSize, bufferDuration, datetimeFormat, encoding, file, fileFingerprintLines, initialPosition, logGroupName, multilineStartPattern, timeZone);
        }
    }
}
