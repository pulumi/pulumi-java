...
public class RecorderStatus extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RecorderStatusArgs.Builder a);
    }
    private static io.pulumi.aws.cfg.RecorderStatusArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.cfg.RecorderStatusArgs.builder();
     ...
     */
    public RecorderStatus(String name, BuilderApplicator argsBuilder) {
