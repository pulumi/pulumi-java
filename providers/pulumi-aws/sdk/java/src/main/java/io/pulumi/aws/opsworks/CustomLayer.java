...
public class CustomLayer extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="cloudwatchConfiguration", type=CustomLayerCloudwatchConfiguration.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="ebsVolumes", type=List.class, parameters={CustomLayerEbsVolume.class})
    ...
    public interface BuilderApplicator {
        public void apply(CustomLayerArgs.Builder a);
    }
    private static io.pulumi.aws.opsworks.CustomLayerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.opsworks.CustomLayerArgs.builder();
     ...
     */
    public CustomLayer(String name, BuilderApplicator argsBuilder) {
