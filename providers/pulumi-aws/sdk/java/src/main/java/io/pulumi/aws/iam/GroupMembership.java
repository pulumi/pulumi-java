...
public class GroupMembership extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.iam.GroupMembershipArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.iam.GroupMembershipArgs.builder();
