...
public class ImagePipeline extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ImagePipelineArgs.Builder a);
    }
    private static io.pulumi.aws.imagebuilder.ImagePipelineArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.imagebuilder.ImagePipelineArgs.builder();
     ...
     */
    public ImagePipeline(String name, BuilderApplicator argsBuilder) {
