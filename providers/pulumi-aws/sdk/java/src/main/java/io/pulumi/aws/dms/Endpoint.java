...
public class Endpoint extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.dms.EndpointArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.dms.EndpointArgs.builder();
    ...
    public Endpoint(String name, EndpointArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:dms/endpoint:Endpoint", name, args == null ? EndpointArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
