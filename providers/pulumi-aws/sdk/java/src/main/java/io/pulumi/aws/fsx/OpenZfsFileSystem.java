...
public class OpenZfsFileSystem extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="copyTagsToVolumes", type=Boolean.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="diskIopsConfiguration", type=OpenZfsFileSystemDiskIopsConfiguration.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="rootVolumeConfiguration", type=OpenZfsFileSystemRootVolumeConfiguration.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="rootVolumeId", type=String.class, parameters={})
    ...
    public interface BuilderApplicator {
        public void apply(OpenZfsFileSystemArgs.Builder a);
    }
    private static io.pulumi.aws.fsx.OpenZfsFileSystemArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.fsx.OpenZfsFileSystemArgs.builder();
     ...
     */
    public OpenZfsFileSystem(String name, BuilderApplicator argsBuilder) {
