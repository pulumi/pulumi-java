...
public class ResourceShareAccepter extends io.pulumi.resources.CustomResource {
    ...
    public ResourceShareAccepter(String name, ResourceShareAccepterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ram/resourceShareAccepter:ResourceShareAccepter", name, args == null ? ResourceShareAccepterArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ResourceShareAccepter(String name, Input<String> id, @Nullable ResourceShareAccepterState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ResourceShareAccepter get(String name, Input<String> id, @Nullable ResourceShareAccepterState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
