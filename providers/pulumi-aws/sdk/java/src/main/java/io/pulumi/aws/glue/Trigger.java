...
public class Trigger extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.glue.TriggerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.glue.TriggerArgs.builder();
    ...
    public Trigger(String name, TriggerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:glue/trigger:Trigger", name, args == null ? TriggerArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
