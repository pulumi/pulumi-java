...
public class LocalGatewayRoute extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.ec2.LocalGatewayRouteArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2.LocalGatewayRouteArgs.builder();
