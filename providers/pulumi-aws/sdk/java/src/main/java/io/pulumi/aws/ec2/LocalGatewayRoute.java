...
public class LocalGatewayRoute extends io.pulumi.resources.CustomResource {
     ...
     */
    public static LocalGatewayRoute get(String name, Output<String> id, @Nullable LocalGatewayRouteState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
