...
public class SecurityProfile extends io.pulumi.resources.CustomResource {
    ...
    public SecurityProfile(String name, SecurityProfileArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:connect/securityProfile:SecurityProfile", name, args == null ? SecurityProfileArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private SecurityProfile(String name, Input<String> id, @Nullable SecurityProfileState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SecurityProfile get(String name, Input<String> id, @Nullable SecurityProfileState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
