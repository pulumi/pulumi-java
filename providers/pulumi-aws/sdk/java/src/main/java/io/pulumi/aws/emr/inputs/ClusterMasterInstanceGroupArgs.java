...
public final class ClusterMasterInstanceGroupArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setEbsConfigs(@Nullable Input<List<ClusterMasterInstanceGroupEbsConfigArgs>> ebsConfigs) {
            this.ebsConfigs = ebsConfigs;
            return this;
        }

        public Builder setEbsConfigs(@Nullable List<ClusterMasterInstanceGroupEbsConfigArgs> ebsConfigs) {
