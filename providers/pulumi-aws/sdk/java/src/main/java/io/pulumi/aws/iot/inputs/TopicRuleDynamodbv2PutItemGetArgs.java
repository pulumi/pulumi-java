...
public final class TopicRuleDynamodbv2PutItemGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public TopicRuleDynamodbv2PutItemGetArgs(Input<String> tableName) {
