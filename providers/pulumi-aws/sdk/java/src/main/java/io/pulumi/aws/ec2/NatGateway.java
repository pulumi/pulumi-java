...
public class NatGateway extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(NatGatewayArgs.Builder a);
    }
    private static io.pulumi.aws.ec2.NatGatewayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2.NatGatewayArgs.builder();
     ...
     */
    public NatGateway(String name, BuilderApplicator argsBuilder) {
