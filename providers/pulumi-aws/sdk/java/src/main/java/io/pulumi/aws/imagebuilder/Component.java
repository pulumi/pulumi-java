...
public class Component extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.imagebuilder.ComponentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.imagebuilder.ComponentArgs.builder();
     ...
     */
    public static Component get(String name, Output<String> id, @Nullable ComponentState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
