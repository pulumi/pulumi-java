...
import io.pulumi.aws.rds.SubnetGroupArgs;
import io.pulumi.aws.rds.inputs.SubnetGroupState;
...
public class SubnetGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.rds.SubnetGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.rds.SubnetGroupArgs.builder();
    ...
    public SubnetGroup(String name, SubnetGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:rds/subnetGroup:SubnetGroup", name, args == null ? SubnetGroupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
