...
public class VoiceConnectorTermination extends io.pulumi.resources.CustomResource {
    ...
    public VoiceConnectorTermination(String name, VoiceConnectorTerminationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:chime/voiceConnectorTermination:VoiceConnectorTermination", name, args == null ? VoiceConnectorTerminationArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private VoiceConnectorTermination(String name, Input<String> id, @Nullable VoiceConnectorTerminationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static VoiceConnectorTermination get(String name, Input<String> id, @Nullable VoiceConnectorTerminationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
