...
public final class TrailEventSelectorGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public TrailEventSelectorGetArgs(
        @Nullable Input<List<TrailEventSelectorDataResourceGetArgs>> dataResources,
    ...
    public static final class Builder {
        private @Nullable Input<List<TrailEventSelectorDataResourceGetArgs>> dataResources;
        ...
        public Builder setDataResources(@Nullable Input<List<TrailEventSelectorDataResourceGetArgs>> dataResources) {
            this.dataResources = dataResources;
            return this;
        }

        public Builder setDataResources(@Nullable List<TrailEventSelectorDataResourceGetArgs> dataResources) {
