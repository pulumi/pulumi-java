...
public class BucketOwnershipControls extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="rule", type=BucketOwnershipControlsRule.class, parameters={})
    ...
    public interface BuilderApplicator {
        public void apply(BucketOwnershipControlsArgs.Builder a);
    }
    private static io.pulumi.aws.s3.BucketOwnershipControlsArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.s3.BucketOwnershipControlsArgs.builder();
     ...
     */
    public BucketOwnershipControls(String name, BuilderApplicator argsBuilder) {
