...
public class Instance extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.servicediscovery.InstanceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.servicediscovery.InstanceArgs.builder();
    ...
    public Instance(String name, InstanceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:servicediscovery/instance:Instance", name, args == null ? InstanceArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
