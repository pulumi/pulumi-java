...
public final class DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs Empty = new DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs();
    ...
    public DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs(
    ...
    private DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs() {
    ...
    public static Builder builder(DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs defaults) {
        ...
        public DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs build() {
            return new DomainDefaultUserSettingsJupyterServerAppSettingsDefaultResourceSpecGetArgs(instanceType, lifecycleConfigArn, sagemakerImageArn, sagemakerImageVersionArn);
        }
    }
}
