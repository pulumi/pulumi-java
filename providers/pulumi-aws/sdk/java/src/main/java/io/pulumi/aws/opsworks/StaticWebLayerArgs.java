...
public final class StaticWebLayerArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public StaticWebLayerArgs(
        ...
        @Nullable Input<StaticWebLayerCloudwatchConfigurationArgs> cloudwatchConfiguration,
        ...
        @Nullable Input<List<StaticWebLayerEbsVolumeArgs>> ebsVolumes,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<StaticWebLayerCloudwatchConfigurationArgs> cloudwatchConfiguration;
        ...
        private @Nullable Input<List<StaticWebLayerEbsVolumeArgs>> ebsVolumes;
        ...
        public Builder setCloudwatchConfiguration(@Nullable Input<StaticWebLayerCloudwatchConfigurationArgs> cloudwatchConfiguration) {
            this.cloudwatchConfiguration = cloudwatchConfiguration;
            return this;
        }

        public Builder setCloudwatchConfiguration(@Nullable StaticWebLayerCloudwatchConfigurationArgs cloudwatchConfiguration) {
        ...
        public Builder setEbsVolumes(@Nullable Input<List<StaticWebLayerEbsVolumeArgs>> ebsVolumes) {
            this.ebsVolumes = ebsVolumes;
            return this;
        }

        public Builder setEbsVolumes(@Nullable List<StaticWebLayerEbsVolumeArgs> ebsVolumes) {
