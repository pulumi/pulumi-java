...
public final class StaticWebLayerArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder cloudwatchConfiguration(@Nullable Input<StaticWebLayerCloudwatchConfigurationArgs> cloudwatchConfiguration) {
            this.cloudwatchConfiguration = cloudwatchConfiguration;
            return this;
        }
        ...
        public Builder ebsVolumes(@Nullable Input<List<StaticWebLayerEbsVolumeArgs>> ebsVolumes) {
            this.ebsVolumes = ebsVolumes;
            return this;
        }
