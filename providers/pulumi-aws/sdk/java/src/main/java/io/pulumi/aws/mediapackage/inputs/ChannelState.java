...
public final class ChannelState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setHlsIngests(@Nullable Input<List<ChannelHlsIngestGetArgs>> hlsIngests) {
            this.hlsIngests = hlsIngests;
            return this;
        }

        public Builder setHlsIngests(@Nullable List<ChannelHlsIngestGetArgs> hlsIngests) {
