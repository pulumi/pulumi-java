...
public class RepositoryPolicy extends io.pulumi.resources.CustomResource {
    ...
    public RepositoryPolicy(String name, RepositoryPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ecrpublic/repositoryPolicy:RepositoryPolicy", name, args == null ? RepositoryPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private RepositoryPolicy(String name, Input<String> id, @Nullable RepositoryPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static RepositoryPolicy get(String name, Input<String> id, @Nullable RepositoryPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
