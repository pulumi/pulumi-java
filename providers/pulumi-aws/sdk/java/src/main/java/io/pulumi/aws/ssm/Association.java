...
public class Association extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="complianceSeverity", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="outputLocation", type=AssociationOutputLocation.class, parameters={})
    ...
    public Association(String name, @Nullable AssociationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ssm/association:Association", name, args == null ? AssociationArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private Association(String name, Input<String> id, @Nullable AssociationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Association get(String name, Input<String> id, @Nullable AssociationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
