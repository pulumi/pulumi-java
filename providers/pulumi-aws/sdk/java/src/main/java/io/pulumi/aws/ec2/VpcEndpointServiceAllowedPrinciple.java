...
public class VpcEndpointServiceAllowedPrinciple extends io.pulumi.resources.CustomResource {
    ...
    public VpcEndpointServiceAllowedPrinciple(String name, VpcEndpointServiceAllowedPrincipleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/vpcEndpointServiceAllowedPrinciple:VpcEndpointServiceAllowedPrinciple", name, args == null ? VpcEndpointServiceAllowedPrincipleArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private VpcEndpointServiceAllowedPrinciple(String name, Input<String> id, @Nullable VpcEndpointServiceAllowedPrincipleState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static VpcEndpointServiceAllowedPrinciple get(String name, Input<String> id, @Nullable VpcEndpointServiceAllowedPrincipleState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
