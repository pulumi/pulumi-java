...
public class CapacityReservation extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(CapacityReservationArgs.Builder a);
    }
    private static io.pulumi.aws.ec2.CapacityReservationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2.CapacityReservationArgs.builder();
     ...
     */
    public CapacityReservation(String name, BuilderApplicator argsBuilder) {
