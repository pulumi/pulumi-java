...
public class ResolverQueryLogConfig extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ResolverQueryLogConfigArgs.Builder a);
    }
    private static io.pulumi.aws.route53.ResolverQueryLogConfigArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.route53.ResolverQueryLogConfigArgs.builder();
     ...
     */
    public ResolverQueryLogConfig(String name, BuilderApplicator argsBuilder) {
