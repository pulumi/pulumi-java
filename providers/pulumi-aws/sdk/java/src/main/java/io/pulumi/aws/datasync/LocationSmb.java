...
public class LocationSmb extends io.pulumi.resources.CustomResource {
    ...
    public LocationSmb(String name, LocationSmbArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:datasync/locationSmb:LocationSmb", name, args == null ? LocationSmbArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private LocationSmb(String name, Input<String> id, @Nullable LocationSmbState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static LocationSmb get(String name, Input<String> id, @Nullable LocationSmbState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
