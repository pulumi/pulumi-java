...
import io.pulumi.aws.emr.inputs.InstanceFleetInstanceTypeConfigConfigurationArgs;
import io.pulumi.aws.emr.inputs.InstanceFleetInstanceTypeConfigEbsConfigArgs;
...
public final class InstanceFleetInstanceTypeConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="configurations")
      private final @Nullable Input<List<InstanceFleetInstanceTypeConfigConfigurationArgs>> configurations;

    public Input<List<InstanceFleetInstanceTypeConfigConfigurationArgs>> getConfigurations() {
    ...
    @InputImport(name="ebsConfigs")
      private final @Nullable Input<List<InstanceFleetInstanceTypeConfigEbsConfigArgs>> ebsConfigs;

    public Input<List<InstanceFleetInstanceTypeConfigEbsConfigArgs>> getEbsConfigs() {
    ...
    public InstanceFleetInstanceTypeConfigArgs(
        ...
        @Nullable Input<List<InstanceFleetInstanceTypeConfigConfigurationArgs>> configurations,
        @Nullable Input<List<InstanceFleetInstanceTypeConfigEbsConfigArgs>> ebsConfigs,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<InstanceFleetInstanceTypeConfigConfigurationArgs>> configurations;
        private @Nullable Input<List<InstanceFleetInstanceTypeConfigEbsConfigArgs>> ebsConfigs;
        ...
        public Builder setConfigurations(@Nullable Input<List<InstanceFleetInstanceTypeConfigConfigurationArgs>> configurations) {
            this.configurations = configurations;
            return this;
        }

        public Builder setConfigurations(@Nullable List<InstanceFleetInstanceTypeConfigConfigurationArgs> configurations) {
            this.configurations = Input.ofNullable(configurations);
            return this;
        }

        public Builder setEbsConfigs(@Nullable Input<List<InstanceFleetInstanceTypeConfigEbsConfigArgs>> ebsConfigs) {
            this.ebsConfigs = ebsConfigs;
            return this;
        }

        public Builder setEbsConfigs(@Nullable List<InstanceFleetInstanceTypeConfigEbsConfigArgs> ebsConfigs) {
