...
public final class InstanceFleetInstanceTypeConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public InstanceFleetInstanceTypeConfigArgs(
        ...
        @Nullable Output<List<InstanceFleetInstanceTypeConfigConfigurationArgs>> configurations,
        @Nullable Output<List<InstanceFleetInstanceTypeConfigEbsConfigArgs>> ebsConfigs,
