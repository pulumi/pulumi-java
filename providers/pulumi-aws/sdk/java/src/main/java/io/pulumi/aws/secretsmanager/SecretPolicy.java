...
public class SecretPolicy extends io.pulumi.resources.CustomResource {
    ...
    public SecretPolicy(String name, SecretPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:secretsmanager/secretPolicy:SecretPolicy", name, args == null ? SecretPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private SecretPolicy(String name, Input<String> id, @Nullable SecretPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SecretPolicy get(String name, Input<String> id, @Nullable SecretPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
