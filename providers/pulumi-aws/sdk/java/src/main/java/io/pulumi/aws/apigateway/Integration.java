...
public class Integration extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.apigateway.IntegrationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.apigateway.IntegrationArgs.builder();
