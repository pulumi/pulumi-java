...
public class DevicePool extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.devicefarm.DevicePoolArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.devicefarm.DevicePoolArgs.builder();
