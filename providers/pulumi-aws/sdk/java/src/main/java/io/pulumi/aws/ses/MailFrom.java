...
public class MailFrom extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(MailFromArgs.Builder a);
    }
    private static io.pulumi.aws.ses.MailFromArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ses.MailFromArgs.builder();
     ...
     */
    public MailFrom(String name, BuilderApplicator argsBuilder) {
    ...
    public MailFrom(String name, MailFromArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ses/mailFrom:MailFrom", name, args == null ? MailFromArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private MailFrom(String name, Input<String> id, @Nullable MailFromState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static MailFrom get(String name, Input<String> id, @Nullable MailFromState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
