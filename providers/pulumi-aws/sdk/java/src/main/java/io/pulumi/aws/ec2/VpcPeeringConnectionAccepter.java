...
public class VpcPeeringConnectionAccepter extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="accepter", type=VpcPeeringConnectionAccepterAccepter.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="requester", type=VpcPeeringConnectionAccepterRequester.class, parameters={})
    ...
    public VpcPeeringConnectionAccepter(String name, VpcPeeringConnectionAccepterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/vpcPeeringConnectionAccepter:VpcPeeringConnectionAccepter", name, args == null ? VpcPeeringConnectionAccepterArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private VpcPeeringConnectionAccepter(String name, Input<String> id, @Nullable VpcPeeringConnectionAccepterState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static VpcPeeringConnectionAccepter get(String name, Input<String> id, @Nullable VpcPeeringConnectionAccepterState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
