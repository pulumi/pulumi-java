...
public final class HostedPrivateVirtualInterfaceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public HostedPrivateVirtualInterfaceArgs build() {
            return new HostedPrivateVirtualInterfaceArgs(addressFamily, amazonAddress, bgpAsn, bgpAuthKey, connectionId, customerAddress, mtu, name, ownerAccountId, vlan);
        }
    }
}
