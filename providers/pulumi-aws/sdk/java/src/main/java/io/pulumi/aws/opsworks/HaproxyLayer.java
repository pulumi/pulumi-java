...
public class HaproxyLayer extends io.pulumi.resources.CustomResource {
    ...
    @Export(name="cloudwatchConfiguration", type=HaproxyLayerCloudwatchConfiguration.class, parameters={})
     ...
     * 
     */
    @Export(name="statsEnabled", type=Boolean.class, parameters={})
     ...
     * 
     */
    @Export(name="statsPassword", type=String.class, parameters={})
