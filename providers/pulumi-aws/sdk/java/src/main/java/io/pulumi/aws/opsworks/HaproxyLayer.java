...
import io.pulumi.aws.opsworks.HaproxyLayerArgs;
import io.pulumi.aws.opsworks.inputs.HaproxyLayerState;
import io.pulumi.aws.opsworks.outputs.HaproxyLayerCloudwatchConfiguration;
import io.pulumi.aws.opsworks.outputs.HaproxyLayerEbsVolume;
...
public class HaproxyLayer extends io.pulumi.resources.CustomResource {
    ...
    @OutputExport(name="cloudwatchConfiguration", type=HaproxyLayerCloudwatchConfiguration.class, parameters={})
    private Output</* @Nullable */ HaproxyLayerCloudwatchConfiguration> cloudwatchConfiguration;

    public Output</* @Nullable */ HaproxyLayerCloudwatchConfiguration> getCloudwatchConfiguration() {
     ...
     * 
     */
    @OutputExport(name="ebsVolumes", type=List.class, parameters={HaproxyLayerEbsVolume.class})
     ...
     * 
     */
    public Output</* @Nullable */ List<HaproxyLayerEbsVolume>> getEbsVolumes() {
     ...
     * 
     */
    @OutputExport(name="healthcheckMethod", type=String.class, parameters={})
     ...
     * 
     */
    public Output</* @Nullable */ String> getHealthcheckMethod() {
     ...
     * 
     */
    @OutputExport(name="healthcheckUrl", type=String.class, parameters={})
     ...
     * 
     */
    public Output</* @Nullable */ String> getHealthcheckUrl() {
     ...
     * 
     */
    @OutputExport(name="statsEnabled", type=Boolean.class, parameters={})
     ...
     * 
     */
    public Output</* @Nullable */ Boolean> getStatsEnabled() {
     ...
     * 
     */
    @OutputExport(name="statsPassword", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="statsUrl", type=String.class, parameters={})
     ...
     * 
     */
    public Output</* @Nullable */ String> getStatsUrl() {
     ...
     * 
     */
    @OutputExport(name="statsUser", type=String.class, parameters={})
     ...
     * 
     */
    public Output</* @Nullable */ String> getStatsUser() {
    ...
    public interface BuilderApplicator {
        public void apply(HaproxyLayerArgs.Builder a);
    }
    private static io.pulumi.aws.opsworks.HaproxyLayerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.opsworks.HaproxyLayerArgs.builder();
     ...
     */
    public HaproxyLayer(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public HaproxyLayer(String name, HaproxyLayerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:opsworks/haproxyLayer:HaproxyLayer", name, args == null ? HaproxyLayerArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private HaproxyLayer(String name, Output<String> id, @Nullable HaproxyLayerState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static HaproxyLayer get(String name, Output<String> id, @Nullable HaproxyLayerState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
