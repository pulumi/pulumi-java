...
public class UserStackAssociation extends io.pulumi.resources.CustomResource {
    ...
    public UserStackAssociation(String name, UserStackAssociationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:appstream/userStackAssociation:UserStackAssociation", name, args == null ? UserStackAssociationArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private UserStackAssociation(String name, Input<String> id, @Nullable UserStackAssociationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static UserStackAssociation get(String name, Input<String> id, @Nullable UserStackAssociationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
