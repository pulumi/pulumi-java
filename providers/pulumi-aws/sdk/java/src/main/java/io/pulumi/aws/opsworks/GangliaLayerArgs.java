...
public final class GangliaLayerArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Output<GangliaLayerCloudwatchConfigurationArgs> cloudwatchConfiguration() {
    ...
    public Output<List<GangliaLayerEbsVolumeArgs>> ebsVolumes() {
    ...
    public GangliaLayerArgs(
        ...
        @Nullable Output<GangliaLayerCloudwatchConfigurationArgs> cloudwatchConfiguration,
        ...
        @Nullable Output<List<GangliaLayerEbsVolumeArgs>> ebsVolumes,
