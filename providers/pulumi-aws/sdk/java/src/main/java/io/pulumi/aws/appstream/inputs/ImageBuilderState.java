...
public final class ImageBuilderState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setAccessEndpoints(@Nullable Input<List<ImageBuilderAccessEndpointGetArgs>> accessEndpoints) {
            this.accessEndpoints = accessEndpoints;
            return this;
        }

        public Builder setAccessEndpoints(@Nullable List<ImageBuilderAccessEndpointGetArgs> accessEndpoints) {
        ...
        public Builder setDomainJoinInfo(@Nullable Input<ImageBuilderDomainJoinInfoGetArgs> domainJoinInfo) {
            this.domainJoinInfo = domainJoinInfo;
            return this;
        }

        public Builder setDomainJoinInfo(@Nullable ImageBuilderDomainJoinInfoGetArgs domainJoinInfo) {
        ...
        public Builder setVpcConfig(@Nullable Input<ImageBuilderVpcConfigGetArgs> vpcConfig) {
            this.vpcConfig = vpcConfig;
            return this;
        }

        public Builder setVpcConfig(@Nullable ImageBuilderVpcConfigGetArgs vpcConfig) {
