...
public class ProxyProtocolPolicy extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="instancePorts", type=List.class, parameters={String.class})
    ...
    public interface BuilderApplicator {
        public void apply(ProxyProtocolPolicyArgs.Builder a);
    }
    private static io.pulumi.aws.ec2.ProxyProtocolPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2.ProxyProtocolPolicyArgs.builder();
     ...
     */
    public ProxyProtocolPolicy(String name, BuilderApplicator argsBuilder) {
