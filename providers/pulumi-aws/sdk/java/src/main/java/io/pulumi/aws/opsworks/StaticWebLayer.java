...
import io.pulumi.aws.opsworks.StaticWebLayerArgs;
...
public class StaticWebLayer extends io.pulumi.resources.CustomResource {
    ...
    @OutputExport(name="cloudwatchConfiguration", type=StaticWebLayerCloudwatchConfiguration.class, parameters={})
    private Output</* @Nullable */ StaticWebLayerCloudwatchConfiguration> cloudwatchConfiguration;

    public Output</* @Nullable */ StaticWebLayerCloudwatchConfiguration> getCloudwatchConfiguration() {
     ...
     * 
     */
    @OutputExport(name="ebsVolumes", type=List.class, parameters={StaticWebLayerEbsVolume.class})
    private Output</* @Nullable */ List<StaticWebLayerEbsVolume>> ebsVolumes;

    /**
     * @return `ebs_volume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
     * 
     */
    public Output</* @Nullable */ List<StaticWebLayerEbsVolume>> getEbsVolumes() {
    ...
    public interface BuilderApplicator {
        public void apply(StaticWebLayerArgs.Builder a);
    }
    private static io.pulumi.aws.opsworks.StaticWebLayerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.opsworks.StaticWebLayerArgs.builder();
     ...
     */
    public StaticWebLayer(String name, BuilderApplicator argsBuilder) {
