...
public final class RuleGroupRuleStatementByteMatchStatementFieldToMatchSingleHeaderGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public RuleGroupRuleStatementByteMatchStatementFieldToMatchSingleHeaderGetArgs(Input<String> name) {
