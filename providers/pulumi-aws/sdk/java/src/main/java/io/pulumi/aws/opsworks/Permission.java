...
public class Permission extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.opsworks.PermissionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.opsworks.PermissionArgs.builder();
    ...
    public Permission(String name, PermissionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:opsworks/permission:Permission", name, args == null ? PermissionArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
