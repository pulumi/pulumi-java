...
public class RolePolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RolePolicyArgs.Builder a);
    }
    private static io.pulumi.aws.iam.RolePolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.iam.RolePolicyArgs.builder();
     ...
     */
    public RolePolicy(String name, BuilderApplicator argsBuilder) {
