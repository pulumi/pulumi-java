...
public class Permission extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="eventSourceToken", type=String.class, parameters={})
    ...
    public Permission(String name, PermissionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:lambda/permission:Permission", name, args == null ? PermissionArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private Permission(String name, Input<String> id, @Nullable PermissionState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Permission get(String name, Input<String> id, @Nullable PermissionState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
