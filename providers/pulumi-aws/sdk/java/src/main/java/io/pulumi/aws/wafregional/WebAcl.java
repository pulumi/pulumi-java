...
public class WebAcl extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.wafregional.WebAclArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.wafregional.WebAclArgs.builder();
