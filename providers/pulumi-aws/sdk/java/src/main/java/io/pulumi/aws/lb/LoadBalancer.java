...
import io.pulumi.aws.lb.LoadBalancerArgs;
import io.pulumi.aws.lb.inputs.LoadBalancerState;
import io.pulumi.aws.lb.outputs.LoadBalancerAccessLogs;
import io.pulumi.aws.lb.outputs.LoadBalancerSubnetMapping;
...
public class LoadBalancer extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.lb.LoadBalancerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.lb.LoadBalancerArgs.builder();
    ...
    public LoadBalancer(String name, @Nullable LoadBalancerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:lb/loadBalancer:LoadBalancer", name, args == null ? LoadBalancerArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("aws:elasticloadbalancingv2/loadBalancer:LoadBalancer").build())
            ))
            .build();
