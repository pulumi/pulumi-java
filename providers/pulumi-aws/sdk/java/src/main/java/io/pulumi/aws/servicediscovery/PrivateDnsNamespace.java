...
public class PrivateDnsNamespace extends io.pulumi.resources.CustomResource {
    ...
    public PrivateDnsNamespace(String name, PrivateDnsNamespaceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:servicediscovery/privateDnsNamespace:PrivateDnsNamespace", name, args == null ? PrivateDnsNamespaceArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private PrivateDnsNamespace(String name, Input<String> id, @Nullable PrivateDnsNamespaceState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static PrivateDnsNamespace get(String name, Input<String> id, @Nullable PrivateDnsNamespaceState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
