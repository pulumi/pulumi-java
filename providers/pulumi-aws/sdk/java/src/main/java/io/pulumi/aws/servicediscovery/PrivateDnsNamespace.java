...
import io.pulumi.aws.servicediscovery.PrivateDnsNamespaceArgs;
import io.pulumi.aws.servicediscovery.inputs.PrivateDnsNamespaceState;
...
public class PrivateDnsNamespace extends io.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @OutputExport(name="vpc", type=String.class, parameters={})
    ...
    public interface BuilderApplicator {
        public void apply(PrivateDnsNamespaceArgs.Builder a);
    }
    private static io.pulumi.aws.servicediscovery.PrivateDnsNamespaceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.servicediscovery.PrivateDnsNamespaceArgs.builder();
     ...
     */
    public PrivateDnsNamespace(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public PrivateDnsNamespace(String name, PrivateDnsNamespaceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:servicediscovery/privateDnsNamespace:PrivateDnsNamespace", name, args == null ? PrivateDnsNamespaceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private PrivateDnsNamespace(String name, Output<String> id, @Nullable PrivateDnsNamespaceState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static PrivateDnsNamespace get(String name, Output<String> id, @Nullable PrivateDnsNamespaceState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
