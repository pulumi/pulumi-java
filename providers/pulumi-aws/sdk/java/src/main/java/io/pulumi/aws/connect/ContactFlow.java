...
public class ContactFlow extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ContactFlowArgs.Builder a);
    }
    private static io.pulumi.aws.connect.ContactFlowArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.connect.ContactFlowArgs.builder();
     ...
     */
    public ContactFlow(String name, BuilderApplicator argsBuilder) {
    ...
    public ContactFlow(String name, ContactFlowArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:connect/contactFlow:ContactFlow", name, args == null ? ContactFlowArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ContactFlow(String name, Output<String> id, @Nullable ContactFlowState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ContactFlow get(String name, Output<String> id, @Nullable ContactFlowState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
