...
public final class InsightFiltersProcessTerminatedAtGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public InsightFiltersProcessTerminatedAtGetArgs(
        @Nullable Input<InsightFiltersProcessTerminatedAtDateRangeGetArgs> dateRange,
    ...
    public static final class Builder {
        private @Nullable Input<InsightFiltersProcessTerminatedAtDateRangeGetArgs> dateRange;
        ...
        public Builder setDateRange(@Nullable Input<InsightFiltersProcessTerminatedAtDateRangeGetArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder setDateRange(@Nullable InsightFiltersProcessTerminatedAtDateRangeGetArgs dateRange) {
