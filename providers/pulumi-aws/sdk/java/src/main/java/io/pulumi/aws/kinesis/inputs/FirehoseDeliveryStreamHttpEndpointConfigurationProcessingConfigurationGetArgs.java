...
public final class FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="processors")
      private final @Nullable Input<List<FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorGetArgs>> processors;

    public Input<List<FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorGetArgs>> getProcessors() {
    ...
    public FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationGetArgs(
        ...
        @Nullable Input<List<FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorGetArgs>> processors) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorGetArgs>> processors;
        ...
        public Builder setProcessors(@Nullable Input<List<FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorGetArgs>> processors) {
            this.processors = processors;
            return this;
        }

        public Builder setProcessors(@Nullable List<FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorGetArgs> processors) {
