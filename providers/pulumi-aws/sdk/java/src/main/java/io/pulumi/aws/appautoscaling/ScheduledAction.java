...
public class ScheduledAction extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="scalableTargetAction", type=ScheduledActionScalableTargetAction.class, parameters={})
    ...
    private static io.pulumi.aws.appautoscaling.ScheduledActionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.appautoscaling.ScheduledActionArgs.builder();
    ...
    public ScheduledAction(String name, ScheduledActionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:appautoscaling/scheduledAction:ScheduledAction", name, args == null ? ScheduledActionArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
