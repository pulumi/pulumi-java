...
public final class ListenerRuleConditionHostHeaderArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public ListenerRuleConditionHostHeaderArgs(Input<List<String>> values) {
