...
public final class RailsAppLayerCloudwatchConfigurationLogStream {
    ...
    public static Builder builder(RailsAppLayerCloudwatchConfigurationLogStream defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RailsAppLayerCloudwatchConfigurationLogStream defaults) {
        ...
        public Builder timeZone(@Nullable String timeZone) {
            this.timeZone = timeZone;
            return this;
        }        public RailsAppLayerCloudwatchConfigurationLogStream build() {
            return new RailsAppLayerCloudwatchConfigurationLogStream(batchCount, batchSize, bufferDuration, datetimeFormat, encoding, file, fileFingerprintLines, initialPosition, logGroupName, multilineStartPattern, timeZone);
        }
    }
}
