...
public final class WebAclDefaultActionBlockCustomResponseArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setResponseHeaders(@Nullable Input<List<WebAclDefaultActionBlockCustomResponseResponseHeaderArgs>> responseHeaders) {
            this.responseHeaders = responseHeaders;
            return this;
        }

        public Builder setResponseHeaders(@Nullable List<WebAclDefaultActionBlockCustomResponseResponseHeaderArgs> responseHeaders) {
