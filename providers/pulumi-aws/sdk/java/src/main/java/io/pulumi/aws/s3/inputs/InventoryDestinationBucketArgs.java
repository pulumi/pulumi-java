...
public final class InventoryDestinationBucketArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setEncryption(@Nullable Input<InventoryDestinationBucketEncryptionArgs> encryption) {
            this.encryption = encryption;
            return this;
        }

        public Builder setEncryption(@Nullable InventoryDestinationBucketEncryptionArgs encryption) {
