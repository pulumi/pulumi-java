...
public final class WebAclDefaultActionBlockCustomResponseGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setResponseHeaders(@Nullable Input<List<WebAclDefaultActionBlockCustomResponseResponseHeaderGetArgs>> responseHeaders) {
            this.responseHeaders = responseHeaders;
            return this;
        }

        public Builder setResponseHeaders(@Nullable List<WebAclDefaultActionBlockCustomResponseResponseHeaderGetArgs> responseHeaders) {
