...
public final class DataLakeSettingsState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setAdmins(@Nullable Input<List<String>> admins) {
            this.admins = admins;
            return this;
        }

        public Builder setAdmins(@Nullable List<String> admins) {
        ...
        public Builder setCreateDatabaseDefaultPermissions(@Nullable Input<List<DataLakeSettingsCreateDatabaseDefaultPermissionGetArgs>> createDatabaseDefaultPermissions) {
            this.createDatabaseDefaultPermissions = createDatabaseDefaultPermissions;
            return this;
        }

        public Builder setCreateDatabaseDefaultPermissions(@Nullable List<DataLakeSettingsCreateDatabaseDefaultPermissionGetArgs> createDatabaseDefaultPermissions) {
            this.createDatabaseDefaultPermissions = Input.ofNullable(createDatabaseDefaultPermissions);
            return this;
        }

        public Builder setCreateTableDefaultPermissions(@Nullable Input<List<DataLakeSettingsCreateTableDefaultPermissionGetArgs>> createTableDefaultPermissions) {
            this.createTableDefaultPermissions = createTableDefaultPermissions;
            return this;
        }

        public Builder setCreateTableDefaultPermissions(@Nullable List<DataLakeSettingsCreateTableDefaultPermissionGetArgs> createTableDefaultPermissions) {
            this.createTableDefaultPermissions = Input.ofNullable(createTableDefaultPermissions);
            return this;
        }

        public Builder setTrustedResourceOwners(@Nullable Input<List<String>> trustedResourceOwners) {
            this.trustedResourceOwners = trustedResourceOwners;
            return this;
        }

        public Builder setTrustedResourceOwners(@Nullable List<String> trustedResourceOwners) {
