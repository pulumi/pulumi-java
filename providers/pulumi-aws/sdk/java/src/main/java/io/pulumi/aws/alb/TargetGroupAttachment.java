...
public class TargetGroupAttachment extends io.pulumi.resources.CustomResource {
    ...
    public TargetGroupAttachment(String name, TargetGroupAttachmentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:alb/targetGroupAttachment:TargetGroupAttachment", name, args == null ? TargetGroupAttachmentArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("aws:applicationloadbalancing/targetGroupAttachment:TargetGroupAttachment").build())
            ))
            .build();
