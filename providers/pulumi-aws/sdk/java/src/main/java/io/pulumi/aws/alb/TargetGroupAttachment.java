...
import io.pulumi.aws.alb.TargetGroupAttachmentArgs;
import io.pulumi.aws.alb.inputs.TargetGroupAttachmentState;
...
public class TargetGroupAttachment extends io.pulumi.resources.CustomResource {
    ...
    public TargetGroupAttachment(String name, TargetGroupAttachmentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:alb/targetGroupAttachment:TargetGroupAttachment", name, args == null ? TargetGroupAttachmentArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("aws:applicationloadbalancing/targetGroupAttachment:TargetGroupAttachment").build())
            ))
            .build();
