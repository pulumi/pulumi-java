...
public class OrganizationConfiguration extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.guardduty.OrganizationConfigurationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.guardduty.OrganizationConfigurationArgs.builder();
