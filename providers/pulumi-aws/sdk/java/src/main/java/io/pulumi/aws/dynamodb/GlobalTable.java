...
public class GlobalTable extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.dynamodb.GlobalTableArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.dynamodb.GlobalTableArgs.builder();
