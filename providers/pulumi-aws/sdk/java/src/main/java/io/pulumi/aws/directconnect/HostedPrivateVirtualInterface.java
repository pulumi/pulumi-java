...
public class HostedPrivateVirtualInterface extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(HostedPrivateVirtualInterfaceArgs.Builder a);
    }
    private static io.pulumi.aws.directconnect.HostedPrivateVirtualInterfaceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.directconnect.HostedPrivateVirtualInterfaceArgs.builder();
     ...
     */
    public HostedPrivateVirtualInterface(String name, BuilderApplicator argsBuilder) {
