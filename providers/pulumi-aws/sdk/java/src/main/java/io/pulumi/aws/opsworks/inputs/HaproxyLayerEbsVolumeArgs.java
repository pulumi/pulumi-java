...
public final class HaproxyLayerEbsVolumeArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public HaproxyLayerEbsVolumeArgs build() {
            return new HaproxyLayerEbsVolumeArgs(encrypted, iops, mountPoint, numberOfDisks, raidLevel, size, type);
        }
    }
}
