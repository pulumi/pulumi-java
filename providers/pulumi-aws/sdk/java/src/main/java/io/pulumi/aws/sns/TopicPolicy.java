...
public class TopicPolicy extends io.pulumi.resources.CustomResource {
    ...
    public TopicPolicy(String name, TopicPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:sns/topicPolicy:TopicPolicy", name, args == null ? TopicPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private TopicPolicy(String name, Input<String> id, @Nullable TopicPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TopicPolicy get(String name, Input<String> id, @Nullable TopicPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
