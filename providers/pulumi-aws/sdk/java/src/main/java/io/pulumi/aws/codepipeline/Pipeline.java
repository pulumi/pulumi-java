...
public class Pipeline extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.codepipeline.PipelineArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.codepipeline.PipelineArgs.builder();
    ...
    public Pipeline(String name, PipelineArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:codepipeline/pipeline:Pipeline", name, args == null ? PipelineArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
