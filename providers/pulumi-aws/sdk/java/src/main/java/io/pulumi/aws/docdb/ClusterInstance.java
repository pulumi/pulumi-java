...
public class ClusterInstance extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.docdb.ClusterInstanceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.docdb.ClusterInstanceArgs.builder();
