...
public class NodejsAppLayer extends io.pulumi.resources.CustomResource {
    ...
    @OutputExport(name="cloudwatchConfiguration", type=NodejsAppLayerCloudwatchConfiguration.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="ebsVolumes", type=List.class, parameters={NodejsAppLayerEbsVolume.class})
     ...
     * 
     */
    @OutputExport(name="nodejsVersion", type=String.class, parameters={})
    ...
    public interface BuilderApplicator {
        public void apply(NodejsAppLayerArgs.Builder a);
    }
    private static io.pulumi.aws.opsworks.NodejsAppLayerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.opsworks.NodejsAppLayerArgs.builder();
     ...
     */
    public NodejsAppLayer(String name, BuilderApplicator argsBuilder) {
    ...
    public NodejsAppLayer(String name, NodejsAppLayerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:opsworks/nodejsAppLayer:NodejsAppLayer", name, args == null ? NodejsAppLayerArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private NodejsAppLayer(String name, Input<String> id, @Nullable NodejsAppLayerState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static NodejsAppLayer get(String name, Input<String> id, @Nullable NodejsAppLayerState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
