...
public class Vpc extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable VpcArgs.Builder a);
    }
    private static io.pulumi.aws.ec2.VpcArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2.VpcArgs.builder();
