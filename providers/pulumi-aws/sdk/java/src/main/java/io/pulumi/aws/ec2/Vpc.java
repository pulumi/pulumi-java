...
public class Vpc extends io.pulumi.resources.CustomResource {
    ...
    public Vpc(String name, @Nullable VpcArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/vpc:Vpc", name, args == null ? VpcArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private Vpc(String name, Input<String> id, @Nullable VpcState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Vpc get(String name, Input<String> id, @Nullable VpcState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
