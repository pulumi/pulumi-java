...
public final class DirectoryConnectSettingsGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(DirectoryConnectSettingsGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DirectoryConnectSettingsGetArgs defaults) {
        ...
        public DirectoryConnectSettingsGetArgs build() {
            return new DirectoryConnectSettingsGetArgs(availabilityZones, connectIps, customerDnsIps, customerUsername, subnetIds, vpcId);
        }
    }
}
