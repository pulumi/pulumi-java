...
public class UserProfile extends io.pulumi.resources.CustomResource {
    ...
    public UserProfile(String name, UserProfileArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:sagemaker/userProfile:UserProfile", name, args == null ? UserProfileArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private UserProfile(String name, Input<String> id, @Nullable UserProfileState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static UserProfile get(String name, Input<String> id, @Nullable UserProfileState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
