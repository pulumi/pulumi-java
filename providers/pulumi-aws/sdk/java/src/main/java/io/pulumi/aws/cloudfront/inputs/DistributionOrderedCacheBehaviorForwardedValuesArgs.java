...
public final class DistributionOrderedCacheBehaviorForwardedValuesArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCookies(Input<DistributionOrderedCacheBehaviorForwardedValuesCookiesArgs> cookies) {
            this.cookies = Objects.requireNonNull(cookies);
            return this;
        }

        public Builder setCookies(DistributionOrderedCacheBehaviorForwardedValuesCookiesArgs cookies) {
