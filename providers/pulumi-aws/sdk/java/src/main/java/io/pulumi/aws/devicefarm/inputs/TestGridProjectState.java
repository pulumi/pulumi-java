...
public final class TestGridProjectState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setVpcConfig(@Nullable Input<TestGridProjectVpcConfigGetArgs> vpcConfig) {
            this.vpcConfig = vpcConfig;
            return this;
        }

        public Builder setVpcConfig(@Nullable TestGridProjectVpcConfigGetArgs vpcConfig) {
