...
public final class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsArgs(
        @Nullable Input<List<RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionArgs>> customActions,
        Input<List<RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleArgs>> statelessRules) {
    ...
    public static final class Builder {
        private @Nullable Input<List<RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionArgs>> customActions;
        private Input<List<RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleArgs>> statelessRules;
        ...
        public Builder setCustomActions(@Nullable Input<List<RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionArgs>> customActions) {
            this.customActions = customActions;
            return this;
        }

        public Builder setCustomActions(@Nullable List<RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionArgs> customActions) {
            this.customActions = Input.ofNullable(customActions);
            return this;
        }

        public Builder setStatelessRules(Input<List<RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleArgs>> statelessRules) {
            this.statelessRules = Objects.requireNonNull(statelessRules);
            return this;
        }

        public Builder setStatelessRules(List<RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleArgs> statelessRules) {
