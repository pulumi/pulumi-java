...
import io.pulumi.aws.ec2.inputs.InstanceState;
import io.pulumi.aws.ec2.outputs.InstanceCapacityReservationSpecification;
import io.pulumi.aws.ec2.outputs.InstanceCreditSpecification;
import io.pulumi.aws.ec2.outputs.InstanceEbsBlockDevice;
import io.pulumi.aws.ec2.outputs.InstanceEnclaveOptions;
import io.pulumi.aws.ec2.outputs.InstanceEphemeralBlockDevice;
import io.pulumi.aws.ec2.outputs.InstanceLaunchTemplate;
import io.pulumi.aws.ec2.outputs.InstanceMetadataOptions;
import io.pulumi.aws.ec2.outputs.InstanceNetworkInterface;
import io.pulumi.aws.ec2.outputs.InstanceRootBlockDevice;
...
public class Instance extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="capacityReservationSpecification", type=InstanceCapacityReservationSpecification.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="creditSpecification", type=InstanceCreditSpecification.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="enclaveOptions", type=InstanceEnclaveOptions.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="launchTemplate", type=InstanceLaunchTemplate.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="metadataOptions", type=InstanceMetadataOptions.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="rootBlockDevice", type=InstanceRootBlockDevice.class, parameters={})
    ...
    public Instance(String name, @Nullable InstanceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/instance:Instance", name, args == null ? InstanceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
