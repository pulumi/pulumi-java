...
public class Portfolio extends io.pulumi.resources.CustomResource {
    ...
    public Portfolio(String name, PortfolioArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:servicecatalog/portfolio:Portfolio", name, args == null ? PortfolioArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private Portfolio(String name, Input<String> id, @Nullable PortfolioState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Portfolio get(String name, Input<String> id, @Nullable PortfolioState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
