...
public class MysqlLayer extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(MysqlLayerArgs.Builder a);
    }
    private static io.pulumi.aws.opsworks.MysqlLayerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.opsworks.MysqlLayerArgs.builder();
     ...
     */
    public MysqlLayer(String name, BuilderApplicator argsBuilder) {
