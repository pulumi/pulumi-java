...
public class BucketPublicAccessBlock extends io.pulumi.resources.CustomResource {
    ...
    public BucketPublicAccessBlock(String name, BucketPublicAccessBlockArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:s3/bucketPublicAccessBlock:BucketPublicAccessBlock", name, args == null ? BucketPublicAccessBlockArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private BucketPublicAccessBlock(String name, Input<String> id, @Nullable BucketPublicAccessBlockState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static BucketPublicAccessBlock get(String name, Input<String> id, @Nullable BucketPublicAccessBlockState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
