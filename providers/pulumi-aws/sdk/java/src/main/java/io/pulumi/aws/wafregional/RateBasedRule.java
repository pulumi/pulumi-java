...
public class RateBasedRule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.wafregional.RateBasedRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.wafregional.RateBasedRuleArgs.builder();
    ...
    public RateBasedRule(String name, RateBasedRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:wafregional/rateBasedRule:RateBasedRule", name, args == null ? RateBasedRuleArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
