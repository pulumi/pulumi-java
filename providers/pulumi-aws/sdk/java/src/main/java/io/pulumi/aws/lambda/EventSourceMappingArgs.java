...
public final class EventSourceMappingArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setFilterCriteria(@Nullable Input<EventSourceMappingFilterCriteriaArgs> filterCriteria) {
            this.filterCriteria = filterCriteria;
            return this;
        }

        public Builder setFilterCriteria(@Nullable EventSourceMappingFilterCriteriaArgs filterCriteria) {
