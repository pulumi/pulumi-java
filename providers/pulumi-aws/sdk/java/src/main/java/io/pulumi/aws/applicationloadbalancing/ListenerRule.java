...
import io.pulumi.aws.applicationloadbalancing.ListenerRuleArgs;
import io.pulumi.aws.applicationloadbalancing.inputs.ListenerRuleState;
import io.pulumi.aws.applicationloadbalancing.outputs.ListenerRuleAction;
import io.pulumi.aws.applicationloadbalancing.outputs.ListenerRuleCondition;
...
public class ListenerRule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.applicationloadbalancing.ListenerRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.applicationloadbalancing.ListenerRuleArgs.builder();
    ...
    public ListenerRule(String name, ListenerRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:applicationloadbalancing/listenerRule:ListenerRule", name, args == null ? ListenerRuleArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
