...
public class Agent extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable AgentArgs.Builder a);
    }
    private static io.pulumi.aws.datasync.AgentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.datasync.AgentArgs.builder();
