...
public class SecretRotation extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(SecretRotationArgs.Builder a);
    }
    private static io.pulumi.aws.secretsmanager.SecretRotationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.secretsmanager.SecretRotationArgs.builder();
     ...
     */
    public SecretRotation(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public static SecretRotation get(String name, Output<String> id, @Nullable SecretRotationState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
