...
public final class InsightFiltersThreatIntelIndicatorType {
    ...
    private InsightFiltersThreatIntelIndicatorType(
        String comparison,
        String value) {
    ...
    */
    ...
    public static Builder builder(InsightFiltersThreatIntelIndicatorType defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(InsightFiltersThreatIntelIndicatorType defaults) {
