...
public final class ListenerRuleConditionSourceIpGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public ListenerRuleConditionSourceIpGetArgs(Input<List<String>> values) {
