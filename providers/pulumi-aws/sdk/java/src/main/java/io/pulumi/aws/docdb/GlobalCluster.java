...
public class GlobalCluster extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.docdb.GlobalClusterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.docdb.GlobalClusterArgs.builder();
    ...
    public GlobalCluster(String name, GlobalClusterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:docdb/globalCluster:GlobalCluster", name, args == null ? GlobalClusterArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
