...
public class DataSet extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.dataexchange.DataSetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.dataexchange.DataSetArgs.builder();
