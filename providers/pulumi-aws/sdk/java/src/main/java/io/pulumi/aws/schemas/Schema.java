...
public class Schema extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.schemas.SchemaArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.schemas.SchemaArgs.builder();
    ...
    public Schema(String name, SchemaArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:schemas/schema:Schema", name, args == null ? SchemaArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
