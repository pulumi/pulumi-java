...
public class SchedulingPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.batch.SchedulingPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.batch.SchedulingPolicyArgs.builder();
