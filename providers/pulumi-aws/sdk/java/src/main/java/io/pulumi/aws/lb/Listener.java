...
import io.pulumi.aws.lb.ListenerArgs;
import io.pulumi.aws.lb.inputs.ListenerState;
...
public class Listener extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.lb.ListenerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.lb.ListenerArgs.builder();
    ...
    public Listener(String name, ListenerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:lb/listener:Listener", name, args == null ? ListenerArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("aws:elasticloadbalancingv2/listener:Listener").build())
            ))
            .build();
