...
public final class RouteState extends io.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @InputImport(name="instanceOwnerId")
      private final @Nullable Input<String> instanceOwnerId;

    public Input<String> getInstanceOwnerId() {
        return this.instanceOwnerId == null ? Input.empty() : this.instanceOwnerId;
    }
    ...
    public RouteState(
        ...
        @Nullable Input<String> instanceOwnerId,
    ...
    private RouteState() {
        ...
        this.instanceOwnerId = Input.empty();
    ...
    public static final class Builder {
        ...
        private @Nullable Input<String> instanceOwnerId;
        ...
        public Builder setDestinationIpv6CidrBlock(@Nullable Input<String> destinationIpv6CidrBlock) {
            this.destinationIpv6CidrBlock = destinationIpv6CidrBlock;
            return this;
        }
        ...
        public Builder setInstanceOwnerId(@Nullable Input<String> instanceOwnerId) {
            this.instanceOwnerId = instanceOwnerId;
            return this;
        }

        public Builder setInstanceOwnerId(@Nullable String instanceOwnerId) {
            this.instanceOwnerId = Input.ofNullable(instanceOwnerId);
            return this;
        }
