...
public final class EndpointConfigurationDataCaptureConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCaptureContentTypeHeader(@Nullable Input<EndpointConfigurationDataCaptureConfigCaptureContentTypeHeaderArgs> captureContentTypeHeader) {
            this.captureContentTypeHeader = captureContentTypeHeader;
            return this;
        }

        public Builder setCaptureContentTypeHeader(@Nullable EndpointConfigurationDataCaptureConfigCaptureContentTypeHeaderArgs captureContentTypeHeader) {
            this.captureContentTypeHeader = Input.ofNullable(captureContentTypeHeader);
            return this;
        }

        public Builder setCaptureOptions(Input<List<EndpointConfigurationDataCaptureConfigCaptureOptionArgs>> captureOptions) {
            this.captureOptions = Objects.requireNonNull(captureOptions);
            return this;
        }

        public Builder setCaptureOptions(List<EndpointConfigurationDataCaptureConfigCaptureOptionArgs> captureOptions) {
