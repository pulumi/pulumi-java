...
public final class GroupArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setInitialLifecycleHooks(@Nullable Input<List<GroupInitialLifecycleHookArgs>> initialLifecycleHooks) {
            this.initialLifecycleHooks = initialLifecycleHooks;
            return this;
        }

        public Builder setInitialLifecycleHooks(@Nullable List<GroupInitialLifecycleHookArgs> initialLifecycleHooks) {
            this.initialLifecycleHooks = Input.ofNullable(initialLifecycleHooks);
            return this;
        }

        public Builder setInstanceRefresh(@Nullable Input<GroupInstanceRefreshArgs> instanceRefresh) {
            this.instanceRefresh = instanceRefresh;
            return this;
        }

        public Builder setInstanceRefresh(@Nullable GroupInstanceRefreshArgs instanceRefresh) {
        ...
        public Builder setLaunchTemplate(@Nullable Input<GroupLaunchTemplateArgs> launchTemplate) {
            this.launchTemplate = launchTemplate;
            return this;
        }

        public Builder setLaunchTemplate(@Nullable GroupLaunchTemplateArgs launchTemplate) {
        ...
        public Builder setMixedInstancesPolicy(@Nullable Input<GroupMixedInstancesPolicyArgs> mixedInstancesPolicy) {
            this.mixedInstancesPolicy = mixedInstancesPolicy;
            return this;
        }

        public Builder setMixedInstancesPolicy(@Nullable GroupMixedInstancesPolicyArgs mixedInstancesPolicy) {
        ...
        public Builder setWarmPool(@Nullable Input<GroupWarmPoolArgs> warmPool) {
            this.warmPool = warmPool;
            return this;
        }

        public Builder setWarmPool(@Nullable GroupWarmPoolArgs warmPool) {
