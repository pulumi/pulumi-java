...
public class OrganizationCustomRule extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="lambdaFunctionArn", type=String.class, parameters={})
     ...
     * 
     */
    @OutputExport(name="triggerTypes", type=List.class, parameters={String.class})
    ...
    public interface BuilderApplicator {
        public void apply(OrganizationCustomRuleArgs.Builder a);
    }
    private static io.pulumi.aws.cfg.OrganizationCustomRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.cfg.OrganizationCustomRuleArgs.builder();
     ...
     */
    public OrganizationCustomRule(String name, BuilderApplicator argsBuilder) {
    ...
    public OrganizationCustomRule(String name, OrganizationCustomRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:cfg/organizationCustomRule:OrganizationCustomRule", name, args == null ? OrganizationCustomRuleArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
