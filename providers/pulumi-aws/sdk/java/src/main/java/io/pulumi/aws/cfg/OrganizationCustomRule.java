...
public class OrganizationCustomRule extends io.pulumi.resources.CustomResource {
    ...
    public OrganizationCustomRule(String name, OrganizationCustomRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:cfg/organizationCustomRule:OrganizationCustomRule", name, args == null ? OrganizationCustomRuleArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private OrganizationCustomRule(String name, Input<String> id, @Nullable OrganizationCustomRuleState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static OrganizationCustomRule get(String name, Input<String> id, @Nullable OrganizationCustomRuleState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
