...
public final class ListenerRuleConditionPathPatternArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public ListenerRuleConditionPathPatternArgs(Input<List<String>> values) {
