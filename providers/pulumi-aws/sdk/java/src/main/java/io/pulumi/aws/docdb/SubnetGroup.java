...
public class SubnetGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.docdb.SubnetGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.docdb.SubnetGroupArgs.builder();
