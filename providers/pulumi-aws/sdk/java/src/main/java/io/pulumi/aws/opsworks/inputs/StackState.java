...
public final class StackState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCustomCookbooksSources(@Nullable Input<List<StackCustomCookbooksSourceGetArgs>> customCookbooksSources) {
            this.customCookbooksSources = customCookbooksSources;
            return this;
        }

        public Builder setCustomCookbooksSources(@Nullable List<StackCustomCookbooksSourceGetArgs> customCookbooksSources) {
        ...
        public Builder setDefaultInstanceProfileArn(@Nullable Input<String> defaultInstanceProfileArn) {
            this.defaultInstanceProfileArn = defaultInstanceProfileArn;
            return this;
        }

        public Builder setDefaultInstanceProfileArn(@Nullable String defaultInstanceProfileArn) {
        ...
        public Builder setStackEndpoint(@Nullable Input<String> stackEndpoint) {
            this.stackEndpoint = stackEndpoint;
            return this;
        }

        public Builder setStackEndpoint(@Nullable String stackEndpoint) {
