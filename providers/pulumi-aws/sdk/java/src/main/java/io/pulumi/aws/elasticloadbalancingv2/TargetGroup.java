...
import io.pulumi.aws.elasticloadbalancingv2.TargetGroupArgs;
import io.pulumi.aws.elasticloadbalancingv2.inputs.TargetGroupState;
import io.pulumi.aws.elasticloadbalancingv2.outputs.TargetGroupHealthCheck;
...
public class TargetGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.elasticloadbalancingv2.TargetGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.elasticloadbalancingv2.TargetGroupArgs.builder();
    ...
    public TargetGroup(String name, @Nullable TargetGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:elasticloadbalancingv2/targetGroup:TargetGroup", name, args == null ? TargetGroupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
