...
public class DefaultVpcDhcpOptions extends io.pulumi.resources.CustomResource {
    ...
    public DefaultVpcDhcpOptions(String name, @Nullable DefaultVpcDhcpOptionsArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/defaultVpcDhcpOptions:DefaultVpcDhcpOptions", name, args == null ? DefaultVpcDhcpOptionsArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private DefaultVpcDhcpOptions(String name, Input<String> id, @Nullable DefaultVpcDhcpOptionsState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static DefaultVpcDhcpOptions get(String name, Input<String> id, @Nullable DefaultVpcDhcpOptionsState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
