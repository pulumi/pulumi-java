...
public final class JavaAppLayerEbsVolumeArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public JavaAppLayerEbsVolumeArgs build() {
            return new JavaAppLayerEbsVolumeArgs(encrypted, iops, mountPoint, numberOfDisks, raidLevel, size, type);
        }
    }
}
