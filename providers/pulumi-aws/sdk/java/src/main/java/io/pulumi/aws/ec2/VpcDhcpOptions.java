...
public class VpcDhcpOptions extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable VpcDhcpOptionsArgs.Builder a);
    }
    private static io.pulumi.aws.ec2.VpcDhcpOptionsArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.ec2.VpcDhcpOptionsArgs.builder();
     ...
     */
    public VpcDhcpOptions(String name, BuilderApplicator argsBuilder) {
