...
public class ResourcePolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.networkfirewall.ResourcePolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.networkfirewall.ResourcePolicyArgs.builder();
    ...
    public ResourcePolicy(String name, ResourcePolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:networkfirewall/resourcePolicy:ResourcePolicy", name, args == null ? ResourcePolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
