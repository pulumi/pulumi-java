...
public class UploadBuffer extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(UploadBufferArgs.Builder a);
    }
    private static io.pulumi.aws.storagegateway.UploadBufferArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.storagegateway.UploadBufferArgs.builder();
     ...
     */
    public UploadBuffer(String name, BuilderApplicator argsBuilder) {
