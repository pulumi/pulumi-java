...
public final class InsightFiltersProcessTerminatedAt {
    ...
    private InsightFiltersProcessTerminatedAt(
        @Nullable InsightFiltersProcessTerminatedAtDateRange dateRange,
        @Nullable String end,
     ...
     * 
     */
    public Optional<InsightFiltersProcessTerminatedAtDateRange> getDateRange() {
    ...
    public static final class Builder {
        ...
        public Builder setDateRange(@Nullable InsightFiltersProcessTerminatedAtDateRange dateRange) {
            this.dateRange = dateRange;
            return this;
        }
