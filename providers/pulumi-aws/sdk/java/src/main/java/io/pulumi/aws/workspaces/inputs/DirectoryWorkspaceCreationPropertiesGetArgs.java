...
public final class DirectoryWorkspaceCreationPropertiesGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final DirectoryWorkspaceCreationPropertiesGetArgs Empty = new DirectoryWorkspaceCreationPropertiesGetArgs();
    ...
    public static Builder builder(DirectoryWorkspaceCreationPropertiesGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DirectoryWorkspaceCreationPropertiesGetArgs defaults) {
        ...
        public Builder userEnabledAsLocalAdministrator(@Nullable Boolean userEnabledAsLocalAdministrator) {
            ...
            return new DirectoryWorkspaceCreationPropertiesGetArgs(customSecurityGroupId, defaultOu, enableInternetAccess, enableMaintenanceMode, userEnabledAsLocalAdministrator);
        }
    }
}
