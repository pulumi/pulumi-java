...
public class GraphQLApi extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(GraphQLApiArgs.Builder a);
    }
    private static io.pulumi.aws.appsync.GraphQLApiArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.appsync.GraphQLApiArgs.builder();
     ...
     */
    public GraphQLApi(String name, BuilderApplicator argsBuilder) {
