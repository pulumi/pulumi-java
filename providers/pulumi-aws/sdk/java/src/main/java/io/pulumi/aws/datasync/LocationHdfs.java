...
public class LocationHdfs extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.datasync.LocationHdfsArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.datasync.LocationHdfsArgs.builder();
     ...
     */
    public static LocationHdfs get(String name, Output<String> id, @Nullable LocationHdfsState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
