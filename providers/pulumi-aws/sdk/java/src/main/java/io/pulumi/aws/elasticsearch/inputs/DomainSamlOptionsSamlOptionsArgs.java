...
public final class DomainSamlOptionsSamlOptionsArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public DomainSamlOptionsSamlOptionsArgs(
        ...
        @Nullable Input<DomainSamlOptionsSamlOptionsIdpArgs> idp,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<DomainSamlOptionsSamlOptionsIdpArgs> idp;
        ...
        public Builder setIdp(@Nullable Input<DomainSamlOptionsSamlOptionsIdpArgs> idp) {
            this.idp = idp;
            return this;
        }

        public Builder setIdp(@Nullable DomainSamlOptionsSamlOptionsIdpArgs idp) {
