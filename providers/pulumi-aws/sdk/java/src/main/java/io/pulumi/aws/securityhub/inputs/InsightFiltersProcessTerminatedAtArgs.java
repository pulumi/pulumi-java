...
public final class InsightFiltersProcessTerminatedAtArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<InsightFiltersProcessTerminatedAtDateRangeArgs> dateRange;

    public Input<InsightFiltersProcessTerminatedAtDateRangeArgs> getDateRange() {
    ...
    public InsightFiltersProcessTerminatedAtArgs(
        @Nullable Input<InsightFiltersProcessTerminatedAtDateRangeArgs> dateRange,
    ...
    public static final class Builder {
        private @Nullable Input<InsightFiltersProcessTerminatedAtDateRangeArgs> dateRange;
        ...
        public Builder setDateRange(@Nullable Input<InsightFiltersProcessTerminatedAtDateRangeArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder setDateRange(@Nullable InsightFiltersProcessTerminatedAtDateRangeArgs dateRange) {
