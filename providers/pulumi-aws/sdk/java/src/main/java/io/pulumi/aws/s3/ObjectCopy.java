...
public class ObjectCopy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ObjectCopyArgs.Builder a);
    }
    private static io.pulumi.aws.s3.ObjectCopyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.s3.ObjectCopyArgs.builder();
     ...
     */
    public ObjectCopy(String name, BuilderApplicator argsBuilder) {
