...
public class Alias extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.gamelift.AliasArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.gamelift.AliasArgs.builder();
    ...
    public Alias(String name, AliasArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:gamelift/alias:Alias", name, args == null ? AliasArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
