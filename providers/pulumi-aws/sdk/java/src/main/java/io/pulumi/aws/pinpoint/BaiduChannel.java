...
public class BaiduChannel extends io.pulumi.resources.CustomResource {
     ...
     */
    public static BaiduChannel get(String name, Output<String> id, @Nullable BaiduChannelState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
