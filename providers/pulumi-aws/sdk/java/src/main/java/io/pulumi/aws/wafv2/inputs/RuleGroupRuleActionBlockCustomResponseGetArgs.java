...
public final class RuleGroupRuleActionBlockCustomResponseGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public RuleGroupRuleActionBlockCustomResponseGetArgs(
        ...
        @Nullable Input<List<RuleGroupRuleActionBlockCustomResponseResponseHeaderGetArgs>> responseHeaders) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<RuleGroupRuleActionBlockCustomResponseResponseHeaderGetArgs>> responseHeaders;
        ...
        public Builder setResponseHeaders(@Nullable Input<List<RuleGroupRuleActionBlockCustomResponseResponseHeaderGetArgs>> responseHeaders) {
            this.responseHeaders = responseHeaders;
            return this;
        }

        public Builder setResponseHeaders(@Nullable List<RuleGroupRuleActionBlockCustomResponseResponseHeaderGetArgs> responseHeaders) {
