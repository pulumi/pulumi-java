...
public final class PolicyStepScalingPolicyConfigurationArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public PolicyStepScalingPolicyConfigurationArgs(
        ...
        @Nullable Input<List<PolicyStepScalingPolicyConfigurationStepAdjustmentArgs>> stepAdjustments) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<PolicyStepScalingPolicyConfigurationStepAdjustmentArgs>> stepAdjustments;
        ...
        public Builder setStepAdjustments(@Nullable Input<List<PolicyStepScalingPolicyConfigurationStepAdjustmentArgs>> stepAdjustments) {
            this.stepAdjustments = stepAdjustments;
            return this;
        }

        public Builder setStepAdjustments(@Nullable List<PolicyStepScalingPolicyConfigurationStepAdjustmentArgs> stepAdjustments) {
