...
public class ResolverRule extends io.pulumi.resources.CustomResource {
    ...
    public ResolverRule(String name, ResolverRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:route53/resolverRule:ResolverRule", name, args == null ? ResolverRuleArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ResolverRule(String name, Input<String> id, @Nullable ResolverRuleState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ResolverRule get(String name, Input<String> id, @Nullable ResolverRuleState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
