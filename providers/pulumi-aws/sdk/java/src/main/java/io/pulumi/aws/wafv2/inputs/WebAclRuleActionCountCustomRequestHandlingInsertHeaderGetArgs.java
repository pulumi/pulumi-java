...
public final class WebAclRuleActionCountCustomRequestHandlingInsertHeaderGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public WebAclRuleActionCountCustomRequestHandlingInsertHeaderGetArgs(
        Input<String> name,
        Input<String> value) {
    ...
    public static final class Builder {
        ...
        public WebAclRuleActionCountCustomRequestHandlingInsertHeaderGetArgs build() {
            return new WebAclRuleActionCountCustomRequestHandlingInsertHeaderGetArgs(name, value);
        }
    }
}
