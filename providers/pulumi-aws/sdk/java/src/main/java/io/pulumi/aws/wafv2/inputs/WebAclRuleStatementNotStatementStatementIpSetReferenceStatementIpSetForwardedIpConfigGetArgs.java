...
public final class WebAclRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs Empty = new WebAclRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs();
    ...
    public WebAclRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs(
    ...
    private WebAclRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs() {
    ...
    public static Builder builder(WebAclRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WebAclRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs defaults) {
        ...
        public WebAclRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs build() {
            return new WebAclRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigGetArgs(fallbackBehavior, headerName, position);
        }
    }
}
