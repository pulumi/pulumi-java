...
public final class InsightFiltersUpdatedAtGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="dateRange")
      private final @Nullable Output<InsightFiltersUpdatedAtDateRangeGetArgs> dateRange;

    public Output<InsightFiltersUpdatedAtDateRangeGetArgs> getDateRange() {
    ...
    public InsightFiltersUpdatedAtGetArgs(
        @Nullable Output<InsightFiltersUpdatedAtDateRangeGetArgs> dateRange,
