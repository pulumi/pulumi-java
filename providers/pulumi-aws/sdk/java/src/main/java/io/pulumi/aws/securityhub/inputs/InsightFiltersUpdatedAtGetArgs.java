...
import io.pulumi.aws.securityhub.inputs.InsightFiltersUpdatedAtDateRangeGetArgs;
...
public final class InsightFiltersUpdatedAtGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="dateRange")
      private final @Nullable Input<InsightFiltersUpdatedAtDateRangeGetArgs> dateRange;

    public Input<InsightFiltersUpdatedAtDateRangeGetArgs> getDateRange() {
    ...
    public InsightFiltersUpdatedAtGetArgs(
        @Nullable Input<InsightFiltersUpdatedAtDateRangeGetArgs> dateRange,
    ...
    public static final class Builder {
        private @Nullable Input<InsightFiltersUpdatedAtDateRangeGetArgs> dateRange;
        ...
        public Builder setDateRange(@Nullable Input<InsightFiltersUpdatedAtDateRangeGetArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder setDateRange(@Nullable InsightFiltersUpdatedAtDateRangeGetArgs dateRange) {
        ...
        public InsightFiltersUpdatedAtGetArgs build() {
            return new InsightFiltersUpdatedAtGetArgs(dateRange, end, start);
        }
    }
}
