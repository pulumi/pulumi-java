...
public final class InsightFiltersUpdatedAtGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder dateRange(@Nullable Input<InsightFiltersUpdatedAtDateRangeGetArgs> dateRange) {
            this.dateRange = dateRange;
            return this;
        }

        public Builder dateRange(@Nullable InsightFiltersUpdatedAtDateRangeGetArgs dateRange) {
