...
public class UsagePlanKey extends io.pulumi.resources.CustomResource {
    ...
    public UsagePlanKey(String name, UsagePlanKeyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:apigateway/usagePlanKey:UsagePlanKey", name, args == null ? UsagePlanKeyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private UsagePlanKey(String name, Input<String> id, @Nullable UsagePlanKeyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static UsagePlanKey get(String name, Input<String> id, @Nullable UsagePlanKeyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
