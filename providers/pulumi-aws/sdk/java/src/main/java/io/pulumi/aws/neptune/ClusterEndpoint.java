...
public class ClusterEndpoint extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.aws.neptune.ClusterEndpointArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.neptune.ClusterEndpointArgs.builder();
