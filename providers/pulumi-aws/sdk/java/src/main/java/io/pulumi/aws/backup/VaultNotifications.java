...
public class VaultNotifications extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="backupVaultEvents", type=List.class, parameters={String.class})
    ...
    public interface BuilderApplicator {
        public void apply(VaultNotificationsArgs.Builder a);
    }
    private static io.pulumi.aws.backup.VaultNotificationsArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.backup.VaultNotificationsArgs.builder();
     ...
     */
    public VaultNotifications(String name, BuilderApplicator argsBuilder) {
