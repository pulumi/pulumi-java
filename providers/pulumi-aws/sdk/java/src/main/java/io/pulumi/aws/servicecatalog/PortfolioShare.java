...
public class PortfolioShare extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PortfolioShareArgs.Builder a);
    }
    private static io.pulumi.aws.servicecatalog.PortfolioShareArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.servicecatalog.PortfolioShareArgs.builder();
     ...
     */
    public PortfolioShare(String name, BuilderApplicator argsBuilder) {
    ...
    public PortfolioShare(String name, PortfolioShareArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:servicecatalog/portfolioShare:PortfolioShare", name, args == null ? PortfolioShareArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private PortfolioShare(String name, Input<String> id, @Nullable PortfolioShareState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static PortfolioShare get(String name, Input<String> id, @Nullable PortfolioShareState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
