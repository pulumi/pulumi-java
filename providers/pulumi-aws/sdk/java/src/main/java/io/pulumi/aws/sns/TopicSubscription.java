...
public class TopicSubscription extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(TopicSubscriptionArgs.Builder a);
    }
    private static io.pulumi.aws.sns.TopicSubscriptionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.sns.TopicSubscriptionArgs.builder();
     ...
     */
    public TopicSubscription(String name, BuilderApplicator argsBuilder) {
