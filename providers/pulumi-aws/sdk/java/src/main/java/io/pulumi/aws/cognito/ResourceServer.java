...
public class ResourceServer extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ResourceServerArgs.Builder a);
    }
    private static io.pulumi.aws.cognito.ResourceServerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.cognito.ResourceServerArgs.builder();
     ...
     */
    public ResourceServer(String name, BuilderApplicator argsBuilder) {
