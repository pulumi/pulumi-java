...
import io.pulumi.aws.wafv2.inputs.WebAclRuleStatementNotStatementStatementOrStatementStatementArgs;
...
public final class WebAclRuleStatementNotStatementStatementOrStatementArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<List<WebAclRuleStatementNotStatementStatementOrStatementStatementArgs>> statements;

    public Input<List<WebAclRuleStatementNotStatementStatementOrStatementStatementArgs>> getStatements() {
        return this.statements;
    }

    public WebAclRuleStatementNotStatementStatementOrStatementArgs(Input<List<WebAclRuleStatementNotStatementStatementOrStatementStatementArgs>> statements) {
    ...
    public static final class Builder {
        private Input<List<WebAclRuleStatementNotStatementStatementOrStatementStatementArgs>> statements;
