...
public class FlowDefinition extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(FlowDefinitionArgs.Builder a);
    }
    private static io.pulumi.aws.sagemaker.FlowDefinitionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.sagemaker.FlowDefinitionArgs.builder();
     ...
     */
    public FlowDefinition(String name, BuilderApplicator argsBuilder) {
