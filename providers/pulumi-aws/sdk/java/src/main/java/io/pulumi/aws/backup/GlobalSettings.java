...
public class GlobalSettings extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(GlobalSettingsArgs.Builder a);
    }
    private static io.pulumi.aws.backup.GlobalSettingsArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.backup.GlobalSettingsArgs.builder();
     ...
     */
    public GlobalSettings(String name, BuilderApplicator argsBuilder) {
