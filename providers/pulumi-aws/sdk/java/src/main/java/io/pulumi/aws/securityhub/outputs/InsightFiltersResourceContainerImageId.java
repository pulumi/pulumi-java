...
@CustomType
public final class InsightFiltersResourceContainerImageId {
    /**
    ...
    */
    ...
    public static Builder builder(InsightFiltersResourceContainerImageId defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(InsightFiltersResourceContainerImageId defaults) {
