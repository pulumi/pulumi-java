...
public final class DetectorDatasourcesArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public DetectorDatasourcesArgs(@Nullable Input<DetectorDatasourcesS3LogsArgs> s3Logs) {
        this.s3Logs = s3Logs;
    }
    ...
    public static final class Builder {
        private @Nullable Input<DetectorDatasourcesS3LogsArgs> s3Logs;
        ...
        public Builder setS3Logs(@Nullable Input<DetectorDatasourcesS3LogsArgs> s3Logs) {
            this.s3Logs = s3Logs;
            return this;
        }

        public Builder setS3Logs(@Nullable DetectorDatasourcesS3LogsArgs s3Logs) {
