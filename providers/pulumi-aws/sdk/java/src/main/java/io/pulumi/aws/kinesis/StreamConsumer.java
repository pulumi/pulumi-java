...
public class StreamConsumer extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(StreamConsumerArgs.Builder a);
    }
    private static io.pulumi.aws.kinesis.StreamConsumerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.kinesis.StreamConsumerArgs.builder();
     ...
     */
    public StreamConsumer(String name, BuilderApplicator argsBuilder) {
    ...
    public StreamConsumer(String name, StreamConsumerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:kinesis/streamConsumer:StreamConsumer", name, args == null ? StreamConsumerArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private StreamConsumer(String name, Input<String> id, @Nullable StreamConsumerState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static StreamConsumer get(String name, Input<String> id, @Nullable StreamConsumerState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
