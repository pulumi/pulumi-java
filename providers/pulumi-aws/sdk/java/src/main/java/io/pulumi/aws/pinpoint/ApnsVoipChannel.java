...
import io.pulumi.aws.pinpoint.ApnsVoipChannelArgs;
...
public class ApnsVoipChannel extends io.pulumi.resources.CustomResource {
    /**
     * The application ID.
     * 
     */
    ...
    public interface BuilderApplicator {
        public void apply(ApnsVoipChannelArgs.Builder a);
    }
    private static io.pulumi.aws.pinpoint.ApnsVoipChannelArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.aws.pinpoint.ApnsVoipChannelArgs.builder();
     ...
     */
    public ApnsVoipChannel(String name, BuilderApplicator argsBuilder) {
    ...
    public ApnsVoipChannel(String name, ApnsVoipChannelArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws:pinpoint/apnsVoipChannel:ApnsVoipChannel", name, args == null ? ApnsVoipChannelArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ApnsVoipChannel(String name, Input<String> id, @Nullable ApnsVoipChannelState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ApnsVoipChannel get(String name, Input<String> id, @Nullable ApnsVoipChannelState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
