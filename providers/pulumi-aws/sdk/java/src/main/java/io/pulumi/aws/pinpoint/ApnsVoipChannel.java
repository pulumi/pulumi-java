...
public class ApnsVoipChannel extends io.pulumi.resources.CustomResource {
     ...
     */
    public static ApnsVoipChannel get(String name, Output<String> id, @Nullable ApnsVoipChannelState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
