...
public final class OrganizationCustomRuleArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setLambdaFunctionArn(Input<String> lambdaFunctionArn) {
            this.lambdaFunctionArn = Objects.requireNonNull(lambdaFunctionArn);
            return this;
        }

        public Builder setLambdaFunctionArn(String lambdaFunctionArn) {
        ...
        public Builder setTriggerTypes(Input<List<String>> triggerTypes) {
            this.triggerTypes = Objects.requireNonNull(triggerTypes);
            return this;
        }

        public Builder setTriggerTypes(List<String> triggerTypes) {
