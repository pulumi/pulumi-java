...
public final class ClassifierJsonClassifierGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public ClassifierJsonClassifierGetArgs(Input<String> jsonPath) {
