...
public final class FirewallPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setFirewallPolicy(Input<FirewallPolicyFirewallPolicyArgs> firewallPolicy) {
            this.firewallPolicy = Objects.requireNonNull(firewallPolicy);
            return this;
        }

        public Builder setFirewallPolicy(FirewallPolicyFirewallPolicyArgs firewallPolicy) {
