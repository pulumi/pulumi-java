...
public final class MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder cloudwatchConfig(@Nullable Input<MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersCloudwatchConfigArgs> cloudwatchConfig) {
            this.cloudwatchConfig = cloudwatchConfig;
            return this;
        }
        ...
        public Builder notificationConfig(@Nullable Input<MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersNotificationConfigArgs> notificationConfig) {
            this.notificationConfig = notificationConfig;
            return this;
        }
        ...
        public Builder parameters(@Nullable Input<List<MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersParameterArgs>> parameters) {
            this.parameters = parameters;
            return this;
        }
