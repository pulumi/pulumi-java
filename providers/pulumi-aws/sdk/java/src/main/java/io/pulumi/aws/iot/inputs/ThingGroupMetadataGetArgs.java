...
public final class ThingGroupMetadataGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public ThingGroupMetadataGetArgs(
        ...
        @Nullable Input<List<ThingGroupMetadataRootToParentGroupGetArgs>> rootToParentGroups) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<ThingGroupMetadataRootToParentGroupGetArgs>> rootToParentGroups;
        ...
        public Builder setRootToParentGroups(@Nullable Input<List<ThingGroupMetadataRootToParentGroupGetArgs>> rootToParentGroups) {
            this.rootToParentGroups = rootToParentGroups;
            return this;
        }

        public Builder setRootToParentGroups(@Nullable List<ThingGroupMetadataRootToParentGroupGetArgs> rootToParentGroups) {
