 ...
 *             .identity(BackupVaultIdentity.builder()
 *                 .type(&#34;SystemAssigned&#34;)
 *                 .build())
 *             .build());
 * 
 ...
 *                     .build(),
 *                 KeyVaultAccessPolicy.builder()
 *                     .tenantId(exampleBackupVault.getIdentity().apply(identity -&gt; identity.getTenantId()))
 *                     .objectId(exampleBackupVault.getIdentity().apply(identity -&gt; identity.getPrincipalId()))
 *                     .keyPermissions(                    
 *                         &#34;create&#34;,
 *                         &#34;get&#34;)
 *                     .secretPermissions(                    
 ...
 *             .value(Output.tuple(exampleServer.getName(), exampleDatabase.getName(), exampleServer.getName()).apply(values -&gt; {
 ...
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .vaultName(exampleBackupVault.getName())
 *             .backupRepeatingTimeIntervals(&#34;R/2021-05-23T02:30:00+00:00/P1W&#34;)
 *             .defaultRetentionDuration(&#34;P4M&#34;)
 *             .build());
 * 
 *         var exampleAssignment = new Assignment(&#34;exampleAssignment&#34;, AssignmentArgs.builder()        
 *             .scope(exampleServer.getId())
 *             .roleDefinitionName(&#34;Reader&#34;)
 *             .principalId(exampleBackupVault.getIdentity().apply(identity -&gt; identity.getPrincipalId()))
 *             .build());
 * 
 ...
 *             .location(exampleResourceGroup.getLocation())
 *             .vaultId(exampleBackupVault.getId())
 *             .databaseId(exampleDatabase.getId())
 *             .backupPolicyId(exampleBackupPolicyPostgresql.getId())
 *             .databaseCredentialKeyVaultSecretId(exampleSecret.getVersionlessId())
 *             .build());
 * 
 *         }
 * }
