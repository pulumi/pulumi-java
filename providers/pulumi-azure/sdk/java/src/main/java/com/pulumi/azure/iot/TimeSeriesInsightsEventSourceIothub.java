 ...
 *             .skuName(&#34;L1&#34;)
 *             .idProperties(&#34;id&#34;)
 *             .storage(TimeSeriesInsightsGen2EnvironmentStorage.builder()
 *                 .name(storage.getName())
 *                 .key(storage.getPrimaryAccessKey())
 *                 .build())
 *             .build());
 * 
 ...
 *             .location(exampleResourceGroup.getLocation())
 *             .environmentId(exampleTimeSeriesInsightsGen2Environment.getId())
 *             .iothubName(exampleIoTHub.getName())
 *             .sharedAccessKey(exampleIoTHub.getSharedAccessPolicies().apply(sharedAccessPolicies -&gt; sharedAccessPolicies[0].getPrimaryKey()))
 *             .sharedAccessKeyName(exampleIoTHub.getSharedAccessPolicies().apply(sharedAccessPolicies -&gt; sharedAccessPolicies[0].getKeyName()))
 *             .consumerGroupName(exampleConsumerGroup.getName())
 *             .eventSourceResourceId(exampleIoTHub.getId())
 *             .build());
 * 
 *         }
 * }
