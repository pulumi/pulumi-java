...
public final class FeaturesKeyVault {
    ...
    public static final class Builder {
        ...
        public Builder recoverSoftDeletedSecrets(@Nullable Boolean recoverSoftDeletedSecrets) {
            ...
            return new FeaturesKeyVault(purgeSoftDeleteOnDestroy, purgeSoftDeletedCertificatesOnDestroy, purgeSoftDeletedKeysOnDestroy, purgeSoftDeletedSecretsOnDestroy, recoverSoftDeletedCertificates, recoverSoftDeletedKeyVaults, recoverSoftDeletedKeys, recoverSoftDeletedSecrets);
        }
    }
}
