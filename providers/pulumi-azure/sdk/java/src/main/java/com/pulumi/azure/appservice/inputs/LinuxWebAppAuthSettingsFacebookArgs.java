...
public final class LinuxWebAppAuthSettingsFacebookArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppAuthSettingsFacebookArgs Empty = new LinuxWebAppAuthSettingsFacebookArgs();
    ...
    private LinuxWebAppAuthSettingsFacebookArgs() {}

    private LinuxWebAppAuthSettingsFacebookArgs(LinuxWebAppAuthSettingsFacebookArgs $) {
        this.appId = $.appId;
    ...
    public static Builder builder(LinuxWebAppAuthSettingsFacebookArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppAuthSettingsFacebookArgs();
        }

        public Builder(LinuxWebAppAuthSettingsFacebookArgs defaults) {
            $ = new LinuxWebAppAuthSettingsFacebookArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppAuthSettingsFacebookArgs build() {
