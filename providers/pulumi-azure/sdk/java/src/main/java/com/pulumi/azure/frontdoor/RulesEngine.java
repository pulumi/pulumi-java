 ...
 *             .frontdoorName(azurerm_frontdoor.getExample().getName())
 *             .resourceGroupName(azurerm_frontdoor.getExample().getResource_group_name())
 *             .rules(            
 *                 RulesEngineRule.builder()
 *                     .name(&#34;debuggingoutput&#34;)
 *                     .priority(1)
 *                     .action(RulesEngineRuleAction.builder()
 *                         .responseHeaders(RulesEngineRuleActionResponseHeader.builder()
 ...
 *                     .priority(2)
 *                     .matchConditions(RulesEngineRuleMatchCondition.builder()
