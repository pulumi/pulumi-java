...
@CustomType
public final class WindowsWebAppSlotAuthSettingsGoogle {
    /**
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsGoogle defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WindowsWebAppSlotAuthSettingsGoogle defaults) {
        ...
        }        public WindowsWebAppSlotAuthSettingsGoogle build() {
            return new WindowsWebAppSlotAuthSettingsGoogle(clientId, clientSecret, clientSecretSettingName, oauthScopes);
        }
    }
}
