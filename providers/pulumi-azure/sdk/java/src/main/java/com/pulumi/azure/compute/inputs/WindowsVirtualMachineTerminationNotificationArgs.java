...
public final class WindowsVirtualMachineTerminationNotificationArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsVirtualMachineTerminationNotificationArgs Empty = new WindowsVirtualMachineTerminationNotificationArgs();
    ...
    private WindowsVirtualMachineTerminationNotificationArgs() {}

    private WindowsVirtualMachineTerminationNotificationArgs(WindowsVirtualMachineTerminationNotificationArgs $) {
    ...
    public static Builder builder(WindowsVirtualMachineTerminationNotificationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsVirtualMachineTerminationNotificationArgs();
        }

        public Builder(WindowsVirtualMachineTerminationNotificationArgs defaults) {
            $ = new WindowsVirtualMachineTerminationNotificationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsVirtualMachineTerminationNotificationArgs build() {
