 ...
 *                     .connectionString(exampleAccount.getPrimaryBlobConnectionString())
 *                     .name(&#34;export&#34;)
 ...
 *                     .connectionString(exampleAuthorizationRule.getPrimaryConnectionString())
 *                     .name(&#34;export2&#34;)
 *                     .build())
 *             .routes(            
 *                 IoTHubRoute.builder()
 ...
 *                     .enabled(true)
 *                     .build())
 *             .enrichments(IoTHubEnrichment.builder()
 *                 .key(&#34;tenant&#34;)
 ...
 *                     &#34;export2&#34;)
 *                 .build())
 *             .cloudToDevice(IoTHubCloudToDevice.builder()
 *                 .maxDeliveryCount(30)
 *                 .defaultTtl(&#34;PT1H&#34;)
 *                 .feedbacks(IoTHubCloudToDeviceFeedback.builder()
 *                     .timeToLive(&#34;PT1H10M&#34;)
 *                     .maxDeliveryCount(15)
 *                     .lockDuration(&#34;PT30S&#34;)
 *                     .build())
...
public class IoTHub extends com.pulumi.resources.CustomResource {
    ...
    public IoTHub(String name, IoTHubArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:iot/ioTHub:IoTHub", name, args == null ? IoTHubArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private IoTHub(String name, Output<String> id, @Nullable IoTHubState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:iot/ioTHub:IoTHub", name, state, makeResourceOptions(options, id));
    }
