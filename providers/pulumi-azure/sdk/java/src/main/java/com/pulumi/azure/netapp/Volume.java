 ...
 *             .dataProtectionReplication(VolumeDataProtectionReplication.builder()
 *                 .endpointType(&#34;dst&#34;)
 *                 .remoteVolumeLocation(azurerm_resource_group.getExample_primary().getLocation())
 *                 .remoteVolumeResourceId(azurerm_netapp_volume.getExample_primary().getId())
 *                 .replicationFrequency(&#34;10minutes&#34;)
 *                 .build())
 *             .dataProtectionSnapshotPolicy(VolumeDataProtectionSnapshotPolicy.builder()
