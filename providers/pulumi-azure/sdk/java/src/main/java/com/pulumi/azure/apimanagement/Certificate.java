 ...
 *             .location(exampleResourceGroup.getLocation())
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .tenantId(data.getAzurerm_client_config().getExample().getTenant_id())
 *             .skuName(&#34;standard&#34;)
 *             .build());
 * 
 *         var exampleAccessPolicy = new AccessPolicy(&#34;exampleAccessPolicy&#34;, AccessPolicyArgs.builder()        
 *             .keyVaultId(exampleKeyVault.getId())
 *             .tenantId(exampleService.getIdentity().apply(identity -&gt; identity.getTenantId()))
 *             .objectId(exampleService.getIdentity().apply(identity -&gt; identity.getPrincipalId()))
 ...
 *         var exampleCertificate = new Certificate(&#34;exampleCertificate&#34;, CertificateArgs.builder()        
 *             .keyVaultId(exampleKeyVault.getId())
 *             .certificate(CertificateCertificate.builder()
 ...
 *             .apiManagementName(exampleService.getName())
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .keyVaultSecretId(exampleCertificate.getSecretId())
 *             .build());
 * 
 *         }
 * }
