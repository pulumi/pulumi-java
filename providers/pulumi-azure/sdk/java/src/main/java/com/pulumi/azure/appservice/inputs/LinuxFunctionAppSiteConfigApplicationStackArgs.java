...
public final class LinuxFunctionAppSiteConfigApplicationStackArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The version of PowerShell Core to run. Possible values are `7`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param dotnetVersion The version of .NET to use. Possible values include `3.1` and `6.0`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param nodeVersion The version of Node to run. Possible values include `12`, `14`, and `16`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param powershellCoreVersion The version of PowerShell Core to run. Possible values are `7`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param pythonVersion The version of Python to run. Possible values include `3.6`, `3.7`, `3.8`, and `3.9`.
         * 
         * @return builder
         * 
         */
