 ...
 *             .resourceGroupName(srcResourceGroup.getName())
 *             .location(srcResourceGroup.getLocation())
 ...
 *             .storageAccountName(srcAccount.getName())
 ...
 *             .resourceGroupName(dstResourceGroup.getName())
 *             .location(dstResourceGroup.getLocation())
 *             .accountTier(&#34;Standard&#34;)
 *             .accountReplicationType(&#34;LRS&#34;)
 *             .blobProperties(AccountBlobProperties.builder()
 *                 .versioningEnabled(true)
 ...
 *             .storageAccountName(dstAccount.getName())
 *             .containerAccessType(&#34;private&#34;)
 *             .build());
 * 
 *         var example = new ObjectReplication(&#34;example&#34;, ObjectReplicationArgs.builder()        
 *             .sourceStorageAccountId(srcAccount.getId())
 *             .destinationStorageAccountId(dstAccount.getId())
 *             .rules(ObjectReplicationRule.builder()
 *                 .sourceContainerName(srcContainer.getName())
 *                 .destinationContainerName(dstContainer.getName())
 *                 .build())
 *             .build());
 * 
 *         }
