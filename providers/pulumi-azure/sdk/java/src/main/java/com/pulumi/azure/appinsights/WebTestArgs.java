...
public final class WebTestArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return An XML configuration specification for a WebTest ([see here for more information](https://docs.microsoft.com/en-us/rest/api/application-insights/webtests/createorupdate/)).
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param configuration An XML configuration specification for a WebTest ([see here for more information](https://docs.microsoft.com/en-us/rest/api/application-insights/webtests/createorupdate/)).
         * 
         * @return builder
         * 
         */
