 ...
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .location(exampleNetworkWatcher.getLocation())
 *             .endpoints(            
 ...
 *                         .items(NetworkConnectionMonitorEndpointFilterItem.builder()
 *                             .address(exampleVirtualMachine.getId())
 *                             .type(&#34;AgentAddress&#34;)
 *                             .build())
 *                         .type(&#34;Include&#34;)
 *                         .build())
 ...
 *                     .build())
 *             .testConfigurations(NetworkConnectionMonitorTestConfiguration.builder()
 *                 .name(&#34;tcpName&#34;)
 *                 .protocol(&#34;Tcp&#34;)
 ...
 *                     .build())
 *                 .build())
 *             .testGroups(NetworkConnectionMonitorTestGroup.builder()
 *                 .name(&#34;exampletg&#34;)
 ...
 *                 .build())
 *             .notes(&#34;examplenote&#34;)
 *             .outputWorkspaceResourceIds(exampleAnalyticsWorkspace.getId())
 *             .build());
 * 
 *         }
 * }
