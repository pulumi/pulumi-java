...
import com.pulumi.azure.appservice.inputs.FunctionAppSlotAuthSettingsActiveDirectoryArgs;
import com.pulumi.azure.appservice.inputs.FunctionAppSlotAuthSettingsFacebookArgs;
import com.pulumi.azure.appservice.inputs.FunctionAppSlotAuthSettingsGoogleArgs;
import com.pulumi.azure.appservice.inputs.FunctionAppSlotAuthSettingsMicrosoftArgs;
import com.pulumi.azure.appservice.inputs.FunctionAppSlotAuthSettingsTwitterArgs;
...
public final class FunctionAppSlotAuthSettingsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<FunctionAppSlotAuthSettingsFacebookArgs> facebook;

    /**
     * @return A `facebook` block as defined below.
     * 
     */
    public Optional<Output<FunctionAppSlotAuthSettingsFacebookArgs>> facebook() {
     ...
     */
    @Import(name="google")
    private @Nullable Output<FunctionAppSlotAuthSettingsGoogleArgs> google;

    /**
     * @return A `google` block as defined below.
     * 
     */
    public Optional<Output<FunctionAppSlotAuthSettingsGoogleArgs>> google() {
    ...
    private @Nullable Output<FunctionAppSlotAuthSettingsMicrosoftArgs> microsoft;

    /**
     * @return A `microsoft` block as defined below.
     * 
     */
    public Optional<Output<FunctionAppSlotAuthSettingsMicrosoftArgs>> microsoft() {
     ...
     */
    @Import(name="twitter")
    private @Nullable Output<FunctionAppSlotAuthSettingsTwitterArgs> twitter;

    /**
     * @return A `twitter` block as defined below.
     * 
     */
    public Optional<Output<FunctionAppSlotAuthSettingsTwitterArgs>> twitter() {
    ...
    private FunctionAppSlotAuthSettingsArgs() {}

    private FunctionAppSlotAuthSettingsArgs(FunctionAppSlotAuthSettingsArgs $) {
    ...
    public static Builder builder(FunctionAppSlotAuthSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionAppSlotAuthSettingsArgs();
        }

        public Builder(FunctionAppSlotAuthSettingsArgs defaults) {
            $ = new FunctionAppSlotAuthSettingsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder activeDirectory(@Nullable Output<FunctionAppSlotAuthSettingsActiveDirectoryArgs> activeDirectory) {
         ...
         * 
         */
        public Builder activeDirectory(FunctionAppSlotAuthSettingsActiveDirectoryArgs activeDirectory) {
         ...
         * 
         */
        public Builder facebook(@Nullable Output<FunctionAppSlotAuthSettingsFacebookArgs> facebook) {
            $.facebook = facebook;
            return this;
        }
         ...
         * 
         */
        public Builder facebook(FunctionAppSlotAuthSettingsFacebookArgs facebook) {
         ...
         * 
         */
        public Builder google(@Nullable Output<FunctionAppSlotAuthSettingsGoogleArgs> google) {
            $.google = google;
            return this;
        }
         ...
         * 
         */
        public Builder google(FunctionAppSlotAuthSettingsGoogleArgs google) {
         ...
         * 
         */
        public Builder microsoft(@Nullable Output<FunctionAppSlotAuthSettingsMicrosoftArgs> microsoft) {
            $.microsoft = microsoft;
            return this;
        }
         ...
         * 
         */
        public Builder microsoft(FunctionAppSlotAuthSettingsMicrosoftArgs microsoft) {
         ...
         * 
         */
        public Builder twitter(@Nullable Output<FunctionAppSlotAuthSettingsTwitterArgs> twitter) {
            $.twitter = twitter;
            return this;
        }
         ...
         * 
         */
        public Builder twitter(FunctionAppSlotAuthSettingsTwitterArgs twitter) {
        ...
        public FunctionAppSlotAuthSettingsArgs build() {
