 ...
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .sku(&#34;Standard&#34;)
 *             .dedicatedClusterId(exampleCluster.getId())
 *             .identity(EventHubNamespaceIdentity.builder()
 *                 .type(&#34;SystemAssigned&#34;)
 *                 .build())
 *             .build());
 * 
 ...
 *             .tenantId(exampleEventHubNamespace.getIdentity().apply(identity -&gt; identity.getTenantId()))
 *             .objectId(exampleEventHubNamespace.getIdentity().apply(identity -&gt; identity.getPrincipalId()))
 *             .keyPermissions(            
 *                 &#34;get&#34;,
 *                 &#34;unwrapkey&#34;,
 *                 &#34;wrapkey&#34;)
 ...
 *             .eventhubNamespaceId(exampleEventHubNamespace.getId())
 *             .keyVaultKeyIds(exampleKey.getId())
 *             .build());
 * 
 *         }
 * }
