...
public final class LinkedServiceAzureSqlDatabaseState extends com.pulumi.resources.ResourceArgs {

    public static final LinkedServiceAzureSqlDatabaseState Empty = new LinkedServiceAzureSqlDatabaseState();
    ...
    private LinkedServiceAzureSqlDatabaseState() {}

    private LinkedServiceAzureSqlDatabaseState(LinkedServiceAzureSqlDatabaseState $) {
    ...
    public static Builder builder(LinkedServiceAzureSqlDatabaseState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinkedServiceAzureSqlDatabaseState();
        }

        public Builder(LinkedServiceAzureSqlDatabaseState defaults) {
            $ = new LinkedServiceAzureSqlDatabaseState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param name Specifies the name of the Data Factory Linked Service Azure SQL Database. Changing this forces a new resource to be created. Must be unique within a data
         * factory. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
         * 
         * @return builder
         * 
        ...
        public LinkedServiceAzureSqlDatabaseState build() {
            return $;
        }
    }
