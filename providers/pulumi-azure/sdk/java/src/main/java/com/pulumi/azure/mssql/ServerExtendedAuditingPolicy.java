 ...
 *             .storageEndpoint(exampleAccount.getPrimaryBlobEndpoint())
 ...
 *             .principalId(exampleServer.getIdentity().apply(identity -&gt; identity.getPrincipalId()))
 *             .build());
 * 
 ...
 *             .networkRules(AccountNetworkRules.builder()
 *                 .defaultAction(&#34;Deny&#34;)
 *                 .ipRules(&#34;127.0.0.1&#34;)
 *                 .virtualNetworkSubnetIds(exampleSubnet.getId())
 ...
 *             .storageAccountSubscriptionId(azurerm_subscription.getPrimary().getSubscription_id())
 *             .build());
 * 
 *         }
 * }
