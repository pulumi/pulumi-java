...
@CustomType
public final class LinuxFunctionAppSlotAuthSettingsGoogle {
    /**
    ...
    private LinuxFunctionAppSlotAuthSettingsGoogle(
    ...
    public static Builder builder(LinuxFunctionAppSlotAuthSettingsGoogle defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LinuxFunctionAppSlotAuthSettingsGoogle defaults) {
        ...
        }        public LinuxFunctionAppSlotAuthSettingsGoogle build() {
            return new LinuxFunctionAppSlotAuthSettingsGoogle(clientId, clientSecret, clientSecretSettingName, oauthScopes);
        }
    }
}
