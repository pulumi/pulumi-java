...
public final class DatasetCosmosDBApiState extends com.pulumi.resources.ResourceArgs {

    public static final DatasetCosmosDBApiState Empty = new DatasetCosmosDBApiState();
    ...
    private DatasetCosmosDBApiState() {}

    private DatasetCosmosDBApiState(DatasetCosmosDBApiState $) {
    ...
    public static Builder builder(DatasetCosmosDBApiState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatasetCosmosDBApiState();
        }

        public Builder(DatasetCosmosDBApiState defaults) {
            $ = new DatasetCosmosDBApiState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param collectionName The collection name of the Data Factory Dataset Azure Cosmos DB SQL API.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder schemaColumns(@Nullable Output<List<DatasetCosmosDBApiSchemaColumnArgs>> schemaColumns) {
         ...
         * 
         */
        public Builder schemaColumns(List<DatasetCosmosDBApiSchemaColumnArgs> schemaColumns) {
         ...
         * 
         */
        public Builder schemaColumns(DatasetCosmosDBApiSchemaColumnArgs... schemaColumns) {
            return schemaColumns(List.of(schemaColumns));
        }

        public DatasetCosmosDBApiState build() {
            return $;
        }
    }
