...
public final class EventHubNamespaceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Defines which tier to use. Valid options are `Basic`, `Standard`, and `Premium`. Please not that setting this field to `Premium` will force the creation of a new resource and also requires setting `zone_redundant` to true.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param sku Defines which tier to use. Valid options are `Basic`, `Standard`, and `Premium`. Please not that setting this field to `Premium` will force the creation of a new resource and also requires setting `zone_redundant` to true.
         * 
         * @return builder
         * 
         */
