...
public final class GetVolumeResult {
    ...
    public static final class Builder {
        ...
        public Builder volumePath(String volumePath) {
            ...
            return new GetVolumeResult(accountName, dataProtectionReplications, id, location, mountIpAddresses, name, poolName, protocols, resourceGroupName, securityStyle, serviceLevel, storageQuotaInGb, subnetId, volumePath);
        }
    }
}
