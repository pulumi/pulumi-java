 ...
 *             .resourceGroupName(rg.getName())
 *             .recoveryVaultName(vault.getName())
 *             .sourceStorageAccountId(protection_container.getStorageAccountId())
 *             .sourceFileShareName(exampleShare.getName())
 *             .backupPolicyId(examplePolicyFileShare.getId())
 *             .build());
 * 
 *         }
 * }
