...
public final class VirtualMachineState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="storageOsDisk")
    private @Nullable Output<VirtualMachineStorageOsDiskArgs> storageOsDisk;

    /**
     * @return A `storage_os_disk` block as defined below.
     * 
     */
    public Optional<Output<VirtualMachineStorageOsDiskArgs>> storageOsDisk() {
        return Optional.ofNullable(this.storageOsDisk);
    }
    ...
    public static final class Builder {
        ...
        /**
         * @param networkInterfaceIds A list of Network Interface ID&#39;s which should be associated with the Virtual Machine.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder storageOsDisk(@Nullable Output<VirtualMachineStorageOsDiskArgs> storageOsDisk) {
