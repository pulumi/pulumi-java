 ...
 *                 Map.entry(&#34;storageEndpoint&#34;, azurerm_storage_account.getExample().getPrimary_blob_endpoint()),
 *                 Map.entry(&#34;storageAccountAccessKey&#34;, azurerm_storage_account.getExample().getPrimary_access_key()),
 ...
 *                     .build(),
 *                 KeyVaultAccessPolicy.builder()
 *                     .tenantId(exampleServer.getIdentity().apply(identity -&gt; identity.getTenantId()))
