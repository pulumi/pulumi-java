 ...
 *             .location(exampleResourceGroup.apply(getBudgetResourceGroupResult -&gt; getBudgetResourceGroupResult.getLocation()))
 *             .resourceGroupName(exampleResourceGroup.apply(getBudgetResourceGroupResult -&gt; getBudgetResourceGroupResult.getName()))
 *             .sku(&#34;Standard&#34;)
 *             .capacity(1)
 *             .build());
 * 
 *         var exampleEventHub = new EventHub(&#34;exampleEventHub&#34;, EventHubArgs.builder()        
 *             .namespaceName(exampleEventHubNamespace.getName())
 *             .resourceGroupName(exampleResourceGroup.apply(getBudgetResourceGroupResult -&gt; getBudgetResourceGroupResult.getName()))
 *             .partitionCount(2)
 *             .messageRetention(1)
 *             .build());
 ...
 *             .namespaceName(exampleEventHubNamespace.getName())
 *             .eventhubName(exampleEventHub.getName())
 *             .resourceGroupName(exampleResourceGroup.apply(getBudgetResourceGroupResult -&gt; getBudgetResourceGroupResult.getName()))
 *             .build());
 * 
 *         var exampleStreamInputEventHub = new StreamInputEventHub(&#34;exampleStreamInputEventHub&#34;, StreamInputEventHubArgs.builder()        
 *             .streamAnalyticsJobName(exampleJob.apply(getJobResult -&gt; getJobResult.getName()))
 *             .resourceGroupName(exampleJob.apply(getJobResult -&gt; getJobResult.getResourceGroupName()))
 *             .eventhubConsumerGroupName(exampleConsumerGroup.getName())
 *             .eventhubName(exampleEventHub.getName())
 *             .servicebusNamespace(exampleEventHubNamespace.getName())
 *             .sharedAccessPolicyKey(exampleEventHubNamespace.getDefaultPrimaryKey())
 *             .sharedAccessPolicyName(&#34;RootManageSharedAccessKey&#34;)
 *             .serialization(StreamInputEventHubSerialization.builder()
 *                 .type(&#34;Json&#34;)
 *                 .encoding(&#34;UTF8&#34;)
 *                 .build())
 *             .build());
