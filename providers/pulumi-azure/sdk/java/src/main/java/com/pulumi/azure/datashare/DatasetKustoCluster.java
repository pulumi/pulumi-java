 ...
 *             .accountId(exampleAccount.getId())
 *             .kind(&#34;InPlace&#34;)
 *             .build());
 * 
 ...
 *             .scope(exampleCluster.getId())
 *             .roleDefinitionName(&#34;Contributor&#34;)
 *             .principalId(exampleAccount.getIdentity().apply(identity -&gt; identity.getPrincipalId()))
 *             .build());
 * 
 *         var exampleDatasetKustoCluster = new DatasetKustoCluster(&#34;exampleDatasetKustoCluster&#34;, DatasetKustoClusterArgs.builder()        
 *             .shareId(exampleShare.getId())
 *             .kustoClusterId(exampleCluster.getId())
 *             .build());
 * 
 *         }
 * }
 ...
 * 
 */
@ResourceType(type="azure:datashare/datasetKustoCluster:DatasetKustoCluster")
public class DatasetKustoCluster extends com.pulumi.resources.CustomResource {
    /**
    ...
    public DatasetKustoCluster(String name, DatasetKustoClusterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:datashare/datasetKustoCluster:DatasetKustoCluster", name, args == null ? DatasetKustoClusterArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
