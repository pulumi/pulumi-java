...
public final class VirtualNetworkGatewayConnectionState extends com.pulumi.resources.ResourceArgs {
    ...
    private VirtualNetworkGatewayConnectionState() {}

    private VirtualNetworkGatewayConnectionState(VirtualNetworkGatewayConnectionState $) {
    ...
    public static Builder builder(VirtualNetworkGatewayConnectionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualNetworkGatewayConnectionState();
        }

        public Builder(VirtualNetworkGatewayConnectionState defaults) {
            $ = new VirtualNetworkGatewayConnectionState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param trafficSelectorPolicy A `traffic_selector_policy` which allows to specify traffic selector policy proposal to be used in a virtual network gateway connection.
         * Only one block can be defined for a connection.
         * For details about traffic selectors refer to [the relevant section in the Azure documentation](https://docs.microsoft.com/en-us/azure/vpn-gateway/vpn-gateway-connect-multiple-policybased-rm-ps).
         * 
         * @return builder
        ...
        public VirtualNetworkGatewayConnectionState build() {
            return $;
        }
    }
