 ...
 *             .resourceId(exampleResourcePolicyAssignment.getResourceId())
 *             .policyAssignmentId(exampleResourcePolicyAssignment.getId())
