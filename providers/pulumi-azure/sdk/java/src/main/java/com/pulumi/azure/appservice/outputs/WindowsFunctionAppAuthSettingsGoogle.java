...
@CustomType
public final class WindowsFunctionAppAuthSettingsGoogle {
    /**
    ...
    private WindowsFunctionAppAuthSettingsGoogle(
    ...
    public static Builder builder(WindowsFunctionAppAuthSettingsGoogle defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WindowsFunctionAppAuthSettingsGoogle defaults) {
        ...
        }        public WindowsFunctionAppAuthSettingsGoogle build() {
            return new WindowsFunctionAppAuthSettingsGoogle(clientId, clientSecret, clientSecretSettingName, oauthScopes);
        }
    }
}
