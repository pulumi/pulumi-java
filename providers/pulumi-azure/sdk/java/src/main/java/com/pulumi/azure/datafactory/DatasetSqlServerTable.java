 ...
 *             .dataFactoryId(exampleFactory.getId())
 *             .linkedServiceName(exampleLinkedServiceSqlServer.getName())
 *             .build());
 * 
 *         }
 * }
...
public class DatasetSqlServerTable extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="schemaColumns", type=List.class, parameters={DatasetSqlServerTableSchemaColumn.class})
    ...
    public DatasetSqlServerTable(String name, DatasetSqlServerTableArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:datafactory/datasetSqlServerTable:DatasetSqlServerTable", name, args == null ? DatasetSqlServerTableArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
