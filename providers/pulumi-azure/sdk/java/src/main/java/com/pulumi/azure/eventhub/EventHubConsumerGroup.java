...
public class EventHubConsumerGroup extends com.pulumi.resources.CustomResource {
    ...
    public EventHubConsumerGroup(String name, EventHubConsumerGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:eventhub/eventHubConsumerGroup:EventHubConsumerGroup", name, args == null ? EventHubConsumerGroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
