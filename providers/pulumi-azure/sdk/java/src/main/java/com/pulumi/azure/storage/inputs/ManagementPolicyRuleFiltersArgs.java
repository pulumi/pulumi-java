...
public final class ManagementPolicyRuleFiltersArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="blobTypes")
    private @Nullable Output<List<String>> blobTypes;

    /**
     * @return An array of predefined values. Valid options are `blockBlob` and `appendBlob`.
     * 
     */
    public Optional<Output<List<String>>> blobTypes() {
        return Optional.ofNullable(this.blobTypes);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder blobTypes(@Nullable Output<List<String>> blobTypes) {
            $.blobTypes = blobTypes;
            return this;
        }
