 ...
 *             .namespaceName(azurerm_eventhub_namespace.getExample().getName())
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .partitionCount(1)
 *             .messageRetention(1)
 *             .build());
 ...
 *             .namespaceName(azurerm_eventhub_namespace.getExample().getName())
 *             .eventhubName(azurerm_eventhub.getExample().getName())
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .build());
 * 
 *         var exampleEventSubscription = new EventSubscription(&#34;exampleEventSubscription&#34;, EventSubscriptionArgs.builder()        
 *             .scope(exampleAccount.getId())
 *             .eventhubEndpointId(azurerm_eventhub.getExample().getId())
 *             .eventDeliverySchema(&#34;EventGridSchema&#34;)
 *             .includedEventTypes(            
 *                 &#34;Microsoft.Storage.BlobCreated&#34;,
 *                 &#34;Microsoft.Storage.BlobRenamed&#34;)
 *             .retryPolicy(EventSubscriptionRetryPolicy.builder()
 *                 .eventTimeToLive(144)
 ...
 *             .eventhubId(azurerm_eventhub.getExample().getId())
