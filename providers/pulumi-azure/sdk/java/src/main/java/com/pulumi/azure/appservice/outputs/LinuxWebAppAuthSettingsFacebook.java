...
@CustomType
public final class LinuxWebAppAuthSettingsFacebook {
    /**
    ...
    private LinuxWebAppAuthSettingsFacebook(
    ...
    public static Builder builder(LinuxWebAppAuthSettingsFacebook defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LinuxWebAppAuthSettingsFacebook defaults) {
        ...
        }        public LinuxWebAppAuthSettingsFacebook build() {
            return new LinuxWebAppAuthSettingsFacebook(appId, appSecret, appSecretSettingName, oauthScopes);
        }
    }
}
