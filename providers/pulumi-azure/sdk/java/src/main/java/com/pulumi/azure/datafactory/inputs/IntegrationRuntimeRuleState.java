...
public final class IntegrationRuntimeRuleState extends com.pulumi.resources.ResourceArgs {

    public static final IntegrationRuntimeRuleState Empty = new IntegrationRuntimeRuleState();
    ...
    private IntegrationRuntimeRuleState() {}

    private IntegrationRuntimeRuleState(IntegrationRuntimeRuleState $) {
    ...
    public static Builder builder(IntegrationRuntimeRuleState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IntegrationRuntimeRuleState();
        }

        public Builder(IntegrationRuntimeRuleState defaults) {
            $ = new IntegrationRuntimeRuleState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param name Specifies the name of the Managed Integration Runtime. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
         * 
         * @return builder
         * 
         */
        ...
        public IntegrationRuntimeRuleState build() {
            return $;
        }
    }
