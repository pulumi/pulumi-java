 ...
 *             .routingRules(FrontdoorRoutingRule.builder()
 ...
 *                     .build())
 *                 .build())
 *             .backendPoolLoadBalancings(FrontdoorBackendPoolLoadBalancing.builder()
 *                 .name(&#34;exampleLoadBalancingSettings1&#34;)
 *                 .build())
 *             .backendPoolHealthProbes(FrontdoorBackendPoolHealthProbe.builder()
 *                 .name(&#34;exampleHealthProbeSetting1&#34;)
 *                 .build())
 *             .backendPools(FrontdoorBackendPool.builder()
 *                 .name(&#34;exampleBackendBing&#34;)
 *                 .backends(FrontdoorBackendPoolBackend.builder()
 ...
 *                 .build())
 *             .frontendEndpoints(FrontdoorFrontendEndpoint.builder()
