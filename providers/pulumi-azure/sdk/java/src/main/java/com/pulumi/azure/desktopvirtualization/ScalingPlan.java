 ...
 *             .scope(exampleResourceGroup.getId())
 ...
 *                 .notActions()
 *                 .build())
 *             .assignableScopes(exampleResourceGroup.getId())
 *             .build());
 * 
 ...
 *             .name(random_uuid.getExample().getResult())
 *             .scope(exampleResourceGroup.getId())
 *             .roleDefinitionId(exampleRoleDefinition.getRoleDefinitionResourceId())
 *             .principalId(exampleServicePrincipal.apply(getServicePrincipalResult -&gt; getServicePrincipalResult.getApplicationId()))
 ...
 *             .schedules(ScalingPlanSchedule.builder()
 *                 .name(&#34;Weekdays&#34;)
 *                 .daysOfWeeks(                
 *                     &#34;Monday&#34;,
 *                     &#34;Tuesday&#34;,
 ...
 *                 .build())
 *             .hostPools(ScalingPlanHostPool.builder()
 *                 .hostpoolId(exampleHostPool.getId())
