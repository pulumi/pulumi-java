...
public final class ManagedDiskArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The ID of a Disk Encryption Set which should be used to encrypt this Managed Disk.
     * 
     */
    ...
    /**
     * @return The disk performance tier to use. Possible values are documented [here](https://docs.microsoft.com/en-us/azure/virtual-machines/disks-change-performance). This feature is currently supported only for premium SSDs.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param diskEncryptionSetId The ID of a Disk Encryption Set which should be used to encrypt this Managed Disk.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param tier The disk performance tier to use. Possible values are documented [here](https://docs.microsoft.com/en-us/azure/virtual-machines/disks-change-performance). This feature is currently supported only for premium SSDs.
         * 
         * @return builder
         * 
         */
