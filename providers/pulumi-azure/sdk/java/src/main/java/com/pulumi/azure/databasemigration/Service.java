...
import com.pulumi.azure.databasemigration.inputs.ServiceState;
 ...
 * 
 */
@ResourceType(type="azure:databasemigration/service:Service")
public class Service extends com.pulumi.resources.CustomResource {
    ...
    public Service(String name, ServiceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:databasemigration/service:Service", name, args == null ? ServiceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Service(String name, Output<String> id, @Nullable ServiceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:databasemigration/service:Service", name, state, makeResourceOptions(options, id));
    }
