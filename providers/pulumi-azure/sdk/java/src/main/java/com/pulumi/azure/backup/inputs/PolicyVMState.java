...
public final class PolicyVMState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Specifies the instant restore retention range in days.
     * 
     */
    ...
    /**
     * @return Specifies the timezone. [the possible values are defined here](http://jackstromberg.com/2017/01/list-of-time-zones-consumed-by-azure/). Defaults to `UTC`
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param instantRestoreRetentionDays Specifies the instant restore retention range in days.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param timezone Specifies the timezone. [the possible values are defined here](http://jackstromberg.com/2017/01/list-of-time-zones-consumed-by-azure/). Defaults to `UTC`
         * 
         * @return builder
         * 
         */
