...
public class EndpointStorageContainer extends com.pulumi.resources.CustomResource {
     ...
     */
    public EndpointStorageContainer(String name) {
     ...
     */
    public static EndpointStorageContainer get(String name, Output<String> id, @Nullable EndpointStorageContainerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
