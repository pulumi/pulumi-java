 ...
 *             .resourceGroupName(azurerm_stream_analytics_job.getExample().getResource_group_name())
 *             .streamAnalyticsJobName(azurerm_stream_analytics_job.getExample().getName())
 *             .server(exampleServer.getFullyQualifiedDomainName())
 *             .database(exampleDatabase.getName())
