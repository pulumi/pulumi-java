 ...
 *             .adminEnabled(false)
 *             .georeplications(            
 *                 RegistryGeoreplication.builder()
 *                     .location(&#34;East US&#34;)
 ...
 *             .location(azurerm_resource_group.getExample().getLocation())
 *             .build());
 * 
 ...
 *             .location(rg.getLocation())
 *             .sku(&#34;Premium&#34;)
 *             .identity(RegistryIdentity.builder()
 *                 .type(&#34;UserAssigned&#34;)
 *                 .identityIds(exampleUserAssignedIdentity.getId())
 *                 .build())
 *             .encryption(RegistryEncryption.builder()
 *                 .enabled(true)
 *                 .keyVaultKeyId(exampleKey.apply(getKeyResult -&gt; getKeyResult.getId()))
 *                 .identityClientId(exampleUserAssignedIdentity.getClientId())
 *                 .build())
 *             .build());
 * 
 *         }
 ...
 *                 .build())
 *             .identity(KubernetesClusterIdentity.builder()
 *                 .type(&#34;SystemAssigned&#34;)
 *                 .build())
 ...
 *             .principalId(exampleKubernetesCluster.getKubeletIdentity().apply(kubeletIdentity -&gt; kubeletIdentity.getObjectId()))
 *             .roleDefinitionName(&#34;AcrPull&#34;)
 *             .scope(exampleRegistry.getId())
