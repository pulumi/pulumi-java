 ...
 *             .location(exampleResourceGroup.getLocation())
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .actions(AutomationAction.builder()
 *                 .type(&#34;EventHub&#34;)
 *                 .resourceId(exampleEventHub.getId())
 *                 .connectionString(exampleAuthorizationRule.getPrimaryConnectionString())
 *                 .build())
 *             .sources(AutomationSource.builder()
 *                 .eventSource(&#34;Alerts&#34;)
 *                 .ruleSets(AutomationSourceRuleSet.builder()
 *                     .rules(AutomationSourceRuleSetRule.builder()
 ...
 *                     .build())
 *                 .build())
 *             .scopes(String.format(&#34;/subscriptions/%s&#34;, current.apply(getClientConfigResult -&gt; getClientConfigResult.getSubscriptionId())))
 *             .build());
 * 
 *         }
 * }
