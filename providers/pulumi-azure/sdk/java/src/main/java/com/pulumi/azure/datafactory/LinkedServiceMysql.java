...
import com.pulumi.azure.datafactory.inputs.LinkedServiceMysqlState;
 ...
 * 
 */
@ResourceType(type="azure:datafactory/linkedServiceMysql:LinkedServiceMysql")
public class LinkedServiceMysql extends com.pulumi.resources.CustomResource {
    /**
    ...
    public LinkedServiceMysql(String name, LinkedServiceMysqlArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:datafactory/linkedServiceMysql:LinkedServiceMysql", name, args == null ? LinkedServiceMysqlArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
