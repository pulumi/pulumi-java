...
public final class SparkPoolState extends com.pulumi.resources.ResourceArgs {
    ...
    private SparkPoolState() {}

    private SparkPoolState(SparkPoolState $) {
    ...
    public static Builder builder(SparkPoolState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SparkPoolState defaults) {
            $ = new SparkPoolState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder nodeSizeFamily(@Nullable Output<String> nodeSizeFamily) {
        ...
        /**
         * @param sparkVersion The Apache Spark version. Possible values are `2.4` and `3.1`. Defaults to `2.4`.
         * 
         * @return builder
         * 
         */
