...
public final class EndpointDeliveryRuleUrlFileExtensionConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final EndpointDeliveryRuleUrlFileExtensionConditionArgs Empty = new EndpointDeliveryRuleUrlFileExtensionConditionArgs();
    ...
    private EndpointDeliveryRuleUrlFileExtensionConditionArgs() {}

    private EndpointDeliveryRuleUrlFileExtensionConditionArgs(EndpointDeliveryRuleUrlFileExtensionConditionArgs $) {
    ...
    public static Builder builder(EndpointDeliveryRuleUrlFileExtensionConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(EndpointDeliveryRuleUrlFileExtensionConditionArgs defaults) {
            $ = new EndpointDeliveryRuleUrlFileExtensionConditionArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param transforms Valid values are `Lowercase` and `Uppercase`.
         * 
         * @return builder
         * 
         */
        ...
        public EndpointDeliveryRuleUrlFileExtensionConditionArgs build() {
