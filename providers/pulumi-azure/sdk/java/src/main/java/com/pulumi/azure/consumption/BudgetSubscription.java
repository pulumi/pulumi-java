 ...
 *             .subscriptionId(current.apply(getBudgetSubscriptionResult -&gt; getBudgetSubscriptionResult.getId()))
 *             .amount(1000)
 *             .timeGrain(&#34;Monthly&#34;)
 *             .timePeriod(BudgetSubscriptionTimePeriod.builder()
 *                 .startDate(&#34;2022-06-01T00:00:00Z&#34;)
 *                 .endDate(&#34;2022-07-01T00:00:00Z&#34;)
 *                 .build())
 *             .filter(BudgetSubscriptionFilter.builder()
 *                 .dimensions(BudgetSubscriptionFilterDimension.builder()
 *                     .name(&#34;ResourceGroupName&#34;)
 *                     .values(exampleResourceGroup.getName())
 *                     .build())
 *                 .tags(BudgetSubscriptionFilterTag.builder()
 *                     .name(&#34;foo&#34;)
 *                     .values(                    
 *                         &#34;bar&#34;,
 *                         &#34;baz&#34;)
 ...
 *                 .build())
 *             .notifications(            
 *                 BudgetSubscriptionNotification.builder()
 *                     .enabled(true)
 *                     .threshold(90)
 *                     .operator(&#34;EqualTo&#34;)
 *                     .contactEmails(                    
 *                         &#34;foo@example.com&#34;,
 *                         &#34;bar@example.com&#34;)
 *                     .contactGroups(exampleActionGroup.getId())
 *                     .contactRoles(&#34;Owner&#34;)
 *                     .build(),
 *                 BudgetSubscriptionNotification.builder()
 *                     .enabled(false)
...
public class BudgetSubscription extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="filter", type=BudgetSubscriptionFilter.class, parameters={})
     ...
     * 
     */
    @Export(name="notifications", type=List.class, parameters={BudgetSubscriptionNotification.class})
     ...
     * 
     */
    @Export(name="timePeriod", type=BudgetSubscriptionTimePeriod.class, parameters={})
