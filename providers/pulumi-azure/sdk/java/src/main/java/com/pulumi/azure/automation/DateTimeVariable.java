...
import com.pulumi.azure.automation.inputs.DateTimeVariableState;
 ...
 * 
 */
@ResourceType(type="azure:automation/dateTimeVariable:DateTimeVariable")
public class DateTimeVariable extends com.pulumi.resources.CustomResource {
    /**
    ...
    /**
     * @return The value of the Automation Variable in the [RFC3339 Section 5.6 Internet Date/Time Format](https://tools.ietf.org/html/rfc3339#section-5.6).
     * 
     */
