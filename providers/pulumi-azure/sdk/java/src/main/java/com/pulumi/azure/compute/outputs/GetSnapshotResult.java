...
public final class GetSnapshotResult {
    ...
    public static final class Builder {
        ...
        public Builder timeCreated(String timeCreated) {
            ...
            return new GetSnapshotResult(creationOption, diskSizeGb, encryptionSettings, id, name, osType, resourceGroupName, sourceResourceId, sourceUri, storageAccountId, timeCreated);
        }
    }
}
