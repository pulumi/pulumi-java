 ...
 *             .connectionString(exampleAccount.apply(getAccountResult -&gt; getAccountResult).apply(exampleAccount -&gt; exampleAccount.apply(getAccountResult -&gt; getAccountResult.getPrimaryConnectionString())))
 *             .build());
 * 
 *         var exampleDatasetAzureBlob = new DatasetAzureBlob(&#34;exampleDatasetAzureBlob&#34;, DatasetAzureBlobArgs.builder()        
 *             .dataFactoryId(exampleFactory.getId())
 *             .linkedServiceName(exampleLinkedServiceAzureBlobStorage.getName())
 *             .path(&#34;foo&#34;)
 *             .filename(&#34;bar.png&#34;)
 *             .build());
 * 
