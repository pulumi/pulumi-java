 ...
 *             .apiManagementId(azurerm_api_management.getExample().getId())
 *             .build()));
 * 
 *         var exampleGatewayApi = new GatewayApi(&#34;exampleGatewayApi&#34;, GatewayApiArgs.builder()        
 *             .gatewayId(exampleGateway.apply(getGatewayResult -&gt; getGatewayResult.getId()))
 *             .apiId(exampleApi.apply(getApiResult -&gt; getApiResult.getId()))
 *             .build());
 * 
 *         }
 * }
