...
public final class WindowsWebAppAuthSettingsGithubArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppAuthSettingsGithubArgs Empty = new WindowsWebAppAuthSettingsGithubArgs();
    ...
    private WindowsWebAppAuthSettingsGithubArgs() {}

    private WindowsWebAppAuthSettingsGithubArgs(WindowsWebAppAuthSettingsGithubArgs $) {
    ...
    public static Builder builder(WindowsWebAppAuthSettingsGithubArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppAuthSettingsGithubArgs();
        }

        public Builder(WindowsWebAppAuthSettingsGithubArgs defaults) {
            $ = new WindowsWebAppAuthSettingsGithubArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppAuthSettingsGithubArgs build() {
