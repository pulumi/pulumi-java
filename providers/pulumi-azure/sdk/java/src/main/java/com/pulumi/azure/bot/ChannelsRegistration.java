...
public class ChannelsRegistration extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ Boolean> isolatedNetworkEnabled;

    /**
     * @return Is the Bot Channels Registration in an isolated network?
     * 
     */
    public Output<Optional<Boolean>> isolatedNetworkEnabled() {
        return Codegen.optional(this.isolatedNetworkEnabled);
    }
    /**
