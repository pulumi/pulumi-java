 ...
 *             .clusterVersion(&#34;3.6&#34;)
 *             .tier(&#34;Standard&#34;)
 *             .componentVersion(HadoopClusterComponentVersion.builder()
 *                 .hadoop(&#34;2.7&#34;)
 *                 .build())
 *             .gateway(HadoopClusterGateway.builder()
 *                 .username(&#34;acctestusrgw&#34;)
 *                 .password(&#34;PAssword123!&#34;)
 *                 .build())
 *             .storageAccounts(HadoopClusterStorageAccount.builder()
 *                 .storageContainerId(exampleContainer.getId())
 *                 .storageAccountKey(exampleAccount.getPrimaryAccessKey())
 *                 .isDefault(true)
 *                 .build())
 *             .roles(HadoopClusterRoles.builder()
 *                 .headNode(HadoopClusterRolesHeadNode.builder()
 *                     .vmSize(&#34;Standard_D3_V2&#34;)
 *                     .username(&#34;acctestusrvm&#34;)
 *                     .password(&#34;AccTestvdSC4daf986!&#34;)
 *                     .build())
 *                 .workerNode(HadoopClusterRolesWorkerNode.builder()
 *                     .vmSize(&#34;Standard_D4_V2&#34;)
 *                     .username(&#34;acctestusrvm&#34;)
 *                     .password(&#34;AccTestvdSC4daf986!&#34;)
 *                     .targetInstanceCount(3)
 *                     .build())
 *                 .zookeeperNode(HadoopClusterRolesZookeeperNode.builder()
 *                     .vmSize(&#34;Standard_D3_V2&#34;)
 *                     .username(&#34;acctestusrvm&#34;)
 *                     .password(&#34;AccTestvdSC4daf986!&#34;)
 *                     .build())
