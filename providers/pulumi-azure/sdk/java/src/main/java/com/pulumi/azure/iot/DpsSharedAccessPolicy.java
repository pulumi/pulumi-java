 ...
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .iothubDpsName(exampleIotHubDps.getName())
...
public class DpsSharedAccessPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public DpsSharedAccessPolicy(String name) {
     ...
     */
    public static DpsSharedAccessPolicy get(String name, Output<String> id, @Nullable DpsSharedAccessPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
