 ...
 *         var mainResourceGroup = new ResourceGroup(&#34;mainResourceGroup&#34;, ResourceGroupArgs.builder()        
 *             .location(&#34;West Europe&#34;)
 *             .build());
 * 
 *         var mainVirtualNetwork = new VirtualNetwork(&#34;mainVirtualNetwork&#34;, VirtualNetworkArgs.builder()        
 *             .addressSpaces(&#34;10.0.0.0/16&#34;)
 *             .location(mainResourceGroup.getLocation())
 *             .resourceGroupName(mainResourceGroup.getName())
 *             .build());
 * 
 *         var internal = new Subnet(&#34;internal&#34;, SubnetArgs.builder()        
 *             .resourceGroupName(mainResourceGroup.getName())
 *             .virtualNetworkName(mainVirtualNetwork.getName())
 ...
 *             .location(mainResourceGroup.getLocation())
 *             .resourceGroupName(mainResourceGroup.getName())
 *             .networkInterfaceIds(mainNetworkInterface.getId())
 *             .vmSize(&#34;Standard_DS1_v2&#34;)
 *             .storageImageReference(VirtualMachineStorageImageReference.builder()
 *                 .publisher(&#34;Canonical&#34;)
 *                 .offer(&#34;UbuntuServer&#34;)
 *                 .sku(&#34;16.04-LTS&#34;)
 *                 .version(&#34;latest&#34;)
 *                 .build())
 *             .storageOsDisk(VirtualMachineStorageOsDisk.builder()
 *                 .name(&#34;myosdisk1&#34;)
 *                 .caching(&#34;ReadWrite&#34;)
 *                 .createOption(&#34;FromImage&#34;)
 *                 .managedDiskType(&#34;Standard_LRS&#34;)
 *                 .build())
 *             .osProfile(VirtualMachineOsProfile.builder()
 *                 .computerName(&#34;hostname&#34;)
 *                 .adminUsername(&#34;testadmin&#34;)
 *                 .adminPassword(&#34;Password1234!&#34;)
 *                 .build())
 *             .osProfileLinuxConfig(VirtualMachineOsProfileLinuxConfig.builder()
...
public class VirtualMachine extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return A list of Network Interface ID&#39;s which should be associated with the Virtual Machine.
     * 
     */
