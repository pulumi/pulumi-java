...
public final class VnpGatewayNatRuleArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="externalAddressSpaceMappings", required=true)
     ...
     * 
     */
    @Import(name="internalAddressSpaceMappings", required=true)
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder externalAddressSpaceMappings(Output<List<String>> externalAddressSpaceMappings) {
         ...
         * 
         */
        public Builder internalAddressSpaceMappings(Output<List<String>> internalAddressSpaceMappings) {
        ...
        public VnpGatewayNatRuleArgs build() {
            $.externalAddressSpaceMappings = Objects.requireNonNull($.externalAddressSpaceMappings, "expected parameter 'externalAddressSpaceMappings' to be non-null");
            $.internalAddressSpaceMappings = Objects.requireNonNull($.internalAddressSpaceMappings, "expected parameter 'internalAddressSpaceMappings' to be non-null");
