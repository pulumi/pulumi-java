...
public final class DatasetSnowflakeArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatasetSnowflakeArgs Empty = new DatasetSnowflakeArgs();
    ...
    /**
     * @return Specifies the name of the Data Factory Dataset Snowflake. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
     * 
     */
    ...
    private DatasetSnowflakeArgs() {}

    private DatasetSnowflakeArgs(DatasetSnowflakeArgs $) {
    ...
    public static Builder builder(DatasetSnowflakeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatasetSnowflakeArgs();
        }

        public Builder(DatasetSnowflakeArgs defaults) {
            $ = new DatasetSnowflakeArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param name Specifies the name of the Data Factory Dataset Snowflake. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
         * 
         * @return builder
         * 
         */
        ...
        public DatasetSnowflakeArgs build() {
