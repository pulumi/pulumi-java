 ...
 *                 &#34;westus&#34;,
 *                 &#34;global&#34;)
 *             .servicebusRuleId(exampleEventHubNamespace.getId().apply(id -&gt; String.format(&#34;%s/authorizationrules/RootManageSharedAccessKey&#34;, id)))
 *             .storageAccountId(exampleAccount.getId())
 *             .retentionPolicy(LogProfileRetentionPolicy.builder()
 *                 .enabled(true)
 *                 .days(7)
 *                 .build())
 *             .build());
