 ...
 *             .location(exampleBackupVault.getLocation())
 *             .vaultId(exampleBackupVault.getId())
 *             .diskId(exampleManagedDisk.getId())
 *             .snapshotResourceGroupName(rg.getName())
 *             .backupPolicyId(exampleBackupPolicyDisk.getId())
 *             .build());
 * 
 *         }
 * }
