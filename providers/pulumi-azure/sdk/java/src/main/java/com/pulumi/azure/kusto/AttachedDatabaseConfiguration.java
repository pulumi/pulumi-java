 ...
 *             .resourceGroupName(rg.getName())
 *             .location(rg.getLocation())
 *             .clusterName(azurerm_kusto_cluster.getCluster2().getName())
 *             .build());
 * 
 ...
 *             .resourceGroupName(rg.getName())
 *             .location(rg.getLocation())
 *             .clusterName(followerCluster.getName())
 *             .clusterResourceId(followedCluster.getId())
 *             .databaseName(exampleDatabase.getName())
 *             .defaultPrincipalModificationsKind(&#34;Union&#34;)
 *             .sharing(AttachedDatabaseConfigurationSharing.builder()
