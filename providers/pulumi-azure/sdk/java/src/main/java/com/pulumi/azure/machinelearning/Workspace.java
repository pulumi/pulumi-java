 ...
 *                 .type(&#34;SystemAssigned&#34;)
 *                 .build())
 *             .encryption(WorkspaceEncryption.builder()
 *                 .keyVaultId(exampleKeyVault.getId())
 *                 .keyId(exampleKey.getId())
 *                 .build())
 *             .build());
 * 
 *         }
 ...
 *             .keyVaultId(exampleKeyVault.getId())
 *             .tenantId(current.apply(getClientConfigResult -&gt; getClientConfigResult.getTenantId()))
 *             .objectId(exampleUserAssignedIdentity.getPrincipalId())
 *             .keyPermissions(            
 *                 &#34;wrapKey&#34;,
 *                 &#34;unwrapKey&#34;,
 *                 &#34;get&#34;,
 ...
 *             .keyVaultId(exampleKeyVault.getId())
 *             .tenantId(current.apply(getClientConfigResult -&gt; getClientConfigResult.getTenantId()))
 *             .objectId(test.apply(getServicePrincipalResult -&gt; getServicePrincipalResult.getObjectId()))
 *             .keyPermissions(            
 *                 &#34;Get&#34;,
 *                 &#34;Recover&#34;,
 *                 &#34;UnwrapKey&#34;,
 ...
 *             .primaryUserAssignedIdentity(exampleUserAssignedIdentity.getId())
 *             .identity(WorkspaceIdentity.builder()
 *                 .type(&#34;UserAssigned&#34;)
 *                 .identityIds(exampleUserAssignedIdentity.getId())
 *                 .build())
 *             .encryption(WorkspaceEncryption.builder()
 *                 .userAssignedIdentityId(exampleUserAssignedIdentity.getId())
 *                 .keyVaultId(exampleKeyVault.getId())
 *                 .keyId(exampleKey.getId())
 *                 .build())
 *             .build());
