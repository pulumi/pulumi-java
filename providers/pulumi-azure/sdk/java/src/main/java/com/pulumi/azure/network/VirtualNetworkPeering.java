 ...
 *             .resourceGroupName(example.getName())
 *             .virtualNetworkName(example_1VirtualNetwork.getName())
 *             .remoteVirtualNetworkId(example_2VirtualNetwork.getId())
 *             .build());
 * 
 ...
 *             .resourceGroupName(example.getName())
 *             .virtualNetworkName(example_2VirtualNetwork.getName())
 *             .remoteVirtualNetworkId(example_1VirtualNetwork.getId())
 *             .build());
 * 
 *         }
 * }
