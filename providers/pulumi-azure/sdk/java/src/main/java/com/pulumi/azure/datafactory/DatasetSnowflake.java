 ...
 *             .linkedServiceName(azurerm_data_factory_linked_service_snowflake.getTest().getName())
...
public class DatasetSnowflake extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="schemaColumns", type=List.class, parameters={DatasetSnowflakeSchemaColumn.class})
    ...
    public DatasetSnowflake(String name, DatasetSnowflakeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:datafactory/datasetSnowflake:DatasetSnowflake", name, args == null ? DatasetSnowflakeArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
