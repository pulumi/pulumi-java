...
public final class WindowsVirtualMachineState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return . A list of Network Interface ID&#39;s which should be attached to this Virtual Machine. The first Network Interface ID in this list will be the Primary Network Interface on the Virtual Machine.
     * 
     */
     ...
     */
    @Import(name="osDisk")
    private @Nullable Output<WindowsVirtualMachineOsDiskArgs> osDisk;

    /**
     * @return A `os_disk` block as defined below.
     * 
     */
    public Optional<Output<WindowsVirtualMachineOsDiskArgs>> osDisk() {
    ...
    /**
     * @return The ID of the Image which this Virtual Machine should be created from. Changing this forces a new resource to be created.
     * 
     */
    ...
    /**
     * @return Specifies the Time Zone which should be used by the Virtual Machine, [the possible values are defined here](https://jackstromberg.com/2017/01/list-of-time-zones-consumed-by-azure/).
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param networkInterfaceIds . A list of Network Interface ID&#39;s which should be attached to this Virtual Machine. The first Network Interface ID in this list will be the Primary Network Interface on the Virtual Machine.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder osDisk(@Nullable Output<WindowsVirtualMachineOsDiskArgs> osDisk) {
            $.osDisk = osDisk;
            return this;
        }
        ...
        /**
         * @param sourceImageId The ID of the Image which this Virtual Machine should be created from. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param timezone Specifies the Time Zone which should be used by the Virtual Machine, [the possible values are defined here](https://jackstromberg.com/2017/01/list-of-time-zones-consumed-by-azure/).
         * 
         * @return builder
         * 
         */
