...
public final class CacheDefaultAccessPolicyAccessRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param rootSquashEnabled Whether to enable [root squash](https://docs.microsoft.com/en-us/azure/hpc-cache/access-policies#root-squash)? Defaults to `false`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param suidEnabled Whether [SUID](https://docs.microsoft.com/en-us/azure/hpc-cache/access-policies#suid) is allowed? Defaults to `false`.
         * 
         * @return builder
         * 
         */
