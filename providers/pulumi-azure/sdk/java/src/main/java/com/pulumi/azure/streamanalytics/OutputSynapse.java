 ...
 *             .server(azurerm_synapse_workspace.getTest().getConnectivity_endpoints().getSqlOnDemand())
 *             .user(azurerm_synapse_workspace.getTest().getSql_administrator_login())
 *             .password(azurerm_synapse_workspace.getTest().getSql_administrator_login_password())
 *             .database(&#34;master&#34;)
 *             .table(&#34;ExampleTable&#34;)
 *             .build());
 * 
