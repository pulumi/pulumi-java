...
public final class SlotAuthSettingsFacebookArgs extends com.pulumi.resources.ResourceArgs {

    public static final SlotAuthSettingsFacebookArgs Empty = new SlotAuthSettingsFacebookArgs();
    ...
    private SlotAuthSettingsFacebookArgs() {}

    private SlotAuthSettingsFacebookArgs(SlotAuthSettingsFacebookArgs $) {
        this.appId = $.appId;
    ...
    public static Builder builder(SlotAuthSettingsFacebookArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SlotAuthSettingsFacebookArgs();
        }

        public Builder(SlotAuthSettingsFacebookArgs defaults) {
            $ = new SlotAuthSettingsFacebookArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SlotAuthSettingsFacebookArgs build() {
