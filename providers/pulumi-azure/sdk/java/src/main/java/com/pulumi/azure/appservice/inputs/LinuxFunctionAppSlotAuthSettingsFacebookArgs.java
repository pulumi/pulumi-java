...
public final class LinuxFunctionAppSlotAuthSettingsFacebookArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppSlotAuthSettingsFacebookArgs Empty = new LinuxFunctionAppSlotAuthSettingsFacebookArgs();
    ...
    private LinuxFunctionAppSlotAuthSettingsFacebookArgs() {}

    private LinuxFunctionAppSlotAuthSettingsFacebookArgs(LinuxFunctionAppSlotAuthSettingsFacebookArgs $) {
        this.appId = $.appId;
    ...
    public static Builder builder(LinuxFunctionAppSlotAuthSettingsFacebookArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppSlotAuthSettingsFacebookArgs();
        }

        public Builder(LinuxFunctionAppSlotAuthSettingsFacebookArgs defaults) {
            $ = new LinuxFunctionAppSlotAuthSettingsFacebookArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppSlotAuthSettingsFacebookArgs build() {
