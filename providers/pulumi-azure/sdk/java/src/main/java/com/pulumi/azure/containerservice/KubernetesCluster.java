 ...
 *             .build());
 * 
 *         ctx.export(&#34;clientCertificate&#34;, exampleKubernetesCluster.getKubeConfigs().apply(kubeConfigs -&gt; kubeConfigs[0].getClientCertificate()));
 *         ctx.export(&#34;kubeConfig&#34;, exampleKubernetesCluster.getKubeConfigRaw());
 *         }
 * }
 * ```
 * 
...
public class KubernetesCluster extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return A `aci_connector_linux` block as defined below. For more details, please visit [Create and configure an AKS cluster to use virtual nodes](https://docs.microsoft.com/en-us/azure/aks/virtual-nodes-portal).
     * 
     */
    ...
    /**
     * @return The ID of the Disk Encryption Set which should be used for the Nodes and Volumes. More information [can be found in the documentation](https://docs.microsoft.com/en-us/azure/aks/azure-disk-customer-managed-keys).
     * 
     */
    ...
    /**
     * @return A `key_vault_secrets_provider` block as defined below. For more details, please visit [Azure Keyvault Secrets Provider for AKS](https://docs.microsoft.com/en-us/azure/aks/csi-secrets-store-driver).
     * 
     */
    ...
    /**
     * @return Version of Kubernetes specified when creating the AKS managed cluster. If not specified, the latest recommended version will be used at provisioning time (but won&#39;t auto-upgrade).
     * 
     */
    ...
    /**
     * @return - If `true` local accounts will be disabled. Defaults to `false`. See [the documentation](https://docs.microsoft.com/en-us/azure/aks/managed-aad#disable-local-accounts) for more information.
     * 
     */
    ...
    /**
     * @return Enable or Disable the [OIDC issuer URL](https://docs.microsoft.com/en-us/azure/aks/cluster-configuration#oidc-issuer-preview)
     * 
     */
