 ...
 *             .databaseName(azurerm_cosmosdb_sql_database.getExample().getName())
 *             .partitionKeyPath(&#34;/definition/id&#34;)
 *             .partitionKeyVersion(1)
 *             .throughput(400)
 *             .indexingPolicy(SqlContainerIndexingPolicy.builder()
 *                 .indexingMode(&#34;Consistent&#34;)
 *                 .includedPaths(                
 *                     SqlContainerIndexingPolicyIncludedPath.builder()
 *                         .path(&#34;/*&#34;)
 *                         .build(),
 *                     SqlContainerIndexingPolicyIncludedPath.builder()
 *                         .path(&#34;/included/?&#34;)
 *                         .build())
 *                 .excludedPaths(SqlContainerIndexingPolicyExcludedPath.builder()
 *                     .path(&#34;/excluded/?&#34;)
 *                     .build())
 *                 .build())
 *             .uniqueKeys(SqlContainerUniqueKey.builder()
 *                 .paths(                
 *                     &#34;/definition/idlong&#34;,
 *                     &#34;/definition/idshort&#34;)
 *                 .build())
