 ...
 *             .clientRootCertificates(VpnServerConfigurationClientRootCertificate.builder()
 ...
 *             .vpnServerConfigurationId(exampleVpnServerConfiguration.getId())
 *             .scaleUnit(1)
 *             .connectionConfiguration(PointToPointVpnGatewayConnectionConfiguration.builder()
