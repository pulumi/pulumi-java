 ...
 *             .customRules(            
 *                 PolicyCustomRule.builder()
 *                     .name(&#34;Rule1&#34;)
 *                     .priority(1)
 *                     .ruleType(&#34;MatchRule&#34;)
 *                     .matchConditions(PolicyCustomRuleMatchCondition.builder()
 *                         .matchVariables(PolicyCustomRuleMatchConditionMatchVariable.builder()
 ...
 *                     .action(&#34;Block&#34;)
 *                     .build())
 *             .policySettings(PolicyPolicySettings.builder()
 *                 .enabled(true)
 *                 .mode(&#34;Prevention&#34;)
 ...
 *                 .build())
 *             .managedRules(PolicyManagedRules.builder()
 *                 .exclusions(                
 ...
 *                         .build())
 *                 .managedRuleSets(PolicyManagedRulesManagedRuleSet.builder()
 *                     .type(&#34;OWASP&#34;)
 *                     .version(&#34;3.1&#34;)
 *                     .ruleGroupOverrides(PolicyManagedRulesManagedRuleSetRuleGroupOverride.builder()
