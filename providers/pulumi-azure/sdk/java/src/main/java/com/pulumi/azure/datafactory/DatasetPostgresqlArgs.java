...
public final class DatasetPostgresqlArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatasetPostgresqlArgs Empty = new DatasetPostgresqlArgs();
    ...
    /**
     * @return Specifies the name of the Data Factory Dataset PostgreSQL. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
     * 
     */
    ...
    private DatasetPostgresqlArgs() {}

    private DatasetPostgresqlArgs(DatasetPostgresqlArgs $) {
    ...
    public static Builder builder(DatasetPostgresqlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatasetPostgresqlArgs();
        }

        public Builder(DatasetPostgresqlArgs defaults) {
            $ = new DatasetPostgresqlArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param additionalProperties A map of additional properties to associate with the Data Factory Dataset PostgreSQL.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param annotations List of tags that can be used for describing the Data Factory Dataset PostgreSQL.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param description The description for the Data Factory Dataset PostgreSQL.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param name Specifies the name of the Data Factory Dataset PostgreSQL. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param parameters A map of parameters to associate with the Data Factory Dataset PostgreSQL.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder schemaColumns(@Nullable Output<List<DatasetPostgresqlSchemaColumnArgs>> schemaColumns) {
         ...
         * 
         */
        public Builder schemaColumns(List<DatasetPostgresqlSchemaColumnArgs> schemaColumns) {
         ...
         * 
         */
        public Builder schemaColumns(DatasetPostgresqlSchemaColumnArgs... schemaColumns) {
            return schemaColumns(List.of(schemaColumns));
        }

        /**
         * @param tableName The table name of the Data Factory Dataset PostgreSQL.
         * 
         * @return builder
         * 
         */
