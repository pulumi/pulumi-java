...
public final class OutputServiceBusQueueArgs extends com.pulumi.resources.ResourceArgs {

    public static final OutputServiceBusQueueArgs Empty = new OutputServiceBusQueueArgs();
    ...
    private Output<OutputServiceBusQueueSerializationArgs> serialization;

    /**
     * @return A `serialization` block as defined below.
     * 
     */
    public Output<OutputServiceBusQueueSerializationArgs> serialization() {
    ...
    private OutputServiceBusQueueArgs() {}

    private OutputServiceBusQueueArgs(OutputServiceBusQueueArgs $) {
        this.name = $.name;
    ...
    public static Builder builder(OutputServiceBusQueueArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OutputServiceBusQueueArgs();
        }

        public Builder(OutputServiceBusQueueArgs defaults) {
            $ = new OutputServiceBusQueueArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder serialization(Output<OutputServiceBusQueueSerializationArgs> serialization) {
