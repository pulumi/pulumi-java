...
public final class LinkServiceState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return A list of Frontend IP Configuration ID&#39;s from a Standard Load Balancer, where traffic from the Private Link Service should be routed. You can use Load Balancer Rules to direct this traffic to appropriate backend pools where your applications are running.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param loadBalancerFrontendIpConfigurationIds A list of Frontend IP Configuration ID&#39;s from a Standard Load Balancer, where traffic from the Private Link Service should be routed. You can use Load Balancer Rules to direct this traffic to appropriate backend pools where your applications are running.
         * 
         * @return builder
         * 
         */
