...
public class TriggerCustom extends com.pulumi.resources.CustomResource {
     ...
     */
    public TriggerCustom(String name) {
     ...
     */
    public static TriggerCustom get(String name, Output<String> id, @Nullable TriggerCustomState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
