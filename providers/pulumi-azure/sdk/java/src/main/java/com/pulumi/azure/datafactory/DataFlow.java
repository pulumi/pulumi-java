 ...
 *             .typePropertiesJson(exampleAccount.getPrimaryConnectionString().apply(primaryConnectionString -&gt; &#34;&#34;&#34;
 * {
 *   &#34;connectionString&#34;: &#34;%s&#34;
 * }
 ...
 *             .dataFactoryId(exampleFactory.getId())
 *             .linkedServiceName(exampleLinkedCustomService.getName())
 *             .azureBlobStorageLocation(DatasetJsonAzureBlobStorageLocation.builder()
 *                 .container(&#34;container&#34;)
 *                 .path(&#34;foo/bar/&#34;)
 *                 .filename(&#34;foo.txt&#34;)
 *                 .build())
 ...
 *             .dataFactoryId(exampleFactory.getId())
 *             .sources(DataFlowSource.builder()
 *                 .name(&#34;source1&#34;)
 *                 .dataset(DataFlowSourceDataset.builder()
 *                     .name(example1.getName())
 *                     .build())
 *                 .build())
 *             .sinks(DataFlowSink.builder()
 *                 .name(&#34;sink1&#34;)
 *                 .dataset(DataFlowSinkDataset.builder()
 *                     .name(example2.getName())
 *                     .build())
 *                 .build())
 *             .script(&#34;&#34;&#34;
 * source(
