...
@CustomType
public final class SlotAuthSettingsFacebook {
    /**
    ...
    public static Builder builder(SlotAuthSettingsFacebook defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SlotAuthSettingsFacebook defaults) {
        ...
        }        public SlotAuthSettingsFacebook build() {
            return new SlotAuthSettingsFacebook(appId, appSecret, oauthScopes);
        }
    }
}
