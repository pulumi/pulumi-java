...
public final class BillingFunctions {
     ...
     *             .build()));
     * 
     *         ctx.export(&#34;id&#34;, example.apply(getEnrollmentAccountScopeResult -&gt; getEnrollmentAccountScopeResult.getId()));
     *         }
     * }
     * ```
     * 
     ...
     *             .build()));
     * 
     *         ctx.export(&#34;id&#34;, example.apply(getMcaAccountScopeResult -&gt; getMcaAccountScopeResult.getId()));
     *         }
     * }
     * ```
     * 
     ...
     *             .build()));
     * 
     *         ctx.export(&#34;id&#34;, example.apply(getMpaAccountScopeResult -&gt; getMpaAccountScopeResult.getId()));
     *         }
     * }
     * ```
     * 
