 ...
 *             .location(&#34;westus&#34;)
 *             .identity(SubscriptionPolicyAssignmentIdentity.builder()
 *                 .type(&#34;SystemAssigned&#34;)
 *                 .build())
 *             .build());
 * 
 ...
 *             .resourceGroupId(exampleSubscription.apply(getBudgetSubscriptionResult -&gt; getBudgetSubscriptionResult.getId()))
 *             .policyAssignmentId(exampleSubscriptionPolicyAssignment.getId())
