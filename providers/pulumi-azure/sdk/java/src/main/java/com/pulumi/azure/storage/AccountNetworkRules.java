 ...
 *             .build());
 * 
 *         var test = new AccountNetworkRules(&#34;test&#34;, AccountNetworkRulesArgs.builder()        
 *             .storageAccountId(azurerm_storage_account.getTest().getId())
 *             .defaultAction(&#34;Allow&#34;)
 *             .ipRules(&#34;127.0.0.1&#34;)
 *             .virtualNetworkSubnetIds(azurerm_subnet.getTest().getId())
 *             .bypasses(&#34;Metrics&#34;)
 *             .build());
 * 
 *         }
