 ...
 *             .dataFactoryId(exampleFactory.getId())
 *             .linkedServiceName(exampleLinkedServicePostgresql.getName())
 *             .build());
 * 
 *         }
 * }
...
public class DatasetPostgresql extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="schemaColumns", type=List.class, parameters={DatasetPostgresqlSchemaColumn.class})
     ...
     */
    public DatasetPostgresql(String name) {
     ...
     */
    public static DatasetPostgresql get(String name, Output<String> id, @Nullable DatasetPostgresqlState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
