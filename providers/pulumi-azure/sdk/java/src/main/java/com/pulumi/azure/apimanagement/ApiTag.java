 ...
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .apiManagementName(azurerm_api_management.getExample().getName())
 *             .revision(&#34;1&#34;)
 *             .build());
 * 
 *         var exampleTag = new Tag(&#34;exampleTag&#34;, TagArgs.builder()        
 *             .apiManagementId(exampleService.apply(getServiceResult -&gt; getServiceResult).apply(exampleService -&gt; exampleService.apply(getServiceResult -&gt; getServiceResult.getId())))
 *             .build());
 * 
