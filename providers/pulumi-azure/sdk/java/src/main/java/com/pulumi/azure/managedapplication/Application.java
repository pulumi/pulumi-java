 ...
 * 
 *         final var builtin = Output.of(AuthorizationFunctions.getRoleDefinition(GetRoleDefinitionArgs.builder()
 *             .name(&#34;Contributor&#34;)
 *             .build()));
 * 
 ...
 *             .authorizations(DefinitionAuthorization.builder()
 *                 .servicePrincipalId(current.apply(getClientConfigResult -&gt; getClientConfigResult.getObjectId()))
 *                 .roleDefinitionId(builtin.apply(getRoleDefinitionResult -&gt; getRoleDefinitionResult.getId()).split(&#34;/&#34;)[builtin.apply(getRoleDefinitionResult -&gt; getRoleDefinitionResult.getId()).split(&#34;/&#34;).length() - 1])
 *                 .build())
 *             .build());
 * 
 ...
 *             .applicationDefinitionId(exampleDefinition.getId())
 *             .parameters(Map.ofEntries(
 *                 Map.entry(&#34;location&#34;, exampleResourceGroup.getLocation()),
