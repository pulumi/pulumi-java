 ...
 *             .remoteVpnSiteId(exampleVpnSite.getId())
 *             .vpnLinks(            
 *                 VpnGatewayConnectionVpnLink.builder()
 *                     .name(&#34;link1&#34;)
 *                     .vpnSiteLinkId(exampleVpnSite.getLinks().apply(links -&gt; links[0].getId()))
 *                     .build(),
 *                 VpnGatewayConnectionVpnLink.builder()
 *                     .name(&#34;link2&#34;)
 *                     .vpnSiteLinkId(exampleVpnSite.getLinks().apply(links -&gt; links[1].getId()))
 *                     .build())
 *             .build());
 * 
 *         }
