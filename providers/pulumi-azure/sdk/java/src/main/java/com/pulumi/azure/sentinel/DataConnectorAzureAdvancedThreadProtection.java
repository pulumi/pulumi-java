...
import com.pulumi.azure.sentinel.inputs.DataConnectorAzureAdvancedThreadProtectionState;
 ...
 * 
 */
@ResourceType(type="azure:sentinel/dataConnectorAzureAdvancedThreadProtection:DataConnectorAzureAdvancedThreadProtection")
public class DataConnectorAzureAdvancedThreadProtection extends com.pulumi.resources.CustomResource {
    /**
    ...
    /**
     * @return The ID of the Log Analytics Workspace that this Azure Advanced Threat Protection Data Connector resides in. Changing this forces a new Azure Advanced Threat Protection Data Connector to be created.
     * 
     */
    ...
    /**
     * @return The name which should be used for this Azure Advanced Threat Protection Data Connector. Changing this forces a new Azure Advanced Threat Protection Data Connector to be created.
     * 
     */
    ...
    /**
     * @return The ID of the tenant that this Azure Advanced Threat Protection Data Connector connects to. Changing this forces a new Azure Advanced Threat Protection Data Connector to be created.
     * 
     */
     ...
     */
    public DataConnectorAzureAdvancedThreadProtection(String name) {
        this(name, DataConnectorAzureAdvancedThreadProtectionArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DataConnectorAzureAdvancedThreadProtection(String name, DataConnectorAzureAdvancedThreadProtectionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DataConnectorAzureAdvancedThreadProtection(String name, DataConnectorAzureAdvancedThreadProtectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:sentinel/dataConnectorAzureAdvancedThreadProtection:DataConnectorAzureAdvancedThreadProtection", name, args == null ? DataConnectorAzureAdvancedThreadProtectionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DataConnectorAzureAdvancedThreadProtection(String name, Output<String> id, @Nullable DataConnectorAzureAdvancedThreadProtectionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:sentinel/dataConnectorAzureAdvancedThreadProtection:DataConnectorAzureAdvancedThreadProtection", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static DataConnectorAzureAdvancedThreadProtection get(String name, Output<String> id, @Nullable DataConnectorAzureAdvancedThreadProtectionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
