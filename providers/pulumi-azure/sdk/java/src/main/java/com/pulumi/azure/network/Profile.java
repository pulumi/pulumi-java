 ...
 *             .location(exampleResourceGroup.getLocation())
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .containerNetworkInterface(ProfileContainerNetworkInterface.builder()
 *                 .name(&#34;examplecnic&#34;)
 *                 .ipConfigurations(ProfileContainerNetworkInterfaceIpConfiguration.builder()
...
public class Profile extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return A list of Container Network Interface ID&#39;s.
     * 
     */
