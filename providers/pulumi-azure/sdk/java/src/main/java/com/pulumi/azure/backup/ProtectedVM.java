 ...
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .recoveryVaultName(exampleVault.getName())
 *             .backup(PolicyVMBackup.builder()
 *                 .frequency(&#34;Daily&#34;)
 *                 .time(&#34;23:00&#34;)
 *                 .build())
 *             .build());
 ...
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .recoveryVaultName(exampleVault.getName())
 *             .sourceVmId(azurerm_virtual_machine.getExample().getId())
 *             .backupPolicyId(examplePolicyVM.getId())
 *             .build());
 * 
 *         }
 * }
