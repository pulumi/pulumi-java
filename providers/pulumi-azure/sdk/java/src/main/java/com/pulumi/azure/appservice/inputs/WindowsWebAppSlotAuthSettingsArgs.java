...
import com.pulumi.azure.appservice.inputs.WindowsWebAppSlotAuthSettingsActiveDirectoryArgs;
import com.pulumi.azure.appservice.inputs.WindowsWebAppSlotAuthSettingsFacebookArgs;
import com.pulumi.azure.appservice.inputs.WindowsWebAppSlotAuthSettingsGithubArgs;
import com.pulumi.azure.appservice.inputs.WindowsWebAppSlotAuthSettingsGoogleArgs;
import com.pulumi.azure.appservice.inputs.WindowsWebAppSlotAuthSettingsMicrosoftArgs;
import com.pulumi.azure.appservice.inputs.WindowsWebAppSlotAuthSettingsTwitterArgs;
...
public final class WindowsWebAppSlotAuthSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSlotAuthSettingsArgs Empty = new WindowsWebAppSlotAuthSettingsArgs();
    ...
    private @Nullable Output<WindowsWebAppSlotAuthSettingsActiveDirectoryArgs> activeDirectory;

    /**
     * @return An `active_directory` block as defined above.
     * 
     */
    public Optional<Output<WindowsWebAppSlotAuthSettingsActiveDirectoryArgs>> activeDirectory() {
    ...
    private @Nullable Output<WindowsWebAppSlotAuthSettingsFacebookArgs> facebook;

    /**
     * @return A `facebook` block as defined below.
     * 
     */
    public Optional<Output<WindowsWebAppSlotAuthSettingsFacebookArgs>> facebook() {
     ...
     */
    @Import(name="github")
    private @Nullable Output<WindowsWebAppSlotAuthSettingsGithubArgs> github;

    /**
     * @return A `github` block as defined below.
     * 
     */
    public Optional<Output<WindowsWebAppSlotAuthSettingsGithubArgs>> github() {
     ...
     */
    @Import(name="google")
    private @Nullable Output<WindowsWebAppSlotAuthSettingsGoogleArgs> google;

    /**
     * @return A `google` block as defined below.
     * 
     */
    public Optional<Output<WindowsWebAppSlotAuthSettingsGoogleArgs>> google() {
    ...
    private @Nullable Output<WindowsWebAppSlotAuthSettingsMicrosoftArgs> microsoft;

    /**
     * @return A `microsoft` block as defined below.
     * 
     */
    public Optional<Output<WindowsWebAppSlotAuthSettingsMicrosoftArgs>> microsoft() {
     ...
     */
    @Import(name="twitter")
    private @Nullable Output<WindowsWebAppSlotAuthSettingsTwitterArgs> twitter;

    /**
     * @return A `twitter` block as defined below.
     * 
     */
    public Optional<Output<WindowsWebAppSlotAuthSettingsTwitterArgs>> twitter() {
    ...
    private WindowsWebAppSlotAuthSettingsArgs() {}

    private WindowsWebAppSlotAuthSettingsArgs(WindowsWebAppSlotAuthSettingsArgs $) {
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotAuthSettingsArgs();
        }

        public Builder(WindowsWebAppSlotAuthSettingsArgs defaults) {
            $ = new WindowsWebAppSlotAuthSettingsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder activeDirectory(@Nullable Output<WindowsWebAppSlotAuthSettingsActiveDirectoryArgs> activeDirectory) {
         ...
         * 
         */
        public Builder activeDirectory(WindowsWebAppSlotAuthSettingsActiveDirectoryArgs activeDirectory) {
        ...
        /**
         * @param allowedExternalRedirectUrls Specifies a list of External URLs that can be redirected to as part of logging in or logging out of the Windows Web App Slot.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param enabled Should the Authentication / Authorization feature be enabled for the Windows Web App?
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder facebook(@Nullable Output<WindowsWebAppSlotAuthSettingsFacebookArgs> facebook) {
            $.facebook = facebook;
            return this;
        }
         ...
         * 
         */
        public Builder facebook(WindowsWebAppSlotAuthSettingsFacebookArgs facebook) {
         ...
         * 
         */
        public Builder github(@Nullable Output<WindowsWebAppSlotAuthSettingsGithubArgs> github) {
            $.github = github;
            return this;
        }
         ...
         * 
         */
        public Builder github(WindowsWebAppSlotAuthSettingsGithubArgs github) {
         ...
         * 
         */
        public Builder google(@Nullable Output<WindowsWebAppSlotAuthSettingsGoogleArgs> google) {
            $.google = google;
            return this;
        }
         ...
         * 
         */
        public Builder google(WindowsWebAppSlotAuthSettingsGoogleArgs google) {
            return google(Output.of(google));
        }

        /**
         * @param issuer The OpenID Connect Issuer URI that represents the entity which issues access tokens for this Windows Web App Slot.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder microsoft(@Nullable Output<WindowsWebAppSlotAuthSettingsMicrosoftArgs> microsoft) {
            $.microsoft = microsoft;
            return this;
        }
         ...
         * 
         */
        public Builder microsoft(WindowsWebAppSlotAuthSettingsMicrosoftArgs microsoft) {
        ...
        /**
         * @param tokenStoreEnabled Should the Windows Web App Slot durably store platform-specific security tokens that are obtained during login flows? Defaults to `false`.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder twitter(@Nullable Output<WindowsWebAppSlotAuthSettingsTwitterArgs> twitter) {
            $.twitter = twitter;
            return this;
        }
         ...
         * 
         */
        public Builder twitter(WindowsWebAppSlotAuthSettingsTwitterArgs twitter) {
        ...
        public WindowsWebAppSlotAuthSettingsArgs build() {
