...
public final class WorkspaceCustomParametersArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The resource ID of the `azure.network.SubnetNetworkSecurityGroupAssociation` resource which is referred to by the `private_subnet_name` field. Required if `virtual_network_id` is set.
     * 
     */
    ...
    /**
     * @return The resource ID of the `azure.network.SubnetNetworkSecurityGroupAssociation` resource which is referred to by the `public_subnet_name` field. Required if `virtual_network_id` is set.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param privateSubnetNetworkSecurityGroupAssociationId The resource ID of the `azure.network.SubnetNetworkSecurityGroupAssociation` resource which is referred to by the `private_subnet_name` field. Required if `virtual_network_id` is set.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param publicSubnetNetworkSecurityGroupAssociationId The resource ID of the `azure.network.SubnetNetworkSecurityGroupAssociation` resource which is referred to by the `public_subnet_name` field. Required if `virtual_network_id` is set.
         * 
         * @return builder
         * 
         */
