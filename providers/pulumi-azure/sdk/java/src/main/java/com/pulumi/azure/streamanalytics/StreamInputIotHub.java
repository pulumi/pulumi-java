 ...
 *             .iothubNamespace(exampleIoTHub.getName())
 *             .sharedAccessPolicyKey(exampleIoTHub.getSharedAccessPolicies().apply(sharedAccessPolicies -&gt; sharedAccessPolicies[0].getPrimaryKey()))
 *             .sharedAccessPolicyName(&#34;iothubowner&#34;)
 *             .serialization(StreamInputIotHubSerialization.builder()
 *                 .type(&#34;Json&#34;)
 *                 .encoding(&#34;UTF8&#34;)
 *                 .build())
 *             .build());
