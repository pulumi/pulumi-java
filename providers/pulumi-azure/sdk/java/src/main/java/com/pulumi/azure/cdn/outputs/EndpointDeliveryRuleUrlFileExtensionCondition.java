...
@CustomType
public final class EndpointDeliveryRuleUrlFileExtensionCondition {
    /**
    ...
    private EndpointDeliveryRuleUrlFileExtensionCondition(
    ...
    public static Builder builder(EndpointDeliveryRuleUrlFileExtensionCondition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(EndpointDeliveryRuleUrlFileExtensionCondition defaults) {
        ...
        }        public EndpointDeliveryRuleUrlFileExtensionCondition build() {
            return new EndpointDeliveryRuleUrlFileExtensionCondition(matchValues, negateCondition, operator, transforms);
        }
    }
}
