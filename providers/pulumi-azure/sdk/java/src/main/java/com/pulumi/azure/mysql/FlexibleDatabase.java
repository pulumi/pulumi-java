 ...
 *             .build());
 * 
 *         var test = new FlexibleServer(&#34;test&#34;, FlexibleServerArgs.builder()        
 ...
 *             .serverName(azurerm_mysql_flexible_server.getExample().getName())
 *             .charset(&#34;utf8&#34;)
...
public class FlexibleDatabase extends com.pulumi.resources.CustomResource {
     ...
     */
    public FlexibleDatabase(String name) {
     ...
     */
    public static FlexibleDatabase get(String name, Output<String> id, @Nullable FlexibleDatabaseState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
