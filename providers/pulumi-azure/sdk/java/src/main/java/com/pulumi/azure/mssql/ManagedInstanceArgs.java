...
public final class ManagedInstanceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The ID of the SQL Managed Instance which will share the DNS zone. This is a prerequisite for creating an `azurerm_managed_instance_failover_group`. Setting this after creation forces a new resource to be created.
     * 
     */
    ...
    /**
     * @return Number of cores that should be assigned to the SQL Managed Instance. Values can be `8`, `16`, or `24` for Gen4 SKUs, or `8`, `16`, `24`, `32`, or `40` for Gen5 SKUs.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param dnsZonePartnerId The ID of the SQL Managed Instance which will share the DNS zone. This is a prerequisite for creating an `azurerm_managed_instance_failover_group`. Setting this after creation forces a new resource to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param resourceGroupName The name of the resource group in which to create the SQL Managed Instance.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param vcores Number of cores that should be assigned to the SQL Managed Instance. Values can be `8`, `16`, or `24` for Gen4 SKUs, or `8`, `16`, `24`, `32`, or `40` for Gen5 SKUs.
         * 
         * @return builder
         * 
         */
