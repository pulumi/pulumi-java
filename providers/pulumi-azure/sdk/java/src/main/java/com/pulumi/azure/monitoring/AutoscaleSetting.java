 ...
 *             .build());
 * 
 *         var exampleScaleSet = new ScaleSet(&#34;exampleScaleSet&#34;);
 * 
 *         var exampleAutoscaleSetting = new AutoscaleSetting(&#34;exampleAutoscaleSetting&#34;, AutoscaleSettingArgs.builder()        
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .location(exampleResourceGroup.getLocation())
 *             .targetResourceId(exampleScaleSet.getId())
 *             .profiles(AutoscaleSettingProfile.builder()
 *                 .name(&#34;defaultProfile&#34;)
 *                 .capacity(AutoscaleSettingProfileCapacity.builder()
 *                     .default_(1)
 *                     .minimum(1)
 *                     .maximum(10)
 *                     .build())
 *                 .rules(                
 *                     AutoscaleSettingProfileRule.builder()
 *                         .metricTrigger(AutoscaleSettingProfileRuleMetricTrigger.builder()
 *                             .metricName(&#34;Percentage CPU&#34;)
 *                             .metricResourceId(exampleScaleSet.getId())
 *                             .timeGrain(&#34;PT1M&#34;)
 *                             .statistic(&#34;Average&#34;)
 *                             .timeWindow(&#34;PT5M&#34;)
 ...
 *                             .dimensions(AutoscaleSettingProfileRuleMetricTriggerDimension.builder()
 *                                 .name(&#34;AppName&#34;)
 *                                 .operator(&#34;Equals&#34;)
 *                                 .values(&#34;App1&#34;)
 *                                 .build())
 *                             .build())
 *                         .scaleAction(AutoscaleSettingProfileRuleScaleAction.builder()
 *                             .direction(&#34;Increase&#34;)
 *                             .type(&#34;ChangeCount&#34;)
 *                             .value(&#34;1&#34;)
 *                             .cooldown(&#34;PT1M&#34;)
 ...
 *                         .build())
 *                 .build())
 *             .notification(AutoscaleSettingNotification.builder()
 *                 .email(AutoscaleSettingNotificationEmail.builder()
 ...
 *                             .build())
 *                         .build())
 *                 .recurrence(AutoscaleSettingProfileRecurrence.builder()
 *                     .frequency(&#34;Week&#34;)
 ...
 *                             .build())
 *                         .build())
 *                 .fixedDate(AutoscaleSettingProfileFixedDate.builder()
 *                     .timezone(&#34;Pacific Standard Time&#34;)
