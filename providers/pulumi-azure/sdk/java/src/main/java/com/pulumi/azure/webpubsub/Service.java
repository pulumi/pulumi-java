 ...
 *             .liveTrace(ServiceLiveTrace.builder()
 *                 .enabled(true)
 *                 .messagingLogsEnabled(true)
 *                 .connectivityLogsEnabled(false)
 *                 .build())
 *             .identity(ServiceIdentity.builder()
 *                 .type(&#34;SystemAssigned&#34;)
 *                 .build())
 *             .build());
 * 
...
public class Service extends com.pulumi.resources.CustomResource {
    ...
    public Service(String name, ServiceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:webpubsub/service:Service", name, args == null ? ServiceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Service(String name, Output<String> id, @Nullable ServiceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:webpubsub/service:Service", name, state, makeResourceOptions(options, id));
    }
