...
import com.pulumi.azure.cosmosdb.inputs.GremlinDatabaseState;
import com.pulumi.azure.cosmosdb.outputs.GremlinDatabaseAutoscaleSettings;
 ...
 * 
 */
@ResourceType(type="azure:cosmosdb/gremlinDatabase:GremlinDatabase")
public class GremlinDatabase extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    public Output<Optional<GremlinDatabaseAutoscaleSettings>> autoscaleSettings() {
    ...
    public GremlinDatabase(String name, GremlinDatabaseArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:cosmosdb/gremlinDatabase:GremlinDatabase", name, args == null ? GremlinDatabaseArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
