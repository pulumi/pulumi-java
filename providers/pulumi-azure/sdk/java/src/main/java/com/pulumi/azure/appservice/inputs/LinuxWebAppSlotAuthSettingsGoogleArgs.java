...
public final class LinuxWebAppSlotAuthSettingsGoogleArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotAuthSettingsGoogleArgs Empty = new LinuxWebAppSlotAuthSettingsGoogleArgs();
    ...
    private LinuxWebAppSlotAuthSettingsGoogleArgs() {}

    private LinuxWebAppSlotAuthSettingsGoogleArgs(LinuxWebAppSlotAuthSettingsGoogleArgs $) {
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsGoogleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotAuthSettingsGoogleArgs();
        }

        public Builder(LinuxWebAppSlotAuthSettingsGoogleArgs defaults) {
            $ = new LinuxWebAppSlotAuthSettingsGoogleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppSlotAuthSettingsGoogleArgs build() {
