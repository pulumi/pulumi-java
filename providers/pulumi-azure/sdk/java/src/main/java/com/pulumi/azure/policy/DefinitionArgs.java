...
public final class DefinitionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The name of the Management Group where this policy should be defined. Changing this forces a new resource to be created.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param managementGroupId The name of the Management Group where this policy should be defined. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
