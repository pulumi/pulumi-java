 ...
 *             .assetId(exampleAsset.getId())
 *             .firstQualityBitrate(128000)
 *             .presentationTimeRange(AssetFilterPresentationTimeRange.builder()
 *                 .startInUnits(0)
 *                 .endInUnits(15)
 ...
 *                 .build())
 *             .trackSelections(            
 *                 AssetFilterTrackSelection.builder()
 *                     .conditions(                    
 *                         AssetFilterTrackSelectionCondition.builder()
 *                             .property(&#34;Type&#34;)
 *                             .operation(&#34;Equal&#34;)
 *                             .value(&#34;Audio&#34;)
 *                             .build(),
