 ...
 *             .streamAnalyticsJobId(azurerm_stream_analytics_job.getExample().getId())
 *             .cosmosdbAccountKey(exampleAccount.getPrimaryKey())
 *             .cosmosdbSqlDatabaseId(exampleSqlDatabase.getId())
