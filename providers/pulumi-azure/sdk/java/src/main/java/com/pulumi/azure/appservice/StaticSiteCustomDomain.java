 ...
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .ttl(300)
 *             .record(exampleStaticSite.getDefaultHostName())
 *             .build());
 * 
 ...
 *             .staticSiteId(exampleStaticSite.getId())
 *             .domainName(Output.tuple(exampleCNameRecord.getName(), exampleCNameRecord.getZoneName()).apply(values -&gt; {
 *                 var name = values.t1;
