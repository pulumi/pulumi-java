...
public final class EndpointCustomDomainCdnManagedHttps {
    ...
    /**
     * @return The TLS protocol version that is used for HTTPS. Possible values are `TLS10` (representing TLS 1.0/1.1) and `TLS12` (representing TLS 1.2). Defaults to `TLS12`.
     * 
     */
