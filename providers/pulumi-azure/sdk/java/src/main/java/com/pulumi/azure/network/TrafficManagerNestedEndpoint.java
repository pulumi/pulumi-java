 ...
 *             .dnsConfig(TrafficManagerProfileDnsConfig.builder()
 *                 .relativeName(&#34;parent-profile&#34;)
 *                 .ttl(100)
 *                 .build())
 *             .monitorConfig(TrafficManagerProfileMonitorConfig.builder()
 *                 .protocol(&#34;http&#34;)
 *                 .port(80)
 *                 .path(&#34;/&#34;)
 ...
 *             .build());
 * 
 *         var test = new TrafficManagerNestedEndpoint(&#34;test&#34;, TrafficManagerNestedEndpointArgs.builder()        
 *             .targetResourceId(azurerm_traffic_manager_profile.getChild().getId())
 *             .priority(1)
