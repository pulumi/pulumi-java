 ...
 *             .eventhubPrimaryConnectionString(exampleAuthorizationRule.getPrimaryConnectionString())
 *             .eventhubSecondaryConnectionString(exampleAuthorizationRule.getSecondaryConnectionString())
 *             .build());
 * 
 *         }
 * }
