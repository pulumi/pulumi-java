...
public class AssessmentPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public AssessmentPolicy(String name) {
     ...
     */
    public static AssessmentPolicy get(String name, Output<String> id, @Nullable AssessmentPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
