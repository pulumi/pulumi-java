...
public final class VpnGatewayConnectionVpnLink {
    ...
    public static final class Builder {
        ...
        public Builder vpnSiteLinkId(String vpnSiteLinkId) {
            ...
            return new VpnGatewayConnectionVpnLink(bandwidthMbps, bgpEnabled, connectionMode, egressNatRuleIds, ingressNatRuleIds, ipsecPolicies, localAzureIpAddressEnabled, name, policyBasedTrafficSelectorEnabled, protocol, ratelimitEnabled, routeWeight, sharedKey, vpnSiteLinkId);
        }
    }
}
