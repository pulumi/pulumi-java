...
public final class LinuxFunctionAppAuthSettingsFacebookArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppAuthSettingsFacebookArgs Empty = new LinuxFunctionAppAuthSettingsFacebookArgs();
    ...
    private LinuxFunctionAppAuthSettingsFacebookArgs() {}

    private LinuxFunctionAppAuthSettingsFacebookArgs(LinuxFunctionAppAuthSettingsFacebookArgs $) {
        this.appId = $.appId;
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsFacebookArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppAuthSettingsFacebookArgs();
        }

        public Builder(LinuxFunctionAppAuthSettingsFacebookArgs defaults) {
            $ = new LinuxFunctionAppAuthSettingsFacebookArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppAuthSettingsFacebookArgs build() {
