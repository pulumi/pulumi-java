 ...
 *             .validityPeriod(&#34;P1D&#34;)
 *             .managedStorageAccountId(azurerm_key_vault_managed_storage_account.getExample().getId())
 *             .sasTemplateUri(exampleAccountSAS.apply(getAccountSASResult -&gt; getAccountSASResult).apply(exampleAccountSAS -&gt; exampleAccountSAS.apply(getAccountSASResult -&gt; getAccountSASResult.getSas())))
 *             .sasType(&#34;account&#34;)
 *             .build());
 * 
 *         }
