 ...
 *             .principalId(exampleClientConfig.apply(getClientConfigResult -&gt; getClientConfigResult.getObjectId()))
 *             .build());
 * 
 *         }
 * }
 ...
 *             .scope(primary.apply(getBudgetSubscriptionResult -&gt; getBudgetSubscriptionResult.getId()))
 *             .roleDefinitionId(exampleRoleDefinition.getRoleDefinitionResourceId())
 *             .principalId(exampleClientConfig.apply(getClientConfigResult -&gt; getClientConfigResult.getObjectId()))
 *             .build());
 * 
 *         }
 ...
 *         final var exampleClientConfig = Output.of(CoreFunctions.getClientConfig());
 * 
 *         final var exampleGroup = Output.of(ManagementFunctions.getGroup());
 * 
 *         var exampleRoleDefinition = new RoleDefinition(&#34;exampleRoleDefinition&#34;, RoleDefinitionArgs.builder()        
 *             .roleDefinitionId(&#34;00000000-0000-0000-0000-000000000000&#34;)
 *             .scope(primary.apply(getBudgetSubscriptionResult -&gt; getBudgetSubscriptionResult.getId()))
 ...
 *         var exampleAssignment = new Assignment(&#34;exampleAssignment&#34;, AssignmentArgs.builder()        
 *             .name(&#34;00000000-0000-0000-0000-000000000000&#34;)
 *             .scope(data.getAzurerm_management_group().getPrimary().getId())
 *             .roleDefinitionId(exampleRoleDefinition.getRoleDefinitionResourceId())
 *             .principalId(exampleClientConfig.apply(getClientConfigResult -&gt; getClientConfigResult.getObjectId()))
 *             .build());
 * 
...
public class Assignment extends com.pulumi.resources.CustomResource {
    ...
    public Assignment(String name, AssignmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:role/assignment:Assignment", name, args == null ? AssignmentArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
