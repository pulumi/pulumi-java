...
public final class LinuxWebAppAuthSettingsGithubArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppAuthSettingsGithubArgs Empty = new LinuxWebAppAuthSettingsGithubArgs();
    ...
    private LinuxWebAppAuthSettingsGithubArgs() {}

    private LinuxWebAppAuthSettingsGithubArgs(LinuxWebAppAuthSettingsGithubArgs $) {
    ...
    public static Builder builder(LinuxWebAppAuthSettingsGithubArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppAuthSettingsGithubArgs();
        }

        public Builder(LinuxWebAppAuthSettingsGithubArgs defaults) {
            $ = new LinuxWebAppAuthSettingsGithubArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppAuthSettingsGithubArgs build() {
