...
public class GroupPolicyAssignment extends com.pulumi.resources.CustomResource {
     ...
     */
    public GroupPolicyAssignment(String name) {
     ...
     */
    public static GroupPolicyAssignment get(String name, Output<String> id, @Nullable GroupPolicyAssignmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
