 ...
 *             .dataFactoryId(testFactory.getId())
 *             .keyVaultId(testKeyVault.getId())
 *             .build());
 * 
 ...
 *             .keyVaultSasToken(LinkedServiceAzureBlobStorageKeyVaultSasToken.builder()
 *                 .linkedServiceName(testLinkedServiceKeyVault.getName())
 *                 .secretName(&#34;secret&#34;)
 *                 .build())
 *             .build());
 * 
 ...
 *             .servicePrincipalLinkedKeyVaultKey(LinkedServiceAzureBlobStorageServicePrincipalLinkedKeyVaultKey.builder()
 *                 .linkedServiceName(testLinkedServiceKeyVault.getName())
 *                 .secretName(&#34;secret&#34;)
 *                 .build())
 *             .build());
