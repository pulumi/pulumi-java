 ...
 *             .apiManagementName(exampleApi.apply(getApiResult -&gt; getApiResult.getApiManagementName()))
 *             .resourceGroupName(exampleApi.apply(getApiResult -&gt; getApiResult.getResourceGroupName()))
 *             .displayName(&#34;Delete User Operation&#34;)
 *             .method(&#34;DELETE&#34;)
 *             .urlTemplate(&#34;/users/{id}/delete&#34;)
 *             .description(&#34;This can only be done by the logged in user.&#34;)
 *             .responses(ApiOperationResponse.builder()
 *                 .statusCode(200)
 *                 .build())
 *             .build());
 * 
 *         var exampleApiOperationTag = new ApiOperationTag(&#34;exampleApiOperationTag&#34;, ApiOperationTagArgs.builder()        
 *             .apiOperationId(exampleApiOperation.getId())
 *             .build());
 * 
 *         }
 * }
