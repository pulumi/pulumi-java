...
public final class LinuxWebAppSlotAuthSettingsGithubArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotAuthSettingsGithubArgs Empty = new LinuxWebAppSlotAuthSettingsGithubArgs();
    ...
    private LinuxWebAppSlotAuthSettingsGithubArgs() {}

    private LinuxWebAppSlotAuthSettingsGithubArgs(LinuxWebAppSlotAuthSettingsGithubArgs $) {
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsGithubArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotAuthSettingsGithubArgs();
        }

        public Builder(LinuxWebAppSlotAuthSettingsGithubArgs defaults) {
            $ = new LinuxWebAppSlotAuthSettingsGithubArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppSlotAuthSettingsGithubArgs build() {
