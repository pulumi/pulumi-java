...
public final class WindowsFunctionAppAuthSettingsFacebookArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppAuthSettingsFacebookArgs Empty = new WindowsFunctionAppAuthSettingsFacebookArgs();
    ...
    private WindowsFunctionAppAuthSettingsFacebookArgs() {}

    private WindowsFunctionAppAuthSettingsFacebookArgs(WindowsFunctionAppAuthSettingsFacebookArgs $) {
        this.appId = $.appId;
    ...
    public static Builder builder(WindowsFunctionAppAuthSettingsFacebookArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppAuthSettingsFacebookArgs();
        }

        public Builder(WindowsFunctionAppAuthSettingsFacebookArgs defaults) {
            $ = new WindowsFunctionAppAuthSettingsFacebookArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppAuthSettingsFacebookArgs build() {
