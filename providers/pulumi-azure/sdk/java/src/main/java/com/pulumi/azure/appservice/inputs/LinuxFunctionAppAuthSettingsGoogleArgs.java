...
public final class LinuxFunctionAppAuthSettingsGoogleArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppAuthSettingsGoogleArgs Empty = new LinuxFunctionAppAuthSettingsGoogleArgs();
    ...
    private LinuxFunctionAppAuthSettingsGoogleArgs() {}

    private LinuxFunctionAppAuthSettingsGoogleArgs(LinuxFunctionAppAuthSettingsGoogleArgs $) {
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsGoogleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppAuthSettingsGoogleArgs();
        }

        public Builder(LinuxFunctionAppAuthSettingsGoogleArgs defaults) {
            $ = new LinuxFunctionAppAuthSettingsGoogleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppAuthSettingsGoogleArgs build() {
