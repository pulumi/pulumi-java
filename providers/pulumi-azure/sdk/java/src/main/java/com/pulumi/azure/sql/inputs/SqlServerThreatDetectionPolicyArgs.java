...
public final class SqlServerThreatDetectionPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final SqlServerThreatDetectionPolicyArgs Empty = new SqlServerThreatDetectionPolicyArgs();
    ...
    private SqlServerThreatDetectionPolicyArgs() {}

    private SqlServerThreatDetectionPolicyArgs(SqlServerThreatDetectionPolicyArgs $) {
    ...
    public static Builder builder(SqlServerThreatDetectionPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SqlServerThreatDetectionPolicyArgs();
        }

        public Builder(SqlServerThreatDetectionPolicyArgs defaults) {
            $ = new SqlServerThreatDetectionPolicyArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param disabledAlerts Specifies a list of alerts which should be disabled. Possible values include `Access_Anomaly`, `Data_Exfiltration`, `Sql_Injection`, `Sql_Injection_Vulnerability` and `Unsafe_Action&#34;`,.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param state The State of the Policy. Possible values are `Enabled` or `Disabled`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param storageEndpoint Specifies the blob storage endpoint (e.g. `https://MyAccount.blob.core.windows.net`). This blob storage will hold all Threat Detection audit logs. Required if `state` is `Enabled`.
         * 
         * @return builder
         * 
         */
        ...
        public SqlServerThreatDetectionPolicyArgs build() {
            return $;
        }
    }
