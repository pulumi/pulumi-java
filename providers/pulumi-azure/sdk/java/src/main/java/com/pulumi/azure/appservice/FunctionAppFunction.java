 ...
 *             .siteConfig(LinuxFunctionAppSiteConfig.builder()
 *                 .applicationStack(LinuxFunctionAppSiteConfigApplicationStack.builder()
 *                     .pythonVersion(&#34;3.9&#34;)
 *                     .build())
 *                 .build())
 *             .build());
 ...
 *             .servicePlanId(azurerm_service_plan.getTest().getId())
 *             .storageAccountName(azurerm_storage_account.getTest().getName())
 *             .storageAccountAccessKey(azurerm_storage_account.getTest().getPrimary_access_key())
 *             .siteConfig(WindowsFunctionAppSiteConfig.builder()
 *                 .applicationStack(WindowsFunctionAppSiteConfigApplicationStack.builder()
 *                     .dotnetVersion(&#34;6&#34;)
 *                     .build())
 *                 .build())
 *             .build());
 * 
 *         var exampleFunctionAppFunction = new FunctionAppFunction(&#34;exampleFunctionAppFunction&#34;, FunctionAppFunctionArgs.builder()        
 *             .functionAppId(azurerm_linux_function_app.getExample().getId())
 *             .language(&#34;CSharp&#34;)
 *             .files(FunctionAppFunctionFile.builder()
 *                 .name(&#34;run.csx&#34;)
