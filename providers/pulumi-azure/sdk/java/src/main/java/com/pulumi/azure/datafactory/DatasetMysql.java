 ...
 *             .dataFactoryId(exampleFactory.getId())
 *             .linkedServiceName(exampleLinkedServiceMysql.getName())
 *             .build());
 * 
 *         }
 * }
...
public class DatasetMysql extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return Specifies the name of the Data Factory Dataset MySQL. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
     * 
     */
