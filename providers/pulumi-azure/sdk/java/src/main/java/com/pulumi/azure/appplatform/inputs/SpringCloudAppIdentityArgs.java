...
public final class SpringCloudAppIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final SpringCloudAppIdentityArgs Empty = new SpringCloudAppIdentityArgs();
    ...
    private SpringCloudAppIdentityArgs() {}

    private SpringCloudAppIdentityArgs(SpringCloudAppIdentityArgs $) {
    ...
    public static Builder builder(SpringCloudAppIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SpringCloudAppIdentityArgs();
        }

        public Builder(SpringCloudAppIdentityArgs defaults) {
            $ = new SpringCloudAppIdentityArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param principalId The Principal ID for the Service Principal associated with the Managed Service Identity of this Spring Cloud Application.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param tenantId The Tenant ID for the Service Principal associated with the Managed Service Identity of this Spring Cloud Application.
         * 
         * @return builder
         * 
         */
        ...
        public SpringCloudAppIdentityArgs build() {
