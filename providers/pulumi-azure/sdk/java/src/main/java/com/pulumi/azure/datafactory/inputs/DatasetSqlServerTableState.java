...
public final class DatasetSqlServerTableState extends com.pulumi.resources.ResourceArgs {

    public static final DatasetSqlServerTableState Empty = new DatasetSqlServerTableState();
    ...
    /**
     * @return Specifies the name of the Data Factory Dataset SQL Server Table. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
     * 
     */
    ...
    private DatasetSqlServerTableState() {}

    private DatasetSqlServerTableState(DatasetSqlServerTableState $) {
    ...
    public static Builder builder(DatasetSqlServerTableState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatasetSqlServerTableState();
        }

        public Builder(DatasetSqlServerTableState defaults) {
            $ = new DatasetSqlServerTableState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param name Specifies the name of the Data Factory Dataset SQL Server Table. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
         * 
         * @return builder
         * 
         */
        ...
        public DatasetSqlServerTableState build() {
            return $;
        }
    }
