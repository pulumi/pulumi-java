 ...
 *             .storageAccountName(exampleStorage / accountAccount.getName())
 ...
 *             .dataShareId(exampleShare.getId())
 *             .containerName(exampleContainer.getName())
 *             .storageAccount(DatasetBlobStorageStorageAccount.builder()
 *                 .name(exampleStorage / accountAccount.getName())
 *                 .resourceGroupName(exampleStorage / accountAccount.getResourceGroupName())
