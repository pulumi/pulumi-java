 ...
 *             .applicationGroupId(remoteapp.getId())
 *             .build());
 * 
 *         }
 * }
...
public class WorkspaceApplicationGroupAssociation extends com.pulumi.resources.CustomResource {
    ...
    public WorkspaceApplicationGroupAssociation(String name, WorkspaceApplicationGroupAssociationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:desktopvirtualization/workspaceApplicationGroupAssociation:WorkspaceApplicationGroupAssociation", name, args == null ? WorkspaceApplicationGroupAssociationArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
