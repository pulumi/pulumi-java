 ...
 *             .location(testResourceGroup.getLocation())
 *             .resourceGroupName(testResourceGroup.getName())
 *             .skuName(&#34;Standard&#34;)
 *             .build());
 * 
 *         var host = new IntegrationAccountPartner(&#34;host&#34;, IntegrationAccountPartnerArgs.builder()        
 *             .resourceGroupName(testResourceGroup.getName())
 *             .integrationAccountName(testIntegrationAccount.getName())
 *             .businessIdentities(IntegrationAccountPartnerBusinessIdentity.builder()
 ...
 *             .integrationAccountName(testIntegrationAccount.getName())
 *             .agreementType(&#34;AS2&#34;)
 *             .hostPartnerName(host.getName())
 *             .guestPartnerName(guest.getName())
 *             .content(Files.readString(&#34;testdata/integration_account_agreement_content_as2.json&#34;))
 *             .hostIdentity(IntegrationAccountAgreementHostIdentity.builder()
 *                 .qualifier(&#34;AS2Identity&#34;)
 *                 .value(&#34;FabrikamNY&#34;)
 *                 .build())
 *             .guestIdentity(IntegrationAccountAgreementGuestIdentity.builder()
 *                 .qualifier(&#34;AS2Identity&#34;)
 *                 .value(&#34;FabrikamDC&#34;)
 *                 .build())
 *             .build());
