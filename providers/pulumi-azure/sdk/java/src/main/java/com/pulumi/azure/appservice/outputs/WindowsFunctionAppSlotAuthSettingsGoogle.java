...
@CustomType
public final class WindowsFunctionAppSlotAuthSettingsGoogle {
    /**
    ...
    public static Builder builder(WindowsFunctionAppSlotAuthSettingsGoogle defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WindowsFunctionAppSlotAuthSettingsGoogle defaults) {
        ...
        }        public WindowsFunctionAppSlotAuthSettingsGoogle build() {
            return new WindowsFunctionAppSlotAuthSettingsGoogle(clientId, clientSecret, clientSecretSettingName, oauthScopes);
        }
    }
}
