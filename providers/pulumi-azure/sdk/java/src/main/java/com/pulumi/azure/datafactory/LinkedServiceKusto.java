 ...
 *             .kustoEndpoint(exampleCluster.getUri())
 *             .kustoDatabaseName(exampleDatabase.getName())
 ...
 *             .tenantId(exampleFactory.getIdentity().apply(identity -&gt; identity.getTenantId()))
 *             .principalId(exampleFactory.getIdentity().apply(identity -&gt; identity.getPrincipalId()))
 *             .principalType(&#34;App&#34;)
 *             .role(&#34;Viewer&#34;)
 *             .build());
 * 
