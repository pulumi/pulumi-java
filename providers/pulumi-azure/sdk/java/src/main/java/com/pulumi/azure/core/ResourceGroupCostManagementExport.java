 ...
 *             .exportDataStorageLocation(ResourceGroupCostManagementExportExportDataStorageLocation.builder()
 *                 .containerId(azurerm_storage_container.getTest().getResource_manager_id())
 *                 .rootFolderPath(&#34;/root/updated&#34;)
 *                 .build())
 *             .exportDataOptions(ResourceGroupCostManagementExportExportDataOptions.builder()
 *                 .type(&#34;Usage&#34;)
...
public class ResourceGroupCostManagementExport extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="exportDataOptions", type=ResourceGroupCostManagementExportExportDataOptions.class, parameters={})
     ...
     * 
     */
    @Export(name="exportDataStorageLocation", type=ResourceGroupCostManagementExportExportDataStorageLocation.class, parameters={})
