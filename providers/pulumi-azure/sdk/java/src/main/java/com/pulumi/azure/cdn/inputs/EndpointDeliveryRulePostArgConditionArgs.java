...
public final class EndpointDeliveryRulePostArgConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final EndpointDeliveryRulePostArgConditionArgs Empty = new EndpointDeliveryRulePostArgConditionArgs();
    ...
    private EndpointDeliveryRulePostArgConditionArgs() {}

    private EndpointDeliveryRulePostArgConditionArgs(EndpointDeliveryRulePostArgConditionArgs $) {
    ...
    public static Builder builder(EndpointDeliveryRulePostArgConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EndpointDeliveryRulePostArgConditionArgs();
        }

        public Builder(EndpointDeliveryRulePostArgConditionArgs defaults) {
            $ = new EndpointDeliveryRulePostArgConditionArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param selector Name of the post arg.
         * 
         * @return builder
         * 
         */
        ...
        public EndpointDeliveryRulePostArgConditionArgs build() {
