 ...
 *             .commonEncryptionCenc(StreamingPolicyCommonEncryptionCenc.builder()
 *                 .enabledProtocols(StreamingPolicyCommonEncryptionCencEnabledProtocols.builder()
 *                     .download(false)
 *                     .dash(true)
 *                     .hls(false)
 *                     .smoothStreaming(false)
 *                     .build())
 *                 .drmPlayready(StreamingPolicyCommonEncryptionCencDrmPlayready.builder()
 ...
 *                 .build())
 *             .commonEncryptionCbcs(StreamingPolicyCommonEncryptionCbcs.builder()
 *                 .enabledProtocols(StreamingPolicyCommonEncryptionCbcsEnabledProtocols.builder()
 *                     .download(false)
 *                     .dash(true)
 *                     .hls(false)
 *                     .smoothStreaming(false)
 *                     .build())
 *                 .drmFairplay(StreamingPolicyCommonEncryptionCbcsDrmFairplay.builder()
