 ...
 *             .principalId(exampleServicePrincipal.apply(getServicePrincipalResult -&gt; getServicePrincipalResult.getObjectId()))
 *             .build());
 * 
 ...
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .cacheName(exampleCache.getName())
 *             .storageContainerId(exampleContainer.getResourceManagerId())
