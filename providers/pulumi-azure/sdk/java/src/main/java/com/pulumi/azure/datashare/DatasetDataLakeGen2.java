 ...
 *             .storageAccountId(exampleStorage / accountAccount.getId())
 *             .build());
 * 
 *         final var exampleServicePrincipal = AzureadFunctions.getServicePrincipal(GetServicePrincipalArgs.builder()
 *             .displayName(exampleAccount.getName())
 *             .build());
 * 
 *         var exampleAssignment = new Assignment(&#34;exampleAssignment&#34;, AssignmentArgs.builder()        
 *             .scope(exampleStorage / accountAccount.getId())
 *             .roleDefinitionName(&#34;Storage Blob Data Reader&#34;)
 *             .principalId(exampleServicePrincipal.apply(getServicePrincipalResult -&gt; getServicePrincipalResult).apply(exampleServicePrincipal -&gt; exampleServicePrincipal.apply(getServicePrincipalResult -&gt; getServicePrincipalResult.getObjectId())))
 *             .build());
 * 
 ...
 *             .storageAccountId(exampleStorage / accountAccount.getId())
 *             .fileSystemName(exampleDataLakeGen2Filesystem.getName())
 *             .filePath(&#34;myfile.txt&#34;)
 *             .build());
 * 
 *         }
