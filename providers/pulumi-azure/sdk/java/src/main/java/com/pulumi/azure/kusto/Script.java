 ...
 *             .url(exampleBlob.getId())
 *             .sasToken(exampleAccountBlobContainerSAS.apply(getAccountBlobContainerSASResult -&gt; getAccountBlobContainerSASResult).apply(exampleAccountBlobContainerSAS -&gt; exampleAccountBlobContainerSAS.apply(getAccountBlobContainerSASResult -&gt; getAccountBlobContainerSASResult.getSas())))
