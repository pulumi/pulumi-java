...
public class IotHubDps extends com.pulumi.resources.CustomResource {
     ...
     */
    public IotHubDps(String name, IotHubDpsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:iot/iotHubDps:IotHubDps", name, args == null ? IotHubDpsArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private IotHubDps(String name, Output<String> id, @Nullable IotHubDpsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:iot/iotHubDps:IotHubDps", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static IotHubDps get(String name, Output<String> id, @Nullable IotHubDpsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
