 ...
 *             .clusterVersion(&#34;3.6&#34;)
 *             .tier(&#34;Standard&#34;)
 *             .componentVersion(SparkClusterComponentVersion.builder()
 *                 .spark(&#34;2.3&#34;)
 *                 .build())
 *             .gateway(SparkClusterGateway.builder()
 *                 .username(&#34;acctestusrgw&#34;)
 *                 .password(&#34;Password123!&#34;)
 *                 .build())
 *             .storageAccounts(SparkClusterStorageAccount.builder()
 *                 .storageContainerId(exampleContainer.getId())
 *                 .storageAccountKey(exampleAccount.getPrimaryAccessKey())
 *                 .isDefault(true)
 *                 .build())
 *             .roles(SparkClusterRoles.builder()
 *                 .headNode(SparkClusterRolesHeadNode.builder()
 *                     .vmSize(&#34;Standard_A3&#34;)
 *                     .username(&#34;acctestusrvm&#34;)
 *                     .password(&#34;AccTestvdSC4daf986!&#34;)
 *                     .build())
 *                 .workerNode(SparkClusterRolesWorkerNode.builder()
 *                     .vmSize(&#34;Standard_A3&#34;)
 *                     .username(&#34;acctestusrvm&#34;)
 *                     .password(&#34;AccTestvdSC4daf986!&#34;)
 *                     .targetInstanceCount(3)
 *                     .build())
 *                 .zookeeperNode(SparkClusterRolesZookeeperNode.builder()
 *                     .vmSize(&#34;Medium&#34;)
 *                     .username(&#34;acctestusrvm&#34;)
 *                     .password(&#34;AccTestvdSC4daf986!&#34;)
 *                     .build())
