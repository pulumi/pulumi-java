...
import com.pulumi.azure.appservice.inputs.LinuxWebAppSiteCredentialArgs;
...
public final class LinuxWebAppState extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppState Empty = new LinuxWebAppState();
    ...
    private @Nullable Output<LinuxWebAppSiteConfigArgs> siteConfig;

    /**
     * @return A `site_config` block as defined below.
     * 
     */
    public Optional<Output<LinuxWebAppSiteConfigArgs>> siteConfig() {
    ...
    private @Nullable Output<List<LinuxWebAppSiteCredentialArgs>> siteCredentials;

    /**
     * @return A `site_credential` block as defined below.
     * 
     */
    public Optional<Output<List<LinuxWebAppSiteCredentialArgs>>> siteCredentials() {
    ...
    private LinuxWebAppState() {}

    private LinuxWebAppState(LinuxWebAppState $) {
    ...
    public static Builder builder(LinuxWebAppState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppState();
        }

        public Builder(LinuxWebAppState defaults) {
            $ = new LinuxWebAppState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder siteConfig(@Nullable Output<LinuxWebAppSiteConfigArgs> siteConfig) {
         ...
         * 
         */
        public Builder siteCredentials(@Nullable Output<List<LinuxWebAppSiteCredentialArgs>> siteCredentials) {
         ...
         * 
         */
        public Builder siteCredentials(List<LinuxWebAppSiteCredentialArgs> siteCredentials) {
         ...
         * 
         */
        public Builder siteCredentials(LinuxWebAppSiteCredentialArgs... siteCredentials) {
