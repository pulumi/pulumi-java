 ...
 *             .networkWatcherName(testNetworkWatcher.getName())
 *             .resourceGroupName(testResourceGroup.getName())
 *             .networkSecurityGroupId(testNetworkSecurityGroup.getId())
 *             .storageAccountId(testAccount.getId())
 *             .enabled(true)
 *             .retentionPolicy(NetworkWatcherFlowLogRetentionPolicy.builder()
 *                 .enabled(true)
 *                 .days(7)
 *                 .build())
 *             .trafficAnalytics(NetworkWatcherFlowLogTrafficAnalytics.builder()
 *                 .enabled(true)
 *                 .workspaceId(testAnalyticsWorkspace.getWorkspaceId())
 *                 .workspaceRegion(testAnalyticsWorkspace.getLocation())
 *                 .workspaceResourceId(testAnalyticsWorkspace.getId())
