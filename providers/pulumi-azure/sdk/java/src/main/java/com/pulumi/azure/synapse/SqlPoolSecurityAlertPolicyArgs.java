...
public final class SqlPoolSecurityAlertPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final SqlPoolSecurityAlertPolicyArgs Empty = new SqlPoolSecurityAlertPolicyArgs();
    ...
    private SqlPoolSecurityAlertPolicyArgs() {}

    private SqlPoolSecurityAlertPolicyArgs(SqlPoolSecurityAlertPolicyArgs $) {
    ...
    public static Builder builder(SqlPoolSecurityAlertPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SqlPoolSecurityAlertPolicyArgs();
        }

        public Builder(SqlPoolSecurityAlertPolicyArgs defaults) {
            $ = new SqlPoolSecurityAlertPolicyArgs(Objects.requireNonNull(defaults));
        }
