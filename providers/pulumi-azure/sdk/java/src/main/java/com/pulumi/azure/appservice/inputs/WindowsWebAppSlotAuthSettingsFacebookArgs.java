...
public final class WindowsWebAppSlotAuthSettingsFacebookArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSlotAuthSettingsFacebookArgs Empty = new WindowsWebAppSlotAuthSettingsFacebookArgs();
    ...
    private WindowsWebAppSlotAuthSettingsFacebookArgs() {}

    private WindowsWebAppSlotAuthSettingsFacebookArgs(WindowsWebAppSlotAuthSettingsFacebookArgs $) {
        this.appId = $.appId;
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsFacebookArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotAuthSettingsFacebookArgs();
        }

        public Builder(WindowsWebAppSlotAuthSettingsFacebookArgs defaults) {
            $ = new WindowsWebAppSlotAuthSettingsFacebookArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppSlotAuthSettingsFacebookArgs build() {
