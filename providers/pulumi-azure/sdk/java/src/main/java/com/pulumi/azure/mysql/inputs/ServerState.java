...
public final class ServerState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Specifies the SKU Name for this MySQL Server. The name of the SKU, follows the `tier` + `family` + `cores` pattern (e.g. `B_Gen4_1`, `GP_Gen5_8`). For more information see the [product documentation](https://docs.microsoft.com/en-us/rest/api/mysql/servers/create#sku).
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param administratorLogin The Administrator Login for the MySQL Server. Required when `create_mode` is `Default`. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param administratorLoginPassword The Password associated with the `administrator_login` for the MySQL Server. Required when `create_mode` is `Default`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param fqdn The FQDN of the MySQL Server.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param name Specifies the name of the MySQL Server. Changing this forces a new resource to be created. This needs to be globally unique within Azure.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param resourceGroupName The name of the resource group in which to create the MySQL Server. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param skuName Specifies the SKU Name for this MySQL Server. The name of the SKU, follows the `tier` + `family` + `cores` pattern (e.g. `B_Gen4_1`, `GP_Gen5_8`). For more information see the [product documentation](https://docs.microsoft.com/en-us/rest/api/mysql/servers/create#sku).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param version Specifies the version of MySQL to use. Valid values are `5.7`, or `8.0`. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
