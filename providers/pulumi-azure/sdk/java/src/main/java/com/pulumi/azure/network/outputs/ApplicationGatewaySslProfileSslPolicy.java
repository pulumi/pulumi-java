...
@CustomType
public final class ApplicationGatewaySslProfileSslPolicy {
    /**
    ...
    public static Builder builder(ApplicationGatewaySslProfileSslPolicy defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ApplicationGatewaySslProfileSslPolicy defaults) {
        ...
        public Builder policyType(@Nullable String policyType) {
            this.policyType = policyType;
            return this;
        }        public ApplicationGatewaySslProfileSslPolicy build() {
            return new ApplicationGatewaySslProfileSslPolicy(cipherSuites, disabledProtocols, minProtocolVersion, policyName, policyType);
        }
    }
}
