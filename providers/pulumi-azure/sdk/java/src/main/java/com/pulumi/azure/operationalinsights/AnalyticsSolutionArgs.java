...
public final class AnalyticsSolutionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Specifies the name of the solution to be deployed. See [here for options](https://docs.microsoft.com/en-us/azure/log-analytics/log-analytics-add-solutions).Changing this forces a new resource to be created.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param solutionName Specifies the name of the solution to be deployed. See [here for options](https://docs.microsoft.com/en-us/azure/log-analytics/log-analytics-add-solutions).Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
