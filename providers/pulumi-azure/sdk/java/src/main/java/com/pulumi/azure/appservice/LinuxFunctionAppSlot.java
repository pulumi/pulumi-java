 ...
 *             .functionAppId(exampleLinuxFunctionApp.getId())
 *             .storageAccountName(exampleAccount.getName())
 *             .siteConfig()
 *             .build());
 * 
...
public class LinuxFunctionAppSlot extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="backup", type=LinuxFunctionAppSlotBackup.class, parameters={})
     ...
     * 
     */
    @Export(name="connectionStrings", type=List.class, parameters={LinuxFunctionAppSlotConnectionString.class})
    ...
    /**
     * @return Is the Linux Function App Slot enabled.
     * 
     */
     ...
     * 
     */
    @Export(name="identity", type=LinuxFunctionAppSlotIdentity.class, parameters={})
     ...
     * 
     */
    @Export(name="siteConfig", type=LinuxFunctionAppSlotSiteConfig.class, parameters={})
     ...
     * 
     */
    @Export(name="siteCredentials", type=List.class, parameters={LinuxFunctionAppSlotSiteCredential.class})
