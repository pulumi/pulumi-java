 ...
 *             .autoScale(PoolAutoScale.builder()
 ...
 *                 .version(&#34;latest&#34;)
 *                 .build())
 *             .containerConfiguration(PoolContainerConfiguration.builder()
 *                 .type(&#34;DockerCompatible&#34;)
 *                 .containerRegistries(PoolContainerConfigurationContainerRegistry.builder()
 *                     .registryServer(&#34;docker.io&#34;)
 *                     .userName(&#34;login&#34;)
 *                     .password(&#34;apassword&#34;)
 *                     .build())
 *                 .build())
 *             .startTask(PoolStartTask.builder()
 *                 .commandLine(&#34;echo &#39;Hello World from $env&#39;&#34;)
 *                 .taskRetryMaximum(1)
 *                 .waitForSuccess(true)
 *                 .commonEnvironmentProperties(Map.of(&#34;env&#34;, &#34;TEST&#34;))
 *                 .userIdentity(PoolStartTaskUserIdentity.builder()
 *                     .autoUser(PoolStartTaskUserIdentityAutoUser.builder()
 *                         .elevationLevel(&#34;NonAdmin&#34;)
 *                         .scope(&#34;Task&#34;)
 *                         .build())
 *                     .build())
 *                 .build())
 *             .certificates(PoolCertificate.builder()
 *                 .id(exampleCertificate.getId())
