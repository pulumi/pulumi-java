 ...
 *             .userId(exampleUser.apply(getUserResult -&gt; getUserResult.getId()))
 *             .groupName(&#34;example-group&#34;)
 *             .resourceGroupName(exampleUser.apply(getUserResult -&gt; getUserResult.getResourceGroupName()))
 *             .apiManagementName(exampleUser.apply(getUserResult -&gt; getUserResult.getApiManagementName()))
 *             .build());
 * 
 *         }
 * }
