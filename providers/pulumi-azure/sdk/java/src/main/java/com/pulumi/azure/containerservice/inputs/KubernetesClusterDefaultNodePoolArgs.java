...
public final class KubernetesClusterDefaultNodePoolArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param enableAutoScaling Should [the Kubernetes Auto Scaler](https://docs.microsoft.com/en-us/azure/aks/cluster-autoscaler) be enabled for this Node Pool? Defaults to `false`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param enableHostEncryption Should the nodes in the Default Node Pool have host encryption enabled? Defaults to `false`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param enableNodePublicIp Should nodes in this Node Pool have a Public IP Address? Defaults to `false`. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param nodeLabels A map of Kubernetes labels which should be applied to nodes in the Default Node Pool. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param type The type of Node Pool which should be created. Possible values are `AvailabilitySet` and `VirtualMachineScaleSets`. Defaults to `VirtualMachineScaleSets`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param ultraSsdEnabled Used to specify whether the UltraSSD is enabled in the Default Node Pool. Defaults to `false`. See [the documentation](https://docs.microsoft.com/en-us/azure/aks/use-ultra-disks) for more information.
         * 
         * @return builder
         * 
         */
