...
public final class WindowsFunctionAppAuthSettingsGithubArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppAuthSettingsGithubArgs Empty = new WindowsFunctionAppAuthSettingsGithubArgs();
    ...
    private WindowsFunctionAppAuthSettingsGithubArgs() {}

    private WindowsFunctionAppAuthSettingsGithubArgs(WindowsFunctionAppAuthSettingsGithubArgs $) {
    ...
    public static Builder builder(WindowsFunctionAppAuthSettingsGithubArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppAuthSettingsGithubArgs();
        }

        public Builder(WindowsFunctionAppAuthSettingsGithubArgs defaults) {
            $ = new WindowsFunctionAppAuthSettingsGithubArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppAuthSettingsGithubArgs build() {
