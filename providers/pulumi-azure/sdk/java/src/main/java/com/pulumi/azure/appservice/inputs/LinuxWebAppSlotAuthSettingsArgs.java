...
import com.pulumi.azure.appservice.inputs.LinuxWebAppSlotAuthSettingsActiveDirectoryArgs;
import com.pulumi.azure.appservice.inputs.LinuxWebAppSlotAuthSettingsFacebookArgs;
import com.pulumi.azure.appservice.inputs.LinuxWebAppSlotAuthSettingsGithubArgs;
import com.pulumi.azure.appservice.inputs.LinuxWebAppSlotAuthSettingsGoogleArgs;
import com.pulumi.azure.appservice.inputs.LinuxWebAppSlotAuthSettingsMicrosoftArgs;
import com.pulumi.azure.appservice.inputs.LinuxWebAppSlotAuthSettingsTwitterArgs;
...
public final class LinuxWebAppSlotAuthSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotAuthSettingsArgs Empty = new LinuxWebAppSlotAuthSettingsArgs();
    ...
    private @Nullable Output<LinuxWebAppSlotAuthSettingsActiveDirectoryArgs> activeDirectory;

    /**
     * @return An `active_directory` block as defined above.
     * 
     */
    public Optional<Output<LinuxWebAppSlotAuthSettingsActiveDirectoryArgs>> activeDirectory() {
    ...
    private @Nullable Output<LinuxWebAppSlotAuthSettingsFacebookArgs> facebook;

    /**
     * @return A `facebook` block as defined below.
     * 
     */
    public Optional<Output<LinuxWebAppSlotAuthSettingsFacebookArgs>> facebook() {
     ...
     */
    @Import(name="github")
    private @Nullable Output<LinuxWebAppSlotAuthSettingsGithubArgs> github;

    /**
     * @return A `github` block as defined below.
     * 
     */
    public Optional<Output<LinuxWebAppSlotAuthSettingsGithubArgs>> github() {
     ...
     */
    @Import(name="google")
    private @Nullable Output<LinuxWebAppSlotAuthSettingsGoogleArgs> google;

    /**
     * @return A `google` block as defined below.
     * 
     */
    public Optional<Output<LinuxWebAppSlotAuthSettingsGoogleArgs>> google() {
    ...
    private @Nullable Output<LinuxWebAppSlotAuthSettingsMicrosoftArgs> microsoft;

    /**
     * @return A `microsoft` block as defined below.
     * 
     */
    public Optional<Output<LinuxWebAppSlotAuthSettingsMicrosoftArgs>> microsoft() {
     ...
     */
    @Import(name="twitter")
    private @Nullable Output<LinuxWebAppSlotAuthSettingsTwitterArgs> twitter;

    /**
     * @return A `twitter` block as defined below.
     * 
     */
    public Optional<Output<LinuxWebAppSlotAuthSettingsTwitterArgs>> twitter() {
    ...
    private LinuxWebAppSlotAuthSettingsArgs() {}

    private LinuxWebAppSlotAuthSettingsArgs(LinuxWebAppSlotAuthSettingsArgs $) {
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotAuthSettingsArgs();
        }

        public Builder(LinuxWebAppSlotAuthSettingsArgs defaults) {
            $ = new LinuxWebAppSlotAuthSettingsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder activeDirectory(@Nullable Output<LinuxWebAppSlotAuthSettingsActiveDirectoryArgs> activeDirectory) {
         ...
         * 
         */
        public Builder activeDirectory(LinuxWebAppSlotAuthSettingsActiveDirectoryArgs activeDirectory) {
         ...
         * 
         */
        public Builder facebook(@Nullable Output<LinuxWebAppSlotAuthSettingsFacebookArgs> facebook) {
            $.facebook = facebook;
            return this;
        }
         ...
         * 
         */
        public Builder facebook(LinuxWebAppSlotAuthSettingsFacebookArgs facebook) {
         ...
         * 
         */
        public Builder github(@Nullable Output<LinuxWebAppSlotAuthSettingsGithubArgs> github) {
            $.github = github;
            return this;
        }
         ...
         * 
         */
        public Builder github(LinuxWebAppSlotAuthSettingsGithubArgs github) {
         ...
         * 
         */
        public Builder google(@Nullable Output<LinuxWebAppSlotAuthSettingsGoogleArgs> google) {
            $.google = google;
            return this;
        }
         ...
         * 
         */
        public Builder google(LinuxWebAppSlotAuthSettingsGoogleArgs google) {
         ...
         * 
         */
        public Builder microsoft(@Nullable Output<LinuxWebAppSlotAuthSettingsMicrosoftArgs> microsoft) {
            $.microsoft = microsoft;
            return this;
        }
         ...
         * 
         */
        public Builder microsoft(LinuxWebAppSlotAuthSettingsMicrosoftArgs microsoft) {
         ...
         * 
         */
        public Builder twitter(@Nullable Output<LinuxWebAppSlotAuthSettingsTwitterArgs> twitter) {
            $.twitter = twitter;
            return this;
        }
         ...
         * 
         */
        public Builder twitter(LinuxWebAppSlotAuthSettingsTwitterArgs twitter) {
        ...
        public LinuxWebAppSlotAuthSettingsArgs build() {
