 ...
 *             .location(primaryResourceGroup.getLocation())
 *             .resourceGroupName(primaryResourceGroup.getName())
 *             .addressSpaces(&#34;10.0.1.0/16&#34;)
 *             .build());
 * 
 *         var primarySubnet = new Subnet(&#34;primarySubnet&#34;, SubnetArgs.builder()        
 *             .resourceGroupName(primaryResourceGroup.getName())
 *             .virtualNetworkName(primaryVirtualNetwork.getName())
 ...
 *             .subnetId(primarySubnet.getId())
 *             .networkSecurityGroupId(primaryNetworkSecurityGroup.getId())
 *             .build());
 * 
 ...
 *                 .location(primaryVirtualNetwork.getLocation())
 *                 .subnetId(primarySubnet.getId())
 *                 .build())
 ...
 *             .location(replicaResourceGroup.getLocation())
 *             .resourceGroupName(replicaResourceGroup.getName())
 *             .addressSpaces(&#34;10.20.0.0/16&#34;)
 *             .build());
 * 
 *         var aaddsReplicaSubnet = new Subnet(&#34;aaddsReplicaSubnet&#34;, SubnetArgs.builder()        
 *             .resourceGroupName(replicaResourceGroup.getName())
 *             .virtualNetworkName(replicaVirtualNetwork.getName())
 ...
 *             .subnetId(aaddsReplicaSubnet.getId())
 *             .networkSecurityGroupId(aaddsReplicaNetworkSecurityGroup.getId())
 *             .build());
 * 
 *         var primaryReplica = new VirtualNetworkPeering(&#34;primaryReplica&#34;, VirtualNetworkPeeringArgs.builder()        
 *             .resourceGroupName(primaryVirtualNetwork.getResourceGroupName())
 *             .virtualNetworkName(primaryVirtualNetwork.getName())
 *             .remoteVirtualNetworkId(replicaVirtualNetwork.getId())
 ...
 *             .resourceGroupName(replicaVirtualNetwork.getResourceGroupName())
 *             .virtualNetworkName(replicaVirtualNetwork.getName())
 *             .remoteVirtualNetworkId(primaryVirtualNetwork.getId())
 *             .allowForwardedTraffic(true)
 *             .allowGatewayTransit(false)
 *             .allowVirtualNetworkAccess(true)
 *             .useRemoteGateways(false)
 ...
 *             .virtualNetworkId(replicaVirtualNetwork.getId())
 *             .dnsServers(exampleService.getInitialReplicaSet().apply(initialReplicaSet -&gt; initialReplicaSet.getDomainControllerIpAddresses()))
 *             .build());
 * 
 *         var replicaReplicaSet = new ReplicaSet(&#34;replicaReplicaSet&#34;, ReplicaSetArgs.builder()        
 *             .domainServiceId(exampleService.getId())
 *             .location(replicaResourceGroup.getLocation())
 *             .subnetId(aaddsReplicaSubnet.getId())
 *             .build());
 * 
