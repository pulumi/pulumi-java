 ...
 *             .identity(FactoryIdentity.builder()
 *                 .type(&#34;SystemAssigned&#34;)
 *                 .build())
 *             .build());
 * 
 ...
 *             .adbDomain(exampleWorkspace.getWorkspaceUrl().apply(workspaceUrl -&gt; String.format(&#34;https://%s&#34;, workspaceUrl)))
 *             .msiWorkSpaceResourceId(exampleWorkspace.getId())
 *             .newClusterConfig(LinkedServiceAzureDatabricksNewClusterConfig.builder()
...
public class LinkedServiceAzureDatabricks extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="adbDomain", type=String.class, parameters={})
     ...
     * 
     */
    @Export(name="keyVaultPassword", type=LinkedServiceAzureDatabricksKeyVaultPassword.class, parameters={})
     ...
     * 
     */
    @Export(name="msiWorkSpaceResourceId", type=String.class, parameters={})
