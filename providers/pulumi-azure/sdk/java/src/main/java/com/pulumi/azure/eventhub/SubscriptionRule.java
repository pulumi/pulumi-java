 ...
 *             .subscriptionId(exampleSubscription.getId())
 ...
 *             .correlationFilter(SubscriptionRuleCorrelationFilter.builder()
 *                 .correlationId(&#34;high&#34;)
 *                 .label(&#34;red&#34;)
...
public class SubscriptionRule extends com.pulumi.resources.CustomResource {
    ...
    public SubscriptionRule(String name, SubscriptionRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:eventhub/subscriptionRule:SubscriptionRule", name, args == null ? SubscriptionRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
