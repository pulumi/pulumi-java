 ...
 *             .routing(VirtualHubConnectionRouting.builder()
 *                 .associatedRouteTableId(exampleVirtualHubRouteTable.getId())
 *                 .build())
 *             .build());
 * 
 ...
 *             .routeTableId(exampleVirtualHubRouteTable.getId())
 *             .destinationsType(&#34;CIDR&#34;)
 *             .destinations(&#34;10.0.0.0/16&#34;)
 *             .nextHopType(&#34;ResourceId&#34;)
 *             .nextHop(exampleVirtualHubConnection.getId())
 *             .build());
 * 
 *         }
 * }
