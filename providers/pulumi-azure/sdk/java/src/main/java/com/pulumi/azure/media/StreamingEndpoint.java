 ...
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .location(exampleResourceGroup.getLocation())
 *             .mediaServicesAccountName(exampleServiceAccount.getName())
 *             .scaleUnits(2)
 *             .build());
 * 
 *         }
 ...
 *             .mediaServicesAccountName(exampleServiceAccount.getName())
 *             .scaleUnits(2)
 *             .accessControl(StreamingEndpointAccessControl.builder()
 *                 .ipAllows(                
 *                     StreamingEndpointAccessControlIpAllow.builder()
 *                         .name(&#34;AllowedIP&#34;)
 *                         .address(&#34;192.168.1.1&#34;)
 *                         .build(),
 *                     StreamingEndpointAccessControlIpAllow.builder()
 ...
 *                     StreamingEndpointAccessControlAkamaiSignatureHeaderAuthenticationKey.builder()
 *                         .identifier(&#34;id1&#34;)
