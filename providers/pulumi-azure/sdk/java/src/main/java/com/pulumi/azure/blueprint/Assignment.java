 ...
 * 
 *         final var exampleDefinition = Output.of(BlueprintFunctions.getDefinition(GetDefinitionArgs.builder()
 *             .name(&#34;exampleBlueprint&#34;)
 *             .scopeId(exampleSubscription.apply(getBudgetSubscriptionResult -&gt; getBudgetSubscriptionResult.getId()))
 *             .build()));
 * 
 *         final var examplePublishedVersion = Output.of(BlueprintFunctions.getPublishedVersion(GetPublishedVersionArgs.builder()
 *             .scopeId(exampleDefinition.apply(getDefinitionResult -&gt; getDefinitionResult.getScopeId()))
 *             .blueprintName(exampleDefinition.apply(getDefinitionResult -&gt; getDefinitionResult.getName()))
 *             .version(&#34;v1.0.0&#34;)
 *             .build()));
 * 
 ...
 *             .scope(exampleSubscription.apply(getBudgetSubscriptionResult -&gt; getBudgetSubscriptionResult.getId()))
 *             .roleDefinitionName(&#34;Blueprint Operator&#34;)
 *             .principalId(exampleUserAssignedIdentity.getPrincipalId())
 *             .build());
 * 
 ...
 *             .targetSubscriptionId(exampleSubscription.apply(getBudgetSubscriptionResult -&gt; getBudgetSubscriptionResult.getId()))
 *             .versionId(examplePublishedVersion.apply(getPublishedVersionResult -&gt; getPublishedVersionResult.getId()))
 *             .location(exampleResourceGroup.getLocation())
 *             .lockMode(&#34;AllResourcesDoNotDelete&#34;)
 *             .lockExcludePrincipals(current.apply(getClientConfigResult -&gt; getClientConfigResult.getObjectId()))
 *             .identity(AssignmentIdentity.builder()
 *                 .type(&#34;UserAssigned&#34;)
