...
public final class GetManagedDiskResult {
    ...
    public static final class Builder {
        ...
        public Builder zones(String... zones) {
            ...
            return new GetManagedDiskResult(createOption, diskEncryptionSetId, diskIopsReadWrite, diskMbpsReadWrite, diskSizeGb, id, imageReferenceId, name, osType, resourceGroupName, sourceResourceId, sourceUri, storageAccountId, storageAccountType, tags, zones);
        }
    }
}
