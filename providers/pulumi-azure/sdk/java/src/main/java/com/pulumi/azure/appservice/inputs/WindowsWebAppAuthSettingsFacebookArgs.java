...
public final class WindowsWebAppAuthSettingsFacebookArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppAuthSettingsFacebookArgs Empty = new WindowsWebAppAuthSettingsFacebookArgs();
    ...
    private WindowsWebAppAuthSettingsFacebookArgs() {}

    private WindowsWebAppAuthSettingsFacebookArgs(WindowsWebAppAuthSettingsFacebookArgs $) {
        this.appId = $.appId;
    ...
    public static Builder builder(WindowsWebAppAuthSettingsFacebookArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppAuthSettingsFacebookArgs();
        }

        public Builder(WindowsWebAppAuthSettingsFacebookArgs defaults) {
            $ = new WindowsWebAppAuthSettingsFacebookArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppAuthSettingsFacebookArgs build() {
