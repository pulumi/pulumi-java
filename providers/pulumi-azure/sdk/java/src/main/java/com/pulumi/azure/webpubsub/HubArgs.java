...
public final class HubArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<List<HubEventHandlerArgs>> eventHandlers;

    /**
     * @return An `event_handler` block as defined below.
     * 
     */
    public Output<List<HubEventHandlerArgs>> eventHandlers() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder eventHandlers(Output<List<HubEventHandlerArgs>> eventHandlers) {
