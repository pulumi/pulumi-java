 ...
 *             .managementGroupId(exampleGroup.getId())
 *             .policyDefinitionId(examplePolicySetDefinition.apply(getPolicySetDefinitionResult -&gt; getPolicySetDefinitionResult.getId()))
 *             .location(&#34;westus&#34;)
 *             .identity(GroupPolicyAssignmentIdentity.builder()
 *                 .type(&#34;SystemAssigned&#34;)
 *                 .build())
 *             .build());
 * 
 ...
 *             .managementGroupId(exampleGroup.getId())
 *             .policyAssignmentId(exampleGroupPolicyAssignment.getId())
