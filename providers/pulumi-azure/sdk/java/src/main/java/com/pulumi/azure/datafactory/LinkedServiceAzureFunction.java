 ...
 *             .url(exampleFunctionApp.apply(getFunctionAppResult -&gt; getFunctionAppResult).apply(exampleFunctionApp -&gt; String.format(&#34;https://%s&#34;, exampleFunctionApp.apply(getFunctionAppResult -&gt; getFunctionAppResult.getDefaultHostname()))))
 *             .key(&#34;foo&#34;)
 *             .build());
 * 
 *         }
