 ...
 *             .appServiceName(exampleLinuxWebApp.getName())
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .location(exampleServicePlan.getLocation())
 *             .servicePlanId(exampleServicePlan.getId())
 *             .siteConfig()
 ...
 * 
 *         var exampleWebAppActiveSlot = new WebAppActiveSlot(&#34;exampleWebAppActiveSlot&#34;, WebAppActiveSlotArgs.builder()        
 *             .slotId(exampleLinuxWebAppSlot.getId())
 *             .build());
 * 
 *         }
 * }
