 ...
 *             .location(exampleResourceGroup.getLocation())
 *             .skuName(&#34;S0&#34;)
 *             .configServerGitSetting(SpringCloudServiceConfigServerGitSetting.builder()
 ...
 *                     &#34;dir2&#34;)
 *                 .build())
 *             .trace(SpringCloudServiceTrace.builder()
 *                 .connectionString(exampleInsights.getConnectionString())
 *                 .sampleRate(10)
 *                 .build())
