 ...
 *             .backendAddressPoolId(exampleBackendAddressPool.apply(getBackendAddressPoolResult -&gt; getBackendAddressPoolResult.getId()))
 *             .virtualNetworkId(exampleVirtualNetwork.apply(getVirtualNetworkResult -&gt; getVirtualNetworkResult.getId()))
 *             .ipAddress(&#34;10.0.0.1&#34;)
 *             .build());
 * 
 *         }
