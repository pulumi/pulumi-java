 ...
 *             .billingScopeId(exampleEnrollmentAccountScope.apply(getEnrollmentAccountScopeResult -&gt; getEnrollmentAccountScopeResult.getId()))
 *             .build());
 * 
 *         }
 * }
 ...
 *             .billingScopeId(exampleMcaAccountScope.apply(getMcaAccountScopeResult -&gt; getMcaAccountScopeResult.getId()))
 *             .build());
 * 
 *         }
 * }
 ...
 *             .billingScopeId(exampleMpaAccountScope.apply(getMpaAccountScopeResult -&gt; getMpaAccountScopeResult.getId()))
 *             .build());
 * 
 *         }
 * }
