 ...
 *                 .publicIpAddressId(primaryPublicIp.getId())
 *                 .build())
 *             .build());
 * 
 ...
 *             .resourceGroupName(primaryResourceGroup.getName())
 *             .vmSize(&#34;Standard_B1s&#34;)
 *             .networkInterfaceIds(vmNetworkInterface.getId())
 ...
 *             .location(secondaryResourceGroup.getLocation())
 *             .resourceGroupName(secondaryResourceGroup.getName())
 *             .sku(&#34;Standard&#34;)
 *             .build());
 * 
 ...
 *             .recoveryVaultName(vault.getName())
 *             .recoveryFabricName(primaryFabric.getName())
 *             .recoverySourceProtectionContainerName(primaryProtectionContainer.getName())
 *             .recoveryTargetProtectionContainerId(secondaryProtectionContainer.getId())
 *             .recoveryReplicationPolicyId(policy.getId())
 *             .build());
 * 
 ...
 *             .resourceGroupName(secondaryResourceGroup.getName())
 *             .recoveryVaultName(vault.getName())
 *             .sourceRecoveryFabricName(primaryFabric.getName())
 *             .targetRecoveryFabricName(secondaryFabric.getName())
 *             .sourceNetworkId(primaryVirtualNetwork.getId())
 *             .targetNetworkId(secondaryVirtualNetwork.getId())
 *             .build());
 * 
 ...
 *             .resourceGroupName(secondaryResourceGroup.getName())
 *             .virtualNetworkName(secondaryVirtualNetwork.getName())
 ...
 *             .recoveryVaultName(vault.getName())
 *             .sourceRecoveryFabricName(primaryFabric.getName())
 *             .sourceVmId(vmVirtualMachine.getId())
 *             .recoveryReplicationPolicyId(policy.getId())
 *             .sourceRecoveryProtectionContainerName(primaryProtectionContainer.getName())
 *             .targetResourceGroupId(secondaryResourceGroup.getId())
 *             .targetRecoveryFabricId(secondaryFabric.getId())
 *             .targetRecoveryProtectionContainerId(secondaryProtectionContainer.getId())
 *             .managedDisks(ReplicatedVMManagedDisk.builder()
 *                 .diskId(vmVirtualMachine.getStorageOsDisk().apply(storageOsDisk -&gt; storageOsDisk.getManagedDiskId()))
 *                 .stagingStorageAccountId(primaryAccount.getId())
 *                 .targetResourceGroupId(secondaryResourceGroup.getId())
 *                 .targetDiskType(&#34;Premium_LRS&#34;)
 *                 .targetReplicaDiskType(&#34;Premium_LRS&#34;)
 *                 .build())
 *             .networkInterfaces(ReplicatedVMNetworkInterface.builder()
 *                 .sourceNetworkInterfaceId(vmNetworkInterface.getId())
 *                 .targetSubnetName(secondarySubnet.getName())
 *                 .recoveryPublicIpAddressId(secondaryPublicIp.getId())
 *                 .build())
 *             .build());
 * 
 *         }
