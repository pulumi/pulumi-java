...
public final class AccountState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The default identity for accessing Key Vault. Possible values are `FirstPartyIdentity`, `SystemAssignedIdentity` or start with `UserAssignedIdentity`. Defaults to `FirstPartyIdentity`.
     * 
     */
    ...
    /**
     * @return Specifies the Kind of CosmosDB to create - possible values are `GlobalDocumentDB` and `MongoDB`. Defaults to `GlobalDocumentDB`. Changing this forces a new resource to be created.
     * 
     */
    ...
    /**
     * @return The Server Version of a MongoDB account. Possible values are `4.0`, `3.6`, and `3.2`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param analyticalStorageEnabled Enable Analytical Storage option for this Cosmos DB account. Defaults to `false`. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param defaultIdentityType The default identity for accessing Key Vault. Possible values are `FirstPartyIdentity`, `SystemAssignedIdentity` or start with `UserAssignedIdentity`. Defaults to `FirstPartyIdentity`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param enableAutomaticFailover Enable automatic fail over for this Cosmos DB account.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param enableFreeTier Enable Free Tier pricing option for this Cosmos DB account. Defaults to `false`. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param ipRangeFilter CosmosDB Firewall Support: This value specifies the set of IP addresses or IP address ranges in CIDR form to be included as the allowed list of client IP&#39;s for a given database account. IP addresses/ranges must be comma separated and must not contain any spaces.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param kind Specifies the Kind of CosmosDB to create - possible values are `GlobalDocumentDB` and `MongoDB`. Defaults to `GlobalDocumentDB`. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param mongoServerVersion The Server Version of a MongoDB account. Possible values are `4.0`, `3.6`, and `3.2`.
         * 
         * @return builder
         * 
         */
