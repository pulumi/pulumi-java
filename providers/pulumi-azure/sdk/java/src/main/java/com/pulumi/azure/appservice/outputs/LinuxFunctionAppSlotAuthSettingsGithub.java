...
@CustomType
public final class LinuxFunctionAppSlotAuthSettingsGithub {
    /**
    ...
    private LinuxFunctionAppSlotAuthSettingsGithub(
    ...
    public static Builder builder(LinuxFunctionAppSlotAuthSettingsGithub defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LinuxFunctionAppSlotAuthSettingsGithub defaults) {
        ...
        }        public LinuxFunctionAppSlotAuthSettingsGithub build() {
            return new LinuxFunctionAppSlotAuthSettingsGithub(clientId, clientSecret, clientSecretSettingName, oauthScopes);
        }
    }
}
