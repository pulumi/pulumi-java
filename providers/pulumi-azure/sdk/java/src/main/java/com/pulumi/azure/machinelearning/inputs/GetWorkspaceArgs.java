...
public final class GetWorkspaceArgs extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return The name of the Machine Learning Workspace exists.
     * 
     */
    public String name() {
        return this.name;
    ...
    /**
     * @return The name of the Resource Group where the Machine Learning Workspace exists.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param name The name of the Machine Learning Workspace exists.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param resourceGroupName The name of the Resource Group where the Machine Learning Workspace exists.
         * 
         * @return builder
         * 
         */
