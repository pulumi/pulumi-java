 ...
 *             .streamAnalyticsJobId(exampleJob.apply(getJobResult -&gt; getJobResult.getId()))
 *             .script(&#34;&#34;&#34;
 * function main() {
 *     this.init = function () {
 *         this.state = 0;
 ...
 * }
 *             &#34;&#34;&#34;)
 *             .inputs(FunctionJavascriptUdaInput.builder()
 *                 .type(&#34;bigint&#34;)
 *                 .build())
 *             .output(FunctionJavascriptUdaOutput.builder()
 *                 .type(&#34;bigint&#34;)
 *                 .build())
 *             .build());
 * 
