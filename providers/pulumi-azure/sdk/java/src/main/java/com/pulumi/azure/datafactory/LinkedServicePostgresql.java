...
public class LinkedServicePostgresql extends com.pulumi.resources.CustomResource {
     ...
     */
    public LinkedServicePostgresql(String name) {
     ...
     */
    public static LinkedServicePostgresql get(String name, Output<String> id, @Nullable LinkedServicePostgresqlState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
