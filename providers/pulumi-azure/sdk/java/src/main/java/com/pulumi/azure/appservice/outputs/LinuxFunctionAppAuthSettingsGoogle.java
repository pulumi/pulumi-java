...
@CustomType
public final class LinuxFunctionAppAuthSettingsGoogle {
    /**
    ...
    private LinuxFunctionAppAuthSettingsGoogle(
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsGoogle defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LinuxFunctionAppAuthSettingsGoogle defaults) {
        ...
        }        public LinuxFunctionAppAuthSettingsGoogle build() {
            return new LinuxFunctionAppAuthSettingsGoogle(clientId, clientSecret, clientSecretSettingName, oauthScopes);
        }
    }
}
