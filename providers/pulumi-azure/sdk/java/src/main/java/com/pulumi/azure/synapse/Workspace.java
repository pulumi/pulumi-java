 ...
 *             .aadAdmin(WorkspaceAadAdmin.builder()
 *                 .login(&#34;AzureAD Admin&#34;)
 ...
 *             .sqlAdministratorLogin(&#34;sqladminuser&#34;)
 *             .sqlAdministratorLoginPassword(&#34;H@Sh1CoR3!&#34;)
 *             .customerManagedKey(WorkspaceCustomerManagedKey.builder()
 *                 .keyVersionlessId(exampleKey.getVersionlessId())
 *                 .keyName(&#34;enckey&#34;)
 *                 .build())
 *             .identity(WorkspaceIdentity.builder()
 *                 .type(&#34;SystemAssigned&#34;)
 ...
 *             .keyVaultId(exampleKeyVault.getId())
 *             .tenantId(exampleWorkspace.getIdentity().apply(identity -&gt; identity.getTenantId()))
 *             .objectId(exampleWorkspace.getIdentity().apply(identity -&gt; identity.getPrincipalId()))
 *             .keyPermissions(            
 *                 &#34;Get&#34;,
 *                 &#34;WrapKey&#34;,
 *                 &#34;UnwrapKey&#34;)
 ...
 *             .customerManagedKeyVersionlessId(exampleKey.getVersionlessId())
