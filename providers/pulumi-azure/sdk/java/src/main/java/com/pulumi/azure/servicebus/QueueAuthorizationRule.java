...
import com.pulumi.azure.servicebus.inputs.QueueAuthorizationRuleState;
 ...
 * 
 */
@ResourceType(type="azure:servicebus/queueAuthorizationRule:QueueAuthorizationRule")
public class QueueAuthorizationRule extends com.pulumi.resources.CustomResource {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure:eventhub/queueAuthorizationRule:QueueAuthorizationRule").build())
            ))
            .build();
