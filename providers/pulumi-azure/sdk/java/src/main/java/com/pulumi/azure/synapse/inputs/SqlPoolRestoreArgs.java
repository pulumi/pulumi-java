...
public final class SqlPoolRestoreArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Specifies the Snapshot time to restore. Changing this forces a new Synapse SQL Pool to be created.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param pointInTime Specifies the Snapshot time to restore. Changing this forces a new Synapse SQL Pool to be created.
         * 
         * @return builder
         * 
         */
        ...
        public SqlPoolRestoreArgs build() {
            ...
            $.sourceDatabaseId = Objects.requireNonNull($.sourceDatabaseId, "expected parameter 'sourceDatabaseId' to be non-null");
            return $;
        }
    }
