...
import com.pulumi.azure.mariadb.inputs.FirewallRuleState;
 ...
 * 
 */
@ResourceType(type="azure:mariadb/firewallRule:FirewallRule")
public class FirewallRule extends com.pulumi.resources.CustomResource {
    ...
    public FirewallRule(String name, FirewallRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:mariadb/firewallRule:FirewallRule", name, args == null ? FirewallRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private FirewallRule(String name, Output<String> id, @Nullable FirewallRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:mariadb/firewallRule:FirewallRule", name, state, makeResourceOptions(options, id));
    }
