 ...
 *             .replyUrls(String.format(&#34;https://%s.developer.azure-api.net/signin&#34;, azurerm_api_management.getTest().getName()))
 *             .build());
 * 
 *         var exampleApplicationPassword = new ApplicationPassword(&#34;exampleApplicationPassword&#34;, ApplicationPasswordArgs.builder()        
 *             .applicationObjectId(azuread_application.getTest().getObject_id())
 *             .endDateRelative(&#34;36h&#34;)
 *             .value(&#34;P@55w0rD!%[7]s&#34;)
 *             .build());
 * 
 ...
 *             .clientId(exampleApplication.getApplicationId())
