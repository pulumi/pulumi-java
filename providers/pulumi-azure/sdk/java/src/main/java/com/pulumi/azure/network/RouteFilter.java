...
public class RouteFilter extends com.pulumi.resources.CustomResource {
    ...
    public RouteFilter(String name, RouteFilterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:network/routeFilter:RouteFilter", name, args == null ? RouteFilterArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RouteFilter(String name, Output<String> id, @Nullable RouteFilterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:network/routeFilter:RouteFilter", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static RouteFilter get(String name, Output<String> id, @Nullable RouteFilterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
