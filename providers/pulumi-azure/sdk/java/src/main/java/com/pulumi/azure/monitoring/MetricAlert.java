 ...
 *             .build());
 * 
 *         var example = new MetricAlert(&#34;example&#34;, MetricAlertArgs.builder()        
 *             .resourceGroupName(mainResourceGroup.getName())
 *             .scopes(toMonitor.getId())
 *             .description(&#34;Action will be triggered when Transactions count is greater than 50.&#34;)
 *             .criterias(MetricAlertCriteria.builder()
 *                 .metricNamespace(&#34;Microsoft.Storage/storageAccounts&#34;)
 *                 .metricName(&#34;Transactions&#34;)
 *                 .aggregation(&#34;Total&#34;)
 *                 .operator(&#34;GreaterThan&#34;)
 *                 .threshold(50)
 *                 .dimensions(MetricAlertCriteriaDimension.builder()
 *                     .name(&#34;ApiName&#34;)
 *                     .operator(&#34;Include&#34;)
 *                     .values(&#34;*&#34;)
 *                     .build())
 *                 .build())
 *             .actions(MetricAlertAction.builder()
 *                 .actionGroupId(mainActionGroup.getId())
 *                 .build())
 *             .build());
 * 
 *         }
