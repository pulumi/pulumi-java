 ...
 *             .apiManagementName(exampleService.apply(getServiceResult -&gt; getServiceResult.getName()))
 *             .resourceGroupName(exampleService.apply(getServiceResult -&gt; getServiceResult.getResourceGroupName()))
 *             .build()));
 * 
 *         final var exampleGroup = Output.of(ApimanagementFunctions.getGroup(GetGroupArgs.builder()
 *             .name(&#34;my-group&#34;)
 *             .apiManagementName(exampleService.apply(getServiceResult -&gt; getServiceResult.getName()))
 *             .resourceGroupName(exampleService.apply(getServiceResult -&gt; getServiceResult.getResourceGroupName()))
 *             .build()));
 ...
 *             .productId(exampleProduct.apply(getProductResult -&gt; getProductResult.getProductId()))
 *             .groupName(exampleGroup.apply(getGroupResult -&gt; getGroupResult.getName()))
 *             .apiManagementName(exampleService.apply(getServiceResult -&gt; getServiceResult.getName()))
 *             .resourceGroupName(exampleService.apply(getServiceResult -&gt; getServiceResult.getResourceGroupName()))
 *             .build());
 * 
