 ...
 *             .retry(TriggerTumblingWindowRetry.builder()
 *                 .count(1)
 *                 .interval(30)
 *                 .build())
 *             .pipeline(TriggerTumblingWindowPipeline.builder()
 *                 .name(azurerm_data_factory_pipeline.getTest().getName())
 *                 .parameters(Map.of(&#34;Env&#34;, &#34;Prod&#34;))
 *                 .build())
 *             .triggerDependencies(TriggerTumblingWindowTriggerDependency.builder()
 *                 .size(&#34;24:00:00&#34;)
 *                 .offset(&#34;-24:00:00&#34;)
 *                 .build())
