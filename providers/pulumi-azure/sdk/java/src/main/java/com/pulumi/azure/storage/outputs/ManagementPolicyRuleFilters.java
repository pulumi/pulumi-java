...
public final class ManagementPolicyRuleFilters {
     ...
     * 
     */
    private final @Nullable List<String> blobTypes;
    /**
    ...
    private ManagementPolicyRuleFilters(
        @CustomType.Parameter("blobTypes") @Nullable List<String> blobTypes,
    ...
    public List<String> blobTypes() {
        return this.blobTypes == null ? List.of() : this.blobTypes;
    }
    /**
     * @return A `match_blob_index_tag` block as defined below. The block defines the blob index tag based filtering for blob objects.
     * 
    ...
    public static final class Builder {
        private @Nullable List<String> blobTypes;
        ...
        public Builder blobTypes(@Nullable List<String> blobTypes) {
            this.blobTypes = blobTypes;
            return this;
        }
