...
@CustomType
public final class EndpointDeliveryRuleCookiesCondition {
    /**
    ...
    public static Builder builder(EndpointDeliveryRuleCookiesCondition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(EndpointDeliveryRuleCookiesCondition defaults) {
        ...
        }        public EndpointDeliveryRuleCookiesCondition build() {
            return new EndpointDeliveryRuleCookiesCondition(matchValues, negateCondition, operator, selector, transforms);
        }
    }
}
