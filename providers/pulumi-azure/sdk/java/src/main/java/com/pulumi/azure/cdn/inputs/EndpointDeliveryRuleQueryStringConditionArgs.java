...
public final class EndpointDeliveryRuleQueryStringConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final EndpointDeliveryRuleQueryStringConditionArgs Empty = new EndpointDeliveryRuleQueryStringConditionArgs();
    ...
    private EndpointDeliveryRuleQueryStringConditionArgs() {}

    private EndpointDeliveryRuleQueryStringConditionArgs(EndpointDeliveryRuleQueryStringConditionArgs $) {
    ...
    public static Builder builder(EndpointDeliveryRuleQueryStringConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EndpointDeliveryRuleQueryStringConditionArgs();
        }

        public Builder(EndpointDeliveryRuleQueryStringConditionArgs defaults) {
            $ = new EndpointDeliveryRuleQueryStringConditionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EndpointDeliveryRuleQueryStringConditionArgs build() {
