...
public final class GetServiceArgs extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return Specifies the name of the SignalR service.
     * 
     */
    public String name() {
        return this.name;
    ...
    /**
     * @return Specifies the name of the resource group the SignalR service is located in.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param name Specifies the name of the SignalR service.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param resourceGroupName Specifies the name of the resource group the SignalR service is located in.
         * 
         * @return builder
         * 
         */
