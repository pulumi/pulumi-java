...
import com.pulumi.azure.appservice.inputs.WindowsFunctionAppSiteConfigAppServiceLogsArgs;
import com.pulumi.azure.appservice.inputs.WindowsFunctionAppSiteConfigApplicationStackArgs;
import com.pulumi.azure.appservice.inputs.WindowsFunctionAppSiteConfigCorsArgs;
import com.pulumi.azure.appservice.inputs.WindowsFunctionAppSiteConfigIpRestrictionArgs;
import com.pulumi.azure.appservice.inputs.WindowsFunctionAppSiteConfigScmIpRestrictionArgs;
...
public final class WindowsFunctionAppSiteConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppSiteConfigArgs Empty = new WindowsFunctionAppSiteConfigArgs();
     ...
     * 
     */
    public Optional<Output<WindowsFunctionAppSiteConfigApplicationStackArgs>> applicationStack() {
     ...
     */
    @Import(name="cors")
    private @Nullable Output<WindowsFunctionAppSiteConfigCorsArgs> cors;

    /**
     * @return A `cors` block as defined above.
     * 
     */
    public Optional<Output<WindowsFunctionAppSiteConfigCorsArgs>> cors() {
    ...
    private WindowsFunctionAppSiteConfigArgs() {}

    private WindowsFunctionAppSiteConfigArgs(WindowsFunctionAppSiteConfigArgs $) {
    ...
    public static Builder builder(WindowsFunctionAppSiteConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppSiteConfigArgs();
        }

        public Builder(WindowsFunctionAppSiteConfigArgs defaults) {
            $ = new WindowsFunctionAppSiteConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder appServiceLogs(@Nullable Output<WindowsFunctionAppSiteConfigAppServiceLogsArgs> appServiceLogs) {
         ...
         * 
         */
        public Builder appServiceLogs(WindowsFunctionAppSiteConfigAppServiceLogsArgs appServiceLogs) {
         ...
         * 
         */
        public Builder applicationStack(@Nullable Output<WindowsFunctionAppSiteConfigApplicationStackArgs> applicationStack) {
         ...
         * 
         */
        public Builder applicationStack(WindowsFunctionAppSiteConfigApplicationStackArgs applicationStack) {
         ...
         * 
         */
        public Builder cors(@Nullable Output<WindowsFunctionAppSiteConfigCorsArgs> cors) {
            $.cors = cors;
            return this;
        }
         ...
         * 
         */
        public Builder cors(WindowsFunctionAppSiteConfigCorsArgs cors) {
            return cors(Output.of(cors));
        }

        /**
         * @param defaultDocuments Specifies a list of Default Documents for the Windows Function App.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param ftpsState State of FTP / FTPS service for this Windows Function App. Possible values include: `AllAllowed`, `FtpsOnly` and `Disabled`. Defaults to `Disabled`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param healthCheckPath The path to be checked for this Windows Function App health.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder ipRestrictions(@Nullable Output<List<WindowsFunctionAppSiteConfigIpRestrictionArgs>> ipRestrictions) {
         ...
         * 
         */
        public Builder ipRestrictions(List<WindowsFunctionAppSiteConfigIpRestrictionArgs> ipRestrictions) {
         ...
         * 
         */
        public Builder ipRestrictions(WindowsFunctionAppSiteConfigIpRestrictionArgs... ipRestrictions) {
        ...
        /**
         * @param preWarmedInstanceCount The number of pre-warmed instances for this Windows Function App. Only affects apps on an Elastic Premium plan.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder scmIpRestrictions(@Nullable Output<List<WindowsFunctionAppSiteConfigScmIpRestrictionArgs>> scmIpRestrictions) {
         ...
         * 
         */
        public Builder scmIpRestrictions(List<WindowsFunctionAppSiteConfigScmIpRestrictionArgs> scmIpRestrictions) {
         ...
         * 
         */
        public Builder scmIpRestrictions(WindowsFunctionAppSiteConfigScmIpRestrictionArgs... scmIpRestrictions) {
        ...
        /**
         * @param use32BitWorker Should the Windows Function App use a 32-bit worker process. Defaults to `true`.
         * 
         * @return builder
         * 
         */
        ...
        public WindowsFunctionAppSiteConfigArgs build() {
            return $;
        }
    }
