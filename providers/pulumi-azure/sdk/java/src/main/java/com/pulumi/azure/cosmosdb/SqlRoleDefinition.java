 ...
 *                 return String.format(&#34;/subscriptions/%s/resourceGroups/%s/providers/Microsoft.DocumentDB/databaseAccounts/%s/dbs/sales&#34;, current.apply(getClientConfigResult -&gt; getClientConfigResult.getSubscriptionId()),exampleResourceGroupName,exampleAccountName);
 *             }))
