...
public final class BlobInventoryPolicyRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return A list of fields to be included in the inventory. See the [Azure API reference](https://docs.microsoft.com/en-us/rest/api/storagerp/blob-inventory-policies/create-or-update#blobinventorypolicydefinition) for all the supported fields.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param schemaFields A list of fields to be included in the inventory. See the [Azure API reference](https://docs.microsoft.com/en-us/rest/api/storagerp/blob-inventory-policies/create-or-update#blobinventorypolicydefinition) for all the supported fields.
         * 
         * @return builder
         * 
         */
