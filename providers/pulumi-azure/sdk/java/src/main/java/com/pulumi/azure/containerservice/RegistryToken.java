 ...
 *             .containerRegistryName(azurerm_container_registry.getAcr().getName())
 *             .resourceGroupName(azurerm_resource_group.getRg().getName())
 *             .actions(            
 ...
 *             .containerRegistryName(azurerm_container_registry.getAcr().getName())
 *             .resourceGroupName(azurerm_resource_group.getRg().getName())
 *             .scopeMapId(azurerm_container_registry_scope_map.getMap().getId())
 *             .build());
 * 
 *         }
 * }
