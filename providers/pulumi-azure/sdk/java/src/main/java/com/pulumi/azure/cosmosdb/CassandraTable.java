 ...
 *             .cassandraKeyspaceId(exampleCassandraKeyspace.getId())
 *             .schema(CassandraTableSchema.builder()
 *                 .columns(                
 *                     CassandraTableSchemaColumn.builder()
 *                         .name(&#34;test1&#34;)
 *                         .type(&#34;ascii&#34;)
 *                         .build(),
 *                     CassandraTableSchemaColumn.builder()
 ...
 *                         .type(&#34;int&#34;)
 *                         .build())
 *                 .partitionKeys(CassandraTableSchemaPartitionKey.builder()
 *                     .name(&#34;test1&#34;)
 *                     .build())
 *                 .build())
 *             .build());
