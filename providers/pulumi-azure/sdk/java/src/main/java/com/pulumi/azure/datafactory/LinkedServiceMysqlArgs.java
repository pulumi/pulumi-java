...
public final class LinkedServiceMysqlArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinkedServiceMysqlArgs Empty = new LinkedServiceMysqlArgs();
    ...
    /**
     * @return Specifies the name of the Data Factory Linked Service MySQL. Changing this forces a new resource to be created. Must be unique within a data
     * factory. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
     * 
     */
    ...
    private LinkedServiceMysqlArgs() {}

    private LinkedServiceMysqlArgs(LinkedServiceMysqlArgs $) {
    ...
    public static Builder builder(LinkedServiceMysqlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinkedServiceMysqlArgs();
        }

        public Builder(LinkedServiceMysqlArgs defaults) {
            $ = new LinkedServiceMysqlArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param name Specifies the name of the Data Factory Linked Service MySQL. Changing this forces a new resource to be created. Must be unique within a data
         * factory. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
         * 
         * @return builder
         * 
