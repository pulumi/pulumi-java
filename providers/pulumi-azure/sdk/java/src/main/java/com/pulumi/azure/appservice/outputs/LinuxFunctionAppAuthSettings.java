...
import com.pulumi.azure.appservice.outputs.LinuxFunctionAppAuthSettingsActiveDirectory;
import com.pulumi.azure.appservice.outputs.LinuxFunctionAppAuthSettingsFacebook;
import com.pulumi.azure.appservice.outputs.LinuxFunctionAppAuthSettingsGithub;
import com.pulumi.azure.appservice.outputs.LinuxFunctionAppAuthSettingsGoogle;
import com.pulumi.azure.appservice.outputs.LinuxFunctionAppAuthSettingsMicrosoft;
import com.pulumi.azure.appservice.outputs.LinuxFunctionAppAuthSettingsTwitter;
...
@CustomType
public final class LinuxFunctionAppAuthSettings {
    /**
     * @return An `active_directory` block as defined above.
     * 
     */
    private final @Nullable LinuxFunctionAppAuthSettingsActiveDirectory activeDirectory;
    /**
     ...
     * 
     */
    private final @Nullable LinuxFunctionAppAuthSettingsFacebook facebook;
    /**
     * @return A `github` block as defined below.
     * 
     */
    private final @Nullable LinuxFunctionAppAuthSettingsGithub github;
    /**
     * @return A `google` block as defined below.
     * 
     */
    private final @Nullable LinuxFunctionAppAuthSettingsGoogle google;
    /**
     ...
     * 
     */
    private final @Nullable LinuxFunctionAppAuthSettingsMicrosoft microsoft;
    /**
     ...
     * 
     */
    private final @Nullable LinuxFunctionAppAuthSettingsTwitter twitter;
    /**
    ...
    private LinuxFunctionAppAuthSettings(
        @CustomType.Parameter("activeDirectory") @Nullable LinuxFunctionAppAuthSettingsActiveDirectory activeDirectory,
        ...
        @CustomType.Parameter("facebook") @Nullable LinuxFunctionAppAuthSettingsFacebook facebook,
        @CustomType.Parameter("github") @Nullable LinuxFunctionAppAuthSettingsGithub github,
        @CustomType.Parameter("google") @Nullable LinuxFunctionAppAuthSettingsGoogle google,
        @CustomType.Parameter("issuer") @Nullable String issuer,
        @CustomType.Parameter("microsoft") @Nullable LinuxFunctionAppAuthSettingsMicrosoft microsoft,
        ...
        @CustomType.Parameter("twitter") @Nullable LinuxFunctionAppAuthSettingsTwitter twitter,
     ...
     * 
     */
    public Optional<LinuxFunctionAppAuthSettingsActiveDirectory> activeDirectory() {
     ...
     * 
     */
    public Optional<LinuxFunctionAppAuthSettingsFacebook> facebook() {
     ...
     * 
     */
    public Optional<LinuxFunctionAppAuthSettingsGithub> github() {
     ...
     * 
     */
    public Optional<LinuxFunctionAppAuthSettingsGoogle> google() {
     ...
     * 
     */
    public Optional<LinuxFunctionAppAuthSettingsMicrosoft> microsoft() {
     ...
     * 
     */
    public Optional<LinuxFunctionAppAuthSettingsTwitter> twitter() {
    ...
    public static Builder builder(LinuxFunctionAppAuthSettings defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable LinuxFunctionAppAuthSettingsActiveDirectory activeDirectory;
        ...
        private @Nullable LinuxFunctionAppAuthSettingsFacebook facebook;
        private @Nullable LinuxFunctionAppAuthSettingsGithub github;
        private @Nullable LinuxFunctionAppAuthSettingsGoogle google;
        private @Nullable String issuer;
        private @Nullable LinuxFunctionAppAuthSettingsMicrosoft microsoft;
        ...
        private @Nullable LinuxFunctionAppAuthSettingsTwitter twitter;
        ...
        public Builder(LinuxFunctionAppAuthSettings defaults) {
        ...
        public Builder activeDirectory(@Nullable LinuxFunctionAppAuthSettingsActiveDirectory activeDirectory) {
            this.activeDirectory = activeDirectory;
            return this;
        }
        ...
        public Builder facebook(@Nullable LinuxFunctionAppAuthSettingsFacebook facebook) {
            this.facebook = facebook;
            return this;
        }
        public Builder github(@Nullable LinuxFunctionAppAuthSettingsGithub github) {
            this.github = github;
            return this;
        }
        public Builder google(@Nullable LinuxFunctionAppAuthSettingsGoogle google) {
            this.google = google;
            return this;
        }
        ...
        public Builder microsoft(@Nullable LinuxFunctionAppAuthSettingsMicrosoft microsoft) {
            this.microsoft = microsoft;
            return this;
        }
        ...
        public Builder twitter(@Nullable LinuxFunctionAppAuthSettingsTwitter twitter) {
            this.twitter = twitter;
            return this;
        }
        public Builder unauthenticatedClientAction(@Nullable String unauthenticatedClientAction) {
            this.unauthenticatedClientAction = unauthenticatedClientAction;
            return this;
        }        public LinuxFunctionAppAuthSettings build() {
            return new LinuxFunctionAppAuthSettings(activeDirectory, additionalLoginParameters, allowedExternalRedirectUrls, defaultProvider, enabled, facebook, github, google, issuer, microsoft, runtimeVersion, tokenRefreshExtensionHours, tokenStoreEnabled, twitter, unauthenticatedClientAction);
        }
    }
}
