...
public final class GetDateTimeVariableArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDateTimeVariableArgs Empty = new GetDateTimeVariableArgs();
    ...
    private GetDateTimeVariableArgs() {}

    private GetDateTimeVariableArgs(GetDateTimeVariableArgs $) {
    ...
    public static Builder builder(GetDateTimeVariableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDateTimeVariableArgs();
        }

        public Builder(GetDateTimeVariableArgs defaults) {
            $ = new GetDateTimeVariableArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDateTimeVariableArgs build() {
