 ...
 *             .eventgridTopicEndpoint(exampleTopic.getEndpoint())
 *             .eventgridTopicPrimaryAccessKey(exampleTopic.getPrimaryAccessKey())
 *             .eventgridTopicSecondaryAccessKey(exampleTopic.getSecondaryAccessKey())
 *             .build());
 * 
 *         }
 * }
