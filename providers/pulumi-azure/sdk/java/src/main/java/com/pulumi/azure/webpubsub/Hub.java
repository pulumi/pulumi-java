 ...
 *             .build());
 * 
 *         var testHub = new Hub(&#34;testHub&#34;, HubArgs.builder()        
 *             .webPubsubId(azurerm_web_pubsub.getExmaple().getId())
 *             .eventHandlers(            
 *                 HubEventHandler.builder()
 ...
 *                         .managedIdentityId(testUserAssignedIdentity.getId())
 *                         .build())
 *                     .build())
...
public class Hub extends com.pulumi.resources.CustomResource {
    ...
    private Output<List<HubEventHandler>> eventHandlers;

    /**
     * @return An `event_handler` block as defined below.
     * 
     */
    public Output<List<HubEventHandler>> eventHandlers() {
