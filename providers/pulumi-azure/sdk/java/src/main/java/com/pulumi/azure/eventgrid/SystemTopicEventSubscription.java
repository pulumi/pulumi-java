 ...
 *             .location(&#34;Global&#34;)
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .sourceArmResourceId(exampleResourceGroup.getId())
 ...
 *             .systemTopic(exampleSystemTopic.getName())
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .storageQueueEndpoint(SystemTopicEventSubscriptionStorageQueueEndpoint.builder()
 *                 .storageAccountId(exampleAccount.getId())
 *                 .queueName(exampleQueue.getName())
 *                 .build())
 *             .build());
 * 
 *         }
