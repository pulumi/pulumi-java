 ...
 *             .offerType(&#34;Standard&#34;)
 *             .capabilities(AccountCapability.builder()
 *                 .name(&#34;EnableCassandra&#34;)
 *                 .build())
 *             .consistencyPolicy(AccountConsistencyPolicy.builder()
 *                 .consistencyLevel(&#34;Strong&#34;)
 *                 .build())
 *             .geoLocations(AccountGeoLocation.builder()
 *                 .location(&#34;West US&#34;)
 *                 .failoverPriority(0)
 *                 .build())
 *             .build());
 ...
 *             .resourceGroupName(exampleAccount.getResourceGroupName())
 *             .accountName(exampleAccount.getName())
 *             .throughput(400)
 *             .build());
 * 
 *         }
