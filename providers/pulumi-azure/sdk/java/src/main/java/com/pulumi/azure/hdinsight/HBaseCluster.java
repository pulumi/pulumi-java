 ...
 *             .clusterVersion(&#34;3.6&#34;)
 *             .tier(&#34;Standard&#34;)
 *             .componentVersion(HBaseClusterComponentVersion.builder()
 *                 .hbase(&#34;1.1&#34;)
 *                 .build())
 *             .gateway(HBaseClusterGateway.builder()
 *                 .username(&#34;acctestusrgw&#34;)
 *                 .password(&#34;Password123!&#34;)
 *                 .build())
 *             .storageAccounts(HBaseClusterStorageAccount.builder()
 *                 .storageContainerId(exampleContainer.getId())
 *                 .storageAccountKey(exampleAccount.getPrimaryAccessKey())
 *                 .isDefault(true)
 *                 .build())
 *             .roles(HBaseClusterRoles.builder()
 *                 .headNode(HBaseClusterRolesHeadNode.builder()
 *                     .vmSize(&#34;Standard_D3_V2&#34;)
 *                     .username(&#34;acctestusrvm&#34;)
 *                     .password(&#34;AccTestvdSC4daf986!&#34;)
 *                     .build())
 *                 .workerNode(HBaseClusterRolesWorkerNode.builder()
 *                     .vmSize(&#34;Standard_D3_V2&#34;)
 *                     .username(&#34;acctestusrvm&#34;)
 *                     .password(&#34;AccTestvdSC4daf986!&#34;)
 *                     .targetInstanceCount(3)
 *                     .build())
 *                 .zookeeperNode(HBaseClusterRolesZookeeperNode.builder()
 *                     .vmSize(&#34;Standard_D3_V2&#34;)
 *                     .username(&#34;acctestusrvm&#34;)
 *                     .password(&#34;AccTestvdSC4daf986!&#34;)
 *                     .build())
