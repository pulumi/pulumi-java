...
import com.pulumi.azure.datashare.inputs.AccountState;
import com.pulumi.azure.datashare.outputs.AccountIdentity;
 ...
 * 
 */
@ResourceType(type="azure:datashare/account:Account")
public class Account extends com.pulumi.resources.CustomResource {
    ...
    public Account(String name, AccountArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:datashare/account:Account", name, args == null ? AccountArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Account(String name, Output<String> id, @Nullable AccountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:datashare/account:Account", name, state, makeResourceOptions(options, id));
    }
