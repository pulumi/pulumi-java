...
public final class GetStringVariableArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetStringVariableArgs Empty = new GetStringVariableArgs();
    ...
    private GetStringVariableArgs() {}

    private GetStringVariableArgs(GetStringVariableArgs $) {
    ...
    public static Builder builder(GetStringVariableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetStringVariableArgs();
        }

        public Builder(GetStringVariableArgs defaults) {
            $ = new GetStringVariableArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetStringVariableArgs build() {
