 ...
 *             .storageSyncId(exampleSync.getId())
 *             .build());
 * 
 ...
 *             .acls(ShareAcl.builder()
 *                 .id(&#34;GhostedRecall&#34;)
 *                 .accessPolicies(ShareAclAccessPolicy.builder()
 *                     .permissions(&#34;r&#34;)
 *                     .build())
 *                 .build())
 *             .build());
 ...
 *             .storageSyncGroupId(exampleSyncGroup.getId())
 *             .fileShareName(exampleShare.getName())
