 ...
 *             .apiManagementName(exampleProduct.apply(getProductResult -&gt; getProductResult.getApiManagementName()))
 *             .resourceGroupName(exampleProduct.apply(getProductResult -&gt; getProductResult.getResourceGroupName()))
 *             .xmlContent(&#34;&#34;&#34;
 * &lt;policies&gt;
 *   &lt;inbound&gt;
