...
public final class LinuxWebAppSiteConfigArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="cors")
    private @Nullable Output<LinuxWebAppSiteConfigCorsArgs> cors;

    /**
     * @return A `cors` block as defined above.
     * 
     */
    public Optional<Output<LinuxWebAppSiteConfigCorsArgs>> cors() {
    ...
    /**
     * @return Should all outbound traffic have Virtual Network Security Groups and User Defined Routes applied? Defaults to `false`.
     * 
     */
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder applicationStack(@Nullable Output<LinuxWebAppSiteConfigApplicationStackArgs> applicationStack) {
         ...
         * 
         */
        public Builder autoHealSetting(@Nullable Output<LinuxWebAppSiteConfigAutoHealSettingArgs> autoHealSetting) {
         ...
         * 
         */
        public Builder cors(@Nullable Output<LinuxWebAppSiteConfigCorsArgs> cors) {
            $.cors = cors;
            return this;
        }
         ...
         * 
         */
        public Builder ipRestrictions(@Nullable Output<List<LinuxWebAppSiteConfigIpRestrictionArgs>> ipRestrictions) {
         ...
         * 
         */
        public Builder ipRestrictions(List<LinuxWebAppSiteConfigIpRestrictionArgs> ipRestrictions) {
         ...
         * 
         */
        public Builder scmIpRestrictions(@Nullable Output<List<LinuxWebAppSiteConfigScmIpRestrictionArgs>> scmIpRestrictions) {
         ...
         * 
         */
        public Builder scmIpRestrictions(List<LinuxWebAppSiteConfigScmIpRestrictionArgs> scmIpRestrictions) {
        ...
        /**
         * @param vnetRouteAllEnabled Should all outbound traffic have Virtual Network Security Groups and User Defined Routes applied? Defaults to `false`.
         * 
         * @return builder
         * 
         */
