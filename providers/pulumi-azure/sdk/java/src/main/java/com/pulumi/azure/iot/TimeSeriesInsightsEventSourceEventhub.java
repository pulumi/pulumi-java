 ...
 *                 .name(exampleAccount.getName())
 *                 .key(exampleAccount.getPrimaryAccessKey())
 *                 .build())
 *             .build());
 * 
 ...
 *             .eventhubName(exampleEventHub.getName())
 *             .namespaceName(exampleEventHubNamespace.getName())
 *             .sharedAccessKey(exampleAuthorizationRule.getPrimaryKey())
 *             .sharedAccessKeyName(exampleAuthorizationRule.getName())
 *             .consumerGroupName(exampleConsumerGroup.getName())
 *             .eventSourceResourceId(exampleEventHub.getId())
 *             .build());
 * 
 *         }
 * }
