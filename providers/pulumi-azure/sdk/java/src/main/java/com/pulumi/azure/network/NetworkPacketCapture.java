 ...
 *             .location(exampleResourceGroup.getLocation())
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .virtualMachineName(exampleVirtualMachine.getName())
 ...
 *             .networkWatcherName(exampleNetworkWatcher.getName())
 *             .resourceGroupName(exampleResourceGroup.getName())
 *             .targetResourceId(exampleVirtualMachine.getId())
 *             .storageLocation(NetworkPacketCaptureStorageLocation.builder()
