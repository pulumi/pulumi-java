...
@CustomType
public final class WindowsWebAppAuthSettingsFacebook {
    /**
    ...
    private WindowsWebAppAuthSettingsFacebook(
    ...
    public static Builder builder(WindowsWebAppAuthSettingsFacebook defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WindowsWebAppAuthSettingsFacebook defaults) {
        ...
        }        public WindowsWebAppAuthSettingsFacebook build() {
            return new WindowsWebAppAuthSettingsFacebook(appId, appSecret, appSecretSettingName, oauthScopes);
        }
    }
}
