 ...
 *             .location(deployResourceGroup.getLocation())
 *             .resourceGroupName(deployResourceGroup.getName())
 *             .addressSpaces(&#34;10.0.1.0/16&#34;)
 *             .build());
 * 
 *         var deploySubnet = new Subnet(&#34;deploySubnet&#34;, SubnetArgs.builder()        
 *             .resourceGroupName(deployResourceGroup.getName())
 *             .virtualNetworkName(deployVirtualNetwork.getName())
 ...
 *             .subnetId(deploySubnet.getId())
 *             .networkSecurityGroupId(deployNetworkSecurityGroup.getId())
 *             .build());
 * 
 ...
 *             .groupObjectId(dcAdmins.getObjectId())
 *             .memberObjectId(adminUser.getObjectId())
 *             .build());
 * 
 ...
 *             .location(aadds.getLocation())
 *             .resourceGroupName(aadds.getName())
 *             .domainName(&#34;widgetslogin.net&#34;)
 *             .sku(&#34;Enterprise&#34;)
 *             .filteredSyncEnabled(false)
 *             .initialReplicaSet(ServiceInitialReplicaSet.builder()
 *                 .subnetId(deploySubnet.getId())
 *                 .build())
 *             .notifications(ServiceNotifications.builder()
 ...
 *                 .build())
 *             .security(ServiceSecurity.builder()
...
public class Service extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return The Active Directory domain to use. See [official documentation](https://docs.microsoft.com/en-us/azure/active-directory-domain-services/tutorial-create-instance#create-a-managed-domain) for constraints and recommendations.
     * 
     */
