...
public final class AccountEncryptionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The Azure key vault reference id with version that should be used to encrypt data, as documented [here](https://docs.microsoft.com/en-us/azure/batch/batch-customer-managed-key). Key rotation is not yet supported.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param keyVaultKeyId The Azure key vault reference id with version that should be used to encrypt data, as documented [here](https://docs.microsoft.com/en-us/azure/batch/batch-customer-managed-key). Key rotation is not yet supported.
         * 
         * @return builder
         * 
         */
