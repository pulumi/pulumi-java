...
public final class WorkspaceState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="storageDataLakeGen2FilesystemId")
    private @Nullable Output<String> storageDataLakeGen2FilesystemId;

    /**
     * @return Specifies the ID of storage data lake gen2 filesystem resource. Changing this forces a new resource to be created.
     * 
     */
    public Optional<Output<String>> storageDataLakeGen2FilesystemId() {
        return Optional.ofNullable(this.storageDataLakeGen2FilesystemId);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder storageDataLakeGen2FilesystemId(@Nullable Output<String> storageDataLakeGen2FilesystemId) {
