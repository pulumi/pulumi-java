 ...
 *             .enabled(true)
 *             .hourlySchedule(SnapshotPolicyHourlySchedule.builder()
 *                 .snapshotsToKeep(4)
 *                 .minute(15)
 *                 .build())
 *             .dailySchedule(SnapshotPolicyDailySchedule.builder()
 *                 .snapshotsToKeep(2)
 *                 .hour(20)
 *                 .minute(15)
 *                 .build())
 *             .weeklySchedule(SnapshotPolicyWeeklySchedule.builder()
 *                 .snapshotsToKeep(1)
 *                 .daysOfWeeks(                
 *                     &#34;Monday&#34;,
 *                     &#34;Friday&#34;)
 ...
 *                 .minute(0)
 *                 .build())
 *             .monthlySchedule(SnapshotPolicyMonthlySchedule.builder()
 *                 .snapshotsToKeep(1)
 *                 .daysOfMonths(                
 *                     1,
 *                     15,
