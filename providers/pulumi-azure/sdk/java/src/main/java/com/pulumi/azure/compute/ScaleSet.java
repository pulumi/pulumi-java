 ...
 *             .domainNameLabel(exampleResourceGroup.getName())
 ...
 *             .rollingUpgradePolicy(ScaleSetRollingUpgradePolicy.builder()
 ...
 *             .sku(ScaleSetSku.builder()
 *                 .name(&#34;Standard_F2&#34;)
 *                 .tier(&#34;Standard&#34;)
 *                 .capacity(2)
 *                 .build())
 *             .storageProfileImageReference(ScaleSetStorageProfileImageReference.builder()
 *                 .publisher(&#34;Canonical&#34;)
 *                 .offer(&#34;UbuntuServer&#34;)
 *                 .sku(&#34;16.04-LTS&#34;)
 *                 .version(&#34;latest&#34;)
 *                 .build())
 *             .storageProfileOsDisk(ScaleSetStorageProfileOsDisk.builder()
 *                 .name(&#34;&#34;)
 *                 .caching(&#34;ReadWrite&#34;)
 *                 .createOption(&#34;FromImage&#34;)
 *                 .managedDiskType(&#34;Standard_LRS&#34;)
 *                 .build())
 *             .storageProfileDataDisks(ScaleSetStorageProfileDataDisk.builder()
 *                 .lun(0)
 *                 .caching(&#34;ReadWrite&#34;)
 *                 .createOption(&#34;Empty&#34;)
 *                 .diskSizeGb(10)
 *                 .build())
 *             .osProfile(ScaleSetOsProfile.builder()
 *                 .computerNamePrefix(&#34;testvm&#34;)
 *                 .adminUsername(&#34;myadmin&#34;)
 *                 .build())
 *             .osProfileLinuxConfig(ScaleSetOsProfileLinuxConfig.builder()
 *                 .disablePasswordAuthentication(true)
 *                 .sshKeys(ScaleSetOsProfileLinuxConfigSshKey.builder()
 *                     .path(&#34;/home/myadmin/.ssh/authorized_keys&#34;)
 *                     .keyData(Files.readString(&#34;~/.ssh/demo_key.pub&#34;))
 *                     .build())
 *                 .build())
 *             .networkProfiles(ScaleSetNetworkProfile.builder()
 *                 .name(&#34;mynetworkprofile&#34;)
 *                 .primary(true)
 *                 .ipConfigurations(ScaleSetNetworkProfileIpConfiguration.builder()
 *                     .name(&#34;TestIPConfiguration&#34;)
 *                     .primary(true)
 *                     .subnetId(exampleSubnet.getId())
 *                     .loadBalancerBackendAddressPoolIds(bpepool.getId())
 *                     .loadBalancerInboundNatRulesIds(lbnatpool.getId())
 *                     .build())
 *                 .build())
 *             .tags(Map.of(&#34;environment&#34;, &#34;staging&#34;))
 *             .build());
 ...
 *                 .caching(&#34;ReadWrite&#34;)
 *                 .createOption(&#34;FromImage&#34;)
 *                 .vhdContainers(Output.tuple(exampleAccount.getPrimaryBlobEndpoint(), exampleContainer.getName()).apply(values -&gt; {
