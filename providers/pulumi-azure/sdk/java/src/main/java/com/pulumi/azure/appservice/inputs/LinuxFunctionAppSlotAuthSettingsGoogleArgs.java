...
public final class LinuxFunctionAppSlotAuthSettingsGoogleArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppSlotAuthSettingsGoogleArgs Empty = new LinuxFunctionAppSlotAuthSettingsGoogleArgs();
    ...
    private LinuxFunctionAppSlotAuthSettingsGoogleArgs() {}

    private LinuxFunctionAppSlotAuthSettingsGoogleArgs(LinuxFunctionAppSlotAuthSettingsGoogleArgs $) {
    ...
    public static Builder builder(LinuxFunctionAppSlotAuthSettingsGoogleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppSlotAuthSettingsGoogleArgs();
        }

        public Builder(LinuxFunctionAppSlotAuthSettingsGoogleArgs defaults) {
            $ = new LinuxFunctionAppSlotAuthSettingsGoogleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppSlotAuthSettingsGoogleArgs build() {
