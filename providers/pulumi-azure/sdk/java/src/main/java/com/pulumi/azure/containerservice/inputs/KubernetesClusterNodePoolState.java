...
public final class KubernetesClusterNodePoolState extends com.pulumi.resources.ResourceArgs {

    public static final KubernetesClusterNodePoolState Empty = new KubernetesClusterNodePoolState();
    ...
    /**
     * @return Whether to enable [auto-scaler](https://docs.microsoft.com/en-us/azure/aks/cluster-autoscaler). Defaults to `false`.
     * 
     */
    ...
    /**
     * @return A map of Kubernetes labels which should be applied to nodes in this Node Pool. Changing this forces a new resource to be created.
     * 
     */
    ...
    /**
     * @return Used to specify whether the UltraSSD is enabled in the Node Pool. Defaults to `false`. See [the documentation](https://docs.microsoft.com/en-us/azure/aks/use-ultra-disks) for more information.
     * 
     */
    ...
    private KubernetesClusterNodePoolState() {}
    ...
    public static Builder builder(KubernetesClusterNodePoolState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KubernetesClusterNodePoolState();
        }

        public Builder(KubernetesClusterNodePoolState defaults) {
            $ = new KubernetesClusterNodePoolState(Objects.requireNonNull(defaults));
        }

        /**
         * @param enableAutoScaling Whether to enable [auto-scaler](https://docs.microsoft.com/en-us/azure/aks/cluster-autoscaler). Defaults to `false`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param nodeLabels A map of Kubernetes labels which should be applied to nodes in this Node Pool. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param ultraSsdEnabled Used to specify whether the UltraSSD is enabled in the Node Pool. Defaults to `false`. See [the documentation](https://docs.microsoft.com/en-us/azure/aks/use-ultra-disks) for more information.
         * 
         * @return builder
         * 
         */
        ...
        public KubernetesClusterNodePoolState build() {
            return $;
        }
    }
