 ...
 *                 KeyVaultAccessPolicy.builder()
 *                     .tenantId(current.apply(getClientConfigResult -&gt; getClientConfigResult.getTenantId()))
 *                     .objectId(exampleServicePrincipal.apply(getServicePrincipalResult -&gt; getServicePrincipalResult.getObjectId()))
 *                     .secretPermissions(                    
 *                         &#34;get&#34;,
 *                         &#34;list&#34;)
 *                     .certificatePermissions(                    
 ...
 *             .resourceGroupName(exampleSpringCloudService.getResourceGroupName())
 *             .serviceName(exampleSpringCloudService.getName())
 *             .keyVaultCertificateId(exampleCertificate.getId())
 *             .build());
 * 
 *         }
 * }
