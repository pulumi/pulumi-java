 ...
 *             .clusterVersion(&#34;4.0&#34;)
 *             .tier(&#34;Standard&#34;)
 *             .componentVersion(KafkaClusterComponentVersion.builder()
 *                 .kafka(&#34;2.1&#34;)
 *                 .build())
 *             .gateway(KafkaClusterGateway.builder()
 *                 .username(&#34;acctestusrgw&#34;)
 *                 .password(&#34;Password123!&#34;)
 *                 .build())
 *             .storageAccounts(KafkaClusterStorageAccount.builder()
 *                 .storageContainerId(exampleContainer.getId())
 *                 .storageAccountKey(exampleAccount.getPrimaryAccessKey())
 *                 .isDefault(true)
 *                 .build())
 *             .roles(KafkaClusterRoles.builder()
 *                 .headNode(KafkaClusterRolesHeadNode.builder()
 *                     .vmSize(&#34;Standard_D3_V2&#34;)
 *                     .username(&#34;acctestusrvm&#34;)
 *                     .password(&#34;AccTestvdSC4daf986!&#34;)
 *                     .build())
 *                 .workerNode(KafkaClusterRolesWorkerNode.builder()
 *                     .vmSize(&#34;Standard_D3_V2&#34;)
 *                     .username(&#34;acctestusrvm&#34;)
 *                     .password(&#34;AccTestvdSC4daf986!&#34;)
 ...
 *                     .build())
 *                 .zookeeperNode(KafkaClusterRolesZookeeperNode.builder()
 *                     .vmSize(&#34;Standard_D3_V2&#34;)
 *                     .username(&#34;acctestusrvm&#34;)
 *                     .password(&#34;AccTestvdSC4daf986!&#34;)
 *                     .build())
