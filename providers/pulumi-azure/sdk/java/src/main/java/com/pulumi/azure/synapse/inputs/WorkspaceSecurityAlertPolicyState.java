...
public final class WorkspaceSecurityAlertPolicyState extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceSecurityAlertPolicyState Empty = new WorkspaceSecurityAlertPolicyState();
    ...
    private WorkspaceSecurityAlertPolicyState() {}

    private WorkspaceSecurityAlertPolicyState(WorkspaceSecurityAlertPolicyState $) {
    ...
    public static Builder builder(WorkspaceSecurityAlertPolicyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceSecurityAlertPolicyState();
        }

        public Builder(WorkspaceSecurityAlertPolicyState defaults) {
            $ = new WorkspaceSecurityAlertPolicyState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param policyState Specifies the state of the policy, whether it is enabled or disabled or a policy has not been applied yet on the specific workspace. Allowed values are: `Disabled`, `Enabled`.
         * 
         * @return builder
         * 
         */
        ...
        public WorkspaceSecurityAlertPolicyState build() {
            return $;
        }
    }
