...
public final class LinkedServiceAzureDatabricksState extends com.pulumi.resources.ResourceArgs {

    public static final LinkedServiceAzureDatabricksState Empty = new LinkedServiceAzureDatabricksState();
     ...
     * 
     */
    @Import(name="adbDomain")
    private @Nullable Output<String> adbDomain;

    /**
     * @return The domain URL of the databricks instance.
     * 
     */
    public Optional<Output<String>> adbDomain() {
        return Optional.ofNullable(this.adbDomain);
    }
    ...
    /**
     * @return Specifies the name of the Data Factory Linked Service. Changing this forces a new resource to be created. Must be unique within a data factory. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
     * 
     */
    ...
    private LinkedServiceAzureDatabricksState() {}

    private LinkedServiceAzureDatabricksState(LinkedServiceAzureDatabricksState $) {
    ...
    public static Builder builder(LinkedServiceAzureDatabricksState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinkedServiceAzureDatabricksState();
        }

        public Builder(LinkedServiceAzureDatabricksState defaults) {
            $ = new LinkedServiceAzureDatabricksState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder adbDomain(@Nullable Output<String> adbDomain) {
            $.adbDomain = adbDomain;
            return this;
        }
        ...
        /**
         * @param name Specifies the name of the Data Factory Linked Service. Changing this forces a new resource to be created. Must be unique within a data factory. See the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/data-factory/naming-rules) for all restrictions.
         * 
         * @return builder
         * 
         */
        ...
        public LinkedServiceAzureDatabricksState build() {
            return $;
        }
    }
