...
@CustomType
public final class WindowsWebAppAuthSettingsGithub {
    /**
    ...
    public static Builder builder(WindowsWebAppAuthSettingsGithub defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WindowsWebAppAuthSettingsGithub defaults) {
        ...
        }        public WindowsWebAppAuthSettingsGithub build() {
            return new WindowsWebAppAuthSettingsGithub(clientId, clientSecret, clientSecretSettingName, oauthScopes);
        }
    }
}
