 ...
 *             .clusterVersion(&#34;3.6&#34;)
 *             .tier(&#34;Standard&#34;)
 *             .componentVersion(InteractiveQueryClusterComponentVersion.builder()
 *                 .interactiveHive(&#34;2.1&#34;)
 *                 .build())
 *             .gateway(InteractiveQueryClusterGateway.builder()
 *                 .username(&#34;acctestusrgw&#34;)
 *                 .password(&#34;Password!&#34;)
 *                 .build())
 *             .storageAccounts(InteractiveQueryClusterStorageAccount.builder()
 *                 .storageContainerId(exampleContainer.getId())
 *                 .storageAccountKey(exampleAccount.getPrimaryAccessKey())
 *                 .isDefault(true)
 *                 .build())
 *             .roles(InteractiveQueryClusterRoles.builder()
 *                 .headNode(InteractiveQueryClusterRolesHeadNode.builder()
 *                     .vmSize(&#34;Standard_D13_V2&#34;)
 *                     .username(&#34;acctestusrvm&#34;)
 *                     .password(&#34;AccTestvdSC4daf986!&#34;)
 *                     .build())
 *                 .workerNode(InteractiveQueryClusterRolesWorkerNode.builder()
 *                     .vmSize(&#34;Standard_D14_V2&#34;)
 *                     .username(&#34;acctestusrvm&#34;)
 *                     .password(&#34;AccTestvdSC4daf986!&#34;)
 *                     .targetInstanceCount(3)
 *                     .build())
 *                 .zookeeperNode(InteractiveQueryClusterRolesZookeeperNode.builder()
