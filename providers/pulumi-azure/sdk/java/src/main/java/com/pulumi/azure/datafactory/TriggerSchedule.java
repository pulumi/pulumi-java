 ...
 *             .dataFactoryId(azurerm_data_factory.getTest().getId())
 *             .pipelineName(testPipeline.getName())
 *             .interval(5)
 *             .frequency(&#34;Day&#34;)
 *             .build());
 * 
...
public class TriggerSchedule extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ Map<String,String>> pipelineParameters;

    /**
     * @return The pipeline parameters that the trigger will act upon.
     * 
     */
    public Output<Optional<Map<String,String>>> pipelineParameters() {
        return Codegen.optional(this.pipelineParameters);
    }
    /**
