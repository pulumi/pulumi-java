 ...
 *             .resourceGroupName(defaultResourceGroup.getName())
 *             .location(defaultResourceGroup.getLocation())
 ...
 *             .storageAccountName(defaultAccount.getName())
 *             .build());
 * 
 *         var defaultEventSubscription = new EventSubscription(&#34;defaultEventSubscription&#34;, EventSubscriptionArgs.builder()        
 *             .scope(defaultResourceGroup.getId())
 *             .storageQueueEndpoint(EventSubscriptionStorageQueueEndpoint.builder()
 *                 .storageAccountId(defaultAccount.getId())
 *                 .queueName(defaultQueue.getName())
 *                 .build())
 *             .build());
 * 
 *         }
