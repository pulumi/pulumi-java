 ...
 *             .policyDefinitionId(examplePolicyDefintion.apply(getPolicyDefintionResult -&gt; getPolicyDefintionResult.getId()))
 *             .parameters(exampleResourceGroup.getLocation().apply(location -&gt; serializeJson(
 *                 jsonObject(
 ...
 *             .resourceGroupId(exampleResourceGroup.getId())
 *             .policyAssignmentId(exampleResourceGroupPolicyAssignment.getId())
