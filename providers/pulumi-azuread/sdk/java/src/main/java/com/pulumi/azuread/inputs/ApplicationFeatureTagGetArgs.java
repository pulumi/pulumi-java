...
public final class ApplicationFeatureTagGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationFeatureTagGetArgs Empty = new ApplicationFeatureTagGetArgs();
    ...
    private ApplicationFeatureTagGetArgs() {
    ...
    public static Builder builder(ApplicationFeatureTagGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ApplicationFeatureTagGetArgs defaults) {
        ...
        public Builder hide(@Nullable Boolean hide) {
            ...
            return this;
        }        public ApplicationFeatureTagGetArgs build() {
            return new ApplicationFeatureTagGetArgs(customSingleSignOn, enterprise, gallery, hide);
        }
    }
}
