...
@CustomType
public final class GetApplicationOptionalClaimAccessToken {
    /**
    ...
    private GetApplicationOptionalClaimAccessToken(
    ...
    public static Builder builder(GetApplicationOptionalClaimAccessToken defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetApplicationOptionalClaimAccessToken defaults) {
        ...
        public Builder source(@Nullable String source) {
            this.source = source;
            return this;
        }        public GetApplicationOptionalClaimAccessToken build() {
            return new GetApplicationOptionalClaimAccessToken(additionalProperties, essential, name, source);
        }
    }
}
