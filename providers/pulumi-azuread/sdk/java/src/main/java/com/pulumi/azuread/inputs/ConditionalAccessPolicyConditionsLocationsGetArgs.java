...
public final class ConditionalAccessPolicyConditionsLocationsGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConditionalAccessPolicyConditionsLocationsGetArgs Empty = new ConditionalAccessPolicyConditionsLocationsGetArgs();
    ...
    private ConditionalAccessPolicyConditionsLocationsGetArgs() {
    ...
    public static Builder builder(ConditionalAccessPolicyConditionsLocationsGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ConditionalAccessPolicyConditionsLocationsGetArgs defaults) {
        ...
        }        public ConditionalAccessPolicyConditionsLocationsGetArgs build() {
            return new ConditionalAccessPolicyConditionsLocationsGetArgs(excludedLocations, includedLocations);
        }
    }
}
