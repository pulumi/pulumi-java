...
public final class ConditionalAccessPolicyConditionsApplicationsGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConditionalAccessPolicyConditionsApplicationsGetArgs Empty = new ConditionalAccessPolicyConditionsApplicationsGetArgs();
    ...
    private ConditionalAccessPolicyConditionsApplicationsGetArgs() {
    ...
    public static Builder builder(ConditionalAccessPolicyConditionsApplicationsGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ConditionalAccessPolicyConditionsApplicationsGetArgs defaults) {
        ...
        }        public ConditionalAccessPolicyConditionsApplicationsGetArgs build() {
            return new ConditionalAccessPolicyConditionsApplicationsGetArgs(excludedApplications, includedApplications, includedUserActions);
        }
    }
}
