...
public final class ApplicationSinglePageApplicationGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationSinglePageApplicationGetArgs Empty = new ApplicationSinglePageApplicationGetArgs();
    ...
    public ApplicationSinglePageApplicationGetArgs(@Nullable Output<List<String>> redirectUris) {
        this.redirectUris = redirectUris;
    }

    private ApplicationSinglePageApplicationGetArgs() {
    ...
    public static Builder builder(ApplicationSinglePageApplicationGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ApplicationSinglePageApplicationGetArgs defaults) {
        ...
        }        public ApplicationSinglePageApplicationGetArgs build() {
            return new ApplicationSinglePageApplicationGetArgs(redirectUris);
        }
    }
}
