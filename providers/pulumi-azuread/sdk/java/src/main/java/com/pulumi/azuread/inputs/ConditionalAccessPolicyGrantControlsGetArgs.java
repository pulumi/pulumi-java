...
public final class ConditionalAccessPolicyGrantControlsGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConditionalAccessPolicyGrantControlsGetArgs Empty = new ConditionalAccessPolicyGrantControlsGetArgs();
    ...
    private ConditionalAccessPolicyGrantControlsGetArgs() {
    ...
    public static Builder builder(ConditionalAccessPolicyGrantControlsGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ConditionalAccessPolicyGrantControlsGetArgs defaults) {
        ...
        }        public ConditionalAccessPolicyGrantControlsGetArgs build() {
            return new ConditionalAccessPolicyGrantControlsGetArgs(builtInControls, customAuthenticationFactors, operator, termsOfUses);
        }
    }
}
