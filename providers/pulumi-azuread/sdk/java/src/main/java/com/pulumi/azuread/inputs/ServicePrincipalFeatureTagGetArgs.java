...
public final class ServicePrincipalFeatureTagGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServicePrincipalFeatureTagGetArgs Empty = new ServicePrincipalFeatureTagGetArgs();
    ...
    private ServicePrincipalFeatureTagGetArgs() {
    ...
    public static Builder builder(ServicePrincipalFeatureTagGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ServicePrincipalFeatureTagGetArgs defaults) {
        ...
        public Builder hide(@Nullable Boolean hide) {
            ...
            return this;
        }        public ServicePrincipalFeatureTagGetArgs build() {
            return new ServicePrincipalFeatureTagGetArgs(customSingleSignOn, enterprise, gallery, hide);
        }
    }
}
