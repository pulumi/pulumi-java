...
public final class GetApplicationOptionalClaimSaml2Token extends com.pulumi.resources.InvokeArgs {

    public static final GetApplicationOptionalClaimSaml2Token Empty = new GetApplicationOptionalClaimSaml2Token();
    ...
    public GetApplicationOptionalClaimSaml2Token(
    ...
    private GetApplicationOptionalClaimSaml2Token() {
    ...
    public static Builder builder(GetApplicationOptionalClaimSaml2Token defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetApplicationOptionalClaimSaml2Token defaults) {
        ...
        public Builder source(@Nullable String source) {
            this.source = source;
            return this;
        }        public GetApplicationOptionalClaimSaml2Token build() {
            return new GetApplicationOptionalClaimSaml2Token(additionalProperties, essential, name, source);
        }
    }
}
