...
public final class ContainerVolumeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ContainerVolumeGetArgs(ContainerVolumeGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ContainerVolumeGetArgs();
        }

        public Builder(ContainerVolumeGetArgs defaults) {
            $ = new ContainerVolumeGetArgs(Objects.requireNonNull(defaults));
        }
