...
public final class ServiceTaskSpecRestartPolicyGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServiceTaskSpecRestartPolicyGetArgs(ServiceTaskSpecRestartPolicyGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceTaskSpecRestartPolicyGetArgs();
        }

        public Builder(ServiceTaskSpecRestartPolicyGetArgs defaults) {
            $ = new ServiceTaskSpecRestartPolicyGetArgs(Objects.requireNonNull(defaults));
        }
