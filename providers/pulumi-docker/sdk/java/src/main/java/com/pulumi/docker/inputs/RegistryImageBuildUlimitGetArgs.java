...
public final class RegistryImageBuildUlimitGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegistryImageBuildUlimitGetArgs(RegistryImageBuildUlimitGetArgs $) {
        this.hard = $.hard;
        this.name = $.name;
        this.soft = $.soft;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegistryImageBuildUlimitGetArgs();
        }

        public Builder(RegistryImageBuildUlimitGetArgs defaults) {
            $ = new RegistryImageBuildUlimitGetArgs(Objects.requireNonNull(defaults));
        }
