...
public final class ContainerNetworkDataGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ContainerNetworkDataGetArgs(ContainerNetworkDataGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ContainerNetworkDataGetArgs();
        }

        public Builder(ContainerNetworkDataGetArgs defaults) {
            $ = new ContainerNetworkDataGetArgs(Objects.requireNonNull(defaults));
        }
