...
import com.pulumi.docker.inputs.ServiceTaskSpecContainerSpecMountVolumeOptionsLabelGetArgs;
...
public final class ServiceTaskSpecContainerSpecMountVolumeOptionsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<List<ServiceTaskSpecContainerSpecMountVolumeOptionsLabelGetArgs>>> labels() {
    ...
    private ServiceTaskSpecContainerSpecMountVolumeOptionsGetArgs(ServiceTaskSpecContainerSpecMountVolumeOptionsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceTaskSpecContainerSpecMountVolumeOptionsGetArgs();
        }

        public Builder(ServiceTaskSpecContainerSpecMountVolumeOptionsGetArgs defaults) {
            $ = new ServiceTaskSpecContainerSpecMountVolumeOptionsGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder labels(List<ServiceTaskSpecContainerSpecMountVolumeOptionsLabelGetArgs> labels) {
