...
public final class RemoteImageBuildGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RemoteImageBuildGetArgs(RemoteImageBuildGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RemoteImageBuildGetArgs();
        }

        public Builder(RemoteImageBuildGetArgs defaults) {
            $ = new RemoteImageBuildGetArgs(Objects.requireNonNull(defaults));
        }
