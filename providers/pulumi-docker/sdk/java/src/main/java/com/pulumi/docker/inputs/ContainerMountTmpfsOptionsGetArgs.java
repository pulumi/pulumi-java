...
public final class ContainerMountTmpfsOptionsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ContainerMountTmpfsOptionsGetArgs(ContainerMountTmpfsOptionsGetArgs $) {
        this.mode = $.mode;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ContainerMountTmpfsOptionsGetArgs();
        }

        public Builder(ContainerMountTmpfsOptionsGetArgs defaults) {
            $ = new ContainerMountTmpfsOptionsGetArgs(Objects.requireNonNull(defaults));
        }
