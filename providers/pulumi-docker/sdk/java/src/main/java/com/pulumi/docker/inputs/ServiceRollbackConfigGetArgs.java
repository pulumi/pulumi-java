...
public final class ServiceRollbackConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServiceRollbackConfigGetArgs(ServiceRollbackConfigGetArgs $) {
        this.delay = $.delay;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceRollbackConfigGetArgs();
        }

        public Builder(ServiceRollbackConfigGetArgs defaults) {
            $ = new ServiceRollbackConfigGetArgs(Objects.requireNonNull(defaults));
        }
