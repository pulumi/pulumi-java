...
public final class ContainerHealthcheckGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ContainerHealthcheckGetArgs(ContainerHealthcheckGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ContainerHealthcheckGetArgs();
        }

        public Builder(ContainerHealthcheckGetArgs defaults) {
            $ = new ContainerHealthcheckGetArgs(Objects.requireNonNull(defaults));
        }
