...
public final class ServiceTaskSpecResourcesReservationGenericResourcesGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServiceTaskSpecResourcesReservationGenericResourcesGetArgs(ServiceTaskSpecResourcesReservationGenericResourcesGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceTaskSpecResourcesReservationGenericResourcesGetArgs();
        }

        public Builder(ServiceTaskSpecResourcesReservationGenericResourcesGetArgs defaults) {
            $ = new ServiceTaskSpecResourcesReservationGenericResourcesGetArgs(Objects.requireNonNull(defaults));
        }
