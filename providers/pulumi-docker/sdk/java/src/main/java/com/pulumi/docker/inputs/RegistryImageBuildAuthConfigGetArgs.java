...
public final class RegistryImageBuildAuthConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegistryImageBuildAuthConfigGetArgs(RegistryImageBuildAuthConfigGetArgs $) {
        this.auth = $.auth;
        this.email = $.email;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegistryImageBuildAuthConfigGetArgs();
        }

        public Builder(RegistryImageBuildAuthConfigGetArgs defaults) {
            $ = new RegistryImageBuildAuthConfigGetArgs(Objects.requireNonNull(defaults));
        }
