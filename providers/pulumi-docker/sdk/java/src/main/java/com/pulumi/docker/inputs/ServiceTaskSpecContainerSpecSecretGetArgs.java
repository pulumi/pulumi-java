...
public final class ServiceTaskSpecContainerSpecSecretGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServiceTaskSpecContainerSpecSecretGetArgs(ServiceTaskSpecContainerSpecSecretGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceTaskSpecContainerSpecSecretGetArgs();
        }

        public Builder(ServiceTaskSpecContainerSpecSecretGetArgs defaults) {
            $ = new ServiceTaskSpecContainerSpecSecretGetArgs(Objects.requireNonNull(defaults));
        }
