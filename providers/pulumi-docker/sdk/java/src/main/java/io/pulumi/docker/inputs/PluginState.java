...
public final class PluginState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setGrantPermissions(@Nullable Input<List<PluginGrantPermissionGetArgs>> grantPermissions) {
            this.grantPermissions = grantPermissions;
            return this;
        }

        public Builder setGrantPermissions(@Nullable List<PluginGrantPermissionGetArgs> grantPermissions) {
        ...
        public Builder setPluginReference(@Nullable Input<String> pluginReference) {
            this.pluginReference = pluginReference;
            return this;
        }

        public Builder setPluginReference(@Nullable String pluginReference) {
