...
public class Service extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.docker.ServiceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.docker.ServiceArgs.builder();
    ...
    public Service(String name, ServiceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("docker:index/service:Service", name, args == null ? ServiceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
