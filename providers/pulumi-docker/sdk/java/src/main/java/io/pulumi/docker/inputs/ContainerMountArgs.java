...
public final class ContainerMountArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="bindOptions")
      private final @Nullable Input<ContainerMountBindOptionsArgs> bindOptions;

    public Input<ContainerMountBindOptionsArgs> getBindOptions() {
    ...
    @InputImport(name="tmpfsOptions")
      private final @Nullable Input<ContainerMountTmpfsOptionsArgs> tmpfsOptions;

    public Input<ContainerMountTmpfsOptionsArgs> getTmpfsOptions() {
    ...
    @InputImport(name="volumeOptions")
      private final @Nullable Input<ContainerMountVolumeOptionsArgs> volumeOptions;

    public Input<ContainerMountVolumeOptionsArgs> getVolumeOptions() {
        return this.volumeOptions == null ? Input.empty() : this.volumeOptions;
    }

    public ContainerMountArgs(
        @Nullable Input<ContainerMountBindOptionsArgs> bindOptions,
        @Nullable Input<Boolean> readOnly,
        @Nullable Input<String> source,
        Input<String> target,
        @Nullable Input<ContainerMountTmpfsOptionsArgs> tmpfsOptions,
        Input<String> type,
        @Nullable Input<ContainerMountVolumeOptionsArgs> volumeOptions) {
    ...
    public static final class Builder {
        private @Nullable Input<ContainerMountBindOptionsArgs> bindOptions;
        private @Nullable Input<Boolean> readOnly;
        private @Nullable Input<String> source;
        private Input<String> target;
        private @Nullable Input<ContainerMountTmpfsOptionsArgs> tmpfsOptions;
        private Input<String> type;
        private @Nullable Input<ContainerMountVolumeOptionsArgs> volumeOptions;
