...
public class RegistryImage extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable RegistryImageArgs.Builder a);
    }
    private static io.pulumi.docker.RegistryImageArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.docker.RegistryImageArgs.builder();
     ...
     */
    public RegistryImage(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public static RegistryImage get(String name, Output<String> id, @Nullable RegistryImageState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
