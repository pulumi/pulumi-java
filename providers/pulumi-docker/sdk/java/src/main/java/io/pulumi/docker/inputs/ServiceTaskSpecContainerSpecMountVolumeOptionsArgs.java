...
public final class ServiceTaskSpecContainerSpecMountVolumeOptionsArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="labels")
      private final @Nullable Input<List<ServiceTaskSpecContainerSpecMountVolumeOptionsLabelArgs>> labels;

    public Input<List<ServiceTaskSpecContainerSpecMountVolumeOptionsLabelArgs>> getLabels() {
    ...
    public ServiceTaskSpecContainerSpecMountVolumeOptionsArgs(
        ...
        @Nullable Input<List<ServiceTaskSpecContainerSpecMountVolumeOptionsLabelArgs>> labels,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<ServiceTaskSpecContainerSpecMountVolumeOptionsLabelArgs>> labels;
        ...
        public Builder setLabels(@Nullable Input<List<ServiceTaskSpecContainerSpecMountVolumeOptionsLabelArgs>> labels) {
            this.labels = labels;
            return this;
        }

        public Builder setLabels(@Nullable List<ServiceTaskSpecContainerSpecMountVolumeOptionsLabelArgs> labels) {
