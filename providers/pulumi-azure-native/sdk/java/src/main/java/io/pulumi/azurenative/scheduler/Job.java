...
public class Job extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.scheduler.JobArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.scheduler.JobArgs.builder();
    ...
    public Job(String name, JobArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:scheduler:Job", name, args == null ? JobArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:scheduler/v20140801preview:Job").build()),
                Output.of(Alias.builder().setType("azure-native:scheduler/v20160101:Job").build()),
                Output.of(Alias.builder().setType("azure-native:scheduler/v20160301:Job").build())
            ))
            .build();
