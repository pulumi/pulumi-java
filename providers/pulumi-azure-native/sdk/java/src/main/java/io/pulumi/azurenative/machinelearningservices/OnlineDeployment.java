...
public class OnlineDeployment extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(OnlineDeploymentArgs.Builder a);
    }
    private static io.pulumi.azurenative.machinelearningservices.OnlineDeploymentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.machinelearningservices.OnlineDeploymentArgs.builder();
     ...
     */
    public OnlineDeployment(String name, BuilderApplicator argsBuilder) {
