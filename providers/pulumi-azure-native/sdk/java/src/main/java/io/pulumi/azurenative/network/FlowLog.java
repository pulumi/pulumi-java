...
public class FlowLog extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.network.FlowLogArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.network.FlowLogArgs.builder();
    ...
    public FlowLog(String name, FlowLogArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:network:FlowLog", name, args == null ? FlowLogArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:network/v20191101:FlowLog").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20191201:FlowLog").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200301:FlowLog").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200401:FlowLog").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200501:FlowLog").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200601:FlowLog").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200701:FlowLog").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200801:FlowLog").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20201101:FlowLog").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20210201:FlowLog").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20210301:FlowLog").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20210501:FlowLog").build())
            ))
            .build();
