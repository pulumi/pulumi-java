...
public class Schema extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.apimanagement.SchemaArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.apimanagement.SchemaArgs.builder();
