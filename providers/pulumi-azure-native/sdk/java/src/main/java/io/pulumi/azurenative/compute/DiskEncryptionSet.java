...
public class DiskEncryptionSet extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(DiskEncryptionSetArgs.Builder a);
    }
    private static io.pulumi.azurenative.compute.DiskEncryptionSetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.compute.DiskEncryptionSetArgs.builder();
     ...
     */
    public DiskEncryptionSet(String name, BuilderApplicator argsBuilder) {
