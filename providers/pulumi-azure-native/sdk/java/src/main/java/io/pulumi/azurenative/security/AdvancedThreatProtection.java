...
public class AdvancedThreatProtection extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(AdvancedThreatProtectionArgs.Builder a);
    }
    private static io.pulumi.azurenative.security.AdvancedThreatProtectionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.security.AdvancedThreatProtectionArgs.builder();
     ...
     */
    public AdvancedThreatProtection(String name, BuilderApplicator argsBuilder) {
    ...
    public AdvancedThreatProtection(String name, AdvancedThreatProtectionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:security:AdvancedThreatProtection", name, args == null ? AdvancedThreatProtectionArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:security/v20170801preview:AdvancedThreatProtection").build()),
                Output.of(Alias.builder().setType("azure-native:security/v20190101:AdvancedThreatProtection").build())
            ))
            .build();
