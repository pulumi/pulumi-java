...
public class DisasterRecoveryConfig extends io.pulumi.resources.CustomResource {
    ...
    public DisasterRecoveryConfig(String name, DisasterRecoveryConfigArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:servicebus:DisasterRecoveryConfig", name, args == null ? DisasterRecoveryConfigArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:servicebus/v20170401:DisasterRecoveryConfig").build()),
                Output.of(Alias.builder().setType("azure-native:servicebus/v20180101preview:DisasterRecoveryConfig").build()),
                Output.of(Alias.builder().setType("azure-native:servicebus/v20210101preview:DisasterRecoveryConfig").build()),
                Output.of(Alias.builder().setType("azure-native:servicebus/v20210601preview:DisasterRecoveryConfig").build()),
                Output.of(Alias.builder().setType("azure-native:servicebus/v20211101:DisasterRecoveryConfig").build())
            ))
            .build();
