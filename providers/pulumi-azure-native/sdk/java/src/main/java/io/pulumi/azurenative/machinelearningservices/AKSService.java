...
class MyStack : Stack
{
    public MyStack()
    {
        var aksService = new AzureNative.MachineLearningServices.AKSService("aksService", new AzureNative.MachineLearningServices.AKSServiceArgs
        {
...
const aksService = new azure_native.machinelearningservices.AKSService("aksService", {
    resourceGroupName: "testrg123",
    serviceName: "service456",
    workspaceName: "workspaces123",
});
...
aks_service = azure_native.machinelearningservices.AKSService("aksService",
