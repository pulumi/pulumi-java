...
public class VirtualMachine extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.connectedvmwarevsphere.VirtualMachineArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.connectedvmwarevsphere.VirtualMachineArgs.builder();
