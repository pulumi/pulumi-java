...
public class TemplateArtifact extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(TemplateArtifactArgs.Builder a);
    }
    private static io.pulumi.azurenative.blueprint.TemplateArtifactArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.blueprint.TemplateArtifactArgs.builder();
     ...
     */
    public TemplateArtifact(String name, BuilderApplicator argsBuilder) {
