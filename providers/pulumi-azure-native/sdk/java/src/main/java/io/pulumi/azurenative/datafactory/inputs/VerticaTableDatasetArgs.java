 ...
 * 
 */
public final class VerticaTableDatasetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public VerticaTableDatasetArgs build() {
            return new VerticaTableDatasetArgs(annotations, description, folder, linkedServiceName, parameters, schema, structure, table, tableName, type);
        }
    }
}
