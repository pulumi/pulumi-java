...
public class Connector extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.customerinsights.ConnectorArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.customerinsights.ConnectorArgs.builder();
    ...
    public Connector(String name, ConnectorArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:customerinsights:Connector", name, args == null ? ConnectorArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:customerinsights/v20170101:Connector").build()),
                Output.of(Alias.builder().setType("azure-native:customerinsights/v20170426:Connector").build())
            ))
            .build();
