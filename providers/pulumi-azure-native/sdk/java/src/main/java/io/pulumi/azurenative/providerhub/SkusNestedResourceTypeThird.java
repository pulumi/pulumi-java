...
public class SkusNestedResourceTypeThird extends io.pulumi.resources.CustomResource {
    ...
    public SkusNestedResourceTypeThird(String name, SkusNestedResourceTypeThirdArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:providerhub:SkusNestedResourceTypeThird", name, args == null ? SkusNestedResourceTypeThirdArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private SkusNestedResourceTypeThird(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:providerhub/v20201120:SkusNestedResourceTypeThird").build()),
                Input.of(Alias.builder().setType("azure-native:providerhub/v20210501preview:SkusNestedResourceTypeThird").build()),
                Input.of(Alias.builder().setType("azure-native:providerhub/v20210601preview:SkusNestedResourceTypeThird").build()),
                Input.of(Alias.builder().setType("azure-native:providerhub/v20210901preview:SkusNestedResourceTypeThird").build())
            ))
            .build();
     ...
     */
    public static SkusNestedResourceTypeThird get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
