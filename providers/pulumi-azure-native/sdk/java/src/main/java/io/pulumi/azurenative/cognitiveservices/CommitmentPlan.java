...
public class CommitmentPlan extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(CommitmentPlanArgs.Builder a);
    }
    private static io.pulumi.azurenative.cognitiveservices.CommitmentPlanArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.cognitiveservices.CommitmentPlanArgs.builder();
     ...
     */
    public CommitmentPlan(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:cognitiveservices/v20211001:CommitmentPlan").build())
            ))
            .build();
