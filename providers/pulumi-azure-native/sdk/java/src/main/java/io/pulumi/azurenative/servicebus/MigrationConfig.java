...
public class MigrationConfig extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:servicebus/v20170401:MigrationConfig").build()),
                Output.of(Alias.builder().setType("azure-native:servicebus/v20180101preview:MigrationConfig").build()),
                Output.of(Alias.builder().setType("azure-native:servicebus/v20210101preview:MigrationConfig").build()),
                Output.of(Alias.builder().setType("azure-native:servicebus/v20210601preview:MigrationConfig").build()),
                Output.of(Alias.builder().setType("azure-native:servicebus/v20211101:MigrationConfig").build())
            ))
            .build();
