...
public class ADLSGen1FileDataSet extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:datashare/v20181101preview:ADLSGen1FileDataSet").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20191101:ADLSGen1FileDataSet").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20200901:ADLSGen1FileDataSet").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20201001preview:ADLSGen1FileDataSet").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20210801:ADLSGen1FileDataSet").build())
            ))
            .build();
     ...
     */
    public static ADLSGen1FileDataSet get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
