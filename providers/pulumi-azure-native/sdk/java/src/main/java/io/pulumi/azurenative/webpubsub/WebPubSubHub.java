...
public class WebPubSubHub extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(WebPubSubHubArgs.Builder a);
    }
    private static io.pulumi.azurenative.webpubsub.WebPubSubHubArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.webpubsub.WebPubSubHubArgs.builder();
     ...
     */
    public WebPubSubHub(String name, BuilderApplicator argsBuilder) {
    ...
    public WebPubSubHub(String name, WebPubSubHubArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:webpubsub:WebPubSubHub", name, args == null ? WebPubSubHubArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:webpubsub/v20211001:WebPubSubHub").build())
            ))
            .build();
