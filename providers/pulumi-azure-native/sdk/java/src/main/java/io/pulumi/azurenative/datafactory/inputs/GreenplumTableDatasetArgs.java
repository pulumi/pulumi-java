 ...
 * 
 */
public final class GreenplumTableDatasetArgs extends io.pulumi.resources.ResourceArgs {

    public static final GreenplumTableDatasetArgs Empty = new GreenplumTableDatasetArgs();
    ...
    private GreenplumTableDatasetArgs() {
    ...
    public static Builder builder(GreenplumTableDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GreenplumTableDatasetArgs defaults) {
        ...
        public GreenplumTableDatasetArgs build() {
            return new GreenplumTableDatasetArgs(annotations, description, folder, linkedServiceName, parameters, schema, structure, table, tableName, type);
        }
    }
}
