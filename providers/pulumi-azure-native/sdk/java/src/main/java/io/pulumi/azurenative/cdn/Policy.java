...
public class Policy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:cdn/v20190615:Policy").build()),
                Output.of(Alias.builder().setType("azure-native:cdn/v20190615preview:Policy").build()),
                Output.of(Alias.builder().setType("azure-native:cdn/v20200331:Policy").build()),
                Output.of(Alias.builder().setType("azure-native:cdn/v20200415:Policy").build()),
                Output.of(Alias.builder().setType("azure-native:cdn/v20200901:Policy").build()),
                Output.of(Alias.builder().setType("azure-native:cdn/v20210601:Policy").build())
            ))
            .build();
