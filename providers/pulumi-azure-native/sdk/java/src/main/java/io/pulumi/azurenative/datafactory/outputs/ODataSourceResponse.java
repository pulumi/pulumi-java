...
public final class ODataSourceResponse {
    ...
    @OutputCustomType.Constructor({"additionalColumns","disableMetricsCollection","httpRequestTimeout","maxConcurrentConnections","query","sourceRetryCount","sourceRetryWait","type"})
