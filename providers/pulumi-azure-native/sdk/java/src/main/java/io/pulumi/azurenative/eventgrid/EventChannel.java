...
public class EventChannel extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(EventChannelArgs.Builder a);
    }
    private static io.pulumi.azurenative.eventgrid.EventChannelArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.eventgrid.EventChannelArgs.builder();
     ...
     */
    public EventChannel(String name, BuilderApplicator argsBuilder) {
