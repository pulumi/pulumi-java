...
public class WorkbookTemplate extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(WorkbookTemplateArgs.Builder a);
    }
    private static io.pulumi.azurenative.insights.WorkbookTemplateArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.insights.WorkbookTemplateArgs.builder();
     ...
     */
    public WorkbookTemplate(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:insights/v20191017preview:WorkbookTemplate").build()),
                Output.of(Alias.builder().setType("azure-native:insights/v20201120:WorkbookTemplate").build())
            ))
            .build();
