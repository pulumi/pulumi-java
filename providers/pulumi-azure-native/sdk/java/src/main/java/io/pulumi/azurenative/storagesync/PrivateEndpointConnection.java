...
public class PrivateEndpointConnection extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.storagesync.PrivateEndpointConnectionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.storagesync.PrivateEndpointConnectionArgs.builder();
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:storagesync/v20200301:PrivateEndpointConnection").build()),
                Output.of(Alias.builder().setType("azure-native:storagesync/v20200901:PrivateEndpointConnection").build())
            ))
            .build();
