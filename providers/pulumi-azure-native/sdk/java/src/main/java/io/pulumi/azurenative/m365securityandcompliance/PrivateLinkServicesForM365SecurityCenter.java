...
public class PrivateLinkServicesForM365SecurityCenter extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PrivateLinkServicesForM365SecurityCenterArgs.Builder a);
    }
    private static io.pulumi.azurenative.m365securityandcompliance.PrivateLinkServicesForM365SecurityCenterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.m365securityandcompliance.PrivateLinkServicesForM365SecurityCenterArgs.builder();
     ...
     */
    public PrivateLinkServicesForM365SecurityCenter(String name, BuilderApplicator argsBuilder) {
    ...
    public PrivateLinkServicesForM365SecurityCenter(String name, PrivateLinkServicesForM365SecurityCenterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:m365securityandcompliance:privateLinkServicesForM365SecurityCenter", name, args == null ? PrivateLinkServicesForM365SecurityCenterArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private PrivateLinkServicesForM365SecurityCenter(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:m365securityandcompliance/v20210325preview:privateLinkServicesForM365SecurityCenter").build())
            ))
            .build();
     ...
     */
    public static PrivateLinkServicesForM365SecurityCenter get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
