...
import io.pulumi.azurenative.securityandcompliance.PrivateEndpointConnectionsForSCCPowershellArgs;
 ...
 * 
 */
@ResourceType(type="azure-native:securityandcompliance:PrivateEndpointConnectionsForSCCPowershell")
public class PrivateEndpointConnectionsForSCCPowershell extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.securityandcompliance.PrivateEndpointConnectionsForSCCPowershellArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.securityandcompliance.PrivateEndpointConnectionsForSCCPowershellArgs.builder();
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsForSCCPowershell").build()),
                Output.of(Alias.builder().type("azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsForSCCPowershell").build())
            ))
            .build();
