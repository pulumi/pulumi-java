...
public class UserRule extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(UserRuleArgs.Builder a);
    }
    private static io.pulumi.azurenative.network.UserRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.network.UserRuleArgs.builder();
     ...
     */
    public UserRule(String name, BuilderApplicator argsBuilder) {
    ...
    public UserRule(String name, UserRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:network:UserRule", name, args == null ? UserRuleArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private UserRule(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:network/v20210201preview:UserRule").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20210501preview:UserRule").build())
            ))
            .build();
     ...
     */
    public static UserRule get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
