...
public class InstanceFailoverGroup extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(InstanceFailoverGroupArgs.Builder a);
    }
    private static io.pulumi.azurenative.sql.InstanceFailoverGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.sql.InstanceFailoverGroupArgs.builder();
     ...
     */
    public InstanceFailoverGroup(String name, BuilderApplicator argsBuilder) {
    ...
    public InstanceFailoverGroup(String name, InstanceFailoverGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:sql:InstanceFailoverGroup", name, args == null ? InstanceFailoverGroupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:sql/v20171001preview:InstanceFailoverGroup").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20200202preview:InstanceFailoverGroup").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20200801preview:InstanceFailoverGroup").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20201101preview:InstanceFailoverGroup").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20210201preview:InstanceFailoverGroup").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20210501preview:InstanceFailoverGroup").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20210801preview:InstanceFailoverGroup").build())
            ))
            .build();
