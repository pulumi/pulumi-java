...
public class KustoClusterDataSet extends io.pulumi.resources.CustomResource {
    ...
    public KustoClusterDataSet(String name, KustoClusterDataSetArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:datashare:KustoClusterDataSet", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private KustoClusterDataSet(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static KustoClusterDataSet get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
