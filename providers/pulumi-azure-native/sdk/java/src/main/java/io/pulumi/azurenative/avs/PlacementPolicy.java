...
public class PlacementPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PlacementPolicyArgs.Builder a);
    }
    private static io.pulumi.azurenative.avs.PlacementPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.avs.PlacementPolicyArgs.builder();
     ...
     */
    public PlacementPolicy(String name, BuilderApplicator argsBuilder) {
