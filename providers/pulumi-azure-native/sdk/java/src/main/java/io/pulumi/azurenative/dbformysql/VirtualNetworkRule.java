...
public class VirtualNetworkRule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:dbformysql/v20171201:VirtualNetworkRule").build()),
                Output.of(Alias.builder().setType("azure-native:dbformysql/v20171201preview:VirtualNetworkRule").build())
            ))
            .build();
