...
@OutputCustomType
public final class SharePointOnlineListResourceDatasetResponse {
    ...
    @OutputCustomType.Constructor({"annotations","description","folder","linkedServiceName","listName","parameters","schema","structure","type"})
    private SharePointOnlineListResourceDatasetResponse(
        @Nullable List<Object> annotations,
        @Nullable String description,
        @Nullable DatasetResponseFolder folder,
        LinkedServiceReferenceResponse linkedServiceName,
        @Nullable Object listName,
    ...
    public Optional<Object> getListName() {
