...
public final class ImpalaSourceArgs extends io.pulumi.resources.ResourceArgs {

    public static final ImpalaSourceArgs Empty = new ImpalaSourceArgs();
    ...
    public static Builder builder(ImpalaSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ImpalaSourceArgs defaults) {
        ...
        public ImpalaSourceArgs build() {
            return new ImpalaSourceArgs(additionalColumns, disableMetricsCollection, maxConcurrentConnections, query, queryTimeout, sourceRetryCount, sourceRetryWait, type);
        }
    }
}
