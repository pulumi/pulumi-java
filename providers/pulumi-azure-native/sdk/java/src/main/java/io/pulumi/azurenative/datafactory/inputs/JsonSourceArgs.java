 ...
 * 
 */
public final class JsonSourceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="formatSettings")
      private final @Nullable Input<JsonReadSettingsArgs> formatSettings;

    public Input<JsonReadSettingsArgs> getFormatSettings() {
    ...
    public JsonSourceArgs(
        ...
        @Nullable Input<JsonReadSettingsArgs> formatSettings,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<JsonReadSettingsArgs> formatSettings;
        ...
        public Builder setFormatSettings(@Nullable Input<JsonReadSettingsArgs> formatSettings) {
            this.formatSettings = formatSettings;
            return this;
        }

        public Builder setFormatSettings(@Nullable JsonReadSettingsArgs formatSettings) {
