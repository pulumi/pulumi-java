...
public class KubeEnvironment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:web/v20210101:KubeEnvironment").build()),
                Output.of(Alias.builder().setType("azure-native:web/v20210115:KubeEnvironment").build()),
                Output.of(Alias.builder().setType("azure-native:web/v20210201:KubeEnvironment").build()),
                Output.of(Alias.builder().setType("azure-native:web/v20210301:KubeEnvironment").build())
            ))
            .build();
