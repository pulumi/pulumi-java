...
public class BuildServiceBuilder extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(BuildServiceBuilderArgs.Builder a);
    }
    private static io.pulumi.azurenative.appplatform.BuildServiceBuilderArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.appplatform.BuildServiceBuilderArgs.builder();
     ...
     */
    public BuildServiceBuilder(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:appplatform/v20220101preview:BuildServiceBuilder").build())
            ))
            .build();
