...
public class WebAppHybridConnection extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(WebAppHybridConnectionArgs.Builder a);
    }
    private static io.pulumi.azurenative.web.WebAppHybridConnectionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.web.WebAppHybridConnectionArgs.builder();
     ...
     */
    public WebAppHybridConnection(String name, BuilderApplicator argsBuilder) {
    ...
    public WebAppHybridConnection(String name, WebAppHybridConnectionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:web:WebAppHybridConnection", name, args == null ? WebAppHybridConnectionArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
