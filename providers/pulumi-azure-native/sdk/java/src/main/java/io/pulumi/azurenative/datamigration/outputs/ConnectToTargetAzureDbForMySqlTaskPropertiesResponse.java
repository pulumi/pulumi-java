...
public final class ConnectToTargetAzureDbForMySqlTaskPropertiesResponse {
    ...
    private ConnectToTargetAzureDbForMySqlTaskPropertiesResponse(
        ...
        @CustomType.Parameter("input") @Nullable ConnectToTargetAzureDbForMySqlTaskInputResponse input,
        @CustomType.Parameter("output") List<ConnectToTargetAzureDbForMySqlTaskOutputResponse> output,
