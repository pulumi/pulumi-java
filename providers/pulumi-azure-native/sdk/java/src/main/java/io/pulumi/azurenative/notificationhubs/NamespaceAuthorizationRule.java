...
public class NamespaceAuthorizationRule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.notificationhubs.NamespaceAuthorizationRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.notificationhubs.NamespaceAuthorizationRuleArgs.builder();
    ...
    public NamespaceAuthorizationRule(String name, NamespaceAuthorizationRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:notificationhubs:NamespaceAuthorizationRule", name, args == null ? NamespaceAuthorizationRuleArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:notificationhubs/v20160301:NamespaceAuthorizationRule").build()),
                Output.of(Alias.builder().setType("azure-native:notificationhubs/v20170401:NamespaceAuthorizationRule").build())
            ))
            .build();
