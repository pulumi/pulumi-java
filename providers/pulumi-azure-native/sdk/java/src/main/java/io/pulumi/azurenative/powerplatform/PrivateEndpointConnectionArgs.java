...
public final class PrivateEndpointConnectionArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="enterprisePolicyName", required=true)
      private final Output<String> enterprisePolicyName;
    ...
    public PrivateEndpointConnectionArgs(
        Output<String> enterprisePolicyName,
    ...
    public static final class Builder {
        ...
        public Builder enterprisePolicyName(String enterprisePolicyName) {
            this.enterprisePolicyName = Output.of(Objects.requireNonNull(enterprisePolicyName));
            return this;
        }
