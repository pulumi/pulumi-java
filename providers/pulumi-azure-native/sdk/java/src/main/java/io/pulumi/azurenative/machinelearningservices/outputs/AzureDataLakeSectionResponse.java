...
public final class AzureDataLakeSectionResponse {
    ...
    @OutputCustomType.Constructor({"authorityUrl","certificate","clientId","clientSecret","credentialType","isCertAuth","resourceGroup","resourceUri","serviceDataAccessAuthIdentity","storeName","subscriptionId","tenantId","thumbprint"})
