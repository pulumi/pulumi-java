...
public class NatRule extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(NatRuleArgs.Builder a);
    }
    private static io.pulumi.azurenative.network.NatRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.network.NatRuleArgs.builder();
     ...
     */
    public NatRule(String name, BuilderApplicator argsBuilder) {
    ...
    public NatRule(String name, NatRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:network:NatRule", name, args == null ? NatRuleArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private NatRule(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static NatRule get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
