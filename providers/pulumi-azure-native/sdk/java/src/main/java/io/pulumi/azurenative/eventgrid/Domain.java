...
public class Domain extends io.pulumi.resources.CustomResource {
    ...
    public Domain(String name) {
        super("azure-native:eventgrid:Domain", name, DomainArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public Domain(String name, DomainArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:eventgrid:Domain", name, args == null ? DomainArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:eventgrid/v20180915preview:Domain").build()),
                Input.of(Alias.builder().setType("azure-native:eventgrid/v20190201preview:Domain").build()),
                Input.of(Alias.builder().setType("azure-native:eventgrid/v20190601:Domain").build()),
                Input.of(Alias.builder().setType("azure-native:eventgrid/v20200101preview:Domain").build()),
                Input.of(Alias.builder().setType("azure-native:eventgrid/v20200401preview:Domain").build()),
                Input.of(Alias.builder().setType("azure-native:eventgrid/v20200601:Domain").build()),
                Input.of(Alias.builder().setType("azure-native:eventgrid/v20201015preview:Domain").build()),
                Input.of(Alias.builder().setType("azure-native:eventgrid/v20210601preview:Domain").build()),
                Input.of(Alias.builder().setType("azure-native:eventgrid/v20211201:Domain").build())
            ))
            .build();
