...
public class PrivateLinkService extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PrivateLinkServiceArgs.Builder a);
    }
    private static io.pulumi.azurenative.network.PrivateLinkServiceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.network.PrivateLinkServiceArgs.builder();
     ...
     */
    public PrivateLinkService(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:network/v20190401:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20190601:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20190701:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20190801:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20190901:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20191101:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20191201:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200301:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200401:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200501:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200601:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200701:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200801:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20201101:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20210201:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20210301:PrivateLinkService").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20210501:PrivateLinkService").build())
            ))
            .build();
     ...
     */
    public static PrivateLinkService get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
