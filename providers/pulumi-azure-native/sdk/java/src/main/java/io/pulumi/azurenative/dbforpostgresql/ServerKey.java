...
public class ServerKey extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.dbforpostgresql.ServerKeyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.dbforpostgresql.ServerKeyArgs.builder();
    ...
    public ServerKey(String name, ServerKeyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:dbforpostgresql:ServerKey", name, args == null ? ServerKeyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:dbforpostgresql/v20200101:ServerKey").build()),
                Output.of(Alias.builder().setType("azure-native:dbforpostgresql/v20200101privatepreview:ServerKey").build())
            ))
            .build();
