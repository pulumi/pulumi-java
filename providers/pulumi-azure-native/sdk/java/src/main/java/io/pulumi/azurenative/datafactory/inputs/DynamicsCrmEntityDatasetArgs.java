 ...
 * 
 */
public final class DynamicsCrmEntityDatasetArgs extends io.pulumi.resources.ResourceArgs {

    public static final DynamicsCrmEntityDatasetArgs Empty = new DynamicsCrmEntityDatasetArgs();
    ...
    public Input<Object> getEntityName() {
    ...
    public DynamicsCrmEntityDatasetArgs(
        @Nullable Input<List<Object>> annotations,
        @Nullable Input<String> description,
        @Nullable Input<Object> entityName,
    ...
    private DynamicsCrmEntityDatasetArgs() {
    ...
    public static Builder builder(DynamicsCrmEntityDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<Object> entityName;
        ...
        public Builder(DynamicsCrmEntityDatasetArgs defaults) {
        ...
        public Builder setEntityName(@Nullable Input<Object> entityName) {
            this.entityName = entityName;
            return this;
        }

        public Builder setEntityName(@Nullable Object entityName) {
        ...
        public DynamicsCrmEntityDatasetArgs build() {
            return new DynamicsCrmEntityDatasetArgs(annotations, description, entityName, folder, linkedServiceName, parameters, schema, structure, type);
        }
    }
}
