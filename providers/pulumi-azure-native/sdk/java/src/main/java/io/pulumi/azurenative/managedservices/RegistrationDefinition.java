...
public class RegistrationDefinition extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RegistrationDefinitionArgs.Builder a);
    }
    private static io.pulumi.azurenative.managedservices.RegistrationDefinitionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.managedservices.RegistrationDefinitionArgs.builder();
     ...
     */
    public RegistrationDefinition(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:managedservices/v20180601preview:RegistrationDefinition").build()),
                Output.of(Alias.builder().setType("azure-native:managedservices/v20190401preview:RegistrationDefinition").build()),
                Output.of(Alias.builder().setType("azure-native:managedservices/v20190601:RegistrationDefinition").build()),
                Output.of(Alias.builder().setType("azure-native:managedservices/v20190901:RegistrationDefinition").build()),
                Output.of(Alias.builder().setType("azure-native:managedservices/v20200201preview:RegistrationDefinition").build())
            ))
            .build();
