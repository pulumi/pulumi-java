...
public final class UrlPathMatchConditionParametersArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="operator", required=true)
      private final Output<Either<String,UrlPathOperator>> operator;

    public Output<Either<String,UrlPathOperator>> getOperator() {
    ...
    public UrlPathMatchConditionParametersArgs(
        ...
        Output<Either<String,UrlPathOperator>> operator,
