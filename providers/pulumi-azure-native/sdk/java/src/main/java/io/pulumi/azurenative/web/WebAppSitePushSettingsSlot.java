...
public class WebAppSitePushSettingsSlot extends io.pulumi.resources.CustomResource {
    ...
    public WebAppSitePushSettingsSlot(String name, WebAppSitePushSettingsSlotArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:web:WebAppSitePushSettingsSlot", name, args == null ? WebAppSitePushSettingsSlotArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private WebAppSitePushSettingsSlot(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static WebAppSitePushSettingsSlot get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
