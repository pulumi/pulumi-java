...
public class JitRequest extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(JitRequestArgs.Builder a);
    }
    private static io.pulumi.azurenative.solutions.JitRequestArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.solutions.JitRequestArgs.builder();
     ...
     */
    public JitRequest(String name, BuilderApplicator argsBuilder) {
    ...
    public JitRequest(String name, JitRequestArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:solutions:JitRequest", name, args == null ? JitRequestArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:solutions/v20190701:JitRequest").build()),
                Output.of(Alias.builder().setType("azure-native:solutions/v20200821preview:JitRequest").build()),
                Output.of(Alias.builder().setType("azure-native:solutions/v20210701:JitRequest").build())
            ))
            .build();
