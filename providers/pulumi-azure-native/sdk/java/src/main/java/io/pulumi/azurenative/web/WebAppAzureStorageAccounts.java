...
public class WebAppAzureStorageAccounts extends io.pulumi.resources.CustomResource {
    ...
    public WebAppAzureStorageAccounts(String name, WebAppAzureStorageAccountsArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:web:WebAppAzureStorageAccounts", name, args == null ? WebAppAzureStorageAccountsArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private WebAppAzureStorageAccounts(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static WebAppAzureStorageAccounts get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
