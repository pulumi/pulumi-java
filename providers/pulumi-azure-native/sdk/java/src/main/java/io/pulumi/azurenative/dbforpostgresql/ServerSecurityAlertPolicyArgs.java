...
public final class ServerSecurityAlertPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="state", required=true)
      private final Input<ServerSecurityAlertPolicyState> state;

    public Input<ServerSecurityAlertPolicyState> getState() {
        return this.state;
    }
    ...
    public ServerSecurityAlertPolicyArgs(
        ...
        Input<ServerSecurityAlertPolicyState> state,
    ...
    public static final class Builder {
        ...
        private Input<ServerSecurityAlertPolicyState> state;
