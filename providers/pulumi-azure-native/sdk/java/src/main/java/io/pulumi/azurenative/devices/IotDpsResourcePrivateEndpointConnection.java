...
public class IotDpsResourcePrivateEndpointConnection extends io.pulumi.resources.CustomResource {
    ...
    public IotDpsResourcePrivateEndpointConnection(String name) {
        super("azure-native:devices:IotDpsResourcePrivateEndpointConnection", name, IotDpsResourcePrivateEndpointConnectionArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
