...
public class EnvironmentSpecificationVersion extends io.pulumi.resources.CustomResource {
    ...
    public EnvironmentSpecificationVersion(String name) {
        super("azure-native:machinelearningservices:EnvironmentSpecificationVersion", name, EnvironmentSpecificationVersionArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
