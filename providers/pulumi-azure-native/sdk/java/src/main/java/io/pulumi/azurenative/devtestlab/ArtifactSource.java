...
public class ArtifactSource extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ArtifactSourceArgs.Builder a);
    }
    private static io.pulumi.azurenative.devtestlab.ArtifactSourceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.devtestlab.ArtifactSourceArgs.builder();
     ...
     */
    public ArtifactSource(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:devtestlab/v20150521preview:ArtifactSource").build()),
                Output.of(Alias.builder().setType("azure-native:devtestlab/v20160515:ArtifactSource").build()),
                Output.of(Alias.builder().setType("azure-native:devtestlab/v20180915:ArtifactSource").build())
            ))
            .build();
