...
public class LinkedService extends io.pulumi.resources.CustomResource {
    ...
    public LinkedService(String name) {
        super("azure-native:machinelearningservices:LinkedService", name, LinkedServiceArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:machinelearningservices/v20200901preview:LinkedService").build())
            ))
            .build();
