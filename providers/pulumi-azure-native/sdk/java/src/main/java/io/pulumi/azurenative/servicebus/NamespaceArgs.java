...
public final class NamespaceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<SBSkuArgs> sku;
        ...
        public Builder setSku(@Nullable Input<SBSkuArgs> sku) {
            this.sku = sku;
            return this;
        }

        public Builder setSku(@Nullable SBSkuArgs sku) {
