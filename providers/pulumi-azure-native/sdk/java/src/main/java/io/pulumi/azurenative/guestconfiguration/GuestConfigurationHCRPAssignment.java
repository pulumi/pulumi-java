...
public class GuestConfigurationHCRPAssignment extends io.pulumi.resources.CustomResource {
    ...
    public GuestConfigurationHCRPAssignment(String name) {
        super("azure-native:guestconfiguration:GuestConfigurationHCRPAssignment", name, GuestConfigurationHCRPAssignmentArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
