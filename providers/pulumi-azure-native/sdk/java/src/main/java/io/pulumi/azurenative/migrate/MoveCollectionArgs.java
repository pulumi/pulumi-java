...
public final class MoveCollectionArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setMoveCollectionName(@Nullable Input<String> moveCollectionName) {
            this.moveCollectionName = moveCollectionName;
            return this;
        }

        public Builder setMoveCollectionName(@Nullable String moveCollectionName) {
            this.moveCollectionName = Input.ofNullable(moveCollectionName);
            return this;
        }

        public Builder setProperties(@Nullable Input<MoveCollectionPropertiesArgs> properties) {
            this.properties = properties;
            return this;
        }

        public Builder setProperties(@Nullable MoveCollectionPropertiesArgs properties) {
