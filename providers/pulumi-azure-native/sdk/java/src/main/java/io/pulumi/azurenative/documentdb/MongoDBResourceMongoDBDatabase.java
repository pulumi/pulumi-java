...
public class MongoDBResourceMongoDBDatabase extends io.pulumi.resources.CustomResource {
    ...
    public Output</* @Nullable */ MongoDBDatabaseGetPropertiesResponseOptions> options() {
        return this.options;
    }
    ...
    public Output</* @Nullable */ MongoDBDatabaseGetPropertiesResponseResource> resource() {
