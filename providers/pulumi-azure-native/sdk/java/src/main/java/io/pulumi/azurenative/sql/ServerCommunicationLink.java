...
public class ServerCommunicationLink extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ServerCommunicationLinkArgs.Builder a);
    }
    private static io.pulumi.azurenative.sql.ServerCommunicationLinkArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.sql.ServerCommunicationLinkArgs.builder();
     ...
     */
    public ServerCommunicationLink(String name, BuilderApplicator argsBuilder) {
    ...
    public ServerCommunicationLink(String name, ServerCommunicationLinkArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:sql:ServerCommunicationLink", name, args == null ? ServerCommunicationLinkArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:sql/v20140401:ServerCommunicationLink").build())
            ))
            .build();
