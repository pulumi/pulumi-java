...
public class WorkloadNetworkVMGroup extends io.pulumi.resources.CustomResource {
    ...
    public WorkloadNetworkVMGroup(String name, WorkloadNetworkVMGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:avs:WorkloadNetworkVMGroup", name, args == null ? WorkloadNetworkVMGroupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private WorkloadNetworkVMGroup(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:avs/v20200717preview:WorkloadNetworkVMGroup").build()),
                Output.of(Alias.builder().setType("azure-native:avs/v20210101preview:WorkloadNetworkVMGroup").build()),
                Output.of(Alias.builder().setType("azure-native:avs/v20210601:WorkloadNetworkVMGroup").build()),
                Output.of(Alias.builder().setType("azure-native:avs/v20211201:WorkloadNetworkVMGroup").build())
            ))
            .build();
     ...
     */
    public static WorkloadNetworkVMGroup get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
