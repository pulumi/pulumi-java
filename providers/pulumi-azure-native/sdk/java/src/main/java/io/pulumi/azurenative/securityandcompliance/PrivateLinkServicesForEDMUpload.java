...
import io.pulumi.azurenative.securityandcompliance.PrivateLinkServicesForEDMUploadArgs;
...
class MyStack : Stack
{
    public MyStack()
    {
        var privateLinkServicesForEDMUpload = new AzureNative.SecurityAndCompliance.PrivateLinkServicesForEDMUpload("privateLinkServicesForEDMUpload", new AzureNative.SecurityAndCompliance.PrivateLinkServicesForEDMUploadArgs
        {
...
public class PrivateLinkServicesForEDMUpload extends io.pulumi.resources.CustomResource {
    /**
    ...
    public PrivateLinkServicesForEDMUpload(String name, PrivateLinkServicesForEDMUploadArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:securityandcompliance:privateLinkServicesForEDMUpload", name, args == null ? PrivateLinkServicesForEDMUploadArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private PrivateLinkServicesForEDMUpload(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:securityandcompliance/v20210111:privateLinkServicesForEDMUpload").build()),
                Input.of(Alias.builder().setType("azure-native:securityandcompliance/v20210308:privateLinkServicesForEDMUpload").build())
            ))
            .build();
     ...
     */
    public static PrivateLinkServicesForEDMUpload get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
