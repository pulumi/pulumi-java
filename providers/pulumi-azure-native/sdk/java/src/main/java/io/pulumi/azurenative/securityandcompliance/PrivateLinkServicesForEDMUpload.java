...
public class PrivateLinkServicesForEDMUpload extends io.pulumi.resources.CustomResource {
    ...
    public PrivateLinkServicesForEDMUpload(String name) {
        super("azure-native:securityandcompliance:privateLinkServicesForEDMUpload", name, PrivateLinkServicesForEDMUploadArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
