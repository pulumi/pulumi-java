...
public class AccessPolicy extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="authentication", type=JwtAuthenticationResponse.class, parameters={})
    ...
    private static io.pulumi.azurenative.videoanalyzer.AccessPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.videoanalyzer.AccessPolicyArgs.builder();
    ...
    public AccessPolicy(String name, AccessPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:videoanalyzer:AccessPolicy", name, args == null ? AccessPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:videoanalyzer/v20210501preview:AccessPolicy").build()),
                Output.of(Alias.builder().setType("azure-native:videoanalyzer/v20211101preview:AccessPolicy").build())
            ))
            .build();
