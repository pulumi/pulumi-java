...
public class AccessPolicy extends io.pulumi.resources.CustomResource {
    ...
    public AccessPolicy(String name, AccessPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:videoanalyzer:AccessPolicy", name, args == null ? AccessPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:videoanalyzer/v20210501preview:AccessPolicy").build()),
                Input.of(Alias.builder().setType("azure-native:videoanalyzer/v20211101preview:AccessPolicy").build())
            ))
            .build();
