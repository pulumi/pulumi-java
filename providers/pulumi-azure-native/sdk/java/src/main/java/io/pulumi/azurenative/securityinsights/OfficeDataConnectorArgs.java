...
public final class OfficeDataConnectorArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setDataTypes(@Nullable Input<OfficeDataConnectorDataTypesArgs> dataTypes) {
            this.dataTypes = dataTypes;
            return this;
        }

        public Builder setDataTypes(@Nullable OfficeDataConnectorDataTypesArgs dataTypes) {
