...
public class EventHubDataConnection extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.synapse.EventHubDataConnectionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.synapse.EventHubDataConnectionArgs.builder();
