...
public class Configuration extends io.pulumi.resources.CustomResource {
    ...
    public Configuration(String name, ConfigurationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:dbforpostgresql:Configuration", name, args == null ? ConfigurationArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:dbforpostgresql/v20171201:Configuration").build()),
                Output.of(Alias.builder().setType("azure-native:dbforpostgresql/v20171201preview:Configuration").build())
            ))
            .build();
