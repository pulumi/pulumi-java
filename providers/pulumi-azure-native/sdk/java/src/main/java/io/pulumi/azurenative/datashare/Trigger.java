...
public class Trigger extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:datashare/v20181101preview:Trigger").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20191101:Trigger").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20200901:Trigger").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20201001preview:Trigger").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20210801:Trigger").build())
            ))
            .build();
