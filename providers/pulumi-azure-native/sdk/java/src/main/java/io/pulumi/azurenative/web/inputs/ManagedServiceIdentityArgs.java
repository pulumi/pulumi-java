...
import io.pulumi.azurenative.web.enums.ManagedServiceIdentityType;
...
public final class ManagedServiceIdentityArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<ManagedServiceIdentityType> type;

    public Input<ManagedServiceIdentityType> getType() {
    ...
    public ManagedServiceIdentityArgs(
        @Nullable Input<ManagedServiceIdentityType> type,
    ...
    public static final class Builder {
        private @Nullable Input<ManagedServiceIdentityType> type;
        ...
        public Builder setType(@Nullable Input<ManagedServiceIdentityType> type) {
            this.type = type;
            return this;
        }

        public Builder setType(@Nullable ManagedServiceIdentityType type) {
