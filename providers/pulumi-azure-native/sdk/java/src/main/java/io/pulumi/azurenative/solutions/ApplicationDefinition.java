...
public class ApplicationDefinition extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ApplicationDefinitionArgs.Builder a);
    }
    private static io.pulumi.azurenative.solutions.ApplicationDefinitionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.solutions.ApplicationDefinitionArgs.builder();
     ...
     */
    public ApplicationDefinition(String name, BuilderApplicator argsBuilder) {
