...
public class AccessPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.timeseriesinsights.AccessPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.timeseriesinsights.AccessPolicyArgs.builder();
