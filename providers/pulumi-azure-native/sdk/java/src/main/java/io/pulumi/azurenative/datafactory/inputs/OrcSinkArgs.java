...
public final class OrcSinkArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setFormatSettings(@Nullable Input<OrcWriteSettingsArgs> formatSettings) {
            this.formatSettings = formatSettings;
            return this;
        }

        public Builder setFormatSettings(@Nullable OrcWriteSettingsArgs formatSettings) {
