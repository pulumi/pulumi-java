...
public class LabPlan extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(LabPlanArgs.Builder a);
    }
    private static io.pulumi.azurenative.labservices.LabPlanArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.labservices.LabPlanArgs.builder();
     ...
     */
    public LabPlan(String name, BuilderApplicator argsBuilder) {
    ...
    public LabPlan(String name, LabPlanArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:labservices:LabPlan", name, args == null ? LabPlanArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private LabPlan(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:labservices/v20211001preview:LabPlan").build()),
                Output.of(Alias.builder().setType("azure-native:labservices/v20211115preview:LabPlan").build())
            ))
            .build();
     ...
     */
    public static LabPlan get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
