...
public class ConfigurationService extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ConfigurationServiceArgs.Builder a);
    }
    private static io.pulumi.azurenative.appplatform.ConfigurationServiceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.appplatform.ConfigurationServiceArgs.builder();
     ...
     */
    public ConfigurationService(String name, BuilderApplicator argsBuilder) {
    ...
    public ConfigurationService(String name, ConfigurationServiceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:appplatform:ConfigurationService", name, args == null ? ConfigurationServiceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ConfigurationService(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:appplatform/v20220101preview:ConfigurationService").build())
            ))
            .build();
     ...
     */
    public static ConfigurationService get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
