...
public class StaticSiteUserProvidedFunctionAppForStaticSite extends io.pulumi.resources.CustomResource {
    ...
    public StaticSiteUserProvidedFunctionAppForStaticSite(String name) {
        super("azure-native:web:StaticSiteUserProvidedFunctionAppForStaticSite", name, StaticSiteUserProvidedFunctionAppForStaticSiteArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
