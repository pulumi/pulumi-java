...
public class LinkedStorageAccount extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:operationalinsights/v20190801preview:LinkedStorageAccount").build()),
                Output.of(Alias.builder().setType("azure-native:operationalinsights/v20200301preview:LinkedStorageAccount").build()),
                Output.of(Alias.builder().setType("azure-native:operationalinsights/v20200801:LinkedStorageAccount").build())
            ))
            .build();
