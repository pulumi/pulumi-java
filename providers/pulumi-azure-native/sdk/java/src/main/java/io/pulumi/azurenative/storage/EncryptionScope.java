...
public class EncryptionScope extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(EncryptionScopeArgs.Builder a);
    }
    private static io.pulumi.azurenative.storage.EncryptionScopeArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.storage.EncryptionScopeArgs.builder();
     ...
     */
    public EncryptionScope(String name, BuilderApplicator argsBuilder) {
