...
public class TagRule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:logz/v20201001:TagRule").build()),
                Output.of(Alias.builder().setType("azure-native:logz/v20201001preview:TagRule").build()),
                Output.of(Alias.builder().setType("azure-native:logz/v20220101preview:TagRule").build())
            ))
            .build();
