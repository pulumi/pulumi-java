...
public class LogProfile extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(LogProfileArgs.Builder a);
    }
    private static io.pulumi.azurenative.insights.LogProfileArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.insights.LogProfileArgs.builder();
     ...
     */
    public LogProfile(String name, BuilderApplicator argsBuilder) {
    ...
    public LogProfile(String name, LogProfileArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:insights:LogProfile", name, args == null ? LogProfileArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private LogProfile(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:insights/v20160301:LogProfile").build())
            ))
            .build();
     ...
     */
    public static LogProfile get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
