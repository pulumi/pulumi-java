...
public class Appliance extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ApplianceArgs.Builder a);
    }
    private static io.pulumi.azurenative.resourceconnector.ApplianceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.resourceconnector.ApplianceArgs.builder();
     ...
     */
    public Appliance(String name, BuilderApplicator argsBuilder) {
    ...
    public Appliance(String name, ApplianceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:resourceconnector:Appliance", name, args == null ? ApplianceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:resourceconnector/v20211031preview:Appliance").build())
            ))
            .build();
