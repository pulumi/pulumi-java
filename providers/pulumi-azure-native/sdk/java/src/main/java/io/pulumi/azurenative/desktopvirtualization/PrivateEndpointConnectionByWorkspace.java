...
public class PrivateEndpointConnectionByWorkspace extends io.pulumi.resources.CustomResource {
    ...
    public PrivateEndpointConnectionByWorkspace(String name) {
        super("azure-native:desktopvirtualization:PrivateEndpointConnectionByWorkspace", name, PrivateEndpointConnectionByWorkspaceArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
