...
public class Solution extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.operationsmanagement.SolutionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.operationsmanagement.SolutionArgs.builder();
