...
import io.pulumi.azurenative.powerplatform.AccountArgs;
...
public class Account extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.powerplatform.AccountArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.powerplatform.AccountArgs.builder();
    ...
    public Account(String name, AccountArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:powerplatform:Account", name, args == null ? AccountArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:powerplatform/v20201030preview:Account").build())
            ))
            .build();
