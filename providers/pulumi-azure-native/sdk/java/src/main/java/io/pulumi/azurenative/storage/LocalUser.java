...
public class LocalUser extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(LocalUserArgs.Builder a);
    }
    private static io.pulumi.azurenative.storage.LocalUserArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.storage.LocalUserArgs.builder();
     ...
     */
    public LocalUser(String name, BuilderApplicator argsBuilder) {
