...
public class Route extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.network.RouteArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.network.RouteArgs.builder();
