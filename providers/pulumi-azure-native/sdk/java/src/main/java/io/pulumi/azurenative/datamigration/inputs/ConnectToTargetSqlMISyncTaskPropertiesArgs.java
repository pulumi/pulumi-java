...
public final class ConnectToTargetSqlMISyncTaskPropertiesArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<ConnectToTargetSqlMISyncTaskInputArgs> input;

    public Input<ConnectToTargetSqlMISyncTaskInputArgs> getInput() {
    ...
    public ConnectToTargetSqlMISyncTaskPropertiesArgs(
        @Nullable Input<ConnectToTargetSqlMISyncTaskInputArgs> input,
    ...
    public static final class Builder {
        private @Nullable Input<ConnectToTargetSqlMISyncTaskInputArgs> input;
        ...
        public Builder setInput(@Nullable Input<ConnectToTargetSqlMISyncTaskInputArgs> input) {
            this.input = input;
            return this;
        }

        public Builder setInput(@Nullable ConnectToTargetSqlMISyncTaskInputArgs input) {
