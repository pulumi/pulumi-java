...
public final class DeliveryRuleQueryStringConditionArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setParameters(Input<QueryStringMatchConditionParametersArgs> parameters) {
            this.parameters = Objects.requireNonNull(parameters);
            return this;
        }

        public Builder setParameters(QueryStringMatchConditionParametersArgs parameters) {
