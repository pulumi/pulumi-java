...
public class ComponentLinkedStorageAccount extends io.pulumi.resources.CustomResource {
    ...
    public ComponentLinkedStorageAccount(String name, ComponentLinkedStorageAccountArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:insights:ComponentLinkedStorageAccount", name, args == null ? ComponentLinkedStorageAccountArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ComponentLinkedStorageAccount(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:insights/v20200301preview:ComponentLinkedStorageAccount").build())
            ))
            .build();
     ...
     */
    public static ComponentLinkedStorageAccount get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
