...
public final class SnowflakeSinkArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setImportSettings(@Nullable Input<SnowflakeImportCopyCommandArgs> importSettings) {
            this.importSettings = importSettings;
            return this;
        }

        public Builder setImportSettings(@Nullable SnowflakeImportCopyCommandArgs importSettings) {
