...
public class HealthAlert extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(HealthAlertArgs.Builder a);
    }
    private static io.pulumi.azurenative.alertsmanagement.HealthAlertArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.alertsmanagement.HealthAlertArgs.builder();
     ...
     */
    public HealthAlert(String name, BuilderApplicator argsBuilder) {
