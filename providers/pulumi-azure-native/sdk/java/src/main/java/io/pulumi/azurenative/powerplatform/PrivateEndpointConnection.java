...
class MyStack : Stack
{
    public MyStack()
    {
        var privateEndpointConnection = new AzureNative.PowerPlatform.PrivateEndpointConnection("privateEndpointConnection", new AzureNative.PowerPlatform.PrivateEndpointConnectionArgs
        {
