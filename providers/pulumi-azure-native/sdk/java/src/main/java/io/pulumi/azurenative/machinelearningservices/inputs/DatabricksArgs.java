 ...
 * 
 */
public final class DatabricksArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setProperties(@Nullable Input<DatabricksPropertiesArgs> properties) {
            this.properties = properties;
            return this;
        }

        public Builder setProperties(@Nullable DatabricksPropertiesArgs properties) {
        ...
        public DatabricksArgs build() {
            return new DatabricksArgs(computeLocation, computeType, description, properties, resourceId);
        }
    }
}
