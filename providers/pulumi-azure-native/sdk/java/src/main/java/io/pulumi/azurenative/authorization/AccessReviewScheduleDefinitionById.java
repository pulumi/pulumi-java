...
public class AccessReviewScheduleDefinitionById extends io.pulumi.resources.CustomResource {
    ...
    public AccessReviewScheduleDefinitionById(String name) {
        super("azure-native:authorization:AccessReviewScheduleDefinitionById", name, AccessReviewScheduleDefinitionByIdArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
