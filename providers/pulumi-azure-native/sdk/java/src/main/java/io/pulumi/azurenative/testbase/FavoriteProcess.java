...
public class FavoriteProcess extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(FavoriteProcessArgs.Builder a);
    }
    private static io.pulumi.azurenative.testbase.FavoriteProcessArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.testbase.FavoriteProcessArgs.builder();
     ...
     */
    public FavoriteProcess(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:testbase/v20201216preview:FavoriteProcess").build())
            ))
            .build();
