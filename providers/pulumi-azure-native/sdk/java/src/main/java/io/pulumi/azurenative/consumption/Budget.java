...
public class Budget extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.consumption.BudgetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.consumption.BudgetArgs.builder();
    ...
    public Budget(String name, BudgetArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:consumption:Budget", name, args == null ? BudgetArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:consumption/v20190101:Budget").build()),
                Output.of(Alias.builder().setType("azure-native:consumption/v20190401preview:Budget").build()),
                Output.of(Alias.builder().setType("azure-native:consumption/v20190501:Budget").build()),
                Output.of(Alias.builder().setType("azure-native:consumption/v20190501preview:Budget").build()),
                Output.of(Alias.builder().setType("azure-native:consumption/v20190601:Budget").build()),
                Output.of(Alias.builder().setType("azure-native:consumption/v20191001:Budget").build()),
                Output.of(Alias.builder().setType("azure-native:consumption/v20191101:Budget").build()),
                Output.of(Alias.builder().setType("azure-native:consumption/v20210501:Budget").build()),
                Output.of(Alias.builder().setType("azure-native:consumption/v20211001:Budget").build())
            ))
            .build();
