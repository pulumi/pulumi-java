...
public class Token extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(TokenArgs.Builder a);
    }
    private static io.pulumi.azurenative.containerregistry.TokenArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.containerregistry.TokenArgs.builder();
     ...
     */
    public Token(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:containerregistry/v20190501preview:Token").build()),
                Output.of(Alias.builder().setType("azure-native:containerregistry/v20201101preview:Token").build()),
                Output.of(Alias.builder().setType("azure-native:containerregistry/v20210601preview:Token").build()),
                Output.of(Alias.builder().setType("azure-native:containerregistry/v20210801preview:Token").build()),
                Output.of(Alias.builder().setType("azure-native:containerregistry/v20211201preview:Token").build())
            ))
            .build();
