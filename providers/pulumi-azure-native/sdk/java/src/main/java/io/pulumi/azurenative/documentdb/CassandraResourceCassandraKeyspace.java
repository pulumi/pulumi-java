...
public class CassandraResourceCassandraKeyspace extends io.pulumi.resources.CustomResource {
    ...
    public CassandraResourceCassandraKeyspace(String name) {
        super("azure-native:documentdb:CassandraResourceCassandraKeyspace", name, CassandraResourceCassandraKeyspaceArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
