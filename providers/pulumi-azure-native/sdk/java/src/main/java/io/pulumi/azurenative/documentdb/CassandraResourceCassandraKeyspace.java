...
public class CassandraResourceCassandraKeyspace extends io.pulumi.resources.CustomResource {
    ...
    public Output</* @Nullable */ CassandraKeyspaceGetPropertiesResponseOptions> options() {
        return this.options;
    }
    ...
    public Output</* @Nullable */ CassandraKeyspaceGetPropertiesResponseResource> resource() {
