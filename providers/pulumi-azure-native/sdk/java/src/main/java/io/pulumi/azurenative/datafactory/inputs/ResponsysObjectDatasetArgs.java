 ...
 * 
 */
public final class ResponsysObjectDatasetArgs extends io.pulumi.resources.ResourceArgs {

    public static final ResponsysObjectDatasetArgs Empty = new ResponsysObjectDatasetArgs();
    ...
    private ResponsysObjectDatasetArgs() {
    ...
    public static Builder builder(ResponsysObjectDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ResponsysObjectDatasetArgs defaults) {
        ...
        public ResponsysObjectDatasetArgs build() {
            return new ResponsysObjectDatasetArgs(annotations, description, folder, linkedServiceName, parameters, schema, structure, tableName, type);
        }
    }
}
