...
public class Device extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.hybridnetwork.DeviceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.hybridnetwork.DeviceArgs.builder();
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:hybridnetwork/v20200101preview:Device").build()),
                Output.of(Alias.builder().setType("azure-native:hybridnetwork/v20210501:Device").build())
            ))
            .build();
