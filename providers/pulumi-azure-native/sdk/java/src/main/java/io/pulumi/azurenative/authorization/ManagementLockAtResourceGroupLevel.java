...
public class ManagementLockAtResourceGroupLevel extends io.pulumi.resources.CustomResource {
    ...
    public ManagementLockAtResourceGroupLevel(String name) {
        super("azure-native:authorization:ManagementLockAtResourceGroupLevel", name, ManagementLockAtResourceGroupLevelArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
