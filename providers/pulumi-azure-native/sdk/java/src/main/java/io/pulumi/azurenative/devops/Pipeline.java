...
public class Pipeline extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:devops/v20190701preview:Pipeline").build()),
                Output.of(Alias.builder().setType("azure-native:devops/v20200713preview:Pipeline").build())
            ))
            .build();
