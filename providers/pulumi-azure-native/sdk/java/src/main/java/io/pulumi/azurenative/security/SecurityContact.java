...
public class SecurityContact extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable SecurityContactArgs.Builder a);
    }
    private static io.pulumi.azurenative.security.SecurityContactArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.security.SecurityContactArgs.builder();
     ...
     */
    public SecurityContact(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:security/v20170801preview:SecurityContact").build()),
                Output.of(Alias.builder().setType("azure-native:security/v20200101preview:SecurityContact").build())
            ))
            .build();
