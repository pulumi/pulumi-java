...
public class Step extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.deploymentmanager.StepArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.deploymentmanager.StepArgs.builder();
