...
public class DiskAccessAPrivateEndpointConnection extends io.pulumi.resources.CustomResource {
    ...
    public DiskAccessAPrivateEndpointConnection(String name) {
        super("azure-native:compute:DiskAccessAPrivateEndpointConnection", name, DiskAccessAPrivateEndpointConnectionArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
