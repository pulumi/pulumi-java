...
public class GlobalReachConnection extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:avs/v20200717preview:GlobalReachConnection").build()),
                Output.of(Alias.builder().setType("azure-native:avs/v20210101preview:GlobalReachConnection").build()),
                Output.of(Alias.builder().setType("azure-native:avs/v20210601:GlobalReachConnection").build()),
                Output.of(Alias.builder().setType("azure-native:avs/v20211201:GlobalReachConnection").build())
            ))
            .build();
