...
public class OpenShiftManagedCluster extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(OpenShiftManagedClusterArgs.Builder a);
    }
    private static io.pulumi.azurenative.containerservice.OpenShiftManagedClusterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.containerservice.OpenShiftManagedClusterArgs.builder();
     ...
     */
    public OpenShiftManagedCluster(String name, BuilderApplicator argsBuilder) {
