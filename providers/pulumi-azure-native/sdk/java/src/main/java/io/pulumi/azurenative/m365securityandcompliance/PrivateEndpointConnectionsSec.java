...
public class PrivateEndpointConnectionsSec extends io.pulumi.resources.CustomResource {
    ...
    public PrivateEndpointConnectionsSec(String name) {
        super("azure-native:m365securityandcompliance:PrivateEndpointConnectionsSec", name, PrivateEndpointConnectionsSecArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
