...
class MyStack : Stack
{
    public MyStack()
    {
        var privateEndpointConnectionsSec = new AzureNative.M365SecurityAndCompliance.PrivateEndpointConnectionsSec("privateEndpointConnectionsSec", new AzureNative.M365SecurityAndCompliance.PrivateEndpointConnectionsSecArgs
        {
...
public class PrivateEndpointConnectionsSec extends io.pulumi.resources.CustomResource {
    ...
    public PrivateEndpointConnectionsSec(String name, PrivateEndpointConnectionsSecArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:m365securityandcompliance:PrivateEndpointConnectionsSec", name, args == null ? PrivateEndpointConnectionsSecArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsSec").build())
            ))
            .build();
