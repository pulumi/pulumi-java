...
public class Environment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.devtestlab.EnvironmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.devtestlab.EnvironmentArgs.builder();
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:devtestlab/v20160515:Environment").build()),
                Output.of(Alias.builder().setType("azure-native:devtestlab/v20180915:Environment").build())
            ))
            .build();
