...
public class MongoDBResourceMongoUserDefinition extends io.pulumi.resources.CustomResource {
    ...
    public MongoDBResourceMongoUserDefinition(String name) {
        super("azure-native:documentdb:MongoDBResourceMongoUserDefinition", name, MongoDBResourceMongoUserDefinitionArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
