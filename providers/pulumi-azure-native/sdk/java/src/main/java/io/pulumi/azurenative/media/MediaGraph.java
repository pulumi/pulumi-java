...
public class MediaGraph extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:media/v20190901preview:MediaGraph").build()),
                Output.of(Alias.builder().setType("azure-native:media/v20200201preview:MediaGraph").build())
            ))
            .build();
