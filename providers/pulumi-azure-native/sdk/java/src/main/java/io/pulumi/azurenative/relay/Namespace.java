...
public class Namespace extends io.pulumi.resources.CustomResource {
    ...
    public Namespace(String name) {
        super("azure-native:relay:Namespace", name, NamespaceArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public Namespace(String name, NamespaceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:relay:Namespace", name, args == null ? NamespaceArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:relay/v20160701:Namespace").build()),
                Input.of(Alias.builder().setType("azure-native:relay/v20170401:Namespace").build()),
                Input.of(Alias.builder().setType("azure-native:relay/v20180101preview:Namespace").build())
            ))
            .build();
