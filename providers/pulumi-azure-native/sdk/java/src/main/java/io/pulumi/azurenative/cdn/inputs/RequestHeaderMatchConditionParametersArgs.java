...
public final class RequestHeaderMatchConditionParametersArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final Input<Either<String,RequestHeaderOperator>> operator;

    public Input<Either<String,RequestHeaderOperator>> getOperator() {
    ...
    public RequestHeaderMatchConditionParametersArgs(
        ...
        Input<Either<String,RequestHeaderOperator>> operator,
    ...
    public static final class Builder {
        ...
        private Input<Either<String,RequestHeaderOperator>> operator;
        ...
        public Builder setOperator(Input<Either<String,RequestHeaderOperator>> operator) {
            this.operator = Objects.requireNonNull(operator);
            return this;
        }

        public Builder setOperator(Either<String,RequestHeaderOperator> operator) {
