...
public class PrivateEndpointConnection extends io.pulumi.resources.CustomResource {
    ...
    public PrivateEndpointConnection(String name, PrivateEndpointConnectionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:digitaltwins:PrivateEndpointConnection", name, args == null ? PrivateEndpointConnectionArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:digitaltwins/v20201201:PrivateEndpointConnection").build()),
                Output.of(Alias.builder().setType("azure-native:digitaltwins/v20210630preview:PrivateEndpointConnection").build())
            ))
            .build();
