...
public final class TeradataSourceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<TeradataPartitionSettingsArgs> partitionSettings;

    public Input<TeradataPartitionSettingsArgs> getPartitionSettings() {
    ...
    public TeradataSourceArgs(
        ...
        @Nullable Input<TeradataPartitionSettingsArgs> partitionSettings,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<TeradataPartitionSettingsArgs> partitionSettings;
        ...
        public Builder setPartitionSettings(@Nullable Input<TeradataPartitionSettingsArgs> partitionSettings) {
            this.partitionSettings = partitionSettings;
            return this;
        }

        public Builder setPartitionSettings(@Nullable TeradataPartitionSettingsArgs partitionSettings) {
