...
public class Function extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.streamanalytics.FunctionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.streamanalytics.FunctionArgs.builder();
