 ...
 * 
 */
public final class AmazonRedshiftTableDatasetArgs extends io.pulumi.resources.ResourceArgs {

    public static final AmazonRedshiftTableDatasetArgs Empty = new AmazonRedshiftTableDatasetArgs();
    ...
    public AmazonRedshiftTableDatasetArgs(
    ...
    private AmazonRedshiftTableDatasetArgs() {
    ...
    public static Builder builder(AmazonRedshiftTableDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AmazonRedshiftTableDatasetArgs defaults) {
        ...
        public Builder table(@Nullable Input<Object> table) {
            this.table = table;
            return this;
        }
        ...
        public AmazonRedshiftTableDatasetArgs build() {
            return new AmazonRedshiftTableDatasetArgs(annotations, description, folder, linkedServiceName, parameters, schema, structure, table, tableName, type);
        }
    }
}
