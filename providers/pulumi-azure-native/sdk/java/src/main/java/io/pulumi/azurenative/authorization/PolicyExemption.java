...
public class PolicyExemption extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PolicyExemptionArgs.Builder a);
    }
    private static io.pulumi.azurenative.authorization.PolicyExemptionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.authorization.PolicyExemptionArgs.builder();
     ...
     */
    public PolicyExemption(String name, BuilderApplicator argsBuilder) {
