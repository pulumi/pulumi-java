...
public class WCFRelay extends io.pulumi.resources.CustomResource {
    ...
    public WCFRelay(String name, WCFRelayArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:relay:WCFRelay", name, args == null ? WCFRelayArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:relay/v20160701:WCFRelay").build()),
                Output.of(Alias.builder().setType("azure-native:relay/v20170401:WCFRelay").build())
            ))
            .build();
