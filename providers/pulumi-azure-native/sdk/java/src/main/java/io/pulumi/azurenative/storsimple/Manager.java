...
public class Manager extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:storsimple/v20161001:Manager").build()),
                Output.of(Alias.builder().setType("azure-native:storsimple/v20170601:Manager").build())
            ))
            .build();
