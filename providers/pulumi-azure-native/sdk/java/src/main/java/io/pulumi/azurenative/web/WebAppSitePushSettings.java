...
public class WebAppSitePushSettings extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(WebAppSitePushSettingsArgs.Builder a);
    }
    private static io.pulumi.azurenative.web.WebAppSitePushSettingsArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.web.WebAppSitePushSettingsArgs.builder();
     ...
     */
    public WebAppSitePushSettings(String name, BuilderApplicator argsBuilder) {
