...
public class RegisteredPrefix extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RegisteredPrefixArgs.Builder a);
    }
    private static io.pulumi.azurenative.peering.RegisteredPrefixArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.peering.RegisteredPrefixArgs.builder();
     ...
     */
    public RegisteredPrefix(String name, BuilderApplicator argsBuilder) {
