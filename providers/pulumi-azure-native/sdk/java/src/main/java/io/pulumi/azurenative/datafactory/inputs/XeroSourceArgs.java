 ...
 * 
 */
public final class XeroSourceArgs extends io.pulumi.resources.ResourceArgs {

    public static final XeroSourceArgs Empty = new XeroSourceArgs();
    ...
    public static Builder builder(XeroSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(XeroSourceArgs defaults) {
        ...
        public XeroSourceArgs build() {
            return new XeroSourceArgs(additionalColumns, disableMetricsCollection, maxConcurrentConnections, query, queryTimeout, sourceRetryCount, sourceRetryWait, type);
        }
    }
}
