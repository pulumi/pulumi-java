...
@OutputCustomType
public final class AzureSqlMITableDatasetResponse {
    /**
    ...
    @OutputCustomType.Constructor({"annotations","description","folder","linkedServiceName","parameters","schema","structure","table","tableName","type"})
    private AzureSqlMITableDatasetResponse(
    ...
    public static Builder builder(AzureSqlMITableDatasetResponse defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AzureSqlMITableDatasetResponse defaults) {
