...
public class NatGateway extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.network.NatGatewayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.network.NatGatewayArgs.builder();
