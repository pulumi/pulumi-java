...
public class AutomationAccount extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(AutomationAccountArgs.Builder a);
    }
    private static io.pulumi.azurenative.automation.AutomationAccountArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.automation.AutomationAccountArgs.builder();
     ...
     */
    public AutomationAccount(String name, BuilderApplicator argsBuilder) {
    ...
    public AutomationAccount(String name, AutomationAccountArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:automation:AutomationAccount", name, args == null ? AutomationAccountArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private AutomationAccount(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:automation/v20151031:AutomationAccount").build()),
                Output.of(Alias.builder().setType("azure-native:automation/v20190601:AutomationAccount").build()),
                Output.of(Alias.builder().setType("azure-native:automation/v20200113preview:AutomationAccount").build()),
                Output.of(Alias.builder().setType("azure-native:automation/v20210622:AutomationAccount").build())
            ))
            .build();
     ...
     */
    public static AutomationAccount get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
