...
public final class ConnectToTargetSqlMITaskPropertiesArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setInput(@Nullable Input<ConnectToTargetSqlMITaskInputArgs> input) {
            this.input = input;
            return this;
        }

        public Builder setInput(@Nullable ConnectToTargetSqlMITaskInputArgs input) {
