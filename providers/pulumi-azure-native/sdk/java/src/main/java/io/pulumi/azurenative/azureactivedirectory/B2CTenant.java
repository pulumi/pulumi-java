...
public class B2CTenant extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(B2CTenantArgs.Builder a);
    }
    private static io.pulumi.azurenative.azureactivedirectory.B2CTenantArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.azureactivedirectory.B2CTenantArgs.builder();
     ...
     */
    public B2CTenant(String name, BuilderApplicator argsBuilder) {
