...
public class FusionAlertRule extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(FusionAlertRuleArgs.Builder a);
    }
    private static io.pulumi.azurenative.securityinsights.FusionAlertRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.securityinsights.FusionAlertRuleArgs.builder();
     ...
     */
    public FusionAlertRule(String name, BuilderApplicator argsBuilder) {
