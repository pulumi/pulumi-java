...
public class PrivateEndpointConnectionsComp extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.m365securityandcompliance.PrivateEndpointConnectionsCompArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.m365securityandcompliance.PrivateEndpointConnectionsCompArgs.builder();
    ...
    public PrivateEndpointConnectionsComp(String name, PrivateEndpointConnectionsCompArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:m365securityandcompliance:PrivateEndpointConnectionsComp", name, args == null ? PrivateEndpointConnectionsCompArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsComp").build())
            ))
            .build();
