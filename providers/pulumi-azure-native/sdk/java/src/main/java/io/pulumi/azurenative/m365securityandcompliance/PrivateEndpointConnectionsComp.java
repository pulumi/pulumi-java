...
public class PrivateEndpointConnectionsComp extends io.pulumi.resources.CustomResource {
    ...
    public PrivateEndpointConnectionsComp(String name, PrivateEndpointConnectionsCompArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:m365securityandcompliance:PrivateEndpointConnectionsComp", name, args == null ? PrivateEndpointConnectionsCompArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsComp").build())
            ))
            .build();
