...
public class PrivateLinkScopedResource extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.hybridcompute.PrivateLinkScopedResourceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.hybridcompute.PrivateLinkScopedResourceArgs.builder();
    ...
    public PrivateLinkScopedResource(String name, PrivateLinkScopedResourceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:hybridcompute:PrivateLinkScopedResource", name, args == null ? PrivateLinkScopedResourceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:hybridcompute/v20200815preview:PrivateLinkScopedResource").build())
            ))
            .build();
