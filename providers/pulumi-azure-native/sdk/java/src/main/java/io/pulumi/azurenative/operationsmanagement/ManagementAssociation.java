...
public class ManagementAssociation extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ManagementAssociationArgs.Builder a);
    }
    private static io.pulumi.azurenative.operationsmanagement.ManagementAssociationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.operationsmanagement.ManagementAssociationArgs.builder();
     ...
     */
    public ManagementAssociation(String name, BuilderApplicator argsBuilder) {
    ...
    public ManagementAssociation(String name, ManagementAssociationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:operationsmanagement:ManagementAssociation", name, args == null ? ManagementAssociationArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ManagementAssociation(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:operationsmanagement/v20151101preview:ManagementAssociation").build())
            ))
            .build();
     ...
     */
    public static ManagementAssociation get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
