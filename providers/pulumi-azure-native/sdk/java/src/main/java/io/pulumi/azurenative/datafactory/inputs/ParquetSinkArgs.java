...
public final class ParquetSinkArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setFormatSettings(@Nullable Input<ParquetWriteSettingsArgs> formatSettings) {
            this.formatSettings = formatSettings;
            return this;
        }

        public Builder setFormatSettings(@Nullable ParquetWriteSettingsArgs formatSettings) {
