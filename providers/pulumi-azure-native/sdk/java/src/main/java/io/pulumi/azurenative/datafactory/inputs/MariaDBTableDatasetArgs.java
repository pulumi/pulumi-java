 ...
 * 
 */
public final class MariaDBTableDatasetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public MariaDBTableDatasetArgs build() {
            return new MariaDBTableDatasetArgs(annotations, description, folder, linkedServiceName, parameters, schema, structure, tableName, type);
        }
    }
}
