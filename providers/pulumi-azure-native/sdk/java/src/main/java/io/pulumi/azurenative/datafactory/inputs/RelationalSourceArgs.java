...
public final class RelationalSourceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public RelationalSourceArgs build() {
            return new RelationalSourceArgs(additionalColumns, disableMetricsCollection, maxConcurrentConnections, query, sourceRetryCount, sourceRetryWait, type);
        }
    }
}
