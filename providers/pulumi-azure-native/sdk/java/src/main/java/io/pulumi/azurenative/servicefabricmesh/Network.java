...
public class Network extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(NetworkArgs.Builder a);
    }
    private static io.pulumi.azurenative.servicefabricmesh.NetworkArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.servicefabricmesh.NetworkArgs.builder();
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:servicefabricmesh/v20180701preview:Network").build()),
                Output.of(Alias.builder().setType("azure-native:servicefabricmesh/v20180901preview:Network").build())
            ))
            .build();
