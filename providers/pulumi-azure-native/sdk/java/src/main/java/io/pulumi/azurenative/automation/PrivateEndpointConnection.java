...
class MyStack : Stack
{
    public MyStack()
    {
        var privateEndpointConnection = new AzureNative.Automation.PrivateEndpointConnection("privateEndpointConnection", new AzureNative.Automation.PrivateEndpointConnectionArgs
        {
