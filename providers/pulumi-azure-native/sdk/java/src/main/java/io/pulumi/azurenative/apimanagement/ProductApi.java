...
public class ProductApi extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ProductApiArgs.Builder a);
    }
    private static io.pulumi.azurenative.apimanagement.ProductApiArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.apimanagement.ProductApiArgs.builder();
     ...
     */
    public ProductApi(String name, BuilderApplicator argsBuilder) {
