...
public class TestBaseAccount extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(TestBaseAccountArgs.Builder a);
    }
    private static io.pulumi.azurenative.testbase.TestBaseAccountArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.testbase.TestBaseAccountArgs.builder();
     ...
     */
    public TestBaseAccount(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:testbase/v20201216preview:TestBaseAccount").build())
            ))
            .build();
