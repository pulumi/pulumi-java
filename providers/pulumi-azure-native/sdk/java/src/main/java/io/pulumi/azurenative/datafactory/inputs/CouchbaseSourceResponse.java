 ...
 * 
 */
public final class CouchbaseSourceResponse extends io.pulumi.resources.InvokeArgs {

    public static final CouchbaseSourceResponse Empty = new CouchbaseSourceResponse();
    ...
    public CouchbaseSourceResponse(
