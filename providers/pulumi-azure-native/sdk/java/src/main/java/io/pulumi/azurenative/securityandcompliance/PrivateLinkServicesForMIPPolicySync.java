...
public class PrivateLinkServicesForMIPPolicySync extends io.pulumi.resources.CustomResource {
    ...
    public PrivateLinkServicesForMIPPolicySync(String name) {
        super("azure-native:securityandcompliance:privateLinkServicesForMIPPolicySync", name, PrivateLinkServicesForMIPPolicySyncArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
