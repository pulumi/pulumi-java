...
public class DataConnection extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.synapse.DataConnectionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.synapse.DataConnectionArgs.builder();
    ...
    public DataConnection(String name, DataConnectionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:synapse:DataConnection", name, args == null ? DataConnectionArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:synapse/v20210401preview:DataConnection").build()),
                Output.of(Alias.builder().setType("azure-native:synapse/v20210601preview:DataConnection").build())
            ))
            .build();
