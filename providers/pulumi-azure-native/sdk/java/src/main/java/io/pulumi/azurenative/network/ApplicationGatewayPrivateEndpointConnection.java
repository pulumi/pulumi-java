...
public class ApplicationGatewayPrivateEndpointConnection extends io.pulumi.resources.CustomResource {
    ...
    public ApplicationGatewayPrivateEndpointConnection(String name) {
        super("azure-native:network:ApplicationGatewayPrivateEndpointConnection", name, ApplicationGatewayPrivateEndpointConnectionArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
