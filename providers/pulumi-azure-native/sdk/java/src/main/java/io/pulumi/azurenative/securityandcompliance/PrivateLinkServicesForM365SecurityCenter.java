...
public class PrivateLinkServicesForM365SecurityCenter extends io.pulumi.resources.CustomResource {
    ...
    public PrivateLinkServicesForM365SecurityCenter(String name) {
        super("azure-native:securityandcompliance:privateLinkServicesForM365SecurityCenter", name, PrivateLinkServicesForM365SecurityCenterArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
