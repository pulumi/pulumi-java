...
public class Share extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.databoxedge.ShareArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.databoxedge.ShareArgs.builder();
    ...
    public Share(String name, ShareArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:databoxedge:Share", name, args == null ? ShareArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:databoxedge/v20190301:Share").build()),
                Output.of(Alias.builder().setType("azure-native:databoxedge/v20190701:Share").build()),
                Output.of(Alias.builder().setType("azure-native:databoxedge/v20190801:Share").build()),
                Output.of(Alias.builder().setType("azure-native:databoxedge/v20200501preview:Share").build()),
                Output.of(Alias.builder().setType("azure-native:databoxedge/v20200901:Share").build()),
                Output.of(Alias.builder().setType("azure-native:databoxedge/v20200901preview:Share").build()),
                Output.of(Alias.builder().setType("azure-native:databoxedge/v20201201:Share").build()),
                Output.of(Alias.builder().setType("azure-native:databoxedge/v20210201:Share").build()),
                Output.of(Alias.builder().setType("azure-native:databoxedge/v20210201preview:Share").build()),
                Output.of(Alias.builder().setType("azure-native:databoxedge/v20210601:Share").build()),
                Output.of(Alias.builder().setType("azure-native:databoxedge/v20210601preview:Share").build())
            ))
            .build();
