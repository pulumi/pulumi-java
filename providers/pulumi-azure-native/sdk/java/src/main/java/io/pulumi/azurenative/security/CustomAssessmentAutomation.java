...
public class CustomAssessmentAutomation extends io.pulumi.resources.CustomResource {
    ...
    public CustomAssessmentAutomation(String name, CustomAssessmentAutomationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:security:CustomAssessmentAutomation", name, args == null ? CustomAssessmentAutomationArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:security/v20210701preview:CustomAssessmentAutomation").build())
            ))
            .build();
