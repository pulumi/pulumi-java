...
public class IncidentRelation extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(IncidentRelationArgs.Builder a);
    }
    private static io.pulumi.azurenative.securityinsights.IncidentRelationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.securityinsights.IncidentRelationArgs.builder();
     ...
     */
    public IncidentRelation(String name, BuilderApplicator argsBuilder) {
