...
public class PublishedBlueprint extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PublishedBlueprintArgs.Builder a);
    }
    private static io.pulumi.azurenative.blueprint.PublishedBlueprintArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.blueprint.PublishedBlueprintArgs.builder();
     ...
     */
    public PublishedBlueprint(String name, BuilderApplicator argsBuilder) {
    ...
    public PublishedBlueprint(String name, PublishedBlueprintArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:blueprint:PublishedBlueprint", name, args == null ? PublishedBlueprintArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:blueprint/v20181101preview:PublishedBlueprint").build())
            ))
            .build();
