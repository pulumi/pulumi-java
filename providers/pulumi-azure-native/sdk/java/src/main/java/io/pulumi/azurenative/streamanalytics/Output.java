...
public class Output extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(OutputArgs.Builder a);
    }
    private static io.pulumi.azurenative.streamanalytics.OutputArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.streamanalytics.OutputArgs.builder();
     ...
     */
    public Output(String name, BuilderApplicator argsBuilder) {
