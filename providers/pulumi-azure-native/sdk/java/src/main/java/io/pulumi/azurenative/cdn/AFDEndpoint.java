...
public class AFDEndpoint extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(AFDEndpointArgs.Builder a);
    }
    private static io.pulumi.azurenative.cdn.AFDEndpointArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.cdn.AFDEndpointArgs.builder();
     ...
     */
    public AFDEndpoint(String name, BuilderApplicator argsBuilder) {
