...
import io.pulumi.azurenative.media.enums.H264Complexity;
import io.pulumi.azurenative.media.enums.StretchMode;
import io.pulumi.azurenative.media.enums.VideoSyncMode;
import io.pulumi.azurenative.media.inputs.H264LayerArgs;
...
public final class H264VideoArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Input<Either<String,H264Complexity>> getComplexity() {
    ...
    public Input<List<H264LayerArgs>> getLayers() {
    ...
    public H264VideoArgs(
        @Nullable Input<Either<String,H264Complexity>> complexity,
        @Nullable Input<String> keyFrameInterval,
        @Nullable Input<String> label,
        @Nullable Input<List<H264LayerArgs>> layers,
    ...
    public static final class Builder {
        private @Nullable Input<Either<String,H264Complexity>> complexity;
        private @Nullable Input<String> keyFrameInterval;
        private @Nullable Input<String> label;
        private @Nullable Input<List<H264LayerArgs>> layers;
        ...
        public Builder setComplexity(@Nullable Input<Either<String,H264Complexity>> complexity) {
            this.complexity = complexity;
            return this;
        }

        public Builder setComplexity(@Nullable Either<String,H264Complexity> complexity) {
        ...
        public Builder setLayers(@Nullable Input<List<H264LayerArgs>> layers) {
            this.layers = layers;
            return this;
        }

        public Builder setLayers(@Nullable List<H264LayerArgs> layers) {
