...
public class FirewallRule extends io.pulumi.resources.CustomResource {
    ...
    public FirewallRule(String name, FirewallRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:dbformariadb:FirewallRule", name, args == null ? FirewallRuleArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:dbformariadb/v20180601:FirewallRule").build()),
                Input.of(Alias.builder().setType("azure-native:dbformariadb/v20180601preview:FirewallRule").build())
            ))
            .build();
