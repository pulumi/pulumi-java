...
import io.pulumi.azurenative.dbformariadb.FirewallRuleArgs;
...
public class FirewallRule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.dbformariadb.FirewallRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.dbformariadb.FirewallRuleArgs.builder();
    ...
    public FirewallRule(String name, FirewallRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:dbformariadb:FirewallRule", name, args == null ? FirewallRuleArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:dbformariadb/v20180601:FirewallRule").build()),
                Output.of(Alias.builder().setType("azure-native:dbformariadb/v20180601preview:FirewallRule").build())
            ))
            .build();
