...
public class ManagedHsm extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ManagedHsmArgs.Builder a);
    }
    private static io.pulumi.azurenative.keyvault.ManagedHsmArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.keyvault.ManagedHsmArgs.builder();
     ...
     */
    public ManagedHsm(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:keyvault/v20200401preview:ManagedHsm").build()),
                Output.of(Alias.builder().setType("azure-native:keyvault/v20210401preview:ManagedHsm").build()),
                Output.of(Alias.builder().setType("azure-native:keyvault/v20210601preview:ManagedHsm").build()),
                Output.of(Alias.builder().setType("azure-native:keyvault/v20211001:ManagedHsm").build()),
                Output.of(Alias.builder().setType("azure-native:keyvault/v20211101preview:ManagedHsm").build())
            ))
            .build();
