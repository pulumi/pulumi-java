...
public class CapacityReservation extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.compute.CapacityReservationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.compute.CapacityReservationArgs.builder();
    ...
    public CapacityReservation(String name, CapacityReservationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:compute:CapacityReservation", name, args == null ? CapacityReservationArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private CapacityReservation(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:compute/v20210401:CapacityReservation").build()),
                Output.of(Alias.builder().setType("azure-native:compute/v20210701:CapacityReservation").build()),
                Output.of(Alias.builder().setType("azure-native:compute/v20211101:CapacityReservation").build())
            ))
            .build();
     ...
     */
    public static CapacityReservation get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
