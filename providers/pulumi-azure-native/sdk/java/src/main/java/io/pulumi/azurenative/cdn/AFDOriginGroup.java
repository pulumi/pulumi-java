...
public class AFDOriginGroup extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(AFDOriginGroupArgs.Builder a);
    }
    private static io.pulumi.azurenative.cdn.AFDOriginGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.cdn.AFDOriginGroupArgs.builder();
     ...
     */
    public AFDOriginGroup(String name, BuilderApplicator argsBuilder) {
