 ...
 * 
 */
public final class HBaseSourceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(HBaseSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(HBaseSourceArgs defaults) {
        ...
        public HBaseSourceArgs build() {
            return new HBaseSourceArgs(additionalColumns, disableMetricsCollection, maxConcurrentConnections, query, queryTimeout, sourceRetryCount, sourceRetryWait, type);
        }
    }
}
