 ...
 * 
 */
public final class PaypalObjectDatasetArgs extends io.pulumi.resources.ResourceArgs {

    public static final PaypalObjectDatasetArgs Empty = new PaypalObjectDatasetArgs();
    ...
    private PaypalObjectDatasetArgs() {
    ...
    public static Builder builder(PaypalObjectDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PaypalObjectDatasetArgs defaults) {
        ...
        public PaypalObjectDatasetArgs build() {
            return new PaypalObjectDatasetArgs(annotations, description, folder, linkedServiceName, parameters, schema, structure, tableName, type);
        }
    }
}
