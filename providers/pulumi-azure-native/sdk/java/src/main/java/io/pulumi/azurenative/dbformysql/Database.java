...
public class Database extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.dbformysql.DatabaseArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.dbformysql.DatabaseArgs.builder();
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:dbformysql/v20171201:Database").build()),
                Output.of(Alias.builder().setType("azure-native:dbformysql/v20171201preview:Database").build())
            ))
            .build();
