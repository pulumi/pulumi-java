...
public class DataFlow extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(DataFlowArgs.Builder a);
    }
    private static io.pulumi.azurenative.datafactory.DataFlowArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.datafactory.DataFlowArgs.builder();
     ...
     */
    public DataFlow(String name, BuilderApplicator argsBuilder) {
