...
public class PrivateLinkServicesForO365ManagementActivityAPI extends io.pulumi.resources.CustomResource {
    ...
    public PrivateLinkServicesForO365ManagementActivityAPI(String name, PrivateLinkServicesForO365ManagementActivityAPIArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:securityandcompliance:privateLinkServicesForO365ManagementActivityAPI", name, args == null ? PrivateLinkServicesForO365ManagementActivityAPIArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:securityandcompliance/v20210111:privateLinkServicesForO365ManagementActivityAPI").build()),
                Input.of(Alias.builder().setType("azure-native:securityandcompliance/v20210308:privateLinkServicesForO365ManagementActivityAPI").build())
            ))
            .build();
