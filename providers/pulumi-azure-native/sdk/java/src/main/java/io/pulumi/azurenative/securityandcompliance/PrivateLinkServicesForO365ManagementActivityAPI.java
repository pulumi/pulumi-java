...
public class PrivateLinkServicesForO365ManagementActivityAPI extends io.pulumi.resources.CustomResource {
    ...
    public PrivateLinkServicesForO365ManagementActivityAPI(String name) {
        super("azure-native:securityandcompliance:privateLinkServicesForO365ManagementActivityAPI", name, PrivateLinkServicesForO365ManagementActivityAPIArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
