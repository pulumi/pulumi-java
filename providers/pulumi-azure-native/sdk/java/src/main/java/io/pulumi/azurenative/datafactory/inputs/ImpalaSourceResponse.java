 ...
 * 
 */
public final class ImpalaSourceResponse extends io.pulumi.resources.InvokeArgs {

    public static final ImpalaSourceResponse Empty = new ImpalaSourceResponse();
