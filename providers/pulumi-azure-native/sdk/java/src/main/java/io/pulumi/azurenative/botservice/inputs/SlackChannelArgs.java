...
public final class SlackChannelArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="properties")
      private final @Nullable Output<SlackChannelPropertiesArgs> properties;

    public Output<SlackChannelPropertiesArgs> getProperties() {
    ...
    public SlackChannelArgs(
        ...
        @Nullable Output<SlackChannelPropertiesArgs> properties) {
    ...
    public static final class Builder {
        ...
        public Builder properties(@Nullable SlackChannelPropertiesArgs properties) {
