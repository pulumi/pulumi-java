...
public final class WebAppHybridConnectionArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public WebAppHybridConnectionArgs build() {
            return new WebAppHybridConnectionArgs(hostname, kind, name, namespaceName, port, relayArmUri, relayName, resourceGroupName, sendKeyName, sendKeyValue, serviceBusNamespace, serviceBusSuffix);
        }
    }
}
