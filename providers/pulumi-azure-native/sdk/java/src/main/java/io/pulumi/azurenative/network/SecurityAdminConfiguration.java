...
public class SecurityAdminConfiguration extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:network/v20210201preview:SecurityAdminConfiguration").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20210501preview:SecurityAdminConfiguration").build())
            ))
            .build();
     ...
     */
    public static SecurityAdminConfiguration get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
