...
public class EventHubDataConnection extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(EventHubDataConnectionArgs.Builder a);
    }
    private static io.pulumi.azurenative.kusto.EventHubDataConnectionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.kusto.EventHubDataConnectionArgs.builder();
     ...
     */
    public EventHubDataConnection(String name, BuilderApplicator argsBuilder) {
    ...
    public EventHubDataConnection(String name, EventHubDataConnectionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:kusto:EventHubDataConnection", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:kusto/v20190121:EventHubDataConnection").build()),
                Output.of(Alias.builder().setType("azure-native:kusto/v20190515:EventHubDataConnection").build()),
                Output.of(Alias.builder().setType("azure-native:kusto/v20190907:EventHubDataConnection").build()),
                Output.of(Alias.builder().setType("azure-native:kusto/v20191109:EventHubDataConnection").build()),
                Output.of(Alias.builder().setType("azure-native:kusto/v20200215:EventHubDataConnection").build()),
                Output.of(Alias.builder().setType("azure-native:kusto/v20200614:EventHubDataConnection").build()),
                Output.of(Alias.builder().setType("azure-native:kusto/v20200918:EventHubDataConnection").build()),
                Output.of(Alias.builder().setType("azure-native:kusto/v20210101:EventHubDataConnection").build()),
                Output.of(Alias.builder().setType("azure-native:kusto/v20210827:EventHubDataConnection").build())
            ))
            .build();
