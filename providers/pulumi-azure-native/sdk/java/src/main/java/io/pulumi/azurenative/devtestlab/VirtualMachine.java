...
public class VirtualMachine extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.devtestlab.VirtualMachineArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.devtestlab.VirtualMachineArgs.builder();
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:devtestlab/v20150521preview:VirtualMachine").build()),
                Output.of(Alias.builder().setType("azure-native:devtestlab/v20160515:VirtualMachine").build()),
                Output.of(Alias.builder().setType("azure-native:devtestlab/v20180915:VirtualMachine").build())
            ))
            .build();
