...
public class PrivateLinkServicesForSCCPowershell extends io.pulumi.resources.CustomResource {
    ...
    public PrivateLinkServicesForSCCPowershell(String name, PrivateLinkServicesForSCCPowershellArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:securityandcompliance:privateLinkServicesForSCCPowershell", name, args == null ? PrivateLinkServicesForSCCPowershellArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
