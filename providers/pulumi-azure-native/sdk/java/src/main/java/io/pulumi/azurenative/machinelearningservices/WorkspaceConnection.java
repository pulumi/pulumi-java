...
public class WorkspaceConnection extends io.pulumi.resources.CustomResource {
    ...
    private WorkspaceConnection(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static WorkspaceConnection get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
