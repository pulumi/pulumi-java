...
public class GalleryImage extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(GalleryImageArgs.Builder a);
    }
    private static io.pulumi.azurenative.labservices.GalleryImageArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.labservices.GalleryImageArgs.builder();
     ...
     */
    public GalleryImage(String name, BuilderApplicator argsBuilder) {
    ...
    public GalleryImage(String name, GalleryImageArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:labservices:GalleryImage", name, args == null ? GalleryImageArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:labservices/v20181015:GalleryImage").build())
            ))
            .build();
