...
public class HybridConnectionAuthorizationRule extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(HybridConnectionAuthorizationRuleArgs.Builder a);
    }
    private static io.pulumi.azurenative.relay.HybridConnectionAuthorizationRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.relay.HybridConnectionAuthorizationRuleArgs.builder();
     ...
     */
    public HybridConnectionAuthorizationRule(String name, BuilderApplicator argsBuilder) {
