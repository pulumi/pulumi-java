...
import io.pulumi.azurenative.datafactory.enums.AzureSearchIndexWriteBehaviorType;
...
public final class AzureSearchIndexSinkArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Input<Either<String,AzureSearchIndexWriteBehaviorType>> getWriteBehavior() {
    ...
    public AzureSearchIndexSinkArgs(
        ...
        @Nullable Input<Either<String,AzureSearchIndexWriteBehaviorType>> writeBehavior) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<Either<String,AzureSearchIndexWriteBehaviorType>> writeBehavior;
        ...
        public Builder setWriteBehavior(@Nullable Input<Either<String,AzureSearchIndexWriteBehaviorType>> writeBehavior) {
            this.writeBehavior = writeBehavior;
            return this;
        }

        public Builder setWriteBehavior(@Nullable Either<String,AzureSearchIndexWriteBehaviorType> writeBehavior) {
