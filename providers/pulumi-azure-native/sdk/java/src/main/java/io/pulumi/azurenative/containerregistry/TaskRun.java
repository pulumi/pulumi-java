...
public class TaskRun extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(TaskRunArgs.Builder a);
    }
    private static io.pulumi.azurenative.containerregistry.TaskRunArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.containerregistry.TaskRunArgs.builder();
     ...
     */
    public TaskRun(String name, BuilderApplicator argsBuilder) {
