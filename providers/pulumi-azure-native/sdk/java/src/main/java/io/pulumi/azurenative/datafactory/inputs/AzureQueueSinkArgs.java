...
public final class AzureQueueSinkArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(AzureQueueSinkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AzureQueueSinkArgs defaults) {
        ...
        public AzureQueueSinkArgs build() {
            return new AzureQueueSinkArgs(disableMetricsCollection, maxConcurrentConnections, sinkRetryCount, sinkRetryWait, type, writeBatchSize, writeBatchTimeout);
        }
    }
}
