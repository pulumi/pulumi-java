...
public class VirtualNetworkLink extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:network/v20180901:VirtualNetworkLink").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200101:VirtualNetworkLink").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200601:VirtualNetworkLink").build())
            ))
            .build();
