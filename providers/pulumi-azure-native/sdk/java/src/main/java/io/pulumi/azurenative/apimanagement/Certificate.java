...
public class Certificate extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.apimanagement.CertificateArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.apimanagement.CertificateArgs.builder();
