...
public class StaticSiteUserProvidedFunctionAppForStaticSiteBuild extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:web/v20201201:StaticSiteUserProvidedFunctionAppForStaticSiteBuild").build()),
                Output.of(Alias.builder().setType("azure-native:web/v20210101:StaticSiteUserProvidedFunctionAppForStaticSiteBuild").build()),
                Output.of(Alias.builder().setType("azure-native:web/v20210115:StaticSiteUserProvidedFunctionAppForStaticSiteBuild").build()),
                Output.of(Alias.builder().setType("azure-native:web/v20210201:StaticSiteUserProvidedFunctionAppForStaticSiteBuild").build()),
                Output.of(Alias.builder().setType("azure-native:web/v20210301:StaticSiteUserProvidedFunctionAppForStaticSiteBuild").build())
            ))
            .build();
