...
public class StaticSiteUserProvidedFunctionAppForStaticSiteBuild extends io.pulumi.resources.CustomResource {
    ...
    public StaticSiteUserProvidedFunctionAppForStaticSiteBuild(String name) {
        super("azure-native:web:StaticSiteUserProvidedFunctionAppForStaticSiteBuild", name, StaticSiteUserProvidedFunctionAppForStaticSiteBuildArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
