...
public class AlertRule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.insights.AlertRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.insights.AlertRuleArgs.builder();
