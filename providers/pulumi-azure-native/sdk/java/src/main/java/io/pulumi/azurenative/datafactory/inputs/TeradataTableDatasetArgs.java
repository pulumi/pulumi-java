 ...
 * 
 */
public final class TeradataTableDatasetArgs extends io.pulumi.resources.ResourceArgs {

    public static final TeradataTableDatasetArgs Empty = new TeradataTableDatasetArgs();
    ...
    private TeradataTableDatasetArgs() {
    ...
    public static Builder builder(TeradataTableDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(TeradataTableDatasetArgs defaults) {
        ...
        public Builder type(String type) {
            ...
            return this;
        }        public TeradataTableDatasetArgs build() {
            return new TeradataTableDatasetArgs(annotations, database, description, folder, linkedServiceName, parameters, schema, structure, table, type);
        }
    }
}
