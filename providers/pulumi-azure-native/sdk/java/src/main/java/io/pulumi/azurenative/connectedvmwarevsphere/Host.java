...
public class Host extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.connectedvmwarevsphere.HostArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.connectedvmwarevsphere.HostArgs.builder();
