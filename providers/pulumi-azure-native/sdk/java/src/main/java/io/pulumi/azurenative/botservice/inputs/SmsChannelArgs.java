...
public final class SmsChannelArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="properties")
      private final @Nullable Input<SmsChannelPropertiesArgs> properties;

    public Input<SmsChannelPropertiesArgs> getProperties() {
    ...
    public SmsChannelArgs(
        ...
        @Nullable Input<SmsChannelPropertiesArgs> properties) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<SmsChannelPropertiesArgs> properties;
        ...
        public Builder setProperties(@Nullable Input<SmsChannelPropertiesArgs> properties) {
            this.properties = properties;
            return this;
        }

        public Builder setProperties(@Nullable SmsChannelPropertiesArgs properties) {
