...
public class ExpressRouteGateway extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:network/v20180801:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20181001:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20181101:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20181201:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20190201:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20190401:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20190601:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20190701:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20190801:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20190901:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20191101:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20191201:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200301:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200401:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200501:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200601:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200701:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200801:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20201101:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20210201:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20210301:ExpressRouteGateway").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20210501:ExpressRouteGateway").build())
            ))
            .build();
