...
public class ObjectAnchorsAccount extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ObjectAnchorsAccountArgs.Builder a);
    }
    private static io.pulumi.azurenative.mixedreality.ObjectAnchorsAccountArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.mixedreality.ObjectAnchorsAccountArgs.builder();
     ...
     */
    public ObjectAnchorsAccount(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:mixedreality/v20210301preview:ObjectAnchorsAccount").build())
            ))
            .build();
