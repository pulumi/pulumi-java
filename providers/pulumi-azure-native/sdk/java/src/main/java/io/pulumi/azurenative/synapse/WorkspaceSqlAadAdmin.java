...
public class WorkspaceSqlAadAdmin extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(WorkspaceSqlAadAdminArgs.Builder a);
    }
    private static io.pulumi.azurenative.synapse.WorkspaceSqlAadAdminArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.synapse.WorkspaceSqlAadAdminArgs.builder();
     ...
     */
    public WorkspaceSqlAadAdmin(String name, BuilderApplicator argsBuilder) {
