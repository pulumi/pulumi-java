...
public class Deployment extends io.pulumi.resources.CustomResource {
    ...
    public Deployment(String name, DeploymentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:appplatform:Deployment", name, args == null ? DeploymentArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:appplatform/v20190501preview:Deployment").build()),
                Output.of(Alias.builder().setType("azure-native:appplatform/v20200701:Deployment").build()),
                Output.of(Alias.builder().setType("azure-native:appplatform/v20201101preview:Deployment").build()),
                Output.of(Alias.builder().setType("azure-native:appplatform/v20210601preview:Deployment").build()),
                Output.of(Alias.builder().setType("azure-native:appplatform/v20210901preview:Deployment").build()),
                Output.of(Alias.builder().setType("azure-native:appplatform/v20220101preview:Deployment").build())
            ))
            .build();
