...
public class PartnerNamespace extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PartnerNamespaceArgs.Builder a);
    }
    private static io.pulumi.azurenative.eventgrid.PartnerNamespaceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.eventgrid.PartnerNamespaceArgs.builder();
     ...
     */
    public PartnerNamespace(String name, BuilderApplicator argsBuilder) {
    ...
    public PartnerNamespace(String name, PartnerNamespaceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:eventgrid:PartnerNamespace", name, args == null ? PartnerNamespaceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private PartnerNamespace(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:eventgrid/v20200401preview:PartnerNamespace").build()),
                Output.of(Alias.builder().setType("azure-native:eventgrid/v20201015preview:PartnerNamespace").build()),
                Output.of(Alias.builder().setType("azure-native:eventgrid/v20210601preview:PartnerNamespace").build())
            ))
            .build();
     ...
     */
    public static PartnerNamespace get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
