...
public final class SiteConfigResponse {
    ...
    private SiteConfigResponse(
        @OutputCustomType.Parameter("acrUseManagedIdentityCreds") @Nullable Boolean acrUseManagedIdentityCreds,
        @OutputCustomType.Parameter("acrUserManagedIdentityID") @Nullable String acrUserManagedIdentityID,
        @OutputCustomType.Parameter("alwaysOn") @Nullable Boolean alwaysOn,
        @OutputCustomType.Parameter("apiDefinition") @Nullable ApiDefinitionInfoResponse apiDefinition,
        @OutputCustomType.Parameter("apiManagementConfig") @Nullable ApiManagementConfigResponse apiManagementConfig,
        @OutputCustomType.Parameter("appCommandLine") @Nullable String appCommandLine,
        @OutputCustomType.Parameter("appSettings") @Nullable List<NameValuePairResponse> appSettings,
        @OutputCustomType.Parameter("autoHealEnabled") @Nullable Boolean autoHealEnabled,
        @OutputCustomType.Parameter("autoHealRules") @Nullable AutoHealRulesResponse autoHealRules,
        @OutputCustomType.Parameter("autoSwapSlotName") @Nullable String autoSwapSlotName,
        @OutputCustomType.Parameter("azureStorageAccounts") @Nullable Map<String,AzureStorageInfoValueResponse> azureStorageAccounts,
        @OutputCustomType.Parameter("connectionStrings") @Nullable List<ConnStringInfoResponse> connectionStrings,
        @OutputCustomType.Parameter("cors") @Nullable CorsSettingsResponse cors,
        @OutputCustomType.Parameter("defaultDocuments") @Nullable List<String> defaultDocuments,
        @OutputCustomType.Parameter("detailedErrorLoggingEnabled") @Nullable Boolean detailedErrorLoggingEnabled,
        @OutputCustomType.Parameter("documentRoot") @Nullable String documentRoot,
        @OutputCustomType.Parameter("experiments") @Nullable ExperimentsResponse experiments,
        @OutputCustomType.Parameter("ftpsState") @Nullable String ftpsState,
        @OutputCustomType.Parameter("functionAppScaleLimit") @Nullable Integer functionAppScaleLimit,
        @OutputCustomType.Parameter("functionsRuntimeScaleMonitoringEnabled") @Nullable Boolean functionsRuntimeScaleMonitoringEnabled,
        @OutputCustomType.Parameter("handlerMappings") @Nullable List<HandlerMappingResponse> handlerMappings,
        @OutputCustomType.Parameter("healthCheckPath") @Nullable String healthCheckPath,
        @OutputCustomType.Parameter("http20Enabled") @Nullable Boolean http20Enabled,
        @OutputCustomType.Parameter("httpLoggingEnabled") @Nullable Boolean httpLoggingEnabled,
        @OutputCustomType.Parameter("ipSecurityRestrictions") @Nullable List<IpSecurityRestrictionResponse> ipSecurityRestrictions,
        @OutputCustomType.Parameter("javaContainer") @Nullable String javaContainer,
        @OutputCustomType.Parameter("javaContainerVersion") @Nullable String javaContainerVersion,
        @OutputCustomType.Parameter("javaVersion") @Nullable String javaVersion,
        @OutputCustomType.Parameter("keyVaultReferenceIdentity") @Nullable String keyVaultReferenceIdentity,
        @OutputCustomType.Parameter("limits") @Nullable SiteLimitsResponse limits,
        @OutputCustomType.Parameter("linuxFxVersion") @Nullable String linuxFxVersion,
        @OutputCustomType.Parameter("loadBalancing") @Nullable String loadBalancing,
        @OutputCustomType.Parameter("localMySqlEnabled") @Nullable Boolean localMySqlEnabled,
        @OutputCustomType.Parameter("logsDirectorySizeLimit") @Nullable Integer logsDirectorySizeLimit,
        @OutputCustomType.Parameter("machineKey") SiteMachineKeyResponse machineKey,
        @OutputCustomType.Parameter("managedPipelineMode") @Nullable String managedPipelineMode,
        @OutputCustomType.Parameter("managedServiceIdentityId") @Nullable Integer managedServiceIdentityId,
        @OutputCustomType.Parameter("minTlsVersion") @Nullable String minTlsVersion,
        @OutputCustomType.Parameter("minimumElasticInstanceCount") @Nullable Integer minimumElasticInstanceCount,
        @OutputCustomType.Parameter("netFrameworkVersion") @Nullable String netFrameworkVersion,
        @OutputCustomType.Parameter("nodeVersion") @Nullable String nodeVersion,
        @OutputCustomType.Parameter("numberOfWorkers") @Nullable Integer numberOfWorkers,
        @OutputCustomType.Parameter("phpVersion") @Nullable String phpVersion,
        @OutputCustomType.Parameter("powerShellVersion") @Nullable String powerShellVersion,
        @OutputCustomType.Parameter("preWarmedInstanceCount") @Nullable Integer preWarmedInstanceCount,
        @OutputCustomType.Parameter("publicNetworkAccess") @Nullable String publicNetworkAccess,
        @OutputCustomType.Parameter("publishingUsername") @Nullable String publishingUsername,
        @OutputCustomType.Parameter("push") @Nullable PushSettingsResponse push,
        @OutputCustomType.Parameter("pythonVersion") @Nullable String pythonVersion,
        @OutputCustomType.Parameter("remoteDebuggingEnabled") @Nullable Boolean remoteDebuggingEnabled,
        @OutputCustomType.Parameter("remoteDebuggingVersion") @Nullable String remoteDebuggingVersion,
        @OutputCustomType.Parameter("requestTracingEnabled") @Nullable Boolean requestTracingEnabled,
        @OutputCustomType.Parameter("requestTracingExpirationTime") @Nullable String requestTracingExpirationTime,
        @OutputCustomType.Parameter("scmIpSecurityRestrictions") @Nullable List<IpSecurityRestrictionResponse> scmIpSecurityRestrictions,
        @OutputCustomType.Parameter("scmIpSecurityRestrictionsUseMain") @Nullable Boolean scmIpSecurityRestrictionsUseMain,
        @OutputCustomType.Parameter("scmMinTlsVersion") @Nullable String scmMinTlsVersion,
        @OutputCustomType.Parameter("scmType") @Nullable String scmType,
        @OutputCustomType.Parameter("tracingOptions") @Nullable String tracingOptions,
        @OutputCustomType.Parameter("use32BitWorkerProcess") @Nullable Boolean use32BitWorkerProcess,
        @OutputCustomType.Parameter("virtualApplications") @Nullable List<VirtualApplicationResponse> virtualApplications,
        @OutputCustomType.Parameter("vnetName") @Nullable String vnetName,
        @OutputCustomType.Parameter("vnetPrivatePortsCount") @Nullable Integer vnetPrivatePortsCount,
        @OutputCustomType.Parameter("vnetRouteAllEnabled") @Nullable Boolean vnetRouteAllEnabled,
        @OutputCustomType.Parameter("webSocketsEnabled") @Nullable Boolean webSocketsEnabled,
        @OutputCustomType.Parameter("websiteTimeZone") @Nullable String websiteTimeZone,
        @OutputCustomType.Parameter("windowsFxVersion") @Nullable String windowsFxVersion,
        @OutputCustomType.Parameter("xManagedServiceIdentityId") @Nullable Integer xManagedServiceIdentityId) {
