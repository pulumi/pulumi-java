...
public class ServiceUnit extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ServiceUnitArgs.Builder a);
    }
    private static io.pulumi.azurenative.deploymentmanager.ServiceUnitArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.deploymentmanager.ServiceUnitArgs.builder();
     ...
     */
    public ServiceUnit(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:deploymentmanager/v20180901preview:ServiceUnit").build()),
                Output.of(Alias.builder().setType("azure-native:deploymentmanager/v20191101preview:ServiceUnit").build())
            ))
            .build();
     ...
     */
    public static ServiceUnit get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
