...
public class Cluster extends io.pulumi.resources.CustomResource {
    ...
    public Cluster(String name, ClusterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:operationalinsights:Cluster", name, args == null ? ClusterArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:operationalinsights/v20190801preview:Cluster").build()),
                Output.of(Alias.builder().setType("azure-native:operationalinsights/v20200301preview:Cluster").build()),
                Output.of(Alias.builder().setType("azure-native:operationalinsights/v20200801:Cluster").build()),
                Output.of(Alias.builder().setType("azure-native:operationalinsights/v20201001:Cluster").build()),
                Output.of(Alias.builder().setType("azure-native:operationalinsights/v20210601:Cluster").build())
            ))
            .build();
