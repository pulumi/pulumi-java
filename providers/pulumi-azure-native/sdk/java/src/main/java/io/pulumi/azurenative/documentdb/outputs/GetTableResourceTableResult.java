...
public final class GetTableResourceTableResult {
    ...
    private GetTableResourceTableResult(
        ...
        @CustomType.Parameter("options") @Nullable TableGetPropertiesResponseOptions options,
        @CustomType.Parameter("resource") @Nullable TableGetPropertiesResponseResource resource,
    ...
    */
    ...
    public Optional<TableGetPropertiesResponseOptions> options() {
        return Optional.ofNullable(this.options);
    }
    public Optional<TableGetPropertiesResponseResource> resource() {
    ...
    */
    ...
    public static final class Builder {
        ...
        public Builder options(@Nullable TableGetPropertiesResponseOptions options) {
            this.options = options;
            return this;
        }
        public Builder resource(@Nullable TableGetPropertiesResponseResource resource) {
            this.resource = resource;
            return this;
        }
