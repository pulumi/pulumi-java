...
class MyStack : Stack
{
    public MyStack()
    {
        var remediationAtResourceGroup = new AzureNative.PolicyInsights.RemediationAtResourceGroup("remediationAtResourceGroup", new AzureNative.PolicyInsights.RemediationAtResourceGroupArgs
        {
