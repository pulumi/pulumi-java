...
public class RemediationAtResourceGroup extends io.pulumi.resources.CustomResource {
    ...
    public RemediationAtResourceGroup(String name, RemediationAtResourceGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:policyinsights:RemediationAtResourceGroup", name, args == null ? RemediationAtResourceGroupArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private RemediationAtResourceGroup(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:policyinsights/v20180701preview:RemediationAtResourceGroup").build()),
                Input.of(Alias.builder().setType("azure-native:policyinsights/v20190701:RemediationAtResourceGroup").build()),
                Input.of(Alias.builder().setType("azure-native:policyinsights/v20211001:RemediationAtResourceGroup").build())
            ))
            .build();
     ...
     */
    public static RemediationAtResourceGroup get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
