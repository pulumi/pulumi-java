...
import io.pulumi.azurenative.policyinsights.RemediationAtResourceGroupArgs;
...
public class RemediationAtResourceGroup extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(RemediationAtResourceGroupArgs.Builder a);
    }
    private static io.pulumi.azurenative.policyinsights.RemediationAtResourceGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.policyinsights.RemediationAtResourceGroupArgs.builder();
     ...
     */
    public RemediationAtResourceGroup(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public RemediationAtResourceGroup(String name, RemediationAtResourceGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:policyinsights:RemediationAtResourceGroup", name, args == null ? RemediationAtResourceGroupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private RemediationAtResourceGroup(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:policyinsights/v20180701preview:RemediationAtResourceGroup").build()),
                Output.of(Alias.builder().setType("azure-native:policyinsights/v20190701:RemediationAtResourceGroup").build()),
                Output.of(Alias.builder().setType("azure-native:policyinsights/v20211001:RemediationAtResourceGroup").build())
            ))
            .build();
     ...
     */
    public static RemediationAtResourceGroup get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
