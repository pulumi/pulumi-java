...
public class DatabaseBlobAuditingPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(DatabaseBlobAuditingPolicyArgs.Builder a);
    }
    private static io.pulumi.azurenative.sql.DatabaseBlobAuditingPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.sql.DatabaseBlobAuditingPolicyArgs.builder();
     ...
     */
    public DatabaseBlobAuditingPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:sql/v20150501preview:DatabaseBlobAuditingPolicy").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20170301preview:DatabaseBlobAuditingPolicy").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20200202preview:DatabaseBlobAuditingPolicy").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20200801preview:DatabaseBlobAuditingPolicy").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20201101preview:DatabaseBlobAuditingPolicy").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20210201preview:DatabaseBlobAuditingPolicy").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20210501preview:DatabaseBlobAuditingPolicy").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20210801preview:DatabaseBlobAuditingPolicy").build())
            ))
            .build();
