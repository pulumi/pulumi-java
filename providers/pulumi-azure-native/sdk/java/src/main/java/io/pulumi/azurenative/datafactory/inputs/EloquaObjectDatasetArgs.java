 ...
 * 
 */
public final class EloquaObjectDatasetArgs extends io.pulumi.resources.ResourceArgs {

    public static final EloquaObjectDatasetArgs Empty = new EloquaObjectDatasetArgs();
    ...
    private EloquaObjectDatasetArgs() {
    ...
    public static Builder builder(EloquaObjectDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(EloquaObjectDatasetArgs defaults) {
        ...
        public EloquaObjectDatasetArgs build() {
            return new EloquaObjectDatasetArgs(annotations, description, folder, linkedServiceName, parameters, schema, structure, tableName, type);
        }
    }
}
