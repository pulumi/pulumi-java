...
public final class SnowflakeDatasetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(SnowflakeDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SnowflakeDatasetArgs defaults) {
        ...
        public SnowflakeDatasetArgs build() {
            return new SnowflakeDatasetArgs(annotations, description, folder, linkedServiceName, parameters, schema, structure, table, type);
        }
    }
}
