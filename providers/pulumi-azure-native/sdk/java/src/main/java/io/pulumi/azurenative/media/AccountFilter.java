...
public class AccountFilter extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(AccountFilterArgs.Builder a);
    }
    private static io.pulumi.azurenative.media.AccountFilterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.media.AccountFilterArgs.builder();
     ...
     */
    public AccountFilter(String name, BuilderApplicator argsBuilder) {
