...
public class Standard extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(StandardArgs.Builder a);
    }
    private static io.pulumi.azurenative.security.StandardArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.security.StandardArgs.builder();
     ...
     */
    public Standard(String name, BuilderApplicator argsBuilder) {
    ...
    public Standard(String name, StandardArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:security:Standard", name, args == null ? StandardArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private Standard(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:security/v20210801preview:Standard").build())
            ))
            .build();
     ...
     */
    public static Standard get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
