...
public class CostAllocationRule extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(CostAllocationRuleArgs.Builder a);
    }
    private static io.pulumi.azurenative.costmanagement.CostAllocationRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.costmanagement.CostAllocationRuleArgs.builder();
     ...
     */
    public CostAllocationRule(String name, BuilderApplicator argsBuilder) {
    ...
    public CostAllocationRule(String name, CostAllocationRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:costmanagement:CostAllocationRule", name, args == null ? CostAllocationRuleArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:costmanagement/v20200301preview:CostAllocationRule").build())
            ))
            .build();
