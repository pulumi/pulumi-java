...
public class RoleManagementPolicyAssignment extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RoleManagementPolicyAssignmentArgs.Builder a);
    }
    private static io.pulumi.azurenative.authorization.RoleManagementPolicyAssignmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.authorization.RoleManagementPolicyAssignmentArgs.builder();
     ...
     */
    public RoleManagementPolicyAssignment(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:authorization/v20201001preview:RoleManagementPolicyAssignment").build())
            ))
            .build();
     ...
     */
    public static RoleManagementPolicyAssignment get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
