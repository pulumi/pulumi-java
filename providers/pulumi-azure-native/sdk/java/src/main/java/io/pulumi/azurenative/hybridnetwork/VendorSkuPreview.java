...
public class VendorSkuPreview extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:hybridnetwork/v20200101preview:VendorSkuPreview").build()),
                Output.of(Alias.builder().setType("azure-native:hybridnetwork/v20210501:VendorSkuPreview").build())
            ))
            .build();
