...
public class PrivateEndpointConnectionsForSCCPowershell extends io.pulumi.resources.CustomResource {
    ...
    public PrivateEndpointConnectionsForSCCPowershell(String name) {
        super("azure-native:m365securityandcompliance:PrivateEndpointConnectionsForSCCPowershell", name, PrivateEndpointConnectionsForSCCPowershellArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
