...
public class PrivateEndpointConnectionsForSCCPowershell extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PrivateEndpointConnectionsForSCCPowershellArgs.Builder a);
    }
    private static io.pulumi.azurenative.m365securityandcompliance.PrivateEndpointConnectionsForSCCPowershellArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.m365securityandcompliance.PrivateEndpointConnectionsForSCCPowershellArgs.builder();
     ...
     */
    public PrivateEndpointConnectionsForSCCPowershell(String name, BuilderApplicator argsBuilder) {
    ...
    public PrivateEndpointConnectionsForSCCPowershell(String name, PrivateEndpointConnectionsForSCCPowershellArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:m365securityandcompliance:PrivateEndpointConnectionsForSCCPowershell", name, args == null ? PrivateEndpointConnectionsForSCCPowershellArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsForSCCPowershell").build())
            ))
            .build();
