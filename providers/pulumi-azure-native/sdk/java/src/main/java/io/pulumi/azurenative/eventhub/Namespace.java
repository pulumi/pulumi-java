...
public class Namespace extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:eventhub/v20140901:Namespace").build()),
                Output.of(Alias.builder().setType("azure-native:eventhub/v20150801:Namespace").build()),
                Output.of(Alias.builder().setType("azure-native:eventhub/v20170401:Namespace").build()),
                Output.of(Alias.builder().setType("azure-native:eventhub/v20180101preview:Namespace").build()),
                Output.of(Alias.builder().setType("azure-native:eventhub/v20210101preview:Namespace").build()),
                Output.of(Alias.builder().setType("azure-native:eventhub/v20210601preview:Namespace").build()),
                Output.of(Alias.builder().setType("azure-native:eventhub/v20211101:Namespace").build())
            ))
            .build();
