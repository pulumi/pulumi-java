...
@OutputCustomType
public final class CustomDatasetResponse {
    /**
    ...
    @OutputCustomType.Constructor({"annotations","description","folder","linkedServiceName","parameters","schema","structure","type"})
