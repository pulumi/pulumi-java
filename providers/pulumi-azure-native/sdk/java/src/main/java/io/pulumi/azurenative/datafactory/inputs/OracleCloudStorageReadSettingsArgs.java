 ...
 */
public final class OracleCloudStorageReadSettingsArgs extends io.pulumi.resources.ResourceArgs {

    public static final OracleCloudStorageReadSettingsArgs Empty = new OracleCloudStorageReadSettingsArgs();
    ...
    private OracleCloudStorageReadSettingsArgs() {
    ...
    public static Builder builder(OracleCloudStorageReadSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(OracleCloudStorageReadSettingsArgs defaults) {
        ...
        public Builder wildcardFolderPath(@Nullable Object wildcardFolderPath) {
            ...
            return this;
        }        public OracleCloudStorageReadSettingsArgs build() {
            return new OracleCloudStorageReadSettingsArgs(deleteFilesAfterCompletion, disableMetricsCollection, enablePartitionDiscovery, fileListPath, maxConcurrentConnections, modifiedDatetimeEnd, modifiedDatetimeStart, partitionRootPath, prefix, recursive, type, wildcardFileName, wildcardFolderPath);
        }
    }
}
