...
public final class HdfsReadSettingsArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setDistcpSettings(@Nullable Input<DistcpSettingsArgs> distcpSettings) {
            this.distcpSettings = distcpSettings;
            return this;
        }

        public Builder setDistcpSettings(@Nullable DistcpSettingsArgs distcpSettings) {
