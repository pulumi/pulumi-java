...
public class BillingRoleAssignmentByBillingAccount extends io.pulumi.resources.CustomResource {
    ...
    public BillingRoleAssignmentByBillingAccount(String name) {
        super("azure-native:billing:BillingRoleAssignmentByBillingAccount", name, BillingRoleAssignmentByBillingAccountArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
