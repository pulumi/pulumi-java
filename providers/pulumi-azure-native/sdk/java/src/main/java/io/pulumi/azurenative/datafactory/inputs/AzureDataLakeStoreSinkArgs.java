 ...
 * 
 */
public final class AzureDataLakeStoreSinkArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public AzureDataLakeStoreSinkArgs(
        ...
        @Nullable Input<Object> enableAdlsSingleFileParallel,
    ...
    private AzureDataLakeStoreSinkArgs() {
        ...
        this.enableAdlsSingleFileParallel = Input.empty();
    ...
    public static final class Builder {
        ...
        private @Nullable Input<Object> enableAdlsSingleFileParallel;
        ...
        public Builder setEnableAdlsSingleFileParallel(@Nullable Input<Object> enableAdlsSingleFileParallel) {
            this.enableAdlsSingleFileParallel = enableAdlsSingleFileParallel;
            return this;
        }

        public Builder setEnableAdlsSingleFileParallel(@Nullable Object enableAdlsSingleFileParallel) {
            this.enableAdlsSingleFileParallel = Input.ofNullable(enableAdlsSingleFileParallel);
            return this;
        }
