...
public class VMwareCollector extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(VMwareCollectorArgs.Builder a);
    }
    private static io.pulumi.azurenative.migrate.VMwareCollectorArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.migrate.VMwareCollectorArgs.builder();
     ...
     */
    public VMwareCollector(String name, BuilderApplicator argsBuilder) {
    ...
    public VMwareCollector(String name, VMwareCollectorArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:migrate:VMwareCollector", name, args == null ? VMwareCollectorArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private VMwareCollector(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:migrate/v20191001:VMwareCollector").build())
            ))
            .build();
     ...
     */
    public static VMwareCollector get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
