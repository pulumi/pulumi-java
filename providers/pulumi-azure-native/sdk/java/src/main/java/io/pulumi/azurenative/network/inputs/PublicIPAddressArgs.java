...
public final class PublicIPAddressArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder linkedPublicIPAddress(@Nullable Input<PublicIPAddressArgs> linkedPublicIPAddress) {
            this.linkedPublicIPAddress = linkedPublicIPAddress;
            return this;
        }
        ...
        public Builder servicePublicIPAddress(@Nullable Input<PublicIPAddressArgs> servicePublicIPAddress) {
            this.servicePublicIPAddress = servicePublicIPAddress;
            return this;
        }
