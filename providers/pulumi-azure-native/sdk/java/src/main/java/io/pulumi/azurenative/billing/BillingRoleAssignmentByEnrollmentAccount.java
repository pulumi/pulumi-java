...
public class BillingRoleAssignmentByEnrollmentAccount extends io.pulumi.resources.CustomResource {
    ...
    public BillingRoleAssignmentByEnrollmentAccount(String name) {
        super("azure-native:billing:BillingRoleAssignmentByEnrollmentAccount", name, BillingRoleAssignmentByEnrollmentAccountArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
