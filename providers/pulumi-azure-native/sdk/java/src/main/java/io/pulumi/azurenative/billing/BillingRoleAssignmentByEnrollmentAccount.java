...
public class BillingRoleAssignmentByEnrollmentAccount extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(BillingRoleAssignmentByEnrollmentAccountArgs.Builder a);
    }
    private static io.pulumi.azurenative.billing.BillingRoleAssignmentByEnrollmentAccountArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.billing.BillingRoleAssignmentByEnrollmentAccountArgs.builder();
     ...
     */
    public BillingRoleAssignmentByEnrollmentAccount(String name, BuilderApplicator argsBuilder) {
    ...
    public BillingRoleAssignmentByEnrollmentAccount(String name, BillingRoleAssignmentByEnrollmentAccountArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:billing:BillingRoleAssignmentByEnrollmentAccount", name, args == null ? BillingRoleAssignmentByEnrollmentAccountArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private BillingRoleAssignmentByEnrollmentAccount(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:billing/v20191001preview:BillingRoleAssignmentByEnrollmentAccount").build())
            ))
            .build();
     ...
     */
    public static BillingRoleAssignmentByEnrollmentAccount get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
