...
public class NamespaceVirtualNetworkRule extends io.pulumi.resources.CustomResource {
    ...
    public NamespaceVirtualNetworkRule(String name, NamespaceVirtualNetworkRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:eventhub:NamespaceVirtualNetworkRule", name, args == null ? NamespaceVirtualNetworkRuleArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:eventhub/v20180101preview:NamespaceVirtualNetworkRule").build())
            ))
            .build();
