...
@OutputCustomType
public final class WebSourceResponse {
    /**
    ...
    @OutputCustomType.Constructor({"additionalColumns","disableMetricsCollection","maxConcurrentConnections","sourceRetryCount","sourceRetryWait","type"})
