...
public final class GetVirtualNetworkGatewayConnectionResult {
    ...
    private GetVirtualNetworkGatewayConnectionResult(
        ...
        @Nullable LocalNetworkGatewayResponse localNetworkGateway2,
        @Nullable String location,
        String name,
        @Nullable SubResourceResponse peer,
        ...
        List<TunnelConnectionHealthResponse> tunnelConnectionStatus,
        String type,
        @Nullable Boolean useLocalAzureIpAddress,
        @Nullable Boolean usePolicyBasedTrafficSelectors,
        VirtualNetworkGatewayResponse virtualNetworkGateway1,
        @Nullable VirtualNetworkGatewayResponse virtualNetworkGateway2) {
