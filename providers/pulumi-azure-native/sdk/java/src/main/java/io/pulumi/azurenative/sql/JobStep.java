...
public class JobStep extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(JobStepArgs.Builder a);
    }
    private static io.pulumi.azurenative.sql.JobStepArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.sql.JobStepArgs.builder();
     ...
     */
    public JobStep(String name, BuilderApplicator argsBuilder) {
