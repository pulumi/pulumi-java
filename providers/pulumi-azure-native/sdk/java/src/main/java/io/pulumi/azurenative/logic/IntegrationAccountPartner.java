...
public class IntegrationAccountPartner extends io.pulumi.resources.CustomResource {
    ...
    public IntegrationAccountPartner(String name, IntegrationAccountPartnerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:logic:IntegrationAccountPartner", name, args == null ? IntegrationAccountPartnerArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private IntegrationAccountPartner(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:logic/v20150801preview:IntegrationAccountPartner").build()),
                Output.of(Alias.builder().setType("azure-native:logic/v20160601:IntegrationAccountPartner").build()),
                Output.of(Alias.builder().setType("azure-native:logic/v20180701preview:IntegrationAccountPartner").build()),
                Output.of(Alias.builder().setType("azure-native:logic/v20190501:IntegrationAccountPartner").build())
            ))
            .build();
     ...
     */
    public static IntegrationAccountPartner get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
