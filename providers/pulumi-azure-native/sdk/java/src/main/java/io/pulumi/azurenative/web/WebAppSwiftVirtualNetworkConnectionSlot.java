...
public class WebAppSwiftVirtualNetworkConnectionSlot extends io.pulumi.resources.CustomResource {
    ...
    public WebAppSwiftVirtualNetworkConnectionSlot(String name) {
        super("azure-native:web:WebAppSwiftVirtualNetworkConnectionSlot", name, WebAppSwiftVirtualNetworkConnectionSlotArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
