...
public class AttestationAtSubscription extends io.pulumi.resources.CustomResource {
    ...
    private AttestationAtSubscription(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:policyinsights/v20210101:AttestationAtSubscription").build())
            ))
            .build();
