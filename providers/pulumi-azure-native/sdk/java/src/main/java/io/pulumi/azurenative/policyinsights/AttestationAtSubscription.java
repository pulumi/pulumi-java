...
import io.pulumi.azurenative.policyinsights.AttestationAtSubscriptionArgs;
...
public class AttestationAtSubscription extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(AttestationAtSubscriptionArgs.Builder a);
    }
    private static io.pulumi.azurenative.policyinsights.AttestationAtSubscriptionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.policyinsights.AttestationAtSubscriptionArgs.builder();
     ...
     */
    public AttestationAtSubscription(String name, BuilderApplicator argsBuilder) {
    ...
    public AttestationAtSubscription(String name, AttestationAtSubscriptionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:policyinsights:AttestationAtSubscription", name, args == null ? AttestationAtSubscriptionArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private AttestationAtSubscription(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:policyinsights/v20210101:AttestationAtSubscription").build())
            ))
            .build();
     ...
     */
    public static AttestationAtSubscription get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
