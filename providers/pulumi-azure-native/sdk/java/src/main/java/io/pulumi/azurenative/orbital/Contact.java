...
public class Contact extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.orbital.ContactArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.orbital.ContactArgs.builder();
    ...
    public Contact(String name, ContactArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:orbital:Contact", name, args == null ? ContactArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:orbital/v20210404preview:Contact").build())
            ))
            .build();
