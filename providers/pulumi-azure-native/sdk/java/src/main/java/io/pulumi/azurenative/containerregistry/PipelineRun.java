...
public class PipelineRun extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PipelineRunArgs.Builder a);
    }
    private static io.pulumi.azurenative.containerregistry.PipelineRunArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.containerregistry.PipelineRunArgs.builder();
     ...
     */
    public PipelineRun(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:containerregistry/v20191201preview:PipelineRun").build()),
                Output.of(Alias.builder().setType("azure-native:containerregistry/v20201101preview:PipelineRun").build()),
                Output.of(Alias.builder().setType("azure-native:containerregistry/v20210601preview:PipelineRun").build()),
                Output.of(Alias.builder().setType("azure-native:containerregistry/v20210801preview:PipelineRun").build()),
                Output.of(Alias.builder().setType("azure-native:containerregistry/v20211201preview:PipelineRun").build())
            ))
            .build();
