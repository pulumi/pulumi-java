...
public class Export extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.costmanagement.ExportArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.costmanagement.ExportArgs.builder();
