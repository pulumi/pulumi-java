...
public class IotHubResourceEventHubConsumerGroup extends io.pulumi.resources.CustomResource {
    ...
    public IotHubResourceEventHubConsumerGroup(String name) {
        super("azure-native:devices:IotHubResourceEventHubConsumerGroup", name, IotHubResourceEventHubConsumerGroupArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
