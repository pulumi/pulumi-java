...
public class MultipleActivationKey extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(MultipleActivationKeyArgs.Builder a);
    }
    private static io.pulumi.azurenative.windowsesu.MultipleActivationKeyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.windowsesu.MultipleActivationKeyArgs.builder();
     ...
     */
    public MultipleActivationKey(String name, BuilderApplicator argsBuilder) {
    ...
    public MultipleActivationKey(String name, MultipleActivationKeyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:windowsesu:MultipleActivationKey", name, args == null ? MultipleActivationKeyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:windowsesu/v20190916preview:MultipleActivationKey").build())
            ))
            .build();
