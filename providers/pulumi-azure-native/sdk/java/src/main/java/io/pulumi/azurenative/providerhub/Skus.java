...
public class Skus extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(SkusArgs.Builder a);
    }
    private static io.pulumi.azurenative.providerhub.SkusArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.providerhub.SkusArgs.builder();
     ...
     */
    public Skus(String name, BuilderApplicator argsBuilder) {
