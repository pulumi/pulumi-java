...
public class PrivateLinkScope extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.hybridcompute.PrivateLinkScopeArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.hybridcompute.PrivateLinkScopeArgs.builder();
