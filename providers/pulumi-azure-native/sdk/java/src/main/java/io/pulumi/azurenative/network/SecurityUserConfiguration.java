...
import io.pulumi.azurenative.network.SecurityUserConfigurationArgs;
...
public class SecurityUserConfiguration extends io.pulumi.resources.CustomResource {
    /**
    ...
    public interface BuilderApplicator {
        public void apply(SecurityUserConfigurationArgs.Builder a);
    }
    private static io.pulumi.azurenative.network.SecurityUserConfigurationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.network.SecurityUserConfigurationArgs.builder();
     ...
     */
    public SecurityUserConfiguration(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public SecurityUserConfiguration(String name, SecurityUserConfigurationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:network:SecurityUserConfiguration", name, args == null ? SecurityUserConfigurationArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private SecurityUserConfiguration(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:network/v20210201preview:SecurityUserConfiguration").build()),
                Input.of(Alias.builder().setType("azure-native:network/v20210501preview:SecurityUserConfiguration").build())
            ))
            .build();
     ...
     */
    public static SecurityUserConfiguration get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
