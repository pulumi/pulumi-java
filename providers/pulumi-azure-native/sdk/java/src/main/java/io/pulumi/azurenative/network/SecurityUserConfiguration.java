...
public class SecurityUserConfiguration extends io.pulumi.resources.CustomResource {
    ...
    public SecurityUserConfiguration(String name, SecurityUserConfigurationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:network:SecurityUserConfiguration", name, args == null ? SecurityUserConfigurationArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private SecurityUserConfiguration(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SecurityUserConfiguration get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
