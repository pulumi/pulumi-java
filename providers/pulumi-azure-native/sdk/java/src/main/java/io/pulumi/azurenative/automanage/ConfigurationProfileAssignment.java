...
public class ConfigurationProfileAssignment extends io.pulumi.resources.CustomResource {
    ...
    public ConfigurationProfileAssignment(String name, ConfigurationProfileAssignmentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:automanage:ConfigurationProfileAssignment", name, args == null ? ConfigurationProfileAssignmentArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ConfigurationProfileAssignment(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:automanage/v20200630preview:ConfigurationProfileAssignment").build()),
                Output.of(Alias.builder().setType("azure-native:automanage/v20210430preview:ConfigurationProfileAssignment").build())
            ))
            .build();
     ...
     */
    public static ConfigurationProfileAssignment get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
