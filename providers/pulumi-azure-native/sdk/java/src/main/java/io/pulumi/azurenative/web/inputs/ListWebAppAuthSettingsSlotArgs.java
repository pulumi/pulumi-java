...
public final class ListWebAppAuthSettingsSlotArgs extends io.pulumi.resources.InvokeArgs {
    ...
    private ListWebAppAuthSettingsSlotArgs() {
        this.name = null;
    ...
    public static Builder builder(ListWebAppAuthSettingsSlotArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ListWebAppAuthSettingsSlotArgs defaults) {
