...
public class ApplicationType extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:servicefabric/v20170701preview:ApplicationType").build()),
                Output.of(Alias.builder().setType("azure-native:servicefabric/v20190301:ApplicationType").build()),
                Output.of(Alias.builder().setType("azure-native:servicefabric/v20190301preview:ApplicationType").build()),
                Output.of(Alias.builder().setType("azure-native:servicefabric/v20190601preview:ApplicationType").build()),
                Output.of(Alias.builder().setType("azure-native:servicefabric/v20191101preview:ApplicationType").build()),
                Output.of(Alias.builder().setType("azure-native:servicefabric/v20200301:ApplicationType").build()),
                Output.of(Alias.builder().setType("azure-native:servicefabric/v20201201preview:ApplicationType").build()),
                Output.of(Alias.builder().setType("azure-native:servicefabric/v20210601:ApplicationType").build())
            ))
            .build();
