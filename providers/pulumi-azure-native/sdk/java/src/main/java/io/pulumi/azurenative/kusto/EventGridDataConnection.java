...
public class EventGridDataConnection extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.kusto.EventGridDataConnectionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.kusto.EventGridDataConnectionArgs.builder();
    ...
    public EventGridDataConnection(String name, EventGridDataConnectionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:kusto:EventGridDataConnection", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }
