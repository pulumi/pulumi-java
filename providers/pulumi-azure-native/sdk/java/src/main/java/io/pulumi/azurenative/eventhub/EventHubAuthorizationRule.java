...
public class EventHubAuthorizationRule extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(EventHubAuthorizationRuleArgs.Builder a);
    }
    private static io.pulumi.azurenative.eventhub.EventHubAuthorizationRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.eventhub.EventHubAuthorizationRuleArgs.builder();
     ...
     */
    public EventHubAuthorizationRule(String name, BuilderApplicator argsBuilder) {
