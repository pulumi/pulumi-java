...
public class Bot extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.botservice.BotArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.botservice.BotArgs.builder();
    ...
    public Bot(String name, BotArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:botservice:Bot", name, args == null ? BotArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
