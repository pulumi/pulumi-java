...
public class SqlMigrationService extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(SqlMigrationServiceArgs.Builder a);
    }
    private static io.pulumi.azurenative.datamigration.SqlMigrationServiceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.datamigration.SqlMigrationServiceArgs.builder();
     ...
     */
    public SqlMigrationService(String name, BuilderApplicator argsBuilder) {
    ...
    private SqlMigrationService(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:datamigration/v20211030preview:SqlMigrationService").build())
            ))
            .build();
