...
public final class UrlFileExtensionMatchConditionParametersArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="operator", required=true)
      private final Output<Either<String,UrlFileExtensionOperator>> operator;

    public Output<Either<String,UrlFileExtensionOperator>> getOperator() {
    ...
    public UrlFileExtensionMatchConditionParametersArgs(
        ...
        Output<Either<String,UrlFileExtensionOperator>> operator,
