...
public class ServerBlobAuditingPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:sql/v20170301preview:ServerBlobAuditingPolicy").build()),
                Output.of(Alias.builder().type("azure-native:sql/v20200202preview:ServerBlobAuditingPolicy").build()),
                Output.of(Alias.builder().type("azure-native:sql/v20200801preview:ServerBlobAuditingPolicy").build()),
                Output.of(Alias.builder().type("azure-native:sql/v20201101preview:ServerBlobAuditingPolicy").build()),
                Output.of(Alias.builder().type("azure-native:sql/v20210201preview:ServerBlobAuditingPolicy").build()),
                Output.of(Alias.builder().type("azure-native:sql/v20210501preview:ServerBlobAuditingPolicy").build()),
                Output.of(Alias.builder().type("azure-native:sql/v20210801preview:ServerBlobAuditingPolicy").build())
            ))
            .build();
