...
public class ServerBlobAuditingPolicy extends io.pulumi.resources.CustomResource {
    ...
    public ServerBlobAuditingPolicy(String name, ServerBlobAuditingPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:sql:ServerBlobAuditingPolicy", name, args == null ? ServerBlobAuditingPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ServerBlobAuditingPolicy(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:sql/v20170301preview:ServerBlobAuditingPolicy").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20200202preview:ServerBlobAuditingPolicy").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20200801preview:ServerBlobAuditingPolicy").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20201101preview:ServerBlobAuditingPolicy").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20210201preview:ServerBlobAuditingPolicy").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20210501preview:ServerBlobAuditingPolicy").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20210801preview:ServerBlobAuditingPolicy").build())
            ))
            .build();
     ...
     */
    public static ServerBlobAuditingPolicy get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
