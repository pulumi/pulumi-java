...
public class Workspace extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.quantum.WorkspaceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.quantum.WorkspaceArgs.builder();
