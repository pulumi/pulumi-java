...
public final class FormulaArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setFormulaContent(@Nullable Input<LabVirtualMachineCreationParameterArgs> formulaContent) {
            this.formulaContent = formulaContent;
            return this;
        }

        public Builder setFormulaContent(@Nullable LabVirtualMachineCreationParameterArgs formulaContent) {
        ...
        public Builder setVm(@Nullable Input<FormulaPropertiesFromVmArgs> vm) {
            this.vm = vm;
            return this;
        }

        public Builder setVm(@Nullable FormulaPropertiesFromVmArgs vm) {
