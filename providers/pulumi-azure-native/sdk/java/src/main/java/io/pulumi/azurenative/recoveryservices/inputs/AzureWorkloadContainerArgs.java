...
public final class AzureWorkloadContainerArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(AzureWorkloadContainerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AzureWorkloadContainerArgs defaults) {
        ...
        public Builder setExtendedInfo(@Nullable Input<AzureWorkloadContainerExtendedInfoArgs> extendedInfo) {
            this.extendedInfo = extendedInfo;
            return this;
        }

        public Builder setExtendedInfo(@Nullable AzureWorkloadContainerExtendedInfoArgs extendedInfo) {
        ...
        public Builder setOperationType(@Nullable Input<Either<String,OperationType>> operationType) {
            this.operationType = operationType;
            return this;
        }

        public Builder setOperationType(@Nullable Either<String,OperationType> operationType) {
        ...
        public AzureWorkloadContainerArgs build() {
            return new AzureWorkloadContainerArgs(backupManagementType, containerType, extendedInfo, friendlyName, healthStatus, lastUpdatedTime, operationType, registrationStatus, sourceResourceId, workloadType);
        }
    }
}
