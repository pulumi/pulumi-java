...
public class LinkedService extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.datafactory.LinkedServiceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.datafactory.LinkedServiceArgs.builder();
