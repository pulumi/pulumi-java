...
public class PeeringService extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PeeringServiceArgs.Builder a);
    }
    private static io.pulumi.azurenative.peering.PeeringServiceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.peering.PeeringServiceArgs.builder();
     ...
     */
    public PeeringService(String name, BuilderApplicator argsBuilder) {
