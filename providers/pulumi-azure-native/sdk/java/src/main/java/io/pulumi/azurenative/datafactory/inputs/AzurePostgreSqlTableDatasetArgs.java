 ...
 * 
 */
public final class AzurePostgreSqlTableDatasetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AzurePostgreSqlTableDatasetArgs build() {
            return new AzurePostgreSqlTableDatasetArgs(annotations, description, folder, linkedServiceName, parameters, schema, structure, table, tableName, type);
        }
    }
}
