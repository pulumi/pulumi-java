...
public class Vendor extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable VendorArgs.Builder a);
    }
    private static io.pulumi.azurenative.hybridnetwork.VendorArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.hybridnetwork.VendorArgs.builder();
     ...
     */
    public Vendor(String name, BuilderApplicator argsBuilder) {
    ...
    public Vendor(String name, @Nullable VendorArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:hybridnetwork:Vendor", name, args == null ? VendorArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:hybridnetwork/v20200101preview:Vendor").build()),
                Output.of(Alias.builder().setType("azure-native:hybridnetwork/v20210501:Vendor").build())
            ))
            .build();
