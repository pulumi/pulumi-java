...
public class ServerSecurityAlertPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.sql.ServerSecurityAlertPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.sql.ServerSecurityAlertPolicyArgs.builder();
