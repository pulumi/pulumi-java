...
public class DeviceSecurityGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:security/v20170801preview:DeviceSecurityGroup").build()),
                Output.of(Alias.builder().setType("azure-native:security/v20190801:DeviceSecurityGroup").build())
            ))
            .build();
