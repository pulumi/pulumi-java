...
public class SubscriptionNetworkManagerConnection extends io.pulumi.resources.CustomResource {
    ...
    public SubscriptionNetworkManagerConnection(String name) {
        super("azure-native:network:SubscriptionNetworkManagerConnection", name, SubscriptionNetworkManagerConnectionArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
