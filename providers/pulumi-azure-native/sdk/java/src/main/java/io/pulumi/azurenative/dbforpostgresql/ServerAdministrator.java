...
public class ServerAdministrator extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.dbforpostgresql.ServerAdministratorArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.dbforpostgresql.ServerAdministratorArgs.builder();
    ...
    public ServerAdministrator(String name, ServerAdministratorArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:dbforpostgresql:ServerAdministrator", name, args == null ? ServerAdministratorArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:dbforpostgresql/v20171201:ServerAdministrator").build()),
                Output.of(Alias.builder().setType("azure-native:dbforpostgresql/v20171201preview:ServerAdministrator").build())
            ))
            .build();
