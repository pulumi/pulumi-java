...
public class MachineExtension extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.connectedvmwarevsphere.MachineExtensionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.connectedvmwarevsphere.MachineExtensionArgs.builder();
