...
public final class GetGremlinResourceGremlinGraphResult {
    ...
    private GetGremlinResourceGremlinGraphResult(
        ...
        @CustomType.Parameter("options") @Nullable GremlinGraphGetPropertiesResponseOptions options,
        @CustomType.Parameter("resource") @Nullable GremlinGraphGetPropertiesResponseResource resource,
