...
public final class GetGremlinResourceGremlinGraphResult {
    ...
    private GetGremlinResourceGremlinGraphResult(
        ...
        @OutputCustomType.Parameter("options") @Nullable GremlinGraphGetPropertiesResponseOptions options,
        @OutputCustomType.Parameter("resource") @Nullable GremlinGraphGetPropertiesResponseResource resource,
