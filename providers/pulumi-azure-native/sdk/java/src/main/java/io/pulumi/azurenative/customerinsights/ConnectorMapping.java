...
public class ConnectorMapping extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ConnectorMappingArgs.Builder a);
    }
    private static io.pulumi.azurenative.customerinsights.ConnectorMappingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.customerinsights.ConnectorMappingArgs.builder();
     ...
     */
    public ConnectorMapping(String name, BuilderApplicator argsBuilder) {
