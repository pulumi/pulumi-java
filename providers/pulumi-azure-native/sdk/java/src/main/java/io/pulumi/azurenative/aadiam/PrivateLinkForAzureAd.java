...
public class PrivateLinkForAzureAd extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PrivateLinkForAzureAdArgs.Builder a);
    }
    private static io.pulumi.azurenative.aadiam.PrivateLinkForAzureAdArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.aadiam.PrivateLinkForAzureAdArgs.builder();
     ...
     */
    public PrivateLinkForAzureAd(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:aadiam/v20200301:privateLinkForAzureAd").build()),
                Output.of(Alias.builder().setType("azure-native:aadiam/v20200301preview:privateLinkForAzureAd").build())
            ))
            .build();
