 ...
 * 
 */
public final class PaypalSourceResponse extends io.pulumi.resources.InvokeArgs {

    public static final PaypalSourceResponse Empty = new PaypalSourceResponse();
