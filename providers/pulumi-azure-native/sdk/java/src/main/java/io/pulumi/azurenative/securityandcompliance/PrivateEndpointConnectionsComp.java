...
public class PrivateEndpointConnectionsComp extends io.pulumi.resources.CustomResource {
    ...
    public PrivateEndpointConnectionsComp(String name) {
        super("azure-native:securityandcompliance:PrivateEndpointConnectionsComp", name, PrivateEndpointConnectionsCompArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
