...
import io.pulumi.azurenative.network.enums.UserRuleKind;
...
public final class UserRuleArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Input<Either<String,UserRuleKind>> getKind() {
        return this.kind;
    }
    ...
    public UserRuleArgs(
        ...
        Input<Either<String,UserRuleKind>> kind,
    ...
    public static final class Builder {
        ...
        private Input<Either<String,UserRuleKind>> kind;
        ...
        public Builder setKind(Input<Either<String,UserRuleKind>> kind) {
            this.kind = Objects.requireNonNull(kind);
            return this;
        }

        public Builder setKind(Either<String,UserRuleKind> kind) {
