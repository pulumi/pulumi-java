...
public class SqlServerRegistration extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:azuredata/v20170301preview:SqlServerRegistration").build()),
                Output.of(Alias.builder().setType("azure-native:azuredata/v20190724preview:SqlServerRegistration").build())
            ))
            .build();
