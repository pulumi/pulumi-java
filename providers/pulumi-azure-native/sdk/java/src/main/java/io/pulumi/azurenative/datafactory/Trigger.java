...
public class Trigger extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.datafactory.TriggerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.datafactory.TriggerArgs.builder();
