...
public class StreamingEndpoint extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(StreamingEndpointArgs.Builder a);
    }
    private static io.pulumi.azurenative.media.StreamingEndpointArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.media.StreamingEndpointArgs.builder();
     ...
     */
    public StreamingEndpoint(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:media/v20180330preview:StreamingEndpoint").build()),
                Output.of(Alias.builder().setType("azure-native:media/v20180601preview:StreamingEndpoint").build()),
                Output.of(Alias.builder().setType("azure-native:media/v20180701:StreamingEndpoint").build()),
                Output.of(Alias.builder().setType("azure-native:media/v20190501preview:StreamingEndpoint").build()),
                Output.of(Alias.builder().setType("azure-native:media/v20200501:StreamingEndpoint").build()),
                Output.of(Alias.builder().setType("azure-native:media/v20210601:StreamingEndpoint").build())
            ))
            .build();
