...
public class KubernetesRole extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(KubernetesRoleArgs.Builder a);
    }
    private static io.pulumi.azurenative.databoxedge.KubernetesRoleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.databoxedge.KubernetesRoleArgs.builder();
     ...
     */
    public KubernetesRole(String name, BuilderApplicator argsBuilder) {
