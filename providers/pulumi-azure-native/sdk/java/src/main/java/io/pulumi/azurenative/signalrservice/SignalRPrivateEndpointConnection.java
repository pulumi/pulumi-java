...
public class SignalRPrivateEndpointConnection extends io.pulumi.resources.CustomResource {
    ...
    public SignalRPrivateEndpointConnection(String name) {
        super("azure-native:signalrservice:SignalRPrivateEndpointConnection", name, SignalRPrivateEndpointConnectionArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
