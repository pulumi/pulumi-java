...
public class ManagedInstanceAzureADOnlyAuthentication extends io.pulumi.resources.CustomResource {
    ...
    public ManagedInstanceAzureADOnlyAuthentication(String name) {
        super("azure-native:sql:ManagedInstanceAzureADOnlyAuthentication", name, ManagedInstanceAzureADOnlyAuthenticationArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
