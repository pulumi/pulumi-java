...
public class EncryptionProtector extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:sql/v20150501preview:EncryptionProtector").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20200202preview:EncryptionProtector").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20200801preview:EncryptionProtector").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20201101preview:EncryptionProtector").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20210201preview:EncryptionProtector").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20210501preview:EncryptionProtector").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20210801preview:EncryptionProtector").build())
            ))
            .build();
