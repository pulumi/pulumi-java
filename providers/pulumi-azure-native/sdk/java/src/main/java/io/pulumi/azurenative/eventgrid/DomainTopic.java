...
public class DomainTopic extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(DomainTopicArgs.Builder a);
    }
    private static io.pulumi.azurenative.eventgrid.DomainTopicArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.eventgrid.DomainTopicArgs.builder();
     ...
     */
    public DomainTopic(String name, BuilderApplicator argsBuilder) {
