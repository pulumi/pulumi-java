...
public class ManagementLockAtSubscriptionLevel extends io.pulumi.resources.CustomResource {
    ...
    public ManagementLockAtSubscriptionLevel(String name) {
        super("azure-native:authorization:ManagementLockAtSubscriptionLevel", name, ManagementLockAtSubscriptionLevelArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
