...
public class NetworkManager extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(NetworkManagerArgs.Builder a);
    }
    private static io.pulumi.azurenative.network.NetworkManagerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.network.NetworkManagerArgs.builder();
     ...
     */
    public NetworkManager(String name, BuilderApplicator argsBuilder) {
    ...
    public NetworkManager(String name, NetworkManagerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:network:NetworkManager", name, args == null ? NetworkManagerArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private NetworkManager(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:network/v20210201preview:NetworkManager").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20210501preview:NetworkManager").build())
            ))
            .build();
     ...
     */
    public static NetworkManager get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
