...
public class PrivateZone extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PrivateZoneArgs.Builder a);
    }
    private static io.pulumi.azurenative.network.PrivateZoneArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.network.PrivateZoneArgs.builder();
     ...
     */
    public PrivateZone(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:network/v20180901:PrivateZone").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200101:PrivateZone").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20200601:PrivateZone").build())
            ))
            .build();
