...
public class DataStore extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.hybriddata.DataStoreArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.hybriddata.DataStoreArgs.builder();
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:hybriddata/v20160601:DataStore").build()),
                Output.of(Alias.builder().setType("azure-native:hybriddata/v20190601:DataStore").build())
            ))
            .build();
