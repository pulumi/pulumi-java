...
public class Project extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.machinelearningexperimentation.ProjectArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.machinelearningexperimentation.ProjectArgs.builder();
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:machinelearningexperimentation/v20170501preview:Project").build())
            ))
            .build();
