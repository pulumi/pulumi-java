...
public class TrafficManagerUserMetricsKey extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable TrafficManagerUserMetricsKeyArgs.Builder a);
    }
    private static io.pulumi.azurenative.network.TrafficManagerUserMetricsKeyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.network.TrafficManagerUserMetricsKeyArgs.builder();
     ...
     */
    public TrafficManagerUserMetricsKey(String name, BuilderApplicator argsBuilder) {
    ...
    public TrafficManagerUserMetricsKey(String name, @Nullable TrafficManagerUserMetricsKeyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:network:TrafficManagerUserMetricsKey", name, args == null ? TrafficManagerUserMetricsKeyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:network/v20180401:TrafficManagerUserMetricsKey").build()),
                Output.of(Alias.builder().setType("azure-native:network/v20180801:TrafficManagerUserMetricsKey").build())
            ))
            .build();
