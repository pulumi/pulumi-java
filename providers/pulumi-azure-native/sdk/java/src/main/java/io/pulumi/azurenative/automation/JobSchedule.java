...
public class JobSchedule extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(JobScheduleArgs.Builder a);
    }
    private static io.pulumi.azurenative.automation.JobScheduleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.automation.JobScheduleArgs.builder();
     ...
     */
    public JobSchedule(String name, BuilderApplicator argsBuilder) {
