...
public class ServerKey extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.dbformysql.ServerKeyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.dbformysql.ServerKeyArgs.builder();
