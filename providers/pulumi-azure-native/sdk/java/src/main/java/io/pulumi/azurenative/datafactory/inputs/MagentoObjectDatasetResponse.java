 ...
 */
public final class MagentoObjectDatasetResponse extends io.pulumi.resources.InvokeArgs {

    public static final MagentoObjectDatasetResponse Empty = new MagentoObjectDatasetResponse();
    ...
    public MagentoObjectDatasetResponse(
