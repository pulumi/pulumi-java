...
public class WCFRelayAuthorizationRule extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(WCFRelayAuthorizationRuleArgs.Builder a);
    }
    private static io.pulumi.azurenative.relay.WCFRelayAuthorizationRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.relay.WCFRelayAuthorizationRuleArgs.builder();
     ...
     */
    public WCFRelayAuthorizationRule(String name, BuilderApplicator argsBuilder) {
    ...
    public WCFRelayAuthorizationRule(String name, WCFRelayAuthorizationRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:relay:WCFRelayAuthorizationRule", name, args == null ? WCFRelayAuthorizationRuleArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private WCFRelayAuthorizationRule(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:relay/v20160701:WCFRelayAuthorizationRule").build()),
                Output.of(Alias.builder().setType("azure-native:relay/v20170401:WCFRelayAuthorizationRule").build())
            ))
            .build();
     ...
     */
    public static WCFRelayAuthorizationRule get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
