...
public class SupportPlanType extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:addons/v20170515:SupportPlanType").build()),
                Output.of(Alias.builder().setType("azure-native:addons/v20180301:SupportPlanType").build())
            ))
            .build();
