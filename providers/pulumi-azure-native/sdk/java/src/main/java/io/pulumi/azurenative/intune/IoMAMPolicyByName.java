...
public class IoMAMPolicyByName extends io.pulumi.resources.CustomResource {
    ...
    public IoMAMPolicyByName(String name, IoMAMPolicyByNameArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:intune:IoMAMPolicyByName", name, args == null ? IoMAMPolicyByNameArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private IoMAMPolicyByName(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:intune/v20150114preview:IoMAMPolicyByName").build()),
                Input.of(Alias.builder().setType("azure-native:intune/v20150114privatepreview:IoMAMPolicyByName").build())
            ))
            .build();
     ...
     */
    public static IoMAMPolicyByName get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
