...
public class IoMAMPolicyByName extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(IoMAMPolicyByNameArgs.Builder a);
    }
    private static io.pulumi.azurenative.intune.IoMAMPolicyByNameArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.intune.IoMAMPolicyByNameArgs.builder();
     ...
     */
    public IoMAMPolicyByName(String name, BuilderApplicator argsBuilder) {
    ...
    public IoMAMPolicyByName(String name, IoMAMPolicyByNameArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:intune:IoMAMPolicyByName", name, args == null ? IoMAMPolicyByNameArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:intune/v20150114preview:IoMAMPolicyByName").build()),
                Output.of(Alias.builder().setType("azure-native:intune/v20150114privatepreview:IoMAMPolicyByName").build())
            ))
            .build();
