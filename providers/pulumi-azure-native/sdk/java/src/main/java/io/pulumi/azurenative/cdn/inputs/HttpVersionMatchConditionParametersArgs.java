...
public final class HttpVersionMatchConditionParametersArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(HttpVersionMatchConditionParametersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(HttpVersionMatchConditionParametersArgs defaults) {
        ...
        public Builder setOperator(Input<Either<String,HttpVersionOperator>> operator) {
            this.operator = Objects.requireNonNull(operator);
            return this;
        }

        public Builder setOperator(Either<String,HttpVersionOperator> operator) {
