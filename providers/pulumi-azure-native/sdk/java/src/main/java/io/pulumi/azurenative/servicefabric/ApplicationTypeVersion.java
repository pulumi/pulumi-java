...
public class ApplicationTypeVersion extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ApplicationTypeVersionArgs.Builder a);
    }
    private static io.pulumi.azurenative.servicefabric.ApplicationTypeVersionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.servicefabric.ApplicationTypeVersionArgs.builder();
     ...
     */
    public ApplicationTypeVersion(String name, BuilderApplicator argsBuilder) {
