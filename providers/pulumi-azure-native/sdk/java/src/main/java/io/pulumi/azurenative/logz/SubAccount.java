...
public class SubAccount extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(SubAccountArgs.Builder a);
    }
    private static io.pulumi.azurenative.logz.SubAccountArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.logz.SubAccountArgs.builder();
     ...
     */
    public SubAccount(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:logz/v20201001:SubAccount").build()),
                Output.of(Alias.builder().setType("azure-native:logz/v20201001preview:SubAccount").build()),
                Output.of(Alias.builder().setType("azure-native:logz/v20220101preview:SubAccount").build())
            ))
            .build();
