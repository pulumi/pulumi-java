 ...
 * 
 */
public final class BinaryDatasetArgs extends io.pulumi.resources.ResourceArgs {

    public static final BinaryDatasetArgs Empty = new BinaryDatasetArgs();
    ...
    public static Builder builder(BinaryDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(BinaryDatasetArgs defaults) {
        ...
        public BinaryDatasetArgs build() {
            return new BinaryDatasetArgs(annotations, compression, description, folder, linkedServiceName, location, parameters, schema, structure, type);
        }
    }
}
