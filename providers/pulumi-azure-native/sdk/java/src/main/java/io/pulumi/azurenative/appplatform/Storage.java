...
public class Storage extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(StorageArgs.Builder a);
    }
    private static io.pulumi.azurenative.appplatform.StorageArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.appplatform.StorageArgs.builder();
     ...
     */
    public Storage(String name, BuilderApplicator argsBuilder) {
    ...
    public Storage(String name, StorageArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:appplatform:Storage", name, args == null ? StorageArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
