...
public class AssetFilter extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(AssetFilterArgs.Builder a);
    }
    private static io.pulumi.azurenative.media.AssetFilterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.media.AssetFilterArgs.builder();
     ...
     */
    public AssetFilter(String name, BuilderApplicator argsBuilder) {
    ...
    public AssetFilter(String name, AssetFilterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:media:AssetFilter", name, args == null ? AssetFilterArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private AssetFilter(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:media/v20180701:AssetFilter").build()),
                Output.of(Alias.builder().setType("azure-native:media/v20200501:AssetFilter").build()),
                Output.of(Alias.builder().setType("azure-native:media/v20210601:AssetFilter").build())
            ))
            .build();
     ...
     */
    public static AssetFilter get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
