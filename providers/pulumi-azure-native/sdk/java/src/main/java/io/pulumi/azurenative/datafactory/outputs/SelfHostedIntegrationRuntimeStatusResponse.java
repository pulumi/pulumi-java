...
import io.pulumi.azurenative.datafactory.outputs.LinkedIntegrationRuntimeResponse;
import io.pulumi.azurenative.datafactory.outputs.SelfHostedIntegrationRuntimeNodeResponse;
...
public final class SelfHostedIntegrationRuntimeStatusResponse {
    ...
    @OutputCustomType.Constructor({"autoUpdate","autoUpdateETA","capabilities","createTime","dataFactoryName","internalChannelEncryption","latestVersion","links","localTimeZoneOffset","nodes","pushedVersion","scheduledUpdateDate","serviceUrls","state","taskQueueId","type","updateDelayOffset","version","versionStatus"})
