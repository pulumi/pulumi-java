...
public class Channel extends io.pulumi.resources.CustomResource {
    ...
    public Channel(String name) {
        super("azure-native:botservice:Channel", name, ChannelArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:botservice/v20171201:Channel").build()),
                Input.of(Alias.builder().setType("azure-native:botservice/v20180712:Channel").build()),
                Input.of(Alias.builder().setType("azure-native:botservice/v20200602:Channel").build()),
                Input.of(Alias.builder().setType("azure-native:botservice/v20210301:Channel").build()),
                Input.of(Alias.builder().setType("azure-native:botservice/v20210501preview:Channel").build())
            ))
            .build();
