...
public class Channel extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:botservice/v20171201:Channel").build()),
                Output.of(Alias.builder().setType("azure-native:botservice/v20180712:Channel").build()),
                Output.of(Alias.builder().setType("azure-native:botservice/v20200602:Channel").build()),
                Output.of(Alias.builder().setType("azure-native:botservice/v20210301:Channel").build()),
                Output.of(Alias.builder().setType("azure-native:botservice/v20210501preview:Channel").build())
            ))
            .build();
