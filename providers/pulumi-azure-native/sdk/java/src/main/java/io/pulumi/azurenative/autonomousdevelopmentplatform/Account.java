...
public class Account extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.autonomousdevelopmentplatform.AccountArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.autonomousdevelopmentplatform.AccountArgs.builder();
    ...
    public Account(String name, AccountArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:autonomousdevelopmentplatform:Account", name, args == null ? AccountArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:autonomousdevelopmentplatform/v20200701preview:Account").build()),
                Output.of(Alias.builder().setType("azure-native:autonomousdevelopmentplatform/v20210201preview:Account").build()),
                Output.of(Alias.builder().setType("azure-native:autonomousdevelopmentplatform/v20211101preview:Account").build())
            ))
            .build();
