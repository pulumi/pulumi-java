...
public class DataSet extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.datashare.DataSetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.datashare.DataSetArgs.builder();
    ...
    public DataSet(String name, DataSetArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:datashare:DataSet", name, args == null ? DataSetArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:datashare/v20181101preview:DataSet").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20191101:DataSet").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20200901:DataSet").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20201001preview:DataSet").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20210801:DataSet").build())
            ))
            .build();
