...
public class WorkloadNetworkSegment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:avs/v20200717preview:WorkloadNetworkSegment").build()),
                Output.of(Alias.builder().setType("azure-native:avs/v20210101preview:WorkloadNetworkSegment").build()),
                Output.of(Alias.builder().setType("azure-native:avs/v20210601:WorkloadNetworkSegment").build()),
                Output.of(Alias.builder().setType("azure-native:avs/v20211201:WorkloadNetworkSegment").build())
            ))
            .build();
     ...
     */
    public static WorkloadNetworkSegment get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
