...
public class WatchlistItem extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(WatchlistItemArgs.Builder a);
    }
    private static io.pulumi.azurenative.securityinsights.WatchlistItemArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.securityinsights.WatchlistItemArgs.builder();
     ...
     */
    public WatchlistItem(String name, BuilderApplicator argsBuilder) {
