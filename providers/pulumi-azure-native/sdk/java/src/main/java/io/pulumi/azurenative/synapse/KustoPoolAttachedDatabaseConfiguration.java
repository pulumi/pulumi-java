...
public class KustoPoolAttachedDatabaseConfiguration extends io.pulumi.resources.CustomResource {
    ...
    public KustoPoolAttachedDatabaseConfiguration(String name, KustoPoolAttachedDatabaseConfigurationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:synapse:KustoPoolAttachedDatabaseConfiguration", name, args == null ? KustoPoolAttachedDatabaseConfigurationArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:synapse/v20210601preview:KustoPoolAttachedDatabaseConfiguration").build())
            ))
            .build();
