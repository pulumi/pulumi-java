...
public class KustoPoolAttachedDatabaseConfiguration extends io.pulumi.resources.CustomResource {
    ...
    public KustoPoolAttachedDatabaseConfiguration(String name) {
        super("azure-native:synapse:KustoPoolAttachedDatabaseConfiguration", name, KustoPoolAttachedDatabaseConfigurationArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
