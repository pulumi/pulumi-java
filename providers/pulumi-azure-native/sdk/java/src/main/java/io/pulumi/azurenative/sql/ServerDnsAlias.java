...
public class ServerDnsAlias extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ServerDnsAliasArgs.Builder a);
    }
    private static io.pulumi.azurenative.sql.ServerDnsAliasArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.sql.ServerDnsAliasArgs.builder();
     ...
     */
    public ServerDnsAlias(String name, BuilderApplicator argsBuilder) {
