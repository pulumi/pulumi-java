...
public class PrivateEndpointConnection extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:attestation/v20201001:PrivateEndpointConnection").build()),
                Output.of(Alias.builder().setType("azure-native:attestation/v20210601preview:PrivateEndpointConnection").build())
            ))
            .build();
