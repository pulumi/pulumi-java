...
public class ADLSGen2FileSystemDataSetMapping extends io.pulumi.resources.CustomResource {
    ...
    public ADLSGen2FileSystemDataSetMapping(String name, ADLSGen2FileSystemDataSetMappingArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:datashare:ADLSGen2FileSystemDataSetMapping", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private ADLSGen2FileSystemDataSetMapping(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:datashare/v20181101preview:ADLSGen2FileSystemDataSetMapping").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20191101:ADLSGen2FileSystemDataSetMapping").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20200901:ADLSGen2FileSystemDataSetMapping").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20201001preview:ADLSGen2FileSystemDataSetMapping").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20210801:ADLSGen2FileSystemDataSetMapping").build())
            ))
            .build();
     ...
     */
    public static ADLSGen2FileSystemDataSetMapping get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
