...
public class TemplateSpec extends io.pulumi.resources.CustomResource {
    ...
    public TemplateSpec(String name, TemplateSpecArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:resources:TemplateSpec", name, args == null ? TemplateSpecArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private TemplateSpec(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TemplateSpec get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
