 ...
 * 
 */
public final class MarketoObjectDatasetResponse extends io.pulumi.resources.InvokeArgs {

    public static final MarketoObjectDatasetResponse Empty = new MarketoObjectDatasetResponse();
    ...
    public MarketoObjectDatasetResponse(
    ...
    public static final class Builder {
        ...
        public MarketoObjectDatasetResponse build() {
            return new MarketoObjectDatasetResponse(annotations, description, folder, linkedServiceName, parameters, schema, structure, tableName, type);
        }
    }
}
