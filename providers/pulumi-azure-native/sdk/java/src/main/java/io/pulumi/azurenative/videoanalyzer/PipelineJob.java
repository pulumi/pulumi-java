...
public class PipelineJob extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PipelineJobArgs.Builder a);
    }
    private static io.pulumi.azurenative.videoanalyzer.PipelineJobArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.videoanalyzer.PipelineJobArgs.builder();
     ...
     */
    public PipelineJob(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public PipelineJob(String name, PipelineJobArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:videoanalyzer:PipelineJob", name, args == null ? PipelineJobArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private PipelineJob(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:videoanalyzer/v20211101preview:PipelineJob").build())
            ))
            .build();
     ...
     */
    public static PipelineJob get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
