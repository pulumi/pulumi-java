...
public class Account extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.machinelearningexperimentation.AccountArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.machinelearningexperimentation.AccountArgs.builder();
