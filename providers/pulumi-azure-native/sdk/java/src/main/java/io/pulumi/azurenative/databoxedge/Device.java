...
public class Device extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.databoxedge.DeviceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.databoxedge.DeviceArgs.builder();
    ...
    public Device(String name, DeviceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:databoxedge:Device", name, args == null ? DeviceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
