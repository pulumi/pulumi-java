...
public class IntegrationAccountBatchConfiguration extends io.pulumi.resources.CustomResource {
    ...
    public IntegrationAccountBatchConfiguration(String name) {
        super("azure-native:logic:IntegrationAccountBatchConfiguration", name, IntegrationAccountBatchConfigurationArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
