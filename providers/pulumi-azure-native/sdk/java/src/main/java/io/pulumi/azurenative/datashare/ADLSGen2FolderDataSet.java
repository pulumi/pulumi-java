...
public class ADLSGen2FolderDataSet extends io.pulumi.resources.CustomResource {
    ...
    public ADLSGen2FolderDataSet(String name, ADLSGen2FolderDataSetArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:datashare:ADLSGen2FolderDataSet", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private ADLSGen2FolderDataSet(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:datashare/v20181101preview:ADLSGen2FolderDataSet").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20191101:ADLSGen2FolderDataSet").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20200901:ADLSGen2FolderDataSet").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20201001preview:ADLSGen2FolderDataSet").build()),
                Output.of(Alias.builder().setType("azure-native:datashare/v20210801:ADLSGen2FolderDataSet").build())
            ))
            .build();
     ...
     */
    public static ADLSGen2FolderDataSet get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
