...
public class GalleryApplication extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:compute/v20190301:GalleryApplication").build()),
                Output.of(Alias.builder().setType("azure-native:compute/v20190701:GalleryApplication").build()),
                Output.of(Alias.builder().setType("azure-native:compute/v20191201:GalleryApplication").build()),
                Output.of(Alias.builder().setType("azure-native:compute/v20200930:GalleryApplication").build()),
                Output.of(Alias.builder().setType("azure-native:compute/v20210701:GalleryApplication").build())
            ))
            .build();
