...
public class CapacityReservationGroup extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(CapacityReservationGroupArgs.Builder a);
    }
    private static io.pulumi.azurenative.compute.CapacityReservationGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.compute.CapacityReservationGroupArgs.builder();
     ...
     */
    public CapacityReservationGroup(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:compute/v20210401:CapacityReservationGroup").build()),
                Output.of(Alias.builder().setType("azure-native:compute/v20210701:CapacityReservationGroup").build()),
                Output.of(Alias.builder().setType("azure-native:compute/v20211101:CapacityReservationGroup").build())
            ))
            .build();
     ...
     */
    public static CapacityReservationGroup get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
