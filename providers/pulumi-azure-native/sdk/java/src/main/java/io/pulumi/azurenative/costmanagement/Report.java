...
public class Report extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.costmanagement.ReportArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.costmanagement.ReportArgs.builder();
