...
public class EndpointVariant extends io.pulumi.resources.CustomResource {
    ...
    public EndpointVariant(String name, EndpointVariantArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:machinelearningservices:EndpointVariant", name, makeArgs(args), makeResourceOptions(options, Output.empty()));
    }

    private EndpointVariant(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:machinelearningservices/v20200501preview:EndpointVariant").build()),
                Output.of(Alias.builder().setType("azure-native:machinelearningservices/v20200515preview:EndpointVariant").build()),
                Output.of(Alias.builder().setType("azure-native:machinelearningservices/v20200901preview:EndpointVariant").build()),
                Output.of(Alias.builder().setType("azure-native:machinelearningservices/v20210101:EndpointVariant").build()),
                Output.of(Alias.builder().setType("azure-native:machinelearningservices/v20210401:EndpointVariant").build())
            ))
            .build();
     ...
     */
    public static EndpointVariant get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
