...
public class RemediationAtResource extends io.pulumi.resources.CustomResource {
    ...
    public RemediationAtResource(String name, RemediationAtResourceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:policyinsights:RemediationAtResource", name, args == null ? RemediationAtResourceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private RemediationAtResource(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:policyinsights/v20180701preview:RemediationAtResource").build()),
                Output.of(Alias.builder().setType("azure-native:policyinsights/v20190701:RemediationAtResource").build()),
                Output.of(Alias.builder().setType("azure-native:policyinsights/v20211001:RemediationAtResource").build())
            ))
            .build();
     ...
     */
    public static RemediationAtResource get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
