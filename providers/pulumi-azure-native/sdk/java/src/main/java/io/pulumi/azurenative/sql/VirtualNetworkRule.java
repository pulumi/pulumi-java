...
public class VirtualNetworkRule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.sql.VirtualNetworkRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.sql.VirtualNetworkRuleArgs.builder();
    ...
    public VirtualNetworkRule(String name, VirtualNetworkRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:sql:VirtualNetworkRule", name, args == null ? VirtualNetworkRuleArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:sql/v20150501preview:VirtualNetworkRule").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20200202preview:VirtualNetworkRule").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20200801preview:VirtualNetworkRule").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20201101preview:VirtualNetworkRule").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20210201preview:VirtualNetworkRule").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20210501preview:VirtualNetworkRule").build()),
                Output.of(Alias.builder().setType("azure-native:sql/v20210801preview:VirtualNetworkRule").build())
            ))
            .build();
