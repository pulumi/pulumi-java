...
public class RoleDefinition extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RoleDefinitionArgs.Builder a);
    }
    private static io.pulumi.azurenative.authorization.RoleDefinitionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.authorization.RoleDefinitionArgs.builder();
     ...
     */
    public RoleDefinition(String name, BuilderApplicator argsBuilder) {
