...
public class Ledger extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:confidentialledger/v20201201preview:Ledger").build()),
                Output.of(Alias.builder().setType("azure-native:confidentialledger/v20210513preview:Ledger").build())
            ))
            .build();
