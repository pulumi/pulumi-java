...
public class PipelineTopology extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PipelineTopologyArgs.Builder a);
    }
    private static io.pulumi.azurenative.videoanalyzer.PipelineTopologyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.videoanalyzer.PipelineTopologyArgs.builder();
     ...
     */
    public PipelineTopology(String name, BuilderApplicator argsBuilder) {
    ...
    public PipelineTopology(String name, PipelineTopologyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:videoanalyzer:PipelineTopology", name, args == null ? PipelineTopologyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private PipelineTopology(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:videoanalyzer/v20211101preview:PipelineTopology").build())
            ))
            .build();
     ...
     */
    public static PipelineTopology get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
