...
public class BatchEndpoint extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(BatchEndpointArgs.Builder a);
    }
    private static io.pulumi.azurenative.machinelearningservices.BatchEndpointArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.machinelearningservices.BatchEndpointArgs.builder();
     ...
     */
    public BatchEndpoint(String name, BuilderApplicator argsBuilder) {
    ...
    public BatchEndpoint(String name, BatchEndpointArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:machinelearningservices:BatchEndpoint", name, args == null ? BatchEndpointArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private BatchEndpoint(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:machinelearningservices/v20210301preview:BatchEndpoint").build())
            ))
            .build();
     ...
     */
    public static BatchEndpoint get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
