...
public final class AzureDataLakeStoreReadSettingsArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final AzureDataLakeStoreReadSettingsArgs Empty = new AzureDataLakeStoreReadSettingsArgs();
    ...
    private final @Nullable Input<Object> listAfter;

    public Input<Object> getListAfter() {
        return this.listAfter == null ? Input.empty() : this.listAfter;
    }
    ...
    private final @Nullable Input<Object> listBefore;

    public Input<Object> getListBefore() {
        return this.listBefore == null ? Input.empty() : this.listBefore;
    }
    ...
    public AzureDataLakeStoreReadSettingsArgs(
        ...
        @Nullable Input<Object> listAfter,
        @Nullable Input<Object> listBefore,
    ...
    private AzureDataLakeStoreReadSettingsArgs() {
        ...
        this.listAfter = Input.empty();
        this.listBefore = Input.empty();
    ...
    public static Builder builder(AzureDataLakeStoreReadSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<Object> listAfter;
        private @Nullable Input<Object> listBefore;
        ...
        public Builder(AzureDataLakeStoreReadSettingsArgs defaults) {
        ...
        public Builder setListAfter(@Nullable Input<Object> listAfter) {
            this.listAfter = listAfter;
            return this;
        }

        public Builder setListAfter(@Nullable Object listAfter) {
            this.listAfter = Input.ofNullable(listAfter);
            return this;
        }

        public Builder setListBefore(@Nullable Input<Object> listBefore) {
            this.listBefore = listBefore;
            return this;
        }

        public Builder setListBefore(@Nullable Object listBefore) {
            this.listBefore = Input.ofNullable(listBefore);
            return this;
        }
        ...
        public AzureDataLakeStoreReadSettingsArgs build() {
            return new AzureDataLakeStoreReadSettingsArgs(deleteFilesAfterCompletion, disableMetricsCollection, enablePartitionDiscovery, fileListPath, listAfter, listBefore, maxConcurrentConnections, modifiedDatetimeEnd, modifiedDatetimeStart, partitionRootPath, recursive, type, wildcardFileName, wildcardFolderPath);
        }
    }
}
