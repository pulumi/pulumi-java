...
public class OperationalizationCluster extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(OperationalizationClusterArgs.Builder a);
    }
    private static io.pulumi.azurenative.machinelearningcompute.OperationalizationClusterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.machinelearningcompute.OperationalizationClusterArgs.builder();
     ...
     */
    public OperationalizationCluster(String name, BuilderApplicator argsBuilder) {
