...
public class Database extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.dbforpostgresql.DatabaseArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.dbforpostgresql.DatabaseArgs.builder();
    ...
    public Database(String name, DatabaseArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:dbforpostgresql:Database", name, args == null ? DatabaseArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:dbforpostgresql/v20171201:Database").build()),
                Output.of(Alias.builder().setType("azure-native:dbforpostgresql/v20171201preview:Database").build())
            ))
            .build();
