...
public class AttestationProvider extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(AttestationProviderArgs.Builder a);
    }
    private static io.pulumi.azurenative.attestation.AttestationProviderArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.attestation.AttestationProviderArgs.builder();
     ...
     */
    public AttestationProvider(String name, BuilderApplicator argsBuilder) {
