...
public class AzurePowerShellScript extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(AzurePowerShellScriptArgs.Builder a);
    }
    private static io.pulumi.azurenative.resources.AzurePowerShellScriptArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.resources.AzurePowerShellScriptArgs.builder();
     ...
     */
    public AzurePowerShellScript(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:resources/v20191001preview:AzurePowerShellScript").build()),
                Output.of(Alias.builder().setType("azure-native:resources/v20201001:AzurePowerShellScript").build())
            ))
            .build();
