...
public final class HiveSourceArgs extends io.pulumi.resources.ResourceArgs {

    public static final HiveSourceArgs Empty = new HiveSourceArgs();
    ...
    public static Builder builder(HiveSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(HiveSourceArgs defaults) {
        ...
        public HiveSourceArgs build() {
            return new HiveSourceArgs(additionalColumns, disableMetricsCollection, maxConcurrentConnections, query, queryTimeout, sourceRetryCount, sourceRetryWait, type);
        }
    }
}
