...
public final class QueryStringMatchConditionParametersArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="operator", required=true)
      private final Output<Either<String,QueryStringOperator>> operator;

    public Output<Either<String,QueryStringOperator>> getOperator() {
    ...
    public QueryStringMatchConditionParametersArgs(
        ...
        Output<Either<String,QueryStringOperator>> operator,
