...
public class EventGridDataConnection extends io.pulumi.resources.CustomResource {
    ...
    public EventGridDataConnection(String name, EventGridDataConnectionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:synapse:EventGridDataConnection", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:synapse/v20210401preview:EventGridDataConnection").build()),
                Output.of(Alias.builder().type("azure-native:synapse/v20210601preview:EventGridDataConnection").build())
            ))
            .build();
