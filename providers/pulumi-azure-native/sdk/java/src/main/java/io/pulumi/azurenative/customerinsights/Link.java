...
public class Link extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(LinkArgs.Builder a);
    }
    private static io.pulumi.azurenative.customerinsights.LinkArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.customerinsights.LinkArgs.builder();
     ...
     */
    public Link(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:customerinsights/v20170101:Link").build()),
                Output.of(Alias.builder().setType("azure-native:customerinsights/v20170426:Link").build())
            ))
            .build();
