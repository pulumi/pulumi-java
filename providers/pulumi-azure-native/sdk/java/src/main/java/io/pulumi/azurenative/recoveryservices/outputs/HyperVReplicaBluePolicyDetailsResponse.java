...
@CustomType
public final class HyperVReplicaBluePolicyDetailsResponse {
    /**
    ...
    private HyperVReplicaBluePolicyDetailsResponse(
        ...
        @CustomType.Parameter("replicationFrequencyInSeconds") @Nullable Integer replicationFrequencyInSeconds,
