...
public class MediaService extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(MediaServiceArgs.Builder a);
    }
    private static io.pulumi.azurenative.media.MediaServiceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.media.MediaServiceArgs.builder();
     ...
     */
    public MediaService(String name, BuilderApplicator argsBuilder) {
