...
public final class IdentityDataArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="type", required=true)
      private final Input<Either<String,ResourceIdentityType>> type;
    ...
    public IdentityDataArgs(
        Input<Either<String,ResourceIdentityType>> type,
    ...
    public static final class Builder {
        private Input<Either<String,ResourceIdentityType>> type;
        ...
        public Builder setType(Input<Either<String,ResourceIdentityType>> type) {
            this.type = Objects.requireNonNull(type);
            return this;
        }

        public Builder setType(Either<String,ResourceIdentityType> type) {
