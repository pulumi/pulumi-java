...
public class SecretValue extends io.pulumi.resources.CustomResource {
    ...
    public SecretValue(String name, SecretValueArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:servicefabricmesh:SecretValue", name, args == null ? SecretValueArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:servicefabricmesh/v20180901preview:SecretValue").build())
            ))
            .build();
