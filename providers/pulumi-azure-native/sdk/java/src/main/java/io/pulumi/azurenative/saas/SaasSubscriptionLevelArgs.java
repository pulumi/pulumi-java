...
public final class SaasSubscriptionLevelArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setProperties(@Nullable Input<SaasCreationPropertiesArgs> properties) {
            this.properties = properties;
            return this;
        }

        public Builder setProperties(@Nullable SaasCreationPropertiesArgs properties) {
