...
public class RoutingIntent extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RoutingIntentArgs.Builder a);
    }
    private static io.pulumi.azurenative.network.RoutingIntentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.network.RoutingIntentArgs.builder();
     ...
     */
    public RoutingIntent(String name, BuilderApplicator argsBuilder) {
