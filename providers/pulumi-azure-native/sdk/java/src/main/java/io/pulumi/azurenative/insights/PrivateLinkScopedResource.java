...
public class PrivateLinkScopedResource extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:insights/v20191017preview:PrivateLinkScopedResource").build()),
                Output.of(Alias.builder().setType("azure-native:insights/v20210701preview:PrivateLinkScopedResource").build())
            ))
            .build();
