...
public class AzureADMetric extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(AzureADMetricArgs.Builder a);
    }
    private static io.pulumi.azurenative.aadiam.AzureADMetricArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.aadiam.AzureADMetricArgs.builder();
     ...
     */
    public AzureADMetric(String name, BuilderApplicator argsBuilder) {
    ...
    public AzureADMetric(String name, AzureADMetricArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:aadiam:azureADMetric", name, args == null ? AzureADMetricArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private AzureADMetric(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:aadiam/v20200701preview:azureADMetric").build())
            ))
            .build();
     ...
     */
    public static AzureADMetric get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
