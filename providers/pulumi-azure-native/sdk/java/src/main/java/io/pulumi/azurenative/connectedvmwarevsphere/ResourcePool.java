...
class MyStack : Stack
{
    public MyStack()
    {
        var resourcePool = new AzureNative.ConnectedVMwarevSphere.ResourcePool("resourcePool", new AzureNative.ConnectedVMwarevSphere.ResourcePoolArgs
        {
...
This property is used in relative allocation between resource consumers.
    ...
    private ResourcePool(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:connectedvmwarevsphere/v20201001preview:ResourcePool").build())
            ))
            .build();
