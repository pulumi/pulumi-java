...
public class VirtualNetworkRule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.dbformariadb.VirtualNetworkRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.dbformariadb.VirtualNetworkRuleArgs.builder();
    ...
    public VirtualNetworkRule(String name, VirtualNetworkRuleArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:dbformariadb:VirtualNetworkRule", name, args == null ? VirtualNetworkRuleArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Input<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Input.of(Alias.builder().setType("azure-native:dbformariadb/v20180601:VirtualNetworkRule").build()),
                Input.of(Alias.builder().setType("azure-native:dbformariadb/v20180601preview:VirtualNetworkRule").build())
            ))
            .build();
