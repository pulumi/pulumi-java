 ...
 * 
 */
public final class SybaseSourceResponse extends io.pulumi.resources.InvokeArgs {

    public static final SybaseSourceResponse Empty = new SybaseSourceResponse();
