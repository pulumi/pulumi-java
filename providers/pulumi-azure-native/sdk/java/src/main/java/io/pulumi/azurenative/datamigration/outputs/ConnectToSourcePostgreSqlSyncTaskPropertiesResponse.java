...
public final class ConnectToSourcePostgreSqlSyncTaskPropertiesResponse {
    ...
    private ConnectToSourcePostgreSqlSyncTaskPropertiesResponse(
        ...
        @OutputCustomType.Parameter("input") @Nullable ConnectToSourcePostgreSqlSyncTaskInputResponse input,
        @OutputCustomType.Parameter("output") List<ConnectToSourcePostgreSqlSyncTaskOutputResponse> output,
