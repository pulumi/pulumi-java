...
public class PrivateEndpoint extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.streamanalytics.PrivateEndpointArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.streamanalytics.PrivateEndpointArgs.builder();
