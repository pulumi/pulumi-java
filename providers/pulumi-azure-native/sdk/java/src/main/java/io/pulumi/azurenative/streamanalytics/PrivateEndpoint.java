...
public class PrivateEndpoint extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:streamanalytics/v20200301:PrivateEndpoint").build()),
                Output.of(Alias.builder().setType("azure-native:streamanalytics/v20200301preview:PrivateEndpoint").build())
            ))
            .build();
