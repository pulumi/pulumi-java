...
public class DataContainer extends io.pulumi.resources.CustomResource {
    ...
    public DataContainer(String name, DataContainerArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:machinelearningservices:DataContainer", name, args == null ? DataContainerArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private DataContainer(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:machinelearningservices/v20210301preview:DataContainer").build())
            ))
            .build();
     ...
     */
    public static DataContainer get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
