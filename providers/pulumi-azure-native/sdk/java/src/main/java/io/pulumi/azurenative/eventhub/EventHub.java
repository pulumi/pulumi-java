...
public class EventHub extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(EventHubArgs.Builder a);
    }
    private static io.pulumi.azurenative.eventhub.EventHubArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.eventhub.EventHubArgs.builder();
     ...
     */
    public EventHub(String name, BuilderApplicator argsBuilder) {
