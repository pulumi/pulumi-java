...
Expected value is 'AzureMySqlSource'.
    ...
    public static final class Builder {
        ...
        public AzureMySqlSourceArgs build() {
            return new AzureMySqlSourceArgs(additionalColumns, disableMetricsCollection, maxConcurrentConnections, query, queryTimeout, sourceRetryCount, sourceRetryWait, type);
        }
    }
}
