...
public class StreamingJob extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:streamanalytics/v20160301:StreamingJob").build()),
                Output.of(Alias.builder().setType("azure-native:streamanalytics/v20170401preview:StreamingJob").build()),
                Output.of(Alias.builder().setType("azure-native:streamanalytics/v20200301:StreamingJob").build()),
                Output.of(Alias.builder().setType("azure-native:streamanalytics/v20211001preview:StreamingJob").build())
            ))
            .build();
