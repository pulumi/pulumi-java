...
public class Monitor extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(MonitorArgs.Builder a);
    }
    private static io.pulumi.azurenative.logz.MonitorArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.logz.MonitorArgs.builder();
     ...
     */
    public Monitor(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:logz/v20201001:Monitor").build()),
                Output.of(Alias.builder().setType("azure-native:logz/v20201001preview:Monitor").build()),
                Output.of(Alias.builder().setType("azure-native:logz/v20220101preview:Monitor").build())
            ))
            .build();
