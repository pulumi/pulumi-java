...
class MyStack : Stack
{
    public MyStack()
    {
        var privateEndpointConnectionsForEDM = new AzureNative.SecurityAndCompliance.PrivateEndpointConnectionsForEDM("privateEndpointConnectionsForEDM", new AzureNative.SecurityAndCompliance.PrivateEndpointConnectionsForEDMArgs
        {
