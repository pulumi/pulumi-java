...
public class PrivateEndpointConnectionsForEDM extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsForEDM").build()),
                Output.of(Alias.builder().setType("azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsForEDM").build())
            ))
            .build();
