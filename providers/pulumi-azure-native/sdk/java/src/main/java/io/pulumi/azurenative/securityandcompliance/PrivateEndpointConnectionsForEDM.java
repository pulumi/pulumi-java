...
public class PrivateEndpointConnectionsForEDM extends io.pulumi.resources.CustomResource {
    ...
    public PrivateEndpointConnectionsForEDM(String name) {
        super("azure-native:securityandcompliance:PrivateEndpointConnectionsForEDM", name, PrivateEndpointConnectionsForEDMArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
