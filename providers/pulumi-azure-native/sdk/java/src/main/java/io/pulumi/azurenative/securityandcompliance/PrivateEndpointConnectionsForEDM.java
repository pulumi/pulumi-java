...
public class PrivateEndpointConnectionsForEDM extends io.pulumi.resources.CustomResource {
    ...
    public PrivateEndpointConnectionsForEDM(String name, PrivateEndpointConnectionsForEDMArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:securityandcompliance:PrivateEndpointConnectionsForEDM", name, args == null ? PrivateEndpointConnectionsForEDMArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsForEDM").build()),
                Output.of(Alias.builder().type("azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsForEDM").build())
            ))
            .build();
