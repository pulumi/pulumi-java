...
public class CustomLocation extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:extendedlocation/v20210315preview:CustomLocation").build()),
                Output.of(Alias.builder().setType("azure-native:extendedlocation/v20210815:CustomLocation").build())
            ))
            .build();
