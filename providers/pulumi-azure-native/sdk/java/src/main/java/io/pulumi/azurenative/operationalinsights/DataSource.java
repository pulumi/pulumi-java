...
public class DataSource extends io.pulumi.resources.CustomResource {
    ...
    public DataSource(String name, DataSourceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:operationalinsights:DataSource", name, args == null ? DataSourceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:operationalinsights/v20151101preview:DataSource").build()),
                Output.of(Alias.builder().setType("azure-native:operationalinsights/v20200301preview:DataSource").build()),
                Output.of(Alias.builder().setType("azure-native:operationalinsights/v20200801:DataSource").build())
            ))
            .build();
