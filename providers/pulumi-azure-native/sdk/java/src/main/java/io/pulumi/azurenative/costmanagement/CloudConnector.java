...
public class CloudConnector extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:costmanagement/v20180801preview:CloudConnector").build()),
                Output.of(Alias.builder().setType("azure-native:costmanagement/v20190301preview:CloudConnector").build())
            ))
            .build();
     ...
     */
    public static CloudConnector get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
