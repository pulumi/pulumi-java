...
public class Factory extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:datafactory/v20170901preview:Factory").build()),
                Output.of(Alias.builder().setType("azure-native:datafactory/v20180601:Factory").build())
            ))
            .build();
     ...
     */
    public static Factory get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
