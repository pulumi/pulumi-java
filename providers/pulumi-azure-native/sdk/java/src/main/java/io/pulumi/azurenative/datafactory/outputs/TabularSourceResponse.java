...
@OutputCustomType
public final class TabularSourceResponse {
    /**
    ...
    @OutputCustomType.Constructor({"additionalColumns","disableMetricsCollection","maxConcurrentConnections","queryTimeout","sourceRetryCount","sourceRetryWait","type"})
