...
public final class SapOpenHubTableDatasetResponse {
    ...
    @OutputCustomType.Constructor({"annotations","baseRequestId","description","excludeLastRequest","folder","linkedServiceName","openHubDestinationName","parameters","schema","structure","type"})
