...
public class PrivateEndpointConnectionsAdtAPI extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.azurenative.m365securityandcompliance.PrivateEndpointConnectionsAdtAPIArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.m365securityandcompliance.PrivateEndpointConnectionsAdtAPIArgs.builder();
    ...
    public PrivateEndpointConnectionsAdtAPI(String name, PrivateEndpointConnectionsAdtAPIArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:m365securityandcompliance:PrivateEndpointConnectionsAdtAPI", name, args == null ? PrivateEndpointConnectionsAdtAPIArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsAdtAPI").build())
            ))
            .build();
