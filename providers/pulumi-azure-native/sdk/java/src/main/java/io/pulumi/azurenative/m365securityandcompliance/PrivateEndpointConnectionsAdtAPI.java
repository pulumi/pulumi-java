...
public class PrivateEndpointConnectionsAdtAPI extends io.pulumi.resources.CustomResource {
    ...
    public PrivateEndpointConnectionsAdtAPI(String name) {
        super("azure-native:m365securityandcompliance:PrivateEndpointConnectionsAdtAPI", name, PrivateEndpointConnectionsAdtAPIArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
