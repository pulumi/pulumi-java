 ...
 * 
 */
public final class SqlServerTableDatasetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public SqlServerTableDatasetArgs build() {
            return new SqlServerTableDatasetArgs(annotations, description, folder, linkedServiceName, parameters, schema, structure, table, tableName, type);
        }
    }
}
