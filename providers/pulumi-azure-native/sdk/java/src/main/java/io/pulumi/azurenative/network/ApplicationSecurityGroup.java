...
public class ApplicationSecurityGroup extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ApplicationSecurityGroupArgs.Builder a);
    }
    private static io.pulumi.azurenative.network.ApplicationSecurityGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.network.ApplicationSecurityGroupArgs.builder();
     ...
     */
    public ApplicationSecurityGroup(String name, BuilderApplicator argsBuilder) {
