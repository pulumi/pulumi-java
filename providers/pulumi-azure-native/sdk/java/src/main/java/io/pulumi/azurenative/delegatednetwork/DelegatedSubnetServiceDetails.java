...
public class DelegatedSubnetServiceDetails extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(DelegatedSubnetServiceDetailsArgs.Builder a);
    }
    private static io.pulumi.azurenative.delegatednetwork.DelegatedSubnetServiceDetailsArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.azurenative.delegatednetwork.DelegatedSubnetServiceDetailsArgs.builder();
     ...
     */
    public DelegatedSubnetServiceDetails(String name, BuilderApplicator argsBuilder) {
    ...
    private static io.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable io.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = io.pulumi.resources.CustomResourceOptions.builder()
            ...
            .setAliases(List.of(
                Output.of(Alias.builder().setType("azure-native:delegatednetwork/v20200808preview:DelegatedSubnetServiceDetails").build()),
                Output.of(Alias.builder().setType("azure-native:delegatednetwork/v20210315:DelegatedSubnetServiceDetails").build())
            ))
            .build();
