...
public class DataMaskingPolicy extends CustomResource {
    /**
     ...
     */
    public DataMaskingPolicy(String name, DataMaskingPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DataMaskingPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DataMaskingPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
