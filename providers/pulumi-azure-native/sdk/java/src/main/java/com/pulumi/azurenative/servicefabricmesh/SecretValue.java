...
public class SecretValue extends CustomResource {
    /**
     ...
     */
    public SecretValue(String name, SecretValueArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SecretValue(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SecretValue get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
