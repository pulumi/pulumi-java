...
public class NetworkGroup extends CustomResource {
    /**
     ...
     */
    public NetworkGroup(String name, NetworkGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NetworkGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
