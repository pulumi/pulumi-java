...
import com.pulumi.azurenative.botservice.inputs.DirectLineChannelPropertiesArgs;
 ...
 * 
 */
public final class DirectLineChannelArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<DirectLineChannelPropertiesArgs>> properties() {
        return Optional.ofNullable(this.properties);
    }

    private DirectLineChannelArgs() {}

    private DirectLineChannelArgs(DirectLineChannelArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DirectLineChannelArgs();
        }

        public Builder(DirectLineChannelArgs defaults) {
            $ = new DirectLineChannelArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder properties(DirectLineChannelPropertiesArgs properties) {
