...
public class LongTermRetentionPolicy extends CustomResource {
    /**
     ...
     */
    public LongTermRetentionPolicy(String name, LongTermRetentionPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LongTermRetentionPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LongTermRetentionPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
