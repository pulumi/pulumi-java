 ...
 * 
 */
public final class AzureDataExplorerSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<Object>> noTruncation() {
    ...
    private AzureDataExplorerSourceArgs(AzureDataExplorerSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureDataExplorerSourceArgs();
        }

        public Builder(AzureDataExplorerSourceArgs defaults) {
            $ = new AzureDataExplorerSourceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder noTruncation(Object noTruncation) {
            return noTruncation(Output.of(noTruncation));
        }
