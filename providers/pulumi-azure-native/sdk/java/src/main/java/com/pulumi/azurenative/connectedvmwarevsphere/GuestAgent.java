...
public class GuestAgent extends CustomResource {
    /**
     ...
     */
    public GuestAgent(String name, GuestAgentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GuestAgent(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GuestAgent get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
