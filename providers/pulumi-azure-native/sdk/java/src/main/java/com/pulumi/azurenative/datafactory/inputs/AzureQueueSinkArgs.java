 ...
 * 
 */
public final class AzureQueueSinkArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzureQueueSinkArgs(AzureQueueSinkArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureQueueSinkArgs();
        }

        public Builder(AzureQueueSinkArgs defaults) {
            $ = new AzureQueueSinkArgs(Objects.requireNonNull(defaults));
        }
