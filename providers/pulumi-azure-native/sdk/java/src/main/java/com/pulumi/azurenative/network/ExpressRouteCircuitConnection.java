...
public class ExpressRouteCircuitConnection extends CustomResource {
    /**
     ...
     */
    public ExpressRouteCircuitConnection(String name, ExpressRouteCircuitConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ExpressRouteCircuitConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ExpressRouteCircuitConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
