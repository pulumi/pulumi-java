...
public class AdaptiveApplicationControl extends CustomResource {
    /**
     ...
     */
    public AdaptiveApplicationControl(String name, AdaptiveApplicationControlArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AdaptiveApplicationControl(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AdaptiveApplicationControl get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
