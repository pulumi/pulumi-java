...
import com.pulumi.azurenative.hybridcompute.outputs.MachineExtensionPropertiesResponseInstanceView;
...
public class MachineExtension extends CustomResource {
    /**
     ...
     */
    public MachineExtension(String name, MachineExtensionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MachineExtension(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MachineExtension get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
