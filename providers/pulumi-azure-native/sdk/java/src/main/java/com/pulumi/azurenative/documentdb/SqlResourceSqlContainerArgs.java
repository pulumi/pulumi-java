...
public final class SqlResourceSqlContainerArgs extends ResourceArgs {
    ...
    /**
     * @return The standard JSON format of a container
     * 
     */
    ...
    private SqlResourceSqlContainerArgs(SqlResourceSqlContainerArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(SqlResourceSqlContainerArgs defaults) {
            $ = new SqlResourceSqlContainerArgs(Objects.requireNonNull(defaults));
        }
