...
public class RegisteredAsn extends CustomResource {
    /**
     ...
     */
    public RegisteredAsn(String name, RegisteredAsnArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegisteredAsn(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegisteredAsn get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
