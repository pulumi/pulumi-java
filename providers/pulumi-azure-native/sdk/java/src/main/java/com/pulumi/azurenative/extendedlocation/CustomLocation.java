...
public class CustomLocation extends CustomResource {
    /**
     ...
     */
    public CustomLocation(String name, CustomLocationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CustomLocation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomLocation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
