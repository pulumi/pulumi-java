...
public class WorkloadNetworkDnsZone extends CustomResource {
    /**
     ...
     */
    public WorkloadNetworkDnsZone(String name, WorkloadNetworkDnsZoneArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WorkloadNetworkDnsZone(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkloadNetworkDnsZone get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
