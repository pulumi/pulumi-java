...
public class SubAccount extends CustomResource {
    ...
    private SubAccount(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SubAccount get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
