 ...
 * 
 */
public final class SparkSourceResponse extends com.pulumi.resources.InvokeArgs {

    public static final SparkSourceResponse Empty = new SparkSourceResponse();
    ...
    private SparkSourceResponse(SparkSourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SparkSourceResponse();
        }

        public Builder(SparkSourceResponse defaults) {
            $ = new SparkSourceResponse(Objects.requireNonNull(defaults));
        }
