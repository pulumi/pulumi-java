...
public class Workspace extends CustomResource {
     ...
     */
    public Workspace(String name, WorkspaceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Workspace(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Workspace get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
