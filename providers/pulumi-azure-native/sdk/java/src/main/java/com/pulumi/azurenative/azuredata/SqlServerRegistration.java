...
public class SqlServerRegistration extends CustomResource {
    /**
     ...
     */
    public SqlServerRegistration(String name, SqlServerRegistrationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SqlServerRegistration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SqlServerRegistration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
