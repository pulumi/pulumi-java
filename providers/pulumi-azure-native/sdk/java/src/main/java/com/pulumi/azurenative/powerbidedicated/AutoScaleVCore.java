...
public class AutoScaleVCore extends CustomResource {
    /**
     ...
     */
    public AutoScaleVCore(String name, AutoScaleVCoreArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AutoScaleVCore(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AutoScaleVCore get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
