...
public final class GetManagerDevicePublicEncryptionKeyArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetManagerDevicePublicEncryptionKeyArgs(GetManagerDevicePublicEncryptionKeyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetManagerDevicePublicEncryptionKeyArgs();
        }

        public Builder(GetManagerDevicePublicEncryptionKeyArgs defaults) {
            $ = new GetManagerDevicePublicEncryptionKeyArgs(Objects.requireNonNull(defaults));
        }
