...
public class IncidentRelation extends CustomResource {
    /**
     ...
     */
    public IncidentRelation(String name, IncidentRelationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IncidentRelation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IncidentRelation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
