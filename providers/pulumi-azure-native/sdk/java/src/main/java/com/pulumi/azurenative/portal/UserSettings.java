...
public class UserSettings extends com.pulumi.resources.CustomResource {
    ...
    private UserSettings(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static UserSettings get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
