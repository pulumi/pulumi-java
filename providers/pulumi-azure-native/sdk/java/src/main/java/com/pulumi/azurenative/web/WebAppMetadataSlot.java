...
public class WebAppMetadataSlot extends CustomResource {
    /**
     * Kind of resource.
     * 
     */
     ...
     */
    public WebAppMetadataSlot(String name, WebAppMetadataSlotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppMetadataSlot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppMetadataSlot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
