...
public class ClusterPrincipalAssignment extends CustomResource {
    /**
     ...
     */
    public ClusterPrincipalAssignment(String name, ClusterPrincipalAssignmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ClusterPrincipalAssignment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ClusterPrincipalAssignment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
