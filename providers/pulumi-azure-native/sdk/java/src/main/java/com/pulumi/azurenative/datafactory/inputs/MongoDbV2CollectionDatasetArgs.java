 ...
 * 
 */
public final class MongoDbV2CollectionDatasetArgs extends ResourceArgs {
    ...
    private MongoDbV2CollectionDatasetArgs(MongoDbV2CollectionDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MongoDbV2CollectionDatasetArgs();
        }

        public Builder(MongoDbV2CollectionDatasetArgs defaults) {
            $ = new MongoDbV2CollectionDatasetArgs(Objects.requireNonNull(defaults));
        }
