...
public class HcxEnterpriseSite extends CustomResource {
    /**
     * The activation key
     * 
     */
     ...
     */
    public HcxEnterpriseSite(String name, HcxEnterpriseSiteArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HcxEnterpriseSite(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HcxEnterpriseSite get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
