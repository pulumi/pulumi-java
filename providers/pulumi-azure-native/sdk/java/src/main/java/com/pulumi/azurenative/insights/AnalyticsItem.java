...
public class AnalyticsItem extends CustomResource {
    /**
     ...
     */
    public AnalyticsItem(String name, AnalyticsItemArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AnalyticsItem(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AnalyticsItem get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
