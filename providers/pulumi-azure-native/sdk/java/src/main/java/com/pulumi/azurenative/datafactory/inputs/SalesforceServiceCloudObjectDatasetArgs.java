 ...
 * 
 */
public final class SalesforceServiceCloudObjectDatasetArgs extends ResourceArgs {
     ...
     * 
     */
    public Optional<Output<Object>> objectApiName() {
    ...
    private SalesforceServiceCloudObjectDatasetArgs(SalesforceServiceCloudObjectDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SalesforceServiceCloudObjectDatasetArgs();
        }

        public Builder(SalesforceServiceCloudObjectDatasetArgs defaults) {
            $ = new SalesforceServiceCloudObjectDatasetArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param objectApiName The Salesforce Service Cloud object API name. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder objectApiName(Object objectApiName) {
            return objectApiName(Output.of(objectApiName));
        }
