...
public final class ListWebAppPublishingCredentialsSlotArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private ListWebAppPublishingCredentialsSlotArgs(ListWebAppPublishingCredentialsSlotArgs $) {
        this.name = $.name;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListWebAppPublishingCredentialsSlotArgs();
        }

        public Builder(ListWebAppPublishingCredentialsSlotArgs defaults) {
            $ = new ListWebAppPublishingCredentialsSlotArgs(Objects.requireNonNull(defaults));
        }
