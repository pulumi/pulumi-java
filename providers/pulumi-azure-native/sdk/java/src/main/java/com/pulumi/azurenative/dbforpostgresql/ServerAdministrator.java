...
public class ServerAdministrator extends CustomResource {
    /**
     ...
     */
    public ServerAdministrator(String name, ServerAdministratorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServerAdministrator(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServerAdministrator get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
