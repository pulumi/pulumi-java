...
public class DataFlow extends CustomResource {
    /**
     ...
     */
    public DataFlow(String name, DataFlowArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datafactory:DataFlow", name, args == null ? DataFlowArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DataFlow(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DataFlow get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
