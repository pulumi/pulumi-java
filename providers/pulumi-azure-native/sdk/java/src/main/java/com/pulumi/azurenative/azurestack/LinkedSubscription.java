...
public class LinkedSubscription extends CustomResource {
    /**
     ...
     */
    public LinkedSubscription(String name, LinkedSubscriptionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LinkedSubscription(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LinkedSubscription get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
