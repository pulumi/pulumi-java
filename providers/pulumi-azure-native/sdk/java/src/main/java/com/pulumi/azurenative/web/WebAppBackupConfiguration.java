...
public class WebAppBackupConfiguration extends CustomResource {
    /**
     * Name of the backup.
     * 
     */
     ...
     */
    public WebAppBackupConfiguration(String name, WebAppBackupConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppBackupConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppBackupConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
