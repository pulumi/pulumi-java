...
public class PrivateLinkServicePrivateEndpointConnection extends CustomResource {
    /**
     ...
     */
    public PrivateLinkServicePrivateEndpointConnection(String name, PrivateLinkServicePrivateEndpointConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateLinkServicePrivateEndpointConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateLinkServicePrivateEndpointConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
