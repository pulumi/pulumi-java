...
public final class ManagedServiceIdentityArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="type")
      private final @Nullable Output<ManagedServiceIdentityType> type;

    public Output<ManagedServiceIdentityType> getType() {
    ...
    public ManagedServiceIdentityArgs(
        @Nullable Output<ManagedServiceIdentityType> type,
    ...
    public static final class Builder {
        ...
        public Builder type(@Nullable ManagedServiceIdentityType type) {
