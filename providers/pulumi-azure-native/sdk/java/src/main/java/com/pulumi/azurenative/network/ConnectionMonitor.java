...
public class ConnectionMonitor extends CustomResource {
    /**
     ...
     */
    public ConnectionMonitor(String name, ConnectionMonitorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConnectionMonitor(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConnectionMonitor get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
