...
public class RegisteredServer extends CustomResource {
    /**
     ...
     */
    public RegisteredServer(String name, RegisteredServerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegisteredServer(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegisteredServer get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
