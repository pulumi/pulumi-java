...
public class JobDefinition extends CustomResource {
    /**
     ...
     */
    public JobDefinition(String name, JobDefinitionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private JobDefinition(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static JobDefinition get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
