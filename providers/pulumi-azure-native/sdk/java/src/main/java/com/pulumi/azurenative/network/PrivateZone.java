...
public class PrivateZone extends CustomResource {
    /**
     ...
     */
    public PrivateZone(String name, PrivateZoneArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateZone(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateZone get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
