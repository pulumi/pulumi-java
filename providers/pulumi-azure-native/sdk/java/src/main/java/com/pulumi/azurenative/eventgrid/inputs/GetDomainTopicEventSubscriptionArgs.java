...
public final class GetDomainTopicEventSubscriptionArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainTopicEventSubscriptionArgs Empty = new GetDomainTopicEventSubscriptionArgs();
    ...
    private GetDomainTopicEventSubscriptionArgs() {}

    private GetDomainTopicEventSubscriptionArgs(GetDomainTopicEventSubscriptionArgs $) {
    ...
    public static Builder builder(GetDomainTopicEventSubscriptionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainTopicEventSubscriptionArgs();
        }

        public Builder(GetDomainTopicEventSubscriptionArgs defaults) {
            $ = new GetDomainTopicEventSubscriptionArgs(Objects.requireNonNull(defaults));
        }
