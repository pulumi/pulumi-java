...
public class ExtendedDatabaseBlobAuditingPolicy extends CustomResource {
    /**
     ...
     */
    public ExtendedDatabaseBlobAuditingPolicy(String name, ExtendedDatabaseBlobAuditingPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ExtendedDatabaseBlobAuditingPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ExtendedDatabaseBlobAuditingPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
