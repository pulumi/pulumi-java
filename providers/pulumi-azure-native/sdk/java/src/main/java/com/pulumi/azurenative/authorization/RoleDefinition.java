...
public class RoleDefinition extends CustomResource {
    /**
     ...
     */
    public RoleDefinition(String name, RoleDefinitionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RoleDefinition(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RoleDefinition get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
