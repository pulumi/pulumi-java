...
public class ServiceRegistry extends CustomResource {
    /**
     ...
     */
    public ServiceRegistry(String name, ServiceRegistryArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceRegistry(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceRegistry get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
