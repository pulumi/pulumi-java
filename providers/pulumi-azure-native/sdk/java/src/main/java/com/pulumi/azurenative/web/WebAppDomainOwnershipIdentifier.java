...
public class WebAppDomainOwnershipIdentifier extends CustomResource {
    /**
     * Kind of resource.
     * 
     */
     ...
     */
    public WebAppDomainOwnershipIdentifier(String name, WebAppDomainOwnershipIdentifierArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppDomainOwnershipIdentifier(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppDomainOwnershipIdentifier get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
