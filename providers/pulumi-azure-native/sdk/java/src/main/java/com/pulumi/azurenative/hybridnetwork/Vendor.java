...
public class Vendor extends CustomResource {
    /**
     ...
     */
    public Vendor(String name, @Nullable VendorArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:hybridnetwork:Vendor", name, args == null ? VendorArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Vendor(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Vendor get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
