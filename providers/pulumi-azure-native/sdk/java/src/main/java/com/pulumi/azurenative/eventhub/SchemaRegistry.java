...
public class SchemaRegistry extends CustomResource {
     ...
     */
    public SchemaRegistry(String name, SchemaRegistryArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SchemaRegistry(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SchemaRegistry get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
