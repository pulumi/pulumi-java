...
public final class AzureDatabricksDeltaLakeSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="exportSettings")
      private final @Nullable Output<AzureDatabricksDeltaLakeExportCommandArgs> exportSettings;

    public Output<AzureDatabricksDeltaLakeExportCommandArgs> getExportSettings() {
    ...
    public AzureDatabricksDeltaLakeSourceArgs(
        ...
        @Nullable Output<AzureDatabricksDeltaLakeExportCommandArgs> exportSettings,
