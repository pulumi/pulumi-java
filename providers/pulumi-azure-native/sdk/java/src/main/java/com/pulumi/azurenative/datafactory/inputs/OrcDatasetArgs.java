 ...
 * 
 */
public final class OrcDatasetArgs extends ResourceArgs {
    ...
    /**
     * @return The location of the ORC data storage.
     * 
     */
    ...
    /**
     * @return The data orcCompressionCodec. Type: string (or Expression with resultType string).
     * 
     */
    public Optional<Output<Object>> orcCompressionCodec() {
    ...
    private OrcDatasetArgs(OrcDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(OrcDatasetArgs defaults) {
            $ = new OrcDatasetArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param orcCompressionCodec The data orcCompressionCodec. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder orcCompressionCodec(Object orcCompressionCodec) {
            return orcCompressionCodec(Output.of(orcCompressionCodec));
        }
