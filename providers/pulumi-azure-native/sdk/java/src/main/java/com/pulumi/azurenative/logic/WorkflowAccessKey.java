...
public class WorkflowAccessKey extends CustomResource {
    /**
     ...
     */
    public WorkflowAccessKey(String name, WorkflowAccessKeyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WorkflowAccessKey(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkflowAccessKey get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
