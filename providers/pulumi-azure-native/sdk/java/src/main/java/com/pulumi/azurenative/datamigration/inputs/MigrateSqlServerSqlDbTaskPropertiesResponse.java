...
public final class MigrateSqlServerSqlDbTaskPropertiesResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private MigrateSqlServerSqlDbTaskPropertiesResponse(MigrateSqlServerSqlDbTaskPropertiesResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MigrateSqlServerSqlDbTaskPropertiesResponse();
        }

        public Builder(MigrateSqlServerSqlDbTaskPropertiesResponse defaults) {
            $ = new MigrateSqlServerSqlDbTaskPropertiesResponse(Objects.requireNonNull(defaults));
        }
