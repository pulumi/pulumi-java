...
public class InventoryItem extends CustomResource {
    /**
     * They inventory type.
     * 
     */
     ...
     */
    public InventoryItem(String name, InventoryItemArgs args, @Nullable CustomResourceOptions options) {
    ...
    private InventoryItem(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static InventoryItem get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
