 ...
 * 
 */
public final class MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputArgs(MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputArgs();
        }
