...
public class TemplateSpec extends CustomResource {
    /**
     ...
     */
    public TemplateSpec(String name, TemplateSpecArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TemplateSpec(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TemplateSpec get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
