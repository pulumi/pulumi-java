...
public class RedisEnterprise extends CustomResource {
    /**
     ...
     */
    public RedisEnterprise(String name, RedisEnterpriseArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RedisEnterprise(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RedisEnterprise get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
