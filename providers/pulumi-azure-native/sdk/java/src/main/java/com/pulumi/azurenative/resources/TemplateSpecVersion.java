...
public class TemplateSpecVersion extends CustomResource {
    /**
     ...
     */
    public TemplateSpecVersion(String name, TemplateSpecVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TemplateSpecVersion(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TemplateSpecVersion get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
