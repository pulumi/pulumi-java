...
public class Database extends com.pulumi.resources.CustomResource {
    ...
    public Database(String name, DatabaseArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:dbformariadb:Database", name, args == null ? DatabaseArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:dbformariadb/v20180601:Database").build()),
                Output.of(Alias.builder().type("azure-native:dbformariadb/v20180601preview:Database").build())
            ))
            .build();
