...
public final class DocumentDbCollectionSourceResponse {
    ...
    /**
     * @return Nested properties separator. Type: string (or Expression with resultType string).
     * 
     */
    private final @Nullable Object nestingSeparator;
    /**
     * @return Documents query. Type: string (or Expression with resultType string).
     * 
     */
