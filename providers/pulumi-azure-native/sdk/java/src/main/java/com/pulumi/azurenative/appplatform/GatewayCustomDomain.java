...
public class GatewayCustomDomain extends CustomResource {
    /**
     ...
     */
    public GatewayCustomDomain(String name, GatewayCustomDomainArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GatewayCustomDomain(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GatewayCustomDomain get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
