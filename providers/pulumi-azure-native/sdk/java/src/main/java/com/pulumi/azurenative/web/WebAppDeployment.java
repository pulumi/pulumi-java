...
public class WebAppDeployment extends CustomResource {
    /**
     ...
     */
    public WebAppDeployment(String name, WebAppDeploymentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppDeployment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppDeployment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
