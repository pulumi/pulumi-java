...
public class TagByProduct extends CustomResource {
    /**
     * Tag name.
     * 
     */
     ...
     */
    public TagByProduct(String name, TagByProductArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TagByProduct(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TagByProduct get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
