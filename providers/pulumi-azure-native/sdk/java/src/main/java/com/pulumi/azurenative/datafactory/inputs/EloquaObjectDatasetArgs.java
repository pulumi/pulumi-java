 ...
 * 
 */
public final class EloquaObjectDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EloquaObjectDatasetArgs(EloquaObjectDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EloquaObjectDatasetArgs();
        }

        public Builder(EloquaObjectDatasetArgs defaults) {
            $ = new EloquaObjectDatasetArgs(Objects.requireNonNull(defaults));
        }
