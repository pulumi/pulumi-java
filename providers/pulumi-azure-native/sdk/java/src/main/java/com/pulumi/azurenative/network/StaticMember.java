...
public class StaticMember extends CustomResource {
    /**
     ...
     */
    public StaticMember(String name, StaticMemberArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StaticMember(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StaticMember get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
