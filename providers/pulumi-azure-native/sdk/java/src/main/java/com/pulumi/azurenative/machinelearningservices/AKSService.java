...
public class AKSService extends CustomResource {
    /**
     ...
     */
    public AKSService(String name, AKSServiceArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:machinelearningservices:AKSService", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private AKSService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AKSService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
