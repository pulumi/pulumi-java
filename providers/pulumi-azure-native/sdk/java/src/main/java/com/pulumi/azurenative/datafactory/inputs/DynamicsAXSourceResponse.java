 ...
 * 
 */
public final class DynamicsAXSourceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private DynamicsAXSourceResponse(DynamicsAXSourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DynamicsAXSourceResponse();
        }

        public Builder(DynamicsAXSourceResponse defaults) {
            $ = new DynamicsAXSourceResponse(Objects.requireNonNull(defaults));
        }
