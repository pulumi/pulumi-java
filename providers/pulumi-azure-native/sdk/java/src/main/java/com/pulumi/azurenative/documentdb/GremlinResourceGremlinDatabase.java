...
public class GremlinResourceGremlinDatabase extends CustomResource {
    /**
     ...
     */
    public GremlinResourceGremlinDatabase(String name, GremlinResourceGremlinDatabaseArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GremlinResourceGremlinDatabase(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GremlinResourceGremlinDatabase get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
