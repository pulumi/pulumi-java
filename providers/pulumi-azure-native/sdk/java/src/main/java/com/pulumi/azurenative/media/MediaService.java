...
public class MediaService extends CustomResource {
    /**
     ...
     */
    public MediaService(String name, MediaServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MediaService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MediaService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
