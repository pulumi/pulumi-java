...
public class RulesEngine extends CustomResource {
    /**
     * Resource name.
     * 
     */
     ...
     */
    public RulesEngine(String name, RulesEngineArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RulesEngine(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RulesEngine get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
