...
public class WebAppSiteExtensionSlot extends CustomResource {
    /**
     * List of authors.
     * 
     */
     ...
     */
    public WebAppSiteExtensionSlot(String name, WebAppSiteExtensionSlotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppSiteExtensionSlot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppSiteExtensionSlot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
