...
public class CustomResourceProvider extends CustomResource {
    /**
     ...
     */
    public CustomResourceProvider(String name, CustomResourceProviderArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CustomResourceProvider(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomResourceProvider get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
