...
public class DedicatedCloudNode extends CustomResource {
    /**
     ...
     */
    public DedicatedCloudNode(String name, DedicatedCloudNodeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DedicatedCloudNode(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DedicatedCloudNode get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
