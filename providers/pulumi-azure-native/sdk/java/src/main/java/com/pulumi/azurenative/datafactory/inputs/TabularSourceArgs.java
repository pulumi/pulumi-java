 ...
 * 
 */
public final class TabularSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TabularSourceArgs(TabularSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TabularSourceArgs();
        }

        public Builder(TabularSourceArgs defaults) {
            $ = new TabularSourceArgs(Objects.requireNonNull(defaults));
        }
