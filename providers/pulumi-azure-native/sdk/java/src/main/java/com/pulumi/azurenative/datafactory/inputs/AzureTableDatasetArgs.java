 ...
 * 
 */
public final class AzureTableDatasetArgs extends ResourceArgs {
    ...
    private AzureTableDatasetArgs(AzureTableDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureTableDatasetArgs();
        }

        public Builder(AzureTableDatasetArgs defaults) {
            $ = new AzureTableDatasetArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param tableName The table name of the Azure Table storage. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
