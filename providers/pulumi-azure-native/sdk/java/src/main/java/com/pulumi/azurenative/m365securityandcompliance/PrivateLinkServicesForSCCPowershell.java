...
public class PrivateLinkServicesForSCCPowershell extends CustomResource {
    /**
     ...
     */
    public PrivateLinkServicesForSCCPowershell(String name, PrivateLinkServicesForSCCPowershellArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateLinkServicesForSCCPowershell(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateLinkServicesForSCCPowershell get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
