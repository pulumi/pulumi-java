...
public class NatRule extends CustomResource {
    /**
     ...
     */
    public NatRule(String name, NatRuleArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:network:NatRule", name, args == null ? NatRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private NatRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NatRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
