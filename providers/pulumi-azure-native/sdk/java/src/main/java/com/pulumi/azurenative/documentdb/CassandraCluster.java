...
public class CassandraCluster extends CustomResource {
    /**
     ...
     */
    public CassandraCluster(String name, CassandraClusterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CassandraCluster(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CassandraCluster get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
