...
public class MSIXPackage extends CustomResource {
    /**
     ...
     */
    public MSIXPackage(String name, MSIXPackageArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MSIXPackage(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MSIXPackage get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
