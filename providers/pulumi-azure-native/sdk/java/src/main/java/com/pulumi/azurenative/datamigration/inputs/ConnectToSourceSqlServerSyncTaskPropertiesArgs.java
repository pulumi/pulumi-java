...
public final class ConnectToSourceSqlServerSyncTaskPropertiesArgs extends ResourceArgs {
    ...
    private ConnectToSourceSqlServerSyncTaskPropertiesArgs(ConnectToSourceSqlServerSyncTaskPropertiesArgs $) {
        this.input = $.input;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectToSourceSqlServerSyncTaskPropertiesArgs();
        }

        public Builder(ConnectToSourceSqlServerSyncTaskPropertiesArgs defaults) {
            $ = new ConnectToSourceSqlServerSyncTaskPropertiesArgs(Objects.requireNonNull(defaults));
        }
