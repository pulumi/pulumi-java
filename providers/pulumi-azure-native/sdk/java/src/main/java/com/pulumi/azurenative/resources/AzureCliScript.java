...
public class AzureCliScript extends CustomResource {
    /**
     ...
     */
    public AzureCliScript(String name, AzureCliScriptArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:resources:AzureCliScript", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private AzureCliScript(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AzureCliScript get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
