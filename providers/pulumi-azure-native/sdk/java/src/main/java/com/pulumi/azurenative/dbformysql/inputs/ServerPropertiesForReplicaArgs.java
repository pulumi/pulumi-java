 ...
 * 
 */
public final class ServerPropertiesForReplicaArgs extends ResourceArgs {
    ...
    /**
     * @return The master server id to create replica from.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param sourceServerId The master server id to create replica from.
         * 
         * @return builder
         * 
         */
