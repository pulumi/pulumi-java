...
public class Sensor extends CustomResource {
    /**
     ...
     */
    public Sensor(String name, SensorArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:iotsecurity:Sensor", name, args == null ? SensorArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Sensor(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Sensor get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
