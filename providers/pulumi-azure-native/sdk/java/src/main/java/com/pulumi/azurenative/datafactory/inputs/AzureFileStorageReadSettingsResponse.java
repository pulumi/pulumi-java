 ...
 * 
 */
public final class AzureFileStorageReadSettingsResponse extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return The prefix filter for the Azure File name starting from root path. Type: string (or Expression with resultType string).
     * 
     */
    ...
    /**
     * @return Azure File Storage wildcardFileName. Type: string (or Expression with resultType string).
     * 
     */
    ...
    /**
     * @return Azure File Storage wildcardFolderPath. Type: string (or Expression with resultType string).
     * 
     */
    ...
    private AzureFileStorageReadSettingsResponse(AzureFileStorageReadSettingsResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureFileStorageReadSettingsResponse();
        }

        public Builder(AzureFileStorageReadSettingsResponse defaults) {
            $ = new AzureFileStorageReadSettingsResponse(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param prefix The prefix filter for the Azure File name starting from root path. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param wildcardFileName Azure File Storage wildcardFileName. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param wildcardFolderPath Azure File Storage wildcardFolderPath. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
