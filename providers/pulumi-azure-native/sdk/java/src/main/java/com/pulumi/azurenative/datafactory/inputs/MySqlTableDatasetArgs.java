 ...
 * 
 */
public final class MySqlTableDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MySqlTableDatasetArgs(MySqlTableDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MySqlTableDatasetArgs();
        }

        public Builder(MySqlTableDatasetArgs defaults) {
            $ = new MySqlTableDatasetArgs(Objects.requireNonNull(defaults));
        }
