...
public class Pool extends CustomResource {
     ...
     */
    public Pool(String name, PoolArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:netapp:Pool", name, args == null ? PoolArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Pool(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Pool get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
