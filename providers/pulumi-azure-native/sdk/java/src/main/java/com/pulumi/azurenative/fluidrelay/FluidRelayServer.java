...
public class FluidRelayServer extends CustomResource {
    /**
     ...
     */
    public FluidRelayServer(String name, FluidRelayServerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FluidRelayServer(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FluidRelayServer get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
