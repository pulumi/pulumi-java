...
public class CustomerSubscription extends CustomResource {
    /**
     ...
     */
    public CustomerSubscription(String name, CustomerSubscriptionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CustomerSubscription(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomerSubscription get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
