...
public class DataExport extends CustomResource {
    /**
     ...
     */
    public DataExport(String name, DataExportArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DataExport(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DataExport get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
