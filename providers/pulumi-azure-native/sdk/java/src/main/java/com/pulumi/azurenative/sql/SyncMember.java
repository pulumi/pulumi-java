...
public class SyncMember extends CustomResource {
    /**
     ...
     */
    public SyncMember(String name, SyncMemberArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:sql:SyncMember", name, args == null ? SyncMemberArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SyncMember(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SyncMember get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
