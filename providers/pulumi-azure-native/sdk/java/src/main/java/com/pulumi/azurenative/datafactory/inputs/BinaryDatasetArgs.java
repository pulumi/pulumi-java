 ...
 * 
 */
public final class BinaryDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private BinaryDatasetArgs(BinaryDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BinaryDatasetArgs();
        }

        public Builder(BinaryDatasetArgs defaults) {
            $ = new BinaryDatasetArgs(Objects.requireNonNull(defaults));
        }
