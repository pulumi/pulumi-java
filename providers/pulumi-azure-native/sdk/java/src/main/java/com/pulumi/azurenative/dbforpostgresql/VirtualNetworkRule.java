 ...
 * 
 */
@ResourceType(type="azure-native:dbforpostgresql:VirtualNetworkRule")
public class VirtualNetworkRule extends CustomResource {
    /**
     ...
     */
    public VirtualNetworkRule(String name, VirtualNetworkRuleArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:dbforpostgresql:VirtualNetworkRule", name, args == null ? VirtualNetworkRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private VirtualNetworkRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
        super("azure-native:dbforpostgresql:VirtualNetworkRule", name, null, makeResourceOptions(options, id));
    }
    ...
    private static CustomResourceOptions makeResourceOptions(@Nullable CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:dbforpostgresql/v20171201:VirtualNetworkRule").build()),
                Output.of(Alias.builder().type("azure-native:dbforpostgresql/v20171201preview:VirtualNetworkRule").build())
            ))
            .build();
     ...
     */
    public static VirtualNetworkRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
