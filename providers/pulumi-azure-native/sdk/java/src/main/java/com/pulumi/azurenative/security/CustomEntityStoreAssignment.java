...
public class CustomEntityStoreAssignment extends CustomResource {
    /**
     ...
     */
    public CustomEntityStoreAssignment(String name, CustomEntityStoreAssignmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CustomEntityStoreAssignment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomEntityStoreAssignment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
