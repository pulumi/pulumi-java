...
public class ServerCollector extends CustomResource {
     ...
     */
    public ServerCollector(String name, ServerCollectorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServerCollector(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServerCollector get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
