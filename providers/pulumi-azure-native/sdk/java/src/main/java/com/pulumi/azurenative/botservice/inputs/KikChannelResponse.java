 ...
 * 
 */
public final class KikChannelResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private KikChannelResponse(KikChannelResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KikChannelResponse();
        }

        public Builder(KikChannelResponse defaults) {
            $ = new KikChannelResponse(Objects.requireNonNull(defaults));
        }
