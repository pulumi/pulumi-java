 ...
 * 
 */
public final class ServiceBusTopicEventSubscriptionDestinationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServiceBusTopicEventSubscriptionDestinationArgs(ServiceBusTopicEventSubscriptionDestinationArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceBusTopicEventSubscriptionDestinationArgs();
        }

        public Builder(ServiceBusTopicEventSubscriptionDestinationArgs defaults) {
            $ = new ServiceBusTopicEventSubscriptionDestinationArgs(Objects.requireNonNull(defaults));
        }
