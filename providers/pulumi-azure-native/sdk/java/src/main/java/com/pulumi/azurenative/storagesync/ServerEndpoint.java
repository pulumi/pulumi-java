...
public class ServerEndpoint extends CustomResource {
    /**
     * Cloud Tiering.
     * 
     */
     ...
     */
    public ServerEndpoint(String name, ServerEndpointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServerEndpoint(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServerEndpoint get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
