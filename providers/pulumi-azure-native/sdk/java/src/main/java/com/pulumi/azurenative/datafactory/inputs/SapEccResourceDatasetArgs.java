 ...
 * 
 */
public final class SapEccResourceDatasetArgs extends ResourceArgs {
    ...
    private SapEccResourceDatasetArgs(SapEccResourceDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SapEccResourceDatasetArgs();
        }

        public Builder(SapEccResourceDatasetArgs defaults) {
            $ = new SapEccResourceDatasetArgs(Objects.requireNonNull(defaults));
        }
