...
public class NetworkManager extends CustomResource {
    /**
     ...
     */
    public NetworkManager(String name, NetworkManagerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NetworkManager(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkManager get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
