...
public class OfficeDataConnector extends CustomResource {
    /**
     ...
     */
    public OfficeDataConnector(String name, OfficeDataConnectorArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:securityinsights:OfficeDataConnector", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private OfficeDataConnector(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OfficeDataConnector get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
