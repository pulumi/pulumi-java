 ...
 * 
 */
public final class CosmosDbMongoDbApiSinkArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CosmosDbMongoDbApiSinkArgs(CosmosDbMongoDbApiSinkArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CosmosDbMongoDbApiSinkArgs();
        }

        public Builder(CosmosDbMongoDbApiSinkArgs defaults) {
            $ = new CosmosDbMongoDbApiSinkArgs(Objects.requireNonNull(defaults));
        }
