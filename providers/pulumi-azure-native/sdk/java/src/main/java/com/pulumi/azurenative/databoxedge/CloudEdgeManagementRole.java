...
public class CloudEdgeManagementRole extends CustomResource {
    /**
     ...
     */
    public CloudEdgeManagementRole(String name, CloudEdgeManagementRoleArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:databoxedge:CloudEdgeManagementRole", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private CloudEdgeManagementRole(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CloudEdgeManagementRole get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
