 ...
 * 
 */
public final class SapEccSourceResponse extends com.pulumi.resources.InvokeArgs {

    public static final SapEccSourceResponse Empty = new SapEccSourceResponse();
    ...
    private SapEccSourceResponse(SapEccSourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SapEccSourceResponse();
        }

        public Builder(SapEccSourceResponse defaults) {
            $ = new SapEccSourceResponse(Objects.requireNonNull(defaults));
        }
