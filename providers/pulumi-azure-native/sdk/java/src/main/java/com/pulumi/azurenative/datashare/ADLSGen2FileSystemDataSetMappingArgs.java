...
public final class ADLSGen2FileSystemDataSetMappingArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ADLSGen2FileSystemDataSetMappingArgs(ADLSGen2FileSystemDataSetMappingArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ADLSGen2FileSystemDataSetMappingArgs();
        }

        public Builder(ADLSGen2FileSystemDataSetMappingArgs defaults) {
            $ = new ADLSGen2FileSystemDataSetMappingArgs(Objects.requireNonNull(defaults));
        }
