...
public class MoveCollection extends CustomResource {
    /**
     ...
     */
    public MoveCollection(String name, MoveCollectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MoveCollection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MoveCollection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
