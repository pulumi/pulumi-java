...
public class HealthAlert extends CustomResource {
    /**
     ...
     */
    public HealthAlert(String name, HealthAlertArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HealthAlert(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HealthAlert get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
