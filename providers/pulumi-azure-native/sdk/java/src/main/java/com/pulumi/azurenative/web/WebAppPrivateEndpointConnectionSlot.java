...
public class WebAppPrivateEndpointConnectionSlot extends CustomResource {
    /**
     ...
     */
    public WebAppPrivateEndpointConnectionSlot(String name, WebAppPrivateEndpointConnectionSlotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppPrivateEndpointConnectionSlot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppPrivateEndpointConnectionSlot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
