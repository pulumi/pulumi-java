...
public class ProviderInstance extends CustomResource {
    /**
     ...
     */
    public ProviderInstance(String name, ProviderInstanceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProviderInstance(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProviderInstance get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
