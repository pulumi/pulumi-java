...
public class AppServiceEnvironmentPrivateEndpointConnection extends CustomResource {
    /**
     ...
     */
    public AppServiceEnvironmentPrivateEndpointConnection(String name, AppServiceEnvironmentPrivateEndpointConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AppServiceEnvironmentPrivateEndpointConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AppServiceEnvironmentPrivateEndpointConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
