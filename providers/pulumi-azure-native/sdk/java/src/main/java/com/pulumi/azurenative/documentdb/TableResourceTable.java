...
public class TableResourceTable extends CustomResource {
    /**
     ...
     */
    public TableResourceTable(String name, TableResourceTableArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TableResourceTable(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TableResourceTable get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
