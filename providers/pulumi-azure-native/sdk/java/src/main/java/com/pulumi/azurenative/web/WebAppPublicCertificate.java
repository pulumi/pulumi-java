...
public class WebAppPublicCertificate extends CustomResource {
    /**
     ...
     */
    public WebAppPublicCertificate(String name, WebAppPublicCertificateArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppPublicCertificate(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppPublicCertificate get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
