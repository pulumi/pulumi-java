...
public class SapMonitor extends CustomResource {
    /**
     ...
     */
    public SapMonitor(String name, SapMonitorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SapMonitor(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SapMonitor get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
