...
public class BlobContainerDataSetMapping extends CustomResource {
    /**
     * BLOB Container name.
     * 
     */
     ...
     */
    public BlobContainerDataSetMapping(String name, BlobContainerDataSetMappingArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datashare:BlobContainerDataSetMapping", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private BlobContainerDataSetMapping(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BlobContainerDataSetMapping get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
