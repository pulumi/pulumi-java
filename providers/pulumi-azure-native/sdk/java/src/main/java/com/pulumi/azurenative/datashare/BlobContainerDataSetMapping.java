...
public class BlobContainerDataSetMapping extends com.pulumi.resources.CustomResource {
    /**
     * BLOB Container name.
     * 
     */
     ...
     */
    public BlobContainerDataSetMapping(String name, BlobContainerDataSetMappingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:datashare:BlobContainerDataSetMapping", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private BlobContainerDataSetMapping(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static BlobContainerDataSetMapping get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
