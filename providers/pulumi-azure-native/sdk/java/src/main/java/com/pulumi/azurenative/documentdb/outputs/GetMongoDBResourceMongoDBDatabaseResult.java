...
public final class GetMongoDBResourceMongoDBDatabaseResult {
    ...
    private final @Nullable MongoDBDatabaseGetPropertiesResponseOptions options;
    private final @Nullable MongoDBDatabaseGetPropertiesResponseResource resource;
    /**
    ...
    private GetMongoDBResourceMongoDBDatabaseResult(
        ...
        @CustomType.Parameter("options") @Nullable MongoDBDatabaseGetPropertiesResponseOptions options,
        @CustomType.Parameter("resource") @Nullable MongoDBDatabaseGetPropertiesResponseResource resource,
    ...
    */
    ...
    public Optional<MongoDBDatabaseGetPropertiesResponseOptions> getOptions() {
        return Optional.ofNullable(this.options);
    }
    public Optional<MongoDBDatabaseGetPropertiesResponseResource> getResource() {
