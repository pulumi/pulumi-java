...
public class VirtualWan extends CustomResource {
    /**
     ...
     */
    public VirtualWan(String name, VirtualWanArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:network:VirtualWan", name, args == null ? VirtualWanArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private VirtualWan(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualWan get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
