...
import com.pulumi.azurenative.botservice.inputs.AlexaChannelPropertiesResponse;
 ...
 * 
 */
public final class AlexaChannelResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private AlexaChannelResponse(AlexaChannelResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlexaChannelResponse();
        }

        public Builder(AlexaChannelResponse defaults) {
            $ = new AlexaChannelResponse(Objects.requireNonNull(defaults));
        }
