...
public class ReplicationvCenter extends CustomResource {
    /**
     * Resource Location
     * 
     */
     ...
     */
    public ReplicationvCenter(String name, ReplicationvCenterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReplicationvCenter(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReplicationvCenter get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
