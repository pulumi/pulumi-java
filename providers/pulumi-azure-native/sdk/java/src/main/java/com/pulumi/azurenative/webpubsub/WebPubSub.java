...
public class WebPubSub extends CustomResource {
    /**
     ...
     */
    public WebPubSub(String name, WebPubSubArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:webpubsub:WebPubSub", name, args == null ? WebPubSubArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private WebPubSub(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebPubSub get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
