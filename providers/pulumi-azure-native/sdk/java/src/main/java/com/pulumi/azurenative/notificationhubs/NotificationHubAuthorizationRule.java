...
public class NotificationHubAuthorizationRule extends CustomResource {
    /**
     ...
     */
    public NotificationHubAuthorizationRule(String name, NotificationHubAuthorizationRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NotificationHubAuthorizationRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NotificationHubAuthorizationRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
