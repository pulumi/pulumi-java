 ...
 * 
 */
public final class AmazonRdsForSqlServerSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final AmazonRdsForSqlServerSourceArgs Empty = new AmazonRdsForSqlServerSourceArgs();
    ...
    private AmazonRdsForSqlServerSourceArgs(AmazonRdsForSqlServerSourceArgs $) {
    ...
    public static Builder builder(AmazonRdsForSqlServerSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AmazonRdsForSqlServerSourceArgs();
        }

        public Builder(AmazonRdsForSqlServerSourceArgs defaults) {
            $ = new AmazonRdsForSqlServerSourceArgs(Objects.requireNonNull(defaults));
        }
