 ...
 * 
 */
public final class Db2TableDatasetArgs extends ResourceArgs {

    public static final Db2TableDatasetArgs Empty = new Db2TableDatasetArgs();
    ...
    /**
     * @return The Db2 table name. Type: string (or Expression with resultType string).
     * 
     */
    ...
    private Db2TableDatasetArgs() {}

    private Db2TableDatasetArgs(Db2TableDatasetArgs $) {
    ...
    public static Builder builder(Db2TableDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new Db2TableDatasetArgs();
        }

        public Builder(Db2TableDatasetArgs defaults) {
            $ = new Db2TableDatasetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Db2TableDatasetArgs build() {
