 ...
 * 
 */
public final class AzureStorageLinkedServiceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzureStorageLinkedServiceArgs(AzureStorageLinkedServiceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureStorageLinkedServiceArgs();
        }

        public Builder(AzureStorageLinkedServiceArgs defaults) {
            $ = new AzureStorageLinkedServiceArgs(Objects.requireNonNull(defaults));
        }
