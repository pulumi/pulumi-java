...
public class PartnerRegistration extends CustomResource {
    /**
     ...
     */
    public PartnerRegistration(String name, PartnerRegistrationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PartnerRegistration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PartnerRegistration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
