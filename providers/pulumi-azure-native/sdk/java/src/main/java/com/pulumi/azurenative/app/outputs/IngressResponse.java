...
public final class IngressResponse {
     ...
     * 
     */
    private final @Nullable List<CustomDomainResponse> customDomains;
    /**
    ...
    private IngressResponse(
        ...
        @CustomType.Parameter("customDomains") @Nullable List<CustomDomainResponse> customDomains,
    ...
    public static final class Builder {
        ...
        public Builder transport(@Nullable String transport) {
            ...
            return new IngressResponse(allowInsecure, customDomains, external, fqdn, targetPort, traffic, transport);
        }
    }
}
