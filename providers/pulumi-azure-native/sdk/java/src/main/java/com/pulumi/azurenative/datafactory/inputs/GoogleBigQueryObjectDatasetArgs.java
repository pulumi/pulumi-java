 ...
 * 
 */
public final class GoogleBigQueryObjectDatasetArgs extends ResourceArgs {
    ...
    private GoogleBigQueryObjectDatasetArgs(GoogleBigQueryObjectDatasetArgs $) {
    ...
    public static Builder builder(GoogleBigQueryObjectDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleBigQueryObjectDatasetArgs();
        }

        public Builder(GoogleBigQueryObjectDatasetArgs defaults) {
            $ = new GoogleBigQueryObjectDatasetArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param dataset The database name of the Google BigQuery. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
        public Builder dataset(@Nullable Output<Object> dataset) {
            $.dataset = dataset;
            return this;
        }
         ...
         * 
         */
        public Builder dataset(Object dataset) {
        ...
        /**
         * @param table The table name of the Google BigQuery. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param tableName This property will be retired. Please consider using database + table properties instead.
         * 
         * @return builder
         * 
         */
        ...
        public GoogleBigQueryObjectDatasetArgs build() {
