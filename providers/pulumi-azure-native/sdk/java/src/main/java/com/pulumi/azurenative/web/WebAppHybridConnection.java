...
public class WebAppHybridConnection extends CustomResource {
    /**
     ...
     */
    public WebAppHybridConnection(String name, WebAppHybridConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppHybridConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppHybridConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
