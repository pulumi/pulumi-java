...
public class WorkspaceAadAdmin extends CustomResource {
    /**
     ...
     */
    public WorkspaceAadAdmin(String name, WorkspaceAadAdminArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WorkspaceAadAdmin(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkspaceAadAdmin get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
