...
public class NetworkVirtualAppliance extends CustomResource {
    /**
     * Address Prefix.
     * 
     */
     ...
     */
    public NetworkVirtualAppliance(String name, NetworkVirtualApplianceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NetworkVirtualAppliance(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkVirtualAppliance get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
