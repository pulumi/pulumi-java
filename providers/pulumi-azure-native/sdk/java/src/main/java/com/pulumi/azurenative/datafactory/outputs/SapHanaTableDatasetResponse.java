...
@CustomType
public final class SapHanaTableDatasetResponse {
    /**
    ...
    /**
     * @return The table name of SAP HANA. Type: string (or Expression with resultType string).
     * 
     */
    ...
    private SapHanaTableDatasetResponse(
    ...
    public static Builder builder(SapHanaTableDatasetResponse defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SapHanaTableDatasetResponse defaults) {
