...
@CustomType
public final class AzureDataExplorerTableDatasetResponse {
        /**
    ...
    private final @Nullable Object structure;
        /**
         * @return The table name of the Azure Data Explorer database. Type: string (or Expression with resultType string).
         * 
         */
