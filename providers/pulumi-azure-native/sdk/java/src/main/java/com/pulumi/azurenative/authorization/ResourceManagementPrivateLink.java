...
public class ResourceManagementPrivateLink extends CustomResource {
    /**
     ...
     */
    public ResourceManagementPrivateLink(String name, ResourceManagementPrivateLinkArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResourceManagementPrivateLink(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResourceManagementPrivateLink get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
