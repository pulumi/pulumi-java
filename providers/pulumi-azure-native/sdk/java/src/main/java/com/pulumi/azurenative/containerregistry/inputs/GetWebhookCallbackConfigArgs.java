...
public final class GetWebhookCallbackConfigArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetWebhookCallbackConfigArgs(GetWebhookCallbackConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetWebhookCallbackConfigArgs();
        }

        public Builder(GetWebhookCallbackConfigArgs defaults) {
            $ = new GetWebhookCallbackConfigArgs(Objects.requireNonNull(defaults));
        }
