...
public final class GetkustoPoolArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetkustoPoolArgs(GetkustoPoolArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetkustoPoolArgs();
        }

        public Builder(GetkustoPoolArgs defaults) {
            $ = new GetkustoPoolArgs(Objects.requireNonNull(defaults));
        }
