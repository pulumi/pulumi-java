...
public class ServerCommunicationLink extends CustomResource {
    /**
     ...
     */
    public ServerCommunicationLink(String name, ServerCommunicationLinkArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServerCommunicationLink(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServerCommunicationLink get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
