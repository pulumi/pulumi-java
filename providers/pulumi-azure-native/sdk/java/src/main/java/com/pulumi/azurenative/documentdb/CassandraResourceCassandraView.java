...
public class CassandraResourceCassandraView extends CustomResource {
    /**
     ...
     */
    public CassandraResourceCassandraView(String name, CassandraResourceCassandraViewArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CassandraResourceCassandraView(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CassandraResourceCassandraView get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
