 ...
 * 
 */
public final class OracleServiceCloudObjectDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OracleServiceCloudObjectDatasetArgs(OracleServiceCloudObjectDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OracleServiceCloudObjectDatasetArgs();
        }

        public Builder(OracleServiceCloudObjectDatasetArgs defaults) {
            $ = new OracleServiceCloudObjectDatasetArgs(Objects.requireNonNull(defaults));
        }
