 ...
 * 
 */
public final class PostArgsMatchConditionParametersResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private PostArgsMatchConditionParametersResponse(PostArgsMatchConditionParametersResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PostArgsMatchConditionParametersResponse();
        }

        public Builder(PostArgsMatchConditionParametersResponse defaults) {
            $ = new PostArgsMatchConditionParametersResponse(Objects.requireNonNull(defaults));
        }
