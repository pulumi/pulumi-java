...
public class RemediationAtResource extends CustomResource {
    /**
     ...
     */
    public RemediationAtResource(String name, RemediationAtResourceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RemediationAtResource(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RemediationAtResource get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
