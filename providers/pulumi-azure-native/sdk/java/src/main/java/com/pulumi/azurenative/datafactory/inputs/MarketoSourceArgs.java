 ...
 * 
 */
public final class MarketoSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MarketoSourceArgs(MarketoSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MarketoSourceArgs();
        }

        public Builder(MarketoSourceArgs defaults) {
            $ = new MarketoSourceArgs(Objects.requireNonNull(defaults));
        }
