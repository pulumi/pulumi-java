...
public final class CommonDataServiceForAppsSinkResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private CommonDataServiceForAppsSinkResponse(CommonDataServiceForAppsSinkResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CommonDataServiceForAppsSinkResponse();
        }

        public Builder(CommonDataServiceForAppsSinkResponse defaults) {
            $ = new CommonDataServiceForAppsSinkResponse(Objects.requireNonNull(defaults));
        }
