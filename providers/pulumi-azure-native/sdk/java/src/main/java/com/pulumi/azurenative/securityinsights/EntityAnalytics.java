...
public class EntityAnalytics extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public EntityAnalytics(String name, EntityAnalyticsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:securityinsights:EntityAnalytics", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private EntityAnalytics(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("azure-native:securityinsights/v20211001preview:EntityAnalytics").build()),
                Output.of(Alias.builder().type("azure-native:securityinsights/v20220101preview:EntityAnalytics").build()),
                Output.of(Alias.builder().type("azure-native:securityinsights/v20220401preview:EntityAnalytics").build())
            ))
            .build();
     ...
     */
    public static EntityAnalytics get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
