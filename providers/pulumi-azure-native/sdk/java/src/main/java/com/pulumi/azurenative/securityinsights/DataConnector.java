...
public class DataConnector extends CustomResource {
    /**
     ...
     */
    public DataConnector(String name, DataConnectorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DataConnector(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DataConnector get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
