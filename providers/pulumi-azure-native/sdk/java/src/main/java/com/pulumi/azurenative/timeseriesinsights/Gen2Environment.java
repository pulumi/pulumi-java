...
public class Gen2Environment extends CustomResource {
    /**
     ...
     */
    public Gen2Environment(String name, Gen2EnvironmentArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:timeseriesinsights:Gen2Environment", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private Gen2Environment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Gen2Environment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
