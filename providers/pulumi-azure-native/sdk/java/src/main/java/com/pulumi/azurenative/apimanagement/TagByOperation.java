...
public class TagByOperation extends CustomResource {
    /**
     * Tag name.
     * 
     */
     ...
     */
    public TagByOperation(String name, TagByOperationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TagByOperation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TagByOperation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
