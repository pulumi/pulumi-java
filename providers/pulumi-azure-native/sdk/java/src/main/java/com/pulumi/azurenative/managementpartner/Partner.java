...
public class Partner extends CustomResource {
     ...
     */
    public Partner(String name, @Nullable PartnerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Partner(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Partner get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
