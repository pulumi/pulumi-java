...
public class ServerDnsAlias extends CustomResource {
    /**
     ...
     */
    public ServerDnsAlias(String name, ServerDnsAliasArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServerDnsAlias(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServerDnsAlias get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
