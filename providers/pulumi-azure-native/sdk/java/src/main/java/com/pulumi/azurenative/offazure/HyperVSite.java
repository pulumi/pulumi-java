...
public class HyperVSite extends CustomResource {
    /**
     ...
     */
    public HyperVSite(String name, HyperVSiteArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HyperVSite(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HyperVSite get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
