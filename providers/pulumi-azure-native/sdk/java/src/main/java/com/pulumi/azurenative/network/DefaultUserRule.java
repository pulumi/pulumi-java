...
public class DefaultUserRule extends CustomResource {
    /**
     ...
     */
    public DefaultUserRule(String name, DefaultUserRuleArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:network:DefaultUserRule", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private DefaultUserRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DefaultUserRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
