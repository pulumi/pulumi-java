...
public class ViewByScope extends CustomResource {
    /**
     ...
     */
    public ViewByScope(String name, ViewByScopeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ViewByScope(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ViewByScope get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
