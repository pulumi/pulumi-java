...
public class BlobServiceProperties extends CustomResource {
    /**
     ...
     */
    public BlobServiceProperties(String name, BlobServicePropertiesArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BlobServiceProperties(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BlobServiceProperties get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
