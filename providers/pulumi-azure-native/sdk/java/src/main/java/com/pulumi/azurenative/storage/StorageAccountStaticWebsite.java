...
public class StorageAccountStaticWebsite extends CustomResource {
    /**
     ...
     */
    public StorageAccountStaticWebsite(String name, StorageAccountStaticWebsiteArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StorageAccountStaticWebsite(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StorageAccountStaticWebsite get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
