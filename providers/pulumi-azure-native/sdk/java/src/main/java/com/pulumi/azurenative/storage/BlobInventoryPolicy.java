...
public class BlobInventoryPolicy extends CustomResource {
    /**
     ...
     */
    public BlobInventoryPolicy(String name, BlobInventoryPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BlobInventoryPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BlobInventoryPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
