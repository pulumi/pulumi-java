...
public class PatchSchedule extends CustomResource {
    /**
     * Resource name.
     * 
     */
     ...
     */
    public PatchSchedule(String name, PatchScheduleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PatchSchedule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PatchSchedule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
