...
import com.pulumi.azurenative.solutions.inputs.UserAssignedResourceIdentityResponse;
...
public final class IdentityResponse extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return The list of user identities associated with the resource. The user identity dictionary key references will be resource ids in the form: &#39;/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}&#39;.
     * 
     */
    public Optional<Map<String,UserAssignedResourceIdentityResponse>> userAssignedIdentities() {
    ...
    public static final class Builder {
        ...
        /**
         * @param userAssignedIdentities The list of user identities associated with the resource. The user identity dictionary key references will be resource ids in the form: &#39;/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}&#39;.
         * 
         * @return builder
         * 
         */
