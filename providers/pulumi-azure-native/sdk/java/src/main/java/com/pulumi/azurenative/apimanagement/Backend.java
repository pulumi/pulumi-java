...
public class Backend extends CustomResource {
    /**
     ...
     */
    public Backend(String name, BackendArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:apimanagement:Backend", name, args == null ? BackendArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Backend(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Backend get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
