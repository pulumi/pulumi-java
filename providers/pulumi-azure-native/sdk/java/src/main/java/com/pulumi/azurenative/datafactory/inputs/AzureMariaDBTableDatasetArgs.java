...
public final class AzureMariaDBTableDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzureMariaDBTableDatasetArgs(AzureMariaDBTableDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureMariaDBTableDatasetArgs();
        }

        public Builder(AzureMariaDBTableDatasetArgs defaults) {
            $ = new AzureMariaDBTableDatasetArgs(Objects.requireNonNull(defaults));
        }
