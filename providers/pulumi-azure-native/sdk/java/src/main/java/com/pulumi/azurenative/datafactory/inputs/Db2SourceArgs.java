 ...
 * 
 */
public final class Db2SourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final Db2SourceArgs Empty = new Db2SourceArgs();
    ...
    public static Builder builder(Db2SourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(Db2SourceArgs defaults) {
        ...
        public Builder type(String type) {
            ...
            return this;
        }        public Db2SourceArgs build() {
            return new Db2SourceArgs(additionalColumns, disableMetricsCollection, maxConcurrentConnections, query, queryTimeout, sourceRetryCount, sourceRetryWait, type);
        }
    }
}
