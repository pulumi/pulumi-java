...
public class WebAppSlot extends CustomResource {
    /**
     ...
     */
    public WebAppSlot(String name, WebAppSlotArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:web:WebAppSlot", name, args == null ? WebAppSlotArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private WebAppSlot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppSlot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
