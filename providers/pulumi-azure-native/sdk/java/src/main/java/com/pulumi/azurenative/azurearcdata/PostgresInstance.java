...
public class PostgresInstance extends CustomResource {
    /**
     ...
     */
    public PostgresInstance(String name, PostgresInstanceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PostgresInstance(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PostgresInstance get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
