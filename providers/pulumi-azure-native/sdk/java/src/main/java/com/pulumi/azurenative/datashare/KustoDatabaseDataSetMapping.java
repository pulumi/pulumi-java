...
public class KustoDatabaseDataSetMapping extends CustomResource {
    /**
     ...
     */
    public KustoDatabaseDataSetMapping(String name, KustoDatabaseDataSetMappingArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datashare:KustoDatabaseDataSetMapping", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private KustoDatabaseDataSetMapping(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static KustoDatabaseDataSetMapping get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
