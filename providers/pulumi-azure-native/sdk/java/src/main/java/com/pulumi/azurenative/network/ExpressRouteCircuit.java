...
public class ExpressRouteCircuit extends CustomResource {
    /**
     ...
     */
    public ExpressRouteCircuit(String name, ExpressRouteCircuitArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ExpressRouteCircuit(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ExpressRouteCircuit get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
