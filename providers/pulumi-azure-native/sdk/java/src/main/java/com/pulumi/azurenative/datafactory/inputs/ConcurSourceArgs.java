 ...
 * 
 */
public final class ConcurSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ConcurSourceArgs(ConcurSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConcurSourceArgs();
        }

        public Builder(ConcurSourceArgs defaults) {
            $ = new ConcurSourceArgs(Objects.requireNonNull(defaults));
        }
