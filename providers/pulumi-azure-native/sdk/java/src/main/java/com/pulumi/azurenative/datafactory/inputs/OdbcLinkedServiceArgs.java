 ...
 * 
 */
public final class OdbcLinkedServiceArgs extends ResourceArgs {
    ...
    private OdbcLinkedServiceArgs(OdbcLinkedServiceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OdbcLinkedServiceArgs();
        }

        public Builder(OdbcLinkedServiceArgs defaults) {
            $ = new OdbcLinkedServiceArgs(Objects.requireNonNull(defaults));
        }
