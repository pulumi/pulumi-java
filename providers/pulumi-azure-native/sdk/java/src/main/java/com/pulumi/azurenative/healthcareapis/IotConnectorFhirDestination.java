...
public class IotConnectorFhirDestination extends CustomResource {
    /**
     ...
     */
    public IotConnectorFhirDestination(String name, IotConnectorFhirDestinationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IotConnectorFhirDestination(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IotConnectorFhirDestination get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
