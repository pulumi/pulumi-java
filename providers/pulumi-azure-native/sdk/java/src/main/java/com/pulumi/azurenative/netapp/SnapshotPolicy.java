...
public class SnapshotPolicy extends CustomResource {
    /**
     ...
     */
    public SnapshotPolicy(String name, SnapshotPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SnapshotPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SnapshotPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
