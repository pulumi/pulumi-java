...
public final class GetTopicEventSubscriptionDeliveryAttributesResult {
    ...
    private GetTopicEventSubscriptionDeliveryAttributesResult(@CustomType.Parameter("value") @Nullable List<Either<DynamicDeliveryAttributeMappingResponse,StaticDeliveryAttributeMappingResponse>> value) {
        this.value = value;
    }
    ...
    public static final class Builder {
        ...
        public Builder value(Either<DynamicDeliveryAttributeMappingResponse,StaticDeliveryAttributeMappingResponse>... value) {
            ...
            return new GetTopicEventSubscriptionDeliveryAttributesResult(value);
        }
    }
}
