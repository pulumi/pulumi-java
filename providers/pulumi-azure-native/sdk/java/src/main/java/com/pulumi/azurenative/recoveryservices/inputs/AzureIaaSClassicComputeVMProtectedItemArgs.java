 ...
 * 
 */
public final class AzureIaaSClassicComputeVMProtectedItemArgs extends ResourceArgs {
    ...
    private AzureIaaSClassicComputeVMProtectedItemArgs(AzureIaaSClassicComputeVMProtectedItemArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureIaaSClassicComputeVMProtectedItemArgs();
        }

        public Builder(AzureIaaSClassicComputeVMProtectedItemArgs defaults) {
            $ = new AzureIaaSClassicComputeVMProtectedItemArgs(Objects.requireNonNull(defaults));
        }
