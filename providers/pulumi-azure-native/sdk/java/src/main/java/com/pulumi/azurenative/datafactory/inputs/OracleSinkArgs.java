 ...
 * 
 */
public final class OracleSinkArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OracleSinkArgs(OracleSinkArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(OracleSinkArgs defaults) {
            $ = new OracleSinkArgs(Objects.requireNonNull(defaults));
        }
