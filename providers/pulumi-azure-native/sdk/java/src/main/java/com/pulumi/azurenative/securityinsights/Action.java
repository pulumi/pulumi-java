...
public class Action extends CustomResource {
    /**
     * Etag of the action.
     * 
     */
     ...
     */
    public Action(String name, ActionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Action(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Action get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
