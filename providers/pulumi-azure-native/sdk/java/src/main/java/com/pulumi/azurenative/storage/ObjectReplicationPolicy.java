...
public class ObjectReplicationPolicy extends CustomResource {
    /**
     ...
     */
    public ObjectReplicationPolicy(String name, ObjectReplicationPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ObjectReplicationPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ObjectReplicationPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
