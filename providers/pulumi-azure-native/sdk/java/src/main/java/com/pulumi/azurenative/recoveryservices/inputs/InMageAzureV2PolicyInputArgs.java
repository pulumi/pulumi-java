...
public final class InMageAzureV2PolicyInputArgs extends ResourceArgs {
    ...
    private InMageAzureV2PolicyInputArgs(InMageAzureV2PolicyInputArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InMageAzureV2PolicyInputArgs();
        }

        public Builder(InMageAzureV2PolicyInputArgs defaults) {
            $ = new InMageAzureV2PolicyInputArgs(Objects.requireNonNull(defaults));
        }
