...
public class Replication extends CustomResource {
    /**
     ...
     */
    public Replication(String name, ReplicationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Replication(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Replication get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
