 ...
 * 
 */
public final class SqlMISinkArgs extends com.pulumi.resources.ResourceArgs {

    public static final SqlMISinkArgs Empty = new SqlMISinkArgs();
    ...
    private SqlMISinkArgs(SqlMISinkArgs $) {
    ...
    public static Builder builder(SqlMISinkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SqlMISinkArgs defaults) {
            $ = new SqlMISinkArgs(Objects.requireNonNull(defaults));
        }
