 ...
 * 
 */
public final class FileShareDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FileShareDatasetArgs(FileShareDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FileShareDatasetArgs();
        }

        public Builder(FileShareDatasetArgs defaults) {
            $ = new FileShareDatasetArgs(Objects.requireNonNull(defaults));
        }
