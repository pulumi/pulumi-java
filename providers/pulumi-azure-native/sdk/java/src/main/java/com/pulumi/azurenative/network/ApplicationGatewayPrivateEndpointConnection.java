...
public class ApplicationGatewayPrivateEndpointConnection extends CustomResource {
    /**
     ...
     */
    public ApplicationGatewayPrivateEndpointConnection(String name, ApplicationGatewayPrivateEndpointConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApplicationGatewayPrivateEndpointConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApplicationGatewayPrivateEndpointConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
