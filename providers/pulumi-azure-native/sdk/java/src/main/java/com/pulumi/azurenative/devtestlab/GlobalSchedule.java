...
public class GlobalSchedule extends CustomResource {
    /**
     ...
     */
    public GlobalSchedule(String name, GlobalScheduleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GlobalSchedule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GlobalSchedule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
