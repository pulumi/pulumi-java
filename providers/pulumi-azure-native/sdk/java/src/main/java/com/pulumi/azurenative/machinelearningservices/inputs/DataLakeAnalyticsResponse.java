...
import com.pulumi.azurenative.machinelearningservices.inputs.DataLakeAnalyticsResponseProperties;
 ...
 * 
 */
public final class DataLakeAnalyticsResponse extends com.pulumi.resources.InvokeArgs {

    public static final DataLakeAnalyticsResponse Empty = new DataLakeAnalyticsResponse();
    ...
    private DataLakeAnalyticsResponse(DataLakeAnalyticsResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataLakeAnalyticsResponse();
        }

        public Builder(DataLakeAnalyticsResponse defaults) {
            $ = new DataLakeAnalyticsResponse(Objects.requireNonNull(defaults));
        }
