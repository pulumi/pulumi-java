...
public class ServiceUnit extends CustomResource {
    /**
     ...
     */
    public ServiceUnit(String name, ServiceUnitArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceUnit(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceUnit get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
