 ...
 * 
 */
public final class WebSourceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private WebSourceResponse(WebSourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebSourceResponse();
        }

        public Builder(WebSourceResponse defaults) {
            $ = new WebSourceResponse(Objects.requireNonNull(defaults));
        }
