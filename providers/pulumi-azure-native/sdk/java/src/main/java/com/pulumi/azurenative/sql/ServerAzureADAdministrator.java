...
public class ServerAzureADAdministrator extends CustomResource {
    /**
     ...
     */
    public ServerAzureADAdministrator(String name, ServerAzureADAdministratorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServerAzureADAdministrator(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServerAzureADAdministrator get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
