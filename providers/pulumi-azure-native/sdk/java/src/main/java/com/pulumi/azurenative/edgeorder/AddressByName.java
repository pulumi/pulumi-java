...
public class AddressByName extends CustomResource {
    /**
     ...
     */
    public AddressByName(String name, AddressByNameArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AddressByName(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AddressByName get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
