...
public class UserSettingsWithLocation extends CustomResource {
    /**
     ...
     */
    public UserSettingsWithLocation(String name, UserSettingsWithLocationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private UserSettingsWithLocation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UserSettingsWithLocation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
