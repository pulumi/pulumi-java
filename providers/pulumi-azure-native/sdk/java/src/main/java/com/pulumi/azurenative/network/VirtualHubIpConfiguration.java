...
public class VirtualHubIpConfiguration extends CustomResource {
    /**
     ...
     */
    public VirtualHubIpConfiguration(String name, VirtualHubIpConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualHubIpConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualHubIpConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
