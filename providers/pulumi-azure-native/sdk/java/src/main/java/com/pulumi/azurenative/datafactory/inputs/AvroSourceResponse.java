 ...
 * 
 */
public final class AvroSourceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private AvroSourceResponse(AvroSourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AvroSourceResponse();
        }

        public Builder(AvroSourceResponse defaults) {
            $ = new AvroSourceResponse(Objects.requireNonNull(defaults));
        }
