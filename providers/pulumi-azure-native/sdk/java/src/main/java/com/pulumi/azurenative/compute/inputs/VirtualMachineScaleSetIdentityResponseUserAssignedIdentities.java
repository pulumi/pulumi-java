...
public final class VirtualMachineScaleSetIdentityResponseUserAssignedIdentities extends com.pulumi.resources.InvokeArgs {
    ...
    private VirtualMachineScaleSetIdentityResponseUserAssignedIdentities(VirtualMachineScaleSetIdentityResponseUserAssignedIdentities $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualMachineScaleSetIdentityResponseUserAssignedIdentities();
        }

        public Builder(VirtualMachineScaleSetIdentityResponseUserAssignedIdentities defaults) {
            $ = new VirtualMachineScaleSetIdentityResponseUserAssignedIdentities(Objects.requireNonNull(defaults));
        }
