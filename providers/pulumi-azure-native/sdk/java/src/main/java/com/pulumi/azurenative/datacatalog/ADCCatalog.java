...
public class ADCCatalog extends CustomResource {
    /**
     ...
     */
    public ADCCatalog(String name, ADCCatalogArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ADCCatalog(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ADCCatalog get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
