...
public class WorkloadNetworkSegment extends CustomResource {
    /**
     ...
     */
    public WorkloadNetworkSegment(String name, WorkloadNetworkSegmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WorkloadNetworkSegment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkloadNetworkSegment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
