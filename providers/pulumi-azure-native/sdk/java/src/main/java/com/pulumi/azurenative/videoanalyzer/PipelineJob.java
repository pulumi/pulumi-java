...
public class PipelineJob extends CustomResource {
    /**
     ...
     */
    public PipelineJob(String name, PipelineJobArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PipelineJob(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PipelineJob get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
