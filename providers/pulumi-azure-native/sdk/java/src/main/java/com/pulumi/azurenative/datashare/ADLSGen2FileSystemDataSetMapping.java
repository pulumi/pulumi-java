...
public class ADLSGen2FileSystemDataSetMapping extends CustomResource {
    /**
     ...
     */
    public ADLSGen2FileSystemDataSetMapping(String name, ADLSGen2FileSystemDataSetMappingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ADLSGen2FileSystemDataSetMapping(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ADLSGen2FileSystemDataSetMapping get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
