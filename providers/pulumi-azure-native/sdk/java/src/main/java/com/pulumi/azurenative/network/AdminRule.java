...
public class AdminRule extends CustomResource {
    /**
     ...
     */
    public AdminRule(String name, AdminRuleArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:network:AdminRule", name, args == null ? AdminRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AdminRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AdminRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
