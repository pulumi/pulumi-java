...
public class CodeContainer extends CustomResource {
    /**
     ...
     */
    public CodeContainer(String name, CodeContainerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CodeContainer(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CodeContainer get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
