...
public class HybridConnectionAuthorizationRule extends CustomResource {
    /**
     * Resource name.
     * 
     */
     ...
     */
    public HybridConnectionAuthorizationRule(String name, HybridConnectionAuthorizationRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HybridConnectionAuthorizationRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HybridConnectionAuthorizationRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
