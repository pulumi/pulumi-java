...
public class HybridConnectionAuthorizationRule extends com.pulumi.resources.CustomResource {
    ...
    private HybridConnectionAuthorizationRule(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("azure-native:relay/v20211101:HybridConnectionAuthorizationRule").build())
            ))
            .build();
     ...
     */
    public static HybridConnectionAuthorizationRule get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
