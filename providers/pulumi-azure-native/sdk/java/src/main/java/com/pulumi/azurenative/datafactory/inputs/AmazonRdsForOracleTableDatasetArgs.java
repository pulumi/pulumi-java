 ...
 * 
 */
public final class AmazonRdsForOracleTableDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AmazonRdsForOracleTableDatasetArgs(AmazonRdsForOracleTableDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AmazonRdsForOracleTableDatasetArgs();
        }

        public Builder(AmazonRdsForOracleTableDatasetArgs defaults) {
            $ = new AmazonRdsForOracleTableDatasetArgs(Objects.requireNonNull(defaults));
        }
