...
public class ApplicationDefinition extends CustomResource {
    /**
     ...
     */
    public ApplicationDefinition(String name, ApplicationDefinitionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApplicationDefinition(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApplicationDefinition get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
