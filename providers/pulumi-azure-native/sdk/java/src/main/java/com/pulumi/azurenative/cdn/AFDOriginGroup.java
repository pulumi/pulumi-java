...
public class AFDOriginGroup extends CustomResource {
     ...
     */
    public AFDOriginGroup(String name, AFDOriginGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AFDOriginGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AFDOriginGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
