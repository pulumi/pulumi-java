 ...
 * 
 */
public final class AzureVmWorkloadProtectedItemResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private AzureVmWorkloadProtectedItemResponse(AzureVmWorkloadProtectedItemResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureVmWorkloadProtectedItemResponse();
        }

        public Builder(AzureVmWorkloadProtectedItemResponse defaults) {
            $ = new AzureVmWorkloadProtectedItemResponse(Objects.requireNonNull(defaults));
        }
