 ...
 * 
 */
public final class HBaseObjectDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private HBaseObjectDatasetArgs(HBaseObjectDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HBaseObjectDatasetArgs();
        }

        public Builder(HBaseObjectDatasetArgs defaults) {
            $ = new HBaseObjectDatasetArgs(Objects.requireNonNull(defaults));
        }
