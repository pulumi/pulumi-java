...
public class FileShare extends CustomResource {
    /**
     ...
     */
    public FileShare(String name, FileShareArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:storage:FileShare", name, args == null ? FileShareArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FileShare(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FileShare get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
