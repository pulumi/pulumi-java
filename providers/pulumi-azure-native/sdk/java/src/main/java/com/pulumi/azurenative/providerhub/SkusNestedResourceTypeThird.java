...
public class SkusNestedResourceTypeThird extends CustomResource {
    /**
     ...
     */
    public SkusNestedResourceTypeThird(String name, SkusNestedResourceTypeThirdArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SkusNestedResourceTypeThird(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SkusNestedResourceTypeThird get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
