 ...
 * 
 */
public final class SalesforceSinkResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private SalesforceSinkResponse(SalesforceSinkResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SalesforceSinkResponse();
        }

        public Builder(SalesforceSinkResponse defaults) {
            $ = new SalesforceSinkResponse(Objects.requireNonNull(defaults));
        }
