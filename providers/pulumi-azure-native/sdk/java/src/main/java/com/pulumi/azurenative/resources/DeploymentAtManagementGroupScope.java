...
public class DeploymentAtManagementGroupScope extends CustomResource {
    /**
     ...
     */
    public DeploymentAtManagementGroupScope(String name, DeploymentAtManagementGroupScopeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DeploymentAtManagementGroupScope(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DeploymentAtManagementGroupScope get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
