...
public class SubscriptionFeatureRegistration extends CustomResource {
    /**
     * Azure resource name.
     * 
     */
     ...
     */
    public SubscriptionFeatureRegistration(String name, SubscriptionFeatureRegistrationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SubscriptionFeatureRegistration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SubscriptionFeatureRegistration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
