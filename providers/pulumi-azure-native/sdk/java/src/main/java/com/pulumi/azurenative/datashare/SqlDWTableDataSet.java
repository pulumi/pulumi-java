...
public class SqlDWTableDataSet extends CustomResource {
    /**
     ...
     */
    public SqlDWTableDataSet(String name, SqlDWTableDataSetArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datashare:SqlDWTableDataSet", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private SqlDWTableDataSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SqlDWTableDataSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
