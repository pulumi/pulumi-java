...
public class BillingRoleAssignmentByDepartment extends CustomResource {
    /**
     ...
     */
    public BillingRoleAssignmentByDepartment(String name, BillingRoleAssignmentByDepartmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BillingRoleAssignmentByDepartment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BillingRoleAssignmentByDepartment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
