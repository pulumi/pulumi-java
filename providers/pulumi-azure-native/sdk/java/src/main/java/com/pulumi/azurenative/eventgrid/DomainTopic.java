...
public class DomainTopic extends CustomResource {
    /**
     ...
     */
    public DomainTopic(String name, DomainTopicArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DomainTopic(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DomainTopic get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
