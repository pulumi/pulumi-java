...
public class WorkspaceSqlAadAdmin extends CustomResource {
    /**
     ...
     */
    public WorkspaceSqlAadAdmin(String name, WorkspaceSqlAadAdminArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WorkspaceSqlAadAdmin(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkspaceSqlAadAdmin get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
