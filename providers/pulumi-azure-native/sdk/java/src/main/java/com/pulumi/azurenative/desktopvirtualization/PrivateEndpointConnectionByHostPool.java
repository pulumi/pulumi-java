...
public class PrivateEndpointConnectionByHostPool extends CustomResource {
    /**
     ...
     */
    public PrivateEndpointConnectionByHostPool(String name, PrivateEndpointConnectionByHostPoolArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateEndpointConnectionByHostPool(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateEndpointConnectionByHostPool get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
