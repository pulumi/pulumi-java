...
@CustomType
public final class PccRuleQosPolicyResponse {
    /**
     ...
     * 
     */
    private final @Nullable AmbrResponse guaranteedBitRate;
    /**
    ...
    private PccRuleQosPolicyResponse(
        ...
        @CustomType.Parameter("guaranteedBitRate") @Nullable AmbrResponse guaranteedBitRate,
     ...
     * 
     */
    public Optional<AmbrResponse> guaranteedBitRate() {
    ...
    public static Builder builder(PccRuleQosPolicyResponse defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable AmbrResponse guaranteedBitRate;
        ...
        public Builder(PccRuleQosPolicyResponse defaults) {
        ...
        public Builder guaranteedBitRate(@Nullable AmbrResponse guaranteedBitRate) {
            this.guaranteedBitRate = guaranteedBitRate;
            return this;
        }
        ...
        public Builder preemptionVulnerability(@Nullable String preemptionVulnerability) {
            this.preemptionVulnerability = preemptionVulnerability;
            return this;
        }        public PccRuleQosPolicyResponse build() {
            return new PccRuleQosPolicyResponse(allocationAndRetentionPriorityLevel, fiveQi, guaranteedBitRate, maximumBitRate, preemptionCapability, preemptionVulnerability);
        }
    }
}
