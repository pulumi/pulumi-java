...
public class IotDpsResourcePrivateEndpointConnection extends CustomResource {
    /**
     * The resource name.
     * 
     */
     ...
     */
    public IotDpsResourcePrivateEndpointConnection(String name, IotDpsResourcePrivateEndpointConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IotDpsResourcePrivateEndpointConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IotDpsResourcePrivateEndpointConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
