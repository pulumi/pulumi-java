...
public class SqlPoolWorkloadClassifier extends CustomResource {
    /**
     ...
     */
    public SqlPoolWorkloadClassifier(String name, SqlPoolWorkloadClassifierArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SqlPoolWorkloadClassifier(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SqlPoolWorkloadClassifier get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
