...
public class GraphQuery extends CustomResource {
    /**
     ...
     */
    public GraphQuery(String name, GraphQueryArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GraphQuery(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GraphQuery get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
