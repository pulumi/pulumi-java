...
@CustomType
public final class AzureMySqlTableDatasetResponse {
    /**
    ...
    /**
     * @return The name of Azure MySQL database table. Type: string (or Expression with resultType string).
     * 
     */
    private final @Nullable Object table;
    /**
     * @return The Azure MySQL database table name. Type: string (or Expression with resultType string).
     * 
     */
    ...
    public static Builder builder(AzureMySqlTableDatasetResponse defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AzureMySqlTableDatasetResponse defaults) {
