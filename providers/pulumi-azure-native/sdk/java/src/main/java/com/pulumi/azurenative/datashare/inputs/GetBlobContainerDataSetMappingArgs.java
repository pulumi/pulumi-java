...
public final class GetBlobContainerDataSetMappingArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetBlobContainerDataSetMappingArgs(GetBlobContainerDataSetMappingArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBlobContainerDataSetMappingArgs();
        }

        public Builder(GetBlobContainerDataSetMappingArgs defaults) {
            $ = new GetBlobContainerDataSetMappingArgs(Objects.requireNonNull(defaults));
        }
