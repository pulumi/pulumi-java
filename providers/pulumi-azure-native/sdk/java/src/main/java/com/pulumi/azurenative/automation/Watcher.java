...
public class Watcher extends CustomResource {
    /**
     ...
     */
    public Watcher(String name, WatcherArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:automation:Watcher", name, args == null ? WatcherArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Watcher(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Watcher get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
