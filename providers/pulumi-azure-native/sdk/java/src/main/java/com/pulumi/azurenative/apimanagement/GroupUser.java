...
public class GroupUser extends CustomResource {
    /**
     * Email address.
     * 
     */
     ...
     */
    public GroupUser(String name, GroupUserArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GroupUser(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GroupUser get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
