...
public class WorkloadNetworkPortMirroring extends CustomResource {
    /**
     ...
     */
    public WorkloadNetworkPortMirroring(String name, WorkloadNetworkPortMirroringArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WorkloadNetworkPortMirroring(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkloadNetworkPortMirroring get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
