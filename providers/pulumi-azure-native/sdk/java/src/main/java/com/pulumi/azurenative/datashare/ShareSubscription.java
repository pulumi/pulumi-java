...
public class ShareSubscription extends CustomResource {
    /**
     ...
     */
    public ShareSubscription(String name, ShareSubscriptionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ShareSubscription(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ShareSubscription get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
