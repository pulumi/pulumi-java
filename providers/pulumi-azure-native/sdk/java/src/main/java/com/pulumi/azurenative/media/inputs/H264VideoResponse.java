...
public final class H264VideoResponse extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param complexity Tells the encoder how to choose its encoding settings. The default value is Balanced.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param sceneChangeDetection Whether or not the encoder should insert key frames at scene changes. If not specified, the default is false. This flag should be set to true only when the encoder is being configured to produce a single output video.
         * 
         * @return builder
         * 
         */
