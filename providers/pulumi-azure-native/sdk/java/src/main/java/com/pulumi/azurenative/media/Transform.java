...
public class Transform extends CustomResource {
    /**
     ...
     */
    public Transform(String name, TransformArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:media:Transform", name, args == null ? TransformArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Transform(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Transform get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
