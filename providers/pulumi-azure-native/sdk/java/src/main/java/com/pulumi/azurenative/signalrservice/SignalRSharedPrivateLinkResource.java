...
public class SignalRSharedPrivateLinkResource extends CustomResource {
    /**
     ...
     */
    public SignalRSharedPrivateLinkResource(String name, SignalRSharedPrivateLinkResourceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SignalRSharedPrivateLinkResource(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SignalRSharedPrivateLinkResource get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
