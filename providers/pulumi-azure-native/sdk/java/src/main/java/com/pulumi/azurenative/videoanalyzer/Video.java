...
public class Video extends CustomResource {
    /**
     ...
     */
    public Video(String name, VideoArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:videoanalyzer:Video", name, args == null ? VideoArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Video(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Video get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
