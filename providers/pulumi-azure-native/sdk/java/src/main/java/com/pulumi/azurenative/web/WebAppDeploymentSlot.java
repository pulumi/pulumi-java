...
public class WebAppDeploymentSlot extends CustomResource {
    /**
     ...
     */
    public WebAppDeploymentSlot(String name, WebAppDeploymentSlotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppDeploymentSlot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppDeploymentSlot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
