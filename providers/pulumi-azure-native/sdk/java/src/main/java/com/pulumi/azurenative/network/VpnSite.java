...
public class VpnSite extends CustomResource {
    /**
     ...
     */
    public VpnSite(String name, VpnSiteArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:network:VpnSite", name, args == null ? VpnSiteArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private VpnSite(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VpnSite get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
