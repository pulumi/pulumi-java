...
public class BuildpackBinding extends CustomResource {
    /**
     ...
     */
    public BuildpackBinding(String name, BuildpackBindingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BuildpackBinding(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BuildpackBinding get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
