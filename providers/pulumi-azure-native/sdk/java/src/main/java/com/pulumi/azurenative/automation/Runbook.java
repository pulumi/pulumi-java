...
public class Runbook extends CustomResource {
    /**
     ...
     */
    public Runbook(String name, RunbookArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:automation:Runbook", name, args == null ? RunbookArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Runbook(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Runbook get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
