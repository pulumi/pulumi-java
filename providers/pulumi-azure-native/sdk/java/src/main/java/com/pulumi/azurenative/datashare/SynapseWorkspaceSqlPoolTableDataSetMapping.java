...
public class SynapseWorkspaceSqlPoolTableDataSetMapping extends CustomResource {
    /**
     ...
     */
    public SynapseWorkspaceSqlPoolTableDataSetMapping(String name, SynapseWorkspaceSqlPoolTableDataSetMappingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SynapseWorkspaceSqlPoolTableDataSetMapping(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SynapseWorkspaceSqlPoolTableDataSetMapping get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
