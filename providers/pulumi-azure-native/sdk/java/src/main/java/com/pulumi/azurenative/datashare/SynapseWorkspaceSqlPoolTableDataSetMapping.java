...
public class SynapseWorkspaceSqlPoolTableDataSetMapping extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public SynapseWorkspaceSqlPoolTableDataSetMapping(String name, SynapseWorkspaceSqlPoolTableDataSetMappingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private SynapseWorkspaceSqlPoolTableDataSetMapping(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SynapseWorkspaceSqlPoolTableDataSetMapping get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
