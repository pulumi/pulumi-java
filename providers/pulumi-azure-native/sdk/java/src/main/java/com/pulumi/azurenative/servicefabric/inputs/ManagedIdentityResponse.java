...
public final class ManagedIdentityResponse extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param principalId The principal id of the managed identity. This property will only be provided for a system assigned identity.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param tenantId The tenant id of the managed identity. This property will only be provided for a system assigned identity.
         * 
         * @return builder
         * 
         */
