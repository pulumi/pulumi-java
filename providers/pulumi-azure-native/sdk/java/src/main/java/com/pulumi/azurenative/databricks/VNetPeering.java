...
public class VNetPeering extends CustomResource {
    /**
     ...
     */
    public VNetPeering(String name, VNetPeeringArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VNetPeering(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VNetPeering get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
