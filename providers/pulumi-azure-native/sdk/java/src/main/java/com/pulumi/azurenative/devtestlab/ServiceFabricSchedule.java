...
public class ServiceFabricSchedule extends com.pulumi.resources.CustomResource {
     ...
     */
    public ServiceFabricSchedule(String name, ServiceFabricScheduleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private ServiceFabricSchedule(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ServiceFabricSchedule get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
