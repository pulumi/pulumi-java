...
public class RemediationAtResourceGroup extends CustomResource {
    /**
     ...
     */
    public RemediationAtResourceGroup(String name, RemediationAtResourceGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RemediationAtResourceGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RemediationAtResourceGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
