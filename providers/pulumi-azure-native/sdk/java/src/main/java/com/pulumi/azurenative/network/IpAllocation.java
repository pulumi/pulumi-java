...
public class IpAllocation extends CustomResource {
    /**
     * IpAllocation tags.
     * 
     */
     ...
     */
    public IpAllocation(String name, IpAllocationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IpAllocation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IpAllocation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
