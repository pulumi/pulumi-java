...
public class LiveEvent extends CustomResource {
    /**
     ...
     */
    public LiveEvent(String name, LiveEventArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:media:LiveEvent", name, args == null ? LiveEventArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private LiveEvent(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LiveEvent get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
