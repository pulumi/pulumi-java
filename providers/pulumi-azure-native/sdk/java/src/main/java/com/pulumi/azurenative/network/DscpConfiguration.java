...
public class DscpConfiguration extends CustomResource {
    /**
     ...
     */
    public DscpConfiguration(String name, DscpConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DscpConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DscpConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
