...
public class ApiIssue extends CustomResource {
    /**
     ...
     */
    public ApiIssue(String name, ApiIssueArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApiIssue(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApiIssue get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
