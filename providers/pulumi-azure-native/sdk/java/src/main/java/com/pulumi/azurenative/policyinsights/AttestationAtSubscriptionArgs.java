...
public final class AttestationAtSubscriptionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AttestationAtSubscriptionArgs(AttestationAtSubscriptionArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AttestationAtSubscriptionArgs();
        }

        public Builder(AttestationAtSubscriptionArgs defaults) {
            $ = new AttestationAtSubscriptionArgs(Objects.requireNonNull(defaults));
        }
