 ...
 * 
 */
public final class ImpalaSourceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private ImpalaSourceResponse(ImpalaSourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ImpalaSourceResponse();
        }

        public Builder(ImpalaSourceResponse defaults) {
            $ = new ImpalaSourceResponse(Objects.requireNonNull(defaults));
        }
