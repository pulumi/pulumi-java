...
public class ConsoleWithLocation extends CustomResource {
    /**
     ...
     */
    public ConsoleWithLocation(String name, ConsoleWithLocationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConsoleWithLocation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConsoleWithLocation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
