...
public class Python2Package extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public Python2Package(String name, Python2PackageArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private Python2Package(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Python2Package get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
