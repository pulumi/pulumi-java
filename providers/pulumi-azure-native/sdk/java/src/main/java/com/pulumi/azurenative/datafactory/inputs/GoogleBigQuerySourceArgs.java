 ...
 * 
 */
public final class GoogleBigQuerySourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GoogleBigQuerySourceArgs(GoogleBigQuerySourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleBigQuerySourceArgs();
        }

        public Builder(GoogleBigQuerySourceArgs defaults) {
            $ = new GoogleBigQuerySourceArgs(Objects.requireNonNull(defaults));
        }
