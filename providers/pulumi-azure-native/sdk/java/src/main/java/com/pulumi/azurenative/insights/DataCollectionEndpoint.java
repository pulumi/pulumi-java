...
public class DataCollectionEndpoint extends CustomResource {
    /**
     ...
     */
    public DataCollectionEndpoint(String name, DataCollectionEndpointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DataCollectionEndpoint(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DataCollectionEndpoint get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
