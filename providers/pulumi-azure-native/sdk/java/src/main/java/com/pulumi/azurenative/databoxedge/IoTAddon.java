...
public class IoTAddon extends CustomResource {
    /**
     ...
     */
    public IoTAddon(String name, IoTAddonArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:databoxedge:IoTAddon", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private IoTAddon(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IoTAddon get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
