 ...
 * 
 */
public final class SapCloudForCustomerSourceArgs extends ResourceArgs {

    public static final SapCloudForCustomerSourceArgs Empty = new SapCloudForCustomerSourceArgs();
    ...
    /**
     * @return SAP Cloud for Customer OData query. For example, &#34;$top=1&#34;. Type: string (or Expression with resultType string).
     * 
     */
    ...
    private SapCloudForCustomerSourceArgs() {}

    private SapCloudForCustomerSourceArgs(SapCloudForCustomerSourceArgs $) {
    ...
    public static Builder builder(SapCloudForCustomerSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SapCloudForCustomerSourceArgs();
        }

        public Builder(SapCloudForCustomerSourceArgs defaults) {
            $ = new SapCloudForCustomerSourceArgs(Objects.requireNonNull(defaults));
        }
