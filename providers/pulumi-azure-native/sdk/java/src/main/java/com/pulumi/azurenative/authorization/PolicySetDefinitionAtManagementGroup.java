...
public class PolicySetDefinitionAtManagementGroup extends CustomResource {
    /**
     ...
     */
    public PolicySetDefinitionAtManagementGroup(String name, PolicySetDefinitionAtManagementGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PolicySetDefinitionAtManagementGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PolicySetDefinitionAtManagementGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
