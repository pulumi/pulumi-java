...
public class LabAccount extends CustomResource {
    /**
     ...
     */
    public LabAccount(String name, LabAccountArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LabAccount(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LabAccount get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
