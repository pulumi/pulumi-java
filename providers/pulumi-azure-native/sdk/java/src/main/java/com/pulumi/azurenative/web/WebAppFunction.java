...
public class WebAppFunction extends CustomResource {
    /**
     * Config information.
     * 
     */
     ...
     */
    public WebAppFunction(String name, WebAppFunctionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppFunction(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppFunction get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
