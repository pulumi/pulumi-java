...
public final class GetIoTAddonArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetIoTAddonArgs(GetIoTAddonArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(GetIoTAddonArgs defaults) {
            $ = new GetIoTAddonArgs(Objects.requireNonNull(defaults));
        }
