...
public class WebAppSitePushSettings extends CustomResource {
    /**
     ...
     */
    public WebAppSitePushSettings(String name, WebAppSitePushSettingsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppSitePushSettings(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppSitePushSettings get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
