...
public class PrivateCloud extends CustomResource {
    /**
     ...
     */
    public PrivateCloud(String name, PrivateCloudArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:avs:PrivateCloud", name, args == null ? PrivateCloudArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private PrivateCloud(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateCloud get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
