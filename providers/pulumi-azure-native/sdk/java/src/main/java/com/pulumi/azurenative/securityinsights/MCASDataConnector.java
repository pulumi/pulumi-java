...
public class MCASDataConnector extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    public Output<Optional<MCASDataConnectorDataTypesResponse>> dataTypes() {
     ...
     */
    public MCASDataConnector(String name, MCASDataConnectorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:securityinsights:MCASDataConnector", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private MCASDataConnector(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static MCASDataConnector get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
