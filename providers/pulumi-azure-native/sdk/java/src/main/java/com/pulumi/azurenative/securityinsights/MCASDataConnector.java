...
public class MCASDataConnector extends CustomResource {
    /**
     ...
     */
    public MCASDataConnector(String name, MCASDataConnectorArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:securityinsights:MCASDataConnector", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private MCASDataConnector(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MCASDataConnector get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
