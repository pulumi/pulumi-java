...
public class AccessControlRecord extends CustomResource {
    /**
     ...
     */
    public AccessControlRecord(String name, AccessControlRecordArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AccessControlRecord(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AccessControlRecord get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
