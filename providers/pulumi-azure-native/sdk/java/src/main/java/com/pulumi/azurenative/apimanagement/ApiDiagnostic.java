...
public class ApiDiagnostic extends CustomResource {
    /**
     ...
     */
    public ApiDiagnostic(String name, ApiDiagnosticArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApiDiagnostic(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApiDiagnostic get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
