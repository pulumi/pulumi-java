...
public class Kpi extends CustomResource {
    /**
     * The aliases.
     * 
     */
     ...
     */
    public Kpi(String name, KpiArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:customerinsights:Kpi", name, args == null ? KpiArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Kpi(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Kpi get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
