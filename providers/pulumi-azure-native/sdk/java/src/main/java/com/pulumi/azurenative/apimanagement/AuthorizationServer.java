...
public class AuthorizationServer extends CustomResource {
    /**
     ...
     */
    public AuthorizationServer(String name, AuthorizationServerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AuthorizationServer(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AuthorizationServer get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
