...
public class MongoDBResourceMongoDBDatabase extends CustomResource {
    /**
     ...
     */
    public MongoDBResourceMongoDBDatabase(String name, MongoDBResourceMongoDBDatabaseArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MongoDBResourceMongoDBDatabase(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MongoDBResourceMongoDBDatabase get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
