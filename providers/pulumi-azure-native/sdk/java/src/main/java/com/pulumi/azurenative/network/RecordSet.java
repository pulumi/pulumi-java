...
public class RecordSet extends CustomResource {
    ...
    private RecordSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RecordSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
