...
public class ConnectionGateway extends CustomResource {
    /**
     * Resource ETag
     * 
     */
     ...
     */
    public ConnectionGateway(String name, ConnectionGatewayArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConnectionGateway(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConnectionGateway get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
