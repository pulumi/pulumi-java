 ...
 * 
 */
@ResourceType(type="azure-native:healthcareapis:WorkspacePrivateEndpointConnection")
public class WorkspacePrivateEndpointConnection extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public WorkspacePrivateEndpointConnection(String name) {
        this(name, WorkspacePrivateEndpointConnectionArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public WorkspacePrivateEndpointConnection(String name, WorkspacePrivateEndpointConnectionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WorkspacePrivateEndpointConnection(String name, WorkspacePrivateEndpointConnectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:healthcareapis:WorkspacePrivateEndpointConnection", name, args == null ? WorkspacePrivateEndpointConnectionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private WorkspacePrivateEndpointConnection(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:healthcareapis:WorkspacePrivateEndpointConnection", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static WorkspacePrivateEndpointConnection get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
