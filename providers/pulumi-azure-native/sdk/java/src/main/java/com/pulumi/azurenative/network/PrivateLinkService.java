...
public class PrivateLinkService extends CustomResource {
    /**
     ...
     */
    public PrivateLinkService(String name, PrivateLinkServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateLinkService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateLinkService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
