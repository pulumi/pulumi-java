 ...
 * 
 */
public final class GoogleAdWordsObjectDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GoogleAdWordsObjectDatasetArgs(GoogleAdWordsObjectDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleAdWordsObjectDatasetArgs();
        }

        public Builder(GoogleAdWordsObjectDatasetArgs defaults) {
            $ = new GoogleAdWordsObjectDatasetArgs(Objects.requireNonNull(defaults));
        }
