...
public class MultipleActivationKey extends CustomResource {
    /**
     ...
     */
    public MultipleActivationKey(String name, MultipleActivationKeyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MultipleActivationKey(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MultipleActivationKey get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
