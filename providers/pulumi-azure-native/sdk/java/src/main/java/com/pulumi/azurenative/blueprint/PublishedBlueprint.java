...
public class PublishedBlueprint extends CustomResource {
    /**
     ...
     */
    public PublishedBlueprint(String name, PublishedBlueprintArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PublishedBlueprint(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PublishedBlueprint get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
