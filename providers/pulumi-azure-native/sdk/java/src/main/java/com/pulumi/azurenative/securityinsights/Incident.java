...
public class Incident extends CustomResource {
    /**
     ...
     */
    public Incident(String name, IncidentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Incident(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Incident get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
