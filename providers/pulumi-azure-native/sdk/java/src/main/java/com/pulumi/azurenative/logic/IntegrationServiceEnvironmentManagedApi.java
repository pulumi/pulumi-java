...
public class IntegrationServiceEnvironmentManagedApi extends CustomResource {
    /**
     * The API definition.
     * 
     */
     ...
     */
    public IntegrationServiceEnvironmentManagedApi(String name, IntegrationServiceEnvironmentManagedApiArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IntegrationServiceEnvironmentManagedApi(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IntegrationServiceEnvironmentManagedApi get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
