...
public class HubVirtualNetworkConnection extends CustomResource {
    /**
     ...
     */
    public HubVirtualNetworkConnection(String name, HubVirtualNetworkConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HubVirtualNetworkConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HubVirtualNetworkConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
