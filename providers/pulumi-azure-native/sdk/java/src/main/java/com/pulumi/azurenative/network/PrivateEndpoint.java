...
public class PrivateEndpoint extends CustomResource {
    /**
     ...
     */
    public PrivateEndpoint(String name, PrivateEndpointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateEndpoint(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateEndpoint get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
