...
public final class GetBlobDataSetMappingArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetBlobDataSetMappingArgs(GetBlobDataSetMappingArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBlobDataSetMappingArgs();
        }

        public Builder(GetBlobDataSetMappingArgs defaults) {
            $ = new GetBlobDataSetMappingArgs(Objects.requireNonNull(defaults));
        }
