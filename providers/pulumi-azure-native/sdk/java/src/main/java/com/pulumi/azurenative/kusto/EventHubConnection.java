...
public class EventHubConnection extends CustomResource {
    /**
     ...
     */
    public EventHubConnection(String name, EventHubConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EventHubConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EventHubConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
