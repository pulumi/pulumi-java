 ...
 * 
 */
public final class HubspotObjectDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private HubspotObjectDatasetArgs(HubspotObjectDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HubspotObjectDatasetArgs();
        }

        public Builder(HubspotObjectDatasetArgs defaults) {
            $ = new HubspotObjectDatasetArgs(Objects.requireNonNull(defaults));
        }
