...
public class AzureFirewall extends CustomResource {
    /**
     ...
     */
    public AzureFirewall(String name, AzureFirewallArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AzureFirewall(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AzureFirewall get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
