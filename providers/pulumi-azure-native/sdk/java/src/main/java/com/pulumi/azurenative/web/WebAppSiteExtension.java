...
public class WebAppSiteExtension extends CustomResource {
    /**
     * List of authors.
     * 
     */
     ...
     */
    public WebAppSiteExtension(String name, WebAppSiteExtensionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppSiteExtension(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppSiteExtension get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
