...
public class ManagedInstanceAdministrator extends CustomResource {
    /**
     ...
     */
    public ManagedInstanceAdministrator(String name, ManagedInstanceAdministratorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagedInstanceAdministrator(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagedInstanceAdministrator get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
