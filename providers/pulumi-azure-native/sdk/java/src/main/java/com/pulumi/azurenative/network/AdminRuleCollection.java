...
public class AdminRuleCollection extends CustomResource {
    /**
     ...
     */
    public AdminRuleCollection(String name, AdminRuleCollectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AdminRuleCollection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AdminRuleCollection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
