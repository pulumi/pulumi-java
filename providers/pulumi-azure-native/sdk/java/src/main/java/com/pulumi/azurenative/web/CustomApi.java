...
public class CustomApi extends CustomResource {
    /**
     * Resource ETag
     * 
     */
     ...
     */
    public CustomApi(String name, CustomApiArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:web:CustomApi", name, args == null ? CustomApiArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private CustomApi(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomApi get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
