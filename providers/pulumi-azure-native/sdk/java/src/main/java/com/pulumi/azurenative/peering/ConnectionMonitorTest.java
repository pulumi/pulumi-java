...
public class ConnectionMonitorTest extends CustomResource {
    /**
     ...
     */
    public ConnectionMonitorTest(String name, ConnectionMonitorTestArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConnectionMonitorTest(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConnectionMonitorTest get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
