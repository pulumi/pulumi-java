...
public class AccountFilter extends com.pulumi.resources.CustomResource {
    ...
    private AccountFilter(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static AccountFilter get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
