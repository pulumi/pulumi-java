...
public class AccountFilter extends CustomResource {
    /**
     * The first quality.
     * 
     */
     ...
     */
    public AccountFilter(String name, AccountFilterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AccountFilter(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AccountFilter get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
