 ...
 * 
 */
@ResourceType(type="azure-native:eventgrid:DomainEventSubscription")
public class DomainEventSubscription extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public DomainEventSubscription(String name) {
        this(name, DomainEventSubscriptionArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DomainEventSubscription(String name, DomainEventSubscriptionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DomainEventSubscription(String name, DomainEventSubscriptionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:eventgrid:DomainEventSubscription", name, args == null ? DomainEventSubscriptionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DomainEventSubscription(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:eventgrid:DomainEventSubscription", name, null, makeResourceOptions(options, id));
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:eventgrid/v20211015preview:DomainEventSubscription").build())
            ))
            .build();
     ...
     */
    public static DomainEventSubscription get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
