...
public class StreamingLocator extends CustomResource {
    /**
     ...
     */
    public StreamingLocator(String name, StreamingLocatorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StreamingLocator(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StreamingLocator get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
