...
public final class GetSqlDBTableDataSetMappingArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetSqlDBTableDataSetMappingArgs(GetSqlDBTableDataSetMappingArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSqlDBTableDataSetMappingArgs();
        }

        public Builder(GetSqlDBTableDataSetMappingArgs defaults) {
            $ = new GetSqlDBTableDataSetMappingArgs(Objects.requireNonNull(defaults));
        }
