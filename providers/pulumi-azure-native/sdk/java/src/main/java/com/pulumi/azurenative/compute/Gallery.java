...
public class Gallery extends CustomResource {
    /**
     ...
     */
    public Gallery(String name, GalleryArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:compute:Gallery", name, args == null ? GalleryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Gallery(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Gallery get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
