...
public class Linker extends CustomResource {
    /**
     ...
     */
    public Linker(String name, LinkerArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:servicelinker:Linker", name, args == null ? LinkerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Linker(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Linker get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
