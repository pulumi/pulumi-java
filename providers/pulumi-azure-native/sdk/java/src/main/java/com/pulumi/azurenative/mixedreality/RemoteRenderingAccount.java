...
public class RemoteRenderingAccount extends CustomResource {
    /**
     ...
     */
    public RemoteRenderingAccount(String name, RemoteRenderingAccountArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RemoteRenderingAccount(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RemoteRenderingAccount get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
