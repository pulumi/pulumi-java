...
public class Factory extends CustomResource {
    /**
     ...
     */
    public Factory(String name, FactoryArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datafactory:Factory", name, args == null ? FactoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Factory(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Factory get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
