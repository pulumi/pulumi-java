...
public class PipelineRun extends CustomResource {
     ...
     */
    public PipelineRun(String name, PipelineRunArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PipelineRun(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PipelineRun get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
