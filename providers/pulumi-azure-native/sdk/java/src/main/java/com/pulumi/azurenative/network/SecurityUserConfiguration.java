...
public class SecurityUserConfiguration extends CustomResource {
    /**
     ...
     */
    public SecurityUserConfiguration(String name, SecurityUserConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SecurityUserConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SecurityUserConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
