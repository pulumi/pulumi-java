...
public class InstanceFailoverGroup extends CustomResource {
    /**
     ...
     */
    public InstanceFailoverGroup(String name, InstanceFailoverGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private InstanceFailoverGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static InstanceFailoverGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
