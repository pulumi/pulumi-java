...
public class EmailTemplate extends CustomResource {
    /**
     ...
     */
    public EmailTemplate(String name, EmailTemplateArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EmailTemplate(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EmailTemplate get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
