...
public class NetworkInterfaceTapConfiguration extends CustomResource {
    /**
     ...
     */
    public NetworkInterfaceTapConfiguration(String name, NetworkInterfaceTapConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NetworkInterfaceTapConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkInterfaceTapConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
