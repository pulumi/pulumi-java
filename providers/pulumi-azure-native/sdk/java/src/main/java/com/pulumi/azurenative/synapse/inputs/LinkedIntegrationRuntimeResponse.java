...
public final class LinkedIntegrationRuntimeResponse extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param dataFactoryLocation The location of the workspace for which the linked integration runtime belong to.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param dataFactoryName The name of the workspace for which the linked integration runtime belong to.
         * 
         * @return builder
         * 
         */
