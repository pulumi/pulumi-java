 ...
 * 
 */
public final class CosmosDbMongoDbApiCollectionDatasetResponse extends com.pulumi.resources.InvokeArgs {

    public static final CosmosDbMongoDbApiCollectionDatasetResponse Empty = new CosmosDbMongoDbApiCollectionDatasetResponse();
    ...
    /**
     * @return The collection name of the CosmosDB (MongoDB API) database. Type: string (or Expression with resultType string).
     * 
     */
