 ...
 * 
 */
public final class PhoenixObjectDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PhoenixObjectDatasetArgs(PhoenixObjectDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PhoenixObjectDatasetArgs();
        }

        public Builder(PhoenixObjectDatasetArgs defaults) {
            $ = new PhoenixObjectDatasetArgs(Objects.requireNonNull(defaults));
        }
