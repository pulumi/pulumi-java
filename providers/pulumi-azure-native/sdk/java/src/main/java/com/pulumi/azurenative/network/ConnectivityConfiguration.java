...
public class ConnectivityConfiguration extends CustomResource {
    /**
     ...
     */
    public ConnectivityConfiguration(String name, ConnectivityConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConnectivityConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConnectivityConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
