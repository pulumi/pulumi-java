 ...
 * 
 */
public final class SalesforceSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final SalesforceSourceArgs Empty = new SalesforceSourceArgs();
    ...
    public Output<Either<String,SalesforceSourceReadBehavior>> getReadBehavior() {
        return this.readBehavior == null ? Codegen.empty() : this.readBehavior;
    }
    ...
    public SalesforceSourceArgs(
        ...
        @Nullable Output<Either<String,SalesforceSourceReadBehavior>> readBehavior,
    ...
    private SalesforceSourceArgs() {
        ...
        this.readBehavior = Codegen.empty();
    ...
    public static Builder builder(SalesforceSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SalesforceSourceArgs defaults) {
        ...
        public Builder readBehavior(@Nullable Either<String,SalesforceSourceReadBehavior> readBehavior) {
            this.readBehavior = Codegen.ofNullable(readBehavior);
            return this;
        }
