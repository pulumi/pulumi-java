...
public class EndpointVariant extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public EndpointVariant(String name, EndpointVariantArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:machinelearningservices:EndpointVariant", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private EndpointVariant(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:machinelearningservices/v20200501preview:EndpointVariant").build()),
                Output.of(Alias.builder().type("azure-native:machinelearningservices/v20200515preview:EndpointVariant").build()),
                Output.of(Alias.builder().type("azure-native:machinelearningservices/v20200901preview:EndpointVariant").build()),
                Output.of(Alias.builder().type("azure-native:machinelearningservices/v20210101:EndpointVariant").build()),
                Output.of(Alias.builder().type("azure-native:machinelearningservices/v20210401:EndpointVariant").build())
            ))
            .build();
     ...
     */
    public static EndpointVariant get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
