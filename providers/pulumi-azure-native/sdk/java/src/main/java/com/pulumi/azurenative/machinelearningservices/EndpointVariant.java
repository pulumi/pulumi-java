...
public class EndpointVariant extends CustomResource {
    /**
     ...
     */
    public EndpointVariant(String name, EndpointVariantArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:machinelearningservices:EndpointVariant", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private EndpointVariant(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EndpointVariant get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
