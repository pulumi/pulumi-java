...
public class AttachedDatabaseConfiguration extends CustomResource {
    /**
     ...
     */
    public AttachedDatabaseConfiguration(String name, AttachedDatabaseConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AttachedDatabaseConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AttachedDatabaseConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
