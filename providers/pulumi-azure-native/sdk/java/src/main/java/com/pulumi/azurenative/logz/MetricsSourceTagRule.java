...
public class MetricsSourceTagRule extends CustomResource {
    /**
     ...
     */
    public MetricsSourceTagRule(String name, MetricsSourceTagRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MetricsSourceTagRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MetricsSourceTagRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
