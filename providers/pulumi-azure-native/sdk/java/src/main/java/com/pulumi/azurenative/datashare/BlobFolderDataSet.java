...
public class BlobFolderDataSet extends CustomResource {
    /**
     ...
     */
    public BlobFolderDataSet(String name, BlobFolderDataSetArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datashare:BlobFolderDataSet", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private BlobFolderDataSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BlobFolderDataSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
