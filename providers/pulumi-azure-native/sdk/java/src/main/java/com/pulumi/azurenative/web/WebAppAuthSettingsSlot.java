...
public class WebAppAuthSettingsSlot extends CustomResource {
    /**
     ...
     */
    public WebAppAuthSettingsSlot(String name, WebAppAuthSettingsSlotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppAuthSettingsSlot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppAuthSettingsSlot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
