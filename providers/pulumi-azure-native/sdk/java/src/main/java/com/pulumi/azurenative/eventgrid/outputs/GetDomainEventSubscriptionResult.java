...
@CustomType
public final class GetDomainEventSubscriptionResult {
    /**
    ...
    public static Builder builder(GetDomainEventSubscriptionResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetDomainEventSubscriptionResult defaults) {
        ...
        public Builder type(String type) {
            ...
            return this;
        }        public GetDomainEventSubscriptionResult build() {
            return new GetDomainEventSubscriptionResult(deadLetterDestination, deadLetterWithResourceIdentity, deliveryWithResourceIdentity, destination, eventDeliverySchema, expirationTimeUtc, filter, id, labels, name, provisioningState, retryPolicy, systemData, topic, type);
        }
    }
}
