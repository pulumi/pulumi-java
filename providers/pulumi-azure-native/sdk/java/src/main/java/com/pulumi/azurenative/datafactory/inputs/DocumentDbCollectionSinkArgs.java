 ...
 * 
 */
public final class DocumentDbCollectionSinkArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DocumentDbCollectionSinkArgs(DocumentDbCollectionSinkArgs $) {
    ...
    public static Builder builder(DocumentDbCollectionSinkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DocumentDbCollectionSinkArgs();
        }

        public Builder(DocumentDbCollectionSinkArgs defaults) {
            $ = new DocumentDbCollectionSinkArgs(Objects.requireNonNull(defaults));
        }
