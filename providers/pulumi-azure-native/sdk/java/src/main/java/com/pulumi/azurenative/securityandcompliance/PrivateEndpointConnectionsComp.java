...
public class PrivateEndpointConnectionsComp extends CustomResource {
    /**
     ...
     */
    public PrivateEndpointConnectionsComp(String name, PrivateEndpointConnectionsCompArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:securityandcompliance:PrivateEndpointConnectionsComp", name, args == null ? PrivateEndpointConnectionsCompArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private PrivateEndpointConnectionsComp(String name, Output<String> id, @Nullable CustomResourceOptions options) {
    ...
    private static CustomResourceOptions makeResourceOptions(@Nullable CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsComp").build()),
                Output.of(Alias.builder().type("azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsComp").build())
            ))
            .build();
     ...
     */
    public static PrivateEndpointConnectionsComp get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
