...
public class ScalingPlan extends CustomResource {
     ...
     */
    public ScalingPlan(String name, ScalingPlanArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ScalingPlan(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ScalingPlan get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
