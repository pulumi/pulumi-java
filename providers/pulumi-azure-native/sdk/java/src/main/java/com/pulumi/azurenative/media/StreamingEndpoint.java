...
public class StreamingEndpoint extends CustomResource {
    /**
     ...
     */
    public StreamingEndpoint(String name, StreamingEndpointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StreamingEndpoint(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StreamingEndpoint get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
