...
public class PolicyDefinition extends CustomResource {
    /**
     ...
     */
    public PolicyDefinition(String name, @Nullable PolicyDefinitionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PolicyDefinition(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PolicyDefinition get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
