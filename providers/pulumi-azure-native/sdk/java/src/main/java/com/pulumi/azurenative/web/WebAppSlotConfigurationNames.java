...
public class WebAppSlotConfigurationNames extends CustomResource {
    /**
     ...
     */
    public WebAppSlotConfigurationNames(String name, WebAppSlotConfigurationNamesArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppSlotConfigurationNames(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppSlotConfigurationNames get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
