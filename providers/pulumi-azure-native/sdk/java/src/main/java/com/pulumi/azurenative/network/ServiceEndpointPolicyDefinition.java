...
public class ServiceEndpointPolicyDefinition extends CustomResource {
    /**
     ...
     */
    public ServiceEndpointPolicyDefinition(String name, ServiceEndpointPolicyDefinitionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceEndpointPolicyDefinition(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceEndpointPolicyDefinition get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
