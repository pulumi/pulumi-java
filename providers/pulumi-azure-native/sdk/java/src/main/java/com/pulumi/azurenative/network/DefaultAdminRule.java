...
public class DefaultAdminRule extends CustomResource {
    /**
     ...
     */
    public DefaultAdminRule(String name, DefaultAdminRuleArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:network:DefaultAdminRule", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private DefaultAdminRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DefaultAdminRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
