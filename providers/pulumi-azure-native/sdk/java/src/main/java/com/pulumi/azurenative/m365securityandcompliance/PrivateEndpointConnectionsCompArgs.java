...
public final class PrivateEndpointConnectionsCompArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PrivateEndpointConnectionsCompArgs(PrivateEndpointConnectionsCompArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PrivateEndpointConnectionsCompArgs();
        }

        public Builder(PrivateEndpointConnectionsCompArgs defaults) {
            $ = new PrivateEndpointConnectionsCompArgs(Objects.requireNonNull(defaults));
        }
