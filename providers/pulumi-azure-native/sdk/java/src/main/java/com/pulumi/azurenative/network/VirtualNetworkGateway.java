...
public class VirtualNetworkGateway extends CustomResource {
    /**
     * ActiveActive flag.
     * 
     */
     ...
     */
    public VirtualNetworkGateway(String name, VirtualNetworkGatewayArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualNetworkGateway(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualNetworkGateway get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
