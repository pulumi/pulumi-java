 ...
 * 
 */
public final class HBaseSourceResponse extends com.pulumi.resources.InvokeArgs {

    public static final HBaseSourceResponse Empty = new HBaseSourceResponse();
    ...
    private HBaseSourceResponse(HBaseSourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HBaseSourceResponse();
        }

        public Builder(HBaseSourceResponse defaults) {
            $ = new HBaseSourceResponse(Objects.requireNonNull(defaults));
        }
