...
public class NamespaceNetworkRuleSet extends CustomResource {
    /**
     ...
     */
    public NamespaceNetworkRuleSet(String name, NamespaceNetworkRuleSetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NamespaceNetworkRuleSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NamespaceNetworkRuleSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
