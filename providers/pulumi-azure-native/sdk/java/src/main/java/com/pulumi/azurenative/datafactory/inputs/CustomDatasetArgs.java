 ...
 * 
 */
public final class CustomDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CustomDatasetArgs(CustomDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CustomDatasetArgs();
        }

        public Builder(CustomDatasetArgs defaults) {
            $ = new CustomDatasetArgs(Objects.requireNonNull(defaults));
        }
