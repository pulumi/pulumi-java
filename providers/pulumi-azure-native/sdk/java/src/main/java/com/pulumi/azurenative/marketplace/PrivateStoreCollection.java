...
public class PrivateStoreCollection extends CustomResource {
    /**
     ...
     */
    public PrivateStoreCollection(String name, PrivateStoreCollectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateStoreCollection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateStoreCollection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
