...
public class JobSchedule extends CustomResource {
    /**
     ...
     */
    public JobSchedule(String name, JobScheduleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private JobSchedule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static JobSchedule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
