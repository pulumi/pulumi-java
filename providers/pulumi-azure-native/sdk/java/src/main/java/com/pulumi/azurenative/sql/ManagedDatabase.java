...
public class ManagedDatabase extends CustomResource {
    /**
     ...
     */
    public ManagedDatabase(String name, ManagedDatabaseArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagedDatabase(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagedDatabase get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
