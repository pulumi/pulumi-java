...
public class DataManager extends CustomResource {
    /**
     ...
     */
    public DataManager(String name, DataManagerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DataManager(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DataManager get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
