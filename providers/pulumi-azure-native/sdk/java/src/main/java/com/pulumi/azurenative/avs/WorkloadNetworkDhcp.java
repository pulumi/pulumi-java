...
public class WorkloadNetworkDhcp extends CustomResource {
    /**
     ...
     */
    public WorkloadNetworkDhcp(String name, WorkloadNetworkDhcpArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WorkloadNetworkDhcp(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkloadNetworkDhcp get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
