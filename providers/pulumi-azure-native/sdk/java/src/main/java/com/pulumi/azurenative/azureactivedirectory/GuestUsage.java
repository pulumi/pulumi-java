...
public class GuestUsage extends CustomResource {
    /**
     ...
     */
    public GuestUsage(String name, GuestUsageArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GuestUsage(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GuestUsage get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
