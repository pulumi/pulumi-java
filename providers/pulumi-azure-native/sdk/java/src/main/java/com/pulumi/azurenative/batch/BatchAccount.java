...
public class BatchAccount extends CustomResource {
    /**
     ...
     */
    public BatchAccount(String name, BatchAccountArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BatchAccount(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BatchAccount get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
