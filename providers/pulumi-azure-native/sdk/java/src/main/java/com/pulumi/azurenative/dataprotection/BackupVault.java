...
public class BackupVault extends CustomResource {
    /**
     * Optional ETag.
     * 
     */
     ...
     */
    public BackupVault(String name, BackupVaultArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BackupVault(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BackupVault get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
