...
public class ControllerDetails extends CustomResource {
    /**
     ...
     */
    public ControllerDetails(String name, ControllerDetailsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ControllerDetails(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ControllerDetails get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
