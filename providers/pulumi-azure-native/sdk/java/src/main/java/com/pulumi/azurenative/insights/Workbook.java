...
public class Workbook extends CustomResource {
    /**
     ...
     */
    public Workbook(String name, WorkbookArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:insights:Workbook", name, args == null ? WorkbookArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Workbook(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Workbook get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
