...
public class AFDCustomDomain extends CustomResource {
    /**
     ...
     */
    public AFDCustomDomain(String name, AFDCustomDomainArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AFDCustomDomain(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AFDCustomDomain get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
