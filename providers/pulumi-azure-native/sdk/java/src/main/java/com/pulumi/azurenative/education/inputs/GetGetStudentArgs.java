...
public final class GetGetStudentArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetGetStudentArgs Empty = new GetGetStudentArgs();
    ...
    private GetGetStudentArgs() {}

    private GetGetStudentArgs(GetGetStudentArgs $) {
    ...
    public static Builder builder(GetGetStudentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGetStudentArgs();
        }

        public Builder(GetGetStudentArgs defaults) {
            $ = new GetGetStudentArgs(Objects.requireNonNull(defaults));
        }
