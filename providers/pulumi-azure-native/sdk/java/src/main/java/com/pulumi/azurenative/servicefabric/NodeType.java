...
public class NodeType extends CustomResource {
    /**
     ...
     */
    public NodeType(String name, NodeTypeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NodeType(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NodeType get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
