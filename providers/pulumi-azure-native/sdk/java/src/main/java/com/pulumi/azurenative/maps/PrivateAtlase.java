...
public class PrivateAtlase extends CustomResource {
    /**
     ...
     */
    public PrivateAtlase(String name, PrivateAtlaseArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateAtlase(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateAtlase get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
