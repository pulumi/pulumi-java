...
public class IncidentComment extends CustomResource {
    /**
     ...
     */
    public IncidentComment(String name, IncidentCommentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IncidentComment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IncidentComment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
