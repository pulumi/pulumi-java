...
public class InstancePool extends CustomResource {
    /**
     ...
     */
    public InstancePool(String name, InstancePoolArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:sql:InstancePool", name, args == null ? InstancePoolArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private InstancePool(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static InstancePool get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
