...
public class LiveOutput extends CustomResource {
    /**
     ...
     */
    public LiveOutput(String name, LiveOutputArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:media:LiveOutput", name, args == null ? LiveOutputArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private LiveOutput(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LiveOutput get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
