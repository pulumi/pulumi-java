 ...
 * 
 */
public final class DrillTableDatasetResponse extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return The table name of the Drill. Type: string (or Expression with resultType string).
     * 
     */
    ...
    private DrillTableDatasetResponse() {}

    private DrillTableDatasetResponse(DrillTableDatasetResponse $) {
    ...
    public static Builder builder(DrillTableDatasetResponse defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DrillTableDatasetResponse();
        }

        public Builder(DrillTableDatasetResponse defaults) {
            $ = new DrillTableDatasetResponse(Objects.requireNonNull(defaults));
        }
