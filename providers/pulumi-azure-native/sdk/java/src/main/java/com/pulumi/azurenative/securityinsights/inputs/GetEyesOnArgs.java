...
public final class GetEyesOnArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetEyesOnArgs(GetEyesOnArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(GetEyesOnArgs defaults) {
            $ = new GetEyesOnArgs(Objects.requireNonNull(defaults));
        }
