...
public class EventHubEventSource extends CustomResource {
    /**
     ...
     */
    public EventHubEventSource(String name, EventHubEventSourceArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:timeseriesinsights:EventHubEventSource", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private EventHubEventSource(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EventHubEventSource get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
