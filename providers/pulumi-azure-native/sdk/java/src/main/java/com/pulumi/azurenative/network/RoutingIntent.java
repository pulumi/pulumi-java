...
public class RoutingIntent extends CustomResource {
    /**
     ...
     */
    public RoutingIntent(String name, RoutingIntentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RoutingIntent(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RoutingIntent get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
