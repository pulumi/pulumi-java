...
public class EnvironmentSpecificationVersion extends CustomResource {
    /**
     ...
     */
    public EnvironmentSpecificationVersion(String name, EnvironmentSpecificationVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EnvironmentSpecificationVersion(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EnvironmentSpecificationVersion get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
