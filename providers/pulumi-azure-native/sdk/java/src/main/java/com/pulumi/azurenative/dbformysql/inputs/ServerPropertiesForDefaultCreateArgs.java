 ...
 * 
 */
public final class ServerPropertiesForDefaultCreateArgs extends ResourceArgs {
    ...
    /**
     * @return The administrator&#39;s login name of a server. Can only be specified when the server is being created (and is required for creation). The login name is required when updating password.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param administratorLogin The administrator&#39;s login name of a server. Can only be specified when the server is being created (and is required for creation). The login name is required when updating password.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param infrastructureEncryption Status showing whether the server enabled infrastructure encryption.
         * 
         * @return builder
         * 
         */
