...
public class CapacityReservationGroup extends CustomResource {
    /**
     ...
     */
    public CapacityReservationGroup(String name, CapacityReservationGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CapacityReservationGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CapacityReservationGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
