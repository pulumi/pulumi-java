...
public final class PrivateLinkServicesForEDMUploadArgs extends ResourceArgs {
    ...
    private PrivateLinkServicesForEDMUploadArgs(PrivateLinkServicesForEDMUploadArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PrivateLinkServicesForEDMUploadArgs();
        }

        public Builder(PrivateLinkServicesForEDMUploadArgs defaults) {
            $ = new PrivateLinkServicesForEDMUploadArgs(Objects.requireNonNull(defaults));
        }
