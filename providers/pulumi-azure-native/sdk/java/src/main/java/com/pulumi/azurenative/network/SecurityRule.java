...
public class SecurityRule extends CustomResource {
    /**
     ...
     */
    public SecurityRule(String name, SecurityRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SecurityRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SecurityRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
