...
public class WebAppSourceControlSlot extends CustomResource {
    /**
     ...
     */
    public WebAppSourceControlSlot(String name, WebAppSourceControlSlotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppSourceControlSlot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppSourceControlSlot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
