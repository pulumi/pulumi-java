...
public class ContentType extends CustomResource {
    /**
     ...
     */
    public ContentType(String name, ContentTypeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ContentType(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ContentType get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
