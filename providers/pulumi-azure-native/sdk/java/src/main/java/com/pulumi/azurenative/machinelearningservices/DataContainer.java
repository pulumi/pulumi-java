...
public class DataContainer extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public DataContainer(String name, DataContainerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private DataContainer(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static DataContainer get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
