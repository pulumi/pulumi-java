...
public class EncryptionScope extends CustomResource {
    /**
     ...
     */
    public EncryptionScope(String name, EncryptionScopeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EncryptionScope(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EncryptionScope get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
