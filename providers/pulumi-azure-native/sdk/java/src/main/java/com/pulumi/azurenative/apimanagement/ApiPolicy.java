...
public class ApiPolicy extends CustomResource {
    /**
     ...
     */
    public ApiPolicy(String name, ApiPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApiPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApiPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
