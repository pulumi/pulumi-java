...
public class PolicyDefinitionAtManagementGroup extends CustomResource {
    /**
     ...
     */
    public PolicyDefinitionAtManagementGroup(String name, PolicyDefinitionAtManagementGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PolicyDefinitionAtManagementGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PolicyDefinitionAtManagementGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
