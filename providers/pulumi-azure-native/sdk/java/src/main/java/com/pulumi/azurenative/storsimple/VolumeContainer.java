...
public class VolumeContainer extends CustomResource {
    /**
     ...
     */
    public VolumeContainer(String name, VolumeContainerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VolumeContainer(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VolumeContainer get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
