...
public class SqlPoolWorkloadGroup extends CustomResource {
    /**
     ...
     */
    public SqlPoolWorkloadGroup(String name, SqlPoolWorkloadGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SqlPoolWorkloadGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SqlPoolWorkloadGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
