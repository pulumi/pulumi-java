...
public class SqlServer extends CustomResource {
    /**
     ...
     */
    public SqlServer(String name, SqlServerArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:azuredata:SqlServer", name, args == null ? SqlServerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SqlServer(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SqlServer get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
