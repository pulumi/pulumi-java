 ...
 * 
 */
public final class JobInputClipResponse extends com.pulumi.resources.InvokeArgs {

    public static final JobInputClipResponse Empty = new JobInputClipResponse();
    ...
    private JobInputClipResponse(JobInputClipResponse $) {
        this.end = $.end;
        this.files = $.files;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobInputClipResponse();
        }

        public Builder(JobInputClipResponse defaults) {
            $ = new JobInputClipResponse(Objects.requireNonNull(defaults));
        }
