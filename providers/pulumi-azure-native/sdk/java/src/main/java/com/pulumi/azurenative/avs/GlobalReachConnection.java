...
public class GlobalReachConnection extends CustomResource {
    /**
     ...
     */
    public GlobalReachConnection(String name, GlobalReachConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GlobalReachConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GlobalReachConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
