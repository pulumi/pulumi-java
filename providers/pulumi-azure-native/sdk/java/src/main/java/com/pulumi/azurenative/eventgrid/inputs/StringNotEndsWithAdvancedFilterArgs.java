 ...
 * 
 */
public final class StringNotEndsWithAdvancedFilterArgs extends ResourceArgs {
    ...
    private StringNotEndsWithAdvancedFilterArgs(StringNotEndsWithAdvancedFilterArgs $) {
        this.key = $.key;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StringNotEndsWithAdvancedFilterArgs();
        }

        public Builder(StringNotEndsWithAdvancedFilterArgs defaults) {
            $ = new StringNotEndsWithAdvancedFilterArgs(Objects.requireNonNull(defaults));
        }
