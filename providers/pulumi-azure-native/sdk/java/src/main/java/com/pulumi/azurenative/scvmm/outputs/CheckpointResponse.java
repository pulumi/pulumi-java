...
public final class CheckpointResponse {
     ...
     * 
     */
    private final @Nullable String parentCheckpointID;

    @CustomType.Constructor
    private CheckpointResponse(
        @CustomType.Parameter("checkpointID") @Nullable String checkpointID,
        @CustomType.Parameter("description") @Nullable String description,
        @CustomType.Parameter("name") @Nullable String name,
        @CustomType.Parameter("parentCheckpointID") @Nullable String parentCheckpointID) {
    ...
    public static final class Builder {
        ...
        public Builder parentCheckpointID(@Nullable String parentCheckpointID) {
            ...
            return new CheckpointResponse(checkpointID, description, name, parentCheckpointID);
        }
    }
}
