...
public class ProactiveDetectionConfiguration extends CustomResource {
    /**
     ...
     */
    public ProactiveDetectionConfiguration(String name, ProactiveDetectionConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProactiveDetectionConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProactiveDetectionConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
