...
public class OrchestratorInstanceServiceDetails extends CustomResource {
    /**
     ...
     */
    public OrchestratorInstanceServiceDetails(String name, OrchestratorInstanceServiceDetailsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OrchestratorInstanceServiceDetails(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OrchestratorInstanceServiceDetails get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
