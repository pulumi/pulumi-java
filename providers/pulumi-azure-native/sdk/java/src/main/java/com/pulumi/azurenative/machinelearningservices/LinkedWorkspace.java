...
public class LinkedWorkspace extends CustomResource {
    /**
     ...
     */
    public LinkedWorkspace(String name, LinkedWorkspaceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LinkedWorkspace(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LinkedWorkspace get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
