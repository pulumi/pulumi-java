...
public class Bookmark extends CustomResource {
    /**
     ...
     */
    public Bookmark(String name, BookmarkArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Bookmark(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Bookmark get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
