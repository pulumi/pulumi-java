...
public class DeploymentAtSubscriptionScope extends CustomResource {
    /**
     ...
     */
    public DeploymentAtSubscriptionScope(String name, DeploymentAtSubscriptionScopeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DeploymentAtSubscriptionScope(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DeploymentAtSubscriptionScope get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
