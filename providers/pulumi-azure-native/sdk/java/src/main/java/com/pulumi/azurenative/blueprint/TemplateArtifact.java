...
public class TemplateArtifact extends CustomResource {
    /**
     ...
     */
    public TemplateArtifact(String name, TemplateArtifactArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:blueprint:TemplateArtifact", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private TemplateArtifact(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TemplateArtifact get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
