...
public class CassandraDataCenter extends CustomResource {
    /**
     ...
     */
    public CassandraDataCenter(String name, CassandraDataCenterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CassandraDataCenter(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CassandraDataCenter get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
