 ...
 * 
 */
public final class GoogleAdWordsSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GoogleAdWordsSourceArgs(GoogleAdWordsSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoogleAdWordsSourceArgs();
        }

        public Builder(GoogleAdWordsSourceArgs defaults) {
            $ = new GoogleAdWordsSourceArgs(Objects.requireNonNull(defaults));
        }
