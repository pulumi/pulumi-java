 ...
 * 
 */
public final class GreenplumTableDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GreenplumTableDatasetArgs(GreenplumTableDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GreenplumTableDatasetArgs();
        }

        public Builder(GreenplumTableDatasetArgs defaults) {
            $ = new GreenplumTableDatasetArgs(Objects.requireNonNull(defaults));
        }
