...
public class Blob extends CustomResource {
    /**
     ...
     */
    public Blob(String name, BlobArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:storage:Blob", name, args == null ? BlobArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Blob(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Blob get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
