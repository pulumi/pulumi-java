...
public class ActionRuleByName extends CustomResource {
    /**
     * Resource location
     * 
     */
     ...
     */
    public ActionRuleByName(String name, ActionRuleByNameArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ActionRuleByName(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ActionRuleByName get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
