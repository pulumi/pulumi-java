...
public final class GetGetLabPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetGetLabPlainArgs Empty = new GetGetLabPlainArgs();
    ...
    private GetGetLabPlainArgs() {}

    private GetGetLabPlainArgs(GetGetLabPlainArgs $) {
    ...
    public static Builder builder(GetGetLabPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetGetLabPlainArgs();
        }

        public Builder(GetGetLabPlainArgs defaults) {
            $ = new GetGetLabPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetGetLabPlainArgs build() {
