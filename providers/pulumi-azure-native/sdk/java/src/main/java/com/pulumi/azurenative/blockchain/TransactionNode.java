...
public class TransactionNode extends CustomResource {
    /**
     ...
     */
    public TransactionNode(String name, TransactionNodeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TransactionNode(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TransactionNode get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
