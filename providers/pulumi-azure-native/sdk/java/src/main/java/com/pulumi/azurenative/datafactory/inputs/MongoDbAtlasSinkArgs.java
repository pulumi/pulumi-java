 ...
 * 
 */
public final class MongoDbAtlasSinkArgs extends ResourceArgs {
    ...
    private MongoDbAtlasSinkArgs(MongoDbAtlasSinkArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MongoDbAtlasSinkArgs();
        }

        public Builder(MongoDbAtlasSinkArgs defaults) {
            $ = new MongoDbAtlasSinkArgs(Objects.requireNonNull(defaults));
        }
