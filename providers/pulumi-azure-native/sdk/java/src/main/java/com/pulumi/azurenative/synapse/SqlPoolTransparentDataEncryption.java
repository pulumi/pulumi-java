...
public class SqlPoolTransparentDataEncryption extends CustomResource {
    /**
     * Resource location.
     * 
     */
     ...
     */
    public SqlPoolTransparentDataEncryption(String name, SqlPoolTransparentDataEncryptionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SqlPoolTransparentDataEncryption(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SqlPoolTransparentDataEncryption get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
