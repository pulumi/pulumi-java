...
public class DisasterRecoveryConfiguration extends CustomResource {
    /**
     ...
     */
    public DisasterRecoveryConfiguration(String name, DisasterRecoveryConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DisasterRecoveryConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DisasterRecoveryConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
