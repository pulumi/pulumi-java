...
public class OuContainer extends CustomResource {
    /**
     ...
     */
    public OuContainer(String name, OuContainerArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:aad:OuContainer", name, args == null ? OuContainerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private OuContainer(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OuContainer get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
