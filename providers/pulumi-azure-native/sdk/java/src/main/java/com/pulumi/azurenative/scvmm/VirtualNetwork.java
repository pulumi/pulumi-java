 ...
 * 
 */
@ResourceType(type="azure-native:scvmm:VirtualNetwork")
public class VirtualNetwork extends com.pulumi.resources.CustomResource {
    ...
    public VirtualNetwork(String name, VirtualNetworkArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:scvmm:VirtualNetwork", name, args == null ? VirtualNetworkArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private VirtualNetwork(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:scvmm:VirtualNetwork", name, null, makeResourceOptions(options, id));
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:scvmm/v20200605preview:VirtualNetwork").build())
            ))
            .build();
