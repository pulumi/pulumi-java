...
public class ArcSetting extends CustomResource {
    /**
     ...
     */
    public ArcSetting(String name, ArcSettingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ArcSetting(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ArcSetting get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
