...
import com.pulumi.azurenative.cdn.enums.IsDeviceOperator;
 ...
 * 
 */
public final class IsDeviceMatchConditionParametersArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Output<Either<String,IsDeviceOperator>> operator() {
    ...
    private IsDeviceMatchConditionParametersArgs(IsDeviceMatchConditionParametersArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IsDeviceMatchConditionParametersArgs();
        }

        public Builder(IsDeviceMatchConditionParametersArgs defaults) {
            $ = new IsDeviceMatchConditionParametersArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder operator(IsDeviceOperator operator) {
