...
public class VirtualApplianceSite extends CustomResource {
    /**
     * Address Prefix.
     * 
     */
     ...
     */
    public VirtualApplianceSite(String name, VirtualApplianceSiteArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualApplianceSite(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualApplianceSite get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
