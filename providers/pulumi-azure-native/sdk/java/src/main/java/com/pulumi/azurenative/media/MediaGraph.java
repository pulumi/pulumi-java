...
public class MediaGraph extends CustomResource {
    /**
     ...
     */
    public MediaGraph(String name, MediaGraphArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:media:MediaGraph", name, args == null ? MediaGraphArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private MediaGraph(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MediaGraph get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
