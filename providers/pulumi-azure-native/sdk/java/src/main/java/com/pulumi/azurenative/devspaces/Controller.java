...
public class Controller extends CustomResource {
    /**
     ...
     */
    public Controller(String name, ControllerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Controller(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Controller get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
