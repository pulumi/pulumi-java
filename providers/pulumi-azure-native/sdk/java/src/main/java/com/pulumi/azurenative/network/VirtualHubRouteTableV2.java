...
public class VirtualHubRouteTableV2 extends CustomResource {
    /**
     ...
     */
    public VirtualHubRouteTableV2(String name, VirtualHubRouteTableV2Args args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualHubRouteTableV2(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualHubRouteTableV2 get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
