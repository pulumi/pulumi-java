...
public class ServerDetails extends CustomResource {
    /**
     ...
     */
    public ServerDetails(String name, ServerDetailsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServerDetails(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServerDetails get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
