...
public class IotConnector extends CustomResource {
    /**
     * Device Mappings.
     * 
     */
     ...
     */
    public IotConnector(String name, IotConnectorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IotConnector(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IotConnector get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
