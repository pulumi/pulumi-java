 ...
 * 
 */
public final class SalesforceSourceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private SalesforceSourceResponse(SalesforceSourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SalesforceSourceResponse();
        }

        public Builder(SalesforceSourceResponse defaults) {
            $ = new SalesforceSourceResponse(Objects.requireNonNull(defaults));
        }
