...
import com.pulumi.azurenative.securityinsights.ProductSettingArgs;
...
public class ProductSetting extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ProductSetting(String name, ProductSettingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:securityinsights:ProductSetting", name, args == null ? ProductSettingArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ProductSetting(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ProductSetting get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
