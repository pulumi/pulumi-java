...
public class ProductSetting extends CustomResource {
    /**
     ...
     */
    public ProductSetting(String name, ProductSettingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProductSetting(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProductSetting get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
