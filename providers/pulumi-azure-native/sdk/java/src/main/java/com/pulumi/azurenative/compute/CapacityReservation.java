...
public class CapacityReservation extends CustomResource {
    ...
    private CapacityReservation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CapacityReservation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
