...
public class ProximityPlacementGroup extends CustomResource {
    /**
     ...
     */
    public ProximityPlacementGroup(String name, ProximityPlacementGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProximityPlacementGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProximityPlacementGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
