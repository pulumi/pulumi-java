...
public class ConnectedRegistry extends CustomResource {
    /**
     ...
     */
    public ConnectedRegistry(String name, ConnectedRegistryArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConnectedRegistry(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConnectedRegistry get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
