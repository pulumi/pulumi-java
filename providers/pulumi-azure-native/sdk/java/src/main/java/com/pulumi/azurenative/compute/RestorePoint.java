...
public class RestorePoint extends CustomResource {
    /**
     ...
     */
    public RestorePoint(String name, RestorePointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RestorePoint(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RestorePoint get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
