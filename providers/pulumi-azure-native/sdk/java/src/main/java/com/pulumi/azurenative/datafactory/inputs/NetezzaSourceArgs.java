...
public final class NetezzaSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<NetezzaPartitionSettingsArgs>> partitionSettings() {
    ...
    private NetezzaSourceArgs(NetezzaSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetezzaSourceArgs();
        }

        public Builder(NetezzaSourceArgs defaults) {
            $ = new NetezzaSourceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder partitionSettings(NetezzaPartitionSettingsArgs partitionSettings) {
