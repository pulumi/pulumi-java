...
public class AssetFilter extends CustomResource {
    /**
     * The first quality.
     * 
     */
     ...
     */
    public AssetFilter(String name, AssetFilterArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:media:AssetFilter", name, args == null ? AssetFilterArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AssetFilter(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AssetFilter get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
