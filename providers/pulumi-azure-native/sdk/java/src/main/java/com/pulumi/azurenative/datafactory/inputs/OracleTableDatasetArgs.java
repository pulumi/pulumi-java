 ...
 * 
 */
public final class OracleTableDatasetArgs extends ResourceArgs {
    ...
    private OracleTableDatasetArgs(OracleTableDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OracleTableDatasetArgs();
        }

        public Builder(OracleTableDatasetArgs defaults) {
            $ = new OracleTableDatasetArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param table The table name of the on-premises Oracle database. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
