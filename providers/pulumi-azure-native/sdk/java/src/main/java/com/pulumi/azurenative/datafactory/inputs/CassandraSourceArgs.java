 ...
 * 
 */
public final class CassandraSourceArgs extends ResourceArgs {
     ...
     * 
     */
    public Optional<Output<Either<String,CassandraSourceReadConsistencyLevels>>> consistencyLevel() {
    ...
    private CassandraSourceArgs(CassandraSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CassandraSourceArgs();
        }

        public Builder(CassandraSourceArgs defaults) {
            $ = new CassandraSourceArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param consistencyLevel The consistency level specifies how many Cassandra servers must respond to a read request before returning data to the client application. Cassandra checks the specified number of Cassandra servers for data to satisfy the read request. Must be one of cassandraSourceReadConsistencyLevels. The default value is &#39;ONE&#39;. It is case-insensitive.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder consistencyLevel(Either<String,CassandraSourceReadConsistencyLevels> consistencyLevel) {
        ...
        /**
         * @param query Database query. Should be a SQL-92 query expression or Cassandra Query Language (CQL) command. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
