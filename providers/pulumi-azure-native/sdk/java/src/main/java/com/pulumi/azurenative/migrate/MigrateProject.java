...
public class MigrateProject extends CustomResource {
    /**
     ...
     */
    public MigrateProject(String name, MigrateProjectArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MigrateProject(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MigrateProject get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
