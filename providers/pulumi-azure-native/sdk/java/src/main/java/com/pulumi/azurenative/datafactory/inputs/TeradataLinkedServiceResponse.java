...
public final class TeradataLinkedServiceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private TeradataLinkedServiceResponse(TeradataLinkedServiceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TeradataLinkedServiceResponse();
        }

        public Builder(TeradataLinkedServiceResponse defaults) {
            $ = new TeradataLinkedServiceResponse(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param connectionString Teradata ODBC connection string. Type: string, SecureString or AzureKeyVaultSecretReference.
         * 
         * @return builder
         * 
         */
