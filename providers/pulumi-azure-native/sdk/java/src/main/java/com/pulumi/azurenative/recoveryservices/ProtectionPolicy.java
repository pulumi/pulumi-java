...
public class ProtectionPolicy extends CustomResource {
    /**
     * Optional ETag.
     * 
     */
     ...
     */
    public ProtectionPolicy(String name, ProtectionPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProtectionPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProtectionPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
