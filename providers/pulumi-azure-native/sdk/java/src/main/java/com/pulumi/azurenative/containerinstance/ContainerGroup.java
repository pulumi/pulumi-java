...
public class ContainerGroup extends CustomResource {
    /**
     ...
     */
    public ContainerGroup(String name, ContainerGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ContainerGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ContainerGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
