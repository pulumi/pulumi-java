...
public class AATPDataConnector extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    public Output</* @Nullable */ AlertsDataTypeOfDataConnectorResponse> dataTypes() {
     ...
     */
    public AATPDataConnector(String name, AATPDataConnectorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:securityinsights:AATPDataConnector", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private AATPDataConnector(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static AATPDataConnector get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
