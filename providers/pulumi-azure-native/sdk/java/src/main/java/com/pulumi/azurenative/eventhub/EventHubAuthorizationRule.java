...
public class EventHubAuthorizationRule extends CustomResource {
    /**
     ...
     */
    public EventHubAuthorizationRule(String name, EventHubAuthorizationRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EventHubAuthorizationRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EventHubAuthorizationRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
