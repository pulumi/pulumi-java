...
public class ReadWriteDatabase extends CustomResource {
    /**
     ...
     */
    public ReadWriteDatabase(String name, ReadWriteDatabaseArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:kusto:ReadWriteDatabase", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ReadWriteDatabase(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReadWriteDatabase get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
