...
public class WebAppAuthSettingsV2 extends CustomResource {
    /**
     ...
     */
    public WebAppAuthSettingsV2(String name, WebAppAuthSettingsV2Args args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppAuthSettingsV2(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppAuthSettingsV2 get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
