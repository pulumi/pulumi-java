...
public class AccessReviewScheduleDefinitionById extends CustomResource {
    /**
     ...
     */
    public AccessReviewScheduleDefinitionById(String name, @Nullable AccessReviewScheduleDefinitionByIdArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AccessReviewScheduleDefinitionById(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AccessReviewScheduleDefinitionById get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
