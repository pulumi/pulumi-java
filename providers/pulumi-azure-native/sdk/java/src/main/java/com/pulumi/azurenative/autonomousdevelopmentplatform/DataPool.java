...
public class DataPool extends CustomResource {
    /**
     ...
     */
    public DataPool(String name, DataPoolArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DataPool(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DataPool get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
