...
public final class VirtualMachineIdentityResponse extends com.pulumi.resources.InvokeArgs {
     ...
     * 
     */
    public Optional<Map<String,VirtualMachineIdentityResponseUserAssignedIdentities>> userAssignedIdentities() {
        return Optional.ofNullable(this.userAssignedIdentities);
    }

    private VirtualMachineIdentityResponse() {}

    private VirtualMachineIdentityResponse(VirtualMachineIdentityResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualMachineIdentityResponse();
        }

        public Builder(VirtualMachineIdentityResponse defaults) {
            $ = new VirtualMachineIdentityResponse(Objects.requireNonNull(defaults));
        }

        /**
         * @param principalId The principal id of virtual machine identity. This property will only be provided for a system assigned identity.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param tenantId The tenant id associated with the virtual machine. This property will only be provided for a system assigned identity.
         * 
         * @return builder
         * 
         */
