...
public class OutboundFirewallRule extends CustomResource {
    /**
     * Resource name.
     * 
     */
     ...
     */
    public OutboundFirewallRule(String name, OutboundFirewallRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OutboundFirewallRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OutboundFirewallRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
