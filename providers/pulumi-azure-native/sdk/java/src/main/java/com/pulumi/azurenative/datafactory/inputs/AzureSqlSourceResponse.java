 ...
 * 
 */
public final class AzureSqlSourceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private AzureSqlSourceResponse() {}

    private AzureSqlSourceResponse(AzureSqlSourceResponse $) {
    ...
    public static Builder builder(AzureSqlSourceResponse defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureSqlSourceResponse();
        }

        public Builder(AzureSqlSourceResponse defaults) {
            $ = new AzureSqlSourceResponse(Objects.requireNonNull(defaults));
        }
