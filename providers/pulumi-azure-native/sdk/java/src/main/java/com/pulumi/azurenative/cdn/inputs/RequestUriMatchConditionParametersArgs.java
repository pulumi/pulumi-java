...
import com.pulumi.azurenative.cdn.enums.RequestUriOperator;
 ...
 * 
 */
public final class RequestUriMatchConditionParametersArgs extends com.pulumi.resources.ResourceArgs {

    public static final RequestUriMatchConditionParametersArgs Empty = new RequestUriMatchConditionParametersArgs();
    ...
    private Output<Either<String,RequestUriOperator>> operator;

    public Output<Either<String,RequestUriOperator>> operator() {
    ...
    private RequestUriMatchConditionParametersArgs() {}

    private RequestUriMatchConditionParametersArgs(RequestUriMatchConditionParametersArgs $) {
    ...
    public static Builder builder(RequestUriMatchConditionParametersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RequestUriMatchConditionParametersArgs();
        }

        public Builder(RequestUriMatchConditionParametersArgs defaults) {
            $ = new RequestUriMatchConditionParametersArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder operator(Output<Either<String,RequestUriOperator>> operator) {
            $.operator = operator;
            return this;
        }

        public Builder operator(Either<String,RequestUriOperator> operator) {
        ...
        public Builder operator(RequestUriOperator operator) {
        ...
        public RequestUriMatchConditionParametersArgs build() {
