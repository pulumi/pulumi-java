...
public class DistributedAvailabilityGroup extends CustomResource {
    /**
     ...
     */
    public DistributedAvailabilityGroup(String name, DistributedAvailabilityGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DistributedAvailabilityGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DistributedAvailabilityGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
