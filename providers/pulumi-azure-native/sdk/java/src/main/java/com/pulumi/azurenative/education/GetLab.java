...
import com.pulumi.azurenative.education.GetLabArgs;
 ...
 * 
 * ```sh
 * $ pulumi import azure-native:education:GetLab default /providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/invoiceSections/{invoiceSectionName}/providers/Microsoft.Education/labs/default 
 * ```
 * 
 */
@ResourceType(type="azure-native:education:GetLab")
public class GetLab extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public GetLab(String name) {
        this(name, GetLabArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public GetLab(String name, GetLabArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GetLab(String name, GetLabArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:education:GetLab", name, args == null ? GetLabArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private GetLab(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:education:GetLab", name, null, makeResourceOptions(options, id));
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:education/v20211201preview:GetLab").build())
            ))
            .build();
     ...
     */
    public static GetLab get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
