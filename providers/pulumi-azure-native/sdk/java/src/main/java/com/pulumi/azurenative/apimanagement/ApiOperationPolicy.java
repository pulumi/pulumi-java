...
public class ApiOperationPolicy extends CustomResource {
    /**
     ...
     */
    public ApiOperationPolicy(String name, ApiOperationPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApiOperationPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApiOperationPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
