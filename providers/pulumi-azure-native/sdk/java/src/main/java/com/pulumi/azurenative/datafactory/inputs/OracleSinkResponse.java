 ...
 * 
 */
public final class OracleSinkResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private OracleSinkResponse(OracleSinkResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OracleSinkResponse();
        }

        public Builder(OracleSinkResponse defaults) {
            $ = new OracleSinkResponse(Objects.requireNonNull(defaults));
        }
