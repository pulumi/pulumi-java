 ...
 * 
 */
public final class SnowflakeDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SnowflakeDatasetArgs(SnowflakeDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SnowflakeDatasetArgs();
        }

        public Builder(SnowflakeDatasetArgs defaults) {
            $ = new SnowflakeDatasetArgs(Objects.requireNonNull(defaults));
        }
