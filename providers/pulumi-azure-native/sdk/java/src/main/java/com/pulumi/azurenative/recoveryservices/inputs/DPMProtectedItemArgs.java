...
public final class DPMProtectedItemArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<String>> backupEngineName() {
    ...
    public Optional<Output<DPMProtectedItemExtendedInfoArgs>> extendedInfo() {
    ...
    private DPMProtectedItemArgs(DPMProtectedItemArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DPMProtectedItemArgs();
        }

        public Builder(DPMProtectedItemArgs defaults) {
            $ = new DPMProtectedItemArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder backupEngineName(String backupEngineName) {
            return backupEngineName(Output.of(backupEngineName));
        }
        ...
        public Builder extendedInfo(DPMProtectedItemExtendedInfoArgs extendedInfo) {
