 ...
 * 
 */
public final class SybaseSourceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private SybaseSourceResponse(SybaseSourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SybaseSourceResponse();
        }

        public Builder(SybaseSourceResponse defaults) {
            $ = new SybaseSourceResponse(Objects.requireNonNull(defaults));
        }
