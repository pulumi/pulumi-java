 ...
 * 
 */
public final class ResponsysObjectDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ResponsysObjectDatasetArgs(ResponsysObjectDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ResponsysObjectDatasetArgs();
        }

        public Builder(ResponsysObjectDatasetArgs defaults) {
            $ = new ResponsysObjectDatasetArgs(Objects.requireNonNull(defaults));
        }
