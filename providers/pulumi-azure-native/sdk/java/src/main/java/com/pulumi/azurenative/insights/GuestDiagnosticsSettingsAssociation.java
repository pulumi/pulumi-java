...
public class GuestDiagnosticsSettingsAssociation extends CustomResource {
    /**
     ...
     */
    public GuestDiagnosticsSettingsAssociation(String name, GuestDiagnosticsSettingsAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GuestDiagnosticsSettingsAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GuestDiagnosticsSettingsAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
