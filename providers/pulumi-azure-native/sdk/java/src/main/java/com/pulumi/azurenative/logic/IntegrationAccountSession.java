...
public class IntegrationAccountSession extends CustomResource {
    /**
     * The changed time.
     * 
     */
     ...
     */
    public IntegrationAccountSession(String name, IntegrationAccountSessionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IntegrationAccountSession(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IntegrationAccountSession get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
