...
public class PrivateEndpointConnectionsSec extends CustomResource {
    /**
     ...
     */
    public PrivateEndpointConnectionsSec(String name, PrivateEndpointConnectionsSecArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateEndpointConnectionsSec(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateEndpointConnectionsSec get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
