...
public class VideoAnalyzer extends CustomResource {
    /**
     ...
     */
    public VideoAnalyzer(String name, VideoAnalyzerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VideoAnalyzer(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VideoAnalyzer get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
