 ...
 * 
 */
public final class EndpointPropertiesResponseCustomHeaders extends com.pulumi.resources.InvokeArgs {
    ...
    private EndpointPropertiesResponseCustomHeaders(EndpointPropertiesResponseCustomHeaders $) {
        this.name = $.name;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EndpointPropertiesResponseCustomHeaders();
        }

        public Builder(EndpointPropertiesResponseCustomHeaders defaults) {
            $ = new EndpointPropertiesResponseCustomHeaders(Objects.requireNonNull(defaults));
        }
