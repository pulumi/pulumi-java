...
public class EnterpriseKnowledgeGraph extends CustomResource {
    /**
     ...
     */
    public EnterpriseKnowledgeGraph(String name, EnterpriseKnowledgeGraphArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EnterpriseKnowledgeGraph(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EnterpriseKnowledgeGraph get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
