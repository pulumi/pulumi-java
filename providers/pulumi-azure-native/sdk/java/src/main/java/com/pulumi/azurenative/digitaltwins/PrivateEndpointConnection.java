...
public class PrivateEndpointConnection extends com.pulumi.resources.CustomResource {
    ...
    public Output<PrivateEndpointConnectionResponseProperties> properties() {
    ...
    public PrivateEndpointConnection(String name, PrivateEndpointConnectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:digitaltwins:PrivateEndpointConnection", name, args == null ? PrivateEndpointConnectionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:digitaltwins/v20201201:PrivateEndpointConnection").build()),
                Output.of(Alias.builder().type("azure-native:digitaltwins/v20210630preview:PrivateEndpointConnection").build())
            ))
            .build();
