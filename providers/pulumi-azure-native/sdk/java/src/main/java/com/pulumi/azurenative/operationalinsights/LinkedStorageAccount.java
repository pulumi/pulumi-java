...
public class LinkedStorageAccount extends CustomResource {
    /**
     ...
     */
    public LinkedStorageAccount(String name, LinkedStorageAccountArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LinkedStorageAccount(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LinkedStorageAccount get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
