 ...
 * 
 */
public final class InformixSinkArgs extends ResourceArgs {

    public static final InformixSinkArgs Empty = new InformixSinkArgs();
    ...
    private InformixSinkArgs() {}

    private InformixSinkArgs(InformixSinkArgs $) {
    ...
    public static Builder builder(InformixSinkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InformixSinkArgs();
        }

        public Builder(InformixSinkArgs defaults) {
            $ = new InformixSinkArgs(Objects.requireNonNull(defaults));
        }
