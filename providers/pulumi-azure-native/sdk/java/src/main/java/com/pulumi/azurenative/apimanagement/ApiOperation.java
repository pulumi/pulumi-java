...
public class ApiOperation extends CustomResource {
    /**
     ...
     */
    public ApiOperation(String name, ApiOperationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApiOperation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApiOperation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
