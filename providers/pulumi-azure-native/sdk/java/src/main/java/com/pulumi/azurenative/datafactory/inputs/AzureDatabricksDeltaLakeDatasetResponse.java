...
public final class AzureDatabricksDeltaLakeDatasetResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private AzureDatabricksDeltaLakeDatasetResponse(AzureDatabricksDeltaLakeDatasetResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureDatabricksDeltaLakeDatasetResponse();
        }

        public Builder(AzureDatabricksDeltaLakeDatasetResponse defaults) {
            $ = new AzureDatabricksDeltaLakeDatasetResponse(Objects.requireNonNull(defaults));
        }
