 ...
 * 
 */
public final class AzureDataLakeStoreSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzureDataLakeStoreSourceArgs(AzureDataLakeStoreSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureDataLakeStoreSourceArgs();
        }

        public Builder(AzureDataLakeStoreSourceArgs defaults) {
            $ = new AzureDataLakeStoreSourceArgs(Objects.requireNonNull(defaults));
        }
