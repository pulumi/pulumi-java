...
public final class AzureSearchIndexDatasetResponse extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return The name of the Azure Search Index. Type: string (or Expression with resultType string).
     * 
     */
    ...
    private AzureSearchIndexDatasetResponse(AzureSearchIndexDatasetResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureSearchIndexDatasetResponse();
        }

        public Builder(AzureSearchIndexDatasetResponse defaults) {
            $ = new AzureSearchIndexDatasetResponse(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param indexName The name of the Azure Search Index. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
