...
public class MachineLearningCompute extends CustomResource {
    /**
     ...
     */
    public MachineLearningCompute(String name, MachineLearningComputeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MachineLearningCompute(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MachineLearningCompute get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
