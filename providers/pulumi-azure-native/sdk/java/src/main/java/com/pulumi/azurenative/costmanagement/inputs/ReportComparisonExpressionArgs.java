...
public final class ReportComparisonExpressionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ReportComparisonExpressionArgs(ReportComparisonExpressionArgs $) {
        this.name = $.name;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReportComparisonExpressionArgs();
        }

        public Builder(ReportComparisonExpressionArgs defaults) {
            $ = new ReportComparisonExpressionArgs(Objects.requireNonNull(defaults));
        }
