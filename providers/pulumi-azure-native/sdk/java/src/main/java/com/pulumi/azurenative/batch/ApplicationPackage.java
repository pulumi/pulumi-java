...
public class ApplicationPackage extends CustomResource {
    /**
     ...
     */
    public ApplicationPackage(String name, ApplicationPackageArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApplicationPackage(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApplicationPackage get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
