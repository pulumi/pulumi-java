...
public class ExpressRouteConnection extends CustomResource {
    /**
     ...
     */
    public ExpressRouteConnection(String name, ExpressRouteConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ExpressRouteConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ExpressRouteConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
