...
public class CustomImage extends CustomResource {
    /**
     ...
     */
    public CustomImage(String name, CustomImageArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CustomImage(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomImage get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
