...
import com.pulumi.azurenative.cdn.enums.PostArgsOperator;
 ...
 * 
 */
public final class PostArgsMatchConditionParametersArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PostArgsMatchConditionParametersArgs(PostArgsMatchConditionParametersArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PostArgsMatchConditionParametersArgs();
        }

        public Builder(PostArgsMatchConditionParametersArgs defaults) {
            $ = new PostArgsMatchConditionParametersArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder operator(PostArgsOperator operator) {
