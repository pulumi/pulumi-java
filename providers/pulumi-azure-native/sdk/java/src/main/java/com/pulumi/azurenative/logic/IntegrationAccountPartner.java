...
public class IntegrationAccountPartner extends CustomResource {
    /**
     * The changed time.
     * 
     */
     ...
     */
    public IntegrationAccountPartner(String name, IntegrationAccountPartnerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IntegrationAccountPartner(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IntegrationAccountPartner get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
