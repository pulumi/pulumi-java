...
public class EdgeModule extends CustomResource {
    /**
     ...
     */
    public EdgeModule(String name, EdgeModuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EdgeModule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EdgeModule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
