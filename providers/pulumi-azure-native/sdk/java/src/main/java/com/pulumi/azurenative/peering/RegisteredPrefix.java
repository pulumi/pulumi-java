...
public class RegisteredPrefix extends CustomResource {
    /**
     ...
     */
    public RegisteredPrefix(String name, RegisteredPrefixArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegisteredPrefix(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegisteredPrefix get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
