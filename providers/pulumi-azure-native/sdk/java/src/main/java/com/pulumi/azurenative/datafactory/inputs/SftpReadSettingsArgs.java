 ...
 * 
 */
public final class SftpReadSettingsArgs extends ResourceArgs {
    ...
    private SftpReadSettingsArgs(SftpReadSettingsArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SftpReadSettingsArgs();
        }

        public Builder(SftpReadSettingsArgs defaults) {
            $ = new SftpReadSettingsArgs(Objects.requireNonNull(defaults));
        }
