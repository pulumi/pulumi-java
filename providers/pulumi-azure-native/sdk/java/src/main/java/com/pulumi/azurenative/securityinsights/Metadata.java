...
public class Metadata extends CustomResource {
    /**
     ...
     */
    public Metadata(String name, MetadataArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Metadata(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Metadata get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
