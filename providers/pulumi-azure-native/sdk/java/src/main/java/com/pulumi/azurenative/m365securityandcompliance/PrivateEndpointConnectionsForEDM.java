...
public class PrivateEndpointConnectionsForEDM extends CustomResource {
    /**
     ...
     */
    public PrivateEndpointConnectionsForEDM(String name, PrivateEndpointConnectionsForEDMArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateEndpointConnectionsForEDM(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateEndpointConnectionsForEDM get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
