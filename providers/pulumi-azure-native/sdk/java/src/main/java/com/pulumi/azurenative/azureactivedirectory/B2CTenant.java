...
public class B2CTenant extends CustomResource {
    /**
     ...
     */
    public B2CTenant(String name, B2CTenantArgs args, @Nullable CustomResourceOptions options) {
    ...
    private B2CTenant(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static B2CTenant get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
