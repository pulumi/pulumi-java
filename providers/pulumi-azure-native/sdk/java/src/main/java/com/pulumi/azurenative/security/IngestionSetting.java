...
public class IngestionSetting extends CustomResource {
    /**
     * Resource name
     * 
     */
     ...
     */
    public IngestionSetting(String name, @Nullable IngestionSettingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IngestionSetting(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IngestionSetting get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
