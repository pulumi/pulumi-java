...
public class Order extends CustomResource {
    /**
     * The contact details.
     * 
     */
     ...
     */
    public Order(String name, OrderArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:databoxedge:Order", name, args == null ? OrderArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Order(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Order get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
