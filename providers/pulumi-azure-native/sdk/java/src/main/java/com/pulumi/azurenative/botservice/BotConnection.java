...
public class BotConnection extends com.pulumi.resources.CustomResource {
    /**
     * Entity Tag
     * 
     */
     ...
     */
    public BotConnection(String name, BotConnectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private BotConnection(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static BotConnection get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
