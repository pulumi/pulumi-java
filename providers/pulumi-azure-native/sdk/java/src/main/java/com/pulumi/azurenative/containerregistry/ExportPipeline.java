...
public class ExportPipeline extends CustomResource {
    /**
     ...
     */
    public ExportPipeline(String name, ExportPipelineArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ExportPipeline(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ExportPipeline get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
