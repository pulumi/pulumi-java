...
public class HybridRunbookWorker extends CustomResource {
    /**
     ...
     */
    public HybridRunbookWorker(String name, HybridRunbookWorkerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HybridRunbookWorker(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HybridRunbookWorker get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
