...
public class VirtualHubBgpConnection extends CustomResource {
    /**
     ...
     */
    public VirtualHubBgpConnection(String name, VirtualHubBgpConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualHubBgpConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualHubBgpConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
