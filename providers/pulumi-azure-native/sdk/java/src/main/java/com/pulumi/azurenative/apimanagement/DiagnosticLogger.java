...
public class DiagnosticLogger extends CustomResource {
    /**
     ...
     */
    public DiagnosticLogger(String name, DiagnosticLoggerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DiagnosticLogger(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DiagnosticLogger get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
