...
public class CustomAssessmentAutomation extends CustomResource {
    /**
     ...
     */
    public CustomAssessmentAutomation(String name, CustomAssessmentAutomationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CustomAssessmentAutomation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomAssessmentAutomation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
