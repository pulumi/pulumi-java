...
public class GatewayHostnameConfiguration extends CustomResource {
    /**
     ...
     */
    public GatewayHostnameConfiguration(String name, GatewayHostnameConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GatewayHostnameConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GatewayHostnameConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
