...
public class ConnectedCluster extends CustomResource {
    /**
     ...
     */
    public ConnectedCluster(String name, ConnectedClusterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConnectedCluster(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConnectedCluster get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
