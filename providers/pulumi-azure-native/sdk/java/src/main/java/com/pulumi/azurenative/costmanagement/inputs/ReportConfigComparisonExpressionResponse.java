...
public final class ReportConfigComparisonExpressionResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private ReportConfigComparisonExpressionResponse(ReportConfigComparisonExpressionResponse $) {
        this.name = $.name;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReportConfigComparisonExpressionResponse();
        }

        public Builder(ReportConfigComparisonExpressionResponse defaults) {
            $ = new ReportConfigComparisonExpressionResponse(Objects.requireNonNull(defaults));
        }
