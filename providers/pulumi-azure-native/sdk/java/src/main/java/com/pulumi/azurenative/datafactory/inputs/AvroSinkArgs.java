...
public final class AvroSinkArgs extends ResourceArgs {
    ...
    /**
     * @return Avro format settings.
     * 
     */
    public Optional<Output<AvroWriteSettingsArgs>> formatSettings() {
    ...
    private AvroSinkArgs(AvroSinkArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(AvroSinkArgs defaults) {
            $ = new AvroSinkArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param formatSettings Avro format settings.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder formatSettings(AvroWriteSettingsArgs formatSettings) {
