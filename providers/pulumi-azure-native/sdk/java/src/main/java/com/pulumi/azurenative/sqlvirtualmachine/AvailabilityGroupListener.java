...
public class AvailabilityGroupListener extends CustomResource {
    /**
     ...
     */
    public AvailabilityGroupListener(String name, AvailabilityGroupListenerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AvailabilityGroupListener(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AvailabilityGroupListener get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
