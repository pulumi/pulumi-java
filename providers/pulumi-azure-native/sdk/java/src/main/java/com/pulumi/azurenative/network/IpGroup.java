...
public class IpGroup extends CustomResource {
     ...
     */
    public IpGroup(String name, IpGroupArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:network:IpGroup", name, args == null ? IpGroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private IpGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IpGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
