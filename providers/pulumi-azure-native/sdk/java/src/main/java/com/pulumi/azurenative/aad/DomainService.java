...
public class DomainService extends CustomResource {
    /**
     * Deployment Id
     * 
     */
     ...
     */
    public DomainService(String name, DomainServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DomainService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DomainService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
