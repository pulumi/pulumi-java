...
public class ServerTrustCertificate extends CustomResource {
    /**
     ...
     */
    public ServerTrustCertificate(String name, ServerTrustCertificateArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServerTrustCertificate(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServerTrustCertificate get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
