...
public class DedicatedCloudService extends CustomResource {
    /**
     ...
     */
    public DedicatedCloudService(String name, DedicatedCloudServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DedicatedCloudService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DedicatedCloudService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
