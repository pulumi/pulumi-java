...
public class PrivateEndpointConnectionsForMIPPolicySync extends CustomResource {
    /**
     ...
     */
    public PrivateEndpointConnectionsForMIPPolicySync(String name, PrivateEndpointConnectionsForMIPPolicySyncArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateEndpointConnectionsForMIPPolicySync(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateEndpointConnectionsForMIPPolicySync get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
