...
public class QueueServiceProperties extends CustomResource {
    /**
     ...
     */
    public QueueServiceProperties(String name, QueueServicePropertiesArgs args, @Nullable CustomResourceOptions options) {
    ...
    private QueueServiceProperties(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static QueueServiceProperties get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
