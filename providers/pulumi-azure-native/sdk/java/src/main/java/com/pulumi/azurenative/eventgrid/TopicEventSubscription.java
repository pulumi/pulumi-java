 ...
 * 
 */
@ResourceType(type="azure-native:eventgrid:TopicEventSubscription")
public class TopicEventSubscription extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public TopicEventSubscription(String name) {
        this(name, TopicEventSubscriptionArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public TopicEventSubscription(String name, TopicEventSubscriptionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TopicEventSubscription(String name, TopicEventSubscriptionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:eventgrid:TopicEventSubscription", name, args == null ? TopicEventSubscriptionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TopicEventSubscription(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:eventgrid:TopicEventSubscription", name, null, makeResourceOptions(options, id));
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:eventgrid/v20211015preview:TopicEventSubscription").build())
            ))
            .build();
     ...
     */
    public static TopicEventSubscription get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
