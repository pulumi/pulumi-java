 ...
 * 
 */
public final class SybaseSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SybaseSourceArgs(SybaseSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SybaseSourceArgs();
        }

        public Builder(SybaseSourceArgs defaults) {
            $ = new SybaseSourceArgs(Objects.requireNonNull(defaults));
        }
