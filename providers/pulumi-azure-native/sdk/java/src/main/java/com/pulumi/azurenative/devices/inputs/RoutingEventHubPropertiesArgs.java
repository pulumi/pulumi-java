 ...
 * 
 */
public final class RoutingEventHubPropertiesArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RoutingEventHubPropertiesArgs(RoutingEventHubPropertiesArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RoutingEventHubPropertiesArgs();
        }

        public Builder(RoutingEventHubPropertiesArgs defaults) {
            $ = new RoutingEventHubPropertiesArgs(Objects.requireNonNull(defaults));
        }
