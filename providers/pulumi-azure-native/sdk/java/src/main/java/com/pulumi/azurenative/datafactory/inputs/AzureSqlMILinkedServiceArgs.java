...
public final class AzureSqlMILinkedServiceArgs extends ResourceArgs {
    ...
    private AzureSqlMILinkedServiceArgs(AzureSqlMILinkedServiceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureSqlMILinkedServiceArgs();
        }

        public Builder(AzureSqlMILinkedServiceArgs defaults) {
            $ = new AzureSqlMILinkedServiceArgs(Objects.requireNonNull(defaults));
        }
