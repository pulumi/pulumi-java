...
public class ManagementGroupNetworkManagerConnection extends CustomResource {
    /**
     ...
     */
    public ManagementGroupNetworkManagerConnection(String name, ManagementGroupNetworkManagerConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagementGroupNetworkManagerConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagementGroupNetworkManagerConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
