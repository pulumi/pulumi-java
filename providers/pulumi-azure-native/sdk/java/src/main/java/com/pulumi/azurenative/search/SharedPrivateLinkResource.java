...
public class SharedPrivateLinkResource extends CustomResource {
    /**
     ...
     */
    public SharedPrivateLinkResource(String name, SharedPrivateLinkResourceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SharedPrivateLinkResource(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SharedPrivateLinkResource get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
