...
public class VirtualMachineRunCommandByVirtualMachine extends CustomResource {
    /**
     ...
     */
    public VirtualMachineRunCommandByVirtualMachine(String name, VirtualMachineRunCommandByVirtualMachineArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualMachineRunCommandByVirtualMachine(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualMachineRunCommandByVirtualMachine get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
