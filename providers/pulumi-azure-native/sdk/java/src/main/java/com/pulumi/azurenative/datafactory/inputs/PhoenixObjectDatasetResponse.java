 ...
 * 
 */
public final class PhoenixObjectDatasetResponse extends com.pulumi.resources.InvokeArgs {

    public static final PhoenixObjectDatasetResponse Empty = new PhoenixObjectDatasetResponse();
    ...
    /**
     * @return The table name of the Phoenix. Type: string (or Expression with resultType string).
     * 
     */
    ...
    private PhoenixObjectDatasetResponse() {}

    private PhoenixObjectDatasetResponse(PhoenixObjectDatasetResponse $) {
    ...
    public static Builder builder(PhoenixObjectDatasetResponse defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PhoenixObjectDatasetResponse();
        }

        public Builder(PhoenixObjectDatasetResponse defaults) {
            $ = new PhoenixObjectDatasetResponse(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param table The table name of the Phoenix. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
