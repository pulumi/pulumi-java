...
public class PowerBIResource extends CustomResource {
    /**
     ...
     */
    public PowerBIResource(String name, PowerBIResourceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PowerBIResource(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PowerBIResource get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
