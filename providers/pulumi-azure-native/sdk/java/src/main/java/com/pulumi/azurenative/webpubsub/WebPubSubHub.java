...
public class WebPubSubHub extends CustomResource {
    /**
     ...
     */
    public WebPubSubHub(String name, WebPubSubHubArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebPubSubHub(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebPubSubHub get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
