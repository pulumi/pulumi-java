...
public class IotHubDataConnection extends CustomResource {
    /**
     ...
     */
    public IotHubDataConnection(String name, IotHubDataConnectionArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:synapse:IotHubDataConnection", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private IotHubDataConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IotHubDataConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
