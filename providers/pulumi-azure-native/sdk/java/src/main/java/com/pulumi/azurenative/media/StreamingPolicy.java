...
public class StreamingPolicy extends CustomResource {
    /**
     ...
     */
    public StreamingPolicy(String name, StreamingPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StreamingPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StreamingPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
