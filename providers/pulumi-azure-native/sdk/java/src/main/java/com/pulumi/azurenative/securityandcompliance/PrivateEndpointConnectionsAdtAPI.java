...
public class PrivateEndpointConnectionsAdtAPI extends CustomResource {
    /**
     ...
     */
    public PrivateEndpointConnectionsAdtAPI(String name, PrivateEndpointConnectionsAdtAPIArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateEndpointConnectionsAdtAPI(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateEndpointConnectionsAdtAPI get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
