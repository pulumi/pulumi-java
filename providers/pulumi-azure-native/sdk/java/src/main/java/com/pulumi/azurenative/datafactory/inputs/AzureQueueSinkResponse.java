 ...
 * 
 */
public final class AzureQueueSinkResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private AzureQueueSinkResponse(AzureQueueSinkResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureQueueSinkResponse();
        }

        public Builder(AzureQueueSinkResponse defaults) {
            $ = new AzureQueueSinkResponse(Objects.requireNonNull(defaults));
        }
