...
public final class StringNotEndsWithAdvancedFilterResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private StringNotEndsWithAdvancedFilterResponse(StringNotEndsWithAdvancedFilterResponse $) {
        this.key = $.key;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StringNotEndsWithAdvancedFilterResponse();
        }

        public Builder(StringNotEndsWithAdvancedFilterResponse defaults) {
            $ = new StringNotEndsWithAdvancedFilterResponse(Objects.requireNonNull(defaults));
        }
