...
public class GalleryImageVersion extends CustomResource {
    /**
     * Resource location
     * 
     */
     ...
     */
    public GalleryImageVersion(String name, GalleryImageVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GalleryImageVersion(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GalleryImageVersion get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
