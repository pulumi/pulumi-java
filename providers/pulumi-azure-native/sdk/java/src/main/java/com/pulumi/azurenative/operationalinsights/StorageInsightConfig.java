...
public class StorageInsightConfig extends CustomResource {
    /**
     ...
     */
    public StorageInsightConfig(String name, StorageInsightConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StorageInsightConfig(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StorageInsightConfig get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
