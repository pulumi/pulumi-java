...
public class HybridRunbookWorkerGroup extends CustomResource {
    /**
     ...
     */
    public HybridRunbookWorkerGroup(String name, HybridRunbookWorkerGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HybridRunbookWorkerGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HybridRunbookWorkerGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
