...
public class File extends CustomResource {
    /**
     ...
     */
    public File(String name, FileArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datamigration:File", name, args == null ? FileArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private File(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static File get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
