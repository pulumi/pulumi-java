...
public class EventHub extends CustomResource {
    /**
     ...
     */
    public EventHub(String name, EventHubArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:eventhub:EventHub", name, args == null ? EventHubArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private EventHub(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EventHub get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
