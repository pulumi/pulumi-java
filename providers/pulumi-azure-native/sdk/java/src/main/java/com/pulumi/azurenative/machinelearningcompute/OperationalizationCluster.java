...
public class OperationalizationCluster extends CustomResource {
    /**
     ...
     */
    public OperationalizationCluster(String name, OperationalizationClusterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OperationalizationCluster(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OperationalizationCluster get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
