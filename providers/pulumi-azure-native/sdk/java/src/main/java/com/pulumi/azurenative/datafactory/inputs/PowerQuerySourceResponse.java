 ...
 * 
 */
public final class PowerQuerySourceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private PowerQuerySourceResponse(PowerQuerySourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerQuerySourceResponse();
        }

        public Builder(PowerQuerySourceResponse defaults) {
            $ = new PowerQuerySourceResponse(Objects.requireNonNull(defaults));
        }
