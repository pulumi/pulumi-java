...
public class StaticSitePrivateEndpointConnection extends CustomResource {
    /**
     ...
     */
    public StaticSitePrivateEndpointConnection(String name, StaticSitePrivateEndpointConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StaticSitePrivateEndpointConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StaticSitePrivateEndpointConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
