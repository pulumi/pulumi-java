...
public class StorageSyncService extends CustomResource {
    /**
     ...
     */
    public StorageSyncService(String name, StorageSyncServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StorageSyncService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StorageSyncService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
