...
public class ApiManagementService extends CustomResource {
    /**
     ...
     */
    public ApiManagementService(String name, ApiManagementServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApiManagementService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApiManagementService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
