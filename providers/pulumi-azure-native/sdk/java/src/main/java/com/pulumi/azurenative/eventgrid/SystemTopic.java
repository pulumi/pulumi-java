...
public class SystemTopic extends CustomResource {
    /**
     ...
     */
    public SystemTopic(String name, SystemTopicArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SystemTopic(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SystemTopic get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
