...
public class RosettaNetProcessConfiguration extends CustomResource {
    /**
     ...
     */
    public RosettaNetProcessConfiguration(String name, RosettaNetProcessConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RosettaNetProcessConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RosettaNetProcessConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
