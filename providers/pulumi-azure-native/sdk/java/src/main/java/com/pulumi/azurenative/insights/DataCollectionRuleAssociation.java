...
public class DataCollectionRuleAssociation extends CustomResource {
    /**
     ...
     */
    public DataCollectionRuleAssociation(String name, DataCollectionRuleAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DataCollectionRuleAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DataCollectionRuleAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
