...
public class AttestationProvider extends CustomResource {
    /**
     ...
     */
    public AttestationProvider(String name, AttestationProviderArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AttestationProvider(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AttestationProvider get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
