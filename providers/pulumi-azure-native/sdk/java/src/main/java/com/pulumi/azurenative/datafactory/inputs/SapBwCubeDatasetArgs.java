 ...
 * 
 */
public final class SapBwCubeDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SapBwCubeDatasetArgs(SapBwCubeDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SapBwCubeDatasetArgs();
        }

        public Builder(SapBwCubeDatasetArgs defaults) {
            $ = new SapBwCubeDatasetArgs(Objects.requireNonNull(defaults));
        }
