...
public class ProtectionIntent extends CustomResource {
    /**
     * Optional ETag.
     * 
     */
     ...
     */
    public ProtectionIntent(String name, ProtectionIntentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProtectionIntent(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProtectionIntent get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
