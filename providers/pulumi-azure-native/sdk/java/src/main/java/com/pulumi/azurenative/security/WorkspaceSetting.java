...
public class WorkspaceSetting extends CustomResource {
    /**
     * Resource name
     * 
     */
     ...
     */
    public WorkspaceSetting(String name, WorkspaceSettingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WorkspaceSetting(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkspaceSetting get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
