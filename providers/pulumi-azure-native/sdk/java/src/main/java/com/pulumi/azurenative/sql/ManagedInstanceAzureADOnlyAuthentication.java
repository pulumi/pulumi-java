...
public class ManagedInstanceAzureADOnlyAuthentication extends CustomResource {
    /**
     ...
     */
    public ManagedInstanceAzureADOnlyAuthentication(String name, ManagedInstanceAzureADOnlyAuthenticationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagedInstanceAzureADOnlyAuthentication(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagedInstanceAzureADOnlyAuthentication get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
