...
public class MyWorkbook extends CustomResource {
    /**
     ...
     */
    public MyWorkbook(String name, MyWorkbookArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MyWorkbook(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MyWorkbook get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
