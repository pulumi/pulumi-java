...
public class DiskPool extends CustomResource {
    /**
     ...
     */
    public DiskPool(String name, DiskPoolArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:storagepool:DiskPool", name, args == null ? DiskPoolArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DiskPool(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DiskPool get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
