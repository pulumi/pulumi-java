...
public class VirtualNetworkLink extends CustomResource {
    /**
     ...
     */
    public VirtualNetworkLink(String name, VirtualNetworkLinkArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualNetworkLink(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualNetworkLink get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
