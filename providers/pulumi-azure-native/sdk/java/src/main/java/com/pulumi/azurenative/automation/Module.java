...
public class Module extends CustomResource {
    /**
     ...
     */
    public Module(String name, ModuleArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:automation:Module", name, args == null ? ModuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Module(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Module get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
