...
public final class SkuCapabilityArgs extends ResourceArgs {
    ...
    private SkuCapabilityArgs(SkuCapabilityArgs $) {
        this.name = $.name;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SkuCapabilityArgs();
        }

        public Builder(SkuCapabilityArgs defaults) {
            $ = new SkuCapabilityArgs(Objects.requireNonNull(defaults));
        }
