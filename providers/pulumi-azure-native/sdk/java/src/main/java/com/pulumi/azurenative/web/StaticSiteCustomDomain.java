...
public class StaticSiteCustomDomain extends CustomResource {
    /**
     ...
     */
    public StaticSiteCustomDomain(String name, StaticSiteCustomDomainArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StaticSiteCustomDomain(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StaticSiteCustomDomain get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
