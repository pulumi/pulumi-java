...
public class DiskAccessAPrivateEndpointConnection extends CustomResource {
    /**
     ...
     */
    public DiskAccessAPrivateEndpointConnection(String name, DiskAccessAPrivateEndpointConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DiskAccessAPrivateEndpointConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DiskAccessAPrivateEndpointConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
