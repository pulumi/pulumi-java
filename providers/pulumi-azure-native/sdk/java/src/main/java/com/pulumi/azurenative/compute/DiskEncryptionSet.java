...
public class DiskEncryptionSet extends CustomResource {
    /**
     ...
     */
    public DiskEncryptionSet(String name, DiskEncryptionSetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DiskEncryptionSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DiskEncryptionSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
