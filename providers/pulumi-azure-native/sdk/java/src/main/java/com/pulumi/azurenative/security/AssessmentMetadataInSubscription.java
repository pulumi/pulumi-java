...
public class AssessmentMetadataInSubscription extends CustomResource {
    /**
     ...
     */
    public AssessmentMetadataInSubscription(String name, AssessmentMetadataInSubscriptionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AssessmentMetadataInSubscription(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AssessmentMetadataInSubscription get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
