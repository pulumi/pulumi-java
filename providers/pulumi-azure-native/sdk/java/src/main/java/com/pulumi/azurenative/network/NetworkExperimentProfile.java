...
public class NetworkExperimentProfile extends CustomResource {
    /**
     ...
     */
    public NetworkExperimentProfile(String name, NetworkExperimentProfileArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NetworkExperimentProfile(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkExperimentProfile get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
