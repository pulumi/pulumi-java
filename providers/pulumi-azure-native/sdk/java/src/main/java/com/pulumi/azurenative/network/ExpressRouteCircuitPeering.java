...
public class ExpressRouteCircuitPeering extends CustomResource {
    /**
     * The Azure ASN.
     * 
     */
     ...
     */
    public ExpressRouteCircuitPeering(String name, ExpressRouteCircuitPeeringArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ExpressRouteCircuitPeering(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ExpressRouteCircuitPeering get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
