...
public final class HBaseLinkedServiceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private HBaseLinkedServiceResponse(HBaseLinkedServiceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HBaseLinkedServiceResponse();
        }

        public Builder(HBaseLinkedServiceResponse defaults) {
            $ = new HBaseLinkedServiceResponse(Objects.requireNonNull(defaults));
        }
