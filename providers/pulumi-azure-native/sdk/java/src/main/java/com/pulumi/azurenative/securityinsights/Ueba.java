...
public class Ueba extends CustomResource {
    /**
     ...
     */
    public Ueba(String name, UebaArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:securityinsights:Ueba", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private Ueba(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Ueba get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
