...
public class Ueba extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public Ueba(String name, UebaArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:securityinsights:Ueba", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private Ueba(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Ueba get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
