...
public class KustoPoolPrincipalAssignment extends CustomResource {
    /**
     ...
     */
    public KustoPoolPrincipalAssignment(String name, KustoPoolPrincipalAssignmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private KustoPoolPrincipalAssignment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static KustoPoolPrincipalAssignment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
