...
public class PartnerNamespace extends CustomResource {
    /**
     ...
     */
    public PartnerNamespace(String name, PartnerNamespaceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PartnerNamespace(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PartnerNamespace get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
