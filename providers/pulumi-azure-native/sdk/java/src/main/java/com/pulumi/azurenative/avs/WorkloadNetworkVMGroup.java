...
public class WorkloadNetworkVMGroup extends CustomResource {
    /**
     ...
     */
    public WorkloadNetworkVMGroup(String name, WorkloadNetworkVMGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WorkloadNetworkVMGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkloadNetworkVMGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
