...
public class WorkloadGroup extends CustomResource {
    /**
     ...
     */
    public WorkloadGroup(String name, WorkloadGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WorkloadGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkloadGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
