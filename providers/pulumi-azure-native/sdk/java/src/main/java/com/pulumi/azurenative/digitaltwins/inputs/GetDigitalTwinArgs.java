...
public final class GetDigitalTwinArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetDigitalTwinArgs(GetDigitalTwinArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDigitalTwinArgs();
        }

        public Builder(GetDigitalTwinArgs defaults) {
            $ = new GetDigitalTwinArgs(Objects.requireNonNull(defaults));
        }
