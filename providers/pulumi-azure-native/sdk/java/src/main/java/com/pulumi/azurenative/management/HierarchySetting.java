...
public class HierarchySetting extends CustomResource {
    /**
     ...
     */
    public HierarchySetting(String name, HierarchySettingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HierarchySetting(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HierarchySetting get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
