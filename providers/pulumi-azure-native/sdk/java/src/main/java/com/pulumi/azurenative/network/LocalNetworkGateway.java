...
public class LocalNetworkGateway extends CustomResource {
    /**
     ...
     */
    public LocalNetworkGateway(String name, LocalNetworkGatewayArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LocalNetworkGateway(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LocalNetworkGateway get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
