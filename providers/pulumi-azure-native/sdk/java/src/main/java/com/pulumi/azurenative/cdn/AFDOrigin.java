...
public class AFDOrigin extends CustomResource {
    /**
     ...
     */
    public AFDOrigin(String name, AFDOriginArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:cdn:AFDOrigin", name, args == null ? AFDOriginArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AFDOrigin(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AFDOrigin get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
