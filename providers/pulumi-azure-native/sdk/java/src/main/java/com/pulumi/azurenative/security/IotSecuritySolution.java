...
public class IotSecuritySolution extends CustomResource {
    /**
     ...
     */
    public IotSecuritySolution(String name, IotSecuritySolutionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IotSecuritySolution(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IotSecuritySolution get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
