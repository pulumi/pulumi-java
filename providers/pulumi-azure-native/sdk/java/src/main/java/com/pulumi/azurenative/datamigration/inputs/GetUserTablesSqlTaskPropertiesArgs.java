...
public final class GetUserTablesSqlTaskPropertiesArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="input")
      private final @Nullable Output<GetUserTablesSqlTaskInputArgs> input;

    public Output<GetUserTablesSqlTaskInputArgs> getInput() {
    ...
    public GetUserTablesSqlTaskPropertiesArgs(
        @Nullable Output<GetUserTablesSqlTaskInputArgs> input,
