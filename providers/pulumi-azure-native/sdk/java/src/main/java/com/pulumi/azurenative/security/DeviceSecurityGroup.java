...
public class DeviceSecurityGroup extends CustomResource {
    /**
     ...
     */
    public DeviceSecurityGroup(String name, DeviceSecurityGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DeviceSecurityGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DeviceSecurityGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
