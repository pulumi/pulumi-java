...
public class VirtualNetworkPeering extends CustomResource {
    /**
     ...
     */
    public VirtualNetworkPeering(String name, VirtualNetworkPeeringArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualNetworkPeering(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualNetworkPeering get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
