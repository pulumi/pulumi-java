...
public class SqlDBTableDataSet extends CustomResource {
    /**
     ...
     */
    public SqlDBTableDataSet(String name, SqlDBTableDataSetArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datashare:SqlDBTableDataSet", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private SqlDBTableDataSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SqlDBTableDataSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
