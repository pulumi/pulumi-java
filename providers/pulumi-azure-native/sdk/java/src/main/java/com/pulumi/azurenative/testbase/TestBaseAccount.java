...
public class TestBaseAccount extends CustomResource {
    /**
     ...
     */
    public TestBaseAccount(String name, TestBaseAccountArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TestBaseAccount(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TestBaseAccount get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
