...
@CustomType
public final class MongoDbV2CollectionDatasetResponse {
    /**
    ...
    /**
     * @return The collection name of the MongoDB database. Type: string (or Expression with resultType string).
     * 
     */
