...
public class IscsiTarget extends CustomResource {
    /**
     ...
     */
    public IscsiTarget(String name, IscsiTargetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IscsiTarget(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IscsiTarget get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
