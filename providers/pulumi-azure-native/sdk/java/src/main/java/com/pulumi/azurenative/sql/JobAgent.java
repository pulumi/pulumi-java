...
public class JobAgent extends CustomResource {
    /**
     ...
     */
    public JobAgent(String name, JobAgentArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:sql:JobAgent", name, args == null ? JobAgentArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private JobAgent(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static JobAgent get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
