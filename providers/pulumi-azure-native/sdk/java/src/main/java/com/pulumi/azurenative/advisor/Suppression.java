...
public class Suppression extends CustomResource {
    /**
     ...
     */
    public Suppression(String name, SuppressionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Suppression(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Suppression get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
