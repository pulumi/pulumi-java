...
public class ThreatIntelligenceIndicator extends CustomResource {
    /**
     ...
     */
    public ThreatIntelligenceIndicator(String name, ThreatIntelligenceIndicatorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ThreatIntelligenceIndicator(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ThreatIntelligenceIndicator get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
