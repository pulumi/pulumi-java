...
public class PeerAsn extends CustomResource {
    /**
     ...
     */
    public PeerAsn(String name, @Nullable PeerAsnArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:peering:PeerAsn", name, args == null ? PeerAsnArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private PeerAsn(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PeerAsn get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
