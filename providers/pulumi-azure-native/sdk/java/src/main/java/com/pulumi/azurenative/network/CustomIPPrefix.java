...
public class CustomIPPrefix extends CustomResource {
    /**
     ...
     */
    public CustomIPPrefix(String name, CustomIPPrefixArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CustomIPPrefix(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomIPPrefix get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
