 ...
 * 
 */
public final class AzureBlobStorageWriteSettingsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzureBlobStorageWriteSettingsArgs(AzureBlobStorageWriteSettingsArgs $) {
    ...
    public static Builder builder(AzureBlobStorageWriteSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureBlobStorageWriteSettingsArgs();
        }

        public Builder(AzureBlobStorageWriteSettingsArgs defaults) {
            $ = new AzureBlobStorageWriteSettingsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AzureBlobStorageWriteSettingsArgs build() {
