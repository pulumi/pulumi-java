...
public class ScheduledQueryRule extends CustomResource {
    /**
     ...
     */
    public ScheduledQueryRule(String name, ScheduledQueryRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ScheduledQueryRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ScheduledQueryRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
