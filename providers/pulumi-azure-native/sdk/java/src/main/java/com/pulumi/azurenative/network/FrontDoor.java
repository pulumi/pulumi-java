...
public class FrontDoor extends CustomResource {
    /**
     ...
     */
    public FrontDoor(String name, FrontDoorArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:network:FrontDoor", name, args == null ? FrontDoorArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FrontDoor(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FrontDoor get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
