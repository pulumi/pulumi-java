...
public class WebAppVnetConnection extends CustomResource {
    /**
     ...
     */
    public WebAppVnetConnection(String name, WebAppVnetConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppVnetConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppVnetConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
