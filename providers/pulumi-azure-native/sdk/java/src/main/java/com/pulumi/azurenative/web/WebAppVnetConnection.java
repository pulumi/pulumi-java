...
public class WebAppVnetConnection extends com.pulumi.resources.CustomResource {
     ...
     */
    public WebAppVnetConnection(String name) {
     ...
     */
    public WebAppVnetConnection(String name, WebAppVnetConnectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:web:WebAppVnetConnection", name, args == null ? WebAppVnetConnectionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private WebAppVnetConnection(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static WebAppVnetConnection get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
