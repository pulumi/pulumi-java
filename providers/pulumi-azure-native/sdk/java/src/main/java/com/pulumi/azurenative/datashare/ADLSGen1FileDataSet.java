...
public class ADLSGen1FileDataSet extends CustomResource {
    /**
     ...
     */
    public ADLSGen1FileDataSet(String name, ADLSGen1FileDataSetArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datashare:ADLSGen1FileDataSet", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ADLSGen1FileDataSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ADLSGen1FileDataSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
