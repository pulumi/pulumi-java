...
public class MetricsSource extends CustomResource {
     ...
     */
    public MetricsSource(String name, MetricsSourceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MetricsSource(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MetricsSource get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
