...
public class Artifact extends CustomResource {
    /**
     ...
     */
    public Artifact(String name, ArtifactArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:blueprint:Artifact", name, args == null ? ArtifactArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Artifact(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Artifact get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
