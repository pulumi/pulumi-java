...
public class NetworkFunction extends CustomResource {
    /**
     ...
     */
    public NetworkFunction(String name, NetworkFunctionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NetworkFunction(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkFunction get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
