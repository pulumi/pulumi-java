...
public class ManagedHsm extends CustomResource {
    /**
     ...
     */
    public ManagedHsm(String name, ManagedHsmArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagedHsm(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagedHsm get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
