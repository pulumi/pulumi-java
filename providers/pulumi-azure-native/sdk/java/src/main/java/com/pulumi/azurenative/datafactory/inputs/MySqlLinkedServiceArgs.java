 ...
 * 
 */
public final class MySqlLinkedServiceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MySqlLinkedServiceArgs(MySqlLinkedServiceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MySqlLinkedServiceArgs();
        }

        public Builder(MySqlLinkedServiceArgs defaults) {
            $ = new MySqlLinkedServiceArgs(Objects.requireNonNull(defaults));
        }
