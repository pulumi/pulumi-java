...
public class WebAppPrivateEndpointConnection extends CustomResource {
    /**
     ...
     */
    public WebAppPrivateEndpointConnection(String name, WebAppPrivateEndpointConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppPrivateEndpointConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppPrivateEndpointConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
