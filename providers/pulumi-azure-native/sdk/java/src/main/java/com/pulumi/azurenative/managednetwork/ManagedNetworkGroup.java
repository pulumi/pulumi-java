...
public class ManagedNetworkGroup extends CustomResource {
    /**
     ...
     */
    public ManagedNetworkGroup(String name, ManagedNetworkGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagedNetworkGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagedNetworkGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
