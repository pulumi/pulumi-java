...
import com.pulumi.azurenative.webpubsub.enums.PrivateLinkServiceConnectionStatus;
...
public final class PrivateLinkServiceConnectionStateArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<Either<String,PrivateLinkServiceConnectionStatus>>> status() {
