...
public class DatabaseAdvisor extends CustomResource {
    /**
     ...
     */
    public DatabaseAdvisor(String name, DatabaseAdvisorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DatabaseAdvisor(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DatabaseAdvisor get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
