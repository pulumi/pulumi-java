...
public class ADLSGen2FolderDataSetMapping extends com.pulumi.resources.CustomResource {
    /**
    ...
    public ADLSGen2FolderDataSetMapping(String name) {
        this(name, ADLSGen2FolderDataSetMappingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ADLSGen2FolderDataSetMapping(String name, ADLSGen2FolderDataSetMappingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ADLSGen2FolderDataSetMapping(String name, ADLSGen2FolderDataSetMappingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:datashare:ADLSGen2FolderDataSetMapping", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ADLSGen2FolderDataSetMapping(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:datashare/v20181101preview:ADLSGen2FolderDataSetMapping").build()),
                Output.of(Alias.builder().type("azure-native:datashare/v20191101:ADLSGen2FolderDataSetMapping").build()),
                Output.of(Alias.builder().type("azure-native:datashare/v20200901:ADLSGen2FolderDataSetMapping").build()),
                Output.of(Alias.builder().type("azure-native:datashare/v20201001preview:ADLSGen2FolderDataSetMapping").build()),
                Output.of(Alias.builder().type("azure-native:datashare/v20210801:ADLSGen2FolderDataSetMapping").build())
            ))
            .build();
     ...
     */
    public static ADLSGen2FolderDataSetMapping get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
