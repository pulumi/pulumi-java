...
public class ADLSGen2FolderDataSetMapping extends CustomResource {
    /**
     ...
     */
    public ADLSGen2FolderDataSetMapping(String name, ADLSGen2FolderDataSetMappingArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datashare:ADLSGen2FolderDataSetMapping", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ADLSGen2FolderDataSetMapping(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ADLSGen2FolderDataSetMapping get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
