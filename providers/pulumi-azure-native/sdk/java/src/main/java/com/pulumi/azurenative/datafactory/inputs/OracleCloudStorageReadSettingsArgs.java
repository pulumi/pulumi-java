 ...
 * 
 */
public final class OracleCloudStorageReadSettingsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OracleCloudStorageReadSettingsArgs(OracleCloudStorageReadSettingsArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OracleCloudStorageReadSettingsArgs();
        }

        public Builder(OracleCloudStorageReadSettingsArgs defaults) {
            $ = new OracleCloudStorageReadSettingsArgs(Objects.requireNonNull(defaults));
        }
