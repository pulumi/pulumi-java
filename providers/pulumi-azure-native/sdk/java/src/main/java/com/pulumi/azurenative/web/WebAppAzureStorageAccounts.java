...
public class WebAppAzureStorageAccounts extends CustomResource {
    /**
     * Kind of resource.
     * 
     */
     ...
     */
    public WebAppAzureStorageAccounts(String name, WebAppAzureStorageAccountsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppAzureStorageAccounts(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppAzureStorageAccounts get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
