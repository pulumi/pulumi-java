...
public class WebAppAzureStorageAccounts extends com.pulumi.resources.CustomResource {
    /**
     * Kind of resource.
     * 
     */
     ...
     */
    public WebAppAzureStorageAccounts(String name, WebAppAzureStorageAccountsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private WebAppAzureStorageAccounts(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static WebAppAzureStorageAccounts get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
