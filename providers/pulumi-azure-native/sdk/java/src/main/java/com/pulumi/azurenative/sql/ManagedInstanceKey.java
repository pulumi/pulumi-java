...
public class ManagedInstanceKey extends CustomResource {
    /**
     ...
     */
    public ManagedInstanceKey(String name, ManagedInstanceKeyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagedInstanceKey(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagedInstanceKey get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
