...
public class PrivateEndpointConnectionProxy extends CustomResource {
    /**
     * ETag from NRP.
     * 
     */
     ...
     */
    public PrivateEndpointConnectionProxy(String name, PrivateEndpointConnectionProxyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateEndpointConnectionProxy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateEndpointConnectionProxy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
