...
public class OpenIdConnectProvider extends CustomResource {
    ...
    private OpenIdConnectProvider(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OpenIdConnectProvider get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
