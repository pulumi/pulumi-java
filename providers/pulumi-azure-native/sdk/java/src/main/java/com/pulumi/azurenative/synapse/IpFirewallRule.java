...
public class IpFirewallRule extends CustomResource {
    /**
     ...
     */
    public IpFirewallRule(String name, IpFirewallRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IpFirewallRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IpFirewallRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
