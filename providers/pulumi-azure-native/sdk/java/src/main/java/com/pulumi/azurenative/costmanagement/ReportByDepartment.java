...
import com.pulumi.azurenative.costmanagement.ReportByDepartmentArgs;
...
public class ReportByDepartment extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ReportByDepartment(String name, ReportByDepartmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private ReportByDepartment(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ReportByDepartment get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
