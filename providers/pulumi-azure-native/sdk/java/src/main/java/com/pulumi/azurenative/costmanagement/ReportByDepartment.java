...
public class ReportByDepartment extends CustomResource {
    /**
     ...
     */
    public ReportByDepartment(String name, ReportByDepartmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReportByDepartment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReportByDepartment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
