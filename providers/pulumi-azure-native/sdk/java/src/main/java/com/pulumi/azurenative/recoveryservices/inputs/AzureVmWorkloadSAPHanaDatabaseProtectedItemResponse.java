 ...
 * 
 */
public final class AzureVmWorkloadSAPHanaDatabaseProtectedItemResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private AzureVmWorkloadSAPHanaDatabaseProtectedItemResponse(AzureVmWorkloadSAPHanaDatabaseProtectedItemResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureVmWorkloadSAPHanaDatabaseProtectedItemResponse();
        }

        public Builder(AzureVmWorkloadSAPHanaDatabaseProtectedItemResponse defaults) {
            $ = new AzureVmWorkloadSAPHanaDatabaseProtectedItemResponse(Objects.requireNonNull(defaults));
        }
