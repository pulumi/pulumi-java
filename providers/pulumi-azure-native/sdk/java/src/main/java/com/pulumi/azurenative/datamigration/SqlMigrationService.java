...
public class SqlMigrationService extends CustomResource {
    /**
     ...
     */
    public SqlMigrationService(String name, SqlMigrationServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SqlMigrationService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SqlMigrationService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
