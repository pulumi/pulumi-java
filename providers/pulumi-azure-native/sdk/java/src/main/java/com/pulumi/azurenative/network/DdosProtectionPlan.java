...
public class DdosProtectionPlan extends CustomResource {
    /**
     ...
     */
    public DdosProtectionPlan(String name, DdosProtectionPlanArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DdosProtectionPlan(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DdosProtectionPlan get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
