...
public class CustomerEvent extends CustomResource {
    /**
     ...
     */
    public CustomerEvent(String name, CustomerEventArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CustomerEvent(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomerEvent get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
