...
public class JitNetworkAccessPolicy extends CustomResource {
    /**
     ...
     */
    public JitNetworkAccessPolicy(String name, JitNetworkAccessPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private JitNetworkAccessPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static JitNetworkAccessPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
