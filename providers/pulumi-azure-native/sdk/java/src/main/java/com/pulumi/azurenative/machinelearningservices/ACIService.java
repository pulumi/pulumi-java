...
public class ACIService extends CustomResource {
    /**
     ...
     */
    public ACIService(String name, ACIServiceArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:machinelearningservices:ACIService", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ACIService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ACIService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
