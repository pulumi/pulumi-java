...
public class KeyValue extends CustomResource {
    /**
     ...
     */
    public KeyValue(String name, KeyValueArgs args, @Nullable CustomResourceOptions options) {
    ...
    private KeyValue(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static KeyValue get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
