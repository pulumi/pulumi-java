...
public class CommitmentPlan extends CustomResource {
    /**
     ...
     */
    public CommitmentPlan(String name, CommitmentPlanArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CommitmentPlan(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CommitmentPlan get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
