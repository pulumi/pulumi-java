...
public class SqlPool extends CustomResource {
    /**
     * Collation mode
     * 
     */
     ...
     */
    public SqlPool(String name, SqlPoolArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:synapse:SqlPool", name, args == null ? SqlPoolArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SqlPool(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SqlPool get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
