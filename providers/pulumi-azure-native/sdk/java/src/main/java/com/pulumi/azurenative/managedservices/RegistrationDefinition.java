...
public class RegistrationDefinition extends CustomResource {
    /**
     ...
     */
    public RegistrationDefinition(String name, RegistrationDefinitionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegistrationDefinition(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegistrationDefinition get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
