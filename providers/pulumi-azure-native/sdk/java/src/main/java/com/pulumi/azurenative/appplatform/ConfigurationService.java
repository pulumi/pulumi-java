...
public class ConfigurationService extends CustomResource {
    /**
     ...
     */
    public ConfigurationService(String name, ConfigurationServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConfigurationService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConfigurationService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
