...
public class ServerAdvisor extends CustomResource {
    /**
     ...
     */
    public ServerAdvisor(String name, ServerAdvisorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServerAdvisor(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServerAdvisor get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
