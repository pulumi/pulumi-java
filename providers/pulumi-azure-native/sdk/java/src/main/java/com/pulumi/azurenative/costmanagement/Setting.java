...
public class Setting extends CustomResource {
    /**
     ...
     */
    public Setting(String name, SettingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Setting(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Setting get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
