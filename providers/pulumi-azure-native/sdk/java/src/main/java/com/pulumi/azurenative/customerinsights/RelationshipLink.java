...
public class RelationshipLink extends CustomResource {
    /**
     ...
     */
    public RelationshipLink(String name, RelationshipLinkArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RelationshipLink(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RelationshipLink get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
