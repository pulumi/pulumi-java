...
public final class GetDomainEventSubscriptionArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainEventSubscriptionArgs Empty = new GetDomainEventSubscriptionArgs();
    ...
    private GetDomainEventSubscriptionArgs() {}

    private GetDomainEventSubscriptionArgs(GetDomainEventSubscriptionArgs $) {
    ...
    public static Builder builder(GetDomainEventSubscriptionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainEventSubscriptionArgs();
        }

        public Builder(GetDomainEventSubscriptionArgs defaults) {
            $ = new GetDomainEventSubscriptionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDomainEventSubscriptionArgs build() {
