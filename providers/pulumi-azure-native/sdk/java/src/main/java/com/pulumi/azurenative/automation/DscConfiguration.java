...
public class DscConfiguration extends CustomResource {
    /**
     ...
     */
    public DscConfiguration(String name, DscConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DscConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DscConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
