...
public class WebPubSubSharedPrivateLinkResource extends CustomResource {
    /**
     ...
     */
    public WebPubSubSharedPrivateLinkResource(String name, WebPubSubSharedPrivateLinkResourceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebPubSubSharedPrivateLinkResource(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebPubSubSharedPrivateLinkResource get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
