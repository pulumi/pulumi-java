...
public class WebPubSubSharedPrivateLinkResource extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public WebPubSubSharedPrivateLinkResource(String name, WebPubSubSharedPrivateLinkResourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:webpubsub:WebPubSubSharedPrivateLinkResource", name, args == null ? WebPubSubSharedPrivateLinkResourceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private WebPubSubSharedPrivateLinkResource(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static WebPubSubSharedPrivateLinkResource get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
