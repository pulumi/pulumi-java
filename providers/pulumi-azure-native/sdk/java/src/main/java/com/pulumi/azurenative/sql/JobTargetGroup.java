...
public class JobTargetGroup extends CustomResource {
    /**
     ...
     */
    public JobTargetGroup(String name, JobTargetGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private JobTargetGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static JobTargetGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
