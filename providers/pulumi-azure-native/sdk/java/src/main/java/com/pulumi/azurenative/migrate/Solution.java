...
public class Solution extends CustomResource {
    /**
     ...
     */
    public Solution(String name, SolutionArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:migrate:Solution", name, args == null ? SolutionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Solution(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Solution get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
