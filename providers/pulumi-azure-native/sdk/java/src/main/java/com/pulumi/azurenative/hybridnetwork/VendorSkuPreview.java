...
public class VendorSkuPreview extends CustomResource {
    /**
     ...
     */
    public VendorSkuPreview(String name, VendorSkuPreviewArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VendorSkuPreview(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VendorSkuPreview get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
