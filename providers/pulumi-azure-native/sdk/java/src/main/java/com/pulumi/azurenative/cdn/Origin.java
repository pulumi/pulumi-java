...
public class Origin extends CustomResource {
     ...
     */
    public Origin(String name, OriginArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:cdn:Origin", name, args == null ? OriginArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Origin(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Origin get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
