...
public class PeeringService extends CustomResource {
    /**
     ...
     */
    public PeeringService(String name, PeeringServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PeeringService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PeeringService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
