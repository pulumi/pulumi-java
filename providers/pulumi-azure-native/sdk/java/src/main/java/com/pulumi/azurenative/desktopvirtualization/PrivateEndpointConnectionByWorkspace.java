...
public class PrivateEndpointConnectionByWorkspace extends CustomResource {
    /**
     ...
     */
    public PrivateEndpointConnectionByWorkspace(String name, PrivateEndpointConnectionByWorkspaceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateEndpointConnectionByWorkspace(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateEndpointConnectionByWorkspace get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
