...
public class BandwidthSchedule extends CustomResource {
    /**
     ...
     */
    public BandwidthSchedule(String name, BandwidthScheduleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BandwidthSchedule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BandwidthSchedule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
