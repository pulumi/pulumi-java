 ...
 * 
 */
public final class InformixTableDatasetResponse extends com.pulumi.resources.InvokeArgs {

    public static final InformixTableDatasetResponse Empty = new InformixTableDatasetResponse();
    ...
    /**
     * @return The Informix table name. Type: string (or Expression with resultType string).
     * 
     */
    ...
    private InformixTableDatasetResponse() {}

    private InformixTableDatasetResponse(InformixTableDatasetResponse $) {
    ...
    public static Builder builder(InformixTableDatasetResponse defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InformixTableDatasetResponse();
        }

        public Builder(InformixTableDatasetResponse defaults) {
            $ = new InformixTableDatasetResponse(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param tableName The Informix table name. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
        ...
        public InformixTableDatasetResponse build() {
