...
public class IdentityProvider extends CustomResource {
    ...
    private IdentityProvider(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IdentityProvider get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
