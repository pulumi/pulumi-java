...
public class DataCollectionRule extends CustomResource {
    /**
     ...
     */
    public DataCollectionRule(String name, DataCollectionRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DataCollectionRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DataCollectionRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
