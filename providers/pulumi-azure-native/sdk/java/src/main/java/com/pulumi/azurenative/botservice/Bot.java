...
public class Bot extends CustomResource {
     ...
     */
    public Bot(String name, BotArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:botservice:Bot", name, args == null ? BotArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Bot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Bot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
