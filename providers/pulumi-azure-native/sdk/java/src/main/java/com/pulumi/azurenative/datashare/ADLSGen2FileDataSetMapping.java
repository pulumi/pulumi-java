...
public class ADLSGen2FileDataSetMapping extends CustomResource {
    /**
     ...
     */
    public ADLSGen2FileDataSetMapping(String name, ADLSGen2FileDataSetMappingArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datashare:ADLSGen2FileDataSetMapping", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ADLSGen2FileDataSetMapping(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ADLSGen2FileDataSetMapping get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
