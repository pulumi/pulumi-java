...
public class WebPubSubPrivateEndpointConnection extends CustomResource {
    /**
     ...
     */
    public WebPubSubPrivateEndpointConnection(String name, WebPubSubPrivateEndpointConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebPubSubPrivateEndpointConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebPubSubPrivateEndpointConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
