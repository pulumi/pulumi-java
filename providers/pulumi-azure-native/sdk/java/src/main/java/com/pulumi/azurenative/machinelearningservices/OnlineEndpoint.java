...
public class OnlineEndpoint extends CustomResource {
    /**
     ...
     */
    public OnlineEndpoint(String name, OnlineEndpointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OnlineEndpoint(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OnlineEndpoint get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
