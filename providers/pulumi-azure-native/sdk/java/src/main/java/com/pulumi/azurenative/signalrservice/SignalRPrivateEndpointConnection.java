...
public class SignalRPrivateEndpointConnection extends CustomResource {
    /**
     ...
     */
    public SignalRPrivateEndpointConnection(String name, SignalRPrivateEndpointConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SignalRPrivateEndpointConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SignalRPrivateEndpointConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
