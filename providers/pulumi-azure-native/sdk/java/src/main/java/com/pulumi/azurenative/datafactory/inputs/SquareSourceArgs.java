 ...
 * 
 */
public final class SquareSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SquareSourceArgs(SquareSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SquareSourceArgs();
        }

        public Builder(SquareSourceArgs defaults) {
            $ = new SquareSourceArgs(Objects.requireNonNull(defaults));
        }
