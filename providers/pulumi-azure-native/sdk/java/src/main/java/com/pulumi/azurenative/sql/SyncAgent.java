...
public class SyncAgent extends CustomResource {
    /**
     ...
     */
    public SyncAgent(String name, SyncAgentArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:sql:SyncAgent", name, args == null ? SyncAgentArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SyncAgent(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SyncAgent get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
