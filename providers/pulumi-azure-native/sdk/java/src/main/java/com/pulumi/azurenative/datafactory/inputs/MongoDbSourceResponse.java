...
public final class MongoDbSourceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private MongoDbSourceResponse(MongoDbSourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MongoDbSourceResponse();
        }

        public Builder(MongoDbSourceResponse defaults) {
            $ = new MongoDbSourceResponse(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param query Database query. Should be a SQL-92 query expression. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
