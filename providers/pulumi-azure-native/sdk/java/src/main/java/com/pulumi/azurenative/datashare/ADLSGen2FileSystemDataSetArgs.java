...
public final class ADLSGen2FileSystemDataSetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ADLSGen2FileSystemDataSetArgs(ADLSGen2FileSystemDataSetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ADLSGen2FileSystemDataSetArgs();
        }

        public Builder(ADLSGen2FileSystemDataSetArgs defaults) {
            $ = new ADLSGen2FileSystemDataSetArgs(Objects.requireNonNull(defaults));
        }
