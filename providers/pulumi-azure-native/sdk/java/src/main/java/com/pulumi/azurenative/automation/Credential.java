...
public class Credential extends CustomResource {
    /**
     ...
     */
    public Credential(String name, CredentialArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Credential(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Credential get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
