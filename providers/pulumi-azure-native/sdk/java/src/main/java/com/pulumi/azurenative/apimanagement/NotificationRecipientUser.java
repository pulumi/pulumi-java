...
public class NotificationRecipientUser extends CustomResource {
    /**
     * Resource name.
     * 
     */
     ...
     */
    public NotificationRecipientUser(String name, NotificationRecipientUserArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NotificationRecipientUser(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NotificationRecipientUser get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
