...
public class ManagementGroupSubscription extends CustomResource {
    /**
     ...
     */
    public ManagementGroupSubscription(String name, ManagementGroupSubscriptionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagementGroupSubscription(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagementGroupSubscription get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
