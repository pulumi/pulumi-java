...
public class Automation extends CustomResource {
    /**
     ...
     */
    public Automation(String name, AutomationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Automation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Automation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
