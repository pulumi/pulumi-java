...
public class ApiPortalCustomDomain extends CustomResource {
    /**
     ...
     */
    public ApiPortalCustomDomain(String name, ApiPortalCustomDomainArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApiPortalCustomDomain(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApiPortalCustomDomain get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
