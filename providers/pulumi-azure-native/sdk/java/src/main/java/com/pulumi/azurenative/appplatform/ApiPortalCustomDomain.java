...
public class ApiPortalCustomDomain extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    public Output<ApiPortalCustomDomainPropertiesResponse> properties() {
     ...
     */
    public ApiPortalCustomDomain(String name, ApiPortalCustomDomainArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:appplatform:ApiPortalCustomDomain", name, args == null ? ApiPortalCustomDomainArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ApiPortalCustomDomain(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("azure-native:appplatform/v20220301preview:ApiPortalCustomDomain").build())
            ))
            .build();
     ...
     */
    public static ApiPortalCustomDomain get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
