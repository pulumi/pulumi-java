...
public class FirewallPolicyRuleCollectionGroup extends CustomResource {
    /**
     ...
     */
    public FirewallPolicyRuleCollectionGroup(String name, FirewallPolicyRuleCollectionGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FirewallPolicyRuleCollectionGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FirewallPolicyRuleCollectionGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
