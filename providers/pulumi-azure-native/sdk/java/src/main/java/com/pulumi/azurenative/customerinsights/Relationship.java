...
public class Relationship extends CustomResource {
    /**
     ...
     */
    public Relationship(String name, RelationshipArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Relationship(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Relationship get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
