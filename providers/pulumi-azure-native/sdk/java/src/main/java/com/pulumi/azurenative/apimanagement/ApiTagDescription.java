...
public class ApiTagDescription extends CustomResource {
    /**
     ...
     */
    public ApiTagDescription(String name, ApiTagDescriptionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApiTagDescription(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApiTagDescription get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
