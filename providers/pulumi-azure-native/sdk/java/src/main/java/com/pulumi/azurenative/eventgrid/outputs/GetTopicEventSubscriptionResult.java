...
@CustomType
public final class GetTopicEventSubscriptionResult {
    /**
    ...
    public static Builder builder(GetTopicEventSubscriptionResult defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetTopicEventSubscriptionResult defaults) {
        ...
        public Builder type(String type) {
            ...
            return this;
        }        public GetTopicEventSubscriptionResult build() {
            return new GetTopicEventSubscriptionResult(deadLetterDestination, deadLetterWithResourceIdentity, deliveryWithResourceIdentity, destination, eventDeliverySchema, expirationTimeUtc, filter, id, labels, name, provisioningState, retryPolicy, systemData, topic, type);
        }
    }
}
