...
public class DeploymentAtTenantScope extends CustomResource {
    /**
     ...
     */
    public DeploymentAtTenantScope(String name, DeploymentAtTenantScopeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DeploymentAtTenantScope(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DeploymentAtTenantScope get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
