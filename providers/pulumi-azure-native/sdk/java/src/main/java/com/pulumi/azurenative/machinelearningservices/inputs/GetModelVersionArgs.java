...
public final class GetModelVersionArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetModelVersionArgs(GetModelVersionArgs $) {
        this.name = $.name;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetModelVersionArgs();
        }

        public Builder(GetModelVersionArgs defaults) {
            $ = new GetModelVersionArgs(Objects.requireNonNull(defaults));
        }
