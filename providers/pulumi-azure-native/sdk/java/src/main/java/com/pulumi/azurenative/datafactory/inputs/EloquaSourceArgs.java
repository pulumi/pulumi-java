 ...
 * 
 */
public final class EloquaSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EloquaSourceArgs(EloquaSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EloquaSourceArgs();
        }

        public Builder(EloquaSourceArgs defaults) {
            $ = new EloquaSourceArgs(Objects.requireNonNull(defaults));
        }
