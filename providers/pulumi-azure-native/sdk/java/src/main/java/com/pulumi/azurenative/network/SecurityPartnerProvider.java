...
public class SecurityPartnerProvider extends CustomResource {
    /**
     ...
     */
    public SecurityPartnerProvider(String name, SecurityPartnerProviderArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SecurityPartnerProvider(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SecurityPartnerProvider get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
