...
public class OnlineDeployment extends CustomResource {
    /**
     ...
     */
    public OnlineDeployment(String name, OnlineDeploymentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OnlineDeployment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OnlineDeployment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
