 ...
 * 
 */
public final class QueryStringMatchConditionParametersResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private QueryStringMatchConditionParametersResponse(QueryStringMatchConditionParametersResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new QueryStringMatchConditionParametersResponse();
        }

        public Builder(QueryStringMatchConditionParametersResponse defaults) {
            $ = new QueryStringMatchConditionParametersResponse(Objects.requireNonNull(defaults));
        }
