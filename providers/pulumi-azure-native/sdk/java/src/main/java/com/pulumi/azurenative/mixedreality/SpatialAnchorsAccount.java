...
public class SpatialAnchorsAccount extends CustomResource {
    /**
     ...
     */
    public SpatialAnchorsAccount(String name, SpatialAnchorsAccountArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SpatialAnchorsAccount(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SpatialAnchorsAccount get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
