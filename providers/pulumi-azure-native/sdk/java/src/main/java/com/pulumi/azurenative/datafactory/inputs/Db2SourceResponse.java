 ...
 * 
 */
public final class Db2SourceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private Db2SourceResponse(Db2SourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new Db2SourceResponse();
        }

        public Builder(Db2SourceResponse defaults) {
            $ = new Db2SourceResponse(Objects.requireNonNull(defaults));
        }
