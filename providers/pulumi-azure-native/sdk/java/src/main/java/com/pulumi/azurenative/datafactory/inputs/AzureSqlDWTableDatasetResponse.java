 ...
 * 
 */
public final class AzureSqlDWTableDatasetResponse extends com.pulumi.resources.InvokeArgs {

    public static final AzureSqlDWTableDatasetResponse Empty = new AzureSqlDWTableDatasetResponse();
    ...
    /**
     * @return The table name of the Azure SQL Data Warehouse. Type: string (or Expression with resultType string).
     * 
     */
    ...
    private AzureSqlDWTableDatasetResponse(AzureSqlDWTableDatasetResponse $) {
    ...
    public static Builder builder(AzureSqlDWTableDatasetResponse defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureSqlDWTableDatasetResponse();
        }

        public Builder(AzureSqlDWTableDatasetResponse defaults) {
            $ = new AzureSqlDWTableDatasetResponse(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param table The table name of the Azure SQL Data Warehouse. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
