...
public class NetworkInterface extends CustomResource {
    ...
    private NetworkInterface(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkInterface get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
