...
public class IotHubResource extends CustomResource {
    /**
     ...
     */
    public IotHubResource(String name, IotHubResourceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IotHubResource(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IotHubResource get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
