...
public class VirtualNetworkGatewayNatRule extends CustomResource {
    /**
     ...
     */
    public VirtualNetworkGatewayNatRule(String name, VirtualNetworkGatewayNatRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualNetworkGatewayNatRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualNetworkGatewayNatRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
