...
public class AttestationAtSubscription extends CustomResource {
    /**
     ...
     */
    public AttestationAtSubscription(String name, AttestationAtSubscriptionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AttestationAtSubscription(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AttestationAtSubscription get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
