...
public class PrivateLinkServicesForMIPPolicySync extends CustomResource {
    /**
     ...
     */
    public PrivateLinkServicesForMIPPolicySync(String name, PrivateLinkServicesForMIPPolicySyncArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:m365securityandcompliance:privateLinkServicesForMIPPolicySync", name, args == null ? PrivateLinkServicesForMIPPolicySyncArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private PrivateLinkServicesForMIPPolicySync(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateLinkServicesForMIPPolicySync get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
