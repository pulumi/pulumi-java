...
public class StaticSite extends CustomResource {
    /**
     ...
     */
    public StaticSite(String name, StaticSiteArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:web:StaticSite", name, args == null ? StaticSiteArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private StaticSite(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StaticSite get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
