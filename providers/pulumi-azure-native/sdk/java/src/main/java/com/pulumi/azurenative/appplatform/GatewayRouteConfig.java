...
public class GatewayRouteConfig extends CustomResource {
    /**
     ...
     */
    public GatewayRouteConfig(String name, GatewayRouteConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GatewayRouteConfig(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GatewayRouteConfig get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
