 ...
 * 
 */
public final class DynamicsCrmSourceArgs extends ResourceArgs {

    public static final DynamicsCrmSourceArgs Empty = new DynamicsCrmSourceArgs();
    ...
    /**
     * @return FetchXML is a proprietary query language that is used in Microsoft Dynamics CRM (online &amp; on-premises). Type: string (or Expression with resultType string).
     * 
     */
    ...
    private DynamicsCrmSourceArgs() {}

    private DynamicsCrmSourceArgs(DynamicsCrmSourceArgs $) {
    ...
    public static Builder builder(DynamicsCrmSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DynamicsCrmSourceArgs();
        }

        public Builder(DynamicsCrmSourceArgs defaults) {
            $ = new DynamicsCrmSourceArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param query FetchXML is a proprietary query language that is used in Microsoft Dynamics CRM (online &amp; on-premises). Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
        ...
        public DynamicsCrmSourceArgs build() {
