...
public class KustoPool extends CustomResource {
    /**
     ...
     */
    public KustoPool(String name, KustoPoolArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:synapse:kustoPool", name, args == null ? KustoPoolArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private KustoPool(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static KustoPool get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
