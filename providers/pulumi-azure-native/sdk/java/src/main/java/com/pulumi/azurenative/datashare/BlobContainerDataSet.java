...
public class BlobContainerDataSet extends CustomResource {
    /**
     * BLOB Container name.
     * 
     */
     ...
     */
    public BlobContainerDataSet(String name, BlobContainerDataSetArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datashare:BlobContainerDataSet", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private BlobContainerDataSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BlobContainerDataSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
