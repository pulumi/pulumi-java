...
public class StorageTarget extends CustomResource {
    /**
     ...
     */
    public StorageTarget(String name, StorageTargetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StorageTarget(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StorageTarget get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
