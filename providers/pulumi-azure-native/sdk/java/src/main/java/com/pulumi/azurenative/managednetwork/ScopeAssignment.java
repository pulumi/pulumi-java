...
public class ScopeAssignment extends CustomResource {
    /**
     ...
     */
    public ScopeAssignment(String name, ScopeAssignmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ScopeAssignment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ScopeAssignment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
