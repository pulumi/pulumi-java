...
public class SyncGroup extends CustomResource {
    /**
     ...
     */
    public SyncGroup(String name, SyncGroupArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:sql:SyncGroup", name, args == null ? SyncGroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SyncGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SyncGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
