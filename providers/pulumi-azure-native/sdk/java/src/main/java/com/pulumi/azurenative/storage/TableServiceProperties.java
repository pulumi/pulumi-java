...
public class TableServiceProperties extends CustomResource {
    /**
     ...
     */
    public TableServiceProperties(String name, TableServicePropertiesArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TableServiceProperties(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TableServiceProperties get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
