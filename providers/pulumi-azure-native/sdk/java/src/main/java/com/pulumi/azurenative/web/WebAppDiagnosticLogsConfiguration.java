...
public class WebAppDiagnosticLogsConfiguration extends CustomResource {
    /**
     ...
     */
    public WebAppDiagnosticLogsConfiguration(String name, WebAppDiagnosticLogsConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppDiagnosticLogsConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppDiagnosticLogsConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
