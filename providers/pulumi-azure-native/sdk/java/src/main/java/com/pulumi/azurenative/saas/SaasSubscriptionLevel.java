...
public class SaasSubscriptionLevel extends CustomResource {
    /**
     ...
     */
    public SaasSubscriptionLevel(String name, SaasSubscriptionLevelArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SaasSubscriptionLevel(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SaasSubscriptionLevel get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
