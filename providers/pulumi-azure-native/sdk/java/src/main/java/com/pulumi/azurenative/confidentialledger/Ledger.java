...
public class Ledger extends CustomResource {
     ...
     */
    public Ledger(String name, LedgerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Ledger(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Ledger get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
