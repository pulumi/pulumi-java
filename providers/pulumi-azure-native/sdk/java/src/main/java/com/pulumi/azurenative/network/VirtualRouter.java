...
public class VirtualRouter extends CustomResource {
    /**
     ...
     */
    public VirtualRouter(String name, VirtualRouterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualRouter(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualRouter get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
