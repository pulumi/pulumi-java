...
public class GuestConfigurationAssignment extends CustomResource {
    /**
     ...
     */
    public GuestConfigurationAssignment(String name, GuestConfigurationAssignmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GuestConfigurationAssignment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GuestConfigurationAssignment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
