...
public class ManagedInstancePrivateEndpointConnection extends CustomResource {
    /**
     * Resource name.
     * 
     */
     ...
     */
    public ManagedInstancePrivateEndpointConnection(String name, ManagedInstancePrivateEndpointConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagedInstancePrivateEndpointConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagedInstancePrivateEndpointConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
