 ...
 * 
 */
public final class AmazonRdsForSqlServerSourceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private AmazonRdsForSqlServerSourceResponse(AmazonRdsForSqlServerSourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AmazonRdsForSqlServerSourceResponse();
        }

        public Builder(AmazonRdsForSqlServerSourceResponse defaults) {
            $ = new AmazonRdsForSqlServerSourceResponse(Objects.requireNonNull(defaults));
        }
