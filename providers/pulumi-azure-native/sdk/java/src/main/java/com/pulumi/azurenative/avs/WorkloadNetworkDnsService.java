...
public class WorkloadNetworkDnsService extends CustomResource {
    /**
     ...
     */
    public WorkloadNetworkDnsService(String name, WorkloadNetworkDnsServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WorkloadNetworkDnsService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkloadNetworkDnsService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
