 ...
 * 
 */
public final class NumberLessThanAdvancedFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private NumberLessThanAdvancedFilterArgs(NumberLessThanAdvancedFilterArgs $) {
        this.key = $.key;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NumberLessThanAdvancedFilterArgs();
        }

        public Builder(NumberLessThanAdvancedFilterArgs defaults) {
            $ = new NumberLessThanAdvancedFilterArgs(Objects.requireNonNull(defaults));
        }
