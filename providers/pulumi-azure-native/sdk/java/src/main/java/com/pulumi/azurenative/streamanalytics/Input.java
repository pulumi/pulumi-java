...
public class Input extends CustomResource {
     ...
     */
    public Input(String name, InputArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:streamanalytics:Input", name, args == null ? InputArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Input(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Input get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
