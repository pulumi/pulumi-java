...
public class ProductGroup extends CustomResource {
    /**
     ...
     */
    public ProductGroup(String name, ProductGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProductGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProductGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
