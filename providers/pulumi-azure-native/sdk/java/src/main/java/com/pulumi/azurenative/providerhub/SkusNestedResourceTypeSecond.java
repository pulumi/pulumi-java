...
public class SkusNestedResourceTypeSecond extends CustomResource {
    /**
     ...
     */
    public SkusNestedResourceTypeSecond(String name, SkusNestedResourceTypeSecondArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SkusNestedResourceTypeSecond(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SkusNestedResourceTypeSecond get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
