...
public class LoadTest extends CustomResource {
    /**
     ...
     */
    public LoadTest(String name, LoadTestArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LoadTest(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LoadTest get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
