...
public class HyperVCollector extends CustomResource {
     ...
     */
    public HyperVCollector(String name, HyperVCollectorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HyperVCollector(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HyperVCollector get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
