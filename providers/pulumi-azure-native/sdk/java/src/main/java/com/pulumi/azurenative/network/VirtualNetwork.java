...
public class VirtualNetwork extends CustomResource {
    /**
     ...
     */
    public VirtualNetwork(String name, VirtualNetworkArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualNetwork(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualNetwork get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
