...
public class ConnectorMapping extends CustomResource {
    /**
     ...
     */
    public ConnectorMapping(String name, ConnectorMappingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConnectorMapping(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConnectorMapping get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
