...
public class ServiceRunner extends CustomResource {
    /**
     ...
     */
    public ServiceRunner(String name, ServiceRunnerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceRunner(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceRunner get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
