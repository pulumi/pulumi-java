...
public class WorkloadNetworkPublicIP extends CustomResource {
    /**
     ...
     */
    public WorkloadNetworkPublicIP(String name, WorkloadNetworkPublicIPArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WorkloadNetworkPublicIP(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkloadNetworkPublicIP get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
