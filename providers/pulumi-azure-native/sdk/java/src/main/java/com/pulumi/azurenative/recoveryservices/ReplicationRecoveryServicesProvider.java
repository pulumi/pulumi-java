...
public class ReplicationRecoveryServicesProvider extends CustomResource {
    /**
     * Resource Location
     * 
     */
     ...
     */
    public ReplicationRecoveryServicesProvider(String name, ReplicationRecoveryServicesProviderArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReplicationRecoveryServicesProvider(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReplicationRecoveryServicesProvider get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
