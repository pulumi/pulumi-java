...
public class MonitoringConfig extends CustomResource {
    /**
     ...
     */
    public MonitoringConfig(String name, MonitoringConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MonitoringConfig(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MonitoringConfig get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
