...
public class ManagementGroup extends CustomResource {
    /**
     ...
     */
    public ManagementGroup(String name, @Nullable ManagementGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagementGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagementGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
