...
public class CommunicationService extends CustomResource {
    /**
     ...
     */
    public CommunicationService(String name, CommunicationServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CommunicationService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CommunicationService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
