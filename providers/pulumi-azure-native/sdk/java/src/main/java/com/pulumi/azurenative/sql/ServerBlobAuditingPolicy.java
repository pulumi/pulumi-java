...
public class ServerBlobAuditingPolicy extends CustomResource {
    /**
     ...
     */
    public ServerBlobAuditingPolicy(String name, ServerBlobAuditingPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServerBlobAuditingPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServerBlobAuditingPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
