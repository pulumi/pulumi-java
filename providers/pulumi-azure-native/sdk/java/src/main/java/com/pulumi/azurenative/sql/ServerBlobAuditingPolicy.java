...
public class ServerBlobAuditingPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ServerBlobAuditingPolicy(String name, ServerBlobAuditingPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private ServerBlobAuditingPolicy(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("azure-native:sql/v20211101preview:ServerBlobAuditingPolicy").build())
            ))
            .build();
     ...
     */
    public static ServerBlobAuditingPolicy get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
