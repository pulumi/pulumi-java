...
public final class GetADLSGen2FileSystemDataSetArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetADLSGen2FileSystemDataSetArgs(GetADLSGen2FileSystemDataSetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetADLSGen2FileSystemDataSetArgs();
        }

        public Builder(GetADLSGen2FileSystemDataSetArgs defaults) {
            $ = new GetADLSGen2FileSystemDataSetArgs(Objects.requireNonNull(defaults));
        }
