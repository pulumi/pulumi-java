...
public class GremlinResourceGremlinGraph extends CustomResource {
    /**
     ...
     */
    public GremlinResourceGremlinGraph(String name, GremlinResourceGremlinGraphArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GremlinResourceGremlinGraph(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GremlinResourceGremlinGraph get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
