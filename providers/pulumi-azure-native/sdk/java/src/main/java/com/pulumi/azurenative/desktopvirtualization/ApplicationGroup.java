...
public class ApplicationGroup extends CustomResource {
    /**
     ...
     */
    public ApplicationGroup(String name, ApplicationGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApplicationGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApplicationGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
