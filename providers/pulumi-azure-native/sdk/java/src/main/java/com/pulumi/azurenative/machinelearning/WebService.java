...
public class WebService extends CustomResource {
    /**
     ...
     */
    public WebService(String name, WebServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
