...
public class HanaInstance extends CustomResource {
    /**
     ...
     */
    public HanaInstance(String name, HanaInstanceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HanaInstance(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HanaInstance get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
