...
public class WebAppDomainOwnershipIdentifierSlot extends CustomResource {
    /**
     * Kind of resource.
     * 
     */
     ...
     */
    public WebAppDomainOwnershipIdentifierSlot(String name, WebAppDomainOwnershipIdentifierSlotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppDomainOwnershipIdentifierSlot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppDomainOwnershipIdentifierSlot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
