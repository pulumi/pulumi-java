...
public class NotificationChannel extends CustomResource {
    ...
    private NotificationChannel(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NotificationChannel get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
