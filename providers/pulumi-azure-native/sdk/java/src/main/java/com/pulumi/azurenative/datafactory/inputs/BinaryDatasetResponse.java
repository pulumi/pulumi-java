 ...
 * 
 */
public final class BinaryDatasetResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private BinaryDatasetResponse(BinaryDatasetResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BinaryDatasetResponse();
        }

        public Builder(BinaryDatasetResponse defaults) {
            $ = new BinaryDatasetResponse(Objects.requireNonNull(defaults));
        }
