...
public class IoTHubEventSource extends CustomResource {
    /**
     ...
     */
    public IoTHubEventSource(String name, IoTHubEventSourceArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:timeseriesinsights:IoTHubEventSource", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private IoTHubEventSource(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IoTHubEventSource get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
