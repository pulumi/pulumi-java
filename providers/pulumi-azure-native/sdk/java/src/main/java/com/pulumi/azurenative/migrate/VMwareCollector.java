...
public class VMwareCollector extends CustomResource {
     ...
     */
    public VMwareCollector(String name, VMwareCollectorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VMwareCollector(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VMwareCollector get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
