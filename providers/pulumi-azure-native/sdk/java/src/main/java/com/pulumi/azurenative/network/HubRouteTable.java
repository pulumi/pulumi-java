...
public class HubRouteTable extends CustomResource {
    /**
     ...
     */
    public HubRouteTable(String name, HubRouteTableArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HubRouteTable(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HubRouteTable get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
