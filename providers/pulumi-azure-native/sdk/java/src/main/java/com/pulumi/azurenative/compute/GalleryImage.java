...
public class GalleryImage extends CustomResource {
    /**
     ...
     */
    public GalleryImage(String name, GalleryImageArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GalleryImage(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GalleryImage get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
