...
public class Standard extends CustomResource {
    /**
     ...
     */
    public Standard(String name, StandardArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:security:Standard", name, args == null ? StandardArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Standard(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Standard get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
