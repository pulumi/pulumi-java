...
public class KustoDatabaseDataSet extends CustomResource {
    /**
     ...
     */
    public KustoDatabaseDataSet(String name, KustoDatabaseDataSetArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datashare:KustoDatabaseDataSet", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private KustoDatabaseDataSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static KustoDatabaseDataSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
