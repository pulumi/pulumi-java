...
public class WebTest extends CustomResource {
    /**
     ...
     */
    public WebTest(String name, WebTestArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:insights:WebTest", name, args == null ? WebTestArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private WebTest(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebTest get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
