 ...
 * 
 */
public final class PaypalObjectDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PaypalObjectDatasetArgs(PaypalObjectDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PaypalObjectDatasetArgs();
        }

        public Builder(PaypalObjectDatasetArgs defaults) {
            $ = new PaypalObjectDatasetArgs(Objects.requireNonNull(defaults));
        }
