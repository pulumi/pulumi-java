...
public class JobCredential extends CustomResource {
    /**
     * Resource name.
     * 
     */
     ...
     */
    public JobCredential(String name, JobCredentialArgs args, @Nullable CustomResourceOptions options) {
    ...
    private JobCredential(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static JobCredential get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
