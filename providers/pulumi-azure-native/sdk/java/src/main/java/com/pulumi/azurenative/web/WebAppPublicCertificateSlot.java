...
public class WebAppPublicCertificateSlot extends CustomResource {
    /**
     ...
     */
    public WebAppPublicCertificateSlot(String name, WebAppPublicCertificateSlotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppPublicCertificateSlot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppPublicCertificateSlot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
