...
public class ManagedDatabaseSensitivityLabel extends CustomResource {
    /**
     * The column name.
     * 
     */
     ...
     */
    public ManagedDatabaseSensitivityLabel(String name, ManagedDatabaseSensitivityLabelArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagedDatabaseSensitivityLabel(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagedDatabaseSensitivityLabel get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
