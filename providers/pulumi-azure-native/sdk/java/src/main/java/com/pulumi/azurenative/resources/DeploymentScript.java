...
public class DeploymentScript extends CustomResource {
    /**
     ...
     */
    public DeploymentScript(String name, DeploymentScriptArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DeploymentScript(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DeploymentScript get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
