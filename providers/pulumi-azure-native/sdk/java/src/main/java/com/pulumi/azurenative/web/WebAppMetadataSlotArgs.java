...
public final class WebAppMetadataSlotArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WebAppMetadataSlotArgs() {}

    private WebAppMetadataSlotArgs(WebAppMetadataSlotArgs $) {
        this.kind = $.kind;
        this.name = $.name;
    ...
    public static Builder builder(WebAppMetadataSlotArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAppMetadataSlotArgs();
        }

        public Builder(WebAppMetadataSlotArgs defaults) {
        ...
        public WebAppMetadataSlotArgs build() {
