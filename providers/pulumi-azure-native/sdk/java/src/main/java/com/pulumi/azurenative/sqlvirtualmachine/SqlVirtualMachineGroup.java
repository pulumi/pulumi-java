...
public class SqlVirtualMachineGroup extends CustomResource {
    /**
     * Cluster type.
     * 
     */
     ...
     */
    public SqlVirtualMachineGroup(String name, SqlVirtualMachineGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SqlVirtualMachineGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SqlVirtualMachineGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
