...
public class Webhook extends CustomResource {
    /**
     ...
     */
    public Webhook(String name, WebhookArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Webhook(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Webhook get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
