...
public class Authorization extends CustomResource {
    /**
     ...
     */
    public Authorization(String name, AuthorizationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Authorization(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Authorization get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
