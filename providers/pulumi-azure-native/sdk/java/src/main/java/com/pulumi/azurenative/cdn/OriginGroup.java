...
public class OriginGroup extends CustomResource {
    /**
     ...
     */
    public OriginGroup(String name, OriginGroupArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:cdn:OriginGroup", name, args == null ? OriginGroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private OriginGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OriginGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
