...
public class BillingRoleAssignmentByBillingAccount extends CustomResource {
    /**
     ...
     */
    public BillingRoleAssignmentByBillingAccount(String name, BillingRoleAssignmentByBillingAccountArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BillingRoleAssignmentByBillingAccount(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BillingRoleAssignmentByBillingAccount get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
