...
public class SensitivityLabel extends CustomResource {
    /**
     * The column name.
     * 
     */
     ...
     */
    public SensitivityLabel(String name, SensitivityLabelArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SensitivityLabel(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SensitivityLabel get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
