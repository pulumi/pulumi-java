...
public class WebApplicationFirewallPolicy extends CustomResource {
    /**
     ...
     */
    public WebApplicationFirewallPolicy(String name, WebApplicationFirewallPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebApplicationFirewallPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebApplicationFirewallPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
