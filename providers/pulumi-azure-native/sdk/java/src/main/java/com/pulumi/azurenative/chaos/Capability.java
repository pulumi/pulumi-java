...
public class Capability extends CustomResource {
    /**
     ...
     */
    public Capability(String name, CapabilityArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:chaos:Capability", name, args == null ? CapabilityArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Capability(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Capability get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
