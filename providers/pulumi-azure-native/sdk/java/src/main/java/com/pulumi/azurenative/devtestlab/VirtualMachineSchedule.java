...
public class VirtualMachineSchedule extends CustomResource {
    /**
     ...
     */
    public VirtualMachineSchedule(String name, VirtualMachineScheduleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualMachineSchedule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualMachineSchedule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
