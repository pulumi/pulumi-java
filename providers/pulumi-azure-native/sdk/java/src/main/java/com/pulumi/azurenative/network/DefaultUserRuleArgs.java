...
public final class DefaultUserRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DefaultUserRuleArgs(DefaultUserRuleArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DefaultUserRuleArgs();
        }

        public Builder(DefaultUserRuleArgs defaults) {
            $ = new DefaultUserRuleArgs(Objects.requireNonNull(defaults));
        }
