...
public class NetworkWatcher extends CustomResource {
    /**
     ...
     */
    public NetworkWatcher(String name, NetworkWatcherArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NetworkWatcher(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkWatcher get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
