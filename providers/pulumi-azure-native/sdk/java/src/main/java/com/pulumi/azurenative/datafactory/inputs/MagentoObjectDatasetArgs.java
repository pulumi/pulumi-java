 ...
 * 
 */
public final class MagentoObjectDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MagentoObjectDatasetArgs(MagentoObjectDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MagentoObjectDatasetArgs();
        }

        public Builder(MagentoObjectDatasetArgs defaults) {
            $ = new MagentoObjectDatasetArgs(Objects.requireNonNull(defaults));
        }
