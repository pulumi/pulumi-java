 ...
 * 
 */
public final class AmazonS3ReadSettingsResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private AmazonS3ReadSettingsResponse(AmazonS3ReadSettingsResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AmazonS3ReadSettingsResponse();
        }

        public Builder(AmazonS3ReadSettingsResponse defaults) {
            $ = new AmazonS3ReadSettingsResponse(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param wildcardFileName AmazonS3 wildcardFileName. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param wildcardFolderPath AmazonS3 wildcardFolderPath. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
