...
public class TagByApi extends CustomResource {
    /**
     * Tag name.
     * 
     */
     ...
     */
    public TagByApi(String name, TagByApiArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TagByApi(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TagByApi get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
