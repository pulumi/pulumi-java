...
public class CustomDomain extends CustomResource {
    /**
     ...
     */
    public CustomDomain(String name, CustomDomainArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:cdn:CustomDomain", name, args == null ? CustomDomainArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private CustomDomain(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomDomain get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
