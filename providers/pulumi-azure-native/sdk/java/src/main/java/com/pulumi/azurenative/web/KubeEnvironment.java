...
public class KubeEnvironment extends CustomResource {
     ...
     */
    public KubeEnvironment(String name, KubeEnvironmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private KubeEnvironment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static KubeEnvironment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
