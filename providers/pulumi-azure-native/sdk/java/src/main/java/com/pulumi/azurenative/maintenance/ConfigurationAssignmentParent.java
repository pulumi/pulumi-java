...
public class ConfigurationAssignmentParent extends CustomResource {
    /**
     ...
     */
    public ConfigurationAssignmentParent(String name, ConfigurationAssignmentParentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConfigurationAssignmentParent(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConfigurationAssignmentParent get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
