...
public class IntegrationAccount extends CustomResource {
    /**
     ...
     */
    public IntegrationAccount(String name, IntegrationAccountArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IntegrationAccount(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IntegrationAccount get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
