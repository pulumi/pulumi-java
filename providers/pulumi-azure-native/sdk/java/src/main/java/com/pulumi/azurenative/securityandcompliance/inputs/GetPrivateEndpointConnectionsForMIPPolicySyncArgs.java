...
public final class GetPrivateEndpointConnectionsForMIPPolicySyncArgs extends InvokeArgs {
    ...
    private GetPrivateEndpointConnectionsForMIPPolicySyncArgs(GetPrivateEndpointConnectionsForMIPPolicySyncArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPrivateEndpointConnectionsForMIPPolicySyncArgs();
        }

        public Builder(GetPrivateEndpointConnectionsForMIPPolicySyncArgs defaults) {
            $ = new GetPrivateEndpointConnectionsForMIPPolicySyncArgs(Objects.requireNonNull(defaults));
        }
