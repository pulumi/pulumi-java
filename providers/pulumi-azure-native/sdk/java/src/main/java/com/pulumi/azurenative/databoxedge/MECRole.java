...
public class MECRole extends CustomResource {
    /**
     ...
     */
    public MECRole(String name, MECRoleArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:databoxedge:MECRole", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private MECRole(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MECRole get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
