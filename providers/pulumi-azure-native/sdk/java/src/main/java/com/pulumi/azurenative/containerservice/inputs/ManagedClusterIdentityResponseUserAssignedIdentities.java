...
public final class ManagedClusterIdentityResponseUserAssignedIdentities extends com.pulumi.resources.InvokeArgs {
    ...
    private ManagedClusterIdentityResponseUserAssignedIdentities(ManagedClusterIdentityResponseUserAssignedIdentities $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagedClusterIdentityResponseUserAssignedIdentities();
        }

        public Builder(ManagedClusterIdentityResponseUserAssignedIdentities defaults) {
            $ = new ManagedClusterIdentityResponseUserAssignedIdentities(Objects.requireNonNull(defaults));
        }
