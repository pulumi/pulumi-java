...
public final class AzureSqlMILinkedServiceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return The ID of the service principal used to authenticate against Azure SQL Managed Instance. Type: string (or Expression with resultType string).
     * 
     */
    ...
    /**
     * @return The key of the service principal used to authenticate against Azure SQL Managed Instance.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param servicePrincipalId The ID of the service principal used to authenticate against Azure SQL Managed Instance. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param servicePrincipalKey The key of the service principal used to authenticate against Azure SQL Managed Instance.
         * 
         * @return builder
         * 
         */
