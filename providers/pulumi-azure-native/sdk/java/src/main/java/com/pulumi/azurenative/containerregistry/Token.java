...
public class Token extends CustomResource {
    /**
     ...
     */
    public Token(String name, TokenArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:containerregistry:Token", name, args == null ? TokenArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Token(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Token get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
