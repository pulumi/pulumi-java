...
@CustomType
public final class GetPrivateEndpointConnectionsForMIPPolicySyncResult {
    /**
    ...
    public static Builder builder(GetPrivateEndpointConnectionsForMIPPolicySyncResult defaults) {
