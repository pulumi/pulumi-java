...
public final class AmazonRdsForOracleTableDatasetResponse {
    ...
    /**
     * @return The table name of the AmazonRdsForOracle database. Type: string (or Expression with resultType string).
     * 
     */
    ...
    private AmazonRdsForOracleTableDatasetResponse(
    ...
    public static Builder builder(AmazonRdsForOracleTableDatasetResponse defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AmazonRdsForOracleTableDatasetResponse defaults) {
