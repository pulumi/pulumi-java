...
public class Watchlist extends CustomResource {
    /**
     ...
     */
    public Watchlist(String name, WatchlistArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Watchlist(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Watchlist get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
