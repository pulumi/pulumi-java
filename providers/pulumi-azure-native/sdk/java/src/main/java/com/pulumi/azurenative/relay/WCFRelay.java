...
public class WCFRelay extends CustomResource {
    /**
     ...
     */
    public WCFRelay(String name, WCFRelayArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:relay:WCFRelay", name, args == null ? WCFRelayArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private WCFRelay(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WCFRelay get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
