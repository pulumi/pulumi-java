...
public class VirtualMachineScaleSetVM extends CustomResource {
    /**
     ...
     */
    public VirtualMachineScaleSetVM(String name, VirtualMachineScaleSetVMArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualMachineScaleSetVM(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualMachineScaleSetVM get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
