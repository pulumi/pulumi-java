...
import com.pulumi.azurenative.machinelearningservices.outputs.BatchEndpointResponse;
...
public class BatchEndpoint extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="properties", type=BatchEndpointResponse.class, parameters={})
     ...
     * 
     */
    public Output<BatchEndpointResponse> properties() {
    ...
    public BatchEndpoint(String name) {
        this(name, BatchEndpointArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public BatchEndpoint(String name, BatchEndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:machinelearningservices:BatchEndpoint", name, args == null ? BatchEndpointArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private BatchEndpoint(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("azure-native:machinelearningservices/v20210301preview:BatchEndpoint").build())
            ))
            .build();
     ...
     */
    public static BatchEndpoint get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
