...
public class BatchEndpoint extends CustomResource {
    /**
     ...
     */
    public BatchEndpoint(String name, BatchEndpointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BatchEndpoint(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BatchEndpoint get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
