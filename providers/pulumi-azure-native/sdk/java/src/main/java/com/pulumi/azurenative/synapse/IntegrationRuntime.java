...
public class IntegrationRuntime extends CustomResource {
    /**
     * Resource Etag.
     * 
     */
     ...
     */
    public IntegrationRuntime(String name, IntegrationRuntimeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IntegrationRuntime(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IntegrationRuntime get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
