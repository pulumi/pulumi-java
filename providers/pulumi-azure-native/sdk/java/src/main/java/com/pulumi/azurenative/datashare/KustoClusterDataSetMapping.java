...
public class KustoClusterDataSetMapping extends CustomResource {
    /**
     ...
     */
    public KustoClusterDataSetMapping(String name, KustoClusterDataSetMappingArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datashare:KustoClusterDataSetMapping", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private KustoClusterDataSetMapping(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static KustoClusterDataSetMapping get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
