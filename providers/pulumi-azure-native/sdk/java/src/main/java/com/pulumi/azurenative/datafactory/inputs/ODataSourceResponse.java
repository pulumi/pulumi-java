 ...
 * 
 */
public final class ODataSourceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private ODataSourceResponse(ODataSourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ODataSourceResponse();
        }

        public Builder(ODataSourceResponse defaults) {
            $ = new ODataSourceResponse(Objects.requireNonNull(defaults));
        }
