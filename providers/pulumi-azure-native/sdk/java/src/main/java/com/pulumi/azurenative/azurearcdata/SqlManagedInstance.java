...
public class SqlManagedInstance extends CustomResource {
    /**
     ...
     */
    public SqlManagedInstance(String name, SqlManagedInstanceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SqlManagedInstance(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SqlManagedInstance get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
