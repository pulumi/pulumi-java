 ...
 * 
 */
public final class PaypalSourceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private PaypalSourceResponse(PaypalSourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PaypalSourceResponse();
        }

        public Builder(PaypalSourceResponse defaults) {
            $ = new PaypalSourceResponse(Objects.requireNonNull(defaults));
        }
