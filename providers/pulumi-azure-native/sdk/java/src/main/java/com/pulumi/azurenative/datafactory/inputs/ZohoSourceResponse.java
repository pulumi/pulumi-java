 ...
 * 
 */
public final class ZohoSourceResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private ZohoSourceResponse(ZohoSourceResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZohoSourceResponse();
        }

        public Builder(ZohoSourceResponse defaults) {
            $ = new ZohoSourceResponse(Objects.requireNonNull(defaults));
        }
