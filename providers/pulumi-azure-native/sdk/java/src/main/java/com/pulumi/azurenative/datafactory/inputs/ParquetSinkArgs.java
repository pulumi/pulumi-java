...
import com.pulumi.azurenative.datafactory.inputs.ParquetWriteSettingsArgs;
 ...
 * 
 */
public final class ParquetSinkArgs extends ResourceArgs {
     ...
     * 
     */
    public Optional<Output<ParquetWriteSettingsArgs>> formatSettings() {
    ...
    private ParquetSinkArgs(ParquetSinkArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(ParquetSinkArgs defaults) {
            $ = new ParquetSinkArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param formatSettings Parquet format settings.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder formatSettings(ParquetWriteSettingsArgs formatSettings) {
