...
public class Console extends CustomResource {
    /**
     ...
     */
    public Console(String name, ConsoleArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:portal:Console", name, args == null ? ConsoleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Console(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Console get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
