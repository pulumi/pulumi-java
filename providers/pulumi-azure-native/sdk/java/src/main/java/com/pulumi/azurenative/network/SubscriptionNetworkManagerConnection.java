...
public class SubscriptionNetworkManagerConnection extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public SubscriptionNetworkManagerConnection(String name, @Nullable SubscriptionNetworkManagerConnectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private SubscriptionNetworkManagerConnection(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SubscriptionNetworkManagerConnection get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
