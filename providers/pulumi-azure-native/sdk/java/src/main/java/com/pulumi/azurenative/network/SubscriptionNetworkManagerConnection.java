...
public class SubscriptionNetworkManagerConnection extends CustomResource {
    /**
     ...
     */
    public SubscriptionNetworkManagerConnection(String name, @Nullable SubscriptionNetworkManagerConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SubscriptionNetworkManagerConnection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SubscriptionNetworkManagerConnection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
