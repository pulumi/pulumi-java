...
public class ConnectionType extends CustomResource {
    /**
     ...
     */
    public ConnectionType(String name, ConnectionTypeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConnectionType(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConnectionType get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
