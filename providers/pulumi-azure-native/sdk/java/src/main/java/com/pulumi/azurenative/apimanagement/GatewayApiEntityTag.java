...
public class GatewayApiEntityTag extends CustomResource {
    /**
     ...
     */
    public GatewayApiEntityTag(String name, GatewayApiEntityTagArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GatewayApiEntityTag(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GatewayApiEntityTag get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
