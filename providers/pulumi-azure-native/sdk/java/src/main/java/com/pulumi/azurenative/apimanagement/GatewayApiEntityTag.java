...
public class GatewayApiEntityTag extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public GatewayApiEntityTag(String name, GatewayApiEntityTagArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private GatewayApiEntityTag(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static GatewayApiEntityTag get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
