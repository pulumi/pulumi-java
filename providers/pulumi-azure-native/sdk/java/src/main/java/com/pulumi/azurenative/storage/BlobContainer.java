...
public class BlobContainer extends CustomResource {
    /**
     ...
     */
    public BlobContainer(String name, BlobContainerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BlobContainer(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BlobContainer get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
