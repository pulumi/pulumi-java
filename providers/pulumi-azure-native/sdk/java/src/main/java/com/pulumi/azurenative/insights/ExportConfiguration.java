...
public class ExportConfiguration extends CustomResource {
    /**
     ...
     */
    public ExportConfiguration(String name, ExportConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ExportConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ExportConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
