...
public class IntegrationAccountAssembly extends CustomResource {
    /**
     ...
     */
    public IntegrationAccountAssembly(String name, IntegrationAccountAssemblyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IntegrationAccountAssembly(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IntegrationAccountAssembly get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
