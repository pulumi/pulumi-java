...
public class WebAppApplicationSettingsSlot extends CustomResource {
    /**
     * Kind of resource.
     * 
     */
     ...
     */
    public WebAppApplicationSettingsSlot(String name, WebAppApplicationSettingsSlotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppApplicationSettingsSlot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppApplicationSettingsSlot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
