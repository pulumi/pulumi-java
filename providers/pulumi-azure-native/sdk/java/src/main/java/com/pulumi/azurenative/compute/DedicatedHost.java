...
public class DedicatedHost extends CustomResource {
    ...
    private DedicatedHost(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DedicatedHost get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
