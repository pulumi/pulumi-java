...
public class HybridIdentityMetadatum extends CustomResource {
    /**
     ...
     */
    public HybridIdentityMetadatum(String name, HybridIdentityMetadatumArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HybridIdentityMetadatum(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HybridIdentityMetadatum get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
