...
public class DatabaseAccount extends CustomResource {
    /**
     ...
     */
    public DatabaseAccount(String name, DatabaseAccountArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DatabaseAccount(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DatabaseAccount get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
