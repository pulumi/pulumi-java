...
public class ServiceFabric extends CustomResource {
    /**
     ...
     */
    public ServiceFabric(String name, ServiceFabricArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceFabric(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceFabric get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
