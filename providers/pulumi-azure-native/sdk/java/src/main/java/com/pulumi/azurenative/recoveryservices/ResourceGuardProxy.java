...
public class ResourceGuardProxy extends CustomResource {
    /**
     * Optional ETag.
     * 
     */
     ...
     */
    public ResourceGuardProxy(String name, ResourceGuardProxyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResourceGuardProxy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResourceGuardProxy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
