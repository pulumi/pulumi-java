...
public class ManagementLockAtResourceGroupLevel extends CustomResource {
    /**
     ...
     */
    public ManagementLockAtResourceGroupLevel(String name, ManagementLockAtResourceGroupLevelArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagementLockAtResourceGroupLevel(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagementLockAtResourceGroupLevel get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
