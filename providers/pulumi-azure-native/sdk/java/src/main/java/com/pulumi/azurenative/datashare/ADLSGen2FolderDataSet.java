...
public class ADLSGen2FolderDataSet extends CustomResource {
    /**
     ...
     */
    public ADLSGen2FolderDataSet(String name, ADLSGen2FolderDataSetArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datashare:ADLSGen2FolderDataSet", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ADLSGen2FolderDataSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ADLSGen2FolderDataSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
