...
public final class MigrateSqlServerSqlMITaskOutputErrorResponse extends com.pulumi.resources.InvokeArgs {
    ...
    private MigrateSqlServerSqlMITaskOutputErrorResponse(MigrateSqlServerSqlMITaskOutputErrorResponse $) {
        this.error = $.error;
        this.id = $.id;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MigrateSqlServerSqlMITaskOutputErrorResponse();
        }

        public Builder(MigrateSqlServerSqlMITaskOutputErrorResponse defaults) {
            $ = new MigrateSqlServerSqlMITaskOutputErrorResponse(Objects.requireNonNull(defaults));
        }
