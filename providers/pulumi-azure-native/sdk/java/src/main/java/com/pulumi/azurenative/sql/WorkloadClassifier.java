...
public class WorkloadClassifier extends CustomResource {
    /**
     ...
     */
    public WorkloadClassifier(String name, WorkloadClassifierArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WorkloadClassifier(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkloadClassifier get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
