...
public class ScheduledTrigger extends CustomResource {
    /**
     ...
     */
    public ScheduledTrigger(String name, ScheduledTriggerArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datashare:ScheduledTrigger", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ScheduledTrigger(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ScheduledTrigger get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
