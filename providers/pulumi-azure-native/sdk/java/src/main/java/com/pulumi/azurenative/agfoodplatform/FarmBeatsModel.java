...
public class FarmBeatsModel extends CustomResource {
    /**
     ...
     */
    public FarmBeatsModel(String name, FarmBeatsModelArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FarmBeatsModel(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FarmBeatsModel get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
