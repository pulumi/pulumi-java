...
public final class GetHybridConnectionAuthorizationRuleArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetHybridConnectionAuthorizationRuleArgs(GetHybridConnectionAuthorizationRuleArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetHybridConnectionAuthorizationRuleArgs();
        }

        public Builder(GetHybridConnectionAuthorizationRuleArgs defaults) {
            $ = new GetHybridConnectionAuthorizationRuleArgs(Objects.requireNonNull(defaults));
        }
