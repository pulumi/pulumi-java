 ...
 * 
 */
public final class AzureBlobFSDatasetResponse extends com.pulumi.resources.InvokeArgs {

    public static final AzureBlobFSDatasetResponse Empty = new AzureBlobFSDatasetResponse();
