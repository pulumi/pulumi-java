...
public class RegistrationAssignment extends CustomResource {
    /**
     ...
     */
    public RegistrationAssignment(String name, RegistrationAssignmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegistrationAssignment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegistrationAssignment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
