...
public class FhirService extends CustomResource {
    /**
     ...
     */
    public FhirService(String name, FhirServiceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FhirService(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FhirService get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
