...
public class WebAppSwiftVirtualNetworkConnectionSlot extends CustomResource {
    /**
     * Kind of resource.
     * 
     */
     ...
     */
    public WebAppSwiftVirtualNetworkConnectionSlot(String name, WebAppSwiftVirtualNetworkConnectionSlotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppSwiftVirtualNetworkConnectionSlot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppSwiftVirtualNetworkConnectionSlot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
