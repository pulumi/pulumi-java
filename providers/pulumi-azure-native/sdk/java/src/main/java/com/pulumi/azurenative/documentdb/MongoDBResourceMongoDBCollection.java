...
public class MongoDBResourceMongoDBCollection extends CustomResource {
    /**
     ...
     */
    public MongoDBResourceMongoDBCollection(String name, MongoDBResourceMongoDBCollectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MongoDBResourceMongoDBCollection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MongoDBResourceMongoDBCollection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
