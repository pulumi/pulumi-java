...
public class ManagementGroupDiagnosticSetting extends CustomResource {
    /**
     ...
     */
    public ManagementGroupDiagnosticSetting(String name, ManagementGroupDiagnosticSettingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagementGroupDiagnosticSetting(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagementGroupDiagnosticSetting get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
