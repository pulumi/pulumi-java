...
public class PolicyAssignment extends CustomResource {
    /**
     ...
     */
    public PolicyAssignment(String name, PolicyAssignmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PolicyAssignment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PolicyAssignment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
