 ...
 * 
 */
public final class DynamicsSourceArgs extends ResourceArgs {
    ...
    /**
     * @return FetchXML is a proprietary query language that is used in Microsoft Dynamics (online &amp; on-premises). Type: string (or Expression with resultType string).
     * 
     */
    ...
    private DynamicsSourceArgs(DynamicsSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DynamicsSourceArgs();
        }

        public Builder(DynamicsSourceArgs defaults) {
            $ = new DynamicsSourceArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param query FetchXML is a proprietary query language that is used in Microsoft Dynamics (online &amp; on-premises). Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
