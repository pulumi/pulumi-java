...
public class BackupSchedule extends CustomResource {
    /**
     ...
     */
    public BackupSchedule(String name, BackupScheduleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BackupSchedule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BackupSchedule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
