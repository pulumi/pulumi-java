...
public final class GetPartnerDestinationResult {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            ...
            return new GetPartnerDestinationResult(activationState, endpointBaseUrl, endpointServiceContext, expirationTimeIfNotActivatedUtc, id, location, messageForActivation, name, partnerRegistrationImmutableId, provisioningState, systemData, tags, type);
        }
    }
}
