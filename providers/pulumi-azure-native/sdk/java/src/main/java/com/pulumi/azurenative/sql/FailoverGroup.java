...
public class FailoverGroup extends CustomResource {
    /**
     ...
     */
    public FailoverGroup(String name, FailoverGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FailoverGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FailoverGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
