...
public class VCenter extends CustomResource {
    /**
     ...
     */
    public VCenter(String name, VCenterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VCenter(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VCenter get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
