...
public class VCenter extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public VCenter(String name, VCenterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private VCenter(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static VCenter get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
