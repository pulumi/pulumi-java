...
public class MongoDBResourceMongoRoleDefinition extends CustomResource {
    /**
     ...
     */
    public MongoDBResourceMongoRoleDefinition(String name, MongoDBResourceMongoRoleDefinitionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MongoDBResourceMongoRoleDefinition(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MongoDBResourceMongoRoleDefinition get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
