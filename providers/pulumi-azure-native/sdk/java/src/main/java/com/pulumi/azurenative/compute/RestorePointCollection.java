...
public class RestorePointCollection extends CustomResource {
    /**
     * Resource location
     * 
     */
     ...
     */
    public RestorePointCollection(String name, RestorePointCollectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RestorePointCollection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RestorePointCollection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
