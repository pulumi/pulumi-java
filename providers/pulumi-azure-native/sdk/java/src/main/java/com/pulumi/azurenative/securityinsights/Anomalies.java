...
public class Anomalies extends CustomResource {
    /**
     ...
     */
    public Anomalies(String name, AnomaliesArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:securityinsights:Anomalies", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private Anomalies(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Anomalies get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
