...
public class ExpressRouteGateway extends CustomResource {
    /**
     ...
     */
    public ExpressRouteGateway(String name, ExpressRouteGatewayArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ExpressRouteGateway(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ExpressRouteGateway get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
