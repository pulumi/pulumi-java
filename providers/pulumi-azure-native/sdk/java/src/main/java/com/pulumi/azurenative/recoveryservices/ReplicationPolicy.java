...
public class ReplicationPolicy extends CustomResource {
    /**
     * Resource Location
     * 
     */
     ...
     */
    public ReplicationPolicy(String name, ReplicationPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReplicationPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReplicationPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
