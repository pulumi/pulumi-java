...
public class FileServiceProperties extends CustomResource {
    /**
     ...
     */
    public FileServiceProperties(String name, FileServicePropertiesArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FileServiceProperties(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FileServiceProperties get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
