...
public class PrivateLinkServicesForM365ComplianceCenter extends CustomResource {
    /**
     ...
     */
    public PrivateLinkServicesForM365ComplianceCenter(String name, PrivateLinkServicesForM365ComplianceCenterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PrivateLinkServicesForM365ComplianceCenter(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrivateLinkServicesForM365ComplianceCenter get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
