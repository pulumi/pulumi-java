...
public class VirtualNetworkTap extends CustomResource {
    /**
     ...
     */
    public VirtualNetworkTap(String name, VirtualNetworkTapArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualNetworkTap(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualNetworkTap get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
