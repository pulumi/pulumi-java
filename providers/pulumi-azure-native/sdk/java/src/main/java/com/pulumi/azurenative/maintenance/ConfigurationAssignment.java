...
public class ConfigurationAssignment extends CustomResource {
    /**
     ...
     */
    public ConfigurationAssignment(String name, ConfigurationAssignmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConfigurationAssignment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConfigurationAssignment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
