 ...
 * 
 */
public final class DynamicsAXResourceDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DynamicsAXResourceDatasetArgs(DynamicsAXResourceDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DynamicsAXResourceDatasetArgs();
        }

        public Builder(DynamicsAXResourceDatasetArgs defaults) {
            $ = new DynamicsAXResourceDatasetArgs(Objects.requireNonNull(defaults));
        }
