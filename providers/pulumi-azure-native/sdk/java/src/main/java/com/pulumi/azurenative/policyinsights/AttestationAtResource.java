...
public class AttestationAtResource extends CustomResource {
    /**
     ...
     */
    public AttestationAtResource(String name, AttestationAtResourceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AttestationAtResource(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AttestationAtResource get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
