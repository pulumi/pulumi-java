 ...
 * 
 */
public final class SparkObjectDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SparkObjectDatasetArgs(SparkObjectDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SparkObjectDatasetArgs();
        }

        public Builder(SparkObjectDatasetArgs defaults) {
            $ = new SparkObjectDatasetArgs(Objects.requireNonNull(defaults));
        }
