...
public class Manager extends CustomResource {
    /**
     ...
     */
    public Manager(String name, ManagerArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:storsimple:Manager", name, args == null ? ManagerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Manager(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Manager get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
