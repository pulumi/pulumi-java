 ...
 * 
 */
public final class SqlServerSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SqlServerSourceArgs(SqlServerSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SqlServerSourceArgs();
        }

        public Builder(SqlServerSourceArgs defaults) {
            $ = new SqlServerSourceArgs(Objects.requireNonNull(defaults));
        }
