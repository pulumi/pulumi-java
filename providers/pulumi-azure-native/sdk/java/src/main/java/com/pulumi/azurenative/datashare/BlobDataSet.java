...
public class BlobDataSet extends CustomResource {
    /**
     ...
     */
    public BlobDataSet(String name, BlobDataSetArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datashare:BlobDataSet", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private BlobDataSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BlobDataSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
