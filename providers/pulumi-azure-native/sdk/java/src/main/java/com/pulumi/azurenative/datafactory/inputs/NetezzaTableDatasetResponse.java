 ...
 * 
 */
public final class NetezzaTableDatasetResponse extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return The table name of the Netezza. Type: string (or Expression with resultType string).
     * 
     */
    ...
    private NetezzaTableDatasetResponse(NetezzaTableDatasetResponse $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetezzaTableDatasetResponse();
        }

        public Builder(NetezzaTableDatasetResponse defaults) {
            $ = new NetezzaTableDatasetResponse(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param table The table name of the Netezza. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
