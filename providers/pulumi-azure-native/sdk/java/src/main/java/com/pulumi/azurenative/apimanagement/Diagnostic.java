...
public class Diagnostic extends CustomResource {
    /**
     ...
     */
    public Diagnostic(String name, DiagnosticArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Diagnostic(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Diagnostic get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
