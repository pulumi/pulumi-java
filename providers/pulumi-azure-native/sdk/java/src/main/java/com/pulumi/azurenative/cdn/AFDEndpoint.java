...
public class AFDEndpoint extends CustomResource {
     ...
     */
    public AFDEndpoint(String name, AFDEndpointArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:cdn:AFDEndpoint", name, args == null ? AFDEndpointArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AFDEndpoint(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AFDEndpoint get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
