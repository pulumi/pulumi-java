...
public class WebApp extends CustomResource {
    ...
    private WebApp(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebApp get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
