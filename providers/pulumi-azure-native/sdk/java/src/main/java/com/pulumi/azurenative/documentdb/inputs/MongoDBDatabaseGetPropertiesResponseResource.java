...
public final class MongoDBDatabaseGetPropertiesResponseResource extends com.pulumi.resources.InvokeArgs {
    ...
    private MongoDBDatabaseGetPropertiesResponseResource(MongoDBDatabaseGetPropertiesResponseResource $) {
        this.etag = $.etag;
        this.id = $.id;
        this.rid = $.rid;
        this.ts = $.ts;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MongoDBDatabaseGetPropertiesResponseResource();
        }

        public Builder(MongoDBDatabaseGetPropertiesResponseResource defaults) {
            $ = new MongoDBDatabaseGetPropertiesResponseResource(Objects.requireNonNull(defaults));
        }
