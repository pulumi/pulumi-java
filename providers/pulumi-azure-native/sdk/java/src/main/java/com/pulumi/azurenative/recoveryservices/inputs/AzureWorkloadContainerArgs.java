...
public final class AzureWorkloadContainerArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzureWorkloadContainerArgs(AzureWorkloadContainerArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureWorkloadContainerArgs();
        }

        public Builder(AzureWorkloadContainerArgs defaults) {
            $ = new AzureWorkloadContainerArgs(Objects.requireNonNull(defaults));
        }
