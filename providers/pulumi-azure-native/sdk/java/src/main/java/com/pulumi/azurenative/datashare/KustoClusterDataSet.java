...
public class KustoClusterDataSet extends CustomResource {
    /**
     ...
     */
    public KustoClusterDataSet(String name, KustoClusterDataSetArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:datashare:KustoClusterDataSet", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private KustoClusterDataSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static KustoClusterDataSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
