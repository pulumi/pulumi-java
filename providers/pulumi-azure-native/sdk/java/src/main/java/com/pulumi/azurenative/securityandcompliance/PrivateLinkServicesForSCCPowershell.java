 ...
 * 
 */
@ResourceType(type="azure-native:securityandcompliance:privateLinkServicesForSCCPowershell")
public class PrivateLinkServicesForSCCPowershell extends com.pulumi.resources.CustomResource {
    ...
    public PrivateLinkServicesForSCCPowershell(String name, PrivateLinkServicesForSCCPowershellArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:securityandcompliance:privateLinkServicesForSCCPowershell", name, args == null ? PrivateLinkServicesForSCCPowershellArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private PrivateLinkServicesForSCCPowershell(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure-native:securityandcompliance:privateLinkServicesForSCCPowershell", name, null, makeResourceOptions(options, id));
    }
