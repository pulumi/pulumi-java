...
public class Invitation extends CustomResource {
    /**
     ...
     */
    public Invitation(String name, InvitationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Invitation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Invitation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
