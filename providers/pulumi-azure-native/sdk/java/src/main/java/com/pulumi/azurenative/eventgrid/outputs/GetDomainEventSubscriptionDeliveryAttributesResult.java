...
public final class GetDomainEventSubscriptionDeliveryAttributesResult {
    ...
    private GetDomainEventSubscriptionDeliveryAttributesResult(@CustomType.Parameter("value") @Nullable List<Either<DynamicDeliveryAttributeMappingResponse,StaticDeliveryAttributeMappingResponse>> value) {
        this.value = value;
    }
    ...
    public static final class Builder {
        ...
        public Builder value(Either<DynamicDeliveryAttributeMappingResponse,StaticDeliveryAttributeMappingResponse>... value) {
            ...
            return new GetDomainEventSubscriptionDeliveryAttributesResult(value);
        }
    }
}
