...
public class AppServiceCertificateOrderCertificate extends CustomResource {
    /**
     ...
     */
    public AppServiceCertificateOrderCertificate(String name, AppServiceCertificateOrderCertificateArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AppServiceCertificateOrderCertificate(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AppServiceCertificateOrderCertificate get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
