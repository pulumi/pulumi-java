...
public class ExtendedServerBlobAuditingPolicy extends CustomResource {
    /**
     ...
     */
    public ExtendedServerBlobAuditingPolicy(String name, ExtendedServerBlobAuditingPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ExtendedServerBlobAuditingPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ExtendedServerBlobAuditingPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
