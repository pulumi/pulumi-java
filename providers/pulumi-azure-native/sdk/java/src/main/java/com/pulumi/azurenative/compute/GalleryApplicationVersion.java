...
public class GalleryApplicationVersion extends CustomResource {
    /**
     * Resource location
     * 
     */
     ...
     */
    public GalleryApplicationVersion(String name, GalleryApplicationVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GalleryApplicationVersion(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GalleryApplicationVersion get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
