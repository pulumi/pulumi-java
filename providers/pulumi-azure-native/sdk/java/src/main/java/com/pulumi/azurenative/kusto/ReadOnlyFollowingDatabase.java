...
public class ReadOnlyFollowingDatabase extends CustomResource {
    /**
     ...
     */
    public ReadOnlyFollowingDatabase(String name, ReadOnlyFollowingDatabaseArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:kusto:ReadOnlyFollowingDatabase", name, makeArgs(args), makeResourceOptions(options, Codegen.empty()));
    }

    private ReadOnlyFollowingDatabase(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReadOnlyFollowingDatabase get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
