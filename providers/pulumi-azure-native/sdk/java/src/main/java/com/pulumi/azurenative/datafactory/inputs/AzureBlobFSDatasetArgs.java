 ...
 * 
 */
public final class AzureBlobFSDatasetArgs extends ResourceArgs {
    ...
    private AzureBlobFSDatasetArgs(AzureBlobFSDatasetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureBlobFSDatasetArgs();
        }

        public Builder(AzureBlobFSDatasetArgs defaults) {
            $ = new AzureBlobFSDatasetArgs(Objects.requireNonNull(defaults));
        }
