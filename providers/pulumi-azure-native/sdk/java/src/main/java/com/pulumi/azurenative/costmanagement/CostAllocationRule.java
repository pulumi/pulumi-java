...
public class CostAllocationRule extends CustomResource {
    /**
     ...
     */
    public CostAllocationRule(String name, CostAllocationRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CostAllocationRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CostAllocationRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
