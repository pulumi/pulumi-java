...
public class ApiDiagnosticLogger extends CustomResource {
    /**
     ...
     */
    public ApiDiagnosticLogger(String name, ApiDiagnosticLoggerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApiDiagnosticLogger(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApiDiagnosticLogger get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
