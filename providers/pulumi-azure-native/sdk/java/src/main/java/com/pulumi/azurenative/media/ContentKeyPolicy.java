...
public class ContentKeyPolicy extends CustomResource {
    /**
     ...
     */
    public ContentKeyPolicy(String name, ContentKeyPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ContentKeyPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ContentKeyPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
