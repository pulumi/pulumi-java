 ...
 * 
 */
public final class MarketoLinkedServiceArgs extends ResourceArgs {
    ...
    private MarketoLinkedServiceArgs(MarketoLinkedServiceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MarketoLinkedServiceArgs();
        }

        public Builder(MarketoLinkedServiceArgs defaults) {
            $ = new MarketoLinkedServiceArgs(Objects.requireNonNull(defaults));
        }
