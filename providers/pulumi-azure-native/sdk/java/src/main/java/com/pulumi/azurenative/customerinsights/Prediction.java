...
public class Prediction extends CustomResource {
    /**
     ...
     */
    public Prediction(String name, PredictionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Prediction(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Prediction get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
