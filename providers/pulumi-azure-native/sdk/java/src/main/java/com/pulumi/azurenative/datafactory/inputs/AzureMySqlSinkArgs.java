 ...
 * 
 */
public final class AzureMySqlSinkArgs extends ResourceArgs {
    ...
    private AzureMySqlSinkArgs(AzureMySqlSinkArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureMySqlSinkArgs();
        }

        public Builder(AzureMySqlSinkArgs defaults) {
            $ = new AzureMySqlSinkArgs(Objects.requireNonNull(defaults));
        }
