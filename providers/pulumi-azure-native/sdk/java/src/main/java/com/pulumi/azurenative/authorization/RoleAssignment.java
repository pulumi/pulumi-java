...
public class RoleAssignment extends CustomResource {
    /**
     ...
     */
    public RoleAssignment(String name, RoleAssignmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RoleAssignment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RoleAssignment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
