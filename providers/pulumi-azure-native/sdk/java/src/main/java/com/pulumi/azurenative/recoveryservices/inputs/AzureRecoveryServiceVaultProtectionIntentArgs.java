 ...
 * 
 */
public final class AzureRecoveryServiceVaultProtectionIntentArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzureRecoveryServiceVaultProtectionIntentArgs(AzureRecoveryServiceVaultProtectionIntentArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureRecoveryServiceVaultProtectionIntentArgs();
        }

        public Builder(AzureRecoveryServiceVaultProtectionIntentArgs defaults) {
            $ = new AzureRecoveryServiceVaultProtectionIntentArgs(Objects.requireNonNull(defaults));
        }
