...
public final class ListVirtualMachineApplicableSchedulesArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private ListVirtualMachineApplicableSchedulesArgs(ListVirtualMachineApplicableSchedulesArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListVirtualMachineApplicableSchedulesArgs();
        }

        public Builder(ListVirtualMachineApplicableSchedulesArgs defaults) {
            $ = new ListVirtualMachineApplicableSchedulesArgs(Objects.requireNonNull(defaults));
        }
