...
public class KustoPoolAttachedDatabaseConfiguration extends CustomResource {
    /**
     ...
     */
    public KustoPoolAttachedDatabaseConfiguration(String name, KustoPoolAttachedDatabaseConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private KustoPoolAttachedDatabaseConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static KustoPoolAttachedDatabaseConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
