...
public class TransparentDataEncryption extends CustomResource {
    /**
     * Resource location.
     * 
     */
     ...
     */
    public TransparentDataEncryption(String name, TransparentDataEncryptionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TransparentDataEncryption(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TransparentDataEncryption get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
