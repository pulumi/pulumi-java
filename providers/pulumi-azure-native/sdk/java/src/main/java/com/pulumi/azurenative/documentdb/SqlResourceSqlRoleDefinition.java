...
public class SqlResourceSqlRoleDefinition extends CustomResource {
    /**
     ...
     */
    public SqlResourceSqlRoleDefinition(String name, SqlResourceSqlRoleDefinitionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SqlResourceSqlRoleDefinition(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SqlResourceSqlRoleDefinition get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
