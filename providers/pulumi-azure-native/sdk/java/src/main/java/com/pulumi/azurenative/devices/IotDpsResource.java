...
public class IotDpsResource extends CustomResource {
    /**
     ...
     */
    public IotDpsResource(String name, IotDpsResourceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IotDpsResource(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IotDpsResource get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
