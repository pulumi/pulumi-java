...
public class IPv6FirewallRule extends CustomResource {
    /**
     ...
     */
    public IPv6FirewallRule(String name, IPv6FirewallRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IPv6FirewallRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IPv6FirewallRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
