...
public class LocalUser extends CustomResource {
    /**
     ...
     */
    public LocalUser(String name, LocalUserArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:storage:LocalUser", name, args == null ? LocalUserArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private LocalUser(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LocalUser get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
