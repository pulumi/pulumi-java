...
public class ManagerExtendedInfo extends CustomResource {
    /**
     ...
     */
    public ManagerExtendedInfo(String name, ManagerExtendedInfoArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ManagerExtendedInfo(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ManagerExtendedInfo get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
