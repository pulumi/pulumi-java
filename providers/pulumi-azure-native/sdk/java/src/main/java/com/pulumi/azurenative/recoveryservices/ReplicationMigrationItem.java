...
public class ReplicationMigrationItem extends CustomResource {
    /**
     * Resource Location
     * 
     */
     ...
     */
    public ReplicationMigrationItem(String name, ReplicationMigrationItemArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReplicationMigrationItem(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReplicationMigrationItem get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
