...
public class Redis extends CustomResource {
    /**
     ...
     */
    public Redis(String name, RedisArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:cache:Redis", name, args == null ? RedisArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Redis(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Redis get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
