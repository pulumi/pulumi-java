...
public final class JsonSinkArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<JsonWriteSettingsArgs>> formatSettings() {
    ...
    private JsonSinkArgs(JsonSinkArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(JsonSinkArgs defaults) {
            $ = new JsonSinkArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder formatSettings(JsonWriteSettingsArgs formatSettings) {
