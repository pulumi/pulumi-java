...
public class AppServiceCertificateOrder extends CustomResource {
    /**
     ...
     */
    public AppServiceCertificateOrder(String name, AppServiceCertificateOrderArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AppServiceCertificateOrder(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AppServiceCertificateOrder get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
