...
public class WebAppAuthSettingsV2Slot extends CustomResource {
    /**
     ...
     */
    public WebAppAuthSettingsV2Slot(String name, WebAppAuthSettingsV2SlotArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebAppAuthSettingsV2Slot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebAppAuthSettingsV2Slot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
