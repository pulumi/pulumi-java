...
public class UserRule extends CustomResource {
    /**
     ...
     */
    public UserRule(String name, UserRuleArgs args, @Nullable CustomResourceOptions options) {
        super("azure-native:network:UserRule", name, args == null ? UserRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private UserRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UserRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
