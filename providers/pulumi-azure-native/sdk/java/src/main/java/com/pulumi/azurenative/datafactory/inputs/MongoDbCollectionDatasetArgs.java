 ...
 * 
 */
public final class MongoDbCollectionDatasetArgs extends ResourceArgs {

    public static final MongoDbCollectionDatasetArgs Empty = new MongoDbCollectionDatasetArgs();
    ...
    /**
     * @return The table name of the MongoDB database. Type: string (or Expression with resultType string).
     * 
     */
    ...
    private MongoDbCollectionDatasetArgs() {}

    private MongoDbCollectionDatasetArgs(MongoDbCollectionDatasetArgs $) {
    ...
    public static Builder builder(MongoDbCollectionDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MongoDbCollectionDatasetArgs();
        }

        public Builder(MongoDbCollectionDatasetArgs defaults) {
            $ = new MongoDbCollectionDatasetArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param collectionName The table name of the MongoDB database. Type: string (or Expression with resultType string).
         * 
         * @return builder
         * 
         */
        ...
        public MongoDbCollectionDatasetArgs build() {
