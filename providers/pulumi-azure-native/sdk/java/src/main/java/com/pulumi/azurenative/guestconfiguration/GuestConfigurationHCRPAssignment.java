...
public class GuestConfigurationHCRPAssignment extends CustomResource {
    /**
     ...
     */
    public GuestConfigurationHCRPAssignment(String name, GuestConfigurationHCRPAssignmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GuestConfigurationHCRPAssignment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GuestConfigurationHCRPAssignment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
