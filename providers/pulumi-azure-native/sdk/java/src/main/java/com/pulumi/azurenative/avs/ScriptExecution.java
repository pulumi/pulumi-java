...
public class ScriptExecution extends CustomResource {
    /**
     ...
     */
    public ScriptExecution(String name, ScriptExecutionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ScriptExecution(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ScriptExecution get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
