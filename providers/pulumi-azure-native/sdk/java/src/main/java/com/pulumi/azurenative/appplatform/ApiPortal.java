...
public class ApiPortal extends CustomResource {
    /**
     ...
     */
    public ApiPortal(String name, ApiPortalArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApiPortal(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApiPortal get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
