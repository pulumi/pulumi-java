...
public class ApiPortal extends com.pulumi.resources.CustomResource {
     ...
     */
    public ApiPortal(String name, ApiPortalArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private ApiPortal(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ApiPortal get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
