...
public final class InstanceGroupManagerVersionGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setTargetSize(@Nullable Input<InstanceGroupManagerVersionTargetSizeGetArgs> targetSize) {
            this.targetSize = targetSize;
            return this;
        }

        public Builder setTargetSize(@Nullable InstanceGroupManagerVersionTargetSizeGetArgs targetSize) {
