...
public final class URLMapPathMatcherDefaultRouteActionCorsPolicyGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final URLMapPathMatcherDefaultRouteActionCorsPolicyGetArgs Empty = new URLMapPathMatcherDefaultRouteActionCorsPolicyGetArgs();
    ...
    public URLMapPathMatcherDefaultRouteActionCorsPolicyGetArgs(
    ...
    private URLMapPathMatcherDefaultRouteActionCorsPolicyGetArgs() {
    ...
    public static Builder builder(URLMapPathMatcherDefaultRouteActionCorsPolicyGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(URLMapPathMatcherDefaultRouteActionCorsPolicyGetArgs defaults) {
        ...
        public URLMapPathMatcherDefaultRouteActionCorsPolicyGetArgs build() {
            return new URLMapPathMatcherDefaultRouteActionCorsPolicyGetArgs(allowCredentials, allowHeaders, allowMethods, allowOriginRegexes, allowOrigins, disabled, exposeHeaders, maxAge);
        }
    }
}
