...
public class WebTypeComputeIamBinding extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(WebTypeComputeIamBindingArgs.Builder a);
    }
    private static io.pulumi.gcp.iap.WebTypeComputeIamBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.iap.WebTypeComputeIamBindingArgs.builder();
     ...
     */
    public WebTypeComputeIamBinding(String name, BuilderApplicator argsBuilder) {
    ...
    public WebTypeComputeIamBinding(String name, WebTypeComputeIamBindingArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webTypeComputeIamBinding:WebTypeComputeIamBinding", name, args == null ? WebTypeComputeIamBindingArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private WebTypeComputeIamBinding(String name, Output<String> id, @Nullable WebTypeComputeIamBindingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static WebTypeComputeIamBinding get(String name, Output<String> id, @Nullable WebTypeComputeIamBindingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
