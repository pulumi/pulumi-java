...
public final class URLMapPathMatcherDefaultRouteActionRetryPolicyGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="perTryTimeout")
      private final @Nullable Input<URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeoutGetArgs> perTryTimeout;

    public Input<URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeoutGetArgs> getPerTryTimeout() {
    ...
    public URLMapPathMatcherDefaultRouteActionRetryPolicyGetArgs(
        ...
        @Nullable Input<URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeoutGetArgs> perTryTimeout,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeoutGetArgs> perTryTimeout;
        ...
        public Builder setPerTryTimeout(@Nullable Input<URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeoutGetArgs> perTryTimeout) {
            this.perTryTimeout = perTryTimeout;
            return this;
        }

        public Builder setPerTryTimeout(@Nullable URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeoutGetArgs perTryTimeout) {
