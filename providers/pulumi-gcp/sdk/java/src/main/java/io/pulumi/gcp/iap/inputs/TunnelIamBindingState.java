...
public final class TunnelIamBindingState extends io.pulumi.resources.ResourceArgs {
    ...
    public TunnelIamBindingState(
        @Nullable Input<TunnelIamBindingConditionGetArgs> condition,
    ...
    public static final class Builder {
        private @Nullable Input<TunnelIamBindingConditionGetArgs> condition;
        ...
        public Builder setCondition(@Nullable Input<TunnelIamBindingConditionGetArgs> condition) {
            this.condition = condition;
            return this;
        }

        public Builder setCondition(@Nullable TunnelIamBindingConditionGetArgs condition) {
