...
public class RegionHealthCheck extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable RegionHealthCheckArgs.Builder a);
    }
    private static io.pulumi.gcp.compute.RegionHealthCheckArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.RegionHealthCheckArgs.builder();
