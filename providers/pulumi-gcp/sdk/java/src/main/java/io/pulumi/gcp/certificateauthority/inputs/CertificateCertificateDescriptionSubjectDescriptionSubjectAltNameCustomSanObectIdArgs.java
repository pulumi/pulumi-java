...
public final class CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameCustomSanObectIdArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameCustomSanObectIdArgs(@Nullable Input<List<Integer>> objectIdPaths) {
