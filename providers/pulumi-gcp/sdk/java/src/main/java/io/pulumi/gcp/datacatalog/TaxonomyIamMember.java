...
public class TaxonomyIamMember extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(TaxonomyIamMemberArgs.Builder a);
    }
    private static io.pulumi.gcp.datacatalog.TaxonomyIamMemberArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.datacatalog.TaxonomyIamMemberArgs.builder();
     ...
     */
    public TaxonomyIamMember(String name, BuilderApplicator argsBuilder) {
    ...
    public TaxonomyIamMember(String name) {
        this(name, TaxonomyIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public TaxonomyIamMember(String name, TaxonomyIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
