...
public class TagKeyIamPolicy extends io.pulumi.resources.CustomResource {
     ...
     */
    public static TagKeyIamPolicy get(String name, Output<String> id, @Nullable TagKeyIamPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
