...
public class Function extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.cloudfunctions.FunctionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.cloudfunctions.FunctionArgs.builder();
