...
public class WebApp extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(WebAppArgs.Builder a);
    }
    private static io.pulumi.gcp.firebase.WebAppArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.firebase.WebAppArgs.builder();
     ...
     */
    public static WebApp get(String name, Output<String> id, @Nullable WebAppState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
