...
public final class BackendServiceState extends io.pulumi.resources.ResourceArgs {
    ...
    public BackendServiceState(
        ...
        @Nullable Input<List<BackendServiceBackendGetArgs>> backends,
        @Nullable Input<BackendServiceCdnPolicyGetArgs> cdnPolicy,
        @Nullable Input<BackendServiceCircuitBreakersGetArgs> circuitBreakers,
        @Nullable Input<Integer> connectionDrainingTimeoutSec,
        @Nullable Input<BackendServiceConsistentHashGetArgs> consistentHash,
        ...
        @Nullable Input<BackendServiceIapGetArgs> iap,
        @Nullable Input<String> loadBalancingScheme,
        @Nullable Input<String> localityLbPolicy,
        @Nullable Input<BackendServiceLogConfigGetArgs> logConfig,
        @Nullable Input<String> name,
        @Nullable Input<BackendServiceOutlierDetectionGetArgs> outlierDetection,
        @Nullable Input<String> portName,
        @Nullable Input<String> project,
        @Nullable Input<String> protocol,
        @Nullable Input<String> securityPolicy,
        @Nullable Input<BackendServiceSecuritySettingsGetArgs> securitySettings,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<BackendServiceBackendGetArgs>> backends;
        private @Nullable Input<BackendServiceCdnPolicyGetArgs> cdnPolicy;
        private @Nullable Input<BackendServiceCircuitBreakersGetArgs> circuitBreakers;
        private @Nullable Input<Integer> connectionDrainingTimeoutSec;
        private @Nullable Input<BackendServiceConsistentHashGetArgs> consistentHash;
        ...
        private @Nullable Input<BackendServiceIapGetArgs> iap;
        private @Nullable Input<String> loadBalancingScheme;
        private @Nullable Input<String> localityLbPolicy;
        private @Nullable Input<BackendServiceLogConfigGetArgs> logConfig;
        private @Nullable Input<String> name;
        private @Nullable Input<BackendServiceOutlierDetectionGetArgs> outlierDetection;
        ...
        private @Nullable Input<BackendServiceSecuritySettingsGetArgs> securitySettings;
        ...
        public Builder setBackends(@Nullable Input<List<BackendServiceBackendGetArgs>> backends) {
            this.backends = backends;
            return this;
        }

        public Builder setBackends(@Nullable List<BackendServiceBackendGetArgs> backends) {
            this.backends = Input.ofNullable(backends);
            return this;
        }

        public Builder setCdnPolicy(@Nullable Input<BackendServiceCdnPolicyGetArgs> cdnPolicy) {
            this.cdnPolicy = cdnPolicy;
            return this;
        }

        public Builder setCdnPolicy(@Nullable BackendServiceCdnPolicyGetArgs cdnPolicy) {
            this.cdnPolicy = Input.ofNullable(cdnPolicy);
            return this;
        }

        public Builder setCircuitBreakers(@Nullable Input<BackendServiceCircuitBreakersGetArgs> circuitBreakers) {
            this.circuitBreakers = circuitBreakers;
            return this;
        }

        public Builder setCircuitBreakers(@Nullable BackendServiceCircuitBreakersGetArgs circuitBreakers) {
        ...
        public Builder setConsistentHash(@Nullable Input<BackendServiceConsistentHashGetArgs> consistentHash) {
            this.consistentHash = consistentHash;
            return this;
        }

        public Builder setConsistentHash(@Nullable BackendServiceConsistentHashGetArgs consistentHash) {
        ...
        public Builder setIap(@Nullable Input<BackendServiceIapGetArgs> iap) {
            this.iap = iap;
            return this;
        }

        public Builder setIap(@Nullable BackendServiceIapGetArgs iap) {
        ...
        public Builder setLogConfig(@Nullable Input<BackendServiceLogConfigGetArgs> logConfig) {
            this.logConfig = logConfig;
            return this;
        }

        public Builder setLogConfig(@Nullable BackendServiceLogConfigGetArgs logConfig) {
        ...
        public Builder setOutlierDetection(@Nullable Input<BackendServiceOutlierDetectionGetArgs> outlierDetection) {
            this.outlierDetection = outlierDetection;
            return this;
        }

        public Builder setOutlierDetection(@Nullable BackendServiceOutlierDetectionGetArgs outlierDetection) {
        ...
        public Builder setSecuritySettings(@Nullable Input<BackendServiceSecuritySettingsGetArgs> securitySettings) {
            this.securitySettings = securitySettings;
            return this;
        }

        public Builder setSecuritySettings(@Nullable BackendServiceSecuritySettingsGetArgs securitySettings) {
