...
public class PacketMirroring extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.PacketMirroringArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.PacketMirroringArgs.builder();
