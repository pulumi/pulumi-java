...
public class EdgeCacheService extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(EdgeCacheServiceArgs.Builder a);
    }
    private static io.pulumi.gcp.networkservices.EdgeCacheServiceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.networkservices.EdgeCacheServiceArgs.builder();
     ...
     */
    public EdgeCacheService(String name, BuilderApplicator argsBuilder) {
