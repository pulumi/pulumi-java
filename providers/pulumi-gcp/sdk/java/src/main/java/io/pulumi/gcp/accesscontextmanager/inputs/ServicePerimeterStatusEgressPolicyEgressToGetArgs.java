...
public final class ServicePerimeterStatusEgressPolicyEgressToGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="operations")
      private final @Nullable Output<List<ServicePerimeterStatusEgressPolicyEgressToOperationGetArgs>> operations;

    public Output<List<ServicePerimeterStatusEgressPolicyEgressToOperationGetArgs>> getOperations() {
    ...
    public ServicePerimeterStatusEgressPolicyEgressToGetArgs(
        @Nullable Output<List<ServicePerimeterStatusEgressPolicyEgressToOperationGetArgs>> operations,
