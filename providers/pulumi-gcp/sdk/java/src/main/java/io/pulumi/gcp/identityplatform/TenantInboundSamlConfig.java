...
public class TenantInboundSamlConfig extends io.pulumi.resources.CustomResource {
    ...
    public TenantInboundSamlConfig(String name) {
        super("gcp:identityplatform/tenantInboundSamlConfig:TenantInboundSamlConfig", name, TenantInboundSamlConfigArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
