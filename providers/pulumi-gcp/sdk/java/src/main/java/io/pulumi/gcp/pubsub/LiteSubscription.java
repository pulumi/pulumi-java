...
public class LiteSubscription extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(LiteSubscriptionArgs.Builder a);
    }
    private static io.pulumi.gcp.pubsub.LiteSubscriptionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.pubsub.LiteSubscriptionArgs.builder();
     ...
     */
    public LiteSubscription(String name, BuilderApplicator argsBuilder) {
