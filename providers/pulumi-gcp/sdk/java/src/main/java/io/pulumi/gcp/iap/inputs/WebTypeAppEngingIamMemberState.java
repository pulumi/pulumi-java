...
public final class WebTypeAppEngingIamMemberState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCondition(@Nullable Input<WebTypeAppEngingIamMemberConditionGetArgs> condition) {
            this.condition = condition;
            return this;
        }

        public Builder setCondition(@Nullable WebTypeAppEngingIamMemberConditionGetArgs condition) {
