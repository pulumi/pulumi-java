...
public final class JobIAMBindingState extends io.pulumi.resources.ResourceArgs {
    ...
    public JobIAMBindingState(
        @Nullable Input<JobIAMBindingConditionGetArgs> condition,
    ...
    public static final class Builder {
        private @Nullable Input<JobIAMBindingConditionGetArgs> condition;
        ...
        public Builder setCondition(@Nullable Input<JobIAMBindingConditionGetArgs> condition) {
            this.condition = condition;
            return this;
        }

        public Builder setCondition(@Nullable JobIAMBindingConditionGetArgs condition) {
