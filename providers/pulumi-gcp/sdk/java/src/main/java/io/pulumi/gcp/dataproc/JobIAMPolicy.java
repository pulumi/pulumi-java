...
public class JobIAMPolicy extends io.pulumi.resources.CustomResource {
     ...
     */
    public static JobIAMPolicy get(String name, Output<String> id, @Nullable JobIAMPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
