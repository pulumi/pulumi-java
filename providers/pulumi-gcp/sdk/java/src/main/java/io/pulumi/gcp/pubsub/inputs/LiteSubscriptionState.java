...
public final class LiteSubscriptionState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setDeliveryConfig(@Nullable Input<LiteSubscriptionDeliveryConfigGetArgs> deliveryConfig) {
            this.deliveryConfig = deliveryConfig;
            return this;
        }

        public Builder setDeliveryConfig(@Nullable LiteSubscriptionDeliveryConfigGetArgs deliveryConfig) {
