...
public final class TenantInboundSamlConfigIdpConfigIdpCertificateArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public TenantInboundSamlConfigIdpConfigIdpCertificateArgs(@Nullable Input<String> x509Certificate) {
