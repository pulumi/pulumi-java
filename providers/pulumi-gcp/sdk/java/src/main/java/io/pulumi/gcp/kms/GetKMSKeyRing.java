...
public class GetKMSKeyRing {
    ...
    public interface BuilderApplicator {
        public void apply(GetKMSKeyRingArgs.Builder a);
    }
    private static GetKMSKeyRingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = GetKMSKeyRingArgs.builder();
 ...
 * 
     */
    public static CompletableFuture<GetKMSKeyRingResult> invokeAsync(BuilderApplicator argsBuilder, @Nullable InvokeOptions options) {
