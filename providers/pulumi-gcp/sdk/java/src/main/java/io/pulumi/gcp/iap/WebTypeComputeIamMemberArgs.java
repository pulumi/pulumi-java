...
import io.pulumi.gcp.iap.inputs.WebTypeComputeIamMemberConditionArgs;
import java.lang.String;
import java.util.Objects;
import javax.annotation.Nullable;


public final class WebTypeComputeIamMemberArgs extends io.pulumi.resources.ResourceArgs {

    public static final WebTypeComputeIamMemberArgs Empty = new WebTypeComputeIamMemberArgs();
    ...
    public WebTypeComputeIamMemberArgs(
        @Nullable Input<WebTypeComputeIamMemberConditionArgs> condition,
        Input<String> member,
    ...
    public static final class Builder {
        private @Nullable Input<WebTypeComputeIamMemberConditionArgs> condition;
        ...
        public Builder setCondition(@Nullable Input<WebTypeComputeIamMemberConditionArgs> condition) {
            this.condition = condition;
            return this;
        }

        public Builder setCondition(@Nullable WebTypeComputeIamMemberConditionArgs condition) {
