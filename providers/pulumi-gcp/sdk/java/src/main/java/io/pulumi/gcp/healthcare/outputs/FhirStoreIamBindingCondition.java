...
@CustomType
public final class FhirStoreIamBindingCondition {
    ...
    public static Builder builder(FhirStoreIamBindingCondition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FhirStoreIamBindingCondition defaults) {
