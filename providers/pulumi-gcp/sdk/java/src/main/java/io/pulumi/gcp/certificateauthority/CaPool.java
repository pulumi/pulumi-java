...
public class CaPool extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.certificateauthority.CaPoolArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.certificateauthority.CaPoolArgs.builder();
