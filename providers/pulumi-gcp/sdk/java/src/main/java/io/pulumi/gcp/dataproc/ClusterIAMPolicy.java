...
public class ClusterIAMPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ClusterIAMPolicyArgs.Builder a);
    }
    private static io.pulumi.gcp.dataproc.ClusterIAMPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.dataproc.ClusterIAMPolicyArgs.builder();
     ...
     */
    public ClusterIAMPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public ClusterIAMPolicy(String name, ClusterIAMPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/clusterIAMPolicy:ClusterIAMPolicy", name, args == null ? ClusterIAMPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ClusterIAMPolicy(String name, Output<String> id, @Nullable ClusterIAMPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ClusterIAMPolicy get(String name, Output<String> id, @Nullable ClusterIAMPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
