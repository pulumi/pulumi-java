...
public final class BackendServiceConsistentHashGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="httpCookie")
      private final @Nullable Input<BackendServiceConsistentHashHttpCookieGetArgs> httpCookie;

    public Input<BackendServiceConsistentHashHttpCookieGetArgs> getHttpCookie() {
    ...
    public BackendServiceConsistentHashGetArgs(
        @Nullable Input<BackendServiceConsistentHashHttpCookieGetArgs> httpCookie,
    ...
    public static final class Builder {
        private @Nullable Input<BackendServiceConsistentHashHttpCookieGetArgs> httpCookie;
        ...
        public Builder setHttpCookie(@Nullable Input<BackendServiceConsistentHashHttpCookieGetArgs> httpCookie) {
            this.httpCookie = httpCookie;
            return this;
        }

        public Builder setHttpCookie(@Nullable BackendServiceConsistentHashHttpCookieGetArgs httpCookie) {
