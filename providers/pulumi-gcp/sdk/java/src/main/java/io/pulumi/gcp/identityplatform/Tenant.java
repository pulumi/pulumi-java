...
public class Tenant extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.identityplatform.TenantArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.identityplatform.TenantArgs.builder();
    ...
    public Tenant(String name, TenantArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:identityplatform/tenant:Tenant", name, args == null ? TenantArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private Tenant(String name, Output<String> id, @Nullable TenantState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Tenant get(String name, Output<String> id, @Nullable TenantState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
