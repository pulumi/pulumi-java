...
@OutputCustomType
public final class DicomStoreIamMemberCondition {
    ...
    public static Builder builder(DicomStoreIamMemberCondition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DicomStoreIamMemberCondition defaults) {
