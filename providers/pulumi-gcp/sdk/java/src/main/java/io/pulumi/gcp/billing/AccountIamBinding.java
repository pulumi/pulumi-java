...
public class AccountIamBinding extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(AccountIamBindingArgs.Builder a);
    }
    private static io.pulumi.gcp.billing.AccountIamBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.billing.AccountIamBindingArgs.builder();
     ...
     */
    public AccountIamBinding(String name, BuilderApplicator argsBuilder) {
