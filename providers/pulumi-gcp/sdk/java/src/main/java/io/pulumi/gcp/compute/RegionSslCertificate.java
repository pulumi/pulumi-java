...
public class RegionSslCertificate extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.RegionSslCertificateArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.RegionSslCertificateArgs.builder();
