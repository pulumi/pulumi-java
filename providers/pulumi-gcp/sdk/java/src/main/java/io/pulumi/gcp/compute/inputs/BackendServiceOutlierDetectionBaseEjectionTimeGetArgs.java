...
public final class BackendServiceOutlierDetectionBaseEjectionTimeGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final BackendServiceOutlierDetectionBaseEjectionTimeGetArgs Empty = new BackendServiceOutlierDetectionBaseEjectionTimeGetArgs();
    ...
    private BackendServiceOutlierDetectionBaseEjectionTimeGetArgs() {
    ...
    public static Builder builder(BackendServiceOutlierDetectionBaseEjectionTimeGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(BackendServiceOutlierDetectionBaseEjectionTimeGetArgs defaults) {
        ...
        public BackendServiceOutlierDetectionBaseEjectionTimeGetArgs build() {
            return new BackendServiceOutlierDetectionBaseEjectionTimeGetArgs(nanos, seconds);
        }
    }
}
