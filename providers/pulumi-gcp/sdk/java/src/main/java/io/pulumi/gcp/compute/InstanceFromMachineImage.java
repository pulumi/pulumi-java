...
public class InstanceFromMachineImage extends io.pulumi.resources.CustomResource {
     ...
     */
    public static InstanceFromMachineImage get(String name, Output<String> id, @Nullable InstanceFromMachineImageState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
