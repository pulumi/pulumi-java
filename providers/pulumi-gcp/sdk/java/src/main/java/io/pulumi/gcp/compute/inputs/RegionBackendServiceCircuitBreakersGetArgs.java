...
public final class RegionBackendServiceCircuitBreakersGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setConnectTimeout(@Nullable Input<RegionBackendServiceCircuitBreakersConnectTimeoutGetArgs> connectTimeout) {
            this.connectTimeout = connectTimeout;
            return this;
        }

        public Builder setConnectTimeout(@Nullable RegionBackendServiceCircuitBreakersConnectTimeoutGetArgs connectTimeout) {
