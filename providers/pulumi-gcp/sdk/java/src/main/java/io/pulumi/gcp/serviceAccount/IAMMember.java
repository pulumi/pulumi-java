...
import io.pulumi.gcp.serviceAccount.outputs.IAMMemberCondition;
...
public class IAMMember extends io.pulumi.resources.CustomResource {
    ...
    public IAMMember(String name) {
        super("gcp:serviceAccount/iAMMember:IAMMember", name, IAMMemberArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public IAMMember(String name, IAMMemberArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:serviceAccount/iAMMember:IAMMember", name, args == null ? IAMMemberArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
