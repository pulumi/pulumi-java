...
public class DatasetAccess extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(DatasetAccessArgs.Builder a);
    }
    private static io.pulumi.gcp.bigquery.DatasetAccessArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.bigquery.DatasetAccessArgs.builder();
     ...
     */
    public DatasetAccess(String name, BuilderApplicator argsBuilder) {
    ...
    public DatasetAccess(String name, DatasetAccessArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigquery/datasetAccess:DatasetAccess", name, args == null ? DatasetAccessArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private DatasetAccess(String name, Output<String> id, @Nullable DatasetAccessState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static DatasetAccess get(String name, Output<String> id, @Nullable DatasetAccessState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
