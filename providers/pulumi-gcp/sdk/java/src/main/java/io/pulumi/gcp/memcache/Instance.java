...
public class Instance extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.memcache.InstanceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.memcache.InstanceArgs.builder();
