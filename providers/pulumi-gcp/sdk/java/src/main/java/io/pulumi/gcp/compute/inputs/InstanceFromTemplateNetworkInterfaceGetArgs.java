...
public final class InstanceFromTemplateNetworkInterfaceGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public InstanceFromTemplateNetworkInterfaceGetArgs(
        @Nullable Input<List<InstanceFromTemplateNetworkInterfaceAccessConfigGetArgs>> accessConfigs,
        @Nullable Input<List<InstanceFromTemplateNetworkInterfaceAliasIpRangeGetArgs>> aliasIpRanges,
        @Nullable Input<List<InstanceFromTemplateNetworkInterfaceIpv6AccessConfigGetArgs>> ipv6AccessConfigs,
    ...
    public static final class Builder {
        private @Nullable Input<List<InstanceFromTemplateNetworkInterfaceAccessConfigGetArgs>> accessConfigs;
        private @Nullable Input<List<InstanceFromTemplateNetworkInterfaceAliasIpRangeGetArgs>> aliasIpRanges;
        private @Nullable Input<List<InstanceFromTemplateNetworkInterfaceIpv6AccessConfigGetArgs>> ipv6AccessConfigs;
        ...
        public Builder setAccessConfigs(@Nullable Input<List<InstanceFromTemplateNetworkInterfaceAccessConfigGetArgs>> accessConfigs) {
            this.accessConfigs = accessConfigs;
            return this;
        }

        public Builder setAccessConfigs(@Nullable List<InstanceFromTemplateNetworkInterfaceAccessConfigGetArgs> accessConfigs) {
            this.accessConfigs = Input.ofNullable(accessConfigs);
            return this;
        }

        public Builder setAliasIpRanges(@Nullable Input<List<InstanceFromTemplateNetworkInterfaceAliasIpRangeGetArgs>> aliasIpRanges) {
            this.aliasIpRanges = aliasIpRanges;
            return this;
        }

        public Builder setAliasIpRanges(@Nullable List<InstanceFromTemplateNetworkInterfaceAliasIpRangeGetArgs> aliasIpRanges) {
            this.aliasIpRanges = Input.ofNullable(aliasIpRanges);
            return this;
        }

        public Builder setIpv6AccessConfigs(@Nullable Input<List<InstanceFromTemplateNetworkInterfaceIpv6AccessConfigGetArgs>> ipv6AccessConfigs) {
            this.ipv6AccessConfigs = ipv6AccessConfigs;
            return this;
        }

        public Builder setIpv6AccessConfigs(@Nullable List<InstanceFromTemplateNetworkInterfaceIpv6AccessConfigGetArgs> ipv6AccessConfigs) {
