...
public class InstanceGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.InstanceGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.InstanceGroupArgs.builder();
