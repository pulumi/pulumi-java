...
public final class RegionBackendServiceOutlierDetectionGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder baseEjectionTime(@Nullable Input<RegionBackendServiceOutlierDetectionBaseEjectionTimeGetArgs> baseEjectionTime) {
            this.baseEjectionTime = baseEjectionTime;
            return this;
        }
        ...
        public Builder interval(@Nullable Input<RegionBackendServiceOutlierDetectionIntervalGetArgs> interval) {
            this.interval = interval;
            return this;
        }
