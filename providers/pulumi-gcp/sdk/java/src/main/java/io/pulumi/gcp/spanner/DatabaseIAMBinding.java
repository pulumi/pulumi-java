...
public class DatabaseIAMBinding extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(DatabaseIAMBindingArgs.Builder a);
    }
    private static io.pulumi.gcp.spanner.DatabaseIAMBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.spanner.DatabaseIAMBindingArgs.builder();
     ...
     */
    public DatabaseIAMBinding(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public static DatabaseIAMBinding get(String name, Output<String> id, @Nullable DatabaseIAMBindingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
