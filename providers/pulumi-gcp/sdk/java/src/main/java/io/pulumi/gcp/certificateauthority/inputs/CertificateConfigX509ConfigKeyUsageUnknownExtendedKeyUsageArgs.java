...
public final class CertificateConfigX509ConfigKeyUsageUnknownExtendedKeyUsageArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public CertificateConfigX509ConfigKeyUsageUnknownExtendedKeyUsageArgs(Input<List<Integer>> objectIdPaths) {
