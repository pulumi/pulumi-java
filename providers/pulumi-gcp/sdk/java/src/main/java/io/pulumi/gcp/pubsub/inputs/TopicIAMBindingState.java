...
public final class TopicIAMBindingState extends io.pulumi.resources.ResourceArgs {
    ...
    public Output<TopicIAMBindingConditionGetArgs> condition() {
    ...
    public TopicIAMBindingState(
        @Nullable Output<TopicIAMBindingConditionGetArgs> condition,
    ...
    public static final class Builder {
        private @Nullable Output<TopicIAMBindingConditionGetArgs> condition;
        ...
        public Builder condition(@Nullable Output<TopicIAMBindingConditionGetArgs> condition) {
            this.condition = condition;
            return this;
        }
        public Builder condition(@Nullable TopicIAMBindingConditionGetArgs condition) {
