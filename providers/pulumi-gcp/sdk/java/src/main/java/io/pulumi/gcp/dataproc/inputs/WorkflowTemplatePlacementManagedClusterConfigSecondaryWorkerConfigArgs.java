...
public final class WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="accelerators")
      private final @Nullable Output<List<WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigAcceleratorArgs>> accelerators;

    public Output<List<WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigAcceleratorArgs>> getAccelerators() {
    ...
    @Import(name="diskConfig")
      private final @Nullable Output<WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigDiskConfigArgs> diskConfig;

    public Output<WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigDiskConfigArgs> getDiskConfig() {
    ...
    @Import(name="managedGroupConfigs")
      private final @Nullable Output<List<WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigManagedGroupConfigArgs>> managedGroupConfigs;

    public Output<List<WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigManagedGroupConfigArgs>> getManagedGroupConfigs() {
    ...
    public WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigArgs(
        @Nullable Output<List<WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigAcceleratorArgs>> accelerators,
        @Nullable Output<WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigDiskConfigArgs> diskConfig,
        ...
        @Nullable Output<List<WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigManagedGroupConfigArgs>> managedGroupConfigs,
