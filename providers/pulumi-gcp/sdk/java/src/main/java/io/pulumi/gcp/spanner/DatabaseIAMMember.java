...
public class DatabaseIAMMember extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(DatabaseIAMMemberArgs.Builder a);
    }
    private static io.pulumi.gcp.spanner.DatabaseIAMMemberArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.spanner.DatabaseIAMMemberArgs.builder();
     ...
     */
    public DatabaseIAMMember(String name, BuilderApplicator argsBuilder) {
    ...
    public DatabaseIAMMember(String name, DatabaseIAMMemberArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:spanner/databaseIAMMember:DatabaseIAMMember", name, args == null ? DatabaseIAMMemberArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private DatabaseIAMMember(String name, Input<String> id, @Nullable DatabaseIAMMemberState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static DatabaseIAMMember get(String name, Input<String> id, @Nullable DatabaseIAMMemberState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
