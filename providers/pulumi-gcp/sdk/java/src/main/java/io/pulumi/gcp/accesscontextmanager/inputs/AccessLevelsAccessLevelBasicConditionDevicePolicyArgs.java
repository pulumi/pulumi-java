...
public final class AccessLevelsAccessLevelBasicConditionDevicePolicyArgs extends io.pulumi.resources.ResourceArgs {

    public static final AccessLevelsAccessLevelBasicConditionDevicePolicyArgs Empty = new AccessLevelsAccessLevelBasicConditionDevicePolicyArgs();
    ...
    private final @Nullable Input<List<AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraintArgs>> osConstraints;

    public Input<List<AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraintArgs>> getOsConstraints() {
    ...
    public AccessLevelsAccessLevelBasicConditionDevicePolicyArgs(
        @Nullable Input<List<String>> allowedDeviceManagementLevels,
        @Nullable Input<List<String>> allowedEncryptionStatuses,
        @Nullable Input<List<AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraintArgs>> osConstraints,
    ...
    private AccessLevelsAccessLevelBasicConditionDevicePolicyArgs() {
    ...
    public static Builder builder(AccessLevelsAccessLevelBasicConditionDevicePolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraintArgs>> osConstraints;
        ...
        public Builder(AccessLevelsAccessLevelBasicConditionDevicePolicyArgs defaults) {
        ...
        public Builder setOsConstraints(@Nullable Input<List<AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraintArgs>> osConstraints) {
            this.osConstraints = osConstraints;
            return this;
        }

        public Builder setOsConstraints(@Nullable List<AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraintArgs> osConstraints) {
        ...
        public AccessLevelsAccessLevelBasicConditionDevicePolicyArgs build() {
            return new AccessLevelsAccessLevelBasicConditionDevicePolicyArgs(allowedDeviceManagementLevels, allowedEncryptionStatuses, osConstraints, requireAdminApproval, requireCorpOwned, requireScreenLock);
        }
    }
}
