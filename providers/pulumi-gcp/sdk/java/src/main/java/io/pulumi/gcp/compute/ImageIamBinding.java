...
public class ImageIamBinding extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ImageIamBindingArgs.Builder a);
    }
    private static io.pulumi.gcp.compute.ImageIamBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.ImageIamBindingArgs.builder();
     ...
     */
    public ImageIamBinding(String name, BuilderApplicator argsBuilder) {
    ...
    public ImageIamBinding(String name) {
        this(name, ImageIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ImageIamBinding(String name, ImageIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
    ...
    public ImageIamBinding(String name, ImageIamBindingArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/imageIamBinding:ImageIamBinding", name, args == null ? ImageIamBindingArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ImageIamBinding(String name, Output<String> id, @Nullable ImageIamBindingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ImageIamBinding get(String name, Output<String> id, @Nullable ImageIamBindingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
