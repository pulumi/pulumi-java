...
public class ConsumerQuotaOverride extends io.pulumi.resources.CustomResource {
     ...
     */
    public static ConsumerQuotaOverride get(String name, Output<String> id, @Nullable ConsumerQuotaOverrideState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
