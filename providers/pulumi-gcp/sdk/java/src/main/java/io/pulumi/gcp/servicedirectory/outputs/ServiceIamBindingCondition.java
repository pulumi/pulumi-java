...
@OutputCustomType
public final class ServiceIamBindingCondition {
    ...
    public static Builder builder(ServiceIamBindingCondition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ServiceIamBindingCondition defaults) {
