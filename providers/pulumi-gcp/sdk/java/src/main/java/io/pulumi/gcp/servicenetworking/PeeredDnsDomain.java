...
public class PeeredDnsDomain extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PeeredDnsDomainArgs.Builder a);
    }
    private static io.pulumi.gcp.servicenetworking.PeeredDnsDomainArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.servicenetworking.PeeredDnsDomainArgs.builder();
     ...
     */
    public PeeredDnsDomain(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public static PeeredDnsDomain get(String name, Output<String> id, @Nullable PeeredDnsDomainState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
