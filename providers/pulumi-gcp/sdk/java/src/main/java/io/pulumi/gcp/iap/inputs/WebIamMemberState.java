...
public final class WebIamMemberState extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<WebIamMemberConditionGetArgs> condition;

    public Input<WebIamMemberConditionGetArgs> getCondition() {
    ...
    public WebIamMemberState(
        @Nullable Input<WebIamMemberConditionGetArgs> condition,
    ...
    public static final class Builder {
        private @Nullable Input<WebIamMemberConditionGetArgs> condition;
        ...
        public Builder setCondition(@Nullable Input<WebIamMemberConditionGetArgs> condition) {
            this.condition = condition;
            return this;
        }

        public Builder setCondition(@Nullable WebIamMemberConditionGetArgs condition) {
