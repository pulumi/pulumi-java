...
public class AccessPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.accesscontextmanager.AccessPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.accesscontextmanager.AccessPolicyArgs.builder();
