...
public final class SloRequestBasedSliDistributionCutArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setRange(Input<SloRequestBasedSliDistributionCutRangeArgs> range) {
            this.range = Objects.requireNonNull(range);
            return this;
        }

        public Builder setRange(SloRequestBasedSliDistributionCutRangeArgs range) {
