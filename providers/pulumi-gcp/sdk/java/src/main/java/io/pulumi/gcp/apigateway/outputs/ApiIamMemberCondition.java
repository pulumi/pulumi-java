...
public final class ApiIamMemberCondition {
    ...
    public static Builder builder(ApiIamMemberCondition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ApiIamMemberCondition defaults) {
