...
public class InstanceIAMBinding extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.InstanceIAMBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.InstanceIAMBindingArgs.builder();
