...
public final class URLMapPathMatcherRouteRuleRouteActionCorsPolicyArgs extends io.pulumi.resources.ResourceArgs {

    public static final URLMapPathMatcherRouteRuleRouteActionCorsPolicyArgs Empty = new URLMapPathMatcherRouteRuleRouteActionCorsPolicyArgs();
    ...
    public URLMapPathMatcherRouteRuleRouteActionCorsPolicyArgs(
    ...
    private URLMapPathMatcherRouteRuleRouteActionCorsPolicyArgs() {
    ...
    public static Builder builder(URLMapPathMatcherRouteRuleRouteActionCorsPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(URLMapPathMatcherRouteRuleRouteActionCorsPolicyArgs defaults) {
        ...
        public URLMapPathMatcherRouteRuleRouteActionCorsPolicyArgs build() {
            return new URLMapPathMatcherRouteRuleRouteActionCorsPolicyArgs(allowCredentials, allowHeaders, allowMethods, allowOriginRegexes, allowOrigins, disabled, exposeHeaders, maxAge);
        }
    }
}
