...
public final class ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperationGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder methodSelectors(@Nullable Input<List<ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperationMethodSelectorGetArgs>> methodSelectors) {
            this.methodSelectors = methodSelectors;
            return this;
        }
