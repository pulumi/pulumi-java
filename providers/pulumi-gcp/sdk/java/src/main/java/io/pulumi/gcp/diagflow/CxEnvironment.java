...
public class CxEnvironment extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(CxEnvironmentArgs.Builder a);
    }
    private static io.pulumi.gcp.diagflow.CxEnvironmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.diagflow.CxEnvironmentArgs.builder();
     ...
     */
    public CxEnvironment(String name, BuilderApplicator argsBuilder) {
