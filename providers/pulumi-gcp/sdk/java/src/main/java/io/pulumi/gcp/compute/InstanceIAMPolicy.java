...
import io.pulumi.gcp.compute.InstanceIAMPolicyArgs;
import io.pulumi.gcp.compute.inputs.InstanceIAMPolicyState;
...
public class InstanceIAMPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.InstanceIAMPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.InstanceIAMPolicyArgs.builder();
