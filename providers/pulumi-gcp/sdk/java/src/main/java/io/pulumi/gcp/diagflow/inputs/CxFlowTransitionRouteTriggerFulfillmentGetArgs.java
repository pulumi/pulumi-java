...
public final class CxFlowTransitionRouteTriggerFulfillmentGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="messages")
        private final @Nullable Input<List<CxFlowTransitionRouteTriggerFulfillmentMessageGetArgs>> messages;

    public Input<List<CxFlowTransitionRouteTriggerFulfillmentMessageGetArgs>> getMessages() {
    ...
    public CxFlowTransitionRouteTriggerFulfillmentGetArgs(
        @Nullable Input<List<CxFlowTransitionRouteTriggerFulfillmentMessageGetArgs>> messages,
    ...
    public static final class Builder {
        private @Nullable Input<List<CxFlowTransitionRouteTriggerFulfillmentMessageGetArgs>> messages;
        ...
        public Builder setMessages(@Nullable Input<List<CxFlowTransitionRouteTriggerFulfillmentMessageGetArgs>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder setMessages(@Nullable List<CxFlowTransitionRouteTriggerFulfillmentMessageGetArgs> messages) {
