...
public class BillingAccountSink extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.logging.BillingAccountSinkArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.logging.BillingAccountSinkArgs.builder();
     ...
     */
    public static BillingAccountSink get(String name, Output<String> id, @Nullable BillingAccountSinkState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
