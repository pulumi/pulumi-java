...
public final class SpannerFunctions {
     ...
     * 
     */
    public static CompletableFuture<GetInstanceResult> getInstance(io.pulumi.gcp.spanner.inputs.GetInstanceArgs args) {
        return getInstance(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetInstanceResult> getInstance(io.pulumi.gcp.spanner.inputs.GetInstanceArgs args, InvokeOptions options) {
