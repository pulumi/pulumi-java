...
public final class BackendServiceCdnPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Output<BackendServiceCdnPolicyCacheKeyPolicyArgs> cacheKeyPolicy() {
    ...
    public Output<List<BackendServiceCdnPolicyNegativeCachingPolicyArgs>> negativeCachingPolicies() {
