...
public final class ServicePerimeterSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="egressPolicies")
      private final @Nullable Input<List<ServicePerimeterSpecEgressPolicyArgs>> egressPolicies;

    public Input<List<ServicePerimeterSpecEgressPolicyArgs>> getEgressPolicies() {
    ...
    @InputImport(name="ingressPolicies")
      private final @Nullable Input<List<ServicePerimeterSpecIngressPolicyArgs>> ingressPolicies;

    public Input<List<ServicePerimeterSpecIngressPolicyArgs>> getIngressPolicies() {
    ...
    @InputImport(name="vpcAccessibleServices")
      private final @Nullable Input<ServicePerimeterSpecVpcAccessibleServicesArgs> vpcAccessibleServices;

    public Input<ServicePerimeterSpecVpcAccessibleServicesArgs> getVpcAccessibleServices() {
    ...
    public ServicePerimeterSpecArgs(
        ...
        @Nullable Input<List<ServicePerimeterSpecEgressPolicyArgs>> egressPolicies,
        @Nullable Input<List<ServicePerimeterSpecIngressPolicyArgs>> ingressPolicies,
        @Nullable Input<List<String>> resources,
        @Nullable Input<List<String>> restrictedServices,
        @Nullable Input<ServicePerimeterSpecVpcAccessibleServicesArgs> vpcAccessibleServices) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<ServicePerimeterSpecEgressPolicyArgs>> egressPolicies;
        private @Nullable Input<List<ServicePerimeterSpecIngressPolicyArgs>> ingressPolicies;
        private @Nullable Input<List<String>> resources;
        private @Nullable Input<List<String>> restrictedServices;
        private @Nullable Input<ServicePerimeterSpecVpcAccessibleServicesArgs> vpcAccessibleServices;
        ...
        public Builder setEgressPolicies(@Nullable Input<List<ServicePerimeterSpecEgressPolicyArgs>> egressPolicies) {
            this.egressPolicies = egressPolicies;
            return this;
        }

        public Builder setEgressPolicies(@Nullable List<ServicePerimeterSpecEgressPolicyArgs> egressPolicies) {
            this.egressPolicies = Input.ofNullable(egressPolicies);
            return this;
        }

        public Builder setIngressPolicies(@Nullable Input<List<ServicePerimeterSpecIngressPolicyArgs>> ingressPolicies) {
            this.ingressPolicies = ingressPolicies;
            return this;
        }

        public Builder setIngressPolicies(@Nullable List<ServicePerimeterSpecIngressPolicyArgs> ingressPolicies) {
        ...
        public Builder setVpcAccessibleServices(@Nullable Input<ServicePerimeterSpecVpcAccessibleServicesArgs> vpcAccessibleServices) {
            this.vpcAccessibleServices = vpcAccessibleServices;
            return this;
        }

        public Builder setVpcAccessibleServices(@Nullable ServicePerimeterSpecVpcAccessibleServicesArgs vpcAccessibleServices) {
