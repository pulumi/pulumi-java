...
public class RepositoryIamMember extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.sourcerepo.RepositoryIamMemberArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.sourcerepo.RepositoryIamMemberArgs.builder();
