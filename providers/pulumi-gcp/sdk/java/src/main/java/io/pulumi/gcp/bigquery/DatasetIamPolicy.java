...
public class DatasetIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public DatasetIamPolicy(String name) {
        super("gcp:bigquery/datasetIamPolicy:DatasetIamPolicy", name, DatasetIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public DatasetIamPolicy(String name, DatasetIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigquery/datasetIamPolicy:DatasetIamPolicy", name, args == null ? DatasetIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
