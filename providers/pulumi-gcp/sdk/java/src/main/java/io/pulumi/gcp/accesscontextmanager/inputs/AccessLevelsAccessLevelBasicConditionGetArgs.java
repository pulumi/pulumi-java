...
public final class AccessLevelsAccessLevelBasicConditionGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="devicePolicy")
      private final @Nullable Input<AccessLevelsAccessLevelBasicConditionDevicePolicyGetArgs> devicePolicy;

    public Input<AccessLevelsAccessLevelBasicConditionDevicePolicyGetArgs> getDevicePolicy() {
    ...
    public AccessLevelsAccessLevelBasicConditionGetArgs(
        @Nullable Input<AccessLevelsAccessLevelBasicConditionDevicePolicyGetArgs> devicePolicy,
    ...
    public static final class Builder {
        private @Nullable Input<AccessLevelsAccessLevelBasicConditionDevicePolicyGetArgs> devicePolicy;
        ...
        public Builder setDevicePolicy(@Nullable Input<AccessLevelsAccessLevelBasicConditionDevicePolicyGetArgs> devicePolicy) {
            this.devicePolicy = devicePolicy;
            return this;
        }

        public Builder setDevicePolicy(@Nullable AccessLevelsAccessLevelBasicConditionDevicePolicyGetArgs devicePolicy) {
