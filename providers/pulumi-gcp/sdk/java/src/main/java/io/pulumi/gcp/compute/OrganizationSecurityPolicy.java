...
public class OrganizationSecurityPolicy extends io.pulumi.resources.CustomResource {
    ...
    public OrganizationSecurityPolicy(String name) {
        super("gcp:compute/organizationSecurityPolicy:OrganizationSecurityPolicy", name, OrganizationSecurityPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
