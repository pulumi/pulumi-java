...
public final class URLMapPathMatcherRouteRuleRouteActionWeightedBackendServiceGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="headerAction")
        private final @Nullable Input<URLMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionGetArgs> headerAction;

    public Input<URLMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionGetArgs> getHeaderAction() {
    ...
    public URLMapPathMatcherRouteRuleRouteActionWeightedBackendServiceGetArgs(
        ...
        @Nullable Input<URLMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionGetArgs> headerAction,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<URLMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionGetArgs> headerAction;
        ...
        public Builder setHeaderAction(@Nullable Input<URLMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionGetArgs> headerAction) {
            this.headerAction = headerAction;
            return this;
        }

        public Builder setHeaderAction(@Nullable URLMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionGetArgs headerAction) {
