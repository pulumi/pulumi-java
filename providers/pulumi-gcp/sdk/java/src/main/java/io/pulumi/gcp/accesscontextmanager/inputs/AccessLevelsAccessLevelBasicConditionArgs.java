...
public final class AccessLevelsAccessLevelBasicConditionArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<AccessLevelsAccessLevelBasicConditionDevicePolicyArgs> devicePolicy;

    public Input<AccessLevelsAccessLevelBasicConditionDevicePolicyArgs> getDevicePolicy() {
    ...
    public AccessLevelsAccessLevelBasicConditionArgs(
        @Nullable Input<AccessLevelsAccessLevelBasicConditionDevicePolicyArgs> devicePolicy,
    ...
    public static final class Builder {
        private @Nullable Input<AccessLevelsAccessLevelBasicConditionDevicePolicyArgs> devicePolicy;
        ...
        public Builder setDevicePolicy(@Nullable Input<AccessLevelsAccessLevelBasicConditionDevicePolicyArgs> devicePolicy) {
            this.devicePolicy = devicePolicy;
            return this;
        }

        public Builder setDevicePolicy(@Nullable AccessLevelsAccessLevelBasicConditionDevicePolicyArgs devicePolicy) {
