...
public final class SecretIamMemberState extends io.pulumi.resources.ResourceArgs {
    ...
    public SecretIamMemberState(
        @Nullable Input<SecretIamMemberConditionGetArgs> condition,
    ...
    public static final class Builder {
        private @Nullable Input<SecretIamMemberConditionGetArgs> condition;
        ...
        public Builder setCondition(@Nullable Input<SecretIamMemberConditionGetArgs> condition) {
            this.condition = condition;
            return this;
        }

        public Builder setCondition(@Nullable SecretIamMemberConditionGetArgs condition) {
