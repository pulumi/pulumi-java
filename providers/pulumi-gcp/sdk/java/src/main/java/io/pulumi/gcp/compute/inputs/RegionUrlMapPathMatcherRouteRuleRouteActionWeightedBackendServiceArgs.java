...
public final class RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceArgs(
        ...
        @Nullable Input<RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionArgs> headerAction,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionArgs> headerAction;
        ...
        public Builder setHeaderAction(@Nullable Input<RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionArgs> headerAction) {
            this.headerAction = headerAction;
            return this;
        }

        public Builder setHeaderAction(@Nullable RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionArgs headerAction) {
