...
public final class WorkerPoolState extends io.pulumi.resources.ResourceArgs {
    ...
    public WorkerPoolState(
        ...
        @Nullable Input<WorkerPoolNetworkConfigGetArgs> networkConfig,
        @Nullable Input<String> project,
        @Nullable Input<String> state,
        @Nullable Input<String> uid,
        @Nullable Input<String> updateTime,
        @Nullable Input<WorkerPoolWorkerConfigGetArgs> workerConfig) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<WorkerPoolNetworkConfigGetArgs> networkConfig;
        private @Nullable Input<String> project;
        private @Nullable Input<String> state;
        private @Nullable Input<String> uid;
        private @Nullable Input<String> updateTime;
        private @Nullable Input<WorkerPoolWorkerConfigGetArgs> workerConfig;
        ...
        public Builder setNetworkConfig(@Nullable Input<WorkerPoolNetworkConfigGetArgs> networkConfig) {
            this.networkConfig = networkConfig;
            return this;
        }

        public Builder setNetworkConfig(@Nullable WorkerPoolNetworkConfigGetArgs networkConfig) {
        ...
        public Builder setWorkerConfig(@Nullable Input<WorkerPoolWorkerConfigGetArgs> workerConfig) {
            this.workerConfig = workerConfig;
            return this;
        }

        public Builder setWorkerConfig(@Nullable WorkerPoolWorkerConfigGetArgs workerConfig) {
