...
public final class ServiceMetadataArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ServiceMetadataArgs build() {
            return new ServiceMetadataArgs(annotations, generation, labels, namespace, resourceVersion, selfLink, uid);
        }
    }
}
