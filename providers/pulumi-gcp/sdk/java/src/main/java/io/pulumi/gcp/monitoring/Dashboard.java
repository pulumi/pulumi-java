...
public class Dashboard extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.monitoring.DashboardArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.monitoring.DashboardArgs.builder();
