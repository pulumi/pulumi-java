...
public final class FunctionState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder eventTrigger(@Nullable Input<FunctionEventTriggerGetArgs> eventTrigger) {
            this.eventTrigger = eventTrigger;
            return this;
        }
        ...
        public Builder sourceRepository(@Nullable Input<FunctionSourceRepositoryGetArgs> sourceRepository) {
            this.sourceRepository = sourceRepository;
            return this;
        }
