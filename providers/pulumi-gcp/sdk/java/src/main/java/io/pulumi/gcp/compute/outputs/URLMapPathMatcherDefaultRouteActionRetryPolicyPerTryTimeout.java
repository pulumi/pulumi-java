...
@CustomType
public final class URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout {
    /**
    ...
    private URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout(
    ...
    */
    ...
    public static Builder builder(URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(URLMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout defaults) {
