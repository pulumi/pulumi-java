...
public final class URLMapTestGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final URLMapTestGetArgs Empty = new URLMapTestGetArgs();
    ...
    public static Builder builder(URLMapTestGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(URLMapTestGetArgs defaults) {
        ...
        public URLMapTestGetArgs build() {
            return new URLMapTestGetArgs(description, host, path, service);
        }
    }
}
