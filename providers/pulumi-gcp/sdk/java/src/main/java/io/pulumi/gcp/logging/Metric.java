...
public class Metric extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(MetricArgs.Builder a);
    }
    private static io.pulumi.gcp.logging.MetricArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.logging.MetricArgs.builder();
     ...
     */
    public Metric(String name, BuilderApplicator argsBuilder) {
