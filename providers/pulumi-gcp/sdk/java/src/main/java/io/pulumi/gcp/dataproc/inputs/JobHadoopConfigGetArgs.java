...
import io.pulumi.gcp.dataproc.inputs.JobHadoopConfigLoggingConfigGetArgs;
...
public final class JobHadoopConfigGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<JobHadoopConfigLoggingConfigGetArgs> loggingConfig;

    public Input<JobHadoopConfigLoggingConfigGetArgs> getLoggingConfig() {
    ...
    public JobHadoopConfigGetArgs(
        ...
        @Nullable Input<JobHadoopConfigLoggingConfigGetArgs> loggingConfig,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<JobHadoopConfigLoggingConfigGetArgs> loggingConfig;
        ...
        public Builder setLoggingConfig(@Nullable Input<JobHadoopConfigLoggingConfigGetArgs> loggingConfig) {
            this.loggingConfig = loggingConfig;
            return this;
        }

        public Builder setLoggingConfig(@Nullable JobHadoopConfigLoggingConfigGetArgs loggingConfig) {
