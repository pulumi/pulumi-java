...
public final class AwsClusterControlPlaneGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setAwsServicesAuthentication(Input<AwsClusterControlPlaneAwsServicesAuthenticationGetArgs> awsServicesAuthentication) {
            this.awsServicesAuthentication = Objects.requireNonNull(awsServicesAuthentication);
            return this;
        }

        public Builder setAwsServicesAuthentication(AwsClusterControlPlaneAwsServicesAuthenticationGetArgs awsServicesAuthentication) {
            this.awsServicesAuthentication = Input.of(Objects.requireNonNull(awsServicesAuthentication));
            return this;
        }

        public Builder setConfigEncryption(Input<AwsClusterControlPlaneConfigEncryptionGetArgs> configEncryption) {
            this.configEncryption = Objects.requireNonNull(configEncryption);
            return this;
        }

        public Builder setConfigEncryption(AwsClusterControlPlaneConfigEncryptionGetArgs configEncryption) {
            this.configEncryption = Input.of(Objects.requireNonNull(configEncryption));
            return this;
        }

        public Builder setDatabaseEncryption(Input<AwsClusterControlPlaneDatabaseEncryptionGetArgs> databaseEncryption) {
            this.databaseEncryption = Objects.requireNonNull(databaseEncryption);
            return this;
        }

        public Builder setDatabaseEncryption(AwsClusterControlPlaneDatabaseEncryptionGetArgs databaseEncryption) {
        ...
        public Builder setMainVolume(@Nullable Input<AwsClusterControlPlaneMainVolumeGetArgs> mainVolume) {
            this.mainVolume = mainVolume;
            return this;
        }

        public Builder setMainVolume(@Nullable AwsClusterControlPlaneMainVolumeGetArgs mainVolume) {
            this.mainVolume = Input.ofNullable(mainVolume);
            return this;
        }

        public Builder setProxyConfig(@Nullable Input<AwsClusterControlPlaneProxyConfigGetArgs> proxyConfig) {
            this.proxyConfig = proxyConfig;
            return this;
        }

        public Builder setProxyConfig(@Nullable AwsClusterControlPlaneProxyConfigGetArgs proxyConfig) {
            this.proxyConfig = Input.ofNullable(proxyConfig);
            return this;
        }

        public Builder setRootVolume(@Nullable Input<AwsClusterControlPlaneRootVolumeGetArgs> rootVolume) {
            this.rootVolume = rootVolume;
            return this;
        }

        public Builder setRootVolume(@Nullable AwsClusterControlPlaneRootVolumeGetArgs rootVolume) {
        ...
        public Builder setSshConfig(@Nullable Input<AwsClusterControlPlaneSshConfigGetArgs> sshConfig) {
            this.sshConfig = sshConfig;
            return this;
        }

        public Builder setSshConfig(@Nullable AwsClusterControlPlaneSshConfigGetArgs sshConfig) {
