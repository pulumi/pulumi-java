...
public final class RegionBackendServiceOutlierDetectionBaseEjectionTimeGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final RegionBackendServiceOutlierDetectionBaseEjectionTimeGetArgs Empty = new RegionBackendServiceOutlierDetectionBaseEjectionTimeGetArgs();
    ...
    private RegionBackendServiceOutlierDetectionBaseEjectionTimeGetArgs() {
    ...
    public static Builder builder(RegionBackendServiceOutlierDetectionBaseEjectionTimeGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RegionBackendServiceOutlierDetectionBaseEjectionTimeGetArgs defaults) {
        ...
        public RegionBackendServiceOutlierDetectionBaseEjectionTimeGetArgs build() {
            return new RegionBackendServiceOutlierDetectionBaseEjectionTimeGetArgs(nanos, seconds);
        }
    }
}
