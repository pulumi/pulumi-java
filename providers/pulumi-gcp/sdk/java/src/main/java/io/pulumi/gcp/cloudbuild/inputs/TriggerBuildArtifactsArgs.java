...
public final class TriggerBuildArtifactsArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public TriggerBuildArtifactsArgs(
        ...
        @Nullable Input<TriggerBuildArtifactsObjectsArgs> objects) {
        this.images = images;
    ...
    public static final class Builder {
        ...
        private @Nullable Input<TriggerBuildArtifactsObjectsArgs> objects;
        ...
        public Builder setObjects(@Nullable Input<TriggerBuildArtifactsObjectsArgs> objects) {
            this.objects = objects;
            return this;
        }

        public Builder setObjects(@Nullable TriggerBuildArtifactsObjectsArgs objects) {
