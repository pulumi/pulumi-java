...
import io.pulumi.gcp.apigateway.outputs.ApiConfigIamMemberCondition;
...
public class ApiConfigIamMember extends io.pulumi.resources.CustomResource {
    /**
    ...
    @OutputExport(name="condition", type=ApiConfigIamMemberCondition.class, parameters={})
    ...
    public interface BuilderApplicator {
        public void apply(ApiConfigIamMemberArgs.Builder a);
    }
    private static io.pulumi.gcp.apigateway.ApiConfigIamMemberArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.apigateway.ApiConfigIamMemberArgs.builder();
     ...
     */
    public ApiConfigIamMember(String name, BuilderApplicator argsBuilder) {
