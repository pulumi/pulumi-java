...
public final class DatabaseIAMBindingConditionArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DatabaseIAMBindingConditionArgs build() {
            return new DatabaseIAMBindingConditionArgs(description, expression, title);
        }
    }
}
