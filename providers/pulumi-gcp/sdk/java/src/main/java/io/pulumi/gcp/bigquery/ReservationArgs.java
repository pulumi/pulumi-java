...
public final class ReservationArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="slotCapacity", required=true)
      private final Output<Integer> slotCapacity;
    ...
    public ReservationArgs(
        ...
        Output<Integer> slotCapacity) {
        this.ignoreIdleSlots = ignoreIdleSlots;
        this.location = location;
        this.name = name;
        this.project = project;
        this.slotCapacity = Objects.requireNonNull(slotCapacity, "expected parameter 'slotCapacity' to be non-null");
    }
