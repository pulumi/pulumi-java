...
public class FirewallPolicyRule extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(FirewallPolicyRuleArgs.Builder a);
    }
    private static io.pulumi.gcp.compute.FirewallPolicyRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.FirewallPolicyRuleArgs.builder();
     ...
     */
    public FirewallPolicyRule(String name, BuilderApplicator argsBuilder) {
