...
public class GlobalNetworkEndpoint extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(GlobalNetworkEndpointArgs.Builder a);
    }
    private static io.pulumi.gcp.compute.GlobalNetworkEndpointArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.GlobalNetworkEndpointArgs.builder();
     ...
     */
    public GlobalNetworkEndpoint(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public static GlobalNetworkEndpoint get(String name, Output<String> id, @Nullable GlobalNetworkEndpointState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
