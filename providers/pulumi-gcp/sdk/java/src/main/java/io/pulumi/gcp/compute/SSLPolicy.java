...
public class SSLPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.SSLPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.SSLPolicyArgs.builder();
