...
public class KeyRingIAMMember extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(KeyRingIAMMemberArgs.Builder a);
    }
    private static io.pulumi.gcp.kms.KeyRingIAMMemberArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.kms.KeyRingIAMMemberArgs.builder();
     ...
     */
    public KeyRingIAMMember(String name, BuilderApplicator argsBuilder) {
