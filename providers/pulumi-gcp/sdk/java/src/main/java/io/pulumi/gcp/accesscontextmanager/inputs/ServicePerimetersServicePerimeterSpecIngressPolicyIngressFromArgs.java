...
public final class ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setSources(@Nullable Input<List<ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSourceArgs>> sources) {
            this.sources = sources;
            return this;
        }

        public Builder setSources(@Nullable List<ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSourceArgs> sources) {
