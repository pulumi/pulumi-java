...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setGcs(@Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGcsGetArgs> gcs) {
            this.gcs = gcs;
            return this;
        }

        public Builder setGcs(@Nullable OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGcsGetArgs gcs) {
        ...
        public Builder setRemote(@Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileRemoteGetArgs> remote) {
            this.remote = remote;
            return this;
        }

        public Builder setRemote(@Nullable OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileRemoteGetArgs remote) {
