...
public class TenantDefaultSupportedIdpConfig extends io.pulumi.resources.CustomResource {
    ...
    public TenantDefaultSupportedIdpConfig(String name) {
        super("gcp:identityplatform/tenantDefaultSupportedIdpConfig:TenantDefaultSupportedIdpConfig", name, TenantDefaultSupportedIdpConfigArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
