...
public final class ClusterNodeConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Output<ClusterNodeConfigEphemeralStorageConfigArgs> getEphemeralStorageConfig() {
    ...
    public Output<ClusterNodeConfigGcfsConfigArgs> getGcfsConfig() {
    ...
    public Output<List<ClusterNodeConfigGuestAcceleratorArgs>> getGuestAccelerators() {
    ...
    public Output<ClusterNodeConfigKubeletConfigArgs> getKubeletConfig() {
    ...
    public Output<ClusterNodeConfigLinuxNodeConfigArgs> getLinuxNodeConfig() {
    ...
    public Output<ClusterNodeConfigSandboxConfigArgs> getSandboxConfig() {
    ...
    public Output<ClusterNodeConfigShieldedInstanceConfigArgs> getShieldedInstanceConfig() {
    ...
    public Output<List<ClusterNodeConfigTaintArgs>> getTaints() {
    ...
    public Output<ClusterNodeConfigWorkloadMetadataConfigArgs> getWorkloadMetadataConfig() {
