...
public final class AccessLevelBasicConditionGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setDevicePolicy(@Nullable Input<AccessLevelBasicConditionDevicePolicyGetArgs> devicePolicy) {
            this.devicePolicy = devicePolicy;
            return this;
        }

        public Builder setDevicePolicy(@Nullable AccessLevelBasicConditionDevicePolicyGetArgs devicePolicy) {
