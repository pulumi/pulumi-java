...
public final class BackendServiceOutlierDetection {
    ...
    private BackendServiceOutlierDetection(
        @OutputCustomType.Parameter("baseEjectionTime") @Nullable BackendServiceOutlierDetectionBaseEjectionTime baseEjectionTime,
        ...
        @OutputCustomType.Parameter("interval") @Nullable BackendServiceOutlierDetectionInterval interval,
