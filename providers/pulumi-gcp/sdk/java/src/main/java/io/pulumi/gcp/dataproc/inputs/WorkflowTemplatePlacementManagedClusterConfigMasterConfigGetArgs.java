...
public final class WorkflowTemplatePlacementManagedClusterConfigMasterConfigGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setAccelerators(@Nullable Input<List<WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorGetArgs>> accelerators) {
            this.accelerators = accelerators;
            return this;
        }

        public Builder setAccelerators(@Nullable List<WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorGetArgs> accelerators) {
            this.accelerators = Input.ofNullable(accelerators);
            return this;
        }

        public Builder setDiskConfig(@Nullable Input<WorkflowTemplatePlacementManagedClusterConfigMasterConfigDiskConfigGetArgs> diskConfig) {
            this.diskConfig = diskConfig;
            return this;
        }

        public Builder setDiskConfig(@Nullable WorkflowTemplatePlacementManagedClusterConfigMasterConfigDiskConfigGetArgs diskConfig) {
        ...
        public Builder setManagedGroupConfigs(@Nullable Input<List<WorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfigGetArgs>> managedGroupConfigs) {
            this.managedGroupConfigs = managedGroupConfigs;
            return this;
        }

        public Builder setManagedGroupConfigs(@Nullable List<WorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfigGetArgs> managedGroupConfigs) {
