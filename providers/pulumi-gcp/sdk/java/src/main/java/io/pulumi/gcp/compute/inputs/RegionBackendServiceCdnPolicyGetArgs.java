...
public final class RegionBackendServiceCdnPolicyGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCacheKeyPolicy(@Nullable Input<RegionBackendServiceCdnPolicyCacheKeyPolicyGetArgs> cacheKeyPolicy) {
            this.cacheKeyPolicy = cacheKeyPolicy;
            return this;
        }

        public Builder setCacheKeyPolicy(@Nullable RegionBackendServiceCdnPolicyCacheKeyPolicyGetArgs cacheKeyPolicy) {
        ...
        public Builder setNegativeCachingPolicies(@Nullable Input<List<RegionBackendServiceCdnPolicyNegativeCachingPolicyGetArgs>> negativeCachingPolicies) {
            this.negativeCachingPolicies = negativeCachingPolicies;
            return this;
        }

        public Builder setNegativeCachingPolicies(@Nullable List<RegionBackendServiceCdnPolicyNegativeCachingPolicyGetArgs> negativeCachingPolicies) {
