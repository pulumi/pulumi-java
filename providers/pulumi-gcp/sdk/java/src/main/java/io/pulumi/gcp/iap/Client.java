...
public class Client extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ClientArgs.Builder a);
    }
    private static io.pulumi.gcp.iap.ClientArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.iap.ClientArgs.builder();
     ...
     */
    public Client(String name, BuilderApplicator argsBuilder) {
    ...
    public Client(String name, ClientArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/client:Client", name, args == null ? ClientArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private Client(String name, Output<String> id, @Nullable ClientState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Client get(String name, Output<String> id, @Nullable ClientState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
