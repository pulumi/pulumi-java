...
public class PreventionDeidentifyTemplate extends io.pulumi.resources.CustomResource {
    ...
    public PreventionDeidentifyTemplate(String name) {
        super("gcp:dataloss/preventionDeidentifyTemplate:PreventionDeidentifyTemplate", name, PreventionDeidentifyTemplateArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
