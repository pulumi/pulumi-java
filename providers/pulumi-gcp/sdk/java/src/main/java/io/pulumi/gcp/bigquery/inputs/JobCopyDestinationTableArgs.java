...
public final class JobCopyDestinationTableArgs extends io.pulumi.resources.ResourceArgs {

    public static final JobCopyDestinationTableArgs Empty = new JobCopyDestinationTableArgs();
    ...
    public JobCopyDestinationTableArgs(
    ...
    private JobCopyDestinationTableArgs() {
    ...
    public static Builder builder(JobCopyDestinationTableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(JobCopyDestinationTableArgs defaults) {
        ...
        public JobCopyDestinationTableArgs build() {
            return new JobCopyDestinationTableArgs(datasetId, projectId, tableId);
        }
    }
}
