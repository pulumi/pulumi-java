...
public class DomainMapping extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.appengine.DomainMappingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.appengine.DomainMappingArgs.builder();
