...
public final class URLMapDefaultRouteActionRetryPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setPerTryTimeout(@Nullable Input<URLMapDefaultRouteActionRetryPolicyPerTryTimeoutArgs> perTryTimeout) {
            this.perTryTimeout = perTryTimeout;
            return this;
        }

        public Builder setPerTryTimeout(@Nullable URLMapDefaultRouteActionRetryPolicyPerTryTimeoutArgs perTryTimeout) {
