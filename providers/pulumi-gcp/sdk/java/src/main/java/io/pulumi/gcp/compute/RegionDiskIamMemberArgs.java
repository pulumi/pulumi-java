...
public final class RegionDiskIamMemberArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public RegionDiskIamMemberArgs(
        @Nullable Input<RegionDiskIamMemberConditionArgs> condition,
        Input<String> member,
    ...
    public static final class Builder {
        private @Nullable Input<RegionDiskIamMemberConditionArgs> condition;
        ...
        public Builder setCondition(@Nullable Input<RegionDiskIamMemberConditionArgs> condition) {
            this.condition = condition;
            return this;
        }

        public Builder setCondition(@Nullable RegionDiskIamMemberConditionArgs condition) {
