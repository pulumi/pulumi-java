...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder gcs(@Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceGcsArgs> gcs) {
            this.gcs = gcs;
            return this;
        }
        ...
        public Builder remote(@Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceRemoteArgs> remote) {
            this.remote = remote;
            return this;
        }
