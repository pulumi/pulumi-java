...
public class TunnelIamBinding extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @OutputExport(name="condition", type=TunnelIamBindingCondition.class, parameters={})
    ...
    public interface BuilderApplicator {
        public void apply(TunnelIamBindingArgs.Builder a);
    }
    private static io.pulumi.gcp.iap.TunnelIamBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.iap.TunnelIamBindingArgs.builder();
     ...
     */
    public TunnelIamBinding(String name, BuilderApplicator argsBuilder) {
    ...
    public TunnelIamBinding(String name, TunnelIamBindingArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/tunnelIamBinding:TunnelIamBinding", name, args == null ? TunnelIamBindingArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private TunnelIamBinding(String name, Input<String> id, @Nullable TunnelIamBindingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TunnelIamBinding get(String name, Input<String> id, @Nullable TunnelIamBindingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
