...
public class Instance extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.datafusion.InstanceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.datafusion.InstanceArgs.builder();
    ...
    public Instance(String name, InstanceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:datafusion/instance:Instance", name, args == null ? InstanceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
