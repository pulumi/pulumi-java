...
public class ImageIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.ImageIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.ImageIamPolicyArgs.builder();
