...
public class SharedVPCHostProject extends io.pulumi.resources.CustomResource {
    ...
    public SharedVPCHostProject(String name) {
        super("gcp:compute/sharedVPCHostProject:SharedVPCHostProject", name, SharedVPCHostProjectArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public SharedVPCHostProject(String name, SharedVPCHostProjectArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/sharedVPCHostProject:SharedVPCHostProject", name, args == null ? SharedVPCHostProjectArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private SharedVPCHostProject(String name, Input<String> id, @Nullable SharedVPCHostProjectState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SharedVPCHostProject get(String name, Input<String> id, @Nullable SharedVPCHostProjectState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
