...
public class MachineImageIamBinding extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(MachineImageIamBindingArgs.Builder a);
    }
    private static io.pulumi.gcp.compute.MachineImageIamBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.MachineImageIamBindingArgs.builder();
     ...
     */
    public MachineImageIamBinding(String name, BuilderApplicator argsBuilder) {
    ...
    public MachineImageIamBinding(String name, MachineImageIamBindingArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/machineImageIamBinding:MachineImageIamBinding", name, args == null ? MachineImageIamBindingArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private MachineImageIamBinding(String name, Output<String> id, @Nullable MachineImageIamBindingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static MachineImageIamBinding get(String name, Output<String> id, @Nullable MachineImageIamBindingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
