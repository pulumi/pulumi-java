...
public class Subscription extends io.pulumi.resources.CustomResource {
     ...
     */
    public static Subscription get(String name, Output<String> id, @Nullable SubscriptionState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
