...
public class IAMMember extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.organizations.IAMMemberArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.organizations.IAMMemberArgs.builder();
    ...
    public IAMMember(String name, IAMMemberArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:organizations/iAMMember:IAMMember", name, args == null ? IAMMemberArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
