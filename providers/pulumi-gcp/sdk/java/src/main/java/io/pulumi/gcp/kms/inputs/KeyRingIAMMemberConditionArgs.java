...
public final class KeyRingIAMMemberConditionArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public KeyRingIAMMemberConditionArgs build() {
            return new KeyRingIAMMemberConditionArgs(description, expression, title);
        }
    }
}
