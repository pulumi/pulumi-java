...
public final class ClusterClusterConfigSoftwareConfigGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder overrideProperties(@Nullable Input<Map<String,String>> overrideProperties) {
            this.overrideProperties = overrideProperties;
            return this;
        }
