...
@OutputCustomType
public final class ConsentStoreIamMemberCondition {
    private final @Nullable String description;
    private final String expression;
    private final String title;

    @OutputCustomType.Constructor({"description","expression","title"})
    private ConsentStoreIamMemberCondition(
    ...
    public static Builder builder(ConsentStoreIamMemberCondition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ConsentStoreIamMemberCondition defaults) {
