...
public final class RegionUrlMapPathMatcherRouteRuleMatchRuleHeaderMatchGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setRangeMatch(@Nullable Input<RegionUrlMapPathMatcherRouteRuleMatchRuleHeaderMatchRangeMatchGetArgs> rangeMatch) {
            this.rangeMatch = rangeMatch;
            return this;
        }

        public Builder setRangeMatch(@Nullable RegionUrlMapPathMatcherRouteRuleMatchRuleHeaderMatchRangeMatchGetArgs rangeMatch) {
