...
public final class TriggerBuildArtifactsObjectsGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setTimings(@Nullable Input<List<TriggerBuildArtifactsObjectsTimingGetArgs>> timings) {
            this.timings = timings;
            return this;
        }

        public Builder setTimings(@Nullable List<TriggerBuildArtifactsObjectsTimingGetArgs> timings) {
