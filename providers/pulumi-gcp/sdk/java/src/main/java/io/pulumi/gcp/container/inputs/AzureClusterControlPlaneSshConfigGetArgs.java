...
public final class AzureClusterControlPlaneSshConfigGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public AzureClusterControlPlaneSshConfigGetArgs(Input<String> authorizedKey) {
