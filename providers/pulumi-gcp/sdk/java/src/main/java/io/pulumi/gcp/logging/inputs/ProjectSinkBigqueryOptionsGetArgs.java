...
public final class ProjectSinkBigqueryOptionsGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public ProjectSinkBigqueryOptionsGetArgs(Input<Boolean> usePartitionedTables) {
