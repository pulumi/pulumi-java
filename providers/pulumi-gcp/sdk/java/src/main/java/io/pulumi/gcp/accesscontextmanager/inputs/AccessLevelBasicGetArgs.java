...
public final class AccessLevelBasicGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setConditions(Input<List<AccessLevelBasicConditionGetArgs>> conditions) {
            this.conditions = Objects.requireNonNull(conditions);
            return this;
        }

        public Builder setConditions(List<AccessLevelBasicConditionGetArgs> conditions) {
