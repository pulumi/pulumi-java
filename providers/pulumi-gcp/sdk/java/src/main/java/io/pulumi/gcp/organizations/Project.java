...
public class Project extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.organizations.ProjectArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.organizations.ProjectArgs.builder();
