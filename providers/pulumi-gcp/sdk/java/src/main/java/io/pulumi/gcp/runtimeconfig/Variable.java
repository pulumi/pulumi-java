...
public class Variable extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.runtimeconfig.VariableArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.runtimeconfig.VariableArgs.builder();
     ...
     */
    public static Variable get(String name, Output<String> id, @Nullable VariableState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
