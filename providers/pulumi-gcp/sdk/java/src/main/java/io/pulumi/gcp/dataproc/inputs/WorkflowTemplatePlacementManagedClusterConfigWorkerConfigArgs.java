...
public final class WorkflowTemplatePlacementManagedClusterConfigWorkerConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="accelerators")
      private final @Nullable Output<List<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigAcceleratorArgs>> accelerators;

    public Output<List<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigAcceleratorArgs>> getAccelerators() {
    ...
    @Import(name="diskConfig")
      private final @Nullable Output<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfigArgs> diskConfig;

    public Output<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfigArgs> getDiskConfig() {
    ...
    @Import(name="managedGroupConfigs")
      private final @Nullable Output<List<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigManagedGroupConfigArgs>> managedGroupConfigs;

    public Output<List<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigManagedGroupConfigArgs>> getManagedGroupConfigs() {
    ...
    public WorkflowTemplatePlacementManagedClusterConfigWorkerConfigArgs(
        @Nullable Output<List<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigAcceleratorArgs>> accelerators,
        @Nullable Output<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfigArgs> diskConfig,
        ...
        @Nullable Output<List<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigManagedGroupConfigArgs>> managedGroupConfigs,
    ...
    public static final class Builder {
        ...
        public Builder accelerators(@Nullable List<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigAcceleratorArgs> accelerators) {
        ...
        public Builder diskConfig(@Nullable WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfigArgs diskConfig) {
        ...
        public Builder managedGroupConfigs(@Nullable List<WorkflowTemplatePlacementManagedClusterConfigWorkerConfigManagedGroupConfigArgs> managedGroupConfigs) {
