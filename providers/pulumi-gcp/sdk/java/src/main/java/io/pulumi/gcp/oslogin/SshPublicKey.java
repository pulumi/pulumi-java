...
public class SshPublicKey extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.oslogin.SshPublicKeyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.oslogin.SshPublicKeyArgs.builder();
