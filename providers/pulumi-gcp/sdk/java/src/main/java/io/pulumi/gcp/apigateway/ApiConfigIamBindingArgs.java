...
public final class ApiConfigIamBindingArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public ApiConfigIamBindingArgs(
        ...
        @Nullable Input<ApiConfigIamBindingConditionArgs> condition,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<ApiConfigIamBindingConditionArgs> condition;
        ...
        public Builder setCondition(@Nullable Input<ApiConfigIamBindingConditionArgs> condition) {
            this.condition = condition;
            return this;
        }

        public Builder setCondition(@Nullable ApiConfigIamBindingConditionArgs condition) {
