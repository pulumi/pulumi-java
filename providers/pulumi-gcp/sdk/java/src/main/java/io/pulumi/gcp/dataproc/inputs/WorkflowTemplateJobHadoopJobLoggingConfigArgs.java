...
public final class WorkflowTemplateJobHadoopJobLoggingConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public WorkflowTemplateJobHadoopJobLoggingConfigArgs(@Nullable Input<Map<String,String>> driverLogLevels) {
