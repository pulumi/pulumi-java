...
public class IamBinding extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.bigquery.IamBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.bigquery.IamBindingArgs.builder();
