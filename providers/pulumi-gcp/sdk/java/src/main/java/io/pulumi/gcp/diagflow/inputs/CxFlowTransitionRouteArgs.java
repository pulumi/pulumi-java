...
public final class CxFlowTransitionRouteArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setTriggerFulfillment(@Nullable Input<CxFlowTransitionRouteTriggerFulfillmentArgs> triggerFulfillment) {
            this.triggerFulfillment = triggerFulfillment;
            return this;
        }

        public Builder setTriggerFulfillment(@Nullable CxFlowTransitionRouteTriggerFulfillmentArgs triggerFulfillment) {
