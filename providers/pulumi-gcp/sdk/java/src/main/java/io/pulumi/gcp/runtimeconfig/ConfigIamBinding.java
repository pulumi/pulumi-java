...
public class ConfigIamBinding extends io.pulumi.resources.CustomResource {
     ...
     */
    public static ConfigIamBinding get(String name, Output<String> id, @Nullable ConfigIamBindingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
