...
public final class WorkflowTemplateJobPigJobArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setLoggingConfig(@Nullable Input<WorkflowTemplateJobPigJobLoggingConfigArgs> loggingConfig) {
            this.loggingConfig = loggingConfig;
            return this;
        }

        public Builder setLoggingConfig(@Nullable WorkflowTemplateJobPigJobLoggingConfigArgs loggingConfig) {
        ...
        public Builder setQueryList(@Nullable Input<WorkflowTemplateJobPigJobQueryListArgs> queryList) {
            this.queryList = queryList;
            return this;
        }

        public Builder setQueryList(@Nullable WorkflowTemplateJobPigJobQueryListArgs queryList) {
