...
public class FolderBucketConfig extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(FolderBucketConfigArgs.Builder a);
    }
    private static io.pulumi.gcp.logging.FolderBucketConfigArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.logging.FolderBucketConfigArgs.builder();
     ...
     */
    public FolderBucketConfig(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public static FolderBucketConfig get(String name, Output<String> id, @Nullable FolderBucketConfigState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
