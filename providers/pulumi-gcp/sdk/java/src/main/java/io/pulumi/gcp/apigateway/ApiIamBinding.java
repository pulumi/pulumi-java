...
public class ApiIamBinding extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ApiIamBindingArgs.Builder a);
    }
    private static io.pulumi.gcp.apigateway.ApiIamBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.apigateway.ApiIamBindingArgs.builder();
     ...
     */
    public ApiIamBinding(String name, BuilderApplicator argsBuilder) {
    ...
    public ApiIamBinding(String name) {
        this(name, ApiIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ApiIamBinding(String name, ApiIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static ApiIamBinding get(String name, Output<String> id, @Nullable ApiIamBindingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
