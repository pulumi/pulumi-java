...
@OutputCustomType
public final class DicomStoreIamBindingCondition {
    ...
    public static Builder builder(DicomStoreIamBindingCondition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DicomStoreIamBindingCondition defaults) {
