...
public class PatchDeployment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.osconfig.PatchDeploymentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.osconfig.PatchDeploymentArgs.builder();
