...
public class EntryGroupIamMember extends io.pulumi.resources.CustomResource {
    @OutputExport(name="condition", type=EntryGroupIamMemberCondition.class, parameters={})
    ...
    public EntryGroupIamMember(String name, EntryGroupIamMemberArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:datacatalog/entryGroupIamMember:EntryGroupIamMember", name, args == null ? EntryGroupIamMemberArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private EntryGroupIamMember(String name, Input<String> id, @Nullable EntryGroupIamMemberState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static EntryGroupIamMember get(String name, Input<String> id, @Nullable EntryGroupIamMemberState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
