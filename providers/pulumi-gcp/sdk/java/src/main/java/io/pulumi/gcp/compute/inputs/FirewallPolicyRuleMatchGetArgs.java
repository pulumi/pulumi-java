...
public final class FirewallPolicyRuleMatchGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public FirewallPolicyRuleMatchGetArgs(
        ...
        Input<List<FirewallPolicyRuleMatchLayer4ConfigGetArgs>> layer4Configs,
    ...
    public static final class Builder {
        ...
        private Input<List<FirewallPolicyRuleMatchLayer4ConfigGetArgs>> layer4Configs;
        ...
        public Builder setLayer4Configs(Input<List<FirewallPolicyRuleMatchLayer4ConfigGetArgs>> layer4Configs) {
            this.layer4Configs = Objects.requireNonNull(layer4Configs);
            return this;
        }

        public Builder setLayer4Configs(List<FirewallPolicyRuleMatchLayer4ConfigGetArgs> layer4Configs) {
