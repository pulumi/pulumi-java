...
public class IAMCustomRole extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.projects.IAMCustomRoleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.projects.IAMCustomRoleArgs.builder();
