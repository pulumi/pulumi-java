...
public final class CxPageEventHandlerGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<CxPageEventHandlerTriggerFulfillmentGetArgs> triggerFulfillment;

    public Input<CxPageEventHandlerTriggerFulfillmentGetArgs> getTriggerFulfillment() {
    ...
    public CxPageEventHandlerGetArgs(
        ...
        @Nullable Input<CxPageEventHandlerTriggerFulfillmentGetArgs> triggerFulfillment) {
        this.event = event;
        this.name = name;
    ...
    public static final class Builder {
        ...
        private @Nullable Input<CxPageEventHandlerTriggerFulfillmentGetArgs> triggerFulfillment;
        ...
        public Builder setTriggerFulfillment(@Nullable Input<CxPageEventHandlerTriggerFulfillmentGetArgs> triggerFulfillment) {
            this.triggerFulfillment = triggerFulfillment;
            return this;
        }

        public Builder setTriggerFulfillment(@Nullable CxPageEventHandlerTriggerFulfillmentGetArgs triggerFulfillment) {
