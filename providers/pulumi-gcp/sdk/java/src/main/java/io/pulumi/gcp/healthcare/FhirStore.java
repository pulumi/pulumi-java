...
public class FhirStore extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.healthcare.FhirStoreArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.healthcare.FhirStoreArgs.builder();
