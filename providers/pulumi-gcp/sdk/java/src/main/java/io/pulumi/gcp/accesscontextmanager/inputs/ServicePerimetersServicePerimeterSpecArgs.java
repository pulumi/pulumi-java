...
public final class ServicePerimetersServicePerimeterSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public ServicePerimetersServicePerimeterSpecArgs(
        ...
        @Nullable Input<List<ServicePerimetersServicePerimeterSpecEgressPolicyArgs>> egressPolicies,
        @Nullable Input<List<ServicePerimetersServicePerimeterSpecIngressPolicyArgs>> ingressPolicies,
        @Nullable Input<List<String>> resources,
        @Nullable Input<List<String>> restrictedServices,
        @Nullable Input<ServicePerimetersServicePerimeterSpecVpcAccessibleServicesArgs> vpcAccessibleServices) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<ServicePerimetersServicePerimeterSpecEgressPolicyArgs>> egressPolicies;
        private @Nullable Input<List<ServicePerimetersServicePerimeterSpecIngressPolicyArgs>> ingressPolicies;
        private @Nullable Input<List<String>> resources;
        private @Nullable Input<List<String>> restrictedServices;
        private @Nullable Input<ServicePerimetersServicePerimeterSpecVpcAccessibleServicesArgs> vpcAccessibleServices;
        ...
        public Builder setEgressPolicies(@Nullable Input<List<ServicePerimetersServicePerimeterSpecEgressPolicyArgs>> egressPolicies) {
            this.egressPolicies = egressPolicies;
            return this;
        }

        public Builder setEgressPolicies(@Nullable List<ServicePerimetersServicePerimeterSpecEgressPolicyArgs> egressPolicies) {
            this.egressPolicies = Input.ofNullable(egressPolicies);
            return this;
        }

        public Builder setIngressPolicies(@Nullable Input<List<ServicePerimetersServicePerimeterSpecIngressPolicyArgs>> ingressPolicies) {
            this.ingressPolicies = ingressPolicies;
            return this;
        }

        public Builder setIngressPolicies(@Nullable List<ServicePerimetersServicePerimeterSpecIngressPolicyArgs> ingressPolicies) {
        ...
        public Builder setVpcAccessibleServices(@Nullable Input<ServicePerimetersServicePerimeterSpecVpcAccessibleServicesArgs> vpcAccessibleServices) {
            this.vpcAccessibleServices = vpcAccessibleServices;
            return this;
        }

        public Builder setVpcAccessibleServices(@Nullable ServicePerimetersServicePerimeterSpecVpcAccessibleServicesArgs vpcAccessibleServices) {
