...
public final class URLMapPathMatcherRouteRuleMatchRuleHeaderMatchArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public URLMapPathMatcherRouteRuleMatchRuleHeaderMatchArgs(
        ...
        @Nullable Input<URLMapPathMatcherRouteRuleMatchRuleHeaderMatchRangeMatchArgs> rangeMatch,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<URLMapPathMatcherRouteRuleMatchRuleHeaderMatchRangeMatchArgs> rangeMatch;
        ...
        public Builder setRangeMatch(@Nullable Input<URLMapPathMatcherRouteRuleMatchRuleHeaderMatchRangeMatchArgs> rangeMatch) {
            this.rangeMatch = rangeMatch;
            return this;
        }

        public Builder setRangeMatch(@Nullable URLMapPathMatcherRouteRuleMatchRuleHeaderMatchRangeMatchArgs rangeMatch) {
