...
public final class FlexibleAppVersionHandlerArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setScript(@Nullable Input<FlexibleAppVersionHandlerScriptArgs> script) {
            this.script = script;
            return this;
        }

        public Builder setScript(@Nullable FlexibleAppVersionHandlerScriptArgs script) {
        ...
        public Builder setStaticFiles(@Nullable Input<FlexibleAppVersionHandlerStaticFilesArgs> staticFiles) {
            this.staticFiles = staticFiles;
            return this;
        }

        public Builder setStaticFiles(@Nullable FlexibleAppVersionHandlerStaticFilesArgs staticFiles) {
