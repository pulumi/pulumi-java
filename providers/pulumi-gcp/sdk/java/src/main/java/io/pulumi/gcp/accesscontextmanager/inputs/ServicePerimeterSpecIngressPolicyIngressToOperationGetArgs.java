...
public final class ServicePerimeterSpecIngressPolicyIngressToOperationGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setMethodSelectors(@Nullable Input<List<ServicePerimeterSpecIngressPolicyIngressToOperationMethodSelectorGetArgs>> methodSelectors) {
            this.methodSelectors = methodSelectors;
            return this;
        }

        public Builder setMethodSelectors(@Nullable List<ServicePerimeterSpecIngressPolicyIngressToOperationMethodSelectorGetArgs> methodSelectors) {
