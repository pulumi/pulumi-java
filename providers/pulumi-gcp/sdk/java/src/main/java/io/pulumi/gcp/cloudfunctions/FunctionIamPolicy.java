...
public class FunctionIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.cloudfunctions.FunctionIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.cloudfunctions.FunctionIamPolicyArgs.builder();
