...
public final class WorkflowTemplateJobSparkSqlJobLoggingConfigGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public WorkflowTemplateJobSparkSqlJobLoggingConfigGetArgs(@Nullable Input<Map<String,String>> driverLogLevels) {
