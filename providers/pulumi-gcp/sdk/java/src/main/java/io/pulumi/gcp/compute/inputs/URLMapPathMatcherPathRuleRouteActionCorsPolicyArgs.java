...
public final class URLMapPathMatcherPathRuleRouteActionCorsPolicyArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public URLMapPathMatcherPathRuleRouteActionCorsPolicyArgs build() {
            return new URLMapPathMatcherPathRuleRouteActionCorsPolicyArgs(allowCredentials, allowHeaders, allowMethods, allowOriginRegexes, allowOrigins, disabled, exposeHeaders, maxAge);
        }
    }
}
