...
public class HealthCheck extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.HealthCheckArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.HealthCheckArgs.builder();
