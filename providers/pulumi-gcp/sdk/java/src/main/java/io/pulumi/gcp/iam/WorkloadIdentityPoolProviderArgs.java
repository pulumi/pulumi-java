...
public final class WorkloadIdentityPoolProviderArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Output<WorkloadIdentityPoolProviderAwsArgs> aws() {
    ...
    public Output<WorkloadIdentityPoolProviderOidcArgs> oidc() {
    ...
    public WorkloadIdentityPoolProviderArgs(
        ...
        @Nullable Output<WorkloadIdentityPoolProviderAwsArgs> aws,
        @Nullable Output<String> description,
        @Nullable Output<Boolean> disabled,
        @Nullable Output<String> displayName,
        @Nullable Output<WorkloadIdentityPoolProviderOidcArgs> oidc,
