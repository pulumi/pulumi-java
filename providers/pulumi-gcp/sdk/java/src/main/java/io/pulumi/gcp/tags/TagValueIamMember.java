...
public class TagValueIamMember extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(TagValueIamMemberArgs.Builder a);
    }
    private static io.pulumi.gcp.tags.TagValueIamMemberArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.tags.TagValueIamMemberArgs.builder();
     ...
     */
    public TagValueIamMember(String name, BuilderApplicator argsBuilder) {
    ...
    public TagValueIamMember(String name, TagValueIamMemberArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:tags/tagValueIamMember:TagValueIamMember", name, args == null ? TagValueIamMemberArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private TagValueIamMember(String name, Output<String> id, @Nullable TagValueIamMemberState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TagValueIamMember get(String name, Output<String> id, @Nullable TagValueIamMemberState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
