...
public final class ServicePerimetersServicePerimeterSpecIngressPolicyIngressToGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Input<List<ServicePerimetersServicePerimeterSpecIngressPolicyIngressToOperationGetArgs>> getOperations() {
    ...
    public ServicePerimetersServicePerimeterSpecIngressPolicyIngressToGetArgs(
        @Nullable Input<List<ServicePerimetersServicePerimeterSpecIngressPolicyIngressToOperationGetArgs>> operations,
    ...
    public static final class Builder {
        private @Nullable Input<List<ServicePerimetersServicePerimeterSpecIngressPolicyIngressToOperationGetArgs>> operations;
        ...
        public Builder setOperations(@Nullable Input<List<ServicePerimetersServicePerimeterSpecIngressPolicyIngressToOperationGetArgs>> operations) {
            this.operations = operations;
            return this;
        }

        public Builder setOperations(@Nullable List<ServicePerimetersServicePerimeterSpecIngressPolicyIngressToOperationGetArgs> operations) {
