...
public class Gateway extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.apigateway.GatewayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.apigateway.GatewayArgs.builder();
