...
public class DicomStoreIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(DicomStoreIamPolicyArgs.Builder a);
    }
    private static io.pulumi.gcp.healthcare.DicomStoreIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.healthcare.DicomStoreIamPolicyArgs.builder();
     ...
     */
    public DicomStoreIamPolicy(String name, BuilderApplicator argsBuilder) {
    ...
    public DicomStoreIamPolicy(String name, DicomStoreIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:healthcare/dicomStoreIamPolicy:DicomStoreIamPolicy", name, args == null ? DicomStoreIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private DicomStoreIamPolicy(String name, Output<String> id, @Nullable DicomStoreIamPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static DicomStoreIamPolicy get(String name, Output<String> id, @Nullable DicomStoreIamPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
