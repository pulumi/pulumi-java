...
public class InstanceIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.bigtable.InstanceIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.bigtable.InstanceIamPolicyArgs.builder();
    ...
    public InstanceIamPolicy(String name, InstanceIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigtable/instanceIamPolicy:InstanceIamPolicy", name, args == null ? InstanceIamPolicyArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
