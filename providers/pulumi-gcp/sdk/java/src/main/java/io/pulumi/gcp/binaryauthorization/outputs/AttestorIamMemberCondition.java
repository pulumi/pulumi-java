...
@CustomType
public final class AttestorIamMemberCondition {
    ...
    public static Builder builder(AttestorIamMemberCondition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AttestorIamMemberCondition defaults) {
