...
public final class AutoscalarAutoscalingPolicyScaleDownControlMaxScaledDownReplicasGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final AutoscalarAutoscalingPolicyScaleDownControlMaxScaledDownReplicasGetArgs Empty = new AutoscalarAutoscalingPolicyScaleDownControlMaxScaledDownReplicasGetArgs();
    ...
    public AutoscalarAutoscalingPolicyScaleDownControlMaxScaledDownReplicasGetArgs(
    ...
    private AutoscalarAutoscalingPolicyScaleDownControlMaxScaledDownReplicasGetArgs() {
    ...
    public static Builder builder(AutoscalarAutoscalingPolicyScaleDownControlMaxScaledDownReplicasGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AutoscalarAutoscalingPolicyScaleDownControlMaxScaledDownReplicasGetArgs defaults) {
