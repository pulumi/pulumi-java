...
public class TagTemplate extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.datacatalog.TagTemplateArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.datacatalog.TagTemplateArgs.builder();
