...
public class SourceRepresentationInstance extends io.pulumi.resources.CustomResource {
     ...
     */
    public static SourceRepresentationInstance get(String name, Output<String> id, @Nullable SourceRepresentationInstanceState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
