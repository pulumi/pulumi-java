...
public class SourceRepresentationInstance extends io.pulumi.resources.CustomResource {
    ...
    public SourceRepresentationInstance(String name) {
        super("gcp:sql/sourceRepresentationInstance:SourceRepresentationInstance", name, SourceRepresentationInstanceArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
