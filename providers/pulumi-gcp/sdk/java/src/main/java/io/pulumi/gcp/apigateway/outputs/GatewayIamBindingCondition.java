...
@OutputCustomType
public final class GatewayIamBindingCondition {
    private final @Nullable String description;
    private final String expression;
    private final String title;

    @OutputCustomType.Constructor({"description","expression","title"})
    private GatewayIamBindingCondition(
    ...
    public static Builder builder(GatewayIamBindingCondition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GatewayIamBindingCondition defaults) {
