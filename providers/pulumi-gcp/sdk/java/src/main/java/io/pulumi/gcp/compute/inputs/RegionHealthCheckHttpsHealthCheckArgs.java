...
public final class RegionHealthCheckHttpsHealthCheckArgs extends io.pulumi.resources.ResourceArgs {

    public static final RegionHealthCheckHttpsHealthCheckArgs Empty = new RegionHealthCheckHttpsHealthCheckArgs();
    ...
    private RegionHealthCheckHttpsHealthCheckArgs() {
    ...
    public static Builder builder(RegionHealthCheckHttpsHealthCheckArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RegionHealthCheckHttpsHealthCheckArgs defaults) {
        ...
        public Builder response(@Nullable String response) {
            ...
            return this;
        }        public RegionHealthCheckHttpsHealthCheckArgs build() {
            return new RegionHealthCheckHttpsHealthCheckArgs(host, port, portName, portSpecification, proxyHeader, requestPath, response);
        }
    }
}
