...
public final class InstanceFromMachineImageSchedulingNodeAffinityArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public InstanceFromMachineImageSchedulingNodeAffinityArgs(
        Output<String> key,
