...
public class IAMBinding extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.projects.IAMBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.projects.IAMBindingArgs.builder();
