...
public final class CertificateTemplatePredefinedValuesKeyUsageBaseKeyUsageGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final CertificateTemplatePredefinedValuesKeyUsageBaseKeyUsageGetArgs Empty = new CertificateTemplatePredefinedValuesKeyUsageBaseKeyUsageGetArgs();
    ...
    public CertificateTemplatePredefinedValuesKeyUsageBaseKeyUsageGetArgs(
    ...
    private CertificateTemplatePredefinedValuesKeyUsageBaseKeyUsageGetArgs() {
    ...
    public static Builder builder(CertificateTemplatePredefinedValuesKeyUsageBaseKeyUsageGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CertificateTemplatePredefinedValuesKeyUsageBaseKeyUsageGetArgs defaults) {
        ...
        public Builder keyEncipherment(@Nullable Boolean keyEncipherment) {
            ...
            return this;
        }        public CertificateTemplatePredefinedValuesKeyUsageBaseKeyUsageGetArgs build() {
            return new CertificateTemplatePredefinedValuesKeyUsageBaseKeyUsageGetArgs(certSign, contentCommitment, crlSign, dataEncipherment, decipherOnly, digitalSignature, encipherOnly, keyAgreement, keyEncipherment);
        }
    }
}
