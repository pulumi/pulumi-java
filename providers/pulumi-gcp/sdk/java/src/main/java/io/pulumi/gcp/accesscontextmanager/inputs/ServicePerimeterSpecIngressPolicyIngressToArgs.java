...
public final class ServicePerimeterSpecIngressPolicyIngressToArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="operations")
      private final @Nullable Output<List<ServicePerimeterSpecIngressPolicyIngressToOperationArgs>> operations;

    public Output<List<ServicePerimeterSpecIngressPolicyIngressToOperationArgs>> getOperations() {
    ...
    public ServicePerimeterSpecIngressPolicyIngressToArgs(
        @Nullable Output<List<ServicePerimeterSpecIngressPolicyIngressToOperationArgs>> operations,
