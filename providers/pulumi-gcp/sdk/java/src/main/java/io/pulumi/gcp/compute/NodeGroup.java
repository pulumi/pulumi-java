...
public class NodeGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.NodeGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.NodeGroupArgs.builder();
