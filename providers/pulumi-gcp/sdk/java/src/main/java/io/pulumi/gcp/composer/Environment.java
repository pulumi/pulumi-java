...
public class Environment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.composer.EnvironmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.composer.EnvironmentArgs.builder();
