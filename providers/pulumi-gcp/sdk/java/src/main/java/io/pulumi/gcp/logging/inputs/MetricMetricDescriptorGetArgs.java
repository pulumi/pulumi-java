...
public final class MetricMetricDescriptorGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setLabels(@Nullable Input<List<MetricMetricDescriptorLabelGetArgs>> labels) {
            this.labels = labels;
            return this;
        }

        public Builder setLabels(@Nullable List<MetricMetricDescriptorLabelGetArgs> labels) {
