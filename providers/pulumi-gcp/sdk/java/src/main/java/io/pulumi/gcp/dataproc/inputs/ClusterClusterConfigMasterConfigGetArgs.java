...
public final class ClusterClusterConfigMasterConfigGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Output<List<ClusterClusterConfigMasterConfigAcceleratorGetArgs>> getAccelerators() {
    ...
    public Output<ClusterClusterConfigMasterConfigDiskConfigGetArgs> getDiskConfig() {
