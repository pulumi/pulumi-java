...
public final class ClusterClusterConfigMasterConfigGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setAccelerators(@Nullable Input<List<ClusterClusterConfigMasterConfigAcceleratorGetArgs>> accelerators) {
            this.accelerators = accelerators;
            return this;
        }

        public Builder setAccelerators(@Nullable List<ClusterClusterConfigMasterConfigAcceleratorGetArgs> accelerators) {
            this.accelerators = Input.ofNullable(accelerators);
            return this;
        }

        public Builder setDiskConfig(@Nullable Input<ClusterClusterConfigMasterConfigDiskConfigGetArgs> diskConfig) {
            this.diskConfig = diskConfig;
            return this;
        }

        public Builder setDiskConfig(@Nullable ClusterClusterConfigMasterConfigDiskConfigGetArgs diskConfig) {
