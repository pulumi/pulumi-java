...
public final class ClusterAddonsConfigConfigConnectorConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public ClusterAddonsConfigConfigConnectorConfigArgs(Output<Boolean> enabled) {
