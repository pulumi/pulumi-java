...
import io.pulumi.gcp.bigquery.inputs.JobLoadDestinationEncryptionConfigurationArgs;
import io.pulumi.gcp.bigquery.inputs.JobLoadDestinationTableArgs;
import io.pulumi.gcp.bigquery.inputs.JobLoadTimePartitioningArgs;
...
public final class JobLoadArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="destinationEncryptionConfiguration")
        private final @Nullable Input<JobLoadDestinationEncryptionConfigurationArgs> destinationEncryptionConfiguration;

    public Input<JobLoadDestinationEncryptionConfigurationArgs> getDestinationEncryptionConfiguration() {
    ...
    @InputImport(name="destinationTable", required=true)
        private final Input<JobLoadDestinationTableArgs> destinationTable;

    public Input<JobLoadDestinationTableArgs> getDestinationTable() {
    ...
    @InputImport(name="timePartitioning")
        private final @Nullable Input<JobLoadTimePartitioningArgs> timePartitioning;

    public Input<JobLoadTimePartitioningArgs> getTimePartitioning() {
    ...
    public JobLoadArgs(
        ...
        @Nullable Input<JobLoadDestinationEncryptionConfigurationArgs> destinationEncryptionConfiguration,
        Input<JobLoadDestinationTableArgs> destinationTable,
        ...
        @Nullable Input<JobLoadTimePartitioningArgs> timePartitioning,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<JobLoadDestinationEncryptionConfigurationArgs> destinationEncryptionConfiguration;
        private Input<JobLoadDestinationTableArgs> destinationTable;
        ...
        private @Nullable Input<JobLoadTimePartitioningArgs> timePartitioning;
        ...
        public Builder setDestinationEncryptionConfiguration(@Nullable Input<JobLoadDestinationEncryptionConfigurationArgs> destinationEncryptionConfiguration) {
            this.destinationEncryptionConfiguration = destinationEncryptionConfiguration;
            return this;
        }

        public Builder setDestinationEncryptionConfiguration(@Nullable JobLoadDestinationEncryptionConfigurationArgs destinationEncryptionConfiguration) {
            this.destinationEncryptionConfiguration = Input.ofNullable(destinationEncryptionConfiguration);
            return this;
        }

        public Builder setDestinationTable(Input<JobLoadDestinationTableArgs> destinationTable) {
            this.destinationTable = Objects.requireNonNull(destinationTable);
            return this;
        }

        public Builder setDestinationTable(JobLoadDestinationTableArgs destinationTable) {
        ...
        public Builder setTimePartitioning(@Nullable Input<JobLoadTimePartitioningArgs> timePartitioning) {
            this.timePartitioning = timePartitioning;
            return this;
        }

        public Builder setTimePartitioning(@Nullable JobLoadTimePartitioningArgs timePartitioning) {
