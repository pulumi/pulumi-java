...
public final class ImageIamMemberState extends io.pulumi.resources.ResourceArgs {
    ...
    public ImageIamMemberState(
        @Nullable Input<ImageIamMemberConditionGetArgs> condition,
    ...
    public static final class Builder {
        private @Nullable Input<ImageIamMemberConditionGetArgs> condition;
        ...
        public Builder setCondition(@Nullable Input<ImageIamMemberConditionGetArgs> condition) {
            this.condition = condition;
            return this;
        }

        public Builder setCondition(@Nullable ImageIamMemberConditionGetArgs condition) {
