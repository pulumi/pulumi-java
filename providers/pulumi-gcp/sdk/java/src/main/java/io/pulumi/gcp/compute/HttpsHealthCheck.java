...
public class HttpsHealthCheck extends io.pulumi.resources.CustomResource {
    ...
    public HttpsHealthCheck(String name, @Nullable HttpsHealthCheckArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/httpsHealthCheck:HttpsHealthCheck", name, args == null ? HttpsHealthCheckArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private HttpsHealthCheck(String name, Input<String> id, @Nullable HttpsHealthCheckState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static HttpsHealthCheck get(String name, Input<String> id, @Nullable HttpsHealthCheckState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
