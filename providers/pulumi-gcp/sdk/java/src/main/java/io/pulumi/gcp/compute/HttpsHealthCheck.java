...
public class HttpsHealthCheck extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.HttpsHealthCheckArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.HttpsHealthCheckArgs.builder();
    ...
    public HttpsHealthCheck(String name, @Nullable HttpsHealthCheckArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/httpsHealthCheck:HttpsHealthCheck", name, args == null ? HttpsHealthCheckArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private HttpsHealthCheck(String name, Output<String> id, @Nullable HttpsHealthCheckState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static HttpsHealthCheck get(String name, Output<String> id, @Nullable HttpsHealthCheckState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
