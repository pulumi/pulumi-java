...
public final class EnvironmentConfigNodeConfigGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setIpAllocationPolicy(@Nullable Input<EnvironmentConfigNodeConfigIpAllocationPolicyGetArgs> ipAllocationPolicy) {
            this.ipAllocationPolicy = ipAllocationPolicy;
            return this;
        }

        public Builder setIpAllocationPolicy(@Nullable EnvironmentConfigNodeConfigIpAllocationPolicyGetArgs ipAllocationPolicy) {
