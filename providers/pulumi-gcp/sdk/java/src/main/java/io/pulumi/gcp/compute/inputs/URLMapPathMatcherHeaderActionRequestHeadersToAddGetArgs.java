...
public final class URLMapPathMatcherHeaderActionRequestHeadersToAddGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final URLMapPathMatcherHeaderActionRequestHeadersToAddGetArgs Empty = new URLMapPathMatcherHeaderActionRequestHeadersToAddGetArgs();
    ...
    public URLMapPathMatcherHeaderActionRequestHeadersToAddGetArgs(
    ...
    private URLMapPathMatcherHeaderActionRequestHeadersToAddGetArgs() {
    ...
    public static Builder builder(URLMapPathMatcherHeaderActionRequestHeadersToAddGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(URLMapPathMatcherHeaderActionRequestHeadersToAddGetArgs defaults) {
        ...
        public URLMapPathMatcherHeaderActionRequestHeadersToAddGetArgs build() {
            return new URLMapPathMatcherHeaderActionRequestHeadersToAddGetArgs(headerName, headerValue, replace);
        }
    }
}
