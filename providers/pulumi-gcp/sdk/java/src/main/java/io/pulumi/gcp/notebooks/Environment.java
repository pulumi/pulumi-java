...
public class Environment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.notebooks.EnvironmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.notebooks.EnvironmentArgs.builder();
