...
public final class FolderSinkBigqueryOptionsArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public FolderSinkBigqueryOptionsArgs(Input<Boolean> usePartitionedTables) {
