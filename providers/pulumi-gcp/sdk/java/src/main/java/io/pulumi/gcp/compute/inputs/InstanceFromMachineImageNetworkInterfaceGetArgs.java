...
public final class InstanceFromMachineImageNetworkInterfaceGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="accessConfigs")
        private final @Nullable Input<List<InstanceFromMachineImageNetworkInterfaceAccessConfigGetArgs>> accessConfigs;

    public Input<List<InstanceFromMachineImageNetworkInterfaceAccessConfigGetArgs>> getAccessConfigs() {
        return this.accessConfigs == null ? Input.empty() : this.accessConfigs;
    }

    @InputImport(name="aliasIpRanges")
        private final @Nullable Input<List<InstanceFromMachineImageNetworkInterfaceAliasIpRangeGetArgs>> aliasIpRanges;

    public Input<List<InstanceFromMachineImageNetworkInterfaceAliasIpRangeGetArgs>> getAliasIpRanges() {
        return this.aliasIpRanges == null ? Input.empty() : this.aliasIpRanges;
    }

    @InputImport(name="ipv6AccessConfigs")
        private final @Nullable Input<List<InstanceFromMachineImageNetworkInterfaceIpv6AccessConfigGetArgs>> ipv6AccessConfigs;

    public Input<List<InstanceFromMachineImageNetworkInterfaceIpv6AccessConfigGetArgs>> getIpv6AccessConfigs() {
    ...
    public InstanceFromMachineImageNetworkInterfaceGetArgs(
        @Nullable Input<List<InstanceFromMachineImageNetworkInterfaceAccessConfigGetArgs>> accessConfigs,
        @Nullable Input<List<InstanceFromMachineImageNetworkInterfaceAliasIpRangeGetArgs>> aliasIpRanges,
        @Nullable Input<List<InstanceFromMachineImageNetworkInterfaceIpv6AccessConfigGetArgs>> ipv6AccessConfigs,
    ...
    public static final class Builder {
        private @Nullable Input<List<InstanceFromMachineImageNetworkInterfaceAccessConfigGetArgs>> accessConfigs;
        private @Nullable Input<List<InstanceFromMachineImageNetworkInterfaceAliasIpRangeGetArgs>> aliasIpRanges;
        private @Nullable Input<List<InstanceFromMachineImageNetworkInterfaceIpv6AccessConfigGetArgs>> ipv6AccessConfigs;
        ...
        public Builder setAccessConfigs(@Nullable Input<List<InstanceFromMachineImageNetworkInterfaceAccessConfigGetArgs>> accessConfigs) {
            this.accessConfigs = accessConfigs;
            return this;
        }

        public Builder setAccessConfigs(@Nullable List<InstanceFromMachineImageNetworkInterfaceAccessConfigGetArgs> accessConfigs) {
            this.accessConfigs = Input.ofNullable(accessConfigs);
            return this;
        }

        public Builder setAliasIpRanges(@Nullable Input<List<InstanceFromMachineImageNetworkInterfaceAliasIpRangeGetArgs>> aliasIpRanges) {
            this.aliasIpRanges = aliasIpRanges;
            return this;
        }

        public Builder setAliasIpRanges(@Nullable List<InstanceFromMachineImageNetworkInterfaceAliasIpRangeGetArgs> aliasIpRanges) {
            this.aliasIpRanges = Input.ofNullable(aliasIpRanges);
            return this;
        }

        public Builder setIpv6AccessConfigs(@Nullable Input<List<InstanceFromMachineImageNetworkInterfaceIpv6AccessConfigGetArgs>> ipv6AccessConfigs) {
            this.ipv6AccessConfigs = ipv6AccessConfigs;
            return this;
        }

        public Builder setIpv6AccessConfigs(@Nullable List<InstanceFromMachineImageNetworkInterfaceIpv6AccessConfigGetArgs> ipv6AccessConfigs) {
