...
public final class InstanceTemplateNetworkInterfaceGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Input<List<InstanceTemplateNetworkInterfaceAccessConfigGetArgs>> getAccessConfigs() {
    ...
    public Input<List<InstanceTemplateNetworkInterfaceAliasIpRangeGetArgs>> getAliasIpRanges() {
    ...
    public Input<List<InstanceTemplateNetworkInterfaceIpv6AccessConfigGetArgs>> getIpv6AccessConfigs() {
    ...
    public InstanceTemplateNetworkInterfaceGetArgs(
        @Nullable Input<List<InstanceTemplateNetworkInterfaceAccessConfigGetArgs>> accessConfigs,
        @Nullable Input<List<InstanceTemplateNetworkInterfaceAliasIpRangeGetArgs>> aliasIpRanges,
        @Nullable Input<List<InstanceTemplateNetworkInterfaceIpv6AccessConfigGetArgs>> ipv6AccessConfigs,
    ...
    public static final class Builder {
        private @Nullable Input<List<InstanceTemplateNetworkInterfaceAccessConfigGetArgs>> accessConfigs;
        private @Nullable Input<List<InstanceTemplateNetworkInterfaceAliasIpRangeGetArgs>> aliasIpRanges;
        private @Nullable Input<List<InstanceTemplateNetworkInterfaceIpv6AccessConfigGetArgs>> ipv6AccessConfigs;
        ...
        public Builder setAccessConfigs(@Nullable Input<List<InstanceTemplateNetworkInterfaceAccessConfigGetArgs>> accessConfigs) {
            this.accessConfigs = accessConfigs;
            return this;
        }

        public Builder setAccessConfigs(@Nullable List<InstanceTemplateNetworkInterfaceAccessConfigGetArgs> accessConfigs) {
            this.accessConfigs = Input.ofNullable(accessConfigs);
            return this;
        }

        public Builder setAliasIpRanges(@Nullable Input<List<InstanceTemplateNetworkInterfaceAliasIpRangeGetArgs>> aliasIpRanges) {
            this.aliasIpRanges = aliasIpRanges;
            return this;
        }

        public Builder setAliasIpRanges(@Nullable List<InstanceTemplateNetworkInterfaceAliasIpRangeGetArgs> aliasIpRanges) {
            this.aliasIpRanges = Input.ofNullable(aliasIpRanges);
            return this;
        }

        public Builder setIpv6AccessConfigs(@Nullable Input<List<InstanceTemplateNetworkInterfaceIpv6AccessConfigGetArgs>> ipv6AccessConfigs) {
            this.ipv6AccessConfigs = ipv6AccessConfigs;
            return this;
        }

        public Builder setIpv6AccessConfigs(@Nullable List<InstanceTemplateNetworkInterfaceIpv6AccessConfigGetArgs> ipv6AccessConfigs) {
