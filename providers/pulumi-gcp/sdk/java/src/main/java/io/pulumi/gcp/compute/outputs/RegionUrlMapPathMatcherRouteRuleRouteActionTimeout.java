...
@OutputCustomType
public final class RegionUrlMapPathMatcherRouteRuleRouteActionTimeout {
    /**
    ...
    private RegionUrlMapPathMatcherRouteRuleRouteActionTimeout(
    ...
    public static Builder builder(RegionUrlMapPathMatcherRouteRuleRouteActionTimeout defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RegionUrlMapPathMatcherRouteRuleRouteActionTimeout defaults) {
