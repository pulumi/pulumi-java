...
public class SecurityScanConfig extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(SecurityScanConfigArgs.Builder a);
    }
    private static io.pulumi.gcp.compute.SecurityScanConfigArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.SecurityScanConfigArgs.builder();
     ...
     */
    public SecurityScanConfig(String name, BuilderApplicator argsBuilder) {
