...
public class RegionAutoscaler extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.RegionAutoscalerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.RegionAutoscalerArgs.builder();
