...
public class SslCert extends io.pulumi.resources.CustomResource {
    ...
    public SslCert(String name) {
        super("gcp:sql/sslCert:SslCert", name, SslCertArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    private SslCert(String name, Input<String> id, @Nullable SslCertState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
