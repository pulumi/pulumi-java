...
public final class BackendServiceOutlierDetectionArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder baseEjectionTime(@Nullable Input<BackendServiceOutlierDetectionBaseEjectionTimeArgs> baseEjectionTime) {
            this.baseEjectionTime = baseEjectionTime;
            return this;
        }
        ...
        public Builder interval(@Nullable Input<BackendServiceOutlierDetectionIntervalArgs> interval) {
            this.interval = interval;
            return this;
        }
