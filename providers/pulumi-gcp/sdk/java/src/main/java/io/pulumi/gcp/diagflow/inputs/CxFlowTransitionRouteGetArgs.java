...
public final class CxFlowTransitionRouteGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setTriggerFulfillment(@Nullable Input<CxFlowTransitionRouteTriggerFulfillmentGetArgs> triggerFulfillment) {
            this.triggerFulfillment = triggerFulfillment;
            return this;
        }

        public Builder setTriggerFulfillment(@Nullable CxFlowTransitionRouteTriggerFulfillmentGetArgs triggerFulfillment) {
