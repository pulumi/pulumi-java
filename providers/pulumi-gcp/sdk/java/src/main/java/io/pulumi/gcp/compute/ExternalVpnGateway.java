...
public class ExternalVpnGateway extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.ExternalVpnGatewayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.ExternalVpnGatewayArgs.builder();
