...
public final class WorkflowTemplateJobSparkSqlJobGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder loggingConfig(@Nullable Input<WorkflowTemplateJobSparkSqlJobLoggingConfigGetArgs> loggingConfig) {
            this.loggingConfig = loggingConfig;
            return this;
        }
        ...
        public Builder queryList(@Nullable Input<WorkflowTemplateJobSparkSqlJobQueryListGetArgs> queryList) {
            this.queryList = queryList;
            return this;
        }
