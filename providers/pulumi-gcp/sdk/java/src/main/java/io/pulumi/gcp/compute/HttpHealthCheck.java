...
public class HttpHealthCheck extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.HttpHealthCheckArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.HttpHealthCheckArgs.builder();
