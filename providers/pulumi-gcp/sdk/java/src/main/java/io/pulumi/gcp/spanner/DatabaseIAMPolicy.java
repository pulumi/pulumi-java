...
public class DatabaseIAMPolicy extends io.pulumi.resources.CustomResource {
     ...
     */
    public static DatabaseIAMPolicy get(String name, Output<String> id, @Nullable DatabaseIAMPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
