...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcsGetArgs> gcs;

    public Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcsGetArgs> getGcs() {
    ...
    private final @Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileRemoteGetArgs> remote;

    public Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileRemoteGetArgs> getRemote() {
    ...
    public OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGetArgs(
        ...
        @Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcsGetArgs> gcs,
        @Nullable Input<String> localPath,
        @Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileRemoteGetArgs> remote) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcsGetArgs> gcs;
        private @Nullable Input<String> localPath;
        private @Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileRemoteGetArgs> remote;
        ...
        public Builder setGcs(@Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcsGetArgs> gcs) {
            this.gcs = gcs;
            return this;
        }

        public Builder setGcs(@Nullable OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcsGetArgs gcs) {
        ...
        public Builder setRemote(@Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileRemoteGetArgs> remote) {
            this.remote = remote;
            return this;
        }

        public Builder setRemote(@Nullable OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileRemoteGetArgs remote) {
