...
public class BackendBucket extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(BackendBucketArgs.Builder a);
    }
    private static io.pulumi.gcp.compute.BackendBucketArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.BackendBucketArgs.builder();
