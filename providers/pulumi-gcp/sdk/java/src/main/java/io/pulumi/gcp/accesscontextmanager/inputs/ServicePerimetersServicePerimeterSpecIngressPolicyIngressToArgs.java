...
public final class ServicePerimetersServicePerimeterSpecIngressPolicyIngressToArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @Import(name="operations")
      private final @Nullable Output<List<ServicePerimetersServicePerimeterSpecIngressPolicyIngressToOperationArgs>> operations;

    public Output<List<ServicePerimetersServicePerimeterSpecIngressPolicyIngressToOperationArgs>> getOperations() {
    ...
    public ServicePerimetersServicePerimeterSpecIngressPolicyIngressToArgs(
        @Nullable Output<List<ServicePerimetersServicePerimeterSpecIngressPolicyIngressToOperationArgs>> operations,
    ...
    public static final class Builder {
        private @Nullable Output<List<ServicePerimetersServicePerimeterSpecIngressPolicyIngressToOperationArgs>> operations;
        ...
        public Builder operations(@Nullable Output<List<ServicePerimetersServicePerimeterSpecIngressPolicyIngressToOperationArgs>> operations) {
            this.operations = operations;
            return this;
        }
        ...
        public Builder operations(ServicePerimetersServicePerimeterSpecIngressPolicyIngressToOperationArgs... operations) {
