...
public final class ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourceGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourceGetArgs Empty = new ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourceGetArgs();
    ...
    private ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourceGetArgs() {
    ...
    public static Builder builder(ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourceGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourceGetArgs defaults) {
        ...
        public ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourceGetArgs build() {
            return new ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourceGetArgs(accessLevel, resource);
        }
    }
}
