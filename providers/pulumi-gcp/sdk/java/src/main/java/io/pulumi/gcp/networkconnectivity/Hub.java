...
public class Hub extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.networkconnectivity.HubArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.networkconnectivity.HubArgs.builder();
     ...
     */
    public static Hub get(String name, Output<String> id, @Nullable HubState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
