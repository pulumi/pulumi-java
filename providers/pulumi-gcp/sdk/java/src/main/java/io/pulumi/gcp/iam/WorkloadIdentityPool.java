...
public class WorkloadIdentityPool extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(WorkloadIdentityPoolArgs.Builder a);
    }
    private static io.pulumi.gcp.iam.WorkloadIdentityPoolArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.iam.WorkloadIdentityPoolArgs.builder();
     ...
     */
    public WorkloadIdentityPool(String name, BuilderApplicator argsBuilder) {
    ...
    public WorkloadIdentityPool(String name, WorkloadIdentityPoolArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iam/workloadIdentityPool:WorkloadIdentityPool", name, args == null ? WorkloadIdentityPoolArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private WorkloadIdentityPool(String name, Output<String> id, @Nullable WorkloadIdentityPoolState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static WorkloadIdentityPool get(String name, Output<String> id, @Nullable WorkloadIdentityPoolState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
