...
public class TopicIAMBinding extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(TopicIAMBindingArgs.Builder a);
    }
    private static io.pulumi.gcp.pubsub.TopicIAMBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.pubsub.TopicIAMBindingArgs.builder();
     ...
     */
    public TopicIAMBinding(String name, BuilderApplicator argsBuilder) {
