...
public class IAMPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.organizations.IAMPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.organizations.IAMPolicyArgs.builder();
