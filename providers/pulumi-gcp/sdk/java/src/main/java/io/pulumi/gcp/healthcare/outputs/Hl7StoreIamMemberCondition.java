...
@OutputCustomType
public final class Hl7StoreIamMemberCondition {
    ...
    public static Builder builder(Hl7StoreIamMemberCondition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(Hl7StoreIamMemberCondition defaults) {
