...
public class WebBackendServiceIamMember extends io.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="condition", type=WebBackendServiceIamMemberCondition.class, parameters={})
     ...
     * 
     */
    public Output</* @Nullable */ WebBackendServiceIamMemberCondition> condition() {
     ...
     */
    public static WebBackendServiceIamMember get(String name, Output<String> id, @Nullable WebBackendServiceIamMemberState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
