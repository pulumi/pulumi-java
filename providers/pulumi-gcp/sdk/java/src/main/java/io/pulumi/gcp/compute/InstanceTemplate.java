...
public class InstanceTemplate extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(InstanceTemplateArgs.Builder a);
    }
    private static io.pulumi.gcp.compute.InstanceTemplateArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.InstanceTemplateArgs.builder();
    ...
    public InstanceTemplate(String name, InstanceTemplateArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/instanceTemplate:InstanceTemplate", name, args == null ? InstanceTemplateArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
