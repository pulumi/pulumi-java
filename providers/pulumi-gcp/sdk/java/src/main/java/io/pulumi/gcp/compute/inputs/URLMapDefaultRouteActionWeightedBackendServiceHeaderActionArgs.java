...
public final class URLMapDefaultRouteActionWeightedBackendServiceHeaderActionArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder requestHeadersToAdds(@Nullable Input<List<URLMapDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs>> requestHeadersToAdds) {
            this.requestHeadersToAdds = requestHeadersToAdds;
            return this;
        }
        ...
        public Builder responseHeadersToAdds(@Nullable Input<List<URLMapDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAddArgs>> responseHeadersToAdds) {
            this.responseHeadersToAdds = responseHeadersToAdds;
            return this;
        }
