...
public class Contact extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.essentialcontacts.ContactArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.essentialcontacts.ContactArgs.builder();
