...
public final class ServicePerimetersServicePerimeterStatusEgressPolicyEgressToGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final ServicePerimetersServicePerimeterStatusEgressPolicyEgressToGetArgs Empty = new ServicePerimetersServicePerimeterStatusEgressPolicyEgressToGetArgs();
    ...
    public static Builder builder(ServicePerimetersServicePerimeterStatusEgressPolicyEgressToGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ServicePerimetersServicePerimeterStatusEgressPolicyEgressToGetArgs defaults) {
    	      Objects.requireNonNull(defaults);
    	      this.operations = defaults.operations;
    	      this.resources = defaults.resources;
        }

        public Builder setOperations(@Nullable Input<List<ServicePerimetersServicePerimeterStatusEgressPolicyEgressToOperationGetArgs>> operations) {
            this.operations = operations;
            return this;
        }

        public Builder setOperations(@Nullable List<ServicePerimetersServicePerimeterStatusEgressPolicyEgressToOperationGetArgs> operations) {
        ...
        public ServicePerimetersServicePerimeterStatusEgressPolicyEgressToGetArgs build() {
            return new ServicePerimetersServicePerimeterStatusEgressPolicyEgressToGetArgs(operations, resources);
        }
    }
}
