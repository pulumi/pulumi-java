...
public class RegionNetworkEndpointGroup extends io.pulumi.resources.CustomResource {
    ...
    public RegionNetworkEndpointGroup(String name) {
        super("gcp:compute/regionNetworkEndpointGroup:RegionNetworkEndpointGroup", name, RegionNetworkEndpointGroupArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
