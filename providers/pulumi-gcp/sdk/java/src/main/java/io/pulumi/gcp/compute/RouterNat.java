...
public class RouterNat extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RouterNatArgs.Builder a);
    }
    private static io.pulumi.gcp.compute.RouterNatArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.RouterNatArgs.builder();
     ...
     */
    public RouterNat(String name, BuilderApplicator argsBuilder) {
