...
public class SecretIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.secretmanager.SecretIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.secretmanager.SecretIamPolicyArgs.builder();
