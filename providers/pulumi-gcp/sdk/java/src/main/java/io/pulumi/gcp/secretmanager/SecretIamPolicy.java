...
public class SecretIamPolicy extends io.pulumi.resources.CustomResource {
     ...
     */
    public static SecretIamPolicy get(String name, Output<String> id, @Nullable SecretIamPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
