...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs(
    ...
    private OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs() {
    ...
    public static Builder builder(OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs defaults) {
        ...
        public OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs build() {
            return new OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs(baseUrl, displayName, gpgKeys, id);
        }
    }
}
