...
public class InstanceIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.notebooks.InstanceIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.notebooks.InstanceIamPolicyArgs.builder();
