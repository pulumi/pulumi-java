...
public final class URLMapHeaderActionGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public URLMapHeaderActionGetArgs(
        @Nullable Input<List<URLMapHeaderActionRequestHeadersToAddGetArgs>> requestHeadersToAdds,
        @Nullable Input<List<String>> requestHeadersToRemoves,
        @Nullable Input<List<URLMapHeaderActionResponseHeadersToAddGetArgs>> responseHeadersToAdds,
    ...
    public static final class Builder {
        private @Nullable Input<List<URLMapHeaderActionRequestHeadersToAddGetArgs>> requestHeadersToAdds;
        private @Nullable Input<List<String>> requestHeadersToRemoves;
        private @Nullable Input<List<URLMapHeaderActionResponseHeadersToAddGetArgs>> responseHeadersToAdds;
        ...
        public Builder setRequestHeadersToAdds(@Nullable Input<List<URLMapHeaderActionRequestHeadersToAddGetArgs>> requestHeadersToAdds) {
            this.requestHeadersToAdds = requestHeadersToAdds;
            return this;
        }

        public Builder setRequestHeadersToAdds(@Nullable List<URLMapHeaderActionRequestHeadersToAddGetArgs> requestHeadersToAdds) {
        ...
        public Builder setResponseHeadersToAdds(@Nullable Input<List<URLMapHeaderActionResponseHeadersToAddGetArgs>> responseHeadersToAdds) {
            this.responseHeadersToAdds = responseHeadersToAdds;
            return this;
        }

        public Builder setResponseHeadersToAdds(@Nullable List<URLMapHeaderActionResponseHeadersToAddGetArgs> responseHeadersToAdds) {
