...
public class InstanceGroupManager extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(InstanceGroupManagerArgs.Builder a);
    }
    private static io.pulumi.gcp.compute.InstanceGroupManagerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.InstanceGroupManagerArgs.builder();
