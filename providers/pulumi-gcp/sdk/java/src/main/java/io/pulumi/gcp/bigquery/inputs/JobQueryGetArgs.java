...
public final class JobQueryGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public Input<JobQueryDefaultDatasetGetArgs> getDefaultDataset() {
    ...
    public Input<JobQueryDestinationEncryptionConfigurationGetArgs> getDestinationEncryptionConfiguration() {
    ...
    public Input<JobQueryDestinationTableGetArgs> getDestinationTable() {
    ...
    public Input<JobQueryScriptOptionsGetArgs> getScriptOptions() {
    ...
    public Input<List<JobQueryUserDefinedFunctionResourceGetArgs>> getUserDefinedFunctionResources() {
    ...
    public JobQueryGetArgs(
        ...
        @Nullable Input<JobQueryDefaultDatasetGetArgs> defaultDataset,
        @Nullable Input<JobQueryDestinationEncryptionConfigurationGetArgs> destinationEncryptionConfiguration,
        @Nullable Input<JobQueryDestinationTableGetArgs> destinationTable,
        ...
        @Nullable Input<JobQueryScriptOptionsGetArgs> scriptOptions,
        @Nullable Input<Boolean> useLegacySql,
        @Nullable Input<Boolean> useQueryCache,
        @Nullable Input<List<JobQueryUserDefinedFunctionResourceGetArgs>> userDefinedFunctionResources,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<JobQueryDefaultDatasetGetArgs> defaultDataset;
        private @Nullable Input<JobQueryDestinationEncryptionConfigurationGetArgs> destinationEncryptionConfiguration;
        private @Nullable Input<JobQueryDestinationTableGetArgs> destinationTable;
        ...
        private @Nullable Input<JobQueryScriptOptionsGetArgs> scriptOptions;
        private @Nullable Input<Boolean> useLegacySql;
        private @Nullable Input<Boolean> useQueryCache;
        private @Nullable Input<List<JobQueryUserDefinedFunctionResourceGetArgs>> userDefinedFunctionResources;
        ...
        public Builder setDefaultDataset(@Nullable Input<JobQueryDefaultDatasetGetArgs> defaultDataset) {
            this.defaultDataset = defaultDataset;
            return this;
        }

        public Builder setDefaultDataset(@Nullable JobQueryDefaultDatasetGetArgs defaultDataset) {
            this.defaultDataset = Input.ofNullable(defaultDataset);
            return this;
        }

        public Builder setDestinationEncryptionConfiguration(@Nullable Input<JobQueryDestinationEncryptionConfigurationGetArgs> destinationEncryptionConfiguration) {
            this.destinationEncryptionConfiguration = destinationEncryptionConfiguration;
            return this;
        }

        public Builder setDestinationEncryptionConfiguration(@Nullable JobQueryDestinationEncryptionConfigurationGetArgs destinationEncryptionConfiguration) {
            this.destinationEncryptionConfiguration = Input.ofNullable(destinationEncryptionConfiguration);
            return this;
        }

        public Builder setDestinationTable(@Nullable Input<JobQueryDestinationTableGetArgs> destinationTable) {
            this.destinationTable = destinationTable;
            return this;
        }

        public Builder setDestinationTable(@Nullable JobQueryDestinationTableGetArgs destinationTable) {
        ...
        public Builder setScriptOptions(@Nullable Input<JobQueryScriptOptionsGetArgs> scriptOptions) {
            this.scriptOptions = scriptOptions;
            return this;
        }

        public Builder setScriptOptions(@Nullable JobQueryScriptOptionsGetArgs scriptOptions) {
        ...
        public Builder setUserDefinedFunctionResources(@Nullable Input<List<JobQueryUserDefinedFunctionResourceGetArgs>> userDefinedFunctionResources) {
            this.userDefinedFunctionResources = userDefinedFunctionResources;
            return this;
        }

        public Builder setUserDefinedFunctionResources(@Nullable List<JobQueryUserDefinedFunctionResourceGetArgs> userDefinedFunctionResources) {
