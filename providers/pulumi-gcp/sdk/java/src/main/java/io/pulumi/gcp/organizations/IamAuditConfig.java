...
public class IamAuditConfig extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.organizations.IamAuditConfigArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.organizations.IamAuditConfigArgs.builder();
