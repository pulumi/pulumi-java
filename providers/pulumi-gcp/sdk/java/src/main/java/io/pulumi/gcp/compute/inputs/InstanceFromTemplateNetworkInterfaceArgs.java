...
import io.pulumi.gcp.compute.inputs.InstanceFromTemplateNetworkInterfaceAccessConfigArgs;
import io.pulumi.gcp.compute.inputs.InstanceFromTemplateNetworkInterfaceAliasIpRangeArgs;
import io.pulumi.gcp.compute.inputs.InstanceFromTemplateNetworkInterfaceIpv6AccessConfigArgs;
...
public final class InstanceFromTemplateNetworkInterfaceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="accessConfigs")
      private final @Nullable Input<List<InstanceFromTemplateNetworkInterfaceAccessConfigArgs>> accessConfigs;

    public Input<List<InstanceFromTemplateNetworkInterfaceAccessConfigArgs>> getAccessConfigs() {
        return this.accessConfigs == null ? Input.empty() : this.accessConfigs;
    }

    @InputImport(name="aliasIpRanges")
      private final @Nullable Input<List<InstanceFromTemplateNetworkInterfaceAliasIpRangeArgs>> aliasIpRanges;

    public Input<List<InstanceFromTemplateNetworkInterfaceAliasIpRangeArgs>> getAliasIpRanges() {
        return this.aliasIpRanges == null ? Input.empty() : this.aliasIpRanges;
    }

    @InputImport(name="ipv6AccessConfigs")
      private final @Nullable Input<List<InstanceFromTemplateNetworkInterfaceIpv6AccessConfigArgs>> ipv6AccessConfigs;

    public Input<List<InstanceFromTemplateNetworkInterfaceIpv6AccessConfigArgs>> getIpv6AccessConfigs() {
    ...
    public InstanceFromTemplateNetworkInterfaceArgs(
        @Nullable Input<List<InstanceFromTemplateNetworkInterfaceAccessConfigArgs>> accessConfigs,
        @Nullable Input<List<InstanceFromTemplateNetworkInterfaceAliasIpRangeArgs>> aliasIpRanges,
        @Nullable Input<List<InstanceFromTemplateNetworkInterfaceIpv6AccessConfigArgs>> ipv6AccessConfigs,
    ...
    public static final class Builder {
        private @Nullable Input<List<InstanceFromTemplateNetworkInterfaceAccessConfigArgs>> accessConfigs;
        private @Nullable Input<List<InstanceFromTemplateNetworkInterfaceAliasIpRangeArgs>> aliasIpRanges;
        private @Nullable Input<List<InstanceFromTemplateNetworkInterfaceIpv6AccessConfigArgs>> ipv6AccessConfigs;
        ...
        public Builder setAccessConfigs(@Nullable Input<List<InstanceFromTemplateNetworkInterfaceAccessConfigArgs>> accessConfigs) {
            this.accessConfigs = accessConfigs;
            return this;
        }

        public Builder setAccessConfigs(@Nullable List<InstanceFromTemplateNetworkInterfaceAccessConfigArgs> accessConfigs) {
            this.accessConfigs = Input.ofNullable(accessConfigs);
            return this;
        }

        public Builder setAliasIpRanges(@Nullable Input<List<InstanceFromTemplateNetworkInterfaceAliasIpRangeArgs>> aliasIpRanges) {
            this.aliasIpRanges = aliasIpRanges;
            return this;
        }

        public Builder setAliasIpRanges(@Nullable List<InstanceFromTemplateNetworkInterfaceAliasIpRangeArgs> aliasIpRanges) {
            this.aliasIpRanges = Input.ofNullable(aliasIpRanges);
            return this;
        }

        public Builder setIpv6AccessConfigs(@Nullable Input<List<InstanceFromTemplateNetworkInterfaceIpv6AccessConfigArgs>> ipv6AccessConfigs) {
            this.ipv6AccessConfigs = ipv6AccessConfigs;
            return this;
        }

        public Builder setIpv6AccessConfigs(@Nullable List<InstanceFromTemplateNetworkInterfaceIpv6AccessConfigArgs> ipv6AccessConfigs) {
