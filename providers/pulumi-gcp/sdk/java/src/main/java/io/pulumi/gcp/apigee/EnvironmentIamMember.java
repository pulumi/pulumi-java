...
public class EnvironmentIamMember extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(EnvironmentIamMemberArgs.Builder a);
    }
    private static io.pulumi.gcp.apigee.EnvironmentIamMemberArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.apigee.EnvironmentIamMemberArgs.builder();
     ...
     */
    public EnvironmentIamMember(String name, BuilderApplicator argsBuilder) {
