...
public final class CaPoolIssuancePolicyBaselineValuesPolicyIdArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public CaPoolIssuancePolicyBaselineValuesPolicyIdArgs(Output<List<Integer>> objectIdPaths) {
