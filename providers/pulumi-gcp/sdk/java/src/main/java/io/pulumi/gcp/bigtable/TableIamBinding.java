...
public class TableIamBinding extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(TableIamBindingArgs.Builder a);
    }
    private static io.pulumi.gcp.bigtable.TableIamBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.bigtable.TableIamBindingArgs.builder();
     ...
     */
    public TableIamBinding(String name, BuilderApplicator argsBuilder) {
