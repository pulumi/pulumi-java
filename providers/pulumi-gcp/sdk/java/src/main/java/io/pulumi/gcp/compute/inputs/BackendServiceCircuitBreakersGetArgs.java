...
public final class BackendServiceCircuitBreakersGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="connectTimeout")
        private final @Nullable Input<BackendServiceCircuitBreakersConnectTimeoutGetArgs> connectTimeout;

    public Input<BackendServiceCircuitBreakersConnectTimeoutGetArgs> getConnectTimeout() {
    ...
    public BackendServiceCircuitBreakersGetArgs(
        @Nullable Input<BackendServiceCircuitBreakersConnectTimeoutGetArgs> connectTimeout,
    ...
    public static final class Builder {
        private @Nullable Input<BackendServiceCircuitBreakersConnectTimeoutGetArgs> connectTimeout;
