...
public class CertificateTemplate extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.certificateauthority.CertificateTemplateArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.certificateauthority.CertificateTemplateArgs.builder();
