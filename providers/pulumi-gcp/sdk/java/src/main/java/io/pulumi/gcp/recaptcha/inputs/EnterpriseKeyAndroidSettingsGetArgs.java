...
public final class EnterpriseKeyAndroidSettingsGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final EnterpriseKeyAndroidSettingsGetArgs Empty = new EnterpriseKeyAndroidSettingsGetArgs();
    ...
    public static Builder builder(EnterpriseKeyAndroidSettingsGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(EnterpriseKeyAndroidSettingsGetArgs defaults) {
        ...
        public EnterpriseKeyAndroidSettingsGetArgs build() {
            return new EnterpriseKeyAndroidSettingsGetArgs(allowAllPackageNames, allowedPackageNames);
        }
    }
}
