...
public final class SubscriptionIAMMemberConditionArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public SubscriptionIAMMemberConditionArgs build() {
            return new SubscriptionIAMMemberConditionArgs(description, expression, title);
        }
    }
}
