...
public final class JobHiveConfigGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final JobHiveConfigGetArgs Empty = new JobHiveConfigGetArgs();
