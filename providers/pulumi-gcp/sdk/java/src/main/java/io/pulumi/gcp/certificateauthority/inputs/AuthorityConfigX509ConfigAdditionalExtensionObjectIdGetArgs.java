...
public final class AuthorityConfigX509ConfigAdditionalExtensionObjectIdGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public AuthorityConfigX509ConfigAdditionalExtensionObjectIdGetArgs(Input<List<Integer>> objectIdPaths) {
