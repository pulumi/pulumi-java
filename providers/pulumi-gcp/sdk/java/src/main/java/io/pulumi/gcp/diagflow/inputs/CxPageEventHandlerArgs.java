...
public final class CxPageEventHandlerArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setTriggerFulfillment(@Nullable Input<CxPageEventHandlerTriggerFulfillmentArgs> triggerFulfillment) {
            this.triggerFulfillment = triggerFulfillment;
            return this;
        }

        public Builder setTriggerFulfillment(@Nullable CxPageEventHandlerTriggerFulfillmentArgs triggerFulfillment) {
