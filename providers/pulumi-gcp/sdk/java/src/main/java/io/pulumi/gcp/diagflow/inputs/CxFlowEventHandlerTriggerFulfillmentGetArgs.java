...
public final class CxFlowEventHandlerTriggerFulfillmentGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setMessages(@Nullable Input<List<CxFlowEventHandlerTriggerFulfillmentMessageGetArgs>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder setMessages(@Nullable List<CxFlowEventHandlerTriggerFulfillmentMessageGetArgs> messages) {
