...
public final class InstanceNetworkInterfaceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder accessConfigs(@Nullable Input<List<InstanceNetworkInterfaceAccessConfigArgs>> accessConfigs) {
            this.accessConfigs = accessConfigs;
            return this;
        }
        ...
        public Builder aliasIpRanges(@Nullable Input<List<InstanceNetworkInterfaceAliasIpRangeArgs>> aliasIpRanges) {
            this.aliasIpRanges = aliasIpRanges;
            return this;
        }
        ...
        public Builder ipv6AccessConfigs(@Nullable Input<List<InstanceNetworkInterfaceIpv6AccessConfigArgs>> ipv6AccessConfigs) {
            this.ipv6AccessConfigs = ipv6AccessConfigs;
            return this;
        }
