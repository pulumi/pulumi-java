...
public class DatasetIamMember extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.healthcare.DatasetIamMemberArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.healthcare.DatasetIamMemberArgs.builder();
