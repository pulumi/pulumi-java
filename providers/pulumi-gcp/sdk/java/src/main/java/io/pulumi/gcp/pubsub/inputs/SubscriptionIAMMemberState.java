...
public final class SubscriptionIAMMemberState extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setCondition(@Nullable Input<SubscriptionIAMMemberConditionGetArgs> condition) {
            this.condition = condition;
            return this;
        }

        public Builder setCondition(@Nullable SubscriptionIAMMemberConditionGetArgs condition) {
