...
public class OrganizationPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.folder.OrganizationPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.folder.OrganizationPolicyArgs.builder();
