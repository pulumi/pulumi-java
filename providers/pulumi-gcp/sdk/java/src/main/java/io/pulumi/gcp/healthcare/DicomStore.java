...
public class DicomStore extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.healthcare.DicomStoreArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.healthcare.DicomStoreArgs.builder();
