...
@OutputCustomType
public final class NamespaceIamBindingCondition {
    private final @Nullable String description;
    private final String expression;
    private final String title;

    @OutputCustomType.Constructor({"description","expression","title"})
    private NamespaceIamBindingCondition(
    ...
    public static Builder builder(NamespaceIamBindingCondition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(NamespaceIamBindingCondition defaults) {
