...
public final class RegionHealthCheckHttp2HealthCheckArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public RegionHealthCheckHttp2HealthCheckArgs build() {
            return new RegionHealthCheckHttp2HealthCheckArgs(host, port, portName, portSpecification, proxyHeader, requestPath, response);
        }
    }
}
