...
public final class RegionUrlMapPathMatcherRouteRuleHeaderActionRequestHeadersToAddGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final RegionUrlMapPathMatcherRouteRuleHeaderActionRequestHeadersToAddGetArgs Empty = new RegionUrlMapPathMatcherRouteRuleHeaderActionRequestHeadersToAddGetArgs();
    ...
    public RegionUrlMapPathMatcherRouteRuleHeaderActionRequestHeadersToAddGetArgs(
    ...
    private RegionUrlMapPathMatcherRouteRuleHeaderActionRequestHeadersToAddGetArgs() {
    ...
    public static Builder builder(RegionUrlMapPathMatcherRouteRuleHeaderActionRequestHeadersToAddGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RegionUrlMapPathMatcherRouteRuleHeaderActionRequestHeadersToAddGetArgs defaults) {
        ...
        public RegionUrlMapPathMatcherRouteRuleHeaderActionRequestHeadersToAddGetArgs build() {
            return new RegionUrlMapPathMatcherRouteRuleHeaderActionRequestHeadersToAddGetArgs(headerName, headerValue, replace);
        }
    }
}
