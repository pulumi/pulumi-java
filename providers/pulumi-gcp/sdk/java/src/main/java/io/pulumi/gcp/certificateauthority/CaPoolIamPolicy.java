...
public class CaPoolIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.certificateauthority.CaPoolIamPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.certificateauthority.CaPoolIamPolicyArgs.builder();
