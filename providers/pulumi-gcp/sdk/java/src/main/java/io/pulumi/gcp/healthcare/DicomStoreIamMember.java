...
public class DicomStoreIamMember extends io.pulumi.resources.CustomResource {
     ...
     */
    public static DicomStoreIamMember get(String name, Output<String> id, @Nullable DicomStoreIamMemberState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
