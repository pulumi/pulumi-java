...
public class RepositoryIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public RepositoryIamPolicy(String name) {
        super("gcp:sourcerepo/repositoryIamPolicy:RepositoryIamPolicy", name, RepositoryIamPolicyArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public RepositoryIamPolicy(String name, RepositoryIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:sourcerepo/repositoryIamPolicy:RepositoryIamPolicy", name, args == null ? RepositoryIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
