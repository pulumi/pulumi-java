...
public final class InstanceFromMachineImageBootDiskGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public InstanceFromMachineImageBootDiskGetArgs(
        ...
        @Nullable Input<InstanceFromMachineImageBootDiskInitializeParamsGetArgs> initializeParams,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<InstanceFromMachineImageBootDiskInitializeParamsGetArgs> initializeParams;
        ...
        public Builder setInitializeParams(@Nullable Input<InstanceFromMachineImageBootDiskInitializeParamsGetArgs> initializeParams) {
            this.initializeParams = initializeParams;
            return this;
        }

        public Builder setInitializeParams(@Nullable InstanceFromMachineImageBootDiskInitializeParamsGetArgs initializeParams) {
