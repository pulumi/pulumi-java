...
import io.pulumi.gcp.servicedirectory.inputs.NamespaceIamBindingConditionGetArgs;
...
public final class NamespaceIamBindingState extends io.pulumi.resources.ResourceArgs {
    ...
    public NamespaceIamBindingState(
        @Nullable Input<NamespaceIamBindingConditionGetArgs> condition,
    ...
    public static final class Builder {
        private @Nullable Input<NamespaceIamBindingConditionGetArgs> condition;
        ...
        public Builder setCondition(@Nullable Input<NamespaceIamBindingConditionGetArgs> condition) {
            this.condition = condition;
            return this;
        }

        public Builder setCondition(@Nullable NamespaceIamBindingConditionGetArgs condition) {
