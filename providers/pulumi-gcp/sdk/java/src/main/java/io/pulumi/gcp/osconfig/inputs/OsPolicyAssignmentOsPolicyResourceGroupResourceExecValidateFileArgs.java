...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileArgs(
        ...
        @Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileGcsArgs> gcs,
        @Nullable Input<String> localPath,
        @Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileRemoteArgs> remote) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileGcsArgs> gcs;
        private @Nullable Input<String> localPath;
        private @Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileRemoteArgs> remote;
        ...
        public Builder setGcs(@Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileGcsArgs> gcs) {
            this.gcs = gcs;
            return this;
        }

        public Builder setGcs(@Nullable OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileGcsArgs gcs) {
        ...
        public Builder setRemote(@Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileRemoteArgs> remote) {
            this.remote = remote;
            return this;
        }

        public Builder setRemote(@Nullable OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileRemoteArgs remote) {
