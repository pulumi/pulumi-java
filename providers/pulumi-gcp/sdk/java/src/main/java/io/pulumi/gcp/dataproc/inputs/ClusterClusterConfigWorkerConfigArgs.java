...
public final class ClusterClusterConfigWorkerConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public ClusterClusterConfigWorkerConfigArgs(
        @Nullable Input<List<ClusterClusterConfigWorkerConfigAcceleratorArgs>> accelerators,
        @Nullable Input<ClusterClusterConfigWorkerConfigDiskConfigArgs> diskConfig,
    ...
    public static final class Builder {
        private @Nullable Input<List<ClusterClusterConfigWorkerConfigAcceleratorArgs>> accelerators;
        private @Nullable Input<ClusterClusterConfigWorkerConfigDiskConfigArgs> diskConfig;
        ...
        public Builder setAccelerators(@Nullable Input<List<ClusterClusterConfigWorkerConfigAcceleratorArgs>> accelerators) {
            this.accelerators = accelerators;
            return this;
        }

        public Builder setAccelerators(@Nullable List<ClusterClusterConfigWorkerConfigAcceleratorArgs> accelerators) {
            this.accelerators = Input.ofNullable(accelerators);
            return this;
        }

        public Builder setDiskConfig(@Nullable Input<ClusterClusterConfigWorkerConfigDiskConfigArgs> diskConfig) {
            this.diskConfig = diskConfig;
            return this;
        }

        public Builder setDiskConfig(@Nullable ClusterClusterConfigWorkerConfigDiskConfigArgs diskConfig) {
