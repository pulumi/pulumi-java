...
public final class InstanceTemplateSchedulingGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setNodeAffinities(@Nullable Input<List<InstanceTemplateSchedulingNodeAffinityGetArgs>> nodeAffinities) {
            this.nodeAffinities = nodeAffinities;
            return this;
        }

        public Builder setNodeAffinities(@Nullable List<InstanceTemplateSchedulingNodeAffinityGetArgs> nodeAffinities) {
