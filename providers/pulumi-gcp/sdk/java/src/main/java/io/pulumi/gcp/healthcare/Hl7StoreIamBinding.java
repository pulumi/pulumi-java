...
public class Hl7StoreIamBinding extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(Hl7StoreIamBindingArgs.Builder a);
    }
    private static io.pulumi.gcp.healthcare.Hl7StoreIamBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.healthcare.Hl7StoreIamBindingArgs.builder();
     ...
     */
    public Hl7StoreIamBinding(String name, BuilderApplicator argsBuilder) {
