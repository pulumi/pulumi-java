...
public class InterconnectAttachment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.InterconnectAttachmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.InterconnectAttachmentArgs.builder();
     ...
     */
    public static InterconnectAttachment get(String name, Output<String> id, @Nullable InterconnectAttachmentState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
