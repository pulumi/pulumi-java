...
@OutputCustomType
public final class CryptoKeyIAMBindingCondition {
    /**
    ...
    public static Builder builder(CryptoKeyIAMBindingCondition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CryptoKeyIAMBindingCondition defaults) {
