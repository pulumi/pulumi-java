...
public final class ClusterNodePoolGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="autoscaling")
      private final @Nullable Input<ClusterNodePoolAutoscalingGetArgs> autoscaling;

    public Input<ClusterNodePoolAutoscalingGetArgs> getAutoscaling() {
    ...
    @InputImport(name="management")
      private final @Nullable Input<ClusterNodePoolManagementGetArgs> management;

    public Input<ClusterNodePoolManagementGetArgs> getManagement() {
    ...
    public Input<ClusterNodePoolNetworkConfigGetArgs> getNetworkConfig() {
    ...
    public Input<ClusterNodePoolNodeConfigGetArgs> getNodeConfig() {
    ...
    @InputImport(name="upgradeSettings")
      private final @Nullable Input<ClusterNodePoolUpgradeSettingsGetArgs> upgradeSettings;

    public Input<ClusterNodePoolUpgradeSettingsGetArgs> getUpgradeSettings() {
    ...
    public ClusterNodePoolGetArgs(
        @Nullable Input<ClusterNodePoolAutoscalingGetArgs> autoscaling,
        ...
        @Nullable Input<ClusterNodePoolManagementGetArgs> management,
        @Nullable Input<Integer> maxPodsPerNode,
        @Nullable Input<String> name,
        @Nullable Input<String> namePrefix,
        @Nullable Input<ClusterNodePoolNetworkConfigGetArgs> networkConfig,
        @Nullable Input<ClusterNodePoolNodeConfigGetArgs> nodeConfig,
        @Nullable Input<Integer> nodeCount,
        @Nullable Input<List<String>> nodeLocations,
        @Nullable Input<ClusterNodePoolUpgradeSettingsGetArgs> upgradeSettings,
    ...
    public static final class Builder {
        private @Nullable Input<ClusterNodePoolAutoscalingGetArgs> autoscaling;
        ...
        private @Nullable Input<ClusterNodePoolManagementGetArgs> management;
        private @Nullable Input<Integer> maxPodsPerNode;
        private @Nullable Input<String> name;
        private @Nullable Input<String> namePrefix;
        private @Nullable Input<ClusterNodePoolNetworkConfigGetArgs> networkConfig;
        private @Nullable Input<ClusterNodePoolNodeConfigGetArgs> nodeConfig;
        private @Nullable Input<Integer> nodeCount;
        private @Nullable Input<List<String>> nodeLocations;
        private @Nullable Input<ClusterNodePoolUpgradeSettingsGetArgs> upgradeSettings;
