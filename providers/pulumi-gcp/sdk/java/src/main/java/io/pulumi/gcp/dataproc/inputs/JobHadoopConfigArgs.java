...
import io.pulumi.gcp.dataproc.inputs.JobHadoopConfigLoggingConfigArgs;
...
public final class JobHadoopConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="loggingConfig")
      private final @Nullable Input<JobHadoopConfigLoggingConfigArgs> loggingConfig;

    public Input<JobHadoopConfigLoggingConfigArgs> getLoggingConfig() {
    ...
    public JobHadoopConfigArgs(
        ...
        @Nullable Input<JobHadoopConfigLoggingConfigArgs> loggingConfig,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<JobHadoopConfigLoggingConfigArgs> loggingConfig;
        ...
        public Builder setLoggingConfig(@Nullable Input<JobHadoopConfigLoggingConfigArgs> loggingConfig) {
            this.loggingConfig = loggingConfig;
            return this;
        }

        public Builder setLoggingConfig(@Nullable JobHadoopConfigLoggingConfigArgs loggingConfig) {
