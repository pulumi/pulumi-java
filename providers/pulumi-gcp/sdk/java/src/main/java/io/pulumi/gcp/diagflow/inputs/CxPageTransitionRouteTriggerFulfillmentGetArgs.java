...
public final class CxPageTransitionRouteTriggerFulfillmentGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="messages")
        private final @Nullable Input<List<CxPageTransitionRouteTriggerFulfillmentMessageGetArgs>> messages;

    public Input<List<CxPageTransitionRouteTriggerFulfillmentMessageGetArgs>> getMessages() {
    ...
    public CxPageTransitionRouteTriggerFulfillmentGetArgs(
        @Nullable Input<List<CxPageTransitionRouteTriggerFulfillmentMessageGetArgs>> messages,
    ...
    public static final class Builder {
        private @Nullable Input<List<CxPageTransitionRouteTriggerFulfillmentMessageGetArgs>> messages;
        ...
        public Builder setMessages(@Nullable Input<List<CxPageTransitionRouteTriggerFulfillmentMessageGetArgs>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder setMessages(@Nullable List<CxPageTransitionRouteTriggerFulfillmentMessageGetArgs> messages) {
