...
public class MachineImage extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.MachineImageArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.MachineImageArgs.builder();
