...
public class InstanceIamMember extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.notebooks.InstanceIamMemberArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.notebooks.InstanceIamMemberArgs.builder();
