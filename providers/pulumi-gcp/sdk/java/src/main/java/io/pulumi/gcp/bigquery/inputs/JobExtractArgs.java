...
public final class JobExtractArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setSourceModel(@Nullable Input<JobExtractSourceModelArgs> sourceModel) {
            this.sourceModel = sourceModel;
            return this;
        }

        public Builder setSourceModel(@Nullable JobExtractSourceModelArgs sourceModel) {
            this.sourceModel = Input.ofNullable(sourceModel);
            return this;
        }

        public Builder setSourceTable(@Nullable Input<JobExtractSourceTableArgs> sourceTable) {
            this.sourceTable = sourceTable;
            return this;
        }

        public Builder setSourceTable(@Nullable JobExtractSourceTableArgs sourceTable) {
