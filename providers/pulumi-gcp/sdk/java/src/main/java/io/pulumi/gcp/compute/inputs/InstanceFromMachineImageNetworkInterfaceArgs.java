...
public final class InstanceFromMachineImageNetworkInterfaceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder accessConfigs(@Nullable Input<List<InstanceFromMachineImageNetworkInterfaceAccessConfigArgs>> accessConfigs) {
            this.accessConfigs = accessConfigs;
            return this;
        }

        public Builder accessConfigs(@Nullable List<InstanceFromMachineImageNetworkInterfaceAccessConfigArgs> accessConfigs) {
            this.accessConfigs = Input.ofNullable(accessConfigs);
            return this;
        }

        public Builder aliasIpRanges(@Nullable Input<List<InstanceFromMachineImageNetworkInterfaceAliasIpRangeArgs>> aliasIpRanges) {
            this.aliasIpRanges = aliasIpRanges;
            return this;
        }

        public Builder aliasIpRanges(@Nullable List<InstanceFromMachineImageNetworkInterfaceAliasIpRangeArgs> aliasIpRanges) {
            this.aliasIpRanges = Input.ofNullable(aliasIpRanges);
            return this;
        }

        public Builder ipv6AccessConfigs(@Nullable Input<List<InstanceFromMachineImageNetworkInterfaceIpv6AccessConfigArgs>> ipv6AccessConfigs) {
            this.ipv6AccessConfigs = ipv6AccessConfigs;
            return this;
        }

        public Builder ipv6AccessConfigs(@Nullable List<InstanceFromMachineImageNetworkInterfaceIpv6AccessConfigArgs> ipv6AccessConfigs) {
