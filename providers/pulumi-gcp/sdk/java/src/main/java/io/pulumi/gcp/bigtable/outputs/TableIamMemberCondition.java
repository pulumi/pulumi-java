...
@OutputCustomType
public final class TableIamMemberCondition {
    ...
    public static Builder builder(TableIamMemberCondition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(TableIamMemberCondition defaults) {
