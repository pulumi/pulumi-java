...
public class RegionDiskIamBinding extends io.pulumi.resources.CustomResource {
     ...
     */
    public static RegionDiskIamBinding get(String name, Output<String> id, @Nullable RegionDiskIamBindingState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
