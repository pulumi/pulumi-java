...
public final class CxFlowTransitionRouteTriggerFulfillmentArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="messages")
      private final @Nullable Input<List<CxFlowTransitionRouteTriggerFulfillmentMessageArgs>> messages;

    public Input<List<CxFlowTransitionRouteTriggerFulfillmentMessageArgs>> getMessages() {
    ...
    public CxFlowTransitionRouteTriggerFulfillmentArgs(
        @Nullable Input<List<CxFlowTransitionRouteTriggerFulfillmentMessageArgs>> messages,
    ...
    public static final class Builder {
        private @Nullable Input<List<CxFlowTransitionRouteTriggerFulfillmentMessageArgs>> messages;
        ...
        public Builder setMessages(@Nullable Input<List<CxFlowTransitionRouteTriggerFulfillmentMessageArgs>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder setMessages(@Nullable List<CxFlowTransitionRouteTriggerFulfillmentMessageArgs> messages) {
