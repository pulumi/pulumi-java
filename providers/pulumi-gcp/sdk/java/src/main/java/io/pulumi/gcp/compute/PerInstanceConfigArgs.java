...
public final class PerInstanceConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setInstanceGroupManager(Input<String> instanceGroupManager) {
        ...
        public Builder setPreservedState(@Nullable Input<PerInstanceConfigPreservedStateArgs> preservedState) {
            this.preservedState = preservedState;
            return this;
        }

        public Builder setPreservedState(@Nullable PerInstanceConfigPreservedStateArgs preservedState) {
