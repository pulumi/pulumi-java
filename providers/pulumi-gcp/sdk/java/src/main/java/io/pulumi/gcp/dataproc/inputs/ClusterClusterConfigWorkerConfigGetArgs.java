...
public final class ClusterClusterConfigWorkerConfigGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setAccelerators(@Nullable Input<List<ClusterClusterConfigWorkerConfigAcceleratorGetArgs>> accelerators) {
            this.accelerators = accelerators;
            return this;
        }

        public Builder setAccelerators(@Nullable List<ClusterClusterConfigWorkerConfigAcceleratorGetArgs> accelerators) {
            this.accelerators = Input.ofNullable(accelerators);
            return this;
        }

        public Builder setDiskConfig(@Nullable Input<ClusterClusterConfigWorkerConfigDiskConfigGetArgs> diskConfig) {
            this.diskConfig = diskConfig;
            return this;
        }

        public Builder setDiskConfig(@Nullable ClusterClusterConfigWorkerConfigDiskConfigGetArgs diskConfig) {
