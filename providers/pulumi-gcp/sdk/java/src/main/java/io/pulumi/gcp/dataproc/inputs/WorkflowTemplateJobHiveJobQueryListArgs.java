...
public final class WorkflowTemplateJobHiveJobQueryListArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public WorkflowTemplateJobHiveJobQueryListArgs(Input<List<String>> queries) {
