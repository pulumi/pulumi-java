...
public class RegionDiskResourcePolicyAttachment extends io.pulumi.resources.CustomResource {
    ...
    public RegionDiskResourcePolicyAttachment(String name) {
        super("gcp:compute/regionDiskResourcePolicyAttachment:RegionDiskResourcePolicyAttachment", name, RegionDiskResourcePolicyAttachmentArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
