...
public final class JobPysparkConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setLoggingConfig(@Nullable Input<JobPysparkConfigLoggingConfigArgs> loggingConfig) {
            this.loggingConfig = loggingConfig;
            return this;
        }

        public Builder setLoggingConfig(@Nullable JobPysparkConfigLoggingConfigArgs loggingConfig) {
