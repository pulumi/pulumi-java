...
public class DefaultServiceAccounts extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(DefaultServiceAccountsArgs.Builder a);
    }
    private static io.pulumi.gcp.projects.DefaultServiceAccountsArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.projects.DefaultServiceAccountsArgs.builder();
     ...
     */
    public DefaultServiceAccounts(String name, BuilderApplicator argsBuilder) {
