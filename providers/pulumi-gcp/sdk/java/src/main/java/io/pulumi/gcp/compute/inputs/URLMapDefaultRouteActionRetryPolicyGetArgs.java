...
import io.pulumi.gcp.compute.inputs.URLMapDefaultRouteActionRetryPolicyPerTryTimeoutGetArgs;
...
public final class URLMapDefaultRouteActionRetryPolicyGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="perTryTimeout")
        private final @Nullable Input<URLMapDefaultRouteActionRetryPolicyPerTryTimeoutGetArgs> perTryTimeout;

    public Input<URLMapDefaultRouteActionRetryPolicyPerTryTimeoutGetArgs> getPerTryTimeout() {
    ...
    public URLMapDefaultRouteActionRetryPolicyGetArgs(
        ...
        @Nullable Input<URLMapDefaultRouteActionRetryPolicyPerTryTimeoutGetArgs> perTryTimeout,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<URLMapDefaultRouteActionRetryPolicyPerTryTimeoutGetArgs> perTryTimeout;
        ...
        public Builder setPerTryTimeout(@Nullable Input<URLMapDefaultRouteActionRetryPolicyPerTryTimeoutGetArgs> perTryTimeout) {
            this.perTryTimeout = perTryTimeout;
            return this;
        }

        public Builder setPerTryTimeout(@Nullable URLMapDefaultRouteActionRetryPolicyPerTryTimeoutGetArgs perTryTimeout) {
