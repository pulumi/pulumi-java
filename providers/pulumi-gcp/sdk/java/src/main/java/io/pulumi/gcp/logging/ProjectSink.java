...
public class ProjectSink extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ProjectSinkArgs.Builder a);
    }
    private static io.pulumi.gcp.logging.ProjectSinkArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.logging.ProjectSinkArgs.builder();
     ...
     */
    public ProjectSink(String name, BuilderApplicator argsBuilder) {
