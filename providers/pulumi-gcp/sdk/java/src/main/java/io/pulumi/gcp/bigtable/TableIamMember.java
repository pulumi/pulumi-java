...
public class TableIamMember extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(TableIamMemberArgs.Builder a);
    }
    private static io.pulumi.gcp.bigtable.TableIamMemberArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.bigtable.TableIamMemberArgs.builder();
     ...
     */
    public TableIamMember(String name, BuilderApplicator argsBuilder) {
    ...
    public TableIamMember(String name, TableIamMemberArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigtable/tableIamMember:TableIamMember", name, args == null ? TableIamMemberArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
