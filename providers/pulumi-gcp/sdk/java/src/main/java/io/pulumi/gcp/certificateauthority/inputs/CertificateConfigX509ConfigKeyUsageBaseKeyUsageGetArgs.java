...
public final class CertificateConfigX509ConfigKeyUsageBaseKeyUsageGetArgs extends io.pulumi.resources.ResourceArgs {

    public static final CertificateConfigX509ConfigKeyUsageBaseKeyUsageGetArgs Empty = new CertificateConfigX509ConfigKeyUsageBaseKeyUsageGetArgs();
    ...
    public CertificateConfigX509ConfigKeyUsageBaseKeyUsageGetArgs(
    ...
    private CertificateConfigX509ConfigKeyUsageBaseKeyUsageGetArgs() {
    ...
    public static Builder builder(CertificateConfigX509ConfigKeyUsageBaseKeyUsageGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CertificateConfigX509ConfigKeyUsageBaseKeyUsageGetArgs defaults) {
        ...
        public CertificateConfigX509ConfigKeyUsageBaseKeyUsageGetArgs build() {
            return new CertificateConfigX509ConfigKeyUsageBaseKeyUsageGetArgs(certSign, contentCommitment, crlSign, dataEncipherment, decipherOnly, digitalSignature, encipherOnly, keyAgreement, keyEncipherment);
        }
    }
}
