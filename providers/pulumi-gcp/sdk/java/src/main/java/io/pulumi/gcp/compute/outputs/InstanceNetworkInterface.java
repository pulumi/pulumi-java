...
public final class InstanceNetworkInterface {
    ...
    private InstanceNetworkInterface(
        @Nullable List<InstanceNetworkInterfaceAccessConfig> accessConfigs,
        @Nullable List<InstanceNetworkInterfaceAliasIpRange> aliasIpRanges,
        @Nullable List<InstanceNetworkInterfaceIpv6AccessConfig> ipv6AccessConfigs,
