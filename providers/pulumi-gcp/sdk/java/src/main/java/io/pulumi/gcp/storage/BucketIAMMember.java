...
public class BucketIAMMember extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(BucketIAMMemberArgs.Builder a);
    }
    private static io.pulumi.gcp.storage.BucketIAMMemberArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.storage.BucketIAMMemberArgs.builder();
     ...
     */
    public BucketIAMMember(String name, BuilderApplicator argsBuilder) {
