...
public class InstanceIamBinding extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.bigtable.InstanceIamBindingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.bigtable.InstanceIamBindingArgs.builder();
