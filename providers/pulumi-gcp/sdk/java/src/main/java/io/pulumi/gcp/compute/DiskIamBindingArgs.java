...
public final class DiskIamBindingArgs extends io.pulumi.resources.ResourceArgs {

    public static final DiskIamBindingArgs Empty = new DiskIamBindingArgs();

    @InputImport(name="condition")
      private final @Nullable Input<DiskIamBindingConditionArgs> condition;

    public Input<DiskIamBindingConditionArgs> getCondition() {
    ...
    public DiskIamBindingArgs(
        @Nullable Input<DiskIamBindingConditionArgs> condition,
    ...
    public static final class Builder {
        private @Nullable Input<DiskIamBindingConditionArgs> condition;
        ...
        public Builder setCondition(@Nullable Input<DiskIamBindingConditionArgs> condition) {
            this.condition = condition;
            return this;
        }

        public Builder setCondition(@Nullable DiskIamBindingConditionArgs condition) {
