...
public class Reservation extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.compute.ReservationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.compute.ReservationArgs.builder();
