...
public final class URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyAbortArgs extends io.pulumi.resources.ResourceArgs {

    public static final URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyAbortArgs Empty = new URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyAbortArgs();
    ...
    private URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyAbortArgs() {
    ...
    public static Builder builder(URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyAbortArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyAbortArgs defaults) {
        ...
        public URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyAbortArgs build() {
            return new URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyAbortArgs(httpStatus, percentage);
        }
    }
}
