...
public class TagValueIamPolicy extends io.pulumi.resources.CustomResource {
    ...
    public TagValueIamPolicy(String name, TagValueIamPolicyArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("gcp:tags/tagValueIamPolicy:TagValueIamPolicy", name, args == null ? TagValueIamPolicyArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private TagValueIamPolicy(String name, Input<String> id, @Nullable TagValueIamPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TagValueIamPolicy get(String name, Input<String> id, @Nullable TagValueIamPolicyState state, @Nullable io.pulumi.resources.CustomResourceOptions options) {
