...
public class DomainMapping extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.gcp.cloudrun.DomainMappingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.cloudrun.DomainMappingArgs.builder();
