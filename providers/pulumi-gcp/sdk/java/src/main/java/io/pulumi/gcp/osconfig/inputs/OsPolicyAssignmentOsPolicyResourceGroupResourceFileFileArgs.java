...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setGcs(@Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGcsArgs> gcs) {
            this.gcs = gcs;
            return this;
        }

        public Builder setGcs(@Nullable OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGcsArgs gcs) {
        ...
        public Builder setRemote(@Nullable Input<OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileRemoteArgs> remote) {
            this.remote = remote;
            return this;
        }

        public Builder setRemote(@Nullable OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileRemoteArgs remote) {
