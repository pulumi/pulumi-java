...
public final class WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigArgs(
        ...
        @Nullable Input<WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigNodeGroupAffinityArgs> nodeGroupAffinity,
        @Nullable Input<String> privateIpv6GoogleAccess,
        @Nullable Input<WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigReservationAffinityArgs> reservationAffinity,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigNodeGroupAffinityArgs> nodeGroupAffinity;
        private @Nullable Input<String> privateIpv6GoogleAccess;
        private @Nullable Input<WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigReservationAffinityArgs> reservationAffinity;
        ...
        public Builder setNodeGroupAffinity(@Nullable Input<WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigNodeGroupAffinityArgs> nodeGroupAffinity) {
            this.nodeGroupAffinity = nodeGroupAffinity;
            return this;
        }

        public Builder setNodeGroupAffinity(@Nullable WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigNodeGroupAffinityArgs nodeGroupAffinity) {
        ...
        public Builder setReservationAffinity(@Nullable Input<WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigReservationAffinityArgs> reservationAffinity) {
            this.reservationAffinity = reservationAffinity;
            return this;
        }

        public Builder setReservationAffinity(@Nullable WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigReservationAffinityArgs reservationAffinity) {
