...
public class CryptoKeyIAMMember extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(CryptoKeyIAMMemberArgs.Builder a);
    }
    private static io.pulumi.gcp.kms.CryptoKeyIAMMemberArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.gcp.kms.CryptoKeyIAMMemberArgs.builder();
     ...
     */
    public CryptoKeyIAMMember(String name, BuilderApplicator argsBuilder) {
