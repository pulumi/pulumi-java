...
@CustomType
public final class RepositoryIamBindingCondition {
    ...
    public static Builder builder(RepositoryIamBindingCondition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RepositoryIamBindingCondition defaults) {
