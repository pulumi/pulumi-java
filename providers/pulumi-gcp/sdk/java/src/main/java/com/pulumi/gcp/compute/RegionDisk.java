...
public class RegionDisk extends CustomResource {
    ...
    private RegionDisk(String name, Output<String> id, @Nullable RegionDiskState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegionDisk get(String name, Output<String> id, @Nullable RegionDiskState state, @Nullable CustomResourceOptions options) {
