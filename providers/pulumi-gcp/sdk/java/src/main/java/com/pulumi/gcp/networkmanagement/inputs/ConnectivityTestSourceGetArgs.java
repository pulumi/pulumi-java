...
public final class ConnectivityTestSourceGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ConnectivityTestSourceGetArgs(ConnectivityTestSourceGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectivityTestSourceGetArgs();
        }

        public Builder(ConnectivityTestSourceGetArgs defaults) {
            $ = new ConnectivityTestSourceGetArgs(Objects.requireNonNull(defaults));
        }
