...
public class ProjectDefaultNetworkTier extends CustomResource {
    /**
     ...
     */
    public ProjectDefaultNetworkTier(String name, ProjectDefaultNetworkTierArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProjectDefaultNetworkTier(String name, Output<String> id, @Nullable ProjectDefaultNetworkTierState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProjectDefaultNetworkTier get(String name, Output<String> id, @Nullable ProjectDefaultNetworkTierState state, @Nullable CustomResourceOptions options) {
