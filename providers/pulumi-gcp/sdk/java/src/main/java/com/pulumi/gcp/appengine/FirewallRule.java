...
public class FirewallRule extends CustomResource {
    ...
    private FirewallRule(String name, Output<String> id, @Nullable FirewallRuleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FirewallRule get(String name, Output<String> id, @Nullable FirewallRuleState state, @Nullable CustomResourceOptions options) {
