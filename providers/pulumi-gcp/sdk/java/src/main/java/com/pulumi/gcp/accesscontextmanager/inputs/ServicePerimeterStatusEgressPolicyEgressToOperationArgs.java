...
import com.pulumi.gcp.accesscontextmanager.inputs.ServicePerimeterStatusEgressPolicyEgressToOperationMethodSelectorArgs;
...
public final class ServicePerimeterStatusEgressPolicyEgressToOperationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<List<ServicePerimeterStatusEgressPolicyEgressToOperationMethodSelectorArgs>>> methodSelectors() {
    ...
    private ServicePerimeterStatusEgressPolicyEgressToOperationArgs(ServicePerimeterStatusEgressPolicyEgressToOperationArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServicePerimeterStatusEgressPolicyEgressToOperationArgs();
        }

        public Builder(ServicePerimeterStatusEgressPolicyEgressToOperationArgs defaults) {
            $ = new ServicePerimeterStatusEgressPolicyEgressToOperationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder methodSelectors(List<ServicePerimeterStatusEgressPolicyEgressToOperationMethodSelectorArgs> methodSelectors) {
