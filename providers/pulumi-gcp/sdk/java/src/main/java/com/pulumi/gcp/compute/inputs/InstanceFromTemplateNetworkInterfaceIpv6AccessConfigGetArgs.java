...
public final class InstanceFromTemplateNetworkInterfaceIpv6AccessConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceFromTemplateNetworkInterfaceIpv6AccessConfigGetArgs(InstanceFromTemplateNetworkInterfaceIpv6AccessConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceFromTemplateNetworkInterfaceIpv6AccessConfigGetArgs();
        }

        public Builder(InstanceFromTemplateNetworkInterfaceIpv6AccessConfigGetArgs defaults) {
            $ = new InstanceFromTemplateNetworkInterfaceIpv6AccessConfigGetArgs(Objects.requireNonNull(defaults));
        }
