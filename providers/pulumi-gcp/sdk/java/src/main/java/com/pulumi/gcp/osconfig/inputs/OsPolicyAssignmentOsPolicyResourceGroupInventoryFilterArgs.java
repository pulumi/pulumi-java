...
public final class OsPolicyAssignmentOsPolicyResourceGroupInventoryFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OsPolicyAssignmentOsPolicyResourceGroupInventoryFilterArgs(OsPolicyAssignmentOsPolicyResourceGroupInventoryFilterArgs $) {
    ...
    public static Builder builder(OsPolicyAssignmentOsPolicyResourceGroupInventoryFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OsPolicyAssignmentOsPolicyResourceGroupInventoryFilterArgs();
        }

        public Builder(OsPolicyAssignmentOsPolicyResourceGroupInventoryFilterArgs defaults) {
            $ = new OsPolicyAssignmentOsPolicyResourceGroupInventoryFilterArgs(Objects.requireNonNull(defaults));
        }
