...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryZypperArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryZypperArgs(OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryZypperArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryZypperArgs();
        }

        public Builder(OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryZypperArgs defaults) {
            $ = new OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryZypperArgs(Objects.requireNonNull(defaults));
        }
