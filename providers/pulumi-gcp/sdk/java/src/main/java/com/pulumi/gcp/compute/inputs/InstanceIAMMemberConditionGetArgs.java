...
public final class InstanceIAMMemberConditionGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceIAMMemberConditionGetArgs Empty = new InstanceIAMMemberConditionGetArgs();
    ...
    private InstanceIAMMemberConditionGetArgs() {}

    private InstanceIAMMemberConditionGetArgs(InstanceIAMMemberConditionGetArgs $) {
    ...
    public static Builder builder(InstanceIAMMemberConditionGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceIAMMemberConditionGetArgs();
        }

        public Builder(InstanceIAMMemberConditionGetArgs defaults) {
            $ = new InstanceIAMMemberConditionGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceIAMMemberConditionGetArgs build() {
