...
public final class TopicIAMMemberState extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="condition")
      private final @Nullable Output<TopicIAMMemberConditionGetArgs> condition;

    public Output<TopicIAMMemberConditionGetArgs> condition() {
    ...
    public TopicIAMMemberState(
        @Nullable Output<TopicIAMMemberConditionGetArgs> condition,
    ...
    public static final class Builder {
        ...
        public Builder condition(@Nullable TopicIAMMemberConditionGetArgs condition) {
        ...
        public Builder topic(@Nullable String topic) {
            ...
            return new TopicIAMMemberState(condition, etag, member, project, role, topic);
        }
    }
}
