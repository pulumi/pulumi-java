...
public final class CxPageEntryFulfillmentMessageTextGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CxPageEntryFulfillmentMessageTextGetArgs(CxPageEntryFulfillmentMessageTextGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxPageEntryFulfillmentMessageTextGetArgs();
        }

        public Builder(CxPageEntryFulfillmentMessageTextGetArgs defaults) {
            $ = new CxPageEntryFulfillmentMessageTextGetArgs(Objects.requireNonNull(defaults));
        }
