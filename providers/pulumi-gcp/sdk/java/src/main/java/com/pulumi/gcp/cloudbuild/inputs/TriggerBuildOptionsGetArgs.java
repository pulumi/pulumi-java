...
public final class TriggerBuildOptionsGetArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<List<TriggerBuildOptionsVolumeGetArgs>>> volumes() {
    ...
    private TriggerBuildOptionsGetArgs(TriggerBuildOptionsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TriggerBuildOptionsGetArgs();
        }

        public Builder(TriggerBuildOptionsGetArgs defaults) {
            $ = new TriggerBuildOptionsGetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder volumes(List<TriggerBuildOptionsVolumeGetArgs> volumes) {
