...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileRemoteArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileRemoteArgs(OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileRemoteArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFileRemoteArgs();
        }
