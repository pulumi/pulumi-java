...
public final class AccessLevelBasicConditionGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="devicePolicy")
      private final @Nullable Output<AccessLevelBasicConditionDevicePolicyGetArgs> devicePolicy;

    public Output<AccessLevelBasicConditionDevicePolicyGetArgs> devicePolicy() {
    ...
    public AccessLevelBasicConditionGetArgs(
        @Nullable Output<AccessLevelBasicConditionDevicePolicyGetArgs> devicePolicy,
