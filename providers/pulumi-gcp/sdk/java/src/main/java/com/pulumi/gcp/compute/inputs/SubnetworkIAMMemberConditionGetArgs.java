...
public final class SubnetworkIAMMemberConditionGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SubnetworkIAMMemberConditionGetArgs(SubnetworkIAMMemberConditionGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SubnetworkIAMMemberConditionGetArgs();
        }

        public Builder(SubnetworkIAMMemberConditionGetArgs defaults) {
            $ = new SubnetworkIAMMemberConditionGetArgs(Objects.requireNonNull(defaults));
        }
