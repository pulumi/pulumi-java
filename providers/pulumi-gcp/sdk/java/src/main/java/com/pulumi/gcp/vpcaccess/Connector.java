...
public class Connector extends CustomResource {
     ...
     */
    public Connector(String name, @Nullable ConnectorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Connector(String name, Output<String> id, @Nullable ConnectorState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Connector get(String name, Output<String> id, @Nullable ConnectorState state, @Nullable CustomResourceOptions options) {
