...
public final class CertificateConfigX509ConfigAdditionalExtensionObjectIdGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final CertificateConfigX509ConfigAdditionalExtensionObjectIdGetArgs Empty = new CertificateConfigX509ConfigAdditionalExtensionObjectIdGetArgs();
    ...
    private CertificateConfigX509ConfigAdditionalExtensionObjectIdGetArgs() {}

    private CertificateConfigX509ConfigAdditionalExtensionObjectIdGetArgs(CertificateConfigX509ConfigAdditionalExtensionObjectIdGetArgs $) {
    ...
    public static Builder builder(CertificateConfigX509ConfigAdditionalExtensionObjectIdGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CertificateConfigX509ConfigAdditionalExtensionObjectIdGetArgs();
        }

        public Builder(CertificateConfigX509ConfigAdditionalExtensionObjectIdGetArgs defaults) {
            $ = new CertificateConfigX509ConfigAdditionalExtensionObjectIdGetArgs(Objects.requireNonNull(defaults));
        }
