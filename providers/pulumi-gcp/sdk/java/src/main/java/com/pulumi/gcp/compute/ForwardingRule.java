...
public class ForwardingRule extends CustomResource {
     ...
     */
    public ForwardingRule(String name, @Nullable ForwardingRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ForwardingRule(String name, Output<String> id, @Nullable ForwardingRuleState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ForwardingRule get(String name, Output<String> id, @Nullable ForwardingRuleState state, @Nullable CustomResourceOptions options) {
