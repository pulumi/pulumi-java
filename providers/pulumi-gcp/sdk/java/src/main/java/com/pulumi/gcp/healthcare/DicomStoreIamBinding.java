...
public class DicomStoreIamBinding extends CustomResource {
     ...
     */
    public DicomStoreIamBinding(String name, DicomStoreIamBindingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DicomStoreIamBinding(String name, Output<String> id, @Nullable DicomStoreIamBindingState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DicomStoreIamBinding get(String name, Output<String> id, @Nullable DicomStoreIamBindingState state, @Nullable CustomResourceOptions options) {
