...
public final class RegionBackendServiceOutlierDetectionBaseEjectionTimeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegionBackendServiceOutlierDetectionBaseEjectionTimeArgs(RegionBackendServiceOutlierDetectionBaseEjectionTimeArgs $) {
        this.nanos = $.nanos;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionBackendServiceOutlierDetectionBaseEjectionTimeArgs();
        }

        public Builder(RegionBackendServiceOutlierDetectionBaseEjectionTimeArgs defaults) {
            $ = new RegionBackendServiceOutlierDetectionBaseEjectionTimeArgs(Objects.requireNonNull(defaults));
        }
