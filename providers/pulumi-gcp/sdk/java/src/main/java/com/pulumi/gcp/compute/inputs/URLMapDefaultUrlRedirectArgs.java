...
public final class URLMapDefaultUrlRedirectArgs extends com.pulumi.resources.ResourceArgs {

    public static final URLMapDefaultUrlRedirectArgs Empty = new URLMapDefaultUrlRedirectArgs();
