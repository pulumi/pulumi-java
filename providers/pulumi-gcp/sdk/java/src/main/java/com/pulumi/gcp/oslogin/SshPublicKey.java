...
public class SshPublicKey extends CustomResource {
    ...
    private SshPublicKey(String name, Output<String> id, @Nullable SshPublicKeyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SshPublicKey get(String name, Output<String> id, @Nullable SshPublicKeyState state, @Nullable CustomResourceOptions options) {
