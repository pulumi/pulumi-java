...
public final class InstanceFromMachineImageServiceAccountArgs extends ResourceArgs {
    ...
    private InstanceFromMachineImageServiceAccountArgs(InstanceFromMachineImageServiceAccountArgs $) {
        this.email = $.email;
        this.scopes = $.scopes;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceFromMachineImageServiceAccountArgs();
        }

        public Builder(InstanceFromMachineImageServiceAccountArgs defaults) {
            $ = new InstanceFromMachineImageServiceAccountArgs(Objects.requireNonNull(defaults));
        }
