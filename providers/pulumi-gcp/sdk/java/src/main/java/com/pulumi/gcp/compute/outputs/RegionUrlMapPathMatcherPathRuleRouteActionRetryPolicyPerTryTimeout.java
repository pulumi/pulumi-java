...
@CustomType
public final class RegionUrlMapPathMatcherPathRuleRouteActionRetryPolicyPerTryTimeout {
    /**
    ...
    private RegionUrlMapPathMatcherPathRuleRouteActionRetryPolicyPerTryTimeout(
    ...
    */
    ...
    public static Builder builder(RegionUrlMapPathMatcherPathRuleRouteActionRetryPolicyPerTryTimeout defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RegionUrlMapPathMatcherPathRuleRouteActionRetryPolicyPerTryTimeout defaults) {
