...
public final class ServicePerimeterSpecIngressPolicyIngressFromSourceArgs extends ResourceArgs {
    ...
    private ServicePerimeterSpecIngressPolicyIngressFromSourceArgs(ServicePerimeterSpecIngressPolicyIngressFromSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServicePerimeterSpecIngressPolicyIngressFromSourceArgs();
        }

        public Builder(ServicePerimeterSpecIngressPolicyIngressFromSourceArgs defaults) {
            $ = new ServicePerimeterSpecIngressPolicyIngressFromSourceArgs(Objects.requireNonNull(defaults));
        }
