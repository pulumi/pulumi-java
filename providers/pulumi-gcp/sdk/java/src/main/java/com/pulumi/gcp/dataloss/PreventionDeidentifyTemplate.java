...
public class PreventionDeidentifyTemplate extends CustomResource {
    /**
     ...
     */
    public PreventionDeidentifyTemplate(String name, PreventionDeidentifyTemplateArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PreventionDeidentifyTemplate(String name, Output<String> id, @Nullable PreventionDeidentifyTemplateState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PreventionDeidentifyTemplate get(String name, Output<String> id, @Nullable PreventionDeidentifyTemplateState state, @Nullable CustomResourceOptions options) {
