...
public class EnvironmentIamPolicy extends CustomResource {
    /**
     ...
     */
    public EnvironmentIamPolicy(String name, EnvironmentIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EnvironmentIamPolicy(String name, Output<String> id, @Nullable EnvironmentIamPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EnvironmentIamPolicy get(String name, Output<String> id, @Nullable EnvironmentIamPolicyState state, @Nullable CustomResourceOptions options) {
