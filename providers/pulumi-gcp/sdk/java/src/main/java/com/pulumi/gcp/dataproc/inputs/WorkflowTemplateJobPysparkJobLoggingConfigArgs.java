...
public final class WorkflowTemplateJobPysparkJobLoggingConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WorkflowTemplateJobPysparkJobLoggingConfigArgs(WorkflowTemplateJobPysparkJobLoggingConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkflowTemplateJobPysparkJobLoggingConfigArgs();
        }

        public Builder(WorkflowTemplateJobPysparkJobLoggingConfigArgs defaults) {
            $ = new WorkflowTemplateJobPysparkJobLoggingConfigArgs(Objects.requireNonNull(defaults));
        }
