...
public final class InstanceFromTemplateAttachedDiskGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceFromTemplateAttachedDiskGetArgs(InstanceFromTemplateAttachedDiskGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceFromTemplateAttachedDiskGetArgs();
        }

        public Builder(InstanceFromTemplateAttachedDiskGetArgs defaults) {
            $ = new InstanceFromTemplateAttachedDiskGetArgs(Objects.requireNonNull(defaults));
        }
