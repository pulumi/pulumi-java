...
public class AccessPolicyIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public AccessPolicyIamPolicy(String name, AccessPolicyIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:accesscontextmanager/accessPolicyIamPolicy:AccessPolicyIamPolicy", name, args == null ? AccessPolicyIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AccessPolicyIamPolicy(String name, Output<String> id, @Nullable AccessPolicyIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:accesscontextmanager/accessPolicyIamPolicy:AccessPolicyIamPolicy", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static AccessPolicyIamPolicy get(String name, Output<String> id, @Nullable AccessPolicyIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
