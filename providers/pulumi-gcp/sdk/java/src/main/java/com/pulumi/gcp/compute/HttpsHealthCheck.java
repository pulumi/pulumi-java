...
public class HttpsHealthCheck extends CustomResource {
    ...
    private HttpsHealthCheck(String name, Output<String> id, @Nullable HttpsHealthCheckState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HttpsHealthCheck get(String name, Output<String> id, @Nullable HttpsHealthCheckState state, @Nullable CustomResourceOptions options) {
