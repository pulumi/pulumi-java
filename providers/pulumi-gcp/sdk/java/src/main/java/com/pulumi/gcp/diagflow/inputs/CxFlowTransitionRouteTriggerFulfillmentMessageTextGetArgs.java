...
public final class CxFlowTransitionRouteTriggerFulfillmentMessageTextGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CxFlowTransitionRouteTriggerFulfillmentMessageTextGetArgs(CxFlowTransitionRouteTriggerFulfillmentMessageTextGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxFlowTransitionRouteTriggerFulfillmentMessageTextGetArgs();
        }

        public Builder(CxFlowTransitionRouteTriggerFulfillmentMessageTextGetArgs defaults) {
            $ = new CxFlowTransitionRouteTriggerFulfillmentMessageTextGetArgs(Objects.requireNonNull(defaults));
        }
