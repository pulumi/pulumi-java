...
public final class ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperationMethodSelectorGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperationMethodSelectorGetArgs(ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperationMethodSelectorGetArgs $) {
        this.method = $.method;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperationMethodSelectorGetArgs();
        }

        public Builder(ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperationMethodSelectorGetArgs defaults) {
            $ = new ServicePerimetersServicePerimeterSpecEgressPolicyEgressToOperationMethodSelectorGetArgs(Objects.requireNonNull(defaults));
        }
