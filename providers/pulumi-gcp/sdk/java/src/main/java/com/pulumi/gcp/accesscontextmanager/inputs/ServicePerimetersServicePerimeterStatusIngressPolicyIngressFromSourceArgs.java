...
public final class ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourceArgs(ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourceArgs();
        }

        public Builder(ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourceArgs defaults) {
            $ = new ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourceArgs(Objects.requireNonNull(defaults));
        }
