...
public final class HealthCheckHttpsHealthCheckGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private HealthCheckHttpsHealthCheckGetArgs(HealthCheckHttpsHealthCheckGetArgs $) {
        this.host = $.host;
        this.port = $.port;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HealthCheckHttpsHealthCheckGetArgs();
        }

        public Builder(HealthCheckHttpsHealthCheckGetArgs defaults) {
            $ = new HealthCheckHttpsHealthCheckGetArgs(Objects.requireNonNull(defaults));
        }
