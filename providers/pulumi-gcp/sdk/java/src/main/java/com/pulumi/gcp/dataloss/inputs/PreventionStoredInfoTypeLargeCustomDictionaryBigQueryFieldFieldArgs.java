...
public final class PreventionStoredInfoTypeLargeCustomDictionaryBigQueryFieldFieldArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PreventionStoredInfoTypeLargeCustomDictionaryBigQueryFieldFieldArgs(PreventionStoredInfoTypeLargeCustomDictionaryBigQueryFieldFieldArgs $) {
        this.name = $.name;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PreventionStoredInfoTypeLargeCustomDictionaryBigQueryFieldFieldArgs();
        }
