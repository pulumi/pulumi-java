...
public class ProjectExclusion extends CustomResource {
    /**
     ...
     */
    public ProjectExclusion(String name, ProjectExclusionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProjectExclusion(String name, Output<String> id, @Nullable ProjectExclusionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProjectExclusion get(String name, Output<String> id, @Nullable ProjectExclusionState state, @Nullable CustomResourceOptions options) {
