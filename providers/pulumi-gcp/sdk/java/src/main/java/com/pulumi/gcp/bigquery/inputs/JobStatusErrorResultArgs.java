...
public final class JobStatusErrorResultArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private JobStatusErrorResultArgs(JobStatusErrorResultArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobStatusErrorResultArgs();
        }

        public Builder(JobStatusErrorResultArgs defaults) {
            $ = new JobStatusErrorResultArgs(Objects.requireNonNull(defaults));
        }
