...
public final class ClusterDnsConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterDnsConfigGetArgs(ClusterDnsConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterDnsConfigGetArgs();
        }

        public Builder(ClusterDnsConfigGetArgs defaults) {
            $ = new ClusterDnsConfigGetArgs(Objects.requireNonNull(defaults));
        }
