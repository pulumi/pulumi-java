...
public class MonitoredProject extends CustomResource {
    /**
     ...
     */
    public MonitoredProject(String name, MonitoredProjectArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MonitoredProject(String name, Output<String> id, @Nullable MonitoredProjectState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MonitoredProject get(String name, Output<String> id, @Nullable MonitoredProjectState state, @Nullable CustomResourceOptions options) {
