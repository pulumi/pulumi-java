...
public final class AwsClusterControlPlaneRootVolumeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AwsClusterControlPlaneRootVolumeGetArgs(AwsClusterControlPlaneRootVolumeGetArgs $) {
        this.iops = $.iops;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsClusterControlPlaneRootVolumeGetArgs();
        }

        public Builder(AwsClusterControlPlaneRootVolumeGetArgs defaults) {
            $ = new AwsClusterControlPlaneRootVolumeGetArgs(Objects.requireNonNull(defaults));
        }
