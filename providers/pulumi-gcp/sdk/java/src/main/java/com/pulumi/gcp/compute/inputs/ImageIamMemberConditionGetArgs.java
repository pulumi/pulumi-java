...
public final class ImageIamMemberConditionGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ImageIamMemberConditionGetArgs(ImageIamMemberConditionGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ImageIamMemberConditionGetArgs();
        }

        public Builder(ImageIamMemberConditionGetArgs defaults) {
            $ = new ImageIamMemberConditionGetArgs(Objects.requireNonNull(defaults));
        }
