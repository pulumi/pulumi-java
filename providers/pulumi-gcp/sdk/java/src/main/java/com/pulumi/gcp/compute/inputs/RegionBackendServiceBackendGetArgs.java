...
public final class RegionBackendServiceBackendGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegionBackendServiceBackendGetArgs(RegionBackendServiceBackendGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionBackendServiceBackendGetArgs();
        }

        public Builder(RegionBackendServiceBackendGetArgs defaults) {
            $ = new RegionBackendServiceBackendGetArgs(Objects.requireNonNull(defaults));
        }
