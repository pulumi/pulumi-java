...
public final class URLMapDefaultRouteActionUrlRewriteGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private URLMapDefaultRouteActionUrlRewriteGetArgs(URLMapDefaultRouteActionUrlRewriteGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapDefaultRouteActionUrlRewriteGetArgs();
        }

        public Builder(URLMapDefaultRouteActionUrlRewriteGetArgs defaults) {
            $ = new URLMapDefaultRouteActionUrlRewriteGetArgs(Objects.requireNonNull(defaults));
        }
