...
import com.pulumi.gcp.accesscontextmanager.outputs.AccessLevelConditionDevicePolicyOsConstraint;
...
public final class AccessLevelConditionDevicePolicy {
    ...
    private final @Nullable List<String> allowedEncryptionStatuses;
         ...
         * 
         */
    private final @Nullable List<AccessLevelConditionDevicePolicyOsConstraint> osConstraints;
        /**
     ...
     * 
     */
    public List<AccessLevelConditionDevicePolicyOsConstraint> osConstraints() {
    ...
    public static Builder builder(AccessLevelConditionDevicePolicy defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<AccessLevelConditionDevicePolicyOsConstraint> osConstraints;
        ...
        public Builder(AccessLevelConditionDevicePolicy defaults) {
        ...
        public Builder osConstraints(@Nullable List<AccessLevelConditionDevicePolicyOsConstraint> osConstraints) {
            this.osConstraints = osConstraints;
            return this;
        }
        public Builder osConstraints(AccessLevelConditionDevicePolicyOsConstraint... osConstraints) {
        ...
        public Builder requireScreenLock(@Nullable Boolean requireScreenLock) {
            this.requireScreenLock = requireScreenLock;
            return this;
        }        public AccessLevelConditionDevicePolicy build() {
            return new AccessLevelConditionDevicePolicy(allowedDeviceManagementLevels, allowedEncryptionStatuses, osConstraints, requireAdminApproval, requireCorpOwned, requireScreenLock);
        }
    }
}
