...
public final class ServicePerimetersServicePerimeterSpecVpcAccessibleServicesGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServicePerimetersServicePerimeterSpecVpcAccessibleServicesGetArgs Empty = new ServicePerimetersServicePerimeterSpecVpcAccessibleServicesGetArgs();
    ...
    private ServicePerimetersServicePerimeterSpecVpcAccessibleServicesGetArgs() {}

    private ServicePerimetersServicePerimeterSpecVpcAccessibleServicesGetArgs(ServicePerimetersServicePerimeterSpecVpcAccessibleServicesGetArgs $) {
    ...
    public static Builder builder(ServicePerimetersServicePerimeterSpecVpcAccessibleServicesGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServicePerimetersServicePerimeterSpecVpcAccessibleServicesGetArgs();
        }

        public Builder(ServicePerimetersServicePerimeterSpecVpcAccessibleServicesGetArgs defaults) {
        ...
        public ServicePerimetersServicePerimeterSpecVpcAccessibleServicesGetArgs build() {
            return $;
        }
    }
