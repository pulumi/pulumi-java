...
public final class InstanceTemplateNetworkInterfaceIpv6AccessConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceTemplateNetworkInterfaceIpv6AccessConfigGetArgs(InstanceTemplateNetworkInterfaceIpv6AccessConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceTemplateNetworkInterfaceIpv6AccessConfigGetArgs();
        }

        public Builder(InstanceTemplateNetworkInterfaceIpv6AccessConfigGetArgs defaults) {
            $ = new InstanceTemplateNetworkInterfaceIpv6AccessConfigGetArgs(Objects.requireNonNull(defaults));
        }
