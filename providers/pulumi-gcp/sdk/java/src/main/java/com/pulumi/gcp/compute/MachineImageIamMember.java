...
public class MachineImageIamMember extends CustomResource {
    /**
     ...
     */
    public MachineImageIamMember(String name, MachineImageIamMemberArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MachineImageIamMember(String name, Output<String> id, @Nullable MachineImageIamMemberState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MachineImageIamMember get(String name, Output<String> id, @Nullable MachineImageIamMemberState state, @Nullable CustomResourceOptions options) {
