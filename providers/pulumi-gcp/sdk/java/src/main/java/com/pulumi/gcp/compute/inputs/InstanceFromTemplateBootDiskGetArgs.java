...
import com.pulumi.gcp.compute.inputs.InstanceFromTemplateBootDiskInitializeParamsGetArgs;
...
public final class InstanceFromTemplateBootDiskGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<InstanceFromTemplateBootDiskInitializeParamsGetArgs>> initializeParams() {
    ...
    private InstanceFromTemplateBootDiskGetArgs(InstanceFromTemplateBootDiskGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceFromTemplateBootDiskGetArgs();
        }

        public Builder(InstanceFromTemplateBootDiskGetArgs defaults) {
            $ = new InstanceFromTemplateBootDiskGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder initializeParams(InstanceFromTemplateBootDiskInitializeParamsGetArgs initializeParams) {
