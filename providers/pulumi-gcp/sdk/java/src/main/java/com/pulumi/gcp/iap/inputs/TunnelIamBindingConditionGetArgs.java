...
public final class TunnelIamBindingConditionGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final TunnelIamBindingConditionGetArgs Empty = new TunnelIamBindingConditionGetArgs();
    ...
    private TunnelIamBindingConditionGetArgs() {}

    private TunnelIamBindingConditionGetArgs(TunnelIamBindingConditionGetArgs $) {
    ...
    public static Builder builder(TunnelIamBindingConditionGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TunnelIamBindingConditionGetArgs();
        }

        public Builder(TunnelIamBindingConditionGetArgs defaults) {
            $ = new TunnelIamBindingConditionGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TunnelIamBindingConditionGetArgs build() {
