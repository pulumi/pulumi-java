...
public class RegionDiskIamPolicy extends CustomResource {
    ...
    private RegionDiskIamPolicy(String name, Output<String> id, @Nullable RegionDiskIamPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegionDiskIamPolicy get(String name, Output<String> id, @Nullable RegionDiskIamPolicyState state, @Nullable CustomResourceOptions options) {
