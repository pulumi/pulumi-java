...
public final class AwsClusterNetworkingGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AwsClusterNetworkingGetArgs(AwsClusterNetworkingGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsClusterNetworkingGetArgs();
        }

        public Builder(AwsClusterNetworkingGetArgs defaults) {
            $ = new AwsClusterNetworkingGetArgs(Objects.requireNonNull(defaults));
        }
