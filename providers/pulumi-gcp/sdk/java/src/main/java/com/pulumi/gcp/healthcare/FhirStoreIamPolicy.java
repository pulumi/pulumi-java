...
public class FhirStoreIamPolicy extends CustomResource {
    /**
     ...
     */
    public FhirStoreIamPolicy(String name, FhirStoreIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FhirStoreIamPolicy(String name, Output<String> id, @Nullable FhirStoreIamPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FhirStoreIamPolicy get(String name, Output<String> id, @Nullable FhirStoreIamPolicyState state, @Nullable CustomResourceOptions options) {
