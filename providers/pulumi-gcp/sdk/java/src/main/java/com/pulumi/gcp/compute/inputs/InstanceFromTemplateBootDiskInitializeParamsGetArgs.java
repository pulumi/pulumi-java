...
public final class InstanceFromTemplateBootDiskInitializeParamsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceFromTemplateBootDiskInitializeParamsGetArgs(InstanceFromTemplateBootDiskInitializeParamsGetArgs $) {
        this.image = $.image;
        this.labels = $.labels;
        this.size = $.size;
        this.type = $.type;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceFromTemplateBootDiskInitializeParamsGetArgs();
        }

        public Builder(InstanceFromTemplateBootDiskInitializeParamsGetArgs defaults) {
            $ = new InstanceFromTemplateBootDiskInitializeParamsGetArgs(Objects.requireNonNull(defaults));
        }
