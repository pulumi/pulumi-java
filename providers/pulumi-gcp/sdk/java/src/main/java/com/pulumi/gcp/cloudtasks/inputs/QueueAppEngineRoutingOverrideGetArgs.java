...
public final class QueueAppEngineRoutingOverrideGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private QueueAppEngineRoutingOverrideGetArgs(QueueAppEngineRoutingOverrideGetArgs $) {
        this.host = $.host;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new QueueAppEngineRoutingOverrideGetArgs();
        }

        public Builder(QueueAppEngineRoutingOverrideGetArgs defaults) {
            $ = new QueueAppEngineRoutingOverrideGetArgs(Objects.requireNonNull(defaults));
        }
