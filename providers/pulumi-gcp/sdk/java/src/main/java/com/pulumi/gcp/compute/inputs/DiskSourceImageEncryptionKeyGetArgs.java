...
public final class DiskSourceImageEncryptionKeyGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DiskSourceImageEncryptionKeyGetArgs(DiskSourceImageEncryptionKeyGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DiskSourceImageEncryptionKeyGetArgs();
        }

        public Builder(DiskSourceImageEncryptionKeyGetArgs defaults) {
            $ = new DiskSourceImageEncryptionKeyGetArgs(Objects.requireNonNull(defaults));
        }
