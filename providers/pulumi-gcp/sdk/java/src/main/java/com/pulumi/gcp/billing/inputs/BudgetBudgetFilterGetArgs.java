...
public final class BudgetBudgetFilterGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private BudgetBudgetFilterGetArgs(BudgetBudgetFilterGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetBudgetFilterGetArgs();
        }

        public Builder(BudgetBudgetFilterGetArgs defaults) {
            $ = new BudgetBudgetFilterGetArgs(Objects.requireNonNull(defaults));
        }
