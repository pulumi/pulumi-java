...
public final class InstanceGroupManagerUpdatePolicyGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceGroupManagerUpdatePolicyGetArgs(InstanceGroupManagerUpdatePolicyGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceGroupManagerUpdatePolicyGetArgs();
        }

        public Builder(InstanceGroupManagerUpdatePolicyGetArgs defaults) {
            $ = new InstanceGroupManagerUpdatePolicyGetArgs(Objects.requireNonNull(defaults));
        }
