...
public class ServiceIdentity extends CustomResource {
    /**
     ...
     */
    public ServiceIdentity(String name, ServiceIdentityArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceIdentity(String name, Output<String> id, @Nullable ServiceIdentityState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceIdentity get(String name, Output<String> id, @Nullable ServiceIdentityState state, @Nullable CustomResourceOptions options) {
