...
public final class CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessageTextGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessageTextGetArgs(CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessageTextGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessageTextGetArgs();
        }

        public Builder(CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessageTextGetArgs defaults) {
            $ = new CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessageTextGetArgs(Objects.requireNonNull(defaults));
        }
