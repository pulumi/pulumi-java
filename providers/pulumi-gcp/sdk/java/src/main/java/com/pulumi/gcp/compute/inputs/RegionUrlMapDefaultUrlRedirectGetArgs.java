...
public final class RegionUrlMapDefaultUrlRedirectGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegionUrlMapDefaultUrlRedirectGetArgs(RegionUrlMapDefaultUrlRedirectGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionUrlMapDefaultUrlRedirectGetArgs();
        }

        public Builder(RegionUrlMapDefaultUrlRedirectGetArgs defaults) {
            $ = new RegionUrlMapDefaultUrlRedirectGetArgs(Objects.requireNonNull(defaults));
        }
