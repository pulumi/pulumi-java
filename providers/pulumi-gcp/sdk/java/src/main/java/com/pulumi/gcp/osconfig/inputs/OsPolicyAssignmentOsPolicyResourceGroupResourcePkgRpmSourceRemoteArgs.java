...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceRemoteArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceRemoteArgs(OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceRemoteArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceRemoteArgs();
        }

        public Builder(OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceRemoteArgs defaults) {
            $ = new OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceRemoteArgs(Objects.requireNonNull(defaults));
        }
