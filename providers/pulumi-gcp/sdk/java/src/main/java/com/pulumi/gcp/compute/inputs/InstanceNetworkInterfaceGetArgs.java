...
import com.pulumi.gcp.compute.inputs.InstanceNetworkInterfaceAccessConfigGetArgs;
import com.pulumi.gcp.compute.inputs.InstanceNetworkInterfaceAliasIpRangeGetArgs;
import com.pulumi.gcp.compute.inputs.InstanceNetworkInterfaceIpv6AccessConfigGetArgs;
...
public final class InstanceNetworkInterfaceGetArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<List<InstanceNetworkInterfaceAccessConfigGetArgs>>> accessConfigs() {
     ...
     * 
     */
    public Optional<Output<List<InstanceNetworkInterfaceAliasIpRangeGetArgs>>> aliasIpRanges() {
     ...
     * 
     */
    public Optional<Output<List<InstanceNetworkInterfaceIpv6AccessConfigGetArgs>>> ipv6AccessConfigs() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder accessConfigs(List<InstanceNetworkInterfaceAccessConfigGetArgs> accessConfigs) {
         ...
         * 
         */
        public Builder accessConfigs(InstanceNetworkInterfaceAccessConfigGetArgs... accessConfigs) {
         ...
         * 
         */
        public Builder aliasIpRanges(List<InstanceNetworkInterfaceAliasIpRangeGetArgs> aliasIpRanges) {
         ...
         * 
         */
        public Builder aliasIpRanges(InstanceNetworkInterfaceAliasIpRangeGetArgs... aliasIpRanges) {
         ...
         * 
         */
        public Builder ipv6AccessConfigs(List<InstanceNetworkInterfaceIpv6AccessConfigGetArgs> ipv6AccessConfigs) {
         ...
         * 
         */
        public Builder ipv6AccessConfigs(InstanceNetworkInterfaceIpv6AccessConfigGetArgs... ipv6AccessConfigs) {
