...
public class RegionTargetHttpsProxy extends CustomResource {
    /**
     ...
     */
    public RegionTargetHttpsProxy(String name, RegionTargetHttpsProxyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegionTargetHttpsProxy(String name, Output<String> id, @Nullable RegionTargetHttpsProxyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegionTargetHttpsProxy get(String name, Output<String> id, @Nullable RegionTargetHttpsProxyState state, @Nullable CustomResourceOptions options) {
