...
public final class ProjectExclusionState extends com.pulumi.resources.ResourceArgs {
    ...
    private ProjectExclusionState(ProjectExclusionState $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectExclusionState();
        }

        public Builder(ProjectExclusionState defaults) {
            $ = new ProjectExclusionState(Objects.requireNonNull(defaults));
        }
