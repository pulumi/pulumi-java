...
public final class KeyRingIAMMemberConditionGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final KeyRingIAMMemberConditionGetArgs Empty = new KeyRingIAMMemberConditionGetArgs();
    ...
    private KeyRingIAMMemberConditionGetArgs() {}

    private KeyRingIAMMemberConditionGetArgs(KeyRingIAMMemberConditionGetArgs $) {
    ...
    public static Builder builder(KeyRingIAMMemberConditionGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KeyRingIAMMemberConditionGetArgs();
        }

        public Builder(KeyRingIAMMemberConditionGetArgs defaults) {
            $ = new KeyRingIAMMemberConditionGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KeyRingIAMMemberConditionGetArgs build() {
