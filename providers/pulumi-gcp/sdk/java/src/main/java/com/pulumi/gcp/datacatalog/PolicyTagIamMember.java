...
public class PolicyTagIamMember extends CustomResource {
     ...
     */
    public PolicyTagIamMember(String name, PolicyTagIamMemberArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PolicyTagIamMember(String name, Output<String> id, @Nullable PolicyTagIamMemberState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PolicyTagIamMember get(String name, Output<String> id, @Nullable PolicyTagIamMemberState state, @Nullable CustomResourceOptions options) {
