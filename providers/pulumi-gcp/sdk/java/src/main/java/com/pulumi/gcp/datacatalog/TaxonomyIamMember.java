...
public class TaxonomyIamMember extends CustomResource {
     ...
     */
    public TaxonomyIamMember(String name, TaxonomyIamMemberArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TaxonomyIamMember(String name, Output<String> id, @Nullable TaxonomyIamMemberState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TaxonomyIamMember get(String name, Output<String> id, @Nullable TaxonomyIamMemberState state, @Nullable CustomResourceOptions options) {
