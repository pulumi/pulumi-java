...
public final class ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromGetArgs Empty = new ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromGetArgs();
    ...
    private ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromGetArgs(ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromGetArgs $) {
    ...
    public static Builder builder(ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromGetArgs();
        }

        public Builder(ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromGetArgs defaults) {
            $ = new ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromGetArgs(Objects.requireNonNull(defaults));
        }
