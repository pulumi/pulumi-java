...
public final class EnvironmentConfigNodeConfigIpAllocationPolicyGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EnvironmentConfigNodeConfigIpAllocationPolicyGetArgs(EnvironmentConfigNodeConfigIpAllocationPolicyGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EnvironmentConfigNodeConfigIpAllocationPolicyGetArgs();
        }

        public Builder(EnvironmentConfigNodeConfigIpAllocationPolicyGetArgs defaults) {
            $ = new EnvironmentConfigNodeConfigIpAllocationPolicyGetArgs(Objects.requireNonNull(defaults));
        }
