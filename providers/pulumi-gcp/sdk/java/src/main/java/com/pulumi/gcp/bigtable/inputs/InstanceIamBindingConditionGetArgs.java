...
public final class InstanceIamBindingConditionGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceIamBindingConditionGetArgs(InstanceIamBindingConditionGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceIamBindingConditionGetArgs();
        }

        public Builder(InstanceIamBindingConditionGetArgs defaults) {
            $ = new InstanceIamBindingConditionGetArgs(Objects.requireNonNull(defaults));
        }
