...
public class Taxonomy extends CustomResource {
    ...
    private Taxonomy(String name, Output<String> id, @Nullable TaxonomyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Taxonomy get(String name, Output<String> id, @Nullable TaxonomyState state, @Nullable CustomResourceOptions options) {
