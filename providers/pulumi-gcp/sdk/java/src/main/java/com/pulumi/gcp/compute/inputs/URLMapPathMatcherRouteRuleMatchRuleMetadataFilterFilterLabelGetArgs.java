...
public final class URLMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabelGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private URLMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabelGetArgs(URLMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabelGetArgs $) {
        this.name = $.name;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabelGetArgs();
        }

        public Builder(URLMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabelGetArgs defaults) {
            $ = new URLMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabelGetArgs(Objects.requireNonNull(defaults));
        }
