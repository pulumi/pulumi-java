...
public final class PatchDeploymentRecurringScheduleTimeOfDayGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PatchDeploymentRecurringScheduleTimeOfDayGetArgs(PatchDeploymentRecurringScheduleTimeOfDayGetArgs $) {
        this.hours = $.hours;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PatchDeploymentRecurringScheduleTimeOfDayGetArgs();
        }

        public Builder(PatchDeploymentRecurringScheduleTimeOfDayGetArgs defaults) {
            $ = new PatchDeploymentRecurringScheduleTimeOfDayGetArgs(Objects.requireNonNull(defaults));
        }
