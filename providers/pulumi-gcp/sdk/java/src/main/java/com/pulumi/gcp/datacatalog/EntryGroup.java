...
public class EntryGroup extends CustomResource {
    ...
    private EntryGroup(String name, Output<String> id, @Nullable EntryGroupState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EntryGroup get(String name, Output<String> id, @Nullable EntryGroupState state, @Nullable CustomResourceOptions options) {
