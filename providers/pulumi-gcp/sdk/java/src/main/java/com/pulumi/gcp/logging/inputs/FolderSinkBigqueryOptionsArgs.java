...
public final class FolderSinkBigqueryOptionsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FolderSinkBigqueryOptionsArgs(FolderSinkBigqueryOptionsArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FolderSinkBigqueryOptionsArgs();
        }

        public Builder(FolderSinkBigqueryOptionsArgs defaults) {
            $ = new FolderSinkBigqueryOptionsArgs(Objects.requireNonNull(defaults));
        }
