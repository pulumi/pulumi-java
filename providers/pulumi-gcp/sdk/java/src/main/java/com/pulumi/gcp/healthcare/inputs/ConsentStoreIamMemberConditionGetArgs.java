...
public final class ConsentStoreIamMemberConditionGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ConsentStoreIamMemberConditionGetArgs(ConsentStoreIamMemberConditionGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConsentStoreIamMemberConditionGetArgs();
        }

        public Builder(ConsentStoreIamMemberConditionGetArgs defaults) {
            $ = new ConsentStoreIamMemberConditionGetArgs(Objects.requireNonNull(defaults));
        }
