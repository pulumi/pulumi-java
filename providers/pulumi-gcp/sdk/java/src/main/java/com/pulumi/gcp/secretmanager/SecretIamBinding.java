...
public class SecretIamBinding extends CustomResource {
     ...
     */
    public SecretIamBinding(String name, SecretIamBindingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SecretIamBinding(String name, Output<String> id, @Nullable SecretIamBindingState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SecretIamBinding get(String name, Output<String> id, @Nullable SecretIamBindingState state, @Nullable CustomResourceOptions options) {
