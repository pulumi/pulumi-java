...
public final class NodePoolNodeConfigGuestAcceleratorGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private NodePoolNodeConfigGuestAcceleratorGetArgs(NodePoolNodeConfigGuestAcceleratorGetArgs $) {
        this.count = $.count;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NodePoolNodeConfigGuestAcceleratorGetArgs();
        }

        public Builder(NodePoolNodeConfigGuestAcceleratorGetArgs defaults) {
            $ = new NodePoolNodeConfigGuestAcceleratorGetArgs(Objects.requireNonNull(defaults));
        }
