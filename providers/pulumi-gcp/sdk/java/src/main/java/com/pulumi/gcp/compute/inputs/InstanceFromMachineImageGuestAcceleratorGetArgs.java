...
public final class InstanceFromMachineImageGuestAcceleratorGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceFromMachineImageGuestAcceleratorGetArgs(InstanceFromMachineImageGuestAcceleratorGetArgs $) {
        this.count = $.count;
        this.type = $.type;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceFromMachineImageGuestAcceleratorGetArgs();
        }

        public Builder(InstanceFromMachineImageGuestAcceleratorGetArgs defaults) {
            $ = new InstanceFromMachineImageGuestAcceleratorGetArgs(Objects.requireNonNull(defaults));
        }
