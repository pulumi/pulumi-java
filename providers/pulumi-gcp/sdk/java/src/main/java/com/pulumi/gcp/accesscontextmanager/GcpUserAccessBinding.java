...
public class GcpUserAccessBinding extends CustomResource {
    ...
    private GcpUserAccessBinding(String name, Output<String> id, @Nullable GcpUserAccessBindingState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GcpUserAccessBinding get(String name, Output<String> id, @Nullable GcpUserAccessBindingState state, @Nullable CustomResourceOptions options) {
