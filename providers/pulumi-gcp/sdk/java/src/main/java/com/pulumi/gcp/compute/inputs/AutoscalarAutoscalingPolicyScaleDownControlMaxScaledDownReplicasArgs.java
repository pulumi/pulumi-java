...
public final class AutoscalarAutoscalingPolicyScaleDownControlMaxScaledDownReplicasArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AutoscalarAutoscalingPolicyScaleDownControlMaxScaledDownReplicasArgs(AutoscalarAutoscalingPolicyScaleDownControlMaxScaledDownReplicasArgs $) {
        this.fixed = $.fixed;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutoscalarAutoscalingPolicyScaleDownControlMaxScaledDownReplicasArgs();
        }

        public Builder(AutoscalarAutoscalingPolicyScaleDownControlMaxScaledDownReplicasArgs defaults) {
            $ = new AutoscalarAutoscalingPolicyScaleDownControlMaxScaledDownReplicasArgs(Objects.requireNonNull(defaults));
        }
