...
public final class HealthCheckSslHealthCheckGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private HealthCheckSslHealthCheckGetArgs(HealthCheckSslHealthCheckGetArgs $) {
        this.port = $.port;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HealthCheckSslHealthCheckGetArgs();
        }

        public Builder(HealthCheckSslHealthCheckGetArgs defaults) {
            $ = new HealthCheckSslHealthCheckGetArgs(Objects.requireNonNull(defaults));
        }
