...
public final class AlertPolicyConditionConditionAbsentTriggerGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AlertPolicyConditionConditionAbsentTriggerGetArgs(AlertPolicyConditionConditionAbsentTriggerGetArgs $) {
        this.count = $.count;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlertPolicyConditionConditionAbsentTriggerGetArgs();
        }

        public Builder(AlertPolicyConditionConditionAbsentTriggerGetArgs defaults) {
            $ = new AlertPolicyConditionConditionAbsentTriggerGetArgs(Objects.requireNonNull(defaults));
        }
