...
public final class ClusterAddonsConfigDnsCacheConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterAddonsConfigDnsCacheConfigGetArgs(ClusterAddonsConfigDnsCacheConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterAddonsConfigDnsCacheConfigGetArgs();
        }

        public Builder(ClusterAddonsConfigDnsCacheConfigGetArgs defaults) {
            $ = new ClusterAddonsConfigDnsCacheConfigGetArgs(Objects.requireNonNull(defaults));
        }
