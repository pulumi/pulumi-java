...
public class TenantInboundSamlConfig extends CustomResource {
    /**
     ...
     */
    public TenantInboundSamlConfig(String name, TenantInboundSamlConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TenantInboundSamlConfig(String name, Output<String> id, @Nullable TenantInboundSamlConfigState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TenantInboundSamlConfig get(String name, Output<String> id, @Nullable TenantInboundSamlConfigState state, @Nullable CustomResourceOptions options) {
