...
public final class RegionBackendServiceCdnPolicyGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Output<RegionBackendServiceCdnPolicyCacheKeyPolicyGetArgs> cacheKeyPolicy() {
    ...
    public Output<List<RegionBackendServiceCdnPolicyNegativeCachingPolicyGetArgs>> negativeCachingPolicies() {
    ...
    public RegionBackendServiceCdnPolicyGetArgs(
        @Nullable Output<RegionBackendServiceCdnPolicyCacheKeyPolicyGetArgs> cacheKeyPolicy,
        ...
        @Nullable Output<List<RegionBackendServiceCdnPolicyNegativeCachingPolicyGetArgs>> negativeCachingPolicies,
