...
public final class EnvironmentConfigWorkloadsConfigSchedulerGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EnvironmentConfigWorkloadsConfigSchedulerGetArgs(EnvironmentConfigWorkloadsConfigSchedulerGetArgs $) {
        this.count = $.count;
        this.cpu = $.cpu;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EnvironmentConfigWorkloadsConfigSchedulerGetArgs();
        }

        public Builder(EnvironmentConfigWorkloadsConfigSchedulerGetArgs defaults) {
            $ = new EnvironmentConfigWorkloadsConfigSchedulerGetArgs(Objects.requireNonNull(defaults));
        }
