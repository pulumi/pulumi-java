...
public class Disk extends CustomResource {
    ...
    private Disk(String name, Output<String> id, @Nullable DiskState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Disk get(String name, Output<String> id, @Nullable DiskState state, @Nullable CustomResourceOptions options) {
