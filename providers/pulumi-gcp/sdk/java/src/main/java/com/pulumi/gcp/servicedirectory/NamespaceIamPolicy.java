...
public class NamespaceIamPolicy extends CustomResource {
    ...
    private NamespaceIamPolicy(String name, Output<String> id, @Nullable NamespaceIamPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NamespaceIamPolicy get(String name, Output<String> id, @Nullable NamespaceIamPolicyState state, @Nullable CustomResourceOptions options) {
