...
public final class PolicyClusterAdmissionRuleGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PolicyClusterAdmissionRuleGetArgs(PolicyClusterAdmissionRuleGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyClusterAdmissionRuleGetArgs();
        }

        public Builder(PolicyClusterAdmissionRuleGetArgs defaults) {
            $ = new PolicyClusterAdmissionRuleGetArgs(Objects.requireNonNull(defaults));
        }
