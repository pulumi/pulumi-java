...
public final class TableExternalDataConfigurationGoogleSheetsOptionsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TableExternalDataConfigurationGoogleSheetsOptionsGetArgs(TableExternalDataConfigurationGoogleSheetsOptionsGetArgs $) {
        this.range = $.range;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TableExternalDataConfigurationGoogleSheetsOptionsGetArgs();
        }

        public Builder(TableExternalDataConfigurationGoogleSheetsOptionsGetArgs defaults) {
            $ = new TableExternalDataConfigurationGoogleSheetsOptionsGetArgs(Objects.requireNonNull(defaults));
        }
