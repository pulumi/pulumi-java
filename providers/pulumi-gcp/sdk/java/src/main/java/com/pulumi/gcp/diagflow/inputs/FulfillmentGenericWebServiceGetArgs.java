...
public final class FulfillmentGenericWebServiceGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FulfillmentGenericWebServiceGetArgs(FulfillmentGenericWebServiceGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FulfillmentGenericWebServiceGetArgs();
        }

        public Builder(FulfillmentGenericWebServiceGetArgs defaults) {
            $ = new FulfillmentGenericWebServiceGetArgs(Objects.requireNonNull(defaults));
        }
