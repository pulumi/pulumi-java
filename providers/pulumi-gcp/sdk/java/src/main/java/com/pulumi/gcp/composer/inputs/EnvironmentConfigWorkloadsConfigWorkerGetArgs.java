...
public final class EnvironmentConfigWorkloadsConfigWorkerGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EnvironmentConfigWorkloadsConfigWorkerGetArgs(EnvironmentConfigWorkloadsConfigWorkerGetArgs $) {
        this.cpu = $.cpu;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EnvironmentConfigWorkloadsConfigWorkerGetArgs();
        }

        public Builder(EnvironmentConfigWorkloadsConfigWorkerGetArgs defaults) {
            $ = new EnvironmentConfigWorkloadsConfigWorkerGetArgs(Objects.requireNonNull(defaults));
        }
