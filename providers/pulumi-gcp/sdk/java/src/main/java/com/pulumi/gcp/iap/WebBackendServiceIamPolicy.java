...
public class WebBackendServiceIamPolicy extends CustomResource {
    /**
     ...
     */
    public WebBackendServiceIamPolicy(String name, WebBackendServiceIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebBackendServiceIamPolicy(String name, Output<String> id, @Nullable WebBackendServiceIamPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebBackendServiceIamPolicy get(String name, Output<String> id, @Nullable WebBackendServiceIamPolicyState state, @Nullable CustomResourceOptions options) {
