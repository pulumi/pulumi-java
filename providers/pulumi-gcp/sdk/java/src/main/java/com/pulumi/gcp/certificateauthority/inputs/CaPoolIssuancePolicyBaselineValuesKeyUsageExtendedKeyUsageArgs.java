...
public final class CaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsageArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsageArgs(CaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsageArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsageArgs();
        }

        public Builder(CaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsageArgs defaults) {
            $ = new CaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsageArgs(Objects.requireNonNull(defaults));
        }
