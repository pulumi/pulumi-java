...
public final class CaPoolIssuancePolicyBaselineValuesCaOptionsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CaPoolIssuancePolicyBaselineValuesCaOptionsArgs(CaPoolIssuancePolicyBaselineValuesCaOptionsArgs $) {
        this.isCa = $.isCa;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CaPoolIssuancePolicyBaselineValuesCaOptionsArgs();
        }

        public Builder(CaPoolIssuancePolicyBaselineValuesCaOptionsArgs defaults) {
            $ = new CaPoolIssuancePolicyBaselineValuesCaOptionsArgs(Objects.requireNonNull(defaults));
        }
