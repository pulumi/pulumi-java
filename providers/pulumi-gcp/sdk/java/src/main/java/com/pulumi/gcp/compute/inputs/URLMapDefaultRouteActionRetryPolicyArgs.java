...
import com.pulumi.gcp.compute.inputs.URLMapDefaultRouteActionRetryPolicyPerTryTimeoutArgs;
...
public final class URLMapDefaultRouteActionRetryPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<URLMapDefaultRouteActionRetryPolicyPerTryTimeoutArgs>> perTryTimeout() {
    ...
    private URLMapDefaultRouteActionRetryPolicyArgs(URLMapDefaultRouteActionRetryPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapDefaultRouteActionRetryPolicyArgs();
        }

        public Builder(URLMapDefaultRouteActionRetryPolicyArgs defaults) {
            $ = new URLMapDefaultRouteActionRetryPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder perTryTimeout(URLMapDefaultRouteActionRetryPolicyPerTryTimeoutArgs perTryTimeout) {
