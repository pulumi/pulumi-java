...
public class SubscriptionIAMMember extends CustomResource {
     ...
     */
    public SubscriptionIAMMember(String name, SubscriptionIAMMemberArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SubscriptionIAMMember(String name, Output<String> id, @Nullable SubscriptionIAMMemberState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SubscriptionIAMMember get(String name, Output<String> id, @Nullable SubscriptionIAMMemberState state, @Nullable CustomResourceOptions options) {
