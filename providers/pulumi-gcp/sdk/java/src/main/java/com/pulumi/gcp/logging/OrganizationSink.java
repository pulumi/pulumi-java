...
public class OrganizationSink extends CustomResource {
    /**
     ...
     */
    public OrganizationSink(String name, OrganizationSinkArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OrganizationSink(String name, Output<String> id, @Nullable OrganizationSinkState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OrganizationSink get(String name, Output<String> id, @Nullable OrganizationSinkState state, @Nullable CustomResourceOptions options) {
