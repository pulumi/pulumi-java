...
public final class AutoscalarAutoscalingPolicyLoadBalancingUtilizationGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AutoscalarAutoscalingPolicyLoadBalancingUtilizationGetArgs(AutoscalarAutoscalingPolicyLoadBalancingUtilizationGetArgs $) {
        this.target = $.target;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutoscalarAutoscalingPolicyLoadBalancingUtilizationGetArgs();
        }

        public Builder(AutoscalarAutoscalingPolicyLoadBalancingUtilizationGetArgs defaults) {
            $ = new AutoscalarAutoscalingPolicyLoadBalancingUtilizationGetArgs(Objects.requireNonNull(defaults));
        }
