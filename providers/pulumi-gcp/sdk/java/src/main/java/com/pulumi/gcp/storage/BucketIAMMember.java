...
public class BucketIAMMember extends CustomResource {
    /**
     ...
     */
    public BucketIAMMember(String name, BucketIAMMemberArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BucketIAMMember(String name, Output<String> id, @Nullable BucketIAMMemberState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BucketIAMMember get(String name, Output<String> id, @Nullable BucketIAMMemberState state, @Nullable CustomResourceOptions options) {
