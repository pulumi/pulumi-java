...
public final class AuthorityConfigX509ConfigKeyUsageExtendedKeyUsageArgs extends com.pulumi.resources.ResourceArgs {

    public static final AuthorityConfigX509ConfigKeyUsageExtendedKeyUsageArgs Empty = new AuthorityConfigX509ConfigKeyUsageExtendedKeyUsageArgs();
    ...
    private AuthorityConfigX509ConfigKeyUsageExtendedKeyUsageArgs() {}

    private AuthorityConfigX509ConfigKeyUsageExtendedKeyUsageArgs(AuthorityConfigX509ConfigKeyUsageExtendedKeyUsageArgs $) {
    ...
    public static Builder builder(AuthorityConfigX509ConfigKeyUsageExtendedKeyUsageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthorityConfigX509ConfigKeyUsageExtendedKeyUsageArgs();
        }

        public Builder(AuthorityConfigX509ConfigKeyUsageExtendedKeyUsageArgs defaults) {
            $ = new AuthorityConfigX509ConfigKeyUsageExtendedKeyUsageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AuthorityConfigX509ConfigKeyUsageExtendedKeyUsageArgs build() {
            return $;
        }
    }
