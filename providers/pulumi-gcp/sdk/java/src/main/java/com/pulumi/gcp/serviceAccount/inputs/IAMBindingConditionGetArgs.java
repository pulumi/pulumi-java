...
public final class IAMBindingConditionGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private IAMBindingConditionGetArgs(IAMBindingConditionGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IAMBindingConditionGetArgs();
        }

        public Builder(IAMBindingConditionGetArgs defaults) {
            $ = new IAMBindingConditionGetArgs(Objects.requireNonNull(defaults));
        }
