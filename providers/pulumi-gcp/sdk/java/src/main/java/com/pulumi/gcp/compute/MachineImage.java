...
public class MachineImage extends CustomResource {
    ...
    private MachineImage(String name, Output<String> id, @Nullable MachineImageState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MachineImage get(String name, Output<String> id, @Nullable MachineImageState state, @Nullable CustomResourceOptions options) {
