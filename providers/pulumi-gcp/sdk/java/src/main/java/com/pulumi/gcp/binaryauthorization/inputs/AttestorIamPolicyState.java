...
public final class AttestorIamPolicyState extends com.pulumi.resources.ResourceArgs {
    ...
    private AttestorIamPolicyState(AttestorIamPolicyState $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AttestorIamPolicyState();
        }

        public Builder(AttestorIamPolicyState defaults) {
            $ = new AttestorIamPolicyState(Objects.requireNonNull(defaults));
        }
