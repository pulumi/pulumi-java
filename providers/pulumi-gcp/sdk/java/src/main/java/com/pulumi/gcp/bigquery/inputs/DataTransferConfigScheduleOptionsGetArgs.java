...
public final class DataTransferConfigScheduleOptionsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DataTransferConfigScheduleOptionsGetArgs(DataTransferConfigScheduleOptionsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataTransferConfigScheduleOptionsGetArgs();
        }

        public Builder(DataTransferConfigScheduleOptionsGetArgs defaults) {
            $ = new DataTransferConfigScheduleOptionsGetArgs(Objects.requireNonNull(defaults));
        }
