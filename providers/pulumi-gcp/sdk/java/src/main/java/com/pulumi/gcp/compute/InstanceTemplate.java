 ...
 *             .canIpForward(false)
 *             .scheduling(InstanceTemplateScheduling.builder()
 ...
 *                     .autoDelete(true)
 *                     .boot(true)
 *                     .resourcePolicies(dailyBackup.getId())
 *                     .build(),
 *                 InstanceTemplateDisk.builder()
 *                     .source(foobar.getName())
 *                     .autoDelete(false)
 *                     .boot(false)
 *                     .build())
 ...
 *                 .sourceImage(myImage.apply(getImageResult -&gt; getImageResult.getSelfLink()))
 *                 .autoDelete(true)
 *                 .boot(true)
 *                 .build())
 *             .networkInterfaces(InstanceTemplateNetworkInterface.builder()
 ...
 *             .region(&#34;us-central1&#34;)
 *             .disks(InstanceTemplateDisk.builder()
 *                 .sourceImage(google_compute_image.getMy_image().getSelf_link())
 *                 .build())
 *             .build());
 * 
 *         }
