...
public class ServiceIamBinding extends CustomResource {
     ...
     */
    public ServiceIamBinding(String name, ServiceIamBindingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceIamBinding(String name, Output<String> id, @Nullable ServiceIamBindingState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceIamBinding get(String name, Output<String> id, @Nullable ServiceIamBindingState state, @Nullable CustomResourceOptions options) {
