...
public final class CxVersionNluSettingGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CxVersionNluSettingGetArgs(CxVersionNluSettingGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxVersionNluSettingGetArgs();
        }

        public Builder(CxVersionNluSettingGetArgs defaults) {
            $ = new CxVersionNluSettingGetArgs(Objects.requireNonNull(defaults));
        }
