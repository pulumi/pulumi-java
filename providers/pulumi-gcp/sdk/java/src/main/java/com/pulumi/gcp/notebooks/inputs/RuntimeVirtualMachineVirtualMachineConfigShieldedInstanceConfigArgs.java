...
public final class RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfigArgs Empty = new RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfigArgs();
    ...
    private RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfigArgs() {}

    private RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfigArgs(RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfigArgs $) {
    ...
    public static Builder builder(RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfigArgs();
        }

        public Builder(RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfigArgs defaults) {
            $ = new RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfigArgs build() {
            return $;
        }
    }
