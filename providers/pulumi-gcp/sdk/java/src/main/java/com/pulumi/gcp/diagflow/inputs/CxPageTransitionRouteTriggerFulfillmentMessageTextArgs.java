...
public final class CxPageTransitionRouteTriggerFulfillmentMessageTextArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CxPageTransitionRouteTriggerFulfillmentMessageTextArgs(CxPageTransitionRouteTriggerFulfillmentMessageTextArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxPageTransitionRouteTriggerFulfillmentMessageTextArgs();
        }

        public Builder(CxPageTransitionRouteTriggerFulfillmentMessageTextArgs defaults) {
            $ = new CxPageTransitionRouteTriggerFulfillmentMessageTextArgs(Objects.requireNonNull(defaults));
        }
