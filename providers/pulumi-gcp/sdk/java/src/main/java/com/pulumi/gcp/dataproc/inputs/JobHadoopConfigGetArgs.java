...
import com.pulumi.gcp.dataproc.inputs.JobHadoopConfigLoggingConfigGetArgs;
...
public final class JobHadoopConfigGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobHadoopConfigGetArgs Empty = new JobHadoopConfigGetArgs();
    ...
    @Import(name="loggingConfig")
      private final @Nullable Output<JobHadoopConfigLoggingConfigGetArgs> loggingConfig;

    public Output<JobHadoopConfigLoggingConfigGetArgs> loggingConfig() {
    ...
    public JobHadoopConfigGetArgs(
        ...
        @Nullable Output<JobHadoopConfigLoggingConfigGetArgs> loggingConfig,
    ...
    private JobHadoopConfigGetArgs() {
    ...
    public static Builder builder(JobHadoopConfigGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Output<JobHadoopConfigLoggingConfigGetArgs> loggingConfig;
        ...
        public Builder(JobHadoopConfigGetArgs defaults) {
        ...
        public Builder loggingConfig(@Nullable Output<JobHadoopConfigLoggingConfigGetArgs> loggingConfig) {
            this.loggingConfig = loggingConfig;
            return this;
        }
        public Builder loggingConfig(@Nullable JobHadoopConfigLoggingConfigGetArgs loggingConfig) {
        ...
        public Builder properties(@Nullable Map<String,String> properties) {
            ...
            return this;
        }        public JobHadoopConfigGetArgs build() {
            return new JobHadoopConfigGetArgs(archiveUris, args, fileUris, jarFileUris, loggingConfig, mainClass, mainJarFileUri, properties);
        }
    }
}
