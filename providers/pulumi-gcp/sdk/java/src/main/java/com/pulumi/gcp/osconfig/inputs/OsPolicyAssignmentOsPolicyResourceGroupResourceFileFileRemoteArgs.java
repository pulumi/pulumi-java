...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileRemoteArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileRemoteArgs(OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileRemoteArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileRemoteArgs();
        }

        public Builder(OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileRemoteArgs defaults) {
            $ = new OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileRemoteArgs(Objects.requireNonNull(defaults));
        }
