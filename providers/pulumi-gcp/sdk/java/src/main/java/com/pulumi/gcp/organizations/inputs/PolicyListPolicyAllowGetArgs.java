...
public final class PolicyListPolicyAllowGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PolicyListPolicyAllowGetArgs(PolicyListPolicyAllowGetArgs $) {
        this.all = $.all;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyListPolicyAllowGetArgs();
        }

        public Builder(PolicyListPolicyAllowGetArgs defaults) {
            $ = new PolicyListPolicyAllowGetArgs(Objects.requireNonNull(defaults));
        }
