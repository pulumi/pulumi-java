...
public final class InboundSamlConfigState extends com.pulumi.resources.ResourceArgs {
    ...
    private InboundSamlConfigState(InboundSamlConfigState $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InboundSamlConfigState();
        }

        public Builder(InboundSamlConfigState defaults) {
            $ = new InboundSamlConfigState(Objects.requireNonNull(defaults));
        }
