...
public class DiskIamMember extends CustomResource {
     ...
     */
    public DiskIamMember(String name, DiskIamMemberArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DiskIamMember(String name, Output<String> id, @Nullable DiskIamMemberState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DiskIamMember get(String name, Output<String> id, @Nullable DiskIamMemberState state, @Nullable CustomResourceOptions options) {
