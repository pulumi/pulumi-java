...
public final class GroupGroupKeyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GroupGroupKeyArgs(GroupGroupKeyArgs $) {
        this.id = $.id;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupGroupKeyArgs();
        }

        public Builder(GroupGroupKeyArgs defaults) {
            $ = new GroupGroupKeyArgs(Objects.requireNonNull(defaults));
        }
