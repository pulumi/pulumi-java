...
public final class RegionBackendServiceLogConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegionBackendServiceLogConfigGetArgs(RegionBackendServiceLogConfigGetArgs $) {
        this.enable = $.enable;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionBackendServiceLogConfigGetArgs();
        }

        public Builder(RegionBackendServiceLogConfigGetArgs defaults) {
            $ = new RegionBackendServiceLogConfigGetArgs(Objects.requireNonNull(defaults));
        }
