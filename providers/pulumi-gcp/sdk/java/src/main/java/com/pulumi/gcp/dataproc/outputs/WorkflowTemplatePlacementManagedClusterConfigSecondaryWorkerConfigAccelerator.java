...
@CustomType
public final class WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigAccelerator {
    /**
    ...
    */
    ...
    public static Builder builder(WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigAccelerator defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigAccelerator defaults) {
        ...
        public Builder acceleratorType(@Nullable String acceleratorType) {
            this.acceleratorType = acceleratorType;
            return this;
        }        public WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigAccelerator build() {
            return new WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigAccelerator(acceleratorCount, acceleratorType);
        }
    }
}
