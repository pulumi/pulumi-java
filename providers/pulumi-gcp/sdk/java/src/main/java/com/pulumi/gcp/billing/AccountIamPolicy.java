...
public class AccountIamPolicy extends CustomResource {
     ...
     */
    public AccountIamPolicy(String name, AccountIamPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AccountIamPolicy(String name, Output<String> id, @Nullable AccountIamPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AccountIamPolicy get(String name, Output<String> id, @Nullable AccountIamPolicyState state, @Nullable CustomResourceOptions options) {
