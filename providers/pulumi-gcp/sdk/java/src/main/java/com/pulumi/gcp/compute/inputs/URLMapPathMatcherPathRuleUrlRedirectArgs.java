...
public final class URLMapPathMatcherPathRuleUrlRedirectArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private URLMapPathMatcherPathRuleUrlRedirectArgs(URLMapPathMatcherPathRuleUrlRedirectArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapPathMatcherPathRuleUrlRedirectArgs();
        }

        public Builder(URLMapPathMatcherPathRuleUrlRedirectArgs defaults) {
            $ = new URLMapPathMatcherPathRuleUrlRedirectArgs(Objects.requireNonNull(defaults));
        }
