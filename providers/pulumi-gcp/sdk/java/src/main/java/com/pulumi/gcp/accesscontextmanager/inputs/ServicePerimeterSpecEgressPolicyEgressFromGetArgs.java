...
public final class ServicePerimeterSpecEgressPolicyEgressFromGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServicePerimeterSpecEgressPolicyEgressFromGetArgs(ServicePerimeterSpecEgressPolicyEgressFromGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServicePerimeterSpecEgressPolicyEgressFromGetArgs();
        }

        public Builder(ServicePerimeterSpecEgressPolicyEgressFromGetArgs defaults) {
            $ = new ServicePerimeterSpecEgressPolicyEgressFromGetArgs(Objects.requireNonNull(defaults));
        }
