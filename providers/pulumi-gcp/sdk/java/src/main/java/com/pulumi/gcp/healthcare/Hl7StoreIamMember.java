...
public class Hl7StoreIamMember extends CustomResource {
     ...
     */
    public Hl7StoreIamMember(String name, Hl7StoreIamMemberArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Hl7StoreIamMember(String name, Output<String> id, @Nullable Hl7StoreIamMemberState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Hl7StoreIamMember get(String name, Output<String> id, @Nullable Hl7StoreIamMemberState state, @Nullable CustomResourceOptions options) {
