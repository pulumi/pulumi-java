...
public final class CxFlowEventHandlerTriggerFulfillmentGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<List<CxFlowEventHandlerTriggerFulfillmentMessageGetArgs>>> messages() {
    ...
    private CxFlowEventHandlerTriggerFulfillmentGetArgs(CxFlowEventHandlerTriggerFulfillmentGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxFlowEventHandlerTriggerFulfillmentGetArgs();
        }

        public Builder(CxFlowEventHandlerTriggerFulfillmentGetArgs defaults) {
            $ = new CxFlowEventHandlerTriggerFulfillmentGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder messages(List<CxFlowEventHandlerTriggerFulfillmentMessageGetArgs> messages) {
