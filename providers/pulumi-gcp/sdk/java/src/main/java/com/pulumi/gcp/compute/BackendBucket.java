...
public class BackendBucket extends CustomResource {
     ...
     */
    public BackendBucket(String name, BackendBucketArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BackendBucket(String name, Output<String> id, @Nullable BackendBucketState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BackendBucket get(String name, Output<String> id, @Nullable BackendBucketState state, @Nullable CustomResourceOptions options) {
