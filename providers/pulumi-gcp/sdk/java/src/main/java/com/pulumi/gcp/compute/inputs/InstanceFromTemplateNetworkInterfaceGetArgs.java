...
public final class InstanceFromTemplateNetworkInterfaceGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Output<List<InstanceFromTemplateNetworkInterfaceAccessConfigGetArgs>> accessConfigs() {
    ...
    public Output<List<InstanceFromTemplateNetworkInterfaceAliasIpRangeGetArgs>> aliasIpRanges() {
    ...
    public Output<List<InstanceFromTemplateNetworkInterfaceIpv6AccessConfigGetArgs>> ipv6AccessConfigs() {
