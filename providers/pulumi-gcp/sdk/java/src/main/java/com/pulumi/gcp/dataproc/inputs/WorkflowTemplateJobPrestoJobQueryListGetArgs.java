...
public final class WorkflowTemplateJobPrestoJobQueryListGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WorkflowTemplateJobPrestoJobQueryListGetArgs(WorkflowTemplateJobPrestoJobQueryListGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkflowTemplateJobPrestoJobQueryListGetArgs();
        }

        public Builder(WorkflowTemplateJobPrestoJobQueryListGetArgs defaults) {
            $ = new WorkflowTemplateJobPrestoJobQueryListGetArgs(Objects.requireNonNull(defaults));
        }
