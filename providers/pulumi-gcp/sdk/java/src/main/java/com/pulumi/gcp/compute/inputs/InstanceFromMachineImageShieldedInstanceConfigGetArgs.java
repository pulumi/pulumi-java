...
public final class InstanceFromMachineImageShieldedInstanceConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceFromMachineImageShieldedInstanceConfigGetArgs(InstanceFromMachineImageShieldedInstanceConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceFromMachineImageShieldedInstanceConfigGetArgs();
        }

        public Builder(InstanceFromMachineImageShieldedInstanceConfigGetArgs defaults) {
            $ = new InstanceFromMachineImageShieldedInstanceConfigGetArgs(Objects.requireNonNull(defaults));
        }
