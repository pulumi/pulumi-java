...
import com.pulumi.gcp.dataproc.inputs.JobSparkConfigLoggingConfigGetArgs;
...
public final class JobSparkConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="loggingConfig")
      private final @Nullable Output<JobSparkConfigLoggingConfigGetArgs> loggingConfig;

    public Output<JobSparkConfigLoggingConfigGetArgs> loggingConfig() {
    ...
    public JobSparkConfigGetArgs(
        ...
        @Nullable Output<JobSparkConfigLoggingConfigGetArgs> loggingConfig,
    ...
    public static final class Builder {
        ...
        private @Nullable Output<JobSparkConfigLoggingConfigGetArgs> loggingConfig;
        ...
        public Builder loggingConfig(@Nullable Output<JobSparkConfigLoggingConfigGetArgs> loggingConfig) {
            this.loggingConfig = loggingConfig;
            return this;
        }
        public Builder loggingConfig(@Nullable JobSparkConfigLoggingConfigGetArgs loggingConfig) {
