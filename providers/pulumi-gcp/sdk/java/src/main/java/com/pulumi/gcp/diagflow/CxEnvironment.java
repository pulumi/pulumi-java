...
public class CxEnvironment extends CustomResource {
    /**
     ...
     */
    public CxEnvironment(String name, CxEnvironmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CxEnvironment(String name, Output<String> id, @Nullable CxEnvironmentState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CxEnvironment get(String name, Output<String> id, @Nullable CxEnvironmentState state, @Nullable CustomResourceOptions options) {
