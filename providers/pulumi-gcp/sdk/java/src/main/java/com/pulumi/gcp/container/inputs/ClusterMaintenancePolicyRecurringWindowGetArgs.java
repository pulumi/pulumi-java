...
public final class ClusterMaintenancePolicyRecurringWindowGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterMaintenancePolicyRecurringWindowGetArgs(ClusterMaintenancePolicyRecurringWindowGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterMaintenancePolicyRecurringWindowGetArgs();
        }

        public Builder(ClusterMaintenancePolicyRecurringWindowGetArgs defaults) {
            $ = new ClusterMaintenancePolicyRecurringWindowGetArgs(Objects.requireNonNull(defaults));
        }
