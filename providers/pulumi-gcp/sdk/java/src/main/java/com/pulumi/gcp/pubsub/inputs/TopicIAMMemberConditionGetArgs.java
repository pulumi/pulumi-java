...
public final class TopicIAMMemberConditionGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TopicIAMMemberConditionGetArgs(TopicIAMMemberConditionGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TopicIAMMemberConditionGetArgs();
        }

        public Builder(TopicIAMMemberConditionGetArgs defaults) {
            $ = new TopicIAMMemberConditionGetArgs(Objects.requireNonNull(defaults));
        }
