...
public class ObjectAccessControl extends CustomResource {
    ...
    private ObjectAccessControl(String name, Output<String> id, @Nullable ObjectAccessControlState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ObjectAccessControl get(String name, Output<String> id, @Nullable ObjectAccessControlState state, @Nullable CustomResourceOptions options) {
