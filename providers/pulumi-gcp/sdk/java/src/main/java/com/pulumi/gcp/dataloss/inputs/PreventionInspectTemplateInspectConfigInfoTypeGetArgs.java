...
public final class PreventionInspectTemplateInspectConfigInfoTypeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PreventionInspectTemplateInspectConfigInfoTypeGetArgs(PreventionInspectTemplateInspectConfigInfoTypeGetArgs $) {
        this.name = $.name;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PreventionInspectTemplateInspectConfigInfoTypeGetArgs();
        }

        public Builder(PreventionInspectTemplateInspectConfigInfoTypeGetArgs defaults) {
            $ = new PreventionInspectTemplateInspectConfigInfoTypeGetArgs(Objects.requireNonNull(defaults));
        }
