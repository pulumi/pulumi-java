...
public final class InstanceFromMachineImageAttachedDiskGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceFromMachineImageAttachedDiskGetArgs() {}

    private InstanceFromMachineImageAttachedDiskGetArgs(InstanceFromMachineImageAttachedDiskGetArgs $) {
    ...
    public static Builder builder(InstanceFromMachineImageAttachedDiskGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceFromMachineImageAttachedDiskGetArgs();
        }

        public Builder(InstanceFromMachineImageAttachedDiskGetArgs defaults) {
            $ = new InstanceFromMachineImageAttachedDiskGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceFromMachineImageAttachedDiskGetArgs build() {
