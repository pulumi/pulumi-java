...
public final class WorkflowTemplateJobPrestoJobLoggingConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WorkflowTemplateJobPrestoJobLoggingConfigArgs(WorkflowTemplateJobPrestoJobLoggingConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkflowTemplateJobPrestoJobLoggingConfigArgs();
        }

        public Builder(WorkflowTemplateJobPrestoJobLoggingConfigArgs defaults) {
            $ = new WorkflowTemplateJobPrestoJobLoggingConfigArgs(Objects.requireNonNull(defaults));
        }
