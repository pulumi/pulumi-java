...
public final class ServicePerimetersServicePerimeterStatusVpcAccessibleServicesGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServicePerimetersServicePerimeterStatusVpcAccessibleServicesGetArgs(ServicePerimetersServicePerimeterStatusVpcAccessibleServicesGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServicePerimetersServicePerimeterStatusVpcAccessibleServicesGetArgs();
        }

        public Builder(ServicePerimetersServicePerimeterStatusVpcAccessibleServicesGetArgs defaults) {
            $ = new ServicePerimetersServicePerimeterStatusVpcAccessibleServicesGetArgs(Objects.requireNonNull(defaults));
        }
