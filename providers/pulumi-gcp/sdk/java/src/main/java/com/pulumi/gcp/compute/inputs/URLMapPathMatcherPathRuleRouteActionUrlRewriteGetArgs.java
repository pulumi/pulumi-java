...
public final class URLMapPathMatcherPathRuleRouteActionUrlRewriteGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private URLMapPathMatcherPathRuleRouteActionUrlRewriteGetArgs(URLMapPathMatcherPathRuleRouteActionUrlRewriteGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapPathMatcherPathRuleRouteActionUrlRewriteGetArgs();
        }

        public Builder(URLMapPathMatcherPathRuleRouteActionUrlRewriteGetArgs defaults) {
            $ = new URLMapPathMatcherPathRuleRouteActionUrlRewriteGetArgs(Objects.requireNonNull(defaults));
        }
