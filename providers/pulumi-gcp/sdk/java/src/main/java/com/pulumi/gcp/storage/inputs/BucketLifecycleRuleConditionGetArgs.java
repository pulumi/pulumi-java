...
public final class BucketLifecycleRuleConditionGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private BucketLifecycleRuleConditionGetArgs(BucketLifecycleRuleConditionGetArgs $) {
        this.age = $.age;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BucketLifecycleRuleConditionGetArgs();
        }

        public Builder(BucketLifecycleRuleConditionGetArgs defaults) {
            $ = new BucketLifecycleRuleConditionGetArgs(Objects.requireNonNull(defaults));
        }
