...
public final class EnvironmentConfigSoftwareConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EnvironmentConfigSoftwareConfigGetArgs(EnvironmentConfigSoftwareConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EnvironmentConfigSoftwareConfigGetArgs();
        }

        public Builder(EnvironmentConfigSoftwareConfigGetArgs defaults) {
            $ = new EnvironmentConfigSoftwareConfigGetArgs(Objects.requireNonNull(defaults));
        }
