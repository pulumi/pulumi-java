...
public final class RegionHealthCheckSslHealthCheckGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegionHealthCheckSslHealthCheckGetArgs(RegionHealthCheckSslHealthCheckGetArgs $) {
        this.port = $.port;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionHealthCheckSslHealthCheckGetArgs();
        }

        public Builder(RegionHealthCheckSslHealthCheckGetArgs defaults) {
            $ = new RegionHealthCheckSslHealthCheckGetArgs(Objects.requireNonNull(defaults));
        }
