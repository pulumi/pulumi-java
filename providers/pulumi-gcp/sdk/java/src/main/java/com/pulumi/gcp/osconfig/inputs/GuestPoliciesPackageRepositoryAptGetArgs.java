...
public final class GuestPoliciesPackageRepositoryAptGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GuestPoliciesPackageRepositoryAptGetArgs(GuestPoliciesPackageRepositoryAptGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GuestPoliciesPackageRepositoryAptGetArgs();
        }

        public Builder(GuestPoliciesPackageRepositoryAptGetArgs defaults) {
            $ = new GuestPoliciesPackageRepositoryAptGetArgs(Objects.requireNonNull(defaults));
        }
