...
public class Notification extends CustomResource {
     ...
     */
    public Notification(String name, NotificationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Notification(String name, Output<String> id, @Nullable NotificationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Notification get(String name, Output<String> id, @Nullable NotificationState state, @Nullable CustomResourceOptions options) {
