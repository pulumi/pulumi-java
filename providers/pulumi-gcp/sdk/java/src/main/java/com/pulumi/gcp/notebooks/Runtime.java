...
public class Runtime extends CustomResource {
    ...
    private Runtime(String name, Output<String> id, @Nullable RuntimeState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Runtime get(String name, Output<String> id, @Nullable RuntimeState state, @Nullable CustomResourceOptions options) {
