...
public class TagValueIamPolicy extends CustomResource {
    ...
    private TagValueIamPolicy(String name, Output<String> id, @Nullable TagValueIamPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TagValueIamPolicy get(String name, Output<String> id, @Nullable TagValueIamPolicyState state, @Nullable CustomResourceOptions options) {
