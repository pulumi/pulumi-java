...
public final class CxPageEntryFulfillmentMessageTextArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CxPageEntryFulfillmentMessageTextArgs(CxPageEntryFulfillmentMessageTextArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxPageEntryFulfillmentMessageTextArgs();
        }

        public Builder(CxPageEntryFulfillmentMessageTextArgs defaults) {
            $ = new CxPageEntryFulfillmentMessageTextArgs(Objects.requireNonNull(defaults));
        }
