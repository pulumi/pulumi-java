...
public class AccessPolicyIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public AccessPolicyIamMember(String name) {
     ...
     */
    public static AccessPolicyIamMember get(String name, Output<String> id, @Nullable AccessPolicyIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
