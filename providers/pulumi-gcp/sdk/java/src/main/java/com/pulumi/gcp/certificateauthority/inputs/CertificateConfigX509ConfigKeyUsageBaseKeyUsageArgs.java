...
public final class CertificateConfigX509ConfigKeyUsageBaseKeyUsageArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CertificateConfigX509ConfigKeyUsageBaseKeyUsageArgs(CertificateConfigX509ConfigKeyUsageBaseKeyUsageArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CertificateConfigX509ConfigKeyUsageBaseKeyUsageArgs();
        }

        public Builder(CertificateConfigX509ConfigKeyUsageBaseKeyUsageArgs defaults) {
            $ = new CertificateConfigX509ConfigKeyUsageBaseKeyUsageArgs(Objects.requireNonNull(defaults));
        }
