...
public final class PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRuleHotwordRegexArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRuleHotwordRegexArgs(PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRuleHotwordRegexArgs $) {
    ...
    public static Builder builder(PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRuleHotwordRegexArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRuleHotwordRegexArgs();
        }

        public Builder(PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRuleHotwordRegexArgs defaults) {
            $ = new PreventionInspectTemplateInspectConfigRuleSetRuleHotwordRuleHotwordRegexArgs(Objects.requireNonNull(defaults));
        }
