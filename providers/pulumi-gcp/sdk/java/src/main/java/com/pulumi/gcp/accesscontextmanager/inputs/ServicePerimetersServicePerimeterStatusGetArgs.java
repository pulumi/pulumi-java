...
public final class ServicePerimetersServicePerimeterStatusGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public ServicePerimetersServicePerimeterStatusGetArgs(
        ...
        @Nullable Output<List<ServicePerimetersServicePerimeterStatusEgressPolicyGetArgs>> egressPolicies,
        @Nullable Output<List<ServicePerimetersServicePerimeterStatusIngressPolicyGetArgs>> ingressPolicies,
        @Nullable Output<List<String>> resources,
        @Nullable Output<List<String>> restrictedServices,
        @Nullable Output<ServicePerimetersServicePerimeterStatusVpcAccessibleServicesGetArgs> vpcAccessibleServices) {
