...
public final class HealthCheckTcpHealthCheckGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private HealthCheckTcpHealthCheckGetArgs(HealthCheckTcpHealthCheckGetArgs $) {
        this.port = $.port;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HealthCheckTcpHealthCheckGetArgs();
        }

        public Builder(HealthCheckTcpHealthCheckGetArgs defaults) {
            $ = new HealthCheckTcpHealthCheckGetArgs(Objects.requireNonNull(defaults));
        }
