...
public final class AzureClusterControlPlaneRootVolumeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzureClusterControlPlaneRootVolumeGetArgs(AzureClusterControlPlaneRootVolumeGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureClusterControlPlaneRootVolumeGetArgs();
        }

        public Builder(AzureClusterControlPlaneRootVolumeGetArgs defaults) {
            $ = new AzureClusterControlPlaneRootVolumeGetArgs(Objects.requireNonNull(defaults));
        }
