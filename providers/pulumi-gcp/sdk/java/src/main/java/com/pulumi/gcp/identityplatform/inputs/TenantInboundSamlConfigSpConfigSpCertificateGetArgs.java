...
public final class TenantInboundSamlConfigSpConfigSpCertificateGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TenantInboundSamlConfigSpConfigSpCertificateGetArgs(TenantInboundSamlConfigSpConfigSpCertificateGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TenantInboundSamlConfigSpConfigSpCertificateGetArgs();
        }

        public Builder(TenantInboundSamlConfigSpConfigSpCertificateGetArgs defaults) {
            $ = new TenantInboundSamlConfigSpConfigSpCertificateGetArgs(Objects.requireNonNull(defaults));
        }
