...
public final class HealthCheckHttp2HealthCheckArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private HealthCheckHttp2HealthCheckArgs() {}

    private HealthCheckHttp2HealthCheckArgs(HealthCheckHttp2HealthCheckArgs $) {
        this.host = $.host;
        this.port = $.port;
    ...
    public static Builder builder(HealthCheckHttp2HealthCheckArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HealthCheckHttp2HealthCheckArgs();
        }

        public Builder(HealthCheckHttp2HealthCheckArgs defaults) {
            $ = new HealthCheckHttp2HealthCheckArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HealthCheckHttp2HealthCheckArgs build() {
            return $;
        }
    }
