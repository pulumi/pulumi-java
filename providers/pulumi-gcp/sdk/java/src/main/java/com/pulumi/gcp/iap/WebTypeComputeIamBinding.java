...
import com.pulumi.gcp.iap.inputs.WebTypeComputeIamBindingState;
...
public class WebTypeComputeIamBinding extends CustomResource {
    /**
     ...
     */
    public WebTypeComputeIamBinding(String name) {
        this(name, WebTypeComputeIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public WebTypeComputeIamBinding(String name, WebTypeComputeIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WebTypeComputeIamBinding(String name, WebTypeComputeIamBindingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebTypeComputeIamBinding(String name, Output<String> id, @Nullable WebTypeComputeIamBindingState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebTypeComputeIamBinding get(String name, Output<String> id, @Nullable WebTypeComputeIamBindingState state, @Nullable CustomResourceOptions options) {
