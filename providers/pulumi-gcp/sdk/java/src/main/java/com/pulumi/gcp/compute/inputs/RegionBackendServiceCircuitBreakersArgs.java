...
import com.pulumi.gcp.compute.inputs.RegionBackendServiceCircuitBreakersConnectTimeoutArgs;
...
public final class RegionBackendServiceCircuitBreakersArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<RegionBackendServiceCircuitBreakersConnectTimeoutArgs>> connectTimeout() {
    ...
    private RegionBackendServiceCircuitBreakersArgs(RegionBackendServiceCircuitBreakersArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionBackendServiceCircuitBreakersArgs();
        }

        public Builder(RegionBackendServiceCircuitBreakersArgs defaults) {
            $ = new RegionBackendServiceCircuitBreakersArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder connectTimeout(RegionBackendServiceCircuitBreakersConnectTimeoutArgs connectTimeout) {
