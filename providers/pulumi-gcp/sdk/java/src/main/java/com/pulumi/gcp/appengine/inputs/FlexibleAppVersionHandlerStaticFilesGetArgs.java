...
public final class FlexibleAppVersionHandlerStaticFilesGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FlexibleAppVersionHandlerStaticFilesGetArgs(FlexibleAppVersionHandlerStaticFilesGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FlexibleAppVersionHandlerStaticFilesGetArgs();
        }

        public Builder(FlexibleAppVersionHandlerStaticFilesGetArgs defaults) {
            $ = new FlexibleAppVersionHandlerStaticFilesGetArgs(Objects.requireNonNull(defaults));
        }
