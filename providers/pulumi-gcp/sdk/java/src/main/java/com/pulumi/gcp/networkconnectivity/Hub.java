...
public class Hub extends CustomResource {
    ...
    private Hub(String name, Output<String> id, @Nullable HubState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Hub get(String name, Output<String> id, @Nullable HubState state, @Nullable CustomResourceOptions options) {
