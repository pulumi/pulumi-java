...
public final class PolicySpecRuleConditionGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicySpecRuleConditionGetArgs Empty = new PolicySpecRuleConditionGetArgs();
    ...
    private PolicySpecRuleConditionGetArgs() {}

    private PolicySpecRuleConditionGetArgs(PolicySpecRuleConditionGetArgs $) {
    ...
    public static Builder builder(PolicySpecRuleConditionGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicySpecRuleConditionGetArgs();
        }

        public Builder(PolicySpecRuleConditionGetArgs defaults) {
            $ = new PolicySpecRuleConditionGetArgs(Objects.requireNonNull(defaults));
        }
