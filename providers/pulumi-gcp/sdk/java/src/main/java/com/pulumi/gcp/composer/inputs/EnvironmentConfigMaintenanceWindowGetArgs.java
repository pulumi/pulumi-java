...
public final class EnvironmentConfigMaintenanceWindowGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EnvironmentConfigMaintenanceWindowGetArgs(EnvironmentConfigMaintenanceWindowGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EnvironmentConfigMaintenanceWindowGetArgs();
        }

        public Builder(EnvironmentConfigMaintenanceWindowGetArgs defaults) {
            $ = new EnvironmentConfigMaintenanceWindowGetArgs(Objects.requireNonNull(defaults));
        }
