...
public final class ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromArgs Empty = new ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromArgs();
    ...
    public static Builder builder(ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromArgs();
        }

        public Builder(ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromArgs defaults) {
            $ = new ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromArgs(Objects.requireNonNull(defaults));
        }
