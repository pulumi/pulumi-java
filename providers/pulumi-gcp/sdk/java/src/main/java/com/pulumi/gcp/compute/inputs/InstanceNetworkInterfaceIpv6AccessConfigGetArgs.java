...
public final class InstanceNetworkInterfaceIpv6AccessConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceNetworkInterfaceIpv6AccessConfigGetArgs(InstanceNetworkInterfaceIpv6AccessConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceNetworkInterfaceIpv6AccessConfigGetArgs();
        }

        public Builder(InstanceNetworkInterfaceIpv6AccessConfigGetArgs defaults) {
            $ = new InstanceNetworkInterfaceIpv6AccessConfigGetArgs(Objects.requireNonNull(defaults));
        }
