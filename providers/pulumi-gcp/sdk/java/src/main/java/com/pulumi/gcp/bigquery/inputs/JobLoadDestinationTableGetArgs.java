...
public final class JobLoadDestinationTableGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private JobLoadDestinationTableGetArgs(JobLoadDestinationTableGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobLoadDestinationTableGetArgs();
        }

        public Builder(JobLoadDestinationTableGetArgs defaults) {
            $ = new JobLoadDestinationTableGetArgs(Objects.requireNonNull(defaults));
        }
