...
public final class ClusterNodeConfigGcfsConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterNodeConfigGcfsConfigGetArgs(ClusterNodeConfigGcfsConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterNodeConfigGcfsConfigGetArgs();
        }

        public Builder(ClusterNodeConfigGcfsConfigGetArgs defaults) {
            $ = new ClusterNodeConfigGcfsConfigGetArgs(Objects.requireNonNull(defaults));
        }
