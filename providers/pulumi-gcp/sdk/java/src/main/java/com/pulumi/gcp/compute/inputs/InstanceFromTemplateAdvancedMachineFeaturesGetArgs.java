...
public final class InstanceFromTemplateAdvancedMachineFeaturesGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceFromTemplateAdvancedMachineFeaturesGetArgs(InstanceFromTemplateAdvancedMachineFeaturesGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceFromTemplateAdvancedMachineFeaturesGetArgs();
        }

        public Builder(InstanceFromTemplateAdvancedMachineFeaturesGetArgs defaults) {
            $ = new InstanceFromTemplateAdvancedMachineFeaturesGetArgs(Objects.requireNonNull(defaults));
        }
