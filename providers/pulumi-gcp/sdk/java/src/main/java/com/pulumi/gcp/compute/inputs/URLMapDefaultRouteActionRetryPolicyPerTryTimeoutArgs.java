...
public final class URLMapDefaultRouteActionRetryPolicyPerTryTimeoutArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private URLMapDefaultRouteActionRetryPolicyPerTryTimeoutArgs(URLMapDefaultRouteActionRetryPolicyPerTryTimeoutArgs $) {
        this.nanos = $.nanos;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapDefaultRouteActionRetryPolicyPerTryTimeoutArgs();
        }

        public Builder(URLMapDefaultRouteActionRetryPolicyPerTryTimeoutArgs defaults) {
            $ = new URLMapDefaultRouteActionRetryPolicyPerTryTimeoutArgs(Objects.requireNonNull(defaults));
        }
