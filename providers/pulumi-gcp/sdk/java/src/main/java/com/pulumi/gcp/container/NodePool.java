...
public class NodePool extends CustomResource {
    ...
    private NodePool(String name, Output<String> id, @Nullable NodePoolState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NodePool get(String name, Output<String> id, @Nullable NodePoolState state, @Nullable CustomResourceOptions options) {
