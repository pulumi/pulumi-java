...
public final class ReservationSpecificReservationInstancePropertiesLocalSsdGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ReservationSpecificReservationInstancePropertiesLocalSsdGetArgs(ReservationSpecificReservationInstancePropertiesLocalSsdGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReservationSpecificReservationInstancePropertiesLocalSsdGetArgs();
        }

        public Builder(ReservationSpecificReservationInstancePropertiesLocalSsdGetArgs defaults) {
            $ = new ReservationSpecificReservationInstancePropertiesLocalSsdGetArgs(Objects.requireNonNull(defaults));
        }
