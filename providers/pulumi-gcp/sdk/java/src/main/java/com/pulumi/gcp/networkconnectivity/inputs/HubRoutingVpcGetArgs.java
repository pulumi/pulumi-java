...
public final class HubRoutingVpcGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private HubRoutingVpcGetArgs(HubRoutingVpcGetArgs $) {
        this.uri = $.uri;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HubRoutingVpcGetArgs();
        }

        public Builder(HubRoutingVpcGetArgs defaults) {
            $ = new HubRoutingVpcGetArgs(Objects.requireNonNull(defaults));
        }
