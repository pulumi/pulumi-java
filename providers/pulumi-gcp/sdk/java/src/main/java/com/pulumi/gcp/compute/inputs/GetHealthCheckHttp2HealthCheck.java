...
public final class GetHealthCheckHttp2HealthCheck extends com.pulumi.resources.InvokeArgs {
    ...
    private GetHealthCheckHttp2HealthCheck(GetHealthCheckHttp2HealthCheck $) {
        this.host = $.host;
        this.port = $.port;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetHealthCheckHttp2HealthCheck();
        }

        public Builder(GetHealthCheckHttp2HealthCheck defaults) {
            $ = new GetHealthCheckHttp2HealthCheck(Objects.requireNonNull(defaults));
        }
