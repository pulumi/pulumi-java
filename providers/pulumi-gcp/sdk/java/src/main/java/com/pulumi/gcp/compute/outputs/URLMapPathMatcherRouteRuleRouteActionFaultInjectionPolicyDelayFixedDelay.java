...
@CustomType
public final class URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyDelayFixedDelay {
    /**
    ...
    private URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyDelayFixedDelay(
    ...
    */
    ...
    public static Builder builder(URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyDelayFixedDelay defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyDelayFixedDelay defaults) {
