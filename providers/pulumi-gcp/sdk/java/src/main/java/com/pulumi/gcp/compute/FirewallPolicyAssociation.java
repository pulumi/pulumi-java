...
public class FirewallPolicyAssociation extends CustomResource {
    /**
     ...
     */
    public FirewallPolicyAssociation(String name, FirewallPolicyAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FirewallPolicyAssociation(String name, Output<String> id, @Nullable FirewallPolicyAssociationState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FirewallPolicyAssociation get(String name, Output<String> id, @Nullable FirewallPolicyAssociationState state, @Nullable CustomResourceOptions options) {
