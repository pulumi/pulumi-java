...
import com.pulumi.gcp.accesscontextmanager.outputs.ServicePerimetersServicePerimeterStatusEgressPolicyEgressToOperation;
...
public final class ServicePerimetersServicePerimeterStatusEgressPolicyEgressTo {
    ...
    private ServicePerimetersServicePerimeterStatusEgressPolicyEgressTo(
        @CustomType.Parameter("operations") @Nullable List<ServicePerimetersServicePerimeterStatusEgressPolicyEgressToOperation> operations,
    ...
    public static final class Builder {
        ...
        public Builder operations(@Nullable List<ServicePerimetersServicePerimeterStatusEgressPolicyEgressToOperation> operations) {
            this.operations = operations;
            return this;
        }
        public Builder operations(ServicePerimetersServicePerimeterStatusEgressPolicyEgressToOperation... operations) {
