...
public final class ClusterNodePoolNetworkConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterNodePoolNetworkConfigGetArgs(ClusterNodePoolNetworkConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterNodePoolNetworkConfigGetArgs();
        }

        public Builder(ClusterNodePoolNetworkConfigGetArgs defaults) {
            $ = new ClusterNodePoolNetworkConfigGetArgs(Objects.requireNonNull(defaults));
        }
