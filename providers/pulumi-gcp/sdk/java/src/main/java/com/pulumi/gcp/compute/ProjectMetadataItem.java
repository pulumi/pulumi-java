...
public class ProjectMetadataItem extends CustomResource {
    /**
     ...
     */
    public ProjectMetadataItem(String name, ProjectMetadataItemArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProjectMetadataItem(String name, Output<String> id, @Nullable ProjectMetadataItemState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProjectMetadataItem get(String name, Output<String> id, @Nullable ProjectMetadataItemState state, @Nullable CustomResourceOptions options) {
