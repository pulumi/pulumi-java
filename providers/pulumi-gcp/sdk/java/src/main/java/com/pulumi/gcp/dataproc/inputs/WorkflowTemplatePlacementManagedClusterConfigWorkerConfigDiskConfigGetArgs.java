...
public final class WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfigGetArgs(WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfigGetArgs();
        }

        public Builder(WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfigGetArgs defaults) {
            $ = new WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfigGetArgs(Objects.requireNonNull(defaults));
        }
