...
public class CaPool extends CustomResource {
    /**
     ...
     */
    public CaPool(String name, CaPoolArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CaPool(String name, Output<String> id, @Nullable CaPoolState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CaPool get(String name, Output<String> id, @Nullable CaPoolState state, @Nullable CustomResourceOptions options) {
