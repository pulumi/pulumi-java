...
public final class RegionBackendServiceConnectionTrackingPolicyGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegionBackendServiceConnectionTrackingPolicyGetArgs(RegionBackendServiceConnectionTrackingPolicyGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionBackendServiceConnectionTrackingPolicyGetArgs();
        }

        public Builder(RegionBackendServiceConnectionTrackingPolicyGetArgs defaults) {
            $ = new RegionBackendServiceConnectionTrackingPolicyGetArgs(Objects.requireNonNull(defaults));
        }
