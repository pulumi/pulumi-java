...
public final class AppEngineServiceIamBindingArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AppEngineServiceIamBindingArgs(AppEngineServiceIamBindingArgs $) {
        this.appId = $.appId;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppEngineServiceIamBindingArgs();
        }

        public Builder(AppEngineServiceIamBindingArgs defaults) {
            $ = new AppEngineServiceIamBindingArgs(Objects.requireNonNull(defaults));
        }
