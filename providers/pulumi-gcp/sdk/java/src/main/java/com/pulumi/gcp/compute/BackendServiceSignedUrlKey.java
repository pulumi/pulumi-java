...
public class BackendServiceSignedUrlKey extends CustomResource {
    /**
     ...
     */
    public BackendServiceSignedUrlKey(String name, BackendServiceSignedUrlKeyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BackendServiceSignedUrlKey(String name, Output<String> id, @Nullable BackendServiceSignedUrlKeyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BackendServiceSignedUrlKey get(String name, Output<String> id, @Nullable BackendServiceSignedUrlKeyState state, @Nullable CustomResourceOptions options) {
