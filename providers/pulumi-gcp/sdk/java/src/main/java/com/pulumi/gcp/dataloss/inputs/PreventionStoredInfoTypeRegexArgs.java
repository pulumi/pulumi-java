...
public final class PreventionStoredInfoTypeRegexArgs extends ResourceArgs {
    ...
    private PreventionStoredInfoTypeRegexArgs(PreventionStoredInfoTypeRegexArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PreventionStoredInfoTypeRegexArgs();
        }

        public Builder(PreventionStoredInfoTypeRegexArgs defaults) {
            $ = new PreventionStoredInfoTypeRegexArgs(Objects.requireNonNull(defaults));
        }
