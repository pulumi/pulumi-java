...
public final class TunnelInstanceIAMBindingConditionGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TunnelInstanceIAMBindingConditionGetArgs(TunnelInstanceIAMBindingConditionGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TunnelInstanceIAMBindingConditionGetArgs();
        }

        public Builder(TunnelInstanceIAMBindingConditionGetArgs defaults) {
            $ = new TunnelInstanceIAMBindingConditionGetArgs(Objects.requireNonNull(defaults));
        }
