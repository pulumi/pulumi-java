...
public final class InboundSamlConfigIdpConfigIdpCertificateArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InboundSamlConfigIdpConfigIdpCertificateArgs(InboundSamlConfigIdpConfigIdpCertificateArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InboundSamlConfigIdpConfigIdpCertificateArgs();
        }

        public Builder(InboundSamlConfigIdpConfigIdpCertificateArgs defaults) {
            $ = new InboundSamlConfigIdpConfigIdpCertificateArgs(Objects.requireNonNull(defaults));
        }
