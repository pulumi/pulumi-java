...
public final class EnterpriseKeyAndroidSettingsGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EnterpriseKeyAndroidSettingsGetArgs(EnterpriseKeyAndroidSettingsGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EnterpriseKeyAndroidSettingsGetArgs();
        }

        public Builder(EnterpriseKeyAndroidSettingsGetArgs defaults) {
            $ = new EnterpriseKeyAndroidSettingsGetArgs(Objects.requireNonNull(defaults));
        }
