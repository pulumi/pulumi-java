...
public final class RegionInstanceGroupManagerStatefulDiskGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegionInstanceGroupManagerStatefulDiskGetArgs(RegionInstanceGroupManagerStatefulDiskGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionInstanceGroupManagerStatefulDiskGetArgs();
        }

        public Builder(RegionInstanceGroupManagerStatefulDiskGetArgs defaults) {
            $ = new RegionInstanceGroupManagerStatefulDiskGetArgs(Objects.requireNonNull(defaults));
        }
