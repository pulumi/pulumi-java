...
public final class URLMapPathMatcherRouteRuleRouteActionCorsPolicy {
    ...
    */
    ...
    public static Builder builder(URLMapPathMatcherRouteRuleRouteActionCorsPolicy defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(URLMapPathMatcherRouteRuleRouteActionCorsPolicy defaults) {
        ...
        public Builder maxAge(@Nullable Integer maxAge) {
            this.maxAge = maxAge;
            return this;
        }        public URLMapPathMatcherRouteRuleRouteActionCorsPolicy build() {
            return new URLMapPathMatcherRouteRuleRouteActionCorsPolicy(allowCredentials, allowHeaders, allowMethods, allowOriginRegexes, allowOrigins, disabled, exposeHeaders, maxAge);
        }
    }
}
