...
public final class GuestPoliciesPackageRepositoryYumGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GuestPoliciesPackageRepositoryYumGetArgs(GuestPoliciesPackageRepositoryYumGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GuestPoliciesPackageRepositoryYumGetArgs();
        }

        public Builder(GuestPoliciesPackageRepositoryYumGetArgs defaults) {
            $ = new GuestPoliciesPackageRepositoryYumGetArgs(Objects.requireNonNull(defaults));
        }
