 ...
 *             .idpConfig(InboundSamlConfigIdpConfig.builder()
 *                 .idpEntityId(&#34;tf-idp&#34;)
 *                 .signRequest(true)
 *                 .ssoUrl(&#34;https://example.com&#34;)
 *                 .idpCertificates(InboundSamlConfigIdpConfigIdpCertificate.builder()
 *                     .x509Certificate(Files.readString(&#34;test-fixtures/rsa_cert.pem&#34;))
 *                     .build())
 *                 .build())
 *             .spConfig(InboundSamlConfigSpConfig.builder()
 *                 .spEntityId(&#34;tf-sp&#34;)
