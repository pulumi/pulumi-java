...
public class SharedVPCServiceProject extends CustomResource {
    /**
     ...
     */
    public SharedVPCServiceProject(String name, SharedVPCServiceProjectArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SharedVPCServiceProject(String name, Output<String> id, @Nullable SharedVPCServiceProjectState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SharedVPCServiceProject get(String name, Output<String> id, @Nullable SharedVPCServiceProjectState state, @Nullable CustomResourceOptions options) {
