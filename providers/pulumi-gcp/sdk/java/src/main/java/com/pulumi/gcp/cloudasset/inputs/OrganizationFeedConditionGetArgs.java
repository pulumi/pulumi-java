...
public final class OrganizationFeedConditionGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final OrganizationFeedConditionGetArgs Empty = new OrganizationFeedConditionGetArgs();
    ...
    private OrganizationFeedConditionGetArgs(OrganizationFeedConditionGetArgs $) {
    ...
    public static Builder builder(OrganizationFeedConditionGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OrganizationFeedConditionGetArgs();
        }

        public Builder(OrganizationFeedConditionGetArgs defaults) {
            $ = new OrganizationFeedConditionGetArgs(Objects.requireNonNull(defaults));
        }
