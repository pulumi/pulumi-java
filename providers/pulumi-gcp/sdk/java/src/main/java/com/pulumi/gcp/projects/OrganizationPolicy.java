...
public class OrganizationPolicy extends CustomResource {
    /**
     ...
     */
    public OrganizationPolicy(String name, OrganizationPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OrganizationPolicy(String name, Output<String> id, @Nullable OrganizationPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OrganizationPolicy get(String name, Output<String> id, @Nullable OrganizationPolicyState state, @Nullable CustomResourceOptions options) {
