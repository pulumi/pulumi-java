...
public final class RegionUrlMapPathMatcherRouteRuleRouteActionUrlRewriteArgs extends ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionUrlMapPathMatcherRouteRuleRouteActionUrlRewriteArgs();
        }

        public Builder(RegionUrlMapPathMatcherRouteRuleRouteActionUrlRewriteArgs defaults) {
            $ = new RegionUrlMapPathMatcherRouteRuleRouteActionUrlRewriteArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param hostRewrite Prior to forwarding the request to the selected service, the request&#39;s host
         * header is replaced with contents of hostRewrite. The value must be between 1 and
         * 255 characters.
         * 
         * @return builder
        ...
        /**
         * @param pathPrefixRewrite Prior to forwarding the request to the selected backend service, the matching
         * portion of the request&#39;s path is replaced by pathPrefixRewrite. The value must
         * be between 1 and 1024 characters.
         * 
         * @return builder
