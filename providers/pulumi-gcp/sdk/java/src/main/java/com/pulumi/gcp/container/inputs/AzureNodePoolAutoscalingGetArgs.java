...
public final class AzureNodePoolAutoscalingGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzureNodePoolAutoscalingGetArgs(AzureNodePoolAutoscalingGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureNodePoolAutoscalingGetArgs();
        }

        public Builder(AzureNodePoolAutoscalingGetArgs defaults) {
            $ = new AzureNodePoolAutoscalingGetArgs(Objects.requireNonNull(defaults));
        }
