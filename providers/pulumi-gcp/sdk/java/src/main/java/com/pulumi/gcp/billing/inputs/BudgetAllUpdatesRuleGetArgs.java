...
public final class BudgetAllUpdatesRuleGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private BudgetAllUpdatesRuleGetArgs(BudgetAllUpdatesRuleGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetAllUpdatesRuleGetArgs();
        }

        public Builder(BudgetAllUpdatesRuleGetArgs defaults) {
            $ = new BudgetAllUpdatesRuleGetArgs(Objects.requireNonNull(defaults));
        }
