...
public final class URLMapPathMatcherDefaultRouteActionUrlRewriteGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final URLMapPathMatcherDefaultRouteActionUrlRewriteGetArgs Empty = new URLMapPathMatcherDefaultRouteActionUrlRewriteGetArgs();
    ...
    private URLMapPathMatcherDefaultRouteActionUrlRewriteGetArgs() {}

    private URLMapPathMatcherDefaultRouteActionUrlRewriteGetArgs(URLMapPathMatcherDefaultRouteActionUrlRewriteGetArgs $) {
    ...
    public static Builder builder(URLMapPathMatcherDefaultRouteActionUrlRewriteGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapPathMatcherDefaultRouteActionUrlRewriteGetArgs();
        }

        public Builder(URLMapPathMatcherDefaultRouteActionUrlRewriteGetArgs defaults) {
            $ = new URLMapPathMatcherDefaultRouteActionUrlRewriteGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public URLMapPathMatcherDefaultRouteActionUrlRewriteGetArgs build() {
            return $;
        }
    }
