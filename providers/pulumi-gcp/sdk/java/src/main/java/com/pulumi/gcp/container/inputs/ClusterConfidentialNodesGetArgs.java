...
public final class ClusterConfidentialNodesGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterConfidentialNodesGetArgs(ClusterConfidentialNodesGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterConfidentialNodesGetArgs();
        }

        public Builder(ClusterConfidentialNodesGetArgs defaults) {
            $ = new ClusterConfidentialNodesGetArgs(Objects.requireNonNull(defaults));
        }
