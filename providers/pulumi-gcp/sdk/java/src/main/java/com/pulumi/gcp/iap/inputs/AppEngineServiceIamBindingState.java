...
public final class AppEngineServiceIamBindingState extends com.pulumi.resources.ResourceArgs {
    ...
    private AppEngineServiceIamBindingState(AppEngineServiceIamBindingState $) {
        this.appId = $.appId;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppEngineServiceIamBindingState();
        }

        public Builder(AppEngineServiceIamBindingState defaults) {
            $ = new AppEngineServiceIamBindingState(Objects.requireNonNull(defaults));
        }
