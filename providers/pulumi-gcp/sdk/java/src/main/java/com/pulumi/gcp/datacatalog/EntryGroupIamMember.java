...
public class EntryGroupIamMember extends CustomResource {
     ...
     */
    public EntryGroupIamMember(String name, EntryGroupIamMemberArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EntryGroupIamMember(String name, Output<String> id, @Nullable EntryGroupIamMemberState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EntryGroupIamMember get(String name, Output<String> id, @Nullable EntryGroupIamMemberState state, @Nullable CustomResourceOptions options) {
