...
public class DicomStoreIamMember extends CustomResource {
     ...
     */
    public DicomStoreIamMember(String name, DicomStoreIamMemberArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DicomStoreIamMember(String name, Output<String> id, @Nullable DicomStoreIamMemberState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DicomStoreIamMember get(String name, Output<String> id, @Nullable DicomStoreIamMemberState state, @Nullable CustomResourceOptions options) {
