...
public final class WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorGetArgs(WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorGetArgs();
        }

        public Builder(WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorGetArgs defaults) {
            $ = new WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorGetArgs(Objects.requireNonNull(defaults));
        }
