...
public final class JobPysparkConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<JobPysparkConfigLoggingConfigGetArgs>> loggingConfig() {
    ...
    private JobPysparkConfigGetArgs(JobPysparkConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobPysparkConfigGetArgs();
        }

        public Builder(JobPysparkConfigGetArgs defaults) {
            $ = new JobPysparkConfigGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder loggingConfig(JobPysparkConfigLoggingConfigGetArgs loggingConfig) {
