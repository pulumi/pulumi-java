...
public final class WebIamBindingConditionGetArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebIamBindingConditionGetArgs Empty = new WebIamBindingConditionGetArgs();
    ...
    private WebIamBindingConditionGetArgs() {}

    private WebIamBindingConditionGetArgs(WebIamBindingConditionGetArgs $) {
    ...
    public static Builder builder(WebIamBindingConditionGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebIamBindingConditionGetArgs();
        }

        public Builder(WebIamBindingConditionGetArgs defaults) {
            $ = new WebIamBindingConditionGetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WebIamBindingConditionGetArgs build() {
