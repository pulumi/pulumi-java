...
public class SubnetworkIAMMember extends CustomResource {
    /**
     ...
     */
    public SubnetworkIAMMember(String name, SubnetworkIAMMemberArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SubnetworkIAMMember(String name, Output<String> id, @Nullable SubnetworkIAMMemberState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SubnetworkIAMMember get(String name, Output<String> id, @Nullable SubnetworkIAMMemberState state, @Nullable CustomResourceOptions options) {
