...
public final class URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyAbortGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyAbortGetArgs(URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyAbortGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyAbortGetArgs();
        }

        public Builder(URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyAbortGetArgs defaults) {
            $ = new URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyAbortGetArgs(Objects.requireNonNull(defaults));
        }
