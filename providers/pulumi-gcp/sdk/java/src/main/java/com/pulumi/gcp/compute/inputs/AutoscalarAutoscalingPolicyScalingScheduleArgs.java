...
public final class AutoscalarAutoscalingPolicyScalingScheduleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public AutoscalarAutoscalingPolicyScalingScheduleArgs(
    ...
    public static final class Builder {
        ...
        public Builder timeZone(@Nullable String timeZone) {
            ...
            return new AutoscalarAutoscalingPolicyScalingScheduleArgs(description, disabled, durationSec, minRequiredReplicas, name, schedule, timeZone);
        }
    }
}
