...
public final class FlexibleAppVersionNetworkGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FlexibleAppVersionNetworkGetArgs(FlexibleAppVersionNetworkGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FlexibleAppVersionNetworkGetArgs();
        }

        public Builder(FlexibleAppVersionNetworkGetArgs defaults) {
            $ = new FlexibleAppVersionNetworkGetArgs(Objects.requireNonNull(defaults));
        }
