...
public final class URLMapTestGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private URLMapTestGetArgs(URLMapTestGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapTestGetArgs();
        }

        public Builder(URLMapTestGetArgs defaults) {
            $ = new URLMapTestGetArgs(Objects.requireNonNull(defaults));
        }
