...
public class FolderExclusion extends CustomResource {
    /**
     ...
     */
    public FolderExclusion(String name, FolderExclusionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FolderExclusion(String name, Output<String> id, @Nullable FolderExclusionState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FolderExclusion get(String name, Output<String> id, @Nullable FolderExclusionState state, @Nullable CustomResourceOptions options) {
