...
public class TaxonomyIamBinding extends CustomResource {
     ...
     */
    public TaxonomyIamBinding(String name, TaxonomyIamBindingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TaxonomyIamBinding(String name, Output<String> id, @Nullable TaxonomyIamBindingState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TaxonomyIamBinding get(String name, Output<String> id, @Nullable TaxonomyIamBindingState state, @Nullable CustomResourceOptions options) {
