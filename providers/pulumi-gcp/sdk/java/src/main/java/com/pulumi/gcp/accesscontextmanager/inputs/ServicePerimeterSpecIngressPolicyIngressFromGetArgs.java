...
import com.pulumi.gcp.accesscontextmanager.inputs.ServicePerimeterSpecIngressPolicyIngressFromSourceGetArgs;
...
public final class ServicePerimeterSpecIngressPolicyIngressFromGetArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<List<ServicePerimeterSpecIngressPolicyIngressFromSourceGetArgs>>> sources() {
        return Optional.ofNullable(this.sources);
    }

    private ServicePerimeterSpecIngressPolicyIngressFromGetArgs() {}

    private ServicePerimeterSpecIngressPolicyIngressFromGetArgs(ServicePerimeterSpecIngressPolicyIngressFromGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServicePerimeterSpecIngressPolicyIngressFromGetArgs();
        }

        public Builder(ServicePerimeterSpecIngressPolicyIngressFromGetArgs defaults) {
            $ = new ServicePerimeterSpecIngressPolicyIngressFromGetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder sources(List<ServicePerimeterSpecIngressPolicyIngressFromSourceGetArgs> sources) {
