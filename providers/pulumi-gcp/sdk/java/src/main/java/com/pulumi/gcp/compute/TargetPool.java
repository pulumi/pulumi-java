...
public class TargetPool extends CustomResource {
     ...
     */
    public TargetPool(String name, @Nullable TargetPoolArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TargetPool(String name, Output<String> id, @Nullable TargetPoolState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TargetPool get(String name, Output<String> id, @Nullable TargetPoolState state, @Nullable CustomResourceOptions options) {
