...
public final class WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigDiskConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigDiskConfigArgs(WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigDiskConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigDiskConfigArgs();
        }

        public Builder(WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigDiskConfigArgs defaults) {
            $ = new WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigDiskConfigArgs(Objects.requireNonNull(defaults));
        }
