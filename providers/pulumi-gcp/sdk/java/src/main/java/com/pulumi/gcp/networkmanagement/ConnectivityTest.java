...
public class ConnectivityTest extends CustomResource {
    ...
    private ConnectivityTest(String name, Output<String> id, @Nullable ConnectivityTestState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConnectivityTest get(String name, Output<String> id, @Nullable ConnectivityTestState state, @Nullable CustomResourceOptions options) {
