...
public class TopicIAMMember extends CustomResource {
     ...
     */
    public TopicIAMMember(String name, TopicIAMMemberArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TopicIAMMember(String name, Output<String> id, @Nullable TopicIAMMemberState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TopicIAMMember get(String name, Output<String> id, @Nullable TopicIAMMemberState state, @Nullable CustomResourceOptions options) {
