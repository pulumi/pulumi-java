...
public final class URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceArgs extends ResourceArgs {
    ...
    private @Nullable Output<URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceHeaderActionArgs> headerAction;
     ...
     * 
     */
    public Optional<Output<URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceHeaderActionArgs>> headerAction() {
    ...
    private URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceArgs() {}

    private URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceArgs(URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceArgs $) {
    ...
    public static Builder builder(URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceArgs();
        }

        public Builder(URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceArgs defaults) {
            $ = new URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headerAction(@Nullable Output<URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceHeaderActionArgs> headerAction) {
         ...
         * 
         */
        public Builder headerAction(URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceHeaderActionArgs headerAction) {
