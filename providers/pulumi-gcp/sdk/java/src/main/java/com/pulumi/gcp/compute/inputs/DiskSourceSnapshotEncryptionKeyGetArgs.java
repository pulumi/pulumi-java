...
public final class DiskSourceSnapshotEncryptionKeyGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DiskSourceSnapshotEncryptionKeyGetArgs(DiskSourceSnapshotEncryptionKeyGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DiskSourceSnapshotEncryptionKeyGetArgs();
        }

        public Builder(DiskSourceSnapshotEncryptionKeyGetArgs defaults) {
            $ = new DiskSourceSnapshotEncryptionKeyGetArgs(Objects.requireNonNull(defaults));
        }
