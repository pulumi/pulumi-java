...
public class ClusterIAMBinding extends CustomResource {
    /**
     ...
     */
    public ClusterIAMBinding(String name, ClusterIAMBindingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ClusterIAMBinding(String name, Output<String> id, @Nullable ClusterIAMBindingState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ClusterIAMBinding get(String name, Output<String> id, @Nullable ClusterIAMBindingState state, @Nullable CustomResourceOptions options) {
