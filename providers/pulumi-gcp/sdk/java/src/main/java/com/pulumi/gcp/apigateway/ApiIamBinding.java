...
import com.pulumi.gcp.apigateway.inputs.ApiIamBindingState;
...
public class ApiIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public ApiIamBinding(String name, ApiIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private ApiIamBinding(String name, Output<String> id, @Nullable ApiIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ApiIamBinding get(String name, Output<String> id, @Nullable ApiIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
