...
public class ApiIamBinding extends CustomResource {
     ...
     */
    public ApiIamBinding(String name, ApiIamBindingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApiIamBinding(String name, Output<String> id, @Nullable ApiIamBindingState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApiIamBinding get(String name, Output<String> id, @Nullable ApiIamBindingState state, @Nullable CustomResourceOptions options) {
