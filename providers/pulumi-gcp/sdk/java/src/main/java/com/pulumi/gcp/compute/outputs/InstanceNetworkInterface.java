...
import com.pulumi.gcp.compute.outputs.InstanceNetworkInterfaceAccessConfig;
...
public final class InstanceNetworkInterface {
    ...
    private InstanceNetworkInterface(
        @CustomType.Parameter("accessConfigs") @Nullable List<InstanceNetworkInterfaceAccessConfig> accessConfigs,
        @CustomType.Parameter("aliasIpRanges") @Nullable List<InstanceNetworkInterfaceAliasIpRange> aliasIpRanges,
        @CustomType.Parameter("ipv6AccessConfigs") @Nullable List<InstanceNetworkInterfaceIpv6AccessConfig> ipv6AccessConfigs,
    ...
    public static final class Builder {
        ...
        public Builder accessConfigs(@Nullable List<InstanceNetworkInterfaceAccessConfig> accessConfigs) {
            this.accessConfigs = accessConfigs;
            return this;
        }
        public Builder accessConfigs(InstanceNetworkInterfaceAccessConfig... accessConfigs) {
            return accessConfigs(List.of(accessConfigs));
        }
        public Builder aliasIpRanges(@Nullable List<InstanceNetworkInterfaceAliasIpRange> aliasIpRanges) {
            this.aliasIpRanges = aliasIpRanges;
            return this;
        }
        public Builder aliasIpRanges(InstanceNetworkInterfaceAliasIpRange... aliasIpRanges) {
            return aliasIpRanges(List.of(aliasIpRanges));
        }
        public Builder ipv6AccessConfigs(@Nullable List<InstanceNetworkInterfaceIpv6AccessConfig> ipv6AccessConfigs) {
            this.ipv6AccessConfigs = ipv6AccessConfigs;
            return this;
        }
        public Builder ipv6AccessConfigs(InstanceNetworkInterfaceIpv6AccessConfig... ipv6AccessConfigs) {
