...
public final class InstanceAttachedDiskGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceAttachedDiskGetArgs(InstanceAttachedDiskGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceAttachedDiskGetArgs();
        }

        public Builder(InstanceAttachedDiskGetArgs defaults) {
            $ = new InstanceAttachedDiskGetArgs(Objects.requireNonNull(defaults));
        }
