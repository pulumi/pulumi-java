...
public final class PolicyListPolicyDenyGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PolicyListPolicyDenyGetArgs(PolicyListPolicyDenyGetArgs $) {
        this.all = $.all;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyListPolicyDenyGetArgs();
        }

        public Builder(PolicyListPolicyDenyGetArgs defaults) {
            $ = new PolicyListPolicyDenyGetArgs(Objects.requireNonNull(defaults));
        }
