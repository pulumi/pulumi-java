...
public final class RegionUrlMapHostRuleGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegionUrlMapHostRuleGetArgs(RegionUrlMapHostRuleGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionUrlMapHostRuleGetArgs();
        }

        public Builder(RegionUrlMapHostRuleGetArgs defaults) {
            $ = new RegionUrlMapHostRuleGetArgs(Objects.requireNonNull(defaults));
        }
