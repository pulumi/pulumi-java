...
public final class AuthorityConfigX509ConfigKeyUsageBaseKeyUsageGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AuthorityConfigX509ConfigKeyUsageBaseKeyUsageGetArgs(AuthorityConfigX509ConfigKeyUsageBaseKeyUsageGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthorityConfigX509ConfigKeyUsageBaseKeyUsageGetArgs();
        }

        public Builder(AuthorityConfigX509ConfigKeyUsageBaseKeyUsageGetArgs defaults) {
            $ = new AuthorityConfigX509ConfigKeyUsageBaseKeyUsageGetArgs(Objects.requireNonNull(defaults));
        }
