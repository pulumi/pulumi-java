...
public class RegionAutoscaler extends CustomResource {
    /**
     ...
     */
    public RegionAutoscaler(String name, RegionAutoscalerArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegionAutoscaler(String name, Output<String> id, @Nullable RegionAutoscalerState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegionAutoscaler get(String name, Output<String> id, @Nullable RegionAutoscalerState state, @Nullable CustomResourceOptions options) {
