...
public final class CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsageArgs extends com.pulumi.resources.ResourceArgs {

    public static final CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsageArgs Empty = new CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsageArgs();
    ...
    private CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsageArgs() {}

    private CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsageArgs(CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsageArgs $) {
    ...
    public static Builder builder(CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsageArgs();
        }

        public Builder(CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsageArgs defaults) {
            $ = new CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsageArgs(Objects.requireNonNull(defaults));
        }
