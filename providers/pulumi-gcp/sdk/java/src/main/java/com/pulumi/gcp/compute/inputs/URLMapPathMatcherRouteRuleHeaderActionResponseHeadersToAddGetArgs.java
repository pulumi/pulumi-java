...
public final class URLMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private URLMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddGetArgs(URLMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddGetArgs();
        }

        public Builder(URLMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddGetArgs defaults) {
            $ = new URLMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddGetArgs(Objects.requireNonNull(defaults));
        }
