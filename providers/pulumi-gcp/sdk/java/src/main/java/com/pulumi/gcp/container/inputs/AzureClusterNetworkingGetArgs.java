...
public final class AzureClusterNetworkingGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzureClusterNetworkingGetArgs(AzureClusterNetworkingGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureClusterNetworkingGetArgs();
        }

        public Builder(AzureClusterNetworkingGetArgs defaults) {
            $ = new AzureClusterNetworkingGetArgs(Objects.requireNonNull(defaults));
        }
