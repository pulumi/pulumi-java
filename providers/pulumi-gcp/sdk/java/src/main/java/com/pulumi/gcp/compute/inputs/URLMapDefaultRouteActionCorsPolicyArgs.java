...
public final class URLMapDefaultRouteActionCorsPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private URLMapDefaultRouteActionCorsPolicyArgs(URLMapDefaultRouteActionCorsPolicyArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapDefaultRouteActionCorsPolicyArgs();
        }

        public Builder(URLMapDefaultRouteActionCorsPolicyArgs defaults) {
            $ = new URLMapDefaultRouteActionCorsPolicyArgs(Objects.requireNonNull(defaults));
        }
