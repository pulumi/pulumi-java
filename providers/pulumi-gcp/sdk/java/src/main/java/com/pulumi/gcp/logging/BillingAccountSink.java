...
public class BillingAccountSink extends CustomResource {
    ...
    private BillingAccountSink(String name, Output<String> id, @Nullable BillingAccountSinkState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BillingAccountSink get(String name, Output<String> id, @Nullable BillingAccountSinkState state, @Nullable CustomResourceOptions options) {
