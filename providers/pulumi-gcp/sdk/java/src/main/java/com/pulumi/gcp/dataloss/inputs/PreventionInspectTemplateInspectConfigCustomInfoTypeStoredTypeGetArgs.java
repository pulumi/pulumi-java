...
public final class PreventionInspectTemplateInspectConfigCustomInfoTypeStoredTypeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PreventionInspectTemplateInspectConfigCustomInfoTypeStoredTypeGetArgs(PreventionInspectTemplateInspectConfigCustomInfoTypeStoredTypeGetArgs $) {
        this.name = $.name;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PreventionInspectTemplateInspectConfigCustomInfoTypeStoredTypeGetArgs();
        }

        public Builder(PreventionInspectTemplateInspectConfigCustomInfoTypeStoredTypeGetArgs defaults) {
            $ = new PreventionInspectTemplateInspectConfigCustomInfoTypeStoredTypeGetArgs(Objects.requireNonNull(defaults));
        }
