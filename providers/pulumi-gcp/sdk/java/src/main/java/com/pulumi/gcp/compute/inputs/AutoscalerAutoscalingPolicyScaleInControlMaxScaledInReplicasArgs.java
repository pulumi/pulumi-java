...
public final class AutoscalerAutoscalingPolicyScaleInControlMaxScaledInReplicasArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AutoscalerAutoscalingPolicyScaleInControlMaxScaledInReplicasArgs(AutoscalerAutoscalingPolicyScaleInControlMaxScaledInReplicasArgs $) {
        this.fixed = $.fixed;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutoscalerAutoscalingPolicyScaleInControlMaxScaledInReplicasArgs();
        }

        public Builder(AutoscalerAutoscalingPolicyScaleInControlMaxScaledInReplicasArgs defaults) {
            $ = new AutoscalerAutoscalingPolicyScaleInControlMaxScaledInReplicasArgs(Objects.requireNonNull(defaults));
        }
