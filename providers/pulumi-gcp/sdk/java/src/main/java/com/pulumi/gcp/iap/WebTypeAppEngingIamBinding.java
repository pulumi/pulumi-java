...
public class WebTypeAppEngingIamBinding extends CustomResource {
    /**
     ...
     */
    public WebTypeAppEngingIamBinding(String name, WebTypeAppEngingIamBindingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WebTypeAppEngingIamBinding(String name, Output<String> id, @Nullable WebTypeAppEngingIamBindingState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebTypeAppEngingIamBinding get(String name, Output<String> id, @Nullable WebTypeAppEngingIamBindingState state, @Nullable CustomResourceOptions options) {
