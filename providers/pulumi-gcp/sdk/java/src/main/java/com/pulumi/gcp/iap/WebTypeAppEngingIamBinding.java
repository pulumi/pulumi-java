...
import com.pulumi.gcp.iap.inputs.WebTypeAppEngingIamBindingState;
import com.pulumi.gcp.iap.outputs.WebTypeAppEngingIamBindingCondition;
...
public class WebTypeAppEngingIamBinding extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    public Output</* @Nullable */ WebTypeAppEngingIamBindingCondition> condition() {
     ...
     */
    public WebTypeAppEngingIamBinding(String name, WebTypeAppEngingIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private WebTypeAppEngingIamBinding(String name, Output<String> id, @Nullable WebTypeAppEngingIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static WebTypeAppEngingIamBinding get(String name, Output<String> id, @Nullable WebTypeAppEngingIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
