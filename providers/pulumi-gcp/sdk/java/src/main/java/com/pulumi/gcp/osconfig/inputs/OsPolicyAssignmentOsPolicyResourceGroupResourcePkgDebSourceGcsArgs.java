...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDebSourceGcsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDebSourceGcsArgs(OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDebSourceGcsArgs $) {
        this.bucket = $.bucket;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDebSourceGcsArgs();
        }

        public Builder(OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDebSourceGcsArgs defaults) {
            $ = new OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDebSourceGcsArgs(Objects.requireNonNull(defaults));
        }
