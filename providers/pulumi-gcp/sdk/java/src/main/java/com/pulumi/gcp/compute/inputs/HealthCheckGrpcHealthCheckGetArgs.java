...
public final class HealthCheckGrpcHealthCheckGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private HealthCheckGrpcHealthCheckGetArgs(HealthCheckGrpcHealthCheckGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HealthCheckGrpcHealthCheckGetArgs();
        }

        public Builder(HealthCheckGrpcHealthCheckGetArgs defaults) {
            $ = new HealthCheckGrpcHealthCheckGetArgs(Objects.requireNonNull(defaults));
        }
