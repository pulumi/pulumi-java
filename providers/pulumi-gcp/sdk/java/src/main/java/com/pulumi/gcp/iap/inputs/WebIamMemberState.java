...
import com.pulumi.gcp.iap.inputs.WebIamMemberConditionGetArgs;
...
public final class WebIamMemberState extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<WebIamMemberConditionGetArgs>> condition() {
    ...
    private WebIamMemberState(WebIamMemberState $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebIamMemberState();
        }

        public Builder(WebIamMemberState defaults) {
            $ = new WebIamMemberState(Objects.requireNonNull(defaults));
        }
        ...
        public Builder condition(WebIamMemberConditionGetArgs condition) {
