...
public class RepositoryIamPolicy extends CustomResource {
    ...
    private RepositoryIamPolicy(String name, Output<String> id, @Nullable RepositoryIamPolicyState state, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RepositoryIamPolicy get(String name, Output<String> id, @Nullable RepositoryIamPolicyState state, @Nullable CustomResourceOptions options) {
