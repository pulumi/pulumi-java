...
public final class InstanceNodeGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceNodeGetArgs(InstanceNodeGetArgs $) {
        this.id = $.id;
        this.zone = $.zone;
    }
