...
public final class WorkflowTemplateJobPysparkJobLoggingConfigGetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WorkflowTemplateJobPysparkJobLoggingConfigGetArgs(WorkflowTemplateJobPysparkJobLoggingConfigGetArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkflowTemplateJobPysparkJobLoggingConfigGetArgs();
        }

        public Builder(WorkflowTemplateJobPysparkJobLoggingConfigGetArgs defaults) {
            $ = new WorkflowTemplateJobPysparkJobLoggingConfigGetArgs(Objects.requireNonNull(defaults));
        }
