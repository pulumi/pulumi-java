 ...
 * 
 */
public final class ConfigurationAggregatorTag extends com.pulumi.resources.InvokeArgs {

    public static final ConfigurationAggregatorTag Empty = new ConfigurationAggregatorTag();
