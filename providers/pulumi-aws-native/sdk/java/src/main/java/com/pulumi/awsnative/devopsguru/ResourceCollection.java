...
public class ResourceCollection extends CustomResource {
     ...
     */
    public ResourceCollection(String name, ResourceCollectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResourceCollection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResourceCollection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
