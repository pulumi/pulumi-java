 ...
 * 
 */
public final class DiskTagArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DiskTagArgs(DiskTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder(DiskTagArgs defaults) {
            $ = new DiskTagArgs(Objects.requireNonNull(defaults));
        }
