...
public class LifecycleHook extends CustomResource {
     ...
     */
    public LifecycleHook(String name, LifecycleHookArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LifecycleHook(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LifecycleHook get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
