...
public class ContainerRecipe extends CustomResource {
     ...
     */
    public ContainerRecipe(String name, @Nullable ContainerRecipeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ContainerRecipe(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ContainerRecipe get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
