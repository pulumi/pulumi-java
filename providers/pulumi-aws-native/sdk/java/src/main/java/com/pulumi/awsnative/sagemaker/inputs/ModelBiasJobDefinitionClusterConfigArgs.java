...
public final class ModelBiasJobDefinitionClusterConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ModelBiasJobDefinitionClusterConfigArgs(ModelBiasJobDefinitionClusterConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ModelBiasJobDefinitionClusterConfigArgs();
        }

        public Builder(ModelBiasJobDefinitionClusterConfigArgs defaults) {
            $ = new ModelBiasJobDefinitionClusterConfigArgs(Objects.requireNonNull(defaults));
        }
