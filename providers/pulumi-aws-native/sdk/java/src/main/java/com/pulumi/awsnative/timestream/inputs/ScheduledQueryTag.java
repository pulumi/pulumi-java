 ...
 * 
 */
public final class ScheduledQueryTag extends com.pulumi.resources.InvokeArgs {
    ...
    private ScheduledQueryTag(ScheduledQueryTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ScheduledQueryTag();
        }

        public Builder(ScheduledQueryTag defaults) {
            $ = new ScheduledQueryTag(Objects.requireNonNull(defaults));
        }
