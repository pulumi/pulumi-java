 ...
 * 
 */
public final class SAMLProviderTag extends com.pulumi.resources.InvokeArgs {
    ...
    private SAMLProviderTag(SAMLProviderTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder(SAMLProviderTag defaults) {
            $ = new SAMLProviderTag(Objects.requireNonNull(defaults));
        }
