...
public class DBProxyTargetGroup extends CustomResource {
     ...
     */
    public DBProxyTargetGroup(String name, DBProxyTargetGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DBProxyTargetGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DBProxyTargetGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
