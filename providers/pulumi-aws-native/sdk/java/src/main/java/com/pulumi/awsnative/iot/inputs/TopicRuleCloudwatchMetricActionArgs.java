...
public final class TopicRuleCloudwatchMetricActionArgs extends ResourceArgs {
    ...
    private TopicRuleCloudwatchMetricActionArgs(TopicRuleCloudwatchMetricActionArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TopicRuleCloudwatchMetricActionArgs();
        }

        public Builder(TopicRuleCloudwatchMetricActionArgs defaults) {
            $ = new TopicRuleCloudwatchMetricActionArgs(Objects.requireNonNull(defaults));
        }
