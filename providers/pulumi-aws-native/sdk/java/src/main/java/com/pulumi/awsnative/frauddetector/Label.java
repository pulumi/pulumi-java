...
public class Label extends CustomResource {
    /**
     * The label ARN.
     * 
     */
     ...
     */
    public Label(String name, @Nullable LabelArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:frauddetector:Label", name, args == null ? LabelArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Label(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Label get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
