...
public class EnclaveCertificateIamRoleAssociation extends CustomResource {
    /**
     ...
     */
    public EnclaveCertificateIamRoleAssociation(String name, EnclaveCertificateIamRoleAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EnclaveCertificateIamRoleAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EnclaveCertificateIamRoleAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
