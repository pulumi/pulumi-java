...
public class TransitGatewayMulticastDomainAssociation extends CustomResource {
    /**
     ...
     */
    public TransitGatewayMulticastDomainAssociation(String name, TransitGatewayMulticastDomainAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TransitGatewayMulticastDomainAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TransitGatewayMulticastDomainAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
