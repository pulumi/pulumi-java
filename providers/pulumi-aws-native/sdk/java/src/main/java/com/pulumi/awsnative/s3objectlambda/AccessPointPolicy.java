...
public class AccessPointPolicy extends CustomResource {
    ...
    private AccessPointPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AccessPointPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
