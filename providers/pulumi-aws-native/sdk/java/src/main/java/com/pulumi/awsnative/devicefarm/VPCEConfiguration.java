...
public class VPCEConfiguration extends CustomResource {
     ...
     */
    public VPCEConfiguration(String name, VPCEConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VPCEConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VPCEConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
