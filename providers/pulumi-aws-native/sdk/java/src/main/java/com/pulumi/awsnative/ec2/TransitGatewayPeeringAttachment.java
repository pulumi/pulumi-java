...
public class TransitGatewayPeeringAttachment extends CustomResource {
    /**
     ...
     */
    public TransitGatewayPeeringAttachment(String name, TransitGatewayPeeringAttachmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TransitGatewayPeeringAttachment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TransitGatewayPeeringAttachment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
