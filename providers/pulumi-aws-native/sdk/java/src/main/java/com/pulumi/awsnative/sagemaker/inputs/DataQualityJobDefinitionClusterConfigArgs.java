 ...
 * 
 */
public final class DataQualityJobDefinitionClusterConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DataQualityJobDefinitionClusterConfigArgs(DataQualityJobDefinitionClusterConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataQualityJobDefinitionClusterConfigArgs();
        }

        public Builder(DataQualityJobDefinitionClusterConfigArgs defaults) {
            $ = new DataQualityJobDefinitionClusterConfigArgs(Objects.requireNonNull(defaults));
        }
