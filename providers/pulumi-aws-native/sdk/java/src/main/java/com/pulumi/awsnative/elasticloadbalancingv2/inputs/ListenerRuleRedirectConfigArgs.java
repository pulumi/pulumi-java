...
public final class ListenerRuleRedirectConfigArgs extends ResourceArgs {
    ...
    private ListenerRuleRedirectConfigArgs(ListenerRuleRedirectConfigArgs $) {
        this.host = $.host;
        this.path = $.path;
        this.port = $.port;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListenerRuleRedirectConfigArgs();
        }

        public Builder(ListenerRuleRedirectConfigArgs defaults) {
            $ = new ListenerRuleRedirectConfigArgs(Objects.requireNonNull(defaults));
        }
