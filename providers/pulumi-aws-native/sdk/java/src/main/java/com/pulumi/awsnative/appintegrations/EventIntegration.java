...
public class EventIntegration extends CustomResource {
    /**
     ...
     */
    public EventIntegration(String name, EventIntegrationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EventIntegration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EventIntegration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
