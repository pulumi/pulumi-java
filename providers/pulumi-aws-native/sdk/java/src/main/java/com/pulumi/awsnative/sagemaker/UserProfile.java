...
public class UserProfile extends CustomResource {
    ...
    private UserProfile(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UserProfile get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
