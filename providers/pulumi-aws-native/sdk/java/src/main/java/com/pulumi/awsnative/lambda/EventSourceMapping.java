...
public class EventSourceMapping extends CustomResource {
    ...
    private EventSourceMapping(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EventSourceMapping get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
