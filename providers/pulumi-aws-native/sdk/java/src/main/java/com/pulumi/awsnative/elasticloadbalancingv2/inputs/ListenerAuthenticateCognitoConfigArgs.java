...
public final class ListenerAuthenticateCognitoConfigArgs extends ResourceArgs {
    ...
    private ListenerAuthenticateCognitoConfigArgs(ListenerAuthenticateCognitoConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListenerAuthenticateCognitoConfigArgs();
        }

        public Builder(ListenerAuthenticateCognitoConfigArgs defaults) {
            $ = new ListenerAuthenticateCognitoConfigArgs(Objects.requireNonNull(defaults));
        }
