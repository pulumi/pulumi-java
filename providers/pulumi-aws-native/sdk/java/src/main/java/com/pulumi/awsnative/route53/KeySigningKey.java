...
public class KeySigningKey extends CustomResource {
    ...
    private KeySigningKey(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static KeySigningKey get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
