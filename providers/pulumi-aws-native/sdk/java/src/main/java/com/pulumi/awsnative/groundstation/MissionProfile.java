...
public class MissionProfile extends CustomResource {
     ...
     */
    public MissionProfile(String name, MissionProfileArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MissionProfile(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MissionProfile get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
