...
public class StorageLens extends CustomResource {
     ...
     */
    public StorageLens(String name, StorageLensArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:s3:StorageLens", name, args == null ? StorageLensArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private StorageLens(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StorageLens get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
