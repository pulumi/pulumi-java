...
public class RoutingControl extends CustomResource {
    /**
     ...
     */
    public RoutingControl(String name, @Nullable RoutingControlArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RoutingControl(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RoutingControl get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
