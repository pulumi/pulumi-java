...
public class EC2Fleet extends CustomResource {
     ...
     */
    public EC2Fleet(String name, EC2FleetArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:ec2:EC2Fleet", name, args == null ? EC2FleetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private EC2Fleet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EC2Fleet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
