...
public class Tracker extends CustomResource {
     ...
     */
    public Tracker(String name, @Nullable TrackerArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:location:Tracker", name, args == null ? TrackerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Tracker(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Tracker get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
