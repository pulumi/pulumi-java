...
public class IPSet extends CustomResource {
    ...
    private IPSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IPSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
