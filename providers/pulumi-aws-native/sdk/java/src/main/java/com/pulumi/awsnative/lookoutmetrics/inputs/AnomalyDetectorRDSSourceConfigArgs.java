...
public final class AnomalyDetectorRDSSourceConfigArgs extends ResourceArgs {
    ...
    private AnomalyDetectorRDSSourceConfigArgs(AnomalyDetectorRDSSourceConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AnomalyDetectorRDSSourceConfigArgs();
        }

        public Builder(AnomalyDetectorRDSSourceConfigArgs defaults) {
            $ = new AnomalyDetectorRDSSourceConfigArgs(Objects.requireNonNull(defaults));
        }
