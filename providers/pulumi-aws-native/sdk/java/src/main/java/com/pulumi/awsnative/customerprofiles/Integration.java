...
public class Integration extends CustomResource {
    ...
    private Integration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Integration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
