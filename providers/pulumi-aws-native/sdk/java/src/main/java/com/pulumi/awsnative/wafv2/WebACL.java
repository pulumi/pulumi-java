...
public class WebACL extends CustomResource {
    ...
    private WebACL(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WebACL get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
