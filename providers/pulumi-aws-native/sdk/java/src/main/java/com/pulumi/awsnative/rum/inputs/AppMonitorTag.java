 ...
 * 
 */
public final class AppMonitorTag extends com.pulumi.resources.InvokeArgs {

    public static final AppMonitorTag Empty = new AppMonitorTag();
    ...
    private AppMonitorTag() {}

    private AppMonitorTag(AppMonitorTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static Builder builder(AppMonitorTag defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AppMonitorTag defaults) {
            $ = new AppMonitorTag(Objects.requireNonNull(defaults));
        }
