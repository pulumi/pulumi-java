 ...
 * 
 */
public final class WorkspaceTag extends com.pulumi.resources.InvokeArgs {
    ...
    private WorkspaceTag(WorkspaceTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder(WorkspaceTag defaults) {
            $ = new WorkspaceTag(Objects.requireNonNull(defaults));
        }
