...
public class ProvisioningTemplate extends CustomResource {
     ...
     */
    public ProvisioningTemplate(String name, ProvisioningTemplateArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProvisioningTemplate(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProvisioningTemplate get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
