...
public final class NetworkInsightsAccessScopeAnalysisTagArgs extends ResourceArgs {
    ...
    private NetworkInsightsAccessScopeAnalysisTagArgs(NetworkInsightsAccessScopeAnalysisTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkInsightsAccessScopeAnalysisTagArgs();
        }

        public Builder(NetworkInsightsAccessScopeAnalysisTagArgs defaults) {
            $ = new NetworkInsightsAccessScopeAnalysisTagArgs(Objects.requireNonNull(defaults));
        }
