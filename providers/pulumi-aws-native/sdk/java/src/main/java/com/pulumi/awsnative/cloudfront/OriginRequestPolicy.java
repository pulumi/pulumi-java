...
public class OriginRequestPolicy extends CustomResource {
     ...
     */
    public OriginRequestPolicy(String name, OriginRequestPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OriginRequestPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OriginRequestPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
