...
public final class DataSourceMariaDbParameters extends com.pulumi.resources.InvokeArgs {
    ...
    private DataSourceMariaDbParameters(DataSourceMariaDbParameters $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataSourceMariaDbParameters();
        }

        public Builder(DataSourceMariaDbParameters defaults) {
            $ = new DataSourceMariaDbParameters(Objects.requireNonNull(defaults));
        }
