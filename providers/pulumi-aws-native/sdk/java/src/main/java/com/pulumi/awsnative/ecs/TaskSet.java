...
public class TaskSet extends CustomResource {
    ...
    private TaskSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TaskSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
