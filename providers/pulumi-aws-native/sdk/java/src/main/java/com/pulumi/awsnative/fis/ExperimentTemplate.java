...
public class ExperimentTemplate extends CustomResource {
     ...
     */
    public ExperimentTemplate(String name, ExperimentTemplateArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ExperimentTemplate(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ExperimentTemplate get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
