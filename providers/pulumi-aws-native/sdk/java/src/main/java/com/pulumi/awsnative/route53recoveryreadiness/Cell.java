...
public class Cell extends CustomResource {
     ...
     */
    public Cell(String name, @Nullable CellArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Cell(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Cell get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
