...
public class Subnet extends CustomResource {
    ...
    private Subnet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Subnet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
