...
public class ComponentVersion extends CustomResource {
     ...
     */
    public ComponentVersion(String name, @Nullable ComponentVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ComponentVersion(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ComponentVersion get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
