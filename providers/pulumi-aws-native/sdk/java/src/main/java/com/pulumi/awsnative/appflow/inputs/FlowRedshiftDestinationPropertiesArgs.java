...
public final class FlowRedshiftDestinationPropertiesArgs extends ResourceArgs {
    ...
    private FlowRedshiftDestinationPropertiesArgs(FlowRedshiftDestinationPropertiesArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FlowRedshiftDestinationPropertiesArgs();
        }

        public Builder(FlowRedshiftDestinationPropertiesArgs defaults) {
            $ = new FlowRedshiftDestinationPropertiesArgs(Objects.requireNonNull(defaults));
        }
