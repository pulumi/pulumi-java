...
public class MonitoringSchedule extends CustomResource {
    /**
     ...
     */
    public MonitoringSchedule(String name, MonitoringScheduleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MonitoringSchedule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MonitoringSchedule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
