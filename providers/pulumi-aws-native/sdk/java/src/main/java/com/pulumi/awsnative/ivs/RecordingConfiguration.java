...
public class RecordingConfiguration extends CustomResource {
     ...
     */
    public RecordingConfiguration(String name, RecordingConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RecordingConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RecordingConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
