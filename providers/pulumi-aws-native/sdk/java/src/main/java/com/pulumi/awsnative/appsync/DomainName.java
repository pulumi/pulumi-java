...
import com.pulumi.awsnative.appsync.DomainNameArgs;
...
public class DomainName extends CustomResource {
    ...
    private DomainName(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DomainName get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
