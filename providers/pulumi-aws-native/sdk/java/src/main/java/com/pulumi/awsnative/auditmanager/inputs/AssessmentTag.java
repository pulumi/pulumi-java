 ...
 * 
 */
public final class AssessmentTag extends com.pulumi.resources.InvokeArgs {

    public static final AssessmentTag Empty = new AssessmentTag();
    ...
    public static Builder builder(AssessmentTag defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AssessmentTag defaults) {
            $ = new AssessmentTag(Objects.requireNonNull(defaults));
        }
