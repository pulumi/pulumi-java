...
public class AnomalyDetector extends CustomResource {
    /**
     ...
     */
    public AnomalyDetector(String name, AnomalyDetectorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AnomalyDetector(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AnomalyDetector get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
