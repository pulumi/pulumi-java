...
public class SubnetNetworkAclAssociation extends CustomResource {
     ...
     */
    public SubnetNetworkAclAssociation(String name, SubnetNetworkAclAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SubnetNetworkAclAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SubnetNetworkAclAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
