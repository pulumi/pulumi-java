...
import com.pulumi.awsnative.iotevents.inputs.AlarmModelAssetPropertyValueArgs;
 ...
 * 
 */
public final class AlarmModelIotSiteWiseArgs extends com.pulumi.resources.ResourceArgs {

    public static final AlarmModelIotSiteWiseArgs Empty = new AlarmModelIotSiteWiseArgs();
    ...
    private Output<AlarmModelAssetPropertyValueArgs> propertyValue;

    public Output<AlarmModelAssetPropertyValueArgs> propertyValue() {
        return this.propertyValue;
    }

    private AlarmModelIotSiteWiseArgs() {}

    private AlarmModelIotSiteWiseArgs(AlarmModelIotSiteWiseArgs $) {
    ...
    public static Builder builder(AlarmModelIotSiteWiseArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlarmModelIotSiteWiseArgs();
        }

        public Builder(AlarmModelIotSiteWiseArgs defaults) {
            $ = new AlarmModelIotSiteWiseArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder propertyValue(Output<AlarmModelAssetPropertyValueArgs> propertyValue) {
            $.propertyValue = propertyValue;
            return this;
        }

        public Builder propertyValue(AlarmModelAssetPropertyValueArgs propertyValue) {
            return propertyValue(Output.of(propertyValue));
        }

        public AlarmModelIotSiteWiseArgs build() {
