...
public class Association extends CustomResource {
    ...
    private Association(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Association get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
