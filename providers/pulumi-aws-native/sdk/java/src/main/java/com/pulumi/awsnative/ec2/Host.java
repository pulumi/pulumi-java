...
public class Host extends CustomResource {
    /**
     ...
     */
    public Host(String name, HostArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:ec2:Host", name, args == null ? HostArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Host(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Host get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
