...
public class TaskDefinition extends CustomResource {
    ...
    private TaskDefinition(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TaskDefinition get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
