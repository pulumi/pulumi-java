...
public class PlaceIndex extends CustomResource {
     ...
     */
    public PlaceIndex(String name, PlaceIndexArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:location:PlaceIndex", name, args == null ? PlaceIndexArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private PlaceIndex(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PlaceIndex get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
