...
public final class ConnectorProfileZendeskConnectorProfileCredentialsArgs extends ResourceArgs {
    ...
    private ConnectorProfileZendeskConnectorProfileCredentialsArgs(ConnectorProfileZendeskConnectorProfileCredentialsArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectorProfileZendeskConnectorProfileCredentialsArgs();
        }

        public Builder(ConnectorProfileZendeskConnectorProfileCredentialsArgs defaults) {
            $ = new ConnectorProfileZendeskConnectorProfileCredentialsArgs(Objects.requireNonNull(defaults));
        }
