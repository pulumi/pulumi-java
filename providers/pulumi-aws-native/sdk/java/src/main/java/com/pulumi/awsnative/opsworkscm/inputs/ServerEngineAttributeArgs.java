...
public final class ServerEngineAttributeArgs extends ResourceArgs {
    ...
    private ServerEngineAttributeArgs(ServerEngineAttributeArgs $) {
        this.name = $.name;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServerEngineAttributeArgs();
        }

        public Builder(ServerEngineAttributeArgs defaults) {
            $ = new ServerEngineAttributeArgs(Objects.requireNonNull(defaults));
        }
