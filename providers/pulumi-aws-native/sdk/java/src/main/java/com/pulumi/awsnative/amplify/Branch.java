...
public class Branch extends CustomResource {
    ...
    private Branch(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Branch get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
