...
public class Trail extends CustomResource {
     ...
     */
    public Trail(String name, TrailArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:cloudtrail:Trail", name, args == null ? TrailArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Trail(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Trail get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
