...
public class FargateProfile extends CustomResource {
    ...
    private FargateProfile(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FargateProfile get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
