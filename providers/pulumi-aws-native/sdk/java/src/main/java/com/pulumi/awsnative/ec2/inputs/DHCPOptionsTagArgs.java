...
public final class DHCPOptionsTagArgs extends ResourceArgs {
    ...
    private DHCPOptionsTagArgs(DHCPOptionsTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DHCPOptionsTagArgs();
        }

        public Builder(DHCPOptionsTagArgs defaults) {
            $ = new DHCPOptionsTagArgs(Objects.requireNonNull(defaults));
        }
