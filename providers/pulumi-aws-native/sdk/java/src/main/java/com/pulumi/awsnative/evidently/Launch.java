...
public class Launch extends CustomResource {
     ...
     */
    public Launch(String name, LaunchArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:evidently:Launch", name, args == null ? LaunchArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Launch(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Launch get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
