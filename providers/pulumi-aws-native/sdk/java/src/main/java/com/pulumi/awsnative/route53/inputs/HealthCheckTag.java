 ...
 * 
 */
public final class HealthCheckTag extends com.pulumi.resources.InvokeArgs {
    ...
    private HealthCheckTag(HealthCheckTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder(HealthCheckTag defaults) {
            $ = new HealthCheckTag(Objects.requireNonNull(defaults));
        }
