...
public class SAMLProvider extends CustomResource {
    ...
    private SAMLProvider(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SAMLProvider get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
