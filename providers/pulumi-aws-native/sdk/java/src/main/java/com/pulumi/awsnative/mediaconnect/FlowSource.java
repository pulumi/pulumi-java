...
public class FlowSource extends CustomResource {
    /**
     ...
     */
    public FlowSource(String name, FlowSourceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FlowSource(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FlowSource get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
