...
public class BotAlias extends CustomResource {
    ...
    private BotAlias(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BotAlias get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
