...
public class ResolverConfig extends CustomResource {
     ...
     */
    public ResolverConfig(String name, ResolverConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResolverConfig(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResolverConfig get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
