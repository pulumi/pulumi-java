...
public class OIDCProvider extends CustomResource {
    /**
     ...
     */
    public OIDCProvider(String name, OIDCProviderArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:iam:OIDCProvider", name, args == null ? OIDCProviderArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private OIDCProvider(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OIDCProvider get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
