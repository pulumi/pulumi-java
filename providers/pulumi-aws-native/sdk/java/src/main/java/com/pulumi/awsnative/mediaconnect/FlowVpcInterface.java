...
public class FlowVpcInterface extends CustomResource {
    /**
     ...
     */
    public FlowVpcInterface(String name, FlowVpcInterfaceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FlowVpcInterface(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FlowVpcInterface get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
