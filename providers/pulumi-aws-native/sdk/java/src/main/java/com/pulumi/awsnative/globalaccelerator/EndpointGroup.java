...
public class EndpointGroup extends CustomResource {
     ...
     */
    public EndpointGroup(String name, EndpointGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EndpointGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EndpointGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
