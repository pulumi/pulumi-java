...
public final class DevicePoolTag extends com.pulumi.resources.InvokeArgs {
    ...
    private DevicePoolTag(DevicePoolTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder(DevicePoolTag defaults) {
            $ = new DevicePoolTag(Objects.requireNonNull(defaults));
        }
