...
public class IPAMPool extends CustomResource {
    /**
     ...
     */
    public IPAMPool(String name, IPAMPoolArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:ec2:IPAMPool", name, args == null ? IPAMPoolArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private IPAMPool(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IPAMPool get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
