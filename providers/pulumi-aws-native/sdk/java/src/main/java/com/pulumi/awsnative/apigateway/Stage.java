...
public class Stage extends CustomResource {
    ...
    private Stage(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Stage get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
