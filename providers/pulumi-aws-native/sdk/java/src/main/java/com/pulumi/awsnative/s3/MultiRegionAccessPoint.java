...
public class MultiRegionAccessPoint extends CustomResource {
    ...
    private MultiRegionAccessPoint(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MultiRegionAccessPoint get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
