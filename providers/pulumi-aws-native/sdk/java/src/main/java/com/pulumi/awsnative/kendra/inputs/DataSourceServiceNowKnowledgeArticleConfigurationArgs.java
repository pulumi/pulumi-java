...
public final class DataSourceServiceNowKnowledgeArticleConfigurationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DataSourceServiceNowKnowledgeArticleConfigurationArgs() {
        ...
        this.filterQuery = Codegen.empty();
    ...
    public static final class Builder {
        ...
        public Builder filterQuery(@Nullable String filterQuery) {
            this.filterQuery = Codegen.ofNullable(filterQuery);
            return this;
        }
