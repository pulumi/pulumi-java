...
public class RealtimeLogConfig extends CustomResource {
     ...
     */
    public RealtimeLogConfig(String name, RealtimeLogConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RealtimeLogConfig(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RealtimeLogConfig get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
