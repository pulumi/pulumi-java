...
public final class DetectorOutcomeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DetectorOutcomeArgs(DetectorOutcomeArgs $) {
        this.arn = $.arn;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DetectorOutcomeArgs();
        }

        public Builder(DetectorOutcomeArgs defaults) {
            $ = new DetectorOutcomeArgs(Objects.requireNonNull(defaults));
        }
