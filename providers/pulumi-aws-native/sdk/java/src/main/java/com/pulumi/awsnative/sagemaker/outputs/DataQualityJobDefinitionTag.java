...
@CustomType
public final class DataQualityJobDefinitionTag {
        /**
    ...
    private DataQualityJobDefinitionTag(
    ...
    public static Builder builder(DataQualityJobDefinitionTag defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DataQualityJobDefinitionTag defaults) {
