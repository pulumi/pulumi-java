...
public class Package extends CustomResource {
     ...
     */
    public Package(String name, @Nullable PackageArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:panorama:Package", name, args == null ? PackageArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Package(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Package get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
