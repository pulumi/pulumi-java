...
public class LocationEFS extends CustomResource {
     ...
     */
    public LocationEFS(String name, LocationEFSArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LocationEFS(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LocationEFS get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
