...
public class ServiceAction extends CustomResource {
     ...
     */
    public ServiceAction(String name, ServiceActionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceAction(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceAction get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
