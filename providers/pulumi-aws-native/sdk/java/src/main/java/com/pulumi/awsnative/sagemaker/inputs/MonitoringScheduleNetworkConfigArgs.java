...
import com.pulumi.awsnative.sagemaker.inputs.MonitoringScheduleVpcConfigArgs;
 ...
 * 
 */
public final class MonitoringScheduleNetworkConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<MonitoringScheduleVpcConfigArgs>> vpcConfig() {
        return Optional.ofNullable(this.vpcConfig);
    }

    private MonitoringScheduleNetworkConfigArgs() {}

    private MonitoringScheduleNetworkConfigArgs(MonitoringScheduleNetworkConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MonitoringScheduleNetworkConfigArgs();
        }
        ...
        public Builder vpcConfig(MonitoringScheduleVpcConfigArgs vpcConfig) {
