...
public final class DeliveryStreamCloudWatchLoggingOptionsArgs extends ResourceArgs {
    ...
    private DeliveryStreamCloudWatchLoggingOptionsArgs(DeliveryStreamCloudWatchLoggingOptionsArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeliveryStreamCloudWatchLoggingOptionsArgs();
        }

        public Builder(DeliveryStreamCloudWatchLoggingOptionsArgs defaults) {
            $ = new DeliveryStreamCloudWatchLoggingOptionsArgs(Objects.requireNonNull(defaults));
        }
