...
public class ACL extends CustomResource {
    ...
    private ACL(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ACL get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
