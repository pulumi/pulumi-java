...
public class ClusterCapacityProviderAssociations extends CustomResource {
     ...
     */
    public ClusterCapacityProviderAssociations(String name, ClusterCapacityProviderAssociationsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ClusterCapacityProviderAssociations(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ClusterCapacityProviderAssociations get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
