...
public class StaticIp extends CustomResource {
    /**
     ...
     */
    public StaticIp(String name, @Nullable StaticIpArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:lightsail:StaticIp", name, args == null ? StaticIpArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private StaticIp(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StaticIp get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
