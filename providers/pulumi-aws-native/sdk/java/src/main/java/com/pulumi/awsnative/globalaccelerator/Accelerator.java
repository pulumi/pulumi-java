...
public class Accelerator extends CustomResource {
    ...
    private Accelerator(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Accelerator get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
