...
public class SlackChannelConfiguration extends CustomResource {
    /**
     ...
     */
    public SlackChannelConfiguration(String name, SlackChannelConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SlackChannelConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SlackChannelConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
