...
public class IPAMScope extends CustomResource {
    /**
     ...
     */
    public IPAMScope(String name, IPAMScopeArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:ec2:IPAMScope", name, args == null ? IPAMScopeArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private IPAMScope(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IPAMScope get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
