 ...
 * 
 */
public final class DataSourceAuroraPostgreSqlParametersArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DataSourceAuroraPostgreSqlParametersArgs(DataSourceAuroraPostgreSqlParametersArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataSourceAuroraPostgreSqlParametersArgs();
        }

        public Builder(DataSourceAuroraPostgreSqlParametersArgs defaults) {
            $ = new DataSourceAuroraPostgreSqlParametersArgs(Objects.requireNonNull(defaults));
        }
