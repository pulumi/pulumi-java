...
public class SchemaVersionMetadata extends CustomResource {
    /**
     * Metadata key
     * 
     */
     ...
     */
    public SchemaVersionMetadata(String name, SchemaVersionMetadataArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SchemaVersionMetadata(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SchemaVersionMetadata get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
