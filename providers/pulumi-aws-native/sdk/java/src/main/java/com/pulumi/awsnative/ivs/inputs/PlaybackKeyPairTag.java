...
public final class PlaybackKeyPairTag extends com.pulumi.resources.InvokeArgs {
    ...
    private PlaybackKeyPairTag(PlaybackKeyPairTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PlaybackKeyPairTag();
        }

        public Builder(PlaybackKeyPairTag defaults) {
            $ = new PlaybackKeyPairTag(Objects.requireNonNull(defaults));
        }
