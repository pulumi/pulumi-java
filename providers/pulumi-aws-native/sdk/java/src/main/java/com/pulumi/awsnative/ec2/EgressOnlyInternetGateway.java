...
public class EgressOnlyInternetGateway extends CustomResource {
    ...
    private EgressOnlyInternetGateway(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EgressOnlyInternetGateway get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
