...
public class Method extends CustomResource {
    ...
    private Method(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Method get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
