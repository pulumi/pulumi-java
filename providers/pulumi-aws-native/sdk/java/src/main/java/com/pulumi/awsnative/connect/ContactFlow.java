...
public class ContactFlow extends CustomResource {
    ...
    private ContactFlow(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ContactFlow get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
