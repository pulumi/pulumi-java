...
public class GlobalCluster extends CustomResource {
     ...
     */
    public GlobalCluster(String name, @Nullable GlobalClusterArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:rds:GlobalCluster", name, args == null ? GlobalClusterArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private GlobalCluster(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GlobalCluster get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
