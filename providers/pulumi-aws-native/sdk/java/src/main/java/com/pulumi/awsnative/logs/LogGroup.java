...
public class LogGroup extends CustomResource {
    ...
    private LogGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LogGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
