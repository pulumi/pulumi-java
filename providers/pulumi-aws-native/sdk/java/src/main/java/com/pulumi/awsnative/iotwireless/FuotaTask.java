...
public class FuotaTask extends CustomResource {
    /**
     ...
     */
    public FuotaTask(String name, FuotaTaskArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:iotwireless:FuotaTask", name, args == null ? FuotaTaskArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FuotaTask(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FuotaTask get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
