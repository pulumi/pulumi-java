...
public class Fleet extends CustomResource {
     ...
     */
    public Fleet(String name, @Nullable FleetArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:gamelift:Fleet", name, args == null ? FleetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Fleet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Fleet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
