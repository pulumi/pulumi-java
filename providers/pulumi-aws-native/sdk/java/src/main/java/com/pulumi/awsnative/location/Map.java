...
public class Map extends CustomResource {
     ...
     */
    public Map(String name, MapArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:location:Map", name, args == null ? MapArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Map(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Map get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
