...
public class FlowLog extends CustomResource {
     ...
     */
    public FlowLog(String name, FlowLogArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:ec2:FlowLog", name, args == null ? FlowLogArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private FlowLog(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FlowLog get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
