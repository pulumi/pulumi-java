...
public class Robot extends CustomResource {
    /**
     ...
     */
    public Robot(String name, RobotArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:robomaker:Robot", name, args == null ? RobotArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Robot(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Robot get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
