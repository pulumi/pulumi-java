...
public class UserGroup extends CustomResource {
    ...
    private UserGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UserGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
