...
public class HoursOfOperation extends CustomResource {
    /**
     ...
     */
    public HoursOfOperation(String name, HoursOfOperationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HoursOfOperation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HoursOfOperation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
