...
public class ProfilingGroup extends CustomResource {
    /**
     ...
     */
    public ProfilingGroup(String name, @Nullable ProfilingGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProfilingGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProfilingGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
