...
public class ConnectionAlias extends CustomResource {
     ...
     */
    public ConnectionAlias(String name, ConnectionAliasArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConnectionAlias(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConnectionAlias get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
