...
public class JobTemplate extends CustomResource {
    /**
     ...
     */
    public JobTemplate(String name, JobTemplateArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:iot:JobTemplate", name, args == null ? JobTemplateArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private JobTemplate(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static JobTemplate get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
