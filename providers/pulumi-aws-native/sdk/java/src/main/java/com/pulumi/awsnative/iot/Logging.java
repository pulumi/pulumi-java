...
public class Logging extends CustomResource {
    /**
     ...
     */
    public Logging(String name, LoggingArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:iot:Logging", name, args == null ? LoggingArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Logging(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Logging get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
