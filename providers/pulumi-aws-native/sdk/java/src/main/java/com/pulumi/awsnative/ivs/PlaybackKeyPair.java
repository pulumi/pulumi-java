...
public class PlaybackKeyPair extends CustomResource {
    /**
     * Key-pair identifier.
     * 
     */
     ...
     */
    public PlaybackKeyPair(String name, PlaybackKeyPairArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PlaybackKeyPair(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PlaybackKeyPair get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
