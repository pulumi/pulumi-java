...
public final class DataSourceSalesforceStandardObjectConfigurationArgs extends ResourceArgs {
    ...
    private DataSourceSalesforceStandardObjectConfigurationArgs(DataSourceSalesforceStandardObjectConfigurationArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataSourceSalesforceStandardObjectConfigurationArgs();
        }

        public Builder(DataSourceSalesforceStandardObjectConfigurationArgs defaults) {
            $ = new DataSourceSalesforceStandardObjectConfigurationArgs(Objects.requireNonNull(defaults));
        }
