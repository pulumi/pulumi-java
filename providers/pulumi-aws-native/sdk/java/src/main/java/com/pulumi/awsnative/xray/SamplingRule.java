...
public class SamplingRule extends CustomResource {
     ...
     */
    public SamplingRule(String name, @Nullable SamplingRuleArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:xray:SamplingRule", name, args == null ? SamplingRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SamplingRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SamplingRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
