...
public class NetworkInsightsAccessScope extends CustomResource {
     ...
     */
    public NetworkInsightsAccessScope(String name, @Nullable NetworkInsightsAccessScopeArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NetworkInsightsAccessScope(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkInsightsAccessScope get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
