...
public class CarrierGateway extends CustomResource {
    ...
    private CarrierGateway(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CarrierGateway get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
