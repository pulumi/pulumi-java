...
public class ConnectorProfile extends CustomResource {
     ...
     */
    public ConnectorProfile(String name, ConnectorProfileArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConnectorProfile(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConnectorProfile get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
