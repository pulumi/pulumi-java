...
public class VPC extends CustomResource {
     ...
     */
    public VPC(String name, VPCArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:ec2:VPC", name, args == null ? VPCArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private VPC(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VPC get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
