...
public class DataflowEndpointGroup extends CustomResource {
    ...
    public Output<Optional<List<DataflowEndpointGroupTag>>> tags() {
     ...
     */
    public DataflowEndpointGroup(String name, DataflowEndpointGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DataflowEndpointGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DataflowEndpointGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
