...
public final class DBProxyEndpointTagFormatArgs extends ResourceArgs {
    ...
    private DBProxyEndpointTagFormatArgs(DBProxyEndpointTagFormatArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DBProxyEndpointTagFormatArgs();
        }

        public Builder(DBProxyEndpointTagFormatArgs defaults) {
            $ = new DBProxyEndpointTagFormatArgs(Objects.requireNonNull(defaults));
        }
