...
public class ImageRecipe extends CustomResource {
    ...
    private ImageRecipe(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ImageRecipe get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
