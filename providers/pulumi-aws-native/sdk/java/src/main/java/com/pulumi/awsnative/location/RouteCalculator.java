...
public class RouteCalculator extends CustomResource {
     ...
     */
    public RouteCalculator(String name, RouteCalculatorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RouteCalculator(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RouteCalculator get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
