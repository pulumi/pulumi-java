...
public final class DeliveryStreamOrcSerDeArgs extends ResourceArgs {
    ...
    private DeliveryStreamOrcSerDeArgs(DeliveryStreamOrcSerDeArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeliveryStreamOrcSerDeArgs();
        }

        public Builder(DeliveryStreamOrcSerDeArgs defaults) {
            $ = new DeliveryStreamOrcSerDeArgs(Objects.requireNonNull(defaults));
        }
