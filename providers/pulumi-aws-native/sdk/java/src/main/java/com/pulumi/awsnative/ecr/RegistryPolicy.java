...
public class RegistryPolicy extends CustomResource {
     ...
     */
    public RegistryPolicy(String name, RegistryPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RegistryPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RegistryPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
