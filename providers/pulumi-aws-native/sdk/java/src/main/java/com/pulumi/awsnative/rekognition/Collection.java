...
import com.pulumi.awsnative.rekognition.CollectionArgs;
...
public class Collection extends CustomResource {
     ...
     * 
     */
    public Output<Optional<List<CollectionTag>>> tags() {
    ...
    private Collection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Collection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
