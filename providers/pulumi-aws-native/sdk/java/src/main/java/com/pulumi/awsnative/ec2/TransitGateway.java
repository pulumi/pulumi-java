...
public class TransitGateway extends CustomResource {
    ...
    private TransitGateway(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TransitGateway get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
