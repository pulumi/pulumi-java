...
public class ReportPlan extends CustomResource {
     ...
     */
    public ReportPlan(String name, ReportPlanArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:backup:ReportPlan", name, args == null ? ReportPlanArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ReportPlan(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReportPlan get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
