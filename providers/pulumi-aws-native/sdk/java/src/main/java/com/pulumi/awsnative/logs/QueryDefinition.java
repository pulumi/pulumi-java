...
public class QueryDefinition extends CustomResource {
    /**
     ...
     */
    public QueryDefinition(String name, QueryDefinitionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private QueryDefinition(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static QueryDefinition get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
