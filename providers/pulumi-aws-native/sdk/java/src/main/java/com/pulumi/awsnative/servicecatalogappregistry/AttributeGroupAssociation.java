...
public class AttributeGroupAssociation extends CustomResource {
    /**
     ...
     */
    public AttributeGroupAssociation(String name, AttributeGroupAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AttributeGroupAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AttributeGroupAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
