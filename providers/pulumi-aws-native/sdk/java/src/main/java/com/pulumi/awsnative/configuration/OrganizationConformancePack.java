...
public class OrganizationConformancePack extends CustomResource {
    ...
    private OrganizationConformancePack(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OrganizationConformancePack get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
