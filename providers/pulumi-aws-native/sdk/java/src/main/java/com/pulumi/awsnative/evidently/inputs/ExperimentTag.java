 ...
 * 
 */
public final class ExperimentTag extends com.pulumi.resources.InvokeArgs {
    ...
    private ExperimentTag(ExperimentTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder(ExperimentTag defaults) {
            $ = new ExperimentTag(Objects.requireNonNull(defaults));
        }
