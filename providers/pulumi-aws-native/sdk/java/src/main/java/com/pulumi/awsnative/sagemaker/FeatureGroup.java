...
public class FeatureGroup extends CustomResource {
    ...
    private FeatureGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FeatureGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
