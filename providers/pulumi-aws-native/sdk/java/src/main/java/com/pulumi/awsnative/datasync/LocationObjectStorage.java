...
public class LocationObjectStorage extends CustomResource {
     ...
     */
    public LocationObjectStorage(String name, LocationObjectStorageArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LocationObjectStorage(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LocationObjectStorage get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
