...
public final class DetectorEntityTypeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DetectorEntityTypeArgs(DetectorEntityTypeArgs $) {
        this.arn = $.arn;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DetectorEntityTypeArgs();
        }

        public Builder(DetectorEntityTypeArgs defaults) {
            $ = new DetectorEntityTypeArgs(Objects.requireNonNull(defaults));
        }
