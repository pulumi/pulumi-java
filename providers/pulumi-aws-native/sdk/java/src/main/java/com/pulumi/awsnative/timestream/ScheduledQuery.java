...
public class ScheduledQuery extends CustomResource {
     ...
     */
    public ScheduledQuery(String name, ScheduledQueryArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ScheduledQuery(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ScheduledQuery get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
