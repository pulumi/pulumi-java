...
public class DetectorModel extends CustomResource {
     ...
     */
    public DetectorModel(String name, DetectorModelArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DetectorModel(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DetectorModel get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
