 ...
 * 
 */
public final class LoadBalancerTag extends com.pulumi.resources.InvokeArgs {
    ...
    private LoadBalancerTag(LoadBalancerTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder(LoadBalancerTag defaults) {
            $ = new LoadBalancerTag(Objects.requireNonNull(defaults));
        }
