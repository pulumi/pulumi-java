...
public class ModelExplainabilityJobDefinition extends CustomResource {
    /**
     ...
     */
    public ModelExplainabilityJobDefinition(String name, ModelExplainabilityJobDefinitionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ModelExplainabilityJobDefinition(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ModelExplainabilityJobDefinition get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
