...
public class TypeActivation extends CustomResource {
    /**
     ...
     */
    public TypeActivation(String name, @Nullable TypeActivationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TypeActivation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TypeActivation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
