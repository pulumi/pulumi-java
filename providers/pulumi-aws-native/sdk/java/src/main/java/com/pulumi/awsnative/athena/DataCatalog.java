...
public class DataCatalog extends CustomResource {
    /**
     ...
     */
    public DataCatalog(String name, DataCatalogArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:athena:DataCatalog", name, args == null ? DataCatalogArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DataCatalog(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DataCatalog get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
