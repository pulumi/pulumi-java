...
public class ReplicationConfiguration extends CustomResource {
     ...
     */
    public ReplicationConfiguration(String name, ReplicationConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReplicationConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReplicationConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
