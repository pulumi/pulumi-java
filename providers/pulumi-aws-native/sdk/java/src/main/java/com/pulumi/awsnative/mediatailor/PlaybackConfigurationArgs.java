...
import com.pulumi.awsnative.mediatailor.inputs.PlaybackConfigurationDashConfigurationForPutArgs;
...
public final class PlaybackConfigurationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<PlaybackConfigurationDashConfigurationForPutArgs> dashConfiguration;

    /**
     * @return The configuration for DASH content.
     * 
     */
    public Optional<Output<PlaybackConfigurationDashConfigurationForPutArgs>> dashConfiguration() {
     ...
     * 
     */
    @Import(name="sessionInitializationEndpointPrefix")
    private @Nullable Output<String> sessionInitializationEndpointPrefix;

    /**
     * @return The URL that the player uses to initialize a session that uses client-side reporting.
     * 
     */
    public Optional<Output<String>> sessionInitializationEndpointPrefix() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder dashConfiguration(@Nullable Output<PlaybackConfigurationDashConfigurationForPutArgs> dashConfiguration) {
         ...
         * 
         */
        public Builder dashConfiguration(PlaybackConfigurationDashConfigurationForPutArgs dashConfiguration) {
        ...
        /**
         * @param sessionInitializationEndpointPrefix The URL that the player uses to initialize a session that uses client-side reporting.
         * 
         * @return builder
         * 
         */
        public Builder sessionInitializationEndpointPrefix(@Nullable Output<String> sessionInitializationEndpointPrefix) {
         ...
         * 
         */
        public Builder sessionInitializationEndpointPrefix(String sessionInitializationEndpointPrefix) {
            return sessionInitializationEndpointPrefix(Output.of(sessionInitializationEndpointPrefix));
        }
