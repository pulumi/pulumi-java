 ...
 * 
 */
public final class AggregationAuthorizationTag extends com.pulumi.resources.InvokeArgs {

    public static final AggregationAuthorizationTag Empty = new AggregationAuthorizationTag();
    ...
    private AggregationAuthorizationTag() {}

    private AggregationAuthorizationTag(AggregationAuthorizationTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static Builder builder(AggregationAuthorizationTag defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AggregationAuthorizationTag();
        }

        public Builder(AggregationAuthorizationTag defaults) {
            $ = new AggregationAuthorizationTag(Objects.requireNonNull(defaults));
        }
