...
public class TransitGatewayVpcAttachment extends CustomResource {
     ...
     */
    public TransitGatewayVpcAttachment(String name, @Nullable TransitGatewayVpcAttachmentArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TransitGatewayVpcAttachment(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TransitGatewayVpcAttachment get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
