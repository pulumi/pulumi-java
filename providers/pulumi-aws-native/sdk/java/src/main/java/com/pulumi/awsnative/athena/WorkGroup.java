...
public class WorkGroup extends CustomResource {
    ...
    private WorkGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WorkGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
