...
public class DeviceFleet extends CustomResource {
    ...
    private DeviceFleet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DeviceFleet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
