...
public final class RouteTableTagArgs extends ResourceArgs {
    ...
    private RouteTableTagArgs(RouteTableTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RouteTableTagArgs();
        }

        public Builder(RouteTableTagArgs defaults) {
            $ = new RouteTableTagArgs(Objects.requireNonNull(defaults));
        }
