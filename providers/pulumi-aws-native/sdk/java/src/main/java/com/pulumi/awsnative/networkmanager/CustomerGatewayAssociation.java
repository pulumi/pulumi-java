...
public class CustomerGatewayAssociation extends CustomResource {
    /**
     ...
     */
    public CustomerGatewayAssociation(String name, CustomerGatewayAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CustomerGatewayAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomerGatewayAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
