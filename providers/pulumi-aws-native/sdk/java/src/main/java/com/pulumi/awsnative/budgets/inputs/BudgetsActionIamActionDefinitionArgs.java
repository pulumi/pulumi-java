...
public final class BudgetsActionIamActionDefinitionArgs extends ResourceArgs {
    ...
    private BudgetsActionIamActionDefinitionArgs(BudgetsActionIamActionDefinitionArgs $) {
        this.groups = $.groups;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetsActionIamActionDefinitionArgs();
        }

        public Builder(BudgetsActionIamActionDefinitionArgs defaults) {
            $ = new BudgetsActionIamActionDefinitionArgs(Objects.requireNonNull(defaults));
        }
