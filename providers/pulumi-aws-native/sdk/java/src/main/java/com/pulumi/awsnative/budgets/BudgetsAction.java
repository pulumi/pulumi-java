...
public class BudgetsAction extends CustomResource {
     ...
     */
    public BudgetsAction(String name, BudgetsActionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BudgetsAction(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BudgetsAction get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
