...
public class Distribution extends CustomResource {
    ...
    private Distribution(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Distribution get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
