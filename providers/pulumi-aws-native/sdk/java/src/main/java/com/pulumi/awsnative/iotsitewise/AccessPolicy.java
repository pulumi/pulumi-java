...
public class AccessPolicy extends CustomResource {
    /**
     ...
     */
    public AccessPolicy(String name, AccessPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AccessPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AccessPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
