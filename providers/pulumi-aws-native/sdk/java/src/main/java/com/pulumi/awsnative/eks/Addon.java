...
public class Addon extends CustomResource {
    ...
    private Addon(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Addon get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
