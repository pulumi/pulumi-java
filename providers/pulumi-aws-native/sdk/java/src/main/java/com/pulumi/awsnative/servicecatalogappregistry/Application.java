...
public class Application extends CustomResource {
     ...
     */
    public Application(String name, @Nullable ApplicationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Application(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Application get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
