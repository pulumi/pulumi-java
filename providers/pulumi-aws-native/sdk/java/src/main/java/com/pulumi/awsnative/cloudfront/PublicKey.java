...
public class PublicKey extends CustomResource {
    ...
    private PublicKey(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PublicKey get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
