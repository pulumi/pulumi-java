...
public class ResolverRuleAssociation extends CustomResource {
    ...
    private ResolverRuleAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResolverRuleAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
