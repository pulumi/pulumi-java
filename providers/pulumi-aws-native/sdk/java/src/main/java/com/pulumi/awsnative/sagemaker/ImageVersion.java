...
public class ImageVersion extends CustomResource {
    ...
    private ImageVersion(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ImageVersion get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
