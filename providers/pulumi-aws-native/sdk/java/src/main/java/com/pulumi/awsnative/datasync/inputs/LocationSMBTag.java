 ...
 * 
 */
public final class LocationSMBTag extends com.pulumi.resources.InvokeArgs {
    ...
    private LocationSMBTag(LocationSMBTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder(LocationSMBTag defaults) {
            $ = new LocationSMBTag(Objects.requireNonNull(defaults));
        }
