...
public class ReadinessCheck extends CustomResource {
    /**
     ...
     */
    public ReadinessCheck(String name, @Nullable ReadinessCheckArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReadinessCheck(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReadinessCheck get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
