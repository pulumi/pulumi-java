...
public class IPAM extends CustomResource {
    /**
     ...
     */
    public IPAM(String name, @Nullable IPAMArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:ec2:IPAM", name, args == null ? IPAMArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private IPAM(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IPAM get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
