...
public class PlaybackConfiguration extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="dashConfiguration", type=PlaybackConfigurationDashConfigurationForPut.class, parameters={})
    private Output</* @Nullable */ PlaybackConfigurationDashConfigurationForPut> dashConfiguration;

    /**
     * @return The configuration for DASH content.
     * 
     */
    public Output<Optional<PlaybackConfigurationDashConfigurationForPut>> dashConfiguration() {
    ...
    private Output</* @Nullable */ String> sessionInitializationEndpointPrefix;

    /**
     * @return The URL that the player uses to initialize a session that uses client-side reporting.
     * 
     */
    public Output<Optional<String>> sessionInitializationEndpointPrefix() {
        return Codegen.optional(this.sessionInitializationEndpointPrefix);
    }
    /**
