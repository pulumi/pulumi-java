...
public class ScheduledAudit extends CustomResource {
    /**
     ...
     */
    public ScheduledAudit(String name, ScheduledAuditArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ScheduledAudit(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ScheduledAudit get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
