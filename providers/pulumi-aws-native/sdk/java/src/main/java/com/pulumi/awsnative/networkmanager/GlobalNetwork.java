...
public class GlobalNetwork extends CustomResource {
    /**
     ...
     */
    public GlobalNetwork(String name, @Nullable GlobalNetworkArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GlobalNetwork(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GlobalNetwork get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
