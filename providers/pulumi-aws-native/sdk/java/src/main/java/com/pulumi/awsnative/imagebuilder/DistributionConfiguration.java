...
public class DistributionConfiguration extends CustomResource {
    ...
    private DistributionConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DistributionConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
