...
public class ServiceProfile extends CustomResource {
    /**
     ...
     */
    public ServiceProfile(String name, @Nullable ServiceProfileArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ServiceProfile(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ServiceProfile get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
