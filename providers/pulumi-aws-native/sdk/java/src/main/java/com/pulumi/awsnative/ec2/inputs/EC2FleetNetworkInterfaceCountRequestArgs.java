...
public final class EC2FleetNetworkInterfaceCountRequestArgs extends ResourceArgs {
    ...
    private EC2FleetNetworkInterfaceCountRequestArgs(EC2FleetNetworkInterfaceCountRequestArgs $) {
        this.max = $.max;
        this.min = $.min;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EC2FleetNetworkInterfaceCountRequestArgs();
        }

        public Builder(EC2FleetNetworkInterfaceCountRequestArgs defaults) {
            $ = new EC2FleetNetworkInterfaceCountRequestArgs(Objects.requireNonNull(defaults));
        }
