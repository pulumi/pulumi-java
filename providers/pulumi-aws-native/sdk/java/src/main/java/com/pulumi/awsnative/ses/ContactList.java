...
public class ContactList extends CustomResource {
    /**
     ...
     */
    public ContactList(String name, @Nullable ContactListArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:ses:ContactList", name, args == null ? ContactListArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ContactList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ContactList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
