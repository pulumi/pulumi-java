...
public class FirewallDomainList extends CustomResource {
    /**
     * Arn
     * 
     */
     ...
     */
    public FirewallDomainList(String name, @Nullable FirewallDomainListArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FirewallDomainList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FirewallDomainList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
