...
public class RecoveryGroup extends CustomResource {
     ...
     */
    public RecoveryGroup(String name, @Nullable RecoveryGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RecoveryGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RecoveryGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
