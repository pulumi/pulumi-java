...
public class ProfilePermission extends CustomResource {
     ...
     */
    public ProfilePermission(String name, ProfilePermissionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ProfilePermission(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ProfilePermission get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
