 ...
 * 
 */
public final class RepositoryAssociationTagArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RepositoryAssociationTagArgs(RepositoryAssociationTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RepositoryAssociationTagArgs();
        }

        public Builder(RepositoryAssociationTagArgs defaults) {
            $ = new RepositoryAssociationTagArgs(Objects.requireNonNull(defaults));
        }
