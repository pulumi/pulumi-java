...
public final class ListenerRulePathPatternConfigArgs extends ResourceArgs {
    ...
    private ListenerRulePathPatternConfigArgs(ListenerRulePathPatternConfigArgs $) {
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListenerRulePathPatternConfigArgs();
        }

        public Builder(ListenerRulePathPatternConfigArgs defaults) {
            $ = new ListenerRulePathPatternConfigArgs(Objects.requireNonNull(defaults));
        }
