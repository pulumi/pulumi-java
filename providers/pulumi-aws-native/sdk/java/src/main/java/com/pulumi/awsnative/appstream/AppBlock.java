...
public class AppBlock extends CustomResource {
     ...
     */
    public AppBlock(String name, AppBlockArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:appstream:AppBlock", name, args == null ? AppBlockArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private AppBlock(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AppBlock get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
