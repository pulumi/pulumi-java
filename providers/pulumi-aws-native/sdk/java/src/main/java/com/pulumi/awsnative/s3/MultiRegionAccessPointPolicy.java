...
public class MultiRegionAccessPointPolicy extends CustomResource {
    ...
    private MultiRegionAccessPointPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MultiRegionAccessPointPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
