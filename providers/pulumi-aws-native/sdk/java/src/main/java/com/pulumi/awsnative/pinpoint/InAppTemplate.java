...
public class InAppTemplate extends CustomResource {
     ...
     */
    public InAppTemplate(String name, InAppTemplateArgs args, @Nullable CustomResourceOptions options) {
    ...
    private InAppTemplate(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static InAppTemplate get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
