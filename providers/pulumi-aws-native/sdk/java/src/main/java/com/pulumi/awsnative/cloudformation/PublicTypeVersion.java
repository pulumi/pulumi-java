...
public class PublicTypeVersion extends CustomResource {
    /**
     ...
     */
    public PublicTypeVersion(String name, @Nullable PublicTypeVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PublicTypeVersion(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PublicTypeVersion get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
