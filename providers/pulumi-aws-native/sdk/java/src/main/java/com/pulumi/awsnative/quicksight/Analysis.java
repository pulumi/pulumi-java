...
public class Analysis extends CustomResource {
     ...
     */
    public Analysis(String name, AnalysisArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:quicksight:Analysis", name, args == null ? AnalysisArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Analysis(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Analysis get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
