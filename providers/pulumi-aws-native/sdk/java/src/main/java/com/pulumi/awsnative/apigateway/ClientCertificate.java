...
public class ClientCertificate extends CustomResource {
    ...
    private ClientCertificate(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ClientCertificate get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
