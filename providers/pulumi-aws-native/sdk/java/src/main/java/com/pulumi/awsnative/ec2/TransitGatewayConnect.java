...
public class TransitGatewayConnect extends CustomResource {
    /**
     * The creation time.
     * 
     */
     ...
     */
    public TransitGatewayConnect(String name, TransitGatewayConnectArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TransitGatewayConnect(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TransitGatewayConnect get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
