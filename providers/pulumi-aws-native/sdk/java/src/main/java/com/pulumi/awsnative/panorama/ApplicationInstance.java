...
public class ApplicationInstance extends CustomResource {
     ...
     */
    public ApplicationInstance(String name, ApplicationInstanceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ApplicationInstance(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApplicationInstance get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
