...
public class SecurityProfile extends CustomResource {
    /**
     ...
     */
    public SecurityProfile(String name, @Nullable SecurityProfileArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SecurityProfile(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SecurityProfile get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
