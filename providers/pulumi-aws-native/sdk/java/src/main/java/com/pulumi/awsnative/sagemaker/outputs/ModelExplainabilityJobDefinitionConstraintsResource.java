...
public final class ModelExplainabilityJobDefinitionConstraintsResource {
    ...
    */
    ...
    public static Builder builder(ModelExplainabilityJobDefinitionConstraintsResource defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ModelExplainabilityJobDefinitionConstraintsResource defaults) {
