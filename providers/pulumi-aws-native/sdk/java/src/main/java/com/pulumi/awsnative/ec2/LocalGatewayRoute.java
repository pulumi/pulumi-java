...
public class LocalGatewayRoute extends CustomResource {
    ...
    private LocalGatewayRoute(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LocalGatewayRoute get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
