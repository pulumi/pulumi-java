...
public class ResourceSpecificLogging extends CustomResource {
    /**
     ...
     */
    public ResourceSpecificLogging(String name, ResourceSpecificLoggingArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResourceSpecificLogging(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResourceSpecificLogging get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
