...
public class VirtualCluster extends CustomResource {
     ...
     */
    public VirtualCluster(String name, VirtualClusterArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualCluster(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualCluster get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
