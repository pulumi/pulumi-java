...
public class ResponsePlan extends CustomResource {
    /**
     * The list of actions.
     * 
     */
     ...
     */
    public ResponsePlan(String name, ResponsePlanArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResponsePlan(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResponsePlan get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
