...
public class PrefixList extends CustomResource {
    /**
     ...
     */
    public PrefixList(String name, PrefixListArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:ec2:PrefixList", name, args == null ? PrefixListArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private PrefixList(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PrefixList get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
