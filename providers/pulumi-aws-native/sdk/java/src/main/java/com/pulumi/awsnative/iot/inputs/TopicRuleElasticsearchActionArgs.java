...
public final class TopicRuleElasticsearchActionArgs extends ResourceArgs {
    ...
    private TopicRuleElasticsearchActionArgs(TopicRuleElasticsearchActionArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TopicRuleElasticsearchActionArgs();
        }

        public Builder(TopicRuleElasticsearchActionArgs defaults) {
            $ = new TopicRuleElasticsearchActionArgs(Objects.requireNonNull(defaults));
        }
