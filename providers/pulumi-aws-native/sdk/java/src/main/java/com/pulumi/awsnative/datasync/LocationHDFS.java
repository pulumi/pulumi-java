...
public class LocationHDFS extends CustomResource {
    ...
    private LocationHDFS(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LocationHDFS get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
