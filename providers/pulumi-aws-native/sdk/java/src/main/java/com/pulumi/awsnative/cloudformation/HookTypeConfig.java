...
public class HookTypeConfig extends CustomResource {
    /**
     ...
     */
    public HookTypeConfig(String name, @Nullable HookTypeConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HookTypeConfig(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HookTypeConfig get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
