...
public final class DataSourceSalesforceStandardKnowledgeArticleTypeConfigurationArgs extends ResourceArgs {
    ...
    private DataSourceSalesforceStandardKnowledgeArticleTypeConfigurationArgs(DataSourceSalesforceStandardKnowledgeArticleTypeConfigurationArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataSourceSalesforceStandardKnowledgeArticleTypeConfigurationArgs();
        }

        public Builder(DataSourceSalesforceStandardKnowledgeArticleTypeConfigurationArgs defaults) {
            $ = new DataSourceSalesforceStandardKnowledgeArticleTypeConfigurationArgs(Objects.requireNonNull(defaults));
        }
