...
public class GlobalReplicationGroup extends CustomResource {
    ...
    private GlobalReplicationGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GlobalReplicationGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
