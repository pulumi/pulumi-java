...
public class MetricStream extends CustomResource {
    ...
    private MetricStream(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MetricStream get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
