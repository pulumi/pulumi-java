...
public class WarmPool extends CustomResource {
     ...
     */
    public WarmPool(String name, WarmPoolArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:autoscaling:WarmPool", name, args == null ? WarmPoolArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private WarmPool(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WarmPool get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
