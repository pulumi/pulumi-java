...
public class Publisher extends CustomResource {
    /**
     ...
     */
    public Publisher(String name, PublisherArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Publisher(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Publisher get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
