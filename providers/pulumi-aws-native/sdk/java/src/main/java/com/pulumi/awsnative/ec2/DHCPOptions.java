...
public class DHCPOptions extends CustomResource {
     ...
     */
    public DHCPOptions(String name, @Nullable DHCPOptionsArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:ec2:DHCPOptions", name, args == null ? DHCPOptionsArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DHCPOptions(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DHCPOptions get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
