...
public class MitigationAction extends CustomResource {
    /**
     ...
     */
    public MitigationAction(String name, MitigationActionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MitigationAction(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MitigationAction get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
