...
public class ApiKey extends CustomResource {
    ...
    private ApiKey(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ApiKey get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
