...
public class ConformancePack extends CustomResource {
     ...
     */
    public ConformancePack(String name, @Nullable ConformancePackArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ConformancePack(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ConformancePack get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
