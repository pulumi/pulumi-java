...
public class DomainConfiguration extends CustomResource {
     ...
     */
    public DomainConfiguration(String name, @Nullable DomainConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DomainConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DomainConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
