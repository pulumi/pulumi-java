...
public class CapacityProvider extends CustomResource {
    ...
    private CapacityProvider(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CapacityProvider get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
