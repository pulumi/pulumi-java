...
public final class TopicRuleStepFunctionsActionArgs extends ResourceArgs {
    ...
    private TopicRuleStepFunctionsActionArgs(TopicRuleStepFunctionsActionArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TopicRuleStepFunctionsActionArgs();
        }

        public Builder(TopicRuleStepFunctionsActionArgs defaults) {
            $ = new TopicRuleStepFunctionsActionArgs(Objects.requireNonNull(defaults));
        }
