...
public class AccessPoint extends CustomResource {
    ...
    private AccessPoint(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AccessPoint get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
