...
public class TopicRule extends CustomResource {
     ...
     */
    public TopicRule(String name, TopicRuleArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:iot:TopicRule", name, args == null ? TopicRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TopicRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TopicRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
