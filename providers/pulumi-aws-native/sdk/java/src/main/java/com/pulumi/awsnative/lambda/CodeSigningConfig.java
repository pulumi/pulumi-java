...
public class CodeSigningConfig extends CustomResource {
    /**
     ...
     */
    public CodeSigningConfig(String name, CodeSigningConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CodeSigningConfig(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CodeSigningConfig get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
