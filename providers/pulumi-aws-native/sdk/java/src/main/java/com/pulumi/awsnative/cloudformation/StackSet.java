...
public class StackSet extends CustomResource {
     ...
     */
    public StackSet(String name, StackSetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StackSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StackSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
