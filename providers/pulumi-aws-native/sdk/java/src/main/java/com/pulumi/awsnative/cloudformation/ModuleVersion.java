...
public class ModuleVersion extends CustomResource {
    /**
     ...
     */
    public ModuleVersion(String name, ModuleVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ModuleVersion(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ModuleVersion get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
