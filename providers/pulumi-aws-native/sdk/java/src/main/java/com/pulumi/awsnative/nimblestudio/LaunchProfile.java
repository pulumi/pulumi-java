...
public class LaunchProfile extends CustomResource {
    /**
     * &lt;p&gt;The description.&lt;/p&gt;
     * 
     */
     ...
     */
    public LaunchProfile(String name, LaunchProfileArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LaunchProfile(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LaunchProfile get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
