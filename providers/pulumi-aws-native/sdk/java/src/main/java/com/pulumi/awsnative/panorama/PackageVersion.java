...
public class PackageVersion extends CustomResource {
     ...
     */
    public PackageVersion(String name, PackageVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PackageVersion(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PackageVersion get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
