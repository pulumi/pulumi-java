...
public class StateMachine extends CustomResource {
    ...
    private StateMachine(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StateMachine get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
