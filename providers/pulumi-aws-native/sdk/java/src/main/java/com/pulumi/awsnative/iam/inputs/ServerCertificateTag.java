 ...
 * 
 */
public final class ServerCertificateTag extends com.pulumi.resources.InvokeArgs {

    public static final ServerCertificateTag Empty = new ServerCertificateTag();
    ...
    private ServerCertificateTag() {}

    private ServerCertificateTag(ServerCertificateTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static Builder builder(ServerCertificateTag defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServerCertificateTag();
        }

        public Builder(ServerCertificateTag defaults) {
            $ = new ServerCertificateTag(Objects.requireNonNull(defaults));
        }
