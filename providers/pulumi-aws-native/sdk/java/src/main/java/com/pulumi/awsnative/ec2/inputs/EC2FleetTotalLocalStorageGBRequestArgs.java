...
public final class EC2FleetTotalLocalStorageGBRequestArgs extends ResourceArgs {
    ...
    private EC2FleetTotalLocalStorageGBRequestArgs(EC2FleetTotalLocalStorageGBRequestArgs $) {
        this.max = $.max;
        this.min = $.min;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EC2FleetTotalLocalStorageGBRequestArgs();
        }

        public Builder(EC2FleetTotalLocalStorageGBRequestArgs defaults) {
            $ = new EC2FleetTotalLocalStorageGBRequestArgs(Objects.requireNonNull(defaults));
        }
