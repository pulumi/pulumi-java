...
public class TransitGatewayRegistration extends CustomResource {
     ...
     */
    public TransitGatewayRegistration(String name, TransitGatewayRegistrationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TransitGatewayRegistration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TransitGatewayRegistration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
