...
public class CustomDataIdentifier extends CustomResource {
     ...
     */
    public CustomDataIdentifier(String name, CustomDataIdentifierArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CustomDataIdentifier(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CustomDataIdentifier get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
