...
public class RepositoryAssociation extends CustomResource {
     ...
     */
    public RepositoryAssociation(String name, RepositoryAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RepositoryAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RepositoryAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
