...
public class ModelPackageGroup extends CustomResource {
    /**
     ...
     */
    public ModelPackageGroup(String name, @Nullable ModelPackageGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ModelPackageGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ModelPackageGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
