...
public class LinkAssociation extends CustomResource {
     ...
     */
    public LinkAssociation(String name, LinkAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LinkAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LinkAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
