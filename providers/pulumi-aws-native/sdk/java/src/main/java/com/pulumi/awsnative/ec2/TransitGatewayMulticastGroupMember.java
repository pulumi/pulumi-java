...
import com.pulumi.awsnative.ec2.TransitGatewayMulticastGroupMemberArgs;
...
public class TransitGatewayMulticastGroupMember extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public TransitGatewayMulticastGroupMember(String name, TransitGatewayMulticastGroupMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private TransitGatewayMulticastGroupMember(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static TransitGatewayMulticastGroupMember get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
