...
public class TransitGatewayMulticastGroupMember extends CustomResource {
    /**
     ...
     */
    public TransitGatewayMulticastGroupMember(String name, TransitGatewayMulticastGroupMemberArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TransitGatewayMulticastGroupMember(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TransitGatewayMulticastGroupMember get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
