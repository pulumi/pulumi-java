...
public class LoggingConfiguration extends CustomResource {
     ...
     */
    public LoggingConfiguration(String name, LoggingConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LoggingConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LoggingConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
