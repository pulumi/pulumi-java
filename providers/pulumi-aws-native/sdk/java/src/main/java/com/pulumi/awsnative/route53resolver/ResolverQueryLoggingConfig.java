...
public class ResolverQueryLoggingConfig extends CustomResource {
    /**
     * Arn
     * 
     */
     ...
     */
    public ResolverQueryLoggingConfig(String name, @Nullable ResolverQueryLoggingConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResolverQueryLoggingConfig(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResolverQueryLoggingConfig get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
