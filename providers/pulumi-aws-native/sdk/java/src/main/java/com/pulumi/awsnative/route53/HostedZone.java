...
public class HostedZone extends CustomResource {
     ...
     */
    public HostedZone(String name, @Nullable HostedZoneArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:route53:HostedZone", name, args == null ? HostedZoneArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private HostedZone(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HostedZone get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
