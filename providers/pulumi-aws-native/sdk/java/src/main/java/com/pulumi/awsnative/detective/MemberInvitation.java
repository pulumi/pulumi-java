...
public class MemberInvitation extends CustomResource {
    /**
     ...
     */
    public MemberInvitation(String name, MemberInvitationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MemberInvitation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MemberInvitation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
