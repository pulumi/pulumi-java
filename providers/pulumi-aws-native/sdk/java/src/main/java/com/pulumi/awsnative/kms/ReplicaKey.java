...
public class ReplicaKey extends CustomResource {
    ...
    private ReplicaKey(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReplicaKey get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
