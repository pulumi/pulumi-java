...
public final class DBProxyTagFormatArgs extends ResourceArgs {
    ...
    private DBProxyTagFormatArgs(DBProxyTagFormatArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DBProxyTagFormatArgs();
        }

        public Builder(DBProxyTagFormatArgs defaults) {
            $ = new DBProxyTagFormatArgs(Objects.requireNonNull(defaults));
        }
