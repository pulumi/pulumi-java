 ...
 * 
 */
public final class MonitoringScheduleTag extends com.pulumi.resources.InvokeArgs {
    ...
    private MonitoringScheduleTag(MonitoringScheduleTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MonitoringScheduleTag();
        }

        public Builder(MonitoringScheduleTag defaults) {
            $ = new MonitoringScheduleTag(Objects.requireNonNull(defaults));
        }
