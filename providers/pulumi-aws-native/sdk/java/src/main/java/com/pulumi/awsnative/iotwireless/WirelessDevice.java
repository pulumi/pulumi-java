...
public class WirelessDevice extends CustomResource {
    /**
     ...
     */
    public WirelessDevice(String name, WirelessDeviceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WirelessDevice(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WirelessDevice get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
