...
public class DomainNameApiAssociation extends CustomResource {
    ...
    private DomainNameApiAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DomainNameApiAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
