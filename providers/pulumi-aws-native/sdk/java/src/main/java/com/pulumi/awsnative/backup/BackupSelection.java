...
public class BackupSelection extends CustomResource {
     ...
     */
    public BackupSelection(String name, BackupSelectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private BackupSelection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BackupSelection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
