...
public class UsagePlan extends CustomResource {
    ...
    private UsagePlan(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UsagePlan get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
