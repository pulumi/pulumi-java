...
public class ModuleDefaultVersion extends CustomResource {
    /**
     ...
     */
    public ModuleDefaultVersion(String name, @Nullable ModuleDefaultVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ModuleDefaultVersion(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ModuleDefaultVersion get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
