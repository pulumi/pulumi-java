...
public class FlowEntitlement extends CustomResource {
    /**
     ...
     */
    public FlowEntitlement(String name, FlowEntitlementArgs args, @Nullable CustomResourceOptions options) {
    ...
    private FlowEntitlement(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FlowEntitlement get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
