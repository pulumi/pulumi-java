...
public class EndpointAccess extends CustomResource {
    /**
     ...
     */
    public EndpointAccess(String name, EndpointAccessArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EndpointAccess(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EndpointAccess get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
