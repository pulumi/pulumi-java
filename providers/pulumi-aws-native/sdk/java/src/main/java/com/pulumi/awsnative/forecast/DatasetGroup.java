...
public class DatasetGroup extends CustomResource {
    /**
     ...
     */
    public DatasetGroup(String name, DatasetGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DatasetGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DatasetGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
