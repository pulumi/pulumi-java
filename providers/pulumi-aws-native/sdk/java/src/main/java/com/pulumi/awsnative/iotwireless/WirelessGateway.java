...
public class WirelessGateway extends CustomResource {
    /**
     ...
     */
    public WirelessGateway(String name, WirelessGatewayArgs args, @Nullable CustomResourceOptions options) {
    ...
    private WirelessGateway(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static WirelessGateway get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
