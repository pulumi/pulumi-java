...
public class LaunchConfiguration extends CustomResource {
    ...
    private LaunchConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LaunchConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
