...
public final class GetDocumentResult {
     ...
     * 
     */
    private final @Nullable List<DocumentAttachmentsSource> attachments;
    /**
     ...
     * 
     */
    private final @Nullable DocumentFormat documentFormat;
    /**
     ...
     * 
     */
    private final @Nullable List<DocumentRequires> requires;
    /**
     ...
     * 
     */
    private final @Nullable DocumentUpdateMethod updateMethod;
    /**
    ...
    private GetDocumentResult(
        @CustomType.Parameter("attachments") @Nullable List<DocumentAttachmentsSource> attachments,
        @CustomType.Parameter("content") @Nullable Object content,
        @CustomType.Parameter("documentFormat") @Nullable DocumentFormat documentFormat,
        @CustomType.Parameter("requires") @Nullable List<DocumentRequires> requires,
        @CustomType.Parameter("tags") @Nullable List<DocumentTag> tags,
        @CustomType.Parameter("targetType") @Nullable String targetType,
        @CustomType.Parameter("updateMethod") @Nullable DocumentUpdateMethod updateMethod,
    ...
    public static final class Builder {
        ...
        public Builder versionName(@Nullable String versionName) {
            ...
            return new GetDocumentResult(attachments, content, documentFormat, requires, tags, targetType, updateMethod, versionName);
        }
    }
}
