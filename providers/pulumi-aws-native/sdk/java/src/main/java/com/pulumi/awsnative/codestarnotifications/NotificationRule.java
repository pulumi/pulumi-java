...
public class NotificationRule extends CustomResource {
     ...
     */
    public NotificationRule(String name, NotificationRuleArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NotificationRule(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NotificationRule get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
