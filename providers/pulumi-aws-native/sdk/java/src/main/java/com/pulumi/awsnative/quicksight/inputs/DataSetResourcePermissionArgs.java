 ...
 * 
 */
public final class DataSetResourcePermissionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DataSetResourcePermissionArgs(DataSetResourcePermissionArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataSetResourcePermissionArgs();
        }

        public Builder(DataSetResourcePermissionArgs defaults) {
            $ = new DataSetResourcePermissionArgs(Objects.requireNonNull(defaults));
        }
