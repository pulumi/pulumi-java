...
public class SpotFleet extends CustomResource {
     ...
     */
    public SpotFleet(String name, SpotFleetArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:ec2:SpotFleet", name, args == null ? SpotFleetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SpotFleet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SpotFleet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
