...
public class LocationFSxWindows extends CustomResource {
    /**
     ...
     */
    public LocationFSxWindows(String name, LocationFSxWindowsArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LocationFSxWindows(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LocationFSxWindows get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
