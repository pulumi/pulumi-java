...
public class LocalGatewayRouteTableVPCAssociation extends CustomResource {
     ...
     */
    public LocalGatewayRouteTableVPCAssociation(String name, LocalGatewayRouteTableVPCAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private LocalGatewayRouteTableVPCAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LocalGatewayRouteTableVPCAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
