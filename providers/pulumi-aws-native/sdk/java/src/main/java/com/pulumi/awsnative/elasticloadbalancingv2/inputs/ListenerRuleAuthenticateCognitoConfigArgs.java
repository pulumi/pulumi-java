...
public final class ListenerRuleAuthenticateCognitoConfigArgs extends ResourceArgs {
    ...
    private ListenerRuleAuthenticateCognitoConfigArgs(ListenerRuleAuthenticateCognitoConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListenerRuleAuthenticateCognitoConfigArgs();
        }

        public Builder(ListenerRuleAuthenticateCognitoConfigArgs defaults) {
            $ = new ListenerRuleAuthenticateCognitoConfigArgs(Objects.requireNonNull(defaults));
        }
