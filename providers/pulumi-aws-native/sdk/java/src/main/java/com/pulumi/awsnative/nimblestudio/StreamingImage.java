...
public class StreamingImage extends CustomResource {
    /**
     ...
     */
    public StreamingImage(String name, StreamingImageArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StreamingImage(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StreamingImage get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
