...
public class Connection extends CustomResource {
     ...
     */
    public Connection(String name, @Nullable ConnectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private Connection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Connection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
