...
public class TopicRuleDestination extends CustomResource {
    /**
     ...
     */
    public TopicRuleDestination(String name, @Nullable TopicRuleDestinationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TopicRuleDestination(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TopicRuleDestination get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
