...
public final class ConnectionAliasTagArgs extends ResourceArgs {
    ...
    private ConnectionAliasTagArgs(ConnectionAliasTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectionAliasTagArgs();
        }

        public Builder(ConnectionAliasTagArgs defaults) {
            $ = new ConnectionAliasTagArgs(Objects.requireNonNull(defaults));
        }
