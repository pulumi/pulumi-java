...
public class Asset extends CustomResource {
    /**
     ...
     */
    public Asset(String name, AssetArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:mediapackage:Asset", name, args == null ? AssetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Asset(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Asset get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
