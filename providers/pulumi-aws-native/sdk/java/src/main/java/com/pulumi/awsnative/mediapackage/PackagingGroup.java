...
public class PackagingGroup extends CustomResource {
    /**
     ...
     */
    public PackagingGroup(String name, @Nullable PackagingGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private PackagingGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static PackagingGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
