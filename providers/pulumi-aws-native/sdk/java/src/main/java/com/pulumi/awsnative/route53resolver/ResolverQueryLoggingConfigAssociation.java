...
public class ResolverQueryLoggingConfigAssociation extends CustomResource {
    /**
     * Rfc3339TimeString
     * 
     */
     ...
     */
    public ResolverQueryLoggingConfigAssociation(String name, @Nullable ResolverQueryLoggingConfigAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResolverQueryLoggingConfigAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResolverQueryLoggingConfigAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
