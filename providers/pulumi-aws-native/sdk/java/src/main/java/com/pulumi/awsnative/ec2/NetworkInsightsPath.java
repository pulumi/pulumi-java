...
public class NetworkInsightsPath extends CustomResource {
     ...
     */
    public NetworkInsightsPath(String name, NetworkInsightsPathArgs args, @Nullable CustomResourceOptions options) {
    ...
    private NetworkInsightsPath(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NetworkInsightsPath get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
