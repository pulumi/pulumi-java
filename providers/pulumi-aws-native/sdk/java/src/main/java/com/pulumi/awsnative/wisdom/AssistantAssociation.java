...
public class AssistantAssociation extends CustomResource {
     ...
     */
    public AssistantAssociation(String name, AssistantAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AssistantAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AssistantAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
