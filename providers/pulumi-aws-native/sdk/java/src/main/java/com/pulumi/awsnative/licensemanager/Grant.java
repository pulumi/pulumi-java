...
public class Grant extends CustomResource {
     ...
     */
    public Grant(String name, @Nullable GrantArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:licensemanager:Grant", name, args == null ? GrantArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Grant(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Grant get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
