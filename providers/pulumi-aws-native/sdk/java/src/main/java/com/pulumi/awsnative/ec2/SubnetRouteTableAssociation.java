...
public class SubnetRouteTableAssociation extends CustomResource {
     ...
     */
    public SubnetRouteTableAssociation(String name, SubnetRouteTableAssociationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SubnetRouteTableAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SubnetRouteTableAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
