...
public final class TopicRuleCloudwatchAlarmActionArgs extends ResourceArgs {
    ...
    private TopicRuleCloudwatchAlarmActionArgs(TopicRuleCloudwatchAlarmActionArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TopicRuleCloudwatchAlarmActionArgs();
        }

        public Builder(TopicRuleCloudwatchAlarmActionArgs defaults) {
            $ = new TopicRuleCloudwatchAlarmActionArgs(Objects.requireNonNull(defaults));
        }
