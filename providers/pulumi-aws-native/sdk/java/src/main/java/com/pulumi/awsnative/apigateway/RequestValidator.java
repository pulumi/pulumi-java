...
public class RequestValidator extends CustomResource {
     ...
     */
    public RequestValidator(String name, RequestValidatorArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RequestValidator(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RequestValidator get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
