...
public class MulticastGroup extends CustomResource {
    /**
     ...
     */
    public MulticastGroup(String name, MulticastGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private MulticastGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MulticastGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
