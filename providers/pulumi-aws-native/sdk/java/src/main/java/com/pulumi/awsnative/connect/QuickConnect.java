...
public class QuickConnect extends CustomResource {
     ...
     */
    public QuickConnect(String name, QuickConnectArgs args, @Nullable CustomResourceOptions options) {
    ...
    private QuickConnect(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static QuickConnect get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
