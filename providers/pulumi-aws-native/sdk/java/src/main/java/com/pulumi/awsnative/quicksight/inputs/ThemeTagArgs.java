 ...
 * 
 */
public final class ThemeTagArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ThemeTagArgs(ThemeTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder(ThemeTagArgs defaults) {
            $ = new ThemeTagArgs(Objects.requireNonNull(defaults));
        }
