...
public class CertificateAuthorityActivation extends CustomResource {
    /**
     ...
     */
    public CertificateAuthorityActivation(String name, CertificateAuthorityActivationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CertificateAuthorityActivation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CertificateAuthorityActivation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
