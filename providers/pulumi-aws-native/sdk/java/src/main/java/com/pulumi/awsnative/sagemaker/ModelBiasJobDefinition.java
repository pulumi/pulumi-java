...
public class ModelBiasJobDefinition extends CustomResource {
    /**
     ...
     */
    public ModelBiasJobDefinition(String name, ModelBiasJobDefinitionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ModelBiasJobDefinition(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ModelBiasJobDefinition get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
