...
public class Theme extends CustomResource {
     ...
     */
    public Theme(String name, ThemeArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:quicksight:Theme", name, args == null ? ThemeArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Theme(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Theme get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
