 ...
 * 
 */
public final class FlowEncryption extends com.pulumi.resources.InvokeArgs {
    ...
    private FlowEncryption(FlowEncryption $) {
    ...
    public static final class Builder {
        ...
        public Builder(FlowEncryption defaults) {
            $ = new FlowEncryption(Objects.requireNonNull(defaults));
        }
