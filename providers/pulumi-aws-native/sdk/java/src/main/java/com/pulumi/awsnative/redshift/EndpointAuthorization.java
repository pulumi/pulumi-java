...
public class EndpointAuthorization extends CustomResource {
     ...
     */
    public EndpointAuthorization(String name, EndpointAuthorizationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private EndpointAuthorization(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static EndpointAuthorization get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
