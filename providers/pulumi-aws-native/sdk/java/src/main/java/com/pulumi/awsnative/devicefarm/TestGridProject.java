...
public class TestGridProject extends CustomResource {
    ...
    private TestGridProject(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TestGridProject get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
