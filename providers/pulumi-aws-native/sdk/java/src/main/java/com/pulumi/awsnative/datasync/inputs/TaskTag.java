 ...
 * 
 */
public final class TaskTag extends com.pulumi.resources.InvokeArgs {

    public static final TaskTag Empty = new TaskTag();
    ...
    public static final class Builder {
        ...
        public Builder(TaskTag defaults) {
            $ = new TaskTag(Objects.requireNonNull(defaults));
        }
