...
public class FindingsFilter extends CustomResource {
    ...
    private FindingsFilter(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static FindingsFilter get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
