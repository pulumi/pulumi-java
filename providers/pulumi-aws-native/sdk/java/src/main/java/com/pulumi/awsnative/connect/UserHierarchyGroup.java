...
public class UserHierarchyGroup extends CustomResource {
    /**
     ...
     */
    public UserHierarchyGroup(String name, UserHierarchyGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private UserHierarchyGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static UserHierarchyGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
