...
public class SubnetGroup extends CustomResource {
    ...
    private SubnetGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SubnetGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
