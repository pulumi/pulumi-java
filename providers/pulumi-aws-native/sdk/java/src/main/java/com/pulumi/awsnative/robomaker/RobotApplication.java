...
public class RobotApplication extends CustomResource {
     ...
     */
    public RobotApplication(String name, RobotApplicationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private RobotApplication(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RobotApplication get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
