...
public class BasePathMapping extends CustomResource {
    ...
    private BasePathMapping(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BasePathMapping get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
