...
public class CloudFormationProvisionedProduct extends CustomResource {
     ...
     */
    public CloudFormationProvisionedProduct(String name, @Nullable CloudFormationProvisionedProductArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CloudFormationProvisionedProduct(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CloudFormationProvisionedProduct get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
