...
public final class OriginRequestPolicyQueryStringsConfig extends com.pulumi.resources.InvokeArgs {
    ...
    private OriginRequestPolicyQueryStringsConfig(OriginRequestPolicyQueryStringsConfig $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OriginRequestPolicyQueryStringsConfig();
        }

        public Builder(OriginRequestPolicyQueryStringsConfig defaults) {
            $ = new OriginRequestPolicyQueryStringsConfig(Objects.requireNonNull(defaults));
        }
