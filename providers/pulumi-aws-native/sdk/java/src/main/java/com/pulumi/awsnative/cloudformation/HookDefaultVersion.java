...
public class HookDefaultVersion extends CustomResource {
    /**
     ...
     */
    public HookDefaultVersion(String name, @Nullable HookDefaultVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private HookDefaultVersion(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static HookDefaultVersion get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
