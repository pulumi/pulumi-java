...
public class TransitGatewayMulticastDomain extends CustomResource {
    /**
     ...
     */
    public TransitGatewayMulticastDomain(String name, TransitGatewayMulticastDomainArgs args, @Nullable CustomResourceOptions options) {
    ...
    private TransitGatewayMulticastDomain(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static TransitGatewayMulticastDomain get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
