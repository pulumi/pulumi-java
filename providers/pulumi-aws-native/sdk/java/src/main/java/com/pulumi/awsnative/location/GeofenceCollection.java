...
public class GeofenceCollection extends CustomResource {
     ...
     */
    public GeofenceCollection(String name, GeofenceCollectionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GeofenceCollection(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GeofenceCollection get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
