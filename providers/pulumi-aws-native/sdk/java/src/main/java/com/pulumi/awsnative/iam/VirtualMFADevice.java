...
public class VirtualMFADevice extends CustomResource {
     ...
     */
    public VirtualMFADevice(String name, VirtualMFADeviceArgs args, @Nullable CustomResourceOptions options) {
    ...
    private VirtualMFADevice(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VirtualMFADevice get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
