...
public class GameServerGroup extends CustomResource {
     ...
     */
    public GameServerGroup(String name, GameServerGroupArgs args, @Nullable CustomResourceOptions options) {
    ...
    private GameServerGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GameServerGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
