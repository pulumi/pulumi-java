...
public class NamedQuery extends CustomResource {
    ...
    private NamedQuery(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static NamedQuery get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
