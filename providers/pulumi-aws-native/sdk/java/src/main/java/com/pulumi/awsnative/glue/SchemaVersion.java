...
public class SchemaVersion extends CustomResource {
     ...
     */
    public SchemaVersion(String name, SchemaVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SchemaVersion(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SchemaVersion get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
