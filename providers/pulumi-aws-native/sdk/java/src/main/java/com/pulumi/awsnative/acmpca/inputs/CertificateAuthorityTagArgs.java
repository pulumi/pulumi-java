...
public final class CertificateAuthorityTagArgs extends ResourceArgs {
    ...
    private CertificateAuthorityTagArgs(CertificateAuthorityTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CertificateAuthorityTagArgs();
        }

        public Builder(CertificateAuthorityTagArgs defaults) {
            $ = new CertificateAuthorityTagArgs(Objects.requireNonNull(defaults));
        }
