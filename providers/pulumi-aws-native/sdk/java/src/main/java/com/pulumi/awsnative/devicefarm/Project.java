...
import com.pulumi.awsnative.devicefarm.ProjectArgs;
...
public class Project extends com.pulumi.resources.CustomResource {
    ...
    public Project(String name, @Nullable ProjectArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:devicefarm:Project", name, args == null ? ProjectArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
