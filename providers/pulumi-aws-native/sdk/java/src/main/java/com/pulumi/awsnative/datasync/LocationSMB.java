...
public class LocationSMB extends CustomResource {
    ...
    private LocationSMB(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static LocationSMB get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
