...
public class CompositeAlarm extends CustomResource {
    ...
    private CompositeAlarm(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CompositeAlarm get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
