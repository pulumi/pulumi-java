 ...
 * 
 */
public final class EventSubscriptionTag extends com.pulumi.resources.InvokeArgs {

    public static final EventSubscriptionTag Empty = new EventSubscriptionTag();
    ...
    private EventSubscriptionTag(EventSubscriptionTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EventSubscriptionTag();
        }

        public Builder(EventSubscriptionTag defaults) {
            $ = new EventSubscriptionTag(Objects.requireNonNull(defaults));
        }
