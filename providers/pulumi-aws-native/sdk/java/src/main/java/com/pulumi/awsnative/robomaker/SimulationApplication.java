...
public class SimulationApplication extends CustomResource {
     ...
     */
    public SimulationApplication(String name, SimulationApplicationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private SimulationApplication(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static SimulationApplication get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
