...
public class AccountAuditConfiguration extends CustomResource {
    /**
     ...
     */
    public AccountAuditConfiguration(String name, AccountAuditConfigurationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AccountAuditConfiguration(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AccountAuditConfiguration get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
