...
public class ImagePipeline extends CustomResource {
    /**
     ...
     */
    public ImagePipeline(String name, @Nullable ImagePipelineArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ImagePipeline(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ImagePipeline get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
