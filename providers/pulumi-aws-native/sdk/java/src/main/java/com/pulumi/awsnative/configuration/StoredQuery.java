...
public class StoredQuery extends CustomResource {
     ...
     */
    public StoredQuery(String name, StoredQueryArgs args, @Nullable CustomResourceOptions options) {
    ...
    private StoredQuery(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static StoredQuery get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
