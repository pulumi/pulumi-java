...
public class ResourceSet extends CustomResource {
    ...
    private ResourceSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResourceSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
