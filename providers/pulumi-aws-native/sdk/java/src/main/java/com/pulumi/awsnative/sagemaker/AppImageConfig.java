...
public class AppImageConfig extends CustomResource {
     ...
     */
    public AppImageConfig(String name, @Nullable AppImageConfigArgs args, @Nullable CustomResourceOptions options) {
    ...
    private AppImageConfig(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static AppImageConfig get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
