...
public class ParameterGroup extends CustomResource {
    ...
    private ParameterGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ParameterGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
