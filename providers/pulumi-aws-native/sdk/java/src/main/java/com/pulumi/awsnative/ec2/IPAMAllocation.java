...
public class IPAMAllocation extends CustomResource {
     ...
     */
    public IPAMAllocation(String name, IPAMAllocationArgs args, @Nullable CustomResourceOptions options) {
    ...
    private IPAMAllocation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static IPAMAllocation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
