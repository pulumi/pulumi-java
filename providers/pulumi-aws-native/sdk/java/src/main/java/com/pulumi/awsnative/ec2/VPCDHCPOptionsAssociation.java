...
public class VPCDHCPOptionsAssociation extends CustomResource {
    ...
    private VPCDHCPOptionsAssociation(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static VPCDHCPOptionsAssociation get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
