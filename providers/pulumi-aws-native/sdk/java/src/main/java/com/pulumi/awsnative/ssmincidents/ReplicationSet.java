...
public class ReplicationSet extends CustomResource {
    /**
     ...
     */
    public ReplicationSet(String name, ReplicationSetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ReplicationSet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ReplicationSet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
