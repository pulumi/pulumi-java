...
public final class RegexPatternSetTagArgs extends ResourceArgs {
    ...
    private RegexPatternSetTagArgs(RegexPatternSetTagArgs $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegexPatternSetTagArgs();
        }

        public Builder(RegexPatternSetTagArgs defaults) {
            $ = new RegexPatternSetTagArgs(Objects.requireNonNull(defaults));
        }
