...
public class CachePolicy extends CustomResource {
     ...
     */
    public CachePolicy(String name, CachePolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CachePolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CachePolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
