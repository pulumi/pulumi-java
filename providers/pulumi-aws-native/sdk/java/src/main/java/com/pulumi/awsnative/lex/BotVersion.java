...
public class BotVersion extends CustomResource {
     ...
     */
    public BotVersion(String name, BotVersionArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:lex:BotVersion", name, args == null ? BotVersionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private BotVersion(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static BotVersion get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
