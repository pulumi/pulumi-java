...
public final class NetworkInsightsAccessScopeTag extends com.pulumi.resources.InvokeArgs {
    ...
    private NetworkInsightsAccessScopeTag(NetworkInsightsAccessScopeTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkInsightsAccessScopeTag();
        }

        public Builder(NetworkInsightsAccessScopeTag defaults) {
            $ = new NetworkInsightsAccessScopeTag(Objects.requireNonNull(defaults));
        }
