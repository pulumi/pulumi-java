...
public final class SpotFleetMemoryMiBRequest extends com.pulumi.resources.InvokeArgs {
    ...
    private SpotFleetMemoryMiBRequest(SpotFleetMemoryMiBRequest $) {
        this.max = $.max;
        this.min = $.min;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SpotFleetMemoryMiBRequest();
        }

        public Builder(SpotFleetMemoryMiBRequest defaults) {
            $ = new SpotFleetMemoryMiBRequest(Objects.requireNonNull(defaults));
        }
