...
public class Alarm extends CustomResource {
     ...
     */
    public Alarm(String name, AlarmArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:lightsail:Alarm", name, args == null ? AlarmArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Alarm(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Alarm get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
