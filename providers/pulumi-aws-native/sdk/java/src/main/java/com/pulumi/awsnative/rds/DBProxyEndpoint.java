...
public class DBProxyEndpoint extends CustomResource {
    /**
     ...
     */
    public DBProxyEndpoint(String name, DBProxyEndpointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DBProxyEndpoint(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DBProxyEndpoint get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
