...
public class ScheduledAction extends CustomResource {
     ...
     */
    public ScheduledAction(String name, @Nullable ScheduledActionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ScheduledAction(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ScheduledAction get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
