 ...
 * 
 */
public final class ReplicaKeyTag extends com.pulumi.resources.InvokeArgs {
    ...
    private ReplicaKeyTag(ReplicaKeyTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder(ReplicaKeyTag defaults) {
            $ = new ReplicaKeyTag(Objects.requireNonNull(defaults));
        }
