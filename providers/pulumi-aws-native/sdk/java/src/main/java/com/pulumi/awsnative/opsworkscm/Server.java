...
public class Server extends CustomResource {
     ...
     */
    public Server(String name, ServerArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:opsworkscm:Server", name, args == null ? ServerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Server(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Server get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
