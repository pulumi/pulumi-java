...
public class ResponseHeadersPolicy extends CustomResource {
     ...
     */
    public ResponseHeadersPolicy(String name, ResponseHeadersPolicyArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResponseHeadersPolicy(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResponseHeadersPolicy get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
