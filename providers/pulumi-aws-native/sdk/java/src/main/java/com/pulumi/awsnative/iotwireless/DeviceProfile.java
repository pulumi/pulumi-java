...
public class DeviceProfile extends CustomResource {
    /**
     ...
     */
    public DeviceProfile(String name, @Nullable DeviceProfileArgs args, @Nullable CustomResourceOptions options) {
    ...
    private DeviceProfile(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static DeviceProfile get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
