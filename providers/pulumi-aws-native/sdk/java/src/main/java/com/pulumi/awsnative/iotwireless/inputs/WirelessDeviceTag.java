...
public final class WirelessDeviceTag extends com.pulumi.resources.InvokeArgs {
    ...
    private WirelessDeviceTag(WirelessDeviceTag $) {
        this.key = $.key;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WirelessDeviceTag();
        }

        public Builder(WirelessDeviceTag defaults) {
            $ = new WirelessDeviceTag(Objects.requireNonNull(defaults));
        }
