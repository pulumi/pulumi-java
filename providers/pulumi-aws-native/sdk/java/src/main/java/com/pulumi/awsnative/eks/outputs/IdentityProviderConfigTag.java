...
@CustomType
public final class IdentityProviderConfigTag {
    /**
    ...
    private IdentityProviderConfigTag(
    ...
    public static Builder builder(IdentityProviderConfigTag defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(IdentityProviderConfigTag defaults) {
        ...
        public Builder value(String value) {
            ...
            return this;
        }        public IdentityProviderConfigTag build() {
            return new IdentityProviderConfigTag(key, value);
        }
    }
}
