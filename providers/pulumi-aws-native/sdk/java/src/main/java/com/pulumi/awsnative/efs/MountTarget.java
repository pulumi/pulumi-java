...
public class MountTarget extends CustomResource {
     ...
     */
    public MountTarget(String name, MountTargetArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:efs:MountTarget", name, args == null ? MountTargetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private MountTarget(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static MountTarget get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
