...
public class OriginEndpoint extends CustomResource {
    /**
     ...
     */
    public OriginEndpoint(String name, OriginEndpointArgs args, @Nullable CustomResourceOptions options) {
    ...
    private OriginEndpoint(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static OriginEndpoint get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
