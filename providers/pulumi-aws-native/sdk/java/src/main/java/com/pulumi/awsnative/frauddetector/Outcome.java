...
public class Outcome extends CustomResource {
    /**
     * The outcome ARN.
     * 
     */
     ...
     */
    public Outcome(String name, @Nullable OutcomeArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:frauddetector:Outcome", name, args == null ? OutcomeArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Outcome(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Outcome get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
