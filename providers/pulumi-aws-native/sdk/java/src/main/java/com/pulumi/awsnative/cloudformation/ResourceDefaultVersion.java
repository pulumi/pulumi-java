...
public class ResourceDefaultVersion extends CustomResource {
    /**
     ...
     */
    public ResourceDefaultVersion(String name, @Nullable ResourceDefaultVersionArgs args, @Nullable CustomResourceOptions options) {
    ...
    private ResourceDefaultVersion(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static ResourceDefaultVersion get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
