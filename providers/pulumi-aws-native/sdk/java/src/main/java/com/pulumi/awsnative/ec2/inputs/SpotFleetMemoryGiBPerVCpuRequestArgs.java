...
public final class SpotFleetMemoryGiBPerVCpuRequestArgs extends ResourceArgs {
    ...
    private SpotFleetMemoryGiBPerVCpuRequestArgs(SpotFleetMemoryGiBPerVCpuRequestArgs $) {
        this.max = $.max;
        this.min = $.min;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SpotFleetMemoryGiBPerVCpuRequestArgs();
        }

        public Builder(SpotFleetMemoryGiBPerVCpuRequestArgs defaults) {
            $ = new SpotFleetMemoryGiBPerVCpuRequestArgs(Objects.requireNonNull(defaults));
        }
