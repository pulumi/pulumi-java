...
public class RuleGroup extends CustomResource {
    ...
    private RuleGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static RuleGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
