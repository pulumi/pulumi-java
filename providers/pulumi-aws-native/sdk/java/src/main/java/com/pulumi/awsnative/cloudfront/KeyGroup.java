...
public class KeyGroup extends CustomResource {
     ...
     */
    public KeyGroup(String name, KeyGroupArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:cloudfront:KeyGroup", name, args == null ? KeyGroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private KeyGroup(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static KeyGroup get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
