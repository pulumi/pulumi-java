...
public class CostCategory extends CustomResource {
     ...
     */
    public CostCategory(String name, CostCategoryArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:ce:CostCategory", name, args == null ? CostCategoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private CostCategory(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CostCategory get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
