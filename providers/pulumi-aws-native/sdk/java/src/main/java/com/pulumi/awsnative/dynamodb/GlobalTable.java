...
public class GlobalTable extends CustomResource {
    ...
    private GlobalTable(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static GlobalTable get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
