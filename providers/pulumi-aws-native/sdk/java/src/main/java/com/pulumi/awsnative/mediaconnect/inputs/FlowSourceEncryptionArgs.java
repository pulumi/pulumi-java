...
public final class FlowSourceEncryptionArgs extends ResourceArgs {
     ...
     * 
     */
    public Optional<Output<FlowSourceEncryptionKeyType>> keyType() {
    ...
    private FlowSourceEncryptionArgs(FlowSourceEncryptionArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FlowSourceEncryptionArgs();
        }

        public Builder(FlowSourceEncryptionArgs defaults) {
            $ = new FlowSourceEncryptionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder keyType(FlowSourceEncryptionKeyType keyType) {
