...
public class Canary extends CustomResource {
     ...
     */
    public Canary(String name, CanaryArgs args, @Nullable CustomResourceOptions options) {
        super("aws-native:synthetics:Canary", name, args == null ? CanaryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Canary(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static Canary get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
