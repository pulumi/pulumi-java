...
public final class ConnectorProfileRedshiftConnectorProfileCredentialsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ConnectorProfileRedshiftConnectorProfileCredentialsArgs(ConnectorProfileRedshiftConnectorProfileCredentialsArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectorProfileRedshiftConnectorProfileCredentialsArgs();
        }

        public Builder(ConnectorProfileRedshiftConnectorProfileCredentialsArgs defaults) {
            $ = new ConnectorProfileRedshiftConnectorProfileCredentialsArgs(Objects.requireNonNull(defaults));
        }
