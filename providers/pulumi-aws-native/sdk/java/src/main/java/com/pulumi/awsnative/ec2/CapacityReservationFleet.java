...
public class CapacityReservationFleet extends CustomResource {
     ...
     */
    public CapacityReservationFleet(String name, @Nullable CapacityReservationFleetArgs args, @Nullable CustomResourceOptions options) {
    ...
    private CapacityReservationFleet(String name, Output<String> id, @Nullable CustomResourceOptions options) {
     ...
     */
    public static CapacityReservationFleet get(String name, Output<String> id, @Nullable CustomResourceOptions options) {
