...
public class Environment extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.finspace.EnvironmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.finspace.EnvironmentArgs.builder();
