...
public class Service extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.apprunner.ServiceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.apprunner.ServiceArgs.builder();
