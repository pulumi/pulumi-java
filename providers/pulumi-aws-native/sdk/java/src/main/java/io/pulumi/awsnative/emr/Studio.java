...
public class Studio extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.emr.StudioArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.emr.StudioArgs.builder();
    ...
    public Studio(String name, StudioArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:emr:Studio", name, args == null ? StudioArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private Studio(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Studio get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
