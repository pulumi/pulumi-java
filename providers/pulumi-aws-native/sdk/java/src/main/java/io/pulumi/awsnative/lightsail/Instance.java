...
public class Instance extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.lightsail.InstanceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.lightsail.InstanceArgs.builder();
    ...
    public Instance(String name, InstanceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:lightsail:Instance", name, args == null ? InstanceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
