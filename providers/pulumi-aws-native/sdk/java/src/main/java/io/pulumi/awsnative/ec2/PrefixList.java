...
public class PrefixList extends io.pulumi.resources.CustomResource {
    ...
    public PrefixList(String name) {
        super("aws-native:ec2:PrefixList", name, PrefixListArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public PrefixList(String name, PrefixListArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:ec2:PrefixList", name, args == null ? PrefixListArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private PrefixList(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static PrefixList get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
