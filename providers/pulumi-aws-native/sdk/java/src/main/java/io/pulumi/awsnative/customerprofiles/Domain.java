...
public class Domain extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.customerprofiles.DomainArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.customerprofiles.DomainArgs.builder();
