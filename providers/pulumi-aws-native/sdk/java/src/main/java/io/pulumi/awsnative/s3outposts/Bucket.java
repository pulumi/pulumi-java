...
public class Bucket extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.s3outposts.BucketArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.s3outposts.BucketArgs.builder();
