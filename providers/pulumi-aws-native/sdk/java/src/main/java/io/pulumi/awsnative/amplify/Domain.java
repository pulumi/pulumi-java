...
public class Domain extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.amplify.DomainArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.amplify.DomainArgs.builder();
