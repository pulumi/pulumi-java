...
public class CodeSigningConfig extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.lambda.CodeSigningConfigArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.lambda.CodeSigningConfigArgs.builder();
