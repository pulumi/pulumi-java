...
public class ApplicationInstance extends io.pulumi.resources.CustomResource {
    ...
    public ApplicationInstance(String name) {
        super("aws-native:panorama:ApplicationInstance", name, ApplicationInstanceArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public ApplicationInstance(String name, ApplicationInstanceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:panorama:ApplicationInstance", name, args == null ? ApplicationInstanceArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }

    private ApplicationInstance(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ApplicationInstance get(String name, Input<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
