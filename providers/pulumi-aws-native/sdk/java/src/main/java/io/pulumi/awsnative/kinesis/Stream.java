...
public class Stream extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.kinesis.StreamArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.kinesis.StreamArgs.builder();
