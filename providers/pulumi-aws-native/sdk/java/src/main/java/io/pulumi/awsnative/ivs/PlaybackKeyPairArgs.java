...
public final class PlaybackKeyPairArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setPublicKeyMaterial(Input<String> publicKeyMaterial) {
            this.publicKeyMaterial = Objects.requireNonNull(publicKeyMaterial);
            return this;
        }

        public Builder setPublicKeyMaterial(String publicKeyMaterial) {
            this.publicKeyMaterial = Input.of(Objects.requireNonNull(publicKeyMaterial));
            return this;
        }

        public Builder setTags(@Nullable Input<List<PlaybackKeyPairTagArgs>> tags) {
            this.tags = tags;
            return this;
        }

        public Builder setTags(@Nullable List<PlaybackKeyPairTagArgs> tags) {
