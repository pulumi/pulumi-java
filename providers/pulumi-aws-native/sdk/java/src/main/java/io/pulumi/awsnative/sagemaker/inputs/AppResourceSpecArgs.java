...
public final class AppResourceSpecArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public AppResourceSpecArgs(
        @Nullable Input<AppResourceSpecInstanceType> instanceType,
    ...
    public static final class Builder {
        private @Nullable Input<AppResourceSpecInstanceType> instanceType;
        ...
        public Builder setInstanceType(@Nullable Input<AppResourceSpecInstanceType> instanceType) {
            this.instanceType = instanceType;
            return this;
        }
