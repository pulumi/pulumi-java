...
public class Agent extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.datasync.AgentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.datasync.AgentArgs.builder();
    ...
    public Agent(String name, AgentArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:datasync:Agent", name, args == null ? AgentArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
