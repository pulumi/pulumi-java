...
public class IPSet extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.wafv2.IPSetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.wafv2.IPSetArgs.builder();
     ...
     */
    public static IPSet get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
