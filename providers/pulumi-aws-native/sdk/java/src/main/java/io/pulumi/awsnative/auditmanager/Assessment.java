...
public class Assessment extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable AssessmentArgs.Builder a);
    }
    private static io.pulumi.awsnative.auditmanager.AssessmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.auditmanager.AssessmentArgs.builder();
