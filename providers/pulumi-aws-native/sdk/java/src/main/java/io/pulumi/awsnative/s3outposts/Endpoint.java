...
public class Endpoint extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.s3outposts.EndpointArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.s3outposts.EndpointArgs.builder();
