...
public class Bucket extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.lightsail.BucketArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.lightsail.BucketArgs.builder();
    ...
    public Bucket(String name, BucketArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:lightsail:Bucket", name, args == null ? BucketArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
