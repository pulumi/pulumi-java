...
public class IPAMPool extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(IPAMPoolArgs.Builder a);
    }
    private static io.pulumi.awsnative.ec2.IPAMPoolArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.ec2.IPAMPoolArgs.builder();
     ...
     */
    public IPAMPool(String name, BuilderApplicator argsBuilder) {
