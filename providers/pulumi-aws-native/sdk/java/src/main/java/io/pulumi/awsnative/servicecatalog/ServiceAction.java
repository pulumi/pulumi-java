...
public class ServiceAction extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.servicecatalog.ServiceActionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.servicecatalog.ServiceActionArgs.builder();
