...
public class ResolverRuleAssociation extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.route53resolver.ResolverRuleAssociationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.route53resolver.ResolverRuleAssociationArgs.builder();
