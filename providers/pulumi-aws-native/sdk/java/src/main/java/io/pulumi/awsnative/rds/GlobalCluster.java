...
public class GlobalCluster extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable GlobalClusterArgs.Builder a);
    }
    private static io.pulumi.awsnative.rds.GlobalClusterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.rds.GlobalClusterArgs.builder();
