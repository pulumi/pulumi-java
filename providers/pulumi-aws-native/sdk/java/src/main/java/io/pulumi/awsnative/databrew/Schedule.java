...
public class Schedule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.databrew.ScheduleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.databrew.ScheduleArgs.builder();
