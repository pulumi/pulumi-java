...
public class Framework extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(FrameworkArgs.Builder a);
    }
    private static io.pulumi.awsnative.backup.FrameworkArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.backup.FrameworkArgs.builder();
     ...
     */
    public Framework(String name, BuilderApplicator argsBuilder) {
    ...
    public Framework(String name, FrameworkArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:backup:Framework", name, args == null ? FrameworkArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private Framework(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Framework get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
