...
public class Schema extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.glue.SchemaArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.glue.SchemaArgs.builder();
