...
public final class EntityTypeArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="tags")
      private final @Nullable Input<List<EntityTypeTagArgs>> tags;

    public Input<List<EntityTypeTagArgs>> getTags() {
    ...
    public EntityTypeArgs(
        ...
        @Nullable Input<List<EntityTypeTagArgs>> tags) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<List<EntityTypeTagArgs>> tags;
        ...
        public Builder setTags(@Nullable Input<List<EntityTypeTagArgs>> tags) {
            this.tags = tags;
            return this;
        }

        public Builder setTags(@Nullable List<EntityTypeTagArgs> tags) {
