...
public class Table extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.timestream.TableArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.timestream.TableArgs.builder();
