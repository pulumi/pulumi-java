...
import java.util.StringJoiner;
    ...
    @EnumType
    public enum OriginEndpointDashPackageAdTriggersItem {
        ...
        OriginEndpointDashPackageAdTriggersItem(String value) {
        ...
        public String toString() {
            return new StringJoiner(", ", "OriginEndpointDashPackageAdTriggersItem[", "]")
