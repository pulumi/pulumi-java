...
public class ReadinessCheck extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable ReadinessCheckArgs.Builder a);
    }
    private static io.pulumi.awsnative.route53recoveryreadiness.ReadinessCheckArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.route53recoveryreadiness.ReadinessCheckArgs.builder();
