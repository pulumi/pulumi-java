...
public final class AppsyncFunctions {
     ...
     * 
     */
    public static CompletableFuture<GetDomainNameResult> getDomainName(io.pulumi.awsnative.appsync.inputs.GetDomainNameArgs args) {
        return getDomainName(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetDomainNameResult> getDomainName(io.pulumi.awsnative.appsync.inputs.GetDomainNameArgs args, InvokeOptions options) {
     ...
     * 
     */
    public static CompletableFuture<GetDomainNameApiAssociationResult> getDomainNameApiAssociation(io.pulumi.awsnative.appsync.inputs.GetDomainNameApiAssociationArgs args) {
        return getDomainNameApiAssociation(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetDomainNameApiAssociationResult> getDomainNameApiAssociation(io.pulumi.awsnative.appsync.inputs.GetDomainNameApiAssociationArgs args, InvokeOptions options) {
