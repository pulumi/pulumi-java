...
public class PermissionSet extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.sso.PermissionSetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.sso.PermissionSetArgs.builder();
