...
public class PlaceIndex extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PlaceIndexArgs.Builder a);
    }
    private static io.pulumi.awsnative.location.PlaceIndexArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.location.PlaceIndexArgs.builder();
     ...
     */
    public PlaceIndex(String name, BuilderApplicator argsBuilder) {
