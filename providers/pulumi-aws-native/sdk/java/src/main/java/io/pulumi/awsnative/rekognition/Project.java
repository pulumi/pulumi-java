...
public class Project extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.rekognition.ProjectArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.rekognition.ProjectArgs.builder();
    ...
    public Project(String name, @Nullable ProjectArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:rekognition:Project", name, args == null ? ProjectArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
