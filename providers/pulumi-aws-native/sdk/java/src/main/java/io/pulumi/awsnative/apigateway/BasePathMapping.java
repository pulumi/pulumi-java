...
public class BasePathMapping extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.apigateway.BasePathMappingArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.apigateway.BasePathMappingArgs.builder();
