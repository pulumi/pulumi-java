...
public class OIDCProvider extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(OIDCProviderArgs.Builder a);
    }
    private static io.pulumi.awsnative.iam.OIDCProviderArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.iam.OIDCProviderArgs.builder();
     ...
     */
    public OIDCProvider(String name, BuilderApplicator argsBuilder) {
