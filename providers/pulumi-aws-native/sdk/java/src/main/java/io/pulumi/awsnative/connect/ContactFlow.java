...
public class ContactFlow extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.connect.ContactFlowArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.connect.ContactFlowArgs.builder();
