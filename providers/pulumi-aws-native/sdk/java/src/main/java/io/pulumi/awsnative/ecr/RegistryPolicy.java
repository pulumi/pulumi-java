...
public class RegistryPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.ecr.RegistryPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.ecr.RegistryPolicyArgs.builder();
