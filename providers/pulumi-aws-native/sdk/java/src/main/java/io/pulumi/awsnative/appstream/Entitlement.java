...
public class Entitlement extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.appstream.EntitlementArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.appstream.EntitlementArgs.builder();
