...
public final class ListenerRedirectConfigArgs extends io.pulumi.resources.ResourceArgs {

    public static final ListenerRedirectConfigArgs Empty = new ListenerRedirectConfigArgs();
    ...
    public static Builder builder(ListenerRedirectConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ListenerRedirectConfigArgs defaults) {
        ...
        public ListenerRedirectConfigArgs build() {
            return new ListenerRedirectConfigArgs(host, path, port, protocol, query, statusCode);
        }
    }
}
