...
public final class DatasetS3DestinationConfigurationArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setGlueConfiguration(@Nullable Input<DatasetGlueConfigurationArgs> glueConfiguration) {
            this.glueConfiguration = glueConfiguration;
            return this;
        }

        public Builder setGlueConfiguration(@Nullable DatasetGlueConfigurationArgs glueConfiguration) {
