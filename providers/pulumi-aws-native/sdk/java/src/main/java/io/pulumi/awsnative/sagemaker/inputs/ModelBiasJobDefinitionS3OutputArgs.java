...
public final class ModelBiasJobDefinitionS3OutputArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<ModelBiasJobDefinitionS3OutputS3UploadMode> s3UploadMode;

    public Input<ModelBiasJobDefinitionS3OutputS3UploadMode> getS3UploadMode() {
    ...
    public ModelBiasJobDefinitionS3OutputArgs(
        ...
        @Nullable Input<ModelBiasJobDefinitionS3OutputS3UploadMode> s3UploadMode,
        Input<String> s3Uri) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<ModelBiasJobDefinitionS3OutputS3UploadMode> s3UploadMode;
        ...
        public Builder setS3UploadMode(@Nullable Input<ModelBiasJobDefinitionS3OutputS3UploadMode> s3UploadMode) {
            this.s3UploadMode = s3UploadMode;
            return this;
        }

        public Builder setS3UploadMode(@Nullable ModelBiasJobDefinitionS3OutputS3UploadMode s3UploadMode) {
