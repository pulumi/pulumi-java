...
public final class ListenerRuleAuthenticateOidcConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public ListenerRuleAuthenticateOidcConfigArgs(
        ...
        @Nullable Input<Boolean> useExistingClientSecret,
    ...
    private ListenerRuleAuthenticateOidcConfigArgs() {
        ...
        this.useExistingClientSecret = Input.empty();
    ...
    public static final class Builder {
        ...
        private @Nullable Input<Boolean> useExistingClientSecret;
        ...
        public Builder setUseExistingClientSecret(@Nullable Input<Boolean> useExistingClientSecret) {
            this.useExistingClientSecret = useExistingClientSecret;
            return this;
        }

        public Builder setUseExistingClientSecret(@Nullable Boolean useExistingClientSecret) {
            this.useExistingClientSecret = Input.ofNullable(useExistingClientSecret);
            return this;
        }
