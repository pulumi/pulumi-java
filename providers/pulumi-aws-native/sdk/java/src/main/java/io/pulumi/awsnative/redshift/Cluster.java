...
public class Cluster extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.redshift.ClusterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.redshift.ClusterArgs.builder();
