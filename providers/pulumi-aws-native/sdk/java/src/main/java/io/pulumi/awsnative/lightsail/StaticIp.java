...
public class StaticIp extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.lightsail.StaticIpArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.lightsail.StaticIpArgs.builder();
     ...
     */
    public static StaticIp get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
