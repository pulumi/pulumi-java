...
public class InternetGateway extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.ec2.InternetGatewayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.ec2.InternetGatewayArgs.builder();
