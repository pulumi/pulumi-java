...
public class Pipeline extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.sagemaker.PipelineArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.sagemaker.PipelineArgs.builder();
