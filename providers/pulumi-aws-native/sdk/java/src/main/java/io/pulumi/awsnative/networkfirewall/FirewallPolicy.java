...
public class FirewallPolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.networkfirewall.FirewallPolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.networkfirewall.FirewallPolicyArgs.builder();
