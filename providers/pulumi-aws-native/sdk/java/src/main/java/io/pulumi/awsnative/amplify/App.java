...
public class App extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.amplify.AppArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.amplify.AppArgs.builder();
