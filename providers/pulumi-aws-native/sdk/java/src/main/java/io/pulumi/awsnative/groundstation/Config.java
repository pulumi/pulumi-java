...
public class Config extends io.pulumi.resources.CustomResource {
    ...
    public Config(String name) {
        super("aws-native:groundstation:Config", name, ConfigArgs.Empty, makeResourceOptions(null, Input.empty()));
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    public Config(String name, ConfigArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:groundstation:Config", name, args == null ? ConfigArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
