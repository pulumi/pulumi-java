...
public class Link extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.networkmanager.LinkArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.networkmanager.LinkArgs.builder();
