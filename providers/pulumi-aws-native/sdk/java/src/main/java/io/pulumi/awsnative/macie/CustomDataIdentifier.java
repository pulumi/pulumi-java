...
public class CustomDataIdentifier extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(CustomDataIdentifierArgs.Builder a);
    }
    private static io.pulumi.awsnative.macie.CustomDataIdentifierArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.macie.CustomDataIdentifierArgs.builder();
