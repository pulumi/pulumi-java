...
public final class ModelBiasJobDefinitionModelBiasBaselineConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setConstraintsResource(@Nullable Input<ModelBiasJobDefinitionConstraintsResourceArgs> constraintsResource) {
            this.constraintsResource = constraintsResource;
            return this;
        }

        public Builder setConstraintsResource(@Nullable ModelBiasJobDefinitionConstraintsResourceArgs constraintsResource) {
