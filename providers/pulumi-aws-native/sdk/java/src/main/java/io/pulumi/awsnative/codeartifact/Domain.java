...
public class Domain extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.codeartifact.DomainArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.codeartifact.DomainArgs.builder();
