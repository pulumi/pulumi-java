...
public class UserProfile extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.sagemaker.UserProfileArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.sagemaker.UserProfileArgs.builder();
    ...
    public UserProfile(String name, UserProfileArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:sagemaker:UserProfile", name, args == null ? UserProfileArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
