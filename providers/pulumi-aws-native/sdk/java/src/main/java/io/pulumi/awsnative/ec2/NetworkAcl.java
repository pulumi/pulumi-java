...
public class NetworkAcl extends io.pulumi.resources.CustomResource {
    ...
    public NetworkAcl(String name, NetworkAclArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:ec2:NetworkAcl", name, args == null ? NetworkAclArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private NetworkAcl(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static NetworkAcl get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
