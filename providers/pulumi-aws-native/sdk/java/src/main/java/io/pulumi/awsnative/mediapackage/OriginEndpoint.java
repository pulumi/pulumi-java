...
public class OriginEndpoint extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(OriginEndpointArgs.Builder a);
    }
    private static io.pulumi.awsnative.mediapackage.OriginEndpointArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.mediapackage.OriginEndpointArgs.builder();
     ...
     */
    public OriginEndpoint(String name, BuilderApplicator argsBuilder) {
