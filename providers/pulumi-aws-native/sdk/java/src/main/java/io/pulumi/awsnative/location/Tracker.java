...
public class Tracker extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable TrackerArgs.Builder a);
    }
    private static io.pulumi.awsnative.location.TrackerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.location.TrackerArgs.builder();
     ...
     */
    public Tracker(String name, BuilderApplicator argsBuilder) {
