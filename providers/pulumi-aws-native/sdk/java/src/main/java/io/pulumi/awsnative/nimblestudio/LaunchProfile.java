...
public class LaunchProfile extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(LaunchProfileArgs.Builder a);
    }
    private static io.pulumi.awsnative.nimblestudio.LaunchProfileArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.nimblestudio.LaunchProfileArgs.builder();
     ...
     */
    public LaunchProfile(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public static LaunchProfile get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
