...
public class Group extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.resourcegroups.GroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.resourcegroups.GroupArgs.builder();
