...
public class PackagingConfiguration extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PackagingConfigurationArgs.Builder a);
    }
    private static io.pulumi.awsnative.mediapackage.PackagingConfigurationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.mediapackage.PackagingConfigurationArgs.builder();
     ...
     */
    public PackagingConfiguration(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public static PackagingConfiguration get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
