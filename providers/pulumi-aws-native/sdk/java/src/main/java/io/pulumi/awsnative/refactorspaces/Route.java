...
public class Route extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.refactorspaces.RouteArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.refactorspaces.RouteArgs.builder();
    ...
    public Route(String name, RouteArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:refactorspaces:Route", name, args == null ? RouteArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
