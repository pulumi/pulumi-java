...
public class Dashboard extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.quicksight.DashboardArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.quicksight.DashboardArgs.builder();
    ...
    public Dashboard(String name, DashboardArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:quicksight:Dashboard", name, args == null ? DashboardArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
