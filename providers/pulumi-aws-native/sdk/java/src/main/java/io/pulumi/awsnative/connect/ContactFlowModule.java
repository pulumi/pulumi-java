...
public class ContactFlowModule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.connect.ContactFlowModuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.connect.ContactFlowModuleArgs.builder();
