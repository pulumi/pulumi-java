...
public class BotAlias extends io.pulumi.resources.CustomResource {
    ...
    public BotAlias(String name, BotAliasArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:lex:BotAlias", name, args == null ? BotAliasArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private BotAlias(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static BotAlias get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
