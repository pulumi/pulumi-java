...
public class ImagePipeline extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable ImagePipelineArgs.Builder a);
    }
    private static io.pulumi.awsnative.imagebuilder.ImagePipelineArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.imagebuilder.ImagePipelineArgs.builder();
