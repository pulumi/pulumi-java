...
public class Distribution extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(DistributionArgs.Builder a);
    }
    private static io.pulumi.awsnative.cloudfront.DistributionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.cloudfront.DistributionArgs.builder();
     ...
     */
    public Distribution(String name, BuilderApplicator argsBuilder) {
