...
public class TopicRule extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.iot.TopicRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.iot.TopicRuleArgs.builder();
