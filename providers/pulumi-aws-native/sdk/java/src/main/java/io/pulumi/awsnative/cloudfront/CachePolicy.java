...
public class CachePolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.cloudfront.CachePolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.cloudfront.CachePolicyArgs.builder();
