...
public class User extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.elasticache.UserArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.elasticache.UserArgs.builder();
    ...
    public User(String name, UserArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:elasticache:User", name, args == null ? UserArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
