...
public class BackupVault extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable BackupVaultArgs.Builder a);
    }
    private static io.pulumi.awsnative.backup.BackupVaultArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.backup.BackupVaultArgs.builder();
