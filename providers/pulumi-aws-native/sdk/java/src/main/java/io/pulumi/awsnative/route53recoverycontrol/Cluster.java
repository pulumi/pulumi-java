...
public class Cluster extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.route53recoverycontrol.ClusterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.route53recoverycontrol.ClusterArgs.builder();
