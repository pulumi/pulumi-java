...
public final class SpotFleetEbsBlockDeviceArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setVolumeType(@Nullable Input<SpotFleetEbsBlockDeviceVolumeType> volumeType) {
            this.volumeType = volumeType;
            return this;
        }

        public Builder setVolumeType(@Nullable SpotFleetEbsBlockDeviceVolumeType volumeType) {
