...
public class MitigationAction extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(MitigationActionArgs.Builder a);
    }
    private static io.pulumi.awsnative.iot.MitigationActionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.iot.MitigationActionArgs.builder();
     ...
     */
    public MitigationAction(String name, BuilderApplicator argsBuilder) {
