...
public class ScheduledAction extends io.pulumi.resources.CustomResource {
    ...
    public ScheduledAction(String name, @Nullable ScheduledActionArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:redshift:ScheduledAction", name, args == null ? ScheduledActionArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private ScheduledAction(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static ScheduledAction get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
