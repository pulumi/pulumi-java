...
public class FleetMetric extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(FleetMetricArgs.Builder a);
    }
    private static io.pulumi.awsnative.iot.FleetMetricArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.iot.FleetMetricArgs.builder();
     ...
     */
    public FleetMetric(String name, BuilderApplicator argsBuilder) {
