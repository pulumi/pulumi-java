...
public class SafetyRule extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable SafetyRuleArgs.Builder a);
    }
    private static io.pulumi.awsnative.route53recoverycontrol.SafetyRuleArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.route53recoverycontrol.SafetyRuleArgs.builder();
