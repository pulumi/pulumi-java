...
public class Account extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.apigateway.AccountArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.apigateway.AccountArgs.builder();
