...
public class Application extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.applicationinsights.ApplicationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.applicationinsights.ApplicationArgs.builder();
    ...
    public Application(String name, ApplicationArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:applicationinsights:Application", name, args == null ? ApplicationArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
