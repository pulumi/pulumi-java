...
public class Portal extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(PortalArgs.Builder a);
    }
    private static io.pulumi.awsnative.iotsitewise.PortalArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.iotsitewise.PortalArgs.builder();
     ...
     */
    public Portal(String name, BuilderApplicator argsBuilder) {
    ...
    public Portal(String name, PortalArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:iotsitewise:Portal", name, args == null ? PortalArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private Portal(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Portal get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
