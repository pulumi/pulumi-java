...
import java.util.StringJoiner;
    ...
    @EnumType
    public enum OriginEndpointHlsPackageAdTriggersItem {
        ...
        OriginEndpointHlsPackageAdTriggersItem(String value) {
        ...
        public String toString() {
            return new StringJoiner(", ", "OriginEndpointHlsPackageAdTriggersItem[", "]")
