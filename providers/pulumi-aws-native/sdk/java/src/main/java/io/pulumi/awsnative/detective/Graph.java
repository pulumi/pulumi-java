...
public class Graph extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.detective.GraphArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.detective.GraphArgs.builder();
