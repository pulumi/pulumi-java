...
public class Collection extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(CollectionArgs.Builder a);
    }
    private static io.pulumi.awsnative.rekognition.CollectionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.rekognition.CollectionArgs.builder();
     ...
     */
    public Collection(String name, BuilderApplicator argsBuilder) {
