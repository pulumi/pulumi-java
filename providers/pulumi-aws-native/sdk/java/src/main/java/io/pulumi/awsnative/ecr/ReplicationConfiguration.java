...
public class ReplicationConfiguration extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ReplicationConfigurationArgs.Builder a);
    }
    private static io.pulumi.awsnative.ecr.ReplicationConfigurationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.ecr.ReplicationConfigurationArgs.builder();
