...
public final class WorkGroupConfigurationArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setResultConfiguration(@Nullable Input<WorkGroupResultConfigurationArgs> resultConfiguration) {
            this.resultConfiguration = resultConfiguration;
            return this;
        }

        public Builder setResultConfiguration(@Nullable WorkGroupResultConfigurationArgs resultConfiguration) {
