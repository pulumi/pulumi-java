...
public class VPC extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(VPCArgs.Builder a);
    }
    private static io.pulumi.awsnative.ec2.VPCArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.ec2.VPCArgs.builder();
     ...
     */
    public VPC(String name, BuilderApplicator argsBuilder) {
    ...
    public VPC(String name, VPCArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:ec2:VPC", name, args == null ? VPCArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private VPC(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static VPC get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
