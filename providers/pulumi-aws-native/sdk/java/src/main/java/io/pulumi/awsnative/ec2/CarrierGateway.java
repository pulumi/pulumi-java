...
public class CarrierGateway extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.ec2.CarrierGatewayArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.ec2.CarrierGatewayArgs.builder();
