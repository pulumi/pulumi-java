...
public class BotVersion extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(BotVersionArgs.Builder a);
    }
    private static io.pulumi.awsnative.lex.BotVersionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.lex.BotVersionArgs.builder();
     ...
     */
    public BotVersion(String name, BuilderApplicator argsBuilder) {
