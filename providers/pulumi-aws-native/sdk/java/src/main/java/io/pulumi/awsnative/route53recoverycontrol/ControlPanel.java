...
public class ControlPanel extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable ControlPanelArgs.Builder a);
    }
    private static io.pulumi.awsnative.route53recoverycontrol.ControlPanelArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.route53recoverycontrol.ControlPanelArgs.builder();
