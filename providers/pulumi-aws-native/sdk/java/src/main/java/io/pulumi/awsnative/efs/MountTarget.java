...
public class MountTarget extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.efs.MountTargetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.efs.MountTargetArgs.builder();
