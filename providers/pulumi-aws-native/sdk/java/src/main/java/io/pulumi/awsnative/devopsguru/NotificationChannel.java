...
public class NotificationChannel extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.devopsguru.NotificationChannelArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.devopsguru.NotificationChannelArgs.builder();
    ...
    public NotificationChannel(String name, NotificationChannelArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:devopsguru:NotificationChannel", name, args == null ? NotificationChannelArgs.Empty : args, makeResourceOptions(options, Input.empty()));
    }
