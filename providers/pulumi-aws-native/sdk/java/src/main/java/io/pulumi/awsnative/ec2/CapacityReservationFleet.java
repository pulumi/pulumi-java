...
public class CapacityReservationFleet extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable CapacityReservationFleetArgs.Builder a);
    }
    private static io.pulumi.awsnative.ec2.CapacityReservationFleetArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.ec2.CapacityReservationFleetArgs.builder();
     ...
     */
    public CapacityReservationFleet(String name, BuilderApplicator argsBuilder) {
