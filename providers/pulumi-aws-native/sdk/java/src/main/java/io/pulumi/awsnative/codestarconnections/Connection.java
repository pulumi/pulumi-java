...
public class Connection extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.codestarconnections.ConnectionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.codestarconnections.ConnectionArgs.builder();
