...
public class EventIntegration extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(EventIntegrationArgs.Builder a);
    }
    private static io.pulumi.awsnative.appintegrations.EventIntegrationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.appintegrations.EventIntegrationArgs.builder();
     ...
     */
    public EventIntegration(String name, BuilderApplicator argsBuilder) {
