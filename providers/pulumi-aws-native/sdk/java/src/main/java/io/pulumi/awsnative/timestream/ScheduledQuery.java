...
public class ScheduledQuery extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ScheduledQueryArgs.Builder a);
    }
    private static io.pulumi.awsnative.timestream.ScheduledQueryArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.timestream.ScheduledQueryArgs.builder();
     ...
     */
    public ScheduledQuery(String name, BuilderApplicator argsBuilder) {
    ...
    public ScheduledQuery(String name, ScheduledQueryArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:timestream:ScheduledQuery", name, args == null ? ScheduledQueryArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
