...
public class ResourceAssociation extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.servicecatalogappregistry.ResourceAssociationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.servicecatalogappregistry.ResourceAssociationArgs.builder();
     ...
     */
    public static ResourceAssociation get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
