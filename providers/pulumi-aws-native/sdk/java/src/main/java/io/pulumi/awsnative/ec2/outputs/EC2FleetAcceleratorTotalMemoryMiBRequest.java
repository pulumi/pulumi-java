...
@CustomType
public final class EC2FleetAcceleratorTotalMemoryMiBRequest {
    ...
    public static Builder builder(EC2FleetAcceleratorTotalMemoryMiBRequest defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(EC2FleetAcceleratorTotalMemoryMiBRequest defaults) {
