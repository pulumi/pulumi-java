...
public class Device extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.sagemaker.DeviceArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.sagemaker.DeviceArgs.builder();
    ...
    public Device(String name, DeviceArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:sagemaker:Device", name, args == null ? DeviceArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
