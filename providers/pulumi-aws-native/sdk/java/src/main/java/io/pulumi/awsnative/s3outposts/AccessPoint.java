...
public class AccessPoint extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.s3outposts.AccessPointArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.s3outposts.AccessPointArgs.builder();
