...
public class NetworkProfile extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.devicefarm.NetworkProfileArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.devicefarm.NetworkProfileArgs.builder();
