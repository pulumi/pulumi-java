...
public class ImageRecipe extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.imagebuilder.ImageRecipeArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.imagebuilder.ImageRecipeArgs.builder();
