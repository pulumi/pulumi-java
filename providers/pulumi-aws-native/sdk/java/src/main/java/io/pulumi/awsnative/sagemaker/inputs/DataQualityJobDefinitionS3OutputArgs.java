 ...
 * 
 */
public final class DataQualityJobDefinitionS3OutputArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public DataQualityJobDefinitionS3OutputArgs(
        ...
        @Nullable Input<DataQualityJobDefinitionS3OutputS3UploadMode> s3UploadMode,
        Input<String> s3Uri) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<DataQualityJobDefinitionS3OutputS3UploadMode> s3UploadMode;
        ...
        public Builder setS3UploadMode(@Nullable Input<DataQualityJobDefinitionS3OutputS3UploadMode> s3UploadMode) {
            this.s3UploadMode = s3UploadMode;
            return this;
        }
