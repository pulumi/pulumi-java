...
public class ServiceActionAssociation extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ServiceActionAssociationArgs.Builder a);
    }
    private static io.pulumi.awsnative.servicecatalog.ServiceActionAssociationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.servicecatalog.ServiceActionAssociationArgs.builder();
     ...
     */
    public ServiceActionAssociation(String name, BuilderApplicator argsBuilder) {
