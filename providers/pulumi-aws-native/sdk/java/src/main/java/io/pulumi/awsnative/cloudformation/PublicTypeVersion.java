...
public class PublicTypeVersion extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable PublicTypeVersionArgs.Builder a);
    }
    private static io.pulumi.awsnative.cloudformation.PublicTypeVersionArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.cloudformation.PublicTypeVersionArgs.builder();
     ...
     */
    public PublicTypeVersion(String name, BuilderApplicator argsBuilder) {
