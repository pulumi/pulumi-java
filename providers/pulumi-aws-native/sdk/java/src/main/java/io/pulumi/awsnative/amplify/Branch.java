...
public class Branch extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(BranchArgs.Builder a);
    }
    private static io.pulumi.awsnative.amplify.BranchArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.amplify.BranchArgs.builder();
     ...
     */
    public Branch(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public static Branch get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
