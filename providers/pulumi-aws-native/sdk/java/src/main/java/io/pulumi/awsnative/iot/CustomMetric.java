...
public class CustomMetric extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(CustomMetricArgs.Builder a);
    }
    private static io.pulumi.awsnative.iot.CustomMetricArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.iot.CustomMetricArgs.builder();
     ...
     */
    public CustomMetric(String name, BuilderApplicator argsBuilder) {
