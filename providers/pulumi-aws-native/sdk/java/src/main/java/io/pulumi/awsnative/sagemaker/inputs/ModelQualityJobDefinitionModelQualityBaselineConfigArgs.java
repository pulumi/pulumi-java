...
public final class ModelQualityJobDefinitionModelQualityBaselineConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    @InputImport(name="constraintsResource")
        private final @Nullable Input<ModelQualityJobDefinitionConstraintsResourceArgs> constraintsResource;

    public Input<ModelQualityJobDefinitionConstraintsResourceArgs> getConstraintsResource() {
    ...
    public ModelQualityJobDefinitionModelQualityBaselineConfigArgs(
        ...
        @Nullable Input<ModelQualityJobDefinitionConstraintsResourceArgs> constraintsResource) {
    ...
    public static final class Builder {
        ...
        private @Nullable Input<ModelQualityJobDefinitionConstraintsResourceArgs> constraintsResource;
        ...
        public Builder setConstraintsResource(@Nullable Input<ModelQualityJobDefinitionConstraintsResourceArgs> constraintsResource) {
            this.constraintsResource = constraintsResource;
            return this;
        }

        public Builder setConstraintsResource(@Nullable ModelQualityJobDefinitionConstraintsResourceArgs constraintsResource) {
