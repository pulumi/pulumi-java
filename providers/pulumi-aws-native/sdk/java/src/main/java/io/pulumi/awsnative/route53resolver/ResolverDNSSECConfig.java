...
public class ResolverDNSSECConfig extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable ResolverDNSSECConfigArgs.Builder a);
    }
    private static io.pulumi.awsnative.route53resolver.ResolverDNSSECConfigArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.route53resolver.ResolverDNSSECConfigArgs.builder();
