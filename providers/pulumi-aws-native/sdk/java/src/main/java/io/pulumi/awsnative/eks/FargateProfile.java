...
public class FargateProfile extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.eks.FargateProfileArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.eks.FargateProfileArgs.builder();
