...
public class Alert extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(AlertArgs.Builder a);
    }
    private static io.pulumi.awsnative.lookoutmetrics.AlertArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.lookoutmetrics.AlertArgs.builder();
     ...
     */
    public Alert(String name, BuilderApplicator argsBuilder) {
