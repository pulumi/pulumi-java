...
public final class FinspaceFunctions {
     ...
     * 
     */
    public static CompletableFuture<GetEnvironmentResult> getEnvironment(io.pulumi.awsnative.finspace.inputs.GetEnvironmentArgs args) {
        return getEnvironment(args, io.pulumi.deployment.InvokeOptions.Empty);
    }
    public static CompletableFuture<GetEnvironmentResult> getEnvironment(io.pulumi.awsnative.finspace.inputs.GetEnvironmentArgs args, InvokeOptions options) {
