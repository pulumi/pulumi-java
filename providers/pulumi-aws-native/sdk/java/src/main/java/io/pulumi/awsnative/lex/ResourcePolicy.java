...
public class ResourcePolicy extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.lex.ResourcePolicyArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.lex.ResourcePolicyArgs.builder();
