...
public class Repository extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.codeartifact.RepositoryArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.codeartifact.RepositoryArgs.builder();
