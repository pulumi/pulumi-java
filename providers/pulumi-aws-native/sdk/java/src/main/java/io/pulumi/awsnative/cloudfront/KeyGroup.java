...
public class KeyGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.cloudfront.KeyGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.cloudfront.KeyGroupArgs.builder();
    ...
    public KeyGroup(String name, KeyGroupArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:cloudfront:KeyGroup", name, args == null ? KeyGroupArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }

    private KeyGroup(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static KeyGroup get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
