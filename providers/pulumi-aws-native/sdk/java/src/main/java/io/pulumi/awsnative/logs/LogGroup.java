...
public class LogGroup extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.logs.LogGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.logs.LogGroupArgs.builder();
