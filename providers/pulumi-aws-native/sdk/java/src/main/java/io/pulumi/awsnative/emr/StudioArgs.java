...
public final class StudioArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setAuthMode(Input<StudioAuthMode> authMode) {
            this.authMode = Objects.requireNonNull(authMode);
            return this;
        }

        public Builder setAuthMode(StudioAuthMode authMode) {
        ...
        public Builder setTags(@Nullable Input<List<StudioTagArgs>> tags) {
            this.tags = tags;
            return this;
        }

        public Builder setTags(@Nullable List<StudioTagArgs> tags) {
