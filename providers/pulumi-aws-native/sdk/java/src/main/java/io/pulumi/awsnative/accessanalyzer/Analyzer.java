...
public class Analyzer extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.accessanalyzer.AnalyzerArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.accessanalyzer.AnalyzerArgs.builder();
