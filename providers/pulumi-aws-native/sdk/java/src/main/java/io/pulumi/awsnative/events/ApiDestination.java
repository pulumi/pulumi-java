...
public class ApiDestination extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(ApiDestinationArgs.Builder a);
    }
    private static io.pulumi.awsnative.events.ApiDestinationArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.events.ApiDestinationArgs.builder();
     ...
     */
    public ApiDestination(String name, BuilderApplicator argsBuilder) {
