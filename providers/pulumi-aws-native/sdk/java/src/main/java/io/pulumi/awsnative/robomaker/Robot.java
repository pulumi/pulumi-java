...
public class Robot extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(RobotArgs.Builder a);
    }
    private static io.pulumi.awsnative.robomaker.RobotArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.robomaker.RobotArgs.builder();
     ...
     */
    public Robot(String name, BuilderApplicator argsBuilder) {
