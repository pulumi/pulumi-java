...
public class User extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.connect.UserArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.connect.UserArgs.builder();
