...
public class License extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(LicenseArgs.Builder a);
    }
    private static io.pulumi.awsnative.licensemanager.LicenseArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.licensemanager.LicenseArgs.builder();
     ...
     */
    public License(String name, BuilderApplicator argsBuilder) {
    ...
    public License(String name, LicenseArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:licensemanager:License", name, args == null ? LicenseArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
