...
public final class CanaryArtifactConfigArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setS3Encryption(@Nullable Input<CanaryS3EncryptionArgs> s3Encryption) {
            this.s3Encryption = s3Encryption;
            return this;
        }

        public Builder setS3Encryption(@Nullable CanaryS3EncryptionArgs s3Encryption) {
