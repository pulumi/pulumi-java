...
public final class DataSourceConfluenceBlogToIndexFieldMapping extends io.pulumi.resources.InvokeArgs {
    ...
    public DataSourceConfluenceBlogToIndexFieldMapping(
        DataSourceConfluenceBlogFieldName dataSourceFieldName,
