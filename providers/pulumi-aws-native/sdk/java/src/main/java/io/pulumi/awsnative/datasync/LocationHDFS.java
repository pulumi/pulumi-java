...
public class LocationHDFS extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(LocationHDFSArgs.Builder a);
    }
    private static io.pulumi.awsnative.datasync.LocationHDFSArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.datasync.LocationHDFSArgs.builder();
     ...
     */
    public LocationHDFS(String name, BuilderApplicator argsBuilder) {
