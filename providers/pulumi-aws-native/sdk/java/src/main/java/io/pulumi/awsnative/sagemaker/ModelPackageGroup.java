...
public class ModelPackageGroup extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable ModelPackageGroupArgs.Builder a);
    }
    private static io.pulumi.awsnative.sagemaker.ModelPackageGroupArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.sagemaker.ModelPackageGroupArgs.builder();
     ...
     */
    public ModelPackageGroup(String name, BuilderApplicator argsBuilder) {
