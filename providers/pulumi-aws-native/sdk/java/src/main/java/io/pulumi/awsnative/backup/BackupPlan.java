...
public class BackupPlan extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(BackupPlanArgs.Builder a);
    }
    private static io.pulumi.awsnative.backup.BackupPlanArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.backup.BackupPlanArgs.builder();
     ...
     */
    public BackupPlan(String name, BuilderApplicator argsBuilder) {
     ...
     */
    public static BackupPlan get(String name, Output<String> id, @Nullable io.pulumi.resources.CustomResourceOptions options) {
