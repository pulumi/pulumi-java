...
public class LifecycleHook extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.autoscaling.LifecycleHookArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.autoscaling.LifecycleHookArgs.builder();
