...
public final class EnvironmentArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder setNetworkFabricType(@Nullable Input<EnvironmentNetworkFabricType> networkFabricType) {
            this.networkFabricType = networkFabricType;
            return this;
        }

        public Builder setNetworkFabricType(@Nullable EnvironmentNetworkFabricType networkFabricType) {
            this.networkFabricType = Input.ofNullable(networkFabricType);
            return this;
        }

        public Builder setTags(@Nullable Input<List<EnvironmentTagArgs>> tags) {
            this.tags = tags;
            return this;
        }

        public Builder setTags(@Nullable List<EnvironmentTagArgs> tags) {
