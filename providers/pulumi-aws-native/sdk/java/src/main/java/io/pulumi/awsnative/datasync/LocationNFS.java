...
public class LocationNFS extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(LocationNFSArgs.Builder a);
    }
    private static io.pulumi.awsnative.datasync.LocationNFSArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.datasync.LocationNFSArgs.builder();
     ...
     */
    public LocationNFS(String name, BuilderApplicator argsBuilder) {
