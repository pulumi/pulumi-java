...
public class Cluster extends io.pulumi.resources.CustomResource {
    ...
    private static io.pulumi.awsnative.eks.ClusterArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.eks.ClusterArgs.builder();
    ...
    public Cluster(String name, ClusterArgs args, @Nullable io.pulumi.resources.CustomResourceOptions options) {
        super("aws-native:eks:Cluster", name, args == null ? ClusterArgs.Empty : args, makeResourceOptions(options, Output.empty()));
    }
