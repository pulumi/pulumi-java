...
public class FirewallDomainList extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable FirewallDomainListArgs.Builder a);
    }
    private static io.pulumi.awsnative.route53resolver.FirewallDomainListArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.route53resolver.FirewallDomainListArgs.builder();
     ...
     */
    public FirewallDomainList(String name, BuilderApplicator argsBuilder) {
