...
public class SigningProfile extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(SigningProfileArgs.Builder a);
    }
    private static io.pulumi.awsnative.signer.SigningProfileArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.signer.SigningProfileArgs.builder();
     ...
     */
    public SigningProfile(String name, BuilderApplicator argsBuilder) {
