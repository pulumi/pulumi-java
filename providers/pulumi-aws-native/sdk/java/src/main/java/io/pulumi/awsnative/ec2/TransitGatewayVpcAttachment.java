...
public class TransitGatewayVpcAttachment extends io.pulumi.resources.CustomResource {
    ...
    public interface BuilderApplicator {
        public void apply(@Nullable TransitGatewayVpcAttachmentArgs.Builder a);
    }
    private static io.pulumi.awsnative.ec2.TransitGatewayVpcAttachmentArgs buildArgs(BuilderApplicator argsBuilder) {
        final var builder = io.pulumi.awsnative.ec2.TransitGatewayVpcAttachmentArgs.builder();
     ...
     */
    public TransitGatewayVpcAttachment(String name, BuilderApplicator argsBuilder) {
