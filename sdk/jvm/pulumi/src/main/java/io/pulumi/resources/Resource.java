...
public abstract class Resource {
     ...
     * @param remote     true if this is a remote component resource
     * @param dependency true if this is a synthetic resource used internally for dependency tracking
     * @param preInit    subclass initialization logic to run before kicking off async registerResource task
     */
    protected Resource(
            String type, String name, boolean custom,
            ResourceArgs args, ResourceOptions options,
            boolean remote, boolean dependency, @Nullable Consumer<Resource> preInit
    ) {
        if (preInit != null) {
            preInit.accept(this);
        }
