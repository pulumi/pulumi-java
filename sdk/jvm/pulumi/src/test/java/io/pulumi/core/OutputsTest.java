...
public class OutputsTest {
    ...
    public void testNullableSecretifyOutput() {
        ...
        Output<String> res0_ = ctx.output.ofNullable((String) null);
        ...
        Output<String> res1 = ctx.output.ofNullable("test1").asSecret();
        ...
        Output<String> res2 = ctx.output.ofNullable(ctx.output.of("test2")).asSecret();
